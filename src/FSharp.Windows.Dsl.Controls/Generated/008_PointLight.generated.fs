...
type PointLightProp = Base of PointLightBaseProp

module PointLight =

    let apply (el: System.Windows.Media.Media3D.PointLight) (prop: PointLightProp) =
        match prop with
        | PointLightProp.Base p -> PointLightBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Media.Media3D.PointLight>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
