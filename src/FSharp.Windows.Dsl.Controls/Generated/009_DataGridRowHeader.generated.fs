...
module DataGridRowHeader =
    let separatorBrush v : obj =
        box (DataGridRowHeaderProp.SeparatorBrush v)

    let separatorVisibility v : obj =
        box (DataGridRowHeaderProp.SeparatorVisibility v)

    let apply (el: System.Windows.Controls.Primitives.DataGridRowHeader) (prop: DataGridRowHeaderProp) =
        match prop with
        | DataGridRowHeaderProp.Base p -> ButtonBase.apply el p
        | DataGridRowHeaderProp.SeparatorBrush v ->
            el.SetValue(System.Windows.Controls.Primitives.DataGridRowHeader.SeparatorBrushProperty, box v)
        | DataGridRowHeaderProp.SeparatorVisibility v ->
            el.SetValue(System.Windows.Controls.Primitives.DataGridRowHeader.SeparatorVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.DataGridRowHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
