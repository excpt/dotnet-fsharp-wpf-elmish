...
module DockPanel =
    let lastChildFill v : obj = box (DockPanelProp.LastChildFill v)

    let apply (el: System.Windows.Controls.DockPanel) (prop: DockPanelProp) =
        match prop with
        | DockPanelProp.Base p -> Panel.apply el p
        | DockPanelProp.LastChildFill v -> el.SetValue(System.Windows.Controls.DockPanel.LastChildFillProperty, box v)
    ...
    let dock (v: System.Windows.Controls.Dock) (node: VirtualNode) : VirtualNode =
