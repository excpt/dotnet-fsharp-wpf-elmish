...
module TreeView =
    let selectedValuePath v : obj = box (TreeViewProp.SelectedValuePath v)

    let apply (el: System.Windows.Controls.TreeView) (prop: TreeViewProp) =
        match prop with
        | TreeViewProp.Base p -> ItemsControl.apply el p
        | TreeViewProp.SelectedValuePath v -> el.SetValue(System.Windows.Controls.TreeView.SelectedValuePathProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.TreeView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
