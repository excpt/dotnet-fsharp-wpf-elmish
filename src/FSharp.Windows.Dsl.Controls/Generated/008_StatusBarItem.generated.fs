...
type StatusBarItemProp = Base of ContentControlProp

module StatusBarItem =

    let apply (el: System.Windows.Controls.Primitives.StatusBarItem) (prop: StatusBarItemProp) =
        match prop with
        | StatusBarItemProp.Base p -> ContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.StatusBarItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
