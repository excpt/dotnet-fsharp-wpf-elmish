...
type ItalicProp = Base of InlineProp

module Italic =

    let apply (el: System.Windows.Documents.Italic) (prop: ItalicProp) =
        match prop with
        | ItalicProp.Base p -> Inline.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.Italic>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
