...
module HeaderedContentControl =
    ...
    let apply (el: System.Windows.Controls.HeaderedContentControl) (prop: HeaderedContentControlProp) =
        match prop with
        | HeaderedContentControlProp.Base p -> ContentControl.apply el p
        | HeaderedContentControlProp.Header v ->
            el.SetValue(System.Windows.Controls.HeaderedContentControl.HeaderProperty, box v)
        | HeaderedContentControlProp.HeaderTemplate v ->
            el.SetValue(System.Windows.Controls.HeaderedContentControl.HeaderTemplateProperty, box v)
        | HeaderedContentControlProp.HeaderTemplateSelector v ->
            el.SetValue(System.Windows.Controls.HeaderedContentControl.HeaderTemplateSelectorProperty, box v)
        | HeaderedContentControlProp.HeaderStringFormat v ->
            el.SetValue(System.Windows.Controls.HeaderedContentControl.HeaderStringFormatProperty, box v)
