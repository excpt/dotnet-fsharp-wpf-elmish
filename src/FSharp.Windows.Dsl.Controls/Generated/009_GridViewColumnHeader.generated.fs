...
type GridViewColumnHeaderProp = Base of ButtonBaseProp

module GridViewColumnHeader =

    let apply (el: System.Windows.Controls.GridViewColumnHeader) (prop: GridViewColumnHeaderProp) =
        match prop with
        | GridViewColumnHeaderProp.Base p -> ButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.GridViewColumnHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
