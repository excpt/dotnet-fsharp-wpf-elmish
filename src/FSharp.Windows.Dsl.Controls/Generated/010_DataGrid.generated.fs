...
module DataGrid =
    let canUserResizeColumns v : obj = box (DataGridProp.CanUserResizeColumns v)
    ...
    let gridLinesVisibility v : obj = box (DataGridProp.GridLinesVisibility v)
    let horizontalGridLinesBrush v : obj = box (DataGridProp.HorizontalGridLinesBrush v)
    let verticalGridLinesBrush v : obj = box (DataGridProp.VerticalGridLinesBrush v)
    let rowStyle v : obj = box (DataGridProp.RowStyle v)
    let rowValidationErrorTemplate v : obj = box (DataGridProp.RowValidationErrorTemplate v)
    let rowStyleSelector v : obj = box (DataGridProp.RowStyleSelector v)
    let rowBackground v : obj = box (DataGridProp.RowBackground v)
    let alternatingRowBackground v : obj = box (DataGridProp.AlternatingRowBackground v)
    ...
    let rowHeaderTemplateSelector v : obj = box (DataGridProp.RowHeaderTemplateSelector v)
    let horizontalScrollBarVisibility v : obj = box (DataGridProp.HorizontalScrollBarVisibility v)
    let verticalScrollBarVisibility v : obj = box (DataGridProp.VerticalScrollBarVisibility v)
    ...
    let rowDetailsVisibilityMode v : obj = box (DataGridProp.RowDetailsVisibilityMode v)
    let areRowDetailsFrozen v : obj = box (DataGridProp.AreRowDetailsFrozen v)
    let rowDetailsTemplate v : obj = box (DataGridProp.RowDetailsTemplate v)
    let rowDetailsTemplateSelector v : obj = box (DataGridProp.RowDetailsTemplateSelector v)
    ...
    let autoGenerateColumns v : obj = box (DataGridProp.AutoGenerateColumns v)
    let frozenColumnCount v : obj = box (DataGridProp.FrozenColumnCount v)
    let enableRowVirtualization v : obj = box (DataGridProp.EnableRowVirtualization v)
    let enableColumnVirtualization v : obj = box (DataGridProp.EnableColumnVirtualization v)
    let canUserReorderColumns v : obj = box (DataGridProp.CanUserReorderColumns v)
    let dragIndicatorStyle v : obj = box (DataGridProp.DragIndicatorStyle v)
    let dropLocationIndicatorStyle v : obj = box (DataGridProp.DropLocationIndicatorStyle v)
    ...
    let apply (el: System.Windows.Controls.DataGrid) (prop: DataGridProp) =
        ...
        | DataGridProp.CanUserResizeColumns v -> el.SetValue(System.Windows.Controls.DataGrid.CanUserResizeColumnsProperty, box v)
        ...
        | DataGridProp.GridLinesVisibility v -> el.SetValue(System.Windows.Controls.DataGrid.GridLinesVisibilityProperty, box v)
        | DataGridProp.HorizontalGridLinesBrush v -> el.SetValue(System.Windows.Controls.DataGrid.HorizontalGridLinesBrushProperty, box v)
        | DataGridProp.VerticalGridLinesBrush v -> el.SetValue(System.Windows.Controls.DataGrid.VerticalGridLinesBrushProperty, box v)
        | DataGridProp.RowStyle v -> el.SetValue(System.Windows.Controls.DataGrid.RowStyleProperty, box v)
        | DataGridProp.RowValidationErrorTemplate v -> el.SetValue(System.Windows.Controls.DataGrid.RowValidationErrorTemplateProperty, box v)
        | DataGridProp.RowStyleSelector v -> el.SetValue(System.Windows.Controls.DataGrid.RowStyleSelectorProperty, box v)
        | DataGridProp.RowBackground v -> el.SetValue(System.Windows.Controls.DataGrid.RowBackgroundProperty, box v)
        | DataGridProp.AlternatingRowBackground v -> el.SetValue(System.Windows.Controls.DataGrid.AlternatingRowBackgroundProperty, box v)
        ...
        | DataGridProp.ColumnHeaderHeight v -> el.SetValue(System.Windows.Controls.DataGrid.ColumnHeaderHeightProperty, box v)
        | DataGridProp.HeadersVisibility v -> el.SetValue(System.Windows.Controls.DataGrid.HeadersVisibilityProperty, box v)
        | DataGridProp.CellStyle v -> el.SetValue(System.Windows.Controls.DataGrid.CellStyleProperty, box v)
        | DataGridProp.ColumnHeaderStyle v -> el.SetValue(System.Windows.Controls.DataGrid.ColumnHeaderStyleProperty, box v)
        | DataGridProp.RowHeaderStyle v -> el.SetValue(System.Windows.Controls.DataGrid.RowHeaderStyleProperty, box v)
        | DataGridProp.RowHeaderTemplate v -> el.SetValue(System.Windows.Controls.DataGrid.RowHeaderTemplateProperty, box v)
        | DataGridProp.RowHeaderTemplateSelector v -> el.SetValue(System.Windows.Controls.DataGrid.RowHeaderTemplateSelectorProperty, box v)
        | DataGridProp.HorizontalScrollBarVisibility v -> el.SetValue(System.Windows.Controls.DataGrid.HorizontalScrollBarVisibilityProperty, box v)
        | DataGridProp.VerticalScrollBarVisibility v -> el.SetValue(System.Windows.Controls.DataGrid.VerticalScrollBarVisibilityProperty, box v)
        ...
        | DataGridProp.CanUserDeleteRows v -> el.SetValue(System.Windows.Controls.DataGrid.CanUserDeleteRowsProperty, box v)
        | DataGridProp.RowDetailsVisibilityMode v -> el.SetValue(System.Windows.Controls.DataGrid.RowDetailsVisibilityModeProperty, box v)
        | DataGridProp.AreRowDetailsFrozen v -> el.SetValue(System.Windows.Controls.DataGrid.AreRowDetailsFrozenProperty, box v)
        | DataGridProp.RowDetailsTemplate v -> el.SetValue(System.Windows.Controls.DataGrid.RowDetailsTemplateProperty, box v)
        | DataGridProp.RowDetailsTemplateSelector v -> el.SetValue(System.Windows.Controls.DataGrid.RowDetailsTemplateSelectorProperty, box v)
        | DataGridProp.CanUserResizeRows v -> el.SetValue(System.Windows.Controls.DataGrid.CanUserResizeRowsProperty, box v)
        ...
        | DataGridProp.CanUserSortColumns v -> el.SetValue(System.Windows.Controls.DataGrid.CanUserSortColumnsProperty, box v)
        | DataGridProp.AutoGenerateColumns v -> el.SetValue(System.Windows.Controls.DataGrid.AutoGenerateColumnsProperty, box v)
        | DataGridProp.FrozenColumnCount v -> el.SetValue(System.Windows.Controls.DataGrid.FrozenColumnCountProperty, box v)
        | DataGridProp.EnableRowVirtualization v -> el.SetValue(System.Windows.Controls.DataGrid.EnableRowVirtualizationProperty, box v)
        | DataGridProp.EnableColumnVirtualization v -> el.SetValue(System.Windows.Controls.DataGrid.EnableColumnVirtualizationProperty, box v)
        | DataGridProp.CanUserReorderColumns v -> el.SetValue(System.Windows.Controls.DataGrid.CanUserReorderColumnsProperty, box v)
        | DataGridProp.DragIndicatorStyle v -> el.SetValue(System.Windows.Controls.DataGrid.DragIndicatorStyleProperty, box v)
    ...
    let horizontalContentAlignment v : obj = box (ControlProp.HorizontalContentAlignment v)
    let verticalContentAlignment v : obj = box (ControlProp.VerticalContentAlignment v)
    ...
    let onSelectionChanged v : obj = box (EventProp(box (SelectorProp.OnSelectionChanged v)))
    let onPreviewMouseDoubleClick v : obj = box (EventProp(box (ControlProp.OnPreviewMouseDoubleClick v)))
    let onMouseDoubleClick v : obj = box (EventProp(box (ControlProp.OnMouseDoubleClick v)))
    let onRequestBringIntoView v : obj = box (EventProp(box (FrameworkElementProp.OnRequestBringIntoView v)))
    let onSizeChanged v : obj = box (EventProp(box (FrameworkElementProp.OnSizeChanged v)))
    let onLoaded v : obj = box (EventProp(box (FrameworkElementProp.OnLoaded v)))
    let onUnloaded v : obj = box (EventProp(box (FrameworkElementProp.OnUnloaded v)))
    let onToolTipOpening v : obj = box (EventProp(box (FrameworkElementProp.OnToolTipOpening v)))
    let onToolTipClosing v : obj = box (EventProp(box (FrameworkElementProp.OnToolTipClosing v)))
    let onContextMenuOpening v : obj = box (EventProp(box (FrameworkElementProp.OnContextMenuOpening v)))
    let onContextMenuClosing v : obj = box (EventProp(box (FrameworkElementProp.OnContextMenuClosing v)))
