...
type DocumentReferenceProp =
    | Base of FrameworkElementProp
    | Source of System.Uri

module DocumentReference =
    let source v : obj = box (DocumentReferenceProp.Source v)

    let apply (el: System.Windows.Documents.DocumentReference) (prop: DocumentReferenceProp) =
        match prop with
        | DocumentReferenceProp.Base p -> FrameworkElement.apply el p
        | DocumentReferenceProp.Source v -> el.SetValue(System.Windows.Documents.DocumentReference.SourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.DocumentReference>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
