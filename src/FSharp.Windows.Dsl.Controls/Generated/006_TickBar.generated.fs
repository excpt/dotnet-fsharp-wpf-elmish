...
module TickBar =
    ...
    let isSelectionRangeEnabled v : obj =
        box (TickBarProp.IsSelectionRangeEnabled v)
    ...
    let apply (el: System.Windows.Controls.Primitives.TickBar) (prop: TickBarProp) =
        match prop with
        | TickBarProp.Base p -> FrameworkElement.apply el p
        ...
        | TickBarProp.SelectionStart v ->
            el.SetValue(System.Windows.Controls.Primitives.TickBar.SelectionStartProperty, box v)
        | TickBarProp.SelectionEnd v ->
            el.SetValue(System.Windows.Controls.Primitives.TickBar.SelectionEndProperty, box v)
        | TickBarProp.IsSelectionRangeEnabled v ->
            el.SetValue(System.Windows.Controls.Primitives.TickBar.IsSelectionRangeEnabledProperty, box v)
        | TickBarProp.TickFrequency v ->
            el.SetValue(System.Windows.Controls.Primitives.TickBar.TickFrequencyProperty, box v)
        | TickBarProp.Ticks v -> el.SetValue(System.Windows.Controls.Primitives.TickBar.TicksProperty, box v)
        | TickBarProp.IsDirectionReversed v ->
            el.SetValue(System.Windows.Controls.Primitives.TickBar.IsDirectionReversedProperty, box v)
        | TickBarProp.Placement v -> el.SetValue(System.Windows.Controls.Primitives.TickBar.PlacementProperty, box v)
        | TickBarProp.ReservedSpace v ->
            el.SetValue(System.Windows.Controls.Primitives.TickBar.ReservedSpaceProperty, box v)
