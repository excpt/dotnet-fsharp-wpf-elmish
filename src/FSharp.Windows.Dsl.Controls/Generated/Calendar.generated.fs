...
module Calendar =
    let calendarButtonStyle v : obj =
        box (CalendarProp.CalendarButtonStyle v)

    let calendarDayButtonStyle v : obj =
        box (CalendarProp.CalendarDayButtonStyle v)
    ...
    let apply (el: System.Windows.Controls.Calendar) (prop: CalendarProp) =
        ...
        | CalendarProp.CalendarButtonStyle v ->
            el.SetValue(System.Windows.Controls.Calendar.CalendarButtonStyleProperty, box v)
        | CalendarProp.CalendarDayButtonStyle v ->
            el.SetValue(System.Windows.Controls.Calendar.CalendarDayButtonStyleProperty, box v)
        | CalendarProp.CalendarItemStyle v ->
            el.SetValue(System.Windows.Controls.Calendar.CalendarItemStyleProperty, box v)
        ...
        | CalendarProp.DisplayDateStart v ->
            el.SetValue(System.Windows.Controls.Calendar.DisplayDateStartProperty, box v)
        ...
        | CalendarProp.IsTodayHighlighted v ->
            el.SetValue(System.Windows.Controls.Calendar.IsTodayHighlightedProperty, box v)
