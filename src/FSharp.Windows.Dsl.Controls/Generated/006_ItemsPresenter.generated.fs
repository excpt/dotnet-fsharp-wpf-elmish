...
type ItemsPresenterProp =
    | Base of FrameworkElementProp

module ItemsPresenter =

    let apply (el: System.Windows.Controls.ItemsPresenter) (prop: ItemsPresenterProp) =
        match prop with
        | ItemsPresenterProp.Base p -> FrameworkElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.ItemsPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
