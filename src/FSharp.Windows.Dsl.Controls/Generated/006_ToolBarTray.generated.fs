...
module ToolBarTray =
    ...
    let apply (el: System.Windows.Controls.ToolBarTray) (prop: ToolBarTrayProp) =
        match prop with
        | ToolBarTrayProp.Base p -> FrameworkElement.apply el p
    ...
    let isLocked (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(System.Windows.Controls.ToolBarTray.IsLockedProperty, box v)) :: node.Props }
