...
type DataGridColumnHeadersPresenterProp = Base of ItemsControlProp

module DataGridColumnHeadersPresenter =

    let apply
        (el: System.Windows.Controls.Primitives.DataGridColumnHeadersPresenter)
        (prop: DataGridColumnHeadersPresenterProp)
        =
        match prop with
        | DataGridColumnHeadersPresenterProp.Base p -> ItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.DataGridColumnHeadersPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
