...
type GroupBoxProp = Base of HeaderedContentControlProp

module GroupBox =

    let apply (el: System.Windows.Controls.GroupBox) (prop: GroupBoxProp) =
        match prop with
        | GroupBoxProp.Base p -> HeaderedContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.GroupBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
