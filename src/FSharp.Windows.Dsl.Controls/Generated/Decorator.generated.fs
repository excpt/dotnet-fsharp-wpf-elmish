...
module Decorator =
    ...
    let apply (el: System.Windows.Controls.Decorator) (prop: DecoratorProp) =
        match prop with
        | DecoratorProp.Base p -> FrameworkElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Decorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
