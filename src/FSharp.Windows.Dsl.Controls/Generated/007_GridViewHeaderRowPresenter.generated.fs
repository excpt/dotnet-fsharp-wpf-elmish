...
module GridViewHeaderRowPresenter =
    let columnHeaderContainerStyle v : obj =
        box (GridViewHeaderRowPresenterProp.ColumnHeaderContainerStyle v)

    let columnHeaderTemplate v : obj =
        box (GridViewHeaderRowPresenterProp.ColumnHeaderTemplate v)

    let columnHeaderTemplateSelector v : obj =
        box (GridViewHeaderRowPresenterProp.ColumnHeaderTemplateSelector v)

    let columnHeaderStringFormat v : obj =
        box (GridViewHeaderRowPresenterProp.ColumnHeaderStringFormat v)

    let allowsColumnReorder v : obj =
        box (GridViewHeaderRowPresenterProp.AllowsColumnReorder v)

    let columnHeaderContextMenu v : obj =
        box (GridViewHeaderRowPresenterProp.ColumnHeaderContextMenu v)

    let columnHeaderToolTip v : obj =
        box (GridViewHeaderRowPresenterProp.ColumnHeaderToolTip v)
    ...
    let apply (el: System.Windows.Controls.GridViewHeaderRowPresenter) (prop: GridViewHeaderRowPresenterProp) =
        ...
        | GridViewHeaderRowPresenterProp.ColumnHeaderContainerStyle v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.ColumnHeaderContainerStyleProperty, box v)
        | GridViewHeaderRowPresenterProp.ColumnHeaderTemplate v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.ColumnHeaderTemplateProperty, box v)
        | GridViewHeaderRowPresenterProp.ColumnHeaderTemplateSelector v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.ColumnHeaderTemplateSelectorProperty, box v)
        | GridViewHeaderRowPresenterProp.ColumnHeaderStringFormat v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.ColumnHeaderStringFormatProperty, box v)
        | GridViewHeaderRowPresenterProp.AllowsColumnReorder v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.AllowsColumnReorderProperty, box v)
        | GridViewHeaderRowPresenterProp.ColumnHeaderContextMenu v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.ColumnHeaderContextMenuProperty, box v)
        | GridViewHeaderRowPresenterProp.ColumnHeaderToolTip v ->
            el.SetValue(System.Windows.Controls.GridViewHeaderRowPresenter.ColumnHeaderToolTipProperty, box v)

    let columns v : obj =
        box (GridViewRowPresenterBaseProp.Columns v)
