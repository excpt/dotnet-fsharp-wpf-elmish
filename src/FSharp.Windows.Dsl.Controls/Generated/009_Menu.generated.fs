...
module Menu =
    let isMainMenu v : obj = box (MenuProp.IsMainMenu v)

    let apply (el: System.Windows.Controls.Menu) (prop: MenuProp) =
        match prop with
        | MenuProp.Base p -> MenuBase.apply el p
        | MenuProp.IsMainMenu v -> el.SetValue(System.Windows.Controls.Menu.IsMainMenuProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Menu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
