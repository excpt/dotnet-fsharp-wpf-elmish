...
type ListViewProp =
    | Base of ListBoxProp
    | View of System.Windows.Controls.ViewBase

module ListView =
    let view v : obj = box (ListViewProp.View v)

    let apply (el: System.Windows.Controls.ListView) (prop: ListViewProp) =
        match prop with
        | ListViewProp.Base p -> ListBox.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.ListView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
