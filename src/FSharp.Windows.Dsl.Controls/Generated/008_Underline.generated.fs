...
type UnderlineProp = Base of InlineProp

module Underline =

    let apply (el: System.Windows.Documents.Underline) (prop: UnderlineProp) =
        match prop with
        | UnderlineProp.Base p -> Inline.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.Underline>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
