...
module UniformGrid =
    ...
    let apply (el: System.Windows.Controls.Primitives.UniformGrid) (prop: UniformGridProp) =
        ...
        | UniformGridProp.FirstColumn v ->
            el.SetValue(System.Windows.Controls.Primitives.UniformGrid.FirstColumnProperty, box v)
        | UniformGridProp.Columns v ->
            el.SetValue(System.Windows.Controls.Primitives.UniformGrid.ColumnsProperty, box v)
