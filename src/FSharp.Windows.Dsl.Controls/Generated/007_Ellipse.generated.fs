...
type EllipseProp = Base of ShapeProp

module Ellipse =

    let apply (el: System.Windows.Shapes.Ellipse) (prop: EllipseProp) =
        match prop with
        | EllipseProp.Base p -> Shape.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Shapes.Ellipse>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
