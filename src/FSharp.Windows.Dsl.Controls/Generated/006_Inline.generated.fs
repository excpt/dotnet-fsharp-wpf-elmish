...
type InlineProp =
    ...
    | BaselineAlignment of System.Windows.BaselineAlignment
...
module Inline =
    ...
    let apply (el: System.Windows.Documents.Inline) (prop: InlineProp) =
        match prop with
        | InlineProp.Base p -> TextElement.apply el p
        | InlineProp.BaselineAlignment v ->
            el.SetValue(System.Windows.Documents.Inline.BaselineAlignmentProperty, box v)
        | InlineProp.TextDecorations v -> el.SetValue(System.Windows.Documents.Inline.TextDecorationsProperty, box v)
        | InlineProp.FlowDirection v -> el.SetValue(System.Windows.Documents.Inline.FlowDirectionProperty, box v)
    ...
    let siblingInlines (cs: VirtualNode list) : obj =
        box (CollectionProp("SiblingInlines", cs))
