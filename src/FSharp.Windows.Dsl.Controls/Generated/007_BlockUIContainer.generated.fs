...
type BlockUIContainerProp = Base of BlockProp

module BlockUIContainer =

    let apply (el: System.Windows.Documents.BlockUIContainer) (prop: BlockUIContainerProp) =
        match prop with
        | BlockUIContainerProp.Base p -> Block.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.BlockUIContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
