...
module FlowDocumentReader =
    let viewingMode v : obj =
        box (FlowDocumentReaderProp.ViewingMode v)

    let isPageViewEnabled v : obj =
        box (FlowDocumentReaderProp.IsPageViewEnabled v)

    let isTwoPageViewEnabled v : obj =
        box (FlowDocumentReaderProp.IsTwoPageViewEnabled v)

    let isScrollViewEnabled v : obj =
        box (FlowDocumentReaderProp.IsScrollViewEnabled v)

    let isFindEnabled v : obj =
        box (FlowDocumentReaderProp.IsFindEnabled v)

    let isPrintEnabled v : obj =
        box (FlowDocumentReaderProp.IsPrintEnabled v)
    ...
    let zoomIncrement v : obj =
        box (FlowDocumentReaderProp.ZoomIncrement v)

    let selectionBrush v : obj =
        box (FlowDocumentReaderProp.SelectionBrush v)

    let selectionOpacity v : obj =
        box (FlowDocumentReaderProp.SelectionOpacity v)

    let isSelectionActive v : obj =
        box (FlowDocumentReaderProp.IsSelectionActive v)

    let isInactiveSelectionHighlightEnabled v : obj =
        box (FlowDocumentReaderProp.IsInactiveSelectionHighlightEnabled v)

    let apply (el: System.Windows.Controls.FlowDocumentReader) (prop: FlowDocumentReaderProp) =
        match prop with
        | FlowDocumentReaderProp.Base p -> Control.apply el p
        | FlowDocumentReaderProp.ViewingMode v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.ViewingModeProperty, box v)
        | FlowDocumentReaderProp.IsPageViewEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsPageViewEnabledProperty, box v)
        | FlowDocumentReaderProp.IsTwoPageViewEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsTwoPageViewEnabledProperty, box v)
        | FlowDocumentReaderProp.IsScrollViewEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsScrollViewEnabledProperty, box v)
        | FlowDocumentReaderProp.IsFindEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsFindEnabledProperty, box v)
        | FlowDocumentReaderProp.IsPrintEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsPrintEnabledProperty, box v)
        | FlowDocumentReaderProp.Document v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.DocumentProperty, box v)
        | FlowDocumentReaderProp.Zoom v -> el.SetValue(System.Windows.Controls.FlowDocumentReader.ZoomProperty, box v)
        | FlowDocumentReaderProp.MaxZoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.MaxZoomProperty, box v)
        | FlowDocumentReaderProp.MinZoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.MinZoomProperty, box v)
        | FlowDocumentReaderProp.ZoomIncrement v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.ZoomIncrementProperty, box v)
        | FlowDocumentReaderProp.SelectionBrush v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.SelectionBrushProperty, box v)
        | FlowDocumentReaderProp.SelectionOpacity v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.SelectionOpacityProperty, box v)
        | FlowDocumentReaderProp.IsSelectionActive v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsSelectionActiveProperty, box v)
        | FlowDocumentReaderProp.IsInactiveSelectionHighlightEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentReader.IsInactiveSelectionHighlightEnabledProperty, box v)
