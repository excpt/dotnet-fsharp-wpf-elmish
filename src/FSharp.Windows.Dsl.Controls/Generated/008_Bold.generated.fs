...
type BoldProp = Base of InlineProp

module Bold =

    let apply (el: System.Windows.Documents.Bold) (prop: BoldProp) =
        match prop with
        | BoldProp.Base p -> Inline.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.Bold>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
