...
type SpanProp = Base of InlineProp

module Span =

    let apply (el: System.Windows.Documents.Span) (prop: SpanProp) =
        match prop with
        | SpanProp.Base p -> Inline.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.Span>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
