...
module GridViewRowPresenterBase =
    ...
    let apply (el: System.Windows.Controls.Primitives.GridViewRowPresenterBase) (prop: GridViewRowPresenterBaseProp) =
        match prop with
        | GridViewRowPresenterBaseProp.Base p -> FrameworkElement.apply el p
        | GridViewRowPresenterBaseProp.Columns v ->
            el.SetValue(System.Windows.Controls.Primitives.GridViewRowPresenterBase.ColumnsProperty, box v)
