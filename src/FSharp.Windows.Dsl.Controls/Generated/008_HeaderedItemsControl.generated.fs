...
module HeaderedItemsControl =
    ...
    let apply (el: System.Windows.Controls.HeaderedItemsControl) (prop: HeaderedItemsControlProp) =
        ...
        | HeaderedItemsControlProp.Header v ->
            el.SetValue(System.Windows.Controls.HeaderedItemsControl.HeaderProperty, box v)
        | HeaderedItemsControlProp.HeaderTemplate v ->
            el.SetValue(System.Windows.Controls.HeaderedItemsControl.HeaderTemplateProperty, box v)
        | HeaderedItemsControlProp.HeaderTemplateSelector v ->
            el.SetValue(System.Windows.Controls.HeaderedItemsControl.HeaderTemplateSelectorProperty, box v)
        | HeaderedItemsControlProp.HeaderStringFormat v ->
            el.SetValue(System.Windows.Controls.HeaderedItemsControl.HeaderStringFormatProperty, box v)
