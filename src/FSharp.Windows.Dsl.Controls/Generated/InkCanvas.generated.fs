...
module InkCanvas =
    ...
    let onStrokeCollected v : obj = box (EventProp(box (InkCanvasProp.OnStrokeCollected v)))
    let onGesture v : obj = box (EventProp(box (InkCanvasProp.OnGesture v)))
    let onActiveEditingModeChanged v : obj = box (EventProp(box (InkCanvasProp.OnActiveEditingModeChanged v)))
    let onEditingModeChanged v : obj = box (EventProp(box (InkCanvasProp.OnEditingModeChanged v)))
    let onEditingModeInvertedChanged v : obj = box (EventProp(box (InkCanvasProp.OnEditingModeInvertedChanged v)))
    let onStrokeErased v : obj = box (EventProp(box (InkCanvasProp.OnStrokeErased v)))
