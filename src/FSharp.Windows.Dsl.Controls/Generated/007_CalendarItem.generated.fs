...
type CalendarItemProp = Base of ControlProp

module CalendarItem =

    let apply (el: System.Windows.Controls.Primitives.CalendarItem) (prop: CalendarItemProp) =
        match prop with
        | CalendarItemProp.Base p -> Control.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.CalendarItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
