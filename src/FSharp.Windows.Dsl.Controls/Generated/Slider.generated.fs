...
module Slider =
    ...
    let isSelectionRangeEnabled v : obj =
        box (SliderProp.IsSelectionRangeEnabled v)
    ...
    let apply (el: System.Windows.Controls.Slider) (prop: SliderProp) =
        ...
        | SliderProp.IsDirectionReversed v ->
            el.SetValue(System.Windows.Controls.Slider.IsDirectionReversedProperty, box v)
        ...
        | SliderProp.AutoToolTipPlacement v ->
            el.SetValue(System.Windows.Controls.Slider.AutoToolTipPlacementProperty, box v)
        | SliderProp.AutoToolTipPrecision v ->
            el.SetValue(System.Windows.Controls.Slider.AutoToolTipPrecisionProperty, box v)
        | SliderProp.IsSnapToTickEnabled v ->
            el.SetValue(System.Windows.Controls.Slider.IsSnapToTickEnabledProperty, box v)
        ...
        | SliderProp.IsSelectionRangeEnabled v ->
            el.SetValue(System.Windows.Controls.Slider.IsSelectionRangeEnabledProperty, box v)
        ...
        | SliderProp.IsMoveToPointEnabled v ->
            el.SetValue(System.Windows.Controls.Slider.IsMoveToPointEnabledProperty, box v)
