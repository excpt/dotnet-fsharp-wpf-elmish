...
module MenuBase =
    ...
    let apply (el: System.Windows.Controls.Primitives.MenuBase) (prop: MenuBaseProp) =
        ...
        | MenuBaseProp.ItemContainerTemplateSelector v -> el.SetValue(System.Windows.Controls.Primitives.MenuBase.ItemContainerTemplateSelectorProperty, box v)
        | MenuBaseProp.UsesItemContainerTemplate v -> el.SetValue(System.Windows.Controls.Primitives.MenuBase.UsesItemContainerTemplateProperty, box v)
