...
type DataGridCellsPanelProp =
    | Base of VirtualizingPanelProp

module DataGridCellsPanel =

    let apply (el: System.Windows.Controls.DataGridCellsPanel) (prop: DataGridCellsPanelProp) =
        match prop with
        | DataGridCellsPanelProp.Base p -> VirtualizingPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.DataGridCellsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
