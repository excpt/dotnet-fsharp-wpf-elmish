...
module DataGridRow =
    ...
    let headerTemplateSelector v : obj =
        box (DataGridRowProp.HeaderTemplateSelector v)

    let validationErrorTemplate v : obj =
        box (DataGridRowProp.ValidationErrorTemplate v)

    let detailsTemplate v : obj = box (DataGridRowProp.DetailsTemplate v)

    let detailsTemplateSelector v : obj =
        box (DataGridRowProp.DetailsTemplateSelector v)

    let detailsVisibility v : obj =
        box (DataGridRowProp.DetailsVisibility v)

    let alternationIndex v : obj =
        box (DataGridRowProp.AlternationIndex v)

    let isSelected v : obj = box (DataGridRowProp.IsSelected v)

    let onSelected v : obj =
        box (EventProp(box (DataGridRowProp.OnSelected v)))

    let onUnselected v : obj =
        box (EventProp(box (DataGridRowProp.OnUnselected v)))

    let apply (el: System.Windows.Controls.DataGridRow) (prop: DataGridRowProp) =
        match prop with
        | DataGridRowProp.Base p -> Control.apply el p
        ...
        | DataGridRowProp.HeaderTemplate v ->
            el.SetValue(System.Windows.Controls.DataGridRow.HeaderTemplateProperty, box v)
        | DataGridRowProp.HeaderTemplateSelector v ->
            el.SetValue(System.Windows.Controls.DataGridRow.HeaderTemplateSelectorProperty, box v)
        | DataGridRowProp.ValidationErrorTemplate v ->
            el.SetValue(System.Windows.Controls.DataGridRow.ValidationErrorTemplateProperty, box v)
        | DataGridRowProp.DetailsTemplate v ->
            el.SetValue(System.Windows.Controls.DataGridRow.DetailsTemplateProperty, box v)
        | DataGridRowProp.DetailsTemplateSelector v ->
            el.SetValue(System.Windows.Controls.DataGridRow.DetailsTemplateSelectorProperty, box v)
        | DataGridRowProp.DetailsVisibility v ->
            el.SetValue(System.Windows.Controls.DataGridRow.DetailsVisibilityProperty, box v)
        | DataGridRowProp.AlternationIndex v ->
            el.SetValue(System.Windows.Controls.DataGridRow.AlternationIndexProperty, box v)
