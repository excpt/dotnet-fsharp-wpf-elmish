...
module TreeViewItem =
    ...
    let onExpanded v : obj = box (EventProp(box (TreeViewItemProp.OnExpanded v)))
    let onCollapsed v : obj = box (EventProp(box (TreeViewItemProp.OnCollapsed v)))
    let onSelected v : obj = box (EventProp(box (TreeViewItemProp.OnSelected v)))
    let onUnselected v : obj = box (EventProp(box (TreeViewItemProp.OnUnselected v)))
