...
module ToolBarOverflowPanel =
    let wrapWidth v : obj =
        box (ToolBarOverflowPanelProp.WrapWidth v)
    ...
    let apply (el: System.Windows.Controls.Primitives.ToolBarOverflowPanel) (prop: ToolBarOverflowPanelProp) =
        ...
        | ToolBarOverflowPanelProp.WrapWidth v ->
            el.SetValue(System.Windows.Controls.Primitives.ToolBarOverflowPanel.WrapWidthProperty, box v)
