...
type ToolBarOverflowPanelProp =
    | Base of PanelProp
    | WrapWidth of float

module ToolBarOverflowPanel =
    let wrapWidth v : obj = box (ToolBarOverflowPanelProp.WrapWidth v)

    let apply (el: System.Windows.Controls.Primitives.ToolBarOverflowPanel) (prop: ToolBarOverflowPanelProp) =
        match prop with
        | ToolBarOverflowPanelProp.Base p -> Panel.apply el p
        | ToolBarOverflowPanelProp.WrapWidth v -> el.SetValue(System.Windows.Controls.Primitives.ToolBarOverflowPanel.WrapWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.ToolBarOverflowPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
