...
type ComboBoxItemProp = Base of ListBoxItemProp

module ComboBoxItem =

    let apply (el: System.Windows.Controls.ComboBoxItem) (prop: ComboBoxItemProp) =
        match prop with
        | ComboBoxItemProp.Base p -> ListBoxItem.apply el p
    ...
    let onSelected v : obj =
        box (EventProp(box (ListBoxItemProp.OnSelected v)))

    let onUnselected v : obj =
        box (EventProp(box (ListBoxItemProp.OnUnselected v)))
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.ComboBoxItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
