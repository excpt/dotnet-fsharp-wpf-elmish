...
module AnchoredBlock =
    ...
    let apply (el: System.Windows.Documents.AnchoredBlock) (prop: AnchoredBlockProp) =
        match prop with
        | AnchoredBlockProp.Base p -> Inline.apply el p
        | AnchoredBlockProp.Margin v -> el.SetValue(System.Windows.Documents.AnchoredBlock.MarginProperty, box v)
        | AnchoredBlockProp.Padding v -> el.SetValue(System.Windows.Documents.AnchoredBlock.PaddingProperty, box v)
        | AnchoredBlockProp.BorderThickness v ->
            el.SetValue(System.Windows.Documents.AnchoredBlock.BorderThicknessProperty, box v)
        | AnchoredBlockProp.BorderBrush v ->
            el.SetValue(System.Windows.Documents.AnchoredBlock.BorderBrushProperty, box v)
        | AnchoredBlockProp.TextAlignment v ->
            el.SetValue(System.Windows.Documents.AnchoredBlock.TextAlignmentProperty, box v)
        | AnchoredBlockProp.LineHeight v ->
            el.SetValue(System.Windows.Documents.AnchoredBlock.LineHeightProperty, box v)
        | AnchoredBlockProp.LineStackingStrategy v ->
            el.SetValue(System.Windows.Documents.AnchoredBlock.LineStackingStrategyProperty, box v)
