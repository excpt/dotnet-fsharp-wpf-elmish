...
module RadioButton =
    let groupName v : obj = box (RadioButtonProp.GroupName v)

    let apply (el: System.Windows.Controls.RadioButton) (prop: RadioButtonProp) =
        match prop with
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.RadioButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
