...
type VirtualizingPanelProp =
    | Base of PanelProp

module VirtualizingPanel =

    let apply (el: System.Windows.Controls.VirtualizingPanel) (prop: VirtualizingPanelProp) =
        match prop with
        | VirtualizingPanelProp.Base p -> Panel.apply el p
    ...
    let scrollUnit (v: System.Windows.Controls.ScrollUnit) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(System.Windows.Controls.VirtualizingPanel.ScrollUnitProperty, box v)) :: node.Props }
    let cacheLength (v: System.Windows.Controls.VirtualizationCacheLength) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(System.Windows.Controls.VirtualizingPanel.CacheLengthProperty, box v)) :: node.Props }
    let cacheLengthUnit (v: System.Windows.Controls.VirtualizationCacheLengthUnit) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(System.Windows.Controls.VirtualizingPanel.CacheLengthUnitProperty, box v)) :: node.Props }
    let isContainerVirtualizable (v: bool) (node: VirtualNode) : VirtualNode =
