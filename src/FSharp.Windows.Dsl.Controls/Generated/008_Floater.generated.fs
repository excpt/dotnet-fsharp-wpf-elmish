...
module Floater =
    let horizontalAlignment v : obj = box (FloaterProp.HorizontalAlignment v)
    let width v : obj = box (FloaterProp.Width v)

    let apply (el: System.Windows.Documents.Floater) (prop: FloaterProp) =
        match prop with
        | FloaterProp.Base p -> AnchoredBlock.apply el p
        | FloaterProp.HorizontalAlignment v ->
            el.SetValue(System.Windows.Documents.Floater.HorizontalAlignmentProperty, box v)
        | FloaterProp.Width v -> el.SetValue(System.Windows.Documents.Floater.WidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.Floater>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
