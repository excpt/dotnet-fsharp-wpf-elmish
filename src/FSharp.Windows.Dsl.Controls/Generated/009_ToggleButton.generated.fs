...
module ToggleButton =
    ...
    let onChecked v : obj =
        box (EventProp(box (ToggleButtonProp.OnChecked v)))

    let onUnchecked v : obj =
        box (EventProp(box (ToggleButtonProp.OnUnchecked v)))

    let onIndeterminate v : obj =
        box (EventProp(box (ToggleButtonProp.OnIndeterminate v)))
    ...
    let apply (el: System.Windows.Controls.Primitives.ToggleButton) (prop: ToggleButtonProp) =
        ...
        | ToggleButtonProp.IsChecked v ->
            el.SetValue(System.Windows.Controls.Primitives.ToggleButton.IsCheckedProperty, box v)
        | ToggleButtonProp.IsThreeState v ->
            el.SetValue(System.Windows.Controls.Primitives.ToggleButton.IsThreeStateProperty, box v)
