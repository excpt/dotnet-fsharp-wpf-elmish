...
module FlowDocumentPageViewer =
    ...
    let maxZoom v : obj =
        box (FlowDocumentPageViewerProp.MaxZoom v)

    let minZoom v : obj =
        box (FlowDocumentPageViewerProp.MinZoom v)

    let zoomIncrement v : obj =
        box (FlowDocumentPageViewerProp.ZoomIncrement v)

    let selectionBrush v : obj =
        box (FlowDocumentPageViewerProp.SelectionBrush v)

    let selectionOpacity v : obj =
        box (FlowDocumentPageViewerProp.SelectionOpacity v)

    let isSelectionActive v : obj =
        box (FlowDocumentPageViewerProp.IsSelectionActive v)

    let isInactiveSelectionHighlightEnabled v : obj =
        box (FlowDocumentPageViewerProp.IsInactiveSelectionHighlightEnabled v)
    ...
    let apply (el: System.Windows.Controls.FlowDocumentPageViewer) (prop: FlowDocumentPageViewerProp) =
        ...
        | FlowDocumentPageViewerProp.Zoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.ZoomProperty, box v)
        | FlowDocumentPageViewerProp.MaxZoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.MaxZoomProperty, box v)
        | FlowDocumentPageViewerProp.MinZoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.MinZoomProperty, box v)
        | FlowDocumentPageViewerProp.ZoomIncrement v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.ZoomIncrementProperty, box v)
        | FlowDocumentPageViewerProp.SelectionBrush v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.SelectionBrushProperty, box v)
        | FlowDocumentPageViewerProp.SelectionOpacity v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.SelectionOpacityProperty, box v)
        | FlowDocumentPageViewerProp.IsSelectionActive v ->
            el.SetValue(System.Windows.Controls.FlowDocumentPageViewer.IsSelectionActiveProperty, box v)
        | FlowDocumentPageViewerProp.IsInactiveSelectionHighlightEnabled v ->
            el.SetValue(
    ...
    let onPageViewsChanged v : obj =
        box (EventProp(box (DocumentViewerBaseProp.OnPageViewsChanged v)))
