...
type UserControlProp = Base of ContentControlProp

module UserControl =

    let apply (el: System.Windows.Controls.UserControl) (prop: UserControlProp) =
        match prop with
        | UserControlProp.Base p -> ContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.UserControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
