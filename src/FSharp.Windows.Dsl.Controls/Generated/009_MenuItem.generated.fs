...
module MenuItem =
    ...
    let itemContainerTemplateSelector v : obj =
        box (MenuItemProp.ItemContainerTemplateSelector v)

    let usesItemContainerTemplate v : obj =
        box (MenuItemProp.UsesItemContainerTemplate v)

    let onClick v : obj =
        box (EventProp(box (MenuItemProp.OnClick v)))

    let onChecked v : obj =
        box (EventProp(box (MenuItemProp.OnChecked v)))

    let onUnchecked v : obj =
        box (EventProp(box (MenuItemProp.OnUnchecked v)))

    let onSubmenuOpened v : obj =
        box (EventProp(box (MenuItemProp.OnSubmenuOpened v)))

    let onSubmenuClosed v : obj =
        box (EventProp(box (MenuItemProp.OnSubmenuClosed v)))
    ...
    let apply (el: System.Windows.Controls.MenuItem) (prop: MenuItemProp) =
        ...
        | MenuItemProp.CommandParameter v ->
            el.SetValue(System.Windows.Controls.MenuItem.CommandParameterProperty, box v)
        ...
        | MenuItemProp.StaysOpenOnClick v ->
            el.SetValue(System.Windows.Controls.MenuItem.StaysOpenOnClickProperty, box v)
        | MenuItemProp.InputGestureText v ->
            el.SetValue(System.Windows.Controls.MenuItem.InputGestureTextProperty, box v)
        | MenuItemProp.Icon v -> el.SetValue(System.Windows.Controls.MenuItem.IconProperty, box v)
        | MenuItemProp.ItemContainerTemplateSelector v ->
            el.SetValue(System.Windows.Controls.MenuItem.ItemContainerTemplateSelectorProperty, box v)
        | MenuItemProp.UsesItemContainerTemplate v ->
            el.SetValue(System.Windows.Controls.MenuItem.UsesItemContainerTemplateProperty, box v)
    ...
    let headerTemplate v : obj =
        box (HeaderedItemsControlProp.HeaderTemplate v)

    let headerTemplateSelector v : obj =
        box (HeaderedItemsControlProp.HeaderTemplateSelector v)

    let headerStringFormat v : obj =
        box (HeaderedItemsControlProp.HeaderStringFormat v)
