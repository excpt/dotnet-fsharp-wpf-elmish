...
module StackPanel =
    ...
    let apply (el: System.Windows.Controls.StackPanel) (prop: StackPanelProp) =
        match prop with
        | StackPanelProp.Base p -> Panel.apply el p
        | StackPanelProp.Orientation v -> el.SetValue(System.Windows.Controls.StackPanel.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.StackPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
