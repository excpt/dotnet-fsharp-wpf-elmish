...
module GridSplitter =
    let resizeDirection v : obj =
        box (GridSplitterProp.ResizeDirection v)
    ...
    let keyboardIncrement v : obj =
        box (GridSplitterProp.KeyboardIncrement v)
    ...
    let apply (el: System.Windows.Controls.GridSplitter) (prop: GridSplitterProp) =
        ...
        | GridSplitterProp.ResizeDirection v ->
            el.SetValue(System.Windows.Controls.GridSplitter.ResizeDirectionProperty, box v)
        | GridSplitterProp.ResizeBehavior v ->
            el.SetValue(System.Windows.Controls.GridSplitter.ResizeBehaviorProperty, box v)
        | GridSplitterProp.ShowsPreview v ->
            el.SetValue(System.Windows.Controls.GridSplitter.ShowsPreviewProperty, box v)
        | GridSplitterProp.PreviewStyle v ->
            el.SetValue(System.Windows.Controls.GridSplitter.PreviewStyleProperty, box v)
        | GridSplitterProp.KeyboardIncrement v ->
            el.SetValue(System.Windows.Controls.GridSplitter.KeyboardIncrementProperty, box v)
        | GridSplitterProp.DragIncrement v ->
            el.SetValue(System.Windows.Controls.GridSplitter.DragIncrementProperty, box v)
    ...
    let onDragStarted v : obj =
        box (EventProp(box (ThumbProp.OnDragStarted v)))

    let onDragDelta v : obj =
        box (EventProp(box (ThumbProp.OnDragDelta v)))

    let onDragCompleted v : obj =
        box (EventProp(box (ThumbProp.OnDragCompleted v)))
