...
module UIElement =
    ...
    let apply (el: System.Windows.UIElement) (prop: UIElementProp) =
        ...
        | UIElementProp.RenderTransformOrigin v -> el.SetValue(System.Windows.UIElement.RenderTransformOriginProperty, box v)
        ...
        | UIElementProp.SnapsToDevicePixels v -> el.SetValue(System.Windows.UIElement.SnapsToDevicePixelsProperty, box v)
        ...
        | UIElementProp.IsManipulationEnabled v -> el.SetValue(System.Windows.UIElement.IsManipulationEnabledProperty, box v)
