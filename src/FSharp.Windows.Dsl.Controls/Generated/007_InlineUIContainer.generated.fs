...
type InlineUIContainerProp = Base of InlineProp

module InlineUIContainer =

    let apply (el: System.Windows.Documents.InlineUIContainer) (prop: InlineUIContainerProp) =
        match prop with
        | InlineUIContainerProp.Base p -> Inline.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.InlineUIContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
