...
type GroupItemProp = Base of ContentControlProp

module GroupItem =

    let apply (el: System.Windows.Controls.GroupItem) (prop: GroupItemProp) =
        match prop with
        | GroupItemProp.Base p -> ContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.GroupItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
