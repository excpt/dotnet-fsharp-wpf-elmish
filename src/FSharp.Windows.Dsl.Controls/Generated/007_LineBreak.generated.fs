...
type LineBreakProp = Base of InlineProp

module LineBreak =

    let apply (el: System.Windows.Documents.LineBreak) (prop: LineBreakProp) =
        match prop with
        | LineBreakProp.Base p -> Inline.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.LineBreak>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
