...
module DocumentViewer =
    let horizontalOffset v : obj =
        box (DocumentViewerProp.HorizontalOffset v)

    let verticalOffset v : obj =
        box (DocumentViewerProp.VerticalOffset v)

    let showPageBorders v : obj =
        box (DocumentViewerProp.ShowPageBorders v)

    let zoom v : obj = box (DocumentViewerProp.Zoom v)

    let maxPagesAcross v : obj =
        box (DocumentViewerProp.MaxPagesAcross v)

    let verticalPageSpacing v : obj =
        box (DocumentViewerProp.VerticalPageSpacing v)

    let horizontalPageSpacing v : obj =
        box (DocumentViewerProp.HorizontalPageSpacing v)
    ...
    let apply (el: System.Windows.Controls.DocumentViewer) (prop: DocumentViewerProp) =
        ...
        | DocumentViewerProp.HorizontalOffset v ->
            el.SetValue(System.Windows.Controls.DocumentViewer.HorizontalOffsetProperty, box v)
        | DocumentViewerProp.VerticalOffset v ->
            el.SetValue(System.Windows.Controls.DocumentViewer.VerticalOffsetProperty, box v)
        | DocumentViewerProp.ShowPageBorders v ->
            el.SetValue(System.Windows.Controls.DocumentViewer.ShowPageBordersProperty, box v)
        | DocumentViewerProp.Zoom v -> el.SetValue(System.Windows.Controls.DocumentViewer.ZoomProperty, box v)
        | DocumentViewerProp.MaxPagesAcross v ->
            el.SetValue(System.Windows.Controls.DocumentViewer.MaxPagesAcrossProperty, box v)
        | DocumentViewerProp.VerticalPageSpacing v ->
            el.SetValue(System.Windows.Controls.DocumentViewer.VerticalPageSpacingProperty, box v)
        | DocumentViewerProp.HorizontalPageSpacing v ->
            el.SetValue(System.Windows.Controls.DocumentViewer.HorizontalPageSpacingProperty, box v)
