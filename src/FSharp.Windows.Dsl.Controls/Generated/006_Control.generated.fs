...
module Control =
    ...
    let apply (el: System.Windows.Controls.Control) (prop: ControlProp) =
        ...
        | ControlProp.HorizontalContentAlignment v -> el.SetValue(System.Windows.Controls.Control.HorizontalContentAlignmentProperty, box v)
        | ControlProp.VerticalContentAlignment v -> el.SetValue(System.Windows.Controls.Control.VerticalContentAlignmentProperty, box v)
