...
module GridViewRowPresenter =
    let content v : obj =
        box (GridViewRowPresenterProp.Content v)
    ...
    let apply (el: System.Windows.Controls.GridViewRowPresenter) (prop: GridViewRowPresenterProp) =
        ...
        | GridViewRowPresenterProp.Content v ->
            el.SetValue(System.Windows.Controls.GridViewRowPresenter.ContentProperty, box v)
