...
module TableCell =
    let padding v : obj = box (TableCellProp.Padding v)
    let borderThickness v : obj = box (TableCellProp.BorderThickness v)
    let borderBrush v : obj = box (TableCellProp.BorderBrush v)
    let textAlignment v : obj = box (TableCellProp.TextAlignment v)
    let flowDirection v : obj = box (TableCellProp.FlowDirection v)
    let lineHeight v : obj = box (TableCellProp.LineHeight v)

    let lineStackingStrategy v : obj =
        box (TableCellProp.LineStackingStrategy v)

    let columnSpan v : obj = box (TableCellProp.ColumnSpan v)
    let rowSpan v : obj = box (TableCellProp.RowSpan v)

    let apply (el: System.Windows.Documents.TableCell) (prop: TableCellProp) =
        match prop with
        | TableCellProp.Base p -> TextElement.apply el p
        | TableCellProp.Padding v -> el.SetValue(System.Windows.Documents.TableCell.PaddingProperty, box v)
        | TableCellProp.BorderThickness v ->
            el.SetValue(System.Windows.Documents.TableCell.BorderThicknessProperty, box v)
        | TableCellProp.BorderBrush v -> el.SetValue(System.Windows.Documents.TableCell.BorderBrushProperty, box v)
        | TableCellProp.TextAlignment v -> el.SetValue(System.Windows.Documents.TableCell.TextAlignmentProperty, box v)
        | TableCellProp.FlowDirection v -> el.SetValue(System.Windows.Documents.TableCell.FlowDirectionProperty, box v)
        | TableCellProp.LineHeight v -> el.SetValue(System.Windows.Documents.TableCell.LineHeightProperty, box v)
        | TableCellProp.LineStackingStrategy v ->
            el.SetValue(System.Windows.Documents.TableCell.LineStackingStrategyProperty, box v)
        | TableCellProp.ColumnSpan v -> el.SetValue(System.Windows.Documents.TableCell.ColumnSpanProperty, box v)
        | TableCellProp.RowSpan v -> el.SetValue(System.Windows.Documents.TableCell.RowSpanProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.TableCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
