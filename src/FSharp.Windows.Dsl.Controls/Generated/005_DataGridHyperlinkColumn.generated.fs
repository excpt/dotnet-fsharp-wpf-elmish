...
type DataGridHyperlinkColumnProp =
    | Base of DataGridBoundColumnProp
    | TargetName of string

module DataGridHyperlinkColumn =
    let targetName v : obj =
        box (DataGridHyperlinkColumnProp.TargetName v)

    let apply (el: System.Windows.Controls.DataGridHyperlinkColumn) (prop: DataGridHyperlinkColumnProp) =
        match prop with
        | DataGridHyperlinkColumnProp.Base p -> DataGridBoundColumn.apply el p
        | DataGridHyperlinkColumnProp.TargetName v ->
            el.SetValue(System.Windows.Controls.DataGridHyperlinkColumn.TargetNameProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.DataGridHyperlinkColumn>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
