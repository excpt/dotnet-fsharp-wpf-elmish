...
module TabControl =
    let tabStripPlacement v : obj =
        box (TabControlProp.TabStripPlacement v)

    let contentTemplate v : obj = box (TabControlProp.ContentTemplate v)

    let contentTemplateSelector v : obj =
        box (TabControlProp.ContentTemplateSelector v)

    let contentStringFormat v : obj =
        box (TabControlProp.ContentStringFormat v)

    let apply (el: System.Windows.Controls.TabControl) (prop: TabControlProp) =
        match prop with
        | TabControlProp.Base p -> Selector.apply el p
        | TabControlProp.TabStripPlacement v ->
            el.SetValue(System.Windows.Controls.TabControl.TabStripPlacementProperty, box v)
        | TabControlProp.ContentTemplate v ->
            el.SetValue(System.Windows.Controls.TabControl.ContentTemplateProperty, box v)
        | TabControlProp.ContentTemplateSelector v ->
            el.SetValue(System.Windows.Controls.TabControl.ContentTemplateSelectorProperty, box v)
        | TabControlProp.ContentStringFormat v ->
            el.SetValue(System.Windows.Controls.TabControl.ContentStringFormatProperty, box v)
