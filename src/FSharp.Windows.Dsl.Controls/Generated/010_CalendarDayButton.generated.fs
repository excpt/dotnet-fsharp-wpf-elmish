...
type CalendarDayButtonProp = Base of ButtonProp

module CalendarDayButton =

    let apply (el: System.Windows.Controls.Primitives.CalendarDayButton) (prop: CalendarDayButtonProp) =
        match prop with
        | CalendarDayButtonProp.Base p -> Button.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.CalendarDayButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
