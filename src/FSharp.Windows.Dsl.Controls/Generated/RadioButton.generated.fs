...
module RadioButton =
    ...
    let onChecked v : obj = box (EventProp(box (ToggleButtonProp.OnChecked v)))
    let onUnchecked v : obj = box (EventProp(box (ToggleButtonProp.OnUnchecked v)))
    let onIndeterminate v : obj = box (EventProp(box (ToggleButtonProp.OnIndeterminate v)))
