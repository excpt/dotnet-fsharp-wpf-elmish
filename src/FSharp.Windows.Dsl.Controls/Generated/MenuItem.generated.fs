...
module MenuItem =
    ...
    let onClick v : obj = box (EventProp(box (MenuItemProp.OnClick v)))
    let onChecked v : obj = box (EventProp(box (MenuItemProp.OnChecked v)))
    let onUnchecked v : obj = box (EventProp(box (MenuItemProp.OnUnchecked v)))
    let onSubmenuOpened v : obj = box (EventProp(box (MenuItemProp.OnSubmenuOpened v)))
    let onSubmenuClosed v : obj = box (EventProp(box (MenuItemProp.OnSubmenuClosed v)))
