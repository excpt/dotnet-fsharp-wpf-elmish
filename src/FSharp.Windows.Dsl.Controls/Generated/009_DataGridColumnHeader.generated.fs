...
type DataGridColumnHeaderProp =
    | Base of ButtonBaseProp
    | SeparatorBrush of System.Windows.Media.Brush
    | SeparatorVisibility of System.Windows.Visibility

module DataGridColumnHeader =
    let separatorBrush v : obj =
        box (DataGridColumnHeaderProp.SeparatorBrush v)

    let separatorVisibility v : obj =
        box (DataGridColumnHeaderProp.SeparatorVisibility v)

    let apply (el: System.Windows.Controls.Primitives.DataGridColumnHeader) (prop: DataGridColumnHeaderProp) =
        match prop with
        | DataGridColumnHeaderProp.Base p -> ButtonBase.apply el p
        | DataGridColumnHeaderProp.SeparatorBrush v ->
            el.SetValue(System.Windows.Controls.Primitives.DataGridColumnHeader.SeparatorBrushProperty, box v)
        | DataGridColumnHeaderProp.SeparatorVisibility v ->
            el.SetValue(System.Windows.Controls.Primitives.DataGridColumnHeader.SeparatorVisibilityProperty, box v)
    ...
    let onClick v : obj =
        box (EventProp(box (ButtonBaseProp.OnClick v)))
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.DataGridColumnHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
