...
module ContentPresenter =
    let recognizesAccessKey v : obj =
        box (ContentPresenterProp.RecognizesAccessKey v)

    let content v : obj = box (ContentPresenterProp.Content v)

    let contentTemplate v : obj =
        box (ContentPresenterProp.ContentTemplate v)

    let contentTemplateSelector v : obj =
        box (ContentPresenterProp.ContentTemplateSelector v)

    let contentStringFormat v : obj =
        box (ContentPresenterProp.ContentStringFormat v)

    let contentSource v : obj =
        box (ContentPresenterProp.ContentSource v)

    let apply (el: System.Windows.Controls.ContentPresenter) (prop: ContentPresenterProp) =
        match prop with
        | ContentPresenterProp.Base p -> FrameworkElement.apply el p
        | ContentPresenterProp.RecognizesAccessKey v ->
            el.SetValue(System.Windows.Controls.ContentPresenter.RecognizesAccessKeyProperty, box v)
        | ContentPresenterProp.Content v -> el.SetValue(System.Windows.Controls.ContentPresenter.ContentProperty, box v)
        | ContentPresenterProp.ContentTemplate v ->
            el.SetValue(System.Windows.Controls.ContentPresenter.ContentTemplateProperty, box v)
        | ContentPresenterProp.ContentTemplateSelector v ->
            el.SetValue(System.Windows.Controls.ContentPresenter.ContentTemplateSelectorProperty, box v)
        | ContentPresenterProp.ContentStringFormat v ->
            el.SetValue(System.Windows.Controls.ContentPresenter.ContentStringFormatProperty, box v)
        | ContentPresenterProp.ContentSource v ->
            el.SetValue(System.Windows.Controls.ContentPresenter.ContentSourceProperty, box v)
