...
module TextBoxBase =
    ...
    let isReadOnlyCaretVisible v : obj =
        box (TextBoxBaseProp.IsReadOnlyCaretVisible v)
    ...
    let horizontalScrollBarVisibility v : obj =
        box (TextBoxBaseProp.HorizontalScrollBarVisibility v)

    let verticalScrollBarVisibility v : obj =
        box (TextBoxBaseProp.VerticalScrollBarVisibility v)

    let isUndoEnabled v : obj = box (TextBoxBaseProp.IsUndoEnabled v)
    let undoLimit v : obj = box (TextBoxBaseProp.UndoLimit v)

    let autoWordSelection v : obj =
        box (TextBoxBaseProp.AutoWordSelection v)
    ...
    let isInactiveSelectionHighlightEnabled v : obj =
        box (TextBoxBaseProp.IsInactiveSelectionHighlightEnabled v)

    let onTextChanged v : obj =
        box (EventProp(box (TextBoxBaseProp.OnTextChanged v)))
    ...
    let apply (el: System.Windows.Controls.Primitives.TextBoxBase) (prop: TextBoxBaseProp) =
        match prop with
        | TextBoxBaseProp.Base p -> Control.apply el p
        | TextBoxBaseProp.IsReadOnly v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.IsReadOnlyProperty, box v)
        | TextBoxBaseProp.IsReadOnlyCaretVisible v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.IsReadOnlyCaretVisibleProperty, box v)
        | TextBoxBaseProp.AcceptsReturn v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.AcceptsReturnProperty, box v)
        | TextBoxBaseProp.AcceptsTab v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.AcceptsTabProperty, box v)
        | TextBoxBaseProp.HorizontalScrollBarVisibility v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.HorizontalScrollBarVisibilityProperty, box v)
        | TextBoxBaseProp.VerticalScrollBarVisibility v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.VerticalScrollBarVisibilityProperty, box v)
        | TextBoxBaseProp.IsUndoEnabled v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.IsUndoEnabledProperty, box v)
        | TextBoxBaseProp.UndoLimit v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.UndoLimitProperty, box v)
        | TextBoxBaseProp.AutoWordSelection v ->
        ...
        | TextBoxBaseProp.CaretBrush v ->
            el.SetValue(System.Windows.Controls.Primitives.TextBoxBase.CaretBrushProperty, box v)
        | TextBoxBaseProp.IsInactiveSelectionHighlightEnabled v ->
            el.SetValue(
