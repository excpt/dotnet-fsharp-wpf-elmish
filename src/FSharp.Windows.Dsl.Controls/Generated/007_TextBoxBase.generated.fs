...
module TextBoxBase =
    ...
    let onTextChanged v : obj = box (EventProp(box (TextBoxBaseProp.OnTextChanged v)))
    let onSelectionChanged v : obj = box (EventProp(box (TextBoxBaseProp.OnSelectionChanged v)))
