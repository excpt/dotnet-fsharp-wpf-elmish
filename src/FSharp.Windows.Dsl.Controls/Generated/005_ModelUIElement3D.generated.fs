...
type ModelUIElement3DProp =
    | Base of UIElement3DProp
    | Model of System.Windows.Media.Media3D.Model3D

module ModelUIElement3D =
    let model v : obj = box (ModelUIElement3DProp.Model v)

    let apply (el: System.Windows.Media.Media3D.ModelUIElement3D) (prop: ModelUIElement3DProp) =
        match prop with
        | ModelUIElement3DProp.Base p -> UIElement3D.apply el p
        | ModelUIElement3DProp.Model v ->
            el.SetValue(System.Windows.Media.Media3D.ModelUIElement3D.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Media.Media3D.ModelUIElement3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
