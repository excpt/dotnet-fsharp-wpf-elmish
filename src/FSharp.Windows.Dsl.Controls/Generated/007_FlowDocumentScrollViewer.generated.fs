...
module FlowDocumentScrollViewer =
    let document v : obj =
        box (FlowDocumentScrollViewerProp.Document v)

    let zoom v : obj =
        box (FlowDocumentScrollViewerProp.Zoom v)

    let maxZoom v : obj =
        box (FlowDocumentScrollViewerProp.MaxZoom v)

    let minZoom v : obj =
        box (FlowDocumentScrollViewerProp.MinZoom v)

    let zoomIncrement v : obj =
        box (FlowDocumentScrollViewerProp.ZoomIncrement v)

    let isSelectionEnabled v : obj =
        box (FlowDocumentScrollViewerProp.IsSelectionEnabled v)

    let isToolBarVisible v : obj =
        box (FlowDocumentScrollViewerProp.IsToolBarVisible v)

    let horizontalScrollBarVisibility v : obj =
        box (FlowDocumentScrollViewerProp.HorizontalScrollBarVisibility v)

    let verticalScrollBarVisibility v : obj =
        box (FlowDocumentScrollViewerProp.VerticalScrollBarVisibility v)

    let selectionBrush v : obj =
        box (FlowDocumentScrollViewerProp.SelectionBrush v)

    let selectionOpacity v : obj =
        box (FlowDocumentScrollViewerProp.SelectionOpacity v)

    let isSelectionActive v : obj =
        box (FlowDocumentScrollViewerProp.IsSelectionActive v)

    let isInactiveSelectionHighlightEnabled v : obj =
        box (FlowDocumentScrollViewerProp.IsInactiveSelectionHighlightEnabled v)

    let apply (el: System.Windows.Controls.FlowDocumentScrollViewer) (prop: FlowDocumentScrollViewerProp) =
        match prop with
        | FlowDocumentScrollViewerProp.Base p -> Control.apply el p
        | FlowDocumentScrollViewerProp.Document v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.DocumentProperty, box v)
        | FlowDocumentScrollViewerProp.Zoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.ZoomProperty, box v)
        | FlowDocumentScrollViewerProp.MaxZoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.MaxZoomProperty, box v)
        | FlowDocumentScrollViewerProp.MinZoom v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.MinZoomProperty, box v)
        | FlowDocumentScrollViewerProp.ZoomIncrement v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.ZoomIncrementProperty, box v)
        | FlowDocumentScrollViewerProp.IsSelectionEnabled v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.IsSelectionEnabledProperty, box v)
        | FlowDocumentScrollViewerProp.IsToolBarVisible v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.IsToolBarVisibleProperty, box v)
        | FlowDocumentScrollViewerProp.HorizontalScrollBarVisibility v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.HorizontalScrollBarVisibilityProperty, box v)
        | FlowDocumentScrollViewerProp.VerticalScrollBarVisibility v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.VerticalScrollBarVisibilityProperty, box v)
        | FlowDocumentScrollViewerProp.SelectionBrush v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.SelectionBrushProperty, box v)
        | FlowDocumentScrollViewerProp.SelectionOpacity v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.SelectionOpacityProperty, box v)
        | FlowDocumentScrollViewerProp.IsSelectionActive v ->
            el.SetValue(System.Windows.Controls.FlowDocumentScrollViewer.IsSelectionActiveProperty, box v)
        | FlowDocumentScrollViewerProp.IsInactiveSelectionHighlightEnabled v ->
            el.SetValue(
