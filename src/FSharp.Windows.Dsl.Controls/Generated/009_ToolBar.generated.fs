...
module ToolBar =
    ...
    let overflowMode (v: System.Windows.Controls.OverflowMode) (node: VirtualNode) : VirtualNode =
        { node with
            Props =
                box (AttachedProp(System.Windows.Controls.ToolBar.OverflowModeProperty, box v))
                :: node.Props }
