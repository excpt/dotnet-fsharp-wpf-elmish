...
module ScrollContentPresenter =
    let canContentScroll v : obj =
        box (ScrollContentPresenterProp.CanContentScroll v)
    ...
    let apply (el: System.Windows.Controls.ScrollContentPresenter) (prop: ScrollContentPresenterProp) =
        ...
        | ScrollContentPresenterProp.CanContentScroll v ->
            el.SetValue(System.Windows.Controls.ScrollContentPresenter.CanContentScrollProperty, box v)
