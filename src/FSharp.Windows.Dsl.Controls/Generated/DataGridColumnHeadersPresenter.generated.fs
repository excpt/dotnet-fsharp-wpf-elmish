...
type DataGridColumnHeadersPresenterProp =
    | Base of ItemsControlProp

module DataGridColumnHeadersPresenter =

    let apply (el: System.Windows.Controls.Primitives.DataGridColumnHeadersPresenter) (prop: DataGridColumnHeadersPresenterProp) =
        match prop with
