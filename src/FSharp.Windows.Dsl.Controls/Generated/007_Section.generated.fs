...
type SectionProp = Base of BlockProp

module Section =

    let apply (el: System.Windows.Documents.Section) (prop: SectionProp) =
        match prop with
        | SectionProp.Base p -> Block.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.Section>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
