...
type AdornerLayerProp =
    | Base of FrameworkElementProp

module AdornerLayer =

    let apply (el: System.Windows.Documents.AdornerLayer) (prop: AdornerLayerProp) =
        match prop with
        | AdornerLayerProp.Base p -> FrameworkElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.AdornerLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
