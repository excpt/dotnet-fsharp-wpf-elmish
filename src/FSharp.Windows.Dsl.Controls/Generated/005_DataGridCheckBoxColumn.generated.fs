...
type DataGridCheckBoxColumnProp =
    | Base of DataGridBoundColumnProp
    | IsThreeState of bool

module DataGridCheckBoxColumn =
    let isThreeState v : obj =
        box (DataGridCheckBoxColumnProp.IsThreeState v)

    let apply (el: System.Windows.Controls.DataGridCheckBoxColumn) (prop: DataGridCheckBoxColumnProp) =
        match prop with
        | DataGridCheckBoxColumnProp.Base p -> DataGridBoundColumn.apply el p
        | DataGridCheckBoxColumnProp.IsThreeState v ->
            el.SetValue(System.Windows.Controls.DataGridCheckBoxColumn.IsThreeStateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.DataGridCheckBoxColumn>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
