...
type DataGridCellsPresenterProp = Base of ItemsControlProp

module DataGridCellsPresenter =

    let apply (el: System.Windows.Controls.Primitives.DataGridCellsPresenter) (prop: DataGridCellsPresenterProp) =
        match prop with
        | DataGridCellsPresenterProp.Base p -> ItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Controls.Primitives.DataGridCellsPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
