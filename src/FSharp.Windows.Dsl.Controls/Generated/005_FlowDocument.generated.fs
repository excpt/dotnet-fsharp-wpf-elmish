...
type FlowDocumentProp =
    | Base of FrameworkContentElementProp
    ...
    | FlowDirection of System.Windows.FlowDirection
    | LineHeight of float
    | LineStackingStrategy of System.Windows.LineStackingStrategy
    | ColumnWidth of float
    | ColumnGap of float
    | IsColumnWidthFlexible of bool
    | ColumnRuleWidth of float
    | ColumnRuleBrush of System.Windows.Media.Brush
    | IsOptimalParagraphEnabled of bool
    | PageWidth of float
    | MinPageWidth of float
    | MaxPageWidth of float
    | PageHeight of float
    | MinPageHeight of float
    | MaxPageHeight of float
    | PagePadding of System.Windows.Thickness
    | IsHyphenationEnabled of bool

module FlowDocument =
    let fontFamily v : obj = box (FlowDocumentProp.FontFamily v)
    let fontStyle v : obj = box (FlowDocumentProp.FontStyle v)
    let fontWeight v : obj = box (FlowDocumentProp.FontWeight v)
    let fontStretch v : obj = box (FlowDocumentProp.FontStretch v)
    let fontSize v : obj = box (FlowDocumentProp.FontSize v)
    let foreground v : obj = box (FlowDocumentProp.Foreground v)
    let background v : obj = box (FlowDocumentProp.Background v)
    let textEffects v : obj = box (FlowDocumentProp.TextEffects v)
    let textAlignment v : obj = box (FlowDocumentProp.TextAlignment v)
    let flowDirection v : obj = box (FlowDocumentProp.FlowDirection v)
    let lineHeight v : obj = box (FlowDocumentProp.LineHeight v)

    let lineStackingStrategy v : obj =
        box (FlowDocumentProp.LineStackingStrategy v)

    let columnWidth v : obj = box (FlowDocumentProp.ColumnWidth v)
    let columnGap v : obj = box (FlowDocumentProp.ColumnGap v)

    let isColumnWidthFlexible v : obj =
        box (FlowDocumentProp.IsColumnWidthFlexible v)

    let columnRuleWidth v : obj =
        box (FlowDocumentProp.ColumnRuleWidth v)

    let columnRuleBrush v : obj =
        box (FlowDocumentProp.ColumnRuleBrush v)

    let isOptimalParagraphEnabled v : obj =
        box (FlowDocumentProp.IsOptimalParagraphEnabled v)

    let pageWidth v : obj = box (FlowDocumentProp.PageWidth v)
    let minPageWidth v : obj = box (FlowDocumentProp.MinPageWidth v)
    let maxPageWidth v : obj = box (FlowDocumentProp.MaxPageWidth v)
    let pageHeight v : obj = box (FlowDocumentProp.PageHeight v)
    let minPageHeight v : obj = box (FlowDocumentProp.MinPageHeight v)
    let maxPageHeight v : obj = box (FlowDocumentProp.MaxPageHeight v)
    let pagePadding v : obj = box (FlowDocumentProp.PagePadding v)

    let isHyphenationEnabled v : obj =
        box (FlowDocumentProp.IsHyphenationEnabled v)

    let apply (el: System.Windows.Documents.FlowDocument) (prop: FlowDocumentProp) =
        match prop with
        | FlowDocumentProp.Base p -> FrameworkContentElement.apply el p
        | FlowDocumentProp.FontFamily v -> el.SetValue(System.Windows.Documents.FlowDocument.FontFamilyProperty, box v)
        | FlowDocumentProp.FontStyle v -> el.SetValue(System.Windows.Documents.FlowDocument.FontStyleProperty, box v)
        | FlowDocumentProp.FontWeight v -> el.SetValue(System.Windows.Documents.FlowDocument.FontWeightProperty, box v)
        | FlowDocumentProp.FontStretch v ->
            el.SetValue(System.Windows.Documents.FlowDocument.FontStretchProperty, box v)
        | FlowDocumentProp.FontSize v -> el.SetValue(System.Windows.Documents.FlowDocument.FontSizeProperty, box v)
        | FlowDocumentProp.Foreground v -> el.SetValue(System.Windows.Documents.FlowDocument.ForegroundProperty, box v)
        | FlowDocumentProp.Background v -> el.SetValue(System.Windows.Documents.FlowDocument.BackgroundProperty, box v)
        | FlowDocumentProp.TextEffects v ->
            el.SetValue(System.Windows.Documents.FlowDocument.TextEffectsProperty, box v)
        | FlowDocumentProp.TextAlignment v ->
            el.SetValue(System.Windows.Documents.FlowDocument.TextAlignmentProperty, box v)
        | FlowDocumentProp.FlowDirection v ->
            el.SetValue(System.Windows.Documents.FlowDocument.FlowDirectionProperty, box v)
        | FlowDocumentProp.LineHeight v -> el.SetValue(System.Windows.Documents.FlowDocument.LineHeightProperty, box v)
        | FlowDocumentProp.LineStackingStrategy v ->
            el.SetValue(System.Windows.Documents.FlowDocument.LineStackingStrategyProperty, box v)
        | FlowDocumentProp.ColumnWidth v ->
            el.SetValue(System.Windows.Documents.FlowDocument.ColumnWidthProperty, box v)
        | FlowDocumentProp.ColumnGap v -> el.SetValue(System.Windows.Documents.FlowDocument.ColumnGapProperty, box v)
        | FlowDocumentProp.IsColumnWidthFlexible v ->
            el.SetValue(System.Windows.Documents.FlowDocument.IsColumnWidthFlexibleProperty, box v)
        | FlowDocumentProp.ColumnRuleWidth v ->
            el.SetValue(System.Windows.Documents.FlowDocument.ColumnRuleWidthProperty, box v)
        | FlowDocumentProp.ColumnRuleBrush v ->
            el.SetValue(System.Windows.Documents.FlowDocument.ColumnRuleBrushProperty, box v)
        | FlowDocumentProp.IsOptimalParagraphEnabled v ->
            el.SetValue(System.Windows.Documents.FlowDocument.IsOptimalParagraphEnabledProperty, box v)
        | FlowDocumentProp.PageWidth v -> el.SetValue(System.Windows.Documents.FlowDocument.PageWidthProperty, box v)
        | FlowDocumentProp.MinPageWidth v ->
            el.SetValue(System.Windows.Documents.FlowDocument.MinPageWidthProperty, box v)
        | FlowDocumentProp.MaxPageWidth v ->
            el.SetValue(System.Windows.Documents.FlowDocument.MaxPageWidthProperty, box v)
        | FlowDocumentProp.PageHeight v -> el.SetValue(System.Windows.Documents.FlowDocument.PageHeightProperty, box v)
        | FlowDocumentProp.MinPageHeight v ->
            el.SetValue(System.Windows.Documents.FlowDocument.MinPageHeightProperty, box v)
        | FlowDocumentProp.MaxPageHeight v ->
            el.SetValue(System.Windows.Documents.FlowDocument.MaxPageHeightProperty, box v)
        | FlowDocumentProp.PagePadding v ->
            el.SetValue(System.Windows.Documents.FlowDocument.PagePaddingProperty, box v)
        | FlowDocumentProp.IsHyphenationEnabled v ->
            el.SetValue(System.Windows.Documents.FlowDocument.IsHyphenationEnabledProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<System.Windows.Documents.FlowDocument>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
