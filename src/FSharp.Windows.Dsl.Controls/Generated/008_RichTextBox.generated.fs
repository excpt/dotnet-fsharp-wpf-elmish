...
module RichTextBox =
    let isDocumentEnabled v : obj =
        box (RichTextBoxProp.IsDocumentEnabled v)

    let apply (el: System.Windows.Controls.RichTextBox) (prop: RichTextBoxProp) =
        match prop with
        | RichTextBoxProp.Base p -> TextBoxBase.apply el p
        | RichTextBoxProp.IsDocumentEnabled v ->
            el.SetValue(System.Windows.Controls.RichTextBox.IsDocumentEnabledProperty, box v)
