...
open System
open System.Windows
open DevExpress.Xpf.Navigation
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TileNavPaneProp =
    ...
    | NavButtonsSource of System.Collections.IEnumerable
    | NavButtonTemplate of System.Windows.DataTemplate
    | NavButtonTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | NavButtonStyle of System.Windows.Style
    | SelectedElement of DevExpress.Xpf.Navigation.NavElementBase
    | GroupHeaderTemplate of System.Windows.DataTemplate
    | GroupHeaderStyle of System.Windows.Style
    | ContinuousNavigation of bool
    | CloseOnOuterClick of bool
    | FlyoutShowMode of DevExpress.Xpf.Navigation.FlyoutShowMode
    | FlyoutShowDirection of DevExpress.Xpf.Navigation.FlyoutShowDirection
    | ShowItemShadow of bool

module TileNavPane =
    let categoriesSource v : obj = box (TileNavPaneProp.CategoriesSource v)
    let categoryTemplate v : obj = box (TileNavPaneProp.CategoryTemplate v)
    let categoryTemplateSelector v : obj = box (TileNavPaneProp.CategoryTemplateSelector v)
    let categoryStyle v : obj = box (TileNavPaneProp.CategoryStyle v)
    let navButtonsSource v : obj = box (TileNavPaneProp.NavButtonsSource v)
    let navButtonTemplate v : obj = box (TileNavPaneProp.NavButtonTemplate v)
    let navButtonTemplateSelector v : obj = box (TileNavPaneProp.NavButtonTemplateSelector v)
    let navButtonStyle v : obj = box (TileNavPaneProp.NavButtonStyle v)
    let selectedElement v : obj = box (TileNavPaneProp.SelectedElement v)
    let groupHeaderTemplate v : obj = box (TileNavPaneProp.GroupHeaderTemplate v)
    let groupHeaderStyle v : obj = box (TileNavPaneProp.GroupHeaderStyle v)
    let continuousNavigation v : obj = box (TileNavPaneProp.ContinuousNavigation v)
    let closeOnOuterClick v : obj = box (TileNavPaneProp.CloseOnOuterClick v)
    let flyoutShowMode v : obj = box (TileNavPaneProp.FlyoutShowMode v)
    let flyoutShowDirection v : obj = box (TileNavPaneProp.FlyoutShowDirection v)
    let showItemShadow v : obj = box (TileNavPaneProp.ShowItemShadow v)

    let apply (el: DevExpress.Xpf.Navigation.TileNavPane) (prop: TileNavPaneProp) =
        match prop with
        | TileNavPaneProp.CategoriesSource v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.CategoriesSourceProperty, box v)
        | TileNavPaneProp.CategoryTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.CategoryTemplateProperty, box v)
        | TileNavPaneProp.CategoryTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.CategoryTemplateSelectorProperty, box v)
        | TileNavPaneProp.CategoryStyle v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.CategoryStyleProperty, box v)
        | TileNavPaneProp.NavButtonsSource v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.NavButtonsSourceProperty, box v)
        | TileNavPaneProp.NavButtonTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.NavButtonTemplateProperty, box v)
        | TileNavPaneProp.NavButtonTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.NavButtonTemplateSelectorProperty, box v)
        | TileNavPaneProp.NavButtonStyle v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.NavButtonStyleProperty, box v)
        | TileNavPaneProp.SelectedElement v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.SelectedElementProperty, box v)
        | TileNavPaneProp.GroupHeaderTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.GroupHeaderTemplateProperty, box v)
        | TileNavPaneProp.GroupHeaderStyle v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.GroupHeaderStyleProperty, box v)
        | TileNavPaneProp.ContinuousNavigation v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.ContinuousNavigationProperty, box v)
        | TileNavPaneProp.CloseOnOuterClick v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.CloseOnOuterClickProperty, box v)
        | TileNavPaneProp.FlyoutShowMode v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.FlyoutShowModeProperty, box v)
        | TileNavPaneProp.FlyoutShowDirection v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.FlyoutShowDirectionProperty, box v)
        | TileNavPaneProp.ShowItemShadow v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavPane.ShowItemShadowProperty, box v)
    ...
    let tileNavGroupHeader (v: obj) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Navigation.TileNavPane.TileNavGroupHeaderProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Navigation.TileNavPane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
