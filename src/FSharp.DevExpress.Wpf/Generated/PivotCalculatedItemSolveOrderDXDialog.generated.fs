...
open System
open System.Windows
open DevExpress.Xpf.Spreadsheet.Forms
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type PivotCalculatedItemSolveOrderDXDialogProp =
    | Base of CustomDXDialogProp

module PivotCalculatedItemSolveOrderDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotCalculatedItemSolveOrderDXDialog) (prop: PivotCalculatedItemSolveOrderDXDialogProp) =
        match prop with
        | PivotCalculatedItemSolveOrderDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotCalculatedItemSolveOrderDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
