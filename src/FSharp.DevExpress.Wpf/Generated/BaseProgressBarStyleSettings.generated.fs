...
type BaseProgressBarStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp
    | AccelerateRatio of float

module BaseProgressBarStyleSettings =
    let accelerateRatio v : obj = box (BaseProgressBarStyleSettingsProp.AccelerateRatio v)

    let apply (el: DevExpress.Xpf.Editors.BaseProgressBarStyleSettings) (prop: BaseProgressBarStyleSettingsProp) =
        match prop with
        | BaseProgressBarStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
        | BaseProgressBarStyleSettingsProp.AccelerateRatio v -> el.SetValue(DevExpress.Xpf.Editors.BaseProgressBarStyleSettings.AccelerateRatioProperty, box v)
