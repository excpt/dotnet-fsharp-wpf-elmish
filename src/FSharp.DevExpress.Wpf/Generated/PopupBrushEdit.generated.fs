...
type PopupBrushEditProp =
    | Base of PopupBrushEditBaseProp

module PopupBrushEdit =

    let apply (el: DevExpress.Xpf.PropertyGrid.PopupBrushEdit) (prop: PopupBrushEditProp) =
        match prop with
        | PopupBrushEditProp.Base p -> PopupBrushEditBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PopupBrushEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
