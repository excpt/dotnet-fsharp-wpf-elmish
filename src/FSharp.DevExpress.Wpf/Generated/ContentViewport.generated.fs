...
type ContentViewportProp =
    | MaxHorizontalIndent of float
    | MaxVerticalIndent of float
    ...
    | KeepPositiveLeftContentPosition of bool
    | UseWholeRow of bool

module ContentViewport =
    let maxHorizontalIndent v : obj = box (ContentViewportProp.MaxHorizontalIndent v)
    let maxVerticalIndent v : obj = box (ContentViewportProp.MaxVerticalIndent v)
    let horizontalContentAlignment v : obj = box (ContentViewportProp.HorizontalContentAlignment v)
    let verticalContentAlignment v : obj = box (ContentViewportProp.VerticalContentAlignment v)
    let keepPositiveLeftContentPosition v : obj = box (ContentViewportProp.KeepPositiveLeftContentPosition v)
    let useWholeRow v : obj = box (ContentViewportProp.UseWholeRow v)

    let apply (el: DevExpress.Xpf.Bars.ContentViewport) (prop: ContentViewportProp) =
        match prop with
        | ContentViewportProp.MaxHorizontalIndent v -> el.SetValue(DevExpress.Xpf.Bars.ContentViewport.MaxHorizontalIndentProperty, box v)
        | ContentViewportProp.MaxVerticalIndent v -> el.SetValue(DevExpress.Xpf.Bars.ContentViewport.MaxVerticalIndentProperty, box v)
        | ContentViewportProp.HorizontalContentAlignment v -> el.SetValue(DevExpress.Xpf.Bars.ContentViewport.HorizontalContentAlignmentProperty, box v)
        | ContentViewportProp.VerticalContentAlignment v -> el.SetValue(DevExpress.Xpf.Bars.ContentViewport.VerticalContentAlignmentProperty, box v)
        | ContentViewportProp.KeepPositiveLeftContentPosition v -> el.SetValue(DevExpress.Xpf.Bars.ContentViewport.KeepPositiveLeftContentPositionProperty, box v)
        | ContentViewportProp.UseWholeRow v -> el.SetValue(DevExpress.Xpf.Bars.ContentViewport.UseWholeRowProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.ContentViewport>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
