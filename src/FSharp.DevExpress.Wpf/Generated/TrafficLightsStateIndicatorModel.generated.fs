...
type TrafficLightsStateIndicatorModelProp =
    | Base of StateIndicatorModelProp

module TrafficLightsStateIndicatorModel =

    let apply (el: DevExpress.Xpf.Gauges.TrafficLightsStateIndicatorModel) (prop: TrafficLightsStateIndicatorModelProp) =
        match prop with
        | TrafficLightsStateIndicatorModelProp.Base p -> StateIndicatorModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.TrafficLightsStateIndicatorModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
