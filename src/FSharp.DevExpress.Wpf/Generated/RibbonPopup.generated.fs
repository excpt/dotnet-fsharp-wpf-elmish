...
type RibbonPopupProp =
    | Base of RibbonPopupBaseProp

module RibbonPopup =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPopup) (prop: RibbonPopupProp) =
        match prop with
        | RibbonPopupProp.Base p -> RibbonPopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
