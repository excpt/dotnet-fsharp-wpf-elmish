...
type PlusMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module PlusMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.PlusMarkerModelControl) (prop: PlusMarkerModelControlProp) =
        match prop with
        | PlusMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.PlusMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
