...
type ChartDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module ChartDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.ChartDashboardLayoutItem) (prop: ChartDashboardLayoutItemProp) =
        match prop with
        | ChartDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let diagramStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.DiagramStyleProperty, box v)) :: node.Props }
    let legendStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.LegendStyleProperty, box v)) :: node.Props }
    let axisXStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.AxisXStyleProperty, box v)) :: node.Props }
    let secondaryAxisYStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.SecondaryAxisYStyleProperty, box v)) :: node.Props }
    let barSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.BarSeriesStyleProperty, box v)) :: node.Props }
    let barStackedSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.BarStackedSeriesStyleProperty, box v)) :: node.Props }
    let pointSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.PointSeriesStyleProperty, box v)) :: node.Props }
    let lineSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.LineSeriesStyleProperty, box v)) :: node.Props }
    let areaSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.AreaSeriesStyleProperty, box v)) :: node.Props }
    let stackedAreaSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.StackedAreaSeriesStyleProperty, box v)) :: node.Props }
    let rangeAreaSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.RangeAreaSeriesStyleProperty, box v)) :: node.Props }
    let rangeBarSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.RangeBarSeriesStyleProperty, box v)) :: node.Props }
    let bubbleSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.BubbleSeriesStyleProperty, box v)) :: node.Props }
    let stockSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.StockSeriesStyleProperty, box v)) :: node.Props }
    let candleStickSeriesStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.ChartDashboardLayoutItem.CandleStickSeriesStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.DashboardWpf.ChartDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
