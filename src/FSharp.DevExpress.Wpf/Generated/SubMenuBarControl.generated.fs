...
type SubMenuBarControlProp =
    | Base of LinksControlProp
    | Popup of DevExpress.Xpf.Bars.PopupMenuBase
    | ContentSideVisibility of System.Windows.Visibility
    | GlyphSideVisibility of System.Windows.Visibility
    | GlyphSidePanelWidth of float
    | MenuHeaderStatesHolder of DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControlStatesResourceHolder

module SubMenuBarControl =
    ...
    let apply (el: DevExpress.Xpf.Bars.SubMenuBarControl) (prop: SubMenuBarControlProp) =
        match prop with
        | SubMenuBarControlProp.Base p -> LinksControl.apply el p
        | SubMenuBarControlProp.Popup v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuBarControl.PopupProperty, box v)
        | SubMenuBarControlProp.ContentSideVisibility v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuBarControl.ContentSideVisibilityProperty, box v)
        | SubMenuBarControlProp.GlyphSideVisibility v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuBarControl.GlyphSideVisibilityProperty, box v)
        | SubMenuBarControlProp.GlyphSidePanelWidth v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuBarControl.GlyphSidePanelWidthProperty, box v)
        | SubMenuBarControlProp.MenuHeaderStatesHolder v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuBarControl.MenuHeaderStatesHolderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.SubMenuBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
