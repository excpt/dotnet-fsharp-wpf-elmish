...
type CircularRedClockQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularRedClockQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularRedClockQuarterTopRightModel) (prop: CircularRedClockQuarterTopRightModelProp) =
        match prop with
        | CircularRedClockQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularRedClockQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
