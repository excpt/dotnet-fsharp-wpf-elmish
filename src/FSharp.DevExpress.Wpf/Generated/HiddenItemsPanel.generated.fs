...
type HiddenItemsPanelProp =
    | Base of psvControlProp

module HiddenItemsPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.HiddenItemsPanel) (prop: HiddenItemsPanelProp) =
        match prop with
        | HiddenItemsPanelProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.HiddenItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
