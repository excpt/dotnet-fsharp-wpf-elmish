...
type SeriesLabelPresentationProp =
    | Base of SeriesLabelPresentationBaseProp

module SeriesLabelPresentation =

    let apply (el: DevExpress.Xpf.Charts.SeriesLabelPresentation) (prop: SeriesLabelPresentationProp) =
        match prop with
        | SeriesLabelPresentationProp.Base p -> SeriesLabelPresentationBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
