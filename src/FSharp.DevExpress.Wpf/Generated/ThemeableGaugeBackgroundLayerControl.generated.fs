...
type ThemeableGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableGaugeBackgroundLayerControl =
    let themeFill v : obj = box (ThemeableGaugeBackgroundLayerControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableGaugeBackgroundLayerControl) (prop: ThemeableGaugeBackgroundLayerControlProp) =
        match prop with
        | ThemeableGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
        | ThemeableGaugeBackgroundLayerControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableGaugeBackgroundLayerControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
