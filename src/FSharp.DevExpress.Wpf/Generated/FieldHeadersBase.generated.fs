...
type FieldHeadersBaseProp =
    | Area of DevExpress.Xpf.PivotGrid.FieldListArea
    | ActualArea of DevExpress.Xpf.PivotGrid.Internal.FieldListActualArea
    | ItemsSource of obj
    | EnableDragDrop of bool
    | EnableHeaderMenu of bool
    | PivotGrid of DevExpress.Xpf.PivotGrid.PivotGridControl
    | ShowListSource of bool

module FieldHeadersBase =
    let area v : obj = box (FieldHeadersBaseProp.Area v)
    let actualArea v : obj = box (FieldHeadersBaseProp.ActualArea v)
    let itemsSource v : obj = box (FieldHeadersBaseProp.ItemsSource v)
    ...
    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase) (prop: FieldHeadersBaseProp) =
        match prop with
        | FieldHeadersBaseProp.Area v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.AreaProperty, box v)
        | FieldHeadersBaseProp.ActualArea v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.ActualAreaProperty, box v)
        | FieldHeadersBaseProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.ItemsSourceProperty, box v)
        | FieldHeadersBaseProp.EnableDragDrop v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.EnableDragDropProperty, box v)
        | FieldHeadersBaseProp.EnableHeaderMenu v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.EnableHeaderMenuProperty, box v)
        | FieldHeadersBaseProp.PivotGrid v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.PivotGridProperty, box v)
        | FieldHeadersBaseProp.ShowListSource v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.ShowListSourceProperty, box v)
    ...
    let fieldListArea (v: DevExpress.Xpf.PivotGrid.FieldListArea) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.FieldListAreaProperty, box v)) :: node.Props }
    let dropPlace (v: DevExpress.Xpf.Core.DropPlace) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.PivotGrid.Internal.FieldHeadersBase.DropPlaceProperty, box v)) :: node.Props }
