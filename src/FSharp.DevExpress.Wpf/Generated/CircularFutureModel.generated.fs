...
type CircularFutureModelProp =
    | Base of CircularGaugeModelProp

module CircularFutureModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFutureModel) (prop: CircularFutureModelProp) =
        match prop with
        | CircularFutureModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFutureModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
