...
type FilterPanelControlProp =
    | Base of FilterPanelControlBaseProp

module FilterPanelControl =

    let apply (el: DevExpress.Xpf.PivotGrid.FilterPanelControl) (prop: FilterPanelControlProp) =
        match prop with
        | FilterPanelControlProp.Base p -> FilterPanelControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.FilterPanelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
