...
type ProgressiveArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveArcScaleBackgroundLayerControl) (prop: ProgressiveArcScaleBackgroundLayerControlProp) =
        match prop with
        | ProgressiveArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
