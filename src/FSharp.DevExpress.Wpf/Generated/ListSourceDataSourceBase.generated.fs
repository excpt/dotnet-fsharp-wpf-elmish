...
type ListSourceDataSourceBaseProp =
    | Base of DataSourceBaseProp

module ListSourceDataSourceBase =

    let apply (el: DevExpress.Xpf.Core.DataSources.ListSourceDataSourceBase) (prop: ListSourceDataSourceBaseProp) =
        match prop with
        | ListSourceDataSourceBaseProp.Base p -> DataSourceBase.apply el p
