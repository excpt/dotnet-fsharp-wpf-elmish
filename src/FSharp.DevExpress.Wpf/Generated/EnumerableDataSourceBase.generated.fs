...
type EnumerableDataSourceBaseProp =
    | Base of DataSourceBaseProp

module EnumerableDataSourceBase =

    let apply (el: DevExpress.Xpf.Core.DataSources.EnumerableDataSourceBase) (prop: EnumerableDataSourceBaseProp) =
        match prop with
        | EnumerableDataSourceBaseProp.Base p -> DataSourceBase.apply el p
