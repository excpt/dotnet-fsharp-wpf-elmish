...
type PixelSnappedUniformGridProp =
    | Base of SchedulerPanelProp
    | Orientation of System.Windows.Controls.Orientation

module PixelSnappedUniformGrid =
    let orientation v : obj = box (PixelSnappedUniformGridProp.Orientation v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.PixelSnappedUniformGrid) (prop: PixelSnappedUniformGridProp) =
        match prop with
        | PixelSnappedUniformGridProp.Base p -> SchedulerPanel.apply el p
        | PixelSnappedUniformGridProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.PixelSnappedUniformGrid.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.PixelSnappedUniformGrid>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
