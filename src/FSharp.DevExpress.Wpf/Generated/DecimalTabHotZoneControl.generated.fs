...
type DecimalTabHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module DecimalTabHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.DecimalTabHotZoneControl) (prop: DecimalTabHotZoneControlProp) =
        match prop with
        | DecimalTabHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.DecimalTabHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
