...
type ColorEditProp =
    ...
    | DefaultColor of System.Windows.Media.Color
    | ShowMoreColorsButton of bool
    | ShowNoColorButton of bool
    | ShowDefaultColorButton of bool
    | DefaultColorButtonContent of obj
    | MoreColorsButtonContent of obj
    | NoColorButtonContent of obj
    | RecentColorsCaption of string
    | ColumnCount of int
    | ChipSize of DevExpress.Xpf.Editors.ChipSize
    | ChipMargin of System.Windows.Thickness
    | ChipBorderBrush of System.Windows.Media.Brush
    | Palettes of DevExpress.Xpf.Editors.PaletteCollection
    | ToolTipColorDisplayFormat of DevExpress.Xpf.Editors.ColorDisplayFormat
    | CloseOwnerPopupOnClick of bool
    | ShowAlphaChannel of bool
    | OnColorChanged of System.Windows.RoutedEventHandler
    | OnGetColorName of DevExpress.Xpf.Editors.GetColorNameEventHandler

module ColorEdit =
    let color v : obj = box (ColorEditProp.Color v)
    let defaultColor v : obj = box (ColorEditProp.DefaultColor v)
    let showMoreColorsButton v : obj = box (ColorEditProp.ShowMoreColorsButton v)
    let showNoColorButton v : obj = box (ColorEditProp.ShowNoColorButton v)
    let showDefaultColorButton v : obj = box (ColorEditProp.ShowDefaultColorButton v)
    let defaultColorButtonContent v : obj = box (ColorEditProp.DefaultColorButtonContent v)
    let moreColorsButtonContent v : obj = box (ColorEditProp.MoreColorsButtonContent v)
    let noColorButtonContent v : obj = box (ColorEditProp.NoColorButtonContent v)
    let recentColorsCaption v : obj = box (ColorEditProp.RecentColorsCaption v)
    let columnCount v : obj = box (ColorEditProp.ColumnCount v)
    let chipSize v : obj = box (ColorEditProp.ChipSize v)
    let chipMargin v : obj = box (ColorEditProp.ChipMargin v)
    let chipBorderBrush v : obj = box (ColorEditProp.ChipBorderBrush v)
    let palettes v : obj = box (ColorEditProp.Palettes v)
    let toolTipColorDisplayFormat v : obj = box (ColorEditProp.ToolTipColorDisplayFormat v)
    let closeOwnerPopupOnClick v : obj = box (ColorEditProp.CloseOwnerPopupOnClick v)
    let showAlphaChannel v : obj = box (ColorEditProp.ShowAlphaChannel v)
    let onColorChanged v : obj = box (EventProp(box (ColorEditProp.OnColorChanged v)))
    let onGetColorName v : obj = box (EventProp(box (ColorEditProp.OnGetColorName v)))

    let apply (el: DevExpress.Xpf.Editors.ColorEdit) (prop: ColorEditProp) =
        match prop with
        | ColorEditProp.Base p -> BaseEdit.apply el p
        | ColorEditProp.Color v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ColorProperty, box v)
        | ColorEditProp.DefaultColor v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.DefaultColorProperty, box v)
        | ColorEditProp.ShowMoreColorsButton v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ShowMoreColorsButtonProperty, box v)
        | ColorEditProp.ShowNoColorButton v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ShowNoColorButtonProperty, box v)
        | ColorEditProp.ShowDefaultColorButton v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ShowDefaultColorButtonProperty, box v)
        | ColorEditProp.DefaultColorButtonContent v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.DefaultColorButtonContentProperty, box v)
        | ColorEditProp.MoreColorsButtonContent v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.MoreColorsButtonContentProperty, box v)
        | ColorEditProp.NoColorButtonContent v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.NoColorButtonContentProperty, box v)
        | ColorEditProp.RecentColorsCaption v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.RecentColorsCaptionProperty, box v)
        | ColorEditProp.ColumnCount v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ColumnCountProperty, box v)
        | ColorEditProp.ChipSize v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ChipSizeProperty, box v)
        | ColorEditProp.ChipMargin v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ChipMarginProperty, box v)
        | ColorEditProp.ChipBorderBrush v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ChipBorderBrushProperty, box v)
        | ColorEditProp.Palettes v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.PalettesProperty, box v)
        | ColorEditProp.ToolTipColorDisplayFormat v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ToolTipColorDisplayFormatProperty, box v)
        | ColorEditProp.CloseOwnerPopupOnClick v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.CloseOwnerPopupOnClickProperty, box v)
        | ColorEditProp.ShowAlphaChannel v -> el.SetValue(DevExpress.Xpf.Editors.ColorEdit.ShowAlphaChannelProperty, box v)
        | ColorEditProp.OnColorChanged h -> el.ColorChanged.AddHandler(h)
        | ColorEditProp.OnGetColorName h -> el.GetColorName.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ColorEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
