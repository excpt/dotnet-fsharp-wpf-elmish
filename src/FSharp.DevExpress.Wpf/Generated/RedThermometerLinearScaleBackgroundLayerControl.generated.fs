...
type RedThermometerLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedThermometerLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedThermometerLinearScaleBackgroundLayerControl) (prop: RedThermometerLinearScaleBackgroundLayerControlProp) =
        match prop with
        | RedThermometerLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedThermometerLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
