...
type TabLayoutPanelProp =
    | Base of RotatableLayoutPanelProp
    | ViewInfo of DevExpress.Xpf.Core.Native.TabViewInfo

module TabLayoutPanel =
    let viewInfo v : obj = box (TabLayoutPanelProp.ViewInfo v)

    let apply (el: DevExpress.Xpf.Core.Native.TabLayoutPanel) (prop: TabLayoutPanelProp) =
        match prop with
        | TabLayoutPanelProp.Base p -> RotatableLayoutPanel.apply el p
        | TabLayoutPanelProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Core.Native.TabLayoutPanel.ViewInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
