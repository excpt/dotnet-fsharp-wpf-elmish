...
type HeaderPresenterProp =
    | Base of ItemPresenterProp

module HeaderPresenter =

    let apply (el: DevExpress.Xpf.Accordion.HeaderPresenter) (prop: HeaderPresenterProp) =
        match prop with
        | HeaderPresenterProp.Base p -> ItemPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.HeaderPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
