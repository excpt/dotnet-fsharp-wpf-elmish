...
type ShowNotesViewProp =
    | Base of ThemedWindowProp

module ShowNotesView =

    let apply (el: DevExpress.Xpf.RichEdit.View.ShowNotesView) (prop: ShowNotesViewProp) =
        match prop with
        | ShowNotesViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.ShowNotesView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
