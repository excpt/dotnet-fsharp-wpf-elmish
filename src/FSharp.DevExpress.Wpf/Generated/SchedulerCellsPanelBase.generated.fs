...
type SchedulerCellsPanelBaseProp =
    | Base of PanelBaseProp
...
module SchedulerCellsPanelBase =
    let schedulerTimeCellControl v : obj = box (SchedulerCellsPanelBaseProp.SchedulerTimeCellControl v)
    let cellContainer v : obj = box (SchedulerCellsPanelBaseProp.CellContainer v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerCellsPanelBase) (prop: SchedulerCellsPanelBaseProp) =
        match prop with
        | SchedulerCellsPanelBaseProp.Base p -> PanelBase.apply el p
        | SchedulerCellsPanelBaseProp.SchedulerTimeCellControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerCellsPanelBase.SchedulerTimeCellControlProperty, box v)
        | SchedulerCellsPanelBaseProp.CellContainer v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerCellsPanelBase.CellContainerProperty, box v)
