...
type OneMonthWeekContainersPanelProp =
...
module OneMonthWeekContainersPanel =
    let view v : obj = box (OneMonthWeekContainersPanelProp.View v)
    let visualData v : obj = box (OneMonthWeekContainersPanelProp.VisualData v)
    let itemContainerAppointmentsContainerStyle v : obj = box (OneMonthWeekContainersPanelProp.ItemContainerAppointmentsContainerStyle v)
    let itemContainerDragAppointmentsContainerStyle v : obj = box (OneMonthWeekContainersPanelProp.ItemContainerDragAppointmentsContainerStyle v)
    let itemContainerVerticalBorderThickness v : obj = box (OneMonthWeekContainersPanelProp.ItemContainerVerticalBorderThickness v)
    let itemContainerHorizontalBorderThickness v : obj = box (OneMonthWeekContainersPanelProp.ItemContainerHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel) (prop: OneMonthWeekContainersPanelProp) =
        match prop with
        | OneMonthWeekContainersPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel.ViewProperty, box v)
        | OneMonthWeekContainersPanelProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel.VisualDataProperty, box v)
        | OneMonthWeekContainersPanelProp.ItemContainerAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel.ItemContainerAppointmentsContainerStyleProperty, box v)
        | OneMonthWeekContainersPanelProp.ItemContainerDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel.ItemContainerDragAppointmentsContainerStyleProperty, box v)
        | OneMonthWeekContainersPanelProp.ItemContainerVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel.ItemContainerVerticalBorderThicknessProperty, box v)
        | OneMonthWeekContainersPanelProp.ItemContainerHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel.ItemContainerHorizontalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
