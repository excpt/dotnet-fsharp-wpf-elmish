...
open System
open System.Windows
open DevExpress.Xpf.PivotGrid.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FieldListLayoutSelectorProp =
    | Layout of DevExpress.Xpf.PivotGrid.FieldListLayout
    | FieldListAreaContent of obj
    | ColumnAreaContent of obj
    | RowAreaContent of obj
    | FilterAreaContent of obj
    | DataAreaContent of obj
    | DefereUpdatesContent of obj
    | StackedDefaultTemplate of System.Windows.Controls.ControlTemplate
    | StackedSideBySideTemplate of System.Windows.Controls.ControlTemplate
    | TopPanelOnlyTemplate of System.Windows.Controls.ControlTemplate
    | BottomPanelOnly2by2Template of System.Windows.Controls.ControlTemplate
    | BottomPanelOnly1by4Template of System.Windows.Controls.ControlTemplate
    | FieldListSplitterY of float
    | FieldListSplitterX of float
    | ShowAll of bool
    | ActualWidthCore of float
    | ActualHeightCore of float

module FieldListLayoutSelector =
    let layout v : obj = box (FieldListLayoutSelectorProp.Layout v)
    let fieldListAreaContent v : obj = box (FieldListLayoutSelectorProp.FieldListAreaContent v)
    let columnAreaContent v : obj = box (FieldListLayoutSelectorProp.ColumnAreaContent v)
    let rowAreaContent v : obj = box (FieldListLayoutSelectorProp.RowAreaContent v)
    let filterAreaContent v : obj = box (FieldListLayoutSelectorProp.FilterAreaContent v)
    let dataAreaContent v : obj = box (FieldListLayoutSelectorProp.DataAreaContent v)
    let defereUpdatesContent v : obj = box (FieldListLayoutSelectorProp.DefereUpdatesContent v)
    let stackedDefaultTemplate v : obj = box (FieldListLayoutSelectorProp.StackedDefaultTemplate v)
    let stackedSideBySideTemplate v : obj = box (FieldListLayoutSelectorProp.StackedSideBySideTemplate v)
    let topPanelOnlyTemplate v : obj = box (FieldListLayoutSelectorProp.TopPanelOnlyTemplate v)
    let bottomPanelOnly2by2Template v : obj = box (FieldListLayoutSelectorProp.BottomPanelOnly2by2Template v)
    let bottomPanelOnly1by4Template v : obj = box (FieldListLayoutSelectorProp.BottomPanelOnly1by4Template v)
    let fieldListSplitterY v : obj = box (FieldListLayoutSelectorProp.FieldListSplitterY v)
    let fieldListSplitterX v : obj = box (FieldListLayoutSelectorProp.FieldListSplitterX v)
    let showAll v : obj = box (FieldListLayoutSelectorProp.ShowAll v)
    let actualWidthCore v : obj = box (FieldListLayoutSelectorProp.ActualWidthCore v)
    let actualHeightCore v : obj = box (FieldListLayoutSelectorProp.ActualHeightCore v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector) (prop: FieldListLayoutSelectorProp) =
        match prop with
        | FieldListLayoutSelectorProp.Layout v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.LayoutProperty, box v)
        | FieldListLayoutSelectorProp.FieldListAreaContent v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.FieldListAreaContentProperty, box v)
        | FieldListLayoutSelectorProp.ColumnAreaContent v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.ColumnAreaContentProperty, box v)
        | FieldListLayoutSelectorProp.RowAreaContent v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.RowAreaContentProperty, box v)
        | FieldListLayoutSelectorProp.FilterAreaContent v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.FilterAreaContentProperty, box v)
        | FieldListLayoutSelectorProp.DataAreaContent v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.DataAreaContentProperty, box v)
        | FieldListLayoutSelectorProp.DefereUpdatesContent v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.DefereUpdatesContentProperty, box v)
        | FieldListLayoutSelectorProp.StackedDefaultTemplate v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.StackedDefaultTemplateProperty, box v)
        | FieldListLayoutSelectorProp.StackedSideBySideTemplate v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.StackedSideBySideTemplateProperty, box v)
        | FieldListLayoutSelectorProp.TopPanelOnlyTemplate v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.TopPanelOnlyTemplateProperty, box v)
        | FieldListLayoutSelectorProp.BottomPanelOnly2by2Template v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.BottomPanelOnly2by2TemplateProperty, box v)
        | FieldListLayoutSelectorProp.BottomPanelOnly1by4Template v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.BottomPanelOnly1by4TemplateProperty, box v)
        | FieldListLayoutSelectorProp.FieldListSplitterY v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.FieldListSplitterYProperty, box v)
        | FieldListLayoutSelectorProp.FieldListSplitterX v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.FieldListSplitterXProperty, box v)
        | FieldListLayoutSelectorProp.ShowAll v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.ShowAllProperty, box v)
        | FieldListLayoutSelectorProp.ActualWidthCore v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.ActualWidthCoreProperty, box v)
        | FieldListLayoutSelectorProp.ActualHeightCore v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector.ActualHeightCoreProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldListLayoutSelector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
