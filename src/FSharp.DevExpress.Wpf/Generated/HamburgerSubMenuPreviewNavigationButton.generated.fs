...
type HamburgerSubMenuPreviewNavigationButtonProp =
    | IsSelected of bool
    | RightContent of obj
    | RightContentTemplate of System.Windows.DataTemplate
    | RightContentMargin of System.Windows.Thickness
    | RightForeground of System.Windows.Media.Brush
    | ShowSelectionIndicator of bool
    | SelectionIndicatorBrush of System.Windows.Media.Brush

module HamburgerSubMenuPreviewNavigationButton =
    let isSelected v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.IsSelected v)
    let rightContent v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.RightContent v)
    let rightContentTemplate v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.RightContentTemplate v)
    let rightContentMargin v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.RightContentMargin v)
    let rightForeground v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.RightForeground v)
    let showSelectionIndicator v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.ShowSelectionIndicator v)
    let selectionIndicatorBrush v : obj = box (HamburgerSubMenuPreviewNavigationButtonProp.SelectionIndicatorBrush v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton) (prop: HamburgerSubMenuPreviewNavigationButtonProp) =
        match prop with
        | HamburgerSubMenuPreviewNavigationButtonProp.IsSelected v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.IsSelectedProperty, box v)
        | HamburgerSubMenuPreviewNavigationButtonProp.RightContent v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.RightContentProperty, box v)
        | HamburgerSubMenuPreviewNavigationButtonProp.RightContentTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.RightContentTemplateProperty, box v)
        | HamburgerSubMenuPreviewNavigationButtonProp.RightContentMargin v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.RightContentMarginProperty, box v)
        | HamburgerSubMenuPreviewNavigationButtonProp.RightForeground v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.RightForegroundProperty, box v)
        | HamburgerSubMenuPreviewNavigationButtonProp.ShowSelectionIndicator v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.ShowSelectionIndicatorProperty, box v)
        | HamburgerSubMenuPreviewNavigationButtonProp.SelectionIndicatorBrush v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton.SelectionIndicatorBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerSubMenuPreviewNavigationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
