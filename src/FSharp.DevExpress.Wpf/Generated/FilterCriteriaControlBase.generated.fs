...
type FilterCriteriaControlBaseProp =
    | Column of DevExpress.Xpf.Grid.ColumnBase
    | DefaultIndex of int

module FilterCriteriaControlBase =
    let column v : obj = box (FilterCriteriaControlBaseProp.Column v)
    let defaultIndex v : obj = box (FilterCriteriaControlBaseProp.DefaultIndex v)

    let apply (el: DevExpress.Xpf.Grid.FilterCriteriaControlBase) (prop: FilterCriteriaControlBaseProp) =
        match prop with
        | FilterCriteriaControlBaseProp.Column v -> el.SetValue(DevExpress.Xpf.Grid.FilterCriteriaControlBase.ColumnProperty, box v)
        | FilterCriteriaControlBaseProp.DefaultIndex v -> el.SetValue(DevExpress.Xpf.Grid.FilterCriteriaControlBase.DefaultIndexProperty, box v)
