...
type MapHorizontalZoomTrackbarProp =
    | Base of MapZoomTrackbarProp

module MapHorizontalZoomTrackbar =

    let apply (el: DevExpress.Xpf.Map.MapHorizontalZoomTrackbar) (prop: MapHorizontalZoomTrackbarProp) =
        match prop with
        | MapHorizontalZoomTrackbarProp.Base p -> MapZoomTrackbar.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapHorizontalZoomTrackbar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
