...
type SmoothScrollerProp =
    | AllowScrollUp of bool
    | AllowScrollDown of bool
    | ScrollSpeed of float
    | Acceleration of float
    | Deceleration of float
    | ChildOffset of float
    | TopBottomSpace of float
    | Orientation of System.Windows.Controls.Orientation

module SmoothScroller =
    let allowScrollUp v : obj = box (SmoothScrollerProp.AllowScrollUp v)
    let allowScrollDown v : obj = box (SmoothScrollerProp.AllowScrollDown v)
    let scrollSpeed v : obj = box (SmoothScrollerProp.ScrollSpeed v)
    let acceleration v : obj = box (SmoothScrollerProp.Acceleration v)
    let deceleration v : obj = box (SmoothScrollerProp.Deceleration v)
    let childOffset v : obj = box (SmoothScrollerProp.ChildOffset v)
    let topBottomSpace v : obj = box (SmoothScrollerProp.TopBottomSpace v)
    let orientation v : obj = box (SmoothScrollerProp.Orientation v)

    let apply (el: DevExpress.Xpf.Core.SmoothScroller) (prop: SmoothScrollerProp) =
        match prop with
        | SmoothScrollerProp.AllowScrollUp v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.AllowScrollUpProperty, box v)
        | SmoothScrollerProp.AllowScrollDown v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.AllowScrollDownProperty, box v)
        | SmoothScrollerProp.ScrollSpeed v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.ScrollSpeedProperty, box v)
        | SmoothScrollerProp.Acceleration v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.AccelerationProperty, box v)
        | SmoothScrollerProp.Deceleration v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.DecelerationProperty, box v)
        | SmoothScrollerProp.ChildOffset v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.ChildOffsetProperty, box v)
        | SmoothScrollerProp.TopBottomSpace v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.TopBottomSpaceProperty, box v)
        | SmoothScrollerProp.Orientation v -> el.SetValue(DevExpress.Xpf.Core.SmoothScroller.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SmoothScroller>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
