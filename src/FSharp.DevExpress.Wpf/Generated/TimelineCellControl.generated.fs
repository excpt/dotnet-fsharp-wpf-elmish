...
type TimelineCellControlProp =
    | Base of CellControlProp

module TimelineCellControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimelineCellControl) (prop: TimelineCellControlProp) =
        match prop with
        | TimelineCellControlProp.Base p -> CellControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimelineCellControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
