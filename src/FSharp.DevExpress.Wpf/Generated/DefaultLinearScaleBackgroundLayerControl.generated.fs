...
type DefaultLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleBackgroundLayerControl) (prop: DefaultLinearScaleBackgroundLayerControlProp) =
        match prop with
        | DefaultLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
