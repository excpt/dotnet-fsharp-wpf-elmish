...
type CircularRedClockThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularRedClockThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularRedClockThreeQuartersModel) (prop: CircularRedClockThreeQuartersModelProp) =
        match prop with
        | CircularRedClockThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularRedClockThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
