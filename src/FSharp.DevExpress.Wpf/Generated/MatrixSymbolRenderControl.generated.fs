...
type MatrixSymbolRenderControlProp =
    | Presentation of DevExpress.Xpf.Gauges.PresentationBase
    | SymbolState of DevExpress.Xpf.Gauges.SymbolState

module MatrixSymbolRenderControl =
    let presentation v : obj = box (MatrixSymbolRenderControlProp.Presentation v)
    let symbolState v : obj = box (MatrixSymbolRenderControlProp.SymbolState v)

    let apply (el: DevExpress.Xpf.Gauges.MatrixSymbolRenderControl) (prop: MatrixSymbolRenderControlProp) =
        match prop with
        | MatrixSymbolRenderControlProp.Presentation v -> el.SetValue(DevExpress.Xpf.Gauges.MatrixSymbolRenderControl.PresentationProperty, box v)
        | MatrixSymbolRenderControlProp.SymbolState v -> el.SetValue(DevExpress.Xpf.Gauges.MatrixSymbolRenderControl.SymbolStateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MatrixSymbolRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
