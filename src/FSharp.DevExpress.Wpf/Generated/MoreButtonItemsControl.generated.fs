...
type MoreButtonItemsControlProp =
    | Base of XPFItemsControlProp
    | View of DevExpress.Xpf.Scheduler.SchedulerViewBase

module MoreButtonItemsControl =
    let view v : obj = box (MoreButtonItemsControlProp.View v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.MoreButtonItemsControl) (prop: MoreButtonItemsControlProp) =
        match prop with
        | MoreButtonItemsControlProp.Base p -> XPFItemsControl.apply el p
        | MoreButtonItemsControlProp.View v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.MoreButtonItemsControl.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.MoreButtonItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
