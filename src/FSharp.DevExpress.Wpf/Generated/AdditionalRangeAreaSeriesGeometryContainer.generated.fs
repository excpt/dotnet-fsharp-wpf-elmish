...
type AdditionalRangeAreaSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalRangeAreaSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalRangeAreaSeriesGeometryContainer) (prop: AdditionalRangeAreaSeriesGeometryContainerProp) =
        match prop with
        | AdditionalRangeAreaSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalRangeAreaSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
