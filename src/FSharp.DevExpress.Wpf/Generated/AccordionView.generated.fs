...
type AccordionViewProp =
    | ShowEmptySourceTemplate of bool

module AccordionView =
    let showEmptySourceTemplate v : obj = box (AccordionViewProp.ShowEmptySourceTemplate v)

    let apply (el: DevExpress.Xpf.Accordion.AccordionView) (prop: AccordionViewProp) =
        match prop with
        | AccordionViewProp.ShowEmptySourceTemplate v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionView.ShowEmptySourceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
