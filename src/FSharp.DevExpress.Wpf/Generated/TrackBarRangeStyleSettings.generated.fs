...
type TrackBarRangeStyleSettingsProp =
    | Base of TrackBarStyleSettingsProp
...
module TrackBarRangeStyleSettings =
    ...
    let apply (el: DevExpress.Xpf.Editors.TrackBarRangeStyleSettings) (prop: TrackBarRangeStyleSettingsProp) =
        match prop with
        | TrackBarRangeStyleSettingsProp.Base p -> TrackBarStyleSettings.apply el p
        | TrackBarRangeStyleSettingsProp.NearThumbStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarRangeStyleSettings.NearThumbStyleProperty, box v)
        | TrackBarRangeStyleSettingsProp.FarThumbStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarRangeStyleSettings.FarThumbStyleProperty, box v)
        | TrackBarRangeStyleSettingsProp.SelectedRangeBackgroundStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarRangeStyleSettings.SelectedRangeBackgroundStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarRangeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
