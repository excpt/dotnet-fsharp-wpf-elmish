...
type AutoHideDockHintAdornerProp =
    | Base of DockingHintAdornerProp

module AutoHideDockHintAdorner =

    let apply (el: DevExpress.Xpf.Docking.Platform.AutoHideDockHintAdorner) (prop: AutoHideDockHintAdornerProp) =
        match prop with
        | AutoHideDockHintAdornerProp.Base p -> DockingHintAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.AutoHideDockHintAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
