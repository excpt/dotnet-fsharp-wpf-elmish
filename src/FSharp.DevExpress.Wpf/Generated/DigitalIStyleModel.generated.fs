...
type DigitalIStyleModelProp =
    | Base of DigitalGaugeModelProp

module DigitalIStyleModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalIStyleModel) (prop: DigitalIStyleModelProp) =
        match prop with
        | DigitalIStyleModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalIStyleModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
