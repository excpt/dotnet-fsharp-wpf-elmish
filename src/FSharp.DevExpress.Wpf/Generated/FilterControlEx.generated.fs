...
type FilterControlExProp =
    | Base of FilterControlProp
    | DisplayNameProvider of DevExpress.Data.IDisplayNameProvider

module FilterControlEx =
    let displayNameProvider v : obj = box (FilterControlExProp.DisplayNameProvider v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEx) (prop: FilterControlExProp) =
        match prop with
        | FilterControlExProp.Base p -> FilterControl.apply el p
        | FilterControlExProp.DisplayNameProvider v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEx.DisplayNameProviderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
