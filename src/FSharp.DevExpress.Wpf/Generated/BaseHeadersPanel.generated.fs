...
type BaseHeadersPanelProp =
    | Base of psvPanelProp
    ...
    | ScrollOffset of float
    | ScrollIndex of int
    | SelectedIndex of int
    | ClipMargin of System.Windows.Thickness
    | TransparencySize of float
    | FixedMultiLineTabHeaders of bool
    | AutoScrollOnOverflow of DevExpress.Xpf.Docking.AutoScrollOnOverflow

module BaseHeadersPanel =
    let orientation v : obj = box (BaseHeadersPanelProp.Orientation v)
    let tabHeaderLayoutType v : obj = box (BaseHeadersPanelProp.TabHeaderLayoutType v)
    let isAutoFillHeaders v : obj = box (BaseHeadersPanelProp.IsAutoFillHeaders v)
    let scrollOffset v : obj = box (BaseHeadersPanelProp.ScrollOffset v)
    let scrollIndex v : obj = box (BaseHeadersPanelProp.ScrollIndex v)
    let selectedIndex v : obj = box (BaseHeadersPanelProp.SelectedIndex v)
    let clipMargin v : obj = box (BaseHeadersPanelProp.ClipMargin v)
    let transparencySize v : obj = box (BaseHeadersPanelProp.TransparencySize v)
    let fixedMultiLineTabHeaders v : obj = box (BaseHeadersPanelProp.FixedMultiLineTabHeaders v)
    let autoScrollOnOverflow v : obj = box (BaseHeadersPanelProp.AutoScrollOnOverflow v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel) (prop: BaseHeadersPanelProp) =
        match prop with
        | BaseHeadersPanelProp.Base p -> psvPanel.apply el p
        | BaseHeadersPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.OrientationProperty, box v)
        | BaseHeadersPanelProp.TabHeaderLayoutType v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.TabHeaderLayoutTypeProperty, box v)
        | BaseHeadersPanelProp.IsAutoFillHeaders v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.IsAutoFillHeadersProperty, box v)
        | BaseHeadersPanelProp.ScrollOffset v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.ScrollOffsetProperty, box v)
        | BaseHeadersPanelProp.ScrollIndex v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.ScrollIndexProperty, box v)
        | BaseHeadersPanelProp.SelectedIndex v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.SelectedIndexProperty, box v)
        | BaseHeadersPanelProp.ClipMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.ClipMarginProperty, box v)
        | BaseHeadersPanelProp.TransparencySize v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.TransparencySizeProperty, box v)
        | BaseHeadersPanelProp.FixedMultiLineTabHeaders v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.FixedMultiLineTabHeadersProperty, box v)
        | BaseHeadersPanelProp.AutoScrollOnOverflow v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseHeadersPanel.AutoScrollOnOverflowProperty, box v)
