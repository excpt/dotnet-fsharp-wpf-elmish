...
type ClassicScaleLabelControlProp =
    | Base of PresentationControlProp

module ClassicScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicScaleLabelControl) (prop: ClassicScaleLabelControlProp) =
        match prop with
        | ClassicScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
