...
type SelectionHintProp =
    | Base of DockHintElementProp

module SelectionHint =

    let apply (el: DevExpress.Xpf.Docking.Platform.SelectionHint) (prop: SelectionHintProp) =
        match prop with
        | SelectionHintProp.Base p -> DockHintElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.SelectionHint>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
