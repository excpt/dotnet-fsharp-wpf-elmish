...
type ClassicArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ClassicArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicArcScaleMarkerControl) (prop: ClassicArcScaleMarkerControlProp) =
        match prop with
        | ClassicArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
