...
type OpenDocumentRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module OpenDocumentRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.OpenDocumentRichEditDocumentSourceProvider) (prop: OpenDocumentRichEditDocumentSourceProviderProp) =
        match prop with
        | OpenDocumentRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.OpenDocumentRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
