...
type TabHeadersAdornerProp =
    | Base of PlacementAdornerProp

module TabHeadersAdorner =

    let apply (el: DevExpress.Xpf.Docking.Platform.TabHeadersAdorner) (prop: TabHeadersAdornerProp) =
        match prop with
        | TabHeadersAdornerProp.Base p -> PlacementAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.TabHeadersAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
