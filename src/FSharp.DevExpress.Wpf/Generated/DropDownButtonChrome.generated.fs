...
type DropDownButtonChromeProp =
    | Base of ButtonChromeProp

module DropDownButtonChrome =

    let apply (el: DevExpress.Xpf.Core.Native.DropDownButtonChrome) (prop: DropDownButtonChromeProp) =
        match prop with
        | DropDownButtonChromeProp.Base p -> ButtonChrome.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DropDownButtonChrome>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
