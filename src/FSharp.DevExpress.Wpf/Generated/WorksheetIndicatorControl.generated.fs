...
type WorksheetIndicatorControlProp =
    | Base of WorksheetPaintControlProp
    | CommentIndicatorBrush of System.Windows.Media.Brush
    | NumberIndicatorBrush of System.Windows.Media.Brush
    | IndicatorWidth of float

module WorksheetIndicatorControl =
    let commentIndicatorBrush v : obj = box (WorksheetIndicatorControlProp.CommentIndicatorBrush v)
    let numberIndicatorBrush v : obj = box (WorksheetIndicatorControlProp.NumberIndicatorBrush v)
    let indicatorWidth v : obj = box (WorksheetIndicatorControlProp.IndicatorWidth v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetIndicatorControl) (prop: WorksheetIndicatorControlProp) =
        match prop with
        | WorksheetIndicatorControlProp.Base p -> WorksheetPaintControl.apply el p
        | WorksheetIndicatorControlProp.CommentIndicatorBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetIndicatorControl.CommentIndicatorBrushProperty, box v)
        | WorksheetIndicatorControlProp.NumberIndicatorBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetIndicatorControl.NumberIndicatorBrushProperty, box v)
        | WorksheetIndicatorControlProp.IndicatorWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetIndicatorControl.IndicatorWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetIndicatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
