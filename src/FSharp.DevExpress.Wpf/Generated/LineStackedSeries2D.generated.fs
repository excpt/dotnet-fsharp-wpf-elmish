...
type LineStackedSeries2DProp =
    | Base of LineSeries2DProp

module LineStackedSeries2D =

    let apply (el: DevExpress.Xpf.Charts.LineStackedSeries2D) (prop: LineStackedSeries2DProp) =
        match prop with
        | LineStackedSeries2DProp.Base p -> LineSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LineStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
