...
type CircularThemeableFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularThemeableFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularThemeableFullModel) (prop: CircularThemeableFullModelProp) =
        match prop with
        | CircularThemeableFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularThemeableFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
