...
type ThemeableQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of ThemeableArcScaleBackgroundLayerControlBaseProp

module ThemeableQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableQuarterTopLeftArcScaleBackgroundLayerControl) (prop: ThemeableQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | ThemeableQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> ThemeableArcScaleBackgroundLayerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
