...
type ScrollControlProp =
    | ScrollButtonsControlTemplate of System.Windows.Controls.ControlTemplate
    | ScrollBarControlTemplate of System.Windows.Controls.ControlTemplate
    | NoScrollControlTemplate of System.Windows.Controls.ControlTemplate
    | ActualScrollMode of DevExpress.Xpf.NavBar.ScrollMode

module ScrollControl =
    let scrollButtonsControlTemplate v : obj = box (ScrollControlProp.ScrollButtonsControlTemplate v)
    let scrollBarControlTemplate v : obj = box (ScrollControlProp.ScrollBarControlTemplate v)
    let noScrollControlTemplate v : obj = box (ScrollControlProp.NoScrollControlTemplate v)
    let actualScrollMode v : obj = box (ScrollControlProp.ActualScrollMode v)

    let apply (el: DevExpress.Xpf.NavBar.ScrollControl) (prop: ScrollControlProp) =
        match prop with
        | ScrollControlProp.ScrollButtonsControlTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollControl.ScrollButtonsControlTemplateProperty, box v)
        | ScrollControlProp.ScrollBarControlTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollControl.ScrollBarControlTemplateProperty, box v)
        | ScrollControlProp.NoScrollControlTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollControl.NoScrollControlTemplateProperty, box v)
        | ScrollControlProp.ActualScrollMode v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollControl.ActualScrollModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ScrollControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
