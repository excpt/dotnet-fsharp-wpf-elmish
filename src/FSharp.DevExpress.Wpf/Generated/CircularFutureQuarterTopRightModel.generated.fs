...
type CircularFutureQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFutureQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFutureQuarterTopRightModel) (prop: CircularFutureQuarterTopRightModelProp) =
        match prop with
        | CircularFutureQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFutureQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
