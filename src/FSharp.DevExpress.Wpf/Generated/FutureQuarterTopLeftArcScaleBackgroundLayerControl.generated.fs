...
type FutureQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureQuarterTopLeftArcScaleBackgroundLayerControl) (prop: FutureQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | FutureQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
