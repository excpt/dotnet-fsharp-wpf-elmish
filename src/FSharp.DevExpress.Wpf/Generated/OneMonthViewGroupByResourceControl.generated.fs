...
type OneMonthViewGroupByResourceControlProp =
    | Base of OneMonthViewControlProp

module OneMonthViewGroupByResourceControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.OneMonthViewGroupByResourceControl) (prop: OneMonthViewGroupByResourceControlProp) =
        match prop with
        | OneMonthViewGroupByResourceControlProp.Base p -> OneMonthViewControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.OneMonthViewGroupByResourceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
