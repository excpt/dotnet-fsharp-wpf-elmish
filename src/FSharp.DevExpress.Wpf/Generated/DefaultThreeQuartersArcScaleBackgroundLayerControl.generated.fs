...
type DefaultThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultThreeQuartersArcScaleBackgroundLayerControl) (prop: DefaultThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | DefaultThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
