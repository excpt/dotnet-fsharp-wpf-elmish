...
type ClassicSpindleCapControlProp =
    | Base of PresentationControlProp

module ClassicSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicSpindleCapControl) (prop: ClassicSpindleCapControlProp) =
        match prop with
        | ClassicSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
