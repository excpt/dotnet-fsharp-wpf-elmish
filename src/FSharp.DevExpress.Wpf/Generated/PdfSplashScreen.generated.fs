...
type PdfSplashScreenProp =
    | Base of SplashScreenWindowProp

module PdfSplashScreen =

    let apply (el: DevExpress.Xpf.PdfViewer.Internal.PdfSplashScreen) (prop: PdfSplashScreenProp) =
        match prop with
        | PdfSplashScreenProp.Base p -> SplashScreenWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.Internal.PdfSplashScreen>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
