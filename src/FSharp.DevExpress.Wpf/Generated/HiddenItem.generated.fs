...
module HiddenItem =
    ...
    let apply (el: DevExpress.Xpf.Docking.VisualElements.HiddenItem) (prop: HiddenItemProp) =
        match prop with
        | HiddenItemProp.Base p -> BaseCustomizationItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.HiddenItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
