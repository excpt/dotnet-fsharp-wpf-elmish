...
type ColorChooserProp =
    | Base of ColorPickerProp

module ColorChooser =

    let apply (el: DevExpress.Xpf.Editors.ColorChooser) (prop: ColorChooserProp) =
        match prop with
        | ColorChooserProp.Base p -> ColorPicker.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ColorChooser>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
