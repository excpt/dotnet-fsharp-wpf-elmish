...
type AppBarTileButtonProp =
    | Base of AppBarButtonBaseProp

module AppBarTileButton =

    let apply (el: DevExpress.Xpf.WindowsUI.AppBarTileButton) (prop: AppBarTileButtonProp) =
        match prop with
        | AppBarTileButtonProp.Base p -> AppBarButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.AppBarTileButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
