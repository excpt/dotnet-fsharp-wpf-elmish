...
type BarSideBySideStackedSeries2DProp =
    | Base of BarStackedSeries2DProp
    | StackedGroup of obj

module BarSideBySideStackedSeries2D =
    let stackedGroup v : obj = box (BarSideBySideStackedSeries2DProp.StackedGroup v)

    let apply (el: DevExpress.Xpf.Charts.BarSideBySideStackedSeries2D) (prop: BarSideBySideStackedSeries2DProp) =
        match prop with
        | BarSideBySideStackedSeries2DProp.Base p -> BarStackedSeries2D.apply el p
        | BarSideBySideStackedSeries2DProp.StackedGroup v -> el.SetValue(DevExpress.Xpf.Charts.BarSideBySideStackedSeries2D.StackedGroupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BarSideBySideStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
