...
type FilterControlClauseNodeProp =
    | Base of FilterControlNodeBaseProp
    | SecondOperandsCount of DevExpress.Xpf.Editors.Filtering.OperandsCount
    | SecondOperandsOneTemplate of System.Windows.Controls.ControlTemplate
    | SecondOperandsTwoTemplate of System.Windows.Controls.ControlTemplate
    | SecondOperandsSeveralTemplate of System.Windows.Controls.ControlTemplate
    | SecondOperandsLocalDateTimeTemplate of System.Windows.Controls.ControlTemplate

module FilterControlClauseNode =
    let secondOperandsCount v : obj = box (FilterControlClauseNodeProp.SecondOperandsCount v)
    let secondOperandsOneTemplate v : obj = box (FilterControlClauseNodeProp.SecondOperandsOneTemplate v)
    let secondOperandsTwoTemplate v : obj = box (FilterControlClauseNodeProp.SecondOperandsTwoTemplate v)
    let secondOperandsSeveralTemplate v : obj = box (FilterControlClauseNodeProp.SecondOperandsSeveralTemplate v)
    let secondOperandsLocalDateTimeTemplate v : obj = box (FilterControlClauseNodeProp.SecondOperandsLocalDateTimeTemplate v)

    let apply (el: DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode) (prop: FilterControlClauseNodeProp) =
        match prop with
        | FilterControlClauseNodeProp.Base p -> FilterControlNodeBase.apply el p
        | FilterControlClauseNodeProp.SecondOperandsCount v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode.SecondOperandsCountProperty, box v)
        | FilterControlClauseNodeProp.SecondOperandsOneTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode.SecondOperandsOneTemplateProperty, box v)
        | FilterControlClauseNodeProp.SecondOperandsTwoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode.SecondOperandsTwoTemplateProperty, box v)
        | FilterControlClauseNodeProp.SecondOperandsSeveralTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode.SecondOperandsSeveralTemplateProperty, box v)
        | FilterControlClauseNodeProp.SecondOperandsLocalDateTimeTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode.SecondOperandsLocalDateTimeTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Filtering.FilterControlClauseNode>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
