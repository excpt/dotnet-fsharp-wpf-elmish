...
type CellEditorBaseProp =
    | Base of InplaceEditorBaseProp
    | RowData of DevExpress.Xpf.Grid.RowData
    | FieldName of string
    | Column of DevExpress.Xpf.Grid.ColumnBase
    | IsFocusedCell of bool
    | ToolTipContent of obj
    | ReadOnly of bool

module CellEditorBase =
    let rowData v : obj = box (CellEditorBaseProp.RowData v)
    let fieldName v : obj = box (CellEditorBaseProp.FieldName v)
    let column v : obj = box (CellEditorBaseProp.Column v)
    let isFocusedCell v : obj = box (CellEditorBaseProp.IsFocusedCell v)
    let toolTipContent v : obj = box (CellEditorBaseProp.ToolTipContent v)
    let readOnly v : obj = box (CellEditorBaseProp.ReadOnly v)

    let apply (el: DevExpress.Xpf.Grid.CellEditorBase) (prop: CellEditorBaseProp) =
        match prop with
        | CellEditorBaseProp.Base p -> InplaceEditorBase.apply el p
        | CellEditorBaseProp.RowData v -> el.SetValue(DevExpress.Xpf.Grid.CellEditorBase.RowDataProperty, box v)
        | CellEditorBaseProp.FieldName v -> el.SetValue(DevExpress.Xpf.Grid.CellEditorBase.FieldNameProperty, box v)
        | CellEditorBaseProp.Column v -> el.SetValue(DevExpress.Xpf.Grid.CellEditorBase.ColumnProperty, box v)
        | CellEditorBaseProp.IsFocusedCell v -> el.SetValue(DevExpress.Xpf.Grid.CellEditorBase.IsFocusedCellProperty, box v)
        | CellEditorBaseProp.ToolTipContent v -> el.SetValue(DevExpress.Xpf.Grid.CellEditorBase.ToolTipContentProperty, box v)
        | CellEditorBaseProp.ReadOnly v -> el.SetValue(DevExpress.Xpf.Grid.CellEditorBase.ReadOnlyProperty, box v)
