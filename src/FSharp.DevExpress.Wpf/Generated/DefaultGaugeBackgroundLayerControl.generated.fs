...
type DefaultGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultGaugeBackgroundLayerControl) (prop: DefaultGaugeBackgroundLayerControlProp) =
        match prop with
        | DefaultGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
