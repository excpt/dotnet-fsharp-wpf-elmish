...
type FilterControlEditorProp =
    | Base of FilterControlEditorExProp
    | ExistingParameters of obj
    | FilterPresenter of DevExpress.DataAccess.Native.Filtering.IFilterPresenter
    | Properties of obj
    | ReportParameterEditorTemplate of System.Windows.DataTemplate
    | QueryParameterEditorTemplate of System.Windows.DataTemplate
    | EditMode of DevExpress.Xpf.Editors.EditMode
    | Node of DevExpress.Xpf.Editors.Filtering.ClauseNode
    | FieldInValue of bool
    | Operator of DevExpress.Data.Filtering.CriteriaOperator
    | Index of int

module FilterControlEditor =
    let existingParameters v : obj = box (FilterControlEditorProp.ExistingParameters v)
    let filterPresenter v : obj = box (FilterControlEditorProp.FilterPresenter v)
    let properties v : obj = box (FilterControlEditorProp.Properties v)
    let reportParameterEditorTemplate v : obj = box (FilterControlEditorProp.ReportParameterEditorTemplate v)
    let queryParameterEditorTemplate v : obj = box (FilterControlEditorProp.QueryParameterEditorTemplate v)
    let editMode v : obj = box (FilterControlEditorProp.EditMode v)
    let node v : obj = box (FilterControlEditorProp.Node v)
    let fieldInValue v : obj = box (FilterControlEditorProp.FieldInValue v)
    let operator v : obj = box (FilterControlEditorProp.Operator v)
    let index v : obj = box (FilterControlEditorProp.Index v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor) (prop: FilterControlEditorProp) =
        match prop with
        | FilterControlEditorProp.Base p -> FilterControlEditorEx.apply el p
        | FilterControlEditorProp.ExistingParameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor.ExistingParametersProperty, box v)
        | FilterControlEditorProp.FilterPresenter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor.FilterPresenterProperty, box v)
        | FilterControlEditorProp.Properties v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor.PropertiesProperty, box v)
        | FilterControlEditorProp.ReportParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor.ReportParameterEditorTemplateProperty, box v)
        | FilterControlEditorProp.QueryParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor.QueryParameterEditorTemplateProperty, box v)
        | FilterControlEditorProp.EditMode v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlEditor.EditModeProperty, box v)
        | FilterControlEditorProp.Node v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlEditor.NodeProperty, box v)
        | FilterControlEditorProp.FieldInValue v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlEditor.FieldInValueProperty, box v)
        | FilterControlEditorProp.Operator v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlEditor.OperatorProperty, box v)
        | FilterControlEditorProp.Index v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControlEditor.IndexProperty, box v)

    let parameterService v : obj = box (FilterControlEditorExProp.ParameterService v)
    let selectedParameter v : obj = box (FilterControlEditorExProp.SelectedParameter v)
    let useCascadeParameters v : obj = box (FilterControlEditorExProp.UseCascadeParameters v)
    let parametersColumnTemplate v : obj = box (FilterControlEditorExProp.ParametersColumnTemplate v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
