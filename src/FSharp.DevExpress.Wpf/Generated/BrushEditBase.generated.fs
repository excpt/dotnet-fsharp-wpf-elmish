...
type BrushEditBaseProp =
    | Base of BaseEditProp

module BrushEditBase =

    let apply (el: DevExpress.Xpf.Editors.BrushEditBase) (prop: BrushEditBaseProp) =
        match prop with
        | BrushEditBaseProp.Base p -> BaseEdit.apply el p
