...
type PaneProp =
    ...
    | EnableAxisXNavigation of obj
    | EnableAxisYNavigation of obj
    | AxisXScrollBarOptions of DevExpress.Xpf.Charts.ScrollBarOptions
    | AxisYScrollBarOptions of DevExpress.Xpf.Charts.ScrollBarOptions
    | DomainBrush of System.Windows.Media.Brush
    | DomainBorderBrush of System.Windows.Media.Brush
    | DomainMargin of System.Windows.Thickness
    | MirrorHeight of float
    | Title of DevExpress.Xpf.Charts.PaneTitle
    | Collapsed of bool
    | RuntimeCollapse of obj
    | CrosshairArgumentBrush of System.Windows.Media.Brush
    | CrosshairValueBrush of System.Windows.Media.Brush
    | CrosshairArgumentLineStyle of DevExpress.Xpf.Charts.LineStyle
    | CrosshairValueLineStyle of DevExpress.Xpf.Charts.LineStyle
    | PaneItems of obj
    | SeriesLabelItems of obj
    | TotalLabelItems of obj
    | Pseudo3DPointItems of obj
    | ChartDataTable of DevExpress.Xpf.Charts.ChartDataTable

module Pane =
    let enableAxisXNavigation v : obj = box (PaneProp.EnableAxisXNavigation v)
    let enableAxisYNavigation v : obj = box (PaneProp.EnableAxisYNavigation v)
    let axisXScrollBarOptions v : obj = box (PaneProp.AxisXScrollBarOptions v)
    let axisYScrollBarOptions v : obj = box (PaneProp.AxisYScrollBarOptions v)
    let domainBrush v : obj = box (PaneProp.DomainBrush v)
    let domainBorderBrush v : obj = box (PaneProp.DomainBorderBrush v)
    let domainMargin v : obj = box (PaneProp.DomainMargin v)
    let mirrorHeight v : obj = box (PaneProp.MirrorHeight v)
    let title v : obj = box (PaneProp.Title v)
    let collapsed v : obj = box (PaneProp.Collapsed v)
    let runtimeCollapse v : obj = box (PaneProp.RuntimeCollapse v)
    let crosshairArgumentBrush v : obj = box (PaneProp.CrosshairArgumentBrush v)
    let crosshairValueBrush v : obj = box (PaneProp.CrosshairValueBrush v)
    let crosshairArgumentLineStyle v : obj = box (PaneProp.CrosshairArgumentLineStyle v)
    let crosshairValueLineStyle v : obj = box (PaneProp.CrosshairValueLineStyle v)
    let paneItems v : obj = box (PaneProp.PaneItems v)
    let seriesLabelItems v : obj = box (PaneProp.SeriesLabelItems v)
    let totalLabelItems v : obj = box (PaneProp.TotalLabelItems v)
    let pseudo3DPointItems v : obj = box (PaneProp.Pseudo3DPointItems v)
    let chartDataTable v : obj = box (PaneProp.ChartDataTable v)

    let apply (el: DevExpress.Xpf.Charts.Pane) (prop: PaneProp) =
        match prop with
        | PaneProp.Base p -> ChartElement.apply el p
        | PaneProp.EnableAxisXNavigation v -> el.SetValue(DevExpress.Xpf.Charts.Pane.EnableAxisXNavigationProperty, box v)
        | PaneProp.EnableAxisYNavigation v -> el.SetValue(DevExpress.Xpf.Charts.Pane.EnableAxisYNavigationProperty, box v)
        | PaneProp.AxisXScrollBarOptions v -> el.SetValue(DevExpress.Xpf.Charts.Pane.AxisXScrollBarOptionsProperty, box v)
        | PaneProp.AxisYScrollBarOptions v -> el.SetValue(DevExpress.Xpf.Charts.Pane.AxisYScrollBarOptionsProperty, box v)
        | PaneProp.DomainBrush v -> el.SetValue(DevExpress.Xpf.Charts.Pane.DomainBrushProperty, box v)
        | PaneProp.DomainBorderBrush v -> el.SetValue(DevExpress.Xpf.Charts.Pane.DomainBorderBrushProperty, box v)
        | PaneProp.DomainMargin v -> el.SetValue(DevExpress.Xpf.Charts.Pane.DomainMarginProperty, box v)
        | PaneProp.MirrorHeight v -> el.SetValue(DevExpress.Xpf.Charts.Pane.MirrorHeightProperty, box v)
        | PaneProp.Title v -> el.SetValue(DevExpress.Xpf.Charts.Pane.TitleProperty, box v)
        | PaneProp.Collapsed v -> el.SetValue(DevExpress.Xpf.Charts.Pane.CollapsedProperty, box v)
        | PaneProp.RuntimeCollapse v -> el.SetValue(DevExpress.Xpf.Charts.Pane.RuntimeCollapseProperty, box v)
        | PaneProp.CrosshairArgumentBrush v -> el.SetValue(DevExpress.Xpf.Charts.Pane.CrosshairArgumentBrushProperty, box v)
        | PaneProp.CrosshairValueBrush v -> el.SetValue(DevExpress.Xpf.Charts.Pane.CrosshairValueBrushProperty, box v)
        | PaneProp.CrosshairArgumentLineStyle v -> el.SetValue(DevExpress.Xpf.Charts.Pane.CrosshairArgumentLineStyleProperty, box v)
        | PaneProp.CrosshairValueLineStyle v -> el.SetValue(DevExpress.Xpf.Charts.Pane.CrosshairValueLineStyleProperty, box v)
        | PaneProp.PaneItems v -> el.SetValue(DevExpress.Xpf.Charts.Pane.PaneItemsProperty, box v)
        | PaneProp.SeriesLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.Pane.SeriesLabelItemsProperty, box v)
        | PaneProp.TotalLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.Pane.TotalLabelItemsProperty, box v)
        | PaneProp.Pseudo3DPointItems v -> el.SetValue(DevExpress.Xpf.Charts.Pane.Pseudo3DPointItemsProperty, box v)
        | PaneProp.ChartDataTable v -> el.SetValue(DevExpress.Xpf.Charts.Pane.ChartDataTableProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Pane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
