...
open System
open System.Windows
open DevExpress.Xpf.Editors.Popups
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type EditorListBoxProp =
    | AllowItemHighlighting of bool
    | ScrollUnit2 of DevExpress.Xpf.Editors.ScrollUnit

module EditorListBox =
    let allowItemHighlighting v : obj = box (EditorListBoxProp.AllowItemHighlighting v)
    let scrollUnit2 v : obj = box (EditorListBoxProp.ScrollUnit2 v)

    let apply (el: DevExpress.Xpf.Editors.Popups.EditorListBox) (prop: EditorListBoxProp) =
        match prop with
        | EditorListBoxProp.AllowItemHighlighting v -> el.SetValue(DevExpress.Xpf.Editors.Popups.EditorListBox.AllowItemHighlightingProperty, box v)
        | EditorListBoxProp.ScrollUnit2 v -> el.SetValue(DevExpress.Xpf.Editors.Popups.EditorListBox.ScrollUnit2Property, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.EditorListBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
