...
type GradientBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module GradientBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.GradientBar2DModelControl) (prop: GradientBar2DModelControlProp) =
        match prop with
        | GradientBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GradientBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
