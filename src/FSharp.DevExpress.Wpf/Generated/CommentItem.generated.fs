...
type CommentItemProp =
    | Text of string
    | TextSettings of DevExpress.Xpf.Spreadsheet.Internal.CommentTextSettings
    | IsReadOnly of bool

module CommentItem =
    let text v : obj = box (CommentItemProp.Text v)
    let textSettings v : obj = box (CommentItemProp.TextSettings v)
    let isReadOnly v : obj = box (CommentItemProp.IsReadOnly v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.CommentItem) (prop: CommentItemProp) =
        match prop with
        | CommentItemProp.Text v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.CommentItem.TextProperty, box v)
        | CommentItemProp.TextSettings v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.CommentItem.TextSettingsProperty, box v)
        | CommentItemProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.CommentItem.IsReadOnlyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.CommentItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
