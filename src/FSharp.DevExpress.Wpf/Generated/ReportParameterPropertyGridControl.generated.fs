...
type ReportParameterPropertyGridControlProp =
    | ReportParameter of DevExpress.Data.IParameter

module ReportParameterPropertyGridControl =
    let reportParameter v : obj = box (ReportParameterPropertyGridControlProp.ReportParameter v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterPropertyGridControl) (prop: ReportParameterPropertyGridControlProp) =
        match prop with
        | ReportParameterPropertyGridControlProp.ReportParameter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterPropertyGridControl.ReportParameterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterPropertyGridControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
