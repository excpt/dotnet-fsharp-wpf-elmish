...
type DayAppointmentControlProp =
    | Base of AppointmentVerticalControlProp

module DayAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DayAppointmentControl) (prop: DayAppointmentControlProp) =
        match prop with
        | DayAppointmentControlProp.Base p -> AppointmentVerticalControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DayAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
