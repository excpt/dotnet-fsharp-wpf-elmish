...
type ThemeableLinearScaleLevelBarControlProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableLinearScaleLevelBarControl =
    let themeFill v : obj = box (ThemeableLinearScaleLevelBarControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableLinearScaleLevelBarControl) (prop: ThemeableLinearScaleLevelBarControlProp) =
        match prop with
        | ThemeableLinearScaleLevelBarControlProp.Base p -> PresentationControl.apply el p
        | ThemeableLinearScaleLevelBarControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableLinearScaleLevelBarControl.ThemeFillProperty, box v)
