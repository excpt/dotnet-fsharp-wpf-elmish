...
type RegressionLineProp =
    | Base of IndicatorProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel

module RegressionLine =
    let valueLevel v : obj = box (RegressionLineProp.ValueLevel v)

    let apply (el: DevExpress.Xpf.Charts.RegressionLine) (prop: RegressionLineProp) =
        match prop with
        | RegressionLineProp.Base p -> Indicator.apply el p
        | RegressionLineProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.RegressionLine.ValueLevelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RegressionLine>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
