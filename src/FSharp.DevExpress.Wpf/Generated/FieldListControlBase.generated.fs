...
type FieldListControlBaseProp =
    | Base of ColumnChooserControlBaseProp
    | GroupFields of bool
    | IncludeVisibleFields of bool

module FieldListControlBase =
    ...
    let apply (el: DevExpress.Xpf.PivotGrid.FieldListControlBase) (prop: FieldListControlBaseProp) =
        match prop with
        | FieldListControlBaseProp.Base p -> ColumnChooserControlBase.apply el p
        | FieldListControlBaseProp.GroupFields v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldListControlBase.GroupFieldsProperty, box v)
        | FieldListControlBaseProp.IncludeVisibleFields v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldListControlBase.IncludeVisibleFieldsProperty, box v)
