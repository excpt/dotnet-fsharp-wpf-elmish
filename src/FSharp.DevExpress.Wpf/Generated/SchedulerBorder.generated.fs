...
type SchedulerBorderProp =
    | CornerRadius of System.Windows.CornerRadius

module SchedulerBorder =
    let cornerRadius v : obj = box (SchedulerBorderProp.CornerRadius v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerBorder) (prop: SchedulerBorderProp) =
        match prop with
        | SchedulerBorderProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerBorder.CornerRadiusProperty, box v)
