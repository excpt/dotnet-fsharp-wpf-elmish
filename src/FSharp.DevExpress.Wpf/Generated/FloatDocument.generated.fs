...
type FloatDocumentProp =
    | Base of DocumentProp

module FloatDocument =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatDocument) (prop: FloatDocumentProp) =
        match prop with
        | FloatDocumentProp.Base p -> Document.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FloatDocument>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
