...
type DXSeparatorProp =
    | Orientation of System.Windows.Controls.Orientation

module DXSeparator =
    let orientation v : obj = box (DXSeparatorProp.Orientation v)

    let apply (el: DevExpress.Xpf.Editors.Controls.DXSeparator) (prop: DXSeparatorProp) =
        match prop with
        | DXSeparatorProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.Controls.DXSeparator.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Controls.DXSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
