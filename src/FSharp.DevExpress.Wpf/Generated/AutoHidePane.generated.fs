...
type AutoHidePaneProp =
    | Base of psvContentControlProp
    | PanelSize of float
    | AutoHideTray of DevExpress.Xpf.Docking.VisualElements.AutoHideTray
    | DisplayMode of DevExpress.Xpf.Docking.Base.AutoHideMode
    | ViewStyle of DevExpress.Xpf.Docking.DockingViewStyle

module AutoHidePane =
    let panelSize v : obj = box (AutoHidePaneProp.PanelSize v)
    let autoHideTray v : obj = box (AutoHidePaneProp.AutoHideTray v)
    let displayMode v : obj = box (AutoHidePaneProp.DisplayMode v)
    let viewStyle v : obj = box (AutoHidePaneProp.ViewStyle v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AutoHidePane) (prop: AutoHidePaneProp) =
        match prop with
        | AutoHidePaneProp.Base p -> psvContentControl.apply el p
        | AutoHidePaneProp.PanelSize v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePane.PanelSizeProperty, box v)
        | AutoHidePaneProp.AutoHideTray v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePane.AutoHideTrayProperty, box v)
        | AutoHidePaneProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePane.DisplayModeProperty, box v)
        | AutoHidePaneProp.ViewStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePane.ViewStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AutoHidePane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
