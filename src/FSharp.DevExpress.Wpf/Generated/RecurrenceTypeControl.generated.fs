...
type RecurrenceTypeControlProp =
    | RecurrenceInfo of DevExpress.XtraScheduler.RecurrenceInfo
    | Controller of DevExpress.Xpf.Scheduler.UI.RecurrenceVisualController
    | IsReadOnly of bool

module RecurrenceTypeControl =
    let recurrenceInfo v : obj = box (RecurrenceTypeControlProp.RecurrenceInfo v)
    let controller v : obj = box (RecurrenceTypeControlProp.Controller v)
    let isReadOnly v : obj = box (RecurrenceTypeControlProp.IsReadOnly v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RecurrenceTypeControl) (prop: RecurrenceTypeControlProp) =
        match prop with
        | RecurrenceTypeControlProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceTypeControl.RecurrenceInfoProperty, box v)
        | RecurrenceTypeControlProp.Controller v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceTypeControl.ControllerProperty, box v)
        | RecurrenceTypeControlProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceTypeControl.IsReadOnlyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RecurrenceTypeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
