...
type PopupLinearGradientBrushEditStyleSettingsProp =
    | Base of PopupBrushEditStyleSettingsBaseProp

module PopupLinearGradientBrushEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupLinearGradientBrushEditStyleSettings) (prop: PopupLinearGradientBrushEditStyleSettingsProp) =
        match prop with
        | PopupLinearGradientBrushEditStyleSettingsProp.Base p -> PopupBrushEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupLinearGradientBrushEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
