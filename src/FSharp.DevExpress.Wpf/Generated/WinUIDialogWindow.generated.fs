...
type WinUIDialogWindowProp =
    | Base of DXDialogWindowProp
    | ContentStyle of System.Windows.Style
    | TitleStyle of System.Windows.Style

module WinUIDialogWindow =
    let contentStyle v : obj = box (WinUIDialogWindowProp.ContentStyle v)
    let titleStyle v : obj = box (WinUIDialogWindowProp.TitleStyle v)

    let apply (el: DevExpress.Xpf.WindowsUI.WinUIDialogWindow) (prop: WinUIDialogWindowProp) =
        match prop with
        | WinUIDialogWindowProp.Base p -> DXDialogWindow.apply el p
        | WinUIDialogWindowProp.ContentStyle v -> el.SetValue(DevExpress.Xpf.WindowsUI.WinUIDialogWindow.ContentStyleProperty, box v)
        | WinUIDialogWindowProp.TitleStyle v -> el.SetValue(DevExpress.Xpf.WindowsUI.WinUIDialogWindow.TitleStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.WinUIDialogWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
