...
type CellContentPresenterProp =
    | RowData of DevExpress.Xpf.Grid.RowData
    | FieldName of string
    | Column of DevExpress.Xpf.Grid.ColumnBase
    | ColumnPosition of DevExpress.Xpf.Grid.ColumnPosition
    | HasRightSibling of bool
    | HasLeftSibling of bool
    | HasTopElement of bool
    | ShowVerticalLines of bool
    | ShowHorizontalLines of bool
    | BorderState of System.Windows.Thickness
    | IsSelected of bool
    | IsFocusedCell of bool
    | SelectionState of DevExpress.Xpf.Grid.SelectionState
    | IsReady of bool

module CellContentPresenter =
    let rowData v : obj = box (CellContentPresenterProp.RowData v)
    let fieldName v : obj = box (CellContentPresenterProp.FieldName v)
    let column v : obj = box (CellContentPresenterProp.Column v)
    let columnPosition v : obj = box (CellContentPresenterProp.ColumnPosition v)
    let hasRightSibling v : obj = box (CellContentPresenterProp.HasRightSibling v)
    let hasLeftSibling v : obj = box (CellContentPresenterProp.HasLeftSibling v)
    let hasTopElement v : obj = box (CellContentPresenterProp.HasTopElement v)
    let showVerticalLines v : obj = box (CellContentPresenterProp.ShowVerticalLines v)
    let showHorizontalLines v : obj = box (CellContentPresenterProp.ShowHorizontalLines v)
    let borderState v : obj = box (CellContentPresenterProp.BorderState v)
    let isSelected v : obj = box (CellContentPresenterProp.IsSelected v)
    let isFocusedCell v : obj = box (CellContentPresenterProp.IsFocusedCell v)
    let selectionState v : obj = box (CellContentPresenterProp.SelectionState v)
    let isReady v : obj = box (CellContentPresenterProp.IsReady v)

    let apply (el: DevExpress.Xpf.Grid.CellContentPresenter) (prop: CellContentPresenterProp) =
        match prop with
        | CellContentPresenterProp.RowData v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.RowDataProperty, box v)
        | CellContentPresenterProp.FieldName v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.FieldNameProperty, box v)
        | CellContentPresenterProp.Column v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.ColumnProperty, box v)
        | CellContentPresenterProp.ColumnPosition v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.ColumnPositionProperty, box v)
        | CellContentPresenterProp.HasRightSibling v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.HasRightSiblingProperty, box v)
        | CellContentPresenterProp.HasLeftSibling v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.HasLeftSiblingProperty, box v)
        | CellContentPresenterProp.HasTopElement v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.HasTopElementProperty, box v)
        | CellContentPresenterProp.ShowVerticalLines v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.ShowVerticalLinesProperty, box v)
        | CellContentPresenterProp.ShowHorizontalLines v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.ShowHorizontalLinesProperty, box v)
        | CellContentPresenterProp.BorderState v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.BorderStateProperty, box v)
        | CellContentPresenterProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.IsSelectedProperty, box v)
        | CellContentPresenterProp.IsFocusedCell v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.IsFocusedCellProperty, box v)
        | CellContentPresenterProp.SelectionState v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.SelectionStateProperty, box v)
        | CellContentPresenterProp.IsReady v -> el.SetValue(DevExpress.Xpf.Grid.CellContentPresenter.IsReadyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.CellContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
