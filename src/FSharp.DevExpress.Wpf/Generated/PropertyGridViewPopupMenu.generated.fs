...
type PropertyGridViewPopupMenuProp =
    | Base of GridPopupMenuBaseProp

module PropertyGridViewPopupMenu =

    let apply (el: DevExpress.Xpf.PropertyGrid.PropertyGridViewPopupMenu) (prop: PropertyGridViewPopupMenuProp) =
        match prop with
        | PropertyGridViewPopupMenuProp.Base p -> GridPopupMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PropertyGridViewPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
