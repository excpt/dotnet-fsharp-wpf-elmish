...
type IStyleSpindleCapControlProp =
    | Base of PresentationControlProp

module IStyleSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleSpindleCapControl) (prop: IStyleSpindleCapControlProp) =
        match prop with
        | IStyleSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
