...
type TimelineCellPanelProp =
    | Base of PixelSnappedUniformGridProp

module TimelineCellPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.TimelineCellPanel) (prop: TimelineCellPanelProp) =
        match prop with
        | TimelineCellPanelProp.Base p -> PixelSnappedUniformGrid.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.TimelineCellPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
