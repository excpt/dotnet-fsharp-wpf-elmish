...
type BarItemLinkSeparatorControlProp =
    | Base of BarItemLinkControlProp
    | InMenuContentOffset of float

module BarItemLinkSeparatorControl =
    let inMenuContentOffset v : obj = box (BarItemLinkSeparatorControlProp.InMenuContentOffset v)

    let apply (el: DevExpress.Xpf.Bars.BarItemLinkSeparatorControl) (prop: BarItemLinkSeparatorControlProp) =
        match prop with
        | BarItemLinkSeparatorControlProp.Base p -> BarItemLinkControl.apply el p
        | BarItemLinkSeparatorControlProp.InMenuContentOffset v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkSeparatorControl.InMenuContentOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemLinkSeparatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
