...
type ConditionalFormattingHighlightCellsRuleControlProp =
    | Base of ReferenceEditBaseControlProp

module ConditionalFormattingHighlightCellsRuleControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ConditionalFormattingHighlightCellsRuleControl) (prop: ConditionalFormattingHighlightCellsRuleControlProp) =
        match prop with
        | ConditionalFormattingHighlightCellsRuleControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ConditionalFormattingHighlightCellsRuleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
