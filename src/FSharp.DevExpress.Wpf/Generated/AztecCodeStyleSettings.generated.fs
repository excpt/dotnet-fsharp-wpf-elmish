...
type AztecCodeStyleSettingsProp =
    | CompactionMode of DevExpress.XtraPrinting.BarCode.AztecCodeCompactionMode
    | Version of DevExpress.XtraPrinting.BarCode.AztecCodeVersion
    | ErrorCorrectionLevel of DevExpress.XtraPrinting.BarCode.AztecCodeErrorCorrectionLevel

module AztecCodeStyleSettings =
    let compactionMode v : obj = box (AztecCodeStyleSettingsProp.CompactionMode v)
    let version v : obj = box (AztecCodeStyleSettingsProp.Version v)
    let errorCorrectionLevel v : obj = box (AztecCodeStyleSettingsProp.ErrorCorrectionLevel v)

    let apply (el: DevExpress.Xpf.Editors.AztecCodeStyleSettings) (prop: AztecCodeStyleSettingsProp) =
        match prop with
        | AztecCodeStyleSettingsProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.AztecCodeStyleSettings.CompactionModeProperty, box v)
        | AztecCodeStyleSettingsProp.Version v -> el.SetValue(DevExpress.Xpf.Editors.AztecCodeStyleSettings.VersionProperty, box v)
        | AztecCodeStyleSettingsProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Editors.AztecCodeStyleSettings.ErrorCorrectionLevelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.AztecCodeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
