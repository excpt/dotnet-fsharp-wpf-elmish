...
type CircularFlatLightThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatLightThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatLightThreeQuartersModel) (prop: CircularFlatLightThreeQuartersModelProp) =
        match prop with
        | CircularFlatLightThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatLightThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
