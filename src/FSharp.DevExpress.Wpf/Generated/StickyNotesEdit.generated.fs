...
type StickyNotesEditProp =
    | Base of BaseEditProp
    | Title of string

module StickyNotesEdit =
    let title v : obj = box (StickyNotesEditProp.Title v)

    let apply (el: DevExpress.Xpf.PdfViewer.StickyNotesEdit) (prop: StickyNotesEditProp) =
        match prop with
        | StickyNotesEditProp.Base p -> BaseEdit.apply el p
        | StickyNotesEditProp.Title v -> el.SetValue(DevExpress.Xpf.PdfViewer.StickyNotesEdit.TitleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.StickyNotesEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
