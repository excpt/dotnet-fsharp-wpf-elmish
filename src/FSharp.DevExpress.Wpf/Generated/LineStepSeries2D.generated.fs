...
type LineStepSeries2DProp =
    | Base of LineSeries2DProp
    | InvertedStep of bool
    | SnapCrosshairToActualStep of bool

module LineStepSeries2D =
    let invertedStep v : obj = box (LineStepSeries2DProp.InvertedStep v)
    let snapCrosshairToActualStep v : obj = box (LineStepSeries2DProp.SnapCrosshairToActualStep v)

    let apply (el: DevExpress.Xpf.Charts.LineStepSeries2D) (prop: LineStepSeries2DProp) =
        match prop with
        | LineStepSeries2DProp.Base p -> LineSeries2D.apply el p
        | LineStepSeries2DProp.InvertedStep v -> el.SetValue(DevExpress.Xpf.Charts.LineStepSeries2D.InvertedStepProperty, box v)
        | LineStepSeries2DProp.SnapCrosshairToActualStep v -> el.SetValue(DevExpress.Xpf.Charts.LineStepSeries2D.SnapCrosshairToActualStepProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LineStepSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
