...
type TrafficLightsRedStatePresentationControlProp =
    | Base of PresentationControlProp

module TrafficLightsRedStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.TrafficLightsRedStatePresentationControl) (prop: TrafficLightsRedStatePresentationControlProp) =
        match prop with
        | TrafficLightsRedStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.TrafficLightsRedStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
