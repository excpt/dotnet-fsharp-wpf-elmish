...
type RibbonQuickAccessToolbarPopupBorderControlProp =
    | Base of PopupBorderControlProp

module RibbonQuickAccessToolbarPopupBorderControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonQuickAccessToolbarPopupBorderControl) (prop: RibbonQuickAccessToolbarPopupBorderControlProp) =
        match prop with
        | RibbonQuickAccessToolbarPopupBorderControlProp.Base p -> PopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonQuickAccessToolbarPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
