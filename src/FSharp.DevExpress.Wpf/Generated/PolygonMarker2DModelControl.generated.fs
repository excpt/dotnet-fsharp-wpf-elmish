...
type PolygonMarker2DModelControlProp =
    | Base of PredefinedMarker2DModelControlProp

module PolygonMarker2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.PolygonMarker2DModelControl) (prop: PolygonMarker2DModelControlProp) =
        match prop with
        | PolygonMarker2DModelControlProp.Base p -> PredefinedMarker2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolygonMarker2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
