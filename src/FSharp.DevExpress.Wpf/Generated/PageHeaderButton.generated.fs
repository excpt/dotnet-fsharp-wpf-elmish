...
type PageHeaderButtonProp =
    | Glyph of System.Windows.Media.ImageSource
    | CornerRadius of System.Windows.CornerRadius
    | GlyphWidth of float
    | GlyphHeight of float

module PageHeaderButton =
    let glyph v : obj = box (PageHeaderButtonProp.Glyph v)
    let cornerRadius v : obj = box (PageHeaderButtonProp.CornerRadius v)
    let glyphWidth v : obj = box (PageHeaderButtonProp.GlyphWidth v)
    let glyphHeight v : obj = box (PageHeaderButtonProp.GlyphHeight v)

    let apply (el: DevExpress.Xpf.Ribbon.PageHeaderButton) (prop: PageHeaderButtonProp) =
        match prop with
        | PageHeaderButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.Ribbon.PageHeaderButton.GlyphProperty, box v)
        | PageHeaderButtonProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Ribbon.PageHeaderButton.CornerRadiusProperty, box v)
        | PageHeaderButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.PageHeaderButton.GlyphWidthProperty, box v)
        | PageHeaderButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.Ribbon.PageHeaderButton.GlyphHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.PageHeaderButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
