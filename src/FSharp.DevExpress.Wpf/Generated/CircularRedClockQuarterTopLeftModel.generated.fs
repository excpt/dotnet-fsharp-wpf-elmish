...
type CircularRedClockQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularRedClockQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularRedClockQuarterTopLeftModel) (prop: CircularRedClockQuarterTopLeftModelProp) =
        match prop with
        | CircularRedClockQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularRedClockQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
