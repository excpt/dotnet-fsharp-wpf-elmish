...
type ProgressiveQuarterTopRightArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveQuarterTopRightArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveQuarterTopRightArcScaleForegroundLayerControl) (prop: ProgressiveQuarterTopRightArcScaleForegroundLayerControlProp) =
        match prop with
        | ProgressiveQuarterTopRightArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveQuarterTopRightArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
