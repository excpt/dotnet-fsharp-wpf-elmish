...
type FileDialogToolbarControlProp =
    | Base of ToolBarControlProp

module FileDialogToolbarControl =

    let apply (el: DevExpress.Xpf.Dialogs.Native.FileDialogToolbarControl) (prop: FileDialogToolbarControlProp) =
        match prop with
        | FileDialogToolbarControlProp.Base p -> ToolBarControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.FileDialogToolbarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
