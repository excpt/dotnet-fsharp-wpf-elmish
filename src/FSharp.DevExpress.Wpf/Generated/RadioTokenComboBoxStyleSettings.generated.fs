...
type RadioTokenComboBoxStyleSettingsProp =
    | Base of RadioComboBoxStyleSettingsProp
...
module RadioTokenComboBoxStyleSettings =
    let showTokenButtons v : obj = box (RadioTokenComboBoxStyleSettingsProp.ShowTokenButtons v)
    let tokenBorderTemplate v : obj = box (RadioTokenComboBoxStyleSettingsProp.TokenBorderTemplate v)
    let enableTokenWrapping v : obj = box (RadioTokenComboBoxStyleSettingsProp.EnableTokenWrapping v)
    let newTokenPosition v : obj = box (RadioTokenComboBoxStyleSettingsProp.NewTokenPosition v)
    let tokenTextTrimming v : obj = box (RadioTokenComboBoxStyleSettingsProp.TokenTextTrimming v)
    let tokenMaxWidth v : obj = box (RadioTokenComboBoxStyleSettingsProp.TokenMaxWidth v)
    let allowEditTokens v : obj = box (RadioTokenComboBoxStyleSettingsProp.AllowEditTokens v)
    let tokenStyle v : obj = box (RadioTokenComboBoxStyleSettingsProp.TokenStyle v)
    let newTokenText v : obj = box (RadioTokenComboBoxStyleSettingsProp.NewTokenText v)

    let apply (el: DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings) (prop: RadioTokenComboBoxStyleSettingsProp) =
        match prop with
        | RadioTokenComboBoxStyleSettingsProp.Base p -> RadioComboBoxStyleSettings.apply el p
        | RadioTokenComboBoxStyleSettingsProp.ShowTokenButtons v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.ShowTokenButtonsProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.TokenBorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.TokenBorderTemplateProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.EnableTokenWrapping v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.EnableTokenWrappingProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.NewTokenPosition v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.NewTokenPositionProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.TokenTextTrimming v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.TokenTextTrimmingProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.TokenMaxWidth v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.TokenMaxWidthProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.AllowEditTokens v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.AllowEditTokensProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.TokenStyle v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.TokenStyleProperty, box v)
        | RadioTokenComboBoxStyleSettingsProp.NewTokenText v -> el.SetValue(DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings.NewTokenTextProperty, box v)

    let showEmptyItem v : obj = box (RadioComboBoxStyleSettingsProp.ShowEmptyItem v)
    let emptyItemText v : obj = box (RadioComboBoxStyleSettingsProp.EmptyItemText v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RadioTokenComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
