...
type TextBoxDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module TextBoxDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.TextBoxDashboardLayoutItem) (prop: TextBoxDashboardLayoutItemProp) =
        match prop with
        | TextBoxDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.TextBoxDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
