...
type ContentHostProp =
    | Base of ContentHostBaseProp

module ContentHost =

    let apply (el: DevExpress.Xpf.Core.ContentHost) (prop: ContentHostProp) =
        match prop with
        | ContentHostProp.Base p -> ContentHostBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ContentHost>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
