...
type SchedulerScrollViewerProp =
    | CornerBoxStyle of System.Windows.Style
    | HorizontalScrollBarControlBoxVisibility of System.Windows.Visibility
    | VerticalScrollBarControlBoxVisibility of System.Windows.Visibility
    | HorizontalScrollBarControlBox of obj
    | HorizontalScrollBarControlBoxTemplate of System.Windows.DataTemplate
    | VerticalScrollBarControlBox of obj
    | VerticalScrollBarControlBoxTemplate of System.Windows.DataTemplate
    | SetHorizontalOffset of float
    | SetVerticalOffset of float
    | IsDeferredVerticalScrollingEnabled of bool
    | ShowScrollTip of bool
    | HScrollSnapping of bool
    | VScrollSnapping of bool

module SchedulerScrollViewer =
    let cornerBoxStyle v : obj = box (SchedulerScrollViewerProp.CornerBoxStyle v)
    let horizontalScrollBarControlBoxVisibility v : obj = box (SchedulerScrollViewerProp.HorizontalScrollBarControlBoxVisibility v)
    let verticalScrollBarControlBoxVisibility v : obj = box (SchedulerScrollViewerProp.VerticalScrollBarControlBoxVisibility v)
    let horizontalScrollBarControlBox v : obj = box (SchedulerScrollViewerProp.HorizontalScrollBarControlBox v)
    let horizontalScrollBarControlBoxTemplate v : obj = box (SchedulerScrollViewerProp.HorizontalScrollBarControlBoxTemplate v)
    let verticalScrollBarControlBox v : obj = box (SchedulerScrollViewerProp.VerticalScrollBarControlBox v)
    let verticalScrollBarControlBoxTemplate v : obj = box (SchedulerScrollViewerProp.VerticalScrollBarControlBoxTemplate v)
    let setHorizontalOffset v : obj = box (SchedulerScrollViewerProp.SetHorizontalOffset v)
    let setVerticalOffset v : obj = box (SchedulerScrollViewerProp.SetVerticalOffset v)
    let isDeferredVerticalScrollingEnabled v : obj = box (SchedulerScrollViewerProp.IsDeferredVerticalScrollingEnabled v)
    let showScrollTip v : obj = box (SchedulerScrollViewerProp.ShowScrollTip v)
    let hScrollSnapping v : obj = box (SchedulerScrollViewerProp.HScrollSnapping v)
    let vScrollSnapping v : obj = box (SchedulerScrollViewerProp.VScrollSnapping v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer) (prop: SchedulerScrollViewerProp) =
        match prop with
        | SchedulerScrollViewerProp.CornerBoxStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.CornerBoxStyleProperty, box v)
        | SchedulerScrollViewerProp.HorizontalScrollBarControlBoxVisibility v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.HorizontalScrollBarControlBoxVisibilityProperty, box v)
        | SchedulerScrollViewerProp.VerticalScrollBarControlBoxVisibility v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.VerticalScrollBarControlBoxVisibilityProperty, box v)
        | SchedulerScrollViewerProp.HorizontalScrollBarControlBox v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.HorizontalScrollBarControlBoxProperty, box v)
        | SchedulerScrollViewerProp.HorizontalScrollBarControlBoxTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.HorizontalScrollBarControlBoxTemplateProperty, box v)
        | SchedulerScrollViewerProp.VerticalScrollBarControlBox v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.VerticalScrollBarControlBoxProperty, box v)
        | SchedulerScrollViewerProp.VerticalScrollBarControlBoxTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.VerticalScrollBarControlBoxTemplateProperty, box v)
        | SchedulerScrollViewerProp.SetHorizontalOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.SetHorizontalOffsetProperty, box v)
        | SchedulerScrollViewerProp.SetVerticalOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.SetVerticalOffsetProperty, box v)
        | SchedulerScrollViewerProp.IsDeferredVerticalScrollingEnabled v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.IsDeferredVerticalScrollingEnabledProperty, box v)
        | SchedulerScrollViewerProp.ShowScrollTip v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.ShowScrollTipProperty, box v)
        | SchedulerScrollViewerProp.HScrollSnapping v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.HScrollSnappingProperty, box v)
        | SchedulerScrollViewerProp.VScrollSnapping v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer.VScrollSnappingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.SchedulerScrollViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
