...
type NestedDonutSeries2DProp =
    | Base of PieSeries2DProp
    | Group of obj
    | InnerIndent of float
    | Weight of float

module NestedDonutSeries2D =
    let group v : obj = box (NestedDonutSeries2DProp.Group v)
    let innerIndent v : obj = box (NestedDonutSeries2DProp.InnerIndent v)
    let weight v : obj = box (NestedDonutSeries2DProp.Weight v)

    let apply (el: DevExpress.Xpf.Charts.NestedDonutSeries2D) (prop: NestedDonutSeries2DProp) =
        match prop with
        | NestedDonutSeries2DProp.Base p -> PieSeries2D.apply el p
        | NestedDonutSeries2DProp.Group v -> el.SetValue(DevExpress.Xpf.Charts.NestedDonutSeries2D.GroupProperty, box v)
        | NestedDonutSeries2DProp.InnerIndent v -> el.SetValue(DevExpress.Xpf.Charts.NestedDonutSeries2D.InnerIndentProperty, box v)
        | NestedDonutSeries2DProp.Weight v -> el.SetValue(DevExpress.Xpf.Charts.NestedDonutSeries2D.WeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.NestedDonutSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
