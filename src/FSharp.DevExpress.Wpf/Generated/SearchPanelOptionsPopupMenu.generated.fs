...
type SearchPanelOptionsPopupMenuProp =
    | Base of CustomizablePopupMenuBaseProp

module SearchPanelOptionsPopupMenu =

    let apply (el: DevExpress.Xpf.Core.Native.SearchPanelOptionsPopupMenu) (prop: SearchPanelOptionsPopupMenuProp) =
        match prop with
        | SearchPanelOptionsPopupMenuProp.Base p -> CustomizablePopupMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.SearchPanelOptionsPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
