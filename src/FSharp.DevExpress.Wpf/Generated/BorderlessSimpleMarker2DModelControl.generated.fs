...
type BorderlessSimpleMarker2DModelControlProp =
    | Base of PredefinedMarker2DModelControlProp

module BorderlessSimpleMarker2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderlessSimpleMarker2DModelControl) (prop: BorderlessSimpleMarker2DModelControlProp) =
        match prop with
        | BorderlessSimpleMarker2DModelControlProp.Base p -> PredefinedMarker2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderlessSimpleMarker2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
