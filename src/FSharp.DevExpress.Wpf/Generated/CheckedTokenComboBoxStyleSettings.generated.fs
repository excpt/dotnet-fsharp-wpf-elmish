...
type CheckedTokenComboBoxStyleSettingsProp =
    | Base of CheckedComboBoxStyleSettingsProp
    | ShowTokenButtons of obj
    | TokenBorderTemplate of System.Windows.Controls.ControlTemplate
    | EnableTokenWrapping of obj
    | NewTokenPosition of obj
    | TokenTextTrimming of obj
    | TokenMaxWidth of obj
    | AllowEditTokens of obj
    | TokenStyle of System.Windows.Style
    | NewTokenText of string
    | FilterOutSelectedTokens of bool

module CheckedTokenComboBoxStyleSettings =
    let showTokenButtons v : obj = box (CheckedTokenComboBoxStyleSettingsProp.ShowTokenButtons v)
    let tokenBorderTemplate v : obj = box (CheckedTokenComboBoxStyleSettingsProp.TokenBorderTemplate v)
    let enableTokenWrapping v : obj = box (CheckedTokenComboBoxStyleSettingsProp.EnableTokenWrapping v)
    let newTokenPosition v : obj = box (CheckedTokenComboBoxStyleSettingsProp.NewTokenPosition v)
    let tokenTextTrimming v : obj = box (CheckedTokenComboBoxStyleSettingsProp.TokenTextTrimming v)
    let tokenMaxWidth v : obj = box (CheckedTokenComboBoxStyleSettingsProp.TokenMaxWidth v)
    let allowEditTokens v : obj = box (CheckedTokenComboBoxStyleSettingsProp.AllowEditTokens v)
    let tokenStyle v : obj = box (CheckedTokenComboBoxStyleSettingsProp.TokenStyle v)
    let newTokenText v : obj = box (CheckedTokenComboBoxStyleSettingsProp.NewTokenText v)
    let filterOutSelectedTokens v : obj = box (CheckedTokenComboBoxStyleSettingsProp.FilterOutSelectedTokens v)

    let apply (el: DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings) (prop: CheckedTokenComboBoxStyleSettingsProp) =
        match prop with
        | CheckedTokenComboBoxStyleSettingsProp.Base p -> CheckedComboBoxStyleSettings.apply el p
        | CheckedTokenComboBoxStyleSettingsProp.ShowTokenButtons v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.ShowTokenButtonsProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.TokenBorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.TokenBorderTemplateProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.EnableTokenWrapping v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.EnableTokenWrappingProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.NewTokenPosition v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.NewTokenPositionProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.TokenTextTrimming v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.TokenTextTrimmingProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.TokenMaxWidth v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.TokenMaxWidthProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.AllowEditTokens v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.AllowEditTokensProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.TokenStyle v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.TokenStyleProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.NewTokenText v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.NewTokenTextProperty, box v)
        | CheckedTokenComboBoxStyleSettingsProp.FilterOutSelectedTokens v -> el.SetValue(DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings.FilterOutSelectedTokensProperty, box v)

    let showSelectAllItem v : obj = box (CheckedComboBoxStyleSettingsProp.ShowSelectAllItem v)
    let selectAllItemText v : obj = box (CheckedComboBoxStyleSettingsProp.SelectAllItemText v)
    let itemContainerStyle v : obj = box (BaseComboBoxStyleSettingsProp.ItemContainerStyle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CheckedTokenComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
