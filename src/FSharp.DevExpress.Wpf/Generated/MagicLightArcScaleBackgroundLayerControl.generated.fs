...
type MagicLightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightArcScaleBackgroundLayerControl) (prop: MagicLightArcScaleBackgroundLayerControlProp) =
        match prop with
        | MagicLightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
