...
type PageNumberWindowProp =
    | Text of string

module PageNumberWindow =
    let text v : obj = box (PageNumberWindowProp.Text v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.PageNumberWindow) (prop: PageNumberWindowProp) =
        match prop with
        | PageNumberWindowProp.Text v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.PageNumberWindow.TextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.PageNumberWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
