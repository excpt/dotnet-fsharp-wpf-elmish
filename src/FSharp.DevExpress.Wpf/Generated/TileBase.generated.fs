...
type TileBaseProp =
    | Base of ClickableBaseProp
    | Size of DevExpress.Xpf.Navigation.Internal.TileSize
    | TileGlyph of System.Windows.Media.ImageSource
    | HorizontalTileGlyphAlignment of System.Windows.HorizontalAlignment
    | VerticalTileGlyphAlignment of System.Windows.VerticalAlignment
...
module TileBase =
    ...
    let apply (el: DevExpress.Xpf.Navigation.TileBase) (prop: TileBaseProp) =
        match prop with
        | TileBaseProp.Base p -> ClickableBase.apply el p
        | TileBaseProp.Size v -> el.SetValue(DevExpress.Xpf.Navigation.TileBase.SizeProperty, box v)
        | TileBaseProp.TileGlyph v -> el.SetValue(DevExpress.Xpf.Navigation.TileBase.TileGlyphProperty, box v)
        | TileBaseProp.HorizontalTileGlyphAlignment v -> el.SetValue(DevExpress.Xpf.Navigation.TileBase.HorizontalTileGlyphAlignmentProperty, box v)
        | TileBaseProp.VerticalTileGlyphAlignment v -> el.SetValue(DevExpress.Xpf.Navigation.TileBase.VerticalTileGlyphAlignmentProperty, box v)
