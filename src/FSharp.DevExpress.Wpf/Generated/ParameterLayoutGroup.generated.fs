...
type ParameterLayoutGroupProp =
    | Base of ParameterLayoutGroupBaseProp

module ParameterLayoutGroup =

    let apply (el: DevExpress.Xpf.Printing.Parameters.ParameterLayoutGroup) (prop: ParameterLayoutGroupProp) =
        match prop with
        | ParameterLayoutGroupProp.Base p -> ParameterLayoutGroupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Parameters.ParameterLayoutGroup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
