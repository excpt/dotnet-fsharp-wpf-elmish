...
type RulerScalePresenterProp =
    | Zoom of float
    | LabelOffset of System.Windows.Point
    | MeasureUnit of DevExpress.Diagram.Core.MeasureUnit
    | Orientation of System.Windows.Controls.Orientation
    | Offset of float
    | Location of System.Windows.Point
    | TickBrush of System.Windows.Media.Brush
    | AlwaysPositiveValues of bool

module RulerScalePresenter =
    let zoom v : obj = box (RulerScalePresenterProp.Zoom v)
    let labelOffset v : obj = box (RulerScalePresenterProp.LabelOffset v)
    let measureUnit v : obj = box (RulerScalePresenterProp.MeasureUnit v)
    let orientation v : obj = box (RulerScalePresenterProp.Orientation v)
    let offset v : obj = box (RulerScalePresenterProp.Offset v)
    let location v : obj = box (RulerScalePresenterProp.Location v)
    let tickBrush v : obj = box (RulerScalePresenterProp.TickBrush v)
    let alwaysPositiveValues v : obj = box (RulerScalePresenterProp.AlwaysPositiveValues v)

    let apply (el: DevExpress.Xpf.Diagram.RulerScalePresenter) (prop: RulerScalePresenterProp) =
        match prop with
        | RulerScalePresenterProp.Zoom v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.ZoomProperty, box v)
        | RulerScalePresenterProp.LabelOffset v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.LabelOffsetProperty, box v)
        | RulerScalePresenterProp.MeasureUnit v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.MeasureUnitProperty, box v)
        | RulerScalePresenterProp.Orientation v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.OrientationProperty, box v)
        | RulerScalePresenterProp.Offset v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.OffsetProperty, box v)
        | RulerScalePresenterProp.Location v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.LocationProperty, box v)
        | RulerScalePresenterProp.TickBrush v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.TickBrushProperty, box v)
        | RulerScalePresenterProp.AlwaysPositiveValues v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScalePresenter.AlwaysPositiveValuesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.RulerScalePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
