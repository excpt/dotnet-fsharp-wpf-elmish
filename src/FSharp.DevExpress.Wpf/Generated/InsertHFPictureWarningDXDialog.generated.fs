...
type InsertHFPictureWarningDXDialogProp =
    | Base of CustomDXDialogProp

module InsertHFPictureWarningDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.InsertHFPictureWarningDXDialog) (prop: InsertHFPictureWarningDXDialogProp) =
        match prop with
        | InsertHFPictureWarningDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.InsertHFPictureWarningDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
