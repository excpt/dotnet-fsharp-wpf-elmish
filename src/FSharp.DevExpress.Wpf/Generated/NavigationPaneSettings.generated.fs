...
type NavigationPaneSettingsProp =
    | ActiveTab of DevExpress.Xpf.Printing.NavigationPaneTabType
    | ShowDocumentMapTab of bool
    | ShowPagesTab of bool
    | UseCaseSensitiveSearch of bool
    | SearchWholeWords of bool

module NavigationPaneSettings =
    let activeTab v : obj = box (NavigationPaneSettingsProp.ActiveTab v)
    let showDocumentMapTab v : obj = box (NavigationPaneSettingsProp.ShowDocumentMapTab v)
    let showPagesTab v : obj = box (NavigationPaneSettingsProp.ShowPagesTab v)
    let useCaseSensitiveSearch v : obj = box (NavigationPaneSettingsProp.UseCaseSensitiveSearch v)
    let searchWholeWords v : obj = box (NavigationPaneSettingsProp.SearchWholeWords v)

    let apply (el: DevExpress.Xpf.Printing.NavigationPaneSettings) (prop: NavigationPaneSettingsProp) =
        match prop with
        | NavigationPaneSettingsProp.ActiveTab v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneSettings.ActiveTabProperty, box v)
        | NavigationPaneSettingsProp.ShowDocumentMapTab v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneSettings.ShowDocumentMapTabProperty, box v)
        | NavigationPaneSettingsProp.ShowPagesTab v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneSettings.ShowPagesTabProperty, box v)
        | NavigationPaneSettingsProp.UseCaseSensitiveSearch v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneSettings.UseCaseSensitiveSearchProperty, box v)
        | NavigationPaneSettingsProp.SearchWholeWords v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneSettings.SearchWholeWordsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.NavigationPaneSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
