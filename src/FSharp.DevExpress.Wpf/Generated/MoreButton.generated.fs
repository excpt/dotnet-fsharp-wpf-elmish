...
type MoreButtonProp =
    ...
    | ViewModel of DevExpress.Xpf.Scheduler.Drawing.MoreButtonViewModel

module MoreButton =
    let viewModel v : obj = box (MoreButtonProp.ViewModel v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.MoreButton) (prop: MoreButtonProp) =
        match prop with
        | MoreButtonProp.Base p -> SchedulerButton.apply el p
        | MoreButtonProp.ViewModel v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.MoreButton.ViewModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.MoreButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
