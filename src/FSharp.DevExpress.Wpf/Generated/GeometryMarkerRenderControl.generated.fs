...
type GeometryMarkerRenderControlProp =
    | Base of MarkerRenderControlBaseProp

module GeometryMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.GeometryMarkerRenderControl) (prop: GeometryMarkerRenderControlProp) =
        match prop with
        | GeometryMarkerRenderControlProp.Base p -> MarkerRenderControlBase.apply el p
