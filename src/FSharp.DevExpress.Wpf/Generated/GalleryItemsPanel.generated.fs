...
type GalleryItemsPanelProp =
    | MaxColCount of int
    | DesiredColCount of int
    | MinColCount of int
    | ItemAutoWidth of bool
    | ItemAutoHeight of bool
    | ViewportSize of System.Windows.Size

module GalleryItemsPanel =
    let maxColCount v : obj = box (GalleryItemsPanelProp.MaxColCount v)
    let desiredColCount v : obj = box (GalleryItemsPanelProp.DesiredColCount v)
    let minColCount v : obj = box (GalleryItemsPanelProp.MinColCount v)
    let itemAutoWidth v : obj = box (GalleryItemsPanelProp.ItemAutoWidth v)
    let itemAutoHeight v : obj = box (GalleryItemsPanelProp.ItemAutoHeight v)
    let viewportSize v : obj = box (GalleryItemsPanelProp.ViewportSize v)

    let apply (el: DevExpress.Xpf.Bars.GalleryItemsPanel) (prop: GalleryItemsPanelProp) =
        match prop with
        | GalleryItemsPanelProp.MaxColCount v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemsPanel.MaxColCountProperty, box v)
        | GalleryItemsPanelProp.DesiredColCount v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemsPanel.DesiredColCountProperty, box v)
        | GalleryItemsPanelProp.MinColCount v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemsPanel.MinColCountProperty, box v)
        | GalleryItemsPanelProp.ItemAutoWidth v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemsPanel.ItemAutoWidthProperty, box v)
        | GalleryItemsPanelProp.ItemAutoHeight v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemsPanel.ItemAutoHeightProperty, box v)
        | GalleryItemsPanelProp.ViewportSize v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemsPanel.ViewportSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
