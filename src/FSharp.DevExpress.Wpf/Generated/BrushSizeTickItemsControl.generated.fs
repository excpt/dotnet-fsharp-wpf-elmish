...
type BrushSizeTickItemsControlProp =
    | Base of TrackBarEditTickItemsControlProp

module BrushSizeTickItemsControl =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrushSizeTickItemsControl) (prop: BrushSizeTickItemsControlProp) =
        match prop with
        | BrushSizeTickItemsControlProp.Base p -> TrackBarEditTickItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrushSizeTickItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
