...
type PositionInfoButtonProp =
    | Base of MediaButtonProp

module PositionInfoButton =

    let apply (el: DevExpress.Xpf.Controls.PositionInfoButton) (prop: PositionInfoButtonProp) =
        match prop with
        | PositionInfoButtonProp.Base p -> MediaButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.PositionInfoButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
