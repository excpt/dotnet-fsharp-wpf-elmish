...
type IStyleLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleLinearScaleBackgroundLayerControl) (prop: IStyleLinearScaleBackgroundLayerControlProp) =
        match prop with
        | IStyleLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
