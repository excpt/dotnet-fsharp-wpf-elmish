...
type PageMarginsEditorProp =
    | Page of DevExpress.Xpf.Printing.PreviewControl.PageViewModel
    | Zoom of float

module PageMarginsEditor =
    let page v : obj = box (PageMarginsEditorProp.Page v)
    let zoom v : obj = box (PageMarginsEditorProp.Zoom v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.PageMarginsEditor) (prop: PageMarginsEditorProp) =
        match prop with
        | PageMarginsEditorProp.Page v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.PageMarginsEditor.PageProperty, box v)
        | PageMarginsEditorProp.Zoom v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.PageMarginsEditor.ZoomProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.PageMarginsEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
