...
type FlowLayoutControlProp =
    | Base of LayoutControlBaseProp
    | AllowAddFlowBreaksDuringItemMoving of bool
    | AllowItemMoving of bool
    | AnimateItemMaximization of bool
    | AnimateItemMoving of bool
    | BreakFlowToFit of bool
    | ItemContainerStyle of System.Windows.Style
    | ItemMovingAnimationDuration of System.TimeSpan
    ...
    | LayerSeparatorStyle of System.Windows.Style
    | LayerSizingCoverBrush of System.Windows.Media.Brush
    | LayerSpace of float
    | MaximizedElement of System.Windows.FrameworkElement
    | MaximizedElementPosition of DevExpress.Xpf.LayoutControl.MaximizedElementPosition
    | MaximizedElementPositionIndicatorStyle of System.Windows.Style
    | MovingItemPlaceHolderBrush of System.Windows.Media.Brush
    | Orientation of System.Windows.Controls.Orientation
    | ShowLayerSeparators of bool
    | StretchContent of bool

module FlowLayoutControl =
    ...
    let apply (el: DevExpress.Xpf.LayoutControl.FlowLayoutControl) (prop: FlowLayoutControlProp) =
        match prop with
        | FlowLayoutControlProp.Base p -> LayoutControlBase.apply el p
        | FlowLayoutControlProp.AllowAddFlowBreaksDuringItemMoving v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.AllowAddFlowBreaksDuringItemMovingProperty, box v)
        | FlowLayoutControlProp.AllowItemMoving v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.AllowItemMovingProperty, box v)
        | FlowLayoutControlProp.AnimateItemMaximization v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.AnimateItemMaximizationProperty, box v)
        | FlowLayoutControlProp.AnimateItemMoving v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.AnimateItemMovingProperty, box v)
        | FlowLayoutControlProp.BreakFlowToFit v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.BreakFlowToFitProperty, box v)
        | FlowLayoutControlProp.ItemContainerStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.ItemContainerStyleProperty, box v)
        | FlowLayoutControlProp.ItemMovingAnimationDuration v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.ItemMovingAnimationDurationProperty, box v)
        | FlowLayoutControlProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.ItemsSourceProperty, box v)
        | FlowLayoutControlProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.ItemTemplateProperty, box v)
        | FlowLayoutControlProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.ItemTemplateSelectorProperty, box v)
        | FlowLayoutControlProp.LayerSeparatorStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.LayerSeparatorStyleProperty, box v)
        | FlowLayoutControlProp.LayerSizingCoverBrush v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.LayerSizingCoverBrushProperty, box v)
        | FlowLayoutControlProp.LayerSpace v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.LayerSpaceProperty, box v)
        | FlowLayoutControlProp.MaximizedElement v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.MaximizedElementProperty, box v)
        | FlowLayoutControlProp.MaximizedElementPosition v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.MaximizedElementPositionProperty, box v)
        | FlowLayoutControlProp.MaximizedElementPositionIndicatorStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.MaximizedElementPositionIndicatorStyleProperty, box v)
        | FlowLayoutControlProp.MovingItemPlaceHolderBrush v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.MovingItemPlaceHolderBrushProperty, box v)
        | FlowLayoutControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.OrientationProperty, box v)
        | FlowLayoutControlProp.ShowLayerSeparators v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.ShowLayerSeparatorsProperty, box v)
        | FlowLayoutControlProp.StretchContent v -> el.SetValue(DevExpress.Xpf.LayoutControl.FlowLayoutControl.StretchContentProperty, box v)
    ...
    let isFlowBreak (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.LayoutControl.FlowLayoutControl.IsFlowBreakProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.LayoutControl.FlowLayoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
