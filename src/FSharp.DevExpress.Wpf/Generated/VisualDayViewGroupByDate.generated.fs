...
type VisualDayViewGroupByDateProp =
    | Base of VisualIntervalsBasedViewInfoProp
    | ShowTimeRulerHeader of bool
    | AllDayAreaContainerGroups of DevExpress.Xpf.Scheduler.Drawing.VisualDayAllDayAreaContainerCollection
...
module VisualDayViewGroupByDate =
    let showTimeRulerHeader v : obj = box (VisualDayViewGroupByDateProp.ShowTimeRulerHeader v)
    let allDayAreaContainerGroups v : obj = box (VisualDayViewGroupByDateProp.AllDayAreaContainerGroups v)
    let dateTimeScrollOffset v : obj = box (VisualDayViewGroupByDateProp.DateTimeScrollOffset v)
    let showDayHeaders v : obj = box (VisualDayViewGroupByDateProp.ShowDayHeaders v)
    let timeIndicatorVisibility v : obj = box (VisualDayViewGroupByDateProp.TimeIndicatorVisibility v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate) (prop: VisualDayViewGroupByDateProp) =
        match prop with
        | VisualDayViewGroupByDateProp.Base p -> VisualIntervalsBasedViewInfo.apply el p
        | VisualDayViewGroupByDateProp.ShowTimeRulerHeader v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate.ShowTimeRulerHeaderProperty, box v)
        | VisualDayViewGroupByDateProp.AllDayAreaContainerGroups v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate.AllDayAreaContainerGroupsProperty, box v)
        | VisualDayViewGroupByDateProp.DateTimeScrollOffset v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate.DateTimeScrollOffsetProperty, box v)
        | VisualDayViewGroupByDateProp.ShowDayHeaders v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate.ShowDayHeadersProperty, box v)
        | VisualDayViewGroupByDateProp.TimeIndicatorVisibility v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate.TimeIndicatorVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByDate>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
