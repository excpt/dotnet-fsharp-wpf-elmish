...
type ChartAnimationRecordProp =
    | Base of ChartElementProp
    | Progress of float

module ChartAnimationRecord =
    let progress v : obj = box (ChartAnimationRecordProp.Progress v)

    let apply (el: DevExpress.Xpf.Charts.ChartAnimationRecord) (prop: ChartAnimationRecordProp) =
        match prop with
        | ChartAnimationRecordProp.Base p -> ChartElement.apply el p
        | ChartAnimationRecordProp.Progress v -> el.SetValue(DevExpress.Xpf.Charts.ChartAnimationRecord.ProgressProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartAnimationRecord>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
