...
type TabSelectorItemProp =
    | State of DevExpress.Xpf.Spreadsheet.Internal.TabSelectorItemState
    | Text of string
    | Color of System.Windows.Media.Color

module TabSelectorItem =
    let state v : obj = box (TabSelectorItemProp.State v)
    let text v : obj = box (TabSelectorItemProp.Text v)
    let color v : obj = box (TabSelectorItemProp.Color v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.TabSelectorItem) (prop: TabSelectorItemProp) =
        match prop with
        | TabSelectorItemProp.State v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.TabSelectorItem.StateProperty, box v)
        | TabSelectorItemProp.Text v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.TabSelectorItem.TextProperty, box v)
        | TabSelectorItemProp.Color v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.TabSelectorItem.ColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.TabSelectorItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
