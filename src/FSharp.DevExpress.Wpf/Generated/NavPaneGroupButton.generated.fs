...
type NavPaneGroupButtonProp =
    | Base of NavPaneXPFButtonProp
...
module NavPaneGroupButton =
    let groupPosition v : obj = box (NavPaneGroupButtonProp.GroupPosition v)
    let isActive v : obj = box (NavPaneGroupButtonProp.IsActive v)
    let isExpanded v : obj = box (NavPaneGroupButtonProp.IsExpanded v)
    let isSplitterVisible v : obj = box (NavPaneGroupButtonProp.IsSplitterVisible v)
    let orientation v : obj = box (NavPaneGroupButtonProp.Orientation v)
    let showBorder v : obj = box (NavPaneGroupButtonProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneGroupButton) (prop: NavPaneGroupButtonProp) =
        match prop with
        | NavPaneGroupButtonProp.Base p -> NavPaneXPFButton.apply el p
        | NavPaneGroupButtonProp.GroupPosition v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButton.GroupPositionProperty, box v)
        | NavPaneGroupButtonProp.IsActive v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButton.IsActiveProperty, box v)
        | NavPaneGroupButtonProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButton.IsExpandedProperty, box v)
        | NavPaneGroupButtonProp.IsSplitterVisible v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButton.IsSplitterVisibleProperty, box v)
        | NavPaneGroupButtonProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButton.OrientationProperty, box v)
        | NavPaneGroupButtonProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButton.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneGroupButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
