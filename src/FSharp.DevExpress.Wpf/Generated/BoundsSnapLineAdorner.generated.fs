...
type BoundsSnapLineAdornerProp =
    | Extent of float

module BoundsSnapLineAdorner =
    let extent v : obj = box (BoundsSnapLineAdornerProp.Extent v)

    let apply (el: DevExpress.Xpf.Diagram.Native.BoundsSnapLineAdorner) (prop: BoundsSnapLineAdornerProp) =
        match prop with
        | BoundsSnapLineAdornerProp.Extent v -> el.SetValue(DevExpress.Xpf.Diagram.Native.BoundsSnapLineAdorner.ExtentProperty, box v)
