...
type VisualMonthViewGroupByDateProp =
    | Base of VisualWeekViewGroupByDateProp

module VisualMonthViewGroupByDate =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualMonthViewGroupByDate) (prop: VisualMonthViewGroupByDateProp) =
        match prop with
        | VisualMonthViewGroupByDateProp.Base p -> VisualWeekViewGroupByDate.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualMonthViewGroupByDate>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
