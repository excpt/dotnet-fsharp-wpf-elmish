...
type MapLegendBaseProp =
    | Base of MapElementProp
    | Header of string
    | Description of string
    | RangeStopsFormat of string
    | Alignment of DevExpress.Xpf.Map.LegendAlignment
    | ItemLabelTemplate of System.Windows.DataTemplate

module MapLegendBase =
    ...
    let apply (el: DevExpress.Xpf.Map.MapLegendBase) (prop: MapLegendBaseProp) =
        match prop with
        | MapLegendBaseProp.Base p -> MapElement.apply el p
        | MapLegendBaseProp.Header v -> el.SetValue(DevExpress.Xpf.Map.MapLegendBase.HeaderProperty, box v)
        | MapLegendBaseProp.Description v -> el.SetValue(DevExpress.Xpf.Map.MapLegendBase.DescriptionProperty, box v)
        | MapLegendBaseProp.RangeStopsFormat v -> el.SetValue(DevExpress.Xpf.Map.MapLegendBase.RangeStopsFormatProperty, box v)
        | MapLegendBaseProp.Alignment v -> el.SetValue(DevExpress.Xpf.Map.MapLegendBase.AlignmentProperty, box v)
        | MapLegendBaseProp.ItemLabelTemplate v -> el.SetValue(DevExpress.Xpf.Map.MapLegendBase.ItemLabelTemplateProperty, box v)
