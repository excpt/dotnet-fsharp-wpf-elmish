...
type FlatOpcRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module FlatOpcRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.FlatOpcRichEditDocumentSourceProvider) (prop: FlatOpcRichEditDocumentSourceProviderProp) =
        match prop with
        | FlatOpcRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.FlatOpcRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
