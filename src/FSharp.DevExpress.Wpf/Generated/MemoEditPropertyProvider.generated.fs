...
type MemoEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp

module MemoEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.MemoEditPropertyProvider) (prop: MemoEditPropertyProviderProp) =
        match prop with
        | MemoEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.MemoEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
