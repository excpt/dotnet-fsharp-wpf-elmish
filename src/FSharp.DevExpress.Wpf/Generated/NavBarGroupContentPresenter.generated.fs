...
type NavBarGroupContentPresenterProp =
    | ItemsDataTemplate of System.Windows.DataTemplate
    | ContentDataTemplate of System.Windows.DataTemplate
    | DisplaySource of DevExpress.Xpf.NavBar.DisplaySource
    | ShowContent of bool
    | ActualContent of obj

module NavBarGroupContentPresenter =
    let itemsDataTemplate v : obj = box (NavBarGroupContentPresenterProp.ItemsDataTemplate v)
    let contentDataTemplate v : obj = box (NavBarGroupContentPresenterProp.ContentDataTemplate v)
    let displaySource v : obj = box (NavBarGroupContentPresenterProp.DisplaySource v)
    let showContent v : obj = box (NavBarGroupContentPresenterProp.ShowContent v)
    let actualContent v : obj = box (NavBarGroupContentPresenterProp.ActualContent v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarGroupContentPresenter) (prop: NavBarGroupContentPresenterProp) =
        match prop with
        | NavBarGroupContentPresenterProp.ItemsDataTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupContentPresenter.ItemsDataTemplateProperty, box v)
        | NavBarGroupContentPresenterProp.ContentDataTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupContentPresenter.ContentDataTemplateProperty, box v)
        | NavBarGroupContentPresenterProp.DisplaySource v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupContentPresenter.DisplaySourceProperty, box v)
        | NavBarGroupContentPresenterProp.ShowContent v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupContentPresenter.ShowContentProperty, box v)
        | NavBarGroupContentPresenterProp.ActualContent v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupContentPresenter.ActualContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarGroupContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
