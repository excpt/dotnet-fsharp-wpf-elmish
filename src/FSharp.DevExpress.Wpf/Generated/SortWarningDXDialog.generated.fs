...
type SortWarningDXDialogProp =
    | Base of CustomDXDialogProp

module SortWarningDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.SortWarningDXDialog) (prop: SortWarningDXDialogProp) =
        match prop with
        | SortWarningDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.SortWarningDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
