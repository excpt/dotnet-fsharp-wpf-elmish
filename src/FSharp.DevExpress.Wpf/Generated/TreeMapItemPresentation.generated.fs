...
type TreeMapItemPresentationProp =
    | TreeMapItem of DevExpress.Xpf.TreeMap.TreeMapItem

module TreeMapItemPresentation =
    let treeMapItem v : obj = box (TreeMapItemPresentationProp.TreeMapItem v)

    let apply (el: DevExpress.Xpf.TreeMap.TreeMapItemPresentation) (prop: TreeMapItemPresentationProp) =
        match prop with
        | TreeMapItemPresentationProp.TreeMapItem v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapItemPresentation.TreeMapItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.TreeMapItemPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
