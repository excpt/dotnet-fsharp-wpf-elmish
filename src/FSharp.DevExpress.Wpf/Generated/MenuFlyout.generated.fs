...
module MenuFlyout =
    let itemsSource v : obj = box (MenuFlyoutProp.ItemsSource v)
    let itemTemplate v : obj = box (MenuFlyoutProp.ItemTemplate v)
    let itemTemplateSelector v : obj = box (MenuFlyoutProp.ItemTemplateSelector v)
    let itemStyle v : obj = box (MenuFlyoutProp.ItemStyle v)

    let apply (el: DevExpress.Xpf.WindowsUI.MenuFlyout) (prop: MenuFlyoutProp) =
        match prop with
        | MenuFlyoutProp.Base p -> FlyoutBase.apply el p
        | MenuFlyoutProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.WindowsUI.MenuFlyout.ItemsSourceProperty, box v)
        | MenuFlyoutProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.MenuFlyout.ItemTemplateProperty, box v)
        | MenuFlyoutProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.MenuFlyout.ItemTemplateSelectorProperty, box v)
        | MenuFlyoutProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.WindowsUI.MenuFlyout.ItemStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.MenuFlyout>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
