...
type ProgressBarMarqueeStyleSettingsProp =
    | Base of BaseProgressBarStyleSettingsProp

module ProgressBarMarqueeStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.ProgressBarMarqueeStyleSettings) (prop: ProgressBarMarqueeStyleSettingsProp) =
        match prop with
        | ProgressBarMarqueeStyleSettingsProp.Base p -> BaseProgressBarStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ProgressBarMarqueeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
