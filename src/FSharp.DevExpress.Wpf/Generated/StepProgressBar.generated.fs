...
type StepProgressBarProp =
    | Progress of float
    | ProgressSize of float
    | ProgressAnimationDuration of System.Windows.Duration
    | ShowProgress of bool
    | Offset of float
    | SelectedItemState of DevExpress.Xpf.Controls.StepProgressBarItemState
    | Orientation of System.Windows.Controls.Orientation
    | ReverseOrder of bool
    | CompletePreviousStepsOnSelection of bool
    | ShowOuterBorder of bool
    | OuterBorderSize of float
    | OuterBorderBrush of System.Windows.Media.Brush
    | OuterBorderIndent of float
    | ProgressStyle of System.Windows.Style
    | NearContentLength of System.Windows.GridLength
    | IndicatorLength of System.Windows.GridLength
    | FarContentLength of System.Windows.GridLength
    | AllowItemClick of bool

module StepProgressBar =
    let progress v : obj = box (StepProgressBarProp.Progress v)
    let progressSize v : obj = box (StepProgressBarProp.ProgressSize v)
    let progressAnimationDuration v : obj = box (StepProgressBarProp.ProgressAnimationDuration v)
    let showProgress v : obj = box (StepProgressBarProp.ShowProgress v)
    let offset v : obj = box (StepProgressBarProp.Offset v)
    let selectedItemState v : obj = box (StepProgressBarProp.SelectedItemState v)
    let orientation v : obj = box (StepProgressBarProp.Orientation v)
    let reverseOrder v : obj = box (StepProgressBarProp.ReverseOrder v)
    let completePreviousStepsOnSelection v : obj = box (StepProgressBarProp.CompletePreviousStepsOnSelection v)
    let showOuterBorder v : obj = box (StepProgressBarProp.ShowOuterBorder v)
    let outerBorderSize v : obj = box (StepProgressBarProp.OuterBorderSize v)
    let outerBorderBrush v : obj = box (StepProgressBarProp.OuterBorderBrush v)
    let outerBorderIndent v : obj = box (StepProgressBarProp.OuterBorderIndent v)
    let progressStyle v : obj = box (StepProgressBarProp.ProgressStyle v)
    let nearContentLength v : obj = box (StepProgressBarProp.NearContentLength v)
    let indicatorLength v : obj = box (StepProgressBarProp.IndicatorLength v)
    let farContentLength v : obj = box (StepProgressBarProp.FarContentLength v)
    let allowItemClick v : obj = box (StepProgressBarProp.AllowItemClick v)

    let apply (el: DevExpress.Xpf.Controls.StepProgressBar) (prop: StepProgressBarProp) =
        match prop with
        | StepProgressBarProp.Progress v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ProgressProperty, box v)
        | StepProgressBarProp.ProgressSize v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ProgressSizeProperty, box v)
        | StepProgressBarProp.ProgressAnimationDuration v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ProgressAnimationDurationProperty, box v)
        | StepProgressBarProp.ShowProgress v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ShowProgressProperty, box v)
        | StepProgressBarProp.Offset v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.OffsetProperty, box v)
        | StepProgressBarProp.SelectedItemState v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.SelectedItemStateProperty, box v)
        | StepProgressBarProp.Orientation v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.OrientationProperty, box v)
        | StepProgressBarProp.ReverseOrder v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ReverseOrderProperty, box v)
        | StepProgressBarProp.CompletePreviousStepsOnSelection v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.CompletePreviousStepsOnSelectionProperty, box v)
        | StepProgressBarProp.ShowOuterBorder v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ShowOuterBorderProperty, box v)
        | StepProgressBarProp.OuterBorderSize v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.OuterBorderSizeProperty, box v)
        | StepProgressBarProp.OuterBorderBrush v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.OuterBorderBrushProperty, box v)
        | StepProgressBarProp.OuterBorderIndent v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.OuterBorderIndentProperty, box v)
        | StepProgressBarProp.ProgressStyle v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.ProgressStyleProperty, box v)
        | StepProgressBarProp.NearContentLength v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.NearContentLengthProperty, box v)
        | StepProgressBarProp.IndicatorLength v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.IndicatorLengthProperty, box v)
        | StepProgressBarProp.FarContentLength v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.FarContentLengthProperty, box v)
        | StepProgressBarProp.AllowItemClick v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBar.AllowItemClickProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.StepProgressBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
