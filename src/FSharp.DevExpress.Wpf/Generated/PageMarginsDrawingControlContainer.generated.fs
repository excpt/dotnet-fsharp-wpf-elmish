...
type PageMarginsDrawingControlContainerProp =
    | Base of BackgroundPanelProp

module PageMarginsDrawingControlContainer =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.PageMarginsDrawingControlContainer) (prop: PageMarginsDrawingControlContainerProp) =
        match prop with
        | PageMarginsDrawingControlContainerProp.Base p -> BackgroundPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.PageMarginsDrawingControlContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
