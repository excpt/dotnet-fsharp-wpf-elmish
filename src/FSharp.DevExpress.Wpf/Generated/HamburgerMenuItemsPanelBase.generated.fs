...
type HamburgerMenuItemsPanelBaseProp =
    | Base of HamburgerMenuPanelBaseProp
    | ShowSpecialElements of bool

module HamburgerMenuItemsPanelBase =
    let showSpecialElements v : obj = box (HamburgerMenuItemsPanelBaseProp.ShowSpecialElements v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuItemsPanelBase) (prop: HamburgerMenuItemsPanelBaseProp) =
        match prop with
        | HamburgerMenuItemsPanelBaseProp.Base p -> HamburgerMenuPanelBase.apply el p
        | HamburgerMenuItemsPanelBaseProp.ShowSpecialElements v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuItemsPanelBase.ShowSpecialElementsProperty, box v)
