...
type ProgressBarEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp

module ProgressBarEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.ProgressBarEditPropertyProvider) (prop: ProgressBarEditPropertyProviderProp) =
        match prop with
        | ProgressBarEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ProgressBarEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
