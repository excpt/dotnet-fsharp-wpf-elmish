...
type ClassicMajorTickmarkControlProp =
    | Base of PresentationControlProp

module ClassicMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicMajorTickmarkControl) (prop: ClassicMajorTickmarkControlProp) =
        match prop with
        | ClassicMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
