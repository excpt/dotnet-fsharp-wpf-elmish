...
type CellsDecorationPanelProp =
    | Base of TimeRegionDecorationPanelBaseProp
    | AllowAlternateDecoration of bool
    | HorizontalBorderThickness of float
    | Borders of DevExpress.Xpf.Scheduling.VisualData.BordersDecorationInfo
    | VerticalBorderThickness of float
    | Selection of DevExpress.Xpf.Scheduling.VisualData.SelectionRegionViewModel

module CellsDecorationPanel =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Panels.CellsDecorationPanel) (prop: CellsDecorationPanelProp) =
        match prop with
        | CellsDecorationPanelProp.Base p -> TimeRegionDecorationPanelBase.apply el p
        | CellsDecorationPanelProp.AllowAlternateDecoration v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.CellsDecorationPanel.AllowAlternateDecorationProperty, box v)
        | CellsDecorationPanelProp.HorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.CellsDecorationPanel.HorizontalBorderThicknessProperty, box v)
        | CellsDecorationPanelProp.Borders v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.CellsDecorationPanel.BordersProperty, box v)
        | CellsDecorationPanelProp.VerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.CellsDecorationPanel.VerticalBorderThicknessProperty, box v)
        | CellsDecorationPanelProp.Selection v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.CellsDecorationPanel.SelectionProperty, box v)
