...
module RangeBaseEdit =
    ...
    let apply (el: DevExpress.Xpf.Editors.RangeBaseEdit) (prop: RangeBaseEditProp) =
        match prop with
        | RangeBaseEditProp.Base p -> BaseEdit.apply el p
        | RangeBaseEditProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.RangeBaseEdit.OrientationProperty, box v)
        | RangeBaseEditProp.Value v -> el.SetValue(DevExpress.Xpf.Editors.RangeBaseEdit.ValueProperty, box v)
        | RangeBaseEditProp.Maximum v -> el.SetValue(DevExpress.Xpf.Editors.RangeBaseEdit.MaximumProperty, box v)
        | RangeBaseEditProp.Minimum v -> el.SetValue(DevExpress.Xpf.Editors.RangeBaseEdit.MinimumProperty, box v)
        | RangeBaseEditProp.SmallStep v -> el.SetValue(DevExpress.Xpf.Editors.RangeBaseEdit.SmallStepProperty, box v)
        | RangeBaseEditProp.LargeStep v -> el.SetValue(DevExpress.Xpf.Editors.RangeBaseEdit.LargeStepProperty, box v)
