...
type CircleMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module CircleMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.CircleMarkerModelControl) (prop: CircleMarkerModelControlProp) =
        match prop with
        | CircleMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.CircleMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
