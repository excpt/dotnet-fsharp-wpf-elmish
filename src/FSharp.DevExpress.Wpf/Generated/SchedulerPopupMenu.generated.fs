...
open System
open System.Windows
open DevExpress.Xpf.Scheduler.Menu
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SchedulerPopupMenuProp =
    | Base of CustomizablePopupMenuBaseProp

module SchedulerPopupMenu =

    let apply (el: DevExpress.Xpf.Scheduler.Menu.SchedulerPopupMenu) (prop: SchedulerPopupMenuProp) =
        match prop with
        | SchedulerPopupMenuProp.Base p -> CustomizablePopupMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Menu.SchedulerPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
