...
type ArrowRightUpStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowRightUpStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowRightUpStatePresentationControl) (prop: ArrowRightUpStatePresentationControlProp) =
        match prop with
        | ArrowRightUpStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowRightUpStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
