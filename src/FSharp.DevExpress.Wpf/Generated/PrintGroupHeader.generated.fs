...
type PrintGroupHeaderProp =
    | Base of GroupHeaderProp

module PrintGroupHeader =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintGroupHeader) (prop: PrintGroupHeaderProp) =
        match prop with
        | PrintGroupHeaderProp.Base p -> GroupHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
