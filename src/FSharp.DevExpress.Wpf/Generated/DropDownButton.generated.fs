...
type DropDownButtonProp =
    | Base of DropDownButtonBaseProp

module DropDownButton =

    let apply (el: DevExpress.Xpf.Core.DropDownButton) (prop: DropDownButtonProp) =
        match prop with
        | DropDownButtonProp.Base p -> DropDownButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DropDownButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
