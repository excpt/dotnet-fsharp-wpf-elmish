...
type CustomizationSeparatorControlProp =
    | Orientation of System.Windows.Controls.Orientation

module CustomizationSeparatorControl =
    let orientation v : obj = box (CustomizationSeparatorControlProp.Orientation v)

    let apply (el: DevExpress.Xpf.Ribbon.CustomizationSeparatorControl) (prop: CustomizationSeparatorControlProp) =
        match prop with
        | CustomizationSeparatorControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Ribbon.CustomizationSeparatorControl.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.CustomizationSeparatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
