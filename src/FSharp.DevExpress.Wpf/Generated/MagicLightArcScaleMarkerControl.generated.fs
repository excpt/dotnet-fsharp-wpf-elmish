...
type MagicLightArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module MagicLightArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightArcScaleMarkerControl) (prop: MagicLightArcScaleMarkerControlProp) =
        match prop with
        | MagicLightArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
