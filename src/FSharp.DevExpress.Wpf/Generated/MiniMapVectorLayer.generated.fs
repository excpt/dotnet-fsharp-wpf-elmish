...
type MiniMapVectorLayerProp =
    | Base of MiniMapLayerBaseProp
...
module MiniMapVectorLayer =
    let data v : obj = box (MiniMapVectorLayerProp.Data v)
    let shapeFill v : obj = box (MiniMapVectorLayerProp.ShapeFill v)
    let shapeStroke v : obj = box (MiniMapVectorLayerProp.ShapeStroke v)
    let shapeStrokeStyle v : obj = box (MiniMapVectorLayerProp.ShapeStrokeStyle v)

    let apply (el: DevExpress.Xpf.Map.MiniMapVectorLayer) (prop: MiniMapVectorLayerProp) =
        match prop with
        | MiniMapVectorLayerProp.Base p -> MiniMapLayerBase.apply el p
        | MiniMapVectorLayerProp.Data v -> el.SetValue(DevExpress.Xpf.Map.MiniMapVectorLayer.DataProperty, box v)
        | MiniMapVectorLayerProp.ShapeFill v -> el.SetValue(DevExpress.Xpf.Map.MiniMapVectorLayer.ShapeFillProperty, box v)
        | MiniMapVectorLayerProp.ShapeStroke v -> el.SetValue(DevExpress.Xpf.Map.MiniMapVectorLayer.ShapeStrokeProperty, box v)
        | MiniMapVectorLayerProp.ShapeStrokeStyle v -> el.SetValue(DevExpress.Xpf.Map.MiniMapVectorLayer.ShapeStrokeStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MiniMapVectorLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
