...
type CircularRangeAreaSeries2DProp =
    | Base of CircularSeriesBase2DProp
    ...
    | SeriesAnimation of DevExpress.Xpf.Charts.CircularAreaAnimationBase
    | LabelValueSeparator of string
    | LegendValueSeparator of string

module CircularRangeAreaSeries2D =
    let marker1Model v : obj = box (CircularRangeAreaSeries2DProp.Marker1Model v)
    let marker1Size v : obj = box (CircularRangeAreaSeries2DProp.Marker1Size v)
    let marker1Visible v : obj = box (CircularRangeAreaSeries2DProp.Marker1Visible v)
    let marker2Model v : obj = box (CircularRangeAreaSeries2DProp.Marker2Model v)
    let marker2Size v : obj = box (CircularRangeAreaSeries2DProp.Marker2Size v)
    let marker2Visible v : obj = box (CircularRangeAreaSeries2DProp.Marker2Visible v)
    let value2DataMember v : obj = box (CircularRangeAreaSeries2DProp.Value2DataMember v)
    let border1 v : obj = box (CircularRangeAreaSeries2DProp.Border1 v)
    let border2 v : obj = box (CircularRangeAreaSeries2DProp.Border2 v)
    let transparency v : obj = box (CircularRangeAreaSeries2DProp.Transparency v)
    let seriesAnimation v : obj = box (CircularRangeAreaSeries2DProp.SeriesAnimation v)
    let labelValueSeparator v : obj = box (CircularRangeAreaSeries2DProp.LabelValueSeparator v)
    let legendValueSeparator v : obj = box (CircularRangeAreaSeries2DProp.LegendValueSeparator v)

    let apply (el: DevExpress.Xpf.Charts.CircularRangeAreaSeries2D) (prop: CircularRangeAreaSeries2DProp) =
        match prop with
        | CircularRangeAreaSeries2DProp.Base p -> CircularSeriesBase2D.apply el p
        | CircularRangeAreaSeries2DProp.Marker1Model v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Marker1ModelProperty, box v)
        | CircularRangeAreaSeries2DProp.Marker1Size v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Marker1SizeProperty, box v)
        | CircularRangeAreaSeries2DProp.Marker1Visible v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Marker1VisibleProperty, box v)
        | CircularRangeAreaSeries2DProp.Marker2Model v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Marker2ModelProperty, box v)
        | CircularRangeAreaSeries2DProp.Marker2Size v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Marker2SizeProperty, box v)
        | CircularRangeAreaSeries2DProp.Marker2Visible v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Marker2VisibleProperty, box v)
        | CircularRangeAreaSeries2DProp.Value2DataMember v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Value2DataMemberProperty, box v)
        | CircularRangeAreaSeries2DProp.Border1 v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Border1Property, box v)
        | CircularRangeAreaSeries2DProp.Border2 v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.Border2Property, box v)
        | CircularRangeAreaSeries2DProp.Transparency v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.TransparencyProperty, box v)
        | CircularRangeAreaSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.SeriesAnimationProperty, box v)
        | CircularRangeAreaSeries2DProp.LabelValueSeparator v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.LabelValueSeparatorProperty, box v)
        | CircularRangeAreaSeries2DProp.LegendValueSeparator v -> el.SetValue(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.LegendValueSeparatorProperty, box v)

    let pointAnimation v : obj = box (CircularSeriesBase2DProp.PointAnimation v)
    ...
    let minValueAngle (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.MinValueAngleProperty, box v)) :: node.Props }
    let maxValueAngle (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.MaxValueAngleProperty, box v)) :: node.Props }
    let labelKind (v: DevExpress.Xpf.Charts.RangeAreaLabelKind) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.CircularRangeAreaSeries2D.LabelKindProperty, box v)) :: node.Props }
