...
type EAN128SymbologyProp =
    | FNC1Substitute of string
    | HumanReadableText of bool

module EAN128Symbology =
    let fNC1Substitute v : obj = box (EAN128SymbologyProp.FNC1Substitute v)
    let humanReadableText v : obj = box (EAN128SymbologyProp.HumanReadableText v)

    let apply (el: DevExpress.Xpf.Controls.EAN128Symbology) (prop: EAN128SymbologyProp) =
        match prop with
        | EAN128SymbologyProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Controls.EAN128Symbology.FNC1SubstituteProperty, box v)
        | EAN128SymbologyProp.HumanReadableText v -> el.SetValue(DevExpress.Xpf.Controls.EAN128Symbology.HumanReadableTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.EAN128Symbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
