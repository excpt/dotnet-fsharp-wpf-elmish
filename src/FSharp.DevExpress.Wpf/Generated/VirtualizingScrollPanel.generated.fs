...
type VirtualizingScrollPanelProp =
    | Orientation of System.Windows.Controls.Orientation

module VirtualizingScrollPanel =
    let orientation v : obj = box (VirtualizingScrollPanelProp.Orientation v)

    let apply (el: DevExpress.Xpf.WindowsUI.Base.VirtualizingScrollPanel) (prop: VirtualizingScrollPanelProp) =
        match prop with
        | VirtualizingScrollPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.VirtualizingScrollPanel.OrientationProperty, box v)
