...
type AdditionalStepAreaSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalStepAreaSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStepAreaSeriesGeometryContainer) (prop: AdditionalStepAreaSeriesGeometryContainerProp) =
        match prop with
        | AdditionalStepAreaSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStepAreaSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
