...
type IStyleQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleQuarterTopLeftArcScaleBackgroundLayerControl) (prop: IStyleQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | IStyleQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
