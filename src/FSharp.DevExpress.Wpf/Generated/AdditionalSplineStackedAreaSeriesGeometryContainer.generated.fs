...
type AdditionalSplineStackedAreaSeriesGeometryContainerProp =
    | Base of AdditionalSeriesGeometryContainerProp

module AdditionalSplineStackedAreaSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineStackedAreaSeriesGeometryContainer) (prop: AdditionalSplineStackedAreaSeriesGeometryContainerProp) =
        match prop with
        | AdditionalSplineStackedAreaSeriesGeometryContainerProp.Base p -> AdditionalSeriesGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineStackedAreaSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
