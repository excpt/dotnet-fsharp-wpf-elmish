...
type StackPanelGroupHeaderProp =
    | Base of ContentControlBaseProp

module StackPanelGroupHeader =

    let apply (el: DevExpress.Xpf.Controls.Primitives.StackPanelGroupHeader) (prop: StackPanelGroupHeaderProp) =
        match prop with
        | StackPanelGroupHeaderProp.Base p -> ContentControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.StackPanelGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
