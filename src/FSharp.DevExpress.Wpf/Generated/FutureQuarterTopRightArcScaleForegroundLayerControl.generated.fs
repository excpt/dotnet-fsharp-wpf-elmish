...
type FutureQuarterTopRightArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module FutureQuarterTopRightArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureQuarterTopRightArcScaleForegroundLayerControl) (prop: FutureQuarterTopRightArcScaleForegroundLayerControlProp) =
        match prop with
        | FutureQuarterTopRightArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureQuarterTopRightArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
