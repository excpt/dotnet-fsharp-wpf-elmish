...
type GanttConnectorEditFlyoutControlProp =
    | Base of GanttEditFlyoutControlBaseProp

module GanttConnectorEditFlyoutControl =

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttConnectorEditFlyoutControl) (prop: GanttConnectorEditFlyoutControlProp) =
        match prop with
        | GanttConnectorEditFlyoutControlProp.Base p -> GanttEditFlyoutControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttConnectorEditFlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
