...
type RoundedBorderControlProp =
    | Base of XPFContentControlProp
    | CornerRadius of System.Windows.CornerRadius
    | RoundBorderThickness of System.Windows.Thickness

module RoundedBorderControl =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.RoundedBorderControl) (prop: RoundedBorderControlProp) =
        match prop with
        | RoundedBorderControlProp.Base p -> XPFContentControl.apply el p
        | RoundedBorderControlProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.RoundedBorderControl.CornerRadiusProperty, box v)
        | RoundedBorderControlProp.RoundBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.RoundedBorderControl.RoundBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.RoundedBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
