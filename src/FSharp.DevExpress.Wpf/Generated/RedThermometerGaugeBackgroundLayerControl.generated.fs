...
type RedThermometerGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedThermometerGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedThermometerGaugeBackgroundLayerControl) (prop: RedThermometerGaugeBackgroundLayerControlProp) =
        match prop with
        | RedThermometerGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedThermometerGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
