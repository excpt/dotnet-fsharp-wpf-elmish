...
type CosmicThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicThreeQuartersArcScaleBackgroundLayerControl) (prop: CosmicThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | CosmicThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
