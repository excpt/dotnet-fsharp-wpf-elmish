...
type SchedulerContentControlProp =
    | Base of XPFContentControlProp

module SchedulerContentControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerContentControl) (prop: SchedulerContentControlProp) =
        match prop with
        | SchedulerContentControlProp.Base p -> XPFContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SchedulerContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
