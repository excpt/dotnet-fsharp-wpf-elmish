...
type TransparentRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module TransparentRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.TransparentRangeBar2DModelControl) (prop: TransparentRangeBar2DModelControlProp) =
        match prop with
        | TransparentRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TransparentRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
