...
type PopupContentContainerProp =
    | DropOpposite of bool

module PopupContentContainer =
    let dropOpposite v : obj = box (PopupContentContainerProp.DropOpposite v)

    let apply (el: DevExpress.Xpf.Editors.Popups.PopupContentContainer) (prop: PopupContentContainerProp) =
        match prop with
        | PopupContentContainerProp.DropOpposite v -> el.SetValue(DevExpress.Xpf.Editors.Popups.PopupContentContainer.DropOppositeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.PopupContentContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
