...
type BarSeries2DBaseProp =
    | Base of XYSeries2DProp
    | BarWidth of float
    | PointAnimation of DevExpress.Xpf.Charts.Bar2DAnimationBase

module BarSeries2DBase =
    let barWidth v : obj = box (BarSeries2DBaseProp.BarWidth v)
    let pointAnimation v : obj = box (BarSeries2DBaseProp.PointAnimation v)

    let apply (el: DevExpress.Xpf.Charts.BarSeries2DBase) (prop: BarSeries2DBaseProp) =
        match prop with
        | BarSeries2DBaseProp.Base p -> XYSeries2D.apply el p
        | BarSeries2DBaseProp.BarWidth v -> el.SetValue(DevExpress.Xpf.Charts.BarSeries2DBase.BarWidthProperty, box v)
        | BarSeries2DBaseProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.BarSeries2DBase.PointAnimationProperty, box v)
