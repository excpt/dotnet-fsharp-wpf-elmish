...
type CalendarGroupItemProp =
    | Base of CalendarItemBaseProp

module CalendarGroupItem =

    let apply (el: DevExpress.Xpf.Editors.RangeControl.CalendarGroupItem) (prop: CalendarGroupItemProp) =
        match prop with
        | CalendarGroupItemProp.Base p -> CalendarItemBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RangeControl.CalendarGroupItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
