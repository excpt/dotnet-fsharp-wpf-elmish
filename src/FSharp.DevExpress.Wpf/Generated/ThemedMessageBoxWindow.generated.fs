...
type ThemedMessageBoxWindowProp =
    | Base of ThemedWindowProp
    | Text of string
    | MessageContent of System.Windows.UIElement
    | TextAlignment of System.Windows.TextAlignment
    | Image of System.Windows.Media.ImageSource
    | AllowTextSelection of bool
    | TimerOptions of DevExpress.Xpf.Core.Native.TimerOptions

module ThemedMessageBoxWindow =
    let text v : obj = box (ThemedMessageBoxWindowProp.Text v)
    let messageContent v : obj = box (ThemedMessageBoxWindowProp.MessageContent v)
    let textAlignment v : obj = box (ThemedMessageBoxWindowProp.TextAlignment v)
    let image v : obj = box (ThemedMessageBoxWindowProp.Image v)
    let allowTextSelection v : obj = box (ThemedMessageBoxWindowProp.AllowTextSelection v)
    let timerOptions v : obj = box (ThemedMessageBoxWindowProp.TimerOptions v)

    let apply (el: DevExpress.Xpf.Core.ThemedMessageBoxWindow) (prop: ThemedMessageBoxWindowProp) =
        match prop with
        | ThemedMessageBoxWindowProp.Base p -> ThemedWindow.apply el p
        | ThemedMessageBoxWindowProp.Text v -> el.SetValue(DevExpress.Xpf.Core.ThemedMessageBoxWindow.TextProperty, box v)
        | ThemedMessageBoxWindowProp.MessageContent v -> el.SetValue(DevExpress.Xpf.Core.ThemedMessageBoxWindow.MessageContentProperty, box v)
        | ThemedMessageBoxWindowProp.TextAlignment v -> el.SetValue(DevExpress.Xpf.Core.ThemedMessageBoxWindow.TextAlignmentProperty, box v)
        | ThemedMessageBoxWindowProp.Image v -> el.SetValue(DevExpress.Xpf.Core.ThemedMessageBoxWindow.ImageProperty, box v)
        | ThemedMessageBoxWindowProp.AllowTextSelection v -> el.SetValue(DevExpress.Xpf.Core.ThemedMessageBoxWindow.AllowTextSelectionProperty, box v)
        | ThemedMessageBoxWindowProp.TimerOptions v -> el.SetValue(DevExpress.Xpf.Core.ThemedMessageBoxWindow.TimerOptionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedMessageBoxWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
