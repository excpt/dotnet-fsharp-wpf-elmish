...
type GlassPie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module GlassPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.GlassPie2DModelControl) (prop: GlassPie2DModelControlProp) =
        match prop with
        | GlassPie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GlassPie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
