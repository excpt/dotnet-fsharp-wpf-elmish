...
module MicroQRCodeSymbology =
    let compactionMode v : obj = box (MicroQRCodeSymbologyProp.CompactionMode v)
    let version v : obj = box (MicroQRCodeSymbologyProp.Version v)
    let errorCorrectionLevel v : obj = box (MicroQRCodeSymbologyProp.ErrorCorrectionLevel v)

    let apply (el: DevExpress.Xpf.Controls.MicroQRCodeSymbology) (prop: MicroQRCodeSymbologyProp) =
        match prop with
        | MicroQRCodeSymbologyProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Controls.MicroQRCodeSymbology.CompactionModeProperty, box v)
        | MicroQRCodeSymbologyProp.Version v -> el.SetValue(DevExpress.Xpf.Controls.MicroQRCodeSymbology.VersionProperty, box v)
        | MicroQRCodeSymbologyProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Controls.MicroQRCodeSymbology.ErrorCorrectionLevelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.MicroQRCodeSymbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
