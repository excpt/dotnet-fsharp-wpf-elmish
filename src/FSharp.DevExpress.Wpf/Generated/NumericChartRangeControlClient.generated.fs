...
type NumericChartRangeControlClientProp =
    | Base of ChartRangeControlClientProp
    | SnapAlignment of float
    | GridAlignment of float

module NumericChartRangeControlClient =
    let snapAlignment v : obj = box (NumericChartRangeControlClientProp.SnapAlignment v)
    let gridAlignment v : obj = box (NumericChartRangeControlClientProp.GridAlignment v)

    let apply (el: DevExpress.Xpf.Charts.RangeControlClient.NumericChartRangeControlClient) (prop: NumericChartRangeControlClientProp) =
        match prop with
        | NumericChartRangeControlClientProp.Base p -> ChartRangeControlClient.apply el p
        | NumericChartRangeControlClientProp.SnapAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.NumericChartRangeControlClient.SnapAlignmentProperty, box v)
        | NumericChartRangeControlClientProp.GridAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.NumericChartRangeControlClient.GridAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RangeControlClient.NumericChartRangeControlClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
