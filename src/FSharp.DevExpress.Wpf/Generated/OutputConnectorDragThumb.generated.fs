...
type OutputConnectorDragThumbProp =
    | Base of ConnectorDragThumbBaseProp

module OutputConnectorDragThumb =

    let apply (el: DevExpress.Xpf.Gantt.Native.OutputConnectorDragThumb) (prop: OutputConnectorDragThumbProp) =
        match prop with
        | OutputConnectorDragThumbProp.Base p -> ConnectorDragThumbBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.OutputConnectorDragThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
