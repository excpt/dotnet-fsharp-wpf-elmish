...
type DayViewMoreButtonControlProp =
    | VisibleAppointmentInfos of obj
    | ScrollViewer of System.Windows.Controls.ScrollViewer
    | View of DevExpress.Xpf.Scheduler.SchedulerViewBase

module DayViewMoreButtonControl =
    let visibleAppointmentInfos v : obj = box (DayViewMoreButtonControlProp.VisibleAppointmentInfos v)
    let scrollViewer v : obj = box (DayViewMoreButtonControlProp.ScrollViewer v)
    let view v : obj = box (DayViewMoreButtonControlProp.View v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DayViewMoreButtonControl) (prop: DayViewMoreButtonControlProp) =
        match prop with
        | DayViewMoreButtonControlProp.VisibleAppointmentInfos v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DayViewMoreButtonControl.VisibleAppointmentInfosProperty, box v)
        | DayViewMoreButtonControlProp.ScrollViewer v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DayViewMoreButtonControl.ScrollViewerProperty, box v)
        | DayViewMoreButtonControlProp.View v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DayViewMoreButtonControl.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DayViewMoreButtonControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
