...
type RibbonAutoHideControlProp =
    | IsAutoHideActive of bool
    | IsRibbonShown of bool

module RibbonAutoHideControl =
    let isAutoHideActive v : obj = box (RibbonAutoHideControlProp.IsAutoHideActive v)
    let isRibbonShown v : obj = box (RibbonAutoHideControlProp.IsRibbonShown v)

    let apply (el: DevExpress.Xpf.Ribbon.Internal.RibbonAutoHideControl) (prop: RibbonAutoHideControlProp) =
        match prop with
        | RibbonAutoHideControlProp.IsAutoHideActive v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonAutoHideControl.IsAutoHideActiveProperty, box v)
        | RibbonAutoHideControlProp.IsRibbonShown v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonAutoHideControl.IsRibbonShownProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.RibbonAutoHideControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
