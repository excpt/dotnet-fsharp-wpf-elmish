...
type LinearGaugeModelProp =
    | Base of GaugeModelBaseProp
    | ScaleModels of DevExpress.Xpf.Gauges.LinearScaleModelCollection
    | MarkerModels of DevExpress.Xpf.Gauges.LinearScaleMarkerModelCollection
    | RangeBarModels of DevExpress.Xpf.Gauges.LinearScaleRangeBarModelCollection
    | LevelBarModels of DevExpress.Xpf.Gauges.LinearScaleLevelBarModelCollection
    | RangeModels of DevExpress.Xpf.Gauges.LinearScaleRangeModelCollection
    | LayerModels of DevExpress.Xpf.Gauges.LayerModelCollection
    | ScaleLayerModels of DevExpress.Xpf.Gauges.LayerModelCollection

module LinearGaugeModel =
    let scaleModels v : obj = box (LinearGaugeModelProp.ScaleModels v)
    let markerModels v : obj = box (LinearGaugeModelProp.MarkerModels v)
    let rangeBarModels v : obj = box (LinearGaugeModelProp.RangeBarModels v)
    let levelBarModels v : obj = box (LinearGaugeModelProp.LevelBarModels v)
    let rangeModels v : obj = box (LinearGaugeModelProp.RangeModels v)
    let layerModels v : obj = box (LinearGaugeModelProp.LayerModels v)
    let scaleLayerModels v : obj = box (LinearGaugeModelProp.ScaleLayerModels v)

    let apply (el: DevExpress.Xpf.Gauges.LinearGaugeModel) (prop: LinearGaugeModelProp) =
        match prop with
        | LinearGaugeModelProp.Base p -> GaugeModelBase.apply el p
        | LinearGaugeModelProp.ScaleModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.ScaleModelsProperty, box v)
        | LinearGaugeModelProp.MarkerModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.MarkerModelsProperty, box v)
        | LinearGaugeModelProp.RangeBarModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.RangeBarModelsProperty, box v)
        | LinearGaugeModelProp.LevelBarModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.LevelBarModelsProperty, box v)
        | LinearGaugeModelProp.RangeModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.RangeModelsProperty, box v)
        | LinearGaugeModelProp.LayerModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.LayerModelsProperty, box v)
        | LinearGaugeModelProp.ScaleLayerModels v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeModel.ScaleLayerModelsProperty, box v)
