...
type NavigationBarItems2PanelProp =
...
module NavigationBarItems2Panel =
    let content1 v : obj = box (NavigationBarItems2PanelProp.Content1 v)
    let content2 v : obj = box (NavigationBarItems2PanelProp.Content2 v)
    let content1Location v : obj = box (NavigationBarItems2PanelProp.Content1Location v)
    let itemSpacing v : obj = box (NavigationBarItems2PanelProp.ItemSpacing v)

    let apply (el: DevExpress.Xpf.Navigation.Internal.NavigationBarItems2Panel) (prop: NavigationBarItems2PanelProp) =
        match prop with
        | NavigationBarItems2PanelProp.Content1 v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarItems2Panel.Content1Property, box v)
        | NavigationBarItems2PanelProp.Content2 v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarItems2Panel.Content2Property, box v)
        | NavigationBarItems2PanelProp.Content1Location v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarItems2Panel.Content1LocationProperty, box v)
        | NavigationBarItems2PanelProp.ItemSpacing v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarItems2Panel.ItemSpacingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.NavigationBarItems2Panel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
