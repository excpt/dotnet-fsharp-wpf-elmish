...
type TextEditBaseProp =
    | Base of BaseEditProp
    | Text of string
    | EditNonEditableTemplate of System.Windows.Controls.ControlTemplate
    | AcceptsReturn of bool
    | TextWrapping of System.Windows.TextWrapping
    | PrintTextWrapping of obj
    ...
    | MaxLength of int
    | ShowTooltipForTrimmedText of bool
    | SelectAllOnGotFocus of bool
    | SelectAllOnMouseUp of bool
    | NullTextForeground of System.Windows.Media.Brush
    | TextInputSettings of DevExpress.Xpf.Editors.TextInputSettingsBase
    | AcceptsTab of bool
    ...
    | Label of string
    | AlwaysShowLabelAtTop of bool
    | AllowLabelAnimation of bool
...
module TextEditBase =
    ...
    let printTextWrapping v : obj = box (TextEditBaseProp.PrintTextWrapping v)
    ...
    let apply (el: DevExpress.Xpf.Editors.TextEditBase) (prop: TextEditBaseProp) =
        match prop with
        | TextEditBaseProp.Base p -> BaseEdit.apply el p
        | TextEditBaseProp.Text v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.TextProperty, box v)
        | TextEditBaseProp.EditNonEditableTemplate v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.EditNonEditableTemplateProperty, box v)
        | TextEditBaseProp.AcceptsReturn v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.AcceptsReturnProperty, box v)
        | TextEditBaseProp.TextWrapping v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.TextWrappingProperty, box v)
        | TextEditBaseProp.PrintTextWrapping v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.PrintTextWrappingProperty, box v)
        | TextEditBaseProp.VerticalScrollBarVisibility v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.VerticalScrollBarVisibilityProperty, box v)
        | TextEditBaseProp.HorizontalScrollBarVisibility v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.HorizontalScrollBarVisibilityProperty, box v)
        | TextEditBaseProp.MaxLength v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.MaxLengthProperty, box v)
        | TextEditBaseProp.ShowTooltipForTrimmedText v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.ShowTooltipForTrimmedTextProperty, box v)
        | TextEditBaseProp.SelectAllOnGotFocus v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.SelectAllOnGotFocusProperty, box v)
        | TextEditBaseProp.SelectAllOnMouseUp v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.SelectAllOnMouseUpProperty, box v)
        | TextEditBaseProp.NullTextForeground v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.NullTextForegroundProperty, box v)
        | TextEditBaseProp.TextInputSettings v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.TextInputSettingsProperty, box v)
        | TextEditBaseProp.AcceptsTab v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.AcceptsTabProperty, box v)
        | TextEditBaseProp.TextTrimming v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.TextTrimmingProperty, box v)
        | TextEditBaseProp.SelectionBrush v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.SelectionBrushProperty, box v)
        | TextEditBaseProp.CaretBrush v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.CaretBrushProperty, box v)
        | TextEditBaseProp.SelectionOpacity v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.SelectionOpacityProperty, box v)
        | TextEditBaseProp.Label v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.LabelProperty, box v)
        | TextEditBaseProp.AlwaysShowLabelAtTop v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.AlwaysShowLabelAtTopProperty, box v)
        | TextEditBaseProp.AllowLabelAnimation v -> el.SetValue(DevExpress.Xpf.Editors.TextEditBase.AllowLabelAnimationProperty, box v)
