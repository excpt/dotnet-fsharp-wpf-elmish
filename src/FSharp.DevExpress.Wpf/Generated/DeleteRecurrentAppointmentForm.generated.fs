...
type DeleteRecurrentAppointmentFormProp =
    | Title of string
    | Message of string
    | CurrentAppointment of DevExpress.XtraScheduler.Appointment
    | Action of DevExpress.XtraScheduler.RecurrentAppointmentAction

module DeleteRecurrentAppointmentForm =
    let title v : obj = box (DeleteRecurrentAppointmentFormProp.Title v)
    let message v : obj = box (DeleteRecurrentAppointmentFormProp.Message v)
    let currentAppointment v : obj = box (DeleteRecurrentAppointmentFormProp.CurrentAppointment v)
    let action v : obj = box (DeleteRecurrentAppointmentFormProp.Action v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.DeleteRecurrentAppointmentForm) (prop: DeleteRecurrentAppointmentFormProp) =
        match prop with
        | DeleteRecurrentAppointmentFormProp.Title v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.DeleteRecurrentAppointmentForm.TitleProperty, box v)
        | DeleteRecurrentAppointmentFormProp.Message v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.DeleteRecurrentAppointmentForm.MessageProperty, box v)
        | DeleteRecurrentAppointmentFormProp.CurrentAppointment v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.DeleteRecurrentAppointmentForm.CurrentAppointmentProperty, box v)
        | DeleteRecurrentAppointmentFormProp.Action v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.DeleteRecurrentAppointmentForm.ActionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.DeleteRecurrentAppointmentForm>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
