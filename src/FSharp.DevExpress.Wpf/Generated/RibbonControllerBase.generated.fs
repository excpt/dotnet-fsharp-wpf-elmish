...
type RibbonControllerBaseProp =
    | Base of BarManagerControllerProp

module RibbonControllerBase =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonControllerBase) (prop: RibbonControllerBaseProp) =
        match prop with
        | RibbonControllerBaseProp.Base p -> BarManagerController.apply el p
