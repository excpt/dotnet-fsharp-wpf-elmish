...
type TileArrowControlProp =
    | Base of ControlBaseProp
    | IsChecked of bool

module TileArrowControl =
    let isChecked v : obj = box (TileArrowControlProp.IsChecked v)

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileArrowControl) (prop: TileArrowControlProp) =
        match prop with
        | TileArrowControlProp.Base p -> ControlBase.apply el p
        | TileArrowControlProp.IsChecked v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.TileArrowControl.IsCheckedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
