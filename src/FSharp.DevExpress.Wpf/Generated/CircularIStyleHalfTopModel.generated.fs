...
type CircularIStyleHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularIStyleHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularIStyleHalfTopModel) (prop: CircularIStyleHalfTopModelProp) =
        match prop with
        | CircularIStyleHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularIStyleHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
