...
type BadgeBorderProp =
    | IgnoreCornerRadius of bool
    | Shape of DevExpress.Xpf.Core.BadgeShape

module BadgeBorder =
    let ignoreCornerRadius v : obj = box (BadgeBorderProp.IgnoreCornerRadius v)
    let shape v : obj = box (BadgeBorderProp.Shape v)

    let apply (el: DevExpress.Xpf.Core.Native.BadgeBorder) (prop: BadgeBorderProp) =
        match prop with
        | BadgeBorderProp.IgnoreCornerRadius v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeBorder.IgnoreCornerRadiusProperty, box v)
        | BadgeBorderProp.Shape v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeBorder.ShapeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.BadgeBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
