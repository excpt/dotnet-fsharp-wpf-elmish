...
type CircularFutureFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFutureFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFutureFullModel) (prop: CircularFutureFullModelProp) =
        match prop with
        | CircularFutureFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFutureFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
