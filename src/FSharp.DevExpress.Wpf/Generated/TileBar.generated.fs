...
module TileBar =
    let allowItemSelection v : obj = box (TileBarProp.AllowItemSelection v)
    let orientation v : obj = box (TileBarProp.Orientation v)
    let showGroupHeaders v : obj = box (TileBarProp.ShowGroupHeaders v)
    let groupHeaderSpacing v : obj = box (TileBarProp.GroupHeaderSpacing v)
    let groupHeaderStyle v : obj = box (TileBarProp.GroupHeaderStyle v)
    let groupHeaderTemplate v : obj = box (TileBarProp.GroupHeaderTemplate v)
    let itemColorMode v : obj = box (TileBarProp.ItemColorMode v)
    let flyoutShowDirection v : obj = box (TileBarProp.FlyoutShowDirection v)
    let itemSpacing v : obj = box (TileBarProp.ItemSpacing v)
    let flyoutShowMode v : obj = box (TileBarProp.FlyoutShowMode v)
    let showItemShadow v : obj = box (TileBarProp.ShowItemShadow v)

    let apply (el: DevExpress.Xpf.Navigation.TileBar) (prop: TileBarProp) =
        match prop with
        | TileBarProp.Base p -> veSelector.apply el p
        | TileBarProp.AllowItemSelection v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.AllowItemSelectionProperty, box v)
        | TileBarProp.Orientation v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.OrientationProperty, box v)
        | TileBarProp.ShowGroupHeaders v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.ShowGroupHeadersProperty, box v)
        | TileBarProp.GroupHeaderSpacing v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.GroupHeaderSpacingProperty, box v)
        | TileBarProp.GroupHeaderStyle v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.GroupHeaderStyleProperty, box v)
        | TileBarProp.GroupHeaderTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.GroupHeaderTemplateProperty, box v)
        | TileBarProp.ItemColorMode v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.ItemColorModeProperty, box v)
        | TileBarProp.FlyoutShowDirection v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.FlyoutShowDirectionProperty, box v)
        | TileBarProp.ItemSpacing v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.ItemSpacingProperty, box v)
        | TileBarProp.FlyoutShowMode v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.FlyoutShowModeProperty, box v)
        | TileBarProp.ShowItemShadow v -> el.SetValue(DevExpress.Xpf.Navigation.TileBar.ShowItemShadowProperty, box v)
    ...
    let groupHeader (v: obj) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Navigation.TileBar.GroupHeaderProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Navigation.TileBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
