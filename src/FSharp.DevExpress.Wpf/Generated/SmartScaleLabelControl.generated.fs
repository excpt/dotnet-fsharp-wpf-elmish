...
type SmartScaleLabelControlProp =
    | Base of PresentationControlProp

module SmartScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartScaleLabelControl) (prop: SmartScaleLabelControlProp) =
        match prop with
        | SmartScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
