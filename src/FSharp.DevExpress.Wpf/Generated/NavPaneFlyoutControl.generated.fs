...
type NavPaneFlyoutControlProp =
    | Base of FlyoutControlProp

module NavPaneFlyoutControl =

    let apply (el: DevExpress.Xpf.NavBar.NavPaneFlyoutControl) (prop: NavPaneFlyoutControlProp) =
        match prop with
        | NavPaneFlyoutControlProp.Base p -> FlyoutControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneFlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
