...
type SplineAreaFullStackedSeries2DProp =
    | Base of AreaFullStackedSeries2DProp
    | SplineAlgorithm of DevExpress.Xpf.Charts.SplineAlgorithm
    | LineTension of float

module SplineAreaFullStackedSeries2D =
    let splineAlgorithm v : obj = box (SplineAreaFullStackedSeries2DProp.SplineAlgorithm v)
    let lineTension v : obj = box (SplineAreaFullStackedSeries2DProp.LineTension v)

    let apply (el: DevExpress.Xpf.Charts.SplineAreaFullStackedSeries2D) (prop: SplineAreaFullStackedSeries2DProp) =
        match prop with
        | SplineAreaFullStackedSeries2DProp.Base p -> AreaFullStackedSeries2D.apply el p
        | SplineAreaFullStackedSeries2DProp.SplineAlgorithm v -> el.SetValue(DevExpress.Xpf.Charts.SplineAreaFullStackedSeries2D.SplineAlgorithmProperty, box v)
        | SplineAreaFullStackedSeries2DProp.LineTension v -> el.SetValue(DevExpress.Xpf.Charts.SplineAreaFullStackedSeries2D.LineTensionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SplineAreaFullStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
