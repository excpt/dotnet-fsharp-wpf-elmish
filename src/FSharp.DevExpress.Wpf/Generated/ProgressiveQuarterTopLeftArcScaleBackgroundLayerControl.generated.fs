...
type ProgressiveQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveQuarterTopLeftArcScaleBackgroundLayerControl) (prop: ProgressiveQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | ProgressiveQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
