...
type RowControlBaseProp =
    | RowData of DevExpress.Xpf.PropertyGrid.RowData
    | OwnerView of DevExpress.Xpf.PropertyGrid.PropertyGridView
    | ActualIndent of float
    | ExpandButtonWidth of float
    | DesiredHeaderWidth of float
    | State of DevExpress.Xpf.PropertyGrid.RowControlVisualStates
    | RenderReadOnly of bool
    | IsReadOnly of bool
    | CustomShowCommandButton of obj
    | ShowCommandButton of bool
    | ActualShowCommandButton of bool
    | IsExpanded of bool
    | IsSelected of bool
    | CanShowCollectionButton of bool
    | ShowCollectionButton of bool
    | IsCollectionRow of bool

module RowControlBase =
    ...
    let customShowCommandButton v : obj = box (RowControlBaseProp.CustomShowCommandButton v)
    ...
    let apply (el: DevExpress.Xpf.PropertyGrid.RowControlBase) (prop: RowControlBaseProp) =
        match prop with
        | RowControlBaseProp.RowData v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.RowDataProperty, box v)
        | RowControlBaseProp.OwnerView v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.OwnerViewProperty, box v)
        | RowControlBaseProp.ActualIndent v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.ActualIndentProperty, box v)
        | RowControlBaseProp.ExpandButtonWidth v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.ExpandButtonWidthProperty, box v)
        | RowControlBaseProp.DesiredHeaderWidth v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.DesiredHeaderWidthProperty, box v)
        | RowControlBaseProp.State v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.StateProperty, box v)
        | RowControlBaseProp.RenderReadOnly v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.RenderReadOnlyProperty, box v)
        | RowControlBaseProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.IsReadOnlyProperty, box v)
        | RowControlBaseProp.CustomShowCommandButton v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.CustomShowCommandButtonProperty, box v)
        | RowControlBaseProp.ShowCommandButton v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.ShowCommandButtonProperty, box v)
        | RowControlBaseProp.ActualShowCommandButton v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.ActualShowCommandButtonProperty, box v)
        | RowControlBaseProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.IsExpandedProperty, box v)
        | RowControlBaseProp.IsSelected v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.IsSelectedProperty, box v)
        | RowControlBaseProp.CanShowCollectionButton v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.CanShowCollectionButtonProperty, box v)
        | RowControlBaseProp.ShowCollectionButton v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.ShowCollectionButtonProperty, box v)
        | RowControlBaseProp.IsCollectionRow v -> el.SetValue(DevExpress.Xpf.PropertyGrid.RowControlBase.IsCollectionRowProperty, box v)
    ...
    let rowControl (v: DevExpress.Xpf.PropertyGrid.RowControlBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.PropertyGrid.RowControlBase.RowControlProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.PropertyGrid.RowControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
