...
type DetrendedPriceOscillatorProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel
    | PointsCount of int

module DetrendedPriceOscillator =
    let valueLevel v : obj = box (DetrendedPriceOscillatorProp.ValueLevel v)
    let pointsCount v : obj = box (DetrendedPriceOscillatorProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.DetrendedPriceOscillator) (prop: DetrendedPriceOscillatorProp) =
        match prop with
        | DetrendedPriceOscillatorProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | DetrendedPriceOscillatorProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.DetrendedPriceOscillator.ValueLevelProperty, box v)
        | DetrendedPriceOscillatorProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.DetrendedPriceOscillator.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.DetrendedPriceOscillator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
