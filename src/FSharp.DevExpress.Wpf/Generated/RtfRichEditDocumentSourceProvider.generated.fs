...
type RtfRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module RtfRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.RtfRichEditDocumentSourceProvider) (prop: RtfRichEditDocumentSourceProviderProp) =
        match prop with
        | RtfRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.RtfRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
