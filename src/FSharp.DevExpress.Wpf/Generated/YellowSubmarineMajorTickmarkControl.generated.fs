...
type YellowSubmarineMajorTickmarkControlProp =
    | Base of PresentationControlProp

module YellowSubmarineMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineMajorTickmarkControl) (prop: YellowSubmarineMajorTickmarkControlProp) =
        match prop with
        | YellowSubmarineMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
