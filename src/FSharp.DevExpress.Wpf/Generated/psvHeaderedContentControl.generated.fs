...
module psvHeaderedContentControl =
    ...
    let apply (el: DevExpress.Xpf.Docking.VisualElements.psvHeaderedContentControl) (prop: psvHeaderedContentControlProp) =
        match prop with
        | psvHeaderedContentControlProp.Base p -> psvContentControl.apply el p
        | psvHeaderedContentControlProp.Header v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.psvHeaderedContentControl.HeaderProperty, box v)
        | psvHeaderedContentControlProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.psvHeaderedContentControl.HeaderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.psvHeaderedContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
