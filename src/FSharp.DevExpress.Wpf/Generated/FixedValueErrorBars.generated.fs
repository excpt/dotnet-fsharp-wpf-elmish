...
type FixedValueErrorBarsProp =
    | Base of ErrorBarsProp
    | NegativeError of float
    | PositiveError of float

module FixedValueErrorBars =
    let negativeError v : obj = box (FixedValueErrorBarsProp.NegativeError v)
    let positiveError v : obj = box (FixedValueErrorBarsProp.PositiveError v)

    let apply (el: DevExpress.Xpf.Charts.FixedValueErrorBars) (prop: FixedValueErrorBarsProp) =
        match prop with
        | FixedValueErrorBarsProp.Base p -> ErrorBars.apply el p
        | FixedValueErrorBarsProp.NegativeError v -> el.SetValue(DevExpress.Xpf.Charts.FixedValueErrorBars.NegativeErrorProperty, box v)
        | FixedValueErrorBarsProp.PositiveError v -> el.SetValue(DevExpress.Xpf.Charts.FixedValueErrorBars.PositiveErrorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FixedValueErrorBars>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
