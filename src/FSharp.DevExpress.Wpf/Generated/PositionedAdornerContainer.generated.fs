...
type PositionedAdornerContainerProp =
    | Base of AdornerContainerProp

module PositionedAdornerContainer =

    let apply (el: DevExpress.Xpf.Core.PositionedAdornerContainer) (prop: PositionedAdornerContainerProp) =
        match prop with
        | PositionedAdornerContainerProp.Base p -> AdornerContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PositionedAdornerContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
