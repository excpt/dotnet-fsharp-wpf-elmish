...
type RibbonStatusBarPartControlBaseProp =
    | Base of RibbonLinksControlProp

module RibbonStatusBarPartControlBase =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonStatusBarPartControlBase) (prop: RibbonStatusBarPartControlBaseProp) =
        match prop with
        | RibbonStatusBarPartControlBaseProp.Base p -> RibbonLinksControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonStatusBarPartControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
