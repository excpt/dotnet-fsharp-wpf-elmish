...
type ClassicLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module ClassicLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicLinearScaleLevelBarForegroundControl) (prop: ClassicLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | ClassicLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
