...
type CheckEditBoxProp =
    | Base of ToggleStateButtonProp
    | DisplayMode of DevExpress.Xpf.Editors.CheckEditDisplayMode
    | Glyph of System.Windows.Media.ImageSource
    | GlyphTemplate of System.Windows.DataTemplate

module CheckEditBox =
    let displayMode v : obj = box (CheckEditBoxProp.DisplayMode v)
    let glyph v : obj = box (CheckEditBoxProp.Glyph v)
    let glyphTemplate v : obj = box (CheckEditBoxProp.GlyphTemplate v)

    let apply (el: DevExpress.Xpf.Editors.CheckEditBox) (prop: CheckEditBoxProp) =
        match prop with
        | CheckEditBoxProp.Base p -> ToggleStateButton.apply el p
        | CheckEditBoxProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Editors.CheckEditBox.DisplayModeProperty, box v)
        | CheckEditBoxProp.Glyph v -> el.SetValue(DevExpress.Xpf.Editors.CheckEditBox.GlyphProperty, box v)
        | CheckEditBoxProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.Editors.CheckEditBox.GlyphTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CheckEditBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
