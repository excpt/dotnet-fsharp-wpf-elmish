...
type EntityPLinqServerModeDataSourceProp =
    | Base of PLinqServerModeDataSourceBaseProp

module EntityPLinqServerModeDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.EntityPLinqServerModeDataSource) (prop: EntityPLinqServerModeDataSourceProp) =
        match prop with
        | EntityPLinqServerModeDataSourceProp.Base p -> PLinqServerModeDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.EntityPLinqServerModeDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
