...
type WeeklyRecurrenceControlProp =
    | Base of RecurrenceControlBaseProp
    | RecurrenceInfo of DevExpress.XtraScheduler.RecurrenceInfo
    | FirstDayOfWeek of System.DayOfWeek

module WeeklyRecurrenceControl =
    let recurrenceInfo v : obj = box (WeeklyRecurrenceControlProp.RecurrenceInfo v)
    let firstDayOfWeek v : obj = box (WeeklyRecurrenceControlProp.FirstDayOfWeek v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.WeeklyRecurrenceControl) (prop: WeeklyRecurrenceControlProp) =
        match prop with
        | WeeklyRecurrenceControlProp.Base p -> RecurrenceControlBase.apply el p
        | WeeklyRecurrenceControlProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.WeeklyRecurrenceControl.RecurrenceInfoProperty, box v)
        | WeeklyRecurrenceControlProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.WeeklyRecurrenceControl.FirstDayOfWeekProperty, box v)

    let isReadOnly v : obj = box (RecurrenceControlBaseProp.IsReadOnly v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.WeeklyRecurrenceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
