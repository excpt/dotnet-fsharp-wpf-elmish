...
type SeriesSeriesPointsActionProp =
    | Base of SeriesAnimationActionProp
    | Sequential of bool
    | EqualSpeed of bool
    | DelayPercentage of float

module SeriesSeriesPointsAction =
    let sequential v : obj = box (SeriesSeriesPointsActionProp.Sequential v)
    let equalSpeed v : obj = box (SeriesSeriesPointsActionProp.EqualSpeed v)
    let delayPercentage v : obj = box (SeriesSeriesPointsActionProp.DelayPercentage v)

    let apply (el: DevExpress.Xpf.Charts.SeriesSeriesPointsAction) (prop: SeriesSeriesPointsActionProp) =
        match prop with
        | SeriesSeriesPointsActionProp.Base p -> SeriesAnimationAction.apply el p
        | SeriesSeriesPointsActionProp.Sequential v -> el.SetValue(DevExpress.Xpf.Charts.SeriesSeriesPointsAction.SequentialProperty, box v)
        | SeriesSeriesPointsActionProp.EqualSpeed v -> el.SetValue(DevExpress.Xpf.Charts.SeriesSeriesPointsAction.EqualSpeedProperty, box v)
        | SeriesSeriesPointsActionProp.DelayPercentage v -> el.SetValue(DevExpress.Xpf.Charts.SeriesSeriesPointsAction.DelayPercentageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesSeriesPointsAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
