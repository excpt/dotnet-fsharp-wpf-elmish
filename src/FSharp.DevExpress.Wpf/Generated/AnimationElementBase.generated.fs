...
type AnimationElementBaseProp =
    | AccelerateRatio of float

module AnimationElementBase =
    let accelerateRatio v : obj = box (AnimationElementBaseProp.AccelerateRatio v)

    let apply (el: DevExpress.Xpf.Editors.AnimationElementBase) (prop: AnimationElementBaseProp) =
        match prop with
        | AnimationElementBaseProp.AccelerateRatio v -> el.SetValue(DevExpress.Xpf.Editors.AnimationElementBase.AccelerateRatioProperty, box v)
