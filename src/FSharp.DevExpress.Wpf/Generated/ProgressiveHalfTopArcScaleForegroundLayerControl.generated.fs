...
type ProgressiveHalfTopArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveHalfTopArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveHalfTopArcScaleForegroundLayerControl) (prop: ProgressiveHalfTopArcScaleForegroundLayerControlProp) =
        match prop with
        | ProgressiveHalfTopArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveHalfTopArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
