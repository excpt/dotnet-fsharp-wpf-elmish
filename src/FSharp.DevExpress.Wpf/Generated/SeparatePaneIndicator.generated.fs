...
type SeparatePaneIndicatorProp =
    | Base of IndicatorProp
    | Pane of obj
    | AxisY of obj

module SeparatePaneIndicator =
    let pane v : obj = box (SeparatePaneIndicatorProp.Pane v)
    let axisY v : obj = box (SeparatePaneIndicatorProp.AxisY v)

    let apply (el: DevExpress.Xpf.Charts.SeparatePaneIndicator) (prop: SeparatePaneIndicatorProp) =
        match prop with
        | SeparatePaneIndicatorProp.Base p -> Indicator.apply el p
        | SeparatePaneIndicatorProp.Pane v -> el.SetValue(DevExpress.Xpf.Charts.SeparatePaneIndicator.PaneProperty, box v)
        | SeparatePaneIndicatorProp.AxisY v -> el.SetValue(DevExpress.Xpf.Charts.SeparatePaneIndicator.AxisYProperty, box v)
