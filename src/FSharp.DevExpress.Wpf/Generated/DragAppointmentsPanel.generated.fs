...
type DragAppointmentsPanelProp =
    | Base of SchedulerCellsPanelBaseProp

module DragAppointmentsPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DragAppointmentsPanel) (prop: DragAppointmentsPanelProp) =
        match prop with
        | DragAppointmentsPanelProp.Base p -> SchedulerCellsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DragAppointmentsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
