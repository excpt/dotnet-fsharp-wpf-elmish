...
type PercentageErrorBarsProp =
    | Base of ErrorBarsProp
    | Percent of float

module PercentageErrorBars =
    let percent v : obj = box (PercentageErrorBarsProp.Percent v)

    let apply (el: DevExpress.Xpf.Charts.PercentageErrorBars) (prop: PercentageErrorBarsProp) =
        match prop with
        | PercentageErrorBarsProp.Base p -> ErrorBars.apply el p
        | PercentageErrorBarsProp.Percent v -> el.SetValue(DevExpress.Xpf.Charts.PercentageErrorBars.PercentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PercentageErrorBars>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
