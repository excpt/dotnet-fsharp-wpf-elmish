...
type ExponentialMovingAverageProp =
    | Base of MovingAverageProp

module ExponentialMovingAverage =

    let apply (el: DevExpress.Xpf.Charts.ExponentialMovingAverage) (prop: ExponentialMovingAverageProp) =
        match prop with
        | ExponentialMovingAverageProp.Base p -> MovingAverage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ExponentialMovingAverage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
