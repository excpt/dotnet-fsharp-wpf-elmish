...
type DockBarContainerControlBaseProp =
    | Base of BarContainerControlProp

module DockBarContainerControlBase =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockBarContainerControlBase) (prop: DockBarContainerControlBaseProp) =
        match prop with
        | DockBarContainerControlBaseProp.Base p -> BarContainerControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockBarContainerControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
