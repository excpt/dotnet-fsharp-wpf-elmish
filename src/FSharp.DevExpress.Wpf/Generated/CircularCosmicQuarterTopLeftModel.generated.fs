...
type CircularCosmicQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCosmicQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCosmicQuarterTopLeftModel) (prop: CircularCosmicQuarterTopLeftModelProp) =
        match prop with
        | CircularCosmicQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCosmicQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
