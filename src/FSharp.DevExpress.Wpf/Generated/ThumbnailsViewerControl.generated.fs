...
type ThumbnailsViewerControlProp =
    | Settings of DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsViewerSettings
    | SelectedPageNumber of int
    | FilteredPageIndices of obj

module ThumbnailsViewerControl =
    let settings v : obj = box (ThumbnailsViewerControlProp.Settings v)
    let selectedPageNumber v : obj = box (ThumbnailsViewerControlProp.SelectedPageNumber v)
    let filteredPageIndices v : obj = box (ThumbnailsViewerControlProp.FilteredPageIndices v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsViewerControl) (prop: ThumbnailsViewerControlProp) =
        match prop with
        | ThumbnailsViewerControlProp.Settings v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsViewerControl.SettingsProperty, box v)
        | ThumbnailsViewerControlProp.SelectedPageNumber v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsViewerControl.SelectedPageNumberProperty, box v)
        | ThumbnailsViewerControlProp.FilteredPageIndices v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsViewerControl.FilteredPageIndicesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsViewerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
