...
type AxisProp =
    ...
    | Title of DevExpress.Xpf.Charts.AxisTitle
    | Logarithmic of bool
...
module Axis =
    ...
    let apply (el: DevExpress.Xpf.Charts.Axis) (prop: AxisProp) =
        match prop with
        | AxisProp.Base p -> AxisBase.apply el p
        | AxisProp.GridSpacing v -> el.SetValue(DevExpress.Xpf.Charts.Axis.GridSpacingProperty, box v)
        | AxisProp.DateTimeMeasureUnit v -> el.SetValue(DevExpress.Xpf.Charts.Axis.DateTimeMeasureUnitProperty, box v)
        | AxisProp.DateTimeGridAlignment v -> el.SetValue(DevExpress.Xpf.Charts.Axis.DateTimeGridAlignmentProperty, box v)
        | AxisProp.DateTimeOptions v -> el.SetValue(DevExpress.Xpf.Charts.Axis.DateTimeOptionsProperty, box v)
        | AxisProp.Range v -> el.SetValue(DevExpress.Xpf.Charts.Axis.RangeProperty, box v)
        | AxisProp.Title v -> el.SetValue(DevExpress.Xpf.Charts.Axis.TitleProperty, box v)
        | AxisProp.Logarithmic v -> el.SetValue(DevExpress.Xpf.Charts.Axis.LogarithmicProperty, box v)
        | AxisProp.LogarithmicBase v -> el.SetValue(DevExpress.Xpf.Charts.Axis.LogarithmicBaseProperty, box v)
        | AxisProp.WholeRange v -> el.SetValue(DevExpress.Xpf.Charts.Axis.WholeRangeProperty, box v)
