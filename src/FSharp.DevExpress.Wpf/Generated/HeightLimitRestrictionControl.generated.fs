...
type HeightLimitRestrictionControlProp =
    | Padding of System.Windows.Thickness

module HeightLimitRestrictionControl =
    let padding v : obj = box (HeightLimitRestrictionControlProp.Padding v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HeightLimitRestrictionControl) (prop: HeightLimitRestrictionControlProp) =
        match prop with
        | HeightLimitRestrictionControlProp.Padding v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeightLimitRestrictionControl.PaddingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HeightLimitRestrictionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
