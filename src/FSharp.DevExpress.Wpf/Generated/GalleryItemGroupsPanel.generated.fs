...
type GalleryItemGroupsPanelProp =
    | ViewportSize of System.Windows.Size

module GalleryItemGroupsPanel =
    let viewportSize v : obj = box (GalleryItemGroupsPanelProp.ViewportSize v)

    let apply (el: DevExpress.Xpf.Bars.GalleryItemGroupsPanel) (prop: GalleryItemGroupsPanelProp) =
        match prop with
        | GalleryItemGroupsPanelProp.ViewportSize v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupsPanel.ViewportSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryItemGroupsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
