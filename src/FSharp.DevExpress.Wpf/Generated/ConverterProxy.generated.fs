...
type ConverterProxyProp =
    | ConverterResourceName of obj
    | ValueToConvert of obj
    | ConvertedValue of obj

module ConverterProxy =
    let converterResourceName v : obj = box (ConverterProxyProp.ConverterResourceName v)
    let valueToConvert v : obj = box (ConverterProxyProp.ValueToConvert v)
    let convertedValue v : obj = box (ConverterProxyProp.ConvertedValue v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.ConverterProxy) (prop: ConverterProxyProp) =
        match prop with
        | ConverterProxyProp.ConverterResourceName v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ConverterProxy.ConverterResourceNameProperty, box v)
        | ConverterProxyProp.ValueToConvert v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ConverterProxy.ValueToConvertProperty, box v)
        | ConverterProxyProp.ConvertedValue v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ConverterProxy.ConvertedValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.ConverterProxy>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
