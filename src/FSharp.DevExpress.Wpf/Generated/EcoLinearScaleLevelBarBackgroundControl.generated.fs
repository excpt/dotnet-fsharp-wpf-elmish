...
type EcoLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module EcoLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoLinearScaleLevelBarBackgroundControl) (prop: EcoLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | EcoLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
