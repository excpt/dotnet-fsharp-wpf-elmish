...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.Native.QueryBuilder
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type QueryBuilderDiagramConnectorBaseProp =
    | Base of DiagramConnectorProp

module QueryBuilderDiagramConnectorBase =

    let apply (el: DevExpress.Xpf.DataAccess.Native.QueryBuilder.QueryBuilderDiagramConnectorBase) (prop: QueryBuilderDiagramConnectorBaseProp) =
        match prop with
        | QueryBuilderDiagramConnectorBaseProp.Base p -> DiagramConnector.apply el p
