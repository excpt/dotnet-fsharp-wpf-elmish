...
type FieldDataValueContentPresenterProp =
    | Base of ScrollableAreaItemContentPresenterProp

module FieldDataValueContentPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldDataValueContentPresenter) (prop: FieldDataValueContentPresenterProp) =
        match prop with
        | FieldDataValueContentPresenterProp.Base p -> ScrollableAreaItemContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldDataValueContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
