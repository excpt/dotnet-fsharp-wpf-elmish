...
type BubbleSeries3DProp =
    | Base of MarkerSeries3DProp
    | MaxSize of float
    | MinSize of float
    | WeightDataMember of string
    | AutoSize of bool

module BubbleSeries3D =
    let maxSize v : obj = box (BubbleSeries3DProp.MaxSize v)
    let minSize v : obj = box (BubbleSeries3DProp.MinSize v)
    let weightDataMember v : obj = box (BubbleSeries3DProp.WeightDataMember v)
    let autoSize v : obj = box (BubbleSeries3DProp.AutoSize v)

    let apply (el: DevExpress.Xpf.Charts.BubbleSeries3D) (prop: BubbleSeries3DProp) =
        match prop with
        | BubbleSeries3DProp.Base p -> MarkerSeries3D.apply el p
        | BubbleSeries3DProp.MaxSize v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries3D.MaxSizeProperty, box v)
        | BubbleSeries3DProp.MinSize v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries3D.MinSizeProperty, box v)
        | BubbleSeries3DProp.WeightDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries3D.WeightDataMemberProperty, box v)
        | BubbleSeries3DProp.AutoSize v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries3D.AutoSizeProperty, box v)

    let model v : obj = box (MarkerSeries3DProp.Model v)
    ...
    let weight (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BubbleSeries3D.WeightProperty, box v)) :: node.Props }
    let valueToDisplay (v: DevExpress.Xpf.Charts.BubbleLabelValueToDisplay) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BubbleSeries3D.ValueToDisplayProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.BubbleSeries3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
