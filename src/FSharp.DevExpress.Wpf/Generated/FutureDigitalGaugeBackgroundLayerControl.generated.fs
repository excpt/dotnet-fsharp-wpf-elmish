...
type FutureDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureDigitalGaugeBackgroundLayerControl) (prop: FutureDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | FutureDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
