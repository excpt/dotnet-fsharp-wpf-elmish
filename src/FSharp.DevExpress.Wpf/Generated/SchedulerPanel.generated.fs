...
type SchedulerPanelProp =
    | Base of SchedulerPanelBaseProp

module SchedulerPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerPanel) (prop: SchedulerPanelProp) =
        match prop with
        | SchedulerPanelProp.Base p -> SchedulerPanelBase.apply el p
