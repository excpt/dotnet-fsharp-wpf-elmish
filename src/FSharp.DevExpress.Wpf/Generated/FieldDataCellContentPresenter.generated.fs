...
type FieldDataCellContentPresenterProp =
    | Base of ScrollableAreaItemContentPresenterProp

module FieldDataCellContentPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldDataCellContentPresenter) (prop: FieldDataCellContentPresenterProp) =
        match prop with
        | FieldDataCellContentPresenterProp.Base p -> ScrollableAreaItemContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldDataCellContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
