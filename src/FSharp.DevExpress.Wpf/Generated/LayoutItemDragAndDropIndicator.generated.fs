...
type LayoutItemDragAndDropIndicatorProp =
    | Base of PanelBaseProp

module LayoutItemDragAndDropIndicator =

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemDragAndDropIndicator) (prop: LayoutItemDragAndDropIndicatorProp) =
        match prop with
        | LayoutItemDragAndDropIndicatorProp.Base p -> PanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemDragAndDropIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
