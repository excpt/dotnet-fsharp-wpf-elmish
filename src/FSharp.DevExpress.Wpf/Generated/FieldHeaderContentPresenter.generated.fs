...
type FieldHeaderContentPresenterProp =
    | Base of PivotContentPresenterProp
    | Field of DevExpress.Xpf.PivotGrid.PivotGridField

module FieldHeaderContentPresenter =
    let field v : obj = box (FieldHeaderContentPresenterProp.Field v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentPresenter) (prop: FieldHeaderContentPresenterProp) =
        match prop with
        | FieldHeaderContentPresenterProp.Base p -> PivotContentPresenter.apply el p
        | FieldHeaderContentPresenterProp.Field v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentPresenter.FieldProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
