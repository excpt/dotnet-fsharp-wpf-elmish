...
type VerticalBoundsSnapLineAdornerProp =
    | Base of BoundsSnapLineAdornerProp

module VerticalBoundsSnapLineAdorner =

    let apply (el: DevExpress.Xpf.Diagram.Native.VerticalBoundsSnapLineAdorner) (prop: VerticalBoundsSnapLineAdornerProp) =
        match prop with
        | VerticalBoundsSnapLineAdornerProp.Base p -> BoundsSnapLineAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.VerticalBoundsSnapLineAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
