...
type BackstageViewItemsControlProp =
    | ItemsPresenterStyle of System.Windows.Style

module BackstageViewItemsControl =
    let itemsPresenterStyle v : obj = box (BackstageViewItemsControlProp.ItemsPresenterStyle v)

    let apply (el: DevExpress.Xpf.Ribbon.BackstageViewItemsControl) (prop: BackstageViewItemsControlProp) =
        match prop with
        | BackstageViewItemsControlProp.ItemsPresenterStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageViewItemsControl.ItemsPresenterStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageViewItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
