...
type ClassicLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicLinearScaleBackgroundLayerControl) (prop: ClassicLinearScaleBackgroundLayerControlProp) =
        match prop with
        | ClassicLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
