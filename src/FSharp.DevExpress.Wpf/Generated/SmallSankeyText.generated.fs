...
type SmallSankeyTextProp =
    | Base of SankeyTextElementProp

module SmallSankeyText =

    let apply (el: DevExpress.Xpf.Charts.Sankey.SmallSankeyText) (prop: SmallSankeyTextProp) =
        match prop with
        | SmallSankeyTextProp.Base p -> SankeyTextElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.SmallSankeyText>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
