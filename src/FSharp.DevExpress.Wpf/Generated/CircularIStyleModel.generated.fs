...
type CircularIStyleModelProp =
    | Base of CircularGaugeModelProp

module CircularIStyleModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularIStyleModel) (prop: CircularIStyleModelProp) =
        match prop with
        | CircularIStyleModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularIStyleModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
