...
type FlatLightLinearScaleLevelBarBackgroundControlProp =
    | Base of PresentationControlProp

module FlatLightLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightLinearScaleLevelBarBackgroundControl) (prop: FlatLightLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | FlatLightLinearScaleLevelBarBackgroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
