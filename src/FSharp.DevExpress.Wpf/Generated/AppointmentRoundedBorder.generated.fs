...
type AppointmentRoundedBorderProp =
    | Base of RoundedBorderControlProp
    ...
    | DefaultRoundBorderThickness of System.Windows.Thickness

module AppointmentRoundedBorder =
    let viewInfo v : obj = box (AppointmentRoundedBorderProp.ViewInfo v)
    let defaultCornerRadius v : obj = box (AppointmentRoundedBorderProp.DefaultCornerRadius v)
    let defaultMargin v : obj = box (AppointmentRoundedBorderProp.DefaultMargin v)
    let noBorderMargin v : obj = box (AppointmentRoundedBorderProp.NoBorderMargin v)
    let defaultRoundBorderThickness v : obj = box (AppointmentRoundedBorderProp.DefaultRoundBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder) (prop: AppointmentRoundedBorderProp) =
        match prop with
        | AppointmentRoundedBorderProp.Base p -> RoundedBorderControl.apply el p
        | AppointmentRoundedBorderProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder.ViewInfoProperty, box v)
        | AppointmentRoundedBorderProp.DefaultCornerRadius v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder.DefaultCornerRadiusProperty, box v)
        | AppointmentRoundedBorderProp.DefaultMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder.DefaultMarginProperty, box v)
        | AppointmentRoundedBorderProp.NoBorderMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder.NoBorderMarginProperty, box v)
        | AppointmentRoundedBorderProp.DefaultRoundBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder.DefaultRoundBorderThicknessProperty, box v)

    let cornerRadius v : obj = box (RoundedBorderControlProp.CornerRadius v)
    let roundBorderThickness v : obj = box (RoundedBorderControlProp.RoundBorderThickness v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentRoundedBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
