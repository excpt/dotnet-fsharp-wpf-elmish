...
type SpreadsheetFormulaBarControlProp =
    | IsExpanded of bool
    | SpreadsheetControl of DevExpress.XtraSpreadsheet.ISpreadsheetControl
    | ShowNameBox of bool
    | ShowFormulaBarButtons of bool
    | ShowFormulaBarEditor of bool
    | NameBoxItemDisplayMode of DevExpress.Xpf.Spreadsheet.NameBoxItemDisplayMode

module SpreadsheetFormulaBarControl =
    let isExpanded v : obj = box (SpreadsheetFormulaBarControlProp.IsExpanded v)
    let spreadsheetControl v : obj = box (SpreadsheetFormulaBarControlProp.SpreadsheetControl v)
    let showNameBox v : obj = box (SpreadsheetFormulaBarControlProp.ShowNameBox v)
    let showFormulaBarButtons v : obj = box (SpreadsheetFormulaBarControlProp.ShowFormulaBarButtons v)
    let showFormulaBarEditor v : obj = box (SpreadsheetFormulaBarControlProp.ShowFormulaBarEditor v)
    let nameBoxItemDisplayMode v : obj = box (SpreadsheetFormulaBarControlProp.NameBoxItemDisplayMode v)

    let apply (el: DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl) (prop: SpreadsheetFormulaBarControlProp) =
        match prop with
        | SpreadsheetFormulaBarControlProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl.IsExpandedProperty, box v)
        | SpreadsheetFormulaBarControlProp.SpreadsheetControl v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl.SpreadsheetControlProperty, box v)
        | SpreadsheetFormulaBarControlProp.ShowNameBox v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl.ShowNameBoxProperty, box v)
        | SpreadsheetFormulaBarControlProp.ShowFormulaBarButtons v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl.ShowFormulaBarButtonsProperty, box v)
        | SpreadsheetFormulaBarControlProp.ShowFormulaBarEditor v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl.ShowFormulaBarEditorProperty, box v)
        | SpreadsheetFormulaBarControlProp.NameBoxItemDisplayMode v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl.NameBoxItemDisplayModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.SpreadsheetFormulaBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
