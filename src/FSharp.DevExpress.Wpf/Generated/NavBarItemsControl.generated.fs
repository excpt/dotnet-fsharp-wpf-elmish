...
type NavBarItemsControlProp =
    | ItemsSourceCore of System.Collections.Specialized.INotifyCollectionChanged

module NavBarItemsControl =
    let itemsSourceCore v : obj = box (NavBarItemsControlProp.ItemsSourceCore v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarItemsControl) (prop: NavBarItemsControlProp) =
        match prop with
        | NavBarItemsControlProp.ItemsSourceCore v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarItemsControl.ItemsSourceCoreProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
