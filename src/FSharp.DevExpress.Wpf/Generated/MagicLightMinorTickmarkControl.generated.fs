...
type MagicLightMinorTickmarkControlProp =
    | Base of PresentationControlProp

module MagicLightMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightMinorTickmarkControl) (prop: MagicLightMinorTickmarkControlProp) =
        match prop with
        | MagicLightMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
