...
type PlainTextRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module PlainTextRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.PlainTextRichEditDocumentSourceProvider) (prop: PlainTextRichEditDocumentSourceProviderProp) =
        match prop with
        | PlainTextRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.PlainTextRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
