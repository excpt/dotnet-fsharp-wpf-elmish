...
type BaseContainerItemsControlProp =
    | Base of SchedulerItemsControlProp

module BaseContainerItemsControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.BaseContainerItemsControl) (prop: BaseContainerItemsControlProp) =
        match prop with
        | BaseContainerItemsControlProp.Base p -> SchedulerItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.BaseContainerItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
