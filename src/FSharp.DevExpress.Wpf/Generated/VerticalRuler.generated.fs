...
type VerticalRulerProp =
    | Base of RulerProp

module VerticalRuler =

    let apply (el: DevExpress.Xpf.Diagram.VerticalRuler) (prop: VerticalRulerProp) =
        match prop with
        | VerticalRulerProp.Base p -> Ruler.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.VerticalRuler>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
