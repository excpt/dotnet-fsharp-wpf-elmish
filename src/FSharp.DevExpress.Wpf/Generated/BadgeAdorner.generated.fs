...
open System
open System.Windows
open DevExpress.Xpf.Core.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type BadgeAdornerProp =
    | Base of AdornerContainerProp

module BadgeAdorner =

    let apply (el: DevExpress.Xpf.Core.Internal.BadgeAdorner) (prop: BadgeAdornerProp) =
        match prop with
        | BadgeAdornerProp.Base p -> AdornerContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Internal.BadgeAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
