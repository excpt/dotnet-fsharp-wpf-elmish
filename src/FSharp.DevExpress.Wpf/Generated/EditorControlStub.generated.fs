...
type EditorControlStubProp =
    | Base of ControlExProp
    | IsTextEditable of bool
    | IsReadOnly of bool
    | EditValue of obj
    | IsChecked of obj
    | SelectedItem of obj
    | SelectedIndex of obj
    | DisplayText of obj
    | HighlightedText of string
    | HighlightedTextCriteria of DevExpress.Xpf.Editors.HighlightedTextCriteria
...
module EditorControlStub =
    let isTextEditable v : obj = box (EditorControlStubProp.IsTextEditable v)
    let isReadOnly v : obj = box (EditorControlStubProp.IsReadOnly v)
    let editValue v : obj = box (EditorControlStubProp.EditValue v)
    let isChecked v : obj = box (EditorControlStubProp.IsChecked v)
    let selectedItem v : obj = box (EditorControlStubProp.SelectedItem v)
    let selectedIndex v : obj = box (EditorControlStubProp.SelectedIndex v)
    let displayText v : obj = box (EditorControlStubProp.DisplayText v)
    let highlightedText v : obj = box (EditorControlStubProp.HighlightedText v)
    let highlightedTextCriteria v : obj = box (EditorControlStubProp.HighlightedTextCriteria v)
    let itemTemplateSelector v : obj = box (EditorControlStubProp.ItemTemplateSelector v)
    let itemTemplate v : obj = box (EditorControlStubProp.ItemTemplate v)
    let styleSettings v : obj = box (EditorControlStubProp.StyleSettings v)

    let apply (el: DevExpress.Xpf.Editors.Internal.EditorControlStub) (prop: EditorControlStubProp) =
        match prop with
        | EditorControlStubProp.Base p -> ControlEx.apply el p
        | EditorControlStubProp.IsTextEditable v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.IsTextEditableProperty, box v)
        | EditorControlStubProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.IsReadOnlyProperty, box v)
        | EditorControlStubProp.EditValue v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.EditValueProperty, box v)
        | EditorControlStubProp.IsChecked v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.IsCheckedProperty, box v)
        | EditorControlStubProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.SelectedItemProperty, box v)
        | EditorControlStubProp.SelectedIndex v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.SelectedIndexProperty, box v)
        | EditorControlStubProp.DisplayText v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.DisplayTextProperty, box v)
        | EditorControlStubProp.HighlightedText v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.HighlightedTextProperty, box v)
        | EditorControlStubProp.HighlightedTextCriteria v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.HighlightedTextCriteriaProperty, box v)
        | EditorControlStubProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.ItemTemplateSelectorProperty, box v)
        | EditorControlStubProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.ItemTemplateProperty, box v)
        | EditorControlStubProp.StyleSettings v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditorControlStub.StyleSettingsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.EditorControlStub>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
