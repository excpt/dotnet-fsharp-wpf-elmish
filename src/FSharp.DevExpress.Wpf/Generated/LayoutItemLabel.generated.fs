...
type LayoutItemLabelProp =
    | Base of ContentControlBaseProp
    | IsRequired of bool

module LayoutItemLabel =
    let isRequired v : obj = box (LayoutItemLabelProp.IsRequired v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemLabel) (prop: LayoutItemLabelProp) =
        match prop with
        | LayoutItemLabelProp.Base p -> ContentControlBase.apply el p
        | LayoutItemLabelProp.IsRequired v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemLabel.IsRequiredProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
