...
type GanttTaskControlBaseProp =
    | Base of GanttItemControlBaseProp
    | ProgressBackground of System.Windows.Media.Brush
    | CornerRadius of System.Windows.CornerRadius

module GanttTaskControlBase =
    ...
    let apply (el: DevExpress.Xpf.Gantt.GanttTaskControlBase) (prop: GanttTaskControlBaseProp) =
        match prop with
        | GanttTaskControlBaseProp.Base p -> GanttItemControlBase.apply el p
        | GanttTaskControlBaseProp.ProgressBackground v -> el.SetValue(DevExpress.Xpf.Gantt.GanttTaskControlBase.ProgressBackgroundProperty, box v)
        | GanttTaskControlBaseProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Gantt.GanttTaskControlBase.CornerRadiusProperty, box v)
