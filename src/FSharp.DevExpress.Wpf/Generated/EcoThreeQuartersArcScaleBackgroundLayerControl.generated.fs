...
type EcoThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoThreeQuartersArcScaleBackgroundLayerControl) (prop: EcoThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | EcoThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
