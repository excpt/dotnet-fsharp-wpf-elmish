...
open System
open System.Windows
open DevExpress.Xpf.Charts.RangeControlClient
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ChartRangeControlClientProp =
    | Base of ChartRangeControlClientBaseProp
    | ItemsSource of obj
    | ArgumentDataMember of string
    | ValueDataMember of string
    | GridSpacing of float
    | ArgumentLabelFormatString of string
    | View of DevExpress.Xpf.Charts.RangeControlClient.RangeControlClientView

module ChartRangeControlClient =
    let itemsSource v : obj = box (ChartRangeControlClientProp.ItemsSource v)
    let argumentDataMember v : obj = box (ChartRangeControlClientProp.ArgumentDataMember v)
    let valueDataMember v : obj = box (ChartRangeControlClientProp.ValueDataMember v)
    let gridSpacing v : obj = box (ChartRangeControlClientProp.GridSpacing v)
    let argumentLabelFormatString v : obj = box (ChartRangeControlClientProp.ArgumentLabelFormatString v)
    let view v : obj = box (ChartRangeControlClientProp.View v)

    let apply (el: DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient) (prop: ChartRangeControlClientProp) =
        match prop with
        | ChartRangeControlClientProp.Base p -> ChartRangeControlClientBase.apply el p
        | ChartRangeControlClientProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient.ItemsSourceProperty, box v)
        | ChartRangeControlClientProp.ArgumentDataMember v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient.ArgumentDataMemberProperty, box v)
        | ChartRangeControlClientProp.ValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient.ValueDataMemberProperty, box v)
        | ChartRangeControlClientProp.GridSpacing v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient.GridSpacingProperty, box v)
        | ChartRangeControlClientProp.ArgumentLabelFormatString v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient.ArgumentLabelFormatStringProperty, box v)
        | ChartRangeControlClientProp.View v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClient.ViewProperty, box v)

    let thumbLabelFormatString v : obj = box (ChartRangeControlClientBaseProp.ThumbLabelFormatString v)
    let showArgumentLabels v : obj = box (ChartRangeControlClientBaseProp.ShowArgumentLabels v)
    let argumentLabelTemplate v : obj = box (ChartRangeControlClientBaseProp.ArgumentLabelTemplate v)
    let showGridLines v : obj = box (ChartRangeControlClientBaseProp.ShowGridLines v)
    let gridLinesBrush v : obj = box (ChartRangeControlClientBaseProp.GridLinesBrush v)
