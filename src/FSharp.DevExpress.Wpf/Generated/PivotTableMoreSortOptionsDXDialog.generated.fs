...
type PivotTableMoreSortOptionsDXDialogProp =
    | Base of ModelessDXDialogProp

module PivotTableMoreSortOptionsDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotTableMoreSortOptionsDXDialog) (prop: PivotTableMoreSortOptionsDXDialogProp) =
        match prop with
        | PivotTableMoreSortOptionsDXDialogProp.Base p -> ModelessDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotTableMoreSortOptionsDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
