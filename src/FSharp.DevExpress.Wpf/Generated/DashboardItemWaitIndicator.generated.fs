...
type DashboardItemWaitIndicatorProp =
    | Base of ColumnWaitIndicatorProp

module DashboardItemWaitIndicator =

    let apply (el: DevExpress.DashboardWpf.Internal.DashboardItemWaitIndicator) (prop: DashboardItemWaitIndicatorProp) =
        match prop with
        | DashboardItemWaitIndicatorProp.Base p -> ColumnWaitIndicator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.DashboardItemWaitIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
