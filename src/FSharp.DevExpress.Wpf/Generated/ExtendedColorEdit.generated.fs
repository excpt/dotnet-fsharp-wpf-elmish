...
type ExtendedColorEditProp =
    | Base of ColorEditProp
    | EditColorPaletteName of string
    | LastAppliedColor of obj
    | Diagram of DevExpress.Xpf.Diagram.DiagramControl

module ExtendedColorEdit =
    let editColorPaletteName v : obj = box (ExtendedColorEditProp.EditColorPaletteName v)
    let lastAppliedColor v : obj = box (ExtendedColorEditProp.LastAppliedColor v)
    let diagram v : obj = box (ExtendedColorEditProp.Diagram v)

    let apply (el: DevExpress.Xpf.Diagram.Native.ExtendedColorEdit) (prop: ExtendedColorEditProp) =
        match prop with
        | ExtendedColorEditProp.Base p -> ColorEdit.apply el p
        | ExtendedColorEditProp.EditColorPaletteName v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ExtendedColorEdit.EditColorPaletteNameProperty, box v)
        | ExtendedColorEditProp.LastAppliedColor v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ExtendedColorEdit.LastAppliedColorProperty, box v)
        | ExtendedColorEditProp.Diagram v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ExtendedColorEdit.DiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.ExtendedColorEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
