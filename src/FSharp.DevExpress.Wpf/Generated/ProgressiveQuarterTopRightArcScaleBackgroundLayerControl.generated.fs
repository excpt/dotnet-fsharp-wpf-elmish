...
type ProgressiveQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveQuarterTopRightArcScaleBackgroundLayerControl) (prop: ProgressiveQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | ProgressiveQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
