...
type AllDayAreaControlContainerProp =
    | Base of XPFContentControlProp
    | AllowScrolling of bool

module AllDayAreaControlContainer =
    let allowScrolling v : obj = box (AllDayAreaControlContainerProp.AllowScrolling v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AllDayAreaControlContainer) (prop: AllDayAreaControlContainerProp) =
        match prop with
        | AllDayAreaControlContainerProp.Base p -> XPFContentControl.apply el p
        | AllDayAreaControlContainerProp.AllowScrolling v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AllDayAreaControlContainer.AllowScrollingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AllDayAreaControlContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
