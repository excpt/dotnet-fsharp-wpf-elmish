...
type CircularDefaultThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularDefaultThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularDefaultThreeQuartersModel) (prop: CircularDefaultThreeQuartersModelProp) =
        match prop with
        | CircularDefaultThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularDefaultThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
