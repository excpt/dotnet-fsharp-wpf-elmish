...
type GradientMultiSliderProp =
    | Brush of System.Windows.Media.GradientBrush
    | SelectedThumb of DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb
    | SelectedThumbColor of System.Windows.Media.Color
    | BrushType of DevExpress.Xpf.Editors.Internal.GradientBrushType

module GradientMultiSlider =
    let brush v : obj = box (GradientMultiSliderProp.Brush v)
    let selectedThumb v : obj = box (GradientMultiSliderProp.SelectedThumb v)
    let selectedThumbColor v : obj = box (GradientMultiSliderProp.SelectedThumbColor v)
    let brushType v : obj = box (GradientMultiSliderProp.BrushType v)

    let apply (el: DevExpress.Xpf.Editors.Internal.GradientMultiSlider) (prop: GradientMultiSliderProp) =
        match prop with
        | GradientMultiSliderProp.Brush v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSlider.BrushProperty, box v)
        | GradientMultiSliderProp.SelectedThumb v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSlider.SelectedThumbProperty, box v)
        | GradientMultiSliderProp.SelectedThumbColor v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSlider.SelectedThumbColorProperty, box v)
        | GradientMultiSliderProp.BrushType v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSlider.BrushTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.GradientMultiSlider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
