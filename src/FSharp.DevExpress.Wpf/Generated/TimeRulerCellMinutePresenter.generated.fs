...
type TimeRulerCellMinutePresenterProp =
    | Base of FastTextBlockProp

module TimeRulerCellMinutePresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimeRulerCellMinutePresenter) (prop: TimeRulerCellMinutePresenterProp) =
        match prop with
        | TimeRulerCellMinutePresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimeRulerCellMinutePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
