...
type CircularFlatLightQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatLightQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatLightQuarterTopLeftModel) (prop: CircularFlatLightQuarterTopLeftModelProp) =
        match prop with
        | CircularFlatLightQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatLightQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
