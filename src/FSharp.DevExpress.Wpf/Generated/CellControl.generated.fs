...
type CellControlProp =
    | Base of ChromePresenterBaseProp
    | Background of System.Windows.Media.Brush
    | SelectedBackground of System.Windows.Media.Brush
    | LeftBorderThickness of float
    | BottomBorderThickness of float
    | DrawDefaultBackground of bool
...
module CellControl =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Visual.CellControl) (prop: CellControlProp) =
        match prop with
        | CellControlProp.Base p -> ChromePresenterBase.apply el p
        | CellControlProp.Background v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.CellControl.BackgroundProperty, box v)
        | CellControlProp.SelectedBackground v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.CellControl.SelectedBackgroundProperty, box v)
        | CellControlProp.LeftBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.CellControl.LeftBorderThicknessProperty, box v)
        | CellControlProp.BottomBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.CellControl.BottomBorderThicknessProperty, box v)
        | CellControlProp.DrawDefaultBackground v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.CellControl.DrawDefaultBackgroundProperty, box v)
        | CellControlProp.DrawDefaultDecoration v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.CellControl.DrawDefaultDecorationProperty, box v)
