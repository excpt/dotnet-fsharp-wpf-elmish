...
type DigitalFutureModelProp =
    | Base of DigitalGaugeModelProp

module DigitalFutureModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalFutureModel) (prop: DigitalFutureModelProp) =
        match prop with
        | DigitalFutureModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalFutureModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
