...
type AccordionItemBackgroundControlProp =
    | ItemState of DevExpress.Xpf.Accordion.AccordionItemState
    | ItemType of DevExpress.Xpf.Accordion.AccordionItemType

module AccordionItemBackgroundControl =
    let itemState v : obj = box (AccordionItemBackgroundControlProp.ItemState v)
    let itemType v : obj = box (AccordionItemBackgroundControlProp.ItemType v)

    let apply (el: DevExpress.Xpf.Accordion.AccordionItemBackgroundControl) (prop: AccordionItemBackgroundControlProp) =
        match prop with
        | AccordionItemBackgroundControlProp.ItemState v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionItemBackgroundControl.ItemStateProperty, box v)
        | AccordionItemBackgroundControlProp.ItemType v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionItemBackgroundControl.ItemTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionItemBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
