...
type DocumentationControlProp =
    | Items of obj
    | DescriptionBlockTemplate of System.Windows.DataTemplate
    | SelectedItem of DevExpress.DataAccess.Native.ExpressionEditor.CategoryNode
    | SelectedOperatorInfo of DevExpress.Data.Controls.ExpressionEditor.ItemInfoBase

module DocumentationControl =
    let items v : obj = box (DocumentationControlProp.Items v)
    let descriptionBlockTemplate v : obj = box (DocumentationControlProp.DescriptionBlockTemplate v)
    let selectedItem v : obj = box (DocumentationControlProp.SelectedItem v)
    let selectedOperatorInfo v : obj = box (DocumentationControlProp.SelectedOperatorInfo v)

    let apply (el: DevExpress.Xpf.ExpressionEditor.Native.DocumentationControl) (prop: DocumentationControlProp) =
        match prop with
        | DocumentationControlProp.Items v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.Native.DocumentationControl.ItemsProperty, box v)
        | DocumentationControlProp.DescriptionBlockTemplate v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.Native.DocumentationControl.DescriptionBlockTemplateProperty, box v)
        | DocumentationControlProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.Native.DocumentationControl.SelectedItemProperty, box v)
        | DocumentationControlProp.SelectedOperatorInfo v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.Native.DocumentationControl.SelectedOperatorInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.ExpressionEditor.Native.DocumentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
