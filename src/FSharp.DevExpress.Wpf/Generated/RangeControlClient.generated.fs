...
type RangeControlClientProp =
    | ChangeToken of obj
    | ItemsSource of obj

module RangeControlClient =
    let changeToken v : obj = box (RangeControlClientProp.ChangeToken v)
    let itemsSource v : obj = box (RangeControlClientProp.ItemsSource v)

    let apply (el: DevExpress.DashboardWpf.Internal.RangeControlClient) (prop: RangeControlClientProp) =
        match prop with
        | RangeControlClientProp.ChangeToken v -> el.SetValue(DevExpress.DashboardWpf.Internal.RangeControlClient.ChangeTokenProperty, box v)
        | RangeControlClientProp.ItemsSource v -> el.SetValue(DevExpress.DashboardWpf.Internal.RangeControlClient.ItemsSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.RangeControlClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
