...
type LampYellowStatePresentationControlProp =
    | Base of PresentationControlProp

module LampYellowStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.LampYellowStatePresentationControl) (prop: LampYellowStatePresentationControlProp) =
        match prop with
        | LampYellowStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LampYellowStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
