...
type GroupCollapseButtonProp =
    | IsCollapseButton of bool
    | Field of DevExpress.Xpf.PivotGrid.PivotGridField

module GroupCollapseButton =
    let isCollapseButton v : obj = box (GroupCollapseButtonProp.IsCollapseButton v)
    let field v : obj = box (GroupCollapseButtonProp.Field v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.GroupCollapseButton) (prop: GroupCollapseButtonProp) =
        match prop with
        | GroupCollapseButtonProp.IsCollapseButton v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.GroupCollapseButton.IsCollapseButtonProperty, box v)
        | GroupCollapseButtonProp.Field v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.GroupCollapseButton.FieldProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.GroupCollapseButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
