...
type TrackBarEditTickItemsControlProp =
    ...
    | DisplayMode of DevExpress.Xpf.Editors.TrackBarEditTickItemDisplayMode
    | Orientation of System.Windows.Controls.Orientation
    | LabelClickCommand of System.Windows.Input.ICommand

module TrackBarEditTickItemsControl =
    let fill v : obj = box (TrackBarEditTickItemsControlProp.Fill v)
    let minimum v : obj = box (TrackBarEditTickItemsControlProp.Minimum v)
    let maximum v : obj = box (TrackBarEditTickItemsControlProp.Maximum v)
    let selectionStart v : obj = box (TrackBarEditTickItemsControlProp.SelectionStart v)
    let selectionEnd v : obj = box (TrackBarEditTickItemsControlProp.SelectionEnd v)
    let tickFrequency v : obj = box (TrackBarEditTickItemsControlProp.TickFrequency v)
    let ticks v : obj = box (TrackBarEditTickItemsControlProp.Ticks v)
    let placement v : obj = box (TrackBarEditTickItemsControlProp.Placement v)
    let reservedSpace v : obj = box (TrackBarEditTickItemsControlProp.ReservedSpace v)
    let displayMode v : obj = box (TrackBarEditTickItemsControlProp.DisplayMode v)
    let orientation v : obj = box (TrackBarEditTickItemsControlProp.Orientation v)
    let labelClickCommand v : obj = box (TrackBarEditTickItemsControlProp.LabelClickCommand v)

    let apply (el: DevExpress.Xpf.Editors.TrackBarEditTickItemsControl) (prop: TrackBarEditTickItemsControlProp) =
        match prop with
        | TrackBarEditTickItemsControlProp.Fill v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.FillProperty, box v)
        | TrackBarEditTickItemsControlProp.Minimum v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.MinimumProperty, box v)
        | TrackBarEditTickItemsControlProp.Maximum v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.MaximumProperty, box v)
        | TrackBarEditTickItemsControlProp.SelectionStart v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.SelectionStartProperty, box v)
        | TrackBarEditTickItemsControlProp.SelectionEnd v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.SelectionEndProperty, box v)
        | TrackBarEditTickItemsControlProp.TickFrequency v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.TickFrequencyProperty, box v)
        | TrackBarEditTickItemsControlProp.Ticks v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.TicksProperty, box v)
        | TrackBarEditTickItemsControlProp.Placement v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.PlacementProperty, box v)
        | TrackBarEditTickItemsControlProp.ReservedSpace v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.ReservedSpaceProperty, box v)
        | TrackBarEditTickItemsControlProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.DisplayModeProperty, box v)
        | TrackBarEditTickItemsControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.OrientationProperty, box v)
        | TrackBarEditTickItemsControlProp.LabelClickCommand v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickItemsControl.LabelClickCommandProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarEditTickItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
