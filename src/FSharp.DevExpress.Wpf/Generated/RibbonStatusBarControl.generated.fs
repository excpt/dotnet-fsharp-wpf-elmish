...
type RibbonStatusBarControlProp =
    | IsSizeGripVisible of bool
    | LeftItemLinksSource of System.Collections.IEnumerable
    | LeftItemTemplate of System.Windows.DataTemplate
    | LeftItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | LeftItemStyle of System.Windows.Style
    | LeftItemStyleSelector of System.Windows.Controls.StyleSelector
    | RightItemLinksSource of System.Collections.IEnumerable
    | RightItemTemplate of System.Windows.DataTemplate
    | RightItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | RightItemStyle of System.Windows.Style
    | RightItemStyleSelector of System.Windows.Controls.StyleSelector
...
module RibbonStatusBarControl =
    let isSizeGripVisible v : obj = box (RibbonStatusBarControlProp.IsSizeGripVisible v)
    let leftItemLinksSource v : obj = box (RibbonStatusBarControlProp.LeftItemLinksSource v)
    let leftItemTemplate v : obj = box (RibbonStatusBarControlProp.LeftItemTemplate v)
    let leftItemTemplateSelector v : obj = box (RibbonStatusBarControlProp.LeftItemTemplateSelector v)
    let leftItemStyle v : obj = box (RibbonStatusBarControlProp.LeftItemStyle v)
    let leftItemStyleSelector v : obj = box (RibbonStatusBarControlProp.LeftItemStyleSelector v)
    let rightItemLinksSource v : obj = box (RibbonStatusBarControlProp.RightItemLinksSource v)
    let rightItemTemplate v : obj = box (RibbonStatusBarControlProp.RightItemTemplate v)
    let rightItemTemplateSelector v : obj = box (RibbonStatusBarControlProp.RightItemTemplateSelector v)
    let rightItemStyle v : obj = box (RibbonStatusBarControlProp.RightItemStyle v)
    let rightItemStyleSelector v : obj = box (RibbonStatusBarControlProp.RightItemStyleSelector v)
    let itemLinksSourceElementGeneratesUniqueBarItem v : obj = box (RibbonStatusBarControlProp.ItemLinksSourceElementGeneratesUniqueBarItem v)
    let mDIMergeStyle v : obj = box (RibbonStatusBarControlProp.MDIMergeStyle v)
    let asyncMergingEnabled v : obj = box (RibbonStatusBarControlProp.AsyncMergingEnabled v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonStatusBarControl) (prop: RibbonStatusBarControlProp) =
        match prop with
        | RibbonStatusBarControlProp.IsSizeGripVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.IsSizeGripVisibleProperty, box v)
        | RibbonStatusBarControlProp.LeftItemLinksSource v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.LeftItemLinksSourceProperty, box v)
        | RibbonStatusBarControlProp.LeftItemTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.LeftItemTemplateProperty, box v)
        | RibbonStatusBarControlProp.LeftItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.LeftItemTemplateSelectorProperty, box v)
        | RibbonStatusBarControlProp.LeftItemStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.LeftItemStyleProperty, box v)
        | RibbonStatusBarControlProp.LeftItemStyleSelector v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.LeftItemStyleSelectorProperty, box v)
        | RibbonStatusBarControlProp.RightItemLinksSource v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.RightItemLinksSourceProperty, box v)
        | RibbonStatusBarControlProp.RightItemTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.RightItemTemplateProperty, box v)
        | RibbonStatusBarControlProp.RightItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.RightItemTemplateSelectorProperty, box v)
        | RibbonStatusBarControlProp.RightItemStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.RightItemStyleProperty, box v)
        | RibbonStatusBarControlProp.RightItemStyleSelector v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.RightItemStyleSelectorProperty, box v)
        | RibbonStatusBarControlProp.ItemLinksSourceElementGeneratesUniqueBarItem v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.ItemLinksSourceElementGeneratesUniqueBarItemProperty, box v)
        | RibbonStatusBarControlProp.MDIMergeStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.MDIMergeStyleProperty, box v)
        | RibbonStatusBarControlProp.AsyncMergingEnabled v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.AsyncMergingEnabledProperty, box v)
    ...
    let ribbonStatusBar (v: DevExpress.Xpf.Ribbon.RibbonStatusBarControl) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Ribbon.RibbonStatusBarControl.RibbonStatusBarProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonStatusBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
