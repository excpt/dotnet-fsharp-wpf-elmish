...
type LayoutItemSelectionIndicatorProp =
    | Base of ControlBaseProp
    | AllowSizing of bool
    | Element of System.Windows.FrameworkElement
    | ElementSize of float
    | IsSizing of bool
    | IsHorizontalSizing of bool
    | IsVerticalSizing of bool

module LayoutItemSelectionIndicator =
    let allowSizing v : obj = box (LayoutItemSelectionIndicatorProp.AllowSizing v)
    let element v : obj = box (LayoutItemSelectionIndicatorProp.Element v)
    let elementSize v : obj = box (LayoutItemSelectionIndicatorProp.ElementSize v)
    let isSizing v : obj = box (LayoutItemSelectionIndicatorProp.IsSizing v)
    let isHorizontalSizing v : obj = box (LayoutItemSelectionIndicatorProp.IsHorizontalSizing v)
    let isVerticalSizing v : obj = box (LayoutItemSelectionIndicatorProp.IsVerticalSizing v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator) (prop: LayoutItemSelectionIndicatorProp) =
        match prop with
        | LayoutItemSelectionIndicatorProp.Base p -> ControlBase.apply el p
        | LayoutItemSelectionIndicatorProp.AllowSizing v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator.AllowSizingProperty, box v)
        | LayoutItemSelectionIndicatorProp.Element v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator.ElementProperty, box v)
        | LayoutItemSelectionIndicatorProp.ElementSize v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator.ElementSizeProperty, box v)
        | LayoutItemSelectionIndicatorProp.IsSizing v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator.IsSizingProperty, box v)
        | LayoutItemSelectionIndicatorProp.IsHorizontalSizing v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator.IsHorizontalSizingProperty, box v)
        | LayoutItemSelectionIndicatorProp.IsVerticalSizing v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator.IsVerticalSizingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemSelectionIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
