...
type CollapsedItemDecoratorProp =
    | Base of ItemPresenterProp
    | Item of obj
    | AllowDefaultToolTip of bool

module CollapsedItemDecorator =
    let item v : obj = box (CollapsedItemDecoratorProp.Item v)
    let allowDefaultToolTip v : obj = box (CollapsedItemDecoratorProp.AllowDefaultToolTip v)

    let apply (el: DevExpress.Xpf.Accordion.CollapsedItemDecorator) (prop: CollapsedItemDecoratorProp) =
        match prop with
        | CollapsedItemDecoratorProp.Base p -> ItemPresenter.apply el p
        | CollapsedItemDecoratorProp.Item v -> el.SetValue(DevExpress.Xpf.Accordion.CollapsedItemDecorator.ItemProperty, box v)
        | CollapsedItemDecoratorProp.AllowDefaultToolTip v -> el.SetValue(DevExpress.Xpf.Accordion.CollapsedItemDecorator.AllowDefaultToolTipProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.CollapsedItemDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
