...
type XpfCommentInplaceEditorProp =
    | Base of CommentItemProp

module XpfCommentInplaceEditor =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.XpfCommentInplaceEditor) (prop: XpfCommentInplaceEditorProp) =
        match prop with
        | XpfCommentInplaceEditorProp.Base p -> CommentItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.XpfCommentInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
