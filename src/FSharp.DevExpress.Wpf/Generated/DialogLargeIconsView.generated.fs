...
type DialogLargeIconsViewProp =
    | Base of DialogIconsViewProp

module DialogLargeIconsView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogLargeIconsView) (prop: DialogLargeIconsViewProp) =
        match prop with
        | DialogLargeIconsViewProp.Base p -> DialogIconsView.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogLargeIconsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
