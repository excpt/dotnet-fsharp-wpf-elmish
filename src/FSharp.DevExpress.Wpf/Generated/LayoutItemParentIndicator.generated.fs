...
type LayoutItemParentIndicatorProp =
    | Base of LayoutItemSelectionIndicatorProp

module LayoutItemParentIndicator =

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemParentIndicator) (prop: LayoutItemParentIndicatorProp) =
        match prop with
        | LayoutItemParentIndicatorProp.Base p -> LayoutItemSelectionIndicator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemParentIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
