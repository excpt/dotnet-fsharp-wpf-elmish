...
type BarItemLinkMenuHeaderControlProp =
    | Base of BarItemLinkControlProp
    | UseLightweightTemplates of bool
    | ColumnIndent of float
    | RowIndent of float
    | PrecedesHeader of bool

module BarItemLinkMenuHeaderControl =
    let useLightweightTemplates v : obj = box (BarItemLinkMenuHeaderControlProp.UseLightweightTemplates v)
    let columnIndent v : obj = box (BarItemLinkMenuHeaderControlProp.ColumnIndent v)
    let rowIndent v : obj = box (BarItemLinkMenuHeaderControlProp.RowIndent v)
    let precedesHeader v : obj = box (BarItemLinkMenuHeaderControlProp.PrecedesHeader v)

    let apply (el: DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControl) (prop: BarItemLinkMenuHeaderControlProp) =
        match prop with
        | BarItemLinkMenuHeaderControlProp.Base p -> BarItemLinkControl.apply el p
        | BarItemLinkMenuHeaderControlProp.UseLightweightTemplates v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControl.UseLightweightTemplatesProperty, box v)
        | BarItemLinkMenuHeaderControlProp.ColumnIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControl.ColumnIndentProperty, box v)
        | BarItemLinkMenuHeaderControlProp.RowIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControl.RowIndentProperty, box v)
        | BarItemLinkMenuHeaderControlProp.PrecedesHeader v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControl.PrecedesHeaderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemLinkMenuHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
