...
type FirstLineIndentHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module FirstLineIndentHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.FirstLineIndentHotZoneControl) (prop: FirstLineIndentHotZoneControlProp) =
        match prop with
        | FirstLineIndentHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.FirstLineIndentHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
