...
type AdditionalSplineAreaSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalSplineAreaSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineAreaSeriesGeometryContainer) (prop: AdditionalSplineAreaSeriesGeometryContainerProp) =
        match prop with
        | AdditionalSplineAreaSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineAreaSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
