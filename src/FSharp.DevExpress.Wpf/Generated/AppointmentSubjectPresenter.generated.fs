...
type AppointmentSubjectPresenterProp =
    | Base of FastTextBlockProp

module AppointmentSubjectPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentSubjectPresenter) (prop: AppointmentSubjectPresenterProp) =
        match prop with
        | AppointmentSubjectPresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentSubjectPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
