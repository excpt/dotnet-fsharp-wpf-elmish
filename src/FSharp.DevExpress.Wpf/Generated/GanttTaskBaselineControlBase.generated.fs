...
type GanttTaskBaselineControlBaseProp =
    | Base of GanttItemControlBaseProp

module GanttTaskBaselineControlBase =

    let apply (el: DevExpress.Xpf.Gantt.GanttTaskBaselineControlBase) (prop: GanttTaskBaselineControlBaseProp) =
        match prop with
        | GanttTaskBaselineControlBaseProp.Base p -> GanttItemControlBase.apply el p
