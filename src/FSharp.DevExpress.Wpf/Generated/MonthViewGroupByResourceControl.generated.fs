...
type MonthViewGroupByResourceControlProp =
    | Base of MonthViewControlBaseProp

module MonthViewGroupByResourceControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthViewGroupByResourceControl) (prop: MonthViewGroupByResourceControlProp) =
        match prop with
        | MonthViewGroupByResourceControlProp.Base p -> MonthViewControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MonthViewGroupByResourceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
