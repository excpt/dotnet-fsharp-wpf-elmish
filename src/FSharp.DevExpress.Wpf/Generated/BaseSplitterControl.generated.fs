...
type BaseSplitterControlProp =
    | Base of BaseSplitterItemProp
    | IsDragDropOver of bool

module BaseSplitterControl =
    let isDragDropOver v : obj = box (BaseSplitterControlProp.IsDragDropOver v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.BaseSplitterControl) (prop: BaseSplitterControlProp) =
        match prop with
        | BaseSplitterControlProp.Base p -> BaseSplitterItem.apply el p
        | BaseSplitterControlProp.IsDragDropOver v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseSplitterControl.IsDragDropOverProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.BaseSplitterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
