...
type AdditionalStepLineSeriesGeometryProp =
    | Base of AdditionalLineSeriesGeometryProp

module AdditionalStepLineSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStepLineSeriesGeometry) (prop: AdditionalStepLineSeriesGeometryProp) =
        match prop with
        | AdditionalStepLineSeriesGeometryProp.Base p -> AdditionalLineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStepLineSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
