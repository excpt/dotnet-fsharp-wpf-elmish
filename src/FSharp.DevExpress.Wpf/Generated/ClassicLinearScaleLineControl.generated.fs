...
type ClassicLinearScaleLineControlProp =
    | Base of PresentationControlProp

module ClassicLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicLinearScaleLineControl) (prop: ClassicLinearScaleLineControlProp) =
        match prop with
        | ClassicLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
