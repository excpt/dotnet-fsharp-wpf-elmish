...
type PdfLayersViewerControlProp =
    | Settings of DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings
    | HideAfterUse of bool

module PdfLayersViewerControl =
    let settings v : obj = box (PdfLayersViewerControlProp.Settings v)
    let hideAfterUse v : obj = box (PdfLayersViewerControlProp.HideAfterUse v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfLayersViewerControl) (prop: PdfLayersViewerControlProp) =
        match prop with
        | PdfLayersViewerControlProp.Settings v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerControl.SettingsProperty, box v)
        | PdfLayersViewerControlProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerControl.HideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfLayersViewerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
