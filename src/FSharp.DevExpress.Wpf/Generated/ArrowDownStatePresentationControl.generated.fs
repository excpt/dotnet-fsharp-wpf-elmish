...
type ArrowDownStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowDownStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowDownStatePresentationControl) (prop: ArrowDownStatePresentationControlProp) =
        match prop with
        | ArrowDownStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowDownStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
