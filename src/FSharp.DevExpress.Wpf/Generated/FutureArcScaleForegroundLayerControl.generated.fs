...
type FutureArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module FutureArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureArcScaleForegroundLayerControl) (prop: FutureArcScaleForegroundLayerControlProp) =
        match prop with
        | FutureArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
