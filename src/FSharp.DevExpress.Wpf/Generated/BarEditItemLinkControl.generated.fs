...
type BarEditItemLinkControlProp =
    | Base of BarItemLinkControlProp
    | Edit of DevExpress.Xpf.Editors.BaseEdit
    | ActualHorizontalEditAlignment of System.Windows.HorizontalAlignment
    | ActualEditWidth of float
    | ActualEditHeight of float
    | ActualContent2 of obj
    | ActualContent2Template of System.Windows.DataTemplate
    | ActualContent2Visibility of System.Windows.Visibility
    | ActualEditStyle of System.Windows.Style
    | EditContentMargin of System.Windows.Thickness
    | InRibbonEditContentMargin of System.Windows.Thickness
    | ActualEditTemplate of System.Windows.DataTemplate
    | ShowInVerticalBar of DevExpress.Utils.DefaultBoolean

module BarEditItemLinkControl =
    let edit v : obj = box (BarEditItemLinkControlProp.Edit v)
    let actualHorizontalEditAlignment v : obj = box (BarEditItemLinkControlProp.ActualHorizontalEditAlignment v)
    let actualEditWidth v : obj = box (BarEditItemLinkControlProp.ActualEditWidth v)
    let actualEditHeight v : obj = box (BarEditItemLinkControlProp.ActualEditHeight v)
    let actualContent2 v : obj = box (BarEditItemLinkControlProp.ActualContent2 v)
    let actualContent2Template v : obj = box (BarEditItemLinkControlProp.ActualContent2Template v)
    let actualContent2Visibility v : obj = box (BarEditItemLinkControlProp.ActualContent2Visibility v)
    let actualEditStyle v : obj = box (BarEditItemLinkControlProp.ActualEditStyle v)
    let editContentMargin v : obj = box (BarEditItemLinkControlProp.EditContentMargin v)
    let inRibbonEditContentMargin v : obj = box (BarEditItemLinkControlProp.InRibbonEditContentMargin v)
    let actualEditTemplate v : obj = box (BarEditItemLinkControlProp.ActualEditTemplate v)
    let showInVerticalBar v : obj = box (BarEditItemLinkControlProp.ShowInVerticalBar v)

    let apply (el: DevExpress.Xpf.Bars.BarEditItemLinkControl) (prop: BarEditItemLinkControlProp) =
        match prop with
        | BarEditItemLinkControlProp.Base p -> BarItemLinkControl.apply el p
        | BarEditItemLinkControlProp.Edit v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.EditProperty, box v)
        | BarEditItemLinkControlProp.ActualHorizontalEditAlignment v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualHorizontalEditAlignmentProperty, box v)
        | BarEditItemLinkControlProp.ActualEditWidth v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualEditWidthProperty, box v)
        | BarEditItemLinkControlProp.ActualEditHeight v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualEditHeightProperty, box v)
        | BarEditItemLinkControlProp.ActualContent2 v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualContent2Property, box v)
        | BarEditItemLinkControlProp.ActualContent2Template v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualContent2TemplateProperty, box v)
        | BarEditItemLinkControlProp.ActualContent2Visibility v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualContent2VisibilityProperty, box v)
        | BarEditItemLinkControlProp.ActualEditStyle v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualEditStyleProperty, box v)
        | BarEditItemLinkControlProp.EditContentMargin v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.EditContentMarginProperty, box v)
        | BarEditItemLinkControlProp.InRibbonEditContentMargin v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.InRibbonEditContentMarginProperty, box v)
        | BarEditItemLinkControlProp.ActualEditTemplate v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ActualEditTemplateProperty, box v)
        | BarEditItemLinkControlProp.ShowInVerticalBar v -> el.SetValue(DevExpress.Xpf.Bars.BarEditItemLinkControl.ShowInVerticalBarProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarEditItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
