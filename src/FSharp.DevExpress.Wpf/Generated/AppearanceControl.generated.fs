...
type AppearanceControlProp =
    | Base of psvControlProp

module AppearanceControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AppearanceControl) (prop: AppearanceControlProp) =
        match prop with
        | AppearanceControlProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AppearanceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
