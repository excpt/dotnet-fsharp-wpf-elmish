...
type NavButtonSeparatorProp =
    | Base of SelectedNavButtonProp

module NavButtonSeparator =

    let apply (el: DevExpress.Xpf.Navigation.Internal.NavButtonSeparator) (prop: NavButtonSeparatorProp) =
        match prop with
        | NavButtonSeparatorProp.Base p -> SelectedNavButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.NavButtonSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
