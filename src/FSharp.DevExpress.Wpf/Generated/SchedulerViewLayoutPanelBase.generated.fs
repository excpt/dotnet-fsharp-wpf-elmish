...
type SchedulerViewLayoutPanelBaseProp =
    | Base of SchedulerPanelProp
    | ViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualViewInfoBase
    | VirtualizationMode of System.Windows.Controls.VirtualizationMode

module SchedulerViewLayoutPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerViewLayoutPanelBase) (prop: SchedulerViewLayoutPanelBaseProp) =
        match prop with
        | SchedulerViewLayoutPanelBaseProp.Base p -> SchedulerPanel.apply el p
        | SchedulerViewLayoutPanelBaseProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerViewLayoutPanelBase.ViewInfoProperty, box v)
        | SchedulerViewLayoutPanelBaseProp.VirtualizationMode v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerViewLayoutPanelBase.VirtualizationModeProperty, box v)
