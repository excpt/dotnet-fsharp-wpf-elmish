...
type PanelControlBoxControlProp =
    | Base of BaseControlBoxControlProp
    | PinButtonTemplate of System.Windows.DataTemplate
    | MaximizeButtonTemplate of System.Windows.DataTemplate
    | MinimizeButtonTemplate of System.Windows.DataTemplate
    | RestoreButtonTemplate of System.Windows.DataTemplate
    | HideButtonTemplate of System.Windows.DataTemplate
    | ExpandButtonTemplate of System.Windows.DataTemplate
    | CollapseButtonTemplate of System.Windows.DataTemplate
    | UseOptimizedTemplate of bool

module PanelControlBoxControl =
    let pinButtonTemplate v : obj = box (PanelControlBoxControlProp.PinButtonTemplate v)
    let maximizeButtonTemplate v : obj = box (PanelControlBoxControlProp.MaximizeButtonTemplate v)
    let minimizeButtonTemplate v : obj = box (PanelControlBoxControlProp.MinimizeButtonTemplate v)
    let restoreButtonTemplate v : obj = box (PanelControlBoxControlProp.RestoreButtonTemplate v)
    let hideButtonTemplate v : obj = box (PanelControlBoxControlProp.HideButtonTemplate v)
    let expandButtonTemplate v : obj = box (PanelControlBoxControlProp.ExpandButtonTemplate v)
    let collapseButtonTemplate v : obj = box (PanelControlBoxControlProp.CollapseButtonTemplate v)
    let useOptimizedTemplate v : obj = box (PanelControlBoxControlProp.UseOptimizedTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl) (prop: PanelControlBoxControlProp) =
        match prop with
        | PanelControlBoxControlProp.Base p -> BaseControlBoxControl.apply el p
        | PanelControlBoxControlProp.PinButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.PinButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.MaximizeButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.MaximizeButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.MinimizeButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.MinimizeButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.RestoreButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.RestoreButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.HideButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.HideButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.ExpandButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.ExpandButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.CollapseButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.CollapseButtonTemplateProperty, box v)
        | PanelControlBoxControlProp.UseOptimizedTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl.UseOptimizedTemplateProperty, box v)

    let buttonWidth v : obj = box (BaseControlBoxControlProp.ButtonWidth v)
    let buttonHeight v : obj = box (BaseControlBoxControlProp.ButtonHeight v)
    let closeButtonTemplate v : obj = box (BaseControlBoxControlProp.CloseButtonTemplate v)
    let layoutItem v : obj = box (BaseControlBoxControlProp.LayoutItem v)
    let buttonStyle v : obj = box (BaseControlBoxControlProp.ButtonStyle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.PanelControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
