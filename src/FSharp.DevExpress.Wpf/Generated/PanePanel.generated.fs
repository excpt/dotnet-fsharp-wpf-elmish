...
type PanePanelProp =
    | Base of ChartItemsPanelBaseProp
    | IsCollapsedPane of bool

module PanePanel =
    let isCollapsedPane v : obj = box (PanePanelProp.IsCollapsedPane v)

    let apply (el: DevExpress.Xpf.Charts.PanePanel) (prop: PanePanelProp) =
        match prop with
        | PanePanelProp.Base p -> ChartItemsPanelBase.apply el p
        | PanePanelProp.IsCollapsedPane v -> el.SetValue(DevExpress.Xpf.Charts.PanePanel.IsCollapsedPaneProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PanePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
