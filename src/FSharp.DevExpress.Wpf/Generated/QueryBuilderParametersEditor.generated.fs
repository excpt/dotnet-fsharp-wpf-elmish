...
type QueryBuilderParametersEditorProp =
    | Parameters of obj
    | SelectedParameter of DevExpress.Xpf.DataAccess.DataSourceWizard.ParameterViewModel
    | ParameterService of DevExpress.DataAccess.Wizard.Services.IParameterService
    | GetPreviewData of obj
    | PreviewTemplate of System.Windows.DataTemplate
    | UseLegacyExpressionEditor of bool
    | MessageBoxServiceTemplate of System.Windows.DataTemplate

module QueryBuilderParametersEditor =
    let parameters v : obj = box (QueryBuilderParametersEditorProp.Parameters v)
    let selectedParameter v : obj = box (QueryBuilderParametersEditorProp.SelectedParameter v)
    let parameterService v : obj = box (QueryBuilderParametersEditorProp.ParameterService v)
    let getPreviewData v : obj = box (QueryBuilderParametersEditorProp.GetPreviewData v)
    let previewTemplate v : obj = box (QueryBuilderParametersEditorProp.PreviewTemplate v)
    let useLegacyExpressionEditor v : obj = box (QueryBuilderParametersEditorProp.UseLegacyExpressionEditor v)
    let messageBoxServiceTemplate v : obj = box (QueryBuilderParametersEditorProp.MessageBoxServiceTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor) (prop: QueryBuilderParametersEditorProp) =
        match prop with
        | QueryBuilderParametersEditorProp.Parameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.ParametersProperty, box v)
        | QueryBuilderParametersEditorProp.SelectedParameter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.SelectedParameterProperty, box v)
        | QueryBuilderParametersEditorProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.ParameterServiceProperty, box v)
        | QueryBuilderParametersEditorProp.GetPreviewData v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.GetPreviewDataProperty, box v)
        | QueryBuilderParametersEditorProp.PreviewTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.PreviewTemplateProperty, box v)
        | QueryBuilderParametersEditorProp.UseLegacyExpressionEditor v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.UseLegacyExpressionEditorProperty, box v)
        | QueryBuilderParametersEditorProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor.MessageBoxServiceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderParametersEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
