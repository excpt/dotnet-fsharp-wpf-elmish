...
type GalleryControlInDropDownProp =
    | Base of GalleryControlProp

module GalleryControlInDropDown =

    let apply (el: DevExpress.Xpf.Ribbon.GalleryControlInDropDown) (prop: GalleryControlInDropDownProp) =
        match prop with
        | GalleryControlInDropDownProp.Base p -> GalleryControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.GalleryControlInDropDown>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
