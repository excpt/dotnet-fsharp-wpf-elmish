...
type ThemePresenterProp =
    | DiagramTheme of DevExpress.Diagram.Core.DiagramTheme
    | Text of string

module ThemePresenter =
    let diagramTheme v : obj = box (ThemePresenterProp.DiagramTheme v)
    let text v : obj = box (ThemePresenterProp.Text v)

    let apply (el: DevExpress.Xpf.Diagram.ThemePresenter) (prop: ThemePresenterProp) =
        match prop with
        | ThemePresenterProp.DiagramTheme v -> el.SetValue(DevExpress.Xpf.Diagram.ThemePresenter.DiagramThemeProperty, box v)
        | ThemePresenterProp.Text v -> el.SetValue(DevExpress.Xpf.Diagram.ThemePresenter.TextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ThemePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
