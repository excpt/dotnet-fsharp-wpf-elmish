...
type CellDrawingBoxContainerProp =
    | Base of WorksheetPaintPanelProp

module CellDrawingBoxContainer =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.CellDrawingBoxContainer) (prop: CellDrawingBoxContainerProp) =
        match prop with
        | CellDrawingBoxContainerProp.Base p -> WorksheetPaintPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.CellDrawingBoxContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
