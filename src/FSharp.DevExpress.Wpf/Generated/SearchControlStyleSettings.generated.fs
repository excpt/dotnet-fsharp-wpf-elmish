...
type SearchControlStyleSettingsProp =
    | Base of ComboBoxStyleSettingsProp

module SearchControlStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.SearchControlStyleSettings) (prop: SearchControlStyleSettingsProp) =
        match prop with
        | SearchControlStyleSettingsProp.Base p -> ComboBoxStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SearchControlStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
