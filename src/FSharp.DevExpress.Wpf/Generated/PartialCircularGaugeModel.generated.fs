...
type PartialCircularGaugeModelProp =
    | Base of GaugeModelBaseProp
    | ScaleModels of DevExpress.Xpf.Gauges.ArcScaleModelCollection
    | NeedleModels of DevExpress.Xpf.Gauges.ArcScaleNeedleModelCollection
    | MarkerModels of DevExpress.Xpf.Gauges.ArcScaleMarkerModelCollection
    | RangeBarModels of DevExpress.Xpf.Gauges.ArcScaleRangeBarModelCollection
    | RangeModels of DevExpress.Xpf.Gauges.ArcScaleRangeModelCollection
    | LayerModels of DevExpress.Xpf.Gauges.LayerModelCollection
    | ScaleLayerModels of DevExpress.Xpf.Gauges.LayerModelCollection

module PartialCircularGaugeModel =
    let scaleModels v : obj = box (PartialCircularGaugeModelProp.ScaleModels v)
    let needleModels v : obj = box (PartialCircularGaugeModelProp.NeedleModels v)
    let markerModels v : obj = box (PartialCircularGaugeModelProp.MarkerModels v)
    let rangeBarModels v : obj = box (PartialCircularGaugeModelProp.RangeBarModels v)
    let rangeModels v : obj = box (PartialCircularGaugeModelProp.RangeModels v)
    let layerModels v : obj = box (PartialCircularGaugeModelProp.LayerModels v)
    let scaleLayerModels v : obj = box (PartialCircularGaugeModelProp.ScaleLayerModels v)

    let apply (el: DevExpress.Xpf.Gauges.PartialCircularGaugeModel) (prop: PartialCircularGaugeModelProp) =
        match prop with
        | PartialCircularGaugeModelProp.Base p -> GaugeModelBase.apply el p
        | PartialCircularGaugeModelProp.ScaleModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.ScaleModelsProperty, box v)
        | PartialCircularGaugeModelProp.NeedleModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.NeedleModelsProperty, box v)
        | PartialCircularGaugeModelProp.MarkerModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.MarkerModelsProperty, box v)
        | PartialCircularGaugeModelProp.RangeBarModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.RangeBarModelsProperty, box v)
        | PartialCircularGaugeModelProp.RangeModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.RangeModelsProperty, box v)
        | PartialCircularGaugeModelProp.LayerModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.LayerModelsProperty, box v)
        | PartialCircularGaugeModelProp.ScaleLayerModels v -> el.SetValue(DevExpress.Xpf.Gauges.PartialCircularGaugeModel.ScaleLayerModelsProperty, box v)

    let innerPadding v : obj = box (GaugeModelBaseProp.InnerPadding v)
