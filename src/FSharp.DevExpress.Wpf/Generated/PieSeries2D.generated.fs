...
type PieSeries2DProp =
    | Base of PieSeriesProp
    | Rotation of float
    | Model of DevExpress.Xpf.Charts.Pie2DModel
    | SweepDirection of DevExpress.Xpf.Charts.PieSweepDirection
    | PointAnimation of DevExpress.Xpf.Charts.Pie2DSeriesPointAnimationBase
    | SeriesAnimation of DevExpress.Xpf.Charts.Pie2DSeriesAnimationBase
    | TotalLabel of DevExpress.Xpf.Charts.PieTotalLabel

module PieSeries2D =
    let rotation v : obj = box (PieSeries2DProp.Rotation v)
    let model v : obj = box (PieSeries2DProp.Model v)
    let sweepDirection v : obj = box (PieSeries2DProp.SweepDirection v)
    let pointAnimation v : obj = box (PieSeries2DProp.PointAnimation v)
    let seriesAnimation v : obj = box (PieSeries2DProp.SeriesAnimation v)
    let totalLabel v : obj = box (PieSeries2DProp.TotalLabel v)

    let apply (el: DevExpress.Xpf.Charts.PieSeries2D) (prop: PieSeries2DProp) =
        match prop with
        | PieSeries2DProp.Base p -> PieSeries.apply el p
        | PieSeries2DProp.Rotation v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2D.RotationProperty, box v)
        | PieSeries2DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2D.ModelProperty, box v)
        | PieSeries2DProp.SweepDirection v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2D.SweepDirectionProperty, box v)
        | PieSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2D.PointAnimationProperty, box v)
        | PieSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2D.SeriesAnimationProperty, box v)
        | PieSeries2DProp.TotalLabel v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2D.TotalLabelProperty, box v)

    let holeRadiusPercent v : obj = box (PieSeriesProp.HoleRadiusPercent v)
    let labelsResolveOverlappingMinIndent v : obj = box (PieSeriesProp.LabelsResolveOverlappingMinIndent v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PieSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
