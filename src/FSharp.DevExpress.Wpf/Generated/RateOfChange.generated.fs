...
type RateOfChangeProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel
    | PointsCount of int

module RateOfChange =
    let valueLevel v : obj = box (RateOfChangeProp.ValueLevel v)
    let pointsCount v : obj = box (RateOfChangeProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.RateOfChange) (prop: RateOfChangeProp) =
        match prop with
        | RateOfChangeProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | RateOfChangeProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.RateOfChange.ValueLevelProperty, box v)
        | RateOfChangeProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.RateOfChange.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RateOfChange>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
