...
type ClassicLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ClassicLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicLinearScaleMarkerControl) (prop: ClassicLinearScaleMarkerControlProp) =
        match prop with
        | ClassicLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
