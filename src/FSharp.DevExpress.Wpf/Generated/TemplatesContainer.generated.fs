...
type TemplatesContainerProp =
    | GridDataRowTemplate of System.Windows.DataTemplate
    | GridHeadersTemplate of System.Windows.DataTemplate
    | ColumnHeaderResources of System.Windows.ResourceDictionary
    | BandColumnHeaderTemplate of System.Windows.DataTemplate

module TemplatesContainer =
    let gridDataRowTemplate v : obj = box (TemplatesContainerProp.GridDataRowTemplate v)
    let gridHeadersTemplate v : obj = box (TemplatesContainerProp.GridHeadersTemplate v)
    let columnHeaderResources v : obj = box (TemplatesContainerProp.ColumnHeaderResources v)
    let bandColumnHeaderTemplate v : obj = box (TemplatesContainerProp.BandColumnHeaderTemplate v)

    let apply (el: DevExpress.Xpf.Grid.TemplatesContainer) (prop: TemplatesContainerProp) =
        match prop with
        | TemplatesContainerProp.GridDataRowTemplate v -> el.SetValue(DevExpress.Xpf.Grid.TemplatesContainer.GridDataRowTemplateProperty, box v)
        | TemplatesContainerProp.GridHeadersTemplate v -> el.SetValue(DevExpress.Xpf.Grid.TemplatesContainer.GridHeadersTemplateProperty, box v)
        | TemplatesContainerProp.ColumnHeaderResources v -> el.SetValue(DevExpress.Xpf.Grid.TemplatesContainer.ColumnHeaderResourcesProperty, box v)
        | TemplatesContainerProp.BandColumnHeaderTemplate v -> el.SetValue(DevExpress.Xpf.Grid.TemplatesContainer.BandColumnHeaderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.TemplatesContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
