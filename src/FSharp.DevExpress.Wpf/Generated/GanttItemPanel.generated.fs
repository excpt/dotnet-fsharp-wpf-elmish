...
type GanttItemPanelProp =
    | ContentPosition of DevExpress.Xpf.Gantt.TaskContentPosition
    | ContentIndent of float
    | FirstVisibleDate of System.DateTime
    | Node of DevExpress.Xpf.Grid.TreeListNode
    | HighlightGroups of bool
    | ShowBaseline of bool
    | View of DevExpress.Xpf.Grid.DataViewBase

module GanttItemPanel =
    let contentPosition v : obj = box (GanttItemPanelProp.ContentPosition v)
    let contentIndent v : obj = box (GanttItemPanelProp.ContentIndent v)
    let firstVisibleDate v : obj = box (GanttItemPanelProp.FirstVisibleDate v)
    let node v : obj = box (GanttItemPanelProp.Node v)
    let highlightGroups v : obj = box (GanttItemPanelProp.HighlightGroups v)
    let showBaseline v : obj = box (GanttItemPanelProp.ShowBaseline v)
    let view v : obj = box (GanttItemPanelProp.View v)

    let apply (el: DevExpress.Xpf.Gantt.GanttItemPanel) (prop: GanttItemPanelProp) =
        match prop with
        | GanttItemPanelProp.ContentPosition v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.ContentPositionProperty, box v)
        | GanttItemPanelProp.ContentIndent v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.ContentIndentProperty, box v)
        | GanttItemPanelProp.FirstVisibleDate v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.FirstVisibleDateProperty, box v)
        | GanttItemPanelProp.Node v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.NodeProperty, box v)
        | GanttItemPanelProp.HighlightGroups v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.HighlightGroupsProperty, box v)
        | GanttItemPanelProp.ShowBaseline v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.ShowBaselineProperty, box v)
        | GanttItemPanelProp.View v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemPanel.ViewProperty, box v)
    ...
    let itemKind (v: DevExpress.Xpf.Gantt.GanttItemKind) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Gantt.GanttItemPanel.ItemKindProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Gantt.GanttItemPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
