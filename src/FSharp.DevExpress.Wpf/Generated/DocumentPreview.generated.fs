...
type DocumentPreviewProp =
    | Base of DocumentPreviewBaseProp
    | Model of DevExpress.Xpf.Printing.IDocumentPreviewModel

module DocumentPreview =
    let model v : obj = box (DocumentPreviewProp.Model v)

    let apply (el: DevExpress.Xpf.Printing.DocumentPreview) (prop: DocumentPreviewProp) =
        match prop with
        | DocumentPreviewProp.Base p -> DocumentPreviewBase.apply el p
        | DocumentPreviewProp.Model v -> el.SetValue(DevExpress.Xpf.Printing.DocumentPreview.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.DocumentPreview>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
