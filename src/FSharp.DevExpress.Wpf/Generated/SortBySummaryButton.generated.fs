...
type SortBySummaryButtonProp =
    | ValueItem of DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaItemBase

module SortBySummaryButton =
    let valueItem v : obj = box (SortBySummaryButtonProp.ValueItem v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.SortBySummaryButton) (prop: SortBySummaryButtonProp) =
        match prop with
        | SortBySummaryButtonProp.ValueItem v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.SortBySummaryButton.ValueItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.SortBySummaryButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
