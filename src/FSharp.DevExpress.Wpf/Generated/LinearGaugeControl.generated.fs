...
type LinearGaugeControlProp =
    | Base of AnalogGaugeControlProp
    | Model of DevExpress.Xpf.Gauges.LinearGaugeModel

module LinearGaugeControl =
    let model v : obj = box (LinearGaugeControlProp.Model v)

    let apply (el: DevExpress.Xpf.Gauges.LinearGaugeControl) (prop: LinearGaugeControlProp) =
        match prop with
        | LinearGaugeControlProp.Base p -> AnalogGaugeControl.apply el p
        | LinearGaugeControlProp.Model v -> el.SetValue(DevExpress.Xpf.Gauges.LinearGaugeControl.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearGaugeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
