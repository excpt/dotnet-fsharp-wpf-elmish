...
type SelectedNavButtonProp =
    | Base of NavButtonProp

module SelectedNavButton =

    let apply (el: DevExpress.Xpf.Navigation.Internal.SelectedNavButton) (prop: SelectedNavButtonProp) =
        match prop with
        | SelectedNavButtonProp.Base p -> NavButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.SelectedNavButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
