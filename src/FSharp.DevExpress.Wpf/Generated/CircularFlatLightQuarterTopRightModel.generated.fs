...
type CircularFlatLightQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatLightQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatLightQuarterTopRightModel) (prop: CircularFlatLightQuarterTopRightModelProp) =
        match prop with
        | CircularFlatLightQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatLightQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
