...
type ClassicLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ClassicLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicLinearScaleLevelBarBackgroundControl) (prop: ClassicLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | ClassicLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
