...
type CircularEcoQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularEcoQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularEcoQuarterTopLeftModel) (prop: CircularEcoQuarterTopLeftModelProp) =
        match prop with
        | CircularEcoQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularEcoQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
