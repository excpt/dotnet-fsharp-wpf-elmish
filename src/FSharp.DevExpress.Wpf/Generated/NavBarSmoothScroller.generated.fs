...
type NavBarSmoothScrollerProp =
    | Base of SmoothScrollerProp
    | ButtonDown of DevExpress.Xpf.NavBar.NavBarRepeatButton
    | ButtonUp of DevExpress.Xpf.NavBar.NavBarRepeatButton

module NavBarSmoothScroller =
    let buttonDown v : obj = box (NavBarSmoothScrollerProp.ButtonDown v)
    let buttonUp v : obj = box (NavBarSmoothScrollerProp.ButtonUp v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarSmoothScroller) (prop: NavBarSmoothScrollerProp) =
        match prop with
        | NavBarSmoothScrollerProp.Base p -> SmoothScroller.apply el p
        | NavBarSmoothScrollerProp.ButtonDown v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarSmoothScroller.ButtonDownProperty, box v)
        | NavBarSmoothScrollerProp.ButtonUp v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarSmoothScroller.ButtonUpProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarSmoothScroller>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
