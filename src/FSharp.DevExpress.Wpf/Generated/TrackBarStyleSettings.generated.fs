...
type TrackBarStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp

module TrackBarStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.TrackBarStyleSettings) (prop: TrackBarStyleSettingsProp) =
        match prop with
        | TrackBarStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
