...
type VisualAllDayAreaCellProp =
    | Base of VisualWorkTimeCellBaseProp
    | IsEdgeItem of bool

module VisualAllDayAreaCell =
    let isEdgeItem v : obj = box (VisualAllDayAreaCellProp.IsEdgeItem v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualAllDayAreaCell) (prop: VisualAllDayAreaCellProp) =
        match prop with
        | VisualAllDayAreaCellProp.Base p -> VisualWorkTimeCellBase.apply el p
        | VisualAllDayAreaCellProp.IsEdgeItem v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualAllDayAreaCell.IsEdgeItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualAllDayAreaCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
