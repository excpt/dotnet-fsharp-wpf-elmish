...
type FlatRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module FlatRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatRangeBar2DModelControl) (prop: FlatRangeBar2DModelControlProp) =
        match prop with
        | FlatRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
