...
type CircularEcoFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularEcoFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularEcoFullModel) (prop: CircularEcoFullModelProp) =
        match prop with
        | CircularEcoFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularEcoFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
