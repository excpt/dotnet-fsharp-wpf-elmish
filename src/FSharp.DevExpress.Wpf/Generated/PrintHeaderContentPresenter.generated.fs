...
type PrintHeaderContentPresenterProp =
    | Base of PivotContentPresenterProp

module PrintHeaderContentPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintHeaderContentPresenter) (prop: PrintHeaderContentPresenterProp) =
        match prop with
        | PrintHeaderContentPresenterProp.Base p -> PivotContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintHeaderContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
