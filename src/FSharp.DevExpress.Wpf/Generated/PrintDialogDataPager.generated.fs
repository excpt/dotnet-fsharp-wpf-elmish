...
open System
open System.Windows
open DevExpress.Xpf.PdfViewer.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type PrintDialogDataPagerProp =
    | Base of DataPagerProp

module PrintDialogDataPager =

    let apply (el: DevExpress.Xpf.PdfViewer.Internal.PrintDialogDataPager) (prop: PrintDialogDataPagerProp) =
        match prop with
        | PrintDialogDataPagerProp.Base p -> DataPager.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.Internal.PrintDialogDataPager>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
