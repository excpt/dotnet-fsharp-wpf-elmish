...
type ParameterEditorProp =
    | ReportParameterEditorTemplate of System.Windows.DataTemplate
    | UseLegacyExpressionEditor of bool
    | EditValue of DevExpress.Xpf.DataAccess.DataSourceWizard.ParameterViewModel
    | ItemsSource of obj
    | FixedParameters of bool
    | ParameterService of DevExpress.DataAccess.Wizard.Services.IParameterService
    | HeaderTemplate of System.Windows.DataTemplate
    | ShowHeader of bool
    | AddCommand of System.Windows.Input.ICommand
    | Title of string
    | ValidationRulesCollection of DevExpress.Xpf.DataAccess.Native.Editors.ValidationRulesCollection
    | ShowPlaceholderOnEmptyItemsSource of bool
    | HasErrors of bool

module ParameterEditor =
    let reportParameterEditorTemplate v : obj = box (ParameterEditorProp.ReportParameterEditorTemplate v)
    let useLegacyExpressionEditor v : obj = box (ParameterEditorProp.UseLegacyExpressionEditor v)
    let editValue v : obj = box (ParameterEditorProp.EditValue v)
    let itemsSource v : obj = box (ParameterEditorProp.ItemsSource v)
    let fixedParameters v : obj = box (ParameterEditorProp.FixedParameters v)
    let parameterService v : obj = box (ParameterEditorProp.ParameterService v)
    let headerTemplate v : obj = box (ParameterEditorProp.HeaderTemplate v)
    let showHeader v : obj = box (ParameterEditorProp.ShowHeader v)
    let addCommand v : obj = box (ParameterEditorProp.AddCommand v)
    let title v : obj = box (ParameterEditorProp.Title v)
    let validationRulesCollection v : obj = box (ParameterEditorProp.ValidationRulesCollection v)
    let showPlaceholderOnEmptyItemsSource v : obj = box (ParameterEditorProp.ShowPlaceholderOnEmptyItemsSource v)
    let hasErrors v : obj = box (ParameterEditorProp.HasErrors v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor) (prop: ParameterEditorProp) =
        match prop with
        | ParameterEditorProp.ReportParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.ReportParameterEditorTemplateProperty, box v)
        | ParameterEditorProp.UseLegacyExpressionEditor v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.UseLegacyExpressionEditorProperty, box v)
        | ParameterEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.EditValueProperty, box v)
        | ParameterEditorProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.ItemsSourceProperty, box v)
        | ParameterEditorProp.FixedParameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.FixedParametersProperty, box v)
        | ParameterEditorProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.ParameterServiceProperty, box v)
        | ParameterEditorProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.HeaderTemplateProperty, box v)
        | ParameterEditorProp.ShowHeader v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.ShowHeaderProperty, box v)
        | ParameterEditorProp.AddCommand v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.AddCommandProperty, box v)
        | ParameterEditorProp.Title v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.TitleProperty, box v)
        | ParameterEditorProp.ValidationRulesCollection v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.ValidationRulesCollectionProperty, box v)
        | ParameterEditorProp.ShowPlaceholderOnEmptyItemsSource v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.ShowPlaceholderOnEmptyItemsSourceProperty, box v)
        | ParameterEditorProp.HasErrors v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.HasErrorsProperty, box v)
    ...
    let editor (v: DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor.EditorProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ParameterEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
