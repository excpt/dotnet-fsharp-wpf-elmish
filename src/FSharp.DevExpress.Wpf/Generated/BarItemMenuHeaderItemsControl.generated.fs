...
type BarItemMenuHeaderItemsControlProp =
    | Base of LinksControlProp
    | HorizontalItems of bool
    | HorizontalGlyphPadding of System.Windows.Thickness
    | ColumnIndent of float
    | RowIndent of float
    | ItemsBorderThickness of System.Windows.Thickness
    | ItemsBorderVisibility of System.Windows.Visibility
    | ItemsPresenterThickness of System.Windows.Thickness

module BarItemMenuHeaderItemsControl =
    let horizontalItems v : obj = box (BarItemMenuHeaderItemsControlProp.HorizontalItems v)
    let horizontalGlyphPadding v : obj = box (BarItemMenuHeaderItemsControlProp.HorizontalGlyphPadding v)
    let columnIndent v : obj = box (BarItemMenuHeaderItemsControlProp.ColumnIndent v)
    let rowIndent v : obj = box (BarItemMenuHeaderItemsControlProp.RowIndent v)
    let itemsBorderThickness v : obj = box (BarItemMenuHeaderItemsControlProp.ItemsBorderThickness v)
    let itemsBorderVisibility v : obj = box (BarItemMenuHeaderItemsControlProp.ItemsBorderVisibility v)
    let itemsPresenterThickness v : obj = box (BarItemMenuHeaderItemsControlProp.ItemsPresenterThickness v)

    let apply (el: DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl) (prop: BarItemMenuHeaderItemsControlProp) =
        match prop with
        | BarItemMenuHeaderItemsControlProp.Base p -> LinksControl.apply el p
        | BarItemMenuHeaderItemsControlProp.HorizontalItems v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.HorizontalItemsProperty, box v)
        | BarItemMenuHeaderItemsControlProp.HorizontalGlyphPadding v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.HorizontalGlyphPaddingProperty, box v)
        | BarItemMenuHeaderItemsControlProp.ColumnIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.ColumnIndentProperty, box v)
        | BarItemMenuHeaderItemsControlProp.RowIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.RowIndentProperty, box v)
        | BarItemMenuHeaderItemsControlProp.ItemsBorderThickness v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.ItemsBorderThicknessProperty, box v)
        | BarItemMenuHeaderItemsControlProp.ItemsBorderVisibility v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.ItemsBorderVisibilityProperty, box v)
        | BarItemMenuHeaderItemsControlProp.ItemsPresenterThickness v -> el.SetValue(DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl.ItemsPresenterThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemMenuHeaderItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
