...
type LayoutControlItemProp =
    | Base of ContentItemProp
    | CaptionToControlDistance of float
    | ShowControl of bool
    | ControlHorizontalAlignment of System.Windows.HorizontalAlignment
    | ControlVerticalAlignment of System.Windows.VerticalAlignment

module LayoutControlItem =
    ...
    let apply (el: DevExpress.Xpf.Docking.LayoutControlItem) (prop: LayoutControlItemProp) =
        match prop with
        | LayoutControlItemProp.Base p -> ContentItem.apply el p
        | LayoutControlItemProp.CaptionToControlDistance v -> el.SetValue(DevExpress.Xpf.Docking.LayoutControlItem.CaptionToControlDistanceProperty, box v)
        | LayoutControlItemProp.ShowControl v -> el.SetValue(DevExpress.Xpf.Docking.LayoutControlItem.ShowControlProperty, box v)
        | LayoutControlItemProp.ControlHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Docking.LayoutControlItem.ControlHorizontalAlignmentProperty, box v)
        | LayoutControlItemProp.ControlVerticalAlignment v -> el.SetValue(DevExpress.Xpf.Docking.LayoutControlItem.ControlVerticalAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.LayoutControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
