...
type GroupSeparatorProp =
    | Base of ControlBaseProp
    | Orientation of System.Windows.Controls.Orientation

module GroupSeparator =
    let orientation v : obj = box (GroupSeparatorProp.Orientation v)

    let apply (el: DevExpress.Xpf.LayoutControl.GroupSeparator) (prop: GroupSeparatorProp) =
        match prop with
        | GroupSeparatorProp.Base p -> ControlBase.apply el p
        | GroupSeparatorProp.Orientation v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupSeparator.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.GroupSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
