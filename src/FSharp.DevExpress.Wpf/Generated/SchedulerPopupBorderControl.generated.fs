...
type SchedulerPopupBorderControlProp =
    | Base of PopupBorderControlProp

module SchedulerPopupBorderControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerPopupBorderControl) (prop: SchedulerPopupBorderControlProp) =
        match prop with
        | SchedulerPopupBorderControlProp.Base p -> PopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SchedulerPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
