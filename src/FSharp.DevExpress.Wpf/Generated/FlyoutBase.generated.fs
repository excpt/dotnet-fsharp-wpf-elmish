...
open System
open System.Windows
open DevExpress.Xpf.Editors.Flyout.Native
...
type FlyoutBaseProp =
    ...
    | IsOpen of bool
    | ActualIsOpen of bool
    | IndicatorDirection of DevExpress.Xpf.Editors.Flyout.Native.IndicatorDirection
    | PlacementTarget of System.Windows.UIElement
    | StaysOpen of bool
    | CloseOnInactiveWindowMouseLeave of bool
    | VerticalOffset of float
    | AllowOutOfScreen of bool
    | AllowMoveAnimation of bool
    | ScaleTransformCompensation of bool
    | TargetBounds of System.Windows.Rect
    | ContainerStyle of System.Windows.Style
    | Settings of DevExpress.Xpf.Editors.Flyout.FlyoutSettingsBase
    | AnimationDuration of System.Windows.Duration
    | AlwaysOnTop of bool
    | OpenOnHover of bool
    | FollowTarget of bool

module FlyoutBase =
    let horizontalOffset v : obj = box (FlyoutBaseProp.HorizontalOffset v)
    let isOpen v : obj = box (FlyoutBaseProp.IsOpen v)
    let actualIsOpen v : obj = box (FlyoutBaseProp.ActualIsOpen v)
    let indicatorDirection v : obj = box (FlyoutBaseProp.IndicatorDirection v)
    let placementTarget v : obj = box (FlyoutBaseProp.PlacementTarget v)
    let staysOpen v : obj = box (FlyoutBaseProp.StaysOpen v)
    let closeOnInactiveWindowMouseLeave v : obj = box (FlyoutBaseProp.CloseOnInactiveWindowMouseLeave v)
    let verticalOffset v : obj = box (FlyoutBaseProp.VerticalOffset v)
    let allowOutOfScreen v : obj = box (FlyoutBaseProp.AllowOutOfScreen v)
    let allowMoveAnimation v : obj = box (FlyoutBaseProp.AllowMoveAnimation v)
    let scaleTransformCompensation v : obj = box (FlyoutBaseProp.ScaleTransformCompensation v)
    let targetBounds v : obj = box (FlyoutBaseProp.TargetBounds v)
    let containerStyle v : obj = box (FlyoutBaseProp.ContainerStyle v)
    let settings v : obj = box (FlyoutBaseProp.Settings v)
    let animationDuration v : obj = box (FlyoutBaseProp.AnimationDuration v)
    let alwaysOnTop v : obj = box (FlyoutBaseProp.AlwaysOnTop v)
    let openOnHover v : obj = box (FlyoutBaseProp.OpenOnHover v)
    let followTarget v : obj = box (FlyoutBaseProp.FollowTarget v)

    let apply (el: DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase) (prop: FlyoutBaseProp) =
        match prop with
        | FlyoutBaseProp.HorizontalOffset v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.HorizontalOffsetProperty, box v)
        | FlyoutBaseProp.IsOpen v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.IsOpenProperty, box v)
        | FlyoutBaseProp.ActualIsOpen v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.ActualIsOpenProperty, box v)
        | FlyoutBaseProp.IndicatorDirection v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.IndicatorDirectionProperty, box v)
        | FlyoutBaseProp.PlacementTarget v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.PlacementTargetProperty, box v)
        | FlyoutBaseProp.StaysOpen v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.StaysOpenProperty, box v)
        | FlyoutBaseProp.CloseOnInactiveWindowMouseLeave v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.CloseOnInactiveWindowMouseLeaveProperty, box v)
        | FlyoutBaseProp.VerticalOffset v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.VerticalOffsetProperty, box v)
        | FlyoutBaseProp.AllowOutOfScreen v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.AllowOutOfScreenProperty, box v)
        | FlyoutBaseProp.AllowMoveAnimation v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.AllowMoveAnimationProperty, box v)
        | FlyoutBaseProp.ScaleTransformCompensation v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.ScaleTransformCompensationProperty, box v)
        | FlyoutBaseProp.TargetBounds v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.TargetBoundsProperty, box v)
        | FlyoutBaseProp.ContainerStyle v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.ContainerStyleProperty, box v)
        | FlyoutBaseProp.Settings v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.SettingsProperty, box v)
        | FlyoutBaseProp.AnimationDuration v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.AnimationDurationProperty, box v)
        | FlyoutBaseProp.AlwaysOnTop v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.AlwaysOnTopProperty, box v)
        | FlyoutBaseProp.OpenOnHover v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.OpenOnHoverProperty, box v)
        | FlyoutBaseProp.FollowTarget v -> el.SetValue(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.FollowTargetProperty, box v)
    ...
    let flyout (v: DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase.FlyoutProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Editors.Flyout.Native.FlyoutBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
