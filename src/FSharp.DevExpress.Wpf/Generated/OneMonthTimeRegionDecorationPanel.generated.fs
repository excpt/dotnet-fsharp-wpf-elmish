...
type OneMonthTimeRegionDecorationPanelProp =
    | Base of TimeRegionDecorationPanelProp

module OneMonthTimeRegionDecorationPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthTimeRegionDecorationPanel) (prop: OneMonthTimeRegionDecorationPanelProp) =
        match prop with
        | OneMonthTimeRegionDecorationPanelProp.Base p -> TimeRegionDecorationPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthTimeRegionDecorationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
