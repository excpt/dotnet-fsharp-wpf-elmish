...
type PlayListInPopupMediaButtonProp =
    | Base of MediaButtonProp

module PlayListInPopupMediaButton =

    let apply (el: DevExpress.Xpf.Controls.PlayListInPopupMediaButton) (prop: PlayListInPopupMediaButtonProp) =
        match prop with
        | PlayListInPopupMediaButtonProp.Base p -> MediaButton.apply el p

    let mediaManager v : obj = box (MediaButtonProp.MediaManager v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.PlayListInPopupMediaButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
