...
type TimelineViewGroupByDateLayoutPanelProp =
    | Base of TimelineViewLayoutPanelProp
    | ResourceHeaderElementPosition of DevExpress.Xpf.Scheduler.Drawing.ElementPosition
    | ResourceNavigatorStyle of System.Windows.Style
    | Scheduler of DevExpress.Xpf.Scheduler.SchedulerControl
    | ResourceNavigatorVisibility of DevExpress.XtraScheduler.ResourceNavigatorVisibility
    | TopRightCornerAreaTemplate of System.Windows.Controls.ControlTemplate
    | TopLeftCornerAreaTemplate of System.Windows.Controls.ControlTemplate
    | BottomRightCornerAreaTemplate of System.Windows.Controls.ControlTemplate
    | BottomLeftCornerAreaTemplate of System.Windows.Controls.ControlTemplate
    | ResourceHeaderStyle of System.Windows.Style

module TimelineViewGroupByDateLayoutPanel =
    let resourceHeaderElementPosition v : obj = box (TimelineViewGroupByDateLayoutPanelProp.ResourceHeaderElementPosition v)
    let resourceNavigatorStyle v : obj = box (TimelineViewGroupByDateLayoutPanelProp.ResourceNavigatorStyle v)
    let scheduler v : obj = box (TimelineViewGroupByDateLayoutPanelProp.Scheduler v)
    let resourceNavigatorVisibility v : obj = box (TimelineViewGroupByDateLayoutPanelProp.ResourceNavigatorVisibility v)
    let topRightCornerAreaTemplate v : obj = box (TimelineViewGroupByDateLayoutPanelProp.TopRightCornerAreaTemplate v)
    let topLeftCornerAreaTemplate v : obj = box (TimelineViewGroupByDateLayoutPanelProp.TopLeftCornerAreaTemplate v)
    let bottomRightCornerAreaTemplate v : obj = box (TimelineViewGroupByDateLayoutPanelProp.BottomRightCornerAreaTemplate v)
    let bottomLeftCornerAreaTemplate v : obj = box (TimelineViewGroupByDateLayoutPanelProp.BottomLeftCornerAreaTemplate v)
    let resourceHeaderStyle v : obj = box (TimelineViewGroupByDateLayoutPanelProp.ResourceHeaderStyle v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel) (prop: TimelineViewGroupByDateLayoutPanelProp) =
        match prop with
        | TimelineViewGroupByDateLayoutPanelProp.Base p -> TimelineViewLayoutPanel.apply el p
        | TimelineViewGroupByDateLayoutPanelProp.ResourceHeaderElementPosition v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.ResourceHeaderElementPositionProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.ResourceNavigatorStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.ResourceNavigatorStyleProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.Scheduler v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.SchedulerProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.ResourceNavigatorVisibility v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.ResourceNavigatorVisibilityProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.TopRightCornerAreaTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.TopRightCornerAreaTemplateProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.TopLeftCornerAreaTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.TopLeftCornerAreaTemplateProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.BottomRightCornerAreaTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.BottomRightCornerAreaTemplateProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.BottomLeftCornerAreaTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.BottomLeftCornerAreaTemplateProperty, box v)
        | TimelineViewGroupByDateLayoutPanelProp.ResourceHeaderStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel.ResourceHeaderStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.TimelineViewGroupByDateLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
