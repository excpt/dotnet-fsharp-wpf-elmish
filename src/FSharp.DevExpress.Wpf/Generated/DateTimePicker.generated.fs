...
module DateTimePicker =
    ...
    let apply (el: DevExpress.Xpf.Editors.DateTimePicker) (prop: DateTimePickerProp) =
        match prop with
        | DateTimePickerProp.Base p -> DateEditCalendarBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateTimePicker>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
