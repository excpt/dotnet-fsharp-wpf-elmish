...
type DefaultMinorTickmarkControlProp =
    | Base of PresentationControlProp

module DefaultMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultMinorTickmarkControl) (prop: DefaultMinorTickmarkControlProp) =
        match prop with
        | DefaultMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
