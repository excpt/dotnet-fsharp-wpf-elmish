...
type BorderlessGradientBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module BorderlessGradientBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderlessGradientBar2DModelControl) (prop: BorderlessGradientBar2DModelControlProp) =
        match prop with
        | BorderlessGradientBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderlessGradientBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
