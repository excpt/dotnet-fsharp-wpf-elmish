...
type ToolTipPanelProp =
    | Base of ChartItemsPanelBaseProp

module ToolTipPanel =

    let apply (el: DevExpress.Xpf.Charts.ToolTipPanel) (prop: ToolTipPanelProp) =
        match prop with
        | ToolTipPanelProp.Base p -> ChartItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ToolTipPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
