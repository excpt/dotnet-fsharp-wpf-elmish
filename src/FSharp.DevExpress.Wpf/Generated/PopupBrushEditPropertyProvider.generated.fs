...
type PopupBrushEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp
    | Brush of System.Windows.Media.Brush

module PopupBrushEditPropertyProvider =
    let brush v : obj = box (PopupBrushEditPropertyProviderProp.Brush v)

    let apply (el: DevExpress.Xpf.Editors.PopupBrushEditPropertyProvider) (prop: PopupBrushEditPropertyProviderProp) =
        match prop with
        | PopupBrushEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
        | PopupBrushEditPropertyProviderProp.Brush v -> el.SetValue(DevExpress.Xpf.Editors.PopupBrushEditPropertyProvider.BrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupBrushEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
