...
type RibbonPageHeaderControlProp =
    | Page of DevExpress.Xpf.Ribbon.RibbonPage
    | SeparatorOpacity of float
    | IsPageSelected of bool
    | IsMinimizedRibbonCollapsed of bool
    | IsRibbonMinimized of bool
    | PageCaptionMinWidth of float
    | CommonPageCaptionMinWidth of float
    | IsRibbonBackStageViewOpened of bool
    | AeroTemplate of System.Windows.Controls.ControlTemplate
    | IsAeroMode of bool
    | BestDesiredSize of System.Windows.Size
    | MinDesiredWidth of float
    | Altitude of int
    | Index of int

module RibbonPageHeaderControl =
    let page v : obj = box (RibbonPageHeaderControlProp.Page v)
    let separatorOpacity v : obj = box (RibbonPageHeaderControlProp.SeparatorOpacity v)
    let isPageSelected v : obj = box (RibbonPageHeaderControlProp.IsPageSelected v)
    let isMinimizedRibbonCollapsed v : obj = box (RibbonPageHeaderControlProp.IsMinimizedRibbonCollapsed v)
    let isRibbonMinimized v : obj = box (RibbonPageHeaderControlProp.IsRibbonMinimized v)
    let pageCaptionMinWidth v : obj = box (RibbonPageHeaderControlProp.PageCaptionMinWidth v)
    let commonPageCaptionMinWidth v : obj = box (RibbonPageHeaderControlProp.CommonPageCaptionMinWidth v)
    let isRibbonBackStageViewOpened v : obj = box (RibbonPageHeaderControlProp.IsRibbonBackStageViewOpened v)
    let aeroTemplate v : obj = box (RibbonPageHeaderControlProp.AeroTemplate v)
    let isAeroMode v : obj = box (RibbonPageHeaderControlProp.IsAeroMode v)
    let bestDesiredSize v : obj = box (RibbonPageHeaderControlProp.BestDesiredSize v)
    let minDesiredWidth v : obj = box (RibbonPageHeaderControlProp.MinDesiredWidth v)
    let altitude v : obj = box (RibbonPageHeaderControlProp.Altitude v)
    let index v : obj = box (RibbonPageHeaderControlProp.Index v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageHeaderControl) (prop: RibbonPageHeaderControlProp) =
        match prop with
        | RibbonPageHeaderControlProp.Page v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.PageProperty, box v)
        | RibbonPageHeaderControlProp.SeparatorOpacity v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.SeparatorOpacityProperty, box v)
        | RibbonPageHeaderControlProp.IsPageSelected v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.IsPageSelectedProperty, box v)
        | RibbonPageHeaderControlProp.IsMinimizedRibbonCollapsed v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.IsMinimizedRibbonCollapsedProperty, box v)
        | RibbonPageHeaderControlProp.IsRibbonMinimized v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.IsRibbonMinimizedProperty, box v)
        | RibbonPageHeaderControlProp.PageCaptionMinWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.PageCaptionMinWidthProperty, box v)
        | RibbonPageHeaderControlProp.CommonPageCaptionMinWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.CommonPageCaptionMinWidthProperty, box v)
        | RibbonPageHeaderControlProp.IsRibbonBackStageViewOpened v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.IsRibbonBackStageViewOpenedProperty, box v)
        | RibbonPageHeaderControlProp.AeroTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.AeroTemplateProperty, box v)
        | RibbonPageHeaderControlProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.IsAeroModeProperty, box v)
        | RibbonPageHeaderControlProp.BestDesiredSize v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.BestDesiredSizeProperty, box v)
        | RibbonPageHeaderControlProp.MinDesiredWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.MinDesiredWidthProperty, box v)
        | RibbonPageHeaderControlProp.Altitude v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.AltitudeProperty, box v)
        | RibbonPageHeaderControlProp.Index v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.IndexProperty, box v)
    ...
    let pageHeaderControl (v: DevExpress.Xpf.Ribbon.RibbonPageHeaderControl) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Ribbon.RibbonPageHeaderControl.PageHeaderControlProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
