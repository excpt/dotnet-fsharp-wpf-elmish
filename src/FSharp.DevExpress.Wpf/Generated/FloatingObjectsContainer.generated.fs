...
type FloatingObjectsContainerProp =
    | Base of WorksheetPaintPanelProp

module FloatingObjectsContainer =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.FloatingObjectsContainer) (prop: FloatingObjectsContainerProp) =
        match prop with
        | FloatingObjectsContainerProp.Base p -> WorksheetPaintPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.FloatingObjectsContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
