...
type DayHeaderProp =
    | Base of SchedulerHeaderProp

module DayHeader =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DayHeader) (prop: DayHeaderProp) =
        match prop with
        | DayHeaderProp.Base p -> SchedulerHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DayHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
