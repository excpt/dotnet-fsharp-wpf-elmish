...
type AppointmentArrowPresenterBaseProp =
    | Space of float

module AppointmentArrowPresenterBase =
    let space v : obj = box (AppointmentArrowPresenterBaseProp.Space v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentArrowPresenterBase) (prop: AppointmentArrowPresenterBaseProp) =
        match prop with
        | AppointmentArrowPresenterBaseProp.Space v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentArrowPresenterBase.SpaceProperty, box v)
