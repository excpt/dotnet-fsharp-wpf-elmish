...
type FilterCheckedTreeViewItemProp =
    | Base of CheckedTreeViewItemProp

module FilterCheckedTreeViewItem =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FilterCheckedTreeViewItem) (prop: FilterCheckedTreeViewItemProp) =
        match prop with
        | FilterCheckedTreeViewItemProp.Base p -> CheckedTreeViewItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FilterCheckedTreeViewItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
