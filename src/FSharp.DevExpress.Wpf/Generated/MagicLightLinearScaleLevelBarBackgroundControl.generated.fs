...
type MagicLightLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module MagicLightLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightLinearScaleLevelBarBackgroundControl) (prop: MagicLightLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | MagicLightLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
