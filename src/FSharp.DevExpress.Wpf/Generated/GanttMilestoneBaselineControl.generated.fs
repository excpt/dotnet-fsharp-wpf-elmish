...
type GanttMilestoneBaselineControlProp =
    | Base of GanttMilestoneControlProp

module GanttMilestoneBaselineControl =

    let apply (el: DevExpress.Xpf.Gantt.GanttMilestoneBaselineControl) (prop: GanttMilestoneBaselineControlProp) =
        match prop with
        | GanttMilestoneBaselineControlProp.Base p -> GanttMilestoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttMilestoneBaselineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
