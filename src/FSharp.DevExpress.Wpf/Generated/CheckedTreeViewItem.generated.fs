...
type CheckedTreeViewItemProp =
    | IsChecked of obj
    | IsThreeState of bool

module CheckedTreeViewItem =
    let isChecked v : obj = box (CheckedTreeViewItemProp.IsChecked v)
    let isThreeState v : obj = box (CheckedTreeViewItemProp.IsThreeState v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.CheckedTreeViewItem) (prop: CheckedTreeViewItemProp) =
        match prop with
        | CheckedTreeViewItemProp.IsChecked v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.CheckedTreeViewItem.IsCheckedProperty, box v)
        | CheckedTreeViewItemProp.IsThreeState v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.CheckedTreeViewItem.IsThreeStateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.CheckedTreeViewItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
