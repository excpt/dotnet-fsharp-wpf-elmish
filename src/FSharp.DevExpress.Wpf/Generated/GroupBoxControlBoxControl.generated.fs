...
type GroupBoxControlBoxControlProp =
    | Base of BaseControlBoxControlProp
    | ExpandButtonTemplate of System.Windows.DataTemplate

module GroupBoxControlBoxControl =
    let expandButtonTemplate v : obj = box (GroupBoxControlBoxControlProp.ExpandButtonTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.GroupBoxControlBoxControl) (prop: GroupBoxControlBoxControlProp) =
        match prop with
        | GroupBoxControlBoxControlProp.Base p -> BaseControlBoxControl.apply el p
        | GroupBoxControlBoxControlProp.ExpandButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.GroupBoxControlBoxControl.ExpandButtonTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.GroupBoxControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
