...
type SunburstSectorPresentationProp =
...
module SunburstSectorPresentation =
    let fill v : obj = box (SunburstSectorPresentationProp.Fill v)
    let stroke v : obj = box (SunburstSectorPresentationProp.Stroke v)
    let strokeThickness v : obj = box (SunburstSectorPresentationProp.StrokeThickness v)
    let geometry v : obj = box (SunburstSectorPresentationProp.Geometry v)

    let apply (el: DevExpress.Xpf.TreeMap.SunburstSectorPresentation) (prop: SunburstSectorPresentationProp) =
        match prop with
        | SunburstSectorPresentationProp.Fill v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstSectorPresentation.FillProperty, box v)
        | SunburstSectorPresentationProp.Stroke v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstSectorPresentation.StrokeProperty, box v)
        | SunburstSectorPresentationProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstSectorPresentation.StrokeThicknessProperty, box v)
        | SunburstSectorPresentationProp.Geometry v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstSectorPresentation.GeometryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.SunburstSectorPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
