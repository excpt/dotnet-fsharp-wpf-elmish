...
type CircularProgressiveFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularProgressiveFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularProgressiveFullModel) (prop: CircularProgressiveFullModelProp) =
        match prop with
        | CircularProgressiveFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularProgressiveFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
