...
type InnerGroupHeaderProp =
    | Base of FieldHeaderProp

module InnerGroupHeader =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.InnerGroupHeader) (prop: InnerGroupHeaderProp) =
        match prop with
        | InnerGroupHeaderProp.Base p -> FieldHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.InnerGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
