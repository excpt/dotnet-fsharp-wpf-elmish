...
type DropBoundsControlProp =
    | DropType of DevExpress.Xpf.Layout.Core.DropType
    | IsDragSource of bool
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem
    | UseOptimizedTemplate of bool
    | CenterElementTemplate of System.Windows.DataTemplate
    | SideElementTemplate of System.Windows.DataTemplate

module DropBoundsControl =
    let dropType v : obj = box (DropBoundsControlProp.DropType v)
    let isDragSource v : obj = box (DropBoundsControlProp.IsDragSource v)
    let layoutItem v : obj = box (DropBoundsControlProp.LayoutItem v)
    let useOptimizedTemplate v : obj = box (DropBoundsControlProp.UseOptimizedTemplate v)
    let centerElementTemplate v : obj = box (DropBoundsControlProp.CenterElementTemplate v)
    let sideElementTemplate v : obj = box (DropBoundsControlProp.SideElementTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DropBoundsControl) (prop: DropBoundsControlProp) =
        match prop with
        | DropBoundsControlProp.DropType v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DropBoundsControl.DropTypeProperty, box v)
        | DropBoundsControlProp.IsDragSource v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DropBoundsControl.IsDragSourceProperty, box v)
        | DropBoundsControlProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DropBoundsControl.LayoutItemProperty, box v)
        | DropBoundsControlProp.UseOptimizedTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DropBoundsControl.UseOptimizedTemplateProperty, box v)
        | DropBoundsControlProp.CenterElementTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DropBoundsControl.CenterElementTemplateProperty, box v)
        | DropBoundsControlProp.SideElementTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DropBoundsControl.SideElementTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DropBoundsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
