...
type MeasurementLabelPresentationProp =
    | Text of string
    | DeleteButtonVisibility of System.Windows.Visibility
    | OnDeleteButtonClicked of System.Windows.RoutedEventHandler

module MeasurementLabelPresentation =
    let text v : obj = box (MeasurementLabelPresentationProp.Text v)
    let deleteButtonVisibility v : obj = box (MeasurementLabelPresentationProp.DeleteButtonVisibility v)
    let onDeleteButtonClicked v : obj = box (EventProp(box (MeasurementLabelPresentationProp.OnDeleteButtonClicked v)))

    let apply (el: DevExpress.Xpf.Map.MeasurementLabelPresentation) (prop: MeasurementLabelPresentationProp) =
        match prop with
        | MeasurementLabelPresentationProp.Text v -> el.SetValue(DevExpress.Xpf.Map.MeasurementLabelPresentation.TextProperty, box v)
        | MeasurementLabelPresentationProp.DeleteButtonVisibility v -> el.SetValue(DevExpress.Xpf.Map.MeasurementLabelPresentation.DeleteButtonVisibilityProperty, box v)
        | MeasurementLabelPresentationProp.OnDeleteButtonClicked h -> el.DeleteButtonClicked.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MeasurementLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
