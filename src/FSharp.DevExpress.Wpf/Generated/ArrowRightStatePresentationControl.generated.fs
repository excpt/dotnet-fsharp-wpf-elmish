...
type ArrowRightStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowRightStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowRightStatePresentationControl) (prop: ArrowRightStatePresentationControlProp) =
        match prop with
        | ArrowRightStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowRightStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
