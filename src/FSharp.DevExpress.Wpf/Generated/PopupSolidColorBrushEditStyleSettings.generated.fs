...
type PopupSolidColorBrushEditStyleSettingsProp =
    | Base of PopupBrushEditStyleSettingsBaseProp

module PopupSolidColorBrushEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupSolidColorBrushEditStyleSettings) (prop: PopupSolidColorBrushEditStyleSettingsProp) =
        match prop with
        | PopupSolidColorBrushEditStyleSettingsProp.Base p -> PopupBrushEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupSolidColorBrushEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
