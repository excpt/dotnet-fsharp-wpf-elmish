...
type PropertyBuilderProp =
    | Definitions of DevExpress.Xpf.PropertyGrid.PropertyDefinitionCollection

module PropertyBuilder =
    let definitions v : obj = box (PropertyBuilderProp.Definitions v)

    let apply (el: DevExpress.Xpf.PropertyGrid.PropertyBuilder) (prop: PropertyBuilderProp) =
        match prop with
        | PropertyBuilderProp.Definitions v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyBuilder.DefinitionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PropertyBuilder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
