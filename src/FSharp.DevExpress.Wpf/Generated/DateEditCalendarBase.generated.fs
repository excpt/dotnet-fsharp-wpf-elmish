...
module DateEditCalendarBase =
    let minValue v : obj = box (DateEditCalendarBaseProp.MinValue v)
    let maxValue v : obj = box (DateEditCalendarBaseProp.MaxValue v)
    ...
    let apply (el: DevExpress.Xpf.Editors.DateEditCalendarBase) (prop: DateEditCalendarBaseProp) =
        match prop with
        | DateEditCalendarBaseProp.MinValue v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.MinValueProperty, box v)
        | DateEditCalendarBaseProp.MaxValue v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.MaxValueProperty, box v)
        | DateEditCalendarBaseProp.ShowWeekNumbers v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.ShowWeekNumbersProperty, box v)
        | DateEditCalendarBaseProp.ShowClearButton v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.ShowClearButtonProperty, box v)
        | DateEditCalendarBaseProp.ShowToday v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.ShowTodayProperty, box v)
        | DateEditCalendarBaseProp.Mask v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.MaskProperty, box v)
        | DateEditCalendarBaseProp.MaskCulture v -> el.SetValue(DevExpress.Xpf.Editors.DateEditCalendarBase.MaskCultureProperty, box v)
    ...
    let dateTime (v: System.DateTime) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DateEditCalendarBase.DateTimeProperty, box v)) :: node.Props }
