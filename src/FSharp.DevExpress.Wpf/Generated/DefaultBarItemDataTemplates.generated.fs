...
type DefaultBarItemDataTemplatesProp =
    | SectionMarginBarItemContentTemplate of System.Windows.DataTemplate
    | SectionPaperKindBarItemContentTemplate of System.Windows.DataTemplate
    | CheckEditTemplate of System.Windows.DataTemplate
    | StyleGalleryItemCaptionTemplate of System.Windows.DataTemplate
    | TableStyleGalleryItemCaptionTemplate of System.Windows.DataTemplate

module DefaultBarItemDataTemplates =
    let sectionMarginBarItemContentTemplate v : obj = box (DefaultBarItemDataTemplatesProp.SectionMarginBarItemContentTemplate v)
    let sectionPaperKindBarItemContentTemplate v : obj = box (DefaultBarItemDataTemplatesProp.SectionPaperKindBarItemContentTemplate v)
    let checkEditTemplate v : obj = box (DefaultBarItemDataTemplatesProp.CheckEditTemplate v)
    let styleGalleryItemCaptionTemplate v : obj = box (DefaultBarItemDataTemplatesProp.StyleGalleryItemCaptionTemplate v)
    let tableStyleGalleryItemCaptionTemplate v : obj = box (DefaultBarItemDataTemplatesProp.TableStyleGalleryItemCaptionTemplate v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates) (prop: DefaultBarItemDataTemplatesProp) =
        match prop with
        | DefaultBarItemDataTemplatesProp.SectionMarginBarItemContentTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates.SectionMarginBarItemContentTemplateProperty, box v)
        | DefaultBarItemDataTemplatesProp.SectionPaperKindBarItemContentTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates.SectionPaperKindBarItemContentTemplateProperty, box v)
        | DefaultBarItemDataTemplatesProp.CheckEditTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates.CheckEditTemplateProperty, box v)
        | DefaultBarItemDataTemplatesProp.StyleGalleryItemCaptionTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates.StyleGalleryItemCaptionTemplateProperty, box v)
        | DefaultBarItemDataTemplatesProp.TableStyleGalleryItemCaptionTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates.TableStyleGalleryItemCaptionTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.DefaultBarItemDataTemplates>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
