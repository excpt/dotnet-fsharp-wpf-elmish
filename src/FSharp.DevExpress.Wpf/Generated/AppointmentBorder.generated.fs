...
type AppointmentBorderProp =
    | Base of AppointmentBorderBaseProp

module AppointmentBorder =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentBorder) (prop: AppointmentBorderProp) =
        match prop with
        | AppointmentBorderProp.Base p -> AppointmentBorderBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
