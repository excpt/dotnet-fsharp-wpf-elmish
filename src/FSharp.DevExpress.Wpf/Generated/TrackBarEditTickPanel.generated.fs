...
type TrackBarEditTickPanelProp =
    | Orientation of System.Windows.Controls.Orientation

module TrackBarEditTickPanel =
    let orientation v : obj = box (TrackBarEditTickPanelProp.Orientation v)

    let apply (el: DevExpress.Xpf.Editors.TrackBarEditTickPanel) (prop: TrackBarEditTickPanelProp) =
        match prop with
        | TrackBarEditTickPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditTickPanel.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarEditTickPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
