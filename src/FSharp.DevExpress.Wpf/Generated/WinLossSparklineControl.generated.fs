...
type WinLossSparklineControlProp =
    | Base of BarSparklineControlBaseProp

module WinLossSparklineControl =

    let apply (el: DevExpress.Xpf.Editors.WinLossSparklineControl) (prop: WinLossSparklineControlProp) =
        match prop with
        | WinLossSparklineControlProp.Base p -> BarSparklineControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.WinLossSparklineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
