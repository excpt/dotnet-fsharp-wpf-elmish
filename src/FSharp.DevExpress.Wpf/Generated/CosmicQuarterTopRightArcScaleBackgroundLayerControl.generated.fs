...
type CosmicQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicQuarterTopRightArcScaleBackgroundLayerControl) (prop: CosmicQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | CosmicQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
