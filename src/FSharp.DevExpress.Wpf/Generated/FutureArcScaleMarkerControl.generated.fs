...
type FutureArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FutureArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureArcScaleMarkerControl) (prop: FutureArcScaleMarkerControlProp) =
        match prop with
        | FutureArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
