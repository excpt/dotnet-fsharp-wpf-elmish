...
type SmileIndifferentStatePresentationControlProp =
    | Base of PresentationControlProp

module SmileIndifferentStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.SmileIndifferentStatePresentationControl) (prop: SmileIndifferentStatePresentationControlProp) =
        match prop with
        | SmileIndifferentStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmileIndifferentStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
