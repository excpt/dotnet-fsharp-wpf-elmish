...
type MagicLightLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightLinearScaleBackgroundLayerControl) (prop: MagicLightLinearScaleBackgroundLayerControlProp) =
        match prop with
        | MagicLightLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
