...
type SmartArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module SmartArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartArcScaleNeedleControl) (prop: SmartArcScaleNeedleControlProp) =
        match prop with
        | SmartArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
