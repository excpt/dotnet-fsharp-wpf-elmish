...
type PdfSignaturesViewerSettingsProp =
    | HideSignatureViewer of bool
    | SignatureViewerState of DevExpress.Xpf.PdfViewer.PdfSignatureViewerState
    | SignatureViewerInitialState of obj
    | SignatureViewerStyle of System.Windows.Style
    | HideAfterUse of obj

module PdfSignaturesViewerSettings =
    let hideSignatureViewer v : obj = box (PdfSignaturesViewerSettingsProp.HideSignatureViewer v)
    let signatureViewerState v : obj = box (PdfSignaturesViewerSettingsProp.SignatureViewerState v)
    let signatureViewerInitialState v : obj = box (PdfSignaturesViewerSettingsProp.SignatureViewerInitialState v)
    let signatureViewerStyle v : obj = box (PdfSignaturesViewerSettingsProp.SignatureViewerStyle v)
    let hideAfterUse v : obj = box (PdfSignaturesViewerSettingsProp.HideAfterUse v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings) (prop: PdfSignaturesViewerSettingsProp) =
        match prop with
        | PdfSignaturesViewerSettingsProp.HideSignatureViewer v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings.HideSignatureViewerProperty, box v)
        | PdfSignaturesViewerSettingsProp.SignatureViewerState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings.SignatureViewerStateProperty, box v)
        | PdfSignaturesViewerSettingsProp.SignatureViewerInitialState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings.SignatureViewerInitialStateProperty, box v)
        | PdfSignaturesViewerSettingsProp.SignatureViewerStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings.SignatureViewerStyleProperty, box v)
        | PdfSignaturesViewerSettingsProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings.HideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfSignaturesViewerSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
