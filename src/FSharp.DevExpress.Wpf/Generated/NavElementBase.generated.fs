...
type NavElementBaseProp =
    | Base of TileSelectorItemProp
    | NavButtonStyle of System.Windows.Style
    | TileContent of obj
    | TileContentTemplate of System.Windows.DataTemplate
    | TileContentTemplateSelector of System.Windows.Controls.DataTemplateSelector

module NavElementBase =
    ...
    let apply (el: DevExpress.Xpf.Navigation.NavElementBase) (prop: NavElementBaseProp) =
        match prop with
        | NavElementBaseProp.Base p -> TileSelectorItem.apply el p
        | NavElementBaseProp.NavButtonStyle v -> el.SetValue(DevExpress.Xpf.Navigation.NavElementBase.NavButtonStyleProperty, box v)
        | NavElementBaseProp.TileContent v -> el.SetValue(DevExpress.Xpf.Navigation.NavElementBase.TileContentProperty, box v)
        | NavElementBaseProp.TileContentTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.NavElementBase.TileContentTemplateProperty, box v)
        | NavElementBaseProp.TileContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.NavElementBase.TileContentTemplateSelectorProperty, box v)
