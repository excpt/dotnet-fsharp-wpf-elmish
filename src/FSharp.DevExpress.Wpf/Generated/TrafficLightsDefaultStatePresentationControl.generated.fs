...
type TrafficLightsDefaultStatePresentationControlProp =
    | Base of PresentationControlProp

module TrafficLightsDefaultStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.TrafficLightsDefaultStatePresentationControl) (prop: TrafficLightsDefaultStatePresentationControlProp) =
        match prop with
        | TrafficLightsDefaultStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.TrafficLightsDefaultStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
