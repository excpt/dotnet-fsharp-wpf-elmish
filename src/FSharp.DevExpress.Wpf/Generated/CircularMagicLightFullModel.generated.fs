...
type CircularMagicLightFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularMagicLightFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularMagicLightFullModel) (prop: CircularMagicLightFullModelProp) =
        match prop with
        | CircularMagicLightFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularMagicLightFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
