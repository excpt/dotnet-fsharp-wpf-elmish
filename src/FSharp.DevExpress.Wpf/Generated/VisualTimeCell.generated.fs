...
type VisualTimeCellProp =
    | Base of VisualWorkTimeCellBaseProp

module VisualTimeCell =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimeCell) (prop: VisualTimeCellProp) =
        match prop with
        | VisualTimeCellProp.Base p -> VisualWorkTimeCellBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualTimeCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
