...
module PieSeries =
    ...
    let apply (el: DevExpress.Xpf.Charts.PieSeries) (prop: PieSeriesProp) =
        match prop with
        | PieSeriesProp.Base p -> Series.apply el p
        | PieSeriesProp.HoleRadiusPercent v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries.HoleRadiusPercentProperty, box v)
        | PieSeriesProp.LabelsResolveOverlappingMinIndent v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries.LabelsResolveOverlappingMinIndentProperty, box v)
    ...
    let explodedDistance (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.PieSeries.ExplodedDistanceProperty, box v)) :: node.Props }
    let labelPosition (v: DevExpress.Xpf.Charts.PieLabelPosition) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.PieSeries.LabelPositionProperty, box v)) :: node.Props }
    let percentOptions (v: DevExpress.Xpf.Charts.PercentOptions) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.PieSeries.PercentOptionsProperty, box v)) :: node.Props }
    let seriesTitleTextPattern (v: string) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.PieSeries.SeriesTitleTextPatternProperty, box v)) :: node.Props }
    let othersPointExplodedDistance (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.PieSeries.OthersPointExplodedDistanceProperty, box v)) :: node.Props }
