...
type EcoDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoDigitalGaugeBackgroundLayerControl) (prop: EcoDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | EcoDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
