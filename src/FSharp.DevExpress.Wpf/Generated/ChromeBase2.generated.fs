...
type ChromeBase2Prop =
    | RenderInfo of DevExpress.Xpf.Core.Native.RenderInfo
    | TemplateProvider of DevExpress.Xpf.Core.Native.ChromeStateProviderBase
    | ContentMargin of System.Windows.Thickness
    | ForegroundInfo of DevExpress.Xpf.Core.Native.ForegroundInfo
    | Child of System.Windows.UIElement

module ChromeBase2 =
    let renderInfo v : obj = box (ChromeBase2Prop.RenderInfo v)
    let templateProvider v : obj = box (ChromeBase2Prop.TemplateProvider v)
    let contentMargin v : obj = box (ChromeBase2Prop.ContentMargin v)
    let foregroundInfo v : obj = box (ChromeBase2Prop.ForegroundInfo v)
    let child v : obj = box (ChromeBase2Prop.Child v)

    let apply (el: DevExpress.Xpf.Core.Native.ChromeBase2) (prop: ChromeBase2Prop) =
        match prop with
        | ChromeBase2Prop.RenderInfo v -> el.SetValue(DevExpress.Xpf.Core.Native.ChromeBase2.RenderInfoProperty, box v)
        | ChromeBase2Prop.TemplateProvider v -> el.SetValue(DevExpress.Xpf.Core.Native.ChromeBase2.TemplateProviderProperty, box v)
        | ChromeBase2Prop.ContentMargin v -> el.SetValue(DevExpress.Xpf.Core.Native.ChromeBase2.ContentMarginProperty, box v)
        | ChromeBase2Prop.ForegroundInfo v -> el.SetValue(DevExpress.Xpf.Core.Native.ChromeBase2.ForegroundInfoProperty, box v)
        | ChromeBase2Prop.Child v -> el.SetValue(DevExpress.Xpf.Core.Native.ChromeBase2.ChildProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ChromeBase2>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
