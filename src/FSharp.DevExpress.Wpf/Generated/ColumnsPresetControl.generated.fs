...
type ColumnsPresetControlProp =
    | Text of string
    | ImageSource of System.Windows.Media.ImageSource

module ColumnsPresetControl =
    let text v : obj = box (ColumnsPresetControlProp.Text v)
    let imageSource v : obj = box (ColumnsPresetControlProp.ImageSource v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.ColumnsPresetControl) (prop: ColumnsPresetControlProp) =
        match prop with
        | ColumnsPresetControlProp.Text v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.ColumnsPresetControl.TextProperty, box v)
        | ColumnsPresetControlProp.ImageSource v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.ColumnsPresetControl.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.ColumnsPresetControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
