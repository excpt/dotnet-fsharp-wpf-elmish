...
type BoundImageDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module BoundImageDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.BoundImageDashboardLayoutItem) (prop: BoundImageDashboardLayoutItemProp) =
        match prop with
        | BoundImageDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.BoundImageDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
