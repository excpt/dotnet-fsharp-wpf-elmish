...
type CleanWhiteHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteHalfTopArcScaleBackgroundLayerControl) (prop: CleanWhiteHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
