...
type PolarPointSeries2DProp =
    | Base of CircularSeries2DProp

module PolarPointSeries2D =

    let apply (el: DevExpress.Xpf.Charts.PolarPointSeries2D) (prop: PolarPointSeries2DProp) =
        match prop with
        | PolarPointSeries2DProp.Base p -> CircularSeries2D.apply el p

    let markerModel v : obj = box (CircularSeries2DProp.MarkerModel v)
    let markerSize v : obj = box (CircularSeries2DProp.MarkerSize v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarPointSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
