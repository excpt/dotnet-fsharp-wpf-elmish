...
type SimplePie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module SimplePie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.SimplePie2DModelControl) (prop: SimplePie2DModelControlProp) =
        match prop with
        | SimplePie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimplePie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
