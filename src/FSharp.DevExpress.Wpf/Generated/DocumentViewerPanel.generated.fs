...
type DocumentViewerPanelProp =
    | ShowSingleItem of bool

module DocumentViewerPanel =
    let showSingleItem v : obj = box (DocumentViewerPanelProp.ShowSingleItem v)

    let apply (el: DevExpress.Xpf.DocumentViewer.DocumentViewerPanel) (prop: DocumentViewerPanelProp) =
        match prop with
        | DocumentViewerPanelProp.ShowSingleItem v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerPanel.ShowSingleItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.DocumentViewerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
