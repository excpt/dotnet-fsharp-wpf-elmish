...
type LinearFutureModelProp =
    | Base of LinearGaugeModelProp

module LinearFutureModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearFutureModel) (prop: LinearFutureModelProp) =
        match prop with
        | LinearFutureModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearFutureModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
