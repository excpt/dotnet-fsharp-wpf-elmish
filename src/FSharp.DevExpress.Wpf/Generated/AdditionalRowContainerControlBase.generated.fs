...
type AdditionalRowContainerControlBaseProp =
    | RowTemplate of System.Windows.Controls.ControlTemplate
    | ItemTemplate of System.Windows.DataTemplate
    | IndicatorWidth of float

module AdditionalRowContainerControlBase =
    let rowTemplate v : obj = box (AdditionalRowContainerControlBaseProp.RowTemplate v)
    let itemTemplate v : obj = box (AdditionalRowContainerControlBaseProp.ItemTemplate v)
    let indicatorWidth v : obj = box (AdditionalRowContainerControlBaseProp.IndicatorWidth v)

    let apply (el: DevExpress.Xpf.Grid.AdditionalRowContainerControlBase) (prop: AdditionalRowContainerControlBaseProp) =
        match prop with
        | AdditionalRowContainerControlBaseProp.RowTemplate v -> el.SetValue(DevExpress.Xpf.Grid.AdditionalRowContainerControlBase.RowTemplateProperty, box v)
        | AdditionalRowContainerControlBaseProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Grid.AdditionalRowContainerControlBase.ItemTemplateProperty, box v)
        | AdditionalRowContainerControlBaseProp.IndicatorWidth v -> el.SetValue(DevExpress.Xpf.Grid.AdditionalRowContainerControlBase.IndicatorWidthProperty, box v)
