...
type DialogIconsViewProp =
    | Base of DialogIconsViewBaseProp

module DialogIconsView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogIconsView) (prop: DialogIconsViewProp) =
        match prop with
        | DialogIconsViewProp.Base p -> DialogIconsViewBase.apply el p
