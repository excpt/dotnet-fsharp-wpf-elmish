...
type ThemedWindowToolbarItemsControlProp =
    | Base of ThemedWindowHeaderItemsControlBaseProp

module ThemedWindowToolbarItemsControl =

    let apply (el: DevExpress.Xpf.Core.ThemedWindowToolbarItemsControl) (prop: ThemedWindowToolbarItemsControlProp) =
        match prop with
        | ThemedWindowToolbarItemsControlProp.Base p -> ThemedWindowHeaderItemsControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowToolbarItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
