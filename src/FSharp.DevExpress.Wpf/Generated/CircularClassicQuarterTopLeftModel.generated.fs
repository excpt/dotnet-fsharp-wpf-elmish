...
type CircularClassicQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularClassicQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularClassicQuarterTopLeftModel) (prop: CircularClassicQuarterTopLeftModelProp) =
        match prop with
        | CircularClassicQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularClassicQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
