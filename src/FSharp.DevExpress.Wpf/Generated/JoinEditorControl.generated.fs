...
type JoinEditorControlProp =
    | ItemsSource of obj
    | JoinType of DevExpress.DataAccess.Sql.SqlJoinType
    | AllowAddItems of bool
    | AllowRemoveItems of bool
    | MessageBoxServiceTemplate of System.Windows.DataTemplate

module JoinEditorControl =
    let itemsSource v : obj = box (JoinEditorControlProp.ItemsSource v)
    let joinType v : obj = box (JoinEditorControlProp.JoinType v)
    let allowAddItems v : obj = box (JoinEditorControlProp.AllowAddItems v)
    let allowRemoveItems v : obj = box (JoinEditorControlProp.AllowRemoveItems v)
    let messageBoxServiceTemplate v : obj = box (JoinEditorControlProp.MessageBoxServiceTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl) (prop: JoinEditorControlProp) =
        match prop with
        | JoinEditorControlProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl.ItemsSourceProperty, box v)
        | JoinEditorControlProp.JoinType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl.JoinTypeProperty, box v)
        | JoinEditorControlProp.AllowAddItems v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl.AllowAddItemsProperty, box v)
        | JoinEditorControlProp.AllowRemoveItems v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl.AllowRemoveItemsProperty, box v)
        | JoinEditorControlProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl.MessageBoxServiceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.JoinEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
