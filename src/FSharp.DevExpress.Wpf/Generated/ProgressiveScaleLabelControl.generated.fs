...
type ProgressiveScaleLabelControlProp =
    | Base of PresentationControlProp

module ProgressiveScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveScaleLabelControl) (prop: ProgressiveScaleLabelControlProp) =
        match prop with
        | ProgressiveScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
