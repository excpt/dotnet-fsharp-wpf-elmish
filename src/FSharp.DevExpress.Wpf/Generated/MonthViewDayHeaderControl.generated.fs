...
type MonthViewDayHeaderControlProp =
    | Base of DayHeaderControlProp

module MonthViewDayHeaderControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.MonthViewDayHeaderControl) (prop: MonthViewDayHeaderControlProp) =
        match prop with
        | MonthViewDayHeaderControlProp.Base p -> DayHeaderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.MonthViewDayHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
