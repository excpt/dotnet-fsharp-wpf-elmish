...
type DockingHintAdornerBaseProp =
    | Base of BaseSurfacedAdornerProp

module DockingHintAdornerBase =

    let apply (el: DevExpress.Xpf.Docking.Platform.DockingHintAdornerBase) (prop: DockingHintAdornerBaseProp) =
        match prop with
        | DockingHintAdornerBaseProp.Base p -> BaseSurfacedAdorner.apply el p
