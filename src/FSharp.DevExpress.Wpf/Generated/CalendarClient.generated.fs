...
type CalendarClientProp =
    | IntervalFactories of obj
    | AllowGrouping of bool
    | GroupingHeight of float
    | ItemStyle of System.Windows.Style
    | GroupItemStyle of System.Windows.Style
    | ZoomOutSelectionMarkerTemplate of System.Windows.DataTemplate
    | CustomItemIntervalFactory of DevExpress.Xpf.Editors.RangeControl.IntervalFactory
    | CustomGroupIntervalFactory of DevExpress.Xpf.Editors.RangeControl.IntervalFactory

module CalendarClient =
    let intervalFactories v : obj = box (CalendarClientProp.IntervalFactories v)
    let allowGrouping v : obj = box (CalendarClientProp.AllowGrouping v)
    let groupingHeight v : obj = box (CalendarClientProp.GroupingHeight v)
    let itemStyle v : obj = box (CalendarClientProp.ItemStyle v)
    let groupItemStyle v : obj = box (CalendarClientProp.GroupItemStyle v)
    let zoomOutSelectionMarkerTemplate v : obj = box (CalendarClientProp.ZoomOutSelectionMarkerTemplate v)
    let customItemIntervalFactory v : obj = box (CalendarClientProp.CustomItemIntervalFactory v)
    let customGroupIntervalFactory v : obj = box (CalendarClientProp.CustomGroupIntervalFactory v)

    let apply (el: DevExpress.Xpf.Editors.RangeControl.CalendarClient) (prop: CalendarClientProp) =
        match prop with
        | CalendarClientProp.IntervalFactories v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.IntervalFactoriesProperty, box v)
        | CalendarClientProp.AllowGrouping v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.AllowGroupingProperty, box v)
        | CalendarClientProp.GroupingHeight v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.GroupingHeightProperty, box v)
        | CalendarClientProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.ItemStyleProperty, box v)
        | CalendarClientProp.GroupItemStyle v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.GroupItemStyleProperty, box v)
        | CalendarClientProp.ZoomOutSelectionMarkerTemplate v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.ZoomOutSelectionMarkerTemplateProperty, box v)
        | CalendarClientProp.CustomItemIntervalFactory v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.CustomItemIntervalFactoryProperty, box v)
        | CalendarClientProp.CustomGroupIntervalFactory v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.CalendarClient.CustomGroupIntervalFactoryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RangeControl.CalendarClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
