...
type LightweightFieldValueElementProp =
    | Base of FieldValueElementProp

module LightweightFieldValueElement =

    let apply (el: DevExpress.Xpf.PivotGrid.LightweightFieldValueElement) (prop: LightweightFieldValueElementProp) =
        match prop with
        | LightweightFieldValueElementProp.Base p -> FieldValueElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.LightweightFieldValueElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
