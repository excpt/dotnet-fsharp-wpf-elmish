...
type RadioListBoxEditStyleSettingsExProp =
    | Base of RadioListBoxEditStyleSettingsProp

module RadioListBoxEditStyleSettingsEx =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.RadioListBoxEditStyleSettingsEx) (prop: RadioListBoxEditStyleSettingsExProp) =
        match prop with
        | RadioListBoxEditStyleSettingsExProp.Base p -> RadioListBoxEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.RadioListBoxEditStyleSettingsEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
