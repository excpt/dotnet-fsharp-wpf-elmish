...
type ProgressBarEditProp =
    | Base of RangeBaseEditProp
    | IsPercent of bool
    | AdditionalForeground of System.Windows.Media.SolidColorBrush
    | Content of obj
    | ContentDisplayMode of DevExpress.Xpf.Editors.ContentDisplayMode
    | ContentTemplate of System.Windows.DataTemplate
    | ProgressBrush of System.Windows.Media.Brush

module ProgressBarEdit =
    let isPercent v : obj = box (ProgressBarEditProp.IsPercent v)
    let additionalForeground v : obj = box (ProgressBarEditProp.AdditionalForeground v)
    let content v : obj = box (ProgressBarEditProp.Content v)
    let contentDisplayMode v : obj = box (ProgressBarEditProp.ContentDisplayMode v)
    let contentTemplate v : obj = box (ProgressBarEditProp.ContentTemplate v)
    let progressBrush v : obj = box (ProgressBarEditProp.ProgressBrush v)

    let apply (el: DevExpress.Xpf.Editors.ProgressBarEdit) (prop: ProgressBarEditProp) =
        match prop with
        | ProgressBarEditProp.Base p -> RangeBaseEdit.apply el p
        | ProgressBarEditProp.IsPercent v -> el.SetValue(DevExpress.Xpf.Editors.ProgressBarEdit.IsPercentProperty, box v)
        | ProgressBarEditProp.AdditionalForeground v -> el.SetValue(DevExpress.Xpf.Editors.ProgressBarEdit.AdditionalForegroundProperty, box v)
        | ProgressBarEditProp.Content v -> el.SetValue(DevExpress.Xpf.Editors.ProgressBarEdit.ContentProperty, box v)
        | ProgressBarEditProp.ContentDisplayMode v -> el.SetValue(DevExpress.Xpf.Editors.ProgressBarEdit.ContentDisplayModeProperty, box v)
        | ProgressBarEditProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ProgressBarEdit.ContentTemplateProperty, box v)
        | ProgressBarEditProp.ProgressBrush v -> el.SetValue(DevExpress.Xpf.Editors.ProgressBarEdit.ProgressBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ProgressBarEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
