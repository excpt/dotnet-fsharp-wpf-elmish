...
type LabelControlProp =
    | Base of psvHeaderedContentControlProp

module LabelControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.LabelControl) (prop: LabelControlProp) =
        match prop with
        | LabelControlProp.Base p -> psvHeaderedContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.LabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
