...
module RatingItem =
    let orientation v : obj = box (RatingItemProp.Orientation v)
    let geometry v : obj = box (RatingItemProp.Geometry v)
    let hoverBackground v : obj = box (RatingItemProp.HoverBackground v)
    let selectedBackground v : obj = box (RatingItemProp.SelectedBackground v)
    let value v : obj = box (RatingItemProp.Value v)
    let hoverValue v : obj = box (RatingItemProp.HoverValue v)

    let apply (el: DevExpress.Xpf.Editors.RatingItem) (prop: RatingItemProp) =
        match prop with
        | RatingItemProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.RatingItem.OrientationProperty, box v)
        | RatingItemProp.Geometry v -> el.SetValue(DevExpress.Xpf.Editors.RatingItem.GeometryProperty, box v)
        | RatingItemProp.HoverBackground v -> el.SetValue(DevExpress.Xpf.Editors.RatingItem.HoverBackgroundProperty, box v)
        | RatingItemProp.SelectedBackground v -> el.SetValue(DevExpress.Xpf.Editors.RatingItem.SelectedBackgroundProperty, box v)
        | RatingItemProp.Value v -> el.SetValue(DevExpress.Xpf.Editors.RatingItem.ValueProperty, box v)
        | RatingItemProp.HoverValue v -> el.SetValue(DevExpress.Xpf.Editors.RatingItem.HoverValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RatingItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
