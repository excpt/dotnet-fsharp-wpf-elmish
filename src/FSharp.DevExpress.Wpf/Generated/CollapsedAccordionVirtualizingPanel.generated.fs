...
type CollapsedAccordionVirtualizingPanelProp =
    | StretchSingleChild of bool
    | AllowCollapseItems of bool
    | ActualChildrenLength of float

module CollapsedAccordionVirtualizingPanel =
    let stretchSingleChild v : obj = box (CollapsedAccordionVirtualizingPanelProp.StretchSingleChild v)
    let allowCollapseItems v : obj = box (CollapsedAccordionVirtualizingPanelProp.AllowCollapseItems v)
    let actualChildrenLength v : obj = box (CollapsedAccordionVirtualizingPanelProp.ActualChildrenLength v)

    let apply (el: DevExpress.Xpf.Accordion.Native.CollapsedAccordionVirtualizingPanel) (prop: CollapsedAccordionVirtualizingPanelProp) =
        match prop with
        | CollapsedAccordionVirtualizingPanelProp.StretchSingleChild v -> el.SetValue(DevExpress.Xpf.Accordion.Native.CollapsedAccordionVirtualizingPanel.StretchSingleChildProperty, box v)
        | CollapsedAccordionVirtualizingPanelProp.AllowCollapseItems v -> el.SetValue(DevExpress.Xpf.Accordion.Native.CollapsedAccordionVirtualizingPanel.AllowCollapseItemsProperty, box v)
        | CollapsedAccordionVirtualizingPanelProp.ActualChildrenLength v -> el.SetValue(DevExpress.Xpf.Accordion.Native.CollapsedAccordionVirtualizingPanel.ActualChildrenLengthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.Native.CollapsedAccordionVirtualizingPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
