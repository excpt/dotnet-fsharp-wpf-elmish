...
type DocumentPaneContentPresenterProp =
    | MDIStyle of DevExpress.Xpf.Docking.MDIStyle

module DocumentPaneContentPresenter =
    let mDIStyle v : obj = box (DocumentPaneContentPresenterProp.MDIStyle v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentPaneContentPresenter) (prop: DocumentPaneContentPresenterProp) =
        match prop with
        | DocumentPaneContentPresenterProp.MDIStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentPaneContentPresenter.MDIStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentPaneContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
