...
type WaitIndicatorProp =
    | DeferedVisibility of bool
    | ShowShadow of bool
    | ContentPadding of System.Windows.Thickness

module WaitIndicator =
    let deferedVisibility v : obj = box (WaitIndicatorProp.DeferedVisibility v)
    let showShadow v : obj = box (WaitIndicatorProp.ShowShadow v)
    let contentPadding v : obj = box (WaitIndicatorProp.ContentPadding v)

    let apply (el: DevExpress.Xpf.Core.WaitIndicator) (prop: WaitIndicatorProp) =
        match prop with
        | WaitIndicatorProp.DeferedVisibility v -> el.SetValue(DevExpress.Xpf.Core.WaitIndicator.DeferedVisibilityProperty, box v)
        | WaitIndicatorProp.ShowShadow v -> el.SetValue(DevExpress.Xpf.Core.WaitIndicator.ShowShadowProperty, box v)
        | WaitIndicatorProp.ContentPadding v -> el.SetValue(DevExpress.Xpf.Core.WaitIndicator.ContentPaddingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.WaitIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
