...
type AdditionalXYWSeriesPointGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalXYWSeriesPointGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalXYWSeriesPointGeometryContainer) (prop: AdditionalXYWSeriesPointGeometryContainerProp) =
        match prop with
        | AdditionalXYWSeriesPointGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalXYWSeriesPointGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
