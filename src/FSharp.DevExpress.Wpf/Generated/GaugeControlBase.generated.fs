...
type GaugeControlBaseProp =
    | EnableAnimation of bool

module GaugeControlBase =
    let enableAnimation v : obj = box (GaugeControlBaseProp.EnableAnimation v)

    let apply (el: DevExpress.Xpf.Gauges.GaugeControlBase) (prop: GaugeControlBaseProp) =
        match prop with
        | GaugeControlBaseProp.EnableAnimation v -> el.SetValue(DevExpress.Xpf.Gauges.GaugeControlBase.EnableAnimationProperty, box v)
