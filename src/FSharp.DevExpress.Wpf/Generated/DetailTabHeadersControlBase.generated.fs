...
type DetailTabHeadersControlBaseProp =
    | Base of DetailHeaderControlBaseProp

module DetailTabHeadersControlBase =

    let apply (el: DevExpress.Xpf.Grid.DetailTabHeadersControlBase) (prop: DetailTabHeadersControlBaseProp) =
        match prop with
        | DetailTabHeadersControlBaseProp.Base p -> DetailHeaderControlBase.apply el p
