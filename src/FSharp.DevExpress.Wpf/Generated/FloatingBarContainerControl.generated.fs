...
type FloatingBarContainerControlProp =
    | Base of BarContainerControlProp

module FloatingBarContainerControl =

    let apply (el: DevExpress.Xpf.Bars.FloatingBarContainerControl) (prop: FloatingBarContainerControlProp) =
        match prop with
        | FloatingBarContainerControlProp.Base p -> BarContainerControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.FloatingBarContainerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
