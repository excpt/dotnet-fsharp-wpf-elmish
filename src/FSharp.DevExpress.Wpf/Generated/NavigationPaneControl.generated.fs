...
type NavigationPaneControlProp =
    | NavigationPaneSettings of DevExpress.Xpf.Printing.NavigationPaneSettings
    | ActualDocument of DevExpress.Xpf.Printing.PreviewControl.Native.Models.DocumentViewModel

module NavigationPaneControl =
    let navigationPaneSettings v : obj = box (NavigationPaneControlProp.NavigationPaneSettings v)
    let actualDocument v : obj = box (NavigationPaneControlProp.ActualDocument v)

    let apply (el: DevExpress.Xpf.Printing.NavigationPaneControl) (prop: NavigationPaneControlProp) =
        match prop with
        | NavigationPaneControlProp.NavigationPaneSettings v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneControl.NavigationPaneSettingsProperty, box v)
        | NavigationPaneControlProp.ActualDocument v -> el.SetValue(DevExpress.Xpf.Printing.NavigationPaneControl.ActualDocumentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.NavigationPaneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
