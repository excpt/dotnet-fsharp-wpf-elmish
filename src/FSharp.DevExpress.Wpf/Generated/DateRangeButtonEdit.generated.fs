...
type DateRangeButtonEditProp =
    | Base of ButtonEditProp

module DateRangeButtonEdit =

    let apply (el: DevExpress.Xpf.Editors.DateRangeButtonEdit) (prop: DateRangeButtonEditProp) =
        match prop with
        | DateRangeButtonEditProp.Base p -> ButtonEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateRangeButtonEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
