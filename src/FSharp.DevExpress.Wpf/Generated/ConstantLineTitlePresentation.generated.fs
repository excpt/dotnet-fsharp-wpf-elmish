...
type ConstantLineTitlePresentationProp =
    | Base of AxisElementTitlePresentationProp

module ConstantLineTitlePresentation =

    let apply (el: DevExpress.Xpf.Charts.ConstantLineTitlePresentation) (prop: ConstantLineTitlePresentationProp) =
        match prop with
        | ConstantLineTitlePresentationProp.Base p -> AxisElementTitlePresentation.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ConstantLineTitlePresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
