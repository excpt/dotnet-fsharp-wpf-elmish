...
type BarButtonGroupItemsControlProp =
    | Base of LinksControlProp

module BarButtonGroupItemsControl =

    let apply (el: DevExpress.Xpf.Ribbon.BarButtonGroupItemsControl) (prop: BarButtonGroupItemsControlProp) =
        match prop with
        | BarButtonGroupItemsControlProp.Base p -> LinksControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BarButtonGroupItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
