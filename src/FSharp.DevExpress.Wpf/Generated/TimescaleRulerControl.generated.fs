...
type TimescaleRulerControlProp =
...
module TimescaleRulerControl =
    let textAlignment v : obj = box (TimescaleRulerControlProp.TextAlignment v)
    let startDate v : obj = box (TimescaleRulerControlProp.StartDate v)
    let textMargin v : obj = box (TimescaleRulerControlProp.TextMargin v)
    let timescale v : obj = box (TimescaleRulerControlProp.Timescale v)
    let showTicks v : obj = box (TimescaleRulerControlProp.ShowTicks v)
    let tickBrush v : obj = box (TimescaleRulerControlProp.TickBrush v)
    let tickWidth v : obj = box (TimescaleRulerControlProp.TickWidth v)
    let tickHeight v : obj = box (TimescaleRulerControlProp.TickHeight v)

    let apply (el: DevExpress.Xpf.Gantt.Native.TimescaleRulerControl) (prop: TimescaleRulerControlProp) =
        match prop with
        | TimescaleRulerControlProp.TextAlignment v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.TextAlignmentProperty, box v)
        | TimescaleRulerControlProp.StartDate v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.StartDateProperty, box v)
        | TimescaleRulerControlProp.TextMargin v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.TextMarginProperty, box v)
        | TimescaleRulerControlProp.Timescale v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.TimescaleProperty, box v)
        | TimescaleRulerControlProp.ShowTicks v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.ShowTicksProperty, box v)
        | TimescaleRulerControlProp.TickBrush v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.TickBrushProperty, box v)
        | TimescaleRulerControlProp.TickWidth v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.TickWidthProperty, box v)
        | TimescaleRulerControlProp.TickHeight v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerControl.TickHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.TimescaleRulerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
