...
type CircularFutureQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFutureQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFutureQuarterTopLeftModel) (prop: CircularFutureQuarterTopLeftModelProp) =
        match prop with
        | CircularFutureQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFutureQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
