...
type DiagramRulerScaleBaseProp =
    | Base of RulerScaleBaseProp

module DiagramRulerScaleBase =

    let apply (el: DevExpress.Xpf.Diagram.DiagramRulerScaleBase) (prop: DiagramRulerScaleBaseProp) =
        match prop with
        | DiagramRulerScaleBaseProp.Base p -> RulerScaleBase.apply el p
