...
type PropertyGridSearchControlProp =
    | Base of SearchControlProp

module PropertyGridSearchControl =

    let apply (el: DevExpress.Xpf.PropertyGrid.PropertyGridSearchControl) (prop: PropertyGridSearchControlProp) =
        match prop with
        | PropertyGridSearchControlProp.Base p -> SearchControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PropertyGridSearchControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
