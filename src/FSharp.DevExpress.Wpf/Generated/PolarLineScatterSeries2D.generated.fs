...
type PolarLineScatterSeries2DProp =
    | Base of CircularLineScatterSeries2DProp

module PolarLineScatterSeries2D =

    let apply (el: DevExpress.Xpf.Charts.PolarLineScatterSeries2D) (prop: PolarLineScatterSeries2DProp) =
        match prop with
        | PolarLineScatterSeries2DProp.Base p -> CircularLineScatterSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarLineScatterSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
