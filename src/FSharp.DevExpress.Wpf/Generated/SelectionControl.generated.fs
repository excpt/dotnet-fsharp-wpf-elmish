...
module SelectionControl =
    ...
    let apply (el: DevExpress.Xpf.Charts.SelectionControl) (prop: SelectionControlProp) =
        match prop with
        | SelectionControlProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Charts.SelectionControl.IsSelectedProperty, box v)
        | SelectionControlProp.IsHighlighted v -> el.SetValue(DevExpress.Xpf.Charts.SelectionControl.IsHighlightedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SelectionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
