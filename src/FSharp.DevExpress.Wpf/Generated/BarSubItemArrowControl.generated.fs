...
type BarSubItemArrowControlProp =
    | Base of ArrowControlProp

module BarSubItemArrowControl =

    let apply (el: DevExpress.Xpf.Bars.BarSubItemArrowControl) (prop: BarSubItemArrowControlProp) =
        match prop with
        | BarSubItemArrowControlProp.Base p -> ArrowControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarSubItemArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
