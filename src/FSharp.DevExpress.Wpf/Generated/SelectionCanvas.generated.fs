...
type SelectionCanvasProp =
    | SelectionRectangle of DevExpress.Xpf.Printing.PreviewControl.Native.SelectionRectangle

module SelectionCanvas =
    let selectionRectangle v : obj = box (SelectionCanvasProp.SelectionRectangle v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.SelectionCanvas) (prop: SelectionCanvasProp) =
        match prop with
        | SelectionCanvasProp.SelectionRectangle v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.SelectionCanvas.SelectionRectangleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.SelectionCanvas>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
