...
type EmptySankeyTextProp =
    | Base of SankeyTextElementProp

module EmptySankeyText =

    let apply (el: DevExpress.Xpf.Charts.Sankey.EmptySankeyText) (prop: EmptySankeyTextProp) =
        match prop with
        | EmptySankeyTextProp.Base p -> SankeyTextElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.EmptySankeyText>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
