...
type FlatLightGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatLightGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightGaugeBackgroundLayerControl) (prop: FlatLightGaugeBackgroundLayerControlProp) =
        match prop with
        | FlatLightGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
