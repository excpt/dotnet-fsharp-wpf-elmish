...
type FinancialSeries2DProp =
    | Base of XYSeries2DProp
    | LowValueDataMember of string
    | HighValueDataMember of string
    | OpenValueDataMember of string
    | CloseValueDataMember of string
    | ReductionOptions of DevExpress.Xpf.Charts.ReductionStockOptions
    | PointAnimation of DevExpress.Xpf.Charts.Stock2DAnimationBase

module FinancialSeries2D =
    let lowValueDataMember v : obj = box (FinancialSeries2DProp.LowValueDataMember v)
    let highValueDataMember v : obj = box (FinancialSeries2DProp.HighValueDataMember v)
    let openValueDataMember v : obj = box (FinancialSeries2DProp.OpenValueDataMember v)
    let closeValueDataMember v : obj = box (FinancialSeries2DProp.CloseValueDataMember v)
    let reductionOptions v : obj = box (FinancialSeries2DProp.ReductionOptions v)
    let pointAnimation v : obj = box (FinancialSeries2DProp.PointAnimation v)

    let apply (el: DevExpress.Xpf.Charts.FinancialSeries2D) (prop: FinancialSeries2DProp) =
        match prop with
        | FinancialSeries2DProp.Base p -> XYSeries2D.apply el p
        | FinancialSeries2DProp.LowValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.FinancialSeries2D.LowValueDataMemberProperty, box v)
        | FinancialSeries2DProp.HighValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.FinancialSeries2D.HighValueDataMemberProperty, box v)
        | FinancialSeries2DProp.OpenValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.FinancialSeries2D.OpenValueDataMemberProperty, box v)
        | FinancialSeries2DProp.CloseValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.FinancialSeries2D.CloseValueDataMemberProperty, box v)
        | FinancialSeries2DProp.ReductionOptions v -> el.SetValue(DevExpress.Xpf.Charts.FinancialSeries2D.ReductionOptionsProperty, box v)
        | FinancialSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.FinancialSeries2D.PointAnimationProperty, box v)
    ...
    let lowValue (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.FinancialSeries2D.LowValueProperty, box v)) :: node.Props }
    let highValue (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.FinancialSeries2D.HighValueProperty, box v)) :: node.Props }
    let openValue (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.FinancialSeries2D.OpenValueProperty, box v)) :: node.Props }
    let closeValue (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.FinancialSeries2D.CloseValueProperty, box v)) :: node.Props }
    let valueToDisplay (v: DevExpress.Xpf.Charts.StockLevel) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.FinancialSeries2D.ValueToDisplayProperty, box v)) :: node.Props }
