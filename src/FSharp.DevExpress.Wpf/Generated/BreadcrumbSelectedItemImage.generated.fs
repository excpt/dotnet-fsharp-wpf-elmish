...
type BreadcrumbSelectedItemImageProp =
    | Base of ClickableButtonProp
    | ImageSource of System.Windows.Media.ImageSource

module BreadcrumbSelectedItemImage =
    let imageSource v : obj = box (BreadcrumbSelectedItemImageProp.ImageSource v)

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbSelectedItemImage) (prop: BreadcrumbSelectedItemImageProp) =
        match prop with
        | BreadcrumbSelectedItemImageProp.Base p -> ClickableButton.apply el p
        | BreadcrumbSelectedItemImageProp.ImageSource v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbSelectedItemImage.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbSelectedItemImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
