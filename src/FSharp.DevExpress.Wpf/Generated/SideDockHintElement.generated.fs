...
open System
open System.Windows
open DevExpress.Xpf.Docking.Platform
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SideDockHintElementProp =
    | Base of DockHintElementProp
    | LeftTemplate of System.Windows.Controls.ControlTemplate
    | RightTemplate of System.Windows.Controls.ControlTemplate
    | TopTemplate of System.Windows.Controls.ControlTemplate
    | BottomTemplate of System.Windows.Controls.ControlTemplate

module SideDockHintElement =
    let leftTemplate v : obj = box (SideDockHintElementProp.LeftTemplate v)
    let rightTemplate v : obj = box (SideDockHintElementProp.RightTemplate v)
    let topTemplate v : obj = box (SideDockHintElementProp.TopTemplate v)
    let bottomTemplate v : obj = box (SideDockHintElementProp.BottomTemplate v)

    let apply (el: DevExpress.Xpf.Docking.Platform.SideDockHintElement) (prop: SideDockHintElementProp) =
        match prop with
        | SideDockHintElementProp.Base p -> DockHintElement.apply el p
        | SideDockHintElementProp.LeftTemplate v -> el.SetValue(DevExpress.Xpf.Docking.Platform.SideDockHintElement.LeftTemplateProperty, box v)
        | SideDockHintElementProp.RightTemplate v -> el.SetValue(DevExpress.Xpf.Docking.Platform.SideDockHintElement.RightTemplateProperty, box v)
        | SideDockHintElementProp.TopTemplate v -> el.SetValue(DevExpress.Xpf.Docking.Platform.SideDockHintElement.TopTemplateProperty, box v)
        | SideDockHintElementProp.BottomTemplate v -> el.SetValue(DevExpress.Xpf.Docking.Platform.SideDockHintElement.BottomTemplateProperty, box v)

    let showShadow v : obj = box (DockHintElementProp.ShowShadow v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.SideDockHintElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
