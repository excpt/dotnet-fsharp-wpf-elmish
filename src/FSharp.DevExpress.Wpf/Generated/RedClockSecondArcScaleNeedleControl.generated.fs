...
type RedClockSecondArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module RedClockSecondArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockSecondArcScaleNeedleControl) (prop: RedClockSecondArcScaleNeedleControlProp) =
        match prop with
        | RedClockSecondArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockSecondArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
