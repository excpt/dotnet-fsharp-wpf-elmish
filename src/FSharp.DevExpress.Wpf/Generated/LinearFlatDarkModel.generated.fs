...
type LinearFlatDarkModelProp =
    | Base of LinearGaugeModelProp

module LinearFlatDarkModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearFlatDarkModel) (prop: LinearFlatDarkModelProp) =
        match prop with
        | LinearFlatDarkModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearFlatDarkModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
