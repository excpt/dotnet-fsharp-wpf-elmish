...
type ArrowLeftStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowLeftStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowLeftStatePresentationControl) (prop: ArrowLeftStatePresentationControlProp) =
        match prop with
        | ArrowLeftStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowLeftStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
