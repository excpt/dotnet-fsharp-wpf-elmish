...
type psvSelectorItemProp =
    | Base of psvContentControlBaseProp
    | ViewStyle of DevExpress.Xpf.Docking.DockingViewStyle

module psvSelectorItem =
    let viewStyle v : obj = box (psvSelectorItemProp.ViewStyle v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.psvSelectorItem) (prop: psvSelectorItemProp) =
        match prop with
        | psvSelectorItemProp.Base p -> psvContentControlBase.apply el p
        | psvSelectorItemProp.ViewStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.psvSelectorItem.ViewStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.psvSelectorItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
