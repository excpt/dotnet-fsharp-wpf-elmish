...
type TileProp =
    ...
    | CalculatedBackground of System.Windows.Media.Brush
    | CalculatedHeaderVisibility of obj
    | PreviousContent of obj
    | AnimateContentChange of bool
    | Command of System.Windows.Input.ICommand
    | CommandParameter of obj
    | ContentChangeInterval of System.TimeSpan
    | ContentSource of System.Collections.IEnumerable
    | HorizontalHeaderAlignment of System.Windows.HorizontalAlignment
    | IsMaximized of bool
    | Size of DevExpress.Xpf.LayoutControl.TileSize
    | VerticalHeaderAlignment of System.Windows.VerticalAlignment

module Tile =
    let calculatedBackground v : obj = box (TileProp.CalculatedBackground v)
    let calculatedHeaderVisibility v : obj = box (TileProp.CalculatedHeaderVisibility v)
    let previousContent v : obj = box (TileProp.PreviousContent v)
    let animateContentChange v : obj = box (TileProp.AnimateContentChange v)
    let command v : obj = box (TileProp.Command v)
    let commandParameter v : obj = box (TileProp.CommandParameter v)
    let contentChangeInterval v : obj = box (TileProp.ContentChangeInterval v)
    let contentSource v : obj = box (TileProp.ContentSource v)
    let horizontalHeaderAlignment v : obj = box (TileProp.HorizontalHeaderAlignment v)
    let isMaximized v : obj = box (TileProp.IsMaximized v)
    let size v : obj = box (TileProp.Size v)
    let verticalHeaderAlignment v : obj = box (TileProp.VerticalHeaderAlignment v)

    let apply (el: DevExpress.Xpf.LayoutControl.Tile) (prop: TileProp) =
        match prop with
        | TileProp.Base p -> MaximizableHeaderedContentControlBase.apply el p
        | TileProp.CalculatedBackground v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.CalculatedBackgroundProperty, box v)
        | TileProp.CalculatedHeaderVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.CalculatedHeaderVisibilityProperty, box v)
        | TileProp.PreviousContent v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.PreviousContentProperty, box v)
        | TileProp.AnimateContentChange v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.AnimateContentChangeProperty, box v)
        | TileProp.Command v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.CommandProperty, box v)
        | TileProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.CommandParameterProperty, box v)
        | TileProp.ContentChangeInterval v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.ContentChangeIntervalProperty, box v)
        | TileProp.ContentSource v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.ContentSourceProperty, box v)
        | TileProp.HorizontalHeaderAlignment v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.HorizontalHeaderAlignmentProperty, box v)
        | TileProp.IsMaximized v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.IsMaximizedProperty, box v)
        | TileProp.Size v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.SizeProperty, box v)
        | TileProp.VerticalHeaderAlignment v -> el.SetValue(DevExpress.Xpf.LayoutControl.Tile.VerticalHeaderAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.Tile>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
