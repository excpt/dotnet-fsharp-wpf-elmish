...
type BarStackedSeries2DProp =
    | Base of BarSeries2DProp

module BarStackedSeries2D =

    let apply (el: DevExpress.Xpf.Charts.BarStackedSeries2D) (prop: BarStackedSeries2DProp) =
        match prop with
        | BarStackedSeries2DProp.Base p -> BarSeries2D.apply el p
    ...
    let totalLabel (v: DevExpress.Xpf.Charts.StackedBarTotalLabel) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BarStackedSeries2D.TotalLabelProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.BarStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
