...
type HiddenItemContextMenuProp =
    | Base of ItemContextMenuBaseProp

module HiddenItemContextMenu =

    let apply (el: DevExpress.Xpf.Docking.HiddenItemContextMenu) (prop: HiddenItemContextMenuProp) =
        match prop with
        | HiddenItemContextMenuProp.Base p -> ItemContextMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.HiddenItemContextMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
