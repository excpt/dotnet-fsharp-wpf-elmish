...
open System
open System.Windows
open DevExpress.Mvvm.UI.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ToastContentControlProp =
    | Command of System.Windows.Input.ICommand
    | TimerPaused of bool

module ToastContentControl =
    let command v : obj = box (ToastContentControlProp.Command v)
    let timerPaused v : obj = box (ToastContentControlProp.TimerPaused v)

    let apply (el: DevExpress.Mvvm.UI.Native.ToastContentControl) (prop: ToastContentControlProp) =
        match prop with
        | ToastContentControlProp.Command v -> el.SetValue(DevExpress.Mvvm.UI.Native.ToastContentControl.CommandProperty, box v)
        | ToastContentControlProp.TimerPaused v -> el.SetValue(DevExpress.Mvvm.UI.Native.ToastContentControl.TimerPausedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Mvvm.UI.Native.ToastContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
