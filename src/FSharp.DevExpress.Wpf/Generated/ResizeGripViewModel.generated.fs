...
type ResizeGripViewModelProp =
    | Base of EditorViewModelBaseProp
    | IsDown of bool

module ResizeGripViewModel =
    let isDown v : obj = box (ResizeGripViewModelProp.IsDown v)

    let apply (el: DevExpress.Xpf.Editors.ResizeGripViewModel) (prop: ResizeGripViewModelProp) =
        match prop with
        | ResizeGripViewModelProp.Base p -> EditorViewModelBase.apply el p
        | ResizeGripViewModelProp.IsDown v -> el.SetValue(DevExpress.Xpf.Editors.ResizeGripViewModel.IsDownProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ResizeGripViewModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
