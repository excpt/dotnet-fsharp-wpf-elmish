...
type PopupListBoxProp =
    | Base of EditorListBoxProp

module PopupListBox =

    let apply (el: DevExpress.Xpf.Editors.Popups.PopupListBox) (prop: PopupListBoxProp) =
        match prop with
        | PopupListBoxProp.Base p -> EditorListBox.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.PopupListBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
