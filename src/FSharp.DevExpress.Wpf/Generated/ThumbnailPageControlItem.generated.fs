...
type ThumbnailPageControlItemProp =
    | Base of PageControlItemProp

module ThumbnailPageControlItem =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailPageControlItem) (prop: ThumbnailPageControlItemProp) =
        match prop with
        | ThumbnailPageControlItemProp.Base p -> PageControlItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailPageControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
