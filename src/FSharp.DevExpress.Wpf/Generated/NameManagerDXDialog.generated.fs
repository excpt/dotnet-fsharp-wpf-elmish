...
type NameManagerDXDialogProp =
    | Base of ModelessDXDialogProp

module NameManagerDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.NameManagerDXDialog) (prop: NameManagerDXDialogProp) =
        match prop with
        | NameManagerDXDialogProp.Base p -> ModelessDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.NameManagerDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
