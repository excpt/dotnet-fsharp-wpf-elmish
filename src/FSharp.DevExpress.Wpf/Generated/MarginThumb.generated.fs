...
type MarginThumbProp =
    | PageMargin of DevExpress.Xpf.Printing.PreviewControl.Native.PageMarginModel
    | SetPageMarginCommand of System.Windows.Input.ICommand
    | Orientation of System.Windows.Controls.Orientation

module MarginThumb =
    let pageMargin v : obj = box (MarginThumbProp.PageMargin v)
    let setPageMarginCommand v : obj = box (MarginThumbProp.SetPageMarginCommand v)
    let orientation v : obj = box (MarginThumbProp.Orientation v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.MarginThumb) (prop: MarginThumbProp) =
        match prop with
        | MarginThumbProp.PageMargin v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.MarginThumb.PageMarginProperty, box v)
        | MarginThumbProp.SetPageMarginCommand v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.MarginThumb.SetPageMarginCommandProperty, box v)
        | MarginThumbProp.Orientation v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.MarginThumb.OrientationProperty, box v)

    let isDragging v : obj = box (ThumbProp.IsDragging v)
    ...
    let onDragStarted v : obj = box (EventProp(box (ThumbProp.OnDragStarted v)))
    let onDragDelta v : obj = box (EventProp(box (ThumbProp.OnDragDelta v)))
    let onDragCompleted v : obj = box (EventProp(box (ThumbProp.OnDragCompleted v)))
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.MarginThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
