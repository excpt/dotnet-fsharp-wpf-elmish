...
type TextEditStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp

module TextEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.TextEditStyleSettings) (prop: TextEditStyleSettingsProp) =
        match prop with
        | TextEditStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TextEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
