...
type DigitalEcoModelProp =
    | Base of DigitalGaugeModelProp

module DigitalEcoModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalEcoModel) (prop: DigitalEcoModelProp) =
        match prop with
        | DigitalEcoModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalEcoModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
