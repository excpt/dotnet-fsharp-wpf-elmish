...
type CircularDefaultModelProp =
    | Base of CircularGaugeModelProp

module CircularDefaultModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularDefaultModel) (prop: CircularDefaultModelProp) =
        match prop with
        | CircularDefaultModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularDefaultModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
