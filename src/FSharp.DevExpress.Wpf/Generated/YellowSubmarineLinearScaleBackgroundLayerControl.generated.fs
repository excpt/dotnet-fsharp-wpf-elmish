...
type YellowSubmarineLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleBackgroundLayerControl) (prop: YellowSubmarineLinearScaleBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
