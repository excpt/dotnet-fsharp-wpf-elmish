...
type SuperTipControlProp =
    | SuperTip of DevExpress.Xpf.Core.SuperTip

module SuperTipControl =
    let superTip v : obj = box (SuperTipControlProp.SuperTip v)

    let apply (el: DevExpress.Xpf.Core.SuperTipControl) (prop: SuperTipControlProp) =
        match prop with
        | SuperTipControlProp.SuperTip v -> el.SetValue(DevExpress.Xpf.Core.SuperTipControl.SuperTipProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SuperTipControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
