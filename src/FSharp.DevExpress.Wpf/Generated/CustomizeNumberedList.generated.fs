...
type CustomizeNumberedListProp =
    | Base of ThemedWindowProp

module CustomizeNumberedList =

    let apply (el: DevExpress.Xpf.RichEdit.View.CustomizeNumberedList) (prop: CustomizeNumberedListProp) =
        match prop with
        | CustomizeNumberedListProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.CustomizeNumberedList>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
