...
open System
open System.Windows
open DevExpress.Xpf.Editors.Popups.Calendar
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DateEditCalendarProp =
    | Base of DateEditCalendarBaseProp
    | WeekdayAbbreviationStyle of System.Windows.Style
    | WeekNumbersStyle of System.Windows.Style
    ...
    | YearsGroupInfoTemplate of System.Windows.Controls.ControlTemplate
    | CalendarTransferStyle of System.Windows.Style
    | Calendar of DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar

module DateEditCalendar =
    let weekdayAbbreviationStyle v : obj = box (DateEditCalendarProp.WeekdayAbbreviationStyle v)
    let weekNumbersStyle v : obj = box (DateEditCalendarProp.WeekNumbersStyle v)
    let cellButtonStyle v : obj = box (DateEditCalendarProp.CellButtonStyle v)
    let monthInfoTemplate v : obj = box (DateEditCalendarProp.MonthInfoTemplate v)
    let yearInfoTemplate v : obj = box (DateEditCalendarProp.YearInfoTemplate v)
    let yearsInfoTemplate v : obj = box (DateEditCalendarProp.YearsInfoTemplate v)
    let yearsGroupInfoTemplate v : obj = box (DateEditCalendarProp.YearsGroupInfoTemplate v)
    let calendarTransferStyle v : obj = box (DateEditCalendarProp.CalendarTransferStyle v)
    let calendar v : obj = box (DateEditCalendarProp.Calendar v)

    let apply (el: DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar) (prop: DateEditCalendarProp) =
        match prop with
        | DateEditCalendarProp.Base p -> DateEditCalendarBase.apply el p
        | DateEditCalendarProp.WeekdayAbbreviationStyle v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.WeekdayAbbreviationStyleProperty, box v)
        | DateEditCalendarProp.WeekNumbersStyle v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.WeekNumbersStyleProperty, box v)
        | DateEditCalendarProp.CellButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.CellButtonStyleProperty, box v)
        | DateEditCalendarProp.MonthInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.MonthInfoTemplateProperty, box v)
        | DateEditCalendarProp.YearInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.YearInfoTemplateProperty, box v)
        | DateEditCalendarProp.YearsInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.YearsInfoTemplateProperty, box v)
        | DateEditCalendarProp.YearsGroupInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.YearsGroupInfoTemplateProperty, box v)
        | DateEditCalendarProp.CalendarTransferStyle v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.CalendarTransferStyleProperty, box v)
        | DateEditCalendarProp.Calendar v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.CalendarProperty, box v)

    let showWeekNumbers v : obj = box (DateEditCalendarBaseProp.ShowWeekNumbers v)
    let showClearButton v : obj = box (DateEditCalendarBaseProp.ShowClearButton v)
    let showToday v : obj = box (DateEditCalendarBaseProp.ShowToday v)
    let mask v : obj = box (DateEditCalendarBaseProp.Mask v)
    let maskCulture v : obj = box (DateEditCalendarBaseProp.MaskCulture v)
    ...
    let cellInactive (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.CellInactiveProperty, box v)) :: node.Props }
    let cellToday (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.CellTodayProperty, box v)) :: node.Props }
    let cellFocused (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar.CellFocusedProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
