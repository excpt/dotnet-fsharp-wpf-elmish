...
type AppBarBackButtonProp =
    | Base of AppBarButtonProp

module AppBarBackButton =

    let apply (el: DevExpress.Xpf.WindowsUI.AppBarBackButton) (prop: AppBarBackButtonProp) =
        match prop with
        | AppBarBackButtonProp.Base p -> AppBarButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.AppBarBackButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
