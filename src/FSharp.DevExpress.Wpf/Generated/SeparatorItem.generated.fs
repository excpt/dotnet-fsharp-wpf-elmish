...
type SeparatorItemProp =
    | Base of FixedItemProp

module SeparatorItem =

    let apply (el: DevExpress.Xpf.Docking.SeparatorItem) (prop: SeparatorItemProp) =
        match prop with
        | SeparatorItemProp.Base p -> FixedItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.SeparatorItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
