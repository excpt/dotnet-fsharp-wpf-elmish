...
type GroupBoxControlBoxButtonProp =
    | Base of ControlBoxButtonProp
    | IsExpanded of bool

module GroupBoxControlBoxButton =
    let isExpanded v : obj = box (GroupBoxControlBoxButtonProp.IsExpanded v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.GroupBoxControlBoxButton) (prop: GroupBoxControlBoxButtonProp) =
        match prop with
        | GroupBoxControlBoxButtonProp.Base p -> ControlBoxButton.apply el p
        | GroupBoxControlBoxButtonProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.GroupBoxControlBoxButton.IsExpandedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.GroupBoxControlBoxButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
