...
type ConnectorArrowPresenterProp =
    | Base of ShapeGeometryPresenterProp
    | ArrowStyle of obj

module ConnectorArrowPresenter =
    let arrowStyle v : obj = box (ConnectorArrowPresenterProp.ArrowStyle v)

    let apply (el: DevExpress.Xpf.Diagram.Native.ConnectorArrowPresenter) (prop: ConnectorArrowPresenterProp) =
        match prop with
        | ConnectorArrowPresenterProp.Base p -> ShapeGeometryPresenter.apply el p
        | ConnectorArrowPresenterProp.ArrowStyle v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ConnectorArrowPresenter.ArrowStyleProperty, box v)

    let stroke v : obj = box (ShapeGeometryPresenterProp.Stroke v)
    let strokeThickness v : obj = box (ShapeGeometryPresenterProp.StrokeThickness v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.ConnectorArrowPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
