...
type HorizontalTableHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module HorizontalTableHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalTableHotZoneControl) (prop: HorizontalTableHotZoneControlProp) =
        match prop with
        | HorizontalTableHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalTableHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
