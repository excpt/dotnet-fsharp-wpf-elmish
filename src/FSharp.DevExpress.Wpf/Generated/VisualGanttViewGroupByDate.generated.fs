...
type VisualGanttViewGroupByDateProp =
    | Base of VisualTimelineViewGroupBaseProp

module VisualGanttViewGroupByDate =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualGanttViewGroupByDate) (prop: VisualGanttViewGroupByDateProp) =
        match prop with
        | VisualGanttViewGroupByDateProp.Base p -> VisualTimelineViewGroupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualGanttViewGroupByDate>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
