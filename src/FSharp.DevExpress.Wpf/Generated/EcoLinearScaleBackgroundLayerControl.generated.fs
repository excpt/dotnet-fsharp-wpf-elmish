...
type EcoLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoLinearScaleBackgroundLayerControl) (prop: EcoLinearScaleBackgroundLayerControlProp) =
        match prop with
        | EcoLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
