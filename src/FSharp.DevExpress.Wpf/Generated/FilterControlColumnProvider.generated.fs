...
type FilterControlColumnProviderProp =
...
module FilterControlColumnProvider =
    let hiddenProperties v : obj = box (FilterControlColumnProviderProp.HiddenProperties v)
    let upperCaseNames v : obj = box (FilterControlColumnProviderProp.UpperCaseNames v)
    let additionalProperties v : obj = box (FilterControlColumnProviderProp.AdditionalProperties v)
    let itemsSourceType v : obj = box (FilterControlColumnProviderProp.ItemsSourceType v)
    let sourceControl v : obj = box (FilterControlColumnProviderProp.SourceControl v)

    let apply (el: DevExpress.Xpf.Editors.FilterControlColumnProvider) (prop: FilterControlColumnProviderProp) =
        match prop with
        | FilterControlColumnProviderProp.HiddenProperties v -> el.SetValue(DevExpress.Xpf.Editors.FilterControlColumnProvider.HiddenPropertiesProperty, box v)
        | FilterControlColumnProviderProp.UpperCaseNames v -> el.SetValue(DevExpress.Xpf.Editors.FilterControlColumnProvider.UpperCasePropertyNamesProperty, box v)
        | FilterControlColumnProviderProp.AdditionalProperties v -> el.SetValue(DevExpress.Xpf.Editors.FilterControlColumnProvider.AdditionalPropertiesProperty, box v)
        | FilterControlColumnProviderProp.ItemsSourceType v -> el.SetValue(DevExpress.Xpf.Editors.FilterControlColumnProvider.ItemsSourceTypeProperty, box v)
        | FilterControlColumnProviderProp.SourceControl v -> el.SetValue(DevExpress.Xpf.Editors.FilterControlColumnProvider.SourceControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.FilterControlColumnProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
