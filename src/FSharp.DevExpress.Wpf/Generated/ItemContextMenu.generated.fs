...
type ItemContextMenuProp =
    | Base of ItemContextMenuBaseProp

module ItemContextMenu =

    let apply (el: DevExpress.Xpf.Docking.ItemContextMenu) (prop: ItemContextMenuProp) =
        match prop with
        | ItemContextMenuProp.Base p -> ItemContextMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.ItemContextMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
