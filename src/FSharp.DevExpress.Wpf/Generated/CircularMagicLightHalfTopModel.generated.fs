...
type CircularMagicLightHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularMagicLightHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularMagicLightHalfTopModel) (prop: CircularMagicLightHalfTopModelProp) =
        match prop with
        | CircularMagicLightHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularMagicLightHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
