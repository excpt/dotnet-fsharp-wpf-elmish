...
type MediaButtonProp =
    | MediaManager of DevExpress.Xpf.Controls.MediaManager

module MediaButton =
    let mediaManager v : obj = box (MediaButtonProp.MediaManager v)

    let apply (el: DevExpress.Xpf.Controls.MediaButton) (prop: MediaButtonProp) =
        match prop with
        | MediaButtonProp.MediaManager v -> el.SetValue(DevExpress.Xpf.Controls.MediaButton.MediaManagerProperty, box v)
