...
type DefaultLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module DefaultLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleMarkerControl) (prop: DefaultLinearScaleMarkerControlProp) =
        match prop with
        | DefaultLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
