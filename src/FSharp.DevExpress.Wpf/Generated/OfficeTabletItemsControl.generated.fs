...
type OfficeTabletItemsControlProp =
    | AddRemoveAnimationAccelerationRatio of float
    | AddRemoveAnimationDecelerationRation of float
    | AddRemoveAnimationDuration of System.Windows.Duration
    | BackCommand of System.Windows.Input.ICommand
    | BackCommandText of obj
    | Caption of obj
    | SizeAnimationAccelerationRatio of float
    | SizeAnimationBeginTime of System.TimeSpan
    | SizeAnimationDecelerationRation of float
    | SizeAnimationDuration of System.Windows.Duration

module OfficeTabletItemsControl =
    let addRemoveAnimationAccelerationRatio v : obj = box (OfficeTabletItemsControlProp.AddRemoveAnimationAccelerationRatio v)
    let addRemoveAnimationDecelerationRation v : obj = box (OfficeTabletItemsControlProp.AddRemoveAnimationDecelerationRation v)
    let addRemoveAnimationDuration v : obj = box (OfficeTabletItemsControlProp.AddRemoveAnimationDuration v)
    let backCommand v : obj = box (OfficeTabletItemsControlProp.BackCommand v)
    let backCommandText v : obj = box (OfficeTabletItemsControlProp.BackCommandText v)
    let caption v : obj = box (OfficeTabletItemsControlProp.Caption v)
    let sizeAnimationAccelerationRatio v : obj = box (OfficeTabletItemsControlProp.SizeAnimationAccelerationRatio v)
    let sizeAnimationBeginTime v : obj = box (OfficeTabletItemsControlProp.SizeAnimationBeginTime v)
    let sizeAnimationDecelerationRation v : obj = box (OfficeTabletItemsControlProp.SizeAnimationDecelerationRation v)
    let sizeAnimationDuration v : obj = box (OfficeTabletItemsControlProp.SizeAnimationDuration v)

    let apply (el: DevExpress.Xpf.Bars.OfficeTabletItemsControl) (prop: OfficeTabletItemsControlProp) =
        match prop with
        | OfficeTabletItemsControlProp.AddRemoveAnimationAccelerationRatio v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.AddRemoveAnimationAccelerationRatioProperty, box v)
        | OfficeTabletItemsControlProp.AddRemoveAnimationDecelerationRation v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.AddRemoveAnimationDecelerationRationProperty, box v)
        | OfficeTabletItemsControlProp.AddRemoveAnimationDuration v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.AddRemoveAnimationDurationProperty, box v)
        | OfficeTabletItemsControlProp.BackCommand v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.BackCommandProperty, box v)
        | OfficeTabletItemsControlProp.BackCommandText v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.BackCommandTextProperty, box v)
        | OfficeTabletItemsControlProp.Caption v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.CaptionProperty, box v)
        | OfficeTabletItemsControlProp.SizeAnimationAccelerationRatio v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.SizeAnimationAccelerationRatioProperty, box v)
        | OfficeTabletItemsControlProp.SizeAnimationBeginTime v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.SizeAnimationBeginTimeProperty, box v)
        | OfficeTabletItemsControlProp.SizeAnimationDecelerationRation v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.SizeAnimationDecelerationRationProperty, box v)
        | OfficeTabletItemsControlProp.SizeAnimationDuration v -> el.SetValue(DevExpress.Xpf.Bars.OfficeTabletItemsControl.SizeAnimationDurationProperty, box v)
    ...
    let sizeAnimationInProgress (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Bars.OfficeTabletItemsControl.SizeAnimationInProgressProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Bars.OfficeTabletItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
