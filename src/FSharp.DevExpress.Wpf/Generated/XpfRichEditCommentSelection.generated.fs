...
type XpfRichEditCommentSelectionProp =
    | Base of XpfRichEditSelectionProp

module XpfRichEditCommentSelection =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditCommentSelection) (prop: XpfRichEditCommentSelectionProp) =
        match prop with
        | XpfRichEditCommentSelectionProp.Base p -> XpfRichEditSelection.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditCommentSelection>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
