...
type DXSchedulerThemesLoaderProp =
    | Base of DXThemesLoaderBaseProp

module DXSchedulerThemesLoader =

    let apply (el: DevExpress.Xpf.Scheduler.DXSchedulerThemesLoader) (prop: DXSchedulerThemesLoaderProp) =
        match prop with
        | DXSchedulerThemesLoaderProp.Base p -> DXThemesLoaderBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.DXSchedulerThemesLoader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
