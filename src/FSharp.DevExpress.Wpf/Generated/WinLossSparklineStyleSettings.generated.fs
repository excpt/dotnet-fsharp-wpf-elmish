...
type WinLossSparklineStyleSettingsProp =
    | Base of SparklineStyleSettingsProp
    | BarDistance of int

module WinLossSparklineStyleSettings =
    let barDistance v : obj = box (WinLossSparklineStyleSettingsProp.BarDistance v)

    let apply (el: DevExpress.Xpf.Editors.WinLossSparklineStyleSettings) (prop: WinLossSparklineStyleSettingsProp) =
        match prop with
        | WinLossSparklineStyleSettingsProp.Base p -> SparklineStyleSettings.apply el p
        | WinLossSparklineStyleSettingsProp.BarDistance v -> el.SetValue(DevExpress.Xpf.Editors.WinLossSparklineStyleSettings.BarDistanceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.WinLossSparklineStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
