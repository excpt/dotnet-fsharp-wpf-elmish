...
type EcoArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoArcScaleBackgroundLayerControl) (prop: EcoArcScaleBackgroundLayerControlProp) =
        match prop with
        | EcoArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
