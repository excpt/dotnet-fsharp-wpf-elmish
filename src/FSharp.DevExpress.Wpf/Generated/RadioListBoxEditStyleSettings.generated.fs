...
type RadioListBoxEditStyleSettingsProp =
    | Base of BaseListBoxEditStyleSettingsProp
    | ShowEmptyItem of bool
    | EmptyItemText of string

module RadioListBoxEditStyleSettings =
    let showEmptyItem v : obj = box (RadioListBoxEditStyleSettingsProp.ShowEmptyItem v)
    let emptyItemText v : obj = box (RadioListBoxEditStyleSettingsProp.EmptyItemText v)

    let apply (el: DevExpress.Xpf.Editors.RadioListBoxEditStyleSettings) (prop: RadioListBoxEditStyleSettingsProp) =
        match prop with
        | RadioListBoxEditStyleSettingsProp.Base p -> BaseListBoxEditStyleSettings.apply el p
        | RadioListBoxEditStyleSettingsProp.ShowEmptyItem v -> el.SetValue(DevExpress.Xpf.Editors.RadioListBoxEditStyleSettings.ShowEmptyItemProperty, box v)
        | RadioListBoxEditStyleSettingsProp.EmptyItemText v -> el.SetValue(DevExpress.Xpf.Editors.RadioListBoxEditStyleSettings.EmptyItemTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RadioListBoxEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
