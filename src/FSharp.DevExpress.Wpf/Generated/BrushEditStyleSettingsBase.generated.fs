...
type BrushEditStyleSettingsBaseProp =
    | Base of BaseEditStyleSettingsProp

module BrushEditStyleSettingsBase =

    let apply (el: DevExpress.Xpf.Editors.BrushEditStyleSettingsBase) (prop: BrushEditStyleSettingsBaseProp) =
        match prop with
        | BrushEditStyleSettingsBaseProp.Base p -> BaseEditStyleSettings.apply el p
