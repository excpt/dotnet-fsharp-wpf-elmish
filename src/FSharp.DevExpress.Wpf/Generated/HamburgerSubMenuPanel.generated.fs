...
type HamburgerSubMenuPanelProp =
    | Base of ItemsSourcePanelProp

module HamburgerSubMenuPanel =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPanel) (prop: HamburgerSubMenuPanelProp) =
        match prop with
        | HamburgerSubMenuPanelProp.Base p -> ItemsSourcePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
