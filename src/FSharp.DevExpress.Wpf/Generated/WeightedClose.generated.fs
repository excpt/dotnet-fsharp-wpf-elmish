...
type WeightedCloseProp =
    | Base of IndicatorProp

module WeightedClose =

    let apply (el: DevExpress.Xpf.Charts.WeightedClose) (prop: WeightedCloseProp) =
        match prop with
        | WeightedCloseProp.Base p -> Indicator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.WeightedClose>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
