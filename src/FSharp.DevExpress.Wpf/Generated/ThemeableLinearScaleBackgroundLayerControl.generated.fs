...
type ThemeableLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableLinearScaleBackgroundLayerControl =
    let themeFill v : obj = box (ThemeableLinearScaleBackgroundLayerControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableLinearScaleBackgroundLayerControl) (prop: ThemeableLinearScaleBackgroundLayerControlProp) =
        match prop with
        | ThemeableLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
        | ThemeableLinearScaleBackgroundLayerControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableLinearScaleBackgroundLayerControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
