...
type DXMultiTriggerInfoProp =
    | Base of DXTriggerInfoBaseProp

module DXMultiTriggerInfo =

    let apply (el: DevExpress.Xpf.Core.Native.DXMultiTriggerInfo) (prop: DXMultiTriggerInfoProp) =
        match prop with
        | DXMultiTriggerInfoProp.Base p -> DXTriggerInfoBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DXMultiTriggerInfo>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
