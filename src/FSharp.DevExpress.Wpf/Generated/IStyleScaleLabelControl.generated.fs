...
type IStyleScaleLabelControlProp =
    | Base of PresentationControlProp

module IStyleScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleScaleLabelControl) (prop: IStyleScaleLabelControlProp) =
        match prop with
        | IStyleScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
