...
type SlideViewItemsPanelProp =
    | Base of SplitPanelProp

module SlideViewItemsPanel =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.SlideViewItemsPanel) (prop: SlideViewItemsPanelProp) =
        match prop with
        | SlideViewItemsPanelProp.Base p -> SplitPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.SlideViewItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
