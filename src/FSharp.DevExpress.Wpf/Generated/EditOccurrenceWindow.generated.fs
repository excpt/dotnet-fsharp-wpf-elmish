...
type EditOccurrenceWindowProp =
    | Base of ThemedWindowProp

module EditOccurrenceWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.EditOccurrenceWindow) (prop: EditOccurrenceWindowProp) =
        match prop with
        | EditOccurrenceWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.EditOccurrenceWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
