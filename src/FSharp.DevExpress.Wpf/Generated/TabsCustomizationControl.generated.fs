...
open System
open System.Windows
open DevExpress.Xpf.Ribbon.Customization
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TabsCustomizationControlProp =
    | Base of BaseTabsCustomizationControlProp
    | LeftElement of DevExpress.Xpf.Ribbon.ElementWrapper
    | LeftSource of System.Collections.IEnumerable
    | LeftTabsMode of int
    | Ribbon of DevExpress.Xpf.Ribbon.RibbonControl
    | RibbonWrapper of DevExpress.Xpf.Ribbon.RibbonElementWrapper
    | RightElement of DevExpress.Xpf.Ribbon.ElementWrapper
    | RightTabsMode of int

module TabsCustomizationControl =
    let leftElement v : obj = box (TabsCustomizationControlProp.LeftElement v)
    let leftSource v : obj = box (TabsCustomizationControlProp.LeftSource v)
    let leftTabsMode v : obj = box (TabsCustomizationControlProp.LeftTabsMode v)
    let ribbon v : obj = box (TabsCustomizationControlProp.Ribbon v)
    let ribbonWrapper v : obj = box (TabsCustomizationControlProp.RibbonWrapper v)
    let rightElement v : obj = box (TabsCustomizationControlProp.RightElement v)
    let rightTabsMode v : obj = box (TabsCustomizationControlProp.RightTabsMode v)

    let apply (el: DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl) (prop: TabsCustomizationControlProp) =
        match prop with
        | TabsCustomizationControlProp.Base p -> BaseTabsCustomizationControl.apply el p
        | TabsCustomizationControlProp.LeftElement v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.LeftElementProperty, box v)
        | TabsCustomizationControlProp.LeftSource v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.LeftSourceProperty, box v)
        | TabsCustomizationControlProp.LeftTabsMode v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.LeftTabsModeProperty, box v)
        | TabsCustomizationControlProp.Ribbon v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.RibbonProperty, box v)
        | TabsCustomizationControlProp.RibbonWrapper v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.RibbonWrapperProperty, box v)
        | TabsCustomizationControlProp.RightElement v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.RightElementProperty, box v)
        | TabsCustomizationControlProp.RightTabsMode v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl.RightTabsModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Customization.TabsCustomizationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
