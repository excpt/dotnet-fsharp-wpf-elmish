...
type MagicLightArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightArcScaleForegroundLayerControl) (prop: MagicLightArcScaleForegroundLayerControlProp) =
        match prop with
        | MagicLightArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
