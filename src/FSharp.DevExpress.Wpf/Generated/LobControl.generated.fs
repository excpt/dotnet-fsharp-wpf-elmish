...
type LobControlProp =
    | Header of System.Windows.Controls.Label
    | HeaderSizeGroup of DevExpress.Xpf.Printing.Native.SharedSizeGroup

module LobControl =
    let header v : obj = box (LobControlProp.Header v)
    let headerSizeGroup v : obj = box (LobControlProp.HeaderSizeGroup v)

    let apply (el: DevExpress.Xpf.Printing.Native.LobControl) (prop: LobControlProp) =
        match prop with
        | LobControlProp.Header v -> el.SetValue(DevExpress.Xpf.Printing.Native.LobControl.HeaderProperty, box v)
        | LobControlProp.HeaderSizeGroup v -> el.SetValue(DevExpress.Xpf.Printing.Native.LobControl.HeaderSizeGroupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.LobControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
