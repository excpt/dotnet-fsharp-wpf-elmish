...
type GaugeControlDecoratorProp =
    | ViewType of DevExpress.DashboardWpf.Internal.GaugeViewType

module GaugeControlDecorator =
    let viewType v : obj = box (GaugeControlDecoratorProp.ViewType v)

    let apply (el: DevExpress.DashboardWpf.Internal.GaugeControlDecorator) (prop: GaugeControlDecoratorProp) =
        match prop with
        | GaugeControlDecoratorProp.ViewType v -> el.SetValue(DevExpress.DashboardWpf.Internal.GaugeControlDecorator.ViewTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.GaugeControlDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
