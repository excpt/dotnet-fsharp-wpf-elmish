...
type BarCodePropertyProviderProp =
    | Base of ActualPropertyProviderProp
    | CalcCheckSum of bool
    | StartStopPair of DevExpress.XtraPrinting.BarCode.CodabarStartStopPair
    | WideNarrowRatio of float32
    | CharacterSet of DevExpress.XtraPrinting.BarCode.Code128Charset
    | MSICheckSum of DevExpress.XtraPrinting.BarCode.MSICheckSum
    | FNC1Substitute of string
    | FNC2Substitute of string
    | FNC3Substitute of string
    | FNC4Substitute of string
    | HumanReadableText of bool
    | Columns of int
    | PDF417CompactionMode of DevExpress.XtraPrinting.BarCode.PDF417CompactionMode
    | DataMatrixCompactionMode of DevExpress.XtraPrinting.BarCode.DataMatrixCompactionMode
    | QRCodeCompactionMode of DevExpress.XtraPrinting.BarCode.QRCodeCompactionMode
    | PDF417ErrorCorrectionLevel of DevExpress.XtraPrinting.BarCode.ErrorCorrectionLevel
    | QRCodeErrorCorrectionLevel of DevExpress.XtraPrinting.BarCode.QRCodeErrorCorrectionLevel
    | Rows of int
    | TruncateSymbol of bool
    | YToXRatio of float32
    | MatrixSize of DevExpress.XtraPrinting.BarCode.DataMatrixSize
    | Version of DevExpress.XtraPrinting.BarCode.QRCodeVersion
    | SegmentsInRow of int
    | Type of DevExpress.XtraPrinting.BarCode.DataBarType

module BarCodePropertyProvider =
    let calcCheckSum v : obj = box (BarCodePropertyProviderProp.CalcCheckSum v)
    let startStopPair v : obj = box (BarCodePropertyProviderProp.StartStopPair v)
    let wideNarrowRatio v : obj = box (BarCodePropertyProviderProp.WideNarrowRatio v)
    let characterSet v : obj = box (BarCodePropertyProviderProp.CharacterSet v)
    let mSICheckSum v : obj = box (BarCodePropertyProviderProp.MSICheckSum v)
    let fNC1Substitute v : obj = box (BarCodePropertyProviderProp.FNC1Substitute v)
    let fNC2Substitute v : obj = box (BarCodePropertyProviderProp.FNC2Substitute v)
    let fNC3Substitute v : obj = box (BarCodePropertyProviderProp.FNC3Substitute v)
    let fNC4Substitute v : obj = box (BarCodePropertyProviderProp.FNC4Substitute v)
    let humanReadableText v : obj = box (BarCodePropertyProviderProp.HumanReadableText v)
    let columns v : obj = box (BarCodePropertyProviderProp.Columns v)
    let pDF417CompactionMode v : obj = box (BarCodePropertyProviderProp.PDF417CompactionMode v)
    let dataMatrixCompactionMode v : obj = box (BarCodePropertyProviderProp.DataMatrixCompactionMode v)
    let qRCodeCompactionMode v : obj = box (BarCodePropertyProviderProp.QRCodeCompactionMode v)
    let pDF417ErrorCorrectionLevel v : obj = box (BarCodePropertyProviderProp.PDF417ErrorCorrectionLevel v)
    let qRCodeErrorCorrectionLevel v : obj = box (BarCodePropertyProviderProp.QRCodeErrorCorrectionLevel v)
    let rows v : obj = box (BarCodePropertyProviderProp.Rows v)
    let truncateSymbol v : obj = box (BarCodePropertyProviderProp.TruncateSymbol v)
    let yToXRatio v : obj = box (BarCodePropertyProviderProp.YToXRatio v)
    let matrixSize v : obj = box (BarCodePropertyProviderProp.MatrixSize v)
    let version v : obj = box (BarCodePropertyProviderProp.Version v)
    let segmentsInRow v : obj = box (BarCodePropertyProviderProp.SegmentsInRow v)
    let type v : obj = box (BarCodePropertyProviderProp.Type v)

    let apply (el: DevExpress.Xpf.Editors.BarCodePropertyProvider) (prop: BarCodePropertyProviderProp) =
        match prop with
        | BarCodePropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
        | BarCodePropertyProviderProp.CalcCheckSum v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.CalcCheckSumProperty, box v)
        | BarCodePropertyProviderProp.StartStopPair v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.StartStopPairProperty, box v)
        | BarCodePropertyProviderProp.WideNarrowRatio v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.WideNarrowRatioProperty, box v)
        | BarCodePropertyProviderProp.CharacterSet v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.CharacterSetProperty, box v)
        | BarCodePropertyProviderProp.MSICheckSum v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.MSICheckSumProperty, box v)
        | BarCodePropertyProviderProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.FNC1SubstituteProperty, box v)
        | BarCodePropertyProviderProp.FNC2Substitute v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.FNC2SubstituteProperty, box v)
        | BarCodePropertyProviderProp.FNC3Substitute v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.FNC3SubstituteProperty, box v)
        | BarCodePropertyProviderProp.FNC4Substitute v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.FNC4SubstituteProperty, box v)
        | BarCodePropertyProviderProp.HumanReadableText v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.HumanReadableTextProperty, box v)
        | BarCodePropertyProviderProp.Columns v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.ColumnsProperty, box v)
        | BarCodePropertyProviderProp.PDF417CompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.PDF417CompactionModeProperty, box v)
        | BarCodePropertyProviderProp.DataMatrixCompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.DataMatrixCompactionModeProperty, box v)
        | BarCodePropertyProviderProp.QRCodeCompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.QRCodeCompactionModeProperty, box v)
        | BarCodePropertyProviderProp.PDF417ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.PDF417ErrorCorrectionLevelProperty, box v)
        | BarCodePropertyProviderProp.QRCodeErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.QRCodeErrorCorrectionLevelProperty, box v)
        | BarCodePropertyProviderProp.Rows v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.RowsProperty, box v)
        | BarCodePropertyProviderProp.TruncateSymbol v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.TruncateSymbolProperty, box v)
        | BarCodePropertyProviderProp.YToXRatio v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.YToXRatioProperty, box v)
        | BarCodePropertyProviderProp.MatrixSize v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.MatrixSizeProperty, box v)
        | BarCodePropertyProviderProp.Version v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.VersionProperty, box v)
        | BarCodePropertyProviderProp.SegmentsInRow v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.SegmentsInRowProperty, box v)
        | BarCodePropertyProviderProp.Type v -> el.SetValue(DevExpress.Xpf.Editors.BarCodePropertyProvider.TypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BarCodePropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
