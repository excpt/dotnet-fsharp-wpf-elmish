...
type GridLinesRenderControlBaseProp =
    | Base of AxisElementsRenderControlBaseProp

module GridLinesRenderControlBase =

    let apply (el: DevExpress.Xpf.Charts.GridLinesRenderControlBase) (prop: GridLinesRenderControlBaseProp) =
        match prop with
        | GridLinesRenderControlBaseProp.Base p -> AxisElementsRenderControlBase.apply el p
