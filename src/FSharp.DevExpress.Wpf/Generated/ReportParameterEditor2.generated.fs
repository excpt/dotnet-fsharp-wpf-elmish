...
type ReportParameterEditor2Prop =
    | Parameter of DevExpress.Data.IParameter

module ReportParameterEditor2 =
    let parameter v : obj = box (ReportParameterEditor2Prop.Parameter v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterEditor2) (prop: ReportParameterEditor2Prop) =
        match prop with
        | ReportParameterEditor2Prop.Parameter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterEditor2.ParameterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterEditor2>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
