...
type ItemsControlBaseProp =
    | ItemsSource of System.Collections.IEnumerable
    | ItemsPanel of System.Windows.Controls.ControlTemplate
    | ContainerStyle of System.Windows.Style
    | ItemTemplate of System.Windows.DataTemplate

module ItemsControlBase =
    let itemsSource v : obj = box (ItemsControlBaseProp.ItemsSource v)
    let itemsPanel v : obj = box (ItemsControlBaseProp.ItemsPanel v)
    let containerStyle v : obj = box (ItemsControlBaseProp.ContainerStyle v)
    let itemTemplate v : obj = box (ItemsControlBaseProp.ItemTemplate v)

    let apply (el: DevExpress.Xpf.Core.ItemsControlBase) (prop: ItemsControlBaseProp) =
        match prop with
        | ItemsControlBaseProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Core.ItemsControlBase.ItemsSourceProperty, box v)
        | ItemsControlBaseProp.ItemsPanel v -> el.SetValue(DevExpress.Xpf.Core.ItemsControlBase.ItemsPanelProperty, box v)
        | ItemsControlBaseProp.ContainerStyle v -> el.SetValue(DevExpress.Xpf.Core.ItemsControlBase.ContainerStyleProperty, box v)
        | ItemsControlBaseProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Core.ItemsControlBase.ItemTemplateProperty, box v)
