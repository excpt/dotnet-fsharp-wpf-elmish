...
type Quasi3DBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module Quasi3DBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.Quasi3DBar2DModelControl) (prop: Quasi3DBar2DModelControlProp) =
        match prop with
        | Quasi3DBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Quasi3DBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
