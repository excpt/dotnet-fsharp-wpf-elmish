...
type SeparatePaneIndicatorWithPointsProp =
    | Base of SeparatePaneIndicatorProp

module SeparatePaneIndicatorWithPoints =

    let apply (el: DevExpress.Xpf.Charts.SeparatePaneIndicatorWithPoints) (prop: SeparatePaneIndicatorWithPointsProp) =
        match prop with
        | SeparatePaneIndicatorWithPointsProp.Base p -> SeparatePaneIndicator.apply el p
