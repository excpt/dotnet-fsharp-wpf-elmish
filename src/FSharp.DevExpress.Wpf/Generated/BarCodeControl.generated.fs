...
type BarCodeControlProp =
    | AutoModule of bool
    | TargetDeviceDpi of obj
    | Module of float
    | ShowText of bool
    | Symbology of DevExpress.Xpf.Controls.SymbologyBase
    | Text of string
...
module BarCodeControl =
    let autoModule v : obj = box (BarCodeControlProp.AutoModule v)
    let targetDeviceDpi v : obj = box (BarCodeControlProp.TargetDeviceDpi v)
    let module v : obj = box (BarCodeControlProp.Module v)
    let showText v : obj = box (BarCodeControlProp.ShowText v)
    let symbology v : obj = box (BarCodeControlProp.Symbology v)
    let text v : obj = box (BarCodeControlProp.Text v)
    let verticalTextAlignment v : obj = box (BarCodeControlProp.VerticalTextAlignment v)
    let horizontalTextAlignment v : obj = box (BarCodeControlProp.HorizontalTextAlignment v)
    let binaryData v : obj = box (BarCodeControlProp.BinaryData v)

    let apply (el: DevExpress.Xpf.Controls.BarCodeControl) (prop: BarCodeControlProp) =
        match prop with
        | BarCodeControlProp.AutoModule v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.AutoModuleProperty, box v)
        | BarCodeControlProp.TargetDeviceDpi v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.TargetDeviceDpiProperty, box v)
        | BarCodeControlProp.Module v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.ModuleProperty, box v)
        | BarCodeControlProp.ShowText v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.ShowTextProperty, box v)
        | BarCodeControlProp.Symbology v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.SymbologyProperty, box v)
        | BarCodeControlProp.Text v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.TextProperty, box v)
        | BarCodeControlProp.VerticalTextAlignment v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.VerticalTextAlignmentProperty, box v)
        | BarCodeControlProp.HorizontalTextAlignment v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.HorizontalTextAlignmentProperty, box v)
        | BarCodeControlProp.BinaryData v -> el.SetValue(DevExpress.Xpf.Controls.BarCodeControl.BinaryDataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.BarCodeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
