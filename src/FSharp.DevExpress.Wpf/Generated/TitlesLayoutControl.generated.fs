...
type TitlesLayoutControlProp =
    | Base of ChartItemsControlProp
    | MasterElement of System.Windows.FrameworkElement
    | Titles of DevExpress.Xpf.Charts.TitleCollection

module TitlesLayoutControl =
    let masterElement v : obj = box (TitlesLayoutControlProp.MasterElement v)
    let titles v : obj = box (TitlesLayoutControlProp.Titles v)

    let apply (el: DevExpress.Xpf.Charts.TitlesLayoutControl) (prop: TitlesLayoutControlProp) =
        match prop with
        | TitlesLayoutControlProp.Base p -> ChartItemsControl.apply el p
        | TitlesLayoutControlProp.MasterElement v -> el.SetValue(DevExpress.Xpf.Charts.TitlesLayoutControl.MasterElementProperty, box v)
        | TitlesLayoutControlProp.Titles v -> el.SetValue(DevExpress.Xpf.Charts.TitlesLayoutControl.TitlesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TitlesLayoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
