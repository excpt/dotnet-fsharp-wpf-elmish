...
type psvTreeViewProp =
    | LayoutGroupTemplate of System.Windows.DataTemplate
    | LayoutItemTemplate of System.Windows.DataTemplate

module psvTreeView =
    let layoutGroupTemplate v : obj = box (psvTreeViewProp.LayoutGroupTemplate v)
    let layoutItemTemplate v : obj = box (psvTreeViewProp.LayoutItemTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.psvTreeView) (prop: psvTreeViewProp) =
        match prop with
        | psvTreeViewProp.LayoutGroupTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.psvTreeView.LayoutGroupTemplateProperty, box v)
        | psvTreeViewProp.LayoutItemTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.psvTreeView.LayoutItemTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.psvTreeView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
