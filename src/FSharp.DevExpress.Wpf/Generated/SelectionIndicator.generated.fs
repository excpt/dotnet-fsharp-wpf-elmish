...
type SelectionIndicatorProp =
    | IsHighlighted of bool
    | IsSelected of bool
    | Orientation of obj
    | IsPressed of bool

module SelectionIndicator =
    let isHighlighted v : obj = box (SelectionIndicatorProp.IsHighlighted v)
    let isSelected v : obj = box (SelectionIndicatorProp.IsSelected v)
    let orientation v : obj = box (SelectionIndicatorProp.Orientation v)
    let isPressed v : obj = box (SelectionIndicatorProp.IsPressed v)

    let apply (el: DevExpress.Xpf.Core.Native.SelectionIndicator) (prop: SelectionIndicatorProp) =
        match prop with
        | SelectionIndicatorProp.IsHighlighted v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicator.IsHighlightedProperty, box v)
        | SelectionIndicatorProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicator.IsSelectedProperty, box v)
        | SelectionIndicatorProp.Orientation v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicator.OrientationProperty, box v)
        | SelectionIndicatorProp.IsPressed v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicator.IsPressedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.SelectionIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
