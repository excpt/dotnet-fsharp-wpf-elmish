...
type PageBorderControlProp =
    | IsPageShadowVisible of bool

module PageBorderControl =
    let isPageShadowVisible v : obj = box (PageBorderControlProp.IsPageShadowVisible v)

    let apply (el: DevExpress.Xpf.Printing.Native.PageBorderControl) (prop: PageBorderControlProp) =
        match prop with
        | PageBorderControlProp.IsPageShadowVisible v -> el.SetValue(DevExpress.Xpf.Printing.Native.PageBorderControl.IsPageShadowVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.PageBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
