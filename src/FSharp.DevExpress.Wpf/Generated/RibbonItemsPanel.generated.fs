...
type RibbonItemsPanelProp =
    | ControlBoxWidth of float
    | DefaultHeaderWidth of float
    | Offset of float

module RibbonItemsPanel =
    let controlBoxWidth v : obj = box (RibbonItemsPanelProp.ControlBoxWidth v)
    let defaultHeaderWidth v : obj = box (RibbonItemsPanelProp.DefaultHeaderWidth v)
    let offset v : obj = box (RibbonItemsPanelProp.Offset v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonItemsPanel) (prop: RibbonItemsPanelProp) =
        match prop with
        | RibbonItemsPanelProp.ControlBoxWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonItemsPanel.ControlBoxWidthProperty, box v)
        | RibbonItemsPanelProp.DefaultHeaderWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonItemsPanel.DefaultHeaderWidthProperty, box v)
        | RibbonItemsPanelProp.Offset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonItemsPanel.OffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
