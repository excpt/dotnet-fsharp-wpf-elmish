...
type HeaderFooterEditControlProp =
    | Provider of DevExpress.XtraSpreadsheet.Layout.HeaderFooterFormatTagProvider
    | LeftHeader of string
    | CenterHeader of string
    | RightHeader of string
    | LeftFooter of string
    | CenterFooter of string
    | RightFooter of string

module HeaderFooterEditControl =
    let provider v : obj = box (HeaderFooterEditControlProp.Provider v)
    let leftHeader v : obj = box (HeaderFooterEditControlProp.LeftHeader v)
    let centerHeader v : obj = box (HeaderFooterEditControlProp.CenterHeader v)
    let rightHeader v : obj = box (HeaderFooterEditControlProp.RightHeader v)
    let leftFooter v : obj = box (HeaderFooterEditControlProp.LeftFooter v)
    let centerFooter v : obj = box (HeaderFooterEditControlProp.CenterFooter v)
    let rightFooter v : obj = box (HeaderFooterEditControlProp.RightFooter v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl) (prop: HeaderFooterEditControlProp) =
        match prop with
        | HeaderFooterEditControlProp.Provider v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.ProviderProperty, box v)
        | HeaderFooterEditControlProp.LeftHeader v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.LeftHeaderProperty, box v)
        | HeaderFooterEditControlProp.CenterHeader v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.CenterHeaderProperty, box v)
        | HeaderFooterEditControlProp.RightHeader v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.RightHeaderProperty, box v)
        | HeaderFooterEditControlProp.LeftFooter v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.LeftFooterProperty, box v)
        | HeaderFooterEditControlProp.CenterFooter v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.CenterFooterProperty, box v)
        | HeaderFooterEditControlProp.RightFooter v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl.RightFooterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterEditControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
