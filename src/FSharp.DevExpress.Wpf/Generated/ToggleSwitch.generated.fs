...
module ToggleSwitch =
    let checkedStateContent v : obj = box (ToggleSwitchProp.CheckedStateContent v)
    let isReadOnly v : obj = box (ToggleSwitchProp.IsReadOnly v)
    let uncheckedStateContent v : obj = box (ToggleSwitchProp.UncheckedStateContent v)
    let enableAnimation v : obj = box (ToggleSwitchProp.EnableAnimation v)
    let contentPlacement v : obj = box (ToggleSwitchProp.ContentPlacement v)
    let toggleSwitchWidth v : obj = box (ToggleSwitchProp.ToggleSwitchWidth v)
    let toggleSwitchHeight v : obj = box (ToggleSwitchProp.ToggleSwitchHeight v)
    let checkedStateContentTemplate v : obj = box (ToggleSwitchProp.CheckedStateContentTemplate v)
    let uncheckedStateContentTemplate v : obj = box (ToggleSwitchProp.UncheckedStateContentTemplate v)
    let animationMode v : obj = box (ToggleSwitchProp.AnimationMode v)
    let switchThumbTemplate v : obj = box (ToggleSwitchProp.SwitchThumbTemplate v)
    let switchBorderTemplate v : obj = box (ToggleSwitchProp.SwitchBorderTemplate v)
    let cornerRadius v : obj = box (ToggleSwitchProp.CornerRadius v)
    let undefinedStateContent v : obj = box (ToggleSwitchProp.UndefinedStateContent v)
    let undefinedStateContentTemplate v : obj = box (ToggleSwitchProp.UndefinedStateContentTemplate v)

    let apply (el: DevExpress.Xpf.Editors.ToggleSwitch) (prop: ToggleSwitchProp) =
        match prop with
        | ToggleSwitchProp.Base p -> ToggleStateButton.apply el p
        | ToggleSwitchProp.CheckedStateContent v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.CheckedStateContentProperty, box v)
        | ToggleSwitchProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.IsReadOnlyProperty, box v)
        | ToggleSwitchProp.UncheckedStateContent v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.UncheckedStateContentProperty, box v)
        | ToggleSwitchProp.EnableAnimation v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.EnableAnimationProperty, box v)
        | ToggleSwitchProp.ContentPlacement v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.ContentPlacementProperty, box v)
        | ToggleSwitchProp.ToggleSwitchWidth v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.ToggleSwitchWidthProperty, box v)
        | ToggleSwitchProp.ToggleSwitchHeight v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.ToggleSwitchHeightProperty, box v)
        | ToggleSwitchProp.CheckedStateContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.CheckedStateContentTemplateProperty, box v)
        | ToggleSwitchProp.UncheckedStateContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.UncheckedStateContentTemplateProperty, box v)
        | ToggleSwitchProp.AnimationMode v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.AnimationModeProperty, box v)
        | ToggleSwitchProp.SwitchThumbTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.SwitchThumbTemplateProperty, box v)
        | ToggleSwitchProp.SwitchBorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.SwitchBorderTemplateProperty, box v)
        | ToggleSwitchProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.CornerRadiusProperty, box v)
        | ToggleSwitchProp.UndefinedStateContent v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.UndefinedStateContentProperty, box v)
        | ToggleSwitchProp.UndefinedStateContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitch.UndefinedStateContentTemplateProperty, box v)

    let handleToggle v : obj = box (ToggleStateButtonProp.HandleToggle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ToggleSwitch>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
