...
type BarButtonColorEditItemLinkControlProp =
    | Base of BarSplitButtonItemLinkControlProp

module BarButtonColorEditItemLinkControl =

    let apply (el: DevExpress.Xpf.Office.UI.BarButtonColorEditItemLinkControl) (prop: BarButtonColorEditItemLinkControlProp) =
        match prop with
        | BarButtonColorEditItemLinkControlProp.Base p -> BarSplitButtonItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Office.UI.BarButtonColorEditItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
