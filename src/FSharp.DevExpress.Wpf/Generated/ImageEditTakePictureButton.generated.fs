...
type ImageEditTakePictureButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditTakePictureButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditTakePictureButton) (prop: ImageEditTakePictureButtonProp) =
        match prop with
        | ImageEditTakePictureButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditTakePictureButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
