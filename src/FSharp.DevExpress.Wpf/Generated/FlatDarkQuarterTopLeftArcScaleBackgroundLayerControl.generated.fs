...
type FlatDarkQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkQuarterTopLeftArcScaleBackgroundLayerControl) (prop: FlatDarkQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatDarkQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
