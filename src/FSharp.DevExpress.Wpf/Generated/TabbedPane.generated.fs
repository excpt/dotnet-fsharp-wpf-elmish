...
module TabbedPane =
    let tabbedTemplate v : obj = box (TabbedPaneProp.TabbedTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabbedPane) (prop: TabbedPaneProp) =
        match prop with
        | TabbedPaneProp.Base p -> psvContentControl.apply el p
        | TabbedPaneProp.TabbedTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabbedPane.TabbedTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabbedPane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
