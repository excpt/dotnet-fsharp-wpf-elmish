...
type FlatBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module FlatBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatBar2DModelControl) (prop: FlatBar2DModelControlProp) =
        match prop with
        | FlatBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
