...
type PDF417StyleSettingsProp =
    | Columns of int
    | CompactionMode of DevExpress.XtraPrinting.BarCode.PDF417CompactionMode
    | ErrorCorrectionLevel of DevExpress.XtraPrinting.BarCode.ErrorCorrectionLevel
    | Rows of int
    | TruncateSymbol of bool
    | YToXRatio of float32

module PDF417StyleSettings =
    let columns v : obj = box (PDF417StyleSettingsProp.Columns v)
    let compactionMode v : obj = box (PDF417StyleSettingsProp.CompactionMode v)
    let errorCorrectionLevel v : obj = box (PDF417StyleSettingsProp.ErrorCorrectionLevel v)
    let rows v : obj = box (PDF417StyleSettingsProp.Rows v)
    let truncateSymbol v : obj = box (PDF417StyleSettingsProp.TruncateSymbol v)
    let yToXRatio v : obj = box (PDF417StyleSettingsProp.YToXRatio v)

    let apply (el: DevExpress.Xpf.Editors.PDF417StyleSettings) (prop: PDF417StyleSettingsProp) =
        match prop with
        | PDF417StyleSettingsProp.Columns v -> el.SetValue(DevExpress.Xpf.Editors.PDF417StyleSettings.ColumnsProperty, box v)
        | PDF417StyleSettingsProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.PDF417StyleSettings.CompactionModeProperty, box v)
        | PDF417StyleSettingsProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Editors.PDF417StyleSettings.ErrorCorrectionLevelProperty, box v)
        | PDF417StyleSettingsProp.Rows v -> el.SetValue(DevExpress.Xpf.Editors.PDF417StyleSettings.RowsProperty, box v)
        | PDF417StyleSettingsProp.TruncateSymbol v -> el.SetValue(DevExpress.Xpf.Editors.PDF417StyleSettings.TruncateSymbolProperty, box v)
        | PDF417StyleSettingsProp.YToXRatio v -> el.SetValue(DevExpress.Xpf.Editors.PDF417StyleSettings.YToXRatioProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PDF417StyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
