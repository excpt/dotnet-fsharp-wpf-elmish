...
open System
open System.Windows
open DevExpress.Xpf.Controls.Primitives
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FlowLayoutPanelProp =
    | Base of LayoutPanelBaseProp
    | AllowItemClipping of bool
    | AllowItemAlignment of bool
...
module FlowLayoutPanel =
    let allowItemClipping v : obj = box (FlowLayoutPanelProp.AllowItemClipping v)
    let allowItemAlignment v : obj = box (FlowLayoutPanelProp.AllowItemAlignment v)
    let allowItemMoving v : obj = box (FlowLayoutPanelProp.AllowItemMoving v)
    let animateItemMoving v : obj = box (FlowLayoutPanelProp.AnimateItemMoving v)
    let itemMovingAnimationDuration v : obj = box (FlowLayoutPanelProp.ItemMovingAnimationDuration v)
    let layerSpace v : obj = box (FlowLayoutPanelProp.LayerSpace v)
    let movingItemPlaceHolderBrush v : obj = box (FlowLayoutPanelProp.MovingItemPlaceHolderBrush v)
    let orientation v : obj = box (FlowLayoutPanelProp.Orientation v)
    let stretchContent v : obj = box (FlowLayoutPanelProp.StretchContent v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel) (prop: FlowLayoutPanelProp) =
        match prop with
        | FlowLayoutPanelProp.Base p -> LayoutPanelBase.apply el p
        | FlowLayoutPanelProp.AllowItemClipping v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.AllowItemClippingProperty, box v)
        | FlowLayoutPanelProp.AllowItemAlignment v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.AllowItemAlignmentProperty, box v)
        | FlowLayoutPanelProp.AllowItemMoving v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.AllowItemMovingProperty, box v)
        | FlowLayoutPanelProp.AnimateItemMoving v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.AnimateItemMovingProperty, box v)
        | FlowLayoutPanelProp.ItemMovingAnimationDuration v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.ItemMovingAnimationDurationProperty, box v)
        | FlowLayoutPanelProp.LayerSpace v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.LayerSpaceProperty, box v)
        | FlowLayoutPanelProp.MovingItemPlaceHolderBrush v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.MovingItemPlaceHolderBrushProperty, box v)
        | FlowLayoutPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.OrientationProperty, box v)
        | FlowLayoutPanelProp.StretchContent v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.StretchContentProperty, box v)

    let itemSpacing v : obj = box (LayoutPanelBaseProp.ItemSpacing v)
    let padding v : obj = box (LayoutPanelBaseProp.Padding v)
    ...
    let isFlowBreak (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel.IsFlowBreakProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.FlowLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
