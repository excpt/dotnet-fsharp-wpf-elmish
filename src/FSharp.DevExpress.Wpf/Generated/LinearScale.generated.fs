...
type LinearScaleProp =
    | Base of ScaleProp
    | LayoutMode of DevExpress.Xpf.Gauges.LinearScaleLayoutMode
    | LabelOptions of DevExpress.Xpf.Gauges.LinearScaleLabelOptions
    | LinePresentation of DevExpress.Xpf.Gauges.LinearScaleLinePresentation

module LinearScale =
    let layoutMode v : obj = box (LinearScaleProp.LayoutMode v)
    let labelOptions v : obj = box (LinearScaleProp.LabelOptions v)
    let linePresentation v : obj = box (LinearScaleProp.LinePresentation v)

    let apply (el: DevExpress.Xpf.Gauges.LinearScale) (prop: LinearScaleProp) =
        match prop with
        | LinearScaleProp.Base p -> Scale.apply el p
        | LinearScaleProp.LayoutMode v -> el.SetValue(DevExpress.Xpf.Gauges.LinearScale.LayoutModeProperty, box v)
        | LinearScaleProp.LabelOptions v -> el.SetValue(DevExpress.Xpf.Gauges.LinearScale.LabelOptionsProperty, box v)
        | LinearScaleProp.LinePresentation v -> el.SetValue(DevExpress.Xpf.Gauges.LinearScale.LinePresentationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearScale>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
