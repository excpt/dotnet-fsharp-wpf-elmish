...
type TokenEditorPresenterProp =
    | IsTokenFocused of bool
    | IsSelected of bool
    | ActiveEditorStyle of System.Windows.Style
    | ShowBorder of bool
    | NullText of string
    | ShowButtons of bool
    | Item of DevExpress.Xpf.Editors.CustomItem
    | IsEditorActivated of bool
    | HasNullText of bool
    | NewTokenText of string
    | IsTokenEditorReadOnly of bool
    | IsNewTokenEditorPresenter of bool
    | IsTextEditable of bool

module TokenEditorPresenter =
    let isTokenFocused v : obj = box (TokenEditorPresenterProp.IsTokenFocused v)
    let isSelected v : obj = box (TokenEditorPresenterProp.IsSelected v)
    let activeEditorStyle v : obj = box (TokenEditorPresenterProp.ActiveEditorStyle v)
    let showBorder v : obj = box (TokenEditorPresenterProp.ShowBorder v)
    let nullText v : obj = box (TokenEditorPresenterProp.NullText v)
    let showButtons v : obj = box (TokenEditorPresenterProp.ShowButtons v)
    let item v : obj = box (TokenEditorPresenterProp.Item v)
    let isEditorActivated v : obj = box (TokenEditorPresenterProp.IsEditorActivated v)
    let hasNullText v : obj = box (TokenEditorPresenterProp.HasNullText v)
    let newTokenText v : obj = box (TokenEditorPresenterProp.NewTokenText v)
    let isTokenEditorReadOnly v : obj = box (TokenEditorPresenterProp.IsTokenEditorReadOnly v)
    let isNewTokenEditorPresenter v : obj = box (TokenEditorPresenterProp.IsNewTokenEditorPresenter v)
    let isTextEditable v : obj = box (TokenEditorPresenterProp.IsTextEditable v)

    let apply (el: DevExpress.Xpf.Editors.Internal.TokenEditorPresenter) (prop: TokenEditorPresenterProp) =
        match prop with
        | TokenEditorPresenterProp.IsTokenFocused v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.IsTokenFocusedProperty, box v)
        | TokenEditorPresenterProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.IsSelectedProperty, box v)
        | TokenEditorPresenterProp.ActiveEditorStyle v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.ActiveEditorStyleProperty, box v)
        | TokenEditorPresenterProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.ShowBorderProperty, box v)
        | TokenEditorPresenterProp.NullText v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.NullTextProperty, box v)
        | TokenEditorPresenterProp.ShowButtons v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.ShowButtonsProperty, box v)
        | TokenEditorPresenterProp.Item v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.ItemProperty, box v)
        | TokenEditorPresenterProp.IsEditorActivated v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.IsEditorActivatedProperty, box v)
        | TokenEditorPresenterProp.HasNullText v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.HasNullTextProperty, box v)
        | TokenEditorPresenterProp.NewTokenText v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.NewTokenTextProperty, box v)
        | TokenEditorPresenterProp.IsTokenEditorReadOnly v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.IsTokenEditorReadOnlyProperty, box v)
        | TokenEditorPresenterProp.IsNewTokenEditorPresenter v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.IsNewTokenEditorPresenterProperty, box v)
        | TokenEditorPresenterProp.IsTextEditable v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPresenter.IsTextEditableProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.TokenEditorPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
