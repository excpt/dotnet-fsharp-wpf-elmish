...
type CollapsedActiveGroupItemsControlProp =
    | DefaultIsChecked of bool
    | ShowMode of DevExpress.Xpf.NavBar.ShowMode
    | DefaultElement of DevExpress.Xpf.NavBar.CollapsedActiveGroupDefaultElement

module CollapsedActiveGroupItemsControl =
    let defaultIsChecked v : obj = box (CollapsedActiveGroupItemsControlProp.DefaultIsChecked v)
    let showMode v : obj = box (CollapsedActiveGroupItemsControlProp.ShowMode v)
    let defaultElement v : obj = box (CollapsedActiveGroupItemsControlProp.DefaultElement v)

    let apply (el: DevExpress.Xpf.NavBar.CollapsedActiveGroupItemsControl) (prop: CollapsedActiveGroupItemsControlProp) =
        match prop with
        | CollapsedActiveGroupItemsControlProp.DefaultIsChecked v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupItemsControl.DefaultIsCheckedProperty, box v)
        | CollapsedActiveGroupItemsControlProp.ShowMode v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupItemsControl.ShowModeProperty, box v)
        | CollapsedActiveGroupItemsControlProp.DefaultElement v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupItemsControl.DefaultElementProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.CollapsedActiveGroupItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
