...
type SelectionViewModelProp =
    | SelectAll of obj
    | IsSelected of bool

module SelectionViewModel =
    let selectAll v : obj = box (SelectionViewModelProp.SelectAll v)
    let isSelected v : obj = box (SelectionViewModelProp.IsSelected v)

    let apply (el: DevExpress.Xpf.Editors.Popups.SelectionViewModel) (prop: SelectionViewModelProp) =
        match prop with
        | SelectionViewModelProp.SelectAll v -> el.SetValue(DevExpress.Xpf.Editors.Popups.SelectionViewModel.SelectAllProperty, box v)
        | SelectionViewModelProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Editors.Popups.SelectionViewModel.IsSelectedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.SelectionViewModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
