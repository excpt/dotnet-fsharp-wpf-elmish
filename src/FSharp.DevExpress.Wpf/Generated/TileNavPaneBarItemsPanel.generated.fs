...
type TileNavPaneBarItemsPanelProp =
    | Base of TileBarItemsPanelProp

module TileNavPaneBarItemsPanel =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileNavPaneBarItemsPanel) (prop: TileNavPaneBarItemsPanelProp) =
        match prop with
        | TileNavPaneBarItemsPanelProp.Base p -> TileBarItemsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileNavPaneBarItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
