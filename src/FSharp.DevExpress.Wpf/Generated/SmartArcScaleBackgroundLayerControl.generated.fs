...
type SmartArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartArcScaleBackgroundLayerControl) (prop: SmartArcScaleBackgroundLayerControlProp) =
        match prop with
        | SmartArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
