...
type LayoutItemAlignmentButtonProp =
    | CornerRadius of System.Windows.CornerRadius
    | Kind of DevExpress.Xpf.LayoutControl.LayoutItemAlignmentButtonKind

module LayoutItemAlignmentButton =
    let cornerRadius v : obj = box (LayoutItemAlignmentButtonProp.CornerRadius v)
    let kind v : obj = box (LayoutItemAlignmentButtonProp.Kind v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemAlignmentButton) (prop: LayoutItemAlignmentButtonProp) =
        match prop with
        | LayoutItemAlignmentButtonProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemAlignmentButton.CornerRadiusProperty, box v)
        | LayoutItemAlignmentButtonProp.Kind v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemAlignmentButton.KindProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemAlignmentButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
