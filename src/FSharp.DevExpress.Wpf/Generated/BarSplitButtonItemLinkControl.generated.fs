...
module BarSplitButtonItemLinkControl =
    ...
    let apply (el: DevExpress.Xpf.Bars.BarSplitButtonItemLinkControl) (prop: BarSplitButtonItemLinkControlProp) =
        match prop with
        | BarSplitButtonItemLinkControlProp.Base p -> BarButtonItemLinkControl.apply el p
        | BarSplitButtonItemLinkControlProp.IsArrowPressed v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitButtonItemLinkControl.IsArrowPressedProperty, box v)
        | BarSplitButtonItemLinkControlProp.ShowArrowHotBorder v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitButtonItemLinkControl.ShowArrowHotBorderProperty, box v)
        | BarSplitButtonItemLinkControlProp.ItemPosition v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitButtonItemLinkControl.ItemPositionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarSplitButtonItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
