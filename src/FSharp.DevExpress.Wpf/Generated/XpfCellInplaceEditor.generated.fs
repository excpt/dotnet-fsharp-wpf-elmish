...
type XpfCellInplaceEditorProp =
    | Base of XpfCellInplaceEditorBaseProp

module XpfCellInplaceEditor =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.XpfCellInplaceEditor) (prop: XpfCellInplaceEditorProp) =
        match prop with
        | XpfCellInplaceEditorProp.Base p -> XpfCellInplaceEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.XpfCellInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
