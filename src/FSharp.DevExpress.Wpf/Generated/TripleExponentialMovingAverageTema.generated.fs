...
type TripleExponentialMovingAverageTemaProp =
    | Base of MovingAverageProp

module TripleExponentialMovingAverageTema =

    let apply (el: DevExpress.Xpf.Charts.TripleExponentialMovingAverageTema) (prop: TripleExponentialMovingAverageTemaProp) =
        match prop with
        | TripleExponentialMovingAverageTemaProp.Base p -> MovingAverage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TripleExponentialMovingAverageTema>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
