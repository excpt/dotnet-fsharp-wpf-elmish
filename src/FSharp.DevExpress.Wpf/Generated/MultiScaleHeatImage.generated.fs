...
type MultiScaleHeatImageProp =
    | Base of FullRequestedMultiScaleImageProp

module MultiScaleHeatImage =

    let apply (el: DevExpress.Xpf.Map.MultiScaleHeatImage) (prop: MultiScaleHeatImageProp) =
        match prop with
        | MultiScaleHeatImageProp.Base p -> FullRequestedMultiScaleImage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MultiScaleHeatImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
