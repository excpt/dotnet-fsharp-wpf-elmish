...
type RowsPrintBackgroundControlProp =
    | Rows of obj

module RowsPrintBackgroundControl =
    let rows v : obj = box (RowsPrintBackgroundControlProp.Rows v)

    let apply (el: DevExpress.Xpf.Gantt.Native.RowsPrintBackgroundControl) (prop: RowsPrintBackgroundControlProp) =
        match prop with
        | RowsPrintBackgroundControlProp.Rows v -> el.SetValue(DevExpress.Xpf.Gantt.Native.RowsPrintBackgroundControl.RowsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.RowsPrintBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
