...
type LinearCosmicModelProp =
    | Base of LinearGaugeModelProp

module LinearCosmicModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearCosmicModel) (prop: LinearCosmicModelProp) =
        match prop with
        | LinearCosmicModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearCosmicModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
