...
type IndicatorPresentationProp =
    | Base of ChartElementBaseProp

module IndicatorPresentation =

    let apply (el: DevExpress.Xpf.Charts.IndicatorPresentation) (prop: IndicatorPresentationProp) =
        match prop with
        | IndicatorPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.IndicatorPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
