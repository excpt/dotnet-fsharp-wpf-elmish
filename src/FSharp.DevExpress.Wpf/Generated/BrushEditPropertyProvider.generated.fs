...
type BrushEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp

module BrushEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.BrushEditPropertyProvider) (prop: BrushEditPropertyProviderProp) =
        match prop with
        | BrushEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BrushEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
