...
type SpreadsheetSpinEditProp =
    | Base of SpinEditProp
    | UseDisplayValueForAutomation of bool

module SpreadsheetSpinEdit =
    let useDisplayValueForAutomation v : obj = box (SpreadsheetSpinEditProp.UseDisplayValueForAutomation v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetSpinEdit) (prop: SpreadsheetSpinEditProp) =
        match prop with
        | SpreadsheetSpinEditProp.Base p -> SpinEdit.apply el p
        | SpreadsheetSpinEditProp.UseDisplayValueForAutomation v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetSpinEdit.UseDisplayValueForAutomationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetSpinEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
