...
type ProgressiveLinearScaleLineControlProp =
    | Base of PresentationControlProp

module ProgressiveLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveLinearScaleLineControl) (prop: ProgressiveLinearScaleLineControlProp) =
        match prop with
        | ProgressiveLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
