...
type LinearThemeableModelProp =
    | Base of LinearGaugeModelProp

module LinearThemeableModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearThemeableModel) (prop: LinearThemeableModelProp) =
        match prop with
        | LinearThemeableModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearThemeableModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
