...
module CircularAreaSeries2D =
    let markerVisible v : obj = box (CircularAreaSeries2DProp.MarkerVisible v)
    let seriesAnimation v : obj = box (CircularAreaSeries2DProp.SeriesAnimation v)
    let transparency v : obj = box (CircularAreaSeries2DProp.Transparency v)
    let border v : obj = box (CircularAreaSeries2DProp.Border v)

    let apply (el: DevExpress.Xpf.Charts.CircularAreaSeries2D) (prop: CircularAreaSeries2DProp) =
        match prop with
        | CircularAreaSeries2DProp.Base p -> CircularSeries2D.apply el p
        | CircularAreaSeries2DProp.MarkerVisible v -> el.SetValue(DevExpress.Xpf.Charts.CircularAreaSeries2D.MarkerVisibleProperty, box v)
        | CircularAreaSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.CircularAreaSeries2D.SeriesAnimationProperty, box v)
        | CircularAreaSeries2DProp.Transparency v -> el.SetValue(DevExpress.Xpf.Charts.CircularAreaSeries2D.TransparencyProperty, box v)
        | CircularAreaSeries2DProp.Border v -> el.SetValue(DevExpress.Xpf.Charts.CircularAreaSeries2D.BorderProperty, box v)
