...
type MajorGridLinesRenderControlProp =
    | Base of GridLinesRenderControlBaseProp

module MajorGridLinesRenderControl =

    let apply (el: DevExpress.Xpf.Charts.MajorGridLinesRenderControl) (prop: MajorGridLinesRenderControlProp) =
        match prop with
        | MajorGridLinesRenderControlProp.Base p -> GridLinesRenderControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.MajorGridLinesRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
