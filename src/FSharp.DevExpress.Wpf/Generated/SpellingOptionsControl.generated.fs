...
type SpellingOptionsControlProp =
    | Base of SpellCheckerControlBaseProp
    | OkCommand of System.Windows.Input.ICommand
    | ApplyCommand of System.Windows.Input.ICommand
    | EditCommand of System.Windows.Input.ICommand
    | CancelCommand of System.Windows.Input.ICommand
    | IgnoreEmails of bool
    | IgnoreUrls of bool
    | IgnoreUri of bool
    | IgnoreUpperCase of bool
    | IgnoreWordsWithDigits of bool
    | IgnoreMixedCaseWords of bool
    | IgnoreRepeatedWords of bool
    | IsModified of bool
    | CurrentLanguage of DevExpress.Xpf.SpellChecker.Forms.LanguageItem

module SpellingOptionsControl =
    let okCommand v : obj = box (SpellingOptionsControlProp.OkCommand v)
    let applyCommand v : obj = box (SpellingOptionsControlProp.ApplyCommand v)
    let editCommand v : obj = box (SpellingOptionsControlProp.EditCommand v)
    let cancelCommand v : obj = box (SpellingOptionsControlProp.CancelCommand v)
    let ignoreEmails v : obj = box (SpellingOptionsControlProp.IgnoreEmails v)
    let ignoreUrls v : obj = box (SpellingOptionsControlProp.IgnoreUrls v)
    let ignoreUri v : obj = box (SpellingOptionsControlProp.IgnoreUri v)
    let ignoreUpperCase v : obj = box (SpellingOptionsControlProp.IgnoreUpperCase v)
    let ignoreWordsWithDigits v : obj = box (SpellingOptionsControlProp.IgnoreWordsWithDigits v)
    let ignoreMixedCaseWords v : obj = box (SpellingOptionsControlProp.IgnoreMixedCaseWords v)
    let ignoreRepeatedWords v : obj = box (SpellingOptionsControlProp.IgnoreRepeatedWords v)
    let isModified v : obj = box (SpellingOptionsControlProp.IsModified v)
    let currentLanguage v : obj = box (SpellingOptionsControlProp.CurrentLanguage v)

    let apply (el: DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl) (prop: SpellingOptionsControlProp) =
        match prop with
        | SpellingOptionsControlProp.Base p -> SpellCheckerControlBase.apply el p
        | SpellingOptionsControlProp.OkCommand v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.OkCommandProperty, box v)
        | SpellingOptionsControlProp.ApplyCommand v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.ApplyCommandProperty, box v)
        | SpellingOptionsControlProp.EditCommand v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.EditCommandProperty, box v)
        | SpellingOptionsControlProp.CancelCommand v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.CancelCommandProperty, box v)
        | SpellingOptionsControlProp.IgnoreEmails v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreEmailsProperty, box v)
        | SpellingOptionsControlProp.IgnoreUrls v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreUrlsProperty, box v)
        | SpellingOptionsControlProp.IgnoreUri v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreUriProperty, box v)
        | SpellingOptionsControlProp.IgnoreUpperCase v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreUpperCaseProperty, box v)
        | SpellingOptionsControlProp.IgnoreWordsWithDigits v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreWordsWithDigitsProperty, box v)
        | SpellingOptionsControlProp.IgnoreMixedCaseWords v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreMixedCaseWordsProperty, box v)
        | SpellingOptionsControlProp.IgnoreRepeatedWords v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IgnoreRepeatedWordsProperty, box v)
        | SpellingOptionsControlProp.IsModified v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.IsModifiedProperty, box v)
        | SpellingOptionsControlProp.CurrentLanguage v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl.CurrentLanguageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.SpellChecker.Forms.SpellingOptionsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
