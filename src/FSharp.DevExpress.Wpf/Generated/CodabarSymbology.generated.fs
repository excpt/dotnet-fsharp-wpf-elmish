...
type CodabarSymbologyProp =
    | StartStopPair of DevExpress.XtraPrinting.BarCode.CodabarStartStopPair
    | WideNarrowRatio of float32

module CodabarSymbology =
    let startStopPair v : obj = box (CodabarSymbologyProp.StartStopPair v)
    let wideNarrowRatio v : obj = box (CodabarSymbologyProp.WideNarrowRatio v)

    let apply (el: DevExpress.Xpf.Controls.CodabarSymbology) (prop: CodabarSymbologyProp) =
        match prop with
        | CodabarSymbologyProp.StartStopPair v -> el.SetValue(DevExpress.Xpf.Controls.CodabarSymbology.StartStopPairProperty, box v)
        | CodabarSymbologyProp.WideNarrowRatio v -> el.SetValue(DevExpress.Xpf.Controls.CodabarSymbology.WideNarrowRatioProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.CodabarSymbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
