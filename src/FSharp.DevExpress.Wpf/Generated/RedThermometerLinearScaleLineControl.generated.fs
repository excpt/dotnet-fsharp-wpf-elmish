...
type RedThermometerLinearScaleLineControlProp =
    | Base of PresentationControlProp

module RedThermometerLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.RedThermometerLinearScaleLineControl) (prop: RedThermometerLinearScaleLineControlProp) =
        match prop with
        | RedThermometerLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedThermometerLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
