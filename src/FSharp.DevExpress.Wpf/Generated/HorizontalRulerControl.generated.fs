...
type HorizontalRulerControlProp =
    | Base of RulerControlBaseProp

module HorizontalRulerControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalRulerControl) (prop: HorizontalRulerControlProp) =
        match prop with
        | HorizontalRulerControlProp.Base p -> RulerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalRulerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
