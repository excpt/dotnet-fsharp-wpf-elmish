...
open System
open System.Windows
open DevExpress.Xpf.Printing.Native.Lines
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type LinesWindowProp =
    | Base of DXDialogProp

module LinesWindow =

    let apply (el: DevExpress.Xpf.Printing.Native.Lines.LinesWindow) (prop: LinesWindowProp) =
        match prop with
        | LinesWindowProp.Base p -> DXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.Lines.LinesWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
