...
type StripLinesPanelProp =
    | FirstVisibleDate of System.DateTime
    | Zoom of System.TimeSpan

module StripLinesPanel =
    let firstVisibleDate v : obj = box (StripLinesPanelProp.FirstVisibleDate v)
    let zoom v : obj = box (StripLinesPanelProp.Zoom v)

    let apply (el: DevExpress.Xpf.Gantt.Native.StripLinesPanel) (prop: StripLinesPanelProp) =
        match prop with
        | StripLinesPanelProp.FirstVisibleDate v -> el.SetValue(DevExpress.Xpf.Gantt.Native.StripLinesPanel.FirstVisibleDateProperty, box v)
        | StripLinesPanelProp.Zoom v -> el.SetValue(DevExpress.Xpf.Gantt.Native.StripLinesPanel.ZoomProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.StripLinesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
