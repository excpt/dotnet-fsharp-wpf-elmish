...
type ContentAndFooterHostPresenterProp =
    | Base of ContentHostPresenterProp
    | FooterCacheMode of DevExpress.Xpf.Core.TabContentCacheMode
    | RegularFooterPresenter of obj
    | FastFooterPresenter of obj

module ContentAndFooterHostPresenter =
    let footerCacheMode v : obj = box (ContentAndFooterHostPresenterProp.FooterCacheMode v)
    let regularFooterPresenter v : obj = box (ContentAndFooterHostPresenterProp.RegularFooterPresenter v)
    let fastFooterPresenter v : obj = box (ContentAndFooterHostPresenterProp.FastFooterPresenter v)

    let apply (el: DevExpress.Xpf.Core.Native.ContentAndFooterHostPresenter) (prop: ContentAndFooterHostPresenterProp) =
        match prop with
        | ContentAndFooterHostPresenterProp.Base p -> ContentHostPresenter.apply el p
        | ContentAndFooterHostPresenterProp.FooterCacheMode v -> el.SetValue(DevExpress.Xpf.Core.Native.ContentAndFooterHostPresenter.FooterCacheModeProperty, box v)
        | ContentAndFooterHostPresenterProp.RegularFooterPresenter v -> el.SetValue(DevExpress.Xpf.Core.Native.ContentAndFooterHostPresenter.RegularFooterPresenterProperty, box v)
        | ContentAndFooterHostPresenterProp.FastFooterPresenter v -> el.SetValue(DevExpress.Xpf.Core.Native.ContentAndFooterHostPresenter.FastFooterPresenterProperty, box v)

    let contentCacheMode v : obj = box (ContentHostPresenterProp.ContentCacheMode v)
    let regularContentPresenter v : obj = box (ContentHostPresenterProp.RegularContentPresenter v)
    let fastContentPresenter v : obj = box (ContentHostPresenterProp.FastContentPresenter v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ContentAndFooterHostPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
