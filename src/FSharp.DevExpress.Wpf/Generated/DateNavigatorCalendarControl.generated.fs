...
type DateNavigatorCalendarControlProp =
    ...
    | CellSize of System.Windows.Size

module DateNavigatorCalendarControl =
    let dateTime v : obj = box (DateNavigatorCalendarControlProp.DateTime v)
    let minValue v : obj = box (DateNavigatorCalendarControlProp.MinValue v)
    let maxValue v : obj = box (DateNavigatorCalendarControlProp.MaxValue v)
    let firstDayOfWeek v : obj = box (DateNavigatorCalendarControlProp.FirstDayOfWeek v)
    let weekNumberRule v : obj = box (DateNavigatorCalendarControlProp.WeekNumberRule v)
    let cellSize v : obj = box (DateNavigatorCalendarControlProp.CellSize v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl) (prop: DateNavigatorCalendarControlProp) =
        match prop with
        | DateNavigatorCalendarControlProp.Base p -> DateNavigatorCalendarBase.apply el p
        | DateNavigatorCalendarControlProp.DateTime v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl.DateTimeProperty, box v)
        | DateNavigatorCalendarControlProp.MinValue v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl.MinValueProperty, box v)
        | DateNavigatorCalendarControlProp.MaxValue v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl.MaxValueProperty, box v)
        | DateNavigatorCalendarControlProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl.FirstDayOfWeekProperty, box v)
        | DateNavigatorCalendarControlProp.WeekNumberRule v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl.WeekNumberRuleProperty, box v)
        | DateNavigatorCalendarControlProp.CellSize v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl.CellSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
