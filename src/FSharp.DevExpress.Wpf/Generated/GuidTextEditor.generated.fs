...
type GuidTextEditorProp =
    | Base of TextEditProp

module GuidTextEditor =

    let apply (el: DevExpress.Xpf.Printing.Native.GuidTextEditor) (prop: GuidTextEditorProp) =
        match prop with
        | GuidTextEditorProp.Base p -> TextEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.GuidTextEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
