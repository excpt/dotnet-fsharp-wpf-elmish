...
type ButtonEditPropertyProviderProp =
    | Base of TextEditPropertyProviderProp
    | NullValueButtonPlacement of DevExpress.Xpf.Editors.EditorPlacement
    | IsTextEditable of bool
    | IsNullValueButtonVisible of bool

module ButtonEditPropertyProvider =
    ...
    let apply (el: DevExpress.Xpf.Editors.ButtonEditPropertyProvider) (prop: ButtonEditPropertyProviderProp) =
        match prop with
        | ButtonEditPropertyProviderProp.Base p -> TextEditPropertyProvider.apply el p
        | ButtonEditPropertyProviderProp.NullValueButtonPlacement v -> el.SetValue(DevExpress.Xpf.Editors.ButtonEditPropertyProvider.NullValueButtonPlacementProperty, box v)
        | ButtonEditPropertyProviderProp.IsTextEditable v -> el.SetValue(DevExpress.Xpf.Editors.ButtonEditPropertyProvider.IsTextEditableProperty, box v)
        | ButtonEditPropertyProviderProp.IsNullValueButtonVisible v -> el.SetValue(DevExpress.Xpf.Editors.ButtonEditPropertyProvider.IsNullValueButtonVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ButtonEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
