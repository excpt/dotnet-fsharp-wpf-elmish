...
type AnimatedAppointmentsPanelProp =
    | Base of AnimationPanel2Prop
    | SchedulerTimeCellControl of DevExpress.Xpf.Scheduler.Drawing.ISchedulerTimeCellControl

module AnimatedAppointmentsPanel =
    let schedulerTimeCellControl v : obj = box (AnimatedAppointmentsPanelProp.SchedulerTimeCellControl v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AnimatedAppointmentsPanel) (prop: AnimatedAppointmentsPanelProp) =
        match prop with
        | AnimatedAppointmentsPanelProp.Base p -> AnimationPanel2.apply el p
        | AnimatedAppointmentsPanelProp.SchedulerTimeCellControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AnimatedAppointmentsPanel.SchedulerTimeCellControlProperty, box v)

    let animationState v : obj = box (AnimationPanel2Prop.AnimationState v)
