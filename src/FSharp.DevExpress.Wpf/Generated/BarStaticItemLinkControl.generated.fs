...
type BarStaticItemLinkControlProp =
    | Base of BarItemLinkControlProp
    | BorderPadding of System.Windows.Thickness
    | ActualContentAlignment of System.Windows.HorizontalAlignment
    | ActualMinWidth of float
    | ShowBorder of bool

module BarStaticItemLinkControl =
    let borderPadding v : obj = box (BarStaticItemLinkControlProp.BorderPadding v)
    let actualContentAlignment v : obj = box (BarStaticItemLinkControlProp.ActualContentAlignment v)
    let actualMinWidth v : obj = box (BarStaticItemLinkControlProp.ActualMinWidth v)
    let showBorder v : obj = box (BarStaticItemLinkControlProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.Bars.BarStaticItemLinkControl) (prop: BarStaticItemLinkControlProp) =
        match prop with
        | BarStaticItemLinkControlProp.Base p -> BarItemLinkControl.apply el p
        | BarStaticItemLinkControlProp.BorderPadding v -> el.SetValue(DevExpress.Xpf.Bars.BarStaticItemLinkControl.BorderPaddingProperty, box v)
        | BarStaticItemLinkControlProp.ActualContentAlignment v -> el.SetValue(DevExpress.Xpf.Bars.BarStaticItemLinkControl.ActualContentAlignmentProperty, box v)
        | BarStaticItemLinkControlProp.ActualMinWidth v -> el.SetValue(DevExpress.Xpf.Bars.BarStaticItemLinkControl.ActualMinWidthProperty, box v)
        | BarStaticItemLinkControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Bars.BarStaticItemLinkControl.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarStaticItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
