...
type PageMarginsPreviewControlProp =
    | TopMargin of float32
    | BottomMargin of float32
    | LeftMargin of float32
    | RightMargin of float32
    | HeaderMargin of float32
    | FooterMargin of float32
    | CenterHorizontally of bool
    | CenterVertically of bool
    | OrientationPortrait of bool

module PageMarginsPreviewControl =
    let topMargin v : obj = box (PageMarginsPreviewControlProp.TopMargin v)
    let bottomMargin v : obj = box (PageMarginsPreviewControlProp.BottomMargin v)
    let leftMargin v : obj = box (PageMarginsPreviewControlProp.LeftMargin v)
    let rightMargin v : obj = box (PageMarginsPreviewControlProp.RightMargin v)
    let headerMargin v : obj = box (PageMarginsPreviewControlProp.HeaderMargin v)
    let footerMargin v : obj = box (PageMarginsPreviewControlProp.FooterMargin v)
    let centerHorizontally v : obj = box (PageMarginsPreviewControlProp.CenterHorizontally v)
    let centerVertically v : obj = box (PageMarginsPreviewControlProp.CenterVertically v)
    let orientationPortrait v : obj = box (PageMarginsPreviewControlProp.OrientationPortrait v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl) (prop: PageMarginsPreviewControlProp) =
        match prop with
        | PageMarginsPreviewControlProp.TopMargin v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.TopMarginProperty, box v)
        | PageMarginsPreviewControlProp.BottomMargin v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.BottomMarginProperty, box v)
        | PageMarginsPreviewControlProp.LeftMargin v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.LeftMarginProperty, box v)
        | PageMarginsPreviewControlProp.RightMargin v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.RightMarginProperty, box v)
        | PageMarginsPreviewControlProp.HeaderMargin v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.HeaderMarginProperty, box v)
        | PageMarginsPreviewControlProp.FooterMargin v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.FooterMarginProperty, box v)
        | PageMarginsPreviewControlProp.CenterHorizontally v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.CenterHorizontallyProperty, box v)
        | PageMarginsPreviewControlProp.CenterVertically v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.CenterVerticallyProperty, box v)
        | PageMarginsPreviewControlProp.OrientationPortrait v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl.OrientationPortraitProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.PageMarginsPreviewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
