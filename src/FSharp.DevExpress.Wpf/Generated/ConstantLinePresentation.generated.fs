...
type ConstantLinePresentationProp =
    | Base of ChartElementBaseProp

module ConstantLinePresentation =

    let apply (el: DevExpress.Xpf.Charts.ConstantLinePresentation) (prop: ConstantLinePresentationProp) =
        match prop with
        | ConstantLinePresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ConstantLinePresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
