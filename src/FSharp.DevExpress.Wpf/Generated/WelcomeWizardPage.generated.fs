...
type WelcomeWizardPageProp =
    | Base of WizardPageProp

module WelcomeWizardPage =

    let apply (el: DevExpress.Xpf.Controls.WelcomeWizardPage) (prop: WelcomeWizardPageProp) =
        match prop with
        | WelcomeWizardPageProp.Base p -> WizardPage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.WelcomeWizardPage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
