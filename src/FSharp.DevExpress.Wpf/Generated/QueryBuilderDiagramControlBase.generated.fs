...
type QueryBuilderDiagramControlBaseProp =
    | Base of DiagramControlProp

module QueryBuilderDiagramControlBase =

    let apply (el: DevExpress.Xpf.DataAccess.Native.QueryBuilder.QueryBuilderDiagramControlBase) (prop: QueryBuilderDiagramControlBaseProp) =
        match prop with
        | QueryBuilderDiagramControlBaseProp.Base p -> DiagramControl.apply el p
