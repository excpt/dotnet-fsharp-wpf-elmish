...
type ThinStock2DModelControlProp =
    | Base of PredefinedModelControlProp

module ThinStock2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.ThinStock2DModelControl) (prop: ThinStock2DModelControlProp) =
        match prop with
        | ThinStock2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ThinStock2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
