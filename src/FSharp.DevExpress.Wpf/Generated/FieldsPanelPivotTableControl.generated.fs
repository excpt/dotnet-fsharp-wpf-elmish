...
type FieldsPanelPivotTableControlProp =
    | Base of DXWindowProp

module FieldsPanelPivotTableControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.FieldsPanelPivotTableControl) (prop: FieldsPanelPivotTableControlProp) =
        match prop with
        | FieldsPanelPivotTableControlProp.Base p -> DXWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.FieldsPanelPivotTableControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
