...
type AutoHideWindowHostProp =
    | Content of obj
    | Background of System.Windows.Media.Brush

module AutoHideWindowHost =
    let content v : obj = box (AutoHideWindowHostProp.Content v)
    let background v : obj = box (AutoHideWindowHostProp.Background v)

    let apply (el: DevExpress.Xpf.Docking.Platform.AutoHideWindowHost) (prop: AutoHideWindowHostProp) =
        match prop with
        | AutoHideWindowHostProp.Content v -> el.SetValue(DevExpress.Xpf.Docking.Platform.AutoHideWindowHost.ContentProperty, box v)
        | AutoHideWindowHostProp.Background v -> el.SetValue(DevExpress.Xpf.Docking.Platform.AutoHideWindowHost.BackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.AutoHideWindowHost>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
