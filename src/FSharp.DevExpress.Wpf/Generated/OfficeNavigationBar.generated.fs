...
type OfficeNavigationBarProp =
    | Base of veSelectorProp
    | ItemSpacing of float
    | MaxItemCount of int
    | Orientation of System.Windows.Controls.Orientation
    | ItemOrientation of System.Windows.Controls.Orientation
    | AllowItemDragDrop of bool
    | CustomizationButtonVisibility of DevExpress.Xpf.Navigation.CustomizationButtonVisibility
    | NavigationClient of DevExpress.Xpf.Core.INavigatorClient
    | ShowPeekFormOnItemHover of bool
    | PeekFormShowDelay of int
    | PeekFormHideDelay of int

module OfficeNavigationBar =
    let itemSpacing v : obj = box (OfficeNavigationBarProp.ItemSpacing v)
    let maxItemCount v : obj = box (OfficeNavigationBarProp.MaxItemCount v)
    let orientation v : obj = box (OfficeNavigationBarProp.Orientation v)
    let itemOrientation v : obj = box (OfficeNavigationBarProp.ItemOrientation v)
    let allowItemDragDrop v : obj = box (OfficeNavigationBarProp.AllowItemDragDrop v)
    let customizationButtonVisibility v : obj = box (OfficeNavigationBarProp.CustomizationButtonVisibility v)
    let navigationClient v : obj = box (OfficeNavigationBarProp.NavigationClient v)
    let showPeekFormOnItemHover v : obj = box (OfficeNavigationBarProp.ShowPeekFormOnItemHover v)
    let peekFormShowDelay v : obj = box (OfficeNavigationBarProp.PeekFormShowDelay v)
    let peekFormHideDelay v : obj = box (OfficeNavigationBarProp.PeekFormHideDelay v)

    let apply (el: DevExpress.Xpf.Navigation.OfficeNavigationBar) (prop: OfficeNavigationBarProp) =
        match prop with
        | OfficeNavigationBarProp.Base p -> veSelector.apply el p
        | OfficeNavigationBarProp.ItemSpacing v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.ItemSpacingProperty, box v)
        | OfficeNavigationBarProp.MaxItemCount v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.MaxItemCountProperty, box v)
        | OfficeNavigationBarProp.Orientation v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.OrientationProperty, box v)
        | OfficeNavigationBarProp.ItemOrientation v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.ItemOrientationProperty, box v)
        | OfficeNavigationBarProp.AllowItemDragDrop v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.AllowItemDragDropProperty, box v)
        | OfficeNavigationBarProp.CustomizationButtonVisibility v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.CustomizationButtonVisibilityProperty, box v)
        | OfficeNavigationBarProp.NavigationClient v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.NavigationClientProperty, box v)
        | OfficeNavigationBarProp.ShowPeekFormOnItemHover v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.ShowPeekFormOnItemHoverProperty, box v)
        | OfficeNavigationBarProp.PeekFormShowDelay v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.PeekFormShowDelayProperty, box v)
        | OfficeNavigationBarProp.PeekFormHideDelay v -> el.SetValue(DevExpress.Xpf.Navigation.OfficeNavigationBar.PeekFormHideDelayProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.OfficeNavigationBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
