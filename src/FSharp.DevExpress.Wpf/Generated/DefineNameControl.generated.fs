...
type DefineNameControlProp =
    | Base of ReferenceEditBaseControlProp

module DefineNameControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.DefineNameControl) (prop: DefineNameControlProp) =
        match prop with
        | DefineNameControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.DefineNameControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
