...
type ControlItemControlPresenterProp =
    | Base of ControlItemElementPresenterProp

module ControlItemControlPresenter =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.ControlItemControlPresenter) (prop: ControlItemControlPresenterProp) =
        match prop with
        | ControlItemControlPresenterProp.Base p -> ControlItemElementPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.ControlItemControlPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
