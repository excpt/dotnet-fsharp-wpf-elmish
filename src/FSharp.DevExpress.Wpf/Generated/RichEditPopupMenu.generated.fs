...
open System
open System.Windows
open DevExpress.Xpf.RichEdit.Menu
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type RichEditPopupMenuProp =
    | Base of CustomizablePopupMenuBaseProp

module RichEditPopupMenu =

    let apply (el: DevExpress.Xpf.RichEdit.Menu.RichEditPopupMenu) (prop: RichEditPopupMenuProp) =
        match prop with
        | RichEditPopupMenuProp.Base p -> CustomizablePopupMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Menu.RichEditPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
