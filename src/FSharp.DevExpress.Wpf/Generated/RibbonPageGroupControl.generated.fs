...
type RibbonPageGroupControlProp =
    | Base of RibbonLinksControlProp
    | IsCollapsed of bool
    | IsSeparatorVisible of bool
    | PageGroup of DevExpress.Xpf.Ribbon.RibbonPageGroup
    | BorderTemplate of System.Windows.Controls.ControlTemplate
    | BorderTemplateInPopup of System.Windows.Controls.ControlTemplate
    | HighlightedBorderTemplate of System.Windows.Controls.ControlTemplate
    | HighlightedBorderTemplateInPopup of System.Windows.Controls.ControlTemplate
    | PopupButtonBorderTemplate of System.Windows.Controls.ControlTemplate
    | PopupButtonContentBorderTemplate of System.Windows.Controls.ControlTemplate
    | PopupButtonGlyphBorderTemplate of System.Windows.Controls.ControlTemplate
    | HighlightedPopupButtonBorderTemplate of System.Windows.Controls.ControlTemplate
    | HighlightedPopupButtonContentBorderTemplate of System.Windows.Controls.ControlTemplate
    | HighlightedPopupButtonGlyphBorderTemplate of System.Windows.Controls.ControlTemplate
    | CaptionBorderTemplate of System.Windows.Controls.ControlTemplate
    | HighlightedCaptionBorderTemplate of System.Windows.Controls.ControlTemplate
    | PopupHorizontalOffset of float
    | PopupVerticalOffset of float
    | IsPageGroupVisible of bool
    | AllowCollapse of bool
    | RibbonStyle of DevExpress.Xpf.Ribbon.RibbonStyle
    | IsDesignTimeCaptionVisible of bool
    | Altitude of int
    | IsMerged of bool
    | IsInSimplifiedRibbon of bool

module RibbonPageGroupControl =
    let isCollapsed v : obj = box (RibbonPageGroupControlProp.IsCollapsed v)
    let isSeparatorVisible v : obj = box (RibbonPageGroupControlProp.IsSeparatorVisible v)
    let pageGroup v : obj = box (RibbonPageGroupControlProp.PageGroup v)
    let borderTemplate v : obj = box (RibbonPageGroupControlProp.BorderTemplate v)
    let borderTemplateInPopup v : obj = box (RibbonPageGroupControlProp.BorderTemplateInPopup v)
    let highlightedBorderTemplate v : obj = box (RibbonPageGroupControlProp.HighlightedBorderTemplate v)
    let highlightedBorderTemplateInPopup v : obj = box (RibbonPageGroupControlProp.HighlightedBorderTemplateInPopup v)
    let popupButtonBorderTemplate v : obj = box (RibbonPageGroupControlProp.PopupButtonBorderTemplate v)
    let popupButtonContentBorderTemplate v : obj = box (RibbonPageGroupControlProp.PopupButtonContentBorderTemplate v)
    let popupButtonGlyphBorderTemplate v : obj = box (RibbonPageGroupControlProp.PopupButtonGlyphBorderTemplate v)
    let highlightedPopupButtonBorderTemplate v : obj = box (RibbonPageGroupControlProp.HighlightedPopupButtonBorderTemplate v)
    let highlightedPopupButtonContentBorderTemplate v : obj = box (RibbonPageGroupControlProp.HighlightedPopupButtonContentBorderTemplate v)
    let highlightedPopupButtonGlyphBorderTemplate v : obj = box (RibbonPageGroupControlProp.HighlightedPopupButtonGlyphBorderTemplate v)
    let captionBorderTemplate v : obj = box (RibbonPageGroupControlProp.CaptionBorderTemplate v)
    let highlightedCaptionBorderTemplate v : obj = box (RibbonPageGroupControlProp.HighlightedCaptionBorderTemplate v)
    let popupHorizontalOffset v : obj = box (RibbonPageGroupControlProp.PopupHorizontalOffset v)
    let popupVerticalOffset v : obj = box (RibbonPageGroupControlProp.PopupVerticalOffset v)
    let isPageGroupVisible v : obj = box (RibbonPageGroupControlProp.IsPageGroupVisible v)
    let allowCollapse v : obj = box (RibbonPageGroupControlProp.AllowCollapse v)
    let ribbonStyle v : obj = box (RibbonPageGroupControlProp.RibbonStyle v)
    let isDesignTimeCaptionVisible v : obj = box (RibbonPageGroupControlProp.IsDesignTimeCaptionVisible v)
    let altitude v : obj = box (RibbonPageGroupControlProp.Altitude v)
    let isMerged v : obj = box (RibbonPageGroupControlProp.IsMerged v)
    let isInSimplifiedRibbon v : obj = box (RibbonPageGroupControlProp.IsInSimplifiedRibbon v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageGroupControl) (prop: RibbonPageGroupControlProp) =
        match prop with
        | RibbonPageGroupControlProp.Base p -> RibbonLinksControl.apply el p
        | RibbonPageGroupControlProp.IsCollapsed v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.IsCollapsedProperty, box v)
        | RibbonPageGroupControlProp.IsSeparatorVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.IsSeparatorVisibleProperty, box v)
        | RibbonPageGroupControlProp.PageGroup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.PageGroupProperty, box v)
        | RibbonPageGroupControlProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.BorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.BorderTemplateInPopup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.BorderTemplateInPopupProperty, box v)
        | RibbonPageGroupControlProp.HighlightedBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.HighlightedBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.HighlightedBorderTemplateInPopup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.HighlightedBorderTemplateInPopupProperty, box v)
        | RibbonPageGroupControlProp.PopupButtonBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.PopupButtonBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.PopupButtonContentBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.PopupButtonContentBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.PopupButtonGlyphBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.PopupButtonGlyphBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.HighlightedPopupButtonBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.HighlightedPopupButtonBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.HighlightedPopupButtonContentBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.HighlightedPopupButtonContentBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.HighlightedPopupButtonGlyphBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.HighlightedPopupButtonGlyphBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.CaptionBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.CaptionBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.HighlightedCaptionBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.HighlightedCaptionBorderTemplateProperty, box v)
        | RibbonPageGroupControlProp.PopupHorizontalOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.PopupHorizontalOffsetProperty, box v)
        | RibbonPageGroupControlProp.PopupVerticalOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.PopupVerticalOffsetProperty, box v)
        | RibbonPageGroupControlProp.IsPageGroupVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.IsPageGroupVisibleProperty, box v)
        | RibbonPageGroupControlProp.AllowCollapse v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.AllowCollapseProperty, box v)
        | RibbonPageGroupControlProp.RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.RibbonStyleProperty, box v)
        | RibbonPageGroupControlProp.IsDesignTimeCaptionVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.IsDesignTimeCaptionVisibleProperty, box v)
        | RibbonPageGroupControlProp.Altitude v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.AltitudeProperty, box v)
        | RibbonPageGroupControlProp.IsMerged v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.IsMergedProperty, box v)
        | RibbonPageGroupControlProp.IsInSimplifiedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupControl.IsInSimplifiedRibbonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
