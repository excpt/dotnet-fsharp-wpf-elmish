...
open System
open System.Windows
open DevExpress.Xpf.Editors.Filtering
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FilterControlProp =
    | FilterCriteria of DevExpress.Data.Filtering.CriteriaOperator
    | SourceControl of obj
    | ShowDateTimeOperators of bool
    | DefaultColumn of DevExpress.Xpf.Editors.Filtering.FilterColumn
    | ShowOperandTypeIcon of bool
    | ShowGroupCommandsIcon of bool
    | ShowToolTips of bool
    | ShowBorder of bool
    | AllowedGroupFilters of DevExpress.Xpf.Editors.Filtering.AllowedGroupFilters
    | EmptyValueTemplate of System.Windows.Controls.ControlTemplate
    | EmptyStringTemplate of System.Windows.Controls.ControlTemplate
    | ValueTemplate of System.Windows.Controls.ControlTemplate
    | BooleanValueTemplate of System.Windows.Controls.ControlTemplate
    | OnBeforeShowValueEditor of DevExpress.Xpf.Editors.Filtering.ShowValueEditorEventHandler

module FilterControl =
    let filterCriteria v : obj = box (FilterControlProp.FilterCriteria v)
    let sourceControl v : obj = box (FilterControlProp.SourceControl v)
    let showDateTimeOperators v : obj = box (FilterControlProp.ShowDateTimeOperators v)
    let defaultColumn v : obj = box (FilterControlProp.DefaultColumn v)
    let showOperandTypeIcon v : obj = box (FilterControlProp.ShowOperandTypeIcon v)
    let showGroupCommandsIcon v : obj = box (FilterControlProp.ShowGroupCommandsIcon v)
    let showToolTips v : obj = box (FilterControlProp.ShowToolTips v)
    let showBorder v : obj = box (FilterControlProp.ShowBorder v)
    let allowedGroupFilters v : obj = box (FilterControlProp.AllowedGroupFilters v)
    let emptyValueTemplate v : obj = box (FilterControlProp.EmptyValueTemplate v)
    let emptyStringTemplate v : obj = box (FilterControlProp.EmptyStringTemplate v)
    let valueTemplate v : obj = box (FilterControlProp.ValueTemplate v)
    let booleanValueTemplate v : obj = box (FilterControlProp.BooleanValueTemplate v)
    let onBeforeShowValueEditor v : obj = box (EventProp(box (FilterControlProp.OnBeforeShowValueEditor v)))

    let apply (el: DevExpress.Xpf.Editors.Filtering.FilterControl) (prop: FilterControlProp) =
        match prop with
        | FilterControlProp.FilterCriteria v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.FilterCriteriaProperty, box v)
        | FilterControlProp.SourceControl v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.SourceControlProperty, box v)
        | FilterControlProp.ShowDateTimeOperators v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.ShowDateTimeOperatorsProperty, box v)
        | FilterControlProp.DefaultColumn v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.DefaultColumnProperty, box v)
        | FilterControlProp.ShowOperandTypeIcon v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.ShowOperandTypeIconProperty, box v)
        | FilterControlProp.ShowGroupCommandsIcon v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.ShowGroupCommandsIconProperty, box v)
        | FilterControlProp.ShowToolTips v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.ShowToolTipsProperty, box v)
        | FilterControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.ShowBorderProperty, box v)
        | FilterControlProp.AllowedGroupFilters v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.AllowedGroupFiltersProperty, box v)
        | FilterControlProp.EmptyValueTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.EmptyValueTemplateProperty, box v)
        | FilterControlProp.EmptyStringTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.EmptyStringTemplateProperty, box v)
        | FilterControlProp.ValueTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.ValueTemplateProperty, box v)
        | FilterControlProp.BooleanValueTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterControl.BooleanValueTemplateProperty, box v)
        | FilterControlProp.OnBeforeShowValueEditor h -> el.BeforeShowValueEditor.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Filtering.FilterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
