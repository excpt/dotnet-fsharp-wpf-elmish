...
type ThumbnailsViewerPresenterControlProp =
    | Base of DocumentPresenterControlProp

module ThumbnailsViewerPresenterControl =

    let apply (el: DevExpress.Xpf.PdfViewer.ThumbnailsViewerPresenterControl) (prop: ThumbnailsViewerPresenterControlProp) =
        match prop with
        | ThumbnailsViewerPresenterControlProp.Base p -> DocumentPresenterControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.ThumbnailsViewerPresenterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
