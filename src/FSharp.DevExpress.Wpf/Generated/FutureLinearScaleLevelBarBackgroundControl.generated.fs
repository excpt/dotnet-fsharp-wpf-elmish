...
type FutureLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FutureLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureLinearScaleLevelBarBackgroundControl) (prop: FutureLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | FutureLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
