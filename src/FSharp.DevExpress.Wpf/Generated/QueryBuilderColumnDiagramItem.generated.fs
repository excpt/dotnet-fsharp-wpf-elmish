...
type QueryBuilderColumnDiagramItemProp =
    | Base of QueryBuilderColumnDiagramItemBaseProp

module QueryBuilderColumnDiagramItem =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderColumnDiagramItem) (prop: QueryBuilderColumnDiagramItemProp) =
        match prop with
        | QueryBuilderColumnDiagramItemProp.Base p -> QueryBuilderColumnDiagramItemBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderColumnDiagramItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
