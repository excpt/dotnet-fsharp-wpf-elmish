...
type CalculatorGaugeProp =
    | Text of string

module CalculatorGauge =
    let text v : obj = box (CalculatorGaugeProp.Text v)

    let apply (el: DevExpress.Xpf.Editors.CalculatorGauge) (prop: CalculatorGaugeProp) =
        match prop with
        | CalculatorGaugeProp.Text v -> el.SetValue(DevExpress.Xpf.Editors.CalculatorGauge.TextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CalculatorGauge>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
