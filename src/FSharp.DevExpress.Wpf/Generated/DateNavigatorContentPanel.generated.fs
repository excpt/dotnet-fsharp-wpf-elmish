...
type DateNavigatorContentPanelProp =
    | ColumnCount of int
    | RowCount of int

module DateNavigatorContentPanel =
    let columnCount v : obj = box (DateNavigatorContentPanelProp.ColumnCount v)
    let rowCount v : obj = box (DateNavigatorContentPanelProp.RowCount v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContentPanel) (prop: DateNavigatorContentPanelProp) =
        match prop with
        | DateNavigatorContentPanelProp.ColumnCount v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContentPanel.ColumnCountProperty, box v)
        | DateNavigatorContentPanelProp.RowCount v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContentPanel.RowCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContentPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
