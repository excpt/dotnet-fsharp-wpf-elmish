...
type RulerCellControlProp =
    | Base of RulerHeaderControlProp

module RulerCellControl =

    let apply (el: DevExpress.Xpf.Scheduler.RulerCellControl) (prop: RulerCellControlProp) =
        match prop with
        | RulerCellControlProp.Base p -> RulerHeaderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.RulerCellControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
