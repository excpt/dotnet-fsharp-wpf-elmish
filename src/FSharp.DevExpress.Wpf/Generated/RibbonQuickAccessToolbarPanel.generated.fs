...
type RibbonQuickAccessToolbarPanelProp =
    | Base of RibbonItemsPanelBaseProp

module RibbonQuickAccessToolbarPanel =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonQuickAccessToolbarPanel) (prop: RibbonQuickAccessToolbarPanelProp) =
        match prop with
        | RibbonQuickAccessToolbarPanelProp.Base p -> RibbonItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonQuickAccessToolbarPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
