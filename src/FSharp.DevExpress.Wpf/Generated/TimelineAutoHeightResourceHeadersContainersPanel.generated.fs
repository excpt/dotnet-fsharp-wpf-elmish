...
type TimelineAutoHeightResourceHeadersContainersPanelProp =
    | Base of ResourceHeadersContainerPanelProp
    | MainPanel of DevExpress.Xpf.Scheduling.Panels.ITimelineGroupsPanel

module TimelineAutoHeightResourceHeadersContainersPanel =
    let mainPanel v : obj = box (TimelineAutoHeightResourceHeadersContainersPanelProp.MainPanel v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightResourceHeadersContainersPanel) (prop: TimelineAutoHeightResourceHeadersContainersPanelProp) =
        match prop with
        | TimelineAutoHeightResourceHeadersContainersPanelProp.Base p -> ResourceHeadersContainerPanel.apply el p
        | TimelineAutoHeightResourceHeadersContainersPanelProp.MainPanel v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightResourceHeadersContainersPanel.MainPanelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightResourceHeadersContainersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
