...
type NavPaneScrollableContentControlProp =
    | Base of ScrollableContentControlProp

module NavPaneScrollableContentControl =

    let apply (el: DevExpress.Xpf.NavBar.NavPaneScrollableContentControl) (prop: NavPaneScrollableContentControlProp) =
        match prop with
        | NavPaneScrollableContentControlProp.Base p -> ScrollableContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneScrollableContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
