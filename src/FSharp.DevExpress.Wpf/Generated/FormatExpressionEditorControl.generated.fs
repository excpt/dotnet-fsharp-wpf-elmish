...
type FormatExpressionEditorControlProp =
    | Base of ExpressionEditorContainerProp

module FormatExpressionEditorControl =

    let apply (el: DevExpress.Xpf.Core.ConditionalFormattingManager.FormatExpressionEditorControl) (prop: FormatExpressionEditorControlProp) =
        match prop with
        | FormatExpressionEditorControlProp.Base p -> ExpressionEditorContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ConditionalFormattingManager.FormatExpressionEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
