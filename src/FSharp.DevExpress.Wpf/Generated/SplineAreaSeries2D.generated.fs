...
type SplineAreaSeries2DProp =
    | Base of AreaSeries2DProp
    | SplineAlgorithm of DevExpress.Xpf.Charts.SplineAlgorithm
    | LineTension of float

module SplineAreaSeries2D =
    let splineAlgorithm v : obj = box (SplineAreaSeries2DProp.SplineAlgorithm v)
    let lineTension v : obj = box (SplineAreaSeries2DProp.LineTension v)

    let apply (el: DevExpress.Xpf.Charts.SplineAreaSeries2D) (prop: SplineAreaSeries2DProp) =
        match prop with
        | SplineAreaSeries2DProp.Base p -> AreaSeries2D.apply el p
        | SplineAreaSeries2DProp.SplineAlgorithm v -> el.SetValue(DevExpress.Xpf.Charts.SplineAreaSeries2D.SplineAlgorithmProperty, box v)
        | SplineAreaSeries2DProp.LineTension v -> el.SetValue(DevExpress.Xpf.Charts.SplineAreaSeries2D.LineTensionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SplineAreaSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
