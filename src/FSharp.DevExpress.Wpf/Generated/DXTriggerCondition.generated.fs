...
type DXTriggerConditionProp =
    | ActualValue of obj

module DXTriggerCondition =
    let actualValue v : obj = box (DXTriggerConditionProp.ActualValue v)

    let apply (el: DevExpress.Xpf.Core.Native.DXTriggerCondition) (prop: DXTriggerConditionProp) =
        match prop with
        | DXTriggerConditionProp.ActualValue v -> el.SetValue(DevExpress.Xpf.Core.Native.DXTriggerCondition.ActualValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DXTriggerCondition>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
