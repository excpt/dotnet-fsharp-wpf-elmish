...
type AdditionalSplineStackedAreaBorderSeriesGeometryProp =
    | Base of AdditionalSplineAreaBorderSeriesGeometryProp

module AdditionalSplineStackedAreaBorderSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineStackedAreaBorderSeriesGeometry) (prop: AdditionalSplineStackedAreaBorderSeriesGeometryProp) =
        match prop with
        | AdditionalSplineStackedAreaBorderSeriesGeometryProp.Base p -> AdditionalSplineAreaBorderSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineStackedAreaBorderSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
