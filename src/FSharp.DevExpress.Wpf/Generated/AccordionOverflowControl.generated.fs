...
type AccordionOverflowControlProp =
    | ItemsSource of obj
    | SelectedItem of DevExpress.Xpf.Accordion.AccordionItem
    | MaxVisibleItems of int
    | CollapsedItemsSource of obj
    | OverflowItemActualLength of float
    | OverflowItemMargin of System.Windows.Thickness
    | OverflowBackgroundPadding of System.Windows.Thickness
    | OverflowItemMinLength of float

module AccordionOverflowControl =
    let itemsSource v : obj = box (AccordionOverflowControlProp.ItemsSource v)
    let selectedItem v : obj = box (AccordionOverflowControlProp.SelectedItem v)
    let maxVisibleItems v : obj = box (AccordionOverflowControlProp.MaxVisibleItems v)
    let collapsedItemsSource v : obj = box (AccordionOverflowControlProp.CollapsedItemsSource v)
    let overflowItemActualLength v : obj = box (AccordionOverflowControlProp.OverflowItemActualLength v)
    let overflowItemMargin v : obj = box (AccordionOverflowControlProp.OverflowItemMargin v)
    let overflowBackgroundPadding v : obj = box (AccordionOverflowControlProp.OverflowBackgroundPadding v)
    let overflowItemMinLength v : obj = box (AccordionOverflowControlProp.OverflowItemMinLength v)

    let apply (el: DevExpress.Xpf.Accordion.AccordionOverflowControl) (prop: AccordionOverflowControlProp) =
        match prop with
        | AccordionOverflowControlProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.ItemsSourceProperty, box v)
        | AccordionOverflowControlProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.SelectedItemProperty, box v)
        | AccordionOverflowControlProp.MaxVisibleItems v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.MaxVisibleItemsProperty, box v)
        | AccordionOverflowControlProp.CollapsedItemsSource v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.CollapsedItemsSourceProperty, box v)
        | AccordionOverflowControlProp.OverflowItemActualLength v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.OverflowItemActualLengthProperty, box v)
        | AccordionOverflowControlProp.OverflowItemMargin v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.OverflowItemMarginProperty, box v)
        | AccordionOverflowControlProp.OverflowBackgroundPadding v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.OverflowBackgroundPaddingProperty, box v)
        | AccordionOverflowControlProp.OverflowItemMinLength v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionOverflowControl.OverflowItemMinLengthProperty, box v)
    ...
    let barItemName (v: string) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Accordion.AccordionOverflowControl.BarItemNameProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionOverflowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
