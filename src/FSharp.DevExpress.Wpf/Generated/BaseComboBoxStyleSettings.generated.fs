...
type BaseComboBoxStyleSettingsProp =
    | Base of BaseLookUpStyleSettingsProp
    | ItemContainerStyle of System.Windows.Style

module BaseComboBoxStyleSettings =
    let itemContainerStyle v : obj = box (BaseComboBoxStyleSettingsProp.ItemContainerStyle v)

    let apply (el: DevExpress.Xpf.Editors.BaseComboBoxStyleSettings) (prop: BaseComboBoxStyleSettingsProp) =
        match prop with
        | BaseComboBoxStyleSettingsProp.Base p -> BaseLookUpStyleSettings.apply el p
        | BaseComboBoxStyleSettingsProp.ItemContainerStyle v -> el.SetValue(DevExpress.Xpf.Editors.BaseComboBoxStyleSettings.ItemContainerStyleProperty, box v)
