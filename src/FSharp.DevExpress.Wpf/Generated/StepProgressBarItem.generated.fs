...
type StepProgressBarItemProp =
    | IsSelected of bool
    | State of DevExpress.Xpf.Controls.StepProgressBarItemState
    | NearContent of obj
    | NearContentTemplate of System.Windows.DataTemplate
    | NearContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | NearContentHorizontalAlignment of System.Windows.HorizontalAlignment
    | NearContentVerticalAlignment of System.Windows.VerticalAlignment
    | FarContent of obj
    | FarContentTemplate of System.Windows.DataTemplate
    | FarContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | IndicatorBorderSize of float
    | IndicatorGeometry of System.Windows.Media.Geometry
    | HoverBackground of System.Windows.Media.Brush
    | HoverBorderBrush of System.Windows.Media.Brush
    | FarContentVerticalAlignment of System.Windows.VerticalAlignment
    | FarContentHorizontalAlignment of System.Windows.HorizontalAlignment

module StepProgressBarItem =
    let isSelected v : obj = box (StepProgressBarItemProp.IsSelected v)
    let state v : obj = box (StepProgressBarItemProp.State v)
    let nearContent v : obj = box (StepProgressBarItemProp.NearContent v)
    let nearContentTemplate v : obj = box (StepProgressBarItemProp.NearContentTemplate v)
    let nearContentTemplateSelector v : obj = box (StepProgressBarItemProp.NearContentTemplateSelector v)
    let nearContentHorizontalAlignment v : obj = box (StepProgressBarItemProp.NearContentHorizontalAlignment v)
    let nearContentVerticalAlignment v : obj = box (StepProgressBarItemProp.NearContentVerticalAlignment v)
    let farContent v : obj = box (StepProgressBarItemProp.FarContent v)
    let farContentTemplate v : obj = box (StepProgressBarItemProp.FarContentTemplate v)
    let farContentTemplateSelector v : obj = box (StepProgressBarItemProp.FarContentTemplateSelector v)
    let indicatorBorderSize v : obj = box (StepProgressBarItemProp.IndicatorBorderSize v)
    let indicatorGeometry v : obj = box (StepProgressBarItemProp.IndicatorGeometry v)
    let hoverBackground v : obj = box (StepProgressBarItemProp.HoverBackground v)
    let hoverBorderBrush v : obj = box (StepProgressBarItemProp.HoverBorderBrush v)
    let farContentVerticalAlignment v : obj = box (StepProgressBarItemProp.FarContentVerticalAlignment v)
    let farContentHorizontalAlignment v : obj = box (StepProgressBarItemProp.FarContentHorizontalAlignment v)

    let apply (el: DevExpress.Xpf.Controls.StepProgressBarItem) (prop: StepProgressBarItemProp) =
        match prop with
        | StepProgressBarItemProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.IsSelectedProperty, box v)
        | StepProgressBarItemProp.State v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.StateProperty, box v)
        | StepProgressBarItemProp.NearContent v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.NearContentProperty, box v)
        | StepProgressBarItemProp.NearContentTemplate v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.NearContentTemplateProperty, box v)
        | StepProgressBarItemProp.NearContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.NearContentTemplateSelectorProperty, box v)
        | StepProgressBarItemProp.NearContentHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.NearContentHorizontalAlignmentProperty, box v)
        | StepProgressBarItemProp.NearContentVerticalAlignment v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.NearContentVerticalAlignmentProperty, box v)
        | StepProgressBarItemProp.FarContent v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.FarContentProperty, box v)
        | StepProgressBarItemProp.FarContentTemplate v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.FarContentTemplateProperty, box v)
        | StepProgressBarItemProp.FarContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.FarContentTemplateSelectorProperty, box v)
        | StepProgressBarItemProp.IndicatorBorderSize v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.IndicatorBorderSizeProperty, box v)
        | StepProgressBarItemProp.IndicatorGeometry v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.IndicatorGeometryProperty, box v)
        | StepProgressBarItemProp.HoverBackground v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.HoverBackgroundProperty, box v)
        | StepProgressBarItemProp.HoverBorderBrush v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.HoverBorderBrushProperty, box v)
        | StepProgressBarItemProp.FarContentVerticalAlignment v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.FarContentVerticalAlignmentProperty, box v)
        | StepProgressBarItemProp.FarContentHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Controls.StepProgressBarItem.FarContentHorizontalAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.StepProgressBarItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
