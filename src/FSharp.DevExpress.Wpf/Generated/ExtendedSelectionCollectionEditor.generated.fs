...
type ExtendedSelectionCollectionEditorProp =
    | Base of CollectionEditorBaseProp
    | SelectedItems of obj

module ExtendedSelectionCollectionEditor =
    let selectedItems v : obj = box (ExtendedSelectionCollectionEditorProp.SelectedItems v)

    let apply (el: DevExpress.Xpf.Diagram.Native.ExtendedSelectionCollectionEditor) (prop: ExtendedSelectionCollectionEditorProp) =
        match prop with
        | ExtendedSelectionCollectionEditorProp.Base p -> CollectionEditorBase.apply el p
        | ExtendedSelectionCollectionEditorProp.SelectedItems v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ExtendedSelectionCollectionEditor.SelectedItemsProperty, box v)
