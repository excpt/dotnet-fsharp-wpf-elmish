...
type AppointmentsItemControlProp =
    | Base of XPFItemsControlProp
    | View of DevExpress.Xpf.Scheduler.SchedulerViewBase

module AppointmentsItemControl =
    let view v : obj = box (AppointmentsItemControlProp.View v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentsItemControl) (prop: AppointmentsItemControlProp) =
        match prop with
        | AppointmentsItemControlProp.Base p -> XPFItemsControl.apply el p
        | AppointmentsItemControlProp.View v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentsItemControl.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentsItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
