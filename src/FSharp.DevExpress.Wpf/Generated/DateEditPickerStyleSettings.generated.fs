...
type DateEditPickerStyleSettingsProp =
    | Base of DateEditStyleSettingsBaseProp
    | HourStep of obj
    | MinuteStep of obj
    | SecondStep of obj

module DateEditPickerStyleSettings =
    let hourStep v : obj = box (DateEditPickerStyleSettingsProp.HourStep v)
    let minuteStep v : obj = box (DateEditPickerStyleSettingsProp.MinuteStep v)
    let secondStep v : obj = box (DateEditPickerStyleSettingsProp.SecondStep v)

    let apply (el: DevExpress.Xpf.Editors.DateEditPickerStyleSettings) (prop: DateEditPickerStyleSettingsProp) =
        match prop with
        | DateEditPickerStyleSettingsProp.Base p -> DateEditStyleSettingsBase.apply el p
        | DateEditPickerStyleSettingsProp.HourStep v -> el.SetValue(DevExpress.Xpf.Editors.DateEditPickerStyleSettings.HourStepProperty, box v)
        | DateEditPickerStyleSettingsProp.MinuteStep v -> el.SetValue(DevExpress.Xpf.Editors.DateEditPickerStyleSettings.MinuteStepProperty, box v)
        | DateEditPickerStyleSettingsProp.SecondStep v -> el.SetValue(DevExpress.Xpf.Editors.DateEditPickerStyleSettings.SecondStepProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateEditPickerStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
