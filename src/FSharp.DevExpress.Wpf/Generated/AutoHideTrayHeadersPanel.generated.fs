...
type AutoHideTrayHeadersPanelProp =
    | Base of BaseHeadersPanelProp
    | BottomMargin of System.Windows.Thickness
    | LeftMargin of System.Windows.Thickness
    | RightMargin of System.Windows.Thickness
    | TopMargin of System.Windows.Thickness
    | ViewStyle of DevExpress.Xpf.Docking.DockingViewStyle

module AutoHideTrayHeadersPanel =
    let bottomMargin v : obj = box (AutoHideTrayHeadersPanelProp.BottomMargin v)
    let leftMargin v : obj = box (AutoHideTrayHeadersPanelProp.LeftMargin v)
    let rightMargin v : obj = box (AutoHideTrayHeadersPanelProp.RightMargin v)
    let topMargin v : obj = box (AutoHideTrayHeadersPanelProp.TopMargin v)
    let viewStyle v : obj = box (AutoHideTrayHeadersPanelProp.ViewStyle v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel) (prop: AutoHideTrayHeadersPanelProp) =
        match prop with
        | AutoHideTrayHeadersPanelProp.Base p -> BaseHeadersPanel.apply el p
        | AutoHideTrayHeadersPanelProp.BottomMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel.BottomMarginProperty, box v)
        | AutoHideTrayHeadersPanelProp.LeftMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel.LeftMarginProperty, box v)
        | AutoHideTrayHeadersPanelProp.RightMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel.RightMarginProperty, box v)
        | AutoHideTrayHeadersPanelProp.TopMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel.TopMarginProperty, box v)
        | AutoHideTrayHeadersPanelProp.ViewStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel.ViewStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
