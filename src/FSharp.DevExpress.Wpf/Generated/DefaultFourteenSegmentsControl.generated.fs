...
type DefaultFourteenSegmentsControlProp =
    | Base of SymbolPresentationControlProp

module DefaultFourteenSegmentsControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultFourteenSegmentsControl) (prop: DefaultFourteenSegmentsControlProp) =
        match prop with
        | DefaultFourteenSegmentsControlProp.Base p -> SymbolPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultFourteenSegmentsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
