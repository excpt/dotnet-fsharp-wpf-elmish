...
type MagicLightDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightDigitalGaugeBackgroundLayerControl) (prop: MagicLightDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | MagicLightDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
