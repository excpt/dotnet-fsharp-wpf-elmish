...
open System
open System.Windows
open DevExpress.Xpf.Printing.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type WinImageEditProp =
    | Base of BaseEditProp
    | Source of obj
    | ImageSizeMode of DevExpress.XtraPrinting.ImageSizeMode
    ...
    | ShowOpenDialogOnClick of bool
    | ShowMenu of bool

module WinImageEdit =
    let source v : obj = box (WinImageEditProp.Source v)
    let imageSizeMode v : obj = box (WinImageEditProp.ImageSizeMode v)
    let openFileDialogServiceTemplate v : obj = box (WinImageEditProp.OpenFileDialogServiceTemplate v)
    let messageBoxServiceTemplate v : obj = box (WinImageEditProp.MessageBoxServiceTemplate v)
    let emptyContentTemplate v : obj = box (WinImageEditProp.EmptyContentTemplate v)
    let showOpenDialogOnClick v : obj = box (WinImageEditProp.ShowOpenDialogOnClick v)
    let showMenu v : obj = box (WinImageEditProp.ShowMenu v)

    let apply (el: DevExpress.Xpf.Printing.Native.WinImageEdit) (prop: WinImageEditProp) =
        match prop with
        | WinImageEditProp.Base p -> BaseEdit.apply el p
        | WinImageEditProp.Source v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.SourceProperty, box v)
        | WinImageEditProp.ImageSizeMode v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.ImageSizeModeProperty, box v)
        | WinImageEditProp.OpenFileDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.OpenFileDialogServiceTemplateProperty, box v)
        | WinImageEditProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.MessageBoxServiceTemplateProperty, box v)
        | WinImageEditProp.EmptyContentTemplate v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.EmptyContentTemplateProperty, box v)
        | WinImageEditProp.ShowOpenDialogOnClick v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.ShowOpenDialogOnClickProperty, box v)
        | WinImageEditProp.ShowMenu v -> el.SetValue(DevExpress.Xpf.Printing.Native.WinImageEdit.ShowMenuProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.WinImageEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
