...
type Axis2DPresentationProp =
    | Base of ChartElementBaseProp

module Axis2DPresentation =

    let apply (el: DevExpress.Xpf.Charts.Axis2DPresentation) (prop: Axis2DPresentationProp) =
        match prop with
        | Axis2DPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Axis2DPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
