...
type GlassCylinderBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp
    | RightEdgeSideSurfaceBrush of System.Windows.Media.Brush
    | RightEdgeBaseBrush of System.Windows.Media.Brush
    | MiddleEdgeSideSurfaceBrush of System.Windows.Media.Brush
    | MiddleEdgeBaseBrush of System.Windows.Media.Brush
    | LeftEdgeSideSurfaceBrush of System.Windows.Media.Brush
    | LeftEdgeBaseBrush of System.Windows.Media.Brush

module GlassCylinderBar2DModelControl =
    let rightEdgeSideSurfaceBrush v : obj = box (GlassCylinderBar2DModelControlProp.RightEdgeSideSurfaceBrush v)
    let rightEdgeBaseBrush v : obj = box (GlassCylinderBar2DModelControlProp.RightEdgeBaseBrush v)
    let middleEdgeSideSurfaceBrush v : obj = box (GlassCylinderBar2DModelControlProp.MiddleEdgeSideSurfaceBrush v)
    let middleEdgeBaseBrush v : obj = box (GlassCylinderBar2DModelControlProp.MiddleEdgeBaseBrush v)
    let leftEdgeSideSurfaceBrush v : obj = box (GlassCylinderBar2DModelControlProp.LeftEdgeSideSurfaceBrush v)
    let leftEdgeBaseBrush v : obj = box (GlassCylinderBar2DModelControlProp.LeftEdgeBaseBrush v)

    let apply (el: DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl) (prop: GlassCylinderBar2DModelControlProp) =
        match prop with
        | GlassCylinderBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
        | GlassCylinderBar2DModelControlProp.RightEdgeSideSurfaceBrush v -> el.SetValue(DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl.RightEdgeSideSurfaceBrushProperty, box v)
        | GlassCylinderBar2DModelControlProp.RightEdgeBaseBrush v -> el.SetValue(DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl.RightEdgeBaseBrushProperty, box v)
        | GlassCylinderBar2DModelControlProp.MiddleEdgeSideSurfaceBrush v -> el.SetValue(DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl.MiddleEdgeSideSurfaceBrushProperty, box v)
        | GlassCylinderBar2DModelControlProp.MiddleEdgeBaseBrush v -> el.SetValue(DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl.MiddleEdgeBaseBrushProperty, box v)
        | GlassCylinderBar2DModelControlProp.LeftEdgeSideSurfaceBrush v -> el.SetValue(DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl.LeftEdgeSideSurfaceBrushProperty, box v)
        | GlassCylinderBar2DModelControlProp.LeftEdgeBaseBrush v -> el.SetValue(DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl.LeftEdgeBaseBrushProperty, box v)

    let pointColor v : obj = box (PredefinedModelControlProp.PointColor v)
    let flipped v : obj = box (ModelControlProp.Flipped v)
    let presentationData v : obj = box (ModelControlProp.PresentationData v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GlassCylinderBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
