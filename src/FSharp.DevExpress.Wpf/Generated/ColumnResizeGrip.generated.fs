...
type ColumnResizeGripProp =
    | Base of DXThumbProp

module ColumnResizeGrip =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ColumnResizeGrip) (prop: ColumnResizeGripProp) =
        match prop with
        | ColumnResizeGripProp.Base p -> DXThumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ColumnResizeGrip>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
