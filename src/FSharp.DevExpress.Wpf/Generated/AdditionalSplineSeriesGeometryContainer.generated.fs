...
type AdditionalSplineSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalSplineSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineSeriesGeometryContainer) (prop: AdditionalSplineSeriesGeometryContainerProp) =
        match prop with
        | AdditionalSplineSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
