...
type ColorPickerDataContentPresenterProp =
    | Base of DataContentPresenterProp

module ColorPickerDataContentPresenter =

    let apply (el: DevExpress.Xpf.Editors.Internal.ColorPickerDataContentPresenter) (prop: ColorPickerDataContentPresenterProp) =
        match prop with
        | ColorPickerDataContentPresenterProp.Base p -> DataContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.ColorPickerDataContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
