...
type BarItemLinkMenuHeaderContentControlProp =
    | ContentBorderThickness of System.Windows.Thickness
    | ContentCornerRadius of System.Windows.CornerRadius

module BarItemLinkMenuHeaderContentControl =
    let contentBorderThickness v : obj = box (BarItemLinkMenuHeaderContentControlProp.ContentBorderThickness v)
    let contentCornerRadius v : obj = box (BarItemLinkMenuHeaderContentControlProp.ContentCornerRadius v)

    let apply (el: DevExpress.Xpf.Bars.BarItemLinkMenuHeaderContentControl) (prop: BarItemLinkMenuHeaderContentControlProp) =
        match prop with
        | BarItemLinkMenuHeaderContentControlProp.ContentBorderThickness v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderContentControl.ContentBorderThicknessProperty, box v)
        | BarItemLinkMenuHeaderContentControlProp.ContentCornerRadius v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderContentControl.ContentCornerRadiusProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemLinkMenuHeaderContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
