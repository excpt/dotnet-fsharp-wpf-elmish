...
type MagicLightScaleLabelControlProp =
    | Base of PresentationControlProp

module MagicLightScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightScaleLabelControl) (prop: MagicLightScaleLabelControlProp) =
        match prop with
        | MagicLightScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
