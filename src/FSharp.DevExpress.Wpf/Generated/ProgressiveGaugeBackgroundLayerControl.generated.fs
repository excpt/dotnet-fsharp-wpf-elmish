...
type ProgressiveGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveGaugeBackgroundLayerControl) (prop: ProgressiveGaugeBackgroundLayerControlProp) =
        match prop with
        | ProgressiveGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
