...
module ScaleCustomElement =
    let content v : obj = box (ScaleCustomElementProp.Content v)
    let contentTemplate v : obj = box (ScaleCustomElementProp.ContentTemplate v)
    let visible v : obj = box (ScaleCustomElementProp.Visible v)
    let zIndex v : obj = box (ScaleCustomElementProp.ZIndex v)

    let apply (el: DevExpress.Xpf.Gauges.ScaleCustomElement) (prop: ScaleCustomElementProp) =
        match prop with
        | ScaleCustomElementProp.Base p -> GaugeElement.apply el p
        | ScaleCustomElementProp.Content v -> el.SetValue(DevExpress.Xpf.Gauges.ScaleCustomElement.ContentProperty, box v)
        | ScaleCustomElementProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Gauges.ScaleCustomElement.ContentTemplateProperty, box v)
        | ScaleCustomElementProp.Visible v -> el.SetValue(DevExpress.Xpf.Gauges.ScaleCustomElement.VisibleProperty, box v)
        | ScaleCustomElementProp.ZIndex v -> el.SetValue(DevExpress.Xpf.Gauges.ScaleCustomElement.ZIndexProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ScaleCustomElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
