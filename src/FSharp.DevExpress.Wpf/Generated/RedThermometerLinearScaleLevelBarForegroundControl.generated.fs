...
type RedThermometerLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module RedThermometerLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.RedThermometerLinearScaleLevelBarForegroundControl) (prop: RedThermometerLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | RedThermometerLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedThermometerLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
