...
type BarSideBySideSeries3DProp =
    | Base of BarSeries3DProp

module BarSideBySideSeries3D =

    let apply (el: DevExpress.Xpf.Charts.BarSideBySideSeries3D) (prop: BarSideBySideSeries3DProp) =
        match prop with
        | BarSideBySideSeries3DProp.Base p -> BarSeries3D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BarSideBySideSeries3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
