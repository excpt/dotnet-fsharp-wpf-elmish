...
type CaptionControlProp =
    | Base of AppearanceControlProp
    | Target of System.Windows.UIElement
    | TextWrapping of System.Windows.TextWrapping
    | CaptionText of string
    | Appearance of DevExpress.Xpf.Docking.AppearanceObject
    | AlternateForeground of System.Windows.Media.Brush
    | ShowCaptionImage of bool
    | CaptionImage of System.Windows.Media.ImageSource

module CaptionControl =
    let target v : obj = box (CaptionControlProp.Target v)
    let textWrapping v : obj = box (CaptionControlProp.TextWrapping v)
    let captionText v : obj = box (CaptionControlProp.CaptionText v)
    let appearance v : obj = box (CaptionControlProp.Appearance v)
    let alternateForeground v : obj = box (CaptionControlProp.AlternateForeground v)
    let showCaptionImage v : obj = box (CaptionControlProp.ShowCaptionImage v)
    let captionImage v : obj = box (CaptionControlProp.CaptionImage v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.CaptionControl) (prop: CaptionControlProp) =
        match prop with
        | CaptionControlProp.Base p -> AppearanceControl.apply el p
        | CaptionControlProp.Target v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.TargetProperty, box v)
        | CaptionControlProp.TextWrapping v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.TextWrappingProperty, box v)
        | CaptionControlProp.CaptionText v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.CaptionTextProperty, box v)
        | CaptionControlProp.Appearance v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.AppearanceProperty, box v)
        | CaptionControlProp.AlternateForeground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.AlternateForegroundProperty, box v)
        | CaptionControlProp.ShowCaptionImage v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.ShowCaptionImageProperty, box v)
        | CaptionControlProp.CaptionImage v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.CaptionControl.CaptionImageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.CaptionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
