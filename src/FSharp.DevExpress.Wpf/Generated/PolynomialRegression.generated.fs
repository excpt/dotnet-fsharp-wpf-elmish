...
type PolynomialRegressionProp =
    | Base of ParametricRegressionProp

module PolynomialRegression =

    let apply (el: DevExpress.Xpf.Charts.PolynomialRegression) (prop: PolynomialRegressionProp) =
        match prop with
        | PolynomialRegressionProp.Base p -> ParametricRegression.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolynomialRegression>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
