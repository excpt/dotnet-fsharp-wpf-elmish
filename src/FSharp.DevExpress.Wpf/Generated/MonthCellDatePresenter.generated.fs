...
type MonthCellDatePresenterProp =
    | Base of FastTextBlockProp

module MonthCellDatePresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthCellDatePresenter) (prop: MonthCellDatePresenterProp) =
        match prop with
        | MonthCellDatePresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MonthCellDatePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
