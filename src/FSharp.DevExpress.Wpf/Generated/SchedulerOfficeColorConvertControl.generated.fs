...
type SchedulerOfficeColorConvertControlProp =
    | Base of SchedulerColorConvertControlProp

module SchedulerOfficeColorConvertControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerOfficeColorConvertControl) (prop: SchedulerOfficeColorConvertControlProp) =
        match prop with
        | SchedulerOfficeColorConvertControlProp.Base p -> SchedulerColorConvertControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SchedulerOfficeColorConvertControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
