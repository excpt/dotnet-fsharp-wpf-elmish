...
type ToggleSwitchEditProp =
    | Base of BaseEditProp
    | IsChecked of obj
    | IsThreeState of bool
    | CheckedStateContent of obj
    | UncheckedStateContent of obj
    | EnableAnimation of bool
    | ContentPlacement of DevExpress.Xpf.Editors.ToggleSwitchContentPlacement
    | ToggleSwitchWidth of float
    | ToggleSwitchHeight of float
    | CheckedStateContentTemplate of System.Windows.DataTemplate
    | UncheckedStateContentTemplate of System.Windows.DataTemplate
    ...
    | AnimationMode of DevExpress.Xpf.Editors.ToggleSwitchAnimationMode
    | SwitchThumbTemplate of System.Windows.DataTemplate
    | SwitchBorderTemplate of System.Windows.DataTemplate
    | UndefinedStateContent of obj
    | UndefinedStateContentTemplate of System.Windows.DataTemplate
...
module ToggleSwitchEdit =
    let isChecked v : obj = box (ToggleSwitchEditProp.IsChecked v)
    let isThreeState v : obj = box (ToggleSwitchEditProp.IsThreeState v)
    let checkedStateContent v : obj = box (ToggleSwitchEditProp.CheckedStateContent v)
    let uncheckedStateContent v : obj = box (ToggleSwitchEditProp.UncheckedStateContent v)
    let enableAnimation v : obj = box (ToggleSwitchEditProp.EnableAnimation v)
    let contentPlacement v : obj = box (ToggleSwitchEditProp.ContentPlacement v)
    let toggleSwitchWidth v : obj = box (ToggleSwitchEditProp.ToggleSwitchWidth v)
    let toggleSwitchHeight v : obj = box (ToggleSwitchEditProp.ToggleSwitchHeight v)
    let checkedStateContentTemplate v : obj = box (ToggleSwitchEditProp.CheckedStateContentTemplate v)
    let uncheckedStateContentTemplate v : obj = box (ToggleSwitchEditProp.UncheckedStateContentTemplate v)
    let clickMode v : obj = box (ToggleSwitchEditProp.ClickMode v)
    let command v : obj = box (ToggleSwitchEditProp.Command v)
    let commandParameter v : obj = box (ToggleSwitchEditProp.CommandParameter v)
    let commandTarget v : obj = box (ToggleSwitchEditProp.CommandTarget v)
    let animationMode v : obj = box (ToggleSwitchEditProp.AnimationMode v)
    let switchThumbTemplate v : obj = box (ToggleSwitchEditProp.SwitchThumbTemplate v)
    let switchBorderTemplate v : obj = box (ToggleSwitchEditProp.SwitchBorderTemplate v)
    let undefinedStateContent v : obj = box (ToggleSwitchEditProp.UndefinedStateContent v)
    let undefinedStateContentTemplate v : obj = box (ToggleSwitchEditProp.UndefinedStateContentTemplate v)
    let onChecked v : obj = box (EventProp(box (ToggleSwitchEditProp.OnChecked v)))
    let onUnchecked v : obj = box (EventProp(box (ToggleSwitchEditProp.OnUnchecked v)))
    let onIndeterminate v : obj = box (EventProp(box (ToggleSwitchEditProp.OnIndeterminate v)))

    let apply (el: DevExpress.Xpf.Editors.ToggleSwitchEdit) (prop: ToggleSwitchEditProp) =
        match prop with
        | ToggleSwitchEditProp.Base p -> BaseEdit.apply el p
        | ToggleSwitchEditProp.IsChecked v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.IsCheckedProperty, box v)
        | ToggleSwitchEditProp.IsThreeState v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.IsThreeStateProperty, box v)
        | ToggleSwitchEditProp.CheckedStateContent v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.CheckedStateContentProperty, box v)
        | ToggleSwitchEditProp.UncheckedStateContent v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.UncheckedStateContentProperty, box v)
        | ToggleSwitchEditProp.EnableAnimation v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.EnableAnimationProperty, box v)
        | ToggleSwitchEditProp.ContentPlacement v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.ContentPlacementProperty, box v)
        | ToggleSwitchEditProp.ToggleSwitchWidth v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.ToggleSwitchWidthProperty, box v)
        | ToggleSwitchEditProp.ToggleSwitchHeight v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.ToggleSwitchHeightProperty, box v)
        | ToggleSwitchEditProp.CheckedStateContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.CheckedStateContentTemplateProperty, box v)
        | ToggleSwitchEditProp.UncheckedStateContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.UncheckedStateContentTemplateProperty, box v)
        | ToggleSwitchEditProp.ClickMode v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.ClickModeProperty, box v)
        | ToggleSwitchEditProp.Command v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.CommandProperty, box v)
        | ToggleSwitchEditProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.CommandParameterProperty, box v)
        | ToggleSwitchEditProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.CommandTargetProperty, box v)
        | ToggleSwitchEditProp.AnimationMode v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.AnimationModeProperty, box v)
        | ToggleSwitchEditProp.SwitchThumbTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.SwitchThumbTemplateProperty, box v)
        | ToggleSwitchEditProp.SwitchBorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.SwitchBorderTemplateProperty, box v)
        | ToggleSwitchEditProp.UndefinedStateContent v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.UndefinedStateContentProperty, box v)
        | ToggleSwitchEditProp.UndefinedStateContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ToggleSwitchEdit.UndefinedStateContentTemplateProperty, box v)
        | ToggleSwitchEditProp.OnChecked h -> el.Checked.AddHandler(h)
        | ToggleSwitchEditProp.OnUnchecked h -> el.Unchecked.AddHandler(h)
        | ToggleSwitchEditProp.OnIndeterminate h -> el.Indeterminate.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ToggleSwitchEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
