...
type AutoHideResizePointerProp =
    | Base of psvControlProp
    | Dock of System.Windows.Controls.Dock

module AutoHideResizePointer =
    let dock v : obj = box (AutoHideResizePointerProp.Dock v)

    let apply (el: DevExpress.Xpf.Docking.Platform.AutoHideResizePointer) (prop: AutoHideResizePointerProp) =
        match prop with
        | AutoHideResizePointerProp.Base p -> psvControl.apply el p
        | AutoHideResizePointerProp.Dock v -> el.SetValue(DevExpress.Xpf.Docking.Platform.AutoHideResizePointer.DockProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.AutoHideResizePointer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
