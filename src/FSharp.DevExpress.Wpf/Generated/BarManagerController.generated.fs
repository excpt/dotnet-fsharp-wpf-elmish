...
type BarManagerControllerProp =
    | Base of BarManagerControllerBaseProp

module BarManagerController =

    let apply (el: DevExpress.Xpf.Bars.BarManagerController) (prop: BarManagerControllerProp) =
        match prop with
        | BarManagerControllerProp.Base p -> BarManagerControllerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarManagerController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
