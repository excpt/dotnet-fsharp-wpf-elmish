...
type DiagramMasterDetailEditorViewProp =
    | Base of MasterDetailEditorViewBaseProp

module DiagramMasterDetailEditorView =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.DiagramMasterDetailEditorView) (prop: DiagramMasterDetailEditorViewProp) =
        match prop with
        | DiagramMasterDetailEditorViewProp.Base p -> MasterDetailEditorViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.DiagramMasterDetailEditorView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
