...
type HamburgerSubMenuMoreButtonProp =
    | IsOwnerSubMenuOpened of bool
    | IsSelected of bool

module HamburgerSubMenuMoreButton =
    let isOwnerSubMenuOpened v : obj = box (HamburgerSubMenuMoreButtonProp.IsOwnerSubMenuOpened v)
    let isSelected v : obj = box (HamburgerSubMenuMoreButtonProp.IsSelected v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuMoreButton) (prop: HamburgerSubMenuMoreButtonProp) =
        match prop with
        | HamburgerSubMenuMoreButtonProp.IsOwnerSubMenuOpened v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuMoreButton.IsOwnerSubMenuOpenedProperty, box v)
        | HamburgerSubMenuMoreButtonProp.IsSelected v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuMoreButton.IsSelectedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuMoreButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
