...
type CircularEcoHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularEcoHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularEcoHalfTopModel) (prop: CircularEcoHalfTopModelProp) =
        match prop with
        | CircularEcoHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularEcoHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
