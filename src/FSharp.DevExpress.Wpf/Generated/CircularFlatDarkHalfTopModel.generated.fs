...
type CircularFlatDarkHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatDarkHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatDarkHalfTopModel) (prop: CircularFlatDarkHalfTopModelProp) =
        match prop with
        | CircularFlatDarkHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatDarkHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
