...
type BarSplitButtonItemArrowControlProp =
    | Base of ArrowControlProp

module BarSplitButtonItemArrowControl =

    let apply (el: DevExpress.Xpf.Bars.BarSplitButtonItemArrowControl) (prop: BarSplitButtonItemArrowControlProp) =
        match prop with
        | BarSplitButtonItemArrowControlProp.Base p -> ArrowControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarSplitButtonItemArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
