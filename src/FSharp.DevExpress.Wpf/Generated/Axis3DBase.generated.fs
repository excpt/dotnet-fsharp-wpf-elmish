...
module Axis3DBase =
    ...
    let apply (el: DevExpress.Xpf.Charts.Axis3DBase) (prop: Axis3DBaseProp) =
        match prop with
        | Axis3DBaseProp.Base p -> Axis3D.apply el p
        | Axis3DBaseProp.CrosshairAxisLabelOptions v -> el.SetValue(DevExpress.Xpf.Charts.Axis3DBase.CrosshairAxisLabelOptionsProperty, box v)
        | Axis3DBaseProp.CrosshairLabelTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Axis3DBase.CrosshairLabelTemplateProperty, box v)
