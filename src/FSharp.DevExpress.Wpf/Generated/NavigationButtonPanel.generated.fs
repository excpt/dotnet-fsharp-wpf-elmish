...
type NavigationButtonPanelProp =
    | Base of RotatablePanelBaseProp

module NavigationButtonPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.NavigationButtonPanel) (prop: NavigationButtonPanelProp) =
        match prop with
        | NavigationButtonPanelProp.Base p -> RotatablePanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.NavigationButtonPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
