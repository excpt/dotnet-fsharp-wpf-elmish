...
type MasterDetailEditorDiagramControlProp =
    | Base of DiagramControlProp

module MasterDetailEditorDiagramControl =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditorDiagramControl) (prop: MasterDetailEditorDiagramControlProp) =
        match prop with
        | MasterDetailEditorDiagramControlProp.Base p -> DiagramControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditorDiagramControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
