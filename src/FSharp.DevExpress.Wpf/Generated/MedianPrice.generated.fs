...
type MedianPriceProp =
    | Base of IndicatorProp

module MedianPrice =

    let apply (el: DevExpress.Xpf.Charts.MedianPrice) (prop: MedianPriceProp) =
        match prop with
        | MedianPriceProp.Base p -> Indicator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.MedianPrice>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
