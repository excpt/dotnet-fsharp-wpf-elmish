...
type GradientLegendItemPanelProp =
    | GradientControl of System.Windows.FrameworkElement

module GradientLegendItemPanel =
    let gradientControl v : obj = box (GradientLegendItemPanelProp.GradientControl v)

    let apply (el: DevExpress.Xpf.Charts.GradientLegendItemPanel) (prop: GradientLegendItemPanelProp) =
        match prop with
        | GradientLegendItemPanelProp.GradientControl v -> el.SetValue(DevExpress.Xpf.Charts.GradientLegendItemPanel.GradientControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GradientLegendItemPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
