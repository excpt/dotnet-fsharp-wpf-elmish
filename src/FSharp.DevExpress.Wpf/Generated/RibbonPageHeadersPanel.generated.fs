...
type RibbonPageHeadersPanelProp =
    | Toolbar of System.Windows.UIElement
    | PageHeadersContainer of System.Windows.UIElement
    | Ribbon of DevExpress.Xpf.Ribbon.RibbonControl

module RibbonPageHeadersPanel =
    let toolbar v : obj = box (RibbonPageHeadersPanelProp.Toolbar v)
    let pageHeadersContainer v : obj = box (RibbonPageHeadersPanelProp.PageHeadersContainer v)
    let ribbon v : obj = box (RibbonPageHeadersPanelProp.Ribbon v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageHeadersPanel) (prop: RibbonPageHeadersPanelProp) =
        match prop with
        | RibbonPageHeadersPanelProp.Toolbar v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeadersPanel.ToolbarProperty, box v)
        | RibbonPageHeadersPanelProp.PageHeadersContainer v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeadersPanel.PageHeadersContainerProperty, box v)
        | RibbonPageHeadersPanelProp.Ribbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageHeadersPanel.RibbonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageHeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
