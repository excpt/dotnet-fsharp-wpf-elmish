...
type Star5MarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module Star5MarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.Star5MarkerModelControl) (prop: Star5MarkerModelControlProp) =
        match prop with
        | Star5MarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.Star5MarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
