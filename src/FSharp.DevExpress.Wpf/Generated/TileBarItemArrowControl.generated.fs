...
type TileBarItemArrowControlProp =
    | Base of TileArrowControlProp

module TileBarItemArrowControl =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileBarItemArrowControl) (prop: TileBarItemArrowControlProp) =
        match prop with
        | TileBarItemArrowControlProp.Base p -> TileArrowControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileBarItemArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
