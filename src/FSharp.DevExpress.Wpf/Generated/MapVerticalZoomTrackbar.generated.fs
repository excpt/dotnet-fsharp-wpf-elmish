...
type MapVerticalZoomTrackbarProp =
    | Base of MapZoomTrackbarProp

module MapVerticalZoomTrackbar =

    let apply (el: DevExpress.Xpf.Map.MapVerticalZoomTrackbar) (prop: MapVerticalZoomTrackbarProp) =
        match prop with
        | MapVerticalZoomTrackbarProp.Base p -> MapZoomTrackbar.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapVerticalZoomTrackbar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
