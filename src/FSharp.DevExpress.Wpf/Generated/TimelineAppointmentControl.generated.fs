...
type TimelineAppointmentControlProp =
    | Base of AppointmentHorizontalControlProp

module TimelineAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimelineAppointmentControl) (prop: TimelineAppointmentControlProp) =
        match prop with
        | TimelineAppointmentControlProp.Base p -> AppointmentHorizontalControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimelineAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
