...
type CellStyleGalleryBarItemLinkControlProp =
    | Base of RibbonGalleryBarItemLinkControlProp

module CellStyleGalleryBarItemLinkControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.CellStyleGalleryBarItemLinkControl) (prop: CellStyleGalleryBarItemLinkControlProp) =
        match prop with
        | CellStyleGalleryBarItemLinkControlProp.Base p -> RibbonGalleryBarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.CellStyleGalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
