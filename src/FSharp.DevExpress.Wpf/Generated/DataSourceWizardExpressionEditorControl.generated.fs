...
type DataSourceWizardExpressionEditorControlProp =
    | Base of ExpressionEditorControlProp
    | ParameterService of DevExpress.DataAccess.Wizard.Services.IParameterService

module DataSourceWizardExpressionEditorControl =
    let parameterService v : obj = box (DataSourceWizardExpressionEditorControlProp.ParameterService v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionEditorControl) (prop: DataSourceWizardExpressionEditorControlProp) =
        match prop with
        | DataSourceWizardExpressionEditorControlProp.Base p -> ExpressionEditorControl.apply el p
        | DataSourceWizardExpressionEditorControlProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionEditorControl.ParameterServiceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
