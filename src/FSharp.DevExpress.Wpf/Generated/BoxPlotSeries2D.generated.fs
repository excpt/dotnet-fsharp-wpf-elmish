...
type BoxPlotSeries2DProp =
    | Base of XYSeries2DProp
    | BoxWidth of float
    | PointAnimation of DevExpress.Xpf.Charts.BoxPlot2DAnimationBase
    | Model of DevExpress.Xpf.Charts.BoxPlot2DModel
    | CapWidthPercentage of float
    | MinValueDataMember of string
    | Quartile1ValueDataMember of string
    | MedianValueDataMember of string
    | Quartile3ValueDataMember of string
    | MaxValueDataMember of string
    | MeanValueDataMember of string
    | OutlierValuesDataMember of string
    | MeanLineVisible of bool
    | MeanLineStyle of DevExpress.Xpf.Charts.LineStyle
    | SeriesAnimation of DevExpress.Xpf.Charts.Line2DAnimationBase

module BoxPlotSeries2D =
    let boxWidth v : obj = box (BoxPlotSeries2DProp.BoxWidth v)
    let pointAnimation v : obj = box (BoxPlotSeries2DProp.PointAnimation v)
    let model v : obj = box (BoxPlotSeries2DProp.Model v)
    let capWidthPercentage v : obj = box (BoxPlotSeries2DProp.CapWidthPercentage v)
    let minValueDataMember v : obj = box (BoxPlotSeries2DProp.MinValueDataMember v)
    let quartile1ValueDataMember v : obj = box (BoxPlotSeries2DProp.Quartile1ValueDataMember v)
    let medianValueDataMember v : obj = box (BoxPlotSeries2DProp.MedianValueDataMember v)
    let quartile3ValueDataMember v : obj = box (BoxPlotSeries2DProp.Quartile3ValueDataMember v)
    let maxValueDataMember v : obj = box (BoxPlotSeries2DProp.MaxValueDataMember v)
    let meanValueDataMember v : obj = box (BoxPlotSeries2DProp.MeanValueDataMember v)
    let outlierValuesDataMember v : obj = box (BoxPlotSeries2DProp.OutlierValuesDataMember v)
    let meanLineVisible v : obj = box (BoxPlotSeries2DProp.MeanLineVisible v)
    let meanLineStyle v : obj = box (BoxPlotSeries2DProp.MeanLineStyle v)
    let seriesAnimation v : obj = box (BoxPlotSeries2DProp.SeriesAnimation v)

    let apply (el: DevExpress.Xpf.Charts.BoxPlotSeries2D) (prop: BoxPlotSeries2DProp) =
        match prop with
        | BoxPlotSeries2DProp.Base p -> XYSeries2D.apply el p
        | BoxPlotSeries2DProp.BoxWidth v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.BoxWidthProperty, box v)
        | BoxPlotSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.PointAnimationProperty, box v)
        | BoxPlotSeries2DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.ModelProperty, box v)
        | BoxPlotSeries2DProp.CapWidthPercentage v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.CapWidthPercentageProperty, box v)
        | BoxPlotSeries2DProp.MinValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.MinValueDataMemberProperty, box v)
        | BoxPlotSeries2DProp.Quartile1ValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.Quartile1ValueDataMemberProperty, box v)
        | BoxPlotSeries2DProp.MedianValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.MedianValueDataMemberProperty, box v)
        | BoxPlotSeries2DProp.Quartile3ValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.Quartile3ValueDataMemberProperty, box v)
        | BoxPlotSeries2DProp.MaxValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.MaxValueDataMemberProperty, box v)
        | BoxPlotSeries2DProp.MeanValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.MeanValueDataMemberProperty, box v)
        | BoxPlotSeries2DProp.OutlierValuesDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.OutlierValuesDataMemberProperty, box v)
        | BoxPlotSeries2DProp.MeanLineVisible v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.MeanLineVisibleProperty, box v)
        | BoxPlotSeries2DProp.MeanLineStyle v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.MeanLineStyleProperty, box v)
        | BoxPlotSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.BoxPlotSeries2D.SeriesAnimationProperty, box v)
    ...
    let values (v: DevExpress.Xpf.Charts.BoxPlotValuesBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BoxPlotSeries2D.ValuesProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.BoxPlotSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
