...
type DataSourceBaseProp =
    | Base of SimpleDataSourceBaseProp
    | ContextType of System.Type
    | Path of string
...
module DataSourceBase =
    ...
    let apply (el: DevExpress.Xpf.Core.DataSources.DataSourceBase) (prop: DataSourceBaseProp) =
        match prop with
        | DataSourceBaseProp.Base p -> SimpleDataSourceBase.apply el p
        | DataSourceBaseProp.ContextType v -> el.SetValue(DevExpress.Xpf.Core.DataSources.DataSourceBase.ContextTypeProperty, box v)
        | DataSourceBaseProp.Path v -> el.SetValue(DevExpress.Xpf.Core.DataSources.DataSourceBase.PathProperty, box v)
