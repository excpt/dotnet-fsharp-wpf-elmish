...
type AdditionalSplineAreaBorderSeriesGeometryProp =
    | Base of AdditionalAreaBorderSeriesGeometryProp

module AdditionalSplineAreaBorderSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineAreaBorderSeriesGeometry) (prop: AdditionalSplineAreaBorderSeriesGeometryProp) =
        match prop with
        | AdditionalSplineAreaBorderSeriesGeometryProp.Base p -> AdditionalAreaBorderSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineAreaBorderSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
