...
type FlyoutDecoratorProp =
    | FlyoutShowMode of DevExpress.Xpf.Navigation.FlyoutShowMode

module FlyoutDecorator =
    let flyoutShowMode v : obj = box (FlyoutDecoratorProp.FlyoutShowMode v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.FlyoutDecorator) (prop: FlyoutDecoratorProp) =
        match prop with
        | FlyoutDecoratorProp.FlyoutShowMode v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlyoutDecorator.FlyoutShowModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.FlyoutDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
