...
type PropertyGridViewKindSelectorControlProp =
    | ShowCategories of DevExpress.Xpf.PropertyGrid.CategoriesShowMode
    | Grid of obj

module PropertyGridViewKindSelectorControl =
    let showCategories v : obj = box (PropertyGridViewKindSelectorControlProp.ShowCategories v)
    let grid v : obj = box (PropertyGridViewKindSelectorControlProp.Grid v)

    let apply (el: DevExpress.Xpf.PropertyGrid.PropertyGridViewKindSelectorControl) (prop: PropertyGridViewKindSelectorControlProp) =
        match prop with
        | PropertyGridViewKindSelectorControlProp.ShowCategories v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyGridViewKindSelectorControl.ShowCategoriesProperty, box v)
        | PropertyGridViewKindSelectorControlProp.Grid v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyGridViewKindSelectorControl.PropertyGridProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PropertyGridViewKindSelectorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
