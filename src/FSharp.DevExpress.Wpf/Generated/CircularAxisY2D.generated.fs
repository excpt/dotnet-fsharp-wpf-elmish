...
type CircularAxisY2DProp =
    | Base of AxisBaseProp
    | DateTimeMeasureUnit of DevExpress.Xpf.Charts.DateTimeMeasurementUnit
    | DateTimeGridAlignment of DevExpress.Xpf.Charts.DateTimeMeasurementUnit
    | DateTimeOptions of DevExpress.Xpf.Charts.DateTimeOptions
    | Range of DevExpress.Xpf.Charts.AxisRange
    | WholeRange of DevExpress.Xpf.Charts.Range
    | Logarithmic of bool
    | LogarithmicBase of float
    | Thickness of int
    ...
    | Visible of bool
    | DateTimeScaleOptions of DevExpress.Xpf.Charts.ContinuousDateTimeScaleOptions
    | TimeSpanScaleOptions of DevExpress.Xpf.Charts.ContinuousTimeSpanScaleOptions
    | NumericScaleOptions of DevExpress.Xpf.Charts.ContinuousNumericScaleOptions

module CircularAxisY2D =
    let dateTimeMeasureUnit v : obj = box (CircularAxisY2DProp.DateTimeMeasureUnit v)
    let dateTimeGridAlignment v : obj = box (CircularAxisY2DProp.DateTimeGridAlignment v)
    let dateTimeOptions v : obj = box (CircularAxisY2DProp.DateTimeOptions v)
    let range v : obj = box (CircularAxisY2DProp.Range v)
    let wholeRange v : obj = box (CircularAxisY2DProp.WholeRange v)
    let logarithmic v : obj = box (CircularAxisY2DProp.Logarithmic v)
    let logarithmicBase v : obj = box (CircularAxisY2DProp.LogarithmicBase v)
    let thickness v : obj = box (CircularAxisY2DProp.Thickness v)
    let brush v : obj = box (CircularAxisY2DProp.Brush v)
    let tickmarksVisible v : obj = box (CircularAxisY2DProp.TickmarksVisible v)
    let tickmarksMinorVisible v : obj = box (CircularAxisY2DProp.TickmarksMinorVisible v)
    let tickmarksThickness v : obj = box (CircularAxisY2DProp.TickmarksThickness v)
    let tickmarksMinorThickness v : obj = box (CircularAxisY2DProp.TickmarksMinorThickness v)
    let tickmarksLength v : obj = box (CircularAxisY2DProp.TickmarksLength v)
    let tickmarksMinorLength v : obj = box (CircularAxisY2DProp.TickmarksMinorLength v)
    let tickmarksCrossAxis v : obj = box (CircularAxisY2DProp.TickmarksCrossAxis v)
    let visible v : obj = box (CircularAxisY2DProp.Visible v)
    let dateTimeScaleOptions v : obj = box (CircularAxisY2DProp.DateTimeScaleOptions v)
    let timeSpanScaleOptions v : obj = box (CircularAxisY2DProp.TimeSpanScaleOptions v)
    let numericScaleOptions v : obj = box (CircularAxisY2DProp.NumericScaleOptions v)

    let apply (el: DevExpress.Xpf.Charts.CircularAxisY2D) (prop: CircularAxisY2DProp) =
        match prop with
        | CircularAxisY2DProp.Base p -> AxisBase.apply el p
        | CircularAxisY2DProp.DateTimeMeasureUnit v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.DateTimeMeasureUnitProperty, box v)
        | CircularAxisY2DProp.DateTimeGridAlignment v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.DateTimeGridAlignmentProperty, box v)
        | CircularAxisY2DProp.DateTimeOptions v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.DateTimeOptionsProperty, box v)
        | CircularAxisY2DProp.Range v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.RangeProperty, box v)
        | CircularAxisY2DProp.WholeRange v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.WholeRangeProperty, box v)
        | CircularAxisY2DProp.Logarithmic v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.LogarithmicProperty, box v)
        | CircularAxisY2DProp.LogarithmicBase v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.LogarithmicBaseProperty, box v)
        | CircularAxisY2DProp.Thickness v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.ThicknessProperty, box v)
        | CircularAxisY2DProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.BrushProperty, box v)
        | CircularAxisY2DProp.TickmarksVisible v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksVisibleProperty, box v)
        | CircularAxisY2DProp.TickmarksMinorVisible v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksMinorVisibleProperty, box v)
        | CircularAxisY2DProp.TickmarksThickness v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksThicknessProperty, box v)
        | CircularAxisY2DProp.TickmarksMinorThickness v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksMinorThicknessProperty, box v)
        | CircularAxisY2DProp.TickmarksLength v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksLengthProperty, box v)
        | CircularAxisY2DProp.TickmarksMinorLength v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksMinorLengthProperty, box v)
        | CircularAxisY2DProp.TickmarksCrossAxis v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TickmarksCrossAxisProperty, box v)
        | CircularAxisY2DProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.VisibleProperty, box v)
        | CircularAxisY2DProp.DateTimeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.DateTimeScaleOptionsProperty, box v)
        | CircularAxisY2DProp.TimeSpanScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.TimeSpanScaleOptionsProperty, box v)
        | CircularAxisY2DProp.NumericScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisY2D.NumericScaleOptionsProperty, box v)
    ...
    let alwaysShowZeroLevel (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.CircularAxisY2D.AlwaysShowZeroLevelProperty, box v)) :: node.Props }
