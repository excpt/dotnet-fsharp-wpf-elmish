...
type SecondaryAxisX2DProp =
    | Base of AxisX2DProp

module SecondaryAxisX2D =

    let apply (el: DevExpress.Xpf.Charts.SecondaryAxisX2D) (prop: SecondaryAxisX2DProp) =
        match prop with
        | SecondaryAxisX2DProp.Base p -> AxisX2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SecondaryAxisX2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
