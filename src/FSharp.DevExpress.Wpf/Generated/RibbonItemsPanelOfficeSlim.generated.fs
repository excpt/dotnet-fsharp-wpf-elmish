...
type RibbonItemsPanelOfficeSlimProp =
    | Base of RibbonItemsPanelProp

module RibbonItemsPanelOfficeSlim =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonItemsPanelOfficeSlim) (prop: RibbonItemsPanelOfficeSlimProp) =
        match prop with
        | RibbonItemsPanelOfficeSlimProp.Base p -> RibbonItemsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonItemsPanelOfficeSlim>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
