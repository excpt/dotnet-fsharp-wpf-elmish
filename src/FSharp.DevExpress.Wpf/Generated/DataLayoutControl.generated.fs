...
type DataLayoutControlProp =
    | Base of LayoutControlProp
    | AddColonToItemLabels of bool
    | AutoGeneratedItemsLocation of DevExpress.Xpf.LayoutControl.DataLayoutControlAutoGeneratedItemsLocation
    | CurrentItem of obj
    | IsReadOnly of bool
    | AutoGenerateItems of bool
    | ItemUpdateSourceTrigger of System.Windows.Data.UpdateSourceTrigger
    | EditorValidationOrder of DevExpress.Xpf.LayoutControl.EditorValidationOrder

module DataLayoutControl =
    let addColonToItemLabels v : obj = box (DataLayoutControlProp.AddColonToItemLabels v)
    let autoGeneratedItemsLocation v : obj = box (DataLayoutControlProp.AutoGeneratedItemsLocation v)
    let currentItem v : obj = box (DataLayoutControlProp.CurrentItem v)
    let isReadOnly v : obj = box (DataLayoutControlProp.IsReadOnly v)
    let autoGenerateItems v : obj = box (DataLayoutControlProp.AutoGenerateItems v)
    let itemUpdateSourceTrigger v : obj = box (DataLayoutControlProp.ItemUpdateSourceTrigger v)
    let editorValidationOrder v : obj = box (DataLayoutControlProp.EditorValidationOrder v)

    let apply (el: DevExpress.Xpf.LayoutControl.DataLayoutControl) (prop: DataLayoutControlProp) =
        match prop with
        | DataLayoutControlProp.Base p -> LayoutControl.apply el p
        | DataLayoutControlProp.AddColonToItemLabels v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.AddColonToItemLabelsProperty, box v)
        | DataLayoutControlProp.AutoGeneratedItemsLocation v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.AutoGeneratedItemsLocationProperty, box v)
        | DataLayoutControlProp.CurrentItem v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.CurrentItemProperty, box v)
        | DataLayoutControlProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.IsReadOnlyProperty, box v)
        | DataLayoutControlProp.AutoGenerateItems v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.AutoGenerateItemsProperty, box v)
        | DataLayoutControlProp.ItemUpdateSourceTrigger v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.ItemUpdateSourceTriggerProperty, box v)
        | DataLayoutControlProp.EditorValidationOrder v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutControl.EditorValidationOrderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.DataLayoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
