...
type OneMonthResourceGroupsPanelProp =
    ...
    | ItemContainerAppointmentsContainerStyle of System.Windows.Style
    | ItemContainerDragAppointmentsContainerStyle of System.Windows.Style
    | ItemContainerVerticalBorderThickness of float
    | ItemContainerHorizontalBorderThickness of float

module OneMonthResourceGroupsPanel =
    let visualData v : obj = box (OneMonthResourceGroupsPanelProp.VisualData v)
    let view v : obj = box (OneMonthResourceGroupsPanelProp.View v)
    let groupSeparatorTemplate v : obj = box (OneMonthResourceGroupsPanelProp.GroupSeparatorTemplate v)
    let itemContainerAppointmentsContainerStyle v : obj = box (OneMonthResourceGroupsPanelProp.ItemContainerAppointmentsContainerStyle v)
    let itemContainerDragAppointmentsContainerStyle v : obj = box (OneMonthResourceGroupsPanelProp.ItemContainerDragAppointmentsContainerStyle v)
    let itemContainerVerticalBorderThickness v : obj = box (OneMonthResourceGroupsPanelProp.ItemContainerVerticalBorderThickness v)
    let itemContainerHorizontalBorderThickness v : obj = box (OneMonthResourceGroupsPanelProp.ItemContainerHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel) (prop: OneMonthResourceGroupsPanelProp) =
        match prop with
        | OneMonthResourceGroupsPanelProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.VisualDataProperty, box v)
        | OneMonthResourceGroupsPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.ViewProperty, box v)
        | OneMonthResourceGroupsPanelProp.GroupSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.GroupSeparatorTemplateProperty, box v)
        | OneMonthResourceGroupsPanelProp.ItemContainerAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.ItemContainerAppointmentsContainerStyleProperty, box v)
        | OneMonthResourceGroupsPanelProp.ItemContainerDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.ItemContainerDragAppointmentsContainerStyleProperty, box v)
        | OneMonthResourceGroupsPanelProp.ItemContainerVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.ItemContainerVerticalBorderThicknessProperty, box v)
        | OneMonthResourceGroupsPanelProp.ItemContainerHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel.ItemContainerHorizontalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthResourceGroupsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
