...
type DayViewGroupByResourceControlProp =
    | Base of DayViewControlBaseProp

module DayViewGroupByResourceControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DayViewGroupByResourceControl) (prop: DayViewGroupByResourceControlProp) =
        match prop with
        | DayViewGroupByResourceControlProp.Base p -> DayViewControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DayViewGroupByResourceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
