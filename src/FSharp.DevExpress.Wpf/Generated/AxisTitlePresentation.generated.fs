...
type AxisTitlePresentationProp =
    | Base of AxisElementTitlePresentationProp

module AxisTitlePresentation =

    let apply (el: DevExpress.Xpf.Charts.AxisTitlePresentation) (prop: AxisTitlePresentationProp) =
        match prop with
        | AxisTitlePresentationProp.Base p -> AxisElementTitlePresentation.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisTitlePresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
