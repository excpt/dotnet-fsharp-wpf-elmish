...
type CircularMagicLightModelProp =
    | Base of CircularGaugeModelProp

module CircularMagicLightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularMagicLightModel) (prop: CircularMagicLightModelProp) =
        match prop with
        | CircularMagicLightModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularMagicLightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
