...
module AztecCodeSymbology =
    let compactionMode v : obj = box (AztecCodeSymbologyProp.CompactionMode v)
    let version v : obj = box (AztecCodeSymbologyProp.Version v)
    let errorCorrectionLevel v : obj = box (AztecCodeSymbologyProp.ErrorCorrectionLevel v)

    let apply (el: DevExpress.Xpf.Controls.AztecCodeSymbology) (prop: AztecCodeSymbologyProp) =
        match prop with
        | AztecCodeSymbologyProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Controls.AztecCodeSymbology.CompactionModeProperty, box v)
        | AztecCodeSymbologyProp.Version v -> el.SetValue(DevExpress.Xpf.Controls.AztecCodeSymbology.VersionProperty, box v)
        | AztecCodeSymbologyProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Controls.AztecCodeSymbology.ErrorCorrectionLevelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.AztecCodeSymbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
