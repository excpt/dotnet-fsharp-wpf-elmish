...
open System
open System.Windows
open DevExpress.Xpf.RichEdit.Controls.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type RichEditViewPageProp =
    | Base of RichEditElementProp
    | CommentsWidth of float
    | CommentsHeight of float
    | CommentsLeft of float
    | CommentsTop of float
    | CommentsVisibility of System.Windows.Visibility

module RichEditViewPage =
    let commentsWidth v : obj = box (RichEditViewPageProp.CommentsWidth v)
    let commentsHeight v : obj = box (RichEditViewPageProp.CommentsHeight v)
    let commentsLeft v : obj = box (RichEditViewPageProp.CommentsLeft v)
    let commentsTop v : obj = box (RichEditViewPageProp.CommentsTop v)
    let commentsVisibility v : obj = box (RichEditViewPageProp.CommentsVisibility v)

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage) (prop: RichEditViewPageProp) =
        match prop with
        | RichEditViewPageProp.Base p -> RichEditElement.apply el p
        | RichEditViewPageProp.CommentsWidth v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage.CommentsWidthProperty, box v)
        | RichEditViewPageProp.CommentsHeight v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage.CommentsHeightProperty, box v)
        | RichEditViewPageProp.CommentsLeft v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage.CommentsLeftProperty, box v)
        | RichEditViewPageProp.CommentsTop v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage.CommentsTopProperty, box v)
        | RichEditViewPageProp.CommentsVisibility v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage.CommentsVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
