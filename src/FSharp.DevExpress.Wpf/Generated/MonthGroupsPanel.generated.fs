...
type MonthGroupsPanelProp =
    | MonthGroupCellContainersPerPage of float
    | MonthGroupCellsCount of float
    | MonthGroupAppointmentsContainerStyle of System.Windows.Style
    | MonthGroupDragAppointmentsContainerStyle of System.Windows.Style
    | MonthGroupAppointmentsDeferredRendering of bool
    | MonthGroupAppointmentsDeferredRenderingRange of int
    | MonthGroupIsAppointmentsOpacityAnimationEnabled of bool
    | MonthGroupAppointmentsOpacityAnimation of System.Windows.Media.Animation.DoubleAnimation

module MonthGroupsPanel =
    let monthGroupCellContainersPerPage v : obj = box (MonthGroupsPanelProp.MonthGroupCellContainersPerPage v)
    let monthGroupCellsCount v : obj = box (MonthGroupsPanelProp.MonthGroupCellsCount v)
    let monthGroupAppointmentsContainerStyle v : obj = box (MonthGroupsPanelProp.MonthGroupAppointmentsContainerStyle v)
    let monthGroupDragAppointmentsContainerStyle v : obj = box (MonthGroupsPanelProp.MonthGroupDragAppointmentsContainerStyle v)
    let monthGroupAppointmentsDeferredRendering v : obj = box (MonthGroupsPanelProp.MonthGroupAppointmentsDeferredRendering v)
    let monthGroupAppointmentsDeferredRenderingRange v : obj = box (MonthGroupsPanelProp.MonthGroupAppointmentsDeferredRenderingRange v)
    let monthGroupIsAppointmentsOpacityAnimationEnabled v : obj = box (MonthGroupsPanelProp.MonthGroupIsAppointmentsOpacityAnimationEnabled v)
    let monthGroupAppointmentsOpacityAnimation v : obj = box (MonthGroupsPanelProp.MonthGroupAppointmentsOpacityAnimation v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel) (prop: MonthGroupsPanelProp) =
        match prop with
        | MonthGroupsPanelProp.MonthGroupCellContainersPerPage v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupCellContainersPerPageProperty, box v)
        | MonthGroupsPanelProp.MonthGroupCellsCount v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupCellsCountProperty, box v)
        | MonthGroupsPanelProp.MonthGroupAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupAppointmentsContainerStyleProperty, box v)
        | MonthGroupsPanelProp.MonthGroupDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupDragAppointmentsContainerStyleProperty, box v)
        | MonthGroupsPanelProp.MonthGroupAppointmentsDeferredRendering v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupAppointmentsDeferredRenderingProperty, box v)
        | MonthGroupsPanelProp.MonthGroupAppointmentsDeferredRenderingRange v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupAppointmentsDeferredRenderingRangeProperty, box v)
        | MonthGroupsPanelProp.MonthGroupIsAppointmentsOpacityAnimationEnabled v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupIsAppointmentsOpacityAnimationEnabledProperty, box v)
        | MonthGroupsPanelProp.MonthGroupAppointmentsOpacityAnimation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel.MonthGroupAppointmentsOpacityAnimationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.MonthGroupsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
