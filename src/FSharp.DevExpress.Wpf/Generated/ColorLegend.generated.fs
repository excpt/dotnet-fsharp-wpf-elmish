...
type ColorLegendProp =
    | Base of ItemsLayerLegendProp
    | CustomItems of DevExpress.Xpf.Map.ColorLegendItemCollection
...
module ColorLegend =
    ...
    let apply (el: DevExpress.Xpf.Map.ColorLegend) (prop: ColorLegendProp) =
        match prop with
        | ColorLegendProp.Base p -> ItemsLayerLegend.apply el p
        | ColorLegendProp.CustomItems v -> el.SetValue(DevExpress.Xpf.Map.ColorLegend.CustomItemsProperty, box v)
        | ColorLegendProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Map.ColorLegend.ItemTemplateProperty, box v)
