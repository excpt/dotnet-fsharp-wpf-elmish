...
type PageViewPanelProp =
    | Base of SplitPanelProp

module PageViewPanel =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.PageViewPanel) (prop: PageViewPanelProp) =
        match prop with
        | PageViewPanelProp.Base p -> SplitPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.PageViewPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
