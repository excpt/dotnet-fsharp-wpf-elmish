...
type FutureArcScaleLineControlProp =
    | Base of PresentationControlProp

module FutureArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureArcScaleLineControl) (prop: FutureArcScaleLineControlProp) =
        match prop with
        | FutureArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
