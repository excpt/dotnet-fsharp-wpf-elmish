...
type PivotFieldsNumberFormatDXDialogProp =
    | Base of CustomDXDialogProp

module PivotFieldsNumberFormatDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotFieldsNumberFormatDXDialog) (prop: PivotFieldsNumberFormatDXDialogProp) =
        match prop with
        | PivotFieldsNumberFormatDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotFieldsNumberFormatDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
