...
type ViewControlBaseProp =
    | HorizontalScrollOffset of float
    | VerticalScrollOffset of float

module ViewControlBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Visual.ViewControlBase) (prop: ViewControlBaseProp) =
        match prop with
        | ViewControlBaseProp.HorizontalScrollOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ViewControlBase.HorizontalScrollOffsetProperty, box v)
        | ViewControlBaseProp.VerticalScrollOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ViewControlBase.VerticalScrollOffsetProperty, box v)
