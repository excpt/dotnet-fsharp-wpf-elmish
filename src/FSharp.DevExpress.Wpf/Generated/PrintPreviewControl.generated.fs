...
type PrintPreviewControlProp =
    | Base of DocumentViewerControlProp
    | Diagram of DevExpress.Xpf.Diagram.DiagramControl
    | PreviewZoomMode of DevExpress.Diagram.Core.PreviewZoomMode

module PrintPreviewControl =
    let diagram v : obj = box (PrintPreviewControlProp.Diagram v)
    let previewZoomMode v : obj = box (PrintPreviewControlProp.PreviewZoomMode v)

    let apply (el: DevExpress.Xpf.Diagram.Native.PrintPreviewControl) (prop: PrintPreviewControlProp) =
        match prop with
        | PrintPreviewControlProp.Base p -> DocumentViewerControl.apply el p
        | PrintPreviewControlProp.Diagram v -> el.SetValue(DevExpress.Xpf.Diagram.Native.PrintPreviewControl.DiagramProperty, box v)
        | PrintPreviewControlProp.PreviewZoomMode v -> el.SetValue(DevExpress.Xpf.Diagram.Native.PrintPreviewControl.PreviewZoomModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.PrintPreviewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
