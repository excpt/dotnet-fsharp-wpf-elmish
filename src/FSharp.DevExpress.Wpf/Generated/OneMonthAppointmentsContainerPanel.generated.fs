...
type OneMonthAppointmentsContainerPanelProp =
    | Base of MonthAppointmentsContainerPanelProp
    | View of DevExpress.Xpf.Scheduling.MonthView
    | MaxRowsCount of float

module OneMonthAppointmentsContainerPanel =
    let view v : obj = box (OneMonthAppointmentsContainerPanelProp.View v)
    let maxRowsCount v : obj = box (OneMonthAppointmentsContainerPanelProp.MaxRowsCount v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthAppointmentsContainerPanel) (prop: OneMonthAppointmentsContainerPanelProp) =
        match prop with
        | OneMonthAppointmentsContainerPanelProp.Base p -> MonthAppointmentsContainerPanel.apply el p
        | OneMonthAppointmentsContainerPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthAppointmentsContainerPanel.ViewProperty, box v)
        | OneMonthAppointmentsContainerPanelProp.MaxRowsCount v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthAppointmentsContainerPanel.MaxRowsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthAppointmentsContainerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
