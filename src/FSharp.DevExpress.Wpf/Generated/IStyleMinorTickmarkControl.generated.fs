...
type IStyleMinorTickmarkControlProp =
    | Base of PresentationControlProp

module IStyleMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleMinorTickmarkControl) (prop: IStyleMinorTickmarkControlProp) =
        match prop with
        | IStyleMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
