...
type BaseBestFitControlProp =
    | Base of BestFitControlBaseProp

module BaseBestFitControl =

    let apply (el: DevExpress.Xpf.Grid.BaseBestFitControl) (prop: BaseBestFitControlProp) =
        match prop with
        | BaseBestFitControlProp.Base p -> BestFitControlBase.apply el p
