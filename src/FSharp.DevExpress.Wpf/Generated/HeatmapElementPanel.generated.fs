...
type HeatmapElementPanelProp =
    | Base of Chart2DElementPanelBaseProp

module HeatmapElementPanel =

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapElementPanel) (prop: HeatmapElementPanelProp) =
        match prop with
        | HeatmapElementPanelProp.Base p -> Chart2DElementPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapElementPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
