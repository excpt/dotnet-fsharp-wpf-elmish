...
type LayoutItemsControlProp =
    | Base of psvItemsControlProp
    | Orientation of System.Windows.Controls.Orientation
    | LastChildFill of bool

module LayoutItemsControl =
    let orientation v : obj = box (LayoutItemsControlProp.Orientation v)
    let lastChildFill v : obj = box (LayoutItemsControlProp.LastChildFill v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.LayoutItemsControl) (prop: LayoutItemsControlProp) =
        match prop with
        | LayoutItemsControlProp.Base p -> psvItemsControl.apply el p
        | LayoutItemsControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutItemsControl.OrientationProperty, box v)
        | LayoutItemsControlProp.LastChildFill v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutItemsControl.LastChildFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.LayoutItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
