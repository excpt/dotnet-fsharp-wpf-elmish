...
type VerticalHeaderGlareBorderProp =
    | Base of HeaderBorderProp

module VerticalHeaderGlareBorder =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VerticalHeaderGlareBorder) (prop: VerticalHeaderGlareBorderProp) =
        match prop with
        | VerticalHeaderGlareBorderProp.Base p -> HeaderBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VerticalHeaderGlareBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
