...
type DotxRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module DotxRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.DotxRichEditDocumentSourceProvider) (prop: DotxRichEditDocumentSourceProviderProp) =
        match prop with
        | DotxRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.DotxRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
