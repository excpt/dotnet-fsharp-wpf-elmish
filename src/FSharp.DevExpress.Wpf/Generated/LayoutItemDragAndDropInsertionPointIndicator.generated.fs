...
type LayoutItemDragAndDropInsertionPointIndicatorProp =
    | Base of ControlBaseProp

module LayoutItemDragAndDropInsertionPointIndicator =

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemDragAndDropInsertionPointIndicator) (prop: LayoutItemDragAndDropInsertionPointIndicatorProp) =
        match prop with
        | LayoutItemDragAndDropInsertionPointIndicatorProp.Base p -> ControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemDragAndDropInsertionPointIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
