...
open System
open System.Windows
open DevExpress.Xpf.Gauges
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ScaleProp =
    | Base of GaugeElementProp
    | StartValue of float
    | EndValue of float
    | MajorTickmarkOptions of DevExpress.Xpf.Gauges.MajorTickmarkOptions
    | MajorIntervalCount of int
    | MinorTickmarkOptions of DevExpress.Xpf.Gauges.MinorTickmarkOptions
    | MinorIntervalCount of int
    | CustomLabelsSource of System.Collections.IEnumerable
    | CustomLabelTemplate of System.Windows.DataTemplate
    | CustomLabelTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | ShowLabels of DevExpress.Utils.DefaultBoolean
    | ShowMajorTickmarks of DevExpress.Utils.DefaultBoolean
    | ShowMinorTickmarks of DevExpress.Utils.DefaultBoolean
    | LabelPresentation of DevExpress.Xpf.Gauges.ScaleLabelPresentation
    | TickmarksPresentation of DevExpress.Xpf.Gauges.TickmarksPresentation
    | LineOptions of DevExpress.Xpf.Gauges.ScaleLineOptions
    | ShowLine of DevExpress.Utils.DefaultBoolean
    | AllowLightweightTickmarks of bool

module Scale =
    let startValue v : obj = box (ScaleProp.StartValue v)
    let endValue v : obj = box (ScaleProp.EndValue v)
    let majorTickmarkOptions v : obj = box (ScaleProp.MajorTickmarkOptions v)
    let majorIntervalCount v : obj = box (ScaleProp.MajorIntervalCount v)
    let minorTickmarkOptions v : obj = box (ScaleProp.MinorTickmarkOptions v)
    let minorIntervalCount v : obj = box (ScaleProp.MinorIntervalCount v)
    let customLabelsSource v : obj = box (ScaleProp.CustomLabelsSource v)
    let customLabelTemplate v : obj = box (ScaleProp.CustomLabelTemplate v)
    let customLabelTemplateSelector v : obj = box (ScaleProp.CustomLabelTemplateSelector v)
    let showLabels v : obj = box (ScaleProp.ShowLabels v)
    let showMajorTickmarks v : obj = box (ScaleProp.ShowMajorTickmarks v)
    let showMinorTickmarks v : obj = box (ScaleProp.ShowMinorTickmarks v)
    let labelPresentation v : obj = box (ScaleProp.LabelPresentation v)
    let tickmarksPresentation v : obj = box (ScaleProp.TickmarksPresentation v)
    let lineOptions v : obj = box (ScaleProp.LineOptions v)
    let showLine v : obj = box (ScaleProp.ShowLine v)
    let allowLightweightTickmarks v : obj = box (ScaleProp.AllowLightweightTickmarks v)

    let apply (el: DevExpress.Xpf.Gauges.Scale) (prop: ScaleProp) =
        match prop with
        | ScaleProp.Base p -> GaugeElement.apply el p
        | ScaleProp.StartValue v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.StartValueProperty, box v)
        | ScaleProp.EndValue v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.EndValueProperty, box v)
        | ScaleProp.MajorTickmarkOptions v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.MajorTickmarkOptionsProperty, box v)
        | ScaleProp.MajorIntervalCount v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.MajorIntervalCountProperty, box v)
        | ScaleProp.MinorTickmarkOptions v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.MinorTickmarkOptionsProperty, box v)
        | ScaleProp.MinorIntervalCount v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.MinorIntervalCountProperty, box v)
        | ScaleProp.CustomLabelsSource v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.CustomLabelsSourceProperty, box v)
        | ScaleProp.CustomLabelTemplate v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.CustomLabelTemplateProperty, box v)
        | ScaleProp.CustomLabelTemplateSelector v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.CustomLabelTemplateSelectorProperty, box v)
        | ScaleProp.ShowLabels v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.ShowLabelsProperty, box v)
        | ScaleProp.ShowMajorTickmarks v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.ShowMajorTickmarksProperty, box v)
        | ScaleProp.ShowMinorTickmarks v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.ShowMinorTickmarksProperty, box v)
        | ScaleProp.LabelPresentation v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.LabelPresentationProperty, box v)
        | ScaleProp.TickmarksPresentation v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.TickmarksPresentationProperty, box v)
        | ScaleProp.LineOptions v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.LineOptionsProperty, box v)
        | ScaleProp.ShowLine v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.ShowLineProperty, box v)
        | ScaleProp.AllowLightweightTickmarks v -> el.SetValue(DevExpress.Xpf.Gauges.Scale.AllowLightweightTickmarksProperty, box v)
