...
type LegacyQueryBuilderViewProp =
    | Base of QueryBuilderViewBaseProp

module LegacyQueryBuilderView =

    let apply (el: DevExpress.Xpf.DataAccess.QueryBuilder.LegacyQueryBuilderView) (prop: LegacyQueryBuilderViewProp) =
        match prop with
        | LegacyQueryBuilderViewProp.Base p -> QueryBuilderViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.QueryBuilder.LegacyQueryBuilderView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
