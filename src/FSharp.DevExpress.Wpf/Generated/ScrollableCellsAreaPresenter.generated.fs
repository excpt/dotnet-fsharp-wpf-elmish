...
type ScrollableCellsAreaPresenterProp =
    | Base of CellsAreaPresenterProp

module ScrollableCellsAreaPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.ScrollableCellsAreaPresenter) (prop: ScrollableCellsAreaPresenterProp) =
        match prop with
        | ScrollableCellsAreaPresenterProp.Base p -> CellsAreaPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.ScrollableCellsAreaPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
