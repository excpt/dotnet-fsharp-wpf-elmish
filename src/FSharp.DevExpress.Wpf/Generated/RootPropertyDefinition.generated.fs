...
type RootPropertyDefinitionProp =
    | Base of PropertyDefinitionProp

module RootPropertyDefinition =

    let apply (el: DevExpress.Xpf.PropertyGrid.RootPropertyDefinition) (prop: RootPropertyDefinitionProp) =
        match prop with
        | RootPropertyDefinitionProp.Base p -> PropertyDefinition.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.RootPropertyDefinition>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
