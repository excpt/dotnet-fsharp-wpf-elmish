...
type StandardTimelineCellsContainerPanelProp =
    | HorizontalViewport of float
    | HorizontalOffset of float
    | HorizontalExtent of float
    | ItemVerticalBorderThickness of float
    | ItemHorizontalBorderThickness of float
    | View of DevExpress.Xpf.Scheduling.TimelineView

module StandardTimelineCellsContainerPanel =
    let horizontalViewport v : obj = box (StandardTimelineCellsContainerPanelProp.HorizontalViewport v)
    let horizontalOffset v : obj = box (StandardTimelineCellsContainerPanelProp.HorizontalOffset v)
    let horizontalExtent v : obj = box (StandardTimelineCellsContainerPanelProp.HorizontalExtent v)
    let itemVerticalBorderThickness v : obj = box (StandardTimelineCellsContainerPanelProp.ItemVerticalBorderThickness v)
    let itemHorizontalBorderThickness v : obj = box (StandardTimelineCellsContainerPanelProp.ItemHorizontalBorderThickness v)
    let view v : obj = box (StandardTimelineCellsContainerPanelProp.View v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel) (prop: StandardTimelineCellsContainerPanelProp) =
        match prop with
        | StandardTimelineCellsContainerPanelProp.HorizontalViewport v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel.HorizontalViewportProperty, box v)
        | StandardTimelineCellsContainerPanelProp.HorizontalOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel.HorizontalOffsetProperty, box v)
        | StandardTimelineCellsContainerPanelProp.HorizontalExtent v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel.HorizontalExtentProperty, box v)
        | StandardTimelineCellsContainerPanelProp.ItemVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel.ItemVerticalBorderThicknessProperty, box v)
        | StandardTimelineCellsContainerPanelProp.ItemHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel.ItemHorizontalBorderThicknessProperty, box v)
        | StandardTimelineCellsContainerPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsContainerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
