...
module RulerScaleBase =
    let zoom v : obj = box (RulerScaleBaseProp.Zoom v)
    let offset v : obj = box (RulerScaleBaseProp.Offset v)
    let location v : obj = box (RulerScaleBaseProp.Location v)
    let viewport v : obj = box (RulerScaleBaseProp.Viewport v)
    let measureUnit v : obj = box (RulerScaleBaseProp.MeasureUnit v)

    let apply (el: DevExpress.Xpf.Diagram.RulerScaleBase) (prop: RulerScaleBaseProp) =
        match prop with
        | RulerScaleBaseProp.Zoom v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScaleBase.ZoomProperty, box v)
        | RulerScaleBaseProp.Offset v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScaleBase.OffsetProperty, box v)
        | RulerScaleBaseProp.Location v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScaleBase.LocationProperty, box v)
        | RulerScaleBaseProp.Viewport v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScaleBase.ViewportProperty, box v)
        | RulerScaleBaseProp.MeasureUnit v -> el.SetValue(DevExpress.Xpf.Diagram.RulerScaleBase.MeasureUnitProperty, box v)
