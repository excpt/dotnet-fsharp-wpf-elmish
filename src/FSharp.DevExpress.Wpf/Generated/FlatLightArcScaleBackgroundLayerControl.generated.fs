...
type FlatLightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatLightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightArcScaleBackgroundLayerControl) (prop: FlatLightArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatLightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
