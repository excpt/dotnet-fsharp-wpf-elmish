...
type CleanWhiteQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteQuarterTopRightArcScaleBackgroundLayerControl) (prop: CleanWhiteQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
