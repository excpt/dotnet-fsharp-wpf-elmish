...
type ThemedWindowContentBorderProp =
    | Base of ThemedWindowBorderProp

module ThemedWindowContentBorder =

    let apply (el: DevExpress.Xpf.Core.ThemedWindowContentBorder) (prop: ThemedWindowContentBorderProp) =
        match prop with
        | ThemedWindowContentBorderProp.Base p -> ThemedWindowBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowContentBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
