...
type XPDataSourceBaseProp =
    | Base of XPOSourceBaseWithSessionProp
    | CaseSensitive of bool
    | Criteria of DevExpress.Data.Filtering.CriteriaOperator
    | SelectDeleted of bool
    | Sorting of obj

module XPDataSourceBase =
    ...
    let sorting v : obj = box (XPDataSourceBaseProp.Sorting v)

    let apply (el: DevExpress.Xpf.Core.DataSources.XPDataSourceBase) (prop: XPDataSourceBaseProp) =
        match prop with
        | XPDataSourceBaseProp.Base p -> XPOSourceBaseWithSession.apply el p
        | XPDataSourceBaseProp.CaseSensitive v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPDataSourceBase.CaseSensitiveProperty, box v)
        | XPDataSourceBaseProp.Criteria v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPDataSourceBase.CriteriaProperty, box v)
        | XPDataSourceBaseProp.SelectDeleted v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPDataSourceBase.SelectDeletedProperty, box v)
        | XPDataSourceBaseProp.Sorting v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPDataSourceBase.SortingProperty, box v)
