...
type DialogListViewProp =
    | Base of DialogIconsViewBaseProp

module DialogListView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogListView) (prop: DialogListViewProp) =
        match prop with
        | DialogListViewProp.Base p -> DialogIconsViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogListView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
