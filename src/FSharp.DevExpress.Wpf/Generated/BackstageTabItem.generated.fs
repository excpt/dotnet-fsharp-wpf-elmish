...
type BackstageTabItemProp =
    | Base of BackstageItemWithImageProp
    | ControlPane of obj
    | SelectedTextStyle of System.Windows.Style
    | KeyGesture of System.Windows.Input.KeyGesture

module BackstageTabItem =
    let controlPane v : obj = box (BackstageTabItemProp.ControlPane v)
    let selectedTextStyle v : obj = box (BackstageTabItemProp.SelectedTextStyle v)
    let keyGesture v : obj = box (BackstageTabItemProp.KeyGesture v)

    let apply (el: DevExpress.Xpf.Ribbon.BackstageTabItem) (prop: BackstageTabItemProp) =
        match prop with
        | BackstageTabItemProp.Base p -> BackstageItemWithImage.apply el p
        | BackstageTabItemProp.ControlPane v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageTabItem.ControlPaneProperty, box v)
        | BackstageTabItemProp.SelectedTextStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageTabItem.SelectedTextStyleProperty, box v)
        | BackstageTabItemProp.KeyGesture v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageTabItem.KeyGestureProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageTabItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
