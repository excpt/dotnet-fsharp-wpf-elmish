...
type NavigationLayerProp =
    | SupportNavigationControl of DevExpress.Xpf.Charts.Native.ISupportNavigationControl

module NavigationLayer =
    let supportNavigationControl v : obj = box (NavigationLayerProp.SupportNavigationControl v)

    let apply (el: DevExpress.Xpf.Charts.NavigationLayer) (prop: NavigationLayerProp) =
        match prop with
        | NavigationLayerProp.SupportNavigationControl v -> el.SetValue(DevExpress.Xpf.Charts.NavigationLayer.SupportNavigationControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.NavigationLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
