...
type WaitIndicatorSplashScreenProp =
    | Base of SplashScreenWindowProp

module WaitIndicatorSplashScreen =

    let apply (el: DevExpress.Xpf.Core.Native.WaitIndicatorSplashScreen) (prop: WaitIndicatorSplashScreenProp) =
        match prop with
        | WaitIndicatorSplashScreenProp.Base p -> SplashScreenWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.WaitIndicatorSplashScreen>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
