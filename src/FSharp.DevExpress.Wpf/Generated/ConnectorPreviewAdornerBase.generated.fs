...
type ConnectorPreviewAdornerBaseProp =
    | Stroke of System.Windows.Media.Brush
    | StrokeThickness of float

module ConnectorPreviewAdornerBase =
    let stroke v : obj = box (ConnectorPreviewAdornerBaseProp.Stroke v)
    let strokeThickness v : obj = box (ConnectorPreviewAdornerBaseProp.StrokeThickness v)

    let apply (el: DevExpress.Xpf.Diagram.ConnectorPreviewAdornerBase) (prop: ConnectorPreviewAdornerBaseProp) =
        match prop with
        | ConnectorPreviewAdornerBaseProp.Stroke v -> el.SetValue(DevExpress.Xpf.Diagram.ConnectorPreviewAdornerBase.StrokeProperty, box v)
        | ConnectorPreviewAdornerBaseProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.Diagram.ConnectorPreviewAdornerBase.StrokeThicknessProperty, box v)
