...
type RichEditControlBorderProp =
    | Base of DXRichEditThemesLoaderProp
    | VisibleBorderTemplate of System.Windows.Controls.ControlTemplate
    | InvisibleBorderTemplate of System.Windows.Controls.ControlTemplate
    | ShowBorder of bool

module RichEditControlBorder =
    let visibleBorderTemplate v : obj = box (RichEditControlBorderProp.VisibleBorderTemplate v)
    let invisibleBorderTemplate v : obj = box (RichEditControlBorderProp.InvisibleBorderTemplate v)
    let showBorder v : obj = box (RichEditControlBorderProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RichEditControlBorder) (prop: RichEditControlBorderProp) =
        match prop with
        | RichEditControlBorderProp.Base p -> DXRichEditThemesLoader.apply el p
        | RichEditControlBorderProp.VisibleBorderTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditControlBorder.VisibleBorderTemplateProperty, box v)
        | RichEditControlBorderProp.InvisibleBorderTemplate v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditControlBorder.InvisibleBorderTemplateProperty, box v)
        | RichEditControlBorderProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditControlBorder.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RichEditControlBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
