...
type PivotPrintCellBaseProp =
    | Base of BasePrintContentPresenterProp

module PivotPrintCellBase =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PivotPrintCellBase) (prop: PivotPrintCellBaseProp) =
        match prop with
        | PivotPrintCellBaseProp.Base p -> BasePrintContentPresenter.apply el p
