...
type InsertSymbolDXDialogProp =
    | Base of ModelessDXDialogProp

module InsertSymbolDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.InsertSymbolDXDialog) (prop: InsertSymbolDXDialogProp) =
        match prop with
        | InsertSymbolDXDialogProp.Base p -> ModelessDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.InsertSymbolDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
