...
type ChooseEFStoredProceduresEditorProp =
    | EditValue of obj
    | ItemsSource of obj

module ChooseEFStoredProceduresEditor =
    let editValue v : obj = box (ChooseEFStoredProceduresEditorProp.EditValue v)
    let itemsSource v : obj = box (ChooseEFStoredProceduresEditorProp.ItemsSource v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ChooseEFStoredProceduresEditor) (prop: ChooseEFStoredProceduresEditorProp) =
        match prop with
        | ChooseEFStoredProceduresEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ChooseEFStoredProceduresEditor.EditValueProperty, box v)
        | ChooseEFStoredProceduresEditorProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ChooseEFStoredProceduresEditor.ItemsSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ChooseEFStoredProceduresEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
