...
type YellowSubmarineQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineQuarterTopRightArcScaleBackgroundLayerControl) (prop: YellowSubmarineQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
