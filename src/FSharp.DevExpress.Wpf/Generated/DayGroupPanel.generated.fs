...
type DayGroupPanelProp =
    | Base of DayGroupPanelBaseProp
    | CellContainers of obj

module DayGroupPanel =
    let cellContainers v : obj = box (DayGroupPanelProp.CellContainers v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.DayGroupPanel) (prop: DayGroupPanelProp) =
        match prop with
        | DayGroupPanelProp.Base p -> DayGroupPanelBase.apply el p
        | DayGroupPanelProp.CellContainers v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanel.CellContainersProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.DayGroupPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
