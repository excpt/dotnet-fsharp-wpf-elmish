...
type TimelineAutoHeightGroupPanelBaseProp =
...
module TimelineAutoHeightGroupPanelBase =
    let view v : obj = box (TimelineAutoHeightGroupPanelBaseProp.View v)
    let visualData v : obj = box (TimelineAutoHeightGroupPanelBaseProp.VisualData v)
    let appointmentsContainerStyle v : obj = box (TimelineAutoHeightGroupPanelBaseProp.AppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (TimelineAutoHeightGroupPanelBaseProp.DragAppointmentsContainerStyle v)
    let itemVerticalBorderThickness v : obj = box (TimelineAutoHeightGroupPanelBaseProp.ItemVerticalBorderThickness v)
    let itemHorizontalBorderThickness v : obj = box (TimelineAutoHeightGroupPanelBaseProp.ItemHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase) (prop: TimelineAutoHeightGroupPanelBaseProp) =
        match prop with
        | TimelineAutoHeightGroupPanelBaseProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase.ViewProperty, box v)
        | TimelineAutoHeightGroupPanelBaseProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase.VisualDataProperty, box v)
        | TimelineAutoHeightGroupPanelBaseProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase.AppointmentsContainerStyleProperty, box v)
        | TimelineAutoHeightGroupPanelBaseProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase.DragAppointmentsContainerStyleProperty, box v)
        | TimelineAutoHeightGroupPanelBaseProp.ItemVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase.ItemVerticalBorderThicknessProperty, box v)
        | TimelineAutoHeightGroupPanelBaseProp.ItemHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase.ItemHorizontalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanelBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
