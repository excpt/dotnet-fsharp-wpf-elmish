...
type AppointmentContinueStartDateControlProp =
    | Base of AppointmentContinueDateControlProp

module AppointmentContinueStartDateControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueStartDateControl) (prop: AppointmentContinueStartDateControlProp) =
        match prop with
        | AppointmentContinueStartDateControlProp.Base p -> AppointmentContinueDateControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueStartDateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
