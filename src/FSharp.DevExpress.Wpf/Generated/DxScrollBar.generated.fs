...
type DxScrollBarProp =
    | CornerRadius of System.Windows.CornerRadius

module DxScrollBar =
    let cornerRadius v : obj = box (DxScrollBarProp.CornerRadius v)

    let apply (el: DevExpress.Xpf.Core.DxScrollBar) (prop: DxScrollBarProp) =
        match prop with
        | DxScrollBarProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Core.DxScrollBar.CornerRadiusProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DxScrollBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
