...
type DocumentSelectorContainerProp =
    | Base of psvControlProp

module DocumentSelectorContainer =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentSelectorContainer) (prop: DocumentSelectorContainerProp) =
        match prop with
        | DocumentSelectorContainerProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentSelectorContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
