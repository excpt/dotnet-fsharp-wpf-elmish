...
type GanttControlProp =
    | View of DevExpress.Xpf.Gantt.GanttView

module GanttControl =
    let view v : obj = box (GanttControlProp.View v)

    let apply (el: DevExpress.Xpf.Gantt.GanttControl) (prop: GanttControlProp) =
        match prop with
        | GanttControlProp.View v -> el.SetValue(DevExpress.Xpf.Gantt.GanttControl.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
