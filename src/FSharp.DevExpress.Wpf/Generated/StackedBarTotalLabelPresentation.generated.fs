...
type StackedBarTotalLabelPresentationProp =
    | Base of SeriesLabelPresentationBaseProp

module StackedBarTotalLabelPresentation =

    let apply (el: DevExpress.Xpf.Charts.StackedBarTotalLabelPresentation) (prop: StackedBarTotalLabelPresentationProp) =
        match prop with
        | StackedBarTotalLabelPresentationProp.Base p -> SeriesLabelPresentationBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StackedBarTotalLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
