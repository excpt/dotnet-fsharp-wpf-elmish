...
type DragTreeViewFieldHeaderProp =
    | Base of TreeViewFieldHeaderProp

module DragTreeViewFieldHeader =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.DragTreeViewFieldHeader) (prop: DragTreeViewFieldHeaderProp) =
        match prop with
        | DragTreeViewFieldHeaderProp.Base p -> TreeViewFieldHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.DragTreeViewFieldHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
