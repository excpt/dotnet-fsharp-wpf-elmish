...
type ShapeToolboxPreviewProp =
    | Stroke of System.Windows.Media.Brush
    | StrokeThickness of float
    | StrokeDashArray of System.Windows.Media.DoubleCollection
    | ItemTool of DevExpress.Diagram.Core.ItemTool
    | Theme of DevExpress.Diagram.Core.DiagramTheme
    | ViewMode of DevExpress.Diagram.Core.ShapeToolboxPreviewMode
    | IsCompact of bool
    | Diagram of DevExpress.Xpf.Diagram.DiagramControl
    | ShapePresenterSize of System.Windows.Size
    | ShapePresenterStretch of System.Windows.Media.Stretch

module ShapeToolboxPreview =
    let stroke v : obj = box (ShapeToolboxPreviewProp.Stroke v)
    let strokeThickness v : obj = box (ShapeToolboxPreviewProp.StrokeThickness v)
    let strokeDashArray v : obj = box (ShapeToolboxPreviewProp.StrokeDashArray v)
    let itemTool v : obj = box (ShapeToolboxPreviewProp.ItemTool v)
    let theme v : obj = box (ShapeToolboxPreviewProp.Theme v)
    let viewMode v : obj = box (ShapeToolboxPreviewProp.ViewMode v)
    let isCompact v : obj = box (ShapeToolboxPreviewProp.IsCompact v)
    let diagram v : obj = box (ShapeToolboxPreviewProp.Diagram v)
    let shapePresenterSize v : obj = box (ShapeToolboxPreviewProp.ShapePresenterSize v)
    let shapePresenterStretch v : obj = box (ShapeToolboxPreviewProp.ShapePresenterStretch v)

    let apply (el: DevExpress.Xpf.Diagram.ShapeToolboxPreview) (prop: ShapeToolboxPreviewProp) =
        match prop with
        | ShapeToolboxPreviewProp.Stroke v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.StrokeProperty, box v)
        | ShapeToolboxPreviewProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.StrokeThicknessProperty, box v)
        | ShapeToolboxPreviewProp.StrokeDashArray v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.StrokeDashArrayProperty, box v)
        | ShapeToolboxPreviewProp.ItemTool v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.ItemToolProperty, box v)
        | ShapeToolboxPreviewProp.Theme v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.ThemeProperty, box v)
        | ShapeToolboxPreviewProp.ViewMode v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.ViewModeProperty, box v)
        | ShapeToolboxPreviewProp.IsCompact v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.IsCompactProperty, box v)
        | ShapeToolboxPreviewProp.Diagram v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.DiagramProperty, box v)
        | ShapeToolboxPreviewProp.ShapePresenterSize v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.ShapePresenterSizeProperty, box v)
        | ShapeToolboxPreviewProp.ShapePresenterStretch v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeToolboxPreview.ShapePresenterStretchProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ShapeToolboxPreview>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
