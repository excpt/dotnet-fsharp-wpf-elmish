...
type NavPaneItemsControlPanelProp =
    | Base of NavBarPositionPanelProp
    | VisibleElementCount of int

module NavPaneItemsControlPanel =
    let visibleElementCount v : obj = box (NavPaneItemsControlPanelProp.VisibleElementCount v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneItemsControlPanel) (prop: NavPaneItemsControlPanelProp) =
        match prop with
        | NavPaneItemsControlPanelProp.Base p -> NavBarPositionPanel.apply el p
        | NavPaneItemsControlPanelProp.VisibleElementCount v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneItemsControlPanel.VisibleElementCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneItemsControlPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
