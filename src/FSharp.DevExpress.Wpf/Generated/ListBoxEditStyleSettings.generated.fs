...
type ListBoxEditStyleSettingsProp =
    | Base of BaseListBoxEditStyleSettingsProp
    | ShowEmptyItem of bool
    | EmptyItemText of string

module ListBoxEditStyleSettings =
    let showEmptyItem v : obj = box (ListBoxEditStyleSettingsProp.ShowEmptyItem v)
    let emptyItemText v : obj = box (ListBoxEditStyleSettingsProp.EmptyItemText v)

    let apply (el: DevExpress.Xpf.Editors.ListBoxEditStyleSettings) (prop: ListBoxEditStyleSettingsProp) =
        match prop with
        | ListBoxEditStyleSettingsProp.Base p -> BaseListBoxEditStyleSettings.apply el p
        | ListBoxEditStyleSettingsProp.ShowEmptyItem v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEditStyleSettings.ShowEmptyItemProperty, box v)
        | ListBoxEditStyleSettingsProp.EmptyItemText v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEditStyleSettings.EmptyItemTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ListBoxEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
