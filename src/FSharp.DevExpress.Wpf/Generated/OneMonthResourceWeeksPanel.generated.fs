...
type OneMonthResourceWeeksPanelProp =
    | View of DevExpress.Xpf.Scheduling.MonthView
    | ExpandedWeekIndexes of obj
...
module OneMonthResourceWeeksPanel =
    let view v : obj = box (OneMonthResourceWeeksPanelProp.View v)
    let expandedWeekIndexes v : obj = box (OneMonthResourceWeeksPanelProp.ExpandedWeekIndexes v)
    let itemContainerAppointmentsContainerStyle v : obj = box (OneMonthResourceWeeksPanelProp.ItemContainerAppointmentsContainerStyle v)
    let itemContainerDragAppointmentsContainerStyle v : obj = box (OneMonthResourceWeeksPanelProp.ItemContainerDragAppointmentsContainerStyle v)
    let itemContainerVerticalBorderThickness v : obj = box (OneMonthResourceWeeksPanelProp.ItemContainerVerticalBorderThickness v)
    let itemContainerHorizontalBorderThickness v : obj = box (OneMonthResourceWeeksPanelProp.ItemContainerHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel) (prop: OneMonthResourceWeeksPanelProp) =
        match prop with
        | OneMonthResourceWeeksPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel.ViewProperty, box v)
        | OneMonthResourceWeeksPanelProp.ExpandedWeekIndexes v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel.ExpandedWeekIndexesProperty, box v)
        | OneMonthResourceWeeksPanelProp.ItemContainerAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel.ItemContainerAppointmentsContainerStyleProperty, box v)
        | OneMonthResourceWeeksPanelProp.ItemContainerDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel.ItemContainerDragAppointmentsContainerStyleProperty, box v)
        | OneMonthResourceWeeksPanelProp.ItemContainerVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel.ItemContainerVerticalBorderThicknessProperty, box v)
        | OneMonthResourceWeeksPanelProp.ItemContainerHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel.ItemContainerHorizontalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthResourceWeeksPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
