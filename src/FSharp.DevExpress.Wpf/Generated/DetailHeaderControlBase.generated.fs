...
type DetailHeaderControlBaseProp =
    | Base of DetailRowControlBaseProp
    | ShowLastDetailMargin of bool
    | DetailDescriptor of DevExpress.Xpf.Grid.DetailDescriptorBase
    | ShowBottomLine of bool

module DetailHeaderControlBase =
    let showLastDetailMargin v : obj = box (DetailHeaderControlBaseProp.ShowLastDetailMargin v)
    let detailDescriptor v : obj = box (DetailHeaderControlBaseProp.DetailDescriptor v)
    let showBottomLine v : obj = box (DetailHeaderControlBaseProp.ShowBottomLine v)

    let apply (el: DevExpress.Xpf.Grid.DetailHeaderControlBase) (prop: DetailHeaderControlBaseProp) =
        match prop with
        | DetailHeaderControlBaseProp.Base p -> DetailRowControlBase.apply el p
        | DetailHeaderControlBaseProp.ShowLastDetailMargin v -> el.SetValue(DevExpress.Xpf.Grid.DetailHeaderControlBase.ShowLastDetailMarginProperty, box v)
        | DetailHeaderControlBaseProp.DetailDescriptor v -> el.SetValue(DevExpress.Xpf.Grid.DetailHeaderControlBase.DetailDescriptorProperty, box v)
        | DetailHeaderControlBaseProp.ShowBottomLine v -> el.SetValue(DevExpress.Xpf.Grid.DetailHeaderControlBase.ShowBottomLineProperty, box v)

    let masterRowData v : obj = box (DetailRowControlBaseProp.MasterRowData v)
