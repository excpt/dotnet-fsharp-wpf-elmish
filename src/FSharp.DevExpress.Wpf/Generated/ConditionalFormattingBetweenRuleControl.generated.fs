...
type ConditionalFormattingBetweenRuleControlProp =
    | Base of ReferenceEditBaseControlProp

module ConditionalFormattingBetweenRuleControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ConditionalFormattingBetweenRuleControl) (prop: ConditionalFormattingBetweenRuleControlProp) =
        match prop with
        | ConditionalFormattingBetweenRuleControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ConditionalFormattingBetweenRuleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
