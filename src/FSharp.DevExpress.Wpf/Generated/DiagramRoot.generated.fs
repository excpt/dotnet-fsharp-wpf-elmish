...
type DiagramRootProp =
    | Base of DiagramContainerBaseProp

module DiagramRoot =

    let apply (el: DevExpress.Xpf.Diagram.DiagramRoot) (prop: DiagramRootProp) =
        match prop with
        | DiagramRootProp.Base p -> DiagramContainerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramRoot>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
