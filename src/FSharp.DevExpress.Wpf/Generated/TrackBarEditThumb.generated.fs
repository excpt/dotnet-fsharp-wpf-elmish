...
type TrackBarEditThumbProp =
    | Base of ThumbProp

module TrackBarEditThumb =

    let apply (el: DevExpress.Xpf.Editors.TrackBarEditThumb) (prop: TrackBarEditThumbProp) =
        match prop with
        | TrackBarEditThumbProp.Base p -> Thumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarEditThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
