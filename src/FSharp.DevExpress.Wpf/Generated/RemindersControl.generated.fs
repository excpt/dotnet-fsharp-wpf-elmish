...
type RemindersControlProp =
    | SelectedReminders of obj

module RemindersControl =
    let selectedReminders v : obj = box (RemindersControlProp.SelectedReminders v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RemindersControl) (prop: RemindersControlProp) =
        match prop with
        | RemindersControlProp.SelectedReminders v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RemindersControl.SelectedRemindersProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RemindersControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
