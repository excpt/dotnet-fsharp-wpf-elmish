...
type WizardHeaderSeparatorProp =
    | Base of WizardSeparatorProp

module WizardHeaderSeparator =

    let apply (el: DevExpress.Xpf.Controls.WizardHeaderSeparator) (prop: WizardHeaderSeparatorProp) =
        match prop with
        | WizardHeaderSeparatorProp.Base p -> WizardSeparator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.WizardHeaderSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
