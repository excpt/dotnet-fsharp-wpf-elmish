...
type DialogSmallIconsViewProp =
    | Base of DialogIconsViewBaseProp

module DialogSmallIconsView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogSmallIconsView) (prop: DialogSmallIconsViewProp) =
        match prop with
        | DialogSmallIconsViewProp.Base p -> DialogIconsViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogSmallIconsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
