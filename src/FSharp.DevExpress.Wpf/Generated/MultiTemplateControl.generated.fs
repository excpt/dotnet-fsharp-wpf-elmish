...
type MultiTemplateControlProp =
    | Base of psvControlProp
    | EmptyTemplate of System.Windows.Controls.ControlTemplate
    | PanelTemplate of System.Windows.Controls.ControlTemplate
    | ControlItemTemplate of System.Windows.Controls.ControlTemplate
    | DocumentTemplate of System.Windows.Controls.ControlTemplate
    | GroupTemplate of System.Windows.Controls.ControlTemplate
    | TabPanelTemplate of System.Windows.Controls.ControlTemplate
    | DocumentPanelTemplate of System.Windows.Controls.ControlTemplate
    | MDIDocumentTemplate of System.Windows.Controls.ControlTemplate
    | FloatDocumentTemplate of System.Windows.Controls.ControlTemplate
    | FloatingWindowTemplate of System.Windows.Controls.ControlTemplate
    | FloatingAdornerTemplate of System.Windows.Controls.ControlTemplate
    | SplitterControlTemplate of System.Windows.Controls.ControlTemplate
    | EmptySpaceControlTemplate of System.Windows.Controls.ControlTemplate
    | LabelControlTemplate of System.Windows.Controls.ControlTemplate
    | SeparatorControlTemplate of System.Windows.Controls.ControlTemplate
    | AutoHideGroupTemplate of System.Windows.Controls.ControlTemplate
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem

module MultiTemplateControl =
    let emptyTemplate v : obj = box (MultiTemplateControlProp.EmptyTemplate v)
    let panelTemplate v : obj = box (MultiTemplateControlProp.PanelTemplate v)
    let controlItemTemplate v : obj = box (MultiTemplateControlProp.ControlItemTemplate v)
    let documentTemplate v : obj = box (MultiTemplateControlProp.DocumentTemplate v)
    let groupTemplate v : obj = box (MultiTemplateControlProp.GroupTemplate v)
    let tabPanelTemplate v : obj = box (MultiTemplateControlProp.TabPanelTemplate v)
    let documentPanelTemplate v : obj = box (MultiTemplateControlProp.DocumentPanelTemplate v)
    let mDIDocumentTemplate v : obj = box (MultiTemplateControlProp.MDIDocumentTemplate v)
    let floatDocumentTemplate v : obj = box (MultiTemplateControlProp.FloatDocumentTemplate v)
    let floatingWindowTemplate v : obj = box (MultiTemplateControlProp.FloatingWindowTemplate v)
    let floatingAdornerTemplate v : obj = box (MultiTemplateControlProp.FloatingAdornerTemplate v)
    let splitterControlTemplate v : obj = box (MultiTemplateControlProp.SplitterControlTemplate v)
    let emptySpaceControlTemplate v : obj = box (MultiTemplateControlProp.EmptySpaceControlTemplate v)
    let labelControlTemplate v : obj = box (MultiTemplateControlProp.LabelControlTemplate v)
    let separatorControlTemplate v : obj = box (MultiTemplateControlProp.SeparatorControlTemplate v)
    let autoHideGroupTemplate v : obj = box (MultiTemplateControlProp.AutoHideGroupTemplate v)
    let layoutItem v : obj = box (MultiTemplateControlProp.LayoutItem v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl) (prop: MultiTemplateControlProp) =
        match prop with
        | MultiTemplateControlProp.Base p -> psvControl.apply el p
        | MultiTemplateControlProp.EmptyTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.EmptyTemplateProperty, box v)
        | MultiTemplateControlProp.PanelTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.PanelTemplateProperty, box v)
        | MultiTemplateControlProp.ControlItemTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.ControlItemTemplateProperty, box v)
        | MultiTemplateControlProp.DocumentTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.DocumentTemplateProperty, box v)
        | MultiTemplateControlProp.GroupTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.GroupTemplateProperty, box v)
        | MultiTemplateControlProp.TabPanelTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.TabPanelTemplateProperty, box v)
        | MultiTemplateControlProp.DocumentPanelTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.DocumentPanelTemplateProperty, box v)
        | MultiTemplateControlProp.MDIDocumentTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.MDIDocumentTemplateProperty, box v)
        | MultiTemplateControlProp.FloatDocumentTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.FloatDocumentTemplateProperty, box v)
        | MultiTemplateControlProp.FloatingWindowTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.FloatingWindowTemplateProperty, box v)
        | MultiTemplateControlProp.FloatingAdornerTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.FloatingAdornerTemplateProperty, box v)
        | MultiTemplateControlProp.SplitterControlTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.SplitterControlTemplateProperty, box v)
        | MultiTemplateControlProp.EmptySpaceControlTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.EmptySpaceControlTemplateProperty, box v)
        | MultiTemplateControlProp.LabelControlTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.LabelControlTemplateProperty, box v)
        | MultiTemplateControlProp.SeparatorControlTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.SeparatorControlTemplateProperty, box v)
        | MultiTemplateControlProp.AutoHideGroupTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.AutoHideGroupTemplateProperty, box v)
        | MultiTemplateControlProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl.LayoutItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.MultiTemplateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
