...
type LabelItemProp =
    | Base of FixedItemProp
    | Content of obj
    | ContentTemplate of System.Windows.DataTemplate
    | ContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | ContentHorizontalAlignment of System.Windows.HorizontalAlignment
    | ContentVerticalAlignment of System.Windows.VerticalAlignment
    | DesiredSizeInternal of obj

module LabelItem =
    let content v : obj = box (LabelItemProp.Content v)
    let contentTemplate v : obj = box (LabelItemProp.ContentTemplate v)
    let contentTemplateSelector v : obj = box (LabelItemProp.ContentTemplateSelector v)
    let contentHorizontalAlignment v : obj = box (LabelItemProp.ContentHorizontalAlignment v)
    let contentVerticalAlignment v : obj = box (LabelItemProp.ContentVerticalAlignment v)
    let desiredSizeInternal v : obj = box (LabelItemProp.DesiredSizeInternal v)

    let apply (el: DevExpress.Xpf.Docking.LabelItem) (prop: LabelItemProp) =
        match prop with
        | LabelItemProp.Base p -> FixedItem.apply el p
        | LabelItemProp.Content v -> el.SetValue(DevExpress.Xpf.Docking.LabelItem.ContentProperty, box v)
        | LabelItemProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Docking.LabelItem.ContentTemplateProperty, box v)
        | LabelItemProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Docking.LabelItem.ContentTemplateSelectorProperty, box v)
        | LabelItemProp.ContentHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Docking.LabelItem.ContentHorizontalAlignmentProperty, box v)
        | LabelItemProp.ContentVerticalAlignment v -> el.SetValue(DevExpress.Xpf.Docking.LabelItem.ContentVerticalAlignmentProperty, box v)
        | LabelItemProp.DesiredSizeInternal v -> el.SetValue(DevExpress.Xpf.Docking.LabelItem.DesiredSizeInternalProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.LabelItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
