...
type LegendBaseProp =
    ...
    | HorizontalPosition of DevExpress.Xpf.Charts.HorizontalPosition
    | VerticalPosition of DevExpress.Xpf.Charts.VerticalPosition
    | IndentFromDiagram of System.Windows.Thickness
    ...
    | Visible of obj
    | ItemVisibilityMode of DevExpress.Xpf.Charts.LegendItemVisibilityMode
    | CustomItemsSource of System.Collections.IEnumerable
    | CustomItemTemplate of System.Windows.DataTemplate
    | CustomItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | Title of DevExpress.Xpf.Charts.LegendTitle

module LegendBase =
    let horizontalPosition v : obj = box (LegendBaseProp.HorizontalPosition v)
    let verticalPosition v : obj = box (LegendBaseProp.VerticalPosition v)
    let indentFromDiagram v : obj = box (LegendBaseProp.IndentFromDiagram v)
    let itemTemplate v : obj = box (LegendBaseProp.ItemTemplate v)
    let itemsPanel v : obj = box (LegendBaseProp.ItemsPanel v)
    let orientation v : obj = box (LegendBaseProp.Orientation v)
    let visible v : obj = box (LegendBaseProp.Visible v)
    let itemVisibilityMode v : obj = box (LegendBaseProp.ItemVisibilityMode v)
    let customItemsSource v : obj = box (LegendBaseProp.CustomItemsSource v)
    let customItemTemplate v : obj = box (LegendBaseProp.CustomItemTemplate v)
    let customItemTemplateSelector v : obj = box (LegendBaseProp.CustomItemTemplateSelector v)
    let title v : obj = box (LegendBaseProp.Title v)

    let apply (el: DevExpress.Xpf.Charts.LegendBase) (prop: LegendBaseProp) =
        match prop with
        | LegendBaseProp.Base p -> ChartNotificationElement.apply el p
        | LegendBaseProp.HorizontalPosition v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.HorizontalPositionProperty, box v)
        | LegendBaseProp.VerticalPosition v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.VerticalPositionProperty, box v)
        | LegendBaseProp.IndentFromDiagram v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.IndentFromDiagramProperty, box v)
        | LegendBaseProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.ItemTemplateProperty, box v)
        | LegendBaseProp.ItemsPanel v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.ItemsPanelProperty, box v)
        | LegendBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.OrientationProperty, box v)
        | LegendBaseProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.VisibleProperty, box v)
        | LegendBaseProp.ItemVisibilityMode v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.ItemVisibilityModeProperty, box v)
        | LegendBaseProp.CustomItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.CustomItemsSourceProperty, box v)
        | LegendBaseProp.CustomItemTemplate v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.CustomItemTemplateProperty, box v)
        | LegendBaseProp.CustomItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.CustomItemTemplateSelectorProperty, box v)
        | LegendBaseProp.Title v -> el.SetValue(DevExpress.Xpf.Charts.LegendBase.TitleProperty, box v)
