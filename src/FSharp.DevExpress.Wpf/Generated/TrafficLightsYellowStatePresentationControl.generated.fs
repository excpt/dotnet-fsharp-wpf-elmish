...
type TrafficLightsYellowStatePresentationControlProp =
    | Base of PresentationControlProp

module TrafficLightsYellowStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.TrafficLightsYellowStatePresentationControl) (prop: TrafficLightsYellowStatePresentationControlProp) =
        match prop with
        | TrafficLightsYellowStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.TrafficLightsYellowStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
