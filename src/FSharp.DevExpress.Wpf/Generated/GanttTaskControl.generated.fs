...
type GanttTaskControlProp =
    | Base of GanttTaskControlBaseProp

module GanttTaskControl =

    let apply (el: DevExpress.Xpf.Gantt.GanttTaskControl) (prop: GanttTaskControlProp) =
        match prop with
        | GanttTaskControlProp.Base p -> GanttTaskControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttTaskControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
