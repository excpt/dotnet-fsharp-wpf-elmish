...
type ItemForegroundWrapperProp =
    | OwnerForeground of System.Windows.Media.Brush
    | Owner of System.Windows.Controls.Control

module ItemForegroundWrapper =
    let ownerForeground v : obj = box (ItemForegroundWrapperProp.OwnerForeground v)
    let owner v : obj = box (ItemForegroundWrapperProp.Owner v)

    let apply (el: DevExpress.Xpf.NavBar.ItemForegroundWrapper) (prop: ItemForegroundWrapperProp) =
        match prop with
        | ItemForegroundWrapperProp.OwnerForeground v -> el.SetValue(DevExpress.Xpf.NavBar.ItemForegroundWrapper.OwnerForegroundProperty, box v)
        | ItemForegroundWrapperProp.Owner v -> el.SetValue(DevExpress.Xpf.NavBar.ItemForegroundWrapper.OwnerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ItemForegroundWrapper>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
