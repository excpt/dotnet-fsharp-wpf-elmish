...
type PieSeries3DProp =
    | Base of PieSeriesProp
    | Model of DevExpress.Xpf.Charts.Pie3DModel
    | DepthTransform of float

module PieSeries3D =
    let model v : obj = box (PieSeries3DProp.Model v)
    let depthTransform v : obj = box (PieSeries3DProp.DepthTransform v)

    let apply (el: DevExpress.Xpf.Charts.PieSeries3D) (prop: PieSeries3DProp) =
        match prop with
        | PieSeries3DProp.Base p -> PieSeries.apply el p
        | PieSeries3DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries3D.ModelProperty, box v)
        | PieSeries3DProp.DepthTransform v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries3D.DepthTransformProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PieSeries3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
