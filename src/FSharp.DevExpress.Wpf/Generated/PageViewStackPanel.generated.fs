...
type PageViewStackPanelProp =
    | Base of StackLayoutPanelProp
    | LayoutType of DevExpress.Xpf.WindowsUI.PageHeadersLayoutType

module PageViewStackPanel =
    let layoutType v : obj = box (PageViewStackPanelProp.LayoutType v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.PageViewStackPanel) (prop: PageViewStackPanelProp) =
        match prop with
        | PageViewStackPanelProp.Base p -> StackLayoutPanel.apply el p
        | PageViewStackPanelProp.LayoutType v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.PageViewStackPanel.LayoutTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.PageViewStackPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
