...
type TrendLineProp =
    | Base of FinancialIndicatorProp
    | ExtrapolateToInfinity of bool
    | ExtrapolateToNegativeInfinity of bool

module TrendLine =
    let extrapolateToInfinity v : obj = box (TrendLineProp.ExtrapolateToInfinity v)
    let extrapolateToNegativeInfinity v : obj = box (TrendLineProp.ExtrapolateToNegativeInfinity v)

    let apply (el: DevExpress.Xpf.Charts.TrendLine) (prop: TrendLineProp) =
        match prop with
        | TrendLineProp.Base p -> FinancialIndicator.apply el p
        | TrendLineProp.ExtrapolateToInfinity v -> el.SetValue(DevExpress.Xpf.Charts.TrendLine.ExtrapolateToInfinityProperty, box v)
        | TrendLineProp.ExtrapolateToNegativeInfinity v -> el.SetValue(DevExpress.Xpf.Charts.TrendLine.ExtrapolateToNegativeInfinityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TrendLine>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
