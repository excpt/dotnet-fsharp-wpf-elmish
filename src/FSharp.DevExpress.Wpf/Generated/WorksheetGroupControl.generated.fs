...
type WorksheetGroupControlProp =
    | HeaderTemplate of System.Windows.Controls.ControlTemplate
    | ButtonTemplate of System.Windows.Controls.ControlTemplate
    | LineThickness of float
    | LineBrush of System.Windows.Media.Brush
    | DotThickness of float
    | DotBrush of System.Windows.Media.Brush

module WorksheetGroupControl =
    let headerTemplate v : obj = box (WorksheetGroupControlProp.HeaderTemplate v)
    let buttonTemplate v : obj = box (WorksheetGroupControlProp.ButtonTemplate v)
    let lineThickness v : obj = box (WorksheetGroupControlProp.LineThickness v)
    let lineBrush v : obj = box (WorksheetGroupControlProp.LineBrush v)
    let dotThickness v : obj = box (WorksheetGroupControlProp.DotThickness v)
    let dotBrush v : obj = box (WorksheetGroupControlProp.DotBrush v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl) (prop: WorksheetGroupControlProp) =
        match prop with
        | WorksheetGroupControlProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl.HeaderTemplateProperty, box v)
        | WorksheetGroupControlProp.ButtonTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl.ButtonTemplateProperty, box v)
        | WorksheetGroupControlProp.LineThickness v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl.LineThicknessProperty, box v)
        | WorksheetGroupControlProp.LineBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl.LineBrushProperty, box v)
        | WorksheetGroupControlProp.DotThickness v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl.DotThicknessProperty, box v)
        | WorksheetGroupControlProp.DotBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl.DotBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
