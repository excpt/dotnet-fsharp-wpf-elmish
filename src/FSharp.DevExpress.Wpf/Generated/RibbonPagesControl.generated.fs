...
type RibbonPagesControlProp =
    | SelectedPage of DevExpress.Xpf.Ribbon.RibbonPage

module RibbonPagesControl =
    let selectedPage v : obj = box (RibbonPagesControlProp.SelectedPage v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPagesControl) (prop: RibbonPagesControlProp) =
        match prop with
        | RibbonPagesControlProp.SelectedPage v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPagesControl.SelectedPageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPagesControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
