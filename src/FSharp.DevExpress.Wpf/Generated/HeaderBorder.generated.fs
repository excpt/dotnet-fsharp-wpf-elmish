...
type HeaderBorderProp =
    | Base of CalculatedBorderBaseProp
    | ElementPosition of DevExpress.Xpf.Scheduler.Drawing.ElementPosition

module HeaderBorder =
    let elementPosition v : obj = box (HeaderBorderProp.ElementPosition v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HeaderBorder) (prop: HeaderBorderProp) =
        match prop with
        | HeaderBorderProp.Base p -> CalculatedBorderBase.apply el p
        | HeaderBorderProp.ElementPosition v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderBorder.ElementPositionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HeaderBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
