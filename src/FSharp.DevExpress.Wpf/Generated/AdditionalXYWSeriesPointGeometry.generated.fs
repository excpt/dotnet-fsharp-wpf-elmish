...
type AdditionalXYWSeriesPointGeometryProp =
    | Base of AdditionalSeriesPointGeometryProp

module AdditionalXYWSeriesPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalXYWSeriesPointGeometry) (prop: AdditionalXYWSeriesPointGeometryProp) =
        match prop with
        | AdditionalXYWSeriesPointGeometryProp.Base p -> AdditionalSeriesPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalXYWSeriesPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
