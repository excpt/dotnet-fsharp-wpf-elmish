...
type SmartMajorTickmarkControlProp =
    | Base of PresentationControlProp

module SmartMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartMajorTickmarkControl) (prop: SmartMajorTickmarkControlProp) =
        match prop with
        | SmartMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
