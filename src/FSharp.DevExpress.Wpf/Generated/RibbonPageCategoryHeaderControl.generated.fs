...
type RibbonPageCategoryHeaderControlProp =
    | Base of RibbonCaptionControlProp
    | Category of DevExpress.Xpf.Ribbon.RibbonPageCategoryBase
    | RightIndent of float
    | IsAeroMode of bool
    | AeroTemplate of System.Windows.Controls.ControlTemplate
    | HeaderVisibility of System.Windows.Visibility

module RibbonPageCategoryHeaderControl =
    let category v : obj = box (RibbonPageCategoryHeaderControlProp.Category v)
    let rightIndent v : obj = box (RibbonPageCategoryHeaderControlProp.RightIndent v)
    let isAeroMode v : obj = box (RibbonPageCategoryHeaderControlProp.IsAeroMode v)
    let aeroTemplate v : obj = box (RibbonPageCategoryHeaderControlProp.AeroTemplate v)
    let headerVisibility v : obj = box (RibbonPageCategoryHeaderControlProp.HeaderVisibility v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl) (prop: RibbonPageCategoryHeaderControlProp) =
        match prop with
        | RibbonPageCategoryHeaderControlProp.Base p -> RibbonCaptionControl.apply el p
        | RibbonPageCategoryHeaderControlProp.Category v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl.CategoryProperty, box v)
        | RibbonPageCategoryHeaderControlProp.RightIndent v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl.RightIndentProperty, box v)
        | RibbonPageCategoryHeaderControlProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl.IsAeroModeProperty, box v)
        | RibbonPageCategoryHeaderControlProp.AeroTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl.AeroTemplateProperty, box v)
        | RibbonPageCategoryHeaderControlProp.HeaderVisibility v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl.HeaderVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageCategoryHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
