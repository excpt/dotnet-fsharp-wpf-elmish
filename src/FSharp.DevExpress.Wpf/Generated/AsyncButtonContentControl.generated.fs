...
type AsyncButtonContentControlProp =
    | CancelCommand of System.Windows.Input.ICommand
    | CancelCommandParameter of obj
    | ShouldShowCancelButton of bool
    | RetryCommand of System.Windows.Input.ICommand
    | RetryCommandParameter of obj
    | ShowRetryButton of bool

module AsyncButtonContentControl =
    let cancelCommand v : obj = box (AsyncButtonContentControlProp.CancelCommand v)
    let cancelCommandParameter v : obj = box (AsyncButtonContentControlProp.CancelCommandParameter v)
    let shouldShowCancelButton v : obj = box (AsyncButtonContentControlProp.ShouldShowCancelButton v)
    let retryCommand v : obj = box (AsyncButtonContentControlProp.RetryCommand v)
    let retryCommandParameter v : obj = box (AsyncButtonContentControlProp.RetryCommandParameter v)
    let showRetryButton v : obj = box (AsyncButtonContentControlProp.ShowRetryButton v)

    let apply (el: DevExpress.Xpf.Core.Native.AsyncButtonContentControl) (prop: AsyncButtonContentControlProp) =
        match prop with
        | AsyncButtonContentControlProp.CancelCommand v -> el.SetValue(DevExpress.Xpf.Core.Native.AsyncButtonContentControl.CancelCommandProperty, box v)
        | AsyncButtonContentControlProp.CancelCommandParameter v -> el.SetValue(DevExpress.Xpf.Core.Native.AsyncButtonContentControl.CancelCommandParameterProperty, box v)
        | AsyncButtonContentControlProp.ShouldShowCancelButton v -> el.SetValue(DevExpress.Xpf.Core.Native.AsyncButtonContentControl.ShouldShowCancelButtonProperty, box v)
        | AsyncButtonContentControlProp.RetryCommand v -> el.SetValue(DevExpress.Xpf.Core.Native.AsyncButtonContentControl.RetryCommandProperty, box v)
        | AsyncButtonContentControlProp.RetryCommandParameter v -> el.SetValue(DevExpress.Xpf.Core.Native.AsyncButtonContentControl.RetryCommandParameterProperty, box v)
        | AsyncButtonContentControlProp.ShowRetryButton v -> el.SetValue(DevExpress.Xpf.Core.Native.AsyncButtonContentControl.ShowRetryButtonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.AsyncButtonContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
