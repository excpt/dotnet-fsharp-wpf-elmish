...
type TemplatedCaptionControlProp =
    | Base of psvControlProp
    | CaptionControlTemplate of System.Windows.Controls.ControlTemplate
    | ContentPresenterTemplate of System.Windows.Controls.ControlTemplate
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem
    | CaptionMargin of System.Windows.Thickness
    | ActualCaptionWidth of float
    | CaptionImage of System.Windows.Media.ImageSource
    | ShowCaptionImage of bool

module TemplatedCaptionControl =
    let captionControlTemplate v : obj = box (TemplatedCaptionControlProp.CaptionControlTemplate v)
    let contentPresenterTemplate v : obj = box (TemplatedCaptionControlProp.ContentPresenterTemplate v)
    let layoutItem v : obj = box (TemplatedCaptionControlProp.LayoutItem v)
    let captionMargin v : obj = box (TemplatedCaptionControlProp.CaptionMargin v)
    let actualCaptionWidth v : obj = box (TemplatedCaptionControlProp.ActualCaptionWidth v)
    let captionImage v : obj = box (TemplatedCaptionControlProp.CaptionImage v)
    let showCaptionImage v : obj = box (TemplatedCaptionControlProp.ShowCaptionImage v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl) (prop: TemplatedCaptionControlProp) =
        match prop with
        | TemplatedCaptionControlProp.Base p -> psvControl.apply el p
        | TemplatedCaptionControlProp.CaptionControlTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.CaptionControlTemplateProperty, box v)
        | TemplatedCaptionControlProp.ContentPresenterTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.ContentPresenterTemplateProperty, box v)
        | TemplatedCaptionControlProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.LayoutItemProperty, box v)
        | TemplatedCaptionControlProp.CaptionMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.CaptionMarginProperty, box v)
        | TemplatedCaptionControlProp.ActualCaptionWidth v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.ActualCaptionWidthProperty, box v)
        | TemplatedCaptionControlProp.CaptionImage v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.CaptionImageProperty, box v)
        | TemplatedCaptionControlProp.ShowCaptionImage v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl.ShowCaptionImageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TemplatedCaptionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
