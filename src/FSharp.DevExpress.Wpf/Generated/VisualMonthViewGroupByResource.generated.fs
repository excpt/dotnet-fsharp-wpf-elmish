...
type VisualMonthViewGroupByResourceProp =
    | Base of VisualResourcesBasedViewInfoProp

module VisualMonthViewGroupByResource =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualMonthViewGroupByResource) (prop: VisualMonthViewGroupByResourceProp) =
        match prop with
        | VisualMonthViewGroupByResourceProp.Base p -> VisualResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualMonthViewGroupByResource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
