...
type DataPagerNumericButtonProp =
    | Base of DataPagerButtonProp

module DataPagerNumericButton =

    let apply (el: DevExpress.Xpf.Editors.DataPager.DataPagerNumericButton) (prop: DataPagerNumericButtonProp) =
        match prop with
        | DataPagerNumericButtonProp.Base p -> DataPagerButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DataPager.DataPagerNumericButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
