...
open System
open System.Windows
open DevExpress.Xpf.Controls.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type BreadcrumbItemProp =
    | ArrowGlyphTransform of System.Windows.Media.RotateTransform
    | ButtonContentTemplate of System.Windows.DataTemplate
    | ButtonContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | SubItems of obj
    | IsArrowMouseOver of bool
    | IsArrowPressed of bool
    | IsButtonMouseOver of bool
    | IsButtonPressed of bool
    | IsPopupOpen of bool
    | ShowArrow of bool
    | SubItemTemplate of System.Windows.DataTemplate
    | SubItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    ...
    | OnItemClick of System.EventHandler

module BreadcrumbItem =
    let arrowGlyphTransform v : obj = box (BreadcrumbItemProp.ArrowGlyphTransform v)
    let buttonContentTemplate v : obj = box (BreadcrumbItemProp.ButtonContentTemplate v)
    let buttonContentTemplateSelector v : obj = box (BreadcrumbItemProp.ButtonContentTemplateSelector v)
    let subItems v : obj = box (BreadcrumbItemProp.SubItems v)
    let isArrowMouseOver v : obj = box (BreadcrumbItemProp.IsArrowMouseOver v)
    let isArrowPressed v : obj = box (BreadcrumbItemProp.IsArrowPressed v)
    let isButtonMouseOver v : obj = box (BreadcrumbItemProp.IsButtonMouseOver v)
    let isButtonPressed v : obj = box (BreadcrumbItemProp.IsButtonPressed v)
    let isPopupOpen v : obj = box (BreadcrumbItemProp.IsPopupOpen v)
    let showArrow v : obj = box (BreadcrumbItemProp.ShowArrow v)
    let subItemTemplate v : obj = box (BreadcrumbItemProp.SubItemTemplate v)
    let subItemTemplateSelector v : obj = box (BreadcrumbItemProp.SubItemTemplateSelector v)
    let popupHeight v : obj = box (BreadcrumbItemProp.PopupHeight v)
    let popupMinHeight v : obj = box (BreadcrumbItemProp.PopupMinHeight v)
    let popupMaxHeight v : obj = box (BreadcrumbItemProp.PopupMaxHeight v)
    let popupWidth v : obj = box (BreadcrumbItemProp.PopupWidth v)
    let popupMinWidth v : obj = box (BreadcrumbItemProp.PopupMinWidth v)
    let popupMaxWidth v : obj = box (BreadcrumbItemProp.PopupMaxWidth v)
    let onItemClick v : obj = box (EventProp(box (BreadcrumbItemProp.OnItemClick v)))

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbItem) (prop: BreadcrumbItemProp) =
        match prop with
        | BreadcrumbItemProp.ArrowGlyphTransform v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.ArrowGlyphTransformProperty, box v)
        | BreadcrumbItemProp.ButtonContentTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.ButtonContentTemplateProperty, box v)
        | BreadcrumbItemProp.ButtonContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.ButtonContentTemplateSelectorProperty, box v)
        | BreadcrumbItemProp.SubItems v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.SubItemsProperty, box v)
        | BreadcrumbItemProp.IsArrowMouseOver v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.IsArrowMouseOverProperty, box v)
        | BreadcrumbItemProp.IsArrowPressed v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.IsArrowPressedProperty, box v)
        | BreadcrumbItemProp.IsButtonMouseOver v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.IsButtonMouseOverProperty, box v)
        | BreadcrumbItemProp.IsButtonPressed v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.IsButtonPressedProperty, box v)
        | BreadcrumbItemProp.IsPopupOpen v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.IsPopupOpenProperty, box v)
        | BreadcrumbItemProp.ShowArrow v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.ShowArrowProperty, box v)
        | BreadcrumbItemProp.SubItemTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.SubItemTemplateProperty, box v)
        | BreadcrumbItemProp.SubItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.SubItemTemplateSelectorProperty, box v)
        | BreadcrumbItemProp.PopupHeight v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.PopupHeightProperty, box v)
        | BreadcrumbItemProp.PopupMinHeight v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.PopupMinHeightProperty, box v)
        | BreadcrumbItemProp.PopupMaxHeight v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.PopupMaxHeightProperty, box v)
        | BreadcrumbItemProp.PopupWidth v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.PopupWidthProperty, box v)
        | BreadcrumbItemProp.PopupMinWidth v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.PopupMinWidthProperty, box v)
        | BreadcrumbItemProp.PopupMaxWidth v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItem.PopupMaxWidthProperty, box v)
        | BreadcrumbItemProp.OnItemClick h -> el.ItemClick.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
