...
type NavigationButtonProp =
    | NavigateTo of obj
    | NavigationParameter of obj
    | NavigationTarget of obj

module NavigationButton =
    let navigateTo v : obj = box (NavigationButtonProp.NavigateTo v)
    let navigationParameter v : obj = box (NavigationButtonProp.NavigationParameter v)
    let navigationTarget v : obj = box (NavigationButtonProp.NavigationTarget v)

    let apply (el: DevExpress.Xpf.WindowsUI.NavigationButton) (prop: NavigationButtonProp) =
        match prop with
        | NavigationButtonProp.NavigateTo v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationButton.NavigateToProperty, box v)
        | NavigationButtonProp.NavigationParameter v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationButton.NavigationParameterProperty, box v)
        | NavigationButtonProp.NavigationTarget v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationButton.NavigationTargetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.NavigationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
