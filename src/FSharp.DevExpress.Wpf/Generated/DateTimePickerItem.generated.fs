...
type DateTimePickerItemProp =
    | IsExpanded of bool
    | IsFake of bool
    | IsActive of bool
    | UseTransitions of bool

module DateTimePickerItem =
    let isExpanded v : obj = box (DateTimePickerItemProp.IsExpanded v)
    let isFake v : obj = box (DateTimePickerItemProp.IsFake v)
    let isActive v : obj = box (DateTimePickerItemProp.IsActive v)
    let useTransitions v : obj = box (DateTimePickerItemProp.UseTransitions v)

    let apply (el: DevExpress.Xpf.Editors.DateTimePickerItem) (prop: DateTimePickerItemProp) =
        match prop with
        | DateTimePickerItemProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.Editors.DateTimePickerItem.IsExpandedProperty, box v)
        | DateTimePickerItemProp.IsFake v -> el.SetValue(DevExpress.Xpf.Editors.DateTimePickerItem.IsFakeProperty, box v)
        | DateTimePickerItemProp.IsActive v -> el.SetValue(DevExpress.Xpf.Editors.DateTimePickerItem.IsActiveProperty, box v)
        | DateTimePickerItemProp.UseTransitions v -> el.SetValue(DevExpress.Xpf.Editors.DateTimePickerItem.UseTransitionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateTimePickerItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
