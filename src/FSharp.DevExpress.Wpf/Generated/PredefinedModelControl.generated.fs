...
type PredefinedModelControlProp =
    | Base of ModelControlProp
    | PointColor of System.Windows.Media.Color

module PredefinedModelControl =
    let pointColor v : obj = box (PredefinedModelControlProp.PointColor v)

    let apply (el: DevExpress.Xpf.Charts.PredefinedModelControl) (prop: PredefinedModelControlProp) =
        match prop with
        | PredefinedModelControlProp.Base p -> ModelControl.apply el p
        | PredefinedModelControlProp.PointColor v -> el.SetValue(DevExpress.Xpf.Charts.PredefinedModelControl.PointColorProperty, box v)
