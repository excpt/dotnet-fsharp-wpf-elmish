...
type MultiScaleTileImageProp =
    | Base of MultiScaleImageBaseProp
    | CacheOptions of DevExpress.Xpf.Map.CacheOptions

module MultiScaleTileImage =
    let cacheOptions v : obj = box (MultiScaleTileImageProp.CacheOptions v)

    let apply (el: DevExpress.Xpf.Map.MultiScaleTileImage) (prop: MultiScaleTileImageProp) =
        match prop with
        | MultiScaleTileImageProp.Base p -> MultiScaleImageBase.apply el p
        | MultiScaleTileImageProp.CacheOptions v -> el.SetValue(DevExpress.Xpf.Map.MultiScaleTileImage.CacheOptionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MultiScaleTileImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
