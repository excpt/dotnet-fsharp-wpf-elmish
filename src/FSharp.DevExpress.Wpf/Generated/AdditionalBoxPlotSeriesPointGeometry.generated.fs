...
type AdditionalBoxPlotSeriesPointGeometryProp =
    | Base of AdditionalSeriesPointGeometryProp

module AdditionalBoxPlotSeriesPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.Native.AdditionalBoxPlotSeriesPointGeometry) (prop: AdditionalBoxPlotSeriesPointGeometryProp) =
        match prop with
        | AdditionalBoxPlotSeriesPointGeometryProp.Base p -> AdditionalSeriesPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Native.AdditionalBoxPlotSeriesPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
