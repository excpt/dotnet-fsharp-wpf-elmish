...
type BarSplitCheckItemLinkControlProp =
    | Base of BarSplitButtonItemLinkControlProp
    | IsTriStateBorderVisible of bool
    | IsCheckVisible of bool
    | IsCheckGlyphBorderVisible of bool
    | IsTriStateGlyphBorderVisible of bool

module BarSplitCheckItemLinkControl =
    let isTriStateBorderVisible v : obj = box (BarSplitCheckItemLinkControlProp.IsTriStateBorderVisible v)
    let isCheckVisible v : obj = box (BarSplitCheckItemLinkControlProp.IsCheckVisible v)
    let isCheckGlyphBorderVisible v : obj = box (BarSplitCheckItemLinkControlProp.IsCheckGlyphBorderVisible v)
    let isTriStateGlyphBorderVisible v : obj = box (BarSplitCheckItemLinkControlProp.IsTriStateGlyphBorderVisible v)

    let apply (el: DevExpress.Xpf.Bars.BarSplitCheckItemLinkControl) (prop: BarSplitCheckItemLinkControlProp) =
        match prop with
        | BarSplitCheckItemLinkControlProp.Base p -> BarSplitButtonItemLinkControl.apply el p
        | BarSplitCheckItemLinkControlProp.IsTriStateBorderVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitCheckItemLinkControl.IsTriStateBorderVisibleProperty, box v)
        | BarSplitCheckItemLinkControlProp.IsCheckVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitCheckItemLinkControl.IsCheckVisibleProperty, box v)
        | BarSplitCheckItemLinkControlProp.IsCheckGlyphBorderVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitCheckItemLinkControl.IsCheckGlyphBorderVisibleProperty, box v)
        | BarSplitCheckItemLinkControlProp.IsTriStateGlyphBorderVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarSplitCheckItemLinkControl.IsTriStateGlyphBorderVisibleProperty, box v)

    let isArrowPressed v : obj = box (BarSplitButtonItemLinkControlProp.IsArrowPressed v)
    let showArrowHotBorder v : obj = box (BarSplitButtonItemLinkControlProp.ShowArrowHotBorder v)
    let itemPosition v : obj = box (BarSplitButtonItemLinkControlProp.ItemPosition v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarSplitCheckItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
