...
type AnnotationRotateThumbProp =
    | Base of AnnotationThumbProp

module AnnotationRotateThumb =

    let apply (el: DevExpress.Xpf.Charts.AnnotationRotateThumb) (prop: AnnotationRotateThumbProp) =
        match prop with
        | AnnotationRotateThumbProp.Base p -> AnnotationThumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AnnotationRotateThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
