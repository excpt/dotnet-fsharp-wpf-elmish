...
type TabHeadersPanelProp =
    | Base of BaseHeadersPanelProp

module TabHeadersPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabHeadersPanel) (prop: TabHeadersPanelProp) =
        match prop with
        | TabHeadersPanelProp.Base p -> BaseHeadersPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabHeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
