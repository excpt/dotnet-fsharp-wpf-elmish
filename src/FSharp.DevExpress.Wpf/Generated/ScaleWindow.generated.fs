...
type ScaleWindowProp =
    | Base of DXDialogProp

module ScaleWindow =

    let apply (el: DevExpress.Xpf.Printing.Native.ScaleWindow) (prop: ScaleWindowProp) =
        match prop with
        | ScaleWindowProp.Base p -> DXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.ScaleWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
