...
type RadarLineSeries2DProp =
    | Base of CircularLineSeries2DProp

module RadarLineSeries2D =

    let apply (el: DevExpress.Xpf.Charts.RadarLineSeries2D) (prop: RadarLineSeries2DProp) =
        match prop with
        | RadarLineSeries2DProp.Base p -> CircularLineSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RadarLineSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
