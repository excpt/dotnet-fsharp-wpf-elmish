...
open System
open System.Windows
open DevExpress.Xpf.Scheduler.Reporting.UI
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SchedulerPrintingSettingsFormProp =
    | Base of DXWindowProp
    | PrintingSettings of DevExpress.Xpf.Scheduler.Reporting.UI.ISchedulerPrintingSettingsFormViewModel
    | ResourcesKindSource of obj

module SchedulerPrintingSettingsForm =
    let printingSettings v : obj = box (SchedulerPrintingSettingsFormProp.PrintingSettings v)
    let resourcesKindSource v : obj = box (SchedulerPrintingSettingsFormProp.ResourcesKindSource v)

    let apply (el: DevExpress.Xpf.Scheduler.Reporting.UI.SchedulerPrintingSettingsForm) (prop: SchedulerPrintingSettingsFormProp) =
        match prop with
        | SchedulerPrintingSettingsFormProp.Base p -> DXWindow.apply el p
        | SchedulerPrintingSettingsFormProp.PrintingSettings v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.UI.SchedulerPrintingSettingsForm.PrintingSettingsProperty, box v)
        | SchedulerPrintingSettingsFormProp.ResourcesKindSource v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.UI.SchedulerPrintingSettingsForm.ResourcesKindSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Reporting.UI.SchedulerPrintingSettingsForm>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
