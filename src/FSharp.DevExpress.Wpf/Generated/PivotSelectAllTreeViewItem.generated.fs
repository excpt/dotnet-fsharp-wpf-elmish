...
type PivotSelectAllTreeViewItemProp =
    | Base of FilterCheckedTreeViewItemProp

module PivotSelectAllTreeViewItem =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.PivotSelectAllTreeViewItem) (prop: PivotSelectAllTreeViewItemProp) =
        match prop with
        | PivotSelectAllTreeViewItemProp.Base p -> FilterCheckedTreeViewItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.PivotSelectAllTreeViewItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
