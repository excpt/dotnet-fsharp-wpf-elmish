...
type IStyleGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleGaugeBackgroundLayerControl) (prop: IStyleGaugeBackgroundLayerControlProp) =
        match prop with
        | IStyleGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
