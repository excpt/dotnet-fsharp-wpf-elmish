...
type XAxis3DProp =
    | Base of ArgumentAxis3DProp

module XAxis3D =

    let apply (el: DevExpress.Xpf.Charts.XAxis3D) (prop: XAxis3DProp) =
        match prop with
        | XAxis3DProp.Base p -> ArgumentAxis3D.apply el p

    let dateTimeScaleOptions v : obj = box (ArgumentAxis3DProp.DateTimeScaleOptions v)
    let timeSpanScaleOptions v : obj = box (ArgumentAxis3DProp.TimeSpanScaleOptions v)
    let numericScaleOptions v : obj = box (ArgumentAxis3DProp.NumericScaleOptions v)
    let qualitativeScaleOptions v : obj = box (ArgumentAxis3DProp.QualitativeScaleOptions v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.XAxis3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
