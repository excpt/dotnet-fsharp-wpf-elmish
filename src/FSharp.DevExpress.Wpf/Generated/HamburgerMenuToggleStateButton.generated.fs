...
type HamburgerMenuToggleStateButtonProp =
    | IsInFlyout of bool

module HamburgerMenuToggleStateButton =
    let isInFlyout v : obj = box (HamburgerMenuToggleStateButtonProp.IsInFlyout v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuToggleStateButton) (prop: HamburgerMenuToggleStateButtonProp) =
        match prop with
        | HamburgerMenuToggleStateButtonProp.IsInFlyout v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuToggleStateButton.IsInFlyoutProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuToggleStateButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
