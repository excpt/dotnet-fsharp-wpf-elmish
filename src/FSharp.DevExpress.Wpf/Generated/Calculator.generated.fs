...
type CalculatorProp =
    | IsDigitalDisplay of bool
    | Precision of int
    | ShowBorder of bool
    | ShowFocusedState of bool
    | Value of System.Decimal
    | CornerRadius of System.Windows.CornerRadius
    | OperationButtonStyle of System.Windows.Style
    | DigitButtonStyle of System.Windows.Style
    | CEButtonStyle of System.Windows.Style
    | OnCustomErrorText of DevExpress.Xpf.Editors.CalculatorCustomErrorTextEventHandler
    | OnValueChanged of DevExpress.Xpf.Editors.CalculatorValueChangedEventHandler

module Calculator =
    let isDigitalDisplay v : obj = box (CalculatorProp.IsDigitalDisplay v)
    let precision v : obj = box (CalculatorProp.Precision v)
    let showBorder v : obj = box (CalculatorProp.ShowBorder v)
    let showFocusedState v : obj = box (CalculatorProp.ShowFocusedState v)
    let value v : obj = box (CalculatorProp.Value v)
    let cornerRadius v : obj = box (CalculatorProp.CornerRadius v)
    let operationButtonStyle v : obj = box (CalculatorProp.OperationButtonStyle v)
    let digitButtonStyle v : obj = box (CalculatorProp.DigitButtonStyle v)
    let cEButtonStyle v : obj = box (CalculatorProp.CEButtonStyle v)
    let onCustomErrorText v : obj = box (EventProp(box (CalculatorProp.OnCustomErrorText v)))
    let onValueChanged v : obj = box (EventProp(box (CalculatorProp.OnValueChanged v)))

    let apply (el: DevExpress.Xpf.Editors.Calculator) (prop: CalculatorProp) =
        match prop with
        | CalculatorProp.IsDigitalDisplay v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.IsDigitalDisplayProperty, box v)
        | CalculatorProp.Precision v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.PrecisionProperty, box v)
        | CalculatorProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.ShowBorderProperty, box v)
        | CalculatorProp.ShowFocusedState v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.ShowFocusedStateProperty, box v)
        | CalculatorProp.Value v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.ValueProperty, box v)
        | CalculatorProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.CornerRadiusProperty, box v)
        | CalculatorProp.OperationButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.OperationButtonStyleProperty, box v)
        | CalculatorProp.DigitButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.DigitButtonStyleProperty, box v)
        | CalculatorProp.CEButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.Calculator.CEButtonStyleProperty, box v)
        | CalculatorProp.OnCustomErrorText h -> el.CustomErrorText.AddHandler(h)
        | CalculatorProp.OnValueChanged h -> el.ValueChanged.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Calculator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
