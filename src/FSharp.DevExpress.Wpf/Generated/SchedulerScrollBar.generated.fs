...
type SchedulerScrollBarProp =
    | AutoHide of bool

module SchedulerScrollBar =
    let autoHide v : obj = box (SchedulerScrollBarProp.AutoHide v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.SchedulerScrollBar) (prop: SchedulerScrollBarProp) =
        match prop with
        | SchedulerScrollBarProp.AutoHide v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerScrollBar.AutoHideProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.SchedulerScrollBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
