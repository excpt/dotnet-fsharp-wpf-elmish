...
type CircularCleanWhiteThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCleanWhiteThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCleanWhiteThreeQuartersModel) (prop: CircularCleanWhiteThreeQuartersModelProp) =
        match prop with
        | CircularCleanWhiteThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCleanWhiteThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
