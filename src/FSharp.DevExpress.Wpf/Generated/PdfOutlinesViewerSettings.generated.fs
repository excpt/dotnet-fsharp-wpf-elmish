...
type PdfOutlinesViewerSettingsProp =
    | Base of DocumentMapSettingsProp
    | HideOutlinesViewer of bool
    | OutlinesViewerState of DevExpress.Xpf.PdfViewer.PdfOutlinesViewerState
    | OutlinesViewerInitialState of obj
    | OutlinesViewerStyle of System.Windows.Style
    | OutlinesViewerPanelStyle of DevExpress.Xpf.PdfViewer.PdfOutlinesViewerPanelStyle
    | ApplyOutlinesForeground of bool

module PdfOutlinesViewerSettings =
    let hideOutlinesViewer v : obj = box (PdfOutlinesViewerSettingsProp.HideOutlinesViewer v)
    let outlinesViewerState v : obj = box (PdfOutlinesViewerSettingsProp.OutlinesViewerState v)
    let outlinesViewerInitialState v : obj = box (PdfOutlinesViewerSettingsProp.OutlinesViewerInitialState v)
    let outlinesViewerStyle v : obj = box (PdfOutlinesViewerSettingsProp.OutlinesViewerStyle v)
    let outlinesViewerPanelStyle v : obj = box (PdfOutlinesViewerSettingsProp.OutlinesViewerPanelStyle v)
    let applyOutlinesForeground v : obj = box (PdfOutlinesViewerSettingsProp.ApplyOutlinesForeground v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings) (prop: PdfOutlinesViewerSettingsProp) =
        match prop with
        | PdfOutlinesViewerSettingsProp.Base p -> DocumentMapSettings.apply el p
        | PdfOutlinesViewerSettingsProp.HideOutlinesViewer v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings.HideOutlinesViewerProperty, box v)
        | PdfOutlinesViewerSettingsProp.OutlinesViewerState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings.OutlinesViewerStateProperty, box v)
        | PdfOutlinesViewerSettingsProp.OutlinesViewerInitialState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings.OutlinesViewerInitialStateProperty, box v)
        | PdfOutlinesViewerSettingsProp.OutlinesViewerStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings.OutlinesViewerStyleProperty, box v)
        | PdfOutlinesViewerSettingsProp.OutlinesViewerPanelStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings.OutlinesViewerPanelStyleProperty, box v)
        | PdfOutlinesViewerSettingsProp.ApplyOutlinesForeground v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings.ApplyOutlinesForegroundProperty, box v)

    let actualHideAfterUse v : obj = box (DocumentMapSettingsProp.ActualHideAfterUse v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfOutlinesViewerSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
