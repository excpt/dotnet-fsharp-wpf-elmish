...
type LayoutTabControlProp =
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem
    | CaptionLocation of DevExpress.Xpf.Docking.CaptionLocation
    | CaptionOrientation of System.Windows.Controls.Orientation
    | TabHeaderLayoutType of DevExpress.Xpf.Layout.Core.TabHeaderLayoutType
    | IsAutoFillHeaders of bool
    | ScrollIndex of int
    | DestroyContentOnTabSwitching of bool
    | TabContentCacheMode of DevExpress.Xpf.Core.TabContentCacheMode
    | ActualTabContentCacheMode of DevExpress.Xpf.Core.TabContentCacheMode
    | ShowTabForSinglePage of bool
    | VisiblePagesCount of obj
    | FixedMultiLineTabHeaders of bool
    | ClipMargin of System.Windows.Thickness
    | TabPanelMargin of System.Windows.Thickness
    | AutoScrollOnOverflow of DevExpress.Xpf.Docking.AutoScrollOnOverflow
    | ViewStyle of DevExpress.Xpf.Docking.DockingViewStyle
    | ArrangeAllCachedTabs of bool
    | TabbedGroupDisplayMode of DevExpress.Xpf.Docking.TabbedGroupDisplayMode

module LayoutTabControl =
    let layoutItem v : obj = box (LayoutTabControlProp.LayoutItem v)
    let captionLocation v : obj = box (LayoutTabControlProp.CaptionLocation v)
    let captionOrientation v : obj = box (LayoutTabControlProp.CaptionOrientation v)
    let tabHeaderLayoutType v : obj = box (LayoutTabControlProp.TabHeaderLayoutType v)
    let isAutoFillHeaders v : obj = box (LayoutTabControlProp.IsAutoFillHeaders v)
    let scrollIndex v : obj = box (LayoutTabControlProp.ScrollIndex v)
    let destroyContentOnTabSwitching v : obj = box (LayoutTabControlProp.DestroyContentOnTabSwitching v)
    let tabContentCacheMode v : obj = box (LayoutTabControlProp.TabContentCacheMode v)
    let actualTabContentCacheMode v : obj = box (LayoutTabControlProp.ActualTabContentCacheMode v)
    let showTabForSinglePage v : obj = box (LayoutTabControlProp.ShowTabForSinglePage v)
    let visiblePagesCount v : obj = box (LayoutTabControlProp.VisiblePagesCount v)
    let fixedMultiLineTabHeaders v : obj = box (LayoutTabControlProp.FixedMultiLineTabHeaders v)
    let clipMargin v : obj = box (LayoutTabControlProp.ClipMargin v)
    let tabPanelMargin v : obj = box (LayoutTabControlProp.TabPanelMargin v)
    let autoScrollOnOverflow v : obj = box (LayoutTabControlProp.AutoScrollOnOverflow v)
    let viewStyle v : obj = box (LayoutTabControlProp.ViewStyle v)
    let arrangeAllCachedTabs v : obj = box (LayoutTabControlProp.ArrangeAllCachedTabs v)
    let tabbedGroupDisplayMode v : obj = box (LayoutTabControlProp.TabbedGroupDisplayMode v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.LayoutTabControl) (prop: LayoutTabControlProp) =
        match prop with
        | LayoutTabControlProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.LayoutItemProperty, box v)
        | LayoutTabControlProp.CaptionLocation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.CaptionLocationProperty, box v)
        | LayoutTabControlProp.CaptionOrientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.CaptionOrientationProperty, box v)
        | LayoutTabControlProp.TabHeaderLayoutType v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.TabHeaderLayoutTypeProperty, box v)
        | LayoutTabControlProp.IsAutoFillHeaders v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.IsAutoFillHeadersProperty, box v)
        | LayoutTabControlProp.ScrollIndex v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.ScrollIndexProperty, box v)
        | LayoutTabControlProp.DestroyContentOnTabSwitching v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.DestroyContentOnTabSwitchingProperty, box v)
        | LayoutTabControlProp.TabContentCacheMode v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.TabContentCacheModeProperty, box v)
        | LayoutTabControlProp.ActualTabContentCacheMode v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.ActualTabContentCacheModeProperty, box v)
        | LayoutTabControlProp.ShowTabForSinglePage v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.ShowTabForSinglePageProperty, box v)
        | LayoutTabControlProp.VisiblePagesCount v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.VisiblePagesCountProperty, box v)
        | LayoutTabControlProp.FixedMultiLineTabHeaders v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.FixedMultiLineTabHeadersProperty, box v)
        | LayoutTabControlProp.ClipMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.ClipMarginProperty, box v)
        | LayoutTabControlProp.TabPanelMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.TabPanelMarginProperty, box v)
        | LayoutTabControlProp.AutoScrollOnOverflow v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.AutoScrollOnOverflowProperty, box v)
        | LayoutTabControlProp.ViewStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.ViewStyleProperty, box v)
        | LayoutTabControlProp.ArrangeAllCachedTabs v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.ArrangeAllCachedTabsProperty, box v)
        | LayoutTabControlProp.TabbedGroupDisplayMode v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabControl.TabbedGroupDisplayModeProperty, box v)
