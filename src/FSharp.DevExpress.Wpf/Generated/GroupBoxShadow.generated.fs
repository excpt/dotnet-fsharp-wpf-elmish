...
type GroupBoxShadowProp =
    | Base of ContainerProp
    | CornerRadius of System.Windows.CornerRadius
    | Offset of float

module GroupBoxShadow =
    let cornerRadius v : obj = box (GroupBoxShadowProp.CornerRadius v)
    let offset v : obj = box (GroupBoxShadowProp.Offset v)

    let apply (el: DevExpress.Xpf.LayoutControl.GroupBoxShadow) (prop: GroupBoxShadowProp) =
        match prop with
        | GroupBoxShadowProp.Base p -> Container.apply el p
        | GroupBoxShadowProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBoxShadow.CornerRadiusProperty, box v)
        | GroupBoxShadowProp.Offset v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBoxShadow.OffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.GroupBoxShadow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
