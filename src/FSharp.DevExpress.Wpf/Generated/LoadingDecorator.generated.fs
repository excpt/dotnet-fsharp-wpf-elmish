...
type LoadingDecoratorProp =
    | UseFadeEffect of bool
    | FadeInDuration of System.TimeSpan
    | FadeOutDuration of System.TimeSpan
    | UseSplashScreen of bool
    | SplashScreenTemplate of System.Windows.DataTemplate
    | SplashScreenDataContext of obj
    | IsSplashScreenShown of obj
    | OwnerLock of DevExpress.Xpf.Core.SplashScreenLock
    | SplashScreenLocation of DevExpress.Xpf.Core.SplashScreenLocation
    | SplashScreenWindowStyle of System.Windows.Style
    | LoadingChildTemplate of System.Windows.DataTemplate
    | BorderEffect of DevExpress.Xpf.Core.BorderEffect
    | BorderEffectColor of System.Windows.Media.SolidColorBrush

module LoadingDecorator =
    let useFadeEffect v : obj = box (LoadingDecoratorProp.UseFadeEffect v)
    let fadeInDuration v : obj = box (LoadingDecoratorProp.FadeInDuration v)
    let fadeOutDuration v : obj = box (LoadingDecoratorProp.FadeOutDuration v)
    let useSplashScreen v : obj = box (LoadingDecoratorProp.UseSplashScreen v)
    let splashScreenTemplate v : obj = box (LoadingDecoratorProp.SplashScreenTemplate v)
    let splashScreenDataContext v : obj = box (LoadingDecoratorProp.SplashScreenDataContext v)
    let isSplashScreenShown v : obj = box (LoadingDecoratorProp.IsSplashScreenShown v)
    let ownerLock v : obj = box (LoadingDecoratorProp.OwnerLock v)
    let splashScreenLocation v : obj = box (LoadingDecoratorProp.SplashScreenLocation v)
    let splashScreenWindowStyle v : obj = box (LoadingDecoratorProp.SplashScreenWindowStyle v)
    let loadingChildTemplate v : obj = box (LoadingDecoratorProp.LoadingChildTemplate v)
    let borderEffect v : obj = box (LoadingDecoratorProp.BorderEffect v)
    let borderEffectColor v : obj = box (LoadingDecoratorProp.BorderEffectColor v)

    let apply (el: DevExpress.Xpf.Core.LoadingDecorator) (prop: LoadingDecoratorProp) =
        match prop with
        | LoadingDecoratorProp.UseFadeEffect v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.UseFadeEffectProperty, box v)
        | LoadingDecoratorProp.FadeInDuration v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.FadeInDurationProperty, box v)
        | LoadingDecoratorProp.FadeOutDuration v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.FadeOutDurationProperty, box v)
        | LoadingDecoratorProp.UseSplashScreen v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.UseSplashScreenProperty, box v)
        | LoadingDecoratorProp.SplashScreenTemplate v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.SplashScreenTemplateProperty, box v)
        | LoadingDecoratorProp.SplashScreenDataContext v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.SplashScreenDataContextProperty, box v)
        | LoadingDecoratorProp.IsSplashScreenShown v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.IsSplashScreenShownProperty, box v)
        | LoadingDecoratorProp.OwnerLock v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.OwnerLockProperty, box v)
        | LoadingDecoratorProp.SplashScreenLocation v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.SplashScreenLocationProperty, box v)
        | LoadingDecoratorProp.SplashScreenWindowStyle v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.SplashScreenWindowStyleProperty, box v)
        | LoadingDecoratorProp.LoadingChildTemplate v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.LoadingChildTemplateProperty, box v)
        | LoadingDecoratorProp.BorderEffect v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.BorderEffectProperty, box v)
        | LoadingDecoratorProp.BorderEffectColor v -> el.SetValue(DevExpress.Xpf.Core.LoadingDecorator.BorderEffectColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.LoadingDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
