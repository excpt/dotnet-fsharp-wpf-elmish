...
type FullscreenControlProp =
    | Base of MediaToggleButtonProp

module FullscreenControl =

    let apply (el: DevExpress.Xpf.Controls.FullscreenControl) (prop: FullscreenControlProp) =
        match prop with
        | FullscreenControlProp.Base p -> MediaToggleButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.FullscreenControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
