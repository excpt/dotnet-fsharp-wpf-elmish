...
type CircularCleanWhiteQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCleanWhiteQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCleanWhiteQuarterTopLeftModel) (prop: CircularCleanWhiteQuarterTopLeftModelProp) =
        match prop with
        | CircularCleanWhiteQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCleanWhiteQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
