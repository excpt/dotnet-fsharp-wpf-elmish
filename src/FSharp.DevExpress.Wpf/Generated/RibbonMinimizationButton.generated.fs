...
type RibbonMinimizationButtonProp =
    | Base of RibbonCheckedBorderControlProp
    | IsInSimplifiedRibbon of bool

module RibbonMinimizationButton =
    let isInSimplifiedRibbon v : obj = box (RibbonMinimizationButtonProp.IsInSimplifiedRibbon v)

    let apply (el: DevExpress.Xpf.Ribbon.Internal.RibbonMinimizationButton) (prop: RibbonMinimizationButtonProp) =
        match prop with
        | RibbonMinimizationButtonProp.Base p -> RibbonCheckedBorderControl.apply el p
        | RibbonMinimizationButtonProp.IsInSimplifiedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonMinimizationButton.IsInSimplifiedRibbonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.RibbonMinimizationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
