...
type ImageEditProp =
    ...
    | ShowMenu of bool
    | ShowMenuMode of DevExpress.Xpf.Editors.ShowMenuMode
    ...
    | ShowLoadDialogOnClickMode of DevExpress.Xpf.Editors.ShowLoadDialogOnClickMode
    | MenuTemplate of System.Windows.Controls.ControlTemplate
    | MenuContainerTemplate of System.Windows.Controls.ControlTemplate
    | ImageEffect of System.Windows.Media.Effects.Effect
    | OnConvertEditValue of DevExpress.Xpf.Editors.ConvertEditValueEventHandler

module ImageEdit =
    let showMenu v : obj = box (ImageEditProp.ShowMenu v)
    let showMenuMode v : obj = box (ImageEditProp.ShowMenuMode v)
    let source v : obj = box (ImageEditProp.Source v)
    let stretch v : obj = box (ImageEditProp.Stretch v)
    let emptyContentTemplate v : obj = box (ImageEditProp.EmptyContentTemplate v)
    let showLoadDialogOnClickMode v : obj = box (ImageEditProp.ShowLoadDialogOnClickMode v)
    let menuTemplate v : obj = box (ImageEditProp.MenuTemplate v)
    let menuContainerTemplate v : obj = box (ImageEditProp.MenuContainerTemplate v)
    let imageEffect v : obj = box (ImageEditProp.ImageEffect v)
    let onConvertEditValue v : obj = box (EventProp(box (ImageEditProp.OnConvertEditValue v)))

    let apply (el: DevExpress.Xpf.Editors.ImageEdit) (prop: ImageEditProp) =
        match prop with
        | ImageEditProp.Base p -> BaseEdit.apply el p
        | ImageEditProp.ShowMenu v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.ShowMenuProperty, box v)
        | ImageEditProp.ShowMenuMode v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.ShowMenuModeProperty, box v)
        | ImageEditProp.Source v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.SourceProperty, box v)
        | ImageEditProp.Stretch v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.StretchProperty, box v)
        | ImageEditProp.EmptyContentTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.EmptyContentTemplateProperty, box v)
        | ImageEditProp.ShowLoadDialogOnClickMode v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.ShowLoadDialogOnClickModeProperty, box v)
        | ImageEditProp.MenuTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.MenuTemplateProperty, box v)
        | ImageEditProp.MenuContainerTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.MenuContainerTemplateProperty, box v)
        | ImageEditProp.ImageEffect v -> el.SetValue(DevExpress.Xpf.Editors.ImageEdit.ImageEffectProperty, box v)
        | ImageEditProp.OnConvertEditValue h -> el.ConvertEditValue.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
