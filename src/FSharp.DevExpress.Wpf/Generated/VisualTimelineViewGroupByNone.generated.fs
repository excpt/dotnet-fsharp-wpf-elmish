...
type VisualTimelineViewGroupByNoneProp =
    | Base of VisualTimelineViewGroupBaseProp

module VisualTimelineViewGroupByNone =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupByNone) (prop: VisualTimelineViewGroupByNoneProp) =
        match prop with
        | VisualTimelineViewGroupByNoneProp.Base p -> VisualTimelineViewGroupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupByNone>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
