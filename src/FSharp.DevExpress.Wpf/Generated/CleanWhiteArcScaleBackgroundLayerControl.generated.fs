...
type CleanWhiteArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteArcScaleBackgroundLayerControl) (prop: CleanWhiteArcScaleBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
