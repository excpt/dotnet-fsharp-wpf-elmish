...
type ThemedSplashScreenProp =
    | Base of SplashScreenWindowProp

module ThemedSplashScreen =

    let apply (el: DevExpress.Xpf.Core.Native.ThemedSplashScreen) (prop: ThemedSplashScreenProp) =
        match prop with
        | ThemedSplashScreenProp.Base p -> SplashScreenWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ThemedSplashScreen>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
