...
type VisualWorkTimeCellBaseProp =
    | Base of VisualTimeCellBaseProp

module VisualWorkTimeCellBase =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualWorkTimeCellBase) (prop: VisualWorkTimeCellBaseProp) =
        match prop with
        | VisualWorkTimeCellBaseProp.Base p -> VisualTimeCellBase.apply el p
