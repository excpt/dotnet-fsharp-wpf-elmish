...
type CleanWhiteDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteDigitalGaugeBackgroundLayerControl) (prop: CleanWhiteDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
