...
type TrackBarZoomStyleSettingsProp =
...
module TrackBarZoomStyleSettings =
    let decrementButtonStyle v : obj = box (TrackBarZoomStyleSettingsProp.DecrementButtonStyle v)
    let incrementButtonStyle v : obj = box (TrackBarZoomStyleSettingsProp.IncrementButtonStyle v)

    let apply (el: DevExpress.Xpf.Editors.TrackBarZoomStyleSettings) (prop: TrackBarZoomStyleSettingsProp) =
        match prop with
        | TrackBarZoomStyleSettingsProp.Base p -> TrackBarStyleSettings.apply el p
        | TrackBarZoomStyleSettingsProp.DecrementButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarZoomStyleSettings.DecrementButtonStyleProperty, box v)
        | TrackBarZoomStyleSettingsProp.IncrementButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarZoomStyleSettings.IncrementButtonStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarZoomStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
