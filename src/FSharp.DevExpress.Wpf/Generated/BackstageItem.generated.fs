...
type BackstageItemProp =
    | Base of BackstageItemBaseProp
    | Content of obj
...
module BackstageItem =
    ...
    let apply (el: DevExpress.Xpf.Ribbon.BackstageItem) (prop: BackstageItemProp) =
        match prop with
        | BackstageItemProp.Base p -> BackstageItemBase.apply el p
        | BackstageItemProp.Content v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItem.ContentProperty, box v)
        | BackstageItemProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItem.ContentTemplateProperty, box v)
        | BackstageItemProp.RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItem.RibbonStyleProperty, box v)
        | BackstageItemProp.KeyTip v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItem.KeyTipProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
