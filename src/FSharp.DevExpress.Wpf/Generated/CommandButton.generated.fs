...
type CommandButtonProp =
    | Glyph of System.Windows.Media.ImageSource
    | AllowGlyphTheming of bool
    | IsEllipseEnabled of bool
    | EllipseDiameter of float
    | GlyphWidth of float
...
module CommandButton =
    ...
    let apply (el: DevExpress.Xpf.WindowsUI.CommandButton) (prop: CommandButtonProp) =
        match prop with
        | CommandButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.GlyphProperty, box v)
        | CommandButtonProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.AllowGlyphThemingProperty, box v)
        | CommandButtonProp.IsEllipseEnabled v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.IsEllipseEnabledProperty, box v)
        | CommandButtonProp.EllipseDiameter v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.EllipseDiameterProperty, box v)
        | CommandButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.GlyphWidthProperty, box v)
        | CommandButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.GlyphHeightProperty, box v)
        | CommandButtonProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.GlyphStretchProperty, box v)
        | CommandButtonProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.WindowsUI.CommandButton.StrokeThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.CommandButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
