...
type CustomDXDialogProp =
    | Base of DXDialogProp

module CustomDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.CustomDXDialog) (prop: CustomDXDialogProp) =
        match prop with
        | CustomDXDialogProp.Base p -> DXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.CustomDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
