...
type FormulaRangesControlProp =
    | Base of WorksheetPaintControlProp

module FormulaRangesControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.FormulaRangesControl) (prop: FormulaRangesControlProp) =
        match prop with
        | FormulaRangesControlProp.Base p -> WorksheetPaintControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.FormulaRangesControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
