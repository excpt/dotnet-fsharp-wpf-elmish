...
type RedClockArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedClockArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockArcScaleBackgroundLayerControl) (prop: RedClockArcScaleBackgroundLayerControlProp) =
        match prop with
        | RedClockArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
