...
type SizeLegendProp =
    | Base of ItemsLayerLegendProp
    | Type of DevExpress.Xpf.Map.SizeLegendType
    | ShowTickMarks of bool
    | ItemFill of System.Windows.Media.Brush
    | ItemStroke of System.Windows.Media.Brush
    | CustomItems of DevExpress.Xpf.Map.SizeLegendItemCollection

module SizeLegend =
    let type v : obj = box (SizeLegendProp.Type v)
    let showTickMarks v : obj = box (SizeLegendProp.ShowTickMarks v)
    let itemFill v : obj = box (SizeLegendProp.ItemFill v)
    let itemStroke v : obj = box (SizeLegendProp.ItemStroke v)
    let customItems v : obj = box (SizeLegendProp.CustomItems v)

    let apply (el: DevExpress.Xpf.Map.SizeLegend) (prop: SizeLegendProp) =
        match prop with
        | SizeLegendProp.Base p -> ItemsLayerLegend.apply el p
        | SizeLegendProp.Type v -> el.SetValue(DevExpress.Xpf.Map.SizeLegend.TypeProperty, box v)
        | SizeLegendProp.ShowTickMarks v -> el.SetValue(DevExpress.Xpf.Map.SizeLegend.ShowTickMarksProperty, box v)
        | SizeLegendProp.ItemFill v -> el.SetValue(DevExpress.Xpf.Map.SizeLegend.ItemFillProperty, box v)
        | SizeLegendProp.ItemStroke v -> el.SetValue(DevExpress.Xpf.Map.SizeLegend.ItemStrokeProperty, box v)
        | SizeLegendProp.CustomItems v -> el.SetValue(DevExpress.Xpf.Map.SizeLegend.CustomItemsProperty, box v)

    let layer v : obj = box (ItemsLayerLegendProp.Layer v)
    let header v : obj = box (MapLegendBaseProp.Header v)
    let description v : obj = box (MapLegendBaseProp.Description v)
    let rangeStopsFormat v : obj = box (MapLegendBaseProp.RangeStopsFormat v)
    let alignment v : obj = box (MapLegendBaseProp.Alignment v)
    let itemLabelTemplate v : obj = box (MapLegendBaseProp.ItemLabelTemplate v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.SizeLegend>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
