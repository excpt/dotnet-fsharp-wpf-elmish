...
type GanttSummaryTaskBracketBorderProp =
    | Base of DXBorderProp

module GanttSummaryTaskBracketBorder =

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttSummaryTaskBracketBorder) (prop: GanttSummaryTaskBracketBorderProp) =
        match prop with
        | GanttSummaryTaskBracketBorderProp.Base p -> DXBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttSummaryTaskBracketBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
