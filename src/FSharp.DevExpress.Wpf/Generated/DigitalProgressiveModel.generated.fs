...
type DigitalProgressiveModelProp =
    | Base of DigitalGaugeModelProp

module DigitalProgressiveModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalProgressiveModel) (prop: DigitalProgressiveModelProp) =
        match prop with
        | DigitalProgressiveModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalProgressiveModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
