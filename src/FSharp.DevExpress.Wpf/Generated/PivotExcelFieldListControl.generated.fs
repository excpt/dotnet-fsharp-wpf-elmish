...
type PivotExcelFieldListControlProp =
    | Base of FieldListControlBaseProp

module PivotExcelFieldListControl =

    let apply (el: DevExpress.Xpf.PivotGrid.PivotExcelFieldListControl) (prop: PivotExcelFieldListControlProp) =
        match prop with
        | PivotExcelFieldListControlProp.Base p -> FieldListControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.PivotExcelFieldListControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
