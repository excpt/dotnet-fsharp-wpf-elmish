...
type HamburgerMenuItemSeparatorProp =
...
module HamburgerMenuItemSeparator =
    let placement v : obj = box (HamburgerMenuItemSeparatorProp.Placement v)
    let compactModeVisibility v : obj = box (HamburgerMenuItemSeparatorProp.CompactModeVisibility v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuItemSeparator) (prop: HamburgerMenuItemSeparatorProp) =
        match prop with
        | HamburgerMenuItemSeparatorProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuItemSeparator.PlacementProperty, box v)
        | HamburgerMenuItemSeparatorProp.CompactModeVisibility v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuItemSeparator.CompactModeVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuItemSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
