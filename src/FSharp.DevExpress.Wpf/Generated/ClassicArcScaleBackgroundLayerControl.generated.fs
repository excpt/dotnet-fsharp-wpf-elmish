...
type ClassicArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicArcScaleBackgroundLayerControl) (prop: ClassicArcScaleBackgroundLayerControlProp) =
        match prop with
        | ClassicArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
