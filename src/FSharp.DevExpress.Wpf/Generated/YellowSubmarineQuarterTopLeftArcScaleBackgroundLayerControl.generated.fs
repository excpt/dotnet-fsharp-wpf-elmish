...
type YellowSubmarineQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineQuarterTopLeftArcScaleBackgroundLayerControl) (prop: YellowSubmarineQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
