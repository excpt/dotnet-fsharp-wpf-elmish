...
type ChartRangeControlClientBaseProp =
    | Base of ChartElementProp
    | ThumbLabelFormatString of string
    | ShowArgumentLabels of bool
    | ArgumentLabelTemplate of System.Windows.DataTemplate
    | ShowGridLines of bool
    | GridLinesBrush of System.Windows.Media.SolidColorBrush

module ChartRangeControlClientBase =
    ...
    let apply (el: DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClientBase) (prop: ChartRangeControlClientBaseProp) =
        match prop with
        | ChartRangeControlClientBaseProp.Base p -> ChartElement.apply el p
        | ChartRangeControlClientBaseProp.ThumbLabelFormatString v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClientBase.ThumbLabelFormatStringProperty, box v)
        | ChartRangeControlClientBaseProp.ShowArgumentLabels v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClientBase.ShowArgumentLabelsProperty, box v)
        | ChartRangeControlClientBaseProp.ArgumentLabelTemplate v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClientBase.ArgumentLabelTemplateProperty, box v)
        | ChartRangeControlClientBaseProp.ShowGridLines v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClientBase.ShowGridLinesProperty, box v)
        | ChartRangeControlClientBaseProp.GridLinesBrush v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartRangeControlClientBase.GridLinesBrushProperty, box v)
