...
type AdditionalStepAreaSeriesGeometryProp =
    | Base of AdditionalAreaSeriesGeometryProp

module AdditionalStepAreaSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStepAreaSeriesGeometry) (prop: AdditionalStepAreaSeriesGeometryProp) =
        match prop with
        | AdditionalStepAreaSeriesGeometryProp.Base p -> AdditionalAreaSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStepAreaSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
