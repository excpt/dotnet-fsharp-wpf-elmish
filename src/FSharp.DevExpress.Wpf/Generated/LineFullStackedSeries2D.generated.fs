...
type LineFullStackedSeries2DProp =
    | Base of LineStackedSeries2DProp

module LineFullStackedSeries2D =

    let apply (el: DevExpress.Xpf.Charts.LineFullStackedSeries2D) (prop: LineFullStackedSeries2DProp) =
        match prop with
        | LineFullStackedSeries2DProp.Base p -> LineStackedSeries2D.apply el p
    ...
    let percentOptions (v: DevExpress.Xpf.Charts.PercentOptions) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.LineFullStackedSeries2D.PercentOptionsProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.LineFullStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
