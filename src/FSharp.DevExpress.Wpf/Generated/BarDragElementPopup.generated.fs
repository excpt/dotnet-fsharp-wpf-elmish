...
open System
open System.Windows
open DevExpress.Xpf.Bars.Customization
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type BarDragElementPopupProp =
    | CursorOffset of System.Windows.Point

module BarDragElementPopup =
    let cursorOffset v : obj = box (BarDragElementPopupProp.CursorOffset v)

    let apply (el: DevExpress.Xpf.Bars.Customization.BarDragElementPopup) (prop: BarDragElementPopupProp) =
        match prop with
        | BarDragElementPopupProp.CursorOffset v -> el.SetValue(DevExpress.Xpf.Bars.Customization.BarDragElementPopup.CursorOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.Customization.BarDragElementPopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
