...
type DiagramImageProp =
    | Base of DiagramItemProp
    | FlipMode of DevExpress.Diagram.Core.ImageFlipMode
    | Image of obj
    | StretchMode of DevExpress.Diagram.Core.StretchMode
    | AllowPlaceholder of bool
    | AltText of string

module DiagramImage =
    let flipMode v : obj = box (DiagramImageProp.FlipMode v)
    let image v : obj = box (DiagramImageProp.Image v)
    let stretchMode v : obj = box (DiagramImageProp.StretchMode v)
    let allowPlaceholder v : obj = box (DiagramImageProp.AllowPlaceholder v)
    let altText v : obj = box (DiagramImageProp.AltText v)

    let apply (el: DevExpress.Xpf.Diagram.DiagramImage) (prop: DiagramImageProp) =
        match prop with
        | DiagramImageProp.Base p -> DiagramItem.apply el p
        | DiagramImageProp.FlipMode v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramImage.FlipModeProperty, box v)
        | DiagramImageProp.Image v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramImage.ImageProperty, box v)
        | DiagramImageProp.StretchMode v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramImage.StretchModeProperty, box v)
        | DiagramImageProp.AllowPlaceholder v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramImage.AllowPlaceholderProperty, box v)
        | DiagramImageProp.AltText v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramImage.AltTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
