...
type NavPaneOverflowPanelProp =
    | ShowBorder of bool

module NavPaneOverflowPanel =
    let showBorder v : obj = box (NavPaneOverflowPanelProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneOverflowPanel) (prop: NavPaneOverflowPanelProp) =
        match prop with
        | NavPaneOverflowPanelProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneOverflowPanel.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneOverflowPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
