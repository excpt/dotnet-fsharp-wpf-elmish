...
type BarManagerCustomizableMenuControllerProp =
    | Base of BarManagerMenuControllerProp

module BarManagerCustomizableMenuController =

    let apply (el: DevExpress.Xpf.Bars.BarManagerCustomizableMenuController) (prop: BarManagerCustomizableMenuControllerProp) =
        match prop with
        | BarManagerCustomizableMenuControllerProp.Base p -> BarManagerMenuController.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarManagerCustomizableMenuController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
