...
type NavigationButtonPairControlProp =
    | Base of SchedulerItemsControlProp
    | ShowBorder of bool
    | PairMargin of System.Windows.Thickness
    | VisibleBorderMargin of System.Windows.Thickness
    | InvisibleBorderMargin of System.Windows.Thickness

module NavigationButtonPairControl =
    let showBorder v : obj = box (NavigationButtonPairControlProp.ShowBorder v)
    let pairMargin v : obj = box (NavigationButtonPairControlProp.PairMargin v)
    let visibleBorderMargin v : obj = box (NavigationButtonPairControlProp.VisibleBorderMargin v)
    let invisibleBorderMargin v : obj = box (NavigationButtonPairControlProp.InvisibleBorderMargin v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.NavigationButtonPairControl) (prop: NavigationButtonPairControlProp) =
        match prop with
        | NavigationButtonPairControlProp.Base p -> SchedulerItemsControl.apply el p
        | NavigationButtonPairControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.NavigationButtonPairControl.ShowBorderProperty, box v)
        | NavigationButtonPairControlProp.PairMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.NavigationButtonPairControl.PairMarginProperty, box v)
        | NavigationButtonPairControlProp.VisibleBorderMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.NavigationButtonPairControl.VisibleBorderMarginProperty, box v)
        | NavigationButtonPairControlProp.InvisibleBorderMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.NavigationButtonPairControl.InvisibleBorderMarginProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.NavigationButtonPairControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
