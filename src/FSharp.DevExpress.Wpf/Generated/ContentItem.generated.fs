...
type ContentItemProp =
    | Base of BaseLayoutItemProp
    | Content of obj
    | ContentTemplate of System.Windows.DataTemplate
    | FocusContentOnActivating of bool
    | ContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | ActivateOnFocusing of DevExpress.Xpf.Docking.ActivateOnFocusing
...
module ContentItem =
    ...
    let apply (el: DevExpress.Xpf.Docking.ContentItem) (prop: ContentItemProp) =
        match prop with
        | ContentItemProp.Base p -> BaseLayoutItem.apply el p
        | ContentItemProp.Content v -> el.SetValue(DevExpress.Xpf.Docking.ContentItem.ContentProperty, box v)
        | ContentItemProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Docking.ContentItem.ContentTemplateProperty, box v)
        | ContentItemProp.FocusContentOnActivating v -> el.SetValue(DevExpress.Xpf.Docking.ContentItem.FocusContentOnActivatingProperty, box v)
        | ContentItemProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Docking.ContentItem.ContentTemplateSelectorProperty, box v)
        | ContentItemProp.ActivateOnFocusing v -> el.SetValue(DevExpress.Xpf.Docking.ContentItem.ActivateOnFocusingProperty, box v)
