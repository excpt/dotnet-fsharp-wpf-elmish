...
type Chart3DContainerProp =
    | Base of ChartElementBaseProp

module Chart3DContainer =

    let apply (el: DevExpress.Xpf.Charts.Chart3DContainer) (prop: Chart3DContainerProp) =
        match prop with
        | Chart3DContainerProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Chart3DContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
