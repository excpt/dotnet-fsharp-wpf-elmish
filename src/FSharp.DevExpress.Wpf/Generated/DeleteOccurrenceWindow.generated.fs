...
type DeleteOccurrenceWindowProp =
    | Base of ThemedWindowProp

module DeleteOccurrenceWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DeleteOccurrenceWindow) (prop: DeleteOccurrenceWindowProp) =
        match prop with
        | DeleteOccurrenceWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DeleteOccurrenceWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
