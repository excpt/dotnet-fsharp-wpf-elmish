...
module ReferenceEdit =
    let collapseButtonTemplate v : obj = box (ReferenceEditProp.CollapseButtonTemplate v)
    let expandButtonTemplate v : obj = box (ReferenceEditProp.ExpandButtonTemplate v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.ReferenceEdit) (prop: ReferenceEditProp) =
        match prop with
        | ReferenceEditProp.Base p -> ButtonEdit.apply el p
        | ReferenceEditProp.CollapseButtonTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.ReferenceEdit.CollapseButtonTemplateProperty, box v)
        | ReferenceEditProp.ExpandButtonTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.ReferenceEdit.ExpandButtonTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.ReferenceEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
