...
type DateNavigatorCalendarCellButtonContentProp =
    | DefaultForegroundSolidColor of System.Windows.Media.Color
    | FocusedForegroundSolidColor of System.Windows.Media.Color
    | HolidayForegroundSolidColor of System.Windows.Media.Color
    | InactiveForegroundSolidColor of System.Windows.Media.Color
    | MouseOverForegroundSolidColor of System.Windows.Media.Color
    | SelectedForegroundSolidColor of System.Windows.Media.Color
    | DisabledForegroundSolidColor of System.Windows.Media.Color
    | Text of string
    | TodayForegroundSolidColor of System.Windows.Media.Color

module DateNavigatorCalendarCellButtonContent =
    let defaultForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.DefaultForegroundSolidColor v)
    let focusedForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.FocusedForegroundSolidColor v)
    let holidayForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.HolidayForegroundSolidColor v)
    let inactiveForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.InactiveForegroundSolidColor v)
    let mouseOverForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.MouseOverForegroundSolidColor v)
    let selectedForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.SelectedForegroundSolidColor v)
    let disabledForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.DisabledForegroundSolidColor v)
    let text v : obj = box (DateNavigatorCalendarCellButtonContentProp.Text v)
    let todayForegroundSolidColor v : obj = box (DateNavigatorCalendarCellButtonContentProp.TodayForegroundSolidColor v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent) (prop: DateNavigatorCalendarCellButtonContentProp) =
        match prop with
        | DateNavigatorCalendarCellButtonContentProp.DefaultForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.DefaultForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.FocusedForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.FocusedForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.HolidayForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.HolidayForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.InactiveForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.InactiveForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.MouseOverForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.MouseOverForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.SelectedForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.SelectedForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.DisabledForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.DisabledForegroundSolidColorProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.Text v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.TextProperty, box v)
        | DateNavigatorCalendarCellButtonContentProp.TodayForegroundSolidColor v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent.TodayForegroundSolidColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButtonContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
