...
type BaseListBoxEditStyleSettingsProp =
    | SelectionEventMode of DevExpress.Xpf.Editors.Popups.SelectionEventMode
    | ItemContainerStyle of System.Windows.Style

module BaseListBoxEditStyleSettings =
    ...
    let apply (el: DevExpress.Xpf.Editors.BaseListBoxEditStyleSettings) (prop: BaseListBoxEditStyleSettingsProp) =
        match prop with
        | BaseListBoxEditStyleSettingsProp.SelectionEventMode v -> el.SetValue(DevExpress.Xpf.Editors.BaseListBoxEditStyleSettings.SelectionEventModeProperty, box v)
        | BaseListBoxEditStyleSettingsProp.ItemContainerStyle v -> el.SetValue(DevExpress.Xpf.Editors.BaseListBoxEditStyleSettings.ItemContainerStyleProperty, box v)
