...
type StateIndicatorControlProp =
    | Model of DevExpress.Xpf.Gauges.StateIndicatorModel
    | StateIndex of int
    | DefaultState of DevExpress.Xpf.Gauges.State

module StateIndicatorControl =
    let model v : obj = box (StateIndicatorControlProp.Model v)
    let stateIndex v : obj = box (StateIndicatorControlProp.StateIndex v)
    let defaultState v : obj = box (StateIndicatorControlProp.DefaultState v)

    let apply (el: DevExpress.Xpf.Gauges.StateIndicatorControl) (prop: StateIndicatorControlProp) =
        match prop with
        | StateIndicatorControlProp.Model v -> el.SetValue(DevExpress.Xpf.Gauges.StateIndicatorControl.ModelProperty, box v)
        | StateIndicatorControlProp.StateIndex v -> el.SetValue(DevExpress.Xpf.Gauges.StateIndicatorControl.StateIndexProperty, box v)
        | StateIndicatorControlProp.DefaultState v -> el.SetValue(DevExpress.Xpf.Gauges.StateIndicatorControl.DefaultStateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.StateIndicatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
