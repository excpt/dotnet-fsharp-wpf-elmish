...
type AdditionalBoxPlotSeriesGeometryContainerProp =
    | Base of AdditionalSeriesGeometryContainerProp

module AdditionalBoxPlotSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalBoxPlotSeriesGeometryContainer) (prop: AdditionalBoxPlotSeriesGeometryContainerProp) =
        match prop with
        | AdditionalBoxPlotSeriesGeometryContainerProp.Base p -> AdditionalSeriesGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalBoxPlotSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
