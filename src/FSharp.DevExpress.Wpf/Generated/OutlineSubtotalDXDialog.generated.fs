...
type OutlineSubtotalDXDialogProp =
    | Base of CustomDXDialogProp

module OutlineSubtotalDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.OutlineSubtotalDXDialog) (prop: OutlineSubtotalDXDialogProp) =
        match prop with
        | OutlineSubtotalDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.OutlineSubtotalDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
