...
type LayoutItemProp =
    ...
    | AddColonToLabel of bool
    | Content of System.Windows.UIElement
    | ElementSpace of float
    | IsRequired of bool
    | Label of obj
    | LabelHorizontalAlignment of System.Windows.HorizontalAlignment
    | LabelVerticalAlignment of System.Windows.VerticalAlignment
    | LabelPosition of DevExpress.Xpf.LayoutControl.LayoutItemLabelPosition
    | LabelStyle of System.Windows.Style
    | LabelTemplate of System.Windows.DataTemplate
    | ActualLabel of obj
    | CalculatedLabelVisibility of obj
    | IsActuallyRequired of bool

module LayoutItem =
    let addColonToLabel v : obj = box (LayoutItemProp.AddColonToLabel v)
    let content v : obj = box (LayoutItemProp.Content v)
    let elementSpace v : obj = box (LayoutItemProp.ElementSpace v)
    let isRequired v : obj = box (LayoutItemProp.IsRequired v)
    let label v : obj = box (LayoutItemProp.Label v)
    let labelHorizontalAlignment v : obj = box (LayoutItemProp.LabelHorizontalAlignment v)
    let labelVerticalAlignment v : obj = box (LayoutItemProp.LabelVerticalAlignment v)
    let labelPosition v : obj = box (LayoutItemProp.LabelPosition v)
    let labelStyle v : obj = box (LayoutItemProp.LabelStyle v)
    let labelTemplate v : obj = box (LayoutItemProp.LabelTemplate v)
    let actualLabel v : obj = box (LayoutItemProp.ActualLabel v)
    let calculatedLabelVisibility v : obj = box (LayoutItemProp.CalculatedLabelVisibility v)
    let isActuallyRequired v : obj = box (LayoutItemProp.IsActuallyRequired v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItem) (prop: LayoutItemProp) =
        match prop with
        | LayoutItemProp.Base p -> ControlBase.apply el p
        | LayoutItemProp.AddColonToLabel v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.AddColonToLabelProperty, box v)
        | LayoutItemProp.Content v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.ContentProperty, box v)
        | LayoutItemProp.ElementSpace v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.ElementSpaceProperty, box v)
        | LayoutItemProp.IsRequired v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.IsRequiredProperty, box v)
        | LayoutItemProp.Label v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.LabelProperty, box v)
        | LayoutItemProp.LabelHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.LabelHorizontalAlignmentProperty, box v)
        | LayoutItemProp.LabelVerticalAlignment v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.LabelVerticalAlignmentProperty, box v)
        | LayoutItemProp.LabelPosition v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.LabelPositionProperty, box v)
        | LayoutItemProp.LabelStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.LabelStyleProperty, box v)
        | LayoutItemProp.LabelTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.LabelTemplateProperty, box v)
        | LayoutItemProp.ActualLabel v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.ActualLabelProperty, box v)
        | LayoutItemProp.CalculatedLabelVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.CalculatedLabelVisibilityProperty, box v)
        | LayoutItemProp.IsActuallyRequired v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItem.IsActuallyRequiredProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
