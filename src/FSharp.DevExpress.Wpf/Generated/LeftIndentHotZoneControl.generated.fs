...
type LeftIndentHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module LeftIndentHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.LeftIndentHotZoneControl) (prop: LeftIndentHotZoneControlProp) =
        match prop with
        | LeftIndentHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.LeftIndentHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
