...
type GanttItemControlBaseProp =
    | UserStyle of System.Windows.Style

module GanttItemControlBase =
    let userStyle v : obj = box (GanttItemControlBaseProp.UserStyle v)

    let apply (el: DevExpress.Xpf.Gantt.GanttItemControlBase) (prop: GanttItemControlBaseProp) =
        match prop with
        | GanttItemControlBaseProp.UserStyle v -> el.SetValue(DevExpress.Xpf.Gantt.GanttItemControlBase.UserStyleProperty, box v)
