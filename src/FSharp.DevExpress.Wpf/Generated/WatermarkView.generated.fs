...
type WatermarkViewProp =
    | Base of ThemedWindowProp

module WatermarkView =

    let apply (el: DevExpress.Xpf.RichEdit.View.WatermarkView) (prop: WatermarkViewProp) =
        match prop with
        | WatermarkViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.WatermarkView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
