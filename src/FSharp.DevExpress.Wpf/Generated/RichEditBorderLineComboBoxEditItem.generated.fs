...
type RichEditBorderLineComboBoxEditItemProp =
    | Control of DevExpress.XtraRichEdit.IRichEditControl

module RichEditBorderLineComboBoxEditItem =
    let control v : obj = box (RichEditBorderLineComboBoxEditItemProp.Control v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.RichEditBorderLineComboBoxEditItem) (prop: RichEditBorderLineComboBoxEditItemProp) =
        match prop with
        | RichEditBorderLineComboBoxEditItemProp.Control v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichEditBorderLineComboBoxEditItem.ControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.RichEditBorderLineComboBoxEditItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
