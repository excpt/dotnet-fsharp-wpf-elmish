...
type GanttResourceControlProp =
    | Base of GanttItemControlBaseProp
    | CornerRadius of System.Windows.CornerRadius
    | ResourceColor of obj
    | RowBackground of System.Windows.Media.Brush

module GanttResourceControl =
    let cornerRadius v : obj = box (GanttResourceControlProp.CornerRadius v)
    let resourceColor v : obj = box (GanttResourceControlProp.ResourceColor v)
    let rowBackground v : obj = box (GanttResourceControlProp.RowBackground v)

    let apply (el: DevExpress.Xpf.Gantt.GanttResourceControl) (prop: GanttResourceControlProp) =
        match prop with
        | GanttResourceControlProp.Base p -> GanttItemControlBase.apply el p
        | GanttResourceControlProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Gantt.GanttResourceControl.CornerRadiusProperty, box v)
        | GanttResourceControlProp.ResourceColor v -> el.SetValue(DevExpress.Xpf.Gantt.GanttResourceControl.ResourceColorProperty, box v)
        | GanttResourceControlProp.RowBackground v -> el.SetValue(DevExpress.Xpf.Gantt.GanttResourceControl.RowBackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttResourceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
