...
type TreeMapPanelProp =
    | GroupLevel of int

module TreeMapPanel =
    let groupLevel v : obj = box (TreeMapPanelProp.GroupLevel v)

    let apply (el: DevExpress.Xpf.TreeMap.TreeMapPanel) (prop: TreeMapPanelProp) =
        match prop with
        | TreeMapPanelProp.GroupLevel v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapPanel.GroupLevelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.TreeMapPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
