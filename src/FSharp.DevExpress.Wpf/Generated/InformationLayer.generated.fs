...
type InformationLayerProp =
    | Base of VectorLayerBaseProp
    | DataProvider of DevExpress.Xpf.Map.InformationDataProviderBase

module InformationLayer =
    let dataProvider v : obj = box (InformationLayerProp.DataProvider v)

    let apply (el: DevExpress.Xpf.Map.InformationLayer) (prop: InformationLayerProp) =
        match prop with
        | InformationLayerProp.Base p -> VectorLayerBase.apply el p
        | InformationLayerProp.DataProvider v -> el.SetValue(DevExpress.Xpf.Map.InformationLayer.DataProviderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.InformationLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
