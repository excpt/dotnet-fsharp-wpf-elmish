...
type AdditionalSeriesPointGeometryProp =
    | Base of AdditionalSeriesGeometryBaseProp

module AdditionalSeriesPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSeriesPointGeometry) (prop: AdditionalSeriesPointGeometryProp) =
        match prop with
        | AdditionalSeriesPointGeometryProp.Base p -> AdditionalSeriesGeometryBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSeriesPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
