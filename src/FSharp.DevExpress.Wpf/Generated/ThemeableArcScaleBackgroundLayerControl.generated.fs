...
type ThemeableArcScaleBackgroundLayerControlProp =
    | Base of ThemeableArcScaleBackgroundLayerControlBaseProp

module ThemeableArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableArcScaleBackgroundLayerControl) (prop: ThemeableArcScaleBackgroundLayerControlProp) =
        match prop with
        | ThemeableArcScaleBackgroundLayerControlProp.Base p -> ThemeableArcScaleBackgroundLayerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
