...
type ComboBoxEditItemProp =
    | Base of ListBoxEditItemProp

module ComboBoxEditItem =

    let apply (el: DevExpress.Xpf.Editors.ComboBoxEditItem) (prop: ComboBoxEditItemProp) =
        match prop with
        | ComboBoxEditItemProp.Base p -> ListBoxEditItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ComboBoxEditItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
