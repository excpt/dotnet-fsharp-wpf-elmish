...
type LayoutItemAlignmentControlProp =
    | Base of ControlBaseProp
    | Alignment of obj

module LayoutItemAlignmentControl =
    let alignment v : obj = box (LayoutItemAlignmentControlProp.Alignment v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemAlignmentControl) (prop: LayoutItemAlignmentControlProp) =
        match prop with
        | LayoutItemAlignmentControlProp.Base p -> ControlBase.apply el p
        | LayoutItemAlignmentControlProp.Alignment v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemAlignmentControl.AlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemAlignmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
