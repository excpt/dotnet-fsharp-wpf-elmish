...
type ThemedWindowDialogButtonProp =
    | Base of SimpleButtonProp
    | Placement of System.Windows.Controls.Dock
    | DialogResult of System.Windows.MessageBoxResult
    | UICommand of DevExpress.Mvvm.UICommand
    | AllowCloseWindow of bool
    | Alignment of DevExpress.Mvvm.DialogButtonAlignment

module ThemedWindowDialogButton =
    let placement v : obj = box (ThemedWindowDialogButtonProp.Placement v)
    let dialogResult v : obj = box (ThemedWindowDialogButtonProp.DialogResult v)
    let uICommand v : obj = box (ThemedWindowDialogButtonProp.UICommand v)
    let allowCloseWindow v : obj = box (ThemedWindowDialogButtonProp.AllowCloseWindow v)
    let alignment v : obj = box (ThemedWindowDialogButtonProp.Alignment v)

    let apply (el: DevExpress.Xpf.Core.ThemedWindowDialogButton) (prop: ThemedWindowDialogButtonProp) =
        match prop with
        | ThemedWindowDialogButtonProp.Base p -> SimpleButton.apply el p
        | ThemedWindowDialogButtonProp.Placement v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowDialogButton.PlacementProperty, box v)
        | ThemedWindowDialogButtonProp.DialogResult v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowDialogButton.DialogResultProperty, box v)
        | ThemedWindowDialogButtonProp.UICommand v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowDialogButton.UICommandProperty, box v)
        | ThemedWindowDialogButtonProp.AllowCloseWindow v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowDialogButton.AllowCloseWindowProperty, box v)
        | ThemedWindowDialogButtonProp.Alignment v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowDialogButton.AlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowDialogButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
