...
type ProgressiveDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveDigitalGaugeBackgroundLayerControl) (prop: ProgressiveDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | ProgressiveDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
