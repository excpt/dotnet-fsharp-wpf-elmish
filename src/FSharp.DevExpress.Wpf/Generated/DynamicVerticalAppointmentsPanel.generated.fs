...
type DynamicVerticalAppointmentsPanelProp =
    | Base of DynamicAppointmentsPanelBaseProp

module DynamicVerticalAppointmentsPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DynamicVerticalAppointmentsPanel) (prop: DynamicVerticalAppointmentsPanelProp) =
        match prop with
        | DynamicVerticalAppointmentsPanelProp.Base p -> DynamicAppointmentsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DynamicVerticalAppointmentsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
