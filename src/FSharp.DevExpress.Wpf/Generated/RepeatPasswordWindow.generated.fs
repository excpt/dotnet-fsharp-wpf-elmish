...
type RepeatPasswordWindowProp =
    | Base of ThemedWindowProp

module RepeatPasswordWindow =

    let apply (el: DevExpress.Xpf.Printing.Native.RepeatPasswordWindow) (prop: RepeatPasswordWindowProp) =
        match prop with
        | RepeatPasswordWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.RepeatPasswordWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
