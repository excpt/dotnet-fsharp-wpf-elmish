...
type TileNavCategoryProp =
    | Base of NavElementBaseProp
    | ItemsSource of obj
...
module TileNavCategory =
    let itemsSource v : obj = box (TileNavCategoryProp.ItemsSource v)
    let itemTemplate v : obj = box (TileNavCategoryProp.ItemTemplate v)
    let itemTemplateSelector v : obj = box (TileNavCategoryProp.ItemTemplateSelector v)
    let itemStyle v : obj = box (TileNavCategoryProp.ItemStyle v)

    let apply (el: DevExpress.Xpf.Navigation.TileNavCategory) (prop: TileNavCategoryProp) =
        match prop with
        | TileNavCategoryProp.Base p -> NavElementBase.apply el p
        | TileNavCategoryProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavCategory.ItemsSourceProperty, box v)
        | TileNavCategoryProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavCategory.ItemTemplateProperty, box v)
        | TileNavCategoryProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavCategory.ItemTemplateSelectorProperty, box v)
        | TileNavCategoryProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Navigation.TileNavCategory.ItemStyleProperty, box v)

    let navButtonStyle v : obj = box (NavElementBaseProp.NavButtonStyle v)
    let tileContent v : obj = box (NavElementBaseProp.TileContent v)
    let tileContentTemplate v : obj = box (NavElementBaseProp.TileContentTemplate v)
    let tileContentTemplateSelector v : obj = box (NavElementBaseProp.TileContentTemplateSelector v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.TileNavCategory>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
