...
type SlideViewProp =
    ...
    | ItemHeaderTemplate of System.Windows.DataTemplate
    | ItemHeaderTemplateSelector of System.Windows.Controls.DataTemplateSelector
    ...
    | StickyHeaders of bool

module SlideView =
    let header v : obj = box (SlideViewProp.Header v)
    let headerTemplate v : obj = box (SlideViewProp.HeaderTemplate v)
    let itemHeaderTemplate v : obj = box (SlideViewProp.ItemHeaderTemplate v)
    let itemHeaderTemplateSelector v : obj = box (SlideViewProp.ItemHeaderTemplateSelector v)
    let backCommand v : obj = box (SlideViewProp.BackCommand v)
    let backCommandParameter v : obj = box (SlideViewProp.BackCommandParameter v)
    let showBackButton v : obj = box (SlideViewProp.ShowBackButton v)
    let itemSpacing v : obj = box (SlideViewProp.ItemSpacing v)
    let orientation v : obj = box (SlideViewProp.Orientation v)
    let stickyHeaders v : obj = box (SlideViewProp.StickyHeaders v)

    let apply (el: DevExpress.Xpf.WindowsUI.SlideView) (prop: SlideViewProp) =
        match prop with
        | SlideViewProp.Base p -> veItemsControl.apply el p
        | SlideViewProp.Header v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.HeaderProperty, box v)
        | SlideViewProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.HeaderTemplateProperty, box v)
        | SlideViewProp.ItemHeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.ItemHeaderTemplateProperty, box v)
        | SlideViewProp.ItemHeaderTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.ItemHeaderTemplateSelectorProperty, box v)
        | SlideViewProp.BackCommand v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.BackCommandProperty, box v)
        | SlideViewProp.BackCommandParameter v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.BackCommandParameterProperty, box v)
        | SlideViewProp.ShowBackButton v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.ShowBackButtonProperty, box v)
        | SlideViewProp.ItemSpacing v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.ItemSpacingProperty, box v)
        | SlideViewProp.Orientation v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.OrientationProperty, box v)
        | SlideViewProp.StickyHeaders v -> el.SetValue(DevExpress.Xpf.WindowsUI.SlideView.StickyHeadersProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.SlideView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
