...
type StackedBarTotalLabelProp =
    ...
    | OnCustomize of DevExpress.Xpf.Charts.CustomizeTotalLabelEventHandler

module StackedBarTotalLabel =
    let indent v : obj = box (StackedBarTotalLabelProp.Indent v)
    let connectorVisible v : obj = box (StackedBarTotalLabelProp.ConnectorVisible v)
    let connectorThickness v : obj = box (StackedBarTotalLabelProp.ConnectorThickness v)
    let resolveOverlappingMode v : obj = box (StackedBarTotalLabelProp.ResolveOverlappingMode v)
    let textPattern v : obj = box (StackedBarTotalLabelProp.TextPattern v)
    let onCustomize v : obj = box (EventProp(box (StackedBarTotalLabelProp.OnCustomize v)))

    let apply (el: DevExpress.Xpf.Charts.StackedBarTotalLabel) (prop: StackedBarTotalLabelProp) =
        match prop with
        | StackedBarTotalLabelProp.Base p -> ChartTextElement.apply el p
        | StackedBarTotalLabelProp.Indent v -> el.SetValue(DevExpress.Xpf.Charts.StackedBarTotalLabel.IndentProperty, box v)
        | StackedBarTotalLabelProp.ConnectorVisible v -> el.SetValue(DevExpress.Xpf.Charts.StackedBarTotalLabel.ConnectorVisibleProperty, box v)
        | StackedBarTotalLabelProp.ConnectorThickness v -> el.SetValue(DevExpress.Xpf.Charts.StackedBarTotalLabel.ConnectorThicknessProperty, box v)
        | StackedBarTotalLabelProp.ResolveOverlappingMode v -> el.SetValue(DevExpress.Xpf.Charts.StackedBarTotalLabel.ResolveOverlappingModeProperty, box v)
        | StackedBarTotalLabelProp.TextPattern v -> el.SetValue(DevExpress.Xpf.Charts.StackedBarTotalLabel.TextPatternProperty, box v)
        | StackedBarTotalLabelProp.OnCustomize h -> el.Customize.AddHandler(h)

    let visible v : obj = box (ChartTextElementProp.Visible v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StackedBarTotalLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
