...
type LegendsPanelProp =
    | Base of SimplePanelProp

module LegendsPanel =

    let apply (el: DevExpress.Xpf.Charts.LegendsPanel) (prop: LegendsPanelProp) =
        match prop with
        | LegendsPanelProp.Base p -> SimplePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LegendsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
