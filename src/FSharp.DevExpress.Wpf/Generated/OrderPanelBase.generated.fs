...
type OrderPanelBaseProp =
    | Orientation of System.Windows.Controls.Orientation
    | ArrangeAccordingToVisibleIndex of bool

module OrderPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Core.OrderPanelBase) (prop: OrderPanelBaseProp) =
        match prop with
        | OrderPanelBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.Core.OrderPanelBase.OrientationProperty, box v)
        | OrderPanelBaseProp.ArrangeAccordingToVisibleIndex v -> el.SetValue(DevExpress.Xpf.Core.OrderPanelBase.ArrangeAccordingToVisibleIndexProperty, box v)
    ...
    let visibleIndex (v: int) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.OrderPanelBase.VisibleIndexProperty, box v)) :: node.Props }
    let panel (v: System.Windows.Controls.Panel) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.OrderPanelBase.PanelProperty, box v)) :: node.Props }
