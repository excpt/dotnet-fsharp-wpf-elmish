...
type GlueToItemAdornerProp =
    | Base of GlueToPointAdornerBaseProp

module GlueToItemAdorner =

    let apply (el: DevExpress.Xpf.Diagram.GlueToItemAdorner) (prop: GlueToItemAdornerProp) =
        match prop with
        | GlueToItemAdornerProp.Base p -> GlueToPointAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.GlueToItemAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
