...
type YearlyRecurrenceControlProp =
    | Base of RecurrenceControlBaseProp
    | RecurrenceInfo of DevExpress.XtraScheduler.RecurrenceInfo

module YearlyRecurrenceControl =
    let recurrenceInfo v : obj = box (YearlyRecurrenceControlProp.RecurrenceInfo v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.YearlyRecurrenceControl) (prop: YearlyRecurrenceControlProp) =
        match prop with
        | YearlyRecurrenceControlProp.Base p -> RecurrenceControlBase.apply el p
        | YearlyRecurrenceControlProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.YearlyRecurrenceControl.RecurrenceInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.YearlyRecurrenceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
