...
type StandAloneEditorPopupBaseProp =
    | Base of EditorPopupBaseProp

module StandAloneEditorPopupBase =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.StandAloneEditorPopupBase) (prop: StandAloneEditorPopupBaseProp) =
        match prop with
        | StandAloneEditorPopupBaseProp.Base p -> EditorPopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.StandAloneEditorPopupBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
