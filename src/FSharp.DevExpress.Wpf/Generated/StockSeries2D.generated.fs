...
type StockSeries2DProp =
    | Base of FinancialSeries2DProp
    | LevelLineLength of float
    | ShowOpenClose of DevExpress.Xpf.Charts.StockType
    | Model of DevExpress.Xpf.Charts.Stock2DModel

module StockSeries2D =
    let levelLineLength v : obj = box (StockSeries2DProp.LevelLineLength v)
    let showOpenClose v : obj = box (StockSeries2DProp.ShowOpenClose v)
    let model v : obj = box (StockSeries2DProp.Model v)

    let apply (el: DevExpress.Xpf.Charts.StockSeries2D) (prop: StockSeries2DProp) =
        match prop with
        | StockSeries2DProp.Base p -> FinancialSeries2D.apply el p
        | StockSeries2DProp.LevelLineLength v -> el.SetValue(DevExpress.Xpf.Charts.StockSeries2D.LevelLineLengthProperty, box v)
        | StockSeries2DProp.ShowOpenClose v -> el.SetValue(DevExpress.Xpf.Charts.StockSeries2D.ShowOpenCloseProperty, box v)
        | StockSeries2DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.StockSeries2D.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StockSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
