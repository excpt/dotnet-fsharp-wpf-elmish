...
type SpreadsheetSparklineEditProp =
    | Base of SparklineEditProp

module SpreadsheetSparklineEdit =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetSparklineEdit) (prop: SpreadsheetSparklineEditProp) =
        match prop with
        | SpreadsheetSparklineEditProp.Base p -> SparklineEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetSparklineEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
