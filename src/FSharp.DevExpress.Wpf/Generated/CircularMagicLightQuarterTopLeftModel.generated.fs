...
type CircularMagicLightQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularMagicLightQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularMagicLightQuarterTopLeftModel) (prop: CircularMagicLightQuarterTopLeftModelProp) =
        match prop with
        | CircularMagicLightQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularMagicLightQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
