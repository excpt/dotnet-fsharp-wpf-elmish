...
type MagicLightQuarterTopLeftArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightQuarterTopLeftArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightQuarterTopLeftArcScaleForegroundLayerControl) (prop: MagicLightQuarterTopLeftArcScaleForegroundLayerControlProp) =
        match prop with
        | MagicLightQuarterTopLeftArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightQuarterTopLeftArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
