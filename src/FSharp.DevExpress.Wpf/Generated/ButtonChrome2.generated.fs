...
type ButtonChrome2Prop =
    | Base of ChromeBase2Prop

module ButtonChrome2 =

    let apply (el: DevExpress.Xpf.Core.Native.ButtonChrome2) (prop: ButtonChrome2Prop) =
        match prop with
        | ButtonChrome2Prop.Base p -> ChromeBase2.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ButtonChrome2>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
