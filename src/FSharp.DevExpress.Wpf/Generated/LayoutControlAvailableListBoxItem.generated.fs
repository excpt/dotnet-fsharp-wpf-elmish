...
type LayoutControlAvailableListBoxItemProp =
    | DeleteElementVisibility of System.Windows.Visibility

module LayoutControlAvailableListBoxItem =
    let deleteElementVisibility v : obj = box (LayoutControlAvailableListBoxItemProp.DeleteElementVisibility v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutControlAvailableListBoxItem) (prop: LayoutControlAvailableListBoxItemProp) =
        match prop with
        | LayoutControlAvailableListBoxItemProp.DeleteElementVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlAvailableListBoxItem.DeleteElementVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutControlAvailableListBoxItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
