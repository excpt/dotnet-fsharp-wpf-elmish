...
type BackstageItemWithImageProp =
    | Base of BackstageItemProp
    | Glyph of System.Windows.Media.ImageSource
    | GlyphContainerStyle of System.Windows.Style
    | GlyphStyle of System.Windows.Style

module BackstageItemWithImage =
    ...
    let apply (el: DevExpress.Xpf.Ribbon.BackstageItemWithImage) (prop: BackstageItemWithImageProp) =
        match prop with
        | BackstageItemWithImageProp.Base p -> BackstageItem.apply el p
        | BackstageItemWithImageProp.Glyph v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemWithImage.GlyphProperty, box v)
        | BackstageItemWithImageProp.GlyphContainerStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemWithImage.GlyphContainerStyleProperty, box v)
        | BackstageItemWithImageProp.GlyphStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemWithImage.GlyphStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageItemWithImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
