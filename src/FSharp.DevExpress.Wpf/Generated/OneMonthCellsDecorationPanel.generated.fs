...
type OneMonthCellsDecorationPanelProp =
    | Base of MonthCellsDecorationPanelProp

module OneMonthCellsDecorationPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthCellsDecorationPanel) (prop: OneMonthCellsDecorationPanelProp) =
        match prop with
        | OneMonthCellsDecorationPanelProp.Base p -> MonthCellsDecorationPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthCellsDecorationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
