...
module DiagramContentItem =
    let content v : obj = box (DiagramContentItemProp.Content v)
    let contentTemplate v : obj = box (DiagramContentItemProp.ContentTemplate v)
    let contentTemplateSelector v : obj = box (DiagramContentItemProp.ContentTemplateSelector v)
    let cornerRadius v : obj = box (DiagramContentItemProp.CornerRadius v)

    let apply (el: DevExpress.Xpf.Diagram.DiagramContentItem) (prop: DiagramContentItemProp) =
        match prop with
        | DiagramContentItemProp.Base p -> DiagramItem.apply el p
        | DiagramContentItemProp.Content v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramContentItem.ContentProperty, box v)
        | DiagramContentItemProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramContentItem.ContentTemplateProperty, box v)
        | DiagramContentItemProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramContentItem.ContentTemplateSelectorProperty, box v)
        | DiagramContentItemProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramContentItem.CornerRadiusProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramContentItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
