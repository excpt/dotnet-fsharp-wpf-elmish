...
type RibbonPopupBaseProp =
    | Base of BarPopupBaseProp

module RibbonPopupBase =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPopupBase) (prop: RibbonPopupBaseProp) =
        match prop with
        | RibbonPopupBaseProp.Base p -> BarPopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPopupBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
