...
module DiagramList =
    ...
    let apply (el: DevExpress.Xpf.Diagram.DiagramList) (prop: DiagramListProp) =
        match prop with
        | DiagramListProp.Base p -> DiagramContainer.apply el p
        | DiagramListProp.Orientation v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramList.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramList>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
