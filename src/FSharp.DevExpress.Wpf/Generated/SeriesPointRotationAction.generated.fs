...
type SeriesPointRotationActionProp =
    | Base of SeriesPointAnimationActionProp
    | Rotation of DevExpress.Xpf.Charts.AnimationRotation

module SeriesPointRotationAction =
    let rotation v : obj = box (SeriesPointRotationActionProp.Rotation v)

    let apply (el: DevExpress.Xpf.Charts.SeriesPointRotationAction) (prop: SeriesPointRotationActionProp) =
        match prop with
        | SeriesPointRotationActionProp.Base p -> SeriesPointAnimationAction.apply el p
        | SeriesPointRotationActionProp.Rotation v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointRotationAction.RotationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesPointRotationAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
