...
type PredefinedBar2DModelControlProp =
    | Base of PredefinedModelControlProp

module PredefinedBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.PredefinedBar2DModelControl) (prop: PredefinedBar2DModelControlProp) =
        match prop with
        | PredefinedBar2DModelControlProp.Base p -> PredefinedModelControl.apply el p
