...
type SmileHappyStatePresentationControlProp =
    | Base of PresentationControlProp

module SmileHappyStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.SmileHappyStatePresentationControl) (prop: SmileHappyStatePresentationControlProp) =
        match prop with
        | SmileHappyStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmileHappyStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
