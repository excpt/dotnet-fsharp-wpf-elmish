...
type NewEditConditionalFormattingRuleControlProp =
    | Base of ReferenceEditBaseControlProp

module NewEditConditionalFormattingRuleControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.NewEditConditionalFormattingRuleControl) (prop: NewEditConditionalFormattingRuleControlProp) =
        match prop with
        | NewEditConditionalFormattingRuleControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.NewEditConditionalFormattingRuleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
