...
type BarButtonGroupLinkControlProp =
    | Base of BarItemLinkControlProp
    | DefaultMargin of System.Windows.Thickness
    | ResourceHolderTemplateInRibbonPageGroup of System.Windows.Controls.ControlTemplate
    | ResourceHolderTemplate of System.Windows.Controls.ControlTemplate
    | CustomizationButtonStyle of System.Windows.Style

module BarButtonGroupLinkControl =
    let defaultMargin v : obj = box (BarButtonGroupLinkControlProp.DefaultMargin v)
    let resourceHolderTemplateInRibbonPageGroup v : obj = box (BarButtonGroupLinkControlProp.ResourceHolderTemplateInRibbonPageGroup v)
    let resourceHolderTemplate v : obj = box (BarButtonGroupLinkControlProp.ResourceHolderTemplate v)
    let customizationButtonStyle v : obj = box (BarButtonGroupLinkControlProp.CustomizationButtonStyle v)

    let apply (el: DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl) (prop: BarButtonGroupLinkControlProp) =
        match prop with
        | BarButtonGroupLinkControlProp.Base p -> BarItemLinkControl.apply el p
        | BarButtonGroupLinkControlProp.DefaultMargin v -> el.SetValue(DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl.DefaultMarginProperty, box v)
        | BarButtonGroupLinkControlProp.ResourceHolderTemplateInRibbonPageGroup v -> el.SetValue(DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl.ResourceHolderTemplateInRibbonPageGroupProperty, box v)
        | BarButtonGroupLinkControlProp.ResourceHolderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl.ResourceHolderTemplateProperty, box v)
        | BarButtonGroupLinkControlProp.CustomizationButtonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl.CustomizationButtonStyleProperty, box v)
    ...
    let hideDesignTimeAdditionalElements (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl.HideDesignTimeAdditionalElementsProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Ribbon.BarButtonGroupLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
