...
type NavigationPanePanelBaseProp =
    | Orientation of System.Windows.Controls.Orientation

module NavigationPanePanelBase =
    let orientation v : obj = box (NavigationPanePanelBaseProp.Orientation v)

    let apply (el: DevExpress.Xpf.NavBar.NavigationPanePanelBase) (prop: NavigationPanePanelBaseProp) =
        match prop with
        | NavigationPanePanelBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavigationPanePanelBase.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavigationPanePanelBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
