...
type ProgressiveArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveArcScaleForegroundLayerControl) (prop: ProgressiveArcScaleForegroundLayerControlProp) =
        match prop with
        | ProgressiveArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
