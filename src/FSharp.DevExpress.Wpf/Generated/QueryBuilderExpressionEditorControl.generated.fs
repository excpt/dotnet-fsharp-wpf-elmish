...
type QueryBuilderExpressionEditorControlProp =
    | Base of ExpressionEditorControlProp
    | Presenter of DevExpress.Data.Controls.ExpressionEditor.IExpressionEditorPresenter

module QueryBuilderExpressionEditorControl =
    let presenter v : obj = box (QueryBuilderExpressionEditorControlProp.Presenter v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditorControl) (prop: QueryBuilderExpressionEditorControlProp) =
        match prop with
        | QueryBuilderExpressionEditorControlProp.Base p -> ExpressionEditorControl.apply el p
        | QueryBuilderExpressionEditorControlProp.Presenter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditorControl.PresenterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
