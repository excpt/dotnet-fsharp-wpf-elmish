...
type MultiContentControlProp =
    | VisibleChildIndex of obj

module MultiContentControl =
    let visibleChildIndex v : obj = box (MultiContentControlProp.VisibleChildIndex v)

    let apply (el: DevExpress.Xpf.Core.Native.MultiContentControl) (prop: MultiContentControlProp) =
        match prop with
        | MultiContentControlProp.VisibleChildIndex v -> el.SetValue(DevExpress.Xpf.Core.Native.MultiContentControl.VisibleChildIndexProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.MultiContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
