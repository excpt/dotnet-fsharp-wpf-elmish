...
type TripleExponentialMovingAverageTrixProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel
    | PointsCount of int

module TripleExponentialMovingAverageTrix =
    let valueLevel v : obj = box (TripleExponentialMovingAverageTrixProp.ValueLevel v)
    let pointsCount v : obj = box (TripleExponentialMovingAverageTrixProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.TripleExponentialMovingAverageTrix) (prop: TripleExponentialMovingAverageTrixProp) =
        match prop with
        | TripleExponentialMovingAverageTrixProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | TripleExponentialMovingAverageTrixProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.TripleExponentialMovingAverageTrix.ValueLevelProperty, box v)
        | TripleExponentialMovingAverageTrixProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.TripleExponentialMovingAverageTrix.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TripleExponentialMovingAverageTrix>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
