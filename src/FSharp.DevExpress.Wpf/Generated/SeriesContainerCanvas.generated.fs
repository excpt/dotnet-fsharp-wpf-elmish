...
type SeriesContainerCanvasProp =
    | SeriesContainerItems of obj

module SeriesContainerCanvas =
    let seriesContainerItems v : obj = box (SeriesContainerCanvasProp.SeriesContainerItems v)

    let apply (el: DevExpress.Xpf.Charts.SeriesContainerCanvas) (prop: SeriesContainerCanvasProp) =
        match prop with
        | SeriesContainerCanvasProp.SeriesContainerItems v -> el.SetValue(DevExpress.Xpf.Charts.SeriesContainerCanvas.SeriesContainerItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesContainerCanvas>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
