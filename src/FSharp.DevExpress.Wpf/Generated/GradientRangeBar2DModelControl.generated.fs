...
type GradientRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module GradientRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.GradientRangeBar2DModelControl) (prop: GradientRangeBar2DModelControlProp) =
        match prop with
        | GradientRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GradientRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
