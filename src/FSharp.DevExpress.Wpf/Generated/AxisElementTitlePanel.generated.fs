...
type AxisElementTitlePanelProp =
    | Title of DevExpress.Xpf.Charts.AxisElementTitleBase

module AxisElementTitlePanel =
    let title v : obj = box (AxisElementTitlePanelProp.Title v)

    let apply (el: DevExpress.Xpf.Charts.AxisElementTitlePanel) (prop: AxisElementTitlePanelProp) =
        match prop with
        | AxisElementTitlePanelProp.Title v -> el.SetValue(DevExpress.Xpf.Charts.AxisElementTitlePanel.TitleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisElementTitlePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
