...
type VisualDateCellHeaderProp =
    | Base of VisualDateHeaderProp

module VisualDateCellHeader =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDateCellHeader) (prop: VisualDateCellHeaderProp) =
        match prop with
        | VisualDateCellHeaderProp.Base p -> VisualDateHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDateCellHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
