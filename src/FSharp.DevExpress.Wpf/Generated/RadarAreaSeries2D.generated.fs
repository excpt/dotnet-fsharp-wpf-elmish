...
type RadarAreaSeries2DProp =
    | Base of CircularAreaSeries2DProp

module RadarAreaSeries2D =

    let apply (el: DevExpress.Xpf.Charts.RadarAreaSeries2D) (prop: RadarAreaSeries2DProp) =
        match prop with
        | RadarAreaSeries2DProp.Base p -> CircularAreaSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RadarAreaSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
