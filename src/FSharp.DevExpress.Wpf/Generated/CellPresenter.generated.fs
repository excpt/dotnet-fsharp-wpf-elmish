...
type CellPresenterProp =
    | ShowCellToolTip of bool
    | CellToolTip of obj

module CellPresenter =
    let showCellToolTip v : obj = box (CellPresenterProp.ShowCellToolTip v)
    let cellToolTip v : obj = box (CellPresenterProp.CellToolTip v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.CellPresenter) (prop: CellPresenterProp) =
        match prop with
        | CellPresenterProp.ShowCellToolTip v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.CellPresenter.ShowCellToolTipProperty, box v)
        | CellPresenterProp.CellToolTip v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.CellPresenter.CellToolTipProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.CellPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
