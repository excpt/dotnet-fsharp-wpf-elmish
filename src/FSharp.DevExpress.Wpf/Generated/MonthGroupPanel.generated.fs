...
module MonthGroupPanel =
    let cellContainers v : obj = box (MonthGroupPanelProp.CellContainers v)
    let cellContainersPerPage v : obj = box (MonthGroupPanelProp.CellContainersPerPage v)
    let cellsCount v : obj = box (MonthGroupPanelProp.CellsCount v)
    let appointmentsContainerStyle v : obj = box (MonthGroupPanelProp.AppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (MonthGroupPanelProp.DragAppointmentsContainerStyle v)
    let appointmentsDeferredRendering v : obj = box (MonthGroupPanelProp.AppointmentsDeferredRendering v)
    let appointmentsDeferredRenderingRange v : obj = box (MonthGroupPanelProp.AppointmentsDeferredRenderingRange v)
    let isAppointmentsOpacityAnimationEnabled v : obj = box (MonthGroupPanelProp.IsAppointmentsOpacityAnimationEnabled v)
    let appointmentsOpacityAnimation v : obj = box (MonthGroupPanelProp.AppointmentsOpacityAnimation v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel) (prop: MonthGroupPanelProp) =
        match prop with
        | MonthGroupPanelProp.Base p -> GroupPanelBase.apply el p
        | MonthGroupPanelProp.CellContainers v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.CellContainersProperty, box v)
        | MonthGroupPanelProp.CellContainersPerPage v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.CellContainersPerPageProperty, box v)
        | MonthGroupPanelProp.CellsCount v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.CellsCountProperty, box v)
        | MonthGroupPanelProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.AppointmentsContainerStyleProperty, box v)
        | MonthGroupPanelProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.DragAppointmentsContainerStyleProperty, box v)
        | MonthGroupPanelProp.AppointmentsDeferredRendering v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.AppointmentsDeferredRenderingProperty, box v)
        | MonthGroupPanelProp.AppointmentsDeferredRenderingRange v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.AppointmentsDeferredRenderingRangeProperty, box v)
        | MonthGroupPanelProp.IsAppointmentsOpacityAnimationEnabled v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.IsAppointmentsOpacityAnimationEnabledProperty, box v)
        | MonthGroupPanelProp.AppointmentsOpacityAnimation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel.AppointmentsOpacityAnimationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.MonthGroupPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
