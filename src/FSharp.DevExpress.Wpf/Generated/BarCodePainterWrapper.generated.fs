...
type BarCodePainterWrapperProp =
    | Base of BarCodePainterProp

module BarCodePainterWrapper =

    let apply (el: DevExpress.Xpf.Controls.Internal.BarCodePainterWrapper) (prop: BarCodePainterWrapperProp) =
        match prop with
        | BarCodePainterWrapperProp.Base p -> BarCodePainter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BarCodePainterWrapper>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
