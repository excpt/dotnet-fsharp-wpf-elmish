...
type LampDefaultStatePresentationControlProp =
    | Base of PresentationControlProp

module LampDefaultStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.LampDefaultStatePresentationControl) (prop: LampDefaultStatePresentationControlProp) =
        match prop with
        | LampDefaultStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LampDefaultStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
