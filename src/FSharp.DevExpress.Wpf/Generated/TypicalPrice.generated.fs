...
type TypicalPriceProp =
    | Base of IndicatorProp

module TypicalPrice =

    let apply (el: DevExpress.Xpf.Charts.TypicalPrice) (prop: TypicalPriceProp) =
        match prop with
        | TypicalPriceProp.Base p -> Indicator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TypicalPrice>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
