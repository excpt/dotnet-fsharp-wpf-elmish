...
type LinqInstantFeedbackDataSourceProp =
    | Base of InstantFeedbackDataSourceBaseProp

module LinqInstantFeedbackDataSource =

    let apply (el: DevExpress.Xpf.Core.ServerMode.LinqInstantFeedbackDataSource) (prop: LinqInstantFeedbackDataSourceProp) =
        match prop with
        | LinqInstantFeedbackDataSourceProp.Base p -> InstantFeedbackDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ServerMode.LinqInstantFeedbackDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
