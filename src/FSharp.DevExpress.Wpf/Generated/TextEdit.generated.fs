...
type TextEditProp =
    | Base of TextEditBaseProp
    | MaskSaveLiteral of bool
    | MaskShowPlaceHolders of bool
    | MaskPlaceHolder of char
    | Mask of string
    | MaskType of DevExpress.Xpf.Editors.MaskType
    | MaskIgnoreBlank of bool
    | MaskUseAsDisplayFormat of bool
    | MaskAutoComplete of DevExpress.Xpf.Editors.AutoCompleteType
    | MaskCulture of System.Globalization.CultureInfo
    | TextDecorations of System.Windows.TextDecorationCollection
    | AllowSpinOnMouseWheel of bool
    | AllowSpin of bool
    | ShowNullTextIfFocused of bool
    | CharacterCasing of System.Windows.Controls.CharacterCasing
    | MaskBeepOnError of bool
    | OnSpin of DevExpress.Xpf.Editors.SpinEventHandler
...
module TextEdit =
    ...
    let apply (el: DevExpress.Xpf.Editors.TextEdit) (prop: TextEditProp) =
        match prop with
        | TextEditProp.Base p -> TextEditBase.apply el p
        | TextEditProp.MaskSaveLiteral v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskSaveLiteralProperty, box v)
        | TextEditProp.MaskShowPlaceHolders v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskShowPlaceHoldersProperty, box v)
        | TextEditProp.MaskPlaceHolder v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskPlaceHolderProperty, box v)
        | TextEditProp.Mask v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskProperty, box v)
        | TextEditProp.MaskType v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskTypeProperty, box v)
        | TextEditProp.MaskIgnoreBlank v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskIgnoreBlankProperty, box v)
        | TextEditProp.MaskUseAsDisplayFormat v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskUseAsDisplayFormatProperty, box v)
        | TextEditProp.MaskAutoComplete v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskAutoCompleteProperty, box v)
        | TextEditProp.MaskCulture v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskCultureProperty, box v)
        | TextEditProp.TextDecorations v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.TextDecorationsProperty, box v)
        | TextEditProp.AllowSpinOnMouseWheel v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.AllowSpinOnMouseWheelProperty, box v)
        | TextEditProp.AllowSpin v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.AllowSpinProperty, box v)
        | TextEditProp.ShowNullTextIfFocused v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.ShowNullTextIfFocusedProperty, box v)
        | TextEditProp.CharacterCasing v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.CharacterCasingProperty, box v)
        | TextEditProp.MaskBeepOnError v -> el.SetValue(DevExpress.Xpf.Editors.TextEdit.MaskBeepOnErrorProperty, box v)
        | TextEditProp.OnSpin h -> el.Spin.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TextEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
