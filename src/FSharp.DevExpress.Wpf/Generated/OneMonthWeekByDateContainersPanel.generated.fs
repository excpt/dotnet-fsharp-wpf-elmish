...
type OneMonthWeekByDateContainersPanelProp =
    | Base of OneMonthWeekContainersPanelProp

module OneMonthWeekByDateContainersPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthWeekByDateContainersPanel) (prop: OneMonthWeekByDateContainersPanelProp) =
        match prop with
        | OneMonthWeekByDateContainersPanelProp.Base p -> OneMonthWeekContainersPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthWeekByDateContainersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
