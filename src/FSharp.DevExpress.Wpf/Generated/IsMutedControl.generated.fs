...
type IsMutedControlProp =
    | Base of MediaToggleButtonProp

module IsMutedControl =

    let apply (el: DevExpress.Xpf.Controls.IsMutedControl) (prop: IsMutedControlProp) =
        match prop with
        | IsMutedControlProp.Base p -> MediaToggleButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.IsMutedControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
