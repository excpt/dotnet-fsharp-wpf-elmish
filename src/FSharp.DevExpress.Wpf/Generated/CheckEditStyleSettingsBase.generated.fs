...
type CheckEditStyleSettingsBaseProp =
    | Base of BaseEditStyleSettingsProp

module CheckEditStyleSettingsBase =

    let apply (el: DevExpress.Xpf.Editors.CheckEditStyleSettingsBase) (prop: CheckEditStyleSettingsBaseProp) =
        match prop with
        | CheckEditStyleSettingsBaseProp.Base p -> BaseEditStyleSettings.apply el p
