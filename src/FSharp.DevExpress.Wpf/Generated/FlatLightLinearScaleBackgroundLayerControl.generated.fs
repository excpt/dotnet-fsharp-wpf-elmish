...
type FlatLightLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatLightLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightLinearScaleBackgroundLayerControl) (prop: FlatLightLinearScaleBackgroundLayerControlProp) =
        match prop with
        | FlatLightLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
