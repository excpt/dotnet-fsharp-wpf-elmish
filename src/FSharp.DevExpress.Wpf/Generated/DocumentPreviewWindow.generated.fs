...
type DocumentPreviewWindowProp =
    | Base of ThemedWindowProp

module DocumentPreviewWindow =

    let apply (el: DevExpress.Xpf.Printing.DocumentPreviewWindow) (prop: DocumentPreviewWindowProp) =
        match prop with
        | DocumentPreviewWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.DocumentPreviewWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
