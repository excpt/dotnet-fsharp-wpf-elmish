...
type TemplatedBarManagerControllerProp =
    | Base of BarManagerControllerProp
    | Template of System.Windows.DataTemplate

module TemplatedBarManagerController =
    let template v : obj = box (TemplatedBarManagerControllerProp.Template v)

    let apply (el: DevExpress.Xpf.Bars.TemplatedBarManagerController) (prop: TemplatedBarManagerControllerProp) =
        match prop with
        | TemplatedBarManagerControllerProp.Base p -> BarManagerController.apply el p
        | TemplatedBarManagerControllerProp.Template v -> el.SetValue(DevExpress.Xpf.Bars.TemplatedBarManagerController.TemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.TemplatedBarManagerController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
