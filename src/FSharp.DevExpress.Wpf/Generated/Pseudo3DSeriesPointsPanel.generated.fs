...
type Pseudo3DSeriesPointsPanelProp =
    | Base of SimplePanelProp

module Pseudo3DSeriesPointsPanel =

    let apply (el: DevExpress.Xpf.Charts.Pseudo3DSeriesPointsPanel) (prop: Pseudo3DSeriesPointsPanelProp) =
        match prop with
        | Pseudo3DSeriesPointsPanelProp.Base p -> SimplePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Pseudo3DSeriesPointsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
