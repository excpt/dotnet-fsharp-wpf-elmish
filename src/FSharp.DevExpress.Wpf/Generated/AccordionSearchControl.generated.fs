...
type AccordionSearchControlProp =
    | Base of SearchControlProp
    | ShowLoadingIndicator of bool

module AccordionSearchControl =
    let showLoadingIndicator v : obj = box (AccordionSearchControlProp.ShowLoadingIndicator v)

    let apply (el: DevExpress.Xpf.Accordion.AccordionSearchControl) (prop: AccordionSearchControlProp) =
        match prop with
        | AccordionSearchControlProp.Base p -> SearchControl.apply el p
        | AccordionSearchControlProp.ShowLoadingIndicator v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionSearchControl.ShowLoadingIndicatorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionSearchControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
