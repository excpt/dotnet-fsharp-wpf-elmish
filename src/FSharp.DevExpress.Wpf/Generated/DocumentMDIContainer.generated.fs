...
type DocumentMDIContainerProp =
    | Base of psvItemsControlProp
...
module DocumentMDIContainer =
    let layoutItem v : obj = box (DocumentMDIContainerProp.LayoutItem v)
    let themeDependentBackground v : obj = box (DocumentMDIContainerProp.ThemeDependentBackground v)
    let actualBackground v : obj = box (DocumentMDIContainerProp.ActualBackground v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentMDIContainer) (prop: DocumentMDIContainerProp) =
        match prop with
        | DocumentMDIContainerProp.Base p -> psvItemsControl.apply el p
        | DocumentMDIContainerProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentMDIContainer.LayoutItemProperty, box v)
        | DocumentMDIContainerProp.ThemeDependentBackground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentMDIContainer.ThemeDependentBackgroundProperty, box v)
        | DocumentMDIContainerProp.ActualBackground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentMDIContainer.ActualBackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentMDIContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
