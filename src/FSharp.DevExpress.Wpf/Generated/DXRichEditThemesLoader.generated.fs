...
type DXRichEditThemesLoaderProp =
    | Base of DXThemesLoaderBaseProp

module DXRichEditThemesLoader =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.DXRichEditThemesLoader) (prop: DXRichEditThemesLoaderProp) =
        match prop with
        | DXRichEditThemesLoaderProp.Base p -> DXThemesLoaderBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.DXRichEditThemesLoader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
