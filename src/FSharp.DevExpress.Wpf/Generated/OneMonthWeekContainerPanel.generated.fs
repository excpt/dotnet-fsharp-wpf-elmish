...
type OneMonthWeekContainerPanelProp =
...
module OneMonthWeekContainerPanel =
    let view v : obj = box (OneMonthWeekContainerPanelProp.View v)
    let visualData v : obj = box (OneMonthWeekContainerPanelProp.VisualData v)
    let appointmentsContainerStyle v : obj = box (OneMonthWeekContainerPanelProp.AppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (OneMonthWeekContainerPanelProp.DragAppointmentsContainerStyle v)
    let itemVerticalBorderThickness v : obj = box (OneMonthWeekContainerPanelProp.ItemVerticalBorderThickness v)
    let itemHorizontalBorderThickness v : obj = box (OneMonthWeekContainerPanelProp.ItemHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel) (prop: OneMonthWeekContainerPanelProp) =
        match prop with
        | OneMonthWeekContainerPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel.ViewProperty, box v)
        | OneMonthWeekContainerPanelProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel.VisualDataProperty, box v)
        | OneMonthWeekContainerPanelProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel.AppointmentsContainerStyleProperty, box v)
        | OneMonthWeekContainerPanelProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel.DragAppointmentsContainerStyleProperty, box v)
        | OneMonthWeekContainerPanelProp.ItemVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel.ItemVerticalBorderThicknessProperty, box v)
        | OneMonthWeekContainerPanelProp.ItemHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel.ItemHorizontalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthWeekContainerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
