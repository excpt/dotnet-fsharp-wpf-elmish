...
type CircularSmartThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularSmartThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularSmartThreeQuartersModel) (prop: CircularSmartThreeQuartersModelProp) =
        match prop with
        | CircularSmartThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularSmartThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
