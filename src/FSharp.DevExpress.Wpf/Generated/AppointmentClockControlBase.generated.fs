...
type AppointmentClockControlBaseProp =
    | ViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentViewInfo
    | TimeText of string
    | TimeTextVisibility of System.Windows.Visibility

module AppointmentClockControlBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentClockControlBase) (prop: AppointmentClockControlBaseProp) =
        match prop with
        | AppointmentClockControlBaseProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentClockControlBase.ViewInfoProperty, box v)
        | AppointmentClockControlBaseProp.TimeText v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentClockControlBase.TimeTextProperty, box v)
        | AppointmentClockControlBaseProp.TimeTextVisibility v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentClockControlBase.TimeTextVisibilityProperty, box v)
