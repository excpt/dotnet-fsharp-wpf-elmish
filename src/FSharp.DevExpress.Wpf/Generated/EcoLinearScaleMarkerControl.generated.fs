...
type EcoLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module EcoLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoLinearScaleMarkerControl) (prop: EcoLinearScaleMarkerControlProp) =
        match prop with
        | EcoLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
