...
type EcoArcScaleLineControlProp =
    | Base of PresentationControlProp

module EcoArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoArcScaleLineControl) (prop: EcoArcScaleLineControlProp) =
        match prop with
        | EcoArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
