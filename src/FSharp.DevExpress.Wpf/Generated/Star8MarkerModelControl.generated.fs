...
type Star8MarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module Star8MarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.Star8MarkerModelControl) (prop: Star8MarkerModelControlProp) =
        match prop with
        | Star8MarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.Star8MarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
