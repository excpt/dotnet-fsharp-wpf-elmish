...
type AppointmentInplaceEditorProp =
    | Base of AppointmentInplaceEditorBaseProp

module AppointmentInplaceEditor =

    let apply (el: DevExpress.Xpf.Scheduler.UI.AppointmentInplaceEditor) (prop: AppointmentInplaceEditorProp) =
        match prop with
        | AppointmentInplaceEditorProp.Base p -> AppointmentInplaceEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.AppointmentInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
