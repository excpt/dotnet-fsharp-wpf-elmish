...
type DiagramPopupToolBarProp =
    | Base of ToolBarControlProp
    | PlacementTarget of System.Windows.UIElement
    | HorizontalOffset of float
    | VerticalOffset of float

module DiagramPopupToolBar =
    let placementTarget v : obj = box (DiagramPopupToolBarProp.PlacementTarget v)
    let horizontalOffset v : obj = box (DiagramPopupToolBarProp.HorizontalOffset v)
    let verticalOffset v : obj = box (DiagramPopupToolBarProp.VerticalOffset v)

    let apply (el: DevExpress.Xpf.Diagram.Native.DiagramPopupToolBar) (prop: DiagramPopupToolBarProp) =
        match prop with
        | DiagramPopupToolBarProp.Base p -> ToolBarControl.apply el p
        | DiagramPopupToolBarProp.PlacementTarget v -> el.SetValue(DevExpress.Xpf.Diagram.Native.DiagramPopupToolBar.PlacementTargetProperty, box v)
        | DiagramPopupToolBarProp.HorizontalOffset v -> el.SetValue(DevExpress.Xpf.Diagram.Native.DiagramPopupToolBar.HorizontalOffsetProperty, box v)
        | DiagramPopupToolBarProp.VerticalOffset v -> el.SetValue(DevExpress.Xpf.Diagram.Native.DiagramPopupToolBar.VerticalOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.DiagramPopupToolBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
