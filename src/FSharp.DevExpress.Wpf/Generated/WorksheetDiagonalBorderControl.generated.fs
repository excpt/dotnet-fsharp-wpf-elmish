...
type WorksheetDiagonalBorderControlProp =
    | Base of WorksheetPaintControlProp

module WorksheetDiagonalBorderControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetDiagonalBorderControl) (prop: WorksheetDiagonalBorderControlProp) =
        match prop with
        | WorksheetDiagonalBorderControlProp.Base p -> WorksheetPaintControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetDiagonalBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
