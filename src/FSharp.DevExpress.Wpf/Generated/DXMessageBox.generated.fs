...
type DXMessageBoxProp =
    | Text of string
    | Caption of string
    | ImageSource of System.Windows.Media.ImageSource

module DXMessageBox =
    let text v : obj = box (DXMessageBoxProp.Text v)
    let caption v : obj = box (DXMessageBoxProp.Caption v)
    let imageSource v : obj = box (DXMessageBoxProp.ImageSource v)

    let apply (el: DevExpress.Xpf.Core.DXMessageBox) (prop: DXMessageBoxProp) =
        match prop with
        | DXMessageBoxProp.Text v -> el.SetValue(DevExpress.Xpf.Core.DXMessageBox.TextProperty, box v)
        | DXMessageBoxProp.Caption v -> el.SetValue(DevExpress.Xpf.Core.DXMessageBox.CaptionProperty, box v)
        | DXMessageBoxProp.ImageSource v -> el.SetValue(DevExpress.Xpf.Core.DXMessageBox.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DXMessageBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
