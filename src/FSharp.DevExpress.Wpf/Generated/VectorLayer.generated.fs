...
type VectorLayerProp =
    | Base of VectorLayerBaseProp
    | ShapeTitleOptions of DevExpress.Xpf.Map.ShapeTitleOptions
    | Data of DevExpress.Xpf.Map.MapDataAdapterBase
    | Colorizer of DevExpress.Xpf.Map.MapColorizer
    | AllowEditItems of bool

module VectorLayer =
    let shapeTitleOptions v : obj = box (VectorLayerProp.ShapeTitleOptions v)
    let data v : obj = box (VectorLayerProp.Data v)
    let colorizer v : obj = box (VectorLayerProp.Colorizer v)
    let allowEditItems v : obj = box (VectorLayerProp.AllowEditItems v)

    let apply (el: DevExpress.Xpf.Map.VectorLayer) (prop: VectorLayerProp) =
        match prop with
        | VectorLayerProp.Base p -> VectorLayerBase.apply el p
        | VectorLayerProp.ShapeTitleOptions v -> el.SetValue(DevExpress.Xpf.Map.VectorLayer.ShapeTitleOptionsProperty, box v)
        | VectorLayerProp.Data v -> el.SetValue(DevExpress.Xpf.Map.VectorLayer.DataProperty, box v)
        | VectorLayerProp.Colorizer v -> el.SetValue(DevExpress.Xpf.Map.VectorLayer.ColorizerProperty, box v)
        | VectorLayerProp.AllowEditItems v -> el.SetValue(DevExpress.Xpf.Map.VectorLayer.AllowEditItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.VectorLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
