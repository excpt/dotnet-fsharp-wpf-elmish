...
type ButtonEditStyleSettingsProp =
    | Base of TextEditStyleSettingsProp

module ButtonEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.ButtonEditStyleSettings) (prop: ButtonEditStyleSettingsProp) =
        match prop with
        | ButtonEditStyleSettingsProp.Base p -> TextEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ButtonEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
