...
type KeyTipControlProp =
    | Text of string

module KeyTipControl =
    let text v : obj = box (KeyTipControlProp.Text v)

    let apply (el: DevExpress.Xpf.Ribbon.KeyTipControl) (prop: KeyTipControlProp) =
        match prop with
        | KeyTipControlProp.Text v -> el.SetValue(DevExpress.Xpf.Ribbon.KeyTipControl.TextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.KeyTipControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
