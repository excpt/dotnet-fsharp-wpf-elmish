...
type LayoutTabFastRenderPanelProp =
    | Base of psvPanelProp
    | ArrangeAllCachedTabs of bool

module LayoutTabFastRenderPanel =
    let arrangeAllCachedTabs v : obj = box (LayoutTabFastRenderPanelProp.ArrangeAllCachedTabs v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.LayoutTabFastRenderPanel) (prop: LayoutTabFastRenderPanelProp) =
        match prop with
        | LayoutTabFastRenderPanelProp.Base p -> psvPanel.apply el p
        | LayoutTabFastRenderPanelProp.ArrangeAllCachedTabs v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.LayoutTabFastRenderPanel.ArrangeAllCachedTabsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.LayoutTabFastRenderPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
