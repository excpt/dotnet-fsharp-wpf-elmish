...
type CosmicLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicLinearScaleBackgroundLayerControl) (prop: CosmicLinearScaleBackgroundLayerControlProp) =
        match prop with
        | CosmicLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
