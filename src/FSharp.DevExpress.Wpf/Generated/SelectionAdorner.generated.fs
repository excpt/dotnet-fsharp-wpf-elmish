...
type SelectionAdornerProp =
    | Base of DockingHintAdornerBaseProp

module SelectionAdorner =

    let apply (el: DevExpress.Xpf.Docking.Platform.SelectionAdorner) (prop: SelectionAdornerProp) =
        match prop with
        | SelectionAdornerProp.Base p -> DockingHintAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.SelectionAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
