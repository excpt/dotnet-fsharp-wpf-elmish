...
type CircularLineSeries2DProp =
    | Base of CircularSeries2DProp
    | Closed of bool
    | MarkerVisible of bool
    | SeriesAnimation of DevExpress.Xpf.Charts.CircularLineAnimationBase
    | LineStyle of DevExpress.Xpf.Charts.LineStyle
    | ShowIsolatedPoints of bool

module CircularLineSeries2D =
    let closed v : obj = box (CircularLineSeries2DProp.Closed v)
    let markerVisible v : obj = box (CircularLineSeries2DProp.MarkerVisible v)
    let seriesAnimation v : obj = box (CircularLineSeries2DProp.SeriesAnimation v)
    let lineStyle v : obj = box (CircularLineSeries2DProp.LineStyle v)
    let showIsolatedPoints v : obj = box (CircularLineSeries2DProp.ShowIsolatedPoints v)

    let apply (el: DevExpress.Xpf.Charts.CircularLineSeries2D) (prop: CircularLineSeries2DProp) =
        match prop with
        | CircularLineSeries2DProp.Base p -> CircularSeries2D.apply el p
        | CircularLineSeries2DProp.Closed v -> el.SetValue(DevExpress.Xpf.Charts.CircularLineSeries2D.ClosedProperty, box v)
        | CircularLineSeries2DProp.MarkerVisible v -> el.SetValue(DevExpress.Xpf.Charts.CircularLineSeries2D.MarkerVisibleProperty, box v)
        | CircularLineSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.CircularLineSeries2D.SeriesAnimationProperty, box v)
        | CircularLineSeries2DProp.LineStyle v -> el.SetValue(DevExpress.Xpf.Charts.CircularLineSeries2D.LineStyleProperty, box v)
        | CircularLineSeries2DProp.ShowIsolatedPoints v -> el.SetValue(DevExpress.Xpf.Charts.CircularLineSeries2D.ShowIsolatedPointsProperty, box v)
