...
type IStyleArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module IStyleArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleArcScaleNeedleControl) (prop: IStyleArcScaleNeedleControlProp) =
        match prop with
        | IStyleArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
