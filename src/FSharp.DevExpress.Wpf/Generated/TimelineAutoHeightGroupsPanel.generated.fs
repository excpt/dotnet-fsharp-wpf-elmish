...
type TimelineAutoHeightGroupsPanelProp =
    | Base of TimelineAutoHeightGroupsPanelBaseProp

module TimelineAutoHeightGroupsPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanel) (prop: TimelineAutoHeightGroupsPanelProp) =
        match prop with
        | TimelineAutoHeightGroupsPanelProp.Base p -> TimelineAutoHeightGroupsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
