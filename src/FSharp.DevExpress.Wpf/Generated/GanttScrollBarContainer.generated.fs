...
type GanttScrollBarContainerProp =
    | VerticalScrollBarVisibility of System.Windows.Visibility

module GanttScrollBarContainer =
    let verticalScrollBarVisibility v : obj = box (GanttScrollBarContainerProp.VerticalScrollBarVisibility v)

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttScrollBarContainer) (prop: GanttScrollBarContainerProp) =
        match prop with
        | GanttScrollBarContainerProp.VerticalScrollBarVisibility v -> el.SetValue(DevExpress.Xpf.Gantt.Native.GanttScrollBarContainer.VerticalScrollBarVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttScrollBarContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
