...
type DiagramProp =
    ...
    | Annotations of obj
    | SeriesTemplate of DevExpress.Xpf.Charts.Series
    | SeriesDataMember of string
    | SeriesItemsSource of System.Collections.IEnumerable
    | SeriesItemTemplate of System.Windows.DataTemplate
    | SeriesItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | OnDrillDownStateChanged of DevExpress.Xpf.Charts.DrillDownStateChangedEventHandler

module Diagram =
    let annotations v : obj = box (DiagramProp.Annotations v)
    ...
    let apply (el: DevExpress.Xpf.Charts.Diagram) (prop: DiagramProp) =
        match prop with
        | DiagramProp.Base p -> ChartElement.apply el p
        | DiagramProp.Annotations v -> el.SetValue(DevExpress.Xpf.Charts.Diagram.AnnotationsProperty, box v)
        | DiagramProp.SeriesTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Diagram.SeriesTemplateProperty, box v)
        | DiagramProp.SeriesDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Diagram.SeriesDataMemberProperty, box v)
        | DiagramProp.SeriesItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.Diagram.SeriesItemsSourceProperty, box v)
        | DiagramProp.SeriesItemTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Diagram.SeriesItemTemplateProperty, box v)
        | DiagramProp.SeriesItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Charts.Diagram.SeriesItemTemplateSelectorProperty, box v)
        | DiagramProp.OnDrillDownStateChanged h -> el.DrillDownStateChanged.AddHandler(h)
