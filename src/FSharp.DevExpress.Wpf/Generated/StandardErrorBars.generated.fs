...
type StandardErrorBarsProp =
    | Base of ErrorBarsProp

module StandardErrorBars =

    let apply (el: DevExpress.Xpf.Charts.StandardErrorBars) (prop: StandardErrorBarsProp) =
        match prop with
        | StandardErrorBarsProp.Base p -> ErrorBars.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StandardErrorBars>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
