...
type RibbonSelectedPageControlProp =
    ...
    | ToolTipVerticalOffsetInPopup of float
    | IsInSimplifiedRibbon of bool

module RibbonSelectedPageControl =
    let borderTemplate v : obj = box (RibbonSelectedPageControlProp.BorderTemplate v)
    let selectedPage v : obj = box (RibbonSelectedPageControlProp.SelectedPage v)
    let borderTemplateInPopup v : obj = box (RibbonSelectedPageControlProp.BorderTemplateInPopup v)
    let highlightedBorderTemplate v : obj = box (RibbonSelectedPageControlProp.HighlightedBorderTemplate v)
    let highlightedBorderTemplateInPopup v : obj = box (RibbonSelectedPageControlProp.HighlightedBorderTemplateInPopup v)
    let toolTipVerticalOffset v : obj = box (RibbonSelectedPageControlProp.ToolTipVerticalOffset v)
    let toolTipVerticalOffsetInPopup v : obj = box (RibbonSelectedPageControlProp.ToolTipVerticalOffsetInPopup v)
    let isInSimplifiedRibbon v : obj = box (RibbonSelectedPageControlProp.IsInSimplifiedRibbon v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonSelectedPageControl) (prop: RibbonSelectedPageControlProp) =
        match prop with
        | RibbonSelectedPageControlProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.BorderTemplateProperty, box v)
        | RibbonSelectedPageControlProp.SelectedPage v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.SelectedPageProperty, box v)
        | RibbonSelectedPageControlProp.BorderTemplateInPopup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.BorderTemplateInPopupProperty, box v)
        | RibbonSelectedPageControlProp.HighlightedBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.HighlightedBorderTemplateProperty, box v)
        | RibbonSelectedPageControlProp.HighlightedBorderTemplateInPopup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.HighlightedBorderTemplateInPopupProperty, box v)
        | RibbonSelectedPageControlProp.ToolTipVerticalOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.ToolTipVerticalOffsetProperty, box v)
        | RibbonSelectedPageControlProp.ToolTipVerticalOffsetInPopup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.ToolTipVerticalOffsetInPopupProperty, box v)
        | RibbonSelectedPageControlProp.IsInSimplifiedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPageControl.IsInSimplifiedRibbonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonSelectedPageControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
