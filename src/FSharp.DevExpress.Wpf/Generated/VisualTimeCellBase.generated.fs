...
type VisualTimeCellBaseProp =
    | Base of VisualResourceCellBaseProp

module VisualTimeCellBase =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimeCellBase) (prop: VisualTimeCellBaseProp) =
        match prop with
        | VisualTimeCellBaseProp.Base p -> VisualResourceCellBase.apply el p
