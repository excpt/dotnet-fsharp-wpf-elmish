...
type SymbolPresentationControlProp =
    | Base of PresentationControlProp

module SymbolPresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.SymbolPresentationControl) (prop: SymbolPresentationControlProp) =
        match prop with
        | SymbolPresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SymbolPresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
