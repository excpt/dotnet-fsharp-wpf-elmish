...
type ThemeableThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of ThemeableArcScaleBackgroundLayerControlBaseProp

module ThemeableThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableThreeQuartersArcScaleBackgroundLayerControl) (prop: ThemeableThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | ThemeableThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> ThemeableArcScaleBackgroundLayerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
