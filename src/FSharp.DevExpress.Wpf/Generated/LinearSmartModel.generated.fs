...
type LinearSmartModelProp =
    | Base of LinearGaugeModelProp

module LinearSmartModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearSmartModel) (prop: LinearSmartModelProp) =
        match prop with
        | LinearSmartModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearSmartModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
