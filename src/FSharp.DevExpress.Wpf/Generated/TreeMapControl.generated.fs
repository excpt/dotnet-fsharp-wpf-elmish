...
type TreeMapControlProp =
    | Base of HierarchicalChartControlBaseProp
    | LayoutAlgorithm of DevExpress.Xpf.TreeMap.TreeMapLayoutAlgorithmBase
    | DataAdapter of DevExpress.Xpf.TreeMap.TreeMapDataAdapterBase
    | Colorizer of DevExpress.Xpf.TreeMap.TreeMapColorizerBase
    | GroupHeaderContentTemplate of System.Windows.DataTemplate
    | LeafContentTemplate of System.Windows.DataTemplate
    | TreeMapStyle of DevExpress.Xpf.TreeMap.TreeMapStyle
    | EnableHighlighting of bool

module TreeMapControl =
    let layoutAlgorithm v : obj = box (TreeMapControlProp.LayoutAlgorithm v)
    let dataAdapter v : obj = box (TreeMapControlProp.DataAdapter v)
    let colorizer v : obj = box (TreeMapControlProp.Colorizer v)
    let groupHeaderContentTemplate v : obj = box (TreeMapControlProp.GroupHeaderContentTemplate v)
    let leafContentTemplate v : obj = box (TreeMapControlProp.LeafContentTemplate v)
    let treeMapStyle v : obj = box (TreeMapControlProp.TreeMapStyle v)
    let enableHighlighting v : obj = box (TreeMapControlProp.EnableHighlighting v)

    let apply (el: DevExpress.Xpf.TreeMap.TreeMapControl) (prop: TreeMapControlProp) =
        match prop with
        | TreeMapControlProp.Base p -> HierarchicalChartControlBase.apply el p
        | TreeMapControlProp.LayoutAlgorithm v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.LayoutAlgorithmProperty, box v)
        | TreeMapControlProp.DataAdapter v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.DataAdapterProperty, box v)
        | TreeMapControlProp.Colorizer v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.ColorizerProperty, box v)
        | TreeMapControlProp.GroupHeaderContentTemplate v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.GroupHeaderContentTemplateProperty, box v)
        | TreeMapControlProp.LeafContentTemplate v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.LeafContentTemplateProperty, box v)
        | TreeMapControlProp.TreeMapStyle v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.TreeMapStyleProperty, box v)
        | TreeMapControlProp.EnableHighlighting v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapControl.EnableHighlightingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.TreeMapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
