...
type EditableTextContentProp =
    | Text of string
    | EditModeEnabled of bool
    | Multiline of bool

module EditableTextContent =
    let text v : obj = box (EditableTextContentProp.Text v)
    let editModeEnabled v : obj = box (EditableTextContentProp.EditModeEnabled v)
    let multiline v : obj = box (EditableTextContentProp.Multiline v)

    let apply (el: DevExpress.Xpf.Charts.EditableTextContent) (prop: EditableTextContentProp) =
        match prop with
        | EditableTextContentProp.Text v -> el.SetValue(DevExpress.Xpf.Charts.EditableTextContent.TextProperty, box v)
        | EditableTextContentProp.EditModeEnabled v -> el.SetValue(DevExpress.Xpf.Charts.EditableTextContent.EditModeEnabledProperty, box v)
        | EditableTextContentProp.Multiline v -> el.SetValue(DevExpress.Xpf.Charts.EditableTextContent.MultilineProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.EditableTextContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
