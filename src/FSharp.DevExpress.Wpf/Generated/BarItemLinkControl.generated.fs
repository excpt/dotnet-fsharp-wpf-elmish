...
type BarItemLinkControlProp =
    | Base of BarItemLinkControlBaseProp

module BarItemLinkControl =

    let apply (el: DevExpress.Xpf.Bars.BarItemLinkControl) (prop: BarItemLinkControlProp) =
        match prop with
        | BarItemLinkControlProp.Base p -> BarItemLinkControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
