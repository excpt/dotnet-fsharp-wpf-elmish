...
type GalleryItemGroupsControlProp =
    ...
    | ScrollBarVisibility of System.Windows.Visibility
    | ScrollBarPosition of float
    | GalleryControl of DevExpress.Xpf.Bars.GalleryControl

module GalleryItemGroupsControl =
    let itemGlyphBorderTemplate v : obj = box (GalleryItemGroupsControlProp.ItemGlyphBorderTemplate v)
    let itemBorderTemplate v : obj = box (GalleryItemGroupsControlProp.ItemBorderTemplate v)
    let scrollBarVisibility v : obj = box (GalleryItemGroupsControlProp.ScrollBarVisibility v)
    let scrollBarPosition v : obj = box (GalleryItemGroupsControlProp.ScrollBarPosition v)
    let galleryControl v : obj = box (GalleryItemGroupsControlProp.GalleryControl v)

    let apply (el: DevExpress.Xpf.Bars.GalleryItemGroupsControl) (prop: GalleryItemGroupsControlProp) =
        match prop with
        | GalleryItemGroupsControlProp.ItemGlyphBorderTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupsControl.ItemGlyphBorderTemplateProperty, box v)
        | GalleryItemGroupsControlProp.ItemBorderTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupsControl.ItemBorderTemplateProperty, box v)
        | GalleryItemGroupsControlProp.ScrollBarVisibility v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupsControl.ScrollBarVisibilityProperty, box v)
        | GalleryItemGroupsControlProp.ScrollBarPosition v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupsControl.ScrollBarPositionProperty, box v)
        | GalleryItemGroupsControlProp.GalleryControl v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupsControl.GalleryControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryItemGroupsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
