...
type WizardDialogFooterProp =
    | Base of DialogFooterProp

module WizardDialogFooter =

    let apply (el: DevExpress.Xpf.Controls.WizardDialogFooter) (prop: WizardDialogFooterProp) =
        match prop with
        | WizardDialogFooterProp.Base p -> DialogFooter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.WizardDialogFooter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
