...
type EcoMajorTickmarkControlProp =
    | Base of PresentationControlProp

module EcoMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoMajorTickmarkControl) (prop: EcoMajorTickmarkControlProp) =
        match prop with
        | EcoMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
