...
type TimeRegionsTimelinePanelProp =
    | TimeRegionSnapToCellsMode of DevExpress.Xpf.Scheduling.TimeRegionSnapToCellsMode

module TimeRegionsTimelinePanel =
    let timeRegionSnapToCellsMode v : obj = box (TimeRegionsTimelinePanelProp.TimeRegionSnapToCellsMode v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimeRegionsTimelinePanel) (prop: TimeRegionsTimelinePanelProp) =
        match prop with
        | TimeRegionsTimelinePanelProp.TimeRegionSnapToCellsMode v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeRegionsTimelinePanel.TimeRegionSnapToCellsModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimeRegionsTimelinePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
