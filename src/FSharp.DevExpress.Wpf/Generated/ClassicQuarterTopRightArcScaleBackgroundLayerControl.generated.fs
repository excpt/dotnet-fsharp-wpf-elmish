...
type ClassicQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicQuarterTopRightArcScaleBackgroundLayerControl) (prop: ClassicQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | ClassicQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
