...
type MapDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module MapDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.MapDashboardLayoutItem) (prop: MapDashboardLayoutItemProp) =
        match prop with
        | MapDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.MapDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
