...
type CircularRedClockHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularRedClockHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularRedClockHalfTopModel) (prop: CircularRedClockHalfTopModelProp) =
        match prop with
        | CircularRedClockHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularRedClockHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
