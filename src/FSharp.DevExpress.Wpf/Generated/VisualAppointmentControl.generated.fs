...
type VisualAppointmentControlProp =
    | Base of SchedulerContentControlProp
    | StyleSelector of System.Windows.Controls.StyleSelector
    | ViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentViewInfo
    | LayoutViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualLayoutViewInfo
    | StatusDisplayType of DevExpress.XtraScheduler.AppointmentStatusDisplayType

module VisualAppointmentControl =
    let styleSelector v : obj = box (VisualAppointmentControlProp.StyleSelector v)
    let viewInfo v : obj = box (VisualAppointmentControlProp.ViewInfo v)
    let layoutViewInfo v : obj = box (VisualAppointmentControlProp.LayoutViewInfo v)
    let statusDisplayType v : obj = box (VisualAppointmentControlProp.StatusDisplayType v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentControl) (prop: VisualAppointmentControlProp) =
        match prop with
        | VisualAppointmentControlProp.Base p -> SchedulerContentControl.apply el p
        | VisualAppointmentControlProp.StyleSelector v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentControl.StyleSelectorProperty, box v)
        | VisualAppointmentControlProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentControl.ViewInfoProperty, box v)
        | VisualAppointmentControlProp.LayoutViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentControl.LayoutViewInfoProperty, box v)
        | VisualAppointmentControlProp.StatusDisplayType v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentControl.StatusDisplayTypeProperty, box v)
