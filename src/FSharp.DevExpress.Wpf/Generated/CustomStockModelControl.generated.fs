...
type CustomStockModelControlProp =
    | Base of CustomModelControlProp
    | OpenLineTemplate of System.Windows.DataTemplate
    | CloseLineTemplate of System.Windows.DataTemplate
    | CenterLineTemplate of System.Windows.DataTemplate

module CustomStockModelControl =
    let openLineTemplate v : obj = box (CustomStockModelControlProp.OpenLineTemplate v)
    let closeLineTemplate v : obj = box (CustomStockModelControlProp.CloseLineTemplate v)
    let centerLineTemplate v : obj = box (CustomStockModelControlProp.CenterLineTemplate v)

    let apply (el: DevExpress.Xpf.Charts.CustomStockModelControl) (prop: CustomStockModelControlProp) =
        match prop with
        | CustomStockModelControlProp.Base p -> CustomModelControl.apply el p
        | CustomStockModelControlProp.OpenLineTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomStockModelControl.OpenLineTemplateProperty, box v)
        | CustomStockModelControlProp.CloseLineTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomStockModelControl.CloseLineTemplateProperty, box v)
        | CustomStockModelControlProp.CenterLineTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomStockModelControl.CenterLineTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CustomStockModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
