...
type CircularYellowSubmarineModelProp =
    | Base of CircularGaugeModelProp

module CircularYellowSubmarineModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularYellowSubmarineModel) (prop: CircularYellowSubmarineModelProp) =
        match prop with
        | CircularYellowSubmarineModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularYellowSubmarineModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
