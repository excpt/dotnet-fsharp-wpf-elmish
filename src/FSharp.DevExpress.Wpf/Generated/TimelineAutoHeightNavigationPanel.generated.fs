...
type TimelineAutoHeightNavigationPanelProp =
    | Base of NavigationControlProp
    | AvailableHeight of float

module TimelineAutoHeightNavigationPanel =
    let availableHeight v : obj = box (TimelineAutoHeightNavigationPanelProp.AvailableHeight v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightNavigationPanel) (prop: TimelineAutoHeightNavigationPanelProp) =
        match prop with
        | TimelineAutoHeightNavigationPanelProp.Base p -> NavigationControl.apply el p
        | TimelineAutoHeightNavigationPanelProp.AvailableHeight v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightNavigationPanel.AvailableHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightNavigationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
