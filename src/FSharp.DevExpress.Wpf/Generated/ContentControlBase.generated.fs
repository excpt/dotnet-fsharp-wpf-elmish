...
module ContentControlBase =
    ...
    let apply (el: DevExpress.Xpf.Core.ContentControlBase) (prop: ContentControlBaseProp) =
        match prop with
        | ContentControlBaseProp.Base p -> ControlBase.apply el p
        | ContentControlBaseProp.Content v -> el.SetValue(DevExpress.Xpf.Core.ContentControlBase.ContentProperty, box v)
        | ContentControlBaseProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Core.ContentControlBase.ContentTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ContentControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
