...
type ScrollableAreaCellProp =
    | ValueItem of DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaItemBase
    | IsLeftMost of bool
    | IsTopMost of bool
    | IsRightMost of bool
    | IsBottomMost of bool
    | Border of System.Windows.Thickness

module ScrollableAreaCell =
    let valueItem v : obj = box (ScrollableAreaCellProp.ValueItem v)
    let isLeftMost v : obj = box (ScrollableAreaCellProp.IsLeftMost v)
    let isTopMost v : obj = box (ScrollableAreaCellProp.IsTopMost v)
    let isRightMost v : obj = box (ScrollableAreaCellProp.IsRightMost v)
    let isBottomMost v : obj = box (ScrollableAreaCellProp.IsBottomMost v)
    let border v : obj = box (ScrollableAreaCellProp.Border v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell) (prop: ScrollableAreaCellProp) =
        match prop with
        | ScrollableAreaCellProp.ValueItem v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell.ValueItemProperty, box v)
        | ScrollableAreaCellProp.IsLeftMost v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell.IsLeftMostProperty, box v)
        | ScrollableAreaCellProp.IsTopMost v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell.IsTopMostProperty, box v)
        | ScrollableAreaCellProp.IsRightMost v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell.IsRightMostProperty, box v)
        | ScrollableAreaCellProp.IsBottomMost v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell.IsBottomMostProperty, box v)
        | ScrollableAreaCellProp.Border v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaCell.BorderProperty, box v)
