...
type CleanWhiteScaleLabelControlProp =
    | Base of PresentationControlProp

module CleanWhiteScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteScaleLabelControl) (prop: CleanWhiteScaleLabelControlProp) =
        match prop with
        | CleanWhiteScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
