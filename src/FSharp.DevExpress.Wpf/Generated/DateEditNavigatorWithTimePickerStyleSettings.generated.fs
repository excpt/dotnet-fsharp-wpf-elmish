...
type DateEditNavigatorWithTimePickerStyleSettingsProp =
    | Base of DateEditStyleSettingsBaseProp

module DateEditNavigatorWithTimePickerStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.DateEditNavigatorWithTimePickerStyleSettings) (prop: DateEditNavigatorWithTimePickerStyleSettingsProp) =
        match prop with
        | DateEditNavigatorWithTimePickerStyleSettingsProp.Base p -> DateEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateEditNavigatorWithTimePickerStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
