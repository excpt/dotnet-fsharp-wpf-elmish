...
type StackedBarTotalLabelConnectorPresentationProp =
    | Base of ChartElementBaseProp

module StackedBarTotalLabelConnectorPresentation =

    let apply (el: DevExpress.Xpf.Charts.StackedBarTotalLabelConnectorPresentation) (prop: StackedBarTotalLabelConnectorPresentationProp) =
        match prop with
        | StackedBarTotalLabelConnectorPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StackedBarTotalLabelConnectorPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
