...
type PopupColorEditProp =
    | Base of PopupBaseEditProp
    | Diagram of DevExpress.Xpf.Diagram.DiagramControl

module PopupColorEdit =
    let diagram v : obj = box (PopupColorEditProp.Diagram v)

    let apply (el: DevExpress.Xpf.Diagram.Native.PopupColorEdit) (prop: PopupColorEditProp) =
        match prop with
        | PopupColorEditProp.Base p -> PopupBaseEdit.apply el p
        | PopupColorEditProp.Diagram v -> el.SetValue(DevExpress.Xpf.Diagram.Native.PopupColorEdit.DiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.PopupColorEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
