...
type FlatLightQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatLightQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightQuarterTopLeftArcScaleBackgroundLayerControl) (prop: FlatLightQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatLightQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
