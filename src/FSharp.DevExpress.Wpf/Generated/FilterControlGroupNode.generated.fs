...
type FilterControlGroupNodeProp =
    | Base of FilterControlNodeBaseProp

module FilterControlGroupNode =

    let apply (el: DevExpress.Xpf.Editors.Filtering.FilterControlGroupNode) (prop: FilterControlGroupNodeProp) =
        match prop with
        | FilterControlGroupNodeProp.Base p -> FilterControlNodeBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Filtering.FilterControlGroupNode>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
