...
type MasterDetailDiagramConnectorProp =
    | Base of DiagramConnectorProp

module MasterDetailDiagramConnector =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailDiagramConnector) (prop: MasterDetailDiagramConnectorProp) =
        match prop with
        | MasterDetailDiagramConnectorProp.Base p -> DiagramConnector.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailDiagramConnector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
