...
type HeatmapHighlightGeometryPresentationProp =
    | Geometry of DevExpress.Charts.Heatmap.Native.HeatmapGeometry
    | HighlightBrush of System.Windows.Media.Brush
    | HighlightElement of DevExpress.Charts.Heatmap.HeatmapCell
    | HighlightMode of DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightMode
    | SelectedCells of obj

module HeatmapHighlightGeometryPresentation =
    let geometry v : obj = box (HeatmapHighlightGeometryPresentationProp.Geometry v)
    let highlightBrush v : obj = box (HeatmapHighlightGeometryPresentationProp.HighlightBrush v)
    let highlightElement v : obj = box (HeatmapHighlightGeometryPresentationProp.HighlightElement v)
    let highlightMode v : obj = box (HeatmapHighlightGeometryPresentationProp.HighlightMode v)
    let selectedCells v : obj = box (HeatmapHighlightGeometryPresentationProp.SelectedCells v)

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation) (prop: HeatmapHighlightGeometryPresentationProp) =
        match prop with
        | HeatmapHighlightGeometryPresentationProp.Geometry v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation.GeometryProperty, box v)
        | HeatmapHighlightGeometryPresentationProp.HighlightBrush v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation.HighlightBrushProperty, box v)
        | HeatmapHighlightGeometryPresentationProp.HighlightElement v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation.HighlightElementProperty, box v)
        | HeatmapHighlightGeometryPresentationProp.HighlightMode v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation.HighlightModeProperty, box v)
        | HeatmapHighlightGeometryPresentationProp.SelectedCells v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation.SelectedCellsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapHighlightGeometryPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
