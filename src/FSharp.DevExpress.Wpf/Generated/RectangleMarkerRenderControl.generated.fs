...
type RectangleMarkerRenderControlProp =
    | Base of MarkerRenderControlBaseProp

module RectangleMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.RectangleMarkerRenderControl) (prop: RectangleMarkerRenderControlProp) =
        match prop with
        | RectangleMarkerRenderControlProp.Base p -> MarkerRenderControlBase.apply el p
