...
type IStyleLinearScaleLineControlProp =
    | Base of PresentationControlProp

module IStyleLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleLinearScaleLineControl) (prop: IStyleLinearScaleLineControlProp) =
        match prop with
        | IStyleLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
