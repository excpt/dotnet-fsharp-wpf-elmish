...
type NavigationFrameProp =
    | Source of obj
    | Journal of DevExpress.Xpf.WindowsUI.Navigation.IJournal
    | AnimationType of DevExpress.Xpf.WindowsUI.AnimationType
    | AnimationSpeedRatio of float
    | AnimationSelector of DevExpress.Xpf.WindowsUI.AnimationSelector
    | AnimationDelay of System.TimeSpan
    | ContentProvider of DevExpress.Xpf.WindowsUI.Navigation.INavigationContentProvider
    | BackNavigationMode of DevExpress.Xpf.WindowsUI.BackNavigationMode
    | NavigationCacheMaxSize of int
    | NavigationCacheMode of DevExpress.Xpf.WindowsUI.NavigationCacheMode
    | AllowMerging of obj
    | PrefetchedSources of System.Collections.IEnumerable
    | PrefetchedSourcesOptions of DevExpress.Xpf.WindowsUI.PrefetchedSourcesOptions

module NavigationFrame =
    let source v : obj = box (NavigationFrameProp.Source v)
    let journal v : obj = box (NavigationFrameProp.Journal v)
    let animationType v : obj = box (NavigationFrameProp.AnimationType v)
    let animationSpeedRatio v : obj = box (NavigationFrameProp.AnimationSpeedRatio v)
    let animationSelector v : obj = box (NavigationFrameProp.AnimationSelector v)
    let animationDelay v : obj = box (NavigationFrameProp.AnimationDelay v)
    let contentProvider v : obj = box (NavigationFrameProp.ContentProvider v)
    let backNavigationMode v : obj = box (NavigationFrameProp.BackNavigationMode v)
    let navigationCacheMaxSize v : obj = box (NavigationFrameProp.NavigationCacheMaxSize v)
    let navigationCacheMode v : obj = box (NavigationFrameProp.NavigationCacheMode v)
    let allowMerging v : obj = box (NavigationFrameProp.AllowMerging v)
    let prefetchedSources v : obj = box (NavigationFrameProp.PrefetchedSources v)
    let prefetchedSourcesOptions v : obj = box (NavigationFrameProp.PrefetchedSourcesOptions v)

    let apply (el: DevExpress.Xpf.WindowsUI.NavigationFrame) (prop: NavigationFrameProp) =
        match prop with
        | NavigationFrameProp.Source v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.SourceProperty, box v)
        | NavigationFrameProp.Journal v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.JournalProperty, box v)
        | NavigationFrameProp.AnimationType v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.AnimationTypeProperty, box v)
        | NavigationFrameProp.AnimationSpeedRatio v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.AnimationSpeedRatioProperty, box v)
        | NavigationFrameProp.AnimationSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.AnimationSelectorProperty, box v)
        | NavigationFrameProp.AnimationDelay v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.AnimationDelayProperty, box v)
        | NavigationFrameProp.ContentProvider v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.ContentProviderProperty, box v)
        | NavigationFrameProp.BackNavigationMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.BackNavigationModeProperty, box v)
        | NavigationFrameProp.NavigationCacheMaxSize v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.NavigationCacheMaxSizeProperty, box v)
        | NavigationFrameProp.NavigationCacheMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.NavigationCacheModeProperty, box v)
        | NavigationFrameProp.AllowMerging v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.AllowMergingProperty, box v)
        | NavigationFrameProp.PrefetchedSources v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.PrefetchedSourcesProperty, box v)
        | NavigationFrameProp.PrefetchedSourcesOptions v -> el.SetValue(DevExpress.Xpf.WindowsUI.NavigationFrame.PrefetchedSourcesOptionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.NavigationFrame>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
