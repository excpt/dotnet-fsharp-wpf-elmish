...
type ResourceHeaderPresenterProp =
    | Base of FastTextBlockProp

module ResourceHeaderPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.ResourceHeaderPresenter) (prop: ResourceHeaderPresenterProp) =
        match prop with
        | ResourceHeaderPresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.ResourceHeaderPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
