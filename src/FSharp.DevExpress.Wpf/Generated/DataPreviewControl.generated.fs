...
type DataPreviewControlProp =
    | Data of System.Collections.IEnumerable

module DataPreviewControl =
    let data v : obj = box (DataPreviewControlProp.Data v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.DataPreviewControl) (prop: DataPreviewControlProp) =
        match prop with
        | DataPreviewControlProp.Data v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.DataPreviewControl.DataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.DataPreviewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
