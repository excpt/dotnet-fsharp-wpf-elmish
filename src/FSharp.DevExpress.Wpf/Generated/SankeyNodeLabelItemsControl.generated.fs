...
type SankeyNodeLabelItemsControlProp =
    | Base of SankeyNodeItemsControlProp

module SankeyNodeLabelItemsControl =

    let apply (el: DevExpress.Xpf.Charts.Sankey.SankeyNodeLabelItemsControl) (prop: SankeyNodeLabelItemsControlProp) =
        match prop with
        | SankeyNodeLabelItemsControlProp.Base p -> SankeyNodeItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.SankeyNodeLabelItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
