...
type TrackBarEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp
    | LabelClickCommand of System.Windows.Input.ICommand
    | ToolTipPlacementCallback of System.Windows.Controls.Primitives.CustomPopupPlacementCallback
    | NearThumbStyle of System.Windows.Style
    | FarThumbStyle of System.Windows.Style
    | SelectedRangeBackgroundStyle of System.Windows.Style
    | DecrementButtonStyle of System.Windows.Style
    | IncrementButtonStyle of System.Windows.Style

module TrackBarEditPropertyProvider =
    let labelClickCommand v : obj = box (TrackBarEditPropertyProviderProp.LabelClickCommand v)
    let toolTipPlacementCallback v : obj = box (TrackBarEditPropertyProviderProp.ToolTipPlacementCallback v)
    let nearThumbStyle v : obj = box (TrackBarEditPropertyProviderProp.NearThumbStyle v)
    let farThumbStyle v : obj = box (TrackBarEditPropertyProviderProp.FarThumbStyle v)
    let selectedRangeBackgroundStyle v : obj = box (TrackBarEditPropertyProviderProp.SelectedRangeBackgroundStyle v)
    let decrementButtonStyle v : obj = box (TrackBarEditPropertyProviderProp.DecrementButtonStyle v)
    let incrementButtonStyle v : obj = box (TrackBarEditPropertyProviderProp.IncrementButtonStyle v)

    let apply (el: DevExpress.Xpf.Editors.TrackBarEditPropertyProvider) (prop: TrackBarEditPropertyProviderProp) =
        match prop with
        | TrackBarEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
        | TrackBarEditPropertyProviderProp.LabelClickCommand v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.LabelClickCommandProperty, box v)
        | TrackBarEditPropertyProviderProp.ToolTipPlacementCallback v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.ToolTipPlacementCallbackProperty, box v)
        | TrackBarEditPropertyProviderProp.NearThumbStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.NearThumbStyleProperty, box v)
        | TrackBarEditPropertyProviderProp.FarThumbStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.FarThumbStyleProperty, box v)
        | TrackBarEditPropertyProviderProp.SelectedRangeBackgroundStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.SelectedRangeBackgroundStyleProperty, box v)
        | TrackBarEditPropertyProviderProp.DecrementButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.DecrementButtonStyleProperty, box v)
        | TrackBarEditPropertyProviderProp.IncrementButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarEditPropertyProvider.IncrementButtonStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
