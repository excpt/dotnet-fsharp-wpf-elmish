...
type AdditionalSeriesPointGeometryContainerProp =
    | Base of AdditionalSeriesGeometryContainerProp

module AdditionalSeriesPointGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSeriesPointGeometryContainer) (prop: AdditionalSeriesPointGeometryContainerProp) =
        match prop with
        | AdditionalSeriesPointGeometryContainerProp.Base p -> AdditionalSeriesGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSeriesPointGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
