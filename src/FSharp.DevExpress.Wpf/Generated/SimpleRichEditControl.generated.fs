...
open System
open System.Windows
open DevExpress.Xpf.RichEdit.View.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SimpleRichEditControlProp =
    | Base of RichEditControlProp

module SimpleRichEditControl =

    let apply (el: DevExpress.Xpf.RichEdit.View.Native.SimpleRichEditControl) (prop: SimpleRichEditControlProp) =
        match prop with
        | SimpleRichEditControlProp.Base p -> RichEditControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.Native.SimpleRichEditControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
