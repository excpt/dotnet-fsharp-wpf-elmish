...
type FibonacciFansProp =
    | Base of FibonacciIndicatorProp
    | ShowLevel0 of bool

module FibonacciFans =
    let showLevel0 v : obj = box (FibonacciFansProp.ShowLevel0 v)

    let apply (el: DevExpress.Xpf.Charts.FibonacciFans) (prop: FibonacciFansProp) =
        match prop with
        | FibonacciFansProp.Base p -> FibonacciIndicator.apply el p
        | FibonacciFansProp.ShowLevel0 v -> el.SetValue(DevExpress.Xpf.Charts.FibonacciFans.ShowLevel0Property, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FibonacciFans>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
