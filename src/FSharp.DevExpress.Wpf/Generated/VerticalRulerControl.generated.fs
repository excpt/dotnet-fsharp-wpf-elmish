...
type VerticalRulerControlProp =
    | Base of RulerControlBaseProp

module VerticalRulerControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.VerticalRulerControl) (prop: VerticalRulerControlProp) =
        match prop with
        | VerticalRulerControlProp.Base p -> RulerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.VerticalRulerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
