...
type OverflowVirtualizingPanelProp =
    | Base of CollapsedAccordionVirtualizingPanelProp
    | MaxVisibleItems of int
    | CollapsedItems of obj

module OverflowVirtualizingPanel =
    let maxVisibleItems v : obj = box (OverflowVirtualizingPanelProp.MaxVisibleItems v)
    let collapsedItems v : obj = box (OverflowVirtualizingPanelProp.CollapsedItems v)

    let apply (el: DevExpress.Xpf.Accordion.Native.OverflowVirtualizingPanel) (prop: OverflowVirtualizingPanelProp) =
        match prop with
        | OverflowVirtualizingPanelProp.Base p -> CollapsedAccordionVirtualizingPanel.apply el p
        | OverflowVirtualizingPanelProp.MaxVisibleItems v -> el.SetValue(DevExpress.Xpf.Accordion.Native.OverflowVirtualizingPanel.MaxVisibleItemsProperty, box v)
        | OverflowVirtualizingPanelProp.CollapsedItems v -> el.SetValue(DevExpress.Xpf.Accordion.Native.OverflowVirtualizingPanel.CollapsedItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.Native.OverflowVirtualizingPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
