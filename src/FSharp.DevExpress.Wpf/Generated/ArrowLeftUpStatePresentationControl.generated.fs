...
type ArrowLeftUpStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowLeftUpStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowLeftUpStatePresentationControl) (prop: ArrowLeftUpStatePresentationControlProp) =
        match prop with
        | ArrowLeftUpStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowLeftUpStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
