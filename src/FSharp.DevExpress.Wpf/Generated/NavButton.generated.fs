...
module NavButton =
    let allowGlyphTheming v : obj = box (NavButtonProp.AllowGlyphTheming v)
    let showFlyoutButton v : obj = box (NavButtonProp.ShowFlyoutButton v)
    let isMain v : obj = box (NavButtonProp.IsMain v)
    let itemsSource v : obj = box (NavButtonProp.ItemsSource v)
    let itemTemplate v : obj = box (NavButtonProp.ItemTemplate v)
    let itemTemplateSelector v : obj = box (NavButtonProp.ItemTemplateSelector v)
    let itemStyle v : obj = box (NavButtonProp.ItemStyle v)

    let apply (el: DevExpress.Xpf.Navigation.NavButton) (prop: NavButtonProp) =
        match prop with
        | NavButtonProp.Base p -> veButtonBase.apply el p
        | NavButtonProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.AllowGlyphThemingProperty, box v)
        | NavButtonProp.ShowFlyoutButton v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.ShowFlyoutButtonProperty, box v)
        | NavButtonProp.IsMain v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.IsMainProperty, box v)
        | NavButtonProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.ItemsSourceProperty, box v)
        | NavButtonProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.ItemTemplateProperty, box v)
        | NavButtonProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.ItemTemplateSelectorProperty, box v)
        | NavButtonProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Navigation.NavButton.ItemStyleProperty, box v)

    let displayMode v : obj = box (veButtonBaseProp.DisplayMode v)
    let glyphAlignment v : obj = box (veButtonBaseProp.GlyphAlignment v)
    let glyph v : obj = box (veButtonBaseProp.Glyph v)
    let command v : obj = box (veButtonBaseProp.Command v)
    let commandParameter v : obj = box (veButtonBaseProp.CommandParameter v)
    let commandTarget v : obj = box (veButtonBaseProp.CommandTarget v)
    let glyphSpace v : obj = box (veButtonBaseProp.GlyphSpace v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.NavButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
