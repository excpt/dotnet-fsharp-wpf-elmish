...
type TabHeaderControlBoxControlProp =
    | Base of BaseControlBoxControlProp
    | ScrollPrevButtonTemplate of System.Windows.DataTemplate
    | ScrollNextButtonTemplate of System.Windows.DataTemplate
    | DropDownButtonTemplate of System.Windows.DataTemplate
    | RestoreButtonTemplate of System.Windows.DataTemplate
    | CanScrollNext of bool
    | CanScrollPrev of bool

module TabHeaderControlBoxControl =
    let scrollPrevButtonTemplate v : obj = box (TabHeaderControlBoxControlProp.ScrollPrevButtonTemplate v)
    let scrollNextButtonTemplate v : obj = box (TabHeaderControlBoxControlProp.ScrollNextButtonTemplate v)
    let dropDownButtonTemplate v : obj = box (TabHeaderControlBoxControlProp.DropDownButtonTemplate v)
    let restoreButtonTemplate v : obj = box (TabHeaderControlBoxControlProp.RestoreButtonTemplate v)
    let canScrollNext v : obj = box (TabHeaderControlBoxControlProp.CanScrollNext v)
    let canScrollPrev v : obj = box (TabHeaderControlBoxControlProp.CanScrollPrev v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl) (prop: TabHeaderControlBoxControlProp) =
        match prop with
        | TabHeaderControlBoxControlProp.Base p -> BaseControlBoxControl.apply el p
        | TabHeaderControlBoxControlProp.ScrollPrevButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.ScrollPrevButtonTemplateProperty, box v)
        | TabHeaderControlBoxControlProp.ScrollNextButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.ScrollNextButtonTemplateProperty, box v)
        | TabHeaderControlBoxControlProp.DropDownButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.DropDownButtonTemplateProperty, box v)
        | TabHeaderControlBoxControlProp.RestoreButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.RestoreButtonTemplateProperty, box v)
        | TabHeaderControlBoxControlProp.CanScrollNext v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.CanScrollNextProperty, box v)
        | TabHeaderControlBoxControlProp.CanScrollPrev v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.CanScrollPrevProperty, box v)
    ...
    let location (v: DevExpress.Xpf.Docking.DockLayoutManager) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl.LocationProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabHeaderControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
