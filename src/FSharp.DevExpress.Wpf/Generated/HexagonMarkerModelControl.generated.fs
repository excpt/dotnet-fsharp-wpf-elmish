...
type HexagonMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module HexagonMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.HexagonMarkerModelControl) (prop: HexagonMarkerModelControlProp) =
        match prop with
        | HexagonMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.HexagonMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
