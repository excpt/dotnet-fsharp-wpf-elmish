...
type ProgressiveSpindleCapControlProp =
    | Base of PresentationControlProp

module ProgressiveSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveSpindleCapControl) (prop: ProgressiveSpindleCapControlProp) =
        match prop with
        | ProgressiveSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
