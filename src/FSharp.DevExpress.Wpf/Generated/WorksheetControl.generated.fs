...
type WorksheetControlProp =
    | GroupWidth of float
    | GroupHeight of float
    | HeaderHeight of float
    | HeaderWidth of float
    | LayoutInfo of DevExpress.XtraSpreadsheet.Layout.IDocumentLayout
    | CellTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | CellTemplate of System.Windows.DataTemplate
    | ConditionalFormattingIconTemplate of System.Windows.DataTemplate
    | ConditionalFormattingDataBarTemplate of System.Windows.DataTemplate

module WorksheetControl =
    let groupWidth v : obj = box (WorksheetControlProp.GroupWidth v)
    let groupHeight v : obj = box (WorksheetControlProp.GroupHeight v)
    let headerHeight v : obj = box (WorksheetControlProp.HeaderHeight v)
    let headerWidth v : obj = box (WorksheetControlProp.HeaderWidth v)
    let layoutInfo v : obj = box (WorksheetControlProp.LayoutInfo v)
    let cellTemplateSelector v : obj = box (WorksheetControlProp.CellTemplateSelector v)
    let cellTemplate v : obj = box (WorksheetControlProp.CellTemplate v)
    let conditionalFormattingIconTemplate v : obj = box (WorksheetControlProp.ConditionalFormattingIconTemplate v)
    let conditionalFormattingDataBarTemplate v : obj = box (WorksheetControlProp.ConditionalFormattingDataBarTemplate v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl) (prop: WorksheetControlProp) =
        match prop with
        | WorksheetControlProp.GroupWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.GroupWidthProperty, box v)
        | WorksheetControlProp.GroupHeight v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.GroupHeightProperty, box v)
        | WorksheetControlProp.HeaderHeight v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.HeaderHeightProperty, box v)
        | WorksheetControlProp.HeaderWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.HeaderWidthProperty, box v)
        | WorksheetControlProp.LayoutInfo v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.LayoutInfoProperty, box v)
        | WorksheetControlProp.CellTemplateSelector v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.CellTemplateSelectorProperty, box v)
        | WorksheetControlProp.CellTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.CellTemplateProperty, box v)
        | WorksheetControlProp.ConditionalFormattingIconTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.ConditionalFormattingIconTemplateProperty, box v)
        | WorksheetControlProp.ConditionalFormattingDataBarTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl.ConditionalFormattingDataBarTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
