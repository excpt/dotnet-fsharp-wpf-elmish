...
type QueryBuilderProp =
    | EditValue of DevExpress.DataAccess.Native.Sql.QueryBuilder.QueryBuilderViewModel
    | DisplayNameProvider of DevExpress.Data.IDisplayNameProvider
    | UseQueryBuilderLight of bool
    | ParameterService of DevExpress.DataAccess.Wizard.Services.IParameterService
    | SelectedAvailableItem of DevExpress.DataAccess.Native.Sql.QueryBuilder.AvailableItemData
    | AllowEditSql of bool
    | UseLegacyExpressionEditor of bool
    | View of DevExpress.Xpf.DataAccess.QueryBuilder.QueryBuilderViewBase
    | PreviewDialogServiceTemplate of System.Windows.DataTemplate
    | FilterDialogServiceTemplate of System.Windows.DataTemplate
    | JoinEditorDialogServiceTemplate of System.Windows.DataTemplate
    | MessageBoxServiceTemplate of System.Windows.DataTemplate
    | SplashScreenServiceTemplate of System.Windows.DataTemplate
    | ExpressionEditorTemplate of System.Windows.DataTemplate
    | QueryParametersEditorTemplate of System.Windows.DataTemplate

module QueryBuilder =
    let editValue v : obj = box (QueryBuilderProp.EditValue v)
    let displayNameProvider v : obj = box (QueryBuilderProp.DisplayNameProvider v)
    let useQueryBuilderLight v : obj = box (QueryBuilderProp.UseQueryBuilderLight v)
    let parameterService v : obj = box (QueryBuilderProp.ParameterService v)
    let selectedAvailableItem v : obj = box (QueryBuilderProp.SelectedAvailableItem v)
    let allowEditSql v : obj = box (QueryBuilderProp.AllowEditSql v)
    let useLegacyExpressionEditor v : obj = box (QueryBuilderProp.UseLegacyExpressionEditor v)
    let view v : obj = box (QueryBuilderProp.View v)
    let previewDialogServiceTemplate v : obj = box (QueryBuilderProp.PreviewDialogServiceTemplate v)
    let filterDialogServiceTemplate v : obj = box (QueryBuilderProp.FilterDialogServiceTemplate v)
    let joinEditorDialogServiceTemplate v : obj = box (QueryBuilderProp.JoinEditorDialogServiceTemplate v)
    let messageBoxServiceTemplate v : obj = box (QueryBuilderProp.MessageBoxServiceTemplate v)
    let splashScreenServiceTemplate v : obj = box (QueryBuilderProp.SplashScreenServiceTemplate v)
    let expressionEditorTemplate v : obj = box (QueryBuilderProp.ExpressionEditorTemplate v)
    let queryParametersEditorTemplate v : obj = box (QueryBuilderProp.QueryParametersEditorTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder) (prop: QueryBuilderProp) =
        match prop with
        | QueryBuilderProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.EditValueProperty, box v)
        | QueryBuilderProp.DisplayNameProvider v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.DisplayNameProviderProperty, box v)
        | QueryBuilderProp.UseQueryBuilderLight v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.UseQueryBuilderLightProperty, box v)
        | QueryBuilderProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.ParameterServiceProperty, box v)
        | QueryBuilderProp.SelectedAvailableItem v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.SelectedAvailableItemProperty, box v)
        | QueryBuilderProp.AllowEditSql v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.AllowEditSqlProperty, box v)
        | QueryBuilderProp.UseLegacyExpressionEditor v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.UseLegacyExpressionEditorProperty, box v)
        | QueryBuilderProp.View v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.ViewProperty, box v)
        | QueryBuilderProp.PreviewDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.PreviewDialogServiceTemplateProperty, box v)
        | QueryBuilderProp.FilterDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.FilterDialogServiceTemplateProperty, box v)
        | QueryBuilderProp.JoinEditorDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.JoinEditorDialogServiceTemplateProperty, box v)
        | QueryBuilderProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.MessageBoxServiceTemplateProperty, box v)
        | QueryBuilderProp.SplashScreenServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.SplashScreenServiceTemplateProperty, box v)
        | QueryBuilderProp.ExpressionEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.ExpressionEditorTemplateProperty, box v)
        | QueryBuilderProp.QueryParametersEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder.QueryParametersEditorTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.DataSourceWizard.QueryBuilder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
