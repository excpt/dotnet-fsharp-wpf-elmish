...
type CircularDefaultQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularDefaultQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularDefaultQuarterTopLeftModel) (prop: CircularDefaultQuarterTopLeftModelProp) =
        match prop with
        | CircularDefaultQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularDefaultQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
