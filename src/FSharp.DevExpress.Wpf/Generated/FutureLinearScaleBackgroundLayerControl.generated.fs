...
type FutureLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureLinearScaleBackgroundLayerControl) (prop: FutureLinearScaleBackgroundLayerControlProp) =
        match prop with
        | FutureLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
