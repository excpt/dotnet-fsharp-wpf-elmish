...
type SmartSpindleCapControlProp =
    | Base of PresentationControlProp

module SmartSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartSpindleCapControl) (prop: SmartSpindleCapControlProp) =
        match prop with
        | SmartSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
