...
type TemplatedTabCaptionControlProp =
    | Base of TemplatedCaptionControlProp

module TemplatedTabCaptionControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TemplatedTabCaptionControl) (prop: TemplatedTabCaptionControlProp) =
        match prop with
        | TemplatedTabCaptionControlProp.Base p -> TemplatedCaptionControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TemplatedTabCaptionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
