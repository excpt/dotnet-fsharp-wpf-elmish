...
type TokenEditorPanelProp =
    | DisplayItems of obj
    | EnableTokenWrapping of bool
    | TokenContainerTemplate of System.Windows.Controls.ControlTemplate
    | EmptyTokenContainerTemplate of System.Windows.Controls.ControlTemplate

module TokenEditorPanel =
    let displayItems v : obj = box (TokenEditorPanelProp.DisplayItems v)
    let enableTokenWrapping v : obj = box (TokenEditorPanelProp.EnableTokenWrapping v)
    let tokenContainerTemplate v : obj = box (TokenEditorPanelProp.TokenContainerTemplate v)
    let emptyTokenContainerTemplate v : obj = box (TokenEditorPanelProp.EmptyTokenContainerTemplate v)

    let apply (el: DevExpress.Xpf.Editors.Internal.TokenEditorPanel) (prop: TokenEditorPanelProp) =
        match prop with
        | TokenEditorPanelProp.DisplayItems v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPanel.DisplayItemsProperty, box v)
        | TokenEditorPanelProp.EnableTokenWrapping v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPanel.EnableTokenWrappingProperty, box v)
        | TokenEditorPanelProp.TokenContainerTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPanel.TokenContainerTemplateProperty, box v)
        | TokenEditorPanelProp.EmptyTokenContainerTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditorPanel.EmptyTokenContainerTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.TokenEditorPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
