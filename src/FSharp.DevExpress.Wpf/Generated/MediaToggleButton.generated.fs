...
type MediaToggleButtonProp =
    | MediaManager of DevExpress.Xpf.Controls.MediaManager

module MediaToggleButton =
    let mediaManager v : obj = box (MediaToggleButtonProp.MediaManager v)

    let apply (el: DevExpress.Xpf.Controls.MediaToggleButton) (prop: MediaToggleButtonProp) =
        match prop with
        | MediaToggleButtonProp.MediaManager v -> el.SetValue(DevExpress.Xpf.Controls.MediaToggleButton.MediaManagerProperty, box v)
