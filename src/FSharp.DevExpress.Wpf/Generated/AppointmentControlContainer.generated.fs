...
type AppointmentControlContainerProp =
    | Base of DXContentPresenterProp

module AppointmentControlContainer =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentControlContainer) (prop: AppointmentControlContainerProp) =
        match prop with
        | AppointmentControlContainerProp.Base p -> DXContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentControlContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
