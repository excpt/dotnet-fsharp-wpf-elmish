...
type CleanWhiteMajorTickmarkControlProp =
    | Base of PresentationControlProp

module CleanWhiteMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteMajorTickmarkControl) (prop: CleanWhiteMajorTickmarkControlProp) =
        match prop with
        | CleanWhiteMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
