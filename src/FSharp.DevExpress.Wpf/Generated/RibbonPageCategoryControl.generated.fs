...
type RibbonPageCategoryControlProp =
    | AllowCollapse of bool
    | PageCategory of DevExpress.Xpf.Ribbon.RibbonPageCategoryBase
...
module RibbonPageCategoryControl =
    let allowCollapse v : obj = box (RibbonPageCategoryControlProp.AllowCollapse v)
    let pageCategory v : obj = box (RibbonPageCategoryControlProp.PageCategory v)
    let isRibbonMinimized v : obj = box (RibbonPageCategoryControlProp.IsRibbonMinimized v)
    let aeroTemplate v : obj = box (RibbonPageCategoryControlProp.AeroTemplate v)
    let isAeroMode v : obj = box (RibbonPageCategoryControlProp.IsAeroMode v)
    let showHeader v : obj = box (RibbonPageCategoryControlProp.ShowHeader v)
    let captionWidth v : obj = box (RibbonPageCategoryControlProp.CaptionWidth v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageCategoryControl) (prop: RibbonPageCategoryControlProp) =
        match prop with
        | RibbonPageCategoryControlProp.AllowCollapse v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.AllowCollapseProperty, box v)
        | RibbonPageCategoryControlProp.PageCategory v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.PageCategoryProperty, box v)
        | RibbonPageCategoryControlProp.IsRibbonMinimized v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.IsRibbonMinimizedProperty, box v)
        | RibbonPageCategoryControlProp.AeroTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.AeroTemplateProperty, box v)
        | RibbonPageCategoryControlProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.IsAeroModeProperty, box v)
        | RibbonPageCategoryControlProp.ShowHeader v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.ShowHeaderProperty, box v)
        | RibbonPageCategoryControlProp.CaptionWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCategoryControl.CaptionWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageCategoryControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
