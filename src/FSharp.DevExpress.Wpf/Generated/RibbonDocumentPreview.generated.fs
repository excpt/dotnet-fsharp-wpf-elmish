...
type RibbonDocumentPreviewProp =
    | Base of DocumentPreviewBaseProp
    | Model of DevExpress.Xpf.Printing.IDocumentPreviewModel

module RibbonDocumentPreview =
    let model v : obj = box (RibbonDocumentPreviewProp.Model v)

    let apply (el: DevExpress.Xpf.Printing.RibbonDocumentPreview) (prop: RibbonDocumentPreviewProp) =
        match prop with
        | RibbonDocumentPreviewProp.Base p -> DocumentPreviewBase.apply el p
        | RibbonDocumentPreviewProp.Model v -> el.SetValue(DevExpress.Xpf.Printing.RibbonDocumentPreview.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.RibbonDocumentPreview>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
