...
type PieDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module PieDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.PieDashboardLayoutItem) (prop: PieDashboardLayoutItemProp) =
        match prop with
        | PieDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let chartStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.PieDashboardLayoutItem.ChartStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.DashboardWpf.PieDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
