...
type ProgressiveMajorTickmarkControlProp =
    | Base of PresentationControlProp

module ProgressiveMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveMajorTickmarkControl) (prop: ProgressiveMajorTickmarkControlProp) =
        match prop with
        | ProgressiveMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
