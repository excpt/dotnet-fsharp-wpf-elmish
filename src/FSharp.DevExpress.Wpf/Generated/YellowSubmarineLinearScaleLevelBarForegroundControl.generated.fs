...
type YellowSubmarineLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module YellowSubmarineLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleLevelBarForegroundControl) (prop: YellowSubmarineLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | YellowSubmarineLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
