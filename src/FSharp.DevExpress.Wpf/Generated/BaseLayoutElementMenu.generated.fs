...
type BaseLayoutElementMenuProp =
    | Base of CustomizablePopupMenuBaseProp

module BaseLayoutElementMenu =

    let apply (el: DevExpress.Xpf.Docking.BaseLayoutElementMenu) (prop: BaseLayoutElementMenuProp) =
        match prop with
        | BaseLayoutElementMenuProp.Base p -> CustomizablePopupMenuBase.apply el p
