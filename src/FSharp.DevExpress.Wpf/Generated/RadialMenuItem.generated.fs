...
type RadialMenuItemProp =
    | Angle of float

module RadialMenuItem =
    let angle v : obj = box (RadialMenuItemProp.Angle v)

    let apply (el: DevExpress.Xpf.Bars.RadialMenuItem) (prop: RadialMenuItemProp) =
        match prop with
        | RadialMenuItemProp.Angle v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuItem.AngleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.RadialMenuItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
