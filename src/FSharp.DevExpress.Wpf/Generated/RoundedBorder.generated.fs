...
module RoundedBorder =
    let borderThickness v : obj = box (RoundedBorderProp.BorderThickness v)
    let cornerRadius v : obj = box (RoundedBorderProp.CornerRadius v)
    let borderBrush v : obj = box (RoundedBorderProp.BorderBrush v)
    let background v : obj = box (RoundedBorderProp.Background v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.RoundedBorder) (prop: RoundedBorderProp) =
        match prop with
        | RoundedBorderProp.BorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.RoundedBorder.BorderThicknessProperty, box v)
        | RoundedBorderProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.RoundedBorder.CornerRadiusProperty, box v)
        | RoundedBorderProp.BorderBrush v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.RoundedBorder.BorderBrushProperty, box v)
        | RoundedBorderProp.Background v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.RoundedBorder.BackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.RoundedBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
