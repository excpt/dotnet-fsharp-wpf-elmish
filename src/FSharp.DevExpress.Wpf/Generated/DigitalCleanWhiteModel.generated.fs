...
type DigitalCleanWhiteModelProp =
    | Base of DigitalGaugeModelProp

module DigitalCleanWhiteModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalCleanWhiteModel) (prop: DigitalCleanWhiteModelProp) =
        match prop with
        | DigitalCleanWhiteModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalCleanWhiteModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
