...
type YellowSubmarineArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineArcScaleBackgroundLayerControl) (prop: YellowSubmarineArcScaleBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
