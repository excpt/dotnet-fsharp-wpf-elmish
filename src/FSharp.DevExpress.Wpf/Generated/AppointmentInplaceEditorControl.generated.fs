...
type AppointmentInplaceEditorControlProp =
    | Base of InplaceEditorControlProp

module AppointmentInplaceEditorControl =

    let apply (el: DevExpress.Xpf.Scheduling.Editors.AppointmentInplaceEditorControl) (prop: AppointmentInplaceEditorControlProp) =
        match prop with
        | AppointmentInplaceEditorControlProp.Base p -> InplaceEditorControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Editors.AppointmentInplaceEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
