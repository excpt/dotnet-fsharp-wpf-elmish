...
type DocumentPreviewDockLayoutManagerProp =
    | Base of DockLayoutManagerProp

module DocumentPreviewDockLayoutManager =

    let apply (el: DevExpress.Xpf.Printing.Native.DocumentPreviewDockLayoutManager) (prop: DocumentPreviewDockLayoutManagerProp) =
        match prop with
        | DocumentPreviewDockLayoutManagerProp.Base p -> DockLayoutManager.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.DocumentPreviewDockLayoutManager>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
