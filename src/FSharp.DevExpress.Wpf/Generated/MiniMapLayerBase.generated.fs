...
type MiniMapLayerBaseProp =
    | Base of MapElementProp

module MiniMapLayerBase =

    let apply (el: DevExpress.Xpf.Map.MiniMapLayerBase) (prop: MiniMapLayerBaseProp) =
        match prop with
        | MiniMapLayerBaseProp.Base p -> MapElement.apply el p
