...
type MagicLightQuarterTopRightArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightQuarterTopRightArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightQuarterTopRightArcScaleForegroundLayerControl) (prop: MagicLightQuarterTopRightArcScaleForegroundLayerControlProp) =
        match prop with
        | MagicLightQuarterTopRightArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightQuarterTopRightArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
