...
type RatingEditProp =
    ...
    | Precision of DevExpress.Xpf.Editors.RatingPrecision
    | ItemsCount of int
...
module RatingEdit =
    let orientation v : obj = box (RatingEditProp.Orientation v)
    let precision v : obj = box (RatingEditProp.Precision v)
    let itemsCount v : obj = box (RatingEditProp.ItemsCount v)
    let itemStyle v : obj = box (RatingEditProp.ItemStyle v)
    let value v : obj = box (RatingEditProp.Value v)
    let maximum v : obj = box (RatingEditProp.Maximum v)
    let minimum v : obj = box (RatingEditProp.Minimum v)

    let apply (el: DevExpress.Xpf.Editors.RatingEdit) (prop: RatingEditProp) =
        match prop with
        | RatingEditProp.Base p -> BaseEdit.apply el p
        | RatingEditProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.OrientationProperty, box v)
        | RatingEditProp.Precision v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.PrecisionProperty, box v)
        | RatingEditProp.ItemsCount v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.ItemsCountProperty, box v)
        | RatingEditProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.ItemStyleProperty, box v)
        | RatingEditProp.Value v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.ValueProperty, box v)
        | RatingEditProp.Maximum v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.MaximumProperty, box v)
        | RatingEditProp.Minimum v -> el.SetValue(DevExpress.Xpf.Editors.RatingEdit.MinimumProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RatingEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
