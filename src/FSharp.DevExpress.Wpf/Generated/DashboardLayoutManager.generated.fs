...
type DashboardLayoutManagerProp =
    | Base of DockLayoutManagerProp

module DashboardLayoutManager =

    let apply (el: DevExpress.DashboardWpf.Internal.DashboardLayoutManager) (prop: DashboardLayoutManagerProp) =
        match prop with
        | DashboardLayoutManagerProp.Base p -> DockLayoutManager.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.DashboardLayoutManager>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
