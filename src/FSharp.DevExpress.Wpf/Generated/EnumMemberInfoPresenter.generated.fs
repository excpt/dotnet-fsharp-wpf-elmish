...
open System
open System.Windows
open DevExpress.Mvvm.UI
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type EnumMemberInfoPresenterProp =
    | EnumMemberInfo of DevExpress.Mvvm.EnumMemberInfo

module EnumMemberInfoPresenter =
    let enumMemberInfo v : obj = box (EnumMemberInfoPresenterProp.EnumMemberInfo v)

    let apply (el: DevExpress.Mvvm.UI.EnumMemberInfoPresenter) (prop: EnumMemberInfoPresenterProp) =
        match prop with
        | EnumMemberInfoPresenterProp.EnumMemberInfo v -> el.SetValue(DevExpress.Mvvm.UI.EnumMemberInfoPresenter.EnumMemberInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Mvvm.UI.EnumMemberInfoPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
