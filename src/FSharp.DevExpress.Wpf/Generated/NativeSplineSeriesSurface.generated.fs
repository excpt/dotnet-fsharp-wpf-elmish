...
open System
open System.Windows
open DevExpress.Xpf.Charts.Surface
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type NativeSplineSeriesSurfaceProp =
    | Base of AdditionalSplineSeriesGeometryProp

module NativeSplineSeriesSurface =

    let apply (el: DevExpress.Xpf.Charts.Surface.NativeSplineSeriesSurface) (prop: NativeSplineSeriesSurfaceProp) =
        match prop with
        | NativeSplineSeriesSurfaceProp.Base p -> AdditionalSplineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Surface.NativeSplineSeriesSurface>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
