...
type RadarPointSeries2DProp =
    | Base of CircularSeries2DProp

module RadarPointSeries2D =

    let apply (el: DevExpress.Xpf.Charts.RadarPointSeries2D) (prop: RadarPointSeries2DProp) =
        match prop with
        | RadarPointSeries2DProp.Base p -> CircularSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RadarPointSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
