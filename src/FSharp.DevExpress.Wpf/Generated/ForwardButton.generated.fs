...
type ForwardButtonProp =
    | Base of CommandButtonProp

module ForwardButton =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.ForwardButton) (prop: ForwardButtonProp) =
        match prop with
        | ForwardButtonProp.Base p -> CommandButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.ForwardButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
