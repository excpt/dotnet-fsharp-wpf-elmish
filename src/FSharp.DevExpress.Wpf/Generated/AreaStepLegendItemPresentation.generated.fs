...
type AreaStepLegendItemPresentationProp =
    | Base of LineStepLegendItemPresentationProp

module AreaStepLegendItemPresentation =

    let apply (el: DevExpress.Xpf.Charts.AreaStepLegendItemPresentation) (prop: AreaStepLegendItemPresentationProp) =
        match prop with
        | AreaStepLegendItemPresentationProp.Base p -> LineStepLegendItemPresentation.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaStepLegendItemPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
