...
type TimelineSelectionDecorationProp =
    | Base of TimelineDecorationPresenterBaseProp

module TimelineSelectionDecoration =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineSelectionDecoration) (prop: TimelineSelectionDecorationProp) =
        match prop with
        | TimelineSelectionDecorationProp.Base p -> TimelineDecorationPresenterBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineSelectionDecoration>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
