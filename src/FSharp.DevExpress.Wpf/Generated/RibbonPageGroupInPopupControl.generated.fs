...
type RibbonPageGroupInPopupControlProp =
    | Base of RibbonPageGroupControlProp

module RibbonPageGroupInPopupControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageGroupInPopupControl) (prop: RibbonPageGroupInPopupControlProp) =
        match prop with
        | RibbonPageGroupInPopupControlProp.Base p -> RibbonPageGroupControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageGroupInPopupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
