...
type TableOfContentsViewProp =
    | Base of ThemedWindowProp

module TableOfContentsView =

    let apply (el: DevExpress.XtraRichEdit.View.TableOfContentsView) (prop: TableOfContentsViewProp) =
        match prop with
        | TableOfContentsViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.View.TableOfContentsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
