...
type TrackBarZoomRangeStyleSettingsProp =
    | Base of TrackBarRangeStyleSettingsProp
    | DecrementButtonStyle of System.Windows.Style
    | IncrementButtonStyle of System.Windows.Style

module TrackBarZoomRangeStyleSettings =
    let decrementButtonStyle v : obj = box (TrackBarZoomRangeStyleSettingsProp.DecrementButtonStyle v)
    let incrementButtonStyle v : obj = box (TrackBarZoomRangeStyleSettingsProp.IncrementButtonStyle v)

    let apply (el: DevExpress.Xpf.Editors.TrackBarZoomRangeStyleSettings) (prop: TrackBarZoomRangeStyleSettingsProp) =
        match prop with
        | TrackBarZoomRangeStyleSettingsProp.Base p -> TrackBarRangeStyleSettings.apply el p
        | TrackBarZoomRangeStyleSettingsProp.DecrementButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarZoomRangeStyleSettings.DecrementButtonStyleProperty, box v)
        | TrackBarZoomRangeStyleSettingsProp.IncrementButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.TrackBarZoomRangeStyleSettings.IncrementButtonStyleProperty, box v)

    let nearThumbStyle v : obj = box (TrackBarRangeStyleSettingsProp.NearThumbStyle v)
    let farThumbStyle v : obj = box (TrackBarRangeStyleSettingsProp.FarThumbStyle v)
    let selectedRangeBackgroundStyle v : obj = box (TrackBarRangeStyleSettingsProp.SelectedRangeBackgroundStyle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TrackBarZoomRangeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
