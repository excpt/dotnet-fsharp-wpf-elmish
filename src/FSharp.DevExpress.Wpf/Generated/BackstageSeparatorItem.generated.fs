...
type BackstageSeparatorItemProp =
    | Base of BackstageItemBaseProp

module BackstageSeparatorItem =

    let apply (el: DevExpress.Xpf.Ribbon.BackstageSeparatorItem) (prop: BackstageSeparatorItemProp) =
        match prop with
        | BackstageSeparatorItemProp.Base p -> BackstageItemBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageSeparatorItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
