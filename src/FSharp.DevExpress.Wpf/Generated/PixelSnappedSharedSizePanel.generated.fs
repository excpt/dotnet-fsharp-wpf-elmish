...
type PixelSnappedSharedSizePanelProp =
    | Base of SharedSizePanelProp

module PixelSnappedSharedSizePanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.PixelSnappedSharedSizePanel) (prop: PixelSnappedSharedSizePanelProp) =
        match prop with
        | PixelSnappedSharedSizePanelProp.Base p -> SharedSizePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.PixelSnappedSharedSizePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
