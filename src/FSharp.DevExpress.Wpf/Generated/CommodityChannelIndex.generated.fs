...
type CommodityChannelIndexProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | PointsCount of int

module CommodityChannelIndex =
    let pointsCount v : obj = box (CommodityChannelIndexProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.CommodityChannelIndex) (prop: CommodityChannelIndexProp) =
        match prop with
        | CommodityChannelIndexProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | CommodityChannelIndexProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.CommodityChannelIndex.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CommodityChannelIndex>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
