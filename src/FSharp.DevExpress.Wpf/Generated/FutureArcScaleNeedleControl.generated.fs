...
type FutureArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FutureArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureArcScaleNeedleControl) (prop: FutureArcScaleNeedleControlProp) =
        match prop with
        | FutureArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
