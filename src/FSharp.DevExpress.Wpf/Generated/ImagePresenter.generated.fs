...
type ImagePresenterProp =
    | Base of DXImageProp
    | AccentColor of System.Windows.Media.Color
    | AllowAccent of bool

module ImagePresenter =
    let accentColor v : obj = box (ImagePresenterProp.AccentColor v)
    let allowAccent v : obj = box (ImagePresenterProp.AllowAccent v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.ImagePresenter) (prop: ImagePresenterProp) =
        match prop with
        | ImagePresenterProp.Base p -> DXImage.apply el p
        | ImagePresenterProp.AccentColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ImagePresenter.AccentColorProperty, box v)
        | ImagePresenterProp.AllowAccent v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ImagePresenter.AllowAccentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.ImagePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
