...
type DataValidationDXDialogProp =
    | Base of ModelessDXDialogProp

module DataValidationDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.DataValidationDXDialog) (prop: DataValidationDXDialogProp) =
        match prop with
        | DataValidationDXDialogProp.Base p -> ModelessDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.DataValidationDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
