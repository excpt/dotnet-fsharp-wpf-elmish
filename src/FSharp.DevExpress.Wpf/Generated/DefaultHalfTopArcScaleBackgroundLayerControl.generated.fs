...
type DefaultHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultHalfTopArcScaleBackgroundLayerControl) (prop: DefaultHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | DefaultHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
