...
open System
open System.Windows
open DevExpress.Xpf.Carousel
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type CarouselPanelProp =
    | ActiveItem of System.Windows.UIElement
    | VisibleItemCount of int
    | ItemMovingPath of System.Windows.Media.PathGeometry
    | OffsetDistributionFunction of DevExpress.Xpf.Carousel.FunctionBase
    | OffsetAnimationAddFunction of DevExpress.Xpf.Carousel.FunctionBase
    | AnimationTime of float
    | FirstVisibleItemIndex of int
    | AttractorPointIndex of int
    | ActiveItemIndex of int
    | SmoothingTimeFraction of float
    | AnimationDisabled of bool
    | PathVisible of bool
    | PathPadding of System.Windows.Thickness
    | ParameterSet of DevExpress.Xpf.Carousel.ParameterCollection
    | ActivateItemOnClick of bool
    | IsRepeat of bool
    | SnapItemsToDevicePixels of bool
    | IsInvertedDirection of bool
    | PointPathFunction of DevExpress.Xpf.Carousel.PieceLinearFunction
    | ItemSize of System.Windows.Size
    | IsAutoSizeItem of bool
    | PathSizingMode of DevExpress.Xpf.Carousel.PathSizingMode

module CarouselPanel =
    let activeItem v : obj = box (CarouselPanelProp.ActiveItem v)
    let visibleItemCount v : obj = box (CarouselPanelProp.VisibleItemCount v)
    let itemMovingPath v : obj = box (CarouselPanelProp.ItemMovingPath v)
    let offsetDistributionFunction v : obj = box (CarouselPanelProp.OffsetDistributionFunction v)
    let offsetAnimationAddFunction v : obj = box (CarouselPanelProp.OffsetAnimationAddFunction v)
    let animationTime v : obj = box (CarouselPanelProp.AnimationTime v)
    let firstVisibleItemIndex v : obj = box (CarouselPanelProp.FirstVisibleItemIndex v)
    let attractorPointIndex v : obj = box (CarouselPanelProp.AttractorPointIndex v)
    let activeItemIndex v : obj = box (CarouselPanelProp.ActiveItemIndex v)
    let smoothingTimeFraction v : obj = box (CarouselPanelProp.SmoothingTimeFraction v)
    let animationDisabled v : obj = box (CarouselPanelProp.AnimationDisabled v)
    let pathVisible v : obj = box (CarouselPanelProp.PathVisible v)
    let pathPadding v : obj = box (CarouselPanelProp.PathPadding v)
    let parameterSet v : obj = box (CarouselPanelProp.ParameterSet v)
    let activateItemOnClick v : obj = box (CarouselPanelProp.ActivateItemOnClick v)
    let isRepeat v : obj = box (CarouselPanelProp.IsRepeat v)
    let snapItemsToDevicePixels v : obj = box (CarouselPanelProp.SnapItemsToDevicePixels v)
    let isInvertedDirection v : obj = box (CarouselPanelProp.IsInvertedDirection v)
    let pointPathFunction v : obj = box (CarouselPanelProp.PointPathFunction v)
    let itemSize v : obj = box (CarouselPanelProp.ItemSize v)
    let isAutoSizeItem v : obj = box (CarouselPanelProp.IsAutoSizeItem v)
    let pathSizingMode v : obj = box (CarouselPanelProp.PathSizingMode v)

    let apply (el: DevExpress.Xpf.Carousel.CarouselPanel) (prop: CarouselPanelProp) =
        match prop with
        | CarouselPanelProp.ActiveItem v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.ActiveItemProperty, box v)
        | CarouselPanelProp.VisibleItemCount v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.VisibleItemCountProperty, box v)
        | CarouselPanelProp.ItemMovingPath v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.ItemMovingPathProperty, box v)
        | CarouselPanelProp.OffsetDistributionFunction v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.OffsetDistributionFunctionProperty, box v)
        | CarouselPanelProp.OffsetAnimationAddFunction v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.OffsetAnimationAddFunctionProperty, box v)
        | CarouselPanelProp.AnimationTime v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.AnimationTimeProperty, box v)
        | CarouselPanelProp.FirstVisibleItemIndex v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.FirstVisibleItemIndexProperty, box v)
        | CarouselPanelProp.AttractorPointIndex v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.AttractorPointIndexProperty, box v)
        | CarouselPanelProp.ActiveItemIndex v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.ActiveItemIndexProperty, box v)
        | CarouselPanelProp.SmoothingTimeFraction v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.SmoothingTimeFractionProperty, box v)
        | CarouselPanelProp.AnimationDisabled v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.AnimationDisabledProperty, box v)
        | CarouselPanelProp.PathVisible v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.PathVisibleProperty, box v)
        | CarouselPanelProp.PathPadding v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.PathPaddingProperty, box v)
        | CarouselPanelProp.ParameterSet v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.ParameterSetProperty, box v)
        | CarouselPanelProp.ActivateItemOnClick v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.ActivateItemOnClickProperty, box v)
        | CarouselPanelProp.IsRepeat v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.IsRepeatProperty, box v)
        | CarouselPanelProp.SnapItemsToDevicePixels v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.SnapItemsToDevicePixelsProperty, box v)
        | CarouselPanelProp.IsInvertedDirection v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.IsInvertedDirectionProperty, box v)
        | CarouselPanelProp.PointPathFunction v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.PointPathFunctionProperty, box v)
        | CarouselPanelProp.ItemSize v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.ItemSizeProperty, box v)
        | CarouselPanelProp.IsAutoSizeItem v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.IsAutoSizeItemProperty, box v)
        | CarouselPanelProp.PathSizingMode v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselPanel.PathSizingModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Carousel.CarouselPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
