...
type VolumeMediaSliderProp =
    | Base of MediaSliderProp

module VolumeMediaSlider =

    let apply (el: DevExpress.Xpf.Controls.VolumeMediaSlider) (prop: VolumeMediaSliderProp) =
        match prop with
        | VolumeMediaSliderProp.Base p -> MediaSlider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.VolumeMediaSlider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
