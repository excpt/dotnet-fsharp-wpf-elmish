...
type RichEditTableStyleGalleryProp =
    | Base of RichEditStyleGalleryProp

module RichEditTableStyleGallery =

    let apply (el: DevExpress.Xpf.RichEdit.UI.RichEditTableStyleGallery) (prop: RichEditTableStyleGalleryProp) =
        match prop with
        | RichEditTableStyleGalleryProp.Base p -> RichEditStyleGallery.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.RichEditTableStyleGallery>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
