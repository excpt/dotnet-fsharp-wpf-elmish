...
type SquareBorderProp =
    | Base of SchedulerBorderProp

module SquareBorder =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SquareBorder) (prop: SquareBorderProp) =
        match prop with
        | SquareBorderProp.Base p -> SchedulerBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SquareBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
