...
type LayoutControlCustomizationControlProp =
...
module LayoutControlCustomizationControl =
    let availableItems v : obj = box (LayoutControlCustomizationControlProp.AvailableItems v)
    let availableItemsUIVisibility v : obj = box (LayoutControlCustomizationControlProp.AvailableItemsUIVisibility v)
    let newItemsInfo v : obj = box (LayoutControlCustomizationControlProp.NewItemsInfo v)
    let newItemsUIVisibility v : obj = box (LayoutControlCustomizationControlProp.NewItemsUIVisibility v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutControlCustomizationControl) (prop: LayoutControlCustomizationControlProp) =
        match prop with
        | LayoutControlCustomizationControlProp.Base p -> ControlBase.apply el p
        | LayoutControlCustomizationControlProp.AvailableItems v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlCustomizationControl.AvailableItemsProperty, box v)
        | LayoutControlCustomizationControlProp.AvailableItemsUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlCustomizationControl.AvailableItemsUIVisibilityProperty, box v)
        | LayoutControlCustomizationControlProp.NewItemsInfo v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlCustomizationControl.NewItemsInfoProperty, box v)
        | LayoutControlCustomizationControlProp.NewItemsUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlCustomizationControl.NewItemsUIVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutControlCustomizationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
