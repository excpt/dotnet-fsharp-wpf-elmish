...
type DocumentPreviewBarManagerControllerProp =
    | Base of TemplatedBarManagerControllerProp
    | DocumentViewer of DevExpress.Xpf.Printing.DocumentViewer

module DocumentPreviewBarManagerController =
    let documentViewer v : obj = box (DocumentPreviewBarManagerControllerProp.DocumentViewer v)

    let apply (el: DevExpress.Xpf.Printing.DocumentPreviewBarManagerController) (prop: DocumentPreviewBarManagerControllerProp) =
        match prop with
        | DocumentPreviewBarManagerControllerProp.Base p -> TemplatedBarManagerController.apply el p
        | DocumentPreviewBarManagerControllerProp.DocumentViewer v -> el.SetValue(DevExpress.Xpf.Printing.DocumentPreviewBarManagerController.DocumentViewerProperty, box v)

    let template v : obj = box (TemplatedBarManagerControllerProp.Template v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.DocumentPreviewBarManagerController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
