...
module GroupPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Panels.GroupPanelBase) (prop: GroupPanelBaseProp) =
        match prop with
        | GroupPanelBaseProp.Base p -> ControlIScrollPanel.apply el p
        | GroupPanelBaseProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.GroupPanelBase.ViewProperty, box v)
        | GroupPanelBaseProp.ItemVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.GroupPanelBase.ItemVerticalBorderThicknessProperty, box v)
        | GroupPanelBaseProp.ItemHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.GroupPanelBase.ItemHorizontalBorderThicknessProperty, box v)
