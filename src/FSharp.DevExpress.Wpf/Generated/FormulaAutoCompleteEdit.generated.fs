...
type FormulaAutoCompleteEditProp =
    | Base of PopupBaseProp

module FormulaAutoCompleteEdit =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.FormulaAutoCompleteEdit) (prop: FormulaAutoCompleteEditProp) =
        match prop with
        | FormulaAutoCompleteEditProp.Base p -> PopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.FormulaAutoCompleteEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
