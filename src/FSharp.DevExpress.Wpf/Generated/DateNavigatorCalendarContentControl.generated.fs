...
type DateNavigatorCalendarContentControlProp =
    | State of DevExpress.Xpf.Editors.DateNavigator.DateNavigatorCalendarView
    | DateTime of System.DateTime
    | FirstItemOffset of int
    | DayNames of obj
    | WeekNumbers of obj
    | FirstDayOfWeek of System.DayOfWeek

module DateNavigatorCalendarContentControl =
    let state v : obj = box (DateNavigatorCalendarContentControlProp.State v)
    let dateTime v : obj = box (DateNavigatorCalendarContentControlProp.DateTime v)
    let firstItemOffset v : obj = box (DateNavigatorCalendarContentControlProp.FirstItemOffset v)
    let dayNames v : obj = box (DateNavigatorCalendarContentControlProp.DayNames v)
    let weekNumbers v : obj = box (DateNavigatorCalendarContentControlProp.WeekNumbers v)
    let firstDayOfWeek v : obj = box (DateNavigatorCalendarContentControlProp.FirstDayOfWeek v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl) (prop: DateNavigatorCalendarContentControlProp) =
        match prop with
        | DateNavigatorCalendarContentControlProp.State v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl.StateProperty, box v)
        | DateNavigatorCalendarContentControlProp.DateTime v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl.DateTimeProperty, box v)
        | DateNavigatorCalendarContentControlProp.FirstItemOffset v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl.FirstItemOffsetProperty, box v)
        | DateNavigatorCalendarContentControlProp.DayNames v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl.DayNamesProperty, box v)
        | DateNavigatorCalendarContentControlProp.WeekNumbers v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl.WeekNumbersProperty, box v)
        | DateNavigatorCalendarContentControlProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl.FirstDayOfWeekProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
