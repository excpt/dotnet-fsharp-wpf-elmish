...
open System
open System.Windows
open DevExpress.Xpf.Gantt.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TimescaleRulerPresenterProp =
    | Timescale of DevExpress.Xpf.Gantt.TimescaleRuler
    | StartDate of System.DateTime
    | TextAlignment of System.Windows.TextAlignment
    | TextMargin of System.Windows.Thickness
    | ShowTicks of bool
    | TickBrush of System.Windows.Media.Brush
    | TickWidth of int
    | TickHeight of float

module TimescaleRulerPresenter =
    let timescale v : obj = box (TimescaleRulerPresenterProp.Timescale v)
    let startDate v : obj = box (TimescaleRulerPresenterProp.StartDate v)
    let textAlignment v : obj = box (TimescaleRulerPresenterProp.TextAlignment v)
    let textMargin v : obj = box (TimescaleRulerPresenterProp.TextMargin v)
    let showTicks v : obj = box (TimescaleRulerPresenterProp.ShowTicks v)
    let tickBrush v : obj = box (TimescaleRulerPresenterProp.TickBrush v)
    let tickWidth v : obj = box (TimescaleRulerPresenterProp.TickWidth v)
    let tickHeight v : obj = box (TimescaleRulerPresenterProp.TickHeight v)

    let apply (el: DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter) (prop: TimescaleRulerPresenterProp) =
        match prop with
        | TimescaleRulerPresenterProp.Timescale v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.TimescaleProperty, box v)
        | TimescaleRulerPresenterProp.StartDate v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.StartDateProperty, box v)
        | TimescaleRulerPresenterProp.TextAlignment v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.TextAlignmentProperty, box v)
        | TimescaleRulerPresenterProp.TextMargin v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.TextMarginProperty, box v)
        | TimescaleRulerPresenterProp.ShowTicks v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.ShowTicksProperty, box v)
        | TimescaleRulerPresenterProp.TickBrush v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.TickBrushProperty, box v)
        | TimescaleRulerPresenterProp.TickWidth v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.TickWidthProperty, box v)
        | TimescaleRulerPresenterProp.TickHeight v -> el.SetValue(DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter.TickHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.TimescaleRulerPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
