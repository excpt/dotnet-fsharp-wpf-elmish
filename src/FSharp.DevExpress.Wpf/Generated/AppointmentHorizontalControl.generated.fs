...
type AppointmentHorizontalControlProp =
    | Base of AppointmentControlProp

module AppointmentHorizontalControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentHorizontalControl) (prop: AppointmentHorizontalControlProp) =
        match prop with
        | AppointmentHorizontalControlProp.Base p -> AppointmentControl.apply el p
