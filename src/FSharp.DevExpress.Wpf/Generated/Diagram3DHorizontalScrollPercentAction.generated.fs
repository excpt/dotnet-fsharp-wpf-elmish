...
type Diagram3DHorizontalScrollPercentActionProp =
    | Base of Diagram3DAnimationActionProp
    | FinalHorizontalScrollPercent of float

module Diagram3DHorizontalScrollPercentAction =
    let finalHorizontalScrollPercent v : obj = box (Diagram3DHorizontalScrollPercentActionProp.FinalHorizontalScrollPercent v)

    let apply (el: DevExpress.Xpf.Charts.Diagram3DHorizontalScrollPercentAction) (prop: Diagram3DHorizontalScrollPercentActionProp) =
        match prop with
        | Diagram3DHorizontalScrollPercentActionProp.Base p -> Diagram3DAnimationAction.apply el p
        | Diagram3DHorizontalScrollPercentActionProp.FinalHorizontalScrollPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DHorizontalScrollPercentAction.FinalHorizontalScrollPercentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Diagram3DHorizontalScrollPercentAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
