...
type FlatDarkMajorTickmarkControlProp =
    | Base of PresentationControlProp

module FlatDarkMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkMajorTickmarkControl) (prop: FlatDarkMajorTickmarkControlProp) =
        match prop with
        | FlatDarkMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
