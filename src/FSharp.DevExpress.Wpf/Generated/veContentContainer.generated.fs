...
type veContentContainerProp =
    | Base of veContentControlProp

module veContentContainer =

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veContentContainer) (prop: veContentContainerProp) =
        match prop with
        | veContentContainerProp.Base p -> veContentControl.apply el p
