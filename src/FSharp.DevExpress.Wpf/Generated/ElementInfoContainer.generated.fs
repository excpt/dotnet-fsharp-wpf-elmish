...
type ElementInfoContainerProp =
    | ElementInfo of obj
    | StretchToAvailableSize of bool

module ElementInfoContainer =
    let elementInfo v : obj = box (ElementInfoContainerProp.ElementInfo v)
    let stretchToAvailableSize v : obj = box (ElementInfoContainerProp.StretchToAvailableSize v)

    let apply (el: DevExpress.Xpf.Gauges.ElementInfoContainer) (prop: ElementInfoContainerProp) =
        match prop with
        | ElementInfoContainerProp.ElementInfo v -> el.SetValue(DevExpress.Xpf.Gauges.ElementInfoContainer.ElementInfoProperty, box v)
        | ElementInfoContainerProp.StretchToAvailableSize v -> el.SetValue(DevExpress.Xpf.Gauges.ElementInfoContainer.StretchToAvailableSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ElementInfoContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
