...
type DotmRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module DotmRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.DotmRichEditDocumentSourceProvider) (prop: DotmRichEditDocumentSourceProviderProp) =
        match prop with
        | DotmRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.DotmRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
