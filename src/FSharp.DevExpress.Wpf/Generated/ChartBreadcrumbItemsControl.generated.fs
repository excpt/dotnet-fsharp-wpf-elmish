...
type ChartBreadcrumbItemsControlProp =
    | Base of ChartItemsControlProp

module ChartBreadcrumbItemsControl =

    let apply (el: DevExpress.Xpf.Charts.ChartBreadcrumbItemsControl) (prop: ChartBreadcrumbItemsControlProp) =
        match prop with
        | ChartBreadcrumbItemsControlProp.Base p -> ChartItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartBreadcrumbItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
