...
type QueryBuilderFilterStringEditorProp =
    | Base of FilterStringUITypeEditorBaseProp
    | AdditionalProperties of DevExpress.Xpf.Editors.Filtering.PropertyInfoCollection
    | ObjectType of System.Type
    | FiltersView of DevExpress.Xpf.DataAccess.Native.Editors.FiltersView
...
module QueryBuilderFilterStringEditor =
    let additionalProperties v : obj = box (QueryBuilderFilterStringEditorProp.AdditionalProperties v)
    let objectType v : obj = box (QueryBuilderFilterStringEditorProp.ObjectType v)
    let filtersView v : obj = box (QueryBuilderFilterStringEditorProp.FiltersView v)
    let displayNameProvider v : obj = box (QueryBuilderFilterStringEditorProp.DisplayNameProvider v)
    let reportParameterEditorTemplate v : obj = box (QueryBuilderFilterStringEditorProp.ReportParameterEditorTemplate v)
    let queryParameterEditorTemplate v : obj = box (QueryBuilderFilterStringEditorProp.QueryParameterEditorTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor) (prop: QueryBuilderFilterStringEditorProp) =
        match prop with
        | QueryBuilderFilterStringEditorProp.Base p -> FilterStringUITypeEditorBase.apply el p
        | QueryBuilderFilterStringEditorProp.AdditionalProperties v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor.AdditionalPropertiesProperty, box v)
        | QueryBuilderFilterStringEditorProp.ObjectType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor.ObjectTypeProperty, box v)
        | QueryBuilderFilterStringEditorProp.FiltersView v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor.FiltersViewProperty, box v)
        | QueryBuilderFilterStringEditorProp.DisplayNameProvider v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor.DisplayNameProviderProperty, box v)
        | QueryBuilderFilterStringEditorProp.ReportParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor.ReportParameterEditorTemplateProperty, box v)
        | QueryBuilderFilterStringEditorProp.QueryParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor.QueryParameterEditorTemplateProperty, box v)

    let editValue v : obj = box (FilterStringUITypeEditorBaseProp.EditValue v)
    let filterCriteria v : obj = box (FilterStringUITypeEditorBaseProp.FilterCriteria v)
    let showOperandTypeIcon v : obj = box (FilterStringUITypeEditorBaseProp.ShowOperandTypeIcon v)
    let parameterService v : obj = box (FilterStringUITypeEditorBaseProp.ParameterService v)
    let selectedParameter v : obj = box (FilterStringUITypeEditorBaseProp.SelectedParameter v)
    let showGroupCommandsIcon v : obj = box (FilterStringUITypeEditorBaseProp.ShowGroupCommandsIcon v)
    let useCascadeParameters v : obj = box (FilterStringUITypeEditorBaseProp.UseCascadeParameters v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterStringEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
