...
type LinearClassicModelProp =
    | Base of LinearGaugeModelProp

module LinearClassicModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearClassicModel) (prop: LinearClassicModelProp) =
        match prop with
        | LinearClassicModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearClassicModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
