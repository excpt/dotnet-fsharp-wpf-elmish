...
type CenterTabHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module CenterTabHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.CenterTabHotZoneControl) (prop: CenterTabHotZoneControlProp) =
        match prop with
        | CenterTabHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.CenterTabHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
