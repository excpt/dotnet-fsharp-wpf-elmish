...
type XpfRichEditDragCaretProp =
    | Base of XpfRichEditCaretProp

module XpfRichEditDragCaret =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditDragCaret) (prop: XpfRichEditDragCaretProp) =
        match prop with
        | XpfRichEditDragCaretProp.Base p -> XpfRichEditCaret.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditDragCaret>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
