...
type ProtectedRangeManagerDXDialogProp =
    | Base of CustomDXDialogProp

module ProtectedRangeManagerDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ProtectedRangeManagerDXDialog) (prop: ProtectedRangeManagerDXDialogProp) =
        match prop with
        | ProtectedRangeManagerDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ProtectedRangeManagerDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
