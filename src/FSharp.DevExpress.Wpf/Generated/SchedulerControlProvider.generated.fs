...
type SchedulerControlProviderProp =
    | SchedulerControl of DevExpress.Xpf.Scheduler.SchedulerControl

module SchedulerControlProvider =
    let schedulerControl v : obj = box (SchedulerControlProviderProp.SchedulerControl v)

    let apply (el: DevExpress.Xpf.Scheduler.SchedulerControlProvider) (prop: SchedulerControlProviderProp) =
        match prop with
        | SchedulerControlProviderProp.SchedulerControl v -> el.SetValue(DevExpress.Xpf.Scheduler.SchedulerControlProvider.SchedulerControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.SchedulerControlProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
