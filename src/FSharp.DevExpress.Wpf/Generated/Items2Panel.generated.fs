...
type Items2PanelProp =
    | Content1 of System.Windows.UIElement
    | Content2 of System.Windows.UIElement
    | Content1Padding of System.Windows.Thickness
    | Content2Padding of System.Windows.Thickness
    | VerticalPadding of System.Windows.Thickness
    | HorizontalPadding of System.Windows.Thickness
    | VerticalIndent of float
    | HorizontalIndent of float
    | Alignment of System.Windows.Controls.Dock
    | FillContent1 of bool
    | FillContent2 of bool
    | EmptyPadding of System.Windows.Thickness
    | StretchedContent of DevExpress.Xpf.Core.StretchedContentType
    | IgnoreContent2HorizontalAlignment of bool

module Items2Panel =
    let content1 v : obj = box (Items2PanelProp.Content1 v)
    let content2 v : obj = box (Items2PanelProp.Content2 v)
    let content1Padding v : obj = box (Items2PanelProp.Content1Padding v)
    let content2Padding v : obj = box (Items2PanelProp.Content2Padding v)
    let verticalPadding v : obj = box (Items2PanelProp.VerticalPadding v)
    let horizontalPadding v : obj = box (Items2PanelProp.HorizontalPadding v)
    let verticalIndent v : obj = box (Items2PanelProp.VerticalIndent v)
    let horizontalIndent v : obj = box (Items2PanelProp.HorizontalIndent v)
    let alignment v : obj = box (Items2PanelProp.Alignment v)
    let fillContent1 v : obj = box (Items2PanelProp.FillContent1 v)
    let fillContent2 v : obj = box (Items2PanelProp.FillContent2 v)
    let emptyPadding v : obj = box (Items2PanelProp.EmptyPadding v)
    let stretchedContent v : obj = box (Items2PanelProp.StretchedContent v)
    let ignoreContent2HorizontalAlignment v : obj = box (Items2PanelProp.IgnoreContent2HorizontalAlignment v)

    let apply (el: DevExpress.Xpf.Core.Items2Panel) (prop: Items2PanelProp) =
        match prop with
        | Items2PanelProp.Content1 v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.Content1Property, box v)
        | Items2PanelProp.Content2 v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.Content2Property, box v)
        | Items2PanelProp.Content1Padding v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.Content1PaddingProperty, box v)
        | Items2PanelProp.Content2Padding v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.Content2PaddingProperty, box v)
        | Items2PanelProp.VerticalPadding v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.VerticalPaddingProperty, box v)
        | Items2PanelProp.HorizontalPadding v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.HorizontalPaddingProperty, box v)
        | Items2PanelProp.VerticalIndent v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.VerticalIndentProperty, box v)
        | Items2PanelProp.HorizontalIndent v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.HorizontalIndentProperty, box v)
        | Items2PanelProp.Alignment v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.AlignmentProperty, box v)
        | Items2PanelProp.FillContent1 v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.FillContent1Property, box v)
        | Items2PanelProp.FillContent2 v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.FillContent2Property, box v)
        | Items2PanelProp.EmptyPadding v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.EmptyPaddingProperty, box v)
        | Items2PanelProp.StretchedContent v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.StretchedContentProperty, box v)
        | Items2PanelProp.IgnoreContent2HorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Core.Items2Panel.IgnoreContent2HorizontalAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Items2Panel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
