...
type SegmentSeries2DBaseProp =
    | Base of MarkerSeries2DProp
    | SegmentColorizer of DevExpress.Xpf.Charts.SegmentColorizerBase

module SegmentSeries2DBase =
    let segmentColorizer v : obj = box (SegmentSeries2DBaseProp.SegmentColorizer v)

    let apply (el: DevExpress.Xpf.Charts.SegmentSeries2DBase) (prop: SegmentSeries2DBaseProp) =
        match prop with
        | SegmentSeries2DBaseProp.Base p -> MarkerSeries2D.apply el p
        | SegmentSeries2DBaseProp.SegmentColorizer v -> el.SetValue(DevExpress.Xpf.Charts.SegmentSeries2DBase.SegmentColorizerProperty, box v)
    ...
    let markerDisplayMode (v: DevExpress.Xpf.Charts.SidePointDisplayMode) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.SegmentSeries2DBase.MarkerDisplayModeProperty, box v)) :: node.Props }
