...
type CosmicSpindleCapControlProp =
    | Base of PresentationControlProp

module CosmicSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicSpindleCapControl) (prop: CosmicSpindleCapControlProp) =
        match prop with
        | CosmicSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
