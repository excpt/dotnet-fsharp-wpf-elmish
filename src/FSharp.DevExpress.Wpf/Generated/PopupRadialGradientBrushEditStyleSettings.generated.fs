...
type PopupRadialGradientBrushEditStyleSettingsProp =
    | Base of PopupBrushEditStyleSettingsBaseProp

module PopupRadialGradientBrushEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupRadialGradientBrushEditStyleSettings) (prop: PopupRadialGradientBrushEditStyleSettingsProp) =
        match prop with
        | PopupRadialGradientBrushEditStyleSettingsProp.Base p -> PopupBrushEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupRadialGradientBrushEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
