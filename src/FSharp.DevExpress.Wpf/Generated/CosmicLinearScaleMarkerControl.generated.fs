...
type CosmicLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CosmicLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicLinearScaleMarkerControl) (prop: CosmicLinearScaleMarkerControlProp) =
        match prop with
        | CosmicLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
