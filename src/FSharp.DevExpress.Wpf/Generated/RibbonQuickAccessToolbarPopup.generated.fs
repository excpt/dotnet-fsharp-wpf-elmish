...
type RibbonQuickAccessToolbarPopupProp =
    | Base of RibbonPopupBaseProp

module RibbonQuickAccessToolbarPopup =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonQuickAccessToolbarPopup) (prop: RibbonQuickAccessToolbarPopupProp) =
        match prop with
        | RibbonQuickAccessToolbarPopupProp.Base p -> RibbonPopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonQuickAccessToolbarPopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
