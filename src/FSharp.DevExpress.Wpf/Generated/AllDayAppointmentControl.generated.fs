...
type AllDayAppointmentControlProp =
    | Base of AppointmentHorizontalControlProp

module AllDayAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AllDayAppointmentControl) (prop: AllDayAppointmentControlProp) =
        match prop with
        | AllDayAppointmentControlProp.Base p -> AppointmentHorizontalControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AllDayAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
