...
type XPInstantFeedbackDataSourceProp =
    | Base of XPOSourceBaseProp
...
module XPInstantFeedbackDataSource =
    let defaultSorting v : obj = box (XPInstantFeedbackDataSourceProp.DefaultSorting v)
    let displayableProperties v : obj = box (XPInstantFeedbackDataSourceProp.DisplayableProperties v)
    let fixedFilterCriteria v : obj = box (XPInstantFeedbackDataSourceProp.FixedFilterCriteria v)
    let fixedFilterString v : obj = box (XPInstantFeedbackDataSourceProp.FixedFilterString v)

    let apply (el: DevExpress.Xpf.Core.DataSources.XPInstantFeedbackDataSource) (prop: XPInstantFeedbackDataSourceProp) =
        match prop with
        | XPInstantFeedbackDataSourceProp.Base p -> XPOSourceBase.apply el p
        | XPInstantFeedbackDataSourceProp.DefaultSorting v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPInstantFeedbackDataSource.DefaultSortingProperty, box v)
        | XPInstantFeedbackDataSourceProp.DisplayableProperties v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPInstantFeedbackDataSource.DisplayablePropertiesProperty, box v)
        | XPInstantFeedbackDataSourceProp.FixedFilterCriteria v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPInstantFeedbackDataSource.FixedFilterCriteriaProperty, box v)
        | XPInstantFeedbackDataSourceProp.FixedFilterString v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPInstantFeedbackDataSource.FixedFilterStringProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.XPInstantFeedbackDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
