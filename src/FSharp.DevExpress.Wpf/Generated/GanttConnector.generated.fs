...
type GanttConnectorProp =
    | Base of GanttConnectorBaseProp
    | ShadowBrush of System.Windows.Media.Brush
    | ShadowThickness of float
    | BeginPoint of DevExpress.Xpf.Gantt.GanttAttachmentPoint
    | EndPoint of DevExpress.Xpf.Gantt.GanttAttachmentPoint
    | LogicalToDisplay of DevExpress.Xpf.Gantt.Native.LogicalToDisplay
    | Points of obj
    | PredecessorLinkType of DevExpress.Mvvm.Gantt.PredecessorLinkType
    | CornerRadius of int
    | LineMargin of int
    | MilestoneLineMargin of int

module GanttConnector =
    let shadowBrush v : obj = box (GanttConnectorProp.ShadowBrush v)
    let shadowThickness v : obj = box (GanttConnectorProp.ShadowThickness v)
    let beginPoint v : obj = box (GanttConnectorProp.BeginPoint v)
    let endPoint v : obj = box (GanttConnectorProp.EndPoint v)
    let logicalToDisplay v : obj = box (GanttConnectorProp.LogicalToDisplay v)
    let points v : obj = box (GanttConnectorProp.Points v)
    let predecessorLinkType v : obj = box (GanttConnectorProp.PredecessorLinkType v)
    let cornerRadius v : obj = box (GanttConnectorProp.CornerRadius v)
    let lineMargin v : obj = box (GanttConnectorProp.LineMargin v)
    let milestoneLineMargin v : obj = box (GanttConnectorProp.MilestoneLineMargin v)

    let apply (el: DevExpress.Xpf.Gantt.GanttConnector) (prop: GanttConnectorProp) =
        match prop with
        | GanttConnectorProp.Base p -> GanttConnectorBase.apply el p
        | GanttConnectorProp.ShadowBrush v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.ShadowBrushProperty, box v)
        | GanttConnectorProp.ShadowThickness v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.ShadowThicknessProperty, box v)
        | GanttConnectorProp.BeginPoint v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.BeginPointProperty, box v)
        | GanttConnectorProp.EndPoint v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.EndPointProperty, box v)
        | GanttConnectorProp.LogicalToDisplay v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.LogicalToDisplayProperty, box v)
        | GanttConnectorProp.Points v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.PointsProperty, box v)
        | GanttConnectorProp.PredecessorLinkType v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.PredecessorLinkTypeProperty, box v)
        | GanttConnectorProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.CornerRadiusProperty, box v)
        | GanttConnectorProp.LineMargin v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.LineMarginProperty, box v)
        | GanttConnectorProp.MilestoneLineMargin v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnector.MilestoneLineMarginProperty, box v)

    let stroke v : obj = box (GanttConnectorBaseProp.Stroke v)
    let strokeThickness v : obj = box (GanttConnectorBaseProp.StrokeThickness v)
    let strokeDashArray v : obj = box (GanttConnectorBaseProp.StrokeDashArray v)
    let strokeDashOffset v : obj = box (GanttConnectorBaseProp.StrokeDashOffset v)
    let arrowSize v : obj = box (GanttConnectorBaseProp.ArrowSize v)
    ...
    let isAttachmentTarget (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Gantt.GanttConnector.IsAttachmentTargetProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Gantt.GanttConnector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
