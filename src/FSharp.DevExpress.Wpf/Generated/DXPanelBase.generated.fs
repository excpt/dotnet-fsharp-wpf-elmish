...
type DXPanelBaseProp =
    | ChildrenSource of obj
    | Orientation of System.Windows.Controls.Orientation

module DXPanelBase =
    let childrenSource v : obj = box (DXPanelBaseProp.ChildrenSource v)
    let orientation v : obj = box (DXPanelBaseProp.Orientation v)

    let apply (el: DevExpress.Xpf.Core.Native.DXPanelBase) (prop: DXPanelBaseProp) =
        match prop with
        | DXPanelBaseProp.ChildrenSource v -> el.SetValue(DevExpress.Xpf.Core.Native.DXPanelBase.ChildrenSourceProperty, box v)
        | DXPanelBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.Core.Native.DXPanelBase.OrientationProperty, box v)
