...
type DXExpanderProp =
    | AllowAddingEvent of bool
    | Duration of float
    | IsExpanded of bool
    | StretchChild of bool
    | HorizontalExpand of DevExpress.Xpf.Core.HorizontalExpandMode
    | VerticalExpand of DevExpress.Xpf.Core.VerticalExpandMode
    | AnimationProgress of float
...
module DXExpander =
    let allowAddingEvent v : obj = box (DXExpanderProp.AllowAddingEvent v)
    let duration v : obj = box (DXExpanderProp.Duration v)
    let isExpanded v : obj = box (DXExpanderProp.IsExpanded v)
    let stretchChild v : obj = box (DXExpanderProp.StretchChild v)
    let horizontalExpand v : obj = box (DXExpanderProp.HorizontalExpand v)
    let verticalExpand v : obj = box (DXExpanderProp.VerticalExpand v)
    let animationProgress v : obj = box (DXExpanderProp.AnimationProgress v)
    let expandStoryboard v : obj = box (DXExpanderProp.ExpandStoryboard v)
    let collapseStoryboard v : obj = box (DXExpanderProp.CollapseStoryboard v)
    let expanding v : obj = box (DXExpanderProp.Expanding v)
    let collapsing v : obj = box (DXExpanderProp.Collapsing v)

    let apply (el: DevExpress.Xpf.Core.DXExpander) (prop: DXExpanderProp) =
        match prop with
        | DXExpanderProp.AllowAddingEvent v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.AllowAddingEventProperty, box v)
        | DXExpanderProp.Duration v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.DurationProperty, box v)
        | DXExpanderProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.IsExpandedProperty, box v)
        | DXExpanderProp.StretchChild v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.StretchChildProperty, box v)
        | DXExpanderProp.HorizontalExpand v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.HorizontalExpandProperty, box v)
        | DXExpanderProp.VerticalExpand v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.VerticalExpandProperty, box v)
        | DXExpanderProp.AnimationProgress v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.AnimationProgressProperty, box v)
        | DXExpanderProp.ExpandStoryboard v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.ExpandStoryboardProperty, box v)
        | DXExpanderProp.CollapseStoryboard v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.CollapseStoryboardProperty, box v)
        | DXExpanderProp.Expanding v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.ExpandingProperty, box v)
        | DXExpanderProp.Collapsing v -> el.SetValue(DevExpress.Xpf.Core.DXExpander.CollapsingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DXExpander>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
