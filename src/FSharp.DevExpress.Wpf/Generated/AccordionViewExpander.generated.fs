...
open System
open System.Windows
open DevExpress.Xpf.Accordion.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type AccordionViewExpanderProp =
    | Base of DXExpanderProp
    | IsContentCollapsed of bool
    | ContentMinWidth of float
    | ItemMinWidth of float

module AccordionViewExpander =
    let isContentCollapsed v : obj = box (AccordionViewExpanderProp.IsContentCollapsed v)
    let contentMinWidth v : obj = box (AccordionViewExpanderProp.ContentMinWidth v)
    let itemMinWidth v : obj = box (AccordionViewExpanderProp.ItemMinWidth v)

    let apply (el: DevExpress.Xpf.Accordion.Native.AccordionViewExpander) (prop: AccordionViewExpanderProp) =
        match prop with
        | AccordionViewExpanderProp.Base p -> DXExpander.apply el p
        | AccordionViewExpanderProp.IsContentCollapsed v -> el.SetValue(DevExpress.Xpf.Accordion.Native.AccordionViewExpander.IsContentCollapsedProperty, box v)
        | AccordionViewExpanderProp.ContentMinWidth v -> el.SetValue(DevExpress.Xpf.Accordion.Native.AccordionViewExpander.ContentMinWidthProperty, box v)
        | AccordionViewExpanderProp.ItemMinWidth v -> el.SetValue(DevExpress.Xpf.Accordion.Native.AccordionViewExpander.ItemMinWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.Native.AccordionViewExpander>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
