...
type SchedulerContentPresenterProp =
    | Base of XPFContentPresenterProp

module SchedulerContentPresenter =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerContentPresenter) (prop: SchedulerContentPresenterProp) =
        match prop with
        | SchedulerContentPresenterProp.Base p -> XPFContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SchedulerContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
