...
type DXTriggerInfoProp =
    | Base of DXTriggerInfoBaseProp

module DXTriggerInfo =

    let apply (el: DevExpress.Xpf.Core.Native.DXTriggerInfo) (prop: DXTriggerInfoProp) =
        match prop with
        | DXTriggerInfoProp.Base p -> DXTriggerInfoBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DXTriggerInfo>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
