...
type NativeLineSeriesSurfaceProp =
    | Base of AdditionalLineSeriesGeometryProp

module NativeLineSeriesSurface =

    let apply (el: DevExpress.Xpf.Charts.Surface.NativeLineSeriesSurface) (prop: NativeLineSeriesSurfaceProp) =
        match prop with
        | NativeLineSeriesSurfaceProp.Base p -> AdditionalLineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Surface.NativeLineSeriesSurface>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
