...
type YellowSubmarineLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module YellowSubmarineLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleMarkerControl) (prop: YellowSubmarineLinearScaleMarkerControlProp) =
        match prop with
        | YellowSubmarineLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
