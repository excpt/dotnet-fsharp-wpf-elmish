...
type CircularDiagram2DItemsControlProp =
    | Base of Diagram2DItemsControlProp
    | Diagram of DevExpress.Xpf.Charts.CircularDiagram2D
    | AxisItems of obj
    | DiagramContent of System.Windows.UIElement
    | SeriesLabelItems of obj

module CircularDiagram2DItemsControl =
    let diagram v : obj = box (CircularDiagram2DItemsControlProp.Diagram v)
    let axisItems v : obj = box (CircularDiagram2DItemsControlProp.AxisItems v)
    let diagramContent v : obj = box (CircularDiagram2DItemsControlProp.DiagramContent v)
    let seriesLabelItems v : obj = box (CircularDiagram2DItemsControlProp.SeriesLabelItems v)

    let apply (el: DevExpress.Xpf.Charts.CircularDiagram2DItemsControl) (prop: CircularDiagram2DItemsControlProp) =
        match prop with
        | CircularDiagram2DItemsControlProp.Base p -> Diagram2DItemsControl.apply el p
        | CircularDiagram2DItemsControlProp.Diagram v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2DItemsControl.DiagramProperty, box v)
        | CircularDiagram2DItemsControlProp.AxisItems v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2DItemsControl.AxisItemsProperty, box v)
        | CircularDiagram2DItemsControlProp.DiagramContent v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2DItemsControl.DiagramContentProperty, box v)
        | CircularDiagram2DItemsControlProp.SeriesLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2DItemsControl.SeriesLabelItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CircularDiagram2DItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
