...
type PdfAttachmentsViewerSettingsProp =
    | HideAttachmentsViewer of bool
    | AttachmentsViewerState of DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerState
    | AttachmentsViewerInitialState of obj
    | AttachmentsViewerStyle of System.Windows.Style
    | AttachmentsViewerPanelStyle of DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerPanelStyle
    | HideAfterUse of obj

module PdfAttachmentsViewerSettings =
    let hideAttachmentsViewer v : obj = box (PdfAttachmentsViewerSettingsProp.HideAttachmentsViewer v)
    let attachmentsViewerState v : obj = box (PdfAttachmentsViewerSettingsProp.AttachmentsViewerState v)
    let attachmentsViewerInitialState v : obj = box (PdfAttachmentsViewerSettingsProp.AttachmentsViewerInitialState v)
    let attachmentsViewerStyle v : obj = box (PdfAttachmentsViewerSettingsProp.AttachmentsViewerStyle v)
    let attachmentsViewerPanelStyle v : obj = box (PdfAttachmentsViewerSettingsProp.AttachmentsViewerPanelStyle v)
    let hideAfterUse v : obj = box (PdfAttachmentsViewerSettingsProp.HideAfterUse v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings) (prop: PdfAttachmentsViewerSettingsProp) =
        match prop with
        | PdfAttachmentsViewerSettingsProp.HideAttachmentsViewer v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings.HideAttachmentsViewerProperty, box v)
        | PdfAttachmentsViewerSettingsProp.AttachmentsViewerState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings.AttachmentsViewerStateProperty, box v)
        | PdfAttachmentsViewerSettingsProp.AttachmentsViewerInitialState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings.AttachmentsViewerInitialStateProperty, box v)
        | PdfAttachmentsViewerSettingsProp.AttachmentsViewerStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings.AttachmentsViewerStyleProperty, box v)
        | PdfAttachmentsViewerSettingsProp.AttachmentsViewerPanelStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings.AttachmentsViewerPanelStyleProperty, box v)
        | PdfAttachmentsViewerSettingsProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings.HideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
