...
type HeatmapGeometryPresentationProp =
    | Geometry of DevExpress.Charts.Heatmap.Native.HeatmapGeometry
    | SeriesItem of DevExpress.Xpf.Charts.SeriesItem

module HeatmapGeometryPresentation =
    let geometry v : obj = box (HeatmapGeometryPresentationProp.Geometry v)
    let seriesItem v : obj = box (HeatmapGeometryPresentationProp.SeriesItem v)

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapGeometryPresentation) (prop: HeatmapGeometryPresentationProp) =
        match prop with
        | HeatmapGeometryPresentationProp.Geometry v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapGeometryPresentation.GeometryProperty, box v)
        | HeatmapGeometryPresentationProp.SeriesItem v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapGeometryPresentation.SeriesItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapGeometryPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
