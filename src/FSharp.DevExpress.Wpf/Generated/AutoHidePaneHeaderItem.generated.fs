...
type AutoHidePaneHeaderItemProp =
    | Base of psvSelectorItemProp
    | Location of System.Windows.Controls.Dock
    | ItemIsVisible of bool

module AutoHidePaneHeaderItem =
    let location v : obj = box (AutoHidePaneHeaderItemProp.Location v)
    let itemIsVisible v : obj = box (AutoHidePaneHeaderItemProp.ItemIsVisible v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AutoHidePaneHeaderItem) (prop: AutoHidePaneHeaderItemProp) =
        match prop with
        | AutoHidePaneHeaderItemProp.Base p -> psvSelectorItem.apply el p
        | AutoHidePaneHeaderItemProp.Location v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePaneHeaderItem.LocationProperty, box v)
        | AutoHidePaneHeaderItemProp.ItemIsVisible v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePaneHeaderItem.ItemIsVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AutoHidePaneHeaderItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
