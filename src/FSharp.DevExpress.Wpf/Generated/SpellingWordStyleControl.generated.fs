...
type SpellingWordStyleControlProp =
    | Base of SpellingControlBaseProp

module SpellingWordStyleControl =

    let apply (el: DevExpress.Xpf.SpellChecker.Forms.SpellingWordStyleControl) (prop: SpellingWordStyleControlProp) =
        match prop with
        | SpellingWordStyleControlProp.Base p -> SpellingControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.SpellChecker.Forms.SpellingWordStyleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
