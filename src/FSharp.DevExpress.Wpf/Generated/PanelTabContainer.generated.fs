...
type PanelTabContainerProp =
    | Base of LayoutTabControlProp
    | TabHeaderBorderThickness of System.Windows.Thickness
    | IsFloatingRootItem of bool

module PanelTabContainer =
    let tabHeaderBorderThickness v : obj = box (PanelTabContainerProp.TabHeaderBorderThickness v)
    let isFloatingRootItem v : obj = box (PanelTabContainerProp.IsFloatingRootItem v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.PanelTabContainer) (prop: PanelTabContainerProp) =
        match prop with
        | PanelTabContainerProp.Base p -> LayoutTabControl.apply el p
        | PanelTabContainerProp.TabHeaderBorderThickness v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelTabContainer.TabHeaderBorderThicknessProperty, box v)
        | PanelTabContainerProp.IsFloatingRootItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.PanelTabContainer.IsFloatingRootItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.PanelTabContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
