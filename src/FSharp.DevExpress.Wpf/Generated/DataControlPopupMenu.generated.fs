...
type DataControlPopupMenuProp =
    | Base of GridPopupMenuBaseProp

module DataControlPopupMenu =

    let apply (el: DevExpress.Xpf.Grid.DataControlPopupMenu) (prop: DataControlPopupMenuProp) =
        match prop with
        | DataControlPopupMenuProp.Base p -> GridPopupMenuBase.apply el p
