...
type StandardTimelineResourceHeadersContainersPanelProp =
    | MainPanel of DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel

module StandardTimelineResourceHeadersContainersPanel =
    let mainPanel v : obj = box (StandardTimelineResourceHeadersContainersPanelProp.MainPanel v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.StandardTimelineResourceHeadersContainersPanel) (prop: StandardTimelineResourceHeadersContainersPanelProp) =
        match prop with
        | StandardTimelineResourceHeadersContainersPanelProp.MainPanel v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineResourceHeadersContainersPanel.MainPanelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.StandardTimelineResourceHeadersContainersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
