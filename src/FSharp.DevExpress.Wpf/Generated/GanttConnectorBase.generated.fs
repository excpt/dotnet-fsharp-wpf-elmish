...
type GanttConnectorBaseProp =
    ...
    | ArrowSize of System.Windows.Size

module GanttConnectorBase =
    ...
    let apply (el: DevExpress.Xpf.Gantt.GanttConnectorBase) (prop: GanttConnectorBaseProp) =
        match prop with
        | GanttConnectorBaseProp.Stroke v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnectorBase.StrokeProperty, box v)
        | GanttConnectorBaseProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnectorBase.StrokeThicknessProperty, box v)
        | GanttConnectorBaseProp.StrokeDashArray v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnectorBase.StrokeDashArrayProperty, box v)
        | GanttConnectorBaseProp.StrokeDashOffset v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnectorBase.StrokeDashOffsetProperty, box v)
        | GanttConnectorBaseProp.ArrowSize v -> el.SetValue(DevExpress.Xpf.Gantt.GanttConnectorBase.ArrowSizeProperty, box v)
