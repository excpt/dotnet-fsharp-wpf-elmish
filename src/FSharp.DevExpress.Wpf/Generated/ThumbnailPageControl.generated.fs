...
type ThumbnailPageControlProp =
    | Base of PageControlProp

module ThumbnailPageControl =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailPageControl) (prop: ThumbnailPageControlProp) =
        match prop with
        | ThumbnailPageControlProp.Base p -> PageControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailPageControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
