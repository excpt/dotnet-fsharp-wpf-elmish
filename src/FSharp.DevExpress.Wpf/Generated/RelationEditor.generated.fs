...
type RelationEditorProp =
    | Relation of DevExpress.Xpf.DataAccess.Native.Editors.Relation

module RelationEditor =
    let relation v : obj = box (RelationEditorProp.Relation v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.RelationEditor) (prop: RelationEditorProp) =
        match prop with
        | RelationEditorProp.Relation v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.RelationEditor.RelationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.RelationEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
