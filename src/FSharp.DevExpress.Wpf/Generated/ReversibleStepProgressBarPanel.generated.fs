...
type ReversibleStepProgressBarPanelProp =
    | Orientation of System.Windows.Controls.Orientation
    | ReverseOrder of bool
    | Offset of float

module ReversibleStepProgressBarPanel =
    let orientation v : obj = box (ReversibleStepProgressBarPanelProp.Orientation v)
    let reverseOrder v : obj = box (ReversibleStepProgressBarPanelProp.ReverseOrder v)
    let offset v : obj = box (ReversibleStepProgressBarPanelProp.Offset v)

    let apply (el: DevExpress.Xpf.Controls.Internal.ReversibleStepProgressBarPanel) (prop: ReversibleStepProgressBarPanelProp) =
        match prop with
        | ReversibleStepProgressBarPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Controls.Internal.ReversibleStepProgressBarPanel.OrientationProperty, box v)
        | ReversibleStepProgressBarPanelProp.ReverseOrder v -> el.SetValue(DevExpress.Xpf.Controls.Internal.ReversibleStepProgressBarPanel.ReverseOrderProperty, box v)
        | ReversibleStepProgressBarPanelProp.Offset v -> el.SetValue(DevExpress.Xpf.Controls.Internal.ReversibleStepProgressBarPanel.OffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.ReversibleStepProgressBarPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
