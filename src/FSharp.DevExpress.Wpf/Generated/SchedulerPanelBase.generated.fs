...
type SchedulerPanelBaseProp =
    | Base of SchedulerPanelCoreBaseProp
    | AttachedPropertiesCalculator of DevExpress.Xpf.Scheduler.Drawing.ISchedulerItemsControlAttachedPropertiesCalculator
    | ApplyInnerContentPadding of bool

module SchedulerPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerPanelBase) (prop: SchedulerPanelBaseProp) =
        match prop with
        | SchedulerPanelBaseProp.Base p -> SchedulerPanelCoreBase.apply el p
        | SchedulerPanelBaseProp.AttachedPropertiesCalculator v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerPanelBase.AttachedPropertiesCalculatorProperty, box v)
        | SchedulerPanelBaseProp.ApplyInnerContentPadding v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerPanelBase.ApplyInnerContentPaddingProperty, box v)
