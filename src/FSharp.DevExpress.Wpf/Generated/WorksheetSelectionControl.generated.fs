...
type WorksheetSelectionControlProp =
    | Base of WorksheetPaintControlProp
    | SelectionBrush of System.Windows.Media.Brush
    | SelectionActiveCellBrush of System.Windows.Media.Brush
    | SelectionBorderBrush of System.Windows.Media.Brush
    | SelectionHideInnerBorder of bool
    | AutoFilterBackgroundBrush of System.Windows.Media.Brush

module WorksheetSelectionControl =
    let selectionBrush v : obj = box (WorksheetSelectionControlProp.SelectionBrush v)
    let selectionActiveCellBrush v : obj = box (WorksheetSelectionControlProp.SelectionActiveCellBrush v)
    let selectionBorderBrush v : obj = box (WorksheetSelectionControlProp.SelectionBorderBrush v)
    let selectionHideInnerBorder v : obj = box (WorksheetSelectionControlProp.SelectionHideInnerBorder v)
    let autoFilterBackgroundBrush v : obj = box (WorksheetSelectionControlProp.AutoFilterBackgroundBrush v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl) (prop: WorksheetSelectionControlProp) =
        match prop with
        | WorksheetSelectionControlProp.Base p -> WorksheetPaintControl.apply el p
        | WorksheetSelectionControlProp.SelectionBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl.SelectionBrushProperty, box v)
        | WorksheetSelectionControlProp.SelectionActiveCellBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl.SelectionActiveCellBrushProperty, box v)
        | WorksheetSelectionControlProp.SelectionBorderBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl.SelectionBorderBrushProperty, box v)
        | WorksheetSelectionControlProp.SelectionHideInnerBorder v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl.SelectionHideInnerBorderProperty, box v)
        | WorksheetSelectionControlProp.AutoFilterBackgroundBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl.AutoFilterBackgroundBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetSelectionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
