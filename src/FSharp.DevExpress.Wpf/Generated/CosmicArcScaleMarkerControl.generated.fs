...
type CosmicArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CosmicArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicArcScaleMarkerControl) (prop: CosmicArcScaleMarkerControlProp) =
        match prop with
        | CosmicArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
