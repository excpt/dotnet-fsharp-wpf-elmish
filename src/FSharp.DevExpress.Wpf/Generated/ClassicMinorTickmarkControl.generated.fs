...
type ClassicMinorTickmarkControlProp =
    | Base of PresentationControlProp

module ClassicMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicMinorTickmarkControl) (prop: ClassicMinorTickmarkControlProp) =
        match prop with
        | ClassicMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
