...
type MDIPanelProp =
    | Base of ScrollablePanelProp

module MDIPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.MDIPanel) (prop: MDIPanelProp) =
        match prop with
        | MDIPanelProp.Base p -> ScrollablePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.MDIPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
