...
type BaseTabsCustomizationControlProp =
    | LeftPartItems of obj

module BaseTabsCustomizationControl =
    let leftPartItems v : obj = box (BaseTabsCustomizationControlProp.LeftPartItems v)

    let apply (el: DevExpress.Xpf.Ribbon.Customization.BaseTabsCustomizationControl) (prop: BaseTabsCustomizationControlProp) =
        match prop with
        | BaseTabsCustomizationControlProp.LeftPartItems v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.BaseTabsCustomizationControl.LeftPartItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Customization.BaseTabsCustomizationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
