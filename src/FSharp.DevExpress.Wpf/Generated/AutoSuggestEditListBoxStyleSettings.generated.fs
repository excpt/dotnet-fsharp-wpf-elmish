...
type AutoSuggestEditListBoxStyleSettingsProp =
    | Base of AutoSuggestEditStyleSettingsProp

module AutoSuggestEditListBoxStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.AutoSuggestEditListBoxStyleSettings) (prop: AutoSuggestEditListBoxStyleSettingsProp) =
        match prop with
        | AutoSuggestEditListBoxStyleSettingsProp.Base p -> AutoSuggestEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.AutoSuggestEditListBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
