...
type RibbonSelectedPagePopupProp =
    | Base of RibbonPopupBaseProp

module RibbonSelectedPagePopup =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonSelectedPagePopup) (prop: RibbonSelectedPagePopupProp) =
        match prop with
        | RibbonSelectedPagePopupProp.Base p -> RibbonPopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonSelectedPagePopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
