...
type GroupScrollableContentControlProp =
    | Base of ScrollableContentControlProp

module GroupScrollableContentControl =

    let apply (el: DevExpress.Xpf.NavBar.GroupScrollableContentControl) (prop: GroupScrollableContentControlProp) =
        match prop with
        | GroupScrollableContentControlProp.Base p -> ScrollableContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.GroupScrollableContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
