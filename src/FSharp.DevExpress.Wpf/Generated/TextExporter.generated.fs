...
type TextExporterProp =
    | ExportSettings of DevExpress.Xpf.PivotGrid.Printing.IPivotTextExportSettings

module TextExporter =
    let exportSettings v : obj = box (TextExporterProp.ExportSettings v)

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.TextExporter) (prop: TextExporterProp) =
        match prop with
        | TextExporterProp.ExportSettings v -> el.SetValue(DevExpress.Xpf.PivotGrid.Printing.TextExporter.ExportSettingsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.TextExporter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
