...
type AdditionalAreaSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalAreaSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalAreaSeriesGeometryContainer) (prop: AdditionalAreaSeriesGeometryContainerProp) =
        match prop with
        | AdditionalAreaSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalAreaSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
