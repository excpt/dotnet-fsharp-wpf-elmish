...
type ExplorerBarScrollableContentControlProp =
    | Base of ScrollableContentControlProp

module ExplorerBarScrollableContentControl =

    let apply (el: DevExpress.Xpf.NavBar.ExplorerBarScrollableContentControl) (prop: ExplorerBarScrollableContentControlProp) =
        match prop with
        | ExplorerBarScrollableContentControlProp.Base p -> ScrollableContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ExplorerBarScrollableContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
