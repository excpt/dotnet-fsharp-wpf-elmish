...
type ChartControlBaseProp =
    | Palette of DevExpress.Xpf.Charts.Palette
    | CrosshairEnabled of obj
    | AutoLayout of bool
    | PrintOptions of DevExpress.Xpf.Charts.ChartPrintOptions
    | CrosshairSeriesLabelPrintingTemplate of System.Windows.DataTemplate
    | CrosshairSeriesLabelItemTemplate of System.Windows.DataTemplate
    | LegendItemsSource of System.Collections.IEnumerable
    | LegendItemTemplate of System.Windows.DataTemplate
    | LegendItemTemplateSelector of System.Windows.Controls.DataTemplateSelector

module ChartControlBase =
    let palette v : obj = box (ChartControlBaseProp.Palette v)
    let crosshairEnabled v : obj = box (ChartControlBaseProp.CrosshairEnabled v)
    ...
    let apply (el: DevExpress.Xpf.Charts.ChartControlBase) (prop: ChartControlBaseProp) =
        match prop with
        | ChartControlBaseProp.Palette v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.PaletteProperty, box v)
        | ChartControlBaseProp.CrosshairEnabled v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.CrosshairEnabledProperty, box v)
        | ChartControlBaseProp.AutoLayout v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.AutoLayoutProperty, box v)
        | ChartControlBaseProp.PrintOptions v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.PrintOptionsProperty, box v)
        | ChartControlBaseProp.CrosshairSeriesLabelPrintingTemplate v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.CrosshairSeriesLabelPrintingTemplateProperty, box v)
        | ChartControlBaseProp.CrosshairSeriesLabelItemTemplate v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.CrosshairSeriesLabelItemTemplateProperty, box v)
        | ChartControlBaseProp.LegendItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.LegendItemsSourceProperty, box v)
        | ChartControlBaseProp.LegendItemTemplate v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.LegendItemTemplateProperty, box v)
        | ChartControlBaseProp.LegendItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Charts.ChartControlBase.LegendItemTemplateSelectorProperty, box v)
    ...
    let chart (v: DevExpress.Xpf.Charts.ChartControlBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.ChartControlBase.ChartProperty, box v)) :: node.Props }
