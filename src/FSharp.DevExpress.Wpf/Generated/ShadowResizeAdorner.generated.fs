...
type ShadowResizeAdornerProp =
    | Base of PlacementAdornerProp

module ShadowResizeAdorner =

    let apply (el: DevExpress.Xpf.Docking.Platform.ShadowResizeAdorner) (prop: ShadowResizeAdornerProp) =
        match prop with
        | ShadowResizeAdornerProp.Base p -> PlacementAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.ShadowResizeAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
