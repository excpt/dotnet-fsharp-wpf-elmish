...
type DefaultSevenSegmentsControlProp =
    | Base of SymbolPresentationControlProp

module DefaultSevenSegmentsControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultSevenSegmentsControl) (prop: DefaultSevenSegmentsControlProp) =
        match prop with
        | DefaultSevenSegmentsControlProp.Base p -> SymbolPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultSevenSegmentsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
