...
type SelectionPresenterProp =
    | Base of SchedulerCellsBasedPanelBaseProp
    | Resource of DevExpress.XtraScheduler.Resource
    | SelectedCells of DevExpress.Xpf.Scheduler.Drawing.SelectedCellIndexesInterval
    | SelectionTemplate of System.Windows.Controls.ControlTemplate

module SelectionPresenter =
    let resource v : obj = box (SelectionPresenterProp.Resource v)
    let selectedCells v : obj = box (SelectionPresenterProp.SelectedCells v)
    let selectionTemplate v : obj = box (SelectionPresenterProp.SelectionTemplate v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SelectionPresenter) (prop: SelectionPresenterProp) =
        match prop with
        | SelectionPresenterProp.Base p -> SchedulerCellsBasedPanelBase.apply el p
        | SelectionPresenterProp.Resource v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SelectionPresenter.ResourceProperty, box v)
        | SelectionPresenterProp.SelectedCells v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SelectionPresenter.SelectedCellsProperty, box v)
        | SelectionPresenterProp.SelectionTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SelectionPresenter.SelectionTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SelectionPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
