...
type DefaultMatrix5x8ControlProp =
    | Base of SymbolPresentationControlProp

module DefaultMatrix5x8Control =

    let apply (el: DevExpress.Xpf.Gauges.DefaultMatrix5x8Control) (prop: DefaultMatrix5x8ControlProp) =
        match prop with
        | DefaultMatrix5x8ControlProp.Base p -> SymbolPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultMatrix5x8Control>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
