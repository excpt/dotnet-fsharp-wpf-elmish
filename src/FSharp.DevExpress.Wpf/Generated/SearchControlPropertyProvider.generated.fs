...
type SearchControlPropertyProviderProp =
    | DisplayText of string
    | IsNullTextVisible of bool
    | FindCommand of System.Windows.Input.ICommand
    | CloseCommandInternal of System.Windows.Input.ICommand
    | ClearSearchTextCommand of System.Windows.Input.ICommand
    | SearchText of string

module SearchControlPropertyProvider =
    let displayText v : obj = box (SearchControlPropertyProviderProp.DisplayText v)
    let isNullTextVisible v : obj = box (SearchControlPropertyProviderProp.IsNullTextVisible v)
    let findCommand v : obj = box (SearchControlPropertyProviderProp.FindCommand v)
    let closeCommandInternal v : obj = box (SearchControlPropertyProviderProp.CloseCommandInternal v)
    let clearSearchTextCommand v : obj = box (SearchControlPropertyProviderProp.ClearSearchTextCommand v)
    let searchText v : obj = box (SearchControlPropertyProviderProp.SearchText v)

    let apply (el: DevExpress.Xpf.Editors.SearchControlPropertyProvider) (prop: SearchControlPropertyProviderProp) =
        match prop with
        | SearchControlPropertyProviderProp.DisplayText v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlPropertyProvider.DisplayTextProperty, box v)
        | SearchControlPropertyProviderProp.IsNullTextVisible v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlPropertyProvider.IsNullTextVisibleProperty, box v)
        | SearchControlPropertyProviderProp.FindCommand v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlPropertyProvider.FindCommandProperty, box v)
        | SearchControlPropertyProviderProp.CloseCommandInternal v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlPropertyProvider.CloseCommandInternalProperty, box v)
        | SearchControlPropertyProviderProp.ClearSearchTextCommand v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlPropertyProvider.ClearSearchTextCommandProperty, box v)
        | SearchControlPropertyProviderProp.SearchText v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlPropertyProvider.SearchTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SearchControlPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
