...
type CandleStickSeries2DProp =
    | Base of FinancialSeries2DProp
    | CandleWidth of float
    | Model of DevExpress.Xpf.Charts.CandleStick2DModel

module CandleStickSeries2D =
    let candleWidth v : obj = box (CandleStickSeries2DProp.CandleWidth v)
    let model v : obj = box (CandleStickSeries2DProp.Model v)

    let apply (el: DevExpress.Xpf.Charts.CandleStickSeries2D) (prop: CandleStickSeries2DProp) =
        match prop with
        | CandleStickSeries2DProp.Base p -> FinancialSeries2D.apply el p
        | CandleStickSeries2DProp.CandleWidth v -> el.SetValue(DevExpress.Xpf.Charts.CandleStickSeries2D.CandleWidthProperty, box v)
        | CandleStickSeries2DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.CandleStickSeries2D.ModelProperty, box v)
    ...
    let fillMode (v: DevExpress.Xpf.Charts.CandleStickFillMode) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.CandleStickSeries2D.FillModeProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.CandleStickSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
