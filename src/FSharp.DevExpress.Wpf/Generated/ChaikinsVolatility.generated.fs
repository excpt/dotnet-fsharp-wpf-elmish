...
type ChaikinsVolatilityProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | PointsCount of int

module ChaikinsVolatility =
    let pointsCount v : obj = box (ChaikinsVolatilityProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.ChaikinsVolatility) (prop: ChaikinsVolatilityProp) =
        match prop with
        | ChaikinsVolatilityProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | ChaikinsVolatilityProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.ChaikinsVolatility.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChaikinsVolatility>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
