...
type ColumnsLayoutControlProp =
    | View of DevExpress.Xpf.Grid.DataViewBase

module ColumnsLayoutControl =
    let view v : obj = box (ColumnsLayoutControlProp.View v)

    let apply (el: DevExpress.Xpf.Grid.ColumnsLayoutControl) (prop: ColumnsLayoutControlProp) =
        match prop with
        | ColumnsLayoutControlProp.View v -> el.SetValue(DevExpress.Xpf.Grid.ColumnsLayoutControl.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.ColumnsLayoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
