...
type GanttSummaryTaskBaselineControlProp =
    | Base of GanttTaskBaselineControlBaseProp

module GanttSummaryTaskBaselineControl =

    let apply (el: DevExpress.Xpf.Gantt.GanttSummaryTaskBaselineControl) (prop: GanttSummaryTaskBaselineControlProp) =
        match prop with
        | GanttSummaryTaskBaselineControlProp.Base p -> GanttTaskBaselineControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttSummaryTaskBaselineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
