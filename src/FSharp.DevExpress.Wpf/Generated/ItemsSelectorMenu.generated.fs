...
type ItemsSelectorMenuProp =
    | Base of BaseLayoutElementMenuProp

module ItemsSelectorMenu =

    let apply (el: DevExpress.Xpf.Docking.ItemsSelectorMenu) (prop: ItemsSelectorMenuProp) =
        match prop with
        | ItemsSelectorMenuProp.Base p -> BaseLayoutElementMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.ItemsSelectorMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
