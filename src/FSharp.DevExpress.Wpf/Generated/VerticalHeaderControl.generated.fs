...
type VerticalHeaderControlProp =
    | Base of HeaderControlProp

module VerticalHeaderControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VerticalHeaderControl) (prop: VerticalHeaderControlProp) =
        match prop with
        | VerticalHeaderControlProp.Base p -> HeaderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VerticalHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
