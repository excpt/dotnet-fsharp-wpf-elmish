...
type FutureArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureArcScaleBackgroundLayerControl) (prop: FutureArcScaleBackgroundLayerControlProp) =
        match prop with
        | FutureArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
