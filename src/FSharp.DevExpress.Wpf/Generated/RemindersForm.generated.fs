...
type RemindersFormProp =
    | Base of RemindersFormBaseProp
    | CanOpenEditAppointmentForm of bool
    | AppointmentStartDisplayText of string
    | SnoozeValue of System.TimeSpan
    | SnoozeList of obj
    | Title of string

module RemindersForm =
    let canOpenEditAppointmentForm v : obj = box (RemindersFormProp.CanOpenEditAppointmentForm v)
    let appointmentStartDisplayText v : obj = box (RemindersFormProp.AppointmentStartDisplayText v)
    let snoozeValue v : obj = box (RemindersFormProp.SnoozeValue v)
    let snoozeList v : obj = box (RemindersFormProp.SnoozeList v)
    let title v : obj = box (RemindersFormProp.Title v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RemindersForm) (prop: RemindersFormProp) =
        match prop with
        | RemindersFormProp.Base p -> RemindersFormBase.apply el p
        | RemindersFormProp.CanOpenEditAppointmentForm v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RemindersForm.CanOpenEditAppointmentFormProperty, box v)
        | RemindersFormProp.AppointmentStartDisplayText v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RemindersForm.AppointmentStartDisplayTextProperty, box v)
        | RemindersFormProp.SnoozeValue v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RemindersForm.SnoozeValueProperty, box v)
        | RemindersFormProp.SnoozeList v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RemindersForm.SnoozeListProperty, box v)
        | RemindersFormProp.Title v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RemindersForm.TitleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RemindersForm>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
