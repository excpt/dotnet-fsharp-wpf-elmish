...
type HamburgerMenuBottomBarCheckBoxProp =
...
module HamburgerMenuBottomBarCheckBox =
    let placement v : obj = box (HamburgerMenuBottomBarCheckBoxProp.Placement v)
    let compactModeVisibility v : obj = box (HamburgerMenuBottomBarCheckBoxProp.CompactModeVisibility v)
    let glyph v : obj = box (HamburgerMenuBottomBarCheckBoxProp.Glyph v)
    let glyphTemplate v : obj = box (HamburgerMenuBottomBarCheckBoxProp.GlyphTemplate v)
    let glyphWidth v : obj = box (HamburgerMenuBottomBarCheckBoxProp.GlyphWidth v)
    let glyphHeight v : obj = box (HamburgerMenuBottomBarCheckBoxProp.GlyphHeight v)
    let glyphStretch v : obj = box (HamburgerMenuBottomBarCheckBoxProp.GlyphStretch v)
    let allowGlyphTheming v : obj = box (HamburgerMenuBottomBarCheckBoxProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (HamburgerMenuBottomBarCheckBoxProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox) (prop: HamburgerMenuBottomBarCheckBoxProp) =
        match prop with
        | HamburgerMenuBottomBarCheckBoxProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.PlacementProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.CompactModeVisibility v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.CompactModeVisibilityProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.GlyphProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.GlyphTemplateProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.GlyphWidthProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.GlyphHeightProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.GlyphStretchProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.AllowGlyphThemingProperty, box v)
        | HamburgerMenuBottomBarCheckBoxProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarCheckBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
