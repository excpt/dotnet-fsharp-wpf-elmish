...
type SeriesPointItemPresentationProp =
    | PointItem of DevExpress.Xpf.Charts.SeriesPointItem
    | Model of DevExpress.Xpf.Charts.PointModel

module SeriesPointItemPresentation =
    let pointItem v : obj = box (SeriesPointItemPresentationProp.PointItem v)
    let model v : obj = box (SeriesPointItemPresentationProp.Model v)

    let apply (el: DevExpress.Xpf.Charts.SeriesPointItemPresentation) (prop: SeriesPointItemPresentationProp) =
        match prop with
        | SeriesPointItemPresentationProp.PointItem v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointItemPresentation.PointItemProperty, box v)
        | SeriesPointItemPresentationProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointItemPresentation.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesPointItemPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
