...
type GroupContentControlProp =
    | Base of BaseGroupContentControlProp

module GroupContentControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.GroupContentControl) (prop: GroupContentControlProp) =
        match prop with
        | GroupContentControlProp.Base p -> BaseGroupContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.GroupContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
