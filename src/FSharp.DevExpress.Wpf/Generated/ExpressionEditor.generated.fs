...
type ExpressionEditorProp =
    | EditValue of string
    | EditorLogicFunc of obj
    | SetExpressionEditorCoreControlsAction of obj

module ExpressionEditor =
    let editValue v : obj = box (ExpressionEditorProp.EditValue v)
    let editorLogicFunc v : obj = box (ExpressionEditorProp.EditorLogicFunc v)
    let setExpressionEditorCoreControlsAction v : obj = box (ExpressionEditorProp.SetExpressionEditorCoreControlsAction v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ExpressionEditor) (prop: ExpressionEditorProp) =
        match prop with
        | ExpressionEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ExpressionEditor.EditValueProperty, box v)
        | ExpressionEditorProp.EditorLogicFunc v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ExpressionEditor.EditorLogicFuncProperty, box v)
        | ExpressionEditorProp.SetExpressionEditorCoreControlsAction v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ExpressionEditor.SetExpressionEditorCoreControlsActionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ExpressionEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
