...
type ItemsSourcePanelProp =
    | ItemsSource of obj

module ItemsSourcePanel =
    let itemsSource v : obj = box (ItemsSourcePanelProp.ItemsSource v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.ItemsSourcePanel) (prop: ItemsSourcePanelProp) =
        match prop with
        | ItemsSourcePanelProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ItemsSourcePanel.ItemsSourceProperty, box v)
