...
type FlatDarkLinearScaleLineControlProp =
    | Base of PresentationControlProp

module FlatDarkLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkLinearScaleLineControl) (prop: FlatDarkLinearScaleLineControlProp) =
        match prop with
        | FlatDarkLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
