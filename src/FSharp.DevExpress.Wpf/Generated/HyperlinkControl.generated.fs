...
type HyperlinkControlProp =
    | SelectedLink of DevExpress.Xpf.Spreadsheet.Forms.HyperlinkType

module HyperlinkControl =
    let selectedLink v : obj = box (HyperlinkControlProp.SelectedLink v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.HyperlinkControl) (prop: HyperlinkControlProp) =
        match prop with
        | HyperlinkControlProp.SelectedLink v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Forms.HyperlinkControl.SelectedLinkProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.HyperlinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
