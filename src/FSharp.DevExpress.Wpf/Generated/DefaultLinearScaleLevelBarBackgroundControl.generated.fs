...
type DefaultLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module DefaultLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleLevelBarBackgroundControl) (prop: DefaultLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | DefaultLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
