...
type TabHeaderHintProp =
    | Base of BaseTabHintProp

module TabHeaderHint =

    let apply (el: DevExpress.Xpf.Docking.Platform.TabHeaderHint) (prop: TabHeaderHintProp) =
        match prop with
        | TabHeaderHintProp.Base p -> BaseTabHint.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.TabHeaderHint>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
