...
type ArrowDefaultStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowDefaultStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowDefaultStatePresentationControl) (prop: ArrowDefaultStatePresentationControlProp) =
        match prop with
        | ArrowDefaultStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowDefaultStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
