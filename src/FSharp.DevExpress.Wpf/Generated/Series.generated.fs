...
type SeriesProp =
    | Base of ChartElementProp
    | DataFiltersConjunctionMode of DevExpress.Xpf.Charts.ConjunctionTypes
    | ArgumentDataMember of string
    | ArgumentScaleType of DevExpress.Xpf.Charts.ScaleType
    | DataSource of obj
    | DisplayName of string
    | Label of DevExpress.Xpf.Charts.SeriesLabel
    | PointOptions of DevExpress.Xpf.Charts.PointOptions
    | LegendPointOptions of DevExpress.Xpf.Charts.PointOptions
    | LegendTextPattern of string
    | ShowInLegend of bool
    | ValueDataMember of string
    | ColorDataMember of string
    | ValueScaleType of DevExpress.Xpf.Charts.ScaleType
    | Visible of bool
    | CheckedInLegend of bool
    | CheckableInLegend of bool
    | AnimationAutoStartMode of DevExpress.Xpf.Charts.AnimationAutoStartMode
    | LegendMarkerTemplate of System.Windows.DataTemplate
    | ToolTipEnabled of obj
    | ToolTipHint of obj
    | ToolTipSeriesPattern of string
    | ToolTipSeriesTemplate of System.Windows.DataTemplate
    | ToolTipPointPattern of string
    | ToolTipPointTemplate of System.Windows.DataTemplate
    | ToolTipHintDataMember of string
    | LabelsVisibility of bool
    | Colorizer of DevExpress.Xpf.Charts.ChartColorizerBase
    | Legend of obj
    | FilterCriteria of DevExpress.Data.Filtering.CriteriaOperator
    | FilterString of string
    | TopNOptions of DevExpress.Xpf.Charts.TopNOptionsBase
    | DataSourceSorted of bool
    | Summary of DevExpress.Xpf.Charts.Summary
...
module Series =
    ...
    let toolTipEnabled v : obj = box (SeriesProp.ToolTipEnabled v)
    ...
    let apply (el: DevExpress.Xpf.Charts.Series) (prop: SeriesProp) =
        match prop with
        | SeriesProp.Base p -> ChartElement.apply el p
        | SeriesProp.DataFiltersConjunctionMode v -> el.SetValue(DevExpress.Xpf.Charts.Series.DataFiltersConjunctionModeProperty, box v)
        | SeriesProp.ArgumentDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Series.ArgumentDataMemberProperty, box v)
        | SeriesProp.ArgumentScaleType v -> el.SetValue(DevExpress.Xpf.Charts.Series.ArgumentScaleTypeProperty, box v)
        | SeriesProp.DataSource v -> el.SetValue(DevExpress.Xpf.Charts.Series.DataSourceProperty, box v)
        | SeriesProp.DisplayName v -> el.SetValue(DevExpress.Xpf.Charts.Series.DisplayNameProperty, box v)
        | SeriesProp.Label v -> el.SetValue(DevExpress.Xpf.Charts.Series.LabelProperty, box v)
        | SeriesProp.PointOptions v -> el.SetValue(DevExpress.Xpf.Charts.Series.PointOptionsProperty, box v)
        | SeriesProp.LegendPointOptions v -> el.SetValue(DevExpress.Xpf.Charts.Series.LegendPointOptionsProperty, box v)
        | SeriesProp.LegendTextPattern v -> el.SetValue(DevExpress.Xpf.Charts.Series.LegendTextPatternProperty, box v)
        | SeriesProp.ShowInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Series.ShowInLegendProperty, box v)
        | SeriesProp.ValueDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Series.ValueDataMemberProperty, box v)
        | SeriesProp.ColorDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Series.ColorDataMemberProperty, box v)
        | SeriesProp.ValueScaleType v -> el.SetValue(DevExpress.Xpf.Charts.Series.ValueScaleTypeProperty, box v)
        | SeriesProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.Series.VisibleProperty, box v)
        | SeriesProp.CheckedInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Series.CheckedInLegendProperty, box v)
        | SeriesProp.CheckableInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Series.CheckableInLegendProperty, box v)
        | SeriesProp.AnimationAutoStartMode v -> el.SetValue(DevExpress.Xpf.Charts.Series.AnimationAutoStartModeProperty, box v)
        | SeriesProp.LegendMarkerTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Series.LegendMarkerTemplateProperty, box v)
        | SeriesProp.ToolTipEnabled v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipEnabledProperty, box v)
        | SeriesProp.ToolTipHint v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipHintProperty, box v)
        | SeriesProp.ToolTipSeriesPattern v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipSeriesPatternProperty, box v)
        | SeriesProp.ToolTipSeriesTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipSeriesTemplateProperty, box v)
        | SeriesProp.ToolTipPointPattern v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipPointPatternProperty, box v)
        | SeriesProp.ToolTipPointTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipPointTemplateProperty, box v)
        | SeriesProp.ToolTipHintDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Series.ToolTipHintDataMemberProperty, box v)
        | SeriesProp.LabelsVisibility v -> el.SetValue(DevExpress.Xpf.Charts.Series.LabelsVisibilityProperty, box v)
        | SeriesProp.Colorizer v -> el.SetValue(DevExpress.Xpf.Charts.Series.ColorizerProperty, box v)
        | SeriesProp.Legend v -> el.SetValue(DevExpress.Xpf.Charts.Series.LegendProperty, box v)
        | SeriesProp.FilterCriteria v -> el.SetValue(DevExpress.Xpf.Charts.Series.FilterCriteriaProperty, box v)
        | SeriesProp.FilterString v -> el.SetValue(DevExpress.Xpf.Charts.Series.FilterStringProperty, box v)
        | SeriesProp.TopNOptions v -> el.SetValue(DevExpress.Xpf.Charts.Series.TopNOptionsProperty, box v)
        | SeriesProp.DataSourceSorted v -> el.SetValue(DevExpress.Xpf.Charts.Series.DataSourceSortedProperty, box v)
        | SeriesProp.Summary v -> el.SetValue(DevExpress.Xpf.Charts.Series.SummaryProperty, box v)
