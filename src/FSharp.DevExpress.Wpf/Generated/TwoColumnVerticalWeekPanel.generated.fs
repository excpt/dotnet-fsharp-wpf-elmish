...
type TwoColumnVerticalWeekPanelProp =
    | Base of WeekPanelProp

module TwoColumnVerticalWeekPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.TwoColumnVerticalWeekPanel) (prop: TwoColumnVerticalWeekPanelProp) =
        match prop with
        | TwoColumnVerticalWeekPanelProp.Base p -> WeekPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.TwoColumnVerticalWeekPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
