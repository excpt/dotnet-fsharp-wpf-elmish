...
type DayAppointmentDragControlProp =
    | Base of DayAppointmentControlProp

module DayAppointmentDragControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DayAppointmentDragControl) (prop: DayAppointmentDragControlProp) =
        match prop with
        | DayAppointmentDragControlProp.Base p -> DayAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DayAppointmentDragControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
