...
type InvertedTriangleMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module InvertedTriangleMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.InvertedTriangleMarkerModelControl) (prop: InvertedTriangleMarkerModelControlProp) =
        match prop with
        | InvertedTriangleMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p

    let shapeStyle v : obj = box (MarkerBubbleControlBaseProp.ShapeStyle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.InvertedTriangleMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
