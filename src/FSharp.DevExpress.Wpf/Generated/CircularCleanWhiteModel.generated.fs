...
type CircularCleanWhiteModelProp =
    | Base of CircularGaugeModelProp

module CircularCleanWhiteModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCleanWhiteModel) (prop: CircularCleanWhiteModelProp) =
        match prop with
        | CircularCleanWhiteModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCleanWhiteModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
