...
type CarouselNavigatorProp =
    | Carousel of DevExpress.Xpf.Carousel.CarouselPanel

module CarouselNavigator =
    let carousel v : obj = box (CarouselNavigatorProp.Carousel v)

    let apply (el: DevExpress.Xpf.Carousel.CarouselNavigator) (prop: CarouselNavigatorProp) =
        match prop with
        | CarouselNavigatorProp.Carousel v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselNavigator.CarouselProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Carousel.CarouselNavigator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
