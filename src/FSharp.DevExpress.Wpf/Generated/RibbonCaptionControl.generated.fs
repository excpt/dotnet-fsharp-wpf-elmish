...
type RibbonCaptionControlProp =
    | IsPressed of bool
    | IsSelected of bool
    | MaxDesiredSize of System.Windows.Size

module RibbonCaptionControl =
    ...
    let apply (el: DevExpress.Xpf.Ribbon.RibbonCaptionControl) (prop: RibbonCaptionControlProp) =
        match prop with
        | RibbonCaptionControlProp.IsPressed v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCaptionControl.IsPressedProperty, box v)
        | RibbonCaptionControlProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCaptionControl.IsSelectedProperty, box v)
        | RibbonCaptionControlProp.MaxDesiredSize v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCaptionControl.MaxDesiredSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonCaptionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
