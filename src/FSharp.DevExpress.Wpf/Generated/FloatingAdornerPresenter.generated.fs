...
type FloatingAdornerPresenterProp =
    | Base of FloatPanePresenterProp
    | SizeToContent of System.Windows.SizeToContent

module FloatingAdornerPresenter =
    let sizeToContent v : obj = box (FloatingAdornerPresenterProp.SizeToContent v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatingAdornerPresenter) (prop: FloatingAdornerPresenterProp) =
        match prop with
        | FloatingAdornerPresenterProp.Base p -> FloatPanePresenter.apply el p
        | FloatingAdornerPresenterProp.SizeToContent v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatingAdornerPresenter.SizeToContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FloatingAdornerPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
