...
type SideBarHeaderProp =
    | Base of NavBarGroupHeaderProp

module SideBarHeader =

    let apply (el: DevExpress.Xpf.NavBar.SideBarHeader) (prop: SideBarHeaderProp) =
        match prop with
        | SideBarHeaderProp.Base p -> NavBarGroupHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.SideBarHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
