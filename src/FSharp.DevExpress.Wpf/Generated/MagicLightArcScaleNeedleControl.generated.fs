...
type MagicLightArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module MagicLightArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightArcScaleNeedleControl) (prop: MagicLightArcScaleNeedleControlProp) =
        match prop with
        | MagicLightArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
