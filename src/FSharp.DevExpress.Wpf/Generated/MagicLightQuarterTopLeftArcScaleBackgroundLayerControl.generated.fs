...
type MagicLightQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightQuarterTopLeftArcScaleBackgroundLayerControl) (prop: MagicLightQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | MagicLightQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
