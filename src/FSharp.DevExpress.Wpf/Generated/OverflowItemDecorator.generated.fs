...
type OverflowItemDecoratorProp =
    | Base of CollapsedItemDecoratorProp

module OverflowItemDecorator =

    let apply (el: DevExpress.Xpf.Accordion.OverflowItemDecorator) (prop: OverflowItemDecoratorProp) =
        match prop with
        | OverflowItemDecoratorProp.Base p -> CollapsedItemDecorator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.OverflowItemDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
