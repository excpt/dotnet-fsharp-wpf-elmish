...
open System
open System.Windows
open DevExpress.Xpf.ExpressionEditor
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ExpressionEditorControlProp =
    | Context of DevExpress.Data.Controls.ExpressionEditor.ExpressionEditorContext
    | EditValue of string
    | DocumentationControlTemplate of System.Windows.DataTemplate
    | MessageBoxServiceTemplate of System.Windows.DataTemplate

module ExpressionEditorControl =
    let context v : obj = box (ExpressionEditorControlProp.Context v)
    let editValue v : obj = box (ExpressionEditorControlProp.EditValue v)
    let documentationControlTemplate v : obj = box (ExpressionEditorControlProp.DocumentationControlTemplate v)
    let messageBoxServiceTemplate v : obj = box (ExpressionEditorControlProp.MessageBoxServiceTemplate v)

    let apply (el: DevExpress.Xpf.ExpressionEditor.ExpressionEditorControl) (prop: ExpressionEditorControlProp) =
        match prop with
        | ExpressionEditorControlProp.Context v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.ExpressionEditorControl.ContextProperty, box v)
        | ExpressionEditorControlProp.EditValue v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.ExpressionEditorControl.EditValueProperty, box v)
        | ExpressionEditorControlProp.DocumentationControlTemplate v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.ExpressionEditorControl.DocumentationControlTemplateProperty, box v)
        | ExpressionEditorControlProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.ExpressionEditorControl.MessageBoxServiceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.ExpressionEditor.ExpressionEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
