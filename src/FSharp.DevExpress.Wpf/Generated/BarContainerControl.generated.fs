...
type BarContainerControlProp =
    | Base of BarItemsControlProp
    | BarVertIndent of float
    | BarHorzIndent of float
    | Orientation of System.Windows.Controls.Orientation
    | DrawBorder of bool
    | ContainerType of DevExpress.Xpf.Bars.BarContainerType
    | BarItemDisplayMode of DevExpress.Xpf.Bars.BarItemDisplayMode

module BarContainerControl =
    let barVertIndent v : obj = box (BarContainerControlProp.BarVertIndent v)
    let barHorzIndent v : obj = box (BarContainerControlProp.BarHorzIndent v)
    let orientation v : obj = box (BarContainerControlProp.Orientation v)
    let drawBorder v : obj = box (BarContainerControlProp.DrawBorder v)
    let containerType v : obj = box (BarContainerControlProp.ContainerType v)
    let barItemDisplayMode v : obj = box (BarContainerControlProp.BarItemDisplayMode v)

    let apply (el: DevExpress.Xpf.Bars.BarContainerControl) (prop: BarContainerControlProp) =
        match prop with
        | BarContainerControlProp.Base p -> BarItemsControl.apply el p
        | BarContainerControlProp.BarVertIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarContainerControl.BarVertIndentProperty, box v)
        | BarContainerControlProp.BarHorzIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarContainerControl.BarHorzIndentProperty, box v)
        | BarContainerControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Bars.BarContainerControl.OrientationProperty, box v)
        | BarContainerControlProp.DrawBorder v -> el.SetValue(DevExpress.Xpf.Bars.BarContainerControl.DrawBorderProperty, box v)
        | BarContainerControlProp.ContainerType v -> el.SetValue(DevExpress.Xpf.Bars.BarContainerControl.ContainerTypeProperty, box v)
        | BarContainerControlProp.BarItemDisplayMode v -> el.SetValue(DevExpress.Xpf.Bars.BarContainerControl.BarItemDisplayModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarContainerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
