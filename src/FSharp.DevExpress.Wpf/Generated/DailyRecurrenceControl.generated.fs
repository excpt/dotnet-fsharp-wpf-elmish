...
type DailyRecurrenceControlProp =
    | Base of RecurrenceControlBaseProp
    | RecurrenceInfo of DevExpress.XtraScheduler.RecurrenceInfo

module DailyRecurrenceControl =
    let recurrenceInfo v : obj = box (DailyRecurrenceControlProp.RecurrenceInfo v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.DailyRecurrenceControl) (prop: DailyRecurrenceControlProp) =
        match prop with
        | DailyRecurrenceControlProp.Base p -> RecurrenceControlBase.apply el p
        | DailyRecurrenceControlProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.DailyRecurrenceControl.RecurrenceInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.DailyRecurrenceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
