...
type EditItemContentPresenterProp =
    | VerticalContentAlignment of System.Windows.VerticalAlignment

module EditItemContentPresenter =
    let verticalContentAlignment v : obj = box (EditItemContentPresenterProp.VerticalContentAlignment v)

    let apply (el: DevExpress.Xpf.Editors.Internal.EditItemContentPresenter) (prop: EditItemContentPresenterProp) =
        match prop with
        | EditItemContentPresenterProp.VerticalContentAlignment v -> el.SetValue(DevExpress.Xpf.Editors.Internal.EditItemContentPresenter.VerticalContentAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.EditItemContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
