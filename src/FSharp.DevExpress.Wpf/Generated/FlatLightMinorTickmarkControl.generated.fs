...
type FlatLightMinorTickmarkControlProp =
    | Base of PresentationControlProp

module FlatLightMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightMinorTickmarkControl) (prop: FlatLightMinorTickmarkControlProp) =
        match prop with
        | FlatLightMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
