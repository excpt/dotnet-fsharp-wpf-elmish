...
type CircularFlatDarkFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatDarkFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatDarkFullModel) (prop: CircularFlatDarkFullModelProp) =
        match prop with
        | CircularFlatDarkFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatDarkFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
