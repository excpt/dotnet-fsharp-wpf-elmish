...
type QueryBuilderColumnDiagramItemBaseProp =
    | Base of DiagramContentItemProp

module QueryBuilderColumnDiagramItemBase =

    let apply (el: DevExpress.Xpf.DataAccess.Native.QueryBuilder.QueryBuilderColumnDiagramItemBase) (prop: QueryBuilderColumnDiagramItemBaseProp) =
        match prop with
        | QueryBuilderColumnDiagramItemBaseProp.Base p -> DiagramContentItem.apply el p
