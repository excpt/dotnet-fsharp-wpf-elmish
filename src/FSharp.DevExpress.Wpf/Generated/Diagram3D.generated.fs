...
type Diagram3DProp =
    ...
    | Lighting of DevExpress.Xpf.Charts.DiagramLightingCollection
    | RuntimeRotation of bool
    | RuntimeScrolling of bool
    | RuntimeZooming of bool
    | NavigationOptions of DevExpress.Xpf.Charts.NavigationOptions3D
...
module Diagram3D =
    ...
    let apply (el: DevExpress.Xpf.Charts.Diagram3D) (prop: Diagram3DProp) =
        match prop with
        | Diagram3DProp.Base p -> Diagram.apply el p
        | Diagram3DProp.ContentTransform v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.ContentTransformProperty, box v)
        | Diagram3DProp.PerspectiveAngle v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.PerspectiveAngleProperty, box v)
        | Diagram3DProp.ZoomPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.ZoomPercentProperty, box v)
        | Diagram3DProp.HorizontalScrollPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.HorizontalScrollPercentProperty, box v)
        | Diagram3DProp.VerticalScrollPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.VerticalScrollPercentProperty, box v)
        | Diagram3DProp.Lighting v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.LightingProperty, box v)
        | Diagram3DProp.RuntimeRotation v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.RuntimeRotationProperty, box v)
        | Diagram3DProp.RuntimeScrolling v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.RuntimeScrollingProperty, box v)
        | Diagram3DProp.RuntimeZooming v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.RuntimeZoomingProperty, box v)
        | Diagram3DProp.NavigationOptions v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3D.NavigationOptionsProperty, box v)
