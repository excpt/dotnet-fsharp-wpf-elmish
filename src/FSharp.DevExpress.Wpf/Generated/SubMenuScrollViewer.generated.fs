...
type SubMenuScrollViewerProp =
    | VerticalOffset of float
    | ViewportHeight of float
    | ScrollAreaHeight of float
    | ScrollAreaWidth of float
    | ViewportWidth of float
    | HorizontalOffset of float

module SubMenuScrollViewer =
    let verticalOffset v : obj = box (SubMenuScrollViewerProp.VerticalOffset v)
    let viewportHeight v : obj = box (SubMenuScrollViewerProp.ViewportHeight v)
    let scrollAreaHeight v : obj = box (SubMenuScrollViewerProp.ScrollAreaHeight v)
    let scrollAreaWidth v : obj = box (SubMenuScrollViewerProp.ScrollAreaWidth v)
    let viewportWidth v : obj = box (SubMenuScrollViewerProp.ViewportWidth v)
    let horizontalOffset v : obj = box (SubMenuScrollViewerProp.HorizontalOffset v)

    let apply (el: DevExpress.Xpf.Bars.SubMenuScrollViewer) (prop: SubMenuScrollViewerProp) =
        match prop with
        | SubMenuScrollViewerProp.VerticalOffset v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuScrollViewer.VerticalOffsetProperty, box v)
        | SubMenuScrollViewerProp.ViewportHeight v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuScrollViewer.ViewportHeightProperty, box v)
        | SubMenuScrollViewerProp.ScrollAreaHeight v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuScrollViewer.ScrollAreaHeightProperty, box v)
        | SubMenuScrollViewerProp.ScrollAreaWidth v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuScrollViewer.ScrollAreaWidthProperty, box v)
        | SubMenuScrollViewerProp.ViewportWidth v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuScrollViewer.ViewportWidthProperty, box v)
        | SubMenuScrollViewerProp.HorizontalOffset v -> el.SetValue(DevExpress.Xpf.Bars.SubMenuScrollViewer.HorizontalOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.SubMenuScrollViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
