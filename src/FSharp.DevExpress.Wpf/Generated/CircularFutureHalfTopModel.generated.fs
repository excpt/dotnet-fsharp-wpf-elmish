...
type CircularFutureHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFutureHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFutureHalfTopModel) (prop: CircularFutureHalfTopModelProp) =
        match prop with
        | CircularFutureHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFutureHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
