...
type DXTabbedWindowProp =
    | Base of DXWindowProp
    | TabbedWindowMode of DevExpress.Xpf.Core.TabbedWindowMode
    | HeaderIndentInNormalState of float
    | HeaderIndentInMaximizedState of float
    | CaptionActualWidth of obj
    | ButtonContainerActualWidth of obj

module DXTabbedWindow =
    let tabbedWindowMode v : obj = box (DXTabbedWindowProp.TabbedWindowMode v)
    let headerIndentInNormalState v : obj = box (DXTabbedWindowProp.HeaderIndentInNormalState v)
    let headerIndentInMaximizedState v : obj = box (DXTabbedWindowProp.HeaderIndentInMaximizedState v)
    let captionActualWidth v : obj = box (DXTabbedWindowProp.CaptionActualWidth v)
    let buttonContainerActualWidth v : obj = box (DXTabbedWindowProp.ButtonContainerActualWidth v)

    let apply (el: DevExpress.Xpf.Core.DXTabbedWindow) (prop: DXTabbedWindowProp) =
        match prop with
        | DXTabbedWindowProp.Base p -> DXWindow.apply el p
        | DXTabbedWindowProp.TabbedWindowMode v -> el.SetValue(DevExpress.Xpf.Core.DXTabbedWindow.TabbedWindowModeProperty, box v)
        | DXTabbedWindowProp.HeaderIndentInNormalState v -> el.SetValue(DevExpress.Xpf.Core.DXTabbedWindow.HeaderIndentInNormalStateProperty, box v)
        | DXTabbedWindowProp.HeaderIndentInMaximizedState v -> el.SetValue(DevExpress.Xpf.Core.DXTabbedWindow.HeaderIndentInMaximizedStateProperty, box v)
        | DXTabbedWindowProp.CaptionActualWidth v -> el.SetValue(DevExpress.Xpf.Core.DXTabbedWindow.CaptionActualWidthProperty, box v)
        | DXTabbedWindowProp.ButtonContainerActualWidth v -> el.SetValue(DevExpress.Xpf.Core.DXTabbedWindow.ButtonContainerActualWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DXTabbedWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
