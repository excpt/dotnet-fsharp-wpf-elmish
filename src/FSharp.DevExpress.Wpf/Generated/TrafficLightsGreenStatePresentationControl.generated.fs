...
type TrafficLightsGreenStatePresentationControlProp =
    | Base of PresentationControlProp

module TrafficLightsGreenStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.TrafficLightsGreenStatePresentationControl) (prop: TrafficLightsGreenStatePresentationControlProp) =
        match prop with
        | TrafficLightsGreenStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.TrafficLightsGreenStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
