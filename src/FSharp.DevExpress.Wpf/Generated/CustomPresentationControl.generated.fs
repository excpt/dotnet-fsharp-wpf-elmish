...
type CustomPresentationControlProp =
    | Base of PresentationControlProp

module CustomPresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.CustomPresentationControl) (prop: CustomPresentationControlProp) =
        match prop with
        | CustomPresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CustomPresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
