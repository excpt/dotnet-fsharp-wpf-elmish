...
type AnnotationResizeThumbProp =
    | Base of AnnotationThumbProp
    | AnnotationAngle of float

module AnnotationResizeThumb =
    let annotationAngle v : obj = box (AnnotationResizeThumbProp.AnnotationAngle v)

    let apply (el: DevExpress.Xpf.Charts.AnnotationResizeThumb) (prop: AnnotationResizeThumbProp) =
        match prop with
        | AnnotationResizeThumbProp.Base p -> AnnotationThumb.apply el p
        | AnnotationResizeThumbProp.AnnotationAngle v -> el.SetValue(DevExpress.Xpf.Charts.AnnotationResizeThumb.AnnotationAngleProperty, box v)

    let annotation v : obj = box (AnnotationThumbProp.Annotation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AnnotationResizeThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
