...
type CleanWhiteThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteThreeQuartersArcScaleBackgroundLayerControl) (prop: CleanWhiteThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
