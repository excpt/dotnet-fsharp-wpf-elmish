...
type RibbonActionContainerProp =
    | Base of BarManagerActionContainerProp

module RibbonActionContainer =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonActionContainer) (prop: RibbonActionContainerProp) =
        match prop with
        | RibbonActionContainerProp.Base p -> BarManagerActionContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonActionContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
