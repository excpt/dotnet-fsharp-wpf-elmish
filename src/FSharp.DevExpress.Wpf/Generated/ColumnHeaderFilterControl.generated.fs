...
type ColumnHeaderFilterControlProp =
    | ColumnFilterPopup of DevExpress.Xpf.Editors.PopupBaseEdit

module ColumnHeaderFilterControl =
    let columnFilterPopup v : obj = box (ColumnHeaderFilterControlProp.ColumnFilterPopup v)

    let apply (el: DevExpress.Xpf.Grid.ColumnHeaderFilterControl) (prop: ColumnHeaderFilterControlProp) =
        match prop with
        | ColumnHeaderFilterControlProp.ColumnFilterPopup v -> el.SetValue(DevExpress.Xpf.Grid.ColumnHeaderFilterControl.ColumnFilterPopupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.ColumnHeaderFilterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
