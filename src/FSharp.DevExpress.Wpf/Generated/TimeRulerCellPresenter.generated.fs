...
type TimeRulerCellPresenterProp =
    | Base of ChromePresenterBaseProp

module TimeRulerCellPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimeRulerCellPresenter) (prop: TimeRulerCellPresenterProp) =
        match prop with
        | TimeRulerCellPresenterProp.Base p -> ChromePresenterBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimeRulerCellPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
