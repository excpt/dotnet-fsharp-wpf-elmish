...
type DefaultArcScaleLineControlProp =
    | Base of PresentationControlProp

module DefaultArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultArcScaleLineControl) (prop: DefaultArcScaleLineControlProp) =
        match prop with
        | DefaultArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
