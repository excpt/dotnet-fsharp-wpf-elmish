...
type CircularClassicHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularClassicHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularClassicHalfTopModel) (prop: CircularClassicHalfTopModelProp) =
        match prop with
        | CircularClassicHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularClassicHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
