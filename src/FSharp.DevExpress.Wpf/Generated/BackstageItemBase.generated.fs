...
type BackstageItemBaseProp =
    | Backstage of DevExpress.Xpf.Ribbon.BackstageViewControl
    ...
    | MergeOrder of int
    | MergeType of DevExpress.Xpf.Bars.BarItemMergeType
    | Placement of DevExpress.Xpf.Ribbon.BackstageItemPlacement

module BackstageItemBase =
    ...
    let apply (el: DevExpress.Xpf.Ribbon.BackstageItemBase) (prop: BackstageItemBaseProp) =
        match prop with
        | BackstageItemBaseProp.Backstage v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.BackstageProperty, box v)
        | BackstageItemBaseProp.BorderStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.BorderStyleProperty, box v)
        | BackstageItemBaseProp.NormalTextStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.NormalTextStyleProperty, box v)
        | BackstageItemBaseProp.HoverTextStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.HoverTextStyleProperty, box v)
        | BackstageItemBaseProp.ContentStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.ContentStyleProperty, box v)
        | BackstageItemBaseProp.MergeOrder v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.MergeOrderProperty, box v)
        | BackstageItemBaseProp.MergeType v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.MergeTypeProperty, box v)
        | BackstageItemBaseProp.Placement v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageItemBase.PlacementProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageItemBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
