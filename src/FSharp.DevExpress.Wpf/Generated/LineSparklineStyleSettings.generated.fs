...
type LineSparklineStyleSettingsProp =
    | Base of SparklineStyleSettingsProp
    | LineWidth of int
...
module LineSparklineStyleSettings =
    let lineWidth v : obj = box (LineSparklineStyleSettingsProp.LineWidth v)
    let highlightNegativePoints v : obj = box (LineSparklineStyleSettingsProp.HighlightNegativePoints v)
    let showMarkers v : obj = box (LineSparklineStyleSettingsProp.ShowMarkers v)
    let markerSize v : obj = box (LineSparklineStyleSettingsProp.MarkerSize v)
    let maxPointMarkerSize v : obj = box (LineSparklineStyleSettingsProp.MaxPointMarkerSize v)
    let minPointMarkerSize v : obj = box (LineSparklineStyleSettingsProp.MinPointMarkerSize v)
    let startPointMarkerSize v : obj = box (LineSparklineStyleSettingsProp.StartPointMarkerSize v)
    let endPointMarkerSize v : obj = box (LineSparklineStyleSettingsProp.EndPointMarkerSize v)
    let negativePointMarkerSize v : obj = box (LineSparklineStyleSettingsProp.NegativePointMarkerSize v)
    let markerBrush v : obj = box (LineSparklineStyleSettingsProp.MarkerBrush v)

    let apply (el: DevExpress.Xpf.Editors.LineSparklineStyleSettings) (prop: LineSparklineStyleSettingsProp) =
        match prop with
        | LineSparklineStyleSettingsProp.Base p -> SparklineStyleSettings.apply el p
        | LineSparklineStyleSettingsProp.LineWidth v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.LineWidthProperty, box v)
        | LineSparklineStyleSettingsProp.HighlightNegativePoints v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.HighlightNegativePointsProperty, box v)
        | LineSparklineStyleSettingsProp.ShowMarkers v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.ShowMarkersProperty, box v)
        | LineSparklineStyleSettingsProp.MarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.MarkerSizeProperty, box v)
        | LineSparklineStyleSettingsProp.MaxPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.MaxPointMarkerSizeProperty, box v)
        | LineSparklineStyleSettingsProp.MinPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.MinPointMarkerSizeProperty, box v)
        | LineSparklineStyleSettingsProp.StartPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.StartPointMarkerSizeProperty, box v)
        | LineSparklineStyleSettingsProp.EndPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.EndPointMarkerSizeProperty, box v)
        | LineSparklineStyleSettingsProp.NegativePointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.NegativePointMarkerSizeProperty, box v)
        | LineSparklineStyleSettingsProp.MarkerBrush v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineStyleSettings.MarkerBrushProperty, box v)

    let highlightMinPoint v : obj = box (SparklineStyleSettingsProp.HighlightMinPoint v)
    let highlightMaxPoint v : obj = box (SparklineStyleSettingsProp.HighlightMaxPoint v)
    let highlightStartPoint v : obj = box (SparklineStyleSettingsProp.HighlightStartPoint v)
    let highlightEndPoint v : obj = box (SparklineStyleSettingsProp.HighlightEndPoint v)
    let brush v : obj = box (SparklineStyleSettingsProp.Brush v)
    let maxPointBrush v : obj = box (SparklineStyleSettingsProp.MaxPointBrush v)
    let minPointBrush v : obj = box (SparklineStyleSettingsProp.MinPointBrush v)
    let startPointBrush v : obj = box (SparklineStyleSettingsProp.StartPointBrush v)
    let endPointBrush v : obj = box (SparklineStyleSettingsProp.EndPointBrush v)
    let negativePointBrush v : obj = box (SparklineStyleSettingsProp.NegativePointBrush v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.LineSparklineStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
