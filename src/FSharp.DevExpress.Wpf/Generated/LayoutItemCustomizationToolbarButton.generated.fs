...
type LayoutItemCustomizationToolbarButtonProp =
    | CornerRadius of System.Windows.CornerRadius

module LayoutItemCustomizationToolbarButton =
    let cornerRadius v : obj = box (LayoutItemCustomizationToolbarButtonProp.CornerRadius v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButton) (prop: LayoutItemCustomizationToolbarButtonProp) =
        match prop with
        | LayoutItemCustomizationToolbarButtonProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButton.CornerRadiusProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
