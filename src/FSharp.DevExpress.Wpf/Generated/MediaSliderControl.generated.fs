...
type MediaSliderControlProp =
    | ChaptersVisibility of System.Windows.Visibility
    | ChaptersDisplayType of DevExpress.Xpf.Controls.ChaptersDisplayType

module MediaSliderControl =
    let chaptersVisibility v : obj = box (MediaSliderControlProp.ChaptersVisibility v)
    let chaptersDisplayType v : obj = box (MediaSliderControlProp.ChaptersDisplayType v)

    let apply (el: DevExpress.Xpf.Controls.MediaSliderControl) (prop: MediaSliderControlProp) =
        match prop with
        | MediaSliderControlProp.ChaptersVisibility v -> el.SetValue(DevExpress.Xpf.Controls.MediaSliderControl.ChaptersVisibilityProperty, box v)
        | MediaSliderControlProp.ChaptersDisplayType v -> el.SetValue(DevExpress.Xpf.Controls.MediaSliderControl.ChaptersDisplayTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.MediaSliderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
