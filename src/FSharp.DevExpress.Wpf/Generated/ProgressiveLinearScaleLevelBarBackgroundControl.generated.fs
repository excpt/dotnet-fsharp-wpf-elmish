...
type ProgressiveLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ProgressiveLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveLinearScaleLevelBarBackgroundControl) (prop: ProgressiveLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | ProgressiveLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
