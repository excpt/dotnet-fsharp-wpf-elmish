...
open System
open System.Windows
open DevExpress.Xpf.Editors.DataPager
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DataPagerProp =
    | AutoEllipsis of bool
    | CurrentPageParams of DevExpress.Xpf.Editors.DataPager.DataPagerCurrentPageParams
    | DisplayMode of DevExpress.Xpf.Editors.DataPager.DataPagerDisplayMode
    | IsTotalItemCountFixed of bool
    | ItemCount of int
    | NumericButtonCount of int
    | PageIndex of int
    | PageSize of int
    | Source of System.Collections.IEnumerable
    | ShowTotalPageCount of bool

module DataPager =
    let autoEllipsis v : obj = box (DataPagerProp.AutoEllipsis v)
    let currentPageParams v : obj = box (DataPagerProp.CurrentPageParams v)
    let displayMode v : obj = box (DataPagerProp.DisplayMode v)
    let isTotalItemCountFixed v : obj = box (DataPagerProp.IsTotalItemCountFixed v)
    let itemCount v : obj = box (DataPagerProp.ItemCount v)
    let numericButtonCount v : obj = box (DataPagerProp.NumericButtonCount v)
    let pageIndex v : obj = box (DataPagerProp.PageIndex v)
    let pageSize v : obj = box (DataPagerProp.PageSize v)
    let source v : obj = box (DataPagerProp.Source v)
    let showTotalPageCount v : obj = box (DataPagerProp.ShowTotalPageCount v)

    let apply (el: DevExpress.Xpf.Editors.DataPager.DataPager) (prop: DataPagerProp) =
        match prop with
        | DataPagerProp.AutoEllipsis v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.AutoEllipsisProperty, box v)
        | DataPagerProp.CurrentPageParams v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.CurrentPageParamsProperty, box v)
        | DataPagerProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.DisplayModeProperty, box v)
        | DataPagerProp.IsTotalItemCountFixed v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.IsTotalItemCountFixedProperty, box v)
        | DataPagerProp.ItemCount v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.ItemCountProperty, box v)
        | DataPagerProp.NumericButtonCount v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.NumericButtonCountProperty, box v)
        | DataPagerProp.PageIndex v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.PageIndexProperty, box v)
        | DataPagerProp.PageSize v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.PageSizeProperty, box v)
        | DataPagerProp.Source v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.SourceProperty, box v)
        | DataPagerProp.ShowTotalPageCount v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPager.ShowTotalPageCountProperty, box v)
    ...
    let dataPager (v: DevExpress.Xpf.Editors.DataPager.DataPager) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DataPager.DataPager.DataPagerProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Editors.DataPager.DataPager>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
