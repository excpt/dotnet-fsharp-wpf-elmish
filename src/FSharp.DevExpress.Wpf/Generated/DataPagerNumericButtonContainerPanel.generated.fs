...
type DataPagerNumericButtonContainerPanelProp =
    | ButtonCount of int
    | HorizontalContentAlignment of System.Windows.HorizontalAlignment

module DataPagerNumericButtonContainerPanel =
    let buttonCount v : obj = box (DataPagerNumericButtonContainerPanelProp.ButtonCount v)
    let horizontalContentAlignment v : obj = box (DataPagerNumericButtonContainerPanelProp.HorizontalContentAlignment v)

    let apply (el: DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainerPanel) (prop: DataPagerNumericButtonContainerPanelProp) =
        match prop with
        | DataPagerNumericButtonContainerPanelProp.ButtonCount v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainerPanel.ButtonCountProperty, box v)
        | DataPagerNumericButtonContainerPanelProp.HorizontalContentAlignment v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainerPanel.HorizontalContentAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
