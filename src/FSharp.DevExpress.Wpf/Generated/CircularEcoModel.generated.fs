...
type CircularEcoModelProp =
    | Base of CircularGaugeModelProp

module CircularEcoModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularEcoModel) (prop: CircularEcoModelProp) =
        match prop with
        | CircularEcoModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularEcoModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
