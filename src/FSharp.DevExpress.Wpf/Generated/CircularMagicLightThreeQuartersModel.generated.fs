...
type CircularMagicLightThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularMagicLightThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularMagicLightThreeQuartersModel) (prop: CircularMagicLightThreeQuartersModelProp) =
        match prop with
        | CircularMagicLightThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularMagicLightThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
