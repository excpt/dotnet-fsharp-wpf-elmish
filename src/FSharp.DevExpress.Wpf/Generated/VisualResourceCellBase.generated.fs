...
type VisualResourceCellBaseProp =
    | Base of SchedulerContentControlProp
    | BackgroundBrushSelector of DevExpress.Xpf.Scheduler.Drawing.ICellBrushSelector
    | BorderBrushSelector of DevExpress.Xpf.Scheduler.Drawing.ICellBrushSelector

module VisualResourceCellBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualResourceCellBase) (prop: VisualResourceCellBaseProp) =
        match prop with
        | VisualResourceCellBaseProp.Base p -> SchedulerContentControl.apply el p
        | VisualResourceCellBaseProp.BackgroundBrushSelector v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualResourceCellBase.BackgroundBrushSelectorProperty, box v)
        | VisualResourceCellBaseProp.BorderBrushSelector v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualResourceCellBase.BorderBrushSelectorProperty, box v)
