...
type ColorPickerProp =
    ...
    | ShowDefaultColor of bool
    | ShowEditors of bool
    | ColorMode of DevExpress.Xpf.Editors.Internal.ColorPickerColorMode
    | ShowAlphaChannel of bool
    | OnColorChanged of System.Windows.RoutedEventHandler

module ColorPicker =
    let editMode v : obj = box (ColorPickerProp.EditMode v)
    let color v : obj = box (ColorPickerProp.Color v)
    let defaultColor v : obj = box (ColorPickerProp.DefaultColor v)
    let showDefaultColor v : obj = box (ColorPickerProp.ShowDefaultColor v)
    let showEditors v : obj = box (ColorPickerProp.ShowEditors v)
    let colorMode v : obj = box (ColorPickerProp.ColorMode v)
    let showAlphaChannel v : obj = box (ColorPickerProp.ShowAlphaChannel v)
    let onColorChanged v : obj = box (EventProp(box (ColorPickerProp.OnColorChanged v)))

    let apply (el: DevExpress.Xpf.Editors.Internal.ColorPicker) (prop: ColorPickerProp) =
        match prop with
        | ColorPickerProp.EditMode v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.EditModeProperty, box v)
        | ColorPickerProp.Color v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.ColorProperty, box v)
        | ColorPickerProp.DefaultColor v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.DefaultColorProperty, box v)
        | ColorPickerProp.ShowDefaultColor v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.ShowDefaultColorProperty, box v)
        | ColorPickerProp.ShowEditors v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.ShowEditorsProperty, box v)
        | ColorPickerProp.ColorMode v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.ColorModeProperty, box v)
        | ColorPickerProp.ShowAlphaChannel v -> el.SetValue(DevExpress.Xpf.Editors.Internal.ColorPicker.ShowAlphaChannelProperty, box v)
        | ColorPickerProp.OnColorChanged h -> el.ColorChanged.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.ColorPicker>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
