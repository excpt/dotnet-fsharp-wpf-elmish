...
type WizardFooterSeparatorProp =
    | Base of WizardSeparatorProp

module WizardFooterSeparator =

    let apply (el: DevExpress.Xpf.Controls.WizardFooterSeparator) (prop: WizardFooterSeparatorProp) =
        match prop with
        | WizardFooterSeparatorProp.Base p -> WizardSeparator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.WizardFooterSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
