...
type ScrollPanelBaseProp =
    | Base of RotatablePanelBaseProp

module ScrollPanelBase =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.ScrollPanelBase) (prop: ScrollPanelBaseProp) =
        match prop with
        | ScrollPanelBaseProp.Base p -> RotatablePanelBase.apply el p
