...
type ImageEditToolButtonProp =
    | ImageSource of System.Windows.Media.ImageSource

module ImageEditToolButton =
    let imageSource v : obj = box (ImageEditToolButtonProp.ImageSource v)

    let apply (el: DevExpress.Xpf.Editors.ImageEditToolButton) (prop: ImageEditToolButtonProp) =
        match prop with
        | ImageEditToolButtonProp.ImageSource v -> el.SetValue(DevExpress.Xpf.Editors.ImageEditToolButton.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
