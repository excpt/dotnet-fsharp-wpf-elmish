...
type veContentControlProp =
    | Base of veContentControlBaseProp
    | ContentTemplateInternal of obj

module veContentControl =
    let contentTemplateInternal v : obj = box (veContentControlProp.ContentTemplateInternal v)

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veContentControl) (prop: veContentControlProp) =
        match prop with
        | veContentControlProp.Base p -> veContentControlBase.apply el p
        | veContentControlProp.ContentTemplateInternal v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veContentControl.ContentTemplateInternalProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Base.veContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
