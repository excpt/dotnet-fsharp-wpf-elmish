...
type CircularSmartHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularSmartHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularSmartHalfTopModel) (prop: CircularSmartHalfTopModelProp) =
        match prop with
        | CircularSmartHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularSmartHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
