...
type RangeDateNavigatorProp =
    | Base of DateNavigatorProp

module RangeDateNavigator =

    let apply (el: DevExpress.Xpf.Editors.RangeDateNavigator) (prop: RangeDateNavigatorProp) =
        match prop with
        | RangeDateNavigatorProp.Base p -> DateNavigator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RangeDateNavigator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
