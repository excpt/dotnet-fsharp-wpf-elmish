...
type ClassicArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ClassicArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicArcScaleNeedleControl) (prop: ClassicArcScaleNeedleControlProp) =
        match prop with
        | ClassicArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
