...
type IStyleHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleHalfTopArcScaleBackgroundLayerControl) (prop: IStyleHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | IStyleHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
