...
type IntelliSenseRichEditProp =
    | Base of RichEditControlProp
    | PopupIsOpen of bool

module IntelliSenseRichEdit =
    let popupIsOpen v : obj = box (IntelliSenseRichEditProp.PopupIsOpen v)

    let apply (el: DevExpress.Xpf.ExpressionEditor.Native.IntelliSenseRichEdit) (prop: IntelliSenseRichEditProp) =
        match prop with
        | IntelliSenseRichEditProp.Base p -> RichEditControl.apply el p
        | IntelliSenseRichEditProp.PopupIsOpen v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.Native.IntelliSenseRichEdit.PopupIsOpenProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.ExpressionEditor.Native.IntelliSenseRichEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
