...
type AreaMarkerRenderControlProp =
    | Base of GeometryMarkerRenderControlProp

module AreaMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.AreaMarkerRenderControl) (prop: AreaMarkerRenderControlProp) =
        match prop with
        | AreaMarkerRenderControlProp.Base p -> GeometryMarkerRenderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaMarkerRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
