...
type RibbonStatusBarLeftPartItemsPanelProp =
    | Base of RibbonItemsPanelBaseProp

module RibbonStatusBarLeftPartItemsPanel =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonStatusBarLeftPartItemsPanel) (prop: RibbonStatusBarLeftPartItemsPanelProp) =
        match prop with
        | RibbonStatusBarLeftPartItemsPanelProp.Base p -> RibbonItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonStatusBarLeftPartItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
