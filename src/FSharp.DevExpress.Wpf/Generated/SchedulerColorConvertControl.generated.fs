...
type SchedulerColorConvertControlProp =
    | Container of DevExpress.Xpf.Scheduler.Drawing.GraphicResourceContainer
    | ControlColor of System.Windows.Media.Color
    | ControlBrush of System.Windows.Media.Brush
    | BaseColors of DevExpress.Xpf.Scheduler.Drawing.ColorCollection
    | BaseBrushColors of DevExpress.Xpf.Scheduler.Drawing.ColorCollection
    | DisableResourceColor of bool

module SchedulerColorConvertControl =
    let container v : obj = box (SchedulerColorConvertControlProp.Container v)
    let controlColor v : obj = box (SchedulerColorConvertControlProp.ControlColor v)
    let controlBrush v : obj = box (SchedulerColorConvertControlProp.ControlBrush v)
    let baseColors v : obj = box (SchedulerColorConvertControlProp.BaseColors v)
    let baseBrushColors v : obj = box (SchedulerColorConvertControlProp.BaseBrushColors v)
    let disableResourceColor v : obj = box (SchedulerColorConvertControlProp.DisableResourceColor v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl) (prop: SchedulerColorConvertControlProp) =
        match prop with
        | SchedulerColorConvertControlProp.Container v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl.ContainerProperty, box v)
        | SchedulerColorConvertControlProp.ControlColor v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl.ControlColorProperty, box v)
        | SchedulerColorConvertControlProp.ControlBrush v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl.ControlBrushProperty, box v)
        | SchedulerColorConvertControlProp.BaseColors v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl.BaseColorsProperty, box v)
        | SchedulerColorConvertControlProp.BaseBrushColors v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl.BaseBrushColorsProperty, box v)
        | SchedulerColorConvertControlProp.DisableResourceColor v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl.DisableResourceColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SchedulerColorConvertControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
