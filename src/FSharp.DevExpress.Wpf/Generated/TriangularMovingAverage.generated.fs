...
type TriangularMovingAverageProp =
    | Base of MovingAverageProp

module TriangularMovingAverage =

    let apply (el: DevExpress.Xpf.Charts.TriangularMovingAverage) (prop: TriangularMovingAverageProp) =
        match prop with
        | TriangularMovingAverageProp.Base p -> MovingAverage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TriangularMovingAverage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
