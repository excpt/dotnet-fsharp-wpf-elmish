...
type GridDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module GridDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.GridDashboardLayoutItem) (prop: GridDashboardLayoutItemProp) =
        match prop with
        | GridDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let gridViewStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.GridDashboardLayoutItem.GridViewStyleProperty, box v)) :: node.Props }
    let columnStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.GridDashboardLayoutItem.ColumnStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.DashboardWpf.GridDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
