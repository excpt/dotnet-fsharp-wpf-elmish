...
type GalleryItemControlProp =
    | IsHoverGlyphVisible of bool
    | Item of DevExpress.Xpf.Bars.GalleryItem
    | GroupControl of DevExpress.Xpf.Bars.GalleryItemGroupControl
    | IsSelected of bool
    | IsItemContentVisible of bool
    | IsItemGlyphVisible of bool
    | Glyph of System.Windows.Media.ImageSource

module GalleryItemControl =
    let isHoverGlyphVisible v : obj = box (GalleryItemControlProp.IsHoverGlyphVisible v)
    let item v : obj = box (GalleryItemControlProp.Item v)
    let groupControl v : obj = box (GalleryItemControlProp.GroupControl v)
    let isSelected v : obj = box (GalleryItemControlProp.IsSelected v)
    let isItemContentVisible v : obj = box (GalleryItemControlProp.IsItemContentVisible v)
    let isItemGlyphVisible v : obj = box (GalleryItemControlProp.IsItemGlyphVisible v)
    let glyph v : obj = box (GalleryItemControlProp.Glyph v)

    let apply (el: DevExpress.Xpf.Bars.GalleryItemControl) (prop: GalleryItemControlProp) =
        match prop with
        | GalleryItemControlProp.IsHoverGlyphVisible v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.IsHoverGlyphVisibleProperty, box v)
        | GalleryItemControlProp.Item v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.ItemProperty, box v)
        | GalleryItemControlProp.GroupControl v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.GroupControlProperty, box v)
        | GalleryItemControlProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.IsSelectedProperty, box v)
        | GalleryItemControlProp.IsItemContentVisible v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.IsItemContentVisibleProperty, box v)
        | GalleryItemControlProp.IsItemGlyphVisible v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.IsItemGlyphVisibleProperty, box v)
        | GalleryItemControlProp.Glyph v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemControl.GlyphProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
