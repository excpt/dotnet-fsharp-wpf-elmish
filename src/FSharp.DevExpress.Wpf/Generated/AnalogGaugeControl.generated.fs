...
type AnalogGaugeControlProp =
    | Base of GaugeControlBaseProp
    | ScalePanelTemplate of System.Windows.Controls.ItemsPanelTemplate

module AnalogGaugeControl =
    let scalePanelTemplate v : obj = box (AnalogGaugeControlProp.ScalePanelTemplate v)

    let apply (el: DevExpress.Xpf.Gauges.AnalogGaugeControl) (prop: AnalogGaugeControlProp) =
        match prop with
        | AnalogGaugeControlProp.Base p -> GaugeControlBase.apply el p
        | AnalogGaugeControlProp.ScalePanelTemplate v -> el.SetValue(DevExpress.Xpf.Gauges.AnalogGaugeControl.ScalePanelTemplateProperty, box v)
    ...
    let valueIndicator (v: DevExpress.Xpf.Gauges.ValueIndicatorBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Gauges.AnalogGaugeControl.ValueIndicatorProperty, box v)) :: node.Props }
