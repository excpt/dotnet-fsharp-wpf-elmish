...
open System
open System.Windows
open DevExpress.Xpf.Editors.Controls
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TrackBarEditThumbContentControlProp =
    | Base of MultiContentControlProp
    | IsDragging of bool

module TrackBarEditThumbContentControl =
    let isDragging v : obj = box (TrackBarEditThumbContentControlProp.IsDragging v)

    let apply (el: DevExpress.Xpf.Editors.Controls.TrackBarEditThumbContentControl) (prop: TrackBarEditThumbContentControlProp) =
        match prop with
        | TrackBarEditThumbContentControlProp.Base p -> MultiContentControl.apply el p
        | TrackBarEditThumbContentControlProp.IsDragging v -> el.SetValue(DevExpress.Xpf.Editors.Controls.TrackBarEditThumbContentControl.IsDraggingProperty, box v)

    let visibleChildIndex v : obj = box (MultiContentControlProp.VisibleChildIndex v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Controls.TrackBarEditThumbContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
