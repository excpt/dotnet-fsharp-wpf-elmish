...
type HeatmapElementItemsControlProp =
    | Base of ChartItemsControlProp

module HeatmapElementItemsControl =

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapElementItemsControl) (prop: HeatmapElementItemsControlProp) =
        match prop with
        | HeatmapElementItemsControlProp.Base p -> ChartItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapElementItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
