...
type RichEditControlProviderProp =
    | RichEditControl of DevExpress.Xpf.RichEdit.RichEditControl

module RichEditControlProvider =
    let richEditControl v : obj = box (RichEditControlProviderProp.RichEditControl v)

    let apply (el: DevExpress.Xpf.RichEdit.RichEditControlProvider) (prop: RichEditControlProviderProp) =
        match prop with
        | RichEditControlProviderProp.RichEditControl v -> el.SetValue(DevExpress.Xpf.RichEdit.RichEditControlProvider.RichEditControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.RichEditControlProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
