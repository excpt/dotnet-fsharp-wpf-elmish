...
type SubMenuClientPanelProp =
    | Base of SubMenuClientPanelBaseProp

module SubMenuClientPanel =

    let apply (el: DevExpress.Xpf.Bars.SubMenuClientPanel) (prop: SubMenuClientPanelProp) =
        match prop with
        | SubMenuClientPanelProp.Base p -> SubMenuClientPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.SubMenuClientPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
