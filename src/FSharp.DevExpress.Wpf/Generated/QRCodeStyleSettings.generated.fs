...
type QRCodeStyleSettingsProp =
    | CompactionMode of DevExpress.XtraPrinting.BarCode.QRCodeCompactionMode
    | ErrorCorrectionLevel of DevExpress.XtraPrinting.BarCode.QRCodeErrorCorrectionLevel
    | Version of DevExpress.XtraPrinting.BarCode.QRCodeVersion

module QRCodeStyleSettings =
    let compactionMode v : obj = box (QRCodeStyleSettingsProp.CompactionMode v)
    let errorCorrectionLevel v : obj = box (QRCodeStyleSettingsProp.ErrorCorrectionLevel v)
    let version v : obj = box (QRCodeStyleSettingsProp.Version v)

    let apply (el: DevExpress.Xpf.Editors.QRCodeStyleSettings) (prop: QRCodeStyleSettingsProp) =
        match prop with
        | QRCodeStyleSettingsProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.QRCodeStyleSettings.CompactionModeProperty, box v)
        | QRCodeStyleSettingsProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Editors.QRCodeStyleSettings.ErrorCorrectionLevelProperty, box v)
        | QRCodeStyleSettingsProp.Version v -> el.SetValue(DevExpress.Xpf.Editors.QRCodeStyleSettings.VersionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.QRCodeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
