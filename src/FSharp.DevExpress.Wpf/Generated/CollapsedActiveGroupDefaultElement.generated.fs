...
type CollapsedActiveGroupDefaultElementProp =
    | Base of CollapsedActiveGroupItemProp

module CollapsedActiveGroupDefaultElement =

    let apply (el: DevExpress.Xpf.NavBar.CollapsedActiveGroupDefaultElement) (prop: CollapsedActiveGroupDefaultElementProp) =
        match prop with
        | CollapsedActiveGroupDefaultElementProp.Base p -> CollapsedActiveGroupItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.CollapsedActiveGroupDefaultElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
