...
type FlatLightArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FlatLightArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightArcScaleNeedleControl) (prop: FlatLightArcScaleNeedleControlProp) =
        match prop with
        | FlatLightArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
