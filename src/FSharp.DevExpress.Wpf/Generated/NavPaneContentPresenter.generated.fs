...
type NavPaneContentPresenterProp =
    | Base of DXContentPresenterProp
    | ActualContent of obj

module NavPaneContentPresenter =
    let actualContent v : obj = box (NavPaneContentPresenterProp.ActualContent v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneContentPresenter) (prop: NavPaneContentPresenterProp) =
        match prop with
        | NavPaneContentPresenterProp.Base p -> DXContentPresenter.apply el p
        | NavPaneContentPresenterProp.ActualContent v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneContentPresenter.ActualContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
