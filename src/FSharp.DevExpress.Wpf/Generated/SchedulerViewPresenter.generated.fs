...
type SchedulerViewPresenterProp =
    | DayViewGroupByNoneTemplate of System.Windows.DataTemplate
    | DayViewGroupByResourceTemplate of System.Windows.DataTemplate
    | DayViewGroupByDateTemplate of System.Windows.DataTemplate
    | MonthViewGroupByNoneTemplate of System.Windows.DataTemplate
    | MonthViewGroupByResourceTemplate of System.Windows.DataTemplate
    | MonthViewGroupByDateTemplate of System.Windows.DataTemplate
    | OneMonthViewGroupByNoneTemplate of System.Windows.DataTemplate
    | OneMonthViewGroupByResourceTemplate of System.Windows.DataTemplate
    | OneMonthViewGroupByDateTemplate of System.Windows.DataTemplate
    | TimelineViewTemplate of System.Windows.DataTemplate
    | AgendaViewTemplate of System.Windows.DataTemplate
    | ListViewTemplate of System.Windows.DataTemplate

module SchedulerViewPresenter =
    let dayViewGroupByNoneTemplate v : obj = box (SchedulerViewPresenterProp.DayViewGroupByNoneTemplate v)
    let dayViewGroupByResourceTemplate v : obj = box (SchedulerViewPresenterProp.DayViewGroupByResourceTemplate v)
    let dayViewGroupByDateTemplate v : obj = box (SchedulerViewPresenterProp.DayViewGroupByDateTemplate v)
    let monthViewGroupByNoneTemplate v : obj = box (SchedulerViewPresenterProp.MonthViewGroupByNoneTemplate v)
    let monthViewGroupByResourceTemplate v : obj = box (SchedulerViewPresenterProp.MonthViewGroupByResourceTemplate v)
    let monthViewGroupByDateTemplate v : obj = box (SchedulerViewPresenterProp.MonthViewGroupByDateTemplate v)
    let oneMonthViewGroupByNoneTemplate v : obj = box (SchedulerViewPresenterProp.OneMonthViewGroupByNoneTemplate v)
    let oneMonthViewGroupByResourceTemplate v : obj = box (SchedulerViewPresenterProp.OneMonthViewGroupByResourceTemplate v)
    let oneMonthViewGroupByDateTemplate v : obj = box (SchedulerViewPresenterProp.OneMonthViewGroupByDateTemplate v)
    let timelineViewTemplate v : obj = box (SchedulerViewPresenterProp.TimelineViewTemplate v)
    let agendaViewTemplate v : obj = box (SchedulerViewPresenterProp.AgendaViewTemplate v)
    let listViewTemplate v : obj = box (SchedulerViewPresenterProp.ListViewTemplate v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter) (prop: SchedulerViewPresenterProp) =
        match prop with
        | SchedulerViewPresenterProp.DayViewGroupByNoneTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.DayViewGroupByNoneTemplateProperty, box v)
        | SchedulerViewPresenterProp.DayViewGroupByResourceTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.DayViewGroupByResourceTemplateProperty, box v)
        | SchedulerViewPresenterProp.DayViewGroupByDateTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.DayViewGroupByDateTemplateProperty, box v)
        | SchedulerViewPresenterProp.MonthViewGroupByNoneTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.MonthViewGroupByNoneTemplateProperty, box v)
        | SchedulerViewPresenterProp.MonthViewGroupByResourceTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.MonthViewGroupByResourceTemplateProperty, box v)
        | SchedulerViewPresenterProp.MonthViewGroupByDateTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.MonthViewGroupByDateTemplateProperty, box v)
        | SchedulerViewPresenterProp.OneMonthViewGroupByNoneTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.OneMonthViewGroupByNoneTemplateProperty, box v)
        | SchedulerViewPresenterProp.OneMonthViewGroupByResourceTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.OneMonthViewGroupByResourceTemplateProperty, box v)
        | SchedulerViewPresenterProp.OneMonthViewGroupByDateTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.OneMonthViewGroupByDateTemplateProperty, box v)
        | SchedulerViewPresenterProp.TimelineViewTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.TimelineViewTemplateProperty, box v)
        | SchedulerViewPresenterProp.AgendaViewTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.AgendaViewTemplateProperty, box v)
        | SchedulerViewPresenterProp.ListViewTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter.ListViewTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.SchedulerViewPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
