...
type AllDayCellControlProp =
    | Base of CellControlProp

module AllDayCellControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AllDayCellControl) (prop: AllDayCellControlProp) =
        match prop with
        | AllDayCellControlProp.Base p -> CellControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AllDayCellControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
