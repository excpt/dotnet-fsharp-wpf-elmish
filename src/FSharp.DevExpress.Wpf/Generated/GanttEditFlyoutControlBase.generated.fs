...
type GanttEditFlyoutControlBaseProp =
    | Base of FlyoutControlProp

module GanttEditFlyoutControlBase =

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttEditFlyoutControlBase) (prop: GanttEditFlyoutControlBaseProp) =
        match prop with
        | GanttEditFlyoutControlBaseProp.Base p -> FlyoutControl.apply el p
