...
type ArrowRightDownStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowRightDownStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowRightDownStatePresentationControl) (prop: ArrowRightDownStatePresentationControlProp) =
        match prop with
        | ArrowRightDownStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowRightDownStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
