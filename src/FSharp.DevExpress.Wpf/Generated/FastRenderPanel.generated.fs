...
type FastRenderPanelProp =
    | ContentCacheMode of DevExpress.Xpf.Core.TabContentCacheMode

module FastRenderPanel =
    let contentCacheMode v : obj = box (FastRenderPanelProp.ContentCacheMode v)

    let apply (el: DevExpress.Xpf.Core.Native.FastRenderPanel) (prop: FastRenderPanelProp) =
        match prop with
        | FastRenderPanelProp.ContentCacheMode v -> el.SetValue(DevExpress.Xpf.Core.Native.FastRenderPanel.ContentCacheModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.FastRenderPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
