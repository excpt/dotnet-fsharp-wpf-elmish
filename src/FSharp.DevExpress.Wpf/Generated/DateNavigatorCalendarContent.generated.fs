...
type DateNavigatorCalendarContentProp =
    | State of DevExpress.Xpf.Editors.DateNavigator.DateNavigatorCalendarView
    | DateTime of System.DateTime

module DateNavigatorCalendarContent =
    let state v : obj = box (DateNavigatorCalendarContentProp.State v)
    let dateTime v : obj = box (DateNavigatorCalendarContentProp.DateTime v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContent) (prop: DateNavigatorCalendarContentProp) =
        match prop with
        | DateNavigatorCalendarContentProp.State v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContent.StateProperty, box v)
        | DateNavigatorCalendarContentProp.DateTime v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContent.DateTimeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
