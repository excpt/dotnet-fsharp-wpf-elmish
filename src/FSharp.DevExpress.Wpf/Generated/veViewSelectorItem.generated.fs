...
type veViewSelectorItemProp =
    | Base of veContentSelectorItemProp

module veViewSelectorItem =

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veViewSelectorItem) (prop: veViewSelectorItemProp) =
        match prop with
        | veViewSelectorItemProp.Base p -> veContentSelectorItem.apply el p
