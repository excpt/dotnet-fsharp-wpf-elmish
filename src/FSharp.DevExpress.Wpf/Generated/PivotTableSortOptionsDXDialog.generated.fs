...
type PivotTableSortOptionsDXDialogProp =
    | Base of CustomDXDialogProp

module PivotTableSortOptionsDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotTableSortOptionsDXDialog) (prop: PivotTableSortOptionsDXDialogProp) =
        match prop with
        | PivotTableSortOptionsDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotTableSortOptionsDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
