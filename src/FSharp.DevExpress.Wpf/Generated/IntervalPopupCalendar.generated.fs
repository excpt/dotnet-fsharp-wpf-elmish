...
type IntervalPopupCalendarProp =
    | Scheduler of DevExpress.Xpf.Scheduling.SchedulerControl
    | CurrentDate of System.DateTime
...
module IntervalPopupCalendar =
    let scheduler v : obj = box (IntervalPopupCalendarProp.Scheduler v)
    let currentDate v : obj = box (IntervalPopupCalendarProp.CurrentDate v)
    let calendarView v : obj = box (IntervalPopupCalendarProp.CalendarView v)
    let displayText v : obj = box (IntervalPopupCalendarProp.DisplayText v)
    let showText v : obj = box (IntervalPopupCalendarProp.ShowText v)
    let showCalendarButton v : obj = box (IntervalPopupCalendarProp.ShowCalendarButton v)
    let textBlockStyle v : obj = box (IntervalPopupCalendarProp.TextBlockStyle v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar) (prop: IntervalPopupCalendarProp) =
        match prop with
        | IntervalPopupCalendarProp.Scheduler v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.SchedulerProperty, box v)
        | IntervalPopupCalendarProp.CurrentDate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.CurrentDateProperty, box v)
        | IntervalPopupCalendarProp.CalendarView v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.CalendarViewProperty, box v)
        | IntervalPopupCalendarProp.DisplayText v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.DisplayTextProperty, box v)
        | IntervalPopupCalendarProp.ShowText v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.ShowTextProperty, box v)
        | IntervalPopupCalendarProp.ShowCalendarButton v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.ShowCalendarButtonProperty, box v)
        | IntervalPopupCalendarProp.TextBlockStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar.TextBlockStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.IntervalPopupCalendar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
