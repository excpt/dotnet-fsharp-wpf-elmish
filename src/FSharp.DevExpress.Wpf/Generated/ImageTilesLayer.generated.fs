...
type ImageTilesLayerProp =
    | Base of ImageLayerProp

module ImageTilesLayer =

    let apply (el: DevExpress.Xpf.Map.ImageTilesLayer) (prop: ImageTilesLayerProp) =
        match prop with
        | ImageTilesLayerProp.Base p -> ImageLayer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.ImageTilesLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
