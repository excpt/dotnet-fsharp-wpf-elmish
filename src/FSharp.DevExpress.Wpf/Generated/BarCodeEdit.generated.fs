...
type BarCodeEditProp =
    | Base of BaseEditProp
    | AutoModule of bool
    | TargetDeviceDpi of obj
    | Module of float
    | ShowText of bool
    | VerticalTextAlignment of System.Windows.VerticalAlignment
    | HorizontalTextAlignment of System.Windows.HorizontalAlignment
    | BinaryData of System.Byte[]

module BarCodeEdit =
    let autoModule v : obj = box (BarCodeEditProp.AutoModule v)
    let targetDeviceDpi v : obj = box (BarCodeEditProp.TargetDeviceDpi v)
    let module v : obj = box (BarCodeEditProp.Module v)
    let showText v : obj = box (BarCodeEditProp.ShowText v)
    let verticalTextAlignment v : obj = box (BarCodeEditProp.VerticalTextAlignment v)
    let horizontalTextAlignment v : obj = box (BarCodeEditProp.HorizontalTextAlignment v)
    let binaryData v : obj = box (BarCodeEditProp.BinaryData v)

    let apply (el: DevExpress.Xpf.Editors.BarCodeEdit) (prop: BarCodeEditProp) =
        match prop with
        | BarCodeEditProp.Base p -> BaseEdit.apply el p
        | BarCodeEditProp.AutoModule v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.AutoModuleProperty, box v)
        | BarCodeEditProp.TargetDeviceDpi v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.TargetDeviceDpiProperty, box v)
        | BarCodeEditProp.Module v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.ModuleProperty, box v)
        | BarCodeEditProp.ShowText v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.ShowTextProperty, box v)
        | BarCodeEditProp.VerticalTextAlignment v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.VerticalTextAlignmentProperty, box v)
        | BarCodeEditProp.HorizontalTextAlignment v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.HorizontalTextAlignmentProperty, box v)
        | BarCodeEditProp.BinaryData v -> el.SetValue(DevExpress.Xpf.Editors.BarCodeEdit.BinaryDataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BarCodeEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
