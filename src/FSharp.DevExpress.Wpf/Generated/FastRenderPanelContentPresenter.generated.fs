...
type FastRenderPanelContentPresenterProp =
    | Base of ContentHostContentPresenterProp

module FastRenderPanelContentPresenter =

    let apply (el: DevExpress.Xpf.Core.Native.FastRenderPanelContentPresenter) (prop: FastRenderPanelContentPresenterProp) =
        match prop with
        | FastRenderPanelContentPresenterProp.Base p -> ContentHostContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.FastRenderPanelContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
