...
type SelectionIndicatorDecoratorProp =
    | SelectionIndicatorStyle of System.Windows.Style
    | EnableAnimations of bool
    | Duration of int
    | EasingFunction of System.Windows.Media.Animation.IEasingFunction

module SelectionIndicatorDecorator =
    let selectionIndicatorStyle v : obj = box (SelectionIndicatorDecoratorProp.SelectionIndicatorStyle v)
    let enableAnimations v : obj = box (SelectionIndicatorDecoratorProp.EnableAnimations v)
    let duration v : obj = box (SelectionIndicatorDecoratorProp.Duration v)
    let easingFunction v : obj = box (SelectionIndicatorDecoratorProp.EasingFunction v)

    let apply (el: DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator) (prop: SelectionIndicatorDecoratorProp) =
        match prop with
        | SelectionIndicatorDecoratorProp.SelectionIndicatorStyle v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator.SelectionIndicatorStyleProperty, box v)
        | SelectionIndicatorDecoratorProp.EnableAnimations v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator.EnableAnimationsProperty, box v)
        | SelectionIndicatorDecoratorProp.Duration v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator.DurationProperty, box v)
        | SelectionIndicatorDecoratorProp.EasingFunction v -> el.SetValue(DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator.EasingFunctionProperty, box v)
    ...
    let instance (v: DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator.InstanceProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Core.Native.SelectionIndicatorDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
