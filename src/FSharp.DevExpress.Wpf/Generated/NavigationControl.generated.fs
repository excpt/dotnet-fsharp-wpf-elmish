...
type NavigationControlProp =
    | GoBackCommand of System.Windows.Input.ICommand
    | GoNextCommand of System.Windows.Input.ICommand
    | BackButtonVisibility of System.Windows.Visibility
    | NextButtonVisibility of System.Windows.Visibility

module NavigationControl =
    let goBackCommand v : obj = box (NavigationControlProp.GoBackCommand v)
    let goNextCommand v : obj = box (NavigationControlProp.GoNextCommand v)
    let backButtonVisibility v : obj = box (NavigationControlProp.BackButtonVisibility v)
    let nextButtonVisibility v : obj = box (NavigationControlProp.NextButtonVisibility v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.NavigationControl) (prop: NavigationControlProp) =
        match prop with
        | NavigationControlProp.GoBackCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.NavigationControl.GoBackCommandProperty, box v)
        | NavigationControlProp.GoNextCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.NavigationControl.GoNextCommandProperty, box v)
        | NavigationControlProp.BackButtonVisibility v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.NavigationControl.BackButtonVisibilityProperty, box v)
        | NavigationControlProp.NextButtonVisibility v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.NavigationControl.NextButtonVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.NavigationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
