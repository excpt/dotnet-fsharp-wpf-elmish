...
module ChartDataTable =
    let fontFamily v : obj = box (ChartDataTableProp.FontFamily v)
    let fontSize v : obj = box (ChartDataTableProp.FontSize v)
    let foreground v : obj = box (ChartDataTableProp.Foreground v)
    let lineBrush v : obj = box (ChartDataTableProp.LineBrush v)

    let apply (el: DevExpress.Xpf.Charts.ChartDataTable) (prop: ChartDataTableProp) =
        match prop with
        | ChartDataTableProp.FontFamily v -> el.SetValue(DevExpress.Xpf.Charts.ChartDataTable.FontFamilyProperty, box v)
        | ChartDataTableProp.FontSize v -> el.SetValue(DevExpress.Xpf.Charts.ChartDataTable.FontSizeProperty, box v)
        | ChartDataTableProp.Foreground v -> el.SetValue(DevExpress.Xpf.Charts.ChartDataTable.ForegroundProperty, box v)
        | ChartDataTableProp.LineBrush v -> el.SetValue(DevExpress.Xpf.Charts.ChartDataTable.LineBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartDataTable>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
