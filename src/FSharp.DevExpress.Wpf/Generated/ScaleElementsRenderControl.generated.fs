...
type ScaleElementsRenderControlProp =
    | Base of PresentationControlProp

module ScaleElementsRenderControl =

    let apply (el: DevExpress.Xpf.Gauges.ScaleElementsRenderControl) (prop: ScaleElementsRenderControlProp) =
        match prop with
        | ScaleElementsRenderControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ScaleElementsRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
