...
type YellowSubmarineDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineDigitalGaugeBackgroundLayerControl) (prop: YellowSubmarineDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
