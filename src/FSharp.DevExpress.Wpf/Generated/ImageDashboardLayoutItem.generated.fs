...
type ImageDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module ImageDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.ImageDashboardLayoutItem) (prop: ImageDashboardLayoutItemProp) =
        match prop with
        | ImageDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.ImageDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
