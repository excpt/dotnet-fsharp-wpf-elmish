...
open System
open System.Windows
open DevExpress.Xpf.Spreadsheet.Menu
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SpreadsheetPopupMenuProp =
    | Base of CustomizablePopupMenuBaseProp

module SpreadsheetPopupMenu =

    let apply (el: DevExpress.Xpf.Spreadsheet.Menu.SpreadsheetPopupMenu) (prop: SpreadsheetPopupMenuProp) =
        match prop with
        | SpreadsheetPopupMenuProp.Base p -> CustomizablePopupMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Menu.SpreadsheetPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
