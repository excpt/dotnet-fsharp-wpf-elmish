...
type PopupCalcEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp

module PopupCalcEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.PopupCalcEditPropertyProvider) (prop: PopupCalcEditPropertyProviderProp) =
        match prop with
        | PopupCalcEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupCalcEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
