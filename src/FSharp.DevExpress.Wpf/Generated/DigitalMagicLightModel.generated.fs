...
type DigitalMagicLightModelProp =
    | Base of DigitalGaugeModelProp

module DigitalMagicLightModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalMagicLightModel) (prop: DigitalMagicLightModelProp) =
        match prop with
        | DigitalMagicLightModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalMagicLightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
