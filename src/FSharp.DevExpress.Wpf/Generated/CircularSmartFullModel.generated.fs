...
type CircularSmartFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularSmartFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularSmartFullModel) (prop: CircularSmartFullModelProp) =
        match prop with
        | CircularSmartFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularSmartFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
