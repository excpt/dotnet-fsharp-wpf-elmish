...
type DiagramDesignerControlProp =
    | Base of DiagramControlProp
    | CommandBarStyle of DevExpress.Xpf.Diagram.CommandBarStyle
    | ShowStatusBar of bool

module DiagramDesignerControl =
    let commandBarStyle v : obj = box (DiagramDesignerControlProp.CommandBarStyle v)
    let showStatusBar v : obj = box (DiagramDesignerControlProp.ShowStatusBar v)

    let apply (el: DevExpress.Xpf.Diagram.DiagramDesignerControl) (prop: DiagramDesignerControlProp) =
        match prop with
        | DiagramDesignerControlProp.Base p -> DiagramControl.apply el p
        | DiagramDesignerControlProp.CommandBarStyle v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramDesignerControl.CommandBarStyleProperty, box v)
        | DiagramDesignerControlProp.ShowStatusBar v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramDesignerControl.ShowStatusBarProperty, box v)
    ...
    let barItemName (v: string) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Diagram.DiagramDesignerControl.BarItemNameProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramDesignerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
