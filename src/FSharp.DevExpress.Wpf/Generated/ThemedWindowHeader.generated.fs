...
type ThemedWindowHeaderProp =
    | EnableTransparency of bool
    | CornerRadius of System.Windows.CornerRadius
    | TitleAlignment of DevExpress.Xpf.Core.WindowTitleAlignment

module ThemedWindowHeader =
    let enableTransparency v : obj = box (ThemedWindowHeaderProp.EnableTransparency v)
    let cornerRadius v : obj = box (ThemedWindowHeaderProp.CornerRadius v)
    let titleAlignment v : obj = box (ThemedWindowHeaderProp.TitleAlignment v)

    let apply (el: DevExpress.Xpf.Core.ThemedWindowHeader) (prop: ThemedWindowHeaderProp) =
        match prop with
        | ThemedWindowHeaderProp.EnableTransparency v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowHeader.EnableTransparencyProperty, box v)
        | ThemedWindowHeaderProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowHeader.CornerRadiusProperty, box v)
        | ThemedWindowHeaderProp.TitleAlignment v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowHeader.TitleAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
