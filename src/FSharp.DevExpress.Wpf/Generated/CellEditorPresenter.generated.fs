...
type CellEditorPresenterProp =
    | IsSelected of bool
    | PathMode of DevExpress.Xpf.PropertyGrid.CellEditorPresenterPathMode
    | Path of string

module CellEditorPresenter =
    let isSelected v : obj = box (CellEditorPresenterProp.IsSelected v)
    let pathMode v : obj = box (CellEditorPresenterProp.PathMode v)
    let path v : obj = box (CellEditorPresenterProp.Path v)

    let apply (el: DevExpress.Xpf.PropertyGrid.CellEditorPresenter) (prop: CellEditorPresenterProp) =
        match prop with
        | CellEditorPresenterProp.IsSelected v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CellEditorPresenter.IsSelectedProperty, box v)
        | CellEditorPresenterProp.PathMode v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CellEditorPresenter.PathModeProperty, box v)
        | CellEditorPresenterProp.Path v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CellEditorPresenter.PathProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.CellEditorPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
