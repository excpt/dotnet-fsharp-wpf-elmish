...
type ScrollableControlProp =
    | Orientation of System.Windows.Controls.Orientation
    | ScrollNext of DevExpress.Mvvm.IDelegateCommand
    | ScrollPrev of DevExpress.Mvvm.IDelegateCommand
    | IsScrollable of bool
    | ScrollButtonColorMode of DevExpress.Xpf.Controls.Primitives.ScrollButtonColorMode

module ScrollableControl =
    let orientation v : obj = box (ScrollableControlProp.Orientation v)
    let scrollNext v : obj = box (ScrollableControlProp.ScrollNext v)
    let scrollPrev v : obj = box (ScrollableControlProp.ScrollPrev v)
    let isScrollable v : obj = box (ScrollableControlProp.IsScrollable v)
    let scrollButtonColorMode v : obj = box (ScrollableControlProp.ScrollButtonColorMode v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.ScrollableControl) (prop: ScrollableControlProp) =
        match prop with
        | ScrollableControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.ScrollableControl.OrientationProperty, box v)
        | ScrollableControlProp.ScrollNext v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.ScrollableControl.ScrollNextProperty, box v)
        | ScrollableControlProp.ScrollPrev v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.ScrollableControl.ScrollPrevProperty, box v)
        | ScrollableControlProp.IsScrollable v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.ScrollableControl.IsScrollableProperty, box v)
        | ScrollableControlProp.ScrollButtonColorMode v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.ScrollableControl.ScrollButtonColorModeProperty, box v)
    ...
    let scrollButtonMode (v: DevExpress.Xpf.Controls.Primitives.ScrollButtonMode) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Controls.Primitives.ScrollableControl.ScrollButtonModeProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.ScrollableControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
