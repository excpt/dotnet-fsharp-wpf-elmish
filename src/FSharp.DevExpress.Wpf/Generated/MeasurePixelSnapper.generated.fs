...
type MeasurePixelSnapperProp =
    | SnapperType of DevExpress.Xpf.Core.SnapperType

module MeasurePixelSnapper =
    let snapperType v : obj = box (MeasurePixelSnapperProp.SnapperType v)

    let apply (el: DevExpress.Xpf.Core.MeasurePixelSnapper) (prop: MeasurePixelSnapperProp) =
        match prop with
        | MeasurePixelSnapperProp.SnapperType v -> el.SetValue(DevExpress.Xpf.Core.MeasurePixelSnapper.SnapperTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.MeasurePixelSnapper>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
