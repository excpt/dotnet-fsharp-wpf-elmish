...
type AreaStepFullStackedSeries2DProp =
    | Base of AreaFullStackedSeries2DProp
    | SnapCrosshairToActualStep of bool

module AreaStepFullStackedSeries2D =
    let snapCrosshairToActualStep v : obj = box (AreaStepFullStackedSeries2DProp.SnapCrosshairToActualStep v)

    let apply (el: DevExpress.Xpf.Charts.AreaStepFullStackedSeries2D) (prop: AreaStepFullStackedSeries2DProp) =
        match prop with
        | AreaStepFullStackedSeries2DProp.Base p -> AreaFullStackedSeries2D.apply el p
        | AreaStepFullStackedSeries2DProp.SnapCrosshairToActualStep v -> el.SetValue(DevExpress.Xpf.Charts.AreaStepFullStackedSeries2D.SnapCrosshairToActualStepProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaStepFullStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
