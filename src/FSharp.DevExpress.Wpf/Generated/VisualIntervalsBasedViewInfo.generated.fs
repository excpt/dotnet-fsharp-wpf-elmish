...
type VisualIntervalsBasedViewInfoProp =
    | Base of VisualViewInfoBaseProp

module VisualIntervalsBasedViewInfo =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualIntervalsBasedViewInfo) (prop: VisualIntervalsBasedViewInfoProp) =
        match prop with
        | VisualIntervalsBasedViewInfoProp.Base p -> VisualViewInfoBase.apply el p
