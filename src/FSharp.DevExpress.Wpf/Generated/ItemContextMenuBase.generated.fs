...
type ItemContextMenuBaseProp =
    | Base of BaseLayoutElementMenuProp

module ItemContextMenuBase =

    let apply (el: DevExpress.Xpf.Docking.ItemContextMenuBase) (prop: ItemContextMenuBaseProp) =
        match prop with
        | ItemContextMenuBaseProp.Base p -> BaseLayoutElementMenu.apply el p
