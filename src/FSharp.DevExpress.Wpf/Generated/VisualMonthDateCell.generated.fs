...
type VisualMonthDateCellProp =
    | Base of VisualDateCellProp

module VisualMonthDateCell =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualMonthDateCell) (prop: VisualMonthDateCellProp) =
        match prop with
        | VisualMonthDateCellProp.Base p -> VisualDateCell.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualMonthDateCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
