...
type FlatCandleStick2DModelControlProp =
    | Base of PredefinedModelControlProp

module FlatCandleStick2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatCandleStick2DModelControl) (prop: FlatCandleStick2DModelControlProp) =
        match prop with
        | FlatCandleStick2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatCandleStick2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
