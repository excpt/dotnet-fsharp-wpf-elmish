...
open System
open System.Windows
open DevExpress.Xpf.Charts.Sankey
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SankeyDiagramControlProp =
    | DataSource of obj
    | SourceDataMember of string
    | TargetDataMember of string
    | WeightDataMember of string
    | Colorizer of DevExpress.Xpf.Charts.Sankey.SankeyColorizerBase
    | NodeTemplate of System.Windows.DataTemplate
    | NodeLabel of DevExpress.Xpf.Charts.Sankey.SankeyNodeLabel
    | ToolTipOptions of DevExpress.Xpf.Charts.Sankey.SankeyToolTipOptions
    | ToolTipItem of DevExpress.Xpf.Charts.Sankey.SankeyToolTipItem
    | NodeComparer of obj
    | LayoutAlgorithm of DevExpress.Xpf.Charts.Sankey.SankeyLayoutAlgorithmBase
    | ViewOptions of DevExpress.Xpf.Charts.Sankey.SankeyViewOptions
    | PrintOptions of DevExpress.Xpf.Charts.Sankey.SankeyPrintOptions
    | SmallSankeyText of DevExpress.Xpf.Charts.Sankey.SmallSankeyText
    | EmptySankeyText of DevExpress.Xpf.Charts.Sankey.EmptySankeyText
    | EnableHighlighting of obj
    | HighlightedItems of System.Collections.IList
    | SelectionMode of DevExpress.Xpf.Charts.Sankey.SankeySelectionMode
    | SelectedItems of System.Collections.IList
    | NodeToolTipContentTemplate of System.Windows.DataTemplate
    | LinkToolTipContentTemplate of System.Windows.DataTemplate
    | ToolTipTemplate of System.Windows.DataTemplate

module SankeyDiagramControl =
    let dataSource v : obj = box (SankeyDiagramControlProp.DataSource v)
    let sourceDataMember v : obj = box (SankeyDiagramControlProp.SourceDataMember v)
    let targetDataMember v : obj = box (SankeyDiagramControlProp.TargetDataMember v)
    let weightDataMember v : obj = box (SankeyDiagramControlProp.WeightDataMember v)
    let colorizer v : obj = box (SankeyDiagramControlProp.Colorizer v)
    let nodeTemplate v : obj = box (SankeyDiagramControlProp.NodeTemplate v)
    let nodeLabel v : obj = box (SankeyDiagramControlProp.NodeLabel v)
    let toolTipOptions v : obj = box (SankeyDiagramControlProp.ToolTipOptions v)
    let toolTipItem v : obj = box (SankeyDiagramControlProp.ToolTipItem v)
    let nodeComparer v : obj = box (SankeyDiagramControlProp.NodeComparer v)
    let layoutAlgorithm v : obj = box (SankeyDiagramControlProp.LayoutAlgorithm v)
    let viewOptions v : obj = box (SankeyDiagramControlProp.ViewOptions v)
    let printOptions v : obj = box (SankeyDiagramControlProp.PrintOptions v)
    let smallSankeyText v : obj = box (SankeyDiagramControlProp.SmallSankeyText v)
    let emptySankeyText v : obj = box (SankeyDiagramControlProp.EmptySankeyText v)
    let enableHighlighting v : obj = box (SankeyDiagramControlProp.EnableHighlighting v)
    let highlightedItems v : obj = box (SankeyDiagramControlProp.HighlightedItems v)
    let selectionMode v : obj = box (SankeyDiagramControlProp.SelectionMode v)
    let selectedItems v : obj = box (SankeyDiagramControlProp.SelectedItems v)
    let nodeToolTipContentTemplate v : obj = box (SankeyDiagramControlProp.NodeToolTipContentTemplate v)
    let linkToolTipContentTemplate v : obj = box (SankeyDiagramControlProp.LinkToolTipContentTemplate v)
    let toolTipTemplate v : obj = box (SankeyDiagramControlProp.ToolTipTemplate v)

    let apply (el: DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl) (prop: SankeyDiagramControlProp) =
        match prop with
        | SankeyDiagramControlProp.DataSource v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.DataSourceProperty, box v)
        | SankeyDiagramControlProp.SourceDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.SourceDataMemberProperty, box v)
        | SankeyDiagramControlProp.TargetDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.TargetDataMemberProperty, box v)
        | SankeyDiagramControlProp.WeightDataMember v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.WeightDataMemberProperty, box v)
        | SankeyDiagramControlProp.Colorizer v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.ColorizerProperty, box v)
        | SankeyDiagramControlProp.NodeTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.NodeTemplateProperty, box v)
        | SankeyDiagramControlProp.NodeLabel v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.NodeLabelProperty, box v)
        | SankeyDiagramControlProp.ToolTipOptions v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.ToolTipOptionsProperty, box v)
        | SankeyDiagramControlProp.ToolTipItem v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.ToolTipItemProperty, box v)
        | SankeyDiagramControlProp.NodeComparer v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.NodeComparerProperty, box v)
        | SankeyDiagramControlProp.LayoutAlgorithm v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.LayoutAlgorithmProperty, box v)
        | SankeyDiagramControlProp.ViewOptions v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.ViewOptionsProperty, box v)
        | SankeyDiagramControlProp.PrintOptions v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.PrintOptionsProperty, box v)
        | SankeyDiagramControlProp.SmallSankeyText v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.SmallSankeyTextProperty, box v)
        | SankeyDiagramControlProp.EmptySankeyText v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.EmptySankeyTextProperty, box v)
        | SankeyDiagramControlProp.EnableHighlighting v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.EnableHighlightingProperty, box v)
        | SankeyDiagramControlProp.HighlightedItems v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.HighlightedItemsProperty, box v)
        | SankeyDiagramControlProp.SelectionMode v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.SelectionModeProperty, box v)
        | SankeyDiagramControlProp.SelectedItems v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.SelectedItemsProperty, box v)
        | SankeyDiagramControlProp.NodeToolTipContentTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.NodeToolTipContentTemplateProperty, box v)
        | SankeyDiagramControlProp.LinkToolTipContentTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.LinkToolTipContentTemplateProperty, box v)
        | SankeyDiagramControlProp.ToolTipTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl.ToolTipTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.SankeyDiagramControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
