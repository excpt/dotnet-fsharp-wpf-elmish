...
type ControlBoxButtonProp =
    | Base of ControlBoxButtonProp
    | Content of obj
    ...
    | IsPressed of bool
    | IsActive of bool
    | BorderStyle of System.Windows.Style
    | OnClick of System.Windows.RoutedEventHandler

module ControlBoxButton =
    let content v : obj = box (ControlBoxButtonProp.Content v)
    let contentTemplate v : obj = box (ControlBoxButtonProp.ContentTemplate v)
    let contentTemplateSelector v : obj = box (ControlBoxButtonProp.ContentTemplateSelector v)
    let command v : obj = box (ControlBoxButtonProp.Command v)
    let commandParameter v : obj = box (ControlBoxButtonProp.CommandParameter v)
    let commandTarget v : obj = box (ControlBoxButtonProp.CommandTarget v)
    let hasCommand v : obj = box (ControlBoxButtonProp.HasCommand v)
    let isPressed v : obj = box (ControlBoxButtonProp.IsPressed v)
    let isActive v : obj = box (ControlBoxButtonProp.IsActive v)
    let borderStyle v : obj = box (ControlBoxButtonProp.BorderStyle v)
    let onClick v : obj = box (EventProp(box (ControlBoxButtonProp.OnClick v)))

    let apply (el: DevExpress.Xpf.Docking.ControlBoxButton) (prop: ControlBoxButtonProp) =
        match prop with
        | ControlBoxButtonProp.Base p -> ControlBoxButton.apply el p
        | ControlBoxButtonProp.Content v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.ContentProperty, box v)
        | ControlBoxButtonProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.ContentTemplateProperty, box v)
        | ControlBoxButtonProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.ContentTemplateSelectorProperty, box v)
        | ControlBoxButtonProp.Command v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.CommandProperty, box v)
        | ControlBoxButtonProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.CommandParameterProperty, box v)
        | ControlBoxButtonProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.CommandTargetProperty, box v)
        | ControlBoxButtonProp.HasCommand v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.HasCommandProperty, box v)
        | ControlBoxButtonProp.IsPressed v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.IsPressedProperty, box v)
        | ControlBoxButtonProp.IsActive v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.IsActiveProperty, box v)
        | ControlBoxButtonProp.BorderStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBoxButton.BorderStyleProperty, box v)
        | ControlBoxButtonProp.OnClick h -> el.Click.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.ControlBoxButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
