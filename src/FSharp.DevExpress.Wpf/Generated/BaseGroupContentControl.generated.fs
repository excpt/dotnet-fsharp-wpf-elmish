...
type BaseGroupContentControlProp =
    | Base of psvContentControlProp

module BaseGroupContentControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.BaseGroupContentControl) (prop: BaseGroupContentControlProp) =
        match prop with
        | BaseGroupContentControlProp.Base p -> psvContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.BaseGroupContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
