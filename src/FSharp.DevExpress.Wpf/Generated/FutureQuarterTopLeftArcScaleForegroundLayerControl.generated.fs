...
type FutureQuarterTopLeftArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module FutureQuarterTopLeftArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureQuarterTopLeftArcScaleForegroundLayerControl) (prop: FutureQuarterTopLeftArcScaleForegroundLayerControlProp) =
        match prop with
        | FutureQuarterTopLeftArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureQuarterTopLeftArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
