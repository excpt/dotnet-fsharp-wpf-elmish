...
type PopupBaseEditStyleSettingsProp =
    | Base of ButtonEditStyleSettingsProp

module PopupBaseEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupBaseEditStyleSettings) (prop: PopupBaseEditStyleSettingsProp) =
        match prop with
        | PopupBaseEditStyleSettingsProp.Base p -> ButtonEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupBaseEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
