...
type DataMatrixGS1StyleSettingsProp =
    | FNC1Substitute of string
    | HumanReadableText of bool
    | MatrixSize of DevExpress.XtraPrinting.BarCode.DataMatrixSize

module DataMatrixGS1StyleSettings =
    let fNC1Substitute v : obj = box (DataMatrixGS1StyleSettingsProp.FNC1Substitute v)
    let humanReadableText v : obj = box (DataMatrixGS1StyleSettingsProp.HumanReadableText v)
    let matrixSize v : obj = box (DataMatrixGS1StyleSettingsProp.MatrixSize v)

    let apply (el: DevExpress.Xpf.Editors.DataMatrixGS1StyleSettings) (prop: DataMatrixGS1StyleSettingsProp) =
        match prop with
        | DataMatrixGS1StyleSettingsProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Editors.DataMatrixGS1StyleSettings.FNC1SubstituteProperty, box v)
        | DataMatrixGS1StyleSettingsProp.HumanReadableText v -> el.SetValue(DevExpress.Xpf.Editors.DataMatrixGS1StyleSettings.HumanReadableTextProperty, box v)
        | DataMatrixGS1StyleSettingsProp.MatrixSize v -> el.SetValue(DevExpress.Xpf.Editors.DataMatrixGS1StyleSettings.MatrixSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DataMatrixGS1StyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
