...
type DefaultMatrix8x14ControlProp =
    | Base of SymbolPresentationControlProp

module DefaultMatrix8x14Control =

    let apply (el: DevExpress.Xpf.Gauges.DefaultMatrix8x14Control) (prop: DefaultMatrix8x14ControlProp) =
        match prop with
        | DefaultMatrix8x14ControlProp.Base p -> SymbolPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultMatrix8x14Control>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
