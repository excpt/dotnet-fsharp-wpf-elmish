...
type EcoSpindleCapControlProp =
    | Base of PresentationControlProp

module EcoSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoSpindleCapControl) (prop: EcoSpindleCapControlProp) =
        match prop with
        | EcoSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
