...
type DiamondMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module DiamondMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.DiamondMarkerModelControl) (prop: DiamondMarkerModelControlProp) =
        match prop with
        | DiamondMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.DiamondMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
