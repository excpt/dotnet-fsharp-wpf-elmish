...
type MapEditorPanelButtonProp =
    | Base of MapToggleButtonProp

module MapEditorPanelButton =

    let apply (el: DevExpress.Xpf.Map.MapEditorPanelButton) (prop: MapEditorPanelButtonProp) =
        match prop with
        | MapEditorPanelButtonProp.Base p -> MapToggleButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapEditorPanelButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
