...
type MapScalePanelProp =
    | KilometersScaleBarWidth of float
    | KilometersScaleText of string
    | MilesScaleBarWidth of float
    | MilesScaleText of string
    | ShowKilometersScale of bool
    | ShowMilesScale of bool
    | KilometersScale of float

module MapScalePanel =
    let kilometersScaleBarWidth v : obj = box (MapScalePanelProp.KilometersScaleBarWidth v)
    let kilometersScaleText v : obj = box (MapScalePanelProp.KilometersScaleText v)
    let milesScaleBarWidth v : obj = box (MapScalePanelProp.MilesScaleBarWidth v)
    let milesScaleText v : obj = box (MapScalePanelProp.MilesScaleText v)
    let showKilometersScale v : obj = box (MapScalePanelProp.ShowKilometersScale v)
    let showMilesScale v : obj = box (MapScalePanelProp.ShowMilesScale v)
    let kilometersScale v : obj = box (MapScalePanelProp.KilometersScale v)

    let apply (el: DevExpress.Xpf.Map.MapScalePanel) (prop: MapScalePanelProp) =
        match prop with
        | MapScalePanelProp.KilometersScaleBarWidth v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.KilometersScaleBarWidthProperty, box v)
        | MapScalePanelProp.KilometersScaleText v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.KilometersScaleTextProperty, box v)
        | MapScalePanelProp.MilesScaleBarWidth v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.MilesScaleBarWidthProperty, box v)
        | MapScalePanelProp.MilesScaleText v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.MilesScaleTextProperty, box v)
        | MapScalePanelProp.ShowKilometersScale v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.ShowKilometersScaleProperty, box v)
        | MapScalePanelProp.ShowMilesScale v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.ShowMilesScaleProperty, box v)
        | MapScalePanelProp.KilometersScale v -> el.SetValue(DevExpress.Xpf.Map.MapScalePanel.KilometersScaleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapScalePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
