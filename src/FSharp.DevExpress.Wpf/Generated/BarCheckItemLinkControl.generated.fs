...
type BarCheckItemLinkControlProp =
...
module BarCheckItemLinkControl =
    let isTriStateBorderVisible v : obj = box (BarCheckItemLinkControlProp.IsTriStateBorderVisible v)
    let isCheckVisible v : obj = box (BarCheckItemLinkControlProp.IsCheckVisible v)
    let isCheckGlyphBorderVisible v : obj = box (BarCheckItemLinkControlProp.IsCheckGlyphBorderVisible v)
    let isTriStateGlyphBorderVisible v : obj = box (BarCheckItemLinkControlProp.IsTriStateGlyphBorderVisible v)

    let apply (el: DevExpress.Xpf.Bars.BarCheckItemLinkControl) (prop: BarCheckItemLinkControlProp) =
        match prop with
        | BarCheckItemLinkControlProp.Base p -> BarButtonItemLinkControl.apply el p
        | BarCheckItemLinkControlProp.IsTriStateBorderVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarCheckItemLinkControl.IsTriStateBorderVisibleProperty, box v)
        | BarCheckItemLinkControlProp.IsCheckVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarCheckItemLinkControl.IsCheckVisibleProperty, box v)
        | BarCheckItemLinkControlProp.IsCheckGlyphBorderVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarCheckItemLinkControl.IsCheckGlyphBorderVisibleProperty, box v)
        | BarCheckItemLinkControlProp.IsTriStateGlyphBorderVisible v -> el.SetValue(DevExpress.Xpf.Bars.BarCheckItemLinkControl.IsTriStateGlyphBorderVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarCheckItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
