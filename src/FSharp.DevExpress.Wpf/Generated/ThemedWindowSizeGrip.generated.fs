...
type ThemedWindowSizeGripProp =
    | Base of ThumbProp

module ThemedWindowSizeGrip =

    let apply (el: DevExpress.Xpf.Core.ThemedWindowSizeGrip) (prop: ThemedWindowSizeGripProp) =
        match prop with
        | ThemedWindowSizeGripProp.Base p -> Thumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowSizeGrip>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
