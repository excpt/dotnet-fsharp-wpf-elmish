...
type FlatLightArcScaleLineControlProp =
    | Base of PresentationControlProp

module FlatLightArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightArcScaleLineControl) (prop: FlatLightArcScaleLineControlProp) =
        match prop with
        | FlatLightArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
