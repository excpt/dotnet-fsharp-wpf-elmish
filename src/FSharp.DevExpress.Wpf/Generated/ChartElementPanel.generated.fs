...
type ChartElementPanelProp =
    | Base of Chart2DElementPanelBaseProp

module ChartElementPanel =

    let apply (el: DevExpress.Xpf.Charts.ChartElementPanel) (prop: ChartElementPanelProp) =
        match prop with
        | ChartElementPanelProp.Base p -> Chart2DElementPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartElementPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
