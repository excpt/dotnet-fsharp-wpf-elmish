...
type BarItemLinkControlToolTipProp =
    | UseToolTipPlacementTarget of bool

module BarItemLinkControlToolTip =
    let useToolTipPlacementTarget v : obj = box (BarItemLinkControlToolTipProp.UseToolTipPlacementTarget v)

    let apply (el: DevExpress.Xpf.Bars.BarItemLinkControlToolTip) (prop: BarItemLinkControlToolTipProp) =
        match prop with
        | BarItemLinkControlToolTipProp.UseToolTipPlacementTarget v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkControlToolTip.UseToolTipPlacementTargetProperty, box v)
    ...
    let horizontalPlacement (v: DevExpress.Xpf.Bars.BarItemLinkControlToolTipHorizontalPlacement) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Bars.BarItemLinkControlToolTip.HorizontalPlacementProperty, box v)) :: node.Props }
    let verticalPlacement (v: DevExpress.Xpf.Bars.BarItemLinkControlToolTipVerticalPlacement) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Bars.BarItemLinkControlToolTip.VerticalPlacementProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Bars.BarItemLinkControlToolTip>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
