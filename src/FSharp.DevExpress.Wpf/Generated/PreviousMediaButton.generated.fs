...
type PreviousMediaButtonProp =
    | Base of MediaButtonProp

module PreviousMediaButton =

    let apply (el: DevExpress.Xpf.Controls.PreviousMediaButton) (prop: PreviousMediaButtonProp) =
        match prop with
        | PreviousMediaButtonProp.Base p -> MediaButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.PreviousMediaButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
