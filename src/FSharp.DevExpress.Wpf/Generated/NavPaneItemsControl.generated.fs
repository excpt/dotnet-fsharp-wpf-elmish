...
type NavPaneItemsControlProp =
    | VisibleElementCount of int
    | Orientation of obj
    | NavBar of DevExpress.Xpf.NavBar.NavBarControl
    | ItemsSourceCore of System.Collections.Specialized.INotifyCollectionChanged

module NavPaneItemsControl =
    let visibleElementCount v : obj = box (NavPaneItemsControlProp.VisibleElementCount v)
    let orientation v : obj = box (NavPaneItemsControlProp.Orientation v)
    let navBar v : obj = box (NavPaneItemsControlProp.NavBar v)
    let itemsSourceCore v : obj = box (NavPaneItemsControlProp.ItemsSourceCore v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneItemsControl) (prop: NavPaneItemsControlProp) =
        match prop with
        | NavPaneItemsControlProp.VisibleElementCount v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneItemsControl.VisibleElementCountProperty, box v)
        | NavPaneItemsControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneItemsControl.OrientationProperty, box v)
        | NavPaneItemsControlProp.NavBar v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneItemsControl.NavBarProperty, box v)
        | NavPaneItemsControlProp.ItemsSourceCore v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneItemsControl.ItemsSourceCoreProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
