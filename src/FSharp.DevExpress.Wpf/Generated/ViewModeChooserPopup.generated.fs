...
type ViewModeChooserPopupProp =
    | SliderValue of float
    | SliderTicks of System.Windows.Media.DoubleCollection
    | SliderMaximum of float
    | OnSliderInitialized of DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup+SliderInitializedEventHandler
    | OnSliderValueChanged of DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup+SliderValueChangedEventHandler
    | OnViewModeBarButtonClick of DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup+ViewModeBarButtonClickEventHandler

module ViewModeChooserPopup =
    let sliderValue v : obj = box (ViewModeChooserPopupProp.SliderValue v)
    let sliderTicks v : obj = box (ViewModeChooserPopupProp.SliderTicks v)
    let sliderMaximum v : obj = box (ViewModeChooserPopupProp.SliderMaximum v)
    let onSliderInitialized v : obj = box (EventProp(box (ViewModeChooserPopupProp.OnSliderInitialized v)))
    let onSliderValueChanged v : obj = box (EventProp(box (ViewModeChooserPopupProp.OnSliderValueChanged v)))
    let onViewModeBarButtonClick v : obj = box (EventProp(box (ViewModeChooserPopupProp.OnViewModeBarButtonClick v)))

    let apply (el: DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup) (prop: ViewModeChooserPopupProp) =
        match prop with
        | ViewModeChooserPopupProp.SliderValue v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup.SliderValueProperty, box v)
        | ViewModeChooserPopupProp.SliderTicks v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup.SliderTicksProperty, box v)
        | ViewModeChooserPopupProp.SliderMaximum v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup.SliderMaximumProperty, box v)
        | ViewModeChooserPopupProp.OnSliderInitialized h -> el.SliderInitialized.AddHandler(h)
        | ViewModeChooserPopupProp.OnSliderValueChanged h -> el.SliderValueChanged.AddHandler(h)
        | ViewModeChooserPopupProp.OnViewModeBarButtonClick h -> el.ViewModeBarButtonClick.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.ViewModeChooserPopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
