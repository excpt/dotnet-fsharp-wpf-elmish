...
type GridPainterProp =
    | PageMargin of System.Windows.Thickness
    | PageSize of System.Windows.Size
    | GridSize of obj
    | LineBrush of System.Windows.Media.Brush
    | MeasureUnit of DevExpress.Diagram.Core.MeasureUnit
    | Offset of System.Windows.Point
    | Location of System.Windows.Point
    | Viewport of System.Windows.Size
    | ZoomFactor of float

module GridPainter =
    let pageMargin v : obj = box (GridPainterProp.PageMargin v)
    let pageSize v : obj = box (GridPainterProp.PageSize v)
    let gridSize v : obj = box (GridPainterProp.GridSize v)
    let lineBrush v : obj = box (GridPainterProp.LineBrush v)
    let measureUnit v : obj = box (GridPainterProp.MeasureUnit v)
    let offset v : obj = box (GridPainterProp.Offset v)
    let location v : obj = box (GridPainterProp.Location v)
    let viewport v : obj = box (GridPainterProp.Viewport v)
    let zoomFactor v : obj = box (GridPainterProp.ZoomFactor v)

    let apply (el: DevExpress.Xpf.Diagram.Native.GridPainter) (prop: GridPainterProp) =
        match prop with
        | GridPainterProp.PageMargin v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.PageMarginProperty, box v)
        | GridPainterProp.PageSize v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.PageSizeProperty, box v)
        | GridPainterProp.GridSize v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.GridSizeProperty, box v)
        | GridPainterProp.LineBrush v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.LineBrushProperty, box v)
        | GridPainterProp.MeasureUnit v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.MeasureUnitProperty, box v)
        | GridPainterProp.Offset v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.OffsetProperty, box v)
        | GridPainterProp.Location v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.LocationProperty, box v)
        | GridPainterProp.Viewport v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.ViewportProperty, box v)
        | GridPainterProp.ZoomFactor v -> el.SetValue(DevExpress.Xpf.Diagram.Native.GridPainter.ZoomFactorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.GridPainter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
