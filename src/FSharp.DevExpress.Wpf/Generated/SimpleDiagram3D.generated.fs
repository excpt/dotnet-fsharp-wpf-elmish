...
type SimpleDiagram3DProp =
    | Base of Diagram3DProp
    | Dimension of int
    | LayoutDirection of DevExpress.Xpf.Charts.LayoutDirection

module SimpleDiagram3D =
    let dimension v : obj = box (SimpleDiagram3DProp.Dimension v)
    let layoutDirection v : obj = box (SimpleDiagram3DProp.LayoutDirection v)

    let apply (el: DevExpress.Xpf.Charts.SimpleDiagram3D) (prop: SimpleDiagram3DProp) =
        match prop with
        | SimpleDiagram3DProp.Base p -> Diagram3D.apply el p
        | SimpleDiagram3DProp.Dimension v -> el.SetValue(DevExpress.Xpf.Charts.SimpleDiagram3D.DimensionProperty, box v)
        | SimpleDiagram3DProp.LayoutDirection v -> el.SetValue(DevExpress.Xpf.Charts.SimpleDiagram3D.LayoutDirectionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleDiagram3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
