...
module DXSelector =
    ...
    let apply (el: DevExpress.Xpf.Editors.DXSelector) (prop: DXSelectorProp) =
        match prop with
        | DXSelectorProp.Base p -> DXItemsControl.apply el p
        | DXSelectorProp.SelectedIndex v -> el.SetValue(DevExpress.Xpf.Editors.DXSelector.SelectedIndexProperty, box v)
        | DXSelectorProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Editors.DXSelector.SelectedItemProperty, box v)
        | DXSelectorProp.SelectedValue v -> el.SetValue(DevExpress.Xpf.Editors.DXSelector.SelectedValueProperty, box v)
        | DXSelectorProp.SelectedValuePath v -> el.SetValue(DevExpress.Xpf.Editors.DXSelector.SelectedValuePathProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DXSelector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
