...
type DigitalSmartModelProp =
    | Base of DigitalGaugeModelProp

module DigitalSmartModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalSmartModel) (prop: DigitalSmartModelProp) =
        match prop with
        | DigitalSmartModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalSmartModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
