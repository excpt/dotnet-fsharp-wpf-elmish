...
type FilterStringEditorProp =
    | Base of FilterStringUITypeEditorBaseProp
    | Properties of DevExpress.Xpf.Editors.Filtering.PropertyInfoCollection
    | FilterPresenter of DevExpress.DataAccess.Native.Filtering.IFilterPresenter
    | ExistingParameters of obj

module FilterStringEditor =
    let properties v : obj = box (FilterStringEditorProp.Properties v)
    let filterPresenter v : obj = box (FilterStringEditorProp.FilterPresenter v)
    let existingParameters v : obj = box (FilterStringEditorProp.ExistingParameters v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.FilterStringEditor) (prop: FilterStringEditorProp) =
        match prop with
        | FilterStringEditorProp.Base p -> FilterStringUITypeEditorBase.apply el p
        | FilterStringEditorProp.Properties v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringEditor.PropertiesProperty, box v)
        | FilterStringEditorProp.FilterPresenter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringEditor.FilterPresenterProperty, box v)
        | FilterStringEditorProp.ExistingParameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringEditor.ExistingParametersProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.FilterStringEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
