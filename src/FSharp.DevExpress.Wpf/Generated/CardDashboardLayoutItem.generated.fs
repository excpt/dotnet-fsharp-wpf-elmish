...
type CardDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module CardDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.CardDashboardLayoutItem) (prop: CardDashboardLayoutItemProp) =
        match prop with
        | CardDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.CardDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
