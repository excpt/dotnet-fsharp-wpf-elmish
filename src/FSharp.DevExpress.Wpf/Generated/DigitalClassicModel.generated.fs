...
type DigitalClassicModelProp =
    | Base of DigitalGaugeModelProp

module DigitalClassicModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalClassicModel) (prop: DigitalClassicModelProp) =
        match prop with
        | DigitalClassicModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalClassicModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
