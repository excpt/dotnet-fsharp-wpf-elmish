...
type PopupViewModelProp =
    | Base of EditorViewModelBaseProp
    | NullValueButtonVisibility of System.Windows.Visibility
    | AddNewButtonVisibility of System.Windows.Visibility
    | OkButtonVisibility of System.Windows.Visibility
    | CancelButtonVisibility of System.Windows.Visibility
    | CloseButtonVisibility of System.Windows.Visibility
    | FooterVisibility of System.Windows.Visibility
    | DropOpposite of bool
    | OkButtonIsEnabled of bool
    | IsLeft of bool

module PopupViewModel =
    let nullValueButtonVisibility v : obj = box (PopupViewModelProp.NullValueButtonVisibility v)
    let addNewButtonVisibility v : obj = box (PopupViewModelProp.AddNewButtonVisibility v)
    let okButtonVisibility v : obj = box (PopupViewModelProp.OkButtonVisibility v)
    let cancelButtonVisibility v : obj = box (PopupViewModelProp.CancelButtonVisibility v)
    let closeButtonVisibility v : obj = box (PopupViewModelProp.CloseButtonVisibility v)
    let footerVisibility v : obj = box (PopupViewModelProp.FooterVisibility v)
    let dropOpposite v : obj = box (PopupViewModelProp.DropOpposite v)
    let okButtonIsEnabled v : obj = box (PopupViewModelProp.OkButtonIsEnabled v)
    let isLeft v : obj = box (PopupViewModelProp.IsLeft v)

    let apply (el: DevExpress.Xpf.Editors.PopupViewModel) (prop: PopupViewModelProp) =
        match prop with
        | PopupViewModelProp.Base p -> EditorViewModelBase.apply el p
        | PopupViewModelProp.NullValueButtonVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.NullValueButtonVisibilityProperty, box v)
        | PopupViewModelProp.AddNewButtonVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.AddNewButtonVisibilityProperty, box v)
        | PopupViewModelProp.OkButtonVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.OkButtonVisibilityProperty, box v)
        | PopupViewModelProp.CancelButtonVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.CancelButtonVisibilityProperty, box v)
        | PopupViewModelProp.CloseButtonVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.CloseButtonVisibilityProperty, box v)
        | PopupViewModelProp.FooterVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.FooterVisibilityProperty, box v)
        | PopupViewModelProp.DropOpposite v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.DropOppositeProperty, box v)
        | PopupViewModelProp.OkButtonIsEnabled v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.OkButtonIsEnabledProperty, box v)
        | PopupViewModelProp.IsLeft v -> el.SetValue(DevExpress.Xpf.Editors.PopupViewModel.IsLeftProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupViewModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
