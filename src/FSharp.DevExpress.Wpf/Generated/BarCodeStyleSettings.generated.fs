...
type BarCodeStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp

module BarCodeStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.BarCodeStyleSettings) (prop: BarCodeStyleSettingsProp) =
        match prop with
        | BarCodeStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
