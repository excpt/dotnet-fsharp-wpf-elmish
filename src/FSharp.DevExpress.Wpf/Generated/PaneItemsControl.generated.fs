...
type PaneItemsControlProp =
    | Base of Diagram2DItemsControlProp
    | Pane of DevExpress.Xpf.Charts.Pane
    | PaneContent of System.Windows.UIElement
    | ScaleBreaksContainerControl of System.Windows.UIElement
    | MirrorControl of System.Windows.UIElement
    | Pseudo3DMirrorControl of System.Windows.UIElement
    | CrosshairContainer of System.Windows.UIElement
    | Pseudo3DBarSeriesContainer of System.Windows.UIElement
    | SelectionControl of System.Windows.UIElement
    | PaneItems of obj
    | SeriesLabelItems of obj
    | TotalLabelItems of obj
    | AxisXScrollBarItem of DevExpress.Xpf.Charts.ScrollBarItem
    | AxisYScrollBarItem of DevExpress.Xpf.Charts.ScrollBarItem
    | AnnotationContainer of System.Windows.UIElement
    | LegendsContainer of System.Windows.UIElement
    | ChartDataTable of System.Windows.UIElement

module PaneItemsControl =
    let pane v : obj = box (PaneItemsControlProp.Pane v)
    let paneContent v : obj = box (PaneItemsControlProp.PaneContent v)
    let scaleBreaksContainerControl v : obj = box (PaneItemsControlProp.ScaleBreaksContainerControl v)
    let mirrorControl v : obj = box (PaneItemsControlProp.MirrorControl v)
    let pseudo3DMirrorControl v : obj = box (PaneItemsControlProp.Pseudo3DMirrorControl v)
    let crosshairContainer v : obj = box (PaneItemsControlProp.CrosshairContainer v)
    let pseudo3DBarSeriesContainer v : obj = box (PaneItemsControlProp.Pseudo3DBarSeriesContainer v)
    let selectionControl v : obj = box (PaneItemsControlProp.SelectionControl v)
    let paneItems v : obj = box (PaneItemsControlProp.PaneItems v)
    let seriesLabelItems v : obj = box (PaneItemsControlProp.SeriesLabelItems v)
    let totalLabelItems v : obj = box (PaneItemsControlProp.TotalLabelItems v)
    let axisXScrollBarItem v : obj = box (PaneItemsControlProp.AxisXScrollBarItem v)
    let axisYScrollBarItem v : obj = box (PaneItemsControlProp.AxisYScrollBarItem v)
    let annotationContainer v : obj = box (PaneItemsControlProp.AnnotationContainer v)
    let legendsContainer v : obj = box (PaneItemsControlProp.LegendsContainer v)
    let chartDataTable v : obj = box (PaneItemsControlProp.ChartDataTable v)

    let apply (el: DevExpress.Xpf.Charts.PaneItemsControl) (prop: PaneItemsControlProp) =
        match prop with
        | PaneItemsControlProp.Base p -> Diagram2DItemsControl.apply el p
        | PaneItemsControlProp.Pane v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.PaneProperty, box v)
        | PaneItemsControlProp.PaneContent v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.PaneContentProperty, box v)
        | PaneItemsControlProp.ScaleBreaksContainerControl v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.ScaleBreaksContainerControlProperty, box v)
        | PaneItemsControlProp.MirrorControl v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.MirrorControlProperty, box v)
        | PaneItemsControlProp.Pseudo3DMirrorControl v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.Pseudo3DMirrorControlProperty, box v)
        | PaneItemsControlProp.CrosshairContainer v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.CrosshairContainerProperty, box v)
        | PaneItemsControlProp.Pseudo3DBarSeriesContainer v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.Pseudo3DBarSeriesContainerProperty, box v)
        | PaneItemsControlProp.SelectionControl v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.SelectionControlProperty, box v)
        | PaneItemsControlProp.PaneItems v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.PaneItemsProperty, box v)
        | PaneItemsControlProp.SeriesLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.SeriesLabelItemsProperty, box v)
        | PaneItemsControlProp.TotalLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.TotalLabelItemsProperty, box v)
        | PaneItemsControlProp.AxisXScrollBarItem v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.AxisXScrollBarItemProperty, box v)
        | PaneItemsControlProp.AxisYScrollBarItem v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.AxisYScrollBarItemProperty, box v)
        | PaneItemsControlProp.AnnotationContainer v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.AnnotationContainerProperty, box v)
        | PaneItemsControlProp.LegendsContainer v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.LegendsContainerProperty, box v)
        | PaneItemsControlProp.ChartDataTable v -> el.SetValue(DevExpress.Xpf.Charts.PaneItemsControl.ChartDataTableProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PaneItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
