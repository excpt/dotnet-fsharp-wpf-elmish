...
open System
open System.Windows
open DevExpress.Xpf.Scheduling.Editors
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type RecurrenceInfoControlBaseProp =
    | RecurrenceInfo of DevExpress.XtraScheduler.IRecurrenceInfo

module RecurrenceInfoControlBase =
    let recurrenceInfo v : obj = box (RecurrenceInfoControlBaseProp.RecurrenceInfo v)

    let apply (el: DevExpress.Xpf.Scheduling.Editors.RecurrenceInfoControlBase) (prop: RecurrenceInfoControlBaseProp) =
        match prop with
        | RecurrenceInfoControlBaseProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduling.Editors.RecurrenceInfoControlBase.RecurrenceInfoProperty, box v)
