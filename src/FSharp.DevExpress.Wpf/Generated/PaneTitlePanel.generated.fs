...
type PaneTitlePanelProp =
    | Title of DevExpress.Xpf.Charts.PaneTitle

module PaneTitlePanel =
    let title v : obj = box (PaneTitlePanelProp.Title v)

    let apply (el: DevExpress.Xpf.Charts.PaneTitlePanel) (prop: PaneTitlePanelProp) =
        match prop with
        | PaneTitlePanelProp.Title v -> el.SetValue(DevExpress.Xpf.Charts.PaneTitlePanel.TitleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PaneTitlePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
