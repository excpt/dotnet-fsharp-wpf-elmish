...
type RibbonCheckedBorderControlProp =
    | IsChecked of obj
    | MergeCheckedStates of bool
    | IsLeftButtonPressed of bool
    | UseAppFocusValue of bool
    | AppFocusValue of bool
    | Color of System.Windows.Media.Color
    | IsInRibbonWindow of bool
    | ToggleIsCheckedOnClick of bool

module RibbonCheckedBorderControl =
    let isChecked v : obj = box (RibbonCheckedBorderControlProp.IsChecked v)
    let mergeCheckedStates v : obj = box (RibbonCheckedBorderControlProp.MergeCheckedStates v)
    let isLeftButtonPressed v : obj = box (RibbonCheckedBorderControlProp.IsLeftButtonPressed v)
    let useAppFocusValue v : obj = box (RibbonCheckedBorderControlProp.UseAppFocusValue v)
    let appFocusValue v : obj = box (RibbonCheckedBorderControlProp.AppFocusValue v)
    let color v : obj = box (RibbonCheckedBorderControlProp.Color v)
    let isInRibbonWindow v : obj = box (RibbonCheckedBorderControlProp.IsInRibbonWindow v)
    let toggleIsCheckedOnClick v : obj = box (RibbonCheckedBorderControlProp.ToggleIsCheckedOnClick v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl) (prop: RibbonCheckedBorderControlProp) =
        match prop with
        | RibbonCheckedBorderControlProp.IsChecked v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.IsCheckedProperty, box v)
        | RibbonCheckedBorderControlProp.MergeCheckedStates v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.MergeCheckedStatesProperty, box v)
        | RibbonCheckedBorderControlProp.IsLeftButtonPressed v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.IsLeftButtonPressedProperty, box v)
        | RibbonCheckedBorderControlProp.UseAppFocusValue v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.UseAppFocusValueProperty, box v)
        | RibbonCheckedBorderControlProp.AppFocusValue v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.AppFocusValueProperty, box v)
        | RibbonCheckedBorderControlProp.Color v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.ColorProperty, box v)
        | RibbonCheckedBorderControlProp.IsInRibbonWindow v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.IsInRibbonWindowProperty, box v)
        | RibbonCheckedBorderControlProp.ToggleIsCheckedOnClick v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl.ToggleIsCheckedOnClickProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonCheckedBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
