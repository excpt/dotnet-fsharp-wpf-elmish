...
type SuperTipItemControlProp =
    | Base of SuperTipItemControlBaseProp

module SuperTipItemControl =

    let apply (el: DevExpress.Xpf.Core.SuperTipItemControl) (prop: SuperTipItemControlProp) =
        match prop with
        | SuperTipItemControlProp.Base p -> SuperTipItemControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SuperTipItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
