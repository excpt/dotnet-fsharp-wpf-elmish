...
type LegendItemPresentationProp =
    | Base of ChartElementBaseProp

module LegendItemPresentation =

    let apply (el: DevExpress.Xpf.Charts.LegendItemPresentation) (prop: LegendItemPresentationProp) =
        match prop with
        | LegendItemPresentationProp.Base p -> ChartElementBase.apply el p
