...
type PageSetupControlProp =
    | Base of ReferenceEditBaseControlProp

module PageSetupControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PageSetupControl) (prop: PageSetupControlProp) =
        match prop with
        | PageSetupControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PageSetupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
