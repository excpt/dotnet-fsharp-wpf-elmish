...
type ThemedWindowTitleProp =
    | TitleAlignment of DevExpress.Xpf.Core.WindowTitleAlignment

module ThemedWindowTitle =
    let titleAlignment v : obj = box (ThemedWindowTitleProp.TitleAlignment v)

    let apply (el: DevExpress.Xpf.Core.ThemedWindowTitle) (prop: ThemedWindowTitleProp) =
        match prop with
        | ThemedWindowTitleProp.TitleAlignment v -> el.SetValue(DevExpress.Xpf.Core.ThemedWindowTitle.TitleAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowTitle>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
