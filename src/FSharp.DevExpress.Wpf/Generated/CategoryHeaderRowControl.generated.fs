...
open System
open System.Windows
open DevExpress.Xpf.PropertyGrid.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type CategoryHeaderRowControlProp =
    | IsSelected of bool
    | Glyph of System.Windows.Media.ImageSource
    | GlyphTemplate of System.Windows.DataTemplate
    | StringTemplate of System.Windows.DataTemplate

module CategoryHeaderRowControl =
    let isSelected v : obj = box (CategoryHeaderRowControlProp.IsSelected v)
    let glyph v : obj = box (CategoryHeaderRowControlProp.Glyph v)
    let glyphTemplate v : obj = box (CategoryHeaderRowControlProp.GlyphTemplate v)
    let stringTemplate v : obj = box (CategoryHeaderRowControlProp.StringTemplate v)

    let apply (el: DevExpress.Xpf.PropertyGrid.Internal.CategoryHeaderRowControl) (prop: CategoryHeaderRowControlProp) =
        match prop with
        | CategoryHeaderRowControlProp.IsSelected v -> el.SetValue(DevExpress.Xpf.PropertyGrid.Internal.CategoryHeaderRowControl.IsSelectedProperty, box v)
        | CategoryHeaderRowControlProp.Glyph v -> el.SetValue(DevExpress.Xpf.PropertyGrid.Internal.CategoryHeaderRowControl.GlyphProperty, box v)
        | CategoryHeaderRowControlProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.PropertyGrid.Internal.CategoryHeaderRowControl.GlyphTemplateProperty, box v)
        | CategoryHeaderRowControlProp.StringTemplate v -> el.SetValue(DevExpress.Xpf.PropertyGrid.Internal.CategoryHeaderRowControl.StringTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.Internal.CategoryHeaderRowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
