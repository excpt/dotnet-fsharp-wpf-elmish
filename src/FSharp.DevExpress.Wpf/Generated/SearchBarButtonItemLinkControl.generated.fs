...
type SearchBarButtonItemLinkControlProp =
    | Base of BarButtonItemLinkControlProp

module SearchBarButtonItemLinkControl =

    let apply (el: DevExpress.Xpf.DocumentViewer.SearchBarButtonItemLinkControl) (prop: SearchBarButtonItemLinkControlProp) =
        match prop with
        | SearchBarButtonItemLinkControlProp.Base p -> BarButtonItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.SearchBarButtonItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
