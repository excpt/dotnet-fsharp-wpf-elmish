...
type CameraControlProp =
    | AllowAutoStart of bool
    | ShowSettingsButton of bool
    | Stretch of System.Windows.Media.Stretch
    | StretchDirection of System.Windows.Controls.StretchDirection
    | DeviceInfo of DevExpress.Xpf.Editors.DeviceInfo
    | BorderTemplate of System.Windows.Controls.ControlTemplate
    | Provider of obj
    | ShowBorder of bool

module CameraControl =
    let allowAutoStart v : obj = box (CameraControlProp.AllowAutoStart v)
    let showSettingsButton v : obj = box (CameraControlProp.ShowSettingsButton v)
    let stretch v : obj = box (CameraControlProp.Stretch v)
    let stretchDirection v : obj = box (CameraControlProp.StretchDirection v)
    let deviceInfo v : obj = box (CameraControlProp.DeviceInfo v)
    let borderTemplate v : obj = box (CameraControlProp.BorderTemplate v)
    let provider v : obj = box (CameraControlProp.Provider v)
    let showBorder v : obj = box (CameraControlProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.Editors.CameraControl) (prop: CameraControlProp) =
        match prop with
        | CameraControlProp.AllowAutoStart v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.AllowAutoStartProperty, box v)
        | CameraControlProp.ShowSettingsButton v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.ShowSettingsButtonProperty, box v)
        | CameraControlProp.Stretch v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.StretchProperty, box v)
        | CameraControlProp.StretchDirection v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.StretchDirectionProperty, box v)
        | CameraControlProp.DeviceInfo v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.DeviceInfoProperty, box v)
        | CameraControlProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.BorderTemplateProperty, box v)
        | CameraControlProp.Provider v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.PropertyProviderProperty, box v)
        | CameraControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Editors.CameraControl.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CameraControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
