...
type GroupBoxButtonProp =
    | Base of DXButtonProp

module GroupBoxButton =

    let apply (el: DevExpress.Xpf.LayoutControl.GroupBoxButton) (prop: GroupBoxButtonProp) =
        match prop with
        | GroupBoxButtonProp.Base p -> DXButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.GroupBoxButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
