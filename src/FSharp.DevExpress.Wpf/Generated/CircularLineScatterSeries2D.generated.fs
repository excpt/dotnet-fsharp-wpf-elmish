...
type CircularLineScatterSeries2DProp =
    | Base of CircularLineSeries2DProp

module CircularLineScatterSeries2D =

    let apply (el: DevExpress.Xpf.Charts.CircularLineScatterSeries2D) (prop: CircularLineScatterSeries2DProp) =
        match prop with
        | CircularLineScatterSeries2DProp.Base p -> CircularLineSeries2D.apply el p
