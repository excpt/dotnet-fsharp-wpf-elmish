...
type CaptionImageProp =
    | Base of DXImageProp

module CaptionImage =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.CaptionImage) (prop: CaptionImageProp) =
        match prop with
        | CaptionImageProp.Base p -> DXImage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.CaptionImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
