...
type DirectionButtonProp =
    | Direction of DevExpress.Xpf.Controls.Primitives.ButtonDirection

module DirectionButton =
    let direction v : obj = box (DirectionButtonProp.Direction v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.DirectionButton) (prop: DirectionButtonProp) =
        match prop with
        | DirectionButtonProp.Direction v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.DirectionButton.DirectionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.DirectionButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
