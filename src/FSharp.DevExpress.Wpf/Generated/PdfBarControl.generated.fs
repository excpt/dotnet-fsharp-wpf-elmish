...
type PdfBarControlProp =
    | Base of BarControlProp

module PdfBarControl =

    let apply (el: DevExpress.Xpf.PdfViewer.PdfBarControl) (prop: PdfBarControlProp) =
        match prop with
        | PdfBarControlProp.Base p -> BarControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
