...
type AreaSeries2DProp =
    ...
    | Border of DevExpress.Xpf.Charts.SeriesBorder

module AreaSeries2D =
    let markerModel v : obj = box (AreaSeries2DProp.MarkerModel v)
    let markerSize v : obj = box (AreaSeries2DProp.MarkerSize v)
    let markerVisible v : obj = box (AreaSeries2DProp.MarkerVisible v)
    let transparency v : obj = box (AreaSeries2DProp.Transparency v)
    let pointAnimation v : obj = box (AreaSeries2DProp.PointAnimation v)
    let seriesAnimation v : obj = box (AreaSeries2DProp.SeriesAnimation v)
    let border v : obj = box (AreaSeries2DProp.Border v)

    let apply (el: DevExpress.Xpf.Charts.AreaSeries2D) (prop: AreaSeries2DProp) =
        match prop with
        | AreaSeries2DProp.Base p -> SegmentSeries2DBase.apply el p
        | AreaSeries2DProp.MarkerModel v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.MarkerModelProperty, box v)
        | AreaSeries2DProp.MarkerSize v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.MarkerSizeProperty, box v)
        | AreaSeries2DProp.MarkerVisible v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.MarkerVisibleProperty, box v)
        | AreaSeries2DProp.Transparency v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.TransparencyProperty, box v)
        | AreaSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.PointAnimationProperty, box v)
        | AreaSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.SeriesAnimationProperty, box v)
        | AreaSeries2DProp.Border v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries2D.BorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
