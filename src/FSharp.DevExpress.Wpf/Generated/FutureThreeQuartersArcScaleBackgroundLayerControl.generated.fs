...
type FutureThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureThreeQuartersArcScaleBackgroundLayerControl) (prop: FutureThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | FutureThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
