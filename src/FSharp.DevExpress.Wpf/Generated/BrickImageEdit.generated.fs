...
type BrickImageEditProp =
    | Base of BaseEditProp
    | Renderer of DevExpress.Xpf.Printing.PreviewControl.Native.Editing.IPictureRenderer
    | Source of DevExpress.XtraPrinting.Drawing.ImageSource
    | EmptyContentTemplate of System.Windows.Controls.ControlTemplate
    | MenuTemplate of System.Windows.Controls.ControlTemplate
    | MenuContainerTemplate of System.Windows.Controls.ControlTemplate
    | OpenFileDialogServiceTemplate of System.Windows.DataTemplate
    | MessageBoxServiceTemplate of System.Windows.DataTemplate

module BrickImageEdit =
    let renderer v : obj = box (BrickImageEditProp.Renderer v)
    let source v : obj = box (BrickImageEditProp.Source v)
    let emptyContentTemplate v : obj = box (BrickImageEditProp.EmptyContentTemplate v)
    let menuTemplate v : obj = box (BrickImageEditProp.MenuTemplate v)
    let menuContainerTemplate v : obj = box (BrickImageEditProp.MenuContainerTemplate v)
    let openFileDialogServiceTemplate v : obj = box (BrickImageEditProp.OpenFileDialogServiceTemplate v)
    let messageBoxServiceTemplate v : obj = box (BrickImageEditProp.MessageBoxServiceTemplate v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit) (prop: BrickImageEditProp) =
        match prop with
        | BrickImageEditProp.Base p -> BaseEdit.apply el p
        | BrickImageEditProp.Renderer v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.RendererProperty, box v)
        | BrickImageEditProp.Source v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.SourceProperty, box v)
        | BrickImageEditProp.EmptyContentTemplate v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.EmptyContentTemplateProperty, box v)
        | BrickImageEditProp.MenuTemplate v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.MenuTemplateProperty, box v)
        | BrickImageEditProp.MenuContainerTemplate v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.MenuContainerTemplateProperty, box v)
        | BrickImageEditProp.OpenFileDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.OpenFileDialogServiceTemplateProperty, box v)
        | BrickImageEditProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit.MessageBoxServiceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.Editing.BrickImageEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
