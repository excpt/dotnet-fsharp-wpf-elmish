...
type PopupImageEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp

module PopupImageEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.PopupImageEditPropertyProvider) (prop: PopupImageEditPropertyProviderProp) =
        match prop with
        | PopupImageEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupImageEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
