...
open System
open System.Windows
open DevExpress.Xpf.Diagram.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type CollectionEditorBaseProp =
    | EditValue of DevExpress.Diagram.Core.Native.IMultiModel
    | EditableCollectionModel of obj
    | ItemTemplate of System.Windows.DataTemplate
    | ItemDetailedDescriptionTemplate of System.Windows.DataTemplate
    | ItemDetailedDescriptionTemplateWrapper of System.Windows.DataTemplate
    | ItemsControlHeaderTemplate of System.Windows.DataTemplate
    | DialogFooterTemplate of System.Windows.DataTemplate
    | ItemsControlTemplate of System.Windows.DataTemplate
    | ItemsListTemplate of System.Windows.DataTemplate
    | NavigationPanelTemplate of System.Windows.DataTemplate
    | ActionButtonsTemplate of System.Windows.DataTemplate

module CollectionEditorBase =
    let editValue v : obj = box (CollectionEditorBaseProp.EditValue v)
    let editableCollectionModel v : obj = box (CollectionEditorBaseProp.EditableCollectionModel v)
    let itemTemplate v : obj = box (CollectionEditorBaseProp.ItemTemplate v)
    let itemDetailedDescriptionTemplate v : obj = box (CollectionEditorBaseProp.ItemDetailedDescriptionTemplate v)
    let itemDetailedDescriptionTemplateWrapper v : obj = box (CollectionEditorBaseProp.ItemDetailedDescriptionTemplateWrapper v)
    let itemsControlHeaderTemplate v : obj = box (CollectionEditorBaseProp.ItemsControlHeaderTemplate v)
    let dialogFooterTemplate v : obj = box (CollectionEditorBaseProp.DialogFooterTemplate v)
    let itemsControlTemplate v : obj = box (CollectionEditorBaseProp.ItemsControlTemplate v)
    let itemsListTemplate v : obj = box (CollectionEditorBaseProp.ItemsListTemplate v)
    let navigationPanelTemplate v : obj = box (CollectionEditorBaseProp.NavigationPanelTemplate v)
    let actionButtonsTemplate v : obj = box (CollectionEditorBaseProp.ActionButtonsTemplate v)

    let apply (el: DevExpress.Xpf.Diagram.Native.CollectionEditorBase) (prop: CollectionEditorBaseProp) =
        match prop with
        | CollectionEditorBaseProp.EditValue v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.EditValueProperty, box v)
        | CollectionEditorBaseProp.EditableCollectionModel v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.EditableCollectionModelProperty, box v)
        | CollectionEditorBaseProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ItemTemplateProperty, box v)
        | CollectionEditorBaseProp.ItemDetailedDescriptionTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ItemDetailedDescriptionTemplateProperty, box v)
        | CollectionEditorBaseProp.ItemDetailedDescriptionTemplateWrapper v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ItemDetailedDescriptionTemplateWrapperProperty, box v)
        | CollectionEditorBaseProp.ItemsControlHeaderTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ItemsControlHeaderTemplateProperty, box v)
        | CollectionEditorBaseProp.DialogFooterTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.DialogFooterTemplateProperty, box v)
        | CollectionEditorBaseProp.ItemsControlTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ItemsControlTemplateProperty, box v)
        | CollectionEditorBaseProp.ItemsListTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ItemsListTemplateProperty, box v)
        | CollectionEditorBaseProp.NavigationPanelTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.NavigationPanelTemplateProperty, box v)
        | CollectionEditorBaseProp.ActionButtonsTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.ActionButtonsTemplateProperty, box v)
    ...
    let editor (v: DevExpress.Xpf.Diagram.Native.CollectionEditorBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Diagram.Native.CollectionEditorBase.EditorProperty, box v)) :: node.Props }
