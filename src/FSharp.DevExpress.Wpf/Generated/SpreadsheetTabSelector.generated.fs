...
type SpreadsheetTabSelectorProp =
    | AddCommandEnabled of bool
    | AddCommandVisible of bool
    | AddCommand of System.Windows.Input.ICommand
    | PrevTabCommand of System.Windows.Input.ICommand
    | NextTabCommand of System.Windows.Input.ICommand
    | LastTabCommand of System.Windows.Input.ICommand
    | FirstTabCommand of System.Windows.Input.ICommand
    | VisibleWidth of float
    | AllowStretch of bool

module SpreadsheetTabSelector =
    let addCommandEnabled v : obj = box (SpreadsheetTabSelectorProp.AddCommandEnabled v)
    let addCommandVisible v : obj = box (SpreadsheetTabSelectorProp.AddCommandVisible v)
    let addCommand v : obj = box (SpreadsheetTabSelectorProp.AddCommand v)
    let prevTabCommand v : obj = box (SpreadsheetTabSelectorProp.PrevTabCommand v)
    let nextTabCommand v : obj = box (SpreadsheetTabSelectorProp.NextTabCommand v)
    let lastTabCommand v : obj = box (SpreadsheetTabSelectorProp.LastTabCommand v)
    let firstTabCommand v : obj = box (SpreadsheetTabSelectorProp.FirstTabCommand v)
    let visibleWidth v : obj = box (SpreadsheetTabSelectorProp.VisibleWidth v)
    let allowStretch v : obj = box (SpreadsheetTabSelectorProp.AllowStretch v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector) (prop: SpreadsheetTabSelectorProp) =
        match prop with
        | SpreadsheetTabSelectorProp.AddCommandEnabled v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.AddCommandEnabledProperty, box v)
        | SpreadsheetTabSelectorProp.AddCommandVisible v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.AddCommandVisibleProperty, box v)
        | SpreadsheetTabSelectorProp.AddCommand v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.AddCommandProperty, box v)
        | SpreadsheetTabSelectorProp.PrevTabCommand v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.PrevTabCommandProperty, box v)
        | SpreadsheetTabSelectorProp.NextTabCommand v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.NextTabCommandProperty, box v)
        | SpreadsheetTabSelectorProp.LastTabCommand v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.LastTabCommandProperty, box v)
        | SpreadsheetTabSelectorProp.FirstTabCommand v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.FirstTabCommandProperty, box v)
        | SpreadsheetTabSelectorProp.VisibleWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.VisibleWidthProperty, box v)
        | SpreadsheetTabSelectorProp.AllowStretch v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector.AllowStretchProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetTabSelector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
