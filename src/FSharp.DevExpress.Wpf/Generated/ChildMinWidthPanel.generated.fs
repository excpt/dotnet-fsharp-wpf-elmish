...
open System
open System.Windows
open DevExpress.Xpf.Editors.Helpers
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ChildMinWidthPanelProp =
    | ChildMinWidth of float

module ChildMinWidthPanel =
    let childMinWidth v : obj = box (ChildMinWidthPanelProp.ChildMinWidth v)

    let apply (el: DevExpress.Xpf.Editors.Helpers.ChildMinWidthPanel) (prop: ChildMinWidthPanelProp) =
        match prop with
        | ChildMinWidthPanelProp.ChildMinWidth v -> el.SetValue(DevExpress.Xpf.Editors.Helpers.ChildMinWidthPanel.ChildMinWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Helpers.ChildMinWidthPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
