...
type PredefinedRangeBar2DModelControlProp =
    | Base of PredefinedModelControlProp

module PredefinedRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.PredefinedRangeBar2DModelControl) (prop: PredefinedRangeBar2DModelControlProp) =
        match prop with
        | PredefinedRangeBar2DModelControlProp.Base p -> PredefinedModelControl.apply el p
