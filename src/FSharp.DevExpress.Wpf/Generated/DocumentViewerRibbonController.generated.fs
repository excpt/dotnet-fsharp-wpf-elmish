...
type DocumentViewerRibbonControllerProp =
    | Base of RibbonControllerProp

module DocumentViewerRibbonController =

    let apply (el: DevExpress.Xpf.DocumentViewer.DocumentViewerRibbonController) (prop: DocumentViewerRibbonControllerProp) =
        match prop with
        | DocumentViewerRibbonControllerProp.Base p -> RibbonController.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.DocumentViewerRibbonController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
