...
type AnnotationThumbProp =
    | Base of ThumbProp
    | Annotation of DevExpress.Xpf.Charts.Annotation

module AnnotationThumb =
    let annotation v : obj = box (AnnotationThumbProp.Annotation v)

    let apply (el: DevExpress.Xpf.Charts.AnnotationThumb) (prop: AnnotationThumbProp) =
        match prop with
        | AnnotationThumbProp.Base p -> Thumb.apply el p
        | AnnotationThumbProp.Annotation v -> el.SetValue(DevExpress.Xpf.Charts.AnnotationThumb.AnnotationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AnnotationThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
