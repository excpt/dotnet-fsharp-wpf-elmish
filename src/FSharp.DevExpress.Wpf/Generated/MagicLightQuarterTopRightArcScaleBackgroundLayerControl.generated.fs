...
type MagicLightQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightQuarterTopRightArcScaleBackgroundLayerControl) (prop: MagicLightQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | MagicLightQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
