...
type FlatStock2DModelControlProp =
    | Base of PredefinedModelControlProp

module FlatStock2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatStock2DModelControl) (prop: FlatStock2DModelControlProp) =
        match prop with
        | FlatStock2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatStock2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
