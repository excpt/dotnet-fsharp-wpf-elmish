...
type CheckEditStyleSettingsProp =
    | Base of CheckEditStyleSettingsBaseProp

module CheckEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.CheckEditStyleSettings) (prop: CheckEditStyleSettingsProp) =
        match prop with
        | CheckEditStyleSettingsProp.Base p -> CheckEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CheckEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
