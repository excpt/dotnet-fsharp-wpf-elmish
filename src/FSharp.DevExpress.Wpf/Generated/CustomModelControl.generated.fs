...
type CustomModelControlProp =
    | Base of ModelControlProp

module CustomModelControl =

    let apply (el: DevExpress.Xpf.Charts.CustomModelControl) (prop: CustomModelControlProp) =
        match prop with
        | CustomModelControlProp.Base p -> ModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CustomModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
