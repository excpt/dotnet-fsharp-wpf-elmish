...
type veControlProp =
    | Base of veControlBaseProp

module veControl =

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veControl) (prop: veControlProp) =
        match prop with
        | veControlProp.Base p -> veControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Base.veControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
