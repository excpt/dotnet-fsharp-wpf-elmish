...
type DefaultLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module DefaultLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleLevelBarForegroundControl) (prop: DefaultLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | DefaultLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
