...
type GradientMultiSliderThumbSelectorProp =
    | SelectedThumb of DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb

module GradientMultiSliderThumbSelector =
    let selectedThumb v : obj = box (GradientMultiSliderThumbSelectorProp.SelectedThumb v)

    let apply (el: DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumbSelector) (prop: GradientMultiSliderThumbSelectorProp) =
        match prop with
        | GradientMultiSliderThumbSelectorProp.SelectedThumb v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumbSelector.SelectedThumbProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumbSelector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
