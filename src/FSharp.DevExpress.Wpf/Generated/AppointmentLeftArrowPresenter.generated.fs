...
type AppointmentLeftArrowPresenterProp =
    | Base of AppointmentArrowPresenterBaseProp

module AppointmentLeftArrowPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentLeftArrowPresenter) (prop: AppointmentLeftArrowPresenterProp) =
        match prop with
        | AppointmentLeftArrowPresenterProp.Base p -> AppointmentArrowPresenterBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentLeftArrowPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
