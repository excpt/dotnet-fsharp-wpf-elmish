...
type ConditionalFormattingRulesManagerControlProp =
    | Base of ReferenceEditBaseControlProp

module ConditionalFormattingRulesManagerControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ConditionalFormattingRulesManagerControl) (prop: ConditionalFormattingRulesManagerControlProp) =
        match prop with
        | ConditionalFormattingRulesManagerControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ConditionalFormattingRulesManagerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
