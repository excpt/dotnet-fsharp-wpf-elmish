...
type VisualWeekViewGroupByResourceProp =
    | Base of VisualResourcesBasedViewInfoProp

module VisualWeekViewGroupByResource =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualWeekViewGroupByResource) (prop: VisualWeekViewGroupByResourceProp) =
        match prop with
        | VisualWeekViewGroupByResourceProp.Base p -> VisualResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualWeekViewGroupByResource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
