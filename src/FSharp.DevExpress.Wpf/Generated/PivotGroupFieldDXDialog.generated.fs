...
type PivotGroupFieldDXDialogProp =
    | Base of CustomDXDialogProp

module PivotGroupFieldDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotGroupFieldDXDialog) (prop: PivotGroupFieldDXDialogProp) =
        match prop with
        | PivotGroupFieldDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotGroupFieldDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
