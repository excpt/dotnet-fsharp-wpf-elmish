...
type SideBarLayoutTransformPanelProp =
    | Base of LayoutTransformPanelProp

module SideBarLayoutTransformPanel =

    let apply (el: DevExpress.Xpf.NavBar.SideBarLayoutTransformPanel) (prop: SideBarLayoutTransformPanelProp) =
        match prop with
        | SideBarLayoutTransformPanelProp.Base p -> LayoutTransformPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.SideBarLayoutTransformPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
