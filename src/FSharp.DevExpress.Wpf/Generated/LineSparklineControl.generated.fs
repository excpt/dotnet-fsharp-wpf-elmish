...
type LineSparklineControlProp =
    | Base of SparklineControlProp
    | LineWidth of int
...
module LineSparklineControl =
    let lineWidth v : obj = box (LineSparklineControlProp.LineWidth v)
    let highlightNegativePoints v : obj = box (LineSparklineControlProp.HighlightNegativePoints v)
    let showMarkers v : obj = box (LineSparklineControlProp.ShowMarkers v)
    let markerSize v : obj = box (LineSparklineControlProp.MarkerSize v)
    let maxPointMarkerSize v : obj = box (LineSparklineControlProp.MaxPointMarkerSize v)
    let minPointMarkerSize v : obj = box (LineSparklineControlProp.MinPointMarkerSize v)
    let startPointMarkerSize v : obj = box (LineSparklineControlProp.StartPointMarkerSize v)
    let endPointMarkerSize v : obj = box (LineSparklineControlProp.EndPointMarkerSize v)
    let negativePointMarkerSize v : obj = box (LineSparklineControlProp.NegativePointMarkerSize v)
    let markerBrush v : obj = box (LineSparklineControlProp.MarkerBrush v)

    let apply (el: DevExpress.Xpf.Editors.LineSparklineControl) (prop: LineSparklineControlProp) =
        match prop with
        | LineSparklineControlProp.Base p -> SparklineControl.apply el p
        | LineSparklineControlProp.LineWidth v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.LineWidthProperty, box v)
        | LineSparklineControlProp.HighlightNegativePoints v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.HighlightNegativePointsProperty, box v)
        | LineSparklineControlProp.ShowMarkers v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.ShowMarkersProperty, box v)
        | LineSparklineControlProp.MarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.MarkerSizeProperty, box v)
        | LineSparklineControlProp.MaxPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.MaxPointMarkerSizeProperty, box v)
        | LineSparklineControlProp.MinPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.MinPointMarkerSizeProperty, box v)
        | LineSparklineControlProp.StartPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.StartPointMarkerSizeProperty, box v)
        | LineSparklineControlProp.EndPointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.EndPointMarkerSizeProperty, box v)
        | LineSparklineControlProp.NegativePointMarkerSize v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.NegativePointMarkerSizeProperty, box v)
        | LineSparklineControlProp.MarkerBrush v -> el.SetValue(DevExpress.Xpf.Editors.LineSparklineControl.MarkerBrushProperty, box v)

    let points v : obj = box (SparklineControlProp.Points v)
    let highlightMaxPoint v : obj = box (SparklineControlProp.HighlightMaxPoint v)
    let highlightMinPoint v : obj = box (SparklineControlProp.HighlightMinPoint v)
    let highlightStartPoint v : obj = box (SparklineControlProp.HighlightStartPoint v)
    let highlightEndPoint v : obj = box (SparklineControlProp.HighlightEndPoint v)
    let brush v : obj = box (SparklineControlProp.Brush v)
    let maxPointBrush v : obj = box (SparklineControlProp.MaxPointBrush v)
    let minPointBrush v : obj = box (SparklineControlProp.MinPointBrush v)
    let startPointBrush v : obj = box (SparklineControlProp.StartPointBrush v)
    let endPointBrush v : obj = box (SparklineControlProp.EndPointBrush v)
    let negativePointBrush v : obj = box (SparklineControlProp.NegativePointBrush v)
    let autoRange v : obj = box (SparklineControlProp.AutoRange v)
    let argumentRange v : obj = box (SparklineControlProp.ArgumentRange v)
    let valueRange v : obj = box (SparklineControlProp.ValueRange v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.LineSparklineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
