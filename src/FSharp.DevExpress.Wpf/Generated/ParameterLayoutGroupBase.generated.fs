...
type ParameterLayoutGroupBaseProp =
    | Base of LayoutGroupProp
    | ItemsSource of obj

module ParameterLayoutGroupBase =
    let itemsSource v : obj = box (ParameterLayoutGroupBaseProp.ItemsSource v)

    let apply (el: DevExpress.Xpf.Printing.Parameters.ParameterLayoutGroupBase) (prop: ParameterLayoutGroupBaseProp) =
        match prop with
        | ParameterLayoutGroupBaseProp.Base p -> LayoutGroup.apply el p
        | ParameterLayoutGroupBaseProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Printing.Parameters.ParameterLayoutGroupBase.ItemsSourceProperty, box v)
