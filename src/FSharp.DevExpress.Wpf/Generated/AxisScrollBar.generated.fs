...
module AxisScrollBar =
    let visible v : obj = box (AxisScrollBarProp.Visible v)
    let orientation v : obj = box (AxisScrollBarProp.Orientation v)
    let minValue v : obj = box (AxisScrollBarProp.MinValue v)
    let maxValue v : obj = box (AxisScrollBarProp.MaxValue v)
    let command v : obj = box (AxisScrollBarProp.Command v)
    let annotations v : obj = box (AxisScrollBarProp.Annotations v)

    let apply (el: DevExpress.Xpf.Charts.AxisScrollBar) (prop: AxisScrollBarProp) =
        match prop with
        | AxisScrollBarProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.AxisScrollBar.VisibleProperty, box v)
        | AxisScrollBarProp.Orientation v -> el.SetValue(DevExpress.Xpf.Charts.AxisScrollBar.OrientationProperty, box v)
        | AxisScrollBarProp.MinValue v -> el.SetValue(DevExpress.Xpf.Charts.AxisScrollBar.MinValueProperty, box v)
        | AxisScrollBarProp.MaxValue v -> el.SetValue(DevExpress.Xpf.Charts.AxisScrollBar.MaxValueProperty, box v)
        | AxisScrollBarProp.Command v -> el.SetValue(DevExpress.Xpf.Charts.AxisScrollBar.CommandProperty, box v)
        | AxisScrollBarProp.Annotations v -> el.SetValue(DevExpress.Xpf.Charts.AxisScrollBar.AnnotationsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisScrollBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
