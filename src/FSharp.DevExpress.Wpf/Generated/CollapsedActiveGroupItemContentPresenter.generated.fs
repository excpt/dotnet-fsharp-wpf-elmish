...
type CollapsedActiveGroupItemContentPresenterProp =
    | IsSelected of bool
    | IsPressed of bool

module CollapsedActiveGroupItemContentPresenter =
    let isSelected v : obj = box (CollapsedActiveGroupItemContentPresenterProp.IsSelected v)
    let isPressed v : obj = box (CollapsedActiveGroupItemContentPresenterProp.IsPressed v)

    let apply (el: DevExpress.Xpf.NavBar.CollapsedActiveGroupItemContentPresenter) (prop: CollapsedActiveGroupItemContentPresenterProp) =
        match prop with
        | CollapsedActiveGroupItemContentPresenterProp.IsSelected v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupItemContentPresenter.IsSelectedProperty, box v)
        | CollapsedActiveGroupItemContentPresenterProp.IsPressed v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupItemContentPresenter.IsPressedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.CollapsedActiveGroupItemContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
