...
type DialogIconsViewBaseProp =
    | Base of DialogViewModeViewBaseProp

module DialogIconsViewBase =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogIconsViewBase) (prop: DialogIconsViewBaseProp) =
        match prop with
        | DialogIconsViewBaseProp.Base p -> DialogViewModeViewBase.apply el p
