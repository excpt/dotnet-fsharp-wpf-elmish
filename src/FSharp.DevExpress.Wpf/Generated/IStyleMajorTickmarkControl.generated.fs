...
type IStyleMajorTickmarkControlProp =
    | Base of PresentationControlProp

module IStyleMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleMajorTickmarkControl) (prop: IStyleMajorTickmarkControlProp) =
        match prop with
        | IStyleMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
