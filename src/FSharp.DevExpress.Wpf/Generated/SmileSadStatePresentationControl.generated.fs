...
type SmileSadStatePresentationControlProp =
    | Base of PresentationControlProp

module SmileSadStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.SmileSadStatePresentationControl) (prop: SmileSadStatePresentationControlProp) =
        match prop with
        | SmileSadStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmileSadStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
