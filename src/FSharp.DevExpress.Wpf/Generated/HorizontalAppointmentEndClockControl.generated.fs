...
type HorizontalAppointmentEndClockControlProp =
    | Base of HorizontalAppointmentClockControlBaseProp

module HorizontalAppointmentEndClockControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentEndClockControl) (prop: HorizontalAppointmentEndClockControlProp) =
        match prop with
        | HorizontalAppointmentEndClockControlProp.Base p -> HorizontalAppointmentClockControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentEndClockControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
