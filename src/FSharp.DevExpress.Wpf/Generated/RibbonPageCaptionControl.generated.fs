...
type RibbonPageCaptionControlProp =
    | Base of RibbonCaptionControlProp
    | Page of DevExpress.Xpf.Ribbon.RibbonPage
    | SelectedTextStyle of System.Windows.Style
    | NormalTextStyle of System.Windows.Style
    | HoverTextStyle of System.Windows.Style
    | IsDefaultCategory of bool
    | NormalContentContainerStyle of System.Windows.Style
    | HighlightedContentContainerStyle of System.Windows.Style
    | Color of System.Windows.Media.Color
    | NormalTextStyleInMinimizedRibbon of System.Windows.Style
    | SelectedTextStyleInMinimizedRibbon of System.Windows.Style
    | HoverTextStyleInMinimizedRibbon of System.Windows.Style
    | IsRibbonMinimized of bool
    | BorderTemplate of System.Windows.Controls.ControlTemplate
    | DefaultContentTemplate of System.Windows.DataTemplate
    | Content of obj
    | ContentTemplate of System.Windows.DataTemplate
    | HighlightedBorderTemplate of System.Windows.Controls.ControlTemplate
    | BorderTemplateInMinimizedRibbon of System.Windows.Controls.ControlTemplate
    | HighlightedBorderTemplateInMinimizedRibbon of System.Windows.Controls.ControlTemplate

module RibbonPageCaptionControl =
    let page v : obj = box (RibbonPageCaptionControlProp.Page v)
    let selectedTextStyle v : obj = box (RibbonPageCaptionControlProp.SelectedTextStyle v)
    let normalTextStyle v : obj = box (RibbonPageCaptionControlProp.NormalTextStyle v)
    let hoverTextStyle v : obj = box (RibbonPageCaptionControlProp.HoverTextStyle v)
    let isDefaultCategory v : obj = box (RibbonPageCaptionControlProp.IsDefaultCategory v)
    let normalContentContainerStyle v : obj = box (RibbonPageCaptionControlProp.NormalContentContainerStyle v)
    let highlightedContentContainerStyle v : obj = box (RibbonPageCaptionControlProp.HighlightedContentContainerStyle v)
    let color v : obj = box (RibbonPageCaptionControlProp.Color v)
    let normalTextStyleInMinimizedRibbon v : obj = box (RibbonPageCaptionControlProp.NormalTextStyleInMinimizedRibbon v)
    let selectedTextStyleInMinimizedRibbon v : obj = box (RibbonPageCaptionControlProp.SelectedTextStyleInMinimizedRibbon v)
    let hoverTextStyleInMinimizedRibbon v : obj = box (RibbonPageCaptionControlProp.HoverTextStyleInMinimizedRibbon v)
    let isRibbonMinimized v : obj = box (RibbonPageCaptionControlProp.IsRibbonMinimized v)
    let borderTemplate v : obj = box (RibbonPageCaptionControlProp.BorderTemplate v)
    let defaultContentTemplate v : obj = box (RibbonPageCaptionControlProp.DefaultContentTemplate v)
    let content v : obj = box (RibbonPageCaptionControlProp.Content v)
    let contentTemplate v : obj = box (RibbonPageCaptionControlProp.ContentTemplate v)
    let highlightedBorderTemplate v : obj = box (RibbonPageCaptionControlProp.HighlightedBorderTemplate v)
    let borderTemplateInMinimizedRibbon v : obj = box (RibbonPageCaptionControlProp.BorderTemplateInMinimizedRibbon v)
    let highlightedBorderTemplateInMinimizedRibbon v : obj = box (RibbonPageCaptionControlProp.HighlightedBorderTemplateInMinimizedRibbon v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageCaptionControl) (prop: RibbonPageCaptionControlProp) =
        match prop with
        | RibbonPageCaptionControlProp.Base p -> RibbonCaptionControl.apply el p
        | RibbonPageCaptionControlProp.Page v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.PageProperty, box v)
        | RibbonPageCaptionControlProp.SelectedTextStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.SelectedTextStyleProperty, box v)
        | RibbonPageCaptionControlProp.NormalTextStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.NormalTextStyleProperty, box v)
        | RibbonPageCaptionControlProp.HoverTextStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.HoverTextStyleProperty, box v)
        | RibbonPageCaptionControlProp.IsDefaultCategory v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.IsDefaultCategoryProperty, box v)
        | RibbonPageCaptionControlProp.NormalContentContainerStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.NormalContentContainerStyleProperty, box v)
        | RibbonPageCaptionControlProp.HighlightedContentContainerStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.HighlightedContentContainerStyleProperty, box v)
        | RibbonPageCaptionControlProp.Color v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.ColorProperty, box v)
        | RibbonPageCaptionControlProp.NormalTextStyleInMinimizedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.NormalTextStyleInMinimizedRibbonProperty, box v)
        | RibbonPageCaptionControlProp.SelectedTextStyleInMinimizedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.SelectedTextStyleInMinimizedRibbonProperty, box v)
        | RibbonPageCaptionControlProp.HoverTextStyleInMinimizedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.HoverTextStyleInMinimizedRibbonProperty, box v)
        | RibbonPageCaptionControlProp.IsRibbonMinimized v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.IsRibbonMinimizedProperty, box v)
        | RibbonPageCaptionControlProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.BorderTemplateProperty, box v)
        | RibbonPageCaptionControlProp.DefaultContentTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.DefaultContentTemplateProperty, box v)
        | RibbonPageCaptionControlProp.Content v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.ContentProperty, box v)
        | RibbonPageCaptionControlProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.ContentTemplateProperty, box v)
        | RibbonPageCaptionControlProp.HighlightedBorderTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.HighlightedBorderTemplateProperty, box v)
        | RibbonPageCaptionControlProp.BorderTemplateInMinimizedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.BorderTemplateInMinimizedRibbonProperty, box v)
        | RibbonPageCaptionControlProp.HighlightedBorderTemplateInMinimizedRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageCaptionControl.HighlightedBorderTemplateInMinimizedRibbonProperty, box v)

    let isPressed v : obj = box (RibbonCaptionControlProp.IsPressed v)
    let isSelected v : obj = box (RibbonCaptionControlProp.IsSelected v)
    let maxDesiredSize v : obj = box (RibbonCaptionControlProp.MaxDesiredSize v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageCaptionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
