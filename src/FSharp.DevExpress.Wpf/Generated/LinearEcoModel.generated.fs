...
type LinearEcoModelProp =
    | Base of LinearGaugeModelProp

module LinearEcoModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearEcoModel) (prop: LinearEcoModelProp) =
        match prop with
        | LinearEcoModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearEcoModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
