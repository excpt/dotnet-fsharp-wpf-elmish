...
type FilterStringUITypeEditorBaseProp =
    | EditValue of string
    ...
    | SelectedParameter of DevExpress.XtraReports.Parameters.Parameter
    | ShowGroupCommandsIcon of bool
    | UseCascadeParameters of bool

module FilterStringUITypeEditorBase =
    ...
    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase) (prop: FilterStringUITypeEditorBaseProp) =
        match prop with
        | FilterStringUITypeEditorBaseProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.EditValueProperty, box v)
        | FilterStringUITypeEditorBaseProp.FilterCriteria v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.FilterCriteriaProperty, box v)
        | FilterStringUITypeEditorBaseProp.ShowOperandTypeIcon v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.ShowOperandTypeIconProperty, box v)
        | FilterStringUITypeEditorBaseProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.ParameterServiceProperty, box v)
        | FilterStringUITypeEditorBaseProp.SelectedParameter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.SelectedParameterProperty, box v)
        | FilterStringUITypeEditorBaseProp.ShowGroupCommandsIcon v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.ShowGroupCommandsIconProperty, box v)
        | FilterStringUITypeEditorBaseProp.UseCascadeParameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.UseCascadeParametersProperty, box v)
    ...
    let editor (v: DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringUITypeEditorBase.EditorProperty, box v)) :: node.Props }
