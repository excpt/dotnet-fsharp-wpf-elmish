...
type EmptySpaceControlProp =
    | Base of psvContentControlProp

module EmptySpaceControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.EmptySpaceControl) (prop: EmptySpaceControlProp) =
        match prop with
        | EmptySpaceControlProp.Base p -> psvContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.EmptySpaceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
