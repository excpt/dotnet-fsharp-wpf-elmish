...
type FutureThreeQuartersArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module FutureThreeQuartersArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureThreeQuartersArcScaleForegroundLayerControl) (prop: FutureThreeQuartersArcScaleForegroundLayerControlProp) =
        match prop with
        | FutureThreeQuartersArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureThreeQuartersArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
