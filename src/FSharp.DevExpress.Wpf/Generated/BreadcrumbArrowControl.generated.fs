...
type BreadcrumbArrowControlProp =
    | Base of BreadcrumbButtonProp
    | ArrowGeometry of System.Windows.Media.Geometry
    | GlyphTransform of System.Windows.Media.RotateTransform

module BreadcrumbArrowControl =
    let arrowGeometry v : obj = box (BreadcrumbArrowControlProp.ArrowGeometry v)
    let glyphTransform v : obj = box (BreadcrumbArrowControlProp.GlyphTransform v)

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbArrowControl) (prop: BreadcrumbArrowControlProp) =
        match prop with
        | BreadcrumbArrowControlProp.Base p -> BreadcrumbButton.apply el p
        | BreadcrumbArrowControlProp.ArrowGeometry v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbArrowControl.ArrowGeometryProperty, box v)
        | BreadcrumbArrowControlProp.GlyphTransform v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbArrowControl.GlyphTransformProperty, box v)

    let contentTemplate v : obj = box (BreadcrumbButtonProp.ContentTemplate v)
    let contentTemplateSelector v : obj = box (BreadcrumbButtonProp.ContentTemplateSelector v)
    let cornerRadius v : obj = box (BreadcrumbButtonProp.CornerRadius v)
    ...
    let onClick v : obj = box (EventProp(box (ClickableButtonProp.OnClick v)))
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
