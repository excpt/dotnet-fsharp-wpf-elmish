...
type QueryBuilderTableDiagramContainerBaseProp =
    | Base of DiagramListProp

module QueryBuilderTableDiagramContainerBase =

    let apply (el: DevExpress.Xpf.DataAccess.Native.QueryBuilder.QueryBuilderTableDiagramContainerBase) (prop: QueryBuilderTableDiagramContainerBaseProp) =
        match prop with
        | QueryBuilderTableDiagramContainerBaseProp.Base p -> DiagramList.apply el p
