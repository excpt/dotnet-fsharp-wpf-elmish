...
type DiagramDecoratorBaseProp =
    | Base of BaseDiagramContainerProp

module DiagramDecoratorBase =

    let apply (el: DevExpress.Xpf.Diagram.DiagramDecoratorBase) (prop: DiagramDecoratorBaseProp) =
        match prop with
        | DiagramDecoratorBaseProp.Base p -> BaseDiagramContainer.apply el p
