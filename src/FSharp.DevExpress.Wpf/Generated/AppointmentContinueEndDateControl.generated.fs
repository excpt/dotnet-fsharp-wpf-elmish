...
type AppointmentContinueEndDateControlProp =
    | Base of AppointmentContinueDateControlProp

module AppointmentContinueEndDateControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueEndDateControl) (prop: AppointmentContinueEndDateControlProp) =
        match prop with
        | AppointmentContinueEndDateControlProp.Base p -> AppointmentContinueDateControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueEndDateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
