...
type GroupHeaderProp =
    | Base of FieldHeaderProp
    | Group of DevExpress.Xpf.PivotGrid.PivotGridGroup

module GroupHeader =
    let group v : obj = box (GroupHeaderProp.Group v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.GroupHeader) (prop: GroupHeaderProp) =
        match prop with
        | GroupHeaderProp.Base p -> FieldHeader.apply el p
        | GroupHeaderProp.Group v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.GroupHeader.GroupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.GroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
