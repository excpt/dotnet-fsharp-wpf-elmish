...
type TabHeaderSmartPresenterProp =
    | Base of HeaderSmartPresenterProp
    | IsSelected of bool

module TabHeaderSmartPresenter =
    let isSelected v : obj = box (TabHeaderSmartPresenterProp.IsSelected v)

    let apply (el: DevExpress.Xpf.Core.Native.TabHeaderSmartPresenter) (prop: TabHeaderSmartPresenterProp) =
        match prop with
        | TabHeaderSmartPresenterProp.Base p -> HeaderSmartPresenter.apply el p
        | TabHeaderSmartPresenterProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Core.Native.TabHeaderSmartPresenter.IsSelectedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabHeaderSmartPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
