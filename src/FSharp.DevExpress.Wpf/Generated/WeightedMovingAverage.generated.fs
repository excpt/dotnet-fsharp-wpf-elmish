...
type WeightedMovingAverageProp =
    | Base of MovingAverageProp

module WeightedMovingAverage =

    let apply (el: DevExpress.Xpf.Charts.WeightedMovingAverage) (prop: WeightedMovingAverageProp) =
        match prop with
        | WeightedMovingAverageProp.Base p -> MovingAverage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.WeightedMovingAverage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
