...
type CircularIStyleFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularIStyleFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularIStyleFullModel) (prop: CircularIStyleFullModelProp) =
        match prop with
        | CircularIStyleFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularIStyleFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
