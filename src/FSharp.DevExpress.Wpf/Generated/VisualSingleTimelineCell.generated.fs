...
type VisualSingleTimelineCellProp =
    | Base of VisualTimeCellProp

module VisualSingleTimelineCell =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualSingleTimelineCell) (prop: VisualSingleTimelineCellProp) =
        match prop with
        | VisualSingleTimelineCellProp.Base p -> VisualTimeCell.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualSingleTimelineCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
