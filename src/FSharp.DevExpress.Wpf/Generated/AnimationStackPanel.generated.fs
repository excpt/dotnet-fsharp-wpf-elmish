...
type AnimationStackPanelProp =
    | Base of AnimationPanel2Prop

module AnimationStackPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AnimationStackPanel) (prop: AnimationStackPanelProp) =
        match prop with
        | AnimationStackPanelProp.Base p -> AnimationPanel2.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AnimationStackPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
