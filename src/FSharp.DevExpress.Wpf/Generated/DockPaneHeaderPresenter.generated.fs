...
type DockPaneHeaderPresenterProp =
    | IsCaptionVisible of bool
    | Background of System.Windows.Media.Brush
    | Foreground of System.Windows.Media.Brush

module DockPaneHeaderPresenter =
    let isCaptionVisible v : obj = box (DockPaneHeaderPresenterProp.IsCaptionVisible v)
    let background v : obj = box (DockPaneHeaderPresenterProp.Background v)
    let foreground v : obj = box (DockPaneHeaderPresenterProp.Foreground v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockPaneHeaderPresenter) (prop: DockPaneHeaderPresenterProp) =
        match prop with
        | DockPaneHeaderPresenterProp.IsCaptionVisible v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockPaneHeaderPresenter.IsCaptionVisibleProperty, box v)
        | DockPaneHeaderPresenterProp.Background v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockPaneHeaderPresenter.BackgroundProperty, box v)
        | DockPaneHeaderPresenterProp.Foreground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockPaneHeaderPresenter.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockPaneHeaderPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
