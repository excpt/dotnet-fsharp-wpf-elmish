...
type FibonacciArcsProp =
    | Base of FibonacciIndicatorProp
    | ShowLevel100 of bool

module FibonacciArcs =
    let showLevel100 v : obj = box (FibonacciArcsProp.ShowLevel100 v)

    let apply (el: DevExpress.Xpf.Charts.FibonacciArcs) (prop: FibonacciArcsProp) =
        match prop with
        | FibonacciArcsProp.Base p -> FibonacciIndicator.apply el p
        | FibonacciArcsProp.ShowLevel100 v -> el.SetValue(DevExpress.Xpf.Charts.FibonacciArcs.ShowLevel100Property, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FibonacciArcs>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
