...
type HierarchicalTreeMapItemControlProp =
    | Text of string

module HierarchicalTreeMapItemControl =
    let text v : obj = box (HierarchicalTreeMapItemControlProp.Text v)

    let apply (el: DevExpress.Xpf.TreeMap.HierarchicalTreeMapItemControl) (prop: HierarchicalTreeMapItemControlProp) =
        match prop with
        | HierarchicalTreeMapItemControlProp.Text v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalTreeMapItemControl.TextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.HierarchicalTreeMapItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
