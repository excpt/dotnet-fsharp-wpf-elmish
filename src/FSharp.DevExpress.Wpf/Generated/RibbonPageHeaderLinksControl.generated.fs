...
type RibbonPageHeaderLinksControlProp =
    | Base of RibbonStatusBarPartControlBaseProp

module RibbonPageHeaderLinksControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageHeaderLinksControl) (prop: RibbonPageHeaderLinksControlProp) =
        match prop with
        | RibbonPageHeaderLinksControlProp.Base p -> RibbonStatusBarPartControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageHeaderLinksControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
