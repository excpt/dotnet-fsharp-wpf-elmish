...
type MarkedTimeControlProp =
    | MarkedTimeIntervals of DevExpress.Xpf.Gantt.Native.MarkedTimeIntervalCollection

module MarkedTimeControl =
    let markedTimeIntervals v : obj = box (MarkedTimeControlProp.MarkedTimeIntervals v)

    let apply (el: DevExpress.Xpf.Gantt.MarkedTimeControl) (prop: MarkedTimeControlProp) =
        match prop with
        | MarkedTimeControlProp.MarkedTimeIntervals v -> el.SetValue(DevExpress.Xpf.Gantt.MarkedTimeControl.MarkedTimeIntervalsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.MarkedTimeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
