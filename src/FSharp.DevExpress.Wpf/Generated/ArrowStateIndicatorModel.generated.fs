...
type ArrowStateIndicatorModelProp =
    | Base of StateIndicatorModelProp

module ArrowStateIndicatorModel =

    let apply (el: DevExpress.Xpf.Gauges.ArrowStateIndicatorModel) (prop: ArrowStateIndicatorModelProp) =
        match prop with
        | ArrowStateIndicatorModelProp.Base p -> StateIndicatorModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowStateIndicatorModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
