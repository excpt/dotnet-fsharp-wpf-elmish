...
type ThemeableArcScaleLineControlProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableArcScaleLineControl =
    let themeFill v : obj = box (ThemeableArcScaleLineControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableArcScaleLineControl) (prop: ThemeableArcScaleLineControlProp) =
        match prop with
        | ThemeableArcScaleLineControlProp.Base p -> PresentationControl.apply el p
        | ThemeableArcScaleLineControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableArcScaleLineControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
