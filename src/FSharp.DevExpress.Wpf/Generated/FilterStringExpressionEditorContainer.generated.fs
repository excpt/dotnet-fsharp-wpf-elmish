...
type FilterStringExpressionEditorContainerProp =
    | Base of ExpressionEditorContainerProp
    | Parameters of obj

module FilterStringExpressionEditorContainer =
    let parameters v : obj = box (FilterStringExpressionEditorContainerProp.Parameters v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.FilterStringExpressionEditorContainer) (prop: FilterStringExpressionEditorContainerProp) =
        match prop with
        | FilterStringExpressionEditorContainerProp.Base p -> ExpressionEditorContainer.apply el p
        | FilterStringExpressionEditorContainerProp.Parameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterStringExpressionEditorContainer.ParametersProperty, box v)

    let currentColumnInfo v : obj = box (ExpressionEditorContainerProp.CurrentColumnInfo v)
    let bindableExpression v : obj = box (ExpressionEditorContainerProp.BindableExpression v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.FilterStringExpressionEditorContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
