...
type RibbonAutoHidePopupProp =
    | Base of BarPopupBaseProp

module RibbonAutoHidePopup =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonAutoHidePopup) (prop: RibbonAutoHidePopupProp) =
        match prop with
        | RibbonAutoHidePopupProp.Base p -> BarPopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonAutoHidePopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
