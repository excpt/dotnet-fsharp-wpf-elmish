...
type VisualVerticalAppointmentControlProp =
    | Base of VisualAppointmentControlProp

module VisualVerticalAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualVerticalAppointmentControl) (prop: VisualVerticalAppointmentControlProp) =
        match prop with
        | VisualVerticalAppointmentControlProp.Base p -> VisualAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualVerticalAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
