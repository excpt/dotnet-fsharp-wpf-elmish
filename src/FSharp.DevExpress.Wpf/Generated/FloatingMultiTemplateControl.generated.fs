...
type FloatingMultiTemplateControlProp =
    | Base of MultiTemplateControlProp

module FloatingMultiTemplateControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatingMultiTemplateControl) (prop: FloatingMultiTemplateControlProp) =
        match prop with
        | FloatingMultiTemplateControlProp.Base p -> MultiTemplateControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FloatingMultiTemplateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
