...
type InterlaceRenderControlProp =
    | Base of AxisElementsRenderControlBaseProp

module InterlaceRenderControl =

    let apply (el: DevExpress.Xpf.Charts.InterlaceRenderControl) (prop: InterlaceRenderControlProp) =
        match prop with
        | InterlaceRenderControlProp.Base p -> AxisElementsRenderControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.InterlaceRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
