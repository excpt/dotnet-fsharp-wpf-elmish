...
type GlassCandleStick2DModelControlProp =
    | Base of PredefinedModelControlProp

module GlassCandleStick2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.GlassCandleStick2DModelControl) (prop: GlassCandleStick2DModelControlProp) =
        match prop with
        | GlassCandleStick2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GlassCandleStick2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
