...
type MovePivotTableControlProp =
    | Base of ReferenceEditBaseControlProp

module MovePivotTableControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.MovePivotTableControl) (prop: MovePivotTableControlProp) =
        match prop with
        | MovePivotTableControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.MovePivotTableControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
