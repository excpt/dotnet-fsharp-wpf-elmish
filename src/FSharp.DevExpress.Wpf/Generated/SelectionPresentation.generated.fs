...
type SelectionPresentationProp =
    | Base of SelectionControlProp

module SelectionPresentation =

    let apply (el: DevExpress.Xpf.Charts.SelectionPresentation) (prop: SelectionPresentationProp) =
        match prop with
        | SelectionPresentationProp.Base p -> SelectionControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SelectionPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
