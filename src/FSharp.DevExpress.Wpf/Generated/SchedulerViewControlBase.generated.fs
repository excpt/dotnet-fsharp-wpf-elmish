...
type SchedulerViewControlBaseProp =
    | Base of ViewControlBaseProp
    | CellVerticalBorderThickness of float
    | CellHorizontalBorderThickness of float

module SchedulerViewControlBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Visual.SchedulerViewControlBase) (prop: SchedulerViewControlBaseProp) =
        match prop with
        | SchedulerViewControlBaseProp.Base p -> ViewControlBase.apply el p
        | SchedulerViewControlBaseProp.CellVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewControlBase.CellVerticalBorderThicknessProperty, box v)
        | SchedulerViewControlBaseProp.CellHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.SchedulerViewControlBase.CellHorizontalBorderThicknessProperty, box v)
