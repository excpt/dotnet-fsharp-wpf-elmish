...
type CodeMSIStyleSettingsProp =
    | MSICheckSum of DevExpress.XtraPrinting.BarCode.MSICheckSum

module CodeMSIStyleSettings =
    let mSICheckSum v : obj = box (CodeMSIStyleSettingsProp.MSICheckSum v)

    let apply (el: DevExpress.Xpf.Editors.CodeMSIStyleSettings) (prop: CodeMSIStyleSettingsProp) =
        match prop with
        | CodeMSIStyleSettingsProp.MSICheckSum v -> el.SetValue(DevExpress.Xpf.Editors.CodeMSIStyleSettings.MSICheckSumProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CodeMSIStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
