...
type ChartStyleGalleryBarItemLinkControlProp =
    | Base of RibbonGalleryBarItemLinkControlProp

module ChartStyleGalleryBarItemLinkControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.ChartStyleGalleryBarItemLinkControl) (prop: ChartStyleGalleryBarItemLinkControlProp) =
        match prop with
        | ChartStyleGalleryBarItemLinkControlProp.Base p -> RibbonGalleryBarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.ChartStyleGalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
