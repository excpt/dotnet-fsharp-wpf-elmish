...
type LampOffStatePresentationControlProp =
    | Base of PresentationControlProp

module LampOffStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.LampOffStatePresentationControl) (prop: LampOffStatePresentationControlProp) =
        match prop with
        | LampOffStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LampOffStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
