...
type ThumbnailsPresenterControlProp =
    | Base of DocumentPresenterControlProp

module ThumbnailsPresenterControl =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsPresenterControl) (prop: ThumbnailsPresenterControlProp) =
        match prop with
        | ThumbnailsPresenterControlProp.Base p -> DocumentPresenterControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsPresenterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
