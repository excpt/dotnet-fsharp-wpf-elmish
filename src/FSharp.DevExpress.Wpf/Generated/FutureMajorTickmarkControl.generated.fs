...
type FutureMajorTickmarkControlProp =
    | Base of PresentationControlProp

module FutureMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureMajorTickmarkControl) (prop: FutureMajorTickmarkControlProp) =
        match prop with
        | FutureMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
