...
type DragGroupHeaderProp =
    | Base of GroupHeaderProp

module DragGroupHeader =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.DragGroupHeader) (prop: DragGroupHeaderProp) =
        match prop with
        | DragGroupHeaderProp.Base p -> GroupHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.DragGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
