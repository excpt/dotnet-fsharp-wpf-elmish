...
type GotoDateFormProp =
    | Date of System.DateTime
    | TargetViewType of DevExpress.XtraScheduler.SchedulerViewType
    | Title of string

module GotoDateForm =
    let date v : obj = box (GotoDateFormProp.Date v)
    let targetViewType v : obj = box (GotoDateFormProp.TargetViewType v)
    let title v : obj = box (GotoDateFormProp.Title v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.GotoDateForm) (prop: GotoDateFormProp) =
        match prop with
        | GotoDateFormProp.Date v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.GotoDateForm.DateProperty, box v)
        | GotoDateFormProp.TargetViewType v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.GotoDateForm.TargetViewTypeProperty, box v)
        | GotoDateFormProp.Title v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.GotoDateForm.TitleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.GotoDateForm>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
