...
type EntityInstantFeedbackDataSourceProp =
    | Base of InstantFeedbackDataSourceBaseProp

module EntityInstantFeedbackDataSource =

    let apply (el: DevExpress.Xpf.Core.ServerMode.EntityInstantFeedbackDataSource) (prop: EntityInstantFeedbackDataSourceProp) =
        match prop with
        | EntityInstantFeedbackDataSourceProp.Base p -> InstantFeedbackDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ServerMode.EntityInstantFeedbackDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
