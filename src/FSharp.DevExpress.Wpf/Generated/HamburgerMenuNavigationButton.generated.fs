...
type HamburgerMenuNavigationButtonProp =
    ...
    | CollapseMenuOnClick of bool
    | AllowGlyphTheming of bool
    | GlyphColor of obj

module HamburgerMenuNavigationButton =
    let placement v : obj = box (HamburgerMenuNavigationButtonProp.Placement v)
    let glyph v : obj = box (HamburgerMenuNavigationButtonProp.Glyph v)
    let glyphTemplate v : obj = box (HamburgerMenuNavigationButtonProp.GlyphTemplate v)
    let glyphWidth v : obj = box (HamburgerMenuNavigationButtonProp.GlyphWidth v)
    let glyphHeight v : obj = box (HamburgerMenuNavigationButtonProp.GlyphHeight v)
    let glyphStretch v : obj = box (HamburgerMenuNavigationButtonProp.GlyphStretch v)
    let collapseMenuOnClick v : obj = box (HamburgerMenuNavigationButtonProp.CollapseMenuOnClick v)
    let allowGlyphTheming v : obj = box (HamburgerMenuNavigationButtonProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (HamburgerMenuNavigationButtonProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton) (prop: HamburgerMenuNavigationButtonProp) =
        match prop with
        | HamburgerMenuNavigationButtonProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.PlacementProperty, box v)
        | HamburgerMenuNavigationButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.GlyphProperty, box v)
        | HamburgerMenuNavigationButtonProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.GlyphTemplateProperty, box v)
        | HamburgerMenuNavigationButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.GlyphWidthProperty, box v)
        | HamburgerMenuNavigationButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.GlyphHeightProperty, box v)
        | HamburgerMenuNavigationButtonProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.GlyphStretchProperty, box v)
        | HamburgerMenuNavigationButtonProp.CollapseMenuOnClick v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.CollapseMenuOnClickProperty, box v)
        | HamburgerMenuNavigationButtonProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.AllowGlyphThemingProperty, box v)
        | HamburgerMenuNavigationButtonProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuNavigationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
