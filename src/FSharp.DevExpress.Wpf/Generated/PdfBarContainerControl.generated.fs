...
type PdfBarContainerControlProp =
    | Base of BarContainerControlProp

module PdfBarContainerControl =

    let apply (el: DevExpress.Xpf.PdfViewer.PdfBarContainerControl) (prop: PdfBarContainerControlProp) =
        match prop with
        | PdfBarContainerControlProp.Base p -> BarContainerControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfBarContainerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
