...
type XYSeries2DProp =
    | Base of XYSeriesProp
    | CrosshairEnabled of obj
    | CrosshairLabelVisibility of obj
    | CrosshairLabelPattern of string
    | CrosshairEmptyValueLegendText of string
    | CrosshairLabelTemplate of System.Windows.DataTemplate
    | CrosshairContentShowMode of DevExpress.Xpf.Charts.CrosshairContentShowMode
    | IndicatorItemsSource of System.Collections.IEnumerable
    | IndicatorItemTemplate of System.Windows.DataTemplate
    | IndicatorItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | Pane of obj
    | AxisX of obj
    | AxisY of obj
    | RangeControlOptions of DevExpress.Xpf.Charts.RangeControlClient.RangeControlOptions
    | FirstPoint of DevExpress.Xpf.Charts.SidePoint
    | LastPoint of DevExpress.Xpf.Charts.SidePoint
    | EmptyPointOptions of DevExpress.Xpf.Charts.EmptyPointOptions

module XYSeries2D =
    let crosshairEnabled v : obj = box (XYSeries2DProp.CrosshairEnabled v)
    let crosshairLabelVisibility v : obj = box (XYSeries2DProp.CrosshairLabelVisibility v)
    ...
    let apply (el: DevExpress.Xpf.Charts.XYSeries2D) (prop: XYSeries2DProp) =
        match prop with
        | XYSeries2DProp.Base p -> XYSeries.apply el p
        | XYSeries2DProp.CrosshairEnabled v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.CrosshairEnabledProperty, box v)
        | XYSeries2DProp.CrosshairLabelVisibility v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.CrosshairLabelVisibilityProperty, box v)
        | XYSeries2DProp.CrosshairLabelPattern v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.CrosshairLabelPatternProperty, box v)
        | XYSeries2DProp.CrosshairEmptyValueLegendText v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.CrosshairEmptyValueLegendTextProperty, box v)
        | XYSeries2DProp.CrosshairLabelTemplate v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.CrosshairLabelTemplateProperty, box v)
        | XYSeries2DProp.CrosshairContentShowMode v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.CrosshairContentShowModeProperty, box v)
        | XYSeries2DProp.IndicatorItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.IndicatorItemsSourceProperty, box v)
        | XYSeries2DProp.IndicatorItemTemplate v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.IndicatorItemTemplateProperty, box v)
        | XYSeries2DProp.IndicatorItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.IndicatorItemTemplateSelectorProperty, box v)
        | XYSeries2DProp.Pane v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.PaneProperty, box v)
        | XYSeries2DProp.AxisX v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.AxisXProperty, box v)
        | XYSeries2DProp.AxisY v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.AxisYProperty, box v)
        | XYSeries2DProp.RangeControlOptions v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.RangeControlOptionsProperty, box v)
        | XYSeries2DProp.FirstPoint v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.FirstPointProperty, box v)
        | XYSeries2DProp.LastPoint v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.LastPointProperty, box v)
        | XYSeries2DProp.EmptyPointOptions v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries2D.EmptyPointOptionsProperty, box v)
