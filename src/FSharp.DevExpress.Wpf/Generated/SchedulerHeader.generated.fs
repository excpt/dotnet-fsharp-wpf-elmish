...
type SchedulerHeaderProp =
    | Base of XPFContentControlProp

module SchedulerHeader =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerHeader) (prop: SchedulerHeaderProp) =
        match prop with
        | SchedulerHeaderProp.Base p -> XPFContentControl.apply el p
