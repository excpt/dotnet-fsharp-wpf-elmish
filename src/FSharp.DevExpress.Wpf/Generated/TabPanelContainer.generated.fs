...
type TabPanelContainerProp =
    | Base of TabOrientablePanelProp
    | NormalMargin of System.Windows.Thickness
    | NormalPadding of System.Windows.Thickness
    | HoldMargin of System.Windows.Thickness
    | HoldPadding of System.Windows.Thickness

module TabPanelContainer =
    let normalMargin v : obj = box (TabPanelContainerProp.NormalMargin v)
    let normalPadding v : obj = box (TabPanelContainerProp.NormalPadding v)
    let holdMargin v : obj = box (TabPanelContainerProp.HoldMargin v)
    let holdPadding v : obj = box (TabPanelContainerProp.HoldPadding v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelContainer) (prop: TabPanelContainerProp) =
        match prop with
        | TabPanelContainerProp.Base p -> TabOrientablePanel.apply el p
        | TabPanelContainerProp.NormalMargin v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelContainer.NormalMarginProperty, box v)
        | TabPanelContainerProp.NormalPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelContainer.NormalPaddingProperty, box v)
        | TabPanelContainerProp.HoldMargin v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelContainer.HoldMarginProperty, box v)
        | TabPanelContainerProp.HoldPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelContainer.HoldPaddingProperty, box v)

    let indent v : obj = box (TabOrientablePanelProp.Indent v)
    let viewInfo v : obj = box (TabOrientablePanelProp.ViewInfo v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabPanelContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
