...
type BarPopupBaseProp =
    | Base of PopupBaseProp
    | DefaultVerticalOffset of float
    | IgnoreMenuDropAlignment of DevExpress.Utils.DefaultBoolean
...
module BarPopupBase =
    ...
    let apply (el: DevExpress.Xpf.Bars.BarPopupBase) (prop: BarPopupBaseProp) =
        match prop with
        | BarPopupBaseProp.Base p -> PopupBase.apply el p
        | BarPopupBaseProp.DefaultVerticalOffset v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupBase.DefaultVerticalOffsetProperty, box v)
        | BarPopupBaseProp.IgnoreMenuDropAlignment v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupBase.IgnoreMenuDropAlignmentProperty, box v)
