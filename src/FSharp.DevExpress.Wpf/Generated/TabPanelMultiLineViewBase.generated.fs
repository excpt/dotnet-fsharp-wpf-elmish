...
type TabPanelMultiLineViewBaseProp =
    | Base of TabPanelBaseProp
    | AutoMoveActiveRow of bool
    | AutoReverseItems of bool
    | IsStretchedHorizontally of bool
    | IsStretchedVertically of bool

module TabPanelMultiLineViewBase =
    let autoMoveActiveRow v : obj = box (TabPanelMultiLineViewBaseProp.AutoMoveActiveRow v)
    let autoReverseItems v : obj = box (TabPanelMultiLineViewBaseProp.AutoReverseItems v)
    let isStretchedHorizontally v : obj = box (TabPanelMultiLineViewBaseProp.IsStretchedHorizontally v)
    let isStretchedVertically v : obj = box (TabPanelMultiLineViewBaseProp.IsStretchedVertically v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelMultiLineViewBase) (prop: TabPanelMultiLineViewBaseProp) =
        match prop with
        | TabPanelMultiLineViewBaseProp.Base p -> TabPanelBase.apply el p
        | TabPanelMultiLineViewBaseProp.AutoMoveActiveRow v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelMultiLineViewBase.AutoMoveActiveRowProperty, box v)
        | TabPanelMultiLineViewBaseProp.AutoReverseItems v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelMultiLineViewBase.AutoReverseItemsProperty, box v)
        | TabPanelMultiLineViewBaseProp.IsStretchedHorizontally v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelMultiLineViewBase.IsStretchedHorizontallyProperty, box v)
        | TabPanelMultiLineViewBaseProp.IsStretchedVertically v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelMultiLineViewBase.IsStretchedVerticallyProperty, box v)
