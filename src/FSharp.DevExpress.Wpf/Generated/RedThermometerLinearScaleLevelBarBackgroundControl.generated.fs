...
type RedThermometerLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module RedThermometerLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.RedThermometerLinearScaleLevelBarBackgroundControl) (prop: RedThermometerLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | RedThermometerLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedThermometerLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
