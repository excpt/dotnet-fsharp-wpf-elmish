...
type NavPanePopupSizeGripProp =
    | Base of ThumbProp

module NavPanePopupSizeGrip =

    let apply (el: DevExpress.Xpf.NavBar.NavPanePopupSizeGrip) (prop: NavPanePopupSizeGripProp) =
        match prop with
        | NavPanePopupSizeGripProp.Base p -> Thumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPanePopupSizeGrip>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
