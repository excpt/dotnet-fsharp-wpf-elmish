...
type AnnotationLayoutPanelProp =
    | Base of ChartItemsPanelBaseProp

module AnnotationLayoutPanel =

    let apply (el: DevExpress.Xpf.Charts.AnnotationLayoutPanel) (prop: AnnotationLayoutPanelProp) =
        match prop with
        | AnnotationLayoutPanelProp.Base p -> ChartItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AnnotationLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
