...
type CupidPie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module CupidPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.CupidPie2DModelControl) (prop: CupidPie2DModelControlProp) =
        match prop with
        | CupidPie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CupidPie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
