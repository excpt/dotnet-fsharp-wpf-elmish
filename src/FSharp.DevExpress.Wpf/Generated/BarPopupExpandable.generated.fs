...
type BarPopupExpandableProp =
    | Base of BarPopupBaseProp
    | ExpandMode of DevExpress.Xpf.Bars.BarPopupExpandMode
...
module BarPopupExpandable =
    ...
    let apply (el: DevExpress.Xpf.Bars.BarPopupExpandable) (prop: BarPopupExpandableProp) =
        match prop with
        | BarPopupExpandableProp.Base p -> BarPopupBase.apply el p
        | BarPopupExpandableProp.ExpandMode v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupExpandable.ExpandModeProperty, box v)
        | BarPopupExpandableProp.Background v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupExpandable.BackgroundProperty, box v)
        | BarPopupExpandableProp.BorderBrush v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupExpandable.BorderBrushProperty, box v)
        | BarPopupExpandableProp.BorderThickness v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupExpandable.BorderThicknessProperty, box v)
        | BarPopupExpandableProp.Padding v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupExpandable.PaddingProperty, box v)
        | BarPopupExpandableProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Bars.BarPopupExpandable.CornerRadiusProperty, box v)
