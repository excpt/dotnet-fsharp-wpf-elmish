...
type FloatingBarPopupContentControlProp =
    | DragWidgetStyle of System.Windows.Style
    | SizeGripStyle of System.Windows.Style
    | CloseButtonStyle of System.Windows.Style
    | CaptionStyle of System.Windows.Style
    | QuickCustomizationButtonStyle of System.Windows.Style
    | Bar of DevExpress.Xpf.Bars.Bar

module FloatingBarPopupContentControl =
    let dragWidgetStyle v : obj = box (FloatingBarPopupContentControlProp.DragWidgetStyle v)
    let sizeGripStyle v : obj = box (FloatingBarPopupContentControlProp.SizeGripStyle v)
    let closeButtonStyle v : obj = box (FloatingBarPopupContentControlProp.CloseButtonStyle v)
    let captionStyle v : obj = box (FloatingBarPopupContentControlProp.CaptionStyle v)
    let quickCustomizationButtonStyle v : obj = box (FloatingBarPopupContentControlProp.QuickCustomizationButtonStyle v)
    let bar v : obj = box (FloatingBarPopupContentControlProp.Bar v)

    let apply (el: DevExpress.Xpf.Bars.FloatingBarPopupContentControl) (prop: FloatingBarPopupContentControlProp) =
        match prop with
        | FloatingBarPopupContentControlProp.DragWidgetStyle v -> el.SetValue(DevExpress.Xpf.Bars.FloatingBarPopupContentControl.DragWidgetStyleProperty, box v)
        | FloatingBarPopupContentControlProp.SizeGripStyle v -> el.SetValue(DevExpress.Xpf.Bars.FloatingBarPopupContentControl.SizeGripStyleProperty, box v)
        | FloatingBarPopupContentControlProp.CloseButtonStyle v -> el.SetValue(DevExpress.Xpf.Bars.FloatingBarPopupContentControl.CloseButtonStyleProperty, box v)
        | FloatingBarPopupContentControlProp.CaptionStyle v -> el.SetValue(DevExpress.Xpf.Bars.FloatingBarPopupContentControl.CaptionStyleProperty, box v)
        | FloatingBarPopupContentControlProp.QuickCustomizationButtonStyle v -> el.SetValue(DevExpress.Xpf.Bars.FloatingBarPopupContentControl.QuickCustomizationButtonStyleProperty, box v)
        | FloatingBarPopupContentControlProp.Bar v -> el.SetValue(DevExpress.Xpf.Bars.FloatingBarPopupContentControl.BarProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.FloatingBarPopupContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
