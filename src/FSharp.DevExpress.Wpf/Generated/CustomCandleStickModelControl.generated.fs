...
type CustomCandleStickModelControlProp =
    | Base of CustomModelControlProp
    | TopStickTemplate of System.Windows.DataTemplate
    | BottomStickTemplate of System.Windows.DataTemplate
    | CandleTemplate of System.Windows.DataTemplate
    | InvertedCandleTemplate of System.Windows.DataTemplate

module CustomCandleStickModelControl =
    let topStickTemplate v : obj = box (CustomCandleStickModelControlProp.TopStickTemplate v)
    let bottomStickTemplate v : obj = box (CustomCandleStickModelControlProp.BottomStickTemplate v)
    let candleTemplate v : obj = box (CustomCandleStickModelControlProp.CandleTemplate v)
    let invertedCandleTemplate v : obj = box (CustomCandleStickModelControlProp.InvertedCandleTemplate v)

    let apply (el: DevExpress.Xpf.Charts.CustomCandleStickModelControl) (prop: CustomCandleStickModelControlProp) =
        match prop with
        | CustomCandleStickModelControlProp.Base p -> CustomModelControl.apply el p
        | CustomCandleStickModelControlProp.TopStickTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomCandleStickModelControl.TopStickTemplateProperty, box v)
        | CustomCandleStickModelControlProp.BottomStickTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomCandleStickModelControl.BottomStickTemplateProperty, box v)
        | CustomCandleStickModelControlProp.CandleTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomCandleStickModelControl.CandleTemplateProperty, box v)
        | CustomCandleStickModelControlProp.InvertedCandleTemplate v -> el.SetValue(DevExpress.Xpf.Charts.CustomCandleStickModelControl.InvertedCandleTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CustomCandleStickModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
