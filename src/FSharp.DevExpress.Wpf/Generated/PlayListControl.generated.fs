...
type PlayListControlProp =
    | Caption of string
    | MediaManager of DevExpress.Xpf.Controls.MediaManager

module PlayListControl =
    let caption v : obj = box (PlayListControlProp.Caption v)
    let mediaManager v : obj = box (PlayListControlProp.MediaManager v)

    let apply (el: DevExpress.Xpf.Controls.PlayListControl) (prop: PlayListControlProp) =
        match prop with
        | PlayListControlProp.Caption v -> el.SetValue(DevExpress.Xpf.Controls.PlayListControl.CaptionProperty, box v)
        | PlayListControlProp.MediaManager v -> el.SetValue(DevExpress.Xpf.Controls.PlayListControl.MediaManagerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.PlayListControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
