...
type ThemeableLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableLinearScaleMarkerControl =
    let themeFill v : obj = box (ThemeableLinearScaleMarkerControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableLinearScaleMarkerControl) (prop: ThemeableLinearScaleMarkerControlProp) =
        match prop with
        | ThemeableLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
        | ThemeableLinearScaleMarkerControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableLinearScaleMarkerControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
