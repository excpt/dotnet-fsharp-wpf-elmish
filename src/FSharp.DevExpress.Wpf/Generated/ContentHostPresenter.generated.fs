...
type ContentHostPresenterProp =
    | Base of ContentHostPresenterBaseProp
    | ContentCacheMode of DevExpress.Xpf.Core.TabContentCacheMode
    | RegularContentPresenter of obj
    | FastContentPresenter of obj

module ContentHostPresenter =
    ...
    let apply (el: DevExpress.Xpf.Core.Native.ContentHostPresenter) (prop: ContentHostPresenterProp) =
        match prop with
        | ContentHostPresenterProp.Base p -> ContentHostPresenterBase.apply el p
        | ContentHostPresenterProp.ContentCacheMode v -> el.SetValue(DevExpress.Xpf.Core.Native.ContentHostPresenter.ContentCacheModeProperty, box v)
        | ContentHostPresenterProp.RegularContentPresenter v -> el.SetValue(DevExpress.Xpf.Core.Native.ContentHostPresenter.RegularContentPresenterProperty, box v)
        | ContentHostPresenterProp.FastContentPresenter v -> el.SetValue(DevExpress.Xpf.Core.Native.ContentHostPresenter.FastContentPresenterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ContentHostPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
