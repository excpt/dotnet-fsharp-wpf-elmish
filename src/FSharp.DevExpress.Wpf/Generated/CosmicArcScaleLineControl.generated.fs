...
type CosmicArcScaleLineControlProp =
    | Base of PresentationControlProp

module CosmicArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicArcScaleLineControl) (prop: CosmicArcScaleLineControlProp) =
        match prop with
        | CosmicArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
