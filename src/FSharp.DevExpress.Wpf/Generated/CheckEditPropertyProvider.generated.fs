...
type CheckEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp

module CheckEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.CheckEditPropertyProvider) (prop: CheckEditPropertyProviderProp) =
        match prop with
        | CheckEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CheckEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
