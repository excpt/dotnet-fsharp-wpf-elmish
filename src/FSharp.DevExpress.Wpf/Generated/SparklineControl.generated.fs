...
type SparklineControlProp =
    | Points of DevExpress.Xpf.Editors.SparklinePointCollection
    ...
    | AutoRange of bool
    | ArgumentRange of DevExpress.Xpf.Editors.Range
    | ValueRange of DevExpress.Xpf.Editors.Range

module SparklineControl =
    ...
    let apply (el: DevExpress.Xpf.Editors.SparklineControl) (prop: SparklineControlProp) =
        match prop with
        | SparklineControlProp.Points v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.PointsProperty, box v)
        | SparklineControlProp.HighlightMaxPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.HighlightMaxPointProperty, box v)
        | SparklineControlProp.HighlightMinPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.HighlightMinPointProperty, box v)
        | SparklineControlProp.HighlightStartPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.HighlightStartPointProperty, box v)
        | SparklineControlProp.HighlightEndPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.HighlightEndPointProperty, box v)
        | SparklineControlProp.Brush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.BrushProperty, box v)
        | SparklineControlProp.MaxPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.MaxPointBrushProperty, box v)
        | SparklineControlProp.MinPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.MinPointBrushProperty, box v)
        | SparklineControlProp.StartPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.StartPointBrushProperty, box v)
        | SparklineControlProp.EndPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.EndPointBrushProperty, box v)
        | SparklineControlProp.NegativePointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.NegativePointBrushProperty, box v)
        | SparklineControlProp.AutoRange v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.AutoRangeProperty, box v)
        | SparklineControlProp.ArgumentRange v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.ArgumentRangeProperty, box v)
        | SparklineControlProp.ValueRange v -> el.SetValue(DevExpress.Xpf.Editors.SparklineControl.ValueRangeProperty, box v)
