...
type DropDownButtonBaseProp =
    | Base of SimpleButtonProp
    | ArrowGlyph of System.Windows.Media.ImageSource
    | ArrowAlignment of System.Windows.Controls.Dock
    | ArrowPadding of System.Windows.Thickness
    | PopupContent of obj
    | PopupContentTemplate of System.Windows.DataTemplate
    | PopupContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | IsPopupOpen of bool
    | PopupAutoWidth of obj
    | PopupWidth of float
    ...
    | PopupDropAlignment of System.Windows.Controls.Dock

module DropDownButtonBase =
    let arrowGlyph v : obj = box (DropDownButtonBaseProp.ArrowGlyph v)
    let arrowAlignment v : obj = box (DropDownButtonBaseProp.ArrowAlignment v)
    let arrowPadding v : obj = box (DropDownButtonBaseProp.ArrowPadding v)
    let popupContent v : obj = box (DropDownButtonBaseProp.PopupContent v)
    let popupContentTemplate v : obj = box (DropDownButtonBaseProp.PopupContentTemplate v)
    let popupContentTemplateSelector v : obj = box (DropDownButtonBaseProp.PopupContentTemplateSelector v)
    let isPopupOpen v : obj = box (DropDownButtonBaseProp.IsPopupOpen v)
    let popupAutoWidth v : obj = box (DropDownButtonBaseProp.PopupAutoWidth v)
    let popupWidth v : obj = box (DropDownButtonBaseProp.PopupWidth v)
    let popupMinWidth v : obj = box (DropDownButtonBaseProp.PopupMinWidth v)
    let popupMaxWidth v : obj = box (DropDownButtonBaseProp.PopupMaxWidth v)
    let popupHeight v : obj = box (DropDownButtonBaseProp.PopupHeight v)
    let popupMinHeight v : obj = box (DropDownButtonBaseProp.PopupMinHeight v)
    let popupMaxHeight v : obj = box (DropDownButtonBaseProp.PopupMaxHeight v)
    let popupDropAlignment v : obj = box (DropDownButtonBaseProp.PopupDropAlignment v)

    let apply (el: DevExpress.Xpf.Core.DropDownButtonBase) (prop: DropDownButtonBaseProp) =
        match prop with
        | DropDownButtonBaseProp.Base p -> SimpleButton.apply el p
        | DropDownButtonBaseProp.ArrowGlyph v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.ArrowGlyphProperty, box v)
        | DropDownButtonBaseProp.ArrowAlignment v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.ArrowAlignmentProperty, box v)
        | DropDownButtonBaseProp.ArrowPadding v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.ArrowPaddingProperty, box v)
        | DropDownButtonBaseProp.PopupContent v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupContentProperty, box v)
        | DropDownButtonBaseProp.PopupContentTemplate v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupContentTemplateProperty, box v)
        | DropDownButtonBaseProp.PopupContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupContentTemplateSelectorProperty, box v)
        | DropDownButtonBaseProp.IsPopupOpen v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.IsPopupOpenProperty, box v)
        | DropDownButtonBaseProp.PopupAutoWidth v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupAutoWidthProperty, box v)
        | DropDownButtonBaseProp.PopupWidth v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupWidthProperty, box v)
        | DropDownButtonBaseProp.PopupMinWidth v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupMinWidthProperty, box v)
        | DropDownButtonBaseProp.PopupMaxWidth v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupMaxWidthProperty, box v)
        | DropDownButtonBaseProp.PopupHeight v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupHeightProperty, box v)
        | DropDownButtonBaseProp.PopupMinHeight v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupMinHeightProperty, box v)
        | DropDownButtonBaseProp.PopupMaxHeight v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupMaxHeightProperty, box v)
        | DropDownButtonBaseProp.PopupDropAlignment v -> el.SetValue(DevExpress.Xpf.Core.DropDownButtonBase.PopupDropAlignmentProperty, box v)

    let asyncDisplayMode v : obj = box (SimpleButtonProp.AsyncDisplayMode v)
    let glyph v : obj = box (SimpleButtonProp.Glyph v)
    let glyphToContentOffset v : obj = box (SimpleButtonProp.GlyphToContentOffset v)
    let buttonKind v : obj = box (SimpleButtonProp.ButtonKind v)
    let delay v : obj = box (SimpleButtonProp.Delay v)
    let interval v : obj = box (SimpleButtonProp.Interval v)
    let isThreeState v : obj = box (SimpleButtonProp.IsThreeState v)
    let glyphAlignment v : obj = box (SimpleButtonProp.GlyphAlignment v)
    let cornerRadius v : obj = box (SimpleButtonProp.CornerRadius v)
    ...
    let onChecked v : obj = box (EventProp(box (SimpleButtonProp.OnChecked v)))
    let onUnchecked v : obj = box (EventProp(box (SimpleButtonProp.OnUnchecked v)))
    let onIndeterminate v : obj = box (EventProp(box (SimpleButtonProp.OnIndeterminate v)))
