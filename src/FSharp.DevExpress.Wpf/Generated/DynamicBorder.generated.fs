...
module DynamicBorder =
    let visibleBorderTemplate v : obj = box (DynamicBorderProp.VisibleBorderTemplate v)
    let invisibleBorderTemplate v : obj = box (DynamicBorderProp.InvisibleBorderTemplate v)
    let showBorder v : obj = box (DynamicBorderProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DynamicBorder) (prop: DynamicBorderProp) =
        match prop with
        | DynamicBorderProp.Base p -> XPFContentControl.apply el p
        | DynamicBorderProp.VisibleBorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicBorder.VisibleBorderTemplateProperty, box v)
        | DynamicBorderProp.InvisibleBorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicBorder.InvisibleBorderTemplateProperty, box v)
        | DynamicBorderProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicBorder.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DynamicBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
