...
type CustomizablePopupMenuBaseProp =
    | Base of PopupMenuProp

module CustomizablePopupMenuBase =

    let apply (el: DevExpress.Xpf.Bars.CustomizablePopupMenuBase) (prop: CustomizablePopupMenuBaseProp) =
        match prop with
        | CustomizablePopupMenuBaseProp.Base p -> PopupMenu.apply el p
