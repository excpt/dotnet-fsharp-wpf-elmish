...
type PrintFieldHeaderProp =
    | Base of FieldHeaderProp

module PrintFieldHeader =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintFieldHeader) (prop: PrintFieldHeaderProp) =
        match prop with
        | PrintFieldHeaderProp.Base p -> FieldHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintFieldHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
