...
type AreaStackedSeries3DProp =
    | Base of AreaSeries3DProp

module AreaStackedSeries3D =

    let apply (el: DevExpress.Xpf.Charts.AreaStackedSeries3D) (prop: AreaStackedSeries3DProp) =
        match prop with
        | AreaStackedSeries3DProp.Base p -> AreaSeries3D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaStackedSeries3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
