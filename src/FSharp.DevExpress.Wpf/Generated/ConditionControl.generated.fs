...
type ConditionControlProp =
    | AllowChangeOperatorType of bool
    | AllowChangeMasterTable of bool
    | Tables of obj
    | LeftTable of DevExpress.Xpf.DataAccess.Native.Editors.AliasedItem
    | LeftColumn of DevExpress.Xpf.DataAccess.Native.Editors.AliasedItem
    | RightTable of DevExpress.Xpf.DataAccess.Native.Editors.AliasedItem
    | RightColumn of DevExpress.Xpf.DataAccess.Native.Editors.AliasedItem
    | OperatorType of DevExpress.Data.Filtering.BinaryOperatorType

module ConditionControl =
    let allowChangeOperatorType v : obj = box (ConditionControlProp.AllowChangeOperatorType v)
    let allowChangeMasterTable v : obj = box (ConditionControlProp.AllowChangeMasterTable v)
    let tables v : obj = box (ConditionControlProp.Tables v)
    let leftTable v : obj = box (ConditionControlProp.LeftTable v)
    let leftColumn v : obj = box (ConditionControlProp.LeftColumn v)
    let rightTable v : obj = box (ConditionControlProp.RightTable v)
    let rightColumn v : obj = box (ConditionControlProp.RightColumn v)
    let operatorType v : obj = box (ConditionControlProp.OperatorType v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl) (prop: ConditionControlProp) =
        match prop with
        | ConditionControlProp.AllowChangeOperatorType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.AllowChangeOperatorTypeProperty, box v)
        | ConditionControlProp.AllowChangeMasterTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.AllowChangeMasterTableProperty, box v)
        | ConditionControlProp.Tables v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.TablesProperty, box v)
        | ConditionControlProp.LeftTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.LeftTableProperty, box v)
        | ConditionControlProp.LeftColumn v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.LeftColumnProperty, box v)
        | ConditionControlProp.RightTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.RightTableProperty, box v)
        | ConditionControlProp.RightColumn v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.RightColumnProperty, box v)
        | ConditionControlProp.OperatorType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl.OperatorTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ConditionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
