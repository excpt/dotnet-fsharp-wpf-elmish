...
type TextEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp

module TextEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.TextEditPropertyProvider) (prop: TextEditPropertyProviderProp) =
        match prop with
        | TextEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TextEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
