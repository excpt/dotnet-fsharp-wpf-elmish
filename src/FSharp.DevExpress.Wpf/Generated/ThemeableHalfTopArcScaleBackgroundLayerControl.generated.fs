...
type ThemeableHalfTopArcScaleBackgroundLayerControlProp =
    | Base of ThemeableArcScaleBackgroundLayerControlBaseProp

module ThemeableHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableHalfTopArcScaleBackgroundLayerControl) (prop: ThemeableHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | ThemeableHalfTopArcScaleBackgroundLayerControlProp.Base p -> ThemeableArcScaleBackgroundLayerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
