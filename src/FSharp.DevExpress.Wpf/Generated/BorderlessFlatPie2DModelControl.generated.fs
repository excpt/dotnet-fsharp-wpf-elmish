...
type BorderlessFlatPie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module BorderlessFlatPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderlessFlatPie2DModelControl) (prop: BorderlessFlatPie2DModelControlProp) =
        match prop with
        | BorderlessFlatPie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderlessFlatPie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
