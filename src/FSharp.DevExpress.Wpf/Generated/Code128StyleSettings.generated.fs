...
type Code128StyleSettingsProp =
    | FNC1Substitute of string
    | FNC2Substitute of string
    | FNC3Substitute of string
    | FNC4Substitute of string

module Code128StyleSettings =
    let fNC1Substitute v : obj = box (Code128StyleSettingsProp.FNC1Substitute v)
    let fNC2Substitute v : obj = box (Code128StyleSettingsProp.FNC2Substitute v)
    let fNC3Substitute v : obj = box (Code128StyleSettingsProp.FNC3Substitute v)
    let fNC4Substitute v : obj = box (Code128StyleSettingsProp.FNC4Substitute v)

    let apply (el: DevExpress.Xpf.Editors.Code128StyleSettings) (prop: Code128StyleSettingsProp) =
        match prop with
        | Code128StyleSettingsProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Editors.Code128StyleSettings.FNC1SubstituteProperty, box v)
        | Code128StyleSettingsProp.FNC2Substitute v -> el.SetValue(DevExpress.Xpf.Editors.Code128StyleSettings.FNC2SubstituteProperty, box v)
        | Code128StyleSettingsProp.FNC3Substitute v -> el.SetValue(DevExpress.Xpf.Editors.Code128StyleSettings.FNC3SubstituteProperty, box v)
        | Code128StyleSettingsProp.FNC4Substitute v -> el.SetValue(DevExpress.Xpf.Editors.Code128StyleSettings.FNC4SubstituteProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Code128StyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
