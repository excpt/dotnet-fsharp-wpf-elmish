...
open System
open System.Windows
open DevExpress.XtraRichEdit.View
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TablePositioningViewProp =
    | Base of ThemedWindowProp

module TablePositioningView =

    let apply (el: DevExpress.XtraRichEdit.View.TablePositioningView) (prop: TablePositioningViewProp) =
        match prop with
        | TablePositioningViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.View.TablePositioningView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
