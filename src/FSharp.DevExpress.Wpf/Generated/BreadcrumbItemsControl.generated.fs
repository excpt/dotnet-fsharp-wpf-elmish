...
type BreadcrumbItemsControlProp =
    ...
    | ShowPredefinedItemsSource of bool
    | PredefinedItemsSource of obj
    | RightIndent of float
    | RotateArrow of bool

module BreadcrumbItemsControl =
    let subItemTemplate v : obj = box (BreadcrumbItemsControlProp.SubItemTemplate v)
    let subItemTemplateSelector v : obj = box (BreadcrumbItemsControlProp.SubItemTemplateSelector v)
    let showBorder v : obj = box (BreadcrumbItemsControlProp.ShowBorder v)
    let popupHeight v : obj = box (BreadcrumbItemsControlProp.PopupHeight v)
    let popupMinHeight v : obj = box (BreadcrumbItemsControlProp.PopupMinHeight v)
    let popupMaxHeight v : obj = box (BreadcrumbItemsControlProp.PopupMaxHeight v)
    let popupWidth v : obj = box (BreadcrumbItemsControlProp.PopupWidth v)
    let popupMinWidth v : obj = box (BreadcrumbItemsControlProp.PopupMinWidth v)
    let popupMaxWidth v : obj = box (BreadcrumbItemsControlProp.PopupMaxWidth v)
    let showPredefinedItemsSource v : obj = box (BreadcrumbItemsControlProp.ShowPredefinedItemsSource v)
    let predefinedItemsSource v : obj = box (BreadcrumbItemsControlProp.PredefinedItemsSource v)
    let rightIndent v : obj = box (BreadcrumbItemsControlProp.RightIndent v)
    let rotateArrow v : obj = box (BreadcrumbItemsControlProp.RotateArrow v)

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl) (prop: BreadcrumbItemsControlProp) =
        match prop with
        | BreadcrumbItemsControlProp.SubItemTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.SubItemTemplateProperty, box v)
        | BreadcrumbItemsControlProp.SubItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.SubItemTemplateSelectorProperty, box v)
        | BreadcrumbItemsControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.ShowBorderProperty, box v)
        | BreadcrumbItemsControlProp.PopupHeight v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PopupHeightProperty, box v)
        | BreadcrumbItemsControlProp.PopupMinHeight v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PopupMinHeightProperty, box v)
        | BreadcrumbItemsControlProp.PopupMaxHeight v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PopupMaxHeightProperty, box v)
        | BreadcrumbItemsControlProp.PopupWidth v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PopupWidthProperty, box v)
        | BreadcrumbItemsControlProp.PopupMinWidth v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PopupMinWidthProperty, box v)
        | BreadcrumbItemsControlProp.PopupMaxWidth v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PopupMaxWidthProperty, box v)
        | BreadcrumbItemsControlProp.ShowPredefinedItemsSource v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.ShowPredefinedItemsSourceProperty, box v)
        | BreadcrumbItemsControlProp.PredefinedItemsSource v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.PredefinedItemsSourceProperty, box v)
        | BreadcrumbItemsControlProp.RightIndent v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.RightIndentProperty, box v)
        | BreadcrumbItemsControlProp.RotateArrow v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl.RotateArrowProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
