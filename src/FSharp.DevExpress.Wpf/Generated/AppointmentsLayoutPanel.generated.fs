...
type AppointmentsLayoutPanelProp =
    | Base of SchedulerPanelProp

module AppointmentsLayoutPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentsLayoutPanel) (prop: AppointmentsLayoutPanelProp) =
        match prop with
        | AppointmentsLayoutPanelProp.Base p -> SchedulerPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentsLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
