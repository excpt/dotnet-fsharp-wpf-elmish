...
type ScrollableContentControlProp =
    | AllowScrolling of bool
    | ButtonUpTemplate of System.Windows.Controls.ControlTemplate
    | ButtonDownTemplate of System.Windows.Controls.ControlTemplate
    | NavBarViewKind of DevExpress.Xpf.NavBar.NavBarViewKind
    | NotAllowScrollingTemplate of System.Windows.Controls.ControlTemplate
    | Orientation of System.Windows.Controls.Orientation
    | ScrollMode of DevExpress.Xpf.NavBar.ScrollMode

module ScrollableContentControl =
    let allowScrolling v : obj = box (ScrollableContentControlProp.AllowScrolling v)
    let buttonUpTemplate v : obj = box (ScrollableContentControlProp.ButtonUpTemplate v)
    let buttonDownTemplate v : obj = box (ScrollableContentControlProp.ButtonDownTemplate v)
    let navBarViewKind v : obj = box (ScrollableContentControlProp.NavBarViewKind v)
    let notAllowScrollingTemplate v : obj = box (ScrollableContentControlProp.NotAllowScrollingTemplate v)
    let orientation v : obj = box (ScrollableContentControlProp.Orientation v)
    let scrollMode v : obj = box (ScrollableContentControlProp.ScrollMode v)

    let apply (el: DevExpress.Xpf.NavBar.ScrollableContentControl) (prop: ScrollableContentControlProp) =
        match prop with
        | ScrollableContentControlProp.AllowScrolling v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.AllowScrollingProperty, box v)
        | ScrollableContentControlProp.ButtonUpTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.ButtonUpTemplateProperty, box v)
        | ScrollableContentControlProp.ButtonDownTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.ButtonDownTemplateProperty, box v)
        | ScrollableContentControlProp.NavBarViewKind v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.NavBarViewKindProperty, box v)
        | ScrollableContentControlProp.NotAllowScrollingTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.NotAllowScrollingTemplateProperty, box v)
        | ScrollableContentControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.OrientationProperty, box v)
        | ScrollableContentControlProp.ScrollMode v -> el.SetValue(DevExpress.Xpf.NavBar.ScrollableContentControl.ScrollModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ScrollableContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
