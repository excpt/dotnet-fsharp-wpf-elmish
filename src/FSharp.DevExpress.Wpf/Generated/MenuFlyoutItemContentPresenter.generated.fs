...
type MenuFlyoutItemContentPresenterProp =
    | Base of veContentControlProp

module MenuFlyoutItemContentPresenter =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.MenuFlyoutItemContentPresenter) (prop: MenuFlyoutItemContentPresenterProp) =
        match prop with
        | MenuFlyoutItemContentPresenterProp.Base p -> veContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.MenuFlyoutItemContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
