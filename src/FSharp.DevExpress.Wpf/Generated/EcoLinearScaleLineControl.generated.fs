...
type EcoLinearScaleLineControlProp =
    | Base of PresentationControlProp

module EcoLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoLinearScaleLineControl) (prop: EcoLinearScaleLineControlProp) =
        match prop with
        | EcoLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
