...
type TileBarGroupHeaderProp =
    | Base of StackPanelGroupHeaderProp

module TileBarGroupHeader =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileBarGroupHeader) (prop: TileBarGroupHeaderProp) =
        match prop with
        | TileBarGroupHeaderProp.Base p -> StackPanelGroupHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileBarGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
