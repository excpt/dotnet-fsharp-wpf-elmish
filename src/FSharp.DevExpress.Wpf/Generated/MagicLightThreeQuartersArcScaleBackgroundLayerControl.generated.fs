...
type MagicLightThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightThreeQuartersArcScaleBackgroundLayerControl) (prop: MagicLightThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | MagicLightThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
