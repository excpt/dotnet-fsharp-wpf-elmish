...
type NavigationBarButtonProp =
    | Base of veButtonBaseProp

module NavigationBarButton =

    let apply (el: DevExpress.Xpf.Navigation.NavigationBarButton) (prop: NavigationBarButtonProp) =
        match prop with
        | NavigationBarButtonProp.Base p -> veButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.NavigationBarButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
