...
type CosmicMajorTickmarkControlProp =
    | Base of PresentationControlProp

module CosmicMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicMajorTickmarkControl) (prop: CosmicMajorTickmarkControlProp) =
        match prop with
        | CosmicMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
