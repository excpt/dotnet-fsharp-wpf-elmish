...
type FlatDarkSpindleCapControlProp =
    | Base of PresentationControlProp

module FlatDarkSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkSpindleCapControl) (prop: FlatDarkSpindleCapControlProp) =
        match prop with
        | FlatDarkSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
