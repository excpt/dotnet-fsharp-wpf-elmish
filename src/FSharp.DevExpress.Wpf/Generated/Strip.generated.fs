...
module Strip =
    let visible v : obj = box (StripProp.Visible v)
    let checkedInLegend v : obj = box (StripProp.CheckedInLegend v)
    let checkableInLegend v : obj = box (StripProp.CheckableInLegend v)
    let minLimit v : obj = box (StripProp.MinLimit v)
    let maxLimit v : obj = box (StripProp.MaxLimit v)
    let brush v : obj = box (StripProp.Brush v)
    let axisLabelText v : obj = box (StripProp.AxisLabelText v)
    let legendText v : obj = box (StripProp.LegendText v)
    let borderColor v : obj = box (StripProp.BorderColor v)
    let legendMarkerTemplate v : obj = box (StripProp.LegendMarkerTemplate v)
    let legend v : obj = box (StripProp.Legend v)

    let apply (el: DevExpress.Xpf.Charts.Strip) (prop: StripProp) =
        match prop with
        | StripProp.Base p -> ChartElement.apply el p
        | StripProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.Strip.VisibleProperty, box v)
        | StripProp.CheckedInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Strip.CheckedInLegendProperty, box v)
        | StripProp.CheckableInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Strip.CheckableInLegendProperty, box v)
        | StripProp.MinLimit v -> el.SetValue(DevExpress.Xpf.Charts.Strip.MinLimitProperty, box v)
        | StripProp.MaxLimit v -> el.SetValue(DevExpress.Xpf.Charts.Strip.MaxLimitProperty, box v)
        | StripProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.Strip.BrushProperty, box v)
        | StripProp.AxisLabelText v -> el.SetValue(DevExpress.Xpf.Charts.Strip.AxisLabelTextProperty, box v)
        | StripProp.LegendText v -> el.SetValue(DevExpress.Xpf.Charts.Strip.LegendTextProperty, box v)
        | StripProp.BorderColor v -> el.SetValue(DevExpress.Xpf.Charts.Strip.BorderColorProperty, box v)
        | StripProp.LegendMarkerTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Strip.LegendMarkerTemplateProperty, box v)
        | StripProp.Legend v -> el.SetValue(DevExpress.Xpf.Charts.Strip.LegendProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Strip>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
