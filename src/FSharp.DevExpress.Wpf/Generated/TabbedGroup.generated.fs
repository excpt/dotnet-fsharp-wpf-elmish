...
module TabbedGroup =
    ...
    let apply (el: DevExpress.Xpf.Docking.TabbedGroup) (prop: TabbedGroupProp) =
        match prop with
        | TabbedGroupProp.Base p -> LayoutGroup.apply el p
        | TabbedGroupProp.ShowTabForSinglePage v -> el.SetValue(DevExpress.Xpf.Docking.TabbedGroup.ShowTabForSinglePageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.TabbedGroup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
