...
type SunburstLabelPresentationProp =
    | LabelBounds of System.Windows.Rect
    | TextTrimming of System.Windows.TextTrimming
    | TextWrapping of System.Windows.TextWrapping
    | Text of string
    | LabelEffect of System.Windows.Media.Effects.Effect

module SunburstLabelPresentation =
    let labelBounds v : obj = box (SunburstLabelPresentationProp.LabelBounds v)
    let textTrimming v : obj = box (SunburstLabelPresentationProp.TextTrimming v)
    let textWrapping v : obj = box (SunburstLabelPresentationProp.TextWrapping v)
    let text v : obj = box (SunburstLabelPresentationProp.Text v)
    let labelEffect v : obj = box (SunburstLabelPresentationProp.LabelEffect v)

    let apply (el: DevExpress.Xpf.TreeMap.SunburstLabelPresentation) (prop: SunburstLabelPresentationProp) =
        match prop with
        | SunburstLabelPresentationProp.LabelBounds v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstLabelPresentation.LabelBoundsProperty, box v)
        | SunburstLabelPresentationProp.TextTrimming v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstLabelPresentation.TextTrimmingProperty, box v)
        | SunburstLabelPresentationProp.TextWrapping v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstLabelPresentation.TextWrappingProperty, box v)
        | SunburstLabelPresentationProp.Text v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstLabelPresentation.TextProperty, box v)
        | SunburstLabelPresentationProp.LabelEffect v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstLabelPresentation.LabelEffectProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.SunburstLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
