...
type ConditionEditorControlProp =
    | ItemsSource of obj
    | AllowChangeOperatorType of bool
    | AllowChangeMasterTable of bool
    | AllowCopyLeftTable of bool
    | AllowCopyRightTable of bool
    | AllowAddItems of bool
    | AllowRemoveItems of bool

module ConditionEditorControl =
    let itemsSource v : obj = box (ConditionEditorControlProp.ItemsSource v)
    let allowChangeOperatorType v : obj = box (ConditionEditorControlProp.AllowChangeOperatorType v)
    let allowChangeMasterTable v : obj = box (ConditionEditorControlProp.AllowChangeMasterTable v)
    let allowCopyLeftTable v : obj = box (ConditionEditorControlProp.AllowCopyLeftTable v)
    let allowCopyRightTable v : obj = box (ConditionEditorControlProp.AllowCopyRightTable v)
    let allowAddItems v : obj = box (ConditionEditorControlProp.AllowAddItems v)
    let allowRemoveItems v : obj = box (ConditionEditorControlProp.AllowRemoveItems v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl) (prop: ConditionEditorControlProp) =
        match prop with
        | ConditionEditorControlProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.ItemsSourceProperty, box v)
        | ConditionEditorControlProp.AllowChangeOperatorType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.AllowChangeOperatorTypeProperty, box v)
        | ConditionEditorControlProp.AllowChangeMasterTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.AllowChangeMasterTableProperty, box v)
        | ConditionEditorControlProp.AllowCopyLeftTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.AllowCopyLeftTableProperty, box v)
        | ConditionEditorControlProp.AllowCopyRightTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.AllowCopyRightTableProperty, box v)
        | ConditionEditorControlProp.AllowAddItems v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.AllowAddItemsProperty, box v)
        | ConditionEditorControlProp.AllowRemoveItems v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl.AllowRemoveItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
