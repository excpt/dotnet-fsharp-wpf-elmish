...
type CustomDictionaryControlProp =
...
module CustomDictionaryControl =
    let okCommand v : obj = box (CustomDictionaryControlProp.OkCommand v)
    let cancelCommand v : obj = box (CustomDictionaryControlProp.CancelCommand v)
    let text v : obj = box (CustomDictionaryControlProp.Text v)

    let apply (el: DevExpress.Xpf.SpellChecker.Forms.CustomDictionaryControl) (prop: CustomDictionaryControlProp) =
        match prop with
        | CustomDictionaryControlProp.Base p -> SpellCheckerControlBase.apply el p
        | CustomDictionaryControlProp.OkCommand v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.CustomDictionaryControl.OkCommandProperty, box v)
        | CustomDictionaryControlProp.CancelCommand v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.CustomDictionaryControl.CancelCommandProperty, box v)
        | CustomDictionaryControlProp.Text v -> el.SetValue(DevExpress.Xpf.SpellChecker.Forms.CustomDictionaryControl.TextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.SpellChecker.Forms.CustomDictionaryControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
