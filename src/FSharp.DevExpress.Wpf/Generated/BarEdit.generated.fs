...
module BarEdit =
    ...
    let apply (el: DevExpress.DashboardWpf.Internal.BarEdit) (prop: BarEditProp) =
        match prop with
        | BarEditProp.Base p -> TextEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.BarEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
