...
type InsertObjectViewProp =
    | Base of ThemedWindowProp

module InsertObjectView =

    let apply (el: DevExpress.Xpf.RichEdit.View.InsertObjectView) (prop: InsertObjectViewProp) =
        match prop with
        | InsertObjectViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.InsertObjectView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
