...
type ThemeableLinearScaleLevelBarForegroundControlProp =
    | Base of ThemeableLinearScaleLevelBarControlProp

module ThemeableLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableLinearScaleLevelBarForegroundControl) (prop: ThemeableLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | ThemeableLinearScaleLevelBarForegroundControlProp.Base p -> ThemeableLinearScaleLevelBarControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
