...
type AgendaAppointmentControlProp =
    | Base of AppointmentControlBaseProp
    | AllDayText of string
    | ShowLabel of obj
    | ShowResource of obj

module AgendaAppointmentControl =
    let allDayText v : obj = box (AgendaAppointmentControlProp.AllDayText v)
    let showLabel v : obj = box (AgendaAppointmentControlProp.ShowLabel v)
    let showResource v : obj = box (AgendaAppointmentControlProp.ShowResource v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AgendaAppointmentControl) (prop: AgendaAppointmentControlProp) =
        match prop with
        | AgendaAppointmentControlProp.Base p -> AppointmentControlBase.apply el p
        | AgendaAppointmentControlProp.AllDayText v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AgendaAppointmentControl.AllDayTextProperty, box v)
        | AgendaAppointmentControlProp.ShowLabel v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AgendaAppointmentControl.ShowLabelProperty, box v)
        | AgendaAppointmentControlProp.ShowResource v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AgendaAppointmentControl.ShowResourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AgendaAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
