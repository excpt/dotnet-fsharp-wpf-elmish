...
type IndicatorLabelElementsPanelProp =
    | Base of ChartItemsPanelBaseProp

module IndicatorLabelElementsPanel =

    let apply (el: DevExpress.Xpf.Charts.IndicatorLabelElementsPanel) (prop: IndicatorLabelElementsPanelProp) =
        match prop with
        | IndicatorLabelElementsPanelProp.Base p -> ChartItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.IndicatorLabelElementsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
