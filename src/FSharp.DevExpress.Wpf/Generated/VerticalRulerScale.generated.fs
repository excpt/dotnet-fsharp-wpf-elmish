...
type VerticalRulerScaleProp =
    | Base of DiagramRulerScaleBaseProp

module VerticalRulerScale =

    let apply (el: DevExpress.Xpf.Diagram.VerticalRulerScale) (prop: VerticalRulerScaleProp) =
        match prop with
        | VerticalRulerScaleProp.Base p -> DiagramRulerScaleBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.VerticalRulerScale>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
