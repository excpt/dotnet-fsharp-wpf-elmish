...
type LightweightEditorProp =
    | Base of InplaceEditorBaseProp

module LightweightEditor =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.LightweightEditor) (prop: LightweightEditorProp) =
        match prop with
        | LightweightEditorProp.Base p -> InplaceEditorBase.apply el p
