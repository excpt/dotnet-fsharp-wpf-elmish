...
type CircularSmartQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularSmartQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularSmartQuarterTopRightModel) (prop: CircularSmartQuarterTopRightModelProp) =
        match prop with
        | CircularSmartQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularSmartQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
