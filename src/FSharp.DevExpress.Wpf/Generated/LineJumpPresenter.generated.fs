...
type LineJumpPresenterProp =
    | Base of ShapeGeometryPresenterProp
    | LineJumpStyle of DevExpress.Diagram.Core.LineJumpDescription

module LineJumpPresenter =
    let lineJumpStyle v : obj = box (LineJumpPresenterProp.LineJumpStyle v)

    let apply (el: DevExpress.Xpf.Diagram.Native.LineJumpPresenter) (prop: LineJumpPresenterProp) =
        match prop with
        | LineJumpPresenterProp.Base p -> ShapeGeometryPresenter.apply el p
        | LineJumpPresenterProp.LineJumpStyle v -> el.SetValue(DevExpress.Xpf.Diagram.Native.LineJumpPresenter.LineJumpStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.LineJumpPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
