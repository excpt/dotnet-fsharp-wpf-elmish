...
type DragDropTemplatesContainerProp =
    | DefaultDragElementTemplate of System.Windows.DataTemplate

module DragDropTemplatesContainer =
    let defaultDragElementTemplate v : obj = box (DragDropTemplatesContainerProp.DefaultDragElementTemplate v)

    let apply (el: DevExpress.Xpf.Grid.DragDropTemplatesContainer) (prop: DragDropTemplatesContainerProp) =
        match prop with
        | DragDropTemplatesContainerProp.DefaultDragElementTemplate v -> el.SetValue(DevExpress.Xpf.Grid.DragDropTemplatesContainer.DefaultDragElementTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.DragDropTemplatesContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
