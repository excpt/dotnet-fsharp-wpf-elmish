...
type BarSideBySideFullStackedSeries2DProp =
    | Base of BarFullStackedSeries2DProp
    | StackedGroup of obj

module BarSideBySideFullStackedSeries2D =
    let stackedGroup v : obj = box (BarSideBySideFullStackedSeries2DProp.StackedGroup v)

    let apply (el: DevExpress.Xpf.Charts.BarSideBySideFullStackedSeries2D) (prop: BarSideBySideFullStackedSeries2DProp) =
        match prop with
        | BarSideBySideFullStackedSeries2DProp.Base p -> BarFullStackedSeries2D.apply el p
        | BarSideBySideFullStackedSeries2DProp.StackedGroup v -> el.SetValue(DevExpress.Xpf.Charts.BarSideBySideFullStackedSeries2D.StackedGroupProperty, box v)

    let model v : obj = box (BarSeries2DProp.Model v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BarSideBySideFullStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
