...
type DropsStock2DModelControlProp =
    | Base of PredefinedModelControlProp

module DropsStock2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.DropsStock2DModelControl) (prop: DropsStock2DModelControlProp) =
        match prop with
        | DropsStock2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.DropsStock2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
