...
type LinqCollectionViewDataSourceProp =
    | Base of CollectionViewDataSourceBaseProp

module LinqCollectionViewDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.LinqCollectionViewDataSource) (prop: LinqCollectionViewDataSourceProp) =
        match prop with
        | LinqCollectionViewDataSourceProp.Base p -> CollectionViewDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.LinqCollectionViewDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
