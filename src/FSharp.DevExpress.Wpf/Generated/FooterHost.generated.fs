...
module FooterHost =
    ...
    let apply (el: DevExpress.Xpf.Core.FooterHost) (prop: FooterHostProp) =
        match prop with
        | FooterHostProp.Base p -> ContentHostBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.FooterHost>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
