...
type DocumentTabContainerProp =
    | Base of LayoutTabControlProp
    | ActualBackground of System.Windows.Media.Brush
    | ContentBorderThickness of System.Windows.Thickness
    | BorderMargin of System.Windows.Thickness
    | IsActive of bool
    | TabColor of System.Windows.Media.Color
    | ThemeDependentBackground of System.Windows.Media.Brush

module DocumentTabContainer =
    let actualBackground v : obj = box (DocumentTabContainerProp.ActualBackground v)
    let contentBorderThickness v : obj = box (DocumentTabContainerProp.ContentBorderThickness v)
    let borderMargin v : obj = box (DocumentTabContainerProp.BorderMargin v)
    let isActive v : obj = box (DocumentTabContainerProp.IsActive v)
    let tabColor v : obj = box (DocumentTabContainerProp.TabColor v)
    let themeDependentBackground v : obj = box (DocumentTabContainerProp.ThemeDependentBackground v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer) (prop: DocumentTabContainerProp) =
        match prop with
        | DocumentTabContainerProp.Base p -> LayoutTabControl.apply el p
        | DocumentTabContainerProp.ActualBackground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer.ActualBackgroundProperty, box v)
        | DocumentTabContainerProp.ContentBorderThickness v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer.ContentBorderThicknessProperty, box v)
        | DocumentTabContainerProp.BorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer.BorderMarginProperty, box v)
        | DocumentTabContainerProp.IsActive v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer.IsActiveProperty, box v)
        | DocumentTabContainerProp.TabColor v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer.TabColorProperty, box v)
        | DocumentTabContainerProp.ThemeDependentBackground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer.ThemeDependentBackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentTabContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
