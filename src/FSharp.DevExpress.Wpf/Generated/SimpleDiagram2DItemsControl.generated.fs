...
type SimpleDiagram2DItemsControlProp =
    | Diagram of DevExpress.Xpf.Charts.SimpleDiagram2D

module SimpleDiagram2DItemsControl =
    let diagram v : obj = box (SimpleDiagram2DItemsControlProp.Diagram v)

    let apply (el: DevExpress.Xpf.Charts.SimpleDiagram2DItemsControl) (prop: SimpleDiagram2DItemsControlProp) =
        match prop with
        | SimpleDiagram2DItemsControlProp.Diagram v -> el.SetValue(DevExpress.Xpf.Charts.SimpleDiagram2DItemsControl.DiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleDiagram2DItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
