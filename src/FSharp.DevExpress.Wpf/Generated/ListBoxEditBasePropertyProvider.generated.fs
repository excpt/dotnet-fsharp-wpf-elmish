...
type ListBoxEditBasePropertyProviderProp =
...
module ListBoxEditBasePropertyProvider =
    let displayMemberPath v : obj = box (ListBoxEditBasePropertyProviderProp.DisplayMemberPath v)
    let selectionViewModel v : obj = box (ListBoxEditBasePropertyProviderProp.SelectionViewModel v)
    let showWaitIndicator v : obj = box (ListBoxEditBasePropertyProviderProp.ShowWaitIndicator v)
    let hasItemTemplate v : obj = box (ListBoxEditBasePropertyProviderProp.HasItemTemplate v)

    let apply (el: DevExpress.Xpf.Editors.ListBoxEditBasePropertyProvider) (prop: ListBoxEditBasePropertyProviderProp) =
        match prop with
        | ListBoxEditBasePropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
        | ListBoxEditBasePropertyProviderProp.DisplayMemberPath v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEditBasePropertyProvider.DisplayMemberPathProperty, box v)
        | ListBoxEditBasePropertyProviderProp.SelectionViewModel v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEditBasePropertyProvider.SelectionViewModelProperty, box v)
        | ListBoxEditBasePropertyProviderProp.ShowWaitIndicator v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEditBasePropertyProvider.ShowWaitIndicatorProperty, box v)
        | ListBoxEditBasePropertyProviderProp.HasItemTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEditBasePropertyProvider.HasItemTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ListBoxEditBasePropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
