...
type BaseControlBoxControlProp =
    | Base of psvControlProp
    | ButtonWidth of float
    | ButtonHeight of float
    | CloseButtonTemplate of System.Windows.DataTemplate
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem
    | ButtonStyle of System.Windows.Style

module BaseControlBoxControl =
    ...
    let apply (el: DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl) (prop: BaseControlBoxControlProp) =
        match prop with
        | BaseControlBoxControlProp.Base p -> psvControl.apply el p
        | BaseControlBoxControlProp.ButtonWidth v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl.ButtonWidthProperty, box v)
        | BaseControlBoxControlProp.ButtonHeight v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl.ButtonHeightProperty, box v)
        | BaseControlBoxControlProp.CloseButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl.CloseButtonTemplateProperty, box v)
        | BaseControlBoxControlProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl.LayoutItemProperty, box v)
        | BaseControlBoxControlProp.ButtonStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl.ButtonStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.BaseControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
