...
type MainMenuControlProp =
    | Base of ToolBarControlBaseProp

module MainMenuControl =

    let apply (el: DevExpress.Xpf.Bars.MainMenuControl) (prop: MainMenuControlProp) =
        match prop with
        | MainMenuControlProp.Base p -> ToolBarControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.MainMenuControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
