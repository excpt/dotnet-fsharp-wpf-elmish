...
type DateNavigatorCellButtonProp =
    | Appearance of DevExpress.Xpf.Editors.DateNavigator.DateNavigatorStateAppearance

module DateNavigatorCellButton =
    let appearance v : obj = box (DateNavigatorCellButtonProp.Appearance v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCellButton) (prop: DateNavigatorCellButtonProp) =
        match prop with
        | DateNavigatorCellButtonProp.Appearance v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCellButton.AppearanceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCellButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
