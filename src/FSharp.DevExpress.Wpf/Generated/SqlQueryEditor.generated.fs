...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.Native.Sql
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SqlQueryEditorProp =
    | Context of DevExpress.Xpf.DataAccess.Native.Sql.SqlQueryEditContextBase

module SqlQueryEditor =
    let context v : obj = box (SqlQueryEditorProp.Context v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Sql.SqlQueryEditor) (prop: SqlQueryEditorProp) =
        match prop with
        | SqlQueryEditorProp.Context v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Sql.SqlQueryEditor.ContextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Sql.SqlQueryEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
