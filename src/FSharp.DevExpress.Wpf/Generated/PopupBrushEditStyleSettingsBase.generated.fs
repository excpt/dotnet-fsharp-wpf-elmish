...
type PopupBrushEditStyleSettingsBaseProp =
    | Base of PopupBaseEditStyleSettingsProp

module PopupBrushEditStyleSettingsBase =

    let apply (el: DevExpress.Xpf.Editors.PopupBrushEditStyleSettingsBase) (prop: PopupBrushEditStyleSettingsBaseProp) =
        match prop with
        | PopupBrushEditStyleSettingsBaseProp.Base p -> PopupBaseEditStyleSettings.apply el p
