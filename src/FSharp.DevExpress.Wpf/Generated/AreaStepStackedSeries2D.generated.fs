...
type AreaStepStackedSeries2DProp =
    | Base of AreaStackedSeries2DProp
    | SnapCrosshairToActualStep of bool

module AreaStepStackedSeries2D =
    let snapCrosshairToActualStep v : obj = box (AreaStepStackedSeries2DProp.SnapCrosshairToActualStep v)

    let apply (el: DevExpress.Xpf.Charts.AreaStepStackedSeries2D) (prop: AreaStepStackedSeries2DProp) =
        match prop with
        | AreaStepStackedSeries2DProp.Base p -> AreaStackedSeries2D.apply el p
        | AreaStepStackedSeries2DProp.SnapCrosshairToActualStep v -> el.SetValue(DevExpress.Xpf.Charts.AreaStepStackedSeries2D.SnapCrosshairToActualStepProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaStepStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
