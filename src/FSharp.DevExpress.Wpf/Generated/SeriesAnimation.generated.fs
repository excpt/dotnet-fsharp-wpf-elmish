...
type SeriesAnimationProp =
    | Base of ChartAnimationProp
    | TargetSeries of DevExpress.Xpf.Charts.Series

module SeriesAnimation =
    let targetSeries v : obj = box (SeriesAnimationProp.TargetSeries v)

    let apply (el: DevExpress.Xpf.Charts.SeriesAnimation) (prop: SeriesAnimationProp) =
        match prop with
        | SeriesAnimationProp.Base p -> ChartAnimation.apply el p
        | SeriesAnimationProp.TargetSeries v -> el.SetValue(DevExpress.Xpf.Charts.SeriesAnimation.TargetSeriesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesAnimation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
