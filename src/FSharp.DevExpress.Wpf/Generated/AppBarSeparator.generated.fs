...
type AppBarSeparatorProp =
    | Alignment of DevExpress.Xpf.WindowsUI.AppBarElementAlignment
    | IsCompact of bool

module AppBarSeparator =
    let alignment v : obj = box (AppBarSeparatorProp.Alignment v)
    let isCompact v : obj = box (AppBarSeparatorProp.IsCompact v)

    let apply (el: DevExpress.Xpf.WindowsUI.AppBarSeparator) (prop: AppBarSeparatorProp) =
        match prop with
        | AppBarSeparatorProp.Alignment v -> el.SetValue(DevExpress.Xpf.WindowsUI.AppBarSeparator.AlignmentProperty, box v)
        | AppBarSeparatorProp.IsCompact v -> el.SetValue(DevExpress.Xpf.WindowsUI.AppBarSeparator.IsCompactProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.AppBarSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
