...
type MagicLightMajorTickmarkControlProp =
    | Base of PresentationControlProp

module MagicLightMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightMajorTickmarkControl) (prop: MagicLightMajorTickmarkControlProp) =
        match prop with
        | MagicLightMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
