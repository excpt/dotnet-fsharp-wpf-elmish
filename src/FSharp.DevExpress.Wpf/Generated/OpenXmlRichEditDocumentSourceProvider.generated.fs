...
type OpenXmlRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module OpenXmlRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.OpenXmlRichEditDocumentSourceProvider) (prop: OpenXmlRichEditDocumentSourceProviderProp) =
        match prop with
        | OpenXmlRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.OpenXmlRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
