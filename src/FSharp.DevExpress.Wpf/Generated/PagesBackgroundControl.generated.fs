...
type PagesBackgroundControlProp =
    | ZoomFactor of float
    | ItemsOffset of System.Windows.Point
    | BackgroundTemplate of System.Windows.DataTemplate
    | PageBackgroundTemplate of System.Windows.DataTemplate
    | PageBackgroundTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | Diagram of DevExpress.Xpf.Diagram.DiagramControl
    | PageMargin of System.Windows.Thickness
    | Scale of float

module PagesBackgroundControl =
    let zoomFactor v : obj = box (PagesBackgroundControlProp.ZoomFactor v)
    let itemsOffset v : obj = box (PagesBackgroundControlProp.ItemsOffset v)
    let backgroundTemplate v : obj = box (PagesBackgroundControlProp.BackgroundTemplate v)
    let pageBackgroundTemplate v : obj = box (PagesBackgroundControlProp.PageBackgroundTemplate v)
    let pageBackgroundTemplateSelector v : obj = box (PagesBackgroundControlProp.PageBackgroundTemplateSelector v)
    let diagram v : obj = box (PagesBackgroundControlProp.Diagram v)
    let pageMargin v : obj = box (PagesBackgroundControlProp.PageMargin v)
    let scale v : obj = box (PagesBackgroundControlProp.Scale v)

    let apply (el: DevExpress.Xpf.Diagram.PagesBackgroundControl) (prop: PagesBackgroundControlProp) =
        match prop with
        | PagesBackgroundControlProp.ZoomFactor v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.ZoomFactorProperty, box v)
        | PagesBackgroundControlProp.ItemsOffset v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.ItemsOffsetProperty, box v)
        | PagesBackgroundControlProp.BackgroundTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.BackgroundTemplateProperty, box v)
        | PagesBackgroundControlProp.PageBackgroundTemplate v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.PageBackgroundTemplateProperty, box v)
        | PagesBackgroundControlProp.PageBackgroundTemplateSelector v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.PageBackgroundTemplateSelectorProperty, box v)
        | PagesBackgroundControlProp.Diagram v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.DiagramProperty, box v)
        | PagesBackgroundControlProp.PageMargin v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.PageMarginProperty, box v)
        | PagesBackgroundControlProp.Scale v -> el.SetValue(DevExpress.Xpf.Diagram.PagesBackgroundControl.ScaleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.PagesBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
