...
type NavPanePopupProp =
    | Orientation of System.Windows.Controls.Orientation
    | ActualParent of System.Windows.FrameworkElement

module NavPanePopup =
    let orientation v : obj = box (NavPanePopupProp.Orientation v)
    let actualParent v : obj = box (NavPanePopupProp.ActualParent v)

    let apply (el: DevExpress.Xpf.NavBar.NavPanePopup) (prop: NavPanePopupProp) =
        match prop with
        | NavPanePopupProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavPanePopup.OrientationProperty, box v)
        | NavPanePopupProp.ActualParent v -> el.SetValue(DevExpress.Xpf.NavBar.NavPanePopup.ActualParentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPanePopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
