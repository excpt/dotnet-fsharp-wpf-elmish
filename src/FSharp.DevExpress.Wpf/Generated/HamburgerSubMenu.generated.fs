...
type HamburgerSubMenuProp =
    | Placement of DevExpress.Xpf.WindowsUI.HamburgerMenuItemPlacement
    | ItemsSource of obj
    ...
    | FlyoutHeader of string
    | FlyoutHeaderTemplate of System.Windows.DataTemplate
    | FlyoutHeaderHeight of float
    | FlyoutHeaderFontSize of float
    | FlyoutHeaderPadding of System.Windows.Thickness
    | FlyoutPaneWidth of float
    | FlyoutDisplayMode of DevExpress.Xpf.WindowsUI.HamburgerSubMenuFlyoutDisplayMode
    | FlyoutPaneMinWidth of float
    | MoreButtonVisibilityMode of DevExpress.Xpf.WindowsUI.HamburgerSubMenuMoreButtonVisibility
    | IsStandaloneSelectionItemMode of bool
    | SelectedItem of obj
    | CompactModeVisibility of DevExpress.Xpf.WindowsUI.HamburgerItemCompactModeVisibility
    | Glyph of System.Windows.Media.ImageSource
    | GlyphTemplate of System.Windows.DataTemplate
    | GlyphWidth of float
    | GlyphHeight of float
    | GlyphStretch of System.Windows.Media.Stretch
    | UseDefaultSubMenuImageColorizer of bool
    | AllowGlyphTheming of bool
    | GlyphColor of obj

module HamburgerSubMenu =
    let placement v : obj = box (HamburgerSubMenuProp.Placement v)
    let itemsSource v : obj = box (HamburgerSubMenuProp.ItemsSource v)
    let itemTemplate v : obj = box (HamburgerSubMenuProp.ItemTemplate v)
    let itemTemplateSelector v : obj = box (HamburgerSubMenuProp.ItemTemplateSelector v)
    let itemStyle v : obj = box (HamburgerSubMenuProp.ItemStyle v)
    let itemStyleSelector v : obj = box (HamburgerSubMenuProp.ItemStyleSelector v)
    let flyoutHeader v : obj = box (HamburgerSubMenuProp.FlyoutHeader v)
    let flyoutHeaderTemplate v : obj = box (HamburgerSubMenuProp.FlyoutHeaderTemplate v)
    let flyoutHeaderHeight v : obj = box (HamburgerSubMenuProp.FlyoutHeaderHeight v)
    let flyoutHeaderFontSize v : obj = box (HamburgerSubMenuProp.FlyoutHeaderFontSize v)
    let flyoutHeaderPadding v : obj = box (HamburgerSubMenuProp.FlyoutHeaderPadding v)
    let flyoutPaneWidth v : obj = box (HamburgerSubMenuProp.FlyoutPaneWidth v)
    let flyoutDisplayMode v : obj = box (HamburgerSubMenuProp.FlyoutDisplayMode v)
    let flyoutPaneMinWidth v : obj = box (HamburgerSubMenuProp.FlyoutPaneMinWidth v)
    let moreButtonVisibilityMode v : obj = box (HamburgerSubMenuProp.MoreButtonVisibilityMode v)
    let isStandaloneSelectionItemMode v : obj = box (HamburgerSubMenuProp.IsStandaloneSelectionItemMode v)
    let selectedItem v : obj = box (HamburgerSubMenuProp.SelectedItem v)
    let compactModeVisibility v : obj = box (HamburgerSubMenuProp.CompactModeVisibility v)
    let glyph v : obj = box (HamburgerSubMenuProp.Glyph v)
    let glyphTemplate v : obj = box (HamburgerSubMenuProp.GlyphTemplate v)
    let glyphWidth v : obj = box (HamburgerSubMenuProp.GlyphWidth v)
    let glyphHeight v : obj = box (HamburgerSubMenuProp.GlyphHeight v)
    let glyphStretch v : obj = box (HamburgerSubMenuProp.GlyphStretch v)
    let useDefaultSubMenuImageColorizer v : obj = box (HamburgerSubMenuProp.UseDefaultSubMenuImageColorizer v)
    let allowGlyphTheming v : obj = box (HamburgerSubMenuProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (HamburgerSubMenuProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerSubMenu) (prop: HamburgerSubMenuProp) =
        match prop with
        | HamburgerSubMenuProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.PlacementProperty, box v)
        | HamburgerSubMenuProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.ItemsSourceProperty, box v)
        | HamburgerSubMenuProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.ItemTemplateProperty, box v)
        | HamburgerSubMenuProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.ItemTemplateSelectorProperty, box v)
        | HamburgerSubMenuProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.ItemStyleProperty, box v)
        | HamburgerSubMenuProp.ItemStyleSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.ItemStyleSelectorProperty, box v)
        | HamburgerSubMenuProp.FlyoutHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutHeaderProperty, box v)
        | HamburgerSubMenuProp.FlyoutHeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutHeaderTemplateProperty, box v)
        | HamburgerSubMenuProp.FlyoutHeaderHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutHeaderHeightProperty, box v)
        | HamburgerSubMenuProp.FlyoutHeaderFontSize v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutHeaderFontSizeProperty, box v)
        | HamburgerSubMenuProp.FlyoutHeaderPadding v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutHeaderPaddingProperty, box v)
        | HamburgerSubMenuProp.FlyoutPaneWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutPaneWidthProperty, box v)
        | HamburgerSubMenuProp.FlyoutDisplayMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutDisplayModeProperty, box v)
        | HamburgerSubMenuProp.FlyoutPaneMinWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.FlyoutPaneMinWidthProperty, box v)
        | HamburgerSubMenuProp.MoreButtonVisibilityMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.MoreButtonVisibilityModeProperty, box v)
        | HamburgerSubMenuProp.IsStandaloneSelectionItemMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.IsStandaloneSelectionItemModeProperty, box v)
        | HamburgerSubMenuProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.SelectedItemProperty, box v)
        | HamburgerSubMenuProp.CompactModeVisibility v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.CompactModeVisibilityProperty, box v)
        | HamburgerSubMenuProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.GlyphProperty, box v)
        | HamburgerSubMenuProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.GlyphTemplateProperty, box v)
        | HamburgerSubMenuProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.GlyphWidthProperty, box v)
        | HamburgerSubMenuProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.GlyphHeightProperty, box v)
        | HamburgerSubMenuProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.GlyphStretchProperty, box v)
        | HamburgerSubMenuProp.UseDefaultSubMenuImageColorizer v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.UseDefaultSubMenuImageColorizerProperty, box v)
        | HamburgerSubMenuProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.AllowGlyphThemingProperty, box v)
        | HamburgerSubMenuProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenu.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerSubMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
