...
type VisualDayOfWeekHeaderProp =
    | Base of VisualResourceCellBaseProp

module VisualDayOfWeekHeader =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDayOfWeekHeader) (prop: VisualDayOfWeekHeaderProp) =
        match prop with
        | VisualDayOfWeekHeaderProp.Base p -> VisualResourceCellBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDayOfWeekHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
