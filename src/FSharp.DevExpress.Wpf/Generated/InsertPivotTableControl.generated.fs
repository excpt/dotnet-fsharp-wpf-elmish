...
type InsertPivotTableControlProp =
    | Base of ReferenceEditBaseControlProp

module InsertPivotTableControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.InsertPivotTableControl) (prop: InsertPivotTableControlProp) =
        match prop with
        | InsertPivotTableControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.InsertPivotTableControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
