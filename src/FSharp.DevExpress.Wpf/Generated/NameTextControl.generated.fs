...
type NameTextControlProp =
    | NameValue of string
    | TextValue of string

module NameTextControl =
    let nameValue v : obj = box (NameTextControlProp.NameValue v)
    let textValue v : obj = box (NameTextControlProp.TextValue v)

    let apply (el: DevExpress.Xpf.Grid.NameTextControl) (prop: NameTextControlProp) =
        match prop with
        | NameTextControlProp.NameValue v -> el.SetValue(DevExpress.Xpf.Grid.NameTextControl.NameValueProperty, box v)
        | NameTextControlProp.TextValue v -> el.SetValue(DevExpress.Xpf.Grid.NameTextControl.TextValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.NameTextControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
