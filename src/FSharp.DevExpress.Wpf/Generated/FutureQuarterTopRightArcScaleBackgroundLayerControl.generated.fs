...
type FutureQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureQuarterTopRightArcScaleBackgroundLayerControl) (prop: FutureQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | FutureQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
