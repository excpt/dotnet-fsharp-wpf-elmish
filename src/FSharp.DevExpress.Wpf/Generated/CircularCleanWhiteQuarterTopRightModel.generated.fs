...
type CircularCleanWhiteQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCleanWhiteQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCleanWhiteQuarterTopRightModel) (prop: CircularCleanWhiteQuarterTopRightModelProp) =
        match prop with
        | CircularCleanWhiteQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCleanWhiteQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
