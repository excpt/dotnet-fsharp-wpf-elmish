...
type AxisElementsRenderControlBaseProp =
    | Base of ChartElementBaseProp
    | AxesSource of DevExpress.Xpf.Charts.Native.IAxesSource

module AxisElementsRenderControlBase =
    let axesSource v : obj = box (AxisElementsRenderControlBaseProp.AxesSource v)

    let apply (el: DevExpress.Xpf.Charts.AxisElementsRenderControlBase) (prop: AxisElementsRenderControlBaseProp) =
        match prop with
        | AxisElementsRenderControlBaseProp.Base p -> ChartElementBase.apply el p
        | AxisElementsRenderControlBaseProp.AxesSource v -> el.SetValue(DevExpress.Xpf.Charts.AxisElementsRenderControlBase.AxesSourceProperty, box v)
