...
type VisualFeedbackControlProp =
    | LineBrush of System.Windows.Media.Brush

module VisualFeedbackControl =
    let lineBrush v : obj = box (VisualFeedbackControlProp.LineBrush v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.VisualFeedbackControl) (prop: VisualFeedbackControlProp) =
        match prop with
        | VisualFeedbackControlProp.LineBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.VisualFeedbackControl.LineBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.VisualFeedbackControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
