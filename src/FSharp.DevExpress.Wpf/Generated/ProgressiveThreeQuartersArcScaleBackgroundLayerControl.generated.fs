...
type ProgressiveThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveThreeQuartersArcScaleBackgroundLayerControl) (prop: ProgressiveThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | ProgressiveThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
