...
type EmptyStateIndicatorModelProp =
    | Base of StateIndicatorModelProp

module EmptyStateIndicatorModel =

    let apply (el: DevExpress.Xpf.Gauges.EmptyStateIndicatorModel) (prop: EmptyStateIndicatorModelProp) =
        match prop with
        | EmptyStateIndicatorModelProp.Base p -> StateIndicatorModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EmptyStateIndicatorModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
