...
type PdfPasswordSecurityOptionsViewProp =
    | Base of ThemedWindowProp

module PdfPasswordSecurityOptionsView =

    let apply (el: DevExpress.Xpf.Printing.Native.PdfPasswordSecurityOptionsView) (prop: PdfPasswordSecurityOptionsViewProp) =
        match prop with
        | PdfPasswordSecurityOptionsViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.PdfPasswordSecurityOptionsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
