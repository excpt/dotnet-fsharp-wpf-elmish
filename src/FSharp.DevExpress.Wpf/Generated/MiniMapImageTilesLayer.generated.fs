...
type MiniMapImageTilesLayerProp =
    | Base of MiniMapLayerBaseProp
    | DataProvider of DevExpress.Xpf.Map.MapTileDataProviderBase

module MiniMapImageTilesLayer =
    let dataProvider v : obj = box (MiniMapImageTilesLayerProp.DataProvider v)

    let apply (el: DevExpress.Xpf.Map.MiniMapImageTilesLayer) (prop: MiniMapImageTilesLayerProp) =
        match prop with
        | MiniMapImageTilesLayerProp.Base p -> MiniMapLayerBase.apply el p
        | MiniMapImageTilesLayerProp.DataProvider v -> el.SetValue(DevExpress.Xpf.Map.MiniMapImageTilesLayer.DataProviderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MiniMapImageTilesLayer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
