...
type SeriesPointAnimationActionProp =
    | Base of ChartElementProp

module SeriesPointAnimationAction =

    let apply (el: DevExpress.Xpf.Charts.SeriesPointAnimationAction) (prop: SeriesPointAnimationActionProp) =
        match prop with
        | SeriesPointAnimationActionProp.Base p -> ChartElement.apply el p
