...
type RibbonPageGroupPopupProp =
    | Base of BarPopupBaseProp
    | PageGroup of DevExpress.Xpf.Ribbon.RibbonPageGroup
    | OwnerPageGroupControl of DevExpress.Xpf.Ribbon.RibbonPageGroupControl

module RibbonPageGroupPopup =
    let pageGroup v : obj = box (RibbonPageGroupPopupProp.PageGroup v)
    let ownerPageGroupControl v : obj = box (RibbonPageGroupPopupProp.OwnerPageGroupControl v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageGroupPopup) (prop: RibbonPageGroupPopupProp) =
        match prop with
        | RibbonPageGroupPopupProp.Base p -> BarPopupBase.apply el p
        | RibbonPageGroupPopupProp.PageGroup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupPopup.PageGroupProperty, box v)
        | RibbonPageGroupPopupProp.OwnerPageGroupControl v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupPopup.OwnerPageGroupControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageGroupPopup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
