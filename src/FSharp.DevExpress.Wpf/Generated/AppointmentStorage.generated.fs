...
type AppointmentStorageProp =
    | Mappings of DevExpress.Xpf.Scheduler.AppointmentMapping
    | CommitIdToDataSource of bool
    | Labels of DevExpress.Xpf.Scheduler.AppointmentLabelCollection
    | Statuses of DevExpress.Xpf.Scheduler.AppointmentStatusCollection
    | ResourceSharing of bool

module AppointmentStorage =
    let mappings v : obj = box (AppointmentStorageProp.Mappings v)
    let commitIdToDataSource v : obj = box (AppointmentStorageProp.CommitIdToDataSource v)
    let labels v : obj = box (AppointmentStorageProp.Labels v)
    let statuses v : obj = box (AppointmentStorageProp.Statuses v)
    let resourceSharing v : obj = box (AppointmentStorageProp.ResourceSharing v)

    let apply (el: DevExpress.Xpf.Scheduler.AppointmentStorage) (prop: AppointmentStorageProp) =
        match prop with
        | AppointmentStorageProp.Mappings v -> el.SetValue(DevExpress.Xpf.Scheduler.AppointmentStorage.MappingsProperty, box v)
        | AppointmentStorageProp.CommitIdToDataSource v -> el.SetValue(DevExpress.Xpf.Scheduler.AppointmentStorage.CommitIdToDataSourceProperty, box v)
        | AppointmentStorageProp.Labels v -> el.SetValue(DevExpress.Xpf.Scheduler.AppointmentStorage.LabelsProperty, box v)
        | AppointmentStorageProp.Statuses v -> el.SetValue(DevExpress.Xpf.Scheduler.AppointmentStorage.StatusesProperty, box v)
        | AppointmentStorageProp.ResourceSharing v -> el.SetValue(DevExpress.Xpf.Scheduler.AppointmentStorage.ResourceSharingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.AppointmentStorage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
