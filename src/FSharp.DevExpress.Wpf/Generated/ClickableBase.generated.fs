...
type ClickableBaseProp =
    | Base of veContentContainerProp

module ClickableBase =

    let apply (el: DevExpress.Xpf.Controls.Primitives.ClickableBase) (prop: ClickableBaseProp) =
        match prop with
        | ClickableBaseProp.Base p -> veContentContainer.apply el p
