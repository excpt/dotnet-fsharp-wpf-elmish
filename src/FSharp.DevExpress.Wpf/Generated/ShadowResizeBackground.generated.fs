...
type ShadowResizeBackgroundProp =
    | Base of psvControlProp

module ShadowResizeBackground =

    let apply (el: DevExpress.Xpf.Docking.Platform.ShadowResizeBackground) (prop: ShadowResizeBackgroundProp) =
        match prop with
        | ShadowResizeBackgroundProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.ShadowResizeBackground>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
