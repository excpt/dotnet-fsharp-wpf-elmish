...
type DotRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module DotRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.DotRichEditDocumentSourceProvider) (prop: DotRichEditDocumentSourceProviderProp) =
        match prop with
        | DotRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.DotRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
