...
type HeaderItemControlProp =
    | ShowBorder of bool
    | TemplateProvider of DevExpress.Xpf.Core.HeaderItemControlTemplateProvider

module HeaderItemControl =
    let showBorder v : obj = box (HeaderItemControlProp.ShowBorder v)
    let templateProvider v : obj = box (HeaderItemControlProp.TemplateProvider v)

    let apply (el: DevExpress.Xpf.Core.HeaderItemControl) (prop: HeaderItemControlProp) =
        match prop with
        | HeaderItemControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Core.HeaderItemControl.ShowBorderProperty, box v)
        | HeaderItemControlProp.TemplateProvider v -> el.SetValue(DevExpress.Xpf.Core.HeaderItemControl.TemplateProviderProperty, box v)
    ...
    let closeTemplateProvider (v: DevExpress.Xpf.Core.CloseHeaderItemControlTemplateProvider) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.HeaderItemControl.CloseTemplateProviderProperty, box v)) :: node.Props }
    let commonTemplateProvider (v: DevExpress.Xpf.Core.CommonHeaderItemControlTemplateProvider) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.HeaderItemControl.CommonTemplateProviderProperty, box v)) :: node.Props }
    let extendedCloseTemplateProvider (v: DevExpress.Xpf.Core.CloseHeaderItemControlTemplateProvider) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.HeaderItemControl.ExtendedCloseTemplateProviderProperty, box v)) :: node.Props }
    let extendedCommonTemplateProvider (v: DevExpress.Xpf.Core.CommonHeaderItemControlTemplateProvider) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.HeaderItemControl.ExtendedCommonTemplateProviderProperty, box v)) :: node.Props }
    let useExtendedTemplateProviders (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.HeaderItemControl.UseExtendedTemplateProvidersProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Core.HeaderItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
