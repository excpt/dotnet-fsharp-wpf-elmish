...
module TreeViewEx =
    let currentItem v : obj = box (TreeViewExProp.CurrentItem v)

    let apply (el: DevExpress.Xpf.ExpressionEditor.Native.TreeViewEx) (prop: TreeViewExProp) =
        match prop with
        | TreeViewExProp.CurrentItem v -> el.SetValue(DevExpress.Xpf.ExpressionEditor.Native.TreeViewEx.CurrentItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.ExpressionEditor.Native.TreeViewEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
