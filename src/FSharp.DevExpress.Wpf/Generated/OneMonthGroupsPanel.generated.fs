...
type OneMonthGroupsPanelProp =
    ...
    | ItemContainerAutoSize of bool
    | ItemContainerMinHeight of float

module OneMonthGroupsPanel =
    let view v : obj = box (OneMonthGroupsPanelProp.View v)
    let itemContainerVerticalBorderThickness v : obj = box (OneMonthGroupsPanelProp.ItemContainerVerticalBorderThickness v)
    let itemContainerHorizontalBorderThickness v : obj = box (OneMonthGroupsPanelProp.ItemContainerHorizontalBorderThickness v)
    let itemContainerAppointmentsContainerStyle v : obj = box (OneMonthGroupsPanelProp.ItemContainerAppointmentsContainerStyle v)
    let itemContainerDragAppointmentsContainerStyle v : obj = box (OneMonthGroupsPanelProp.ItemContainerDragAppointmentsContainerStyle v)
    let itemContainerAutoSize v : obj = box (OneMonthGroupsPanelProp.ItemContainerAutoSize v)
    let itemContainerMinHeight v : obj = box (OneMonthGroupsPanelProp.ItemContainerMinHeight v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel) (prop: OneMonthGroupsPanelProp) =
        match prop with
        | OneMonthGroupsPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ViewProperty, box v)
        | OneMonthGroupsPanelProp.ItemContainerVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ItemContainerVerticalBorderThicknessProperty, box v)
        | OneMonthGroupsPanelProp.ItemContainerHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ItemContainerHorizontalBorderThicknessProperty, box v)
        | OneMonthGroupsPanelProp.ItemContainerAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ItemContainerAppointmentsContainerStyleProperty, box v)
        | OneMonthGroupsPanelProp.ItemContainerDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ItemContainerDragAppointmentsContainerStyleProperty, box v)
        | OneMonthGroupsPanelProp.ItemContainerAutoSize v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ItemContainerAutoSizeProperty, box v)
        | OneMonthGroupsPanelProp.ItemContainerMinHeight v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel.ItemContainerMinHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
