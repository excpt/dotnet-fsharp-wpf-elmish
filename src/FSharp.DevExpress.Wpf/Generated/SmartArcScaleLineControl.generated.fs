...
type SmartArcScaleLineControlProp =
    | Base of PresentationControlProp

module SmartArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartArcScaleLineControl) (prop: SmartArcScaleLineControlProp) =
        match prop with
        | SmartArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
