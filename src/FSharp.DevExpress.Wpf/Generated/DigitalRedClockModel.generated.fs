...
type DigitalRedClockModelProp =
    | Base of DigitalGaugeModelProp

module DigitalRedClockModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalRedClockModel) (prop: DigitalRedClockModelProp) =
        match prop with
        | DigitalRedClockModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalRedClockModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
