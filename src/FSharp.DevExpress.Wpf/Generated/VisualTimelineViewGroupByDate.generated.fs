...
type VisualTimelineViewGroupByDateProp =
    | Base of VisualTimelineViewGroupBaseProp

module VisualTimelineViewGroupByDate =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupByDate) (prop: VisualTimelineViewGroupByDateProp) =
        match prop with
        | VisualTimelineViewGroupByDateProp.Base p -> VisualTimelineViewGroupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupByDate>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
