...
type FormBorderContentControlProp =
    | IsActive of bool

module FormBorderContentControl =
    let isActive v : obj = box (FormBorderContentControlProp.IsActive v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FormBorderContentControl) (prop: FormBorderContentControlProp) =
        match prop with
        | FormBorderContentControlProp.IsActive v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderContentControl.IsActiveProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FormBorderContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
