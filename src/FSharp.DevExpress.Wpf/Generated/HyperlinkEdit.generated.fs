...
type HyperlinkEditProp =
    | Base of BaseEditProp
    | NavigationUrlMember of string
    | NavigationUrlFormat of string
    | NavigationUrl of string
    | Text of string
    | DisplayMember of string
    | AllowAutoNavigate of bool
    | Command of System.Windows.Input.ICommand
    | CommandParameter of obj
    | CommandTarget of System.Windows.IInputElement
    | ShowNavigationUrlToolTip of bool
    | TextWrapping of System.Windows.TextWrapping
    | TextTrimming of System.Windows.TextTrimming
    | OnRequestNavigation of DevExpress.Xpf.Editors.HyperlinkEditRequestNavigationEventHandler

module HyperlinkEdit =
    let navigationUrlMember v : obj = box (HyperlinkEditProp.NavigationUrlMember v)
    let navigationUrlFormat v : obj = box (HyperlinkEditProp.NavigationUrlFormat v)
    let navigationUrl v : obj = box (HyperlinkEditProp.NavigationUrl v)
    let text v : obj = box (HyperlinkEditProp.Text v)
    let displayMember v : obj = box (HyperlinkEditProp.DisplayMember v)
    let allowAutoNavigate v : obj = box (HyperlinkEditProp.AllowAutoNavigate v)
    let command v : obj = box (HyperlinkEditProp.Command v)
    let commandParameter v : obj = box (HyperlinkEditProp.CommandParameter v)
    let commandTarget v : obj = box (HyperlinkEditProp.CommandTarget v)
    let showNavigationUrlToolTip v : obj = box (HyperlinkEditProp.ShowNavigationUrlToolTip v)
    let textWrapping v : obj = box (HyperlinkEditProp.TextWrapping v)
    let textTrimming v : obj = box (HyperlinkEditProp.TextTrimming v)
    let onRequestNavigation v : obj = box (EventProp(box (HyperlinkEditProp.OnRequestNavigation v)))

    let apply (el: DevExpress.Xpf.Editors.HyperlinkEdit) (prop: HyperlinkEditProp) =
        match prop with
        | HyperlinkEditProp.Base p -> BaseEdit.apply el p
        | HyperlinkEditProp.NavigationUrlMember v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.NavigationUrlMemberProperty, box v)
        | HyperlinkEditProp.NavigationUrlFormat v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.NavigationUrlFormatProperty, box v)
        | HyperlinkEditProp.NavigationUrl v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.NavigationUrlProperty, box v)
        | HyperlinkEditProp.Text v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.TextProperty, box v)
        | HyperlinkEditProp.DisplayMember v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.DisplayMemberProperty, box v)
        | HyperlinkEditProp.AllowAutoNavigate v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.AllowAutoNavigateProperty, box v)
        | HyperlinkEditProp.Command v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.CommandProperty, box v)
        | HyperlinkEditProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.CommandParameterProperty, box v)
        | HyperlinkEditProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.CommandTargetProperty, box v)
        | HyperlinkEditProp.ShowNavigationUrlToolTip v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.ShowNavigationUrlToolTipProperty, box v)
        | HyperlinkEditProp.TextWrapping v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.TextWrappingProperty, box v)
        | HyperlinkEditProp.TextTrimming v -> el.SetValue(DevExpress.Xpf.Editors.HyperlinkEdit.TextTrimmingProperty, box v)
        | HyperlinkEditProp.OnRequestNavigation h -> el.RequestNavigation.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.HyperlinkEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
