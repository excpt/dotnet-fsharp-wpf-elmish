...
type TableStyleGalleryBarItemLinkControlProp =
    | Base of RibbonGalleryBarItemLinkControlProp

module TableStyleGalleryBarItemLinkControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.TableStyleGalleryBarItemLinkControl) (prop: TableStyleGalleryBarItemLinkControlProp) =
        match prop with
        | TableStyleGalleryBarItemLinkControlProp.Base p -> RibbonGalleryBarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.TableStyleGalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
