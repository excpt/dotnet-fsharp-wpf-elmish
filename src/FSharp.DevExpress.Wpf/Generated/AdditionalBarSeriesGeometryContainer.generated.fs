...
type AdditionalBarSeriesGeometryContainerProp =
    | Base of AdditionalSeriesGeometryContainerProp

module AdditionalBarSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalBarSeriesGeometryContainer) (prop: AdditionalBarSeriesGeometryContainerProp) =
        match prop with
        | AdditionalBarSeriesGeometryContainerProp.Base p -> AdditionalSeriesGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalBarSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
