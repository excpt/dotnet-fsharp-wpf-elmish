...
type ScaleBreaksRenderControlProp =
    | Base of ChartElementBaseProp

module ScaleBreaksRenderControl =

    let apply (el: DevExpress.Xpf.Charts.ScaleBreaksRenderControl) (prop: ScaleBreaksRenderControlProp) =
        match prop with
        | ScaleBreaksRenderControlProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ScaleBreaksRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
