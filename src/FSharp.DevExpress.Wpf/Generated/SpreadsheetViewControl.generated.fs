...
type SpreadsheetViewControlProp =
    | LayoutInfo of DevExpress.XtraSpreadsheet.Layout.IDocumentLayout
    | ScrollBarPosition of float
    | ShowTabSelector of bool
    | ShowHorizontalScrollbar of bool
    | ShowVerticalScrollbar of bool

module SpreadsheetViewControl =
    let layoutInfo v : obj = box (SpreadsheetViewControlProp.LayoutInfo v)
    let scrollBarPosition v : obj = box (SpreadsheetViewControlProp.ScrollBarPosition v)
    let showTabSelector v : obj = box (SpreadsheetViewControlProp.ShowTabSelector v)
    let showHorizontalScrollbar v : obj = box (SpreadsheetViewControlProp.ShowHorizontalScrollbar v)
    let showVerticalScrollbar v : obj = box (SpreadsheetViewControlProp.ShowVerticalScrollbar v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl) (prop: SpreadsheetViewControlProp) =
        match prop with
        | SpreadsheetViewControlProp.LayoutInfo v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl.LayoutInfoProperty, box v)
        | SpreadsheetViewControlProp.ScrollBarPosition v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl.ScrollBarPositionProperty, box v)
        | SpreadsheetViewControlProp.ShowTabSelector v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl.ShowTabSelectorProperty, box v)
        | SpreadsheetViewControlProp.ShowHorizontalScrollbar v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl.ShowHorizontalScrollbarProperty, box v)
        | SpreadsheetViewControlProp.ShowVerticalScrollbar v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl.ShowVerticalScrollbarProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetViewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
