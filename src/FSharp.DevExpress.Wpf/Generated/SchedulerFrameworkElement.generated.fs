...
type SchedulerFrameworkElementProp =
    | Base of DXFrameworkElementProp

module SchedulerFrameworkElement =

    let apply (el: DevExpress.Xpf.Scheduler.SchedulerFrameworkElement) (prop: SchedulerFrameworkElementProp) =
        match prop with
        | SchedulerFrameworkElementProp.Base p -> DXFrameworkElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.SchedulerFrameworkElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
