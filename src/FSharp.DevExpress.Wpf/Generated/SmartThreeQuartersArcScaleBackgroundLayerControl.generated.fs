...
type SmartThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartThreeQuartersArcScaleBackgroundLayerControl) (prop: SmartThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | SmartThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
