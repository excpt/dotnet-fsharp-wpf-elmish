...
type DefaultSpindleCapControlProp =
    | Base of PresentationControlProp

module DefaultSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultSpindleCapControl) (prop: DefaultSpindleCapControlProp) =
        match prop with
        | DefaultSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
