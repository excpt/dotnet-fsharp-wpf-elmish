...
type LinksControlProp =
    | Base of BarItemsControlProp
    | DropIndicatorStyle of System.Windows.Style
    | GlyphPadding of System.Windows.Thickness
    | SpacingMode of DevExpress.Xpf.Bars.SpacingMode
    | LinksHolder of DevExpress.Xpf.Bars.ILinksHolder
    | ItemRenderTemplateSelector of DevExpress.Xpf.Core.Native.RenderTemplateSelector
...
module LinksControl =
    ...
    let apply (el: DevExpress.Xpf.Bars.LinksControl) (prop: LinksControlProp) =
        match prop with
        | LinksControlProp.Base p -> BarItemsControl.apply el p
        | LinksControlProp.DropIndicatorStyle v -> el.SetValue(DevExpress.Xpf.Bars.LinksControl.DropIndicatorStyleProperty, box v)
        | LinksControlProp.GlyphPadding v -> el.SetValue(DevExpress.Xpf.Bars.LinksControl.GlyphPaddingProperty, box v)
        | LinksControlProp.SpacingMode v -> el.SetValue(DevExpress.Xpf.Bars.LinksControl.SpacingModeProperty, box v)
        | LinksControlProp.LinksHolder v -> el.SetValue(DevExpress.Xpf.Bars.LinksControl.LinksHolderProperty, box v)
        | LinksControlProp.ItemRenderTemplateSelector v -> el.SetValue(DevExpress.Xpf.Bars.LinksControl.ItemRenderTemplateSelectorProperty, box v)
        | LinksControlProp.UseLightweightTemplates v -> el.SetValue(DevExpress.Xpf.Bars.LinksControl.UseLightweightTemplatesProperty, box v)
