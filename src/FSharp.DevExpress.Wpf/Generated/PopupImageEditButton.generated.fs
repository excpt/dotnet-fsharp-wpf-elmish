...
type PopupImageEditButtonProp =
    | Base of ImageEditToolButtonProp

module PopupImageEditButton =

    let apply (el: DevExpress.Xpf.Editors.PopupImageEditButton) (prop: PopupImageEditButtonProp) =
        match prop with
        | PopupImageEditButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupImageEditButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
