...
type MagicLightLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module MagicLightLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightLinearScaleLevelBarForegroundControl) (prop: MagicLightLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | MagicLightLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
