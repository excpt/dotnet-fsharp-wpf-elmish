...
type FlatDarkQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkQuarterTopRightArcScaleBackgroundLayerControl) (prop: FlatDarkQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatDarkQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
