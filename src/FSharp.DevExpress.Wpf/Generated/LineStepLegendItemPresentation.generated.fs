...
type LineStepLegendItemPresentationProp =
    | Base of LegendItemPresentationProp
    | InvertedStep of bool

module LineStepLegendItemPresentation =
    let invertedStep v : obj = box (LineStepLegendItemPresentationProp.InvertedStep v)

    let apply (el: DevExpress.Xpf.Charts.LineStepLegendItemPresentation) (prop: LineStepLegendItemPresentationProp) =
        match prop with
        | LineStepLegendItemPresentationProp.Base p -> LegendItemPresentation.apply el p
        | LineStepLegendItemPresentationProp.InvertedStep v -> el.SetValue(DevExpress.Xpf.Charts.LineStepLegendItemPresentation.InvertedStepProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LineStepLegendItemPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
