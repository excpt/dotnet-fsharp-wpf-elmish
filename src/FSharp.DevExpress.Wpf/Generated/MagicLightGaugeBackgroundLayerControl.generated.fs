...
type MagicLightGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightGaugeBackgroundLayerControl) (prop: MagicLightGaugeBackgroundLayerControlProp) =
        match prop with
        | MagicLightGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
