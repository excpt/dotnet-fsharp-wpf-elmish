...
type PolarDiagram2DProp =
    | Base of CircularDiagram2DProp
    | AxisX of DevExpress.Xpf.Charts.PolarAxisX2D
    | AxisY of DevExpress.Xpf.Charts.PolarAxisY2D

module PolarDiagram2D =
    let axisX v : obj = box (PolarDiagram2DProp.AxisX v)
    let axisY v : obj = box (PolarDiagram2DProp.AxisY v)

    let apply (el: DevExpress.Xpf.Charts.PolarDiagram2D) (prop: PolarDiagram2DProp) =
        match prop with
        | PolarDiagram2DProp.Base p -> CircularDiagram2D.apply el p
        | PolarDiagram2DProp.AxisX v -> el.SetValue(DevExpress.Xpf.Charts.PolarDiagram2D.AxisXProperty, box v)
        | PolarDiagram2DProp.AxisY v -> el.SetValue(DevExpress.Xpf.Charts.PolarDiagram2D.AxisYProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarDiagram2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
