...
type LinearProgressiveModelProp =
    | Base of LinearGaugeModelProp

module LinearProgressiveModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearProgressiveModel) (prop: LinearProgressiveModelProp) =
        match prop with
        | LinearProgressiveModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearProgressiveModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
