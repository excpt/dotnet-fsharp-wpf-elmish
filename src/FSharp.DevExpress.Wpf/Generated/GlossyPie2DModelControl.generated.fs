...
type GlossyPie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module GlossyPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.GlossyPie2DModelControl) (prop: GlossyPie2DModelControlProp) =
        match prop with
        | GlossyPie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GlossyPie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
