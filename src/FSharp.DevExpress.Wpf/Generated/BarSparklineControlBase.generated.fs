...
type BarSparklineControlBaseProp =
    | Base of SparklineControlProp
    | BarDistance of int

module BarSparklineControlBase =
    let barDistance v : obj = box (BarSparklineControlBaseProp.BarDistance v)

    let apply (el: DevExpress.Xpf.Editors.BarSparklineControlBase) (prop: BarSparklineControlBaseProp) =
        match prop with
        | BarSparklineControlBaseProp.Base p -> SparklineControl.apply el p
        | BarSparklineControlBaseProp.BarDistance v -> el.SetValue(DevExpress.Xpf.Editors.BarSparklineControlBase.BarDistanceProperty, box v)
