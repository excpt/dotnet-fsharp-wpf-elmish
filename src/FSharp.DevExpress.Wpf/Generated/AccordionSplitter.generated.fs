...
type AccordionSplitterProp =
    | Base of ThumbProp
    | ShowBorder of bool

module AccordionSplitter =
    let showBorder v : obj = box (AccordionSplitterProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.Accordion.AccordionSplitter) (prop: AccordionSplitterProp) =
        match prop with
        | AccordionSplitterProp.Base p -> Thumb.apply el p
        | AccordionSplitterProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionSplitter.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionSplitter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
