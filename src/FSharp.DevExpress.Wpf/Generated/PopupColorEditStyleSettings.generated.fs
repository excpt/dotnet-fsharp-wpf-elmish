...
type PopupColorEditStyleSettingsProp =
    | Base of PopupBaseEditStyleSettingsProp

module PopupColorEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupColorEditStyleSettings) (prop: PopupColorEditStyleSettingsProp) =
        match prop with
        | PopupColorEditStyleSettingsProp.Base p -> PopupBaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupColorEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
