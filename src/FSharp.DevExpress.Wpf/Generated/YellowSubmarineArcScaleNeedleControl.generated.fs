...
type YellowSubmarineArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module YellowSubmarineArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineArcScaleNeedleControl) (prop: YellowSubmarineArcScaleNeedleControlProp) =
        match prop with
        | YellowSubmarineArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
