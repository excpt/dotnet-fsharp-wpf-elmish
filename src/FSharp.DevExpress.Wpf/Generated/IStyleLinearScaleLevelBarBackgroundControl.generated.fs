...
type IStyleLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module IStyleLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleLinearScaleLevelBarBackgroundControl) (prop: IStyleLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | IStyleLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
