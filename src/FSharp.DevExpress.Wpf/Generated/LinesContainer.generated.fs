...
type LinesContainerProp =
    | Base of DXContentPresenterProp
    | Lines of obj

module LinesContainer =
    let lines v : obj = box (LinesContainerProp.Lines v)

    let apply (el: DevExpress.Xpf.Printing.Native.Lines.LinesContainer) (prop: LinesContainerProp) =
        match prop with
        | LinesContainerProp.Base p -> DXContentPresenter.apply el p
        | LinesContainerProp.Lines v -> el.SetValue(DevExpress.Xpf.Printing.Native.Lines.LinesContainer.LinesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.Lines.LinesContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
