...
type CustomizeBulletedListProp =
    | Base of ThemedWindowProp

module CustomizeBulletedList =

    let apply (el: DevExpress.Xpf.RichEdit.View.CustomizeBulletedList) (prop: CustomizeBulletedListProp) =
        match prop with
        | CustomizeBulletedListProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.CustomizeBulletedList>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
