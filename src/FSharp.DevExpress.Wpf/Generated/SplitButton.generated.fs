...
type SplitButtonProp =
    ...
    | ArrowBackground of System.Windows.Media.Brush
    | ArrowBorderBrush of System.Windows.Media.Brush
    | ArrowBorderThickness of System.Windows.Thickness
    | ArrowCornerRadius of System.Windows.CornerRadius
    | ContentCornerRadius of System.Windows.CornerRadius
    | SeparatorThickness of System.Windows.Thickness

module SplitButton =
    let arrowBackground v : obj = box (SplitButtonProp.ArrowBackground v)
    let arrowBorderBrush v : obj = box (SplitButtonProp.ArrowBorderBrush v)
    let arrowBorderThickness v : obj = box (SplitButtonProp.ArrowBorderThickness v)
    let arrowCornerRadius v : obj = box (SplitButtonProp.ArrowCornerRadius v)
    let contentCornerRadius v : obj = box (SplitButtonProp.ContentCornerRadius v)
    let separatorThickness v : obj = box (SplitButtonProp.SeparatorThickness v)

    let apply (el: DevExpress.Xpf.Core.SplitButton) (prop: SplitButtonProp) =
        match prop with
        | SplitButtonProp.Base p -> DropDownButtonBase.apply el p
        | SplitButtonProp.ArrowBackground v -> el.SetValue(DevExpress.Xpf.Core.SplitButton.ArrowBackgroundProperty, box v)
        | SplitButtonProp.ArrowBorderBrush v -> el.SetValue(DevExpress.Xpf.Core.SplitButton.ArrowBorderBrushProperty, box v)
        | SplitButtonProp.ArrowBorderThickness v -> el.SetValue(DevExpress.Xpf.Core.SplitButton.ArrowBorderThicknessProperty, box v)
        | SplitButtonProp.ArrowCornerRadius v -> el.SetValue(DevExpress.Xpf.Core.SplitButton.ArrowCornerRadiusProperty, box v)
        | SplitButtonProp.ContentCornerRadius v -> el.SetValue(DevExpress.Xpf.Core.SplitButton.ContentCornerRadiusProperty, box v)
        | SplitButtonProp.SeparatorThickness v -> el.SetValue(DevExpress.Xpf.Core.SplitButton.SeparatorThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SplitButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
