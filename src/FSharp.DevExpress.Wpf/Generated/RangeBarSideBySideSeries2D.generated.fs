...
type RangeBarSideBySideSeries2DProp =
    | Base of RangeBarSeries2DProp

module RangeBarSideBySideSeries2D =

    let apply (el: DevExpress.Xpf.Charts.RangeBarSideBySideSeries2D) (prop: RangeBarSideBySideSeries2DProp) =
        match prop with
        | RangeBarSideBySideSeries2DProp.Base p -> RangeBarSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RangeBarSideBySideSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
