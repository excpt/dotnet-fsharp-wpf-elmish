...
type ExtendedWrapPanelProp =
    | ActualItemWidth of float

module ExtendedWrapPanel =
    let actualItemWidth v : obj = box (ExtendedWrapPanelProp.ActualItemWidth v)

    let apply (el: DevExpress.Xpf.Diagram.Native.ExtendedWrapPanel) (prop: ExtendedWrapPanelProp) =
        match prop with
        | ExtendedWrapPanelProp.ActualItemWidth v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ExtendedWrapPanel.ActualItemWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.ExtendedWrapPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
