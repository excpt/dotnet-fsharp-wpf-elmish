...
type FlatDarkLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkLinearScaleBackgroundLayerControl) (prop: FlatDarkLinearScaleBackgroundLayerControlProp) =
        match prop with
        | FlatDarkLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
