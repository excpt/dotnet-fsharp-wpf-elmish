...
type StackVisibleIndexPanelProp =
    | Base of OrderPanelBaseProp

module StackVisibleIndexPanel =

    let apply (el: DevExpress.Xpf.Core.StackVisibleIndexPanel) (prop: StackVisibleIndexPanelProp) =
        match prop with
        | StackVisibleIndexPanelProp.Base p -> OrderPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.StackVisibleIndexPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
