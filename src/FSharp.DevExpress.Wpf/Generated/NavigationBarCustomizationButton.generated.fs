...
type NavigationBarCustomizationButtonProp =
    | Base of NavigationBarButtonProp

module NavigationBarCustomizationButton =

    let apply (el: DevExpress.Xpf.Navigation.Internal.NavigationBarCustomizationButton) (prop: NavigationBarCustomizationButtonProp) =
        match prop with
        | NavigationBarCustomizationButtonProp.Base p -> NavigationBarButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.NavigationBarCustomizationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
