...
type BarItemListItemProp =
    | Base of BarItemListItemCompabilityProp

module BarItemListItem =

    let apply (el: DevExpress.Xpf.Bars.Customization.BarItemListItem) (prop: BarItemListItemProp) =
        match prop with
        | BarItemListItemProp.Base p -> BarItemListItemCompability.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.Customization.BarItemListItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
