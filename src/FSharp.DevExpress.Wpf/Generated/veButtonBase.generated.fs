...
type veButtonBaseProp =
    | Base of veContentContainerProp
...
module veButtonBase =
    ...
    let apply (el: DevExpress.Xpf.Controls.Primitives.veButtonBase) (prop: veButtonBaseProp) =
        match prop with
        | veButtonBaseProp.Base p -> veContentContainer.apply el p
        | veButtonBaseProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.DisplayModeProperty, box v)
        | veButtonBaseProp.GlyphAlignment v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.GlyphAlignmentProperty, box v)
        | veButtonBaseProp.Glyph v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.GlyphProperty, box v)
        | veButtonBaseProp.Command v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.CommandProperty, box v)
        | veButtonBaseProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.CommandParameterProperty, box v)
        | veButtonBaseProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.CommandTargetProperty, box v)
        | veButtonBaseProp.GlyphSpace v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.veButtonBase.GlyphSpaceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.veButtonBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
