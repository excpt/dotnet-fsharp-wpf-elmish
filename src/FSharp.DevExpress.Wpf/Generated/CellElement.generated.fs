...
type CellElementProp =
    | Base of ScrollableAreaCellProp

module CellElement =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.CellElement) (prop: CellElementProp) =
        match prop with
        | CellElementProp.Base p -> ScrollableAreaCell.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.CellElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
