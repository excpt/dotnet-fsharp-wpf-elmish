...
type MenuBarControlProp =
    | MenuInfo of DevExpress.Xpf.Bars.PopupMenuBarInfo
    | ShowGlyphSideBackground of bool
    | ShowContentSideBackground of bool
    | Menu of DevExpress.Xpf.Bars.PopupMenu

module MenuBarControl =
    let menuInfo v : obj = box (MenuBarControlProp.MenuInfo v)
    let showGlyphSideBackground v : obj = box (MenuBarControlProp.ShowGlyphSideBackground v)
    let showContentSideBackground v : obj = box (MenuBarControlProp.ShowContentSideBackground v)
    let menu v : obj = box (MenuBarControlProp.Menu v)

    let apply (el: DevExpress.Xpf.Bars.MenuBarControl) (prop: MenuBarControlProp) =
        match prop with
        | MenuBarControlProp.MenuInfo v -> el.SetValue(DevExpress.Xpf.Bars.MenuBarControl.MenuInfoProperty, box v)
        | MenuBarControlProp.ShowGlyphSideBackground v -> el.SetValue(DevExpress.Xpf.Bars.MenuBarControl.ShowGlyphSideBackgroundProperty, box v)
        | MenuBarControlProp.ShowContentSideBackground v -> el.SetValue(DevExpress.Xpf.Bars.MenuBarControl.ShowContentSideBackgroundProperty, box v)
        | MenuBarControlProp.Menu v -> el.SetValue(DevExpress.Xpf.Bars.MenuBarControl.MenuProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.MenuBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
