...
open System
open System.Windows
open DevExpress.Xpf.Core.ServerMode
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ODataServerModeDataSourceProp =
    | Base of ListSourceDataSourceBaseProp
    | DefaultSorting of string
    | FixedFilter of string
    | ElementType of System.Type
    | KeyExpressions of string
    | KeyExpression of string
    | DataServiceContext of obj
    | Query of System.Linq.IQueryable
    | ServiceRoot of System.Uri
    | OnExceptionThrown of DevExpress.Xpf.Core.ServerMode.GetEnumerableEventHandler
    | OnInconsistencyDetected of System.Windows.RoutedEventHandler

module ODataServerModeDataSource =
    let defaultSorting v : obj = box (ODataServerModeDataSourceProp.DefaultSorting v)
    let fixedFilter v : obj = box (ODataServerModeDataSourceProp.FixedFilter v)
    let elementType v : obj = box (ODataServerModeDataSourceProp.ElementType v)
    let keyExpressions v : obj = box (ODataServerModeDataSourceProp.KeyExpressions v)
    let keyExpression v : obj = box (ODataServerModeDataSourceProp.KeyExpression v)
    let dataServiceContext v : obj = box (ODataServerModeDataSourceProp.DataServiceContext v)
    let query v : obj = box (ODataServerModeDataSourceProp.Query v)
    let serviceRoot v : obj = box (ODataServerModeDataSourceProp.ServiceRoot v)
    let onExceptionThrown v : obj = box (EventProp(box (ODataServerModeDataSourceProp.OnExceptionThrown v)))
    let onInconsistencyDetected v : obj = box (EventProp(box (ODataServerModeDataSourceProp.OnInconsistencyDetected v)))

    let apply (el: DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource) (prop: ODataServerModeDataSourceProp) =
        match prop with
        | ODataServerModeDataSourceProp.Base p -> ListSourceDataSourceBase.apply el p
        | ODataServerModeDataSourceProp.DefaultSorting v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.DefaultSortingProperty, box v)
        | ODataServerModeDataSourceProp.FixedFilter v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.FixedFilterProperty, box v)
        | ODataServerModeDataSourceProp.ElementType v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.ElementTypeProperty, box v)
        | ODataServerModeDataSourceProp.KeyExpressions v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.KeyExpressionsProperty, box v)
        | ODataServerModeDataSourceProp.KeyExpression v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.KeyExpressionProperty, box v)
        | ODataServerModeDataSourceProp.DataServiceContext v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.DataServiceContextProperty, box v)
        | ODataServerModeDataSourceProp.Query v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.QueryProperty, box v)
        | ODataServerModeDataSourceProp.ServiceRoot v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource.ServiceRootProperty, box v)
        | ODataServerModeDataSourceProp.OnExceptionThrown h -> el.ExceptionThrown.AddHandler(h)
        | ODataServerModeDataSourceProp.OnInconsistencyDetected h -> el.InconsistencyDetected.AddHandler(h)

    let contextType v : obj = box (DataSourceBaseProp.ContextType v)
    let path v : obj = box (DataSourceBaseProp.Path v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ServerMode.ODataServerModeDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
