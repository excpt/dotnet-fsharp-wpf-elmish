...
type UnderlinePreviewControlProp =
    | UnderlineType of DevExpress.XtraRichEdit.Model.UnderlineType

module UnderlinePreviewControl =
    let underlineType v : obj = box (UnderlinePreviewControlProp.UnderlineType v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.UnderlinePreviewControl) (prop: UnderlinePreviewControlProp) =
        match prop with
        | UnderlinePreviewControlProp.UnderlineType v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.UnderlinePreviewControl.UnderlineTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.UnderlinePreviewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
