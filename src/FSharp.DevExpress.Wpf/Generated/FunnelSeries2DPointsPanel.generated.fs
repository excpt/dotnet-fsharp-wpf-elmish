...
type FunnelSeries2DPointsPanelProp =
    | Base of SimplePanelProp

module FunnelSeries2DPointsPanel =

    let apply (el: DevExpress.Xpf.Charts.FunnelSeries2DPointsPanel) (prop: FunnelSeries2DPointsPanelProp) =
        match prop with
        | FunnelSeries2DPointsPanelProp.Base p -> SimplePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FunnelSeries2DPointsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
