...
type CleanWhiteLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CleanWhiteLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteLinearScaleLevelBarBackgroundControl) (prop: CleanWhiteLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | CleanWhiteLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
