...
type EditRecurrentAppointmentFormProp =
    | Title of string

module EditRecurrentAppointmentForm =
    let title v : obj = box (EditRecurrentAppointmentFormProp.Title v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.EditRecurrentAppointmentForm) (prop: EditRecurrentAppointmentFormProp) =
        match prop with
        | EditRecurrentAppointmentFormProp.Title v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.EditRecurrentAppointmentForm.TitleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.EditRecurrentAppointmentForm>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
