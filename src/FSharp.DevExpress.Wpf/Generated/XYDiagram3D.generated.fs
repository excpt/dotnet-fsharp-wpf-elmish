...
type XYDiagram3DProp =
    | Base of Diagram3DProp
    | DomainBrush of System.Windows.Media.Brush
    | HeightToWidthRatio of float
    | AxisX of DevExpress.Xpf.Charts.AxisX3D
    | AxisY of DevExpress.Xpf.Charts.AxisY3D
    | SeriesDistance of float
    | SeriesPadding of float
    | PlaneDepthFixed of int
...
module XYDiagram3D =
    let domainBrush v : obj = box (XYDiagram3DProp.DomainBrush v)
    let heightToWidthRatio v : obj = box (XYDiagram3DProp.HeightToWidthRatio v)
    let axisX v : obj = box (XYDiagram3DProp.AxisX v)
    let axisY v : obj = box (XYDiagram3DProp.AxisY v)
    let seriesDistance v : obj = box (XYDiagram3DProp.SeriesDistance v)
    let seriesPadding v : obj = box (XYDiagram3DProp.SeriesPadding v)
    let planeDepthFixed v : obj = box (XYDiagram3DProp.PlaneDepthFixed v)
    let material v : obj = box (XYDiagram3DProp.Material v)
    let barDistance v : obj = box (XYDiagram3DProp.BarDistance v)
    let barDistanceFixed v : obj = box (XYDiagram3DProp.BarDistanceFixed v)
    let equalBarWidth v : obj = box (XYDiagram3DProp.EqualBarWidth v)

    let apply (el: DevExpress.Xpf.Charts.XYDiagram3D) (prop: XYDiagram3DProp) =
        match prop with
        | XYDiagram3DProp.Base p -> Diagram3D.apply el p
        | XYDiagram3DProp.DomainBrush v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.DomainBrushProperty, box v)
        | XYDiagram3DProp.HeightToWidthRatio v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.HeightToWidthRatioProperty, box v)
        | XYDiagram3DProp.AxisX v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.AxisXProperty, box v)
        | XYDiagram3DProp.AxisY v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.AxisYProperty, box v)
        | XYDiagram3DProp.SeriesDistance v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.SeriesDistanceProperty, box v)
        | XYDiagram3DProp.SeriesPadding v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.SeriesPaddingProperty, box v)
        | XYDiagram3DProp.PlaneDepthFixed v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.PlaneDepthFixedProperty, box v)
        | XYDiagram3DProp.Material v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.MaterialProperty, box v)
        | XYDiagram3DProp.BarDistance v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.BarDistanceProperty, box v)
        | XYDiagram3DProp.BarDistanceFixed v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.BarDistanceFixedProperty, box v)
        | XYDiagram3DProp.EqualBarWidth v -> el.SetValue(DevExpress.Xpf.Charts.XYDiagram3D.EqualBarWidthProperty, box v)

    let contentTransform v : obj = box (Diagram3DProp.ContentTransform v)
    let perspectiveAngle v : obj = box (Diagram3DProp.PerspectiveAngle v)
    let zoomPercent v : obj = box (Diagram3DProp.ZoomPercent v)
    let horizontalScrollPercent v : obj = box (Diagram3DProp.HorizontalScrollPercent v)
    let verticalScrollPercent v : obj = box (Diagram3DProp.VerticalScrollPercent v)
    let lighting v : obj = box (Diagram3DProp.Lighting v)
    let runtimeRotation v : obj = box (Diagram3DProp.RuntimeRotation v)
    let runtimeScrolling v : obj = box (Diagram3DProp.RuntimeScrolling v)
    let runtimeZooming v : obj = box (Diagram3DProp.RuntimeZooming v)
    let navigationOptions v : obj = box (Diagram3DProp.NavigationOptions v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.XYDiagram3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
