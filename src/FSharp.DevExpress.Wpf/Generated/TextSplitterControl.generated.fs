...
type TextSplitterControlProp =
    | Content of obj
    | SplitMethod of DevExpress.Xpf.Bars.SplitTextMode
    | FirstStringHorizontalAlignment of System.Windows.HorizontalAlignment
    | SecondStringHorizontalAlignment of System.Windows.HorizontalAlignment
    | SecondString of string
    | FirstString of string
    | ContentVisibility of System.Windows.Visibility
    | FirstStringOpacity of float
    | SecondStringOpacity of float
    | ContentTemplate of System.Windows.Controls.ControlTemplate
    | FirstStringMargin of System.Windows.Thickness
    | SecondStringMargin of System.Windows.Thickness
    | NormalTextStyle of System.Windows.Style
    | SelectedTextStyle of System.Windows.Style
    | RightSideArrowContainerStyle of System.Windows.Style
    | BottomSideArrowContainerStyle of System.Windows.Style
    | NormalArrowTemplate of System.Windows.Controls.ControlTemplate
    | SelectedArrowTemplate of System.Windows.Controls.ControlTemplate
    | IsArrowVisible of bool
    | IsSelected of bool
    | DisabledTextStyle of System.Windows.Style
    | FontSettings of DevExpress.Xpf.Bars.FontSettings

module TextSplitterControl =
    let content v : obj = box (TextSplitterControlProp.Content v)
    let splitMethod v : obj = box (TextSplitterControlProp.SplitMethod v)
    let firstStringHorizontalAlignment v : obj = box (TextSplitterControlProp.FirstStringHorizontalAlignment v)
    let secondStringHorizontalAlignment v : obj = box (TextSplitterControlProp.SecondStringHorizontalAlignment v)
    let secondString v : obj = box (TextSplitterControlProp.SecondString v)
    let firstString v : obj = box (TextSplitterControlProp.FirstString v)
    let contentVisibility v : obj = box (TextSplitterControlProp.ContentVisibility v)
    let firstStringOpacity v : obj = box (TextSplitterControlProp.FirstStringOpacity v)
    let secondStringOpacity v : obj = box (TextSplitterControlProp.SecondStringOpacity v)
    let contentTemplate v : obj = box (TextSplitterControlProp.ContentTemplate v)
    let firstStringMargin v : obj = box (TextSplitterControlProp.FirstStringMargin v)
    let secondStringMargin v : obj = box (TextSplitterControlProp.SecondStringMargin v)
    let normalTextStyle v : obj = box (TextSplitterControlProp.NormalTextStyle v)
    let selectedTextStyle v : obj = box (TextSplitterControlProp.SelectedTextStyle v)
    let rightSideArrowContainerStyle v : obj = box (TextSplitterControlProp.RightSideArrowContainerStyle v)
    let bottomSideArrowContainerStyle v : obj = box (TextSplitterControlProp.BottomSideArrowContainerStyle v)
    let normalArrowTemplate v : obj = box (TextSplitterControlProp.NormalArrowTemplate v)
    let selectedArrowTemplate v : obj = box (TextSplitterControlProp.SelectedArrowTemplate v)
    let isArrowVisible v : obj = box (TextSplitterControlProp.IsArrowVisible v)
    let isSelected v : obj = box (TextSplitterControlProp.IsSelected v)
    let disabledTextStyle v : obj = box (TextSplitterControlProp.DisabledTextStyle v)
    let fontSettings v : obj = box (TextSplitterControlProp.FontSettings v)

    let apply (el: DevExpress.Xpf.Bars.TextSplitterControl) (prop: TextSplitterControlProp) =
        match prop with
        | TextSplitterControlProp.Content v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.ContentProperty, box v)
        | TextSplitterControlProp.SplitMethod v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SplitMethodProperty, box v)
        | TextSplitterControlProp.FirstStringHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.FirstStringHorizontalAlignmentProperty, box v)
        | TextSplitterControlProp.SecondStringHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SecondStringHorizontalAlignmentProperty, box v)
        | TextSplitterControlProp.SecondString v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SecondStringProperty, box v)
        | TextSplitterControlProp.FirstString v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.FirstStringProperty, box v)
        | TextSplitterControlProp.ContentVisibility v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.ContentVisibilityProperty, box v)
        | TextSplitterControlProp.FirstStringOpacity v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.FirstStringOpacityProperty, box v)
        | TextSplitterControlProp.SecondStringOpacity v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SecondStringOpacityProperty, box v)
        | TextSplitterControlProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.ContentTemplateProperty, box v)
        | TextSplitterControlProp.FirstStringMargin v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.FirstStringMarginProperty, box v)
        | TextSplitterControlProp.SecondStringMargin v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SecondStringMarginProperty, box v)
        | TextSplitterControlProp.NormalTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.NormalTextStyleProperty, box v)
        | TextSplitterControlProp.SelectedTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SelectedTextStyleProperty, box v)
        | TextSplitterControlProp.RightSideArrowContainerStyle v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.RightSideArrowContainerStyleProperty, box v)
        | TextSplitterControlProp.BottomSideArrowContainerStyle v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.BottomSideArrowContainerStyleProperty, box v)
        | TextSplitterControlProp.NormalArrowTemplate v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.NormalArrowTemplateProperty, box v)
        | TextSplitterControlProp.SelectedArrowTemplate v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.SelectedArrowTemplateProperty, box v)
        | TextSplitterControlProp.IsArrowVisible v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.IsArrowVisibleProperty, box v)
        | TextSplitterControlProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.IsSelectedProperty, box v)
        | TextSplitterControlProp.DisabledTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.DisabledTextStyleProperty, box v)
        | TextSplitterControlProp.FontSettings v -> el.SetValue(DevExpress.Xpf.Bars.TextSplitterControl.FontSettingsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.TextSplitterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
