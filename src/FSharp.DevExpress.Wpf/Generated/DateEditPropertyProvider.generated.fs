...
type DateEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp

module DateEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.DateEditPropertyProvider) (prop: DateEditPropertyProviderProp) =
        match prop with
        | DateEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
