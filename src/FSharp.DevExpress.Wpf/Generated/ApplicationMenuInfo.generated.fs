...
type ApplicationMenuInfoProp =
    | Base of PopupMenuInfoProp
...
module ApplicationMenuInfo =
    let rightPane v : obj = box (ApplicationMenuInfoProp.RightPane v)
    let bottomPane v : obj = box (ApplicationMenuInfoProp.BottomPane v)
    let showRightPane v : obj = box (ApplicationMenuInfoProp.ShowRightPane v)
    let rightPaneWidth v : obj = box (ApplicationMenuInfoProp.RightPaneWidth v)

    let apply (el: DevExpress.Xpf.Ribbon.ApplicationMenuInfo) (prop: ApplicationMenuInfoProp) =
        match prop with
        | ApplicationMenuInfoProp.Base p -> PopupMenuInfo.apply el p
        | ApplicationMenuInfoProp.RightPane v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuInfo.RightPaneProperty, box v)
        | ApplicationMenuInfoProp.BottomPane v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuInfo.BottomPaneProperty, box v)
        | ApplicationMenuInfoProp.ShowRightPane v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuInfo.ShowRightPaneProperty, box v)
        | ApplicationMenuInfoProp.RightPaneWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuInfo.RightPaneWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.ApplicationMenuInfo>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
