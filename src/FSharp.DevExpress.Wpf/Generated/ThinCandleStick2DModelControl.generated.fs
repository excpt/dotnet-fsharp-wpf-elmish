...
type ThinCandleStick2DModelControlProp =
    | Base of PredefinedModelControlProp

module ThinCandleStick2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.ThinCandleStick2DModelControl) (prop: ThinCandleStick2DModelControlProp) =
        match prop with
        | ThinCandleStick2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ThinCandleStick2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
