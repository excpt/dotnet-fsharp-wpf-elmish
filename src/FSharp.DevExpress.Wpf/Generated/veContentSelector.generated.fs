...
type veContentSelectorProp =
    | Base of veSelectorProp
    | SelectedContent of obj
    | SelectedContentTemplate of System.Windows.DataTemplate
    | SelectedContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | ContentTemplate of System.Windows.DataTemplate
    | ContentTemplateSelector of System.Windows.Controls.DataTemplateSelector

module veContentSelector =
    ...
    let apply (el: DevExpress.Xpf.WindowsUI.Base.veContentSelector) (prop: veContentSelectorProp) =
        match prop with
        | veContentSelectorProp.Base p -> veSelector.apply el p
        | veContentSelectorProp.SelectedContent v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veContentSelector.SelectedContentProperty, box v)
        | veContentSelectorProp.SelectedContentTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veContentSelector.SelectedContentTemplateProperty, box v)
        | veContentSelectorProp.SelectedContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veContentSelector.SelectedContentTemplateSelectorProperty, box v)
        | veContentSelectorProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veContentSelector.ContentTemplateProperty, box v)
        | veContentSelectorProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veContentSelector.ContentTemplateSelectorProperty, box v)
