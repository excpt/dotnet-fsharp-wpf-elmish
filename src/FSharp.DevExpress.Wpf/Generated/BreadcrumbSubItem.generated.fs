...
module BreadcrumbSubItem =
    let buttonContentTemplate v : obj = box (BreadcrumbSubItemProp.ButtonContentTemplate v)
    let buttonContentTemplateSelector v : obj = box (BreadcrumbSubItemProp.ButtonContentTemplateSelector v)

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbSubItem) (prop: BreadcrumbSubItemProp) =
        match prop with
        | BreadcrumbSubItemProp.ButtonContentTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbSubItem.ButtonContentTemplateProperty, box v)
        | BreadcrumbSubItemProp.ButtonContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbSubItem.ButtonContentTemplateSelectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbSubItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
