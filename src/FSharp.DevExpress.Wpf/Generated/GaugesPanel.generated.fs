...
type GaugesPanelProp =
    | Base of CardsPanelProp

module GaugesPanel =

    let apply (el: DevExpress.DashboardWpf.Internal.GaugesPanel) (prop: GaugesPanelProp) =
        match prop with
        | GaugesPanelProp.Base p -> CardsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.GaugesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
