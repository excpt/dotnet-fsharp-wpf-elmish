...
module Document =
    ...
    let apply (el: DevExpress.Xpf.Docking.VisualElements.Document) (prop: DocumentProp) =
        match prop with
        | DocumentProp.Base p -> BaseDocument.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.Document>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
