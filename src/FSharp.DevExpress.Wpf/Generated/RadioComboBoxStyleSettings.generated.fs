...
module RadioComboBoxStyleSettings =
    ...
    let apply (el: DevExpress.Xpf.Editors.RadioComboBoxStyleSettings) (prop: RadioComboBoxStyleSettingsProp) =
        match prop with
        | RadioComboBoxStyleSettingsProp.Base p -> BaseComboBoxStyleSettings.apply el p
        | RadioComboBoxStyleSettingsProp.ShowEmptyItem v -> el.SetValue(DevExpress.Xpf.Editors.RadioComboBoxStyleSettings.ShowEmptyItemProperty, box v)
        | RadioComboBoxStyleSettingsProp.EmptyItemText v -> el.SetValue(DevExpress.Xpf.Editors.RadioComboBoxStyleSettings.EmptyItemTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RadioComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
