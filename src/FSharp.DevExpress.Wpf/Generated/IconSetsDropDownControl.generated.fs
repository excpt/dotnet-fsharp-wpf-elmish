...
type IconSetsDropDownControlProp =
    | SelectedIcon of DevExpress.XtraSpreadsheet.Forms.IconsAllRules

module IconSetsDropDownControl =
    let selectedIcon v : obj = box (IconSetsDropDownControlProp.SelectedIcon v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.IconSetsDropDownControl) (prop: IconSetsDropDownControlProp) =
        match prop with
        | IconSetsDropDownControlProp.SelectedIcon v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Forms.IconSetsDropDownControl.SelectedIconProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.IconSetsDropDownControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
