...
type BrushEditProp =
    | Base of BrushEditBaseProp

module BrushEdit =

    let apply (el: DevExpress.Xpf.PropertyGrid.BrushEdit) (prop: BrushEditProp) =
        match prop with
        | BrushEditProp.Base p -> BrushEditBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.BrushEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
