...
type MultiColorBorderProp =
    | DefaultBorderThickness of System.Windows.Thickness
    | ElementPosition of DevExpress.Xpf.Scheduler.Drawing.ElementPosition
    | OuterBorderBrush of System.Windows.Media.Brush
    | InnerBorderBrush of System.Windows.Media.Brush

module MultiColorBorder =
    let defaultBorderThickness v : obj = box (MultiColorBorderProp.DefaultBorderThickness v)
    let elementPosition v : obj = box (MultiColorBorderProp.ElementPosition v)
    let outerBorderBrush v : obj = box (MultiColorBorderProp.OuterBorderBrush v)
    let innerBorderBrush v : obj = box (MultiColorBorderProp.InnerBorderBrush v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.MultiColorBorder) (prop: MultiColorBorderProp) =
        match prop with
        | MultiColorBorderProp.DefaultBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.MultiColorBorder.DefaultBorderThicknessProperty, box v)
        | MultiColorBorderProp.ElementPosition v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.MultiColorBorder.ElementPositionProperty, box v)
        | MultiColorBorderProp.OuterBorderBrush v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.MultiColorBorder.OuterBorderBrushProperty, box v)
        | MultiColorBorderProp.InnerBorderBrush v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.MultiColorBorder.InnerBorderBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.MultiColorBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
