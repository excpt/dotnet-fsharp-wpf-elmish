...
open System
open System.Windows
open DevExpress.Xpf.Scheduling.Panels
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DayGroupPanelBaseProp =
    | Base of GroupPanelBaseProp
    | CellContainersPerPage of float
    | CellContainersPerGroup of int
    | CellsCount of float
    | AppointmentsContainerStyle of System.Windows.Style
    | DragAppointmentsContainerStyle of System.Windows.Style
    | AppointmentsDeferredRendering of bool
    | AppointmentsDeferredRenderingRange of int
    | ShowSeparators of bool
    | SeparatorTemplate of System.Windows.DataTemplate
    | IsAppointmentsOpacityAnimationEnabled of bool
    | AppointmentsOpacityAnimation of System.Windows.Media.Animation.DoubleAnimation
    | ShowTimeIndicator of bool
    | ShowTimeIndicatorOverAppointment of bool
    | TimeIndicatorPosition of float

module DayGroupPanelBase =
    let cellContainersPerPage v : obj = box (DayGroupPanelBaseProp.CellContainersPerPage v)
    let cellContainersPerGroup v : obj = box (DayGroupPanelBaseProp.CellContainersPerGroup v)
    let cellsCount v : obj = box (DayGroupPanelBaseProp.CellsCount v)
    let appointmentsContainerStyle v : obj = box (DayGroupPanelBaseProp.AppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (DayGroupPanelBaseProp.DragAppointmentsContainerStyle v)
    let appointmentsDeferredRendering v : obj = box (DayGroupPanelBaseProp.AppointmentsDeferredRendering v)
    let appointmentsDeferredRenderingRange v : obj = box (DayGroupPanelBaseProp.AppointmentsDeferredRenderingRange v)
    let showSeparators v : obj = box (DayGroupPanelBaseProp.ShowSeparators v)
    let separatorTemplate v : obj = box (DayGroupPanelBaseProp.SeparatorTemplate v)
    let isAppointmentsOpacityAnimationEnabled v : obj = box (DayGroupPanelBaseProp.IsAppointmentsOpacityAnimationEnabled v)
    let appointmentsOpacityAnimation v : obj = box (DayGroupPanelBaseProp.AppointmentsOpacityAnimation v)
    let showTimeIndicator v : obj = box (DayGroupPanelBaseProp.ShowTimeIndicator v)
    let showTimeIndicatorOverAppointment v : obj = box (DayGroupPanelBaseProp.ShowTimeIndicatorOverAppointment v)
    let timeIndicatorPosition v : obj = box (DayGroupPanelBaseProp.TimeIndicatorPosition v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase) (prop: DayGroupPanelBaseProp) =
        match prop with
        | DayGroupPanelBaseProp.Base p -> GroupPanelBase.apply el p
        | DayGroupPanelBaseProp.CellContainersPerPage v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.CellContainersPerPageProperty, box v)
        | DayGroupPanelBaseProp.CellContainersPerGroup v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.CellContainersPerGroupProperty, box v)
        | DayGroupPanelBaseProp.CellsCount v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.CellsCountProperty, box v)
        | DayGroupPanelBaseProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.AppointmentsContainerStyleProperty, box v)
        | DayGroupPanelBaseProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.DragAppointmentsContainerStyleProperty, box v)
        | DayGroupPanelBaseProp.AppointmentsDeferredRendering v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.AppointmentsDeferredRenderingProperty, box v)
        | DayGroupPanelBaseProp.AppointmentsDeferredRenderingRange v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.AppointmentsDeferredRenderingRangeProperty, box v)
        | DayGroupPanelBaseProp.ShowSeparators v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.ShowSeparatorsProperty, box v)
        | DayGroupPanelBaseProp.SeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.SeparatorTemplateProperty, box v)
        | DayGroupPanelBaseProp.IsAppointmentsOpacityAnimationEnabled v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.IsAppointmentsOpacityAnimationEnabledProperty, box v)
        | DayGroupPanelBaseProp.AppointmentsOpacityAnimation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.AppointmentsOpacityAnimationProperty, box v)
        | DayGroupPanelBaseProp.ShowTimeIndicator v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.ShowTimeIndicatorProperty, box v)
        | DayGroupPanelBaseProp.ShowTimeIndicatorOverAppointment v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.ShowTimeIndicatorOverAppointmentProperty, box v)
        | DayGroupPanelBaseProp.TimeIndicatorPosition v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DayGroupPanelBase.TimeIndicatorPositionProperty, box v)

    let view v : obj = box (GroupPanelBaseProp.View v)
    let itemVerticalBorderThickness v : obj = box (GroupPanelBaseProp.ItemVerticalBorderThickness v)
    let itemHorizontalBorderThickness v : obj = box (GroupPanelBaseProp.ItemHorizontalBorderThickness v)
