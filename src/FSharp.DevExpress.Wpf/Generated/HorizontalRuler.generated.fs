...
type HorizontalRulerProp =
    | Base of RulerProp

module HorizontalRuler =

    let apply (el: DevExpress.Xpf.Diagram.HorizontalRuler) (prop: HorizontalRulerProp) =
        match prop with
        | HorizontalRulerProp.Base p -> Ruler.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.HorizontalRuler>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
