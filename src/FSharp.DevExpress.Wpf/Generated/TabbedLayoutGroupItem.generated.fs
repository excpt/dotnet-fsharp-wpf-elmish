...
type TabbedLayoutGroupItemProp =
    | Base of TabbedPaneItemProp

module TabbedLayoutGroupItem =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabbedLayoutGroupItem) (prop: TabbedLayoutGroupItemProp) =
        match prop with
        | TabbedLayoutGroupItemProp.Base p -> TabbedPaneItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabbedLayoutGroupItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
