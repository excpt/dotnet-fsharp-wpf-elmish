...
type FluentSplashScreenProp =
    | Base of SplashScreenWindowProp

module FluentSplashScreen =

    let apply (el: DevExpress.Xpf.Core.Native.FluentSplashScreen) (prop: FluentSplashScreenProp) =
        match prop with
        | FluentSplashScreenProp.Base p -> SplashScreenWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.FluentSplashScreen>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
