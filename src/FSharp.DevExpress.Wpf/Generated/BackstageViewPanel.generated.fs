...
type BackstageViewPanelProp =
    | TabPane of System.Windows.UIElement
    | FirstControlPane of System.Windows.UIElement
    | SecondControlPane of System.Windows.UIElement

module BackstageViewPanel =
    let tabPane v : obj = box (BackstageViewPanelProp.TabPane v)
    let firstControlPane v : obj = box (BackstageViewPanelProp.FirstControlPane v)
    let secondControlPane v : obj = box (BackstageViewPanelProp.SecondControlPane v)

    let apply (el: DevExpress.Xpf.Ribbon.BackstageViewPanel) (prop: BackstageViewPanelProp) =
        match prop with
        | BackstageViewPanelProp.TabPane v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageViewPanel.TabPaneProperty, box v)
        | BackstageViewPanelProp.FirstControlPane v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageViewPanel.FirstControlPaneProperty, box v)
        | BackstageViewPanelProp.SecondControlPane v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageViewPanel.SecondControlPaneProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageViewPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
