...
type CircularProgressiveHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularProgressiveHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularProgressiveHalfTopModel) (prop: CircularProgressiveHalfTopModelProp) =
        match prop with
        | CircularProgressiveHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularProgressiveHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
