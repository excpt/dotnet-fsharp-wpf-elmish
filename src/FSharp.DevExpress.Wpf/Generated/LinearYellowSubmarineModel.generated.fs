...
type LinearYellowSubmarineModelProp =
    | Base of LinearGaugeModelProp

module LinearYellowSubmarineModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearYellowSubmarineModel) (prop: LinearYellowSubmarineModelProp) =
        match prop with
        | LinearYellowSubmarineModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearYellowSubmarineModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
