...
type FlatLightArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FlatLightArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightArcScaleMarkerControl) (prop: FlatLightArcScaleMarkerControlProp) =
        match prop with
        | FlatLightArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
