...
type PlacementAdornerProp =
    | Base of BaseSurfacedAdornerProp

module PlacementAdorner =

    let apply (el: DevExpress.Xpf.Core.PlacementAdorner) (prop: PlacementAdornerProp) =
        match prop with
        | PlacementAdornerProp.Base p -> BaseSurfacedAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PlacementAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
