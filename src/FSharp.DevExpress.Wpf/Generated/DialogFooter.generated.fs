...
type DialogFooterProp =
    | Base of NonVisualDecoratorProp
    | ActualDialogWindow of DevExpress.Xpf.Core.DXDialogWindow
    | ActualThemedDialogWindow of obj

module DialogFooter =
    let actualDialogWindow v : obj = box (DialogFooterProp.ActualDialogWindow v)
    let actualThemedDialogWindow v : obj = box (DialogFooterProp.ActualThemedDialogWindow v)

    let apply (el: DevExpress.Xpf.Core.DialogFooter) (prop: DialogFooterProp) =
        match prop with
        | DialogFooterProp.Base p -> NonVisualDecorator.apply el p
        | DialogFooterProp.ActualDialogWindow v -> el.SetValue(DevExpress.Xpf.Core.DialogFooter.ActualDialogWindowProperty, box v)
        | DialogFooterProp.ActualThemedDialogWindow v -> el.SetValue(DevExpress.Xpf.Core.DialogFooter.ActualThemedDialogWindowProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DialogFooter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
