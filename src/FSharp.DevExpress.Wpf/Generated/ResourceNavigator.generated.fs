...
type ResourceNavigatorProp =
    | FirstCommand of System.Windows.Input.ICommand
    | PrevPageCommand of System.Windows.Input.ICommand
    | PrevCommand of System.Windows.Input.ICommand
    | NextCommand of System.Windows.Input.ICommand
    | NextPageCommand of System.Windows.Input.ICommand
    | LastCommand of System.Windows.Input.ICommand
    | PlusCommand of System.Windows.Input.ICommand
    | MinusCommand of System.Windows.Input.ICommand
    | Orientation of System.Windows.Controls.Orientation

module ResourceNavigator =
    let firstCommand v : obj = box (ResourceNavigatorProp.FirstCommand v)
    let prevPageCommand v : obj = box (ResourceNavigatorProp.PrevPageCommand v)
    let prevCommand v : obj = box (ResourceNavigatorProp.PrevCommand v)
    let nextCommand v : obj = box (ResourceNavigatorProp.NextCommand v)
    let nextPageCommand v : obj = box (ResourceNavigatorProp.NextPageCommand v)
    let lastCommand v : obj = box (ResourceNavigatorProp.LastCommand v)
    let plusCommand v : obj = box (ResourceNavigatorProp.PlusCommand v)
    let minusCommand v : obj = box (ResourceNavigatorProp.MinusCommand v)
    let orientation v : obj = box (ResourceNavigatorProp.Orientation v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.ResourceNavigator) (prop: ResourceNavigatorProp) =
        match prop with
        | ResourceNavigatorProp.FirstCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.FirstCommandProperty, box v)
        | ResourceNavigatorProp.PrevPageCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.PrevPageCommandProperty, box v)
        | ResourceNavigatorProp.PrevCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.PrevCommandProperty, box v)
        | ResourceNavigatorProp.NextCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.NextCommandProperty, box v)
        | ResourceNavigatorProp.NextPageCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.NextPageCommandProperty, box v)
        | ResourceNavigatorProp.LastCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.LastCommandProperty, box v)
        | ResourceNavigatorProp.PlusCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.PlusCommandProperty, box v)
        | ResourceNavigatorProp.MinusCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.MinusCommandProperty, box v)
        | ResourceNavigatorProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ResourceNavigator.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.ResourceNavigator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
