...
type LayoutGroupProp =
    | Base of LayoutControlBaseProp
    | GroupBoxStyle of System.Windows.Style
    | Header of obj
    | HeaderTemplate of System.Windows.DataTemplate
    | IsCollapsed of bool
    | IsCollapsible of bool
    | IsLocked of bool
    | ItemLabelsAlignment of DevExpress.Xpf.LayoutControl.LayoutItemLabelsAlignment
    | ItemStyle of System.Windows.Style
    | KeepSelectionOnTabRemoval of bool
    | MeasureSelectedTabChildOnly of bool
    | Orientation of System.Windows.Controls.Orientation
    | SelectedTabIndex of int
    | TabsStyle of System.Windows.Style
    | TabStyle of System.Windows.Style
    | View of DevExpress.Xpf.LayoutControl.LayoutGroupView
    | GroupBoxDisplayMode of DevExpress.Xpf.LayoutControl.GroupBoxDisplayMode
...
module LayoutGroup =
    ...
    let apply (el: DevExpress.Xpf.LayoutControl.LayoutGroup) (prop: LayoutGroupProp) =
        match prop with
        | LayoutGroupProp.Base p -> LayoutControlBase.apply el p
        | LayoutGroupProp.GroupBoxStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.GroupBoxStyleProperty, box v)
        | LayoutGroupProp.Header v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.HeaderProperty, box v)
        | LayoutGroupProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.HeaderTemplateProperty, box v)
        | LayoutGroupProp.IsCollapsed v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.IsCollapsedProperty, box v)
        | LayoutGroupProp.IsCollapsible v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.IsCollapsibleProperty, box v)
        | LayoutGroupProp.IsLocked v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.IsLockedProperty, box v)
        | LayoutGroupProp.ItemLabelsAlignment v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.ItemLabelsAlignmentProperty, box v)
        | LayoutGroupProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.ItemStyleProperty, box v)
        | LayoutGroupProp.KeepSelectionOnTabRemoval v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.KeepSelectionOnTabRemovalProperty, box v)
        | LayoutGroupProp.MeasureSelectedTabChildOnly v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.MeasureSelectedTabChildOnlyProperty, box v)
        | LayoutGroupProp.Orientation v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.OrientationProperty, box v)
        | LayoutGroupProp.SelectedTabIndex v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.SelectedTabIndexProperty, box v)
        | LayoutGroupProp.TabsStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.TabsStyleProperty, box v)
        | LayoutGroupProp.TabStyle v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.TabStyleProperty, box v)
        | LayoutGroupProp.View v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.ViewProperty, box v)
        | LayoutGroupProp.GroupBoxDisplayMode v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutGroup.GroupBoxDisplayModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutGroup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
