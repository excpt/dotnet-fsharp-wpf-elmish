...
type AdditionalSplineSeriesGeometryProp =
    | Base of AdditionalLineSeriesGeometryProp

module AdditionalSplineSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineSeriesGeometry) (prop: AdditionalSplineSeriesGeometryProp) =
        match prop with
        | AdditionalSplineSeriesGeometryProp.Base p -> AdditionalLineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
