...
type PropertyDescriptionPresenterControlProp =
    | IsInTooltip of bool
    | ShowSelectedRowHeader of bool
    | SelectedRow of DevExpress.Xpf.PropertyGrid.RowData

module PropertyDescriptionPresenterControl =
    let isInTooltip v : obj = box (PropertyDescriptionPresenterControlProp.IsInTooltip v)
    let showSelectedRowHeader v : obj = box (PropertyDescriptionPresenterControlProp.ShowSelectedRowHeader v)
    let selectedRow v : obj = box (PropertyDescriptionPresenterControlProp.SelectedRow v)

    let apply (el: DevExpress.Xpf.PropertyGrid.PropertyDescriptionPresenterControl) (prop: PropertyDescriptionPresenterControlProp) =
        match prop with
        | PropertyDescriptionPresenterControlProp.IsInTooltip v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyDescriptionPresenterControl.IsInTooltipProperty, box v)
        | PropertyDescriptionPresenterControlProp.ShowSelectedRowHeader v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyDescriptionPresenterControl.ShowSelectedRowHeaderProperty, box v)
        | PropertyDescriptionPresenterControlProp.SelectedRow v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyDescriptionPresenterControl.SelectedRowProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PropertyDescriptionPresenterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
