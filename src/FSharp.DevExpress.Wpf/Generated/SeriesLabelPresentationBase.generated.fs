...
type SeriesLabelPresentationBaseProp =
    | Base of ChartElementBaseProp

module SeriesLabelPresentationBase =

    let apply (el: DevExpress.Xpf.Charts.SeriesLabelPresentationBase) (prop: SeriesLabelPresentationBaseProp) =
        match prop with
        | SeriesLabelPresentationBaseProp.Base p -> ChartElementBase.apply el p
