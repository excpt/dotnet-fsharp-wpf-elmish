...
type TimelineAutoHeightGroupPanelProp =
    | Base of TimelineAutoHeightGroupPanelBaseProp

module TimelineAutoHeightGroupPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanel) (prop: TimelineAutoHeightGroupPanelProp) =
        match prop with
        | TimelineAutoHeightGroupPanelProp.Base p -> TimelineAutoHeightGroupPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
