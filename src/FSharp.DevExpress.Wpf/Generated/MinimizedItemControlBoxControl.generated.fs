...
type MinimizedItemControlBoxControlProp =
    | Base of WindowControlBoxControlProp

module MinimizedItemControlBoxControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.MinimizedItemControlBoxControl) (prop: MinimizedItemControlBoxControlProp) =
        match prop with
        | MinimizedItemControlBoxControlProp.Base p -> WindowControlBoxControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.MinimizedItemControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
