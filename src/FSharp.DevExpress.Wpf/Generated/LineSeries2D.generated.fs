...
type LineSeries2DProp =
    | Base of SegmentSeries2DBaseProp
    | MarkerModel of DevExpress.Xpf.Charts.Marker2DModel
    | MarkerSize of int
    | MarkerVisible of bool
    | LineStyle of DevExpress.Xpf.Charts.LineStyle
    ...
    | ShowIsolatedPoints of bool

module LineSeries2D =
    let markerModel v : obj = box (LineSeries2DProp.MarkerModel v)
    let markerSize v : obj = box (LineSeries2DProp.MarkerSize v)
    let markerVisible v : obj = box (LineSeries2DProp.MarkerVisible v)
    let lineStyle v : obj = box (LineSeries2DProp.LineStyle v)
    let pointAnimation v : obj = box (LineSeries2DProp.PointAnimation v)
    let seriesAnimation v : obj = box (LineSeries2DProp.SeriesAnimation v)
    let showIsolatedPoints v : obj = box (LineSeries2DProp.ShowIsolatedPoints v)

    let apply (el: DevExpress.Xpf.Charts.LineSeries2D) (prop: LineSeries2DProp) =
        match prop with
        | LineSeries2DProp.Base p -> SegmentSeries2DBase.apply el p
        | LineSeries2DProp.MarkerModel v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.MarkerModelProperty, box v)
        | LineSeries2DProp.MarkerSize v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.MarkerSizeProperty, box v)
        | LineSeries2DProp.MarkerVisible v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.MarkerVisibleProperty, box v)
        | LineSeries2DProp.LineStyle v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.LineStyleProperty, box v)
        | LineSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.PointAnimationProperty, box v)
        | LineSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.SeriesAnimationProperty, box v)
        | LineSeries2DProp.ShowIsolatedPoints v -> el.SetValue(DevExpress.Xpf.Charts.LineSeries2D.ShowIsolatedPointsProperty, box v)

    let segmentColorizer v : obj = box (SegmentSeries2DBaseProp.SegmentColorizer v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LineSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
