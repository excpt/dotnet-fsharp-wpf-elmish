...
type RangeDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module RangeDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.RangeDashboardLayoutItem) (prop: RangeDashboardLayoutItemProp) =
        match prop with
        | RangeDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let rangeControlClientStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.RangeDashboardLayoutItem.RangeControlClientStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.DashboardWpf.RangeDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
