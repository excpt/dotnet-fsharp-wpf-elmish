...
type SpreadsheetDocumentPreviewControlProp =
    | Base of DocumentPreviewControlProp
    | Copies of int16
    | Collate of bool
    | PagesFrom of obj
    | PagesTo of obj
...
module SpreadsheetDocumentPreviewControl =
    let copies v : obj = box (SpreadsheetDocumentPreviewControlProp.Copies v)
    let collate v : obj = box (SpreadsheetDocumentPreviewControlProp.Collate v)
    let pagesFrom v : obj = box (SpreadsheetDocumentPreviewControlProp.PagesFrom v)
    let pagesTo v : obj = box (SpreadsheetDocumentPreviewControlProp.PagesTo v)
    let minPageCount v : obj = box (SpreadsheetDocumentPreviewControlProp.MinPageCount v)
    let maxPageCount v : obj = box (SpreadsheetDocumentPreviewControlProp.MaxPageCount v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl) (prop: SpreadsheetDocumentPreviewControlProp) =
        match prop with
        | SpreadsheetDocumentPreviewControlProp.Base p -> DocumentPreviewControl.apply el p
        | SpreadsheetDocumentPreviewControlProp.Copies v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl.CopiesProperty, box v)
        | SpreadsheetDocumentPreviewControlProp.Collate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl.CollateProperty, box v)
        | SpreadsheetDocumentPreviewControlProp.PagesFrom v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl.PagesFromProperty, box v)
        | SpreadsheetDocumentPreviewControlProp.PagesTo v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl.PagesToProperty, box v)
        | SpreadsheetDocumentPreviewControlProp.MinPageCount v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl.MinPageCountProperty, box v)
        | SpreadsheetDocumentPreviewControlProp.MaxPageCount v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl.MaxPageCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetDocumentPreviewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
