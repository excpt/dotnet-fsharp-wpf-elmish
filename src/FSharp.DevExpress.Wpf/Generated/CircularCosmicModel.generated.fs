...
type CircularCosmicModelProp =
    | Base of CircularGaugeModelProp

module CircularCosmicModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCosmicModel) (prop: CircularCosmicModelProp) =
        match prop with
        | CircularCosmicModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCosmicModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
