...
type DataLayoutItemProp =
    | Base of LayoutItemProp
    | UnderlyingObject of obj
    | AttributeSettings of obj
    | IsReadOnly of bool
    | ApplySettingsForCustomContent of bool

module DataLayoutItem =
    let underlyingObject v : obj = box (DataLayoutItemProp.UnderlyingObject v)
    let attributeSettings v : obj = box (DataLayoutItemProp.AttributeSettings v)
    let isReadOnly v : obj = box (DataLayoutItemProp.IsReadOnly v)
    let applySettingsForCustomContent v : obj = box (DataLayoutItemProp.ApplySettingsForCustomContent v)

    let apply (el: DevExpress.Xpf.LayoutControl.DataLayoutItem) (prop: DataLayoutItemProp) =
        match prop with
        | DataLayoutItemProp.Base p -> LayoutItem.apply el p
        | DataLayoutItemProp.UnderlyingObject v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutItem.UnderlyingObjectProperty, box v)
        | DataLayoutItemProp.AttributeSettings v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutItem.AttributeSettingsProperty, box v)
        | DataLayoutItemProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutItem.IsReadOnlyProperty, box v)
        | DataLayoutItemProp.ApplySettingsForCustomContent v -> el.SetValue(DevExpress.Xpf.LayoutControl.DataLayoutItem.ApplySettingsForCustomContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.DataLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
