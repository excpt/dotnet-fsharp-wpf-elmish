...
type RadialMenuControlProp =
    | Base of PopupMenuBarControlProp
    | ToolTipVerticalOffset of float
    | DefaultGlyphTemplate of System.Windows.DataTemplate
    | DefaultBackButtonGlyphTemplate of System.Windows.DataTemplate
    | DefaultGlyph of System.Windows.Media.ImageSource
    | DefaultBackButtonGlyph of System.Windows.Media.ImageSource
    | IsExpanded of bool
...
module RadialMenuControl =
    let toolTipVerticalOffset v : obj = box (RadialMenuControlProp.ToolTipVerticalOffset v)
    let defaultGlyphTemplate v : obj = box (RadialMenuControlProp.DefaultGlyphTemplate v)
    let defaultBackButtonGlyphTemplate v : obj = box (RadialMenuControlProp.DefaultBackButtonGlyphTemplate v)
    let defaultGlyph v : obj = box (RadialMenuControlProp.DefaultGlyph v)
    let defaultBackButtonGlyph v : obj = box (RadialMenuControlProp.DefaultBackButtonGlyph v)
    let isExpanded v : obj = box (RadialMenuControlProp.IsExpanded v)
    let glyph v : obj = box (RadialMenuControlProp.Glyph v)
    let backButtonGlyph v : obj = box (RadialMenuControlProp.BackButtonGlyph v)
    let glyphTemplate v : obj = box (RadialMenuControlProp.GlyphTemplate v)
    let backButtonGlyphTemplate v : obj = box (RadialMenuControlProp.BackButtonGlyphTemplate v)
    let sectorGap v : obj = box (RadialMenuControlProp.SectorGap v)

    let apply (el: DevExpress.Xpf.Bars.RadialMenuControl) (prop: RadialMenuControlProp) =
        match prop with
        | RadialMenuControlProp.Base p -> PopupMenuBarControl.apply el p
        | RadialMenuControlProp.ToolTipVerticalOffset v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.ToolTipVerticalOffsetProperty, box v)
        | RadialMenuControlProp.DefaultGlyphTemplate v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.DefaultGlyphTemplateProperty, box v)
        | RadialMenuControlProp.DefaultBackButtonGlyphTemplate v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.DefaultBackButtonGlyphTemplateProperty, box v)
        | RadialMenuControlProp.DefaultGlyph v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.DefaultGlyphProperty, box v)
        | RadialMenuControlProp.DefaultBackButtonGlyph v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.DefaultBackButtonGlyphProperty, box v)
        | RadialMenuControlProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.IsExpandedProperty, box v)
        | RadialMenuControlProp.Glyph v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.GlyphProperty, box v)
        | RadialMenuControlProp.BackButtonGlyph v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.BackButtonGlyphProperty, box v)
        | RadialMenuControlProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.GlyphTemplateProperty, box v)
        | RadialMenuControlProp.BackButtonGlyphTemplate v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.BackButtonGlyphTemplateProperty, box v)
        | RadialMenuControlProp.SectorGap v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuControl.SectorGapProperty, box v)

    let popup v : obj = box (SubMenuBarControlProp.Popup v)
    let contentSideVisibility v : obj = box (SubMenuBarControlProp.ContentSideVisibility v)
    let glyphSideVisibility v : obj = box (SubMenuBarControlProp.GlyphSideVisibility v)
    let glyphSidePanelWidth v : obj = box (SubMenuBarControlProp.GlyphSidePanelWidth v)
    let menuHeaderStatesHolder v : obj = box (SubMenuBarControlProp.MenuHeaderStatesHolder v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.RadialMenuControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
