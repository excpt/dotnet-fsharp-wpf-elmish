...
type AutoHideTrayHeadersGroupProp =
    | Base of psvItemsControlProp
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem
    | DockType of System.Windows.Controls.Dock

module AutoHideTrayHeadersGroup =
    let layoutItem v : obj = box (AutoHideTrayHeadersGroupProp.LayoutItem v)
    let dockType v : obj = box (AutoHideTrayHeadersGroupProp.DockType v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersGroup) (prop: AutoHideTrayHeadersGroupProp) =
        match prop with
        | AutoHideTrayHeadersGroupProp.Base p -> psvItemsControl.apply el p
        | AutoHideTrayHeadersGroupProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersGroup.LayoutItemProperty, box v)
        | AutoHideTrayHeadersGroupProp.DockType v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersGroup.DockTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AutoHideTrayHeadersGroup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
