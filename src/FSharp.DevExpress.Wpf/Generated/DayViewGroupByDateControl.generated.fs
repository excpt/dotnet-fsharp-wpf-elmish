...
type DayViewGroupByDateControlProp =
    | Base of DayViewControlBaseProp

module DayViewGroupByDateControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DayViewGroupByDateControl) (prop: DayViewGroupByDateControlProp) =
        match prop with
        | DayViewGroupByDateControlProp.Base p -> DayViewControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DayViewGroupByDateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
