...
type GantViewGroupByDateLayoutPanelProp =
    | Base of TimelineViewGroupByDateLayoutPanelProp

module GantViewGroupByDateLayoutPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.GantViewGroupByDateLayoutPanel) (prop: GantViewGroupByDateLayoutPanelProp) =
        match prop with
        | GantViewGroupByDateLayoutPanelProp.Base p -> TimelineViewGroupByDateLayoutPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.GantViewGroupByDateLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
