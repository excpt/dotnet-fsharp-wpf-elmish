...
type RadarAxisX2DProp =
    | Base of CircularAxisX2DProp
...
module RadarAxisX2D =
    let dateTimeMeasureUnit v : obj = box (RadarAxisX2DProp.DateTimeMeasureUnit v)
    let dateTimeGridAlignment v : obj = box (RadarAxisX2DProp.DateTimeGridAlignment v)
    let dateTimeOptions v : obj = box (RadarAxisX2DProp.DateTimeOptions v)
    let range v : obj = box (RadarAxisX2DProp.Range v)
    let wholeRange v : obj = box (RadarAxisX2DProp.WholeRange v)
    let logarithmic v : obj = box (RadarAxisX2DProp.Logarithmic v)
    let logarithmicBase v : obj = box (RadarAxisX2DProp.LogarithmicBase v)
    let dateTimeScaleOptions v : obj = box (RadarAxisX2DProp.DateTimeScaleOptions v)
    let timeSpanScaleOptions v : obj = box (RadarAxisX2DProp.TimeSpanScaleOptions v)
    let qualitativeScaleOptions v : obj = box (RadarAxisX2DProp.QualitativeScaleOptions v)

    let apply (el: DevExpress.Xpf.Charts.RadarAxisX2D) (prop: RadarAxisX2DProp) =
        match prop with
        | RadarAxisX2DProp.Base p -> CircularAxisX2D.apply el p
        | RadarAxisX2DProp.DateTimeMeasureUnit v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.DateTimeMeasureUnitProperty, box v)
        | RadarAxisX2DProp.DateTimeGridAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.DateTimeGridAlignmentProperty, box v)
        | RadarAxisX2DProp.DateTimeOptions v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.DateTimeOptionsProperty, box v)
        | RadarAxisX2DProp.Range v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.RangeProperty, box v)
        | RadarAxisX2DProp.WholeRange v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.WholeRangeProperty, box v)
        | RadarAxisX2DProp.Logarithmic v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.LogarithmicProperty, box v)
        | RadarAxisX2DProp.LogarithmicBase v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.LogarithmicBaseProperty, box v)
        | RadarAxisX2DProp.DateTimeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.DateTimeScaleOptionsProperty, box v)
        | RadarAxisX2DProp.TimeSpanScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.TimeSpanScaleOptionsProperty, box v)
        | RadarAxisX2DProp.QualitativeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.RadarAxisX2D.QualitativeScaleOptionsProperty, box v)

    let numericScaleOptions v : obj = box (CircularAxisX2DProp.NumericScaleOptions v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RadarAxisX2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
