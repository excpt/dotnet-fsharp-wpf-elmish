...
type HorizontalBoundsSnapLineAdornerProp =
    | Base of BoundsSnapLineAdornerProp

module HorizontalBoundsSnapLineAdorner =

    let apply (el: DevExpress.Xpf.Diagram.Native.HorizontalBoundsSnapLineAdorner) (prop: HorizontalBoundsSnapLineAdornerProp) =
        match prop with
        | HorizontalBoundsSnapLineAdornerProp.Base p -> BoundsSnapLineAdorner.apply el p

    let extent v : obj = box (BoundsSnapLineAdornerProp.Extent v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.HorizontalBoundsSnapLineAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
