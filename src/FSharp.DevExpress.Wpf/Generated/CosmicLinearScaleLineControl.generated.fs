...
type CosmicLinearScaleLineControlProp =
    | Base of PresentationControlProp

module CosmicLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicLinearScaleLineControl) (prop: CosmicLinearScaleLineControlProp) =
        match prop with
        | CosmicLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
