...
type AppointmentIntervalSubjectPresenterProp =
    | Base of FastTextBlockProp

module AppointmentIntervalSubjectPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalSubjectPresenter) (prop: AppointmentIntervalSubjectPresenterProp) =
        match prop with
        | AppointmentIntervalSubjectPresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalSubjectPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
