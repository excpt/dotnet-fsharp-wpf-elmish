...
type TimeIndicatorControlProp =
    | Orientation of System.Windows.Controls.Orientation

module TimeIndicatorControl =
    let orientation v : obj = box (TimeIndicatorControlProp.Orientation v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimeIndicatorControl) (prop: TimeIndicatorControlProp) =
        match prop with
        | TimeIndicatorControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.TimeIndicatorControl.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimeIndicatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
