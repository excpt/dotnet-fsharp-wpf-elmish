...
type CellContentProp =
    | Base of HeaderBorderProp

module CellContent =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.CellContent) (prop: CellContentProp) =
        match prop with
        | CellContentProp.Base p -> HeaderBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.CellContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
