...
type AdditionalBarSeriesHighlightedPointGeometryProp =
    | Base of AdditionalSeriesHighlightedPointGeometryProp

module AdditionalBarSeriesHighlightedPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalBarSeriesHighlightedPointGeometry) (prop: AdditionalBarSeriesHighlightedPointGeometryProp) =
        match prop with
        | AdditionalBarSeriesHighlightedPointGeometryProp.Base p -> AdditionalSeriesHighlightedPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalBarSeriesHighlightedPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
