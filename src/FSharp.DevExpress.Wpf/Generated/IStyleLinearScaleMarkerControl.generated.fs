...
type IStyleLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module IStyleLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleLinearScaleMarkerControl) (prop: IStyleLinearScaleMarkerControlProp) =
        match prop with
        | IStyleLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
