...
type FieldValueCellElementProp =
    | Base of ScrollableAreaCellProp

module FieldValueCellElement =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldValueCellElement) (prop: FieldValueCellElementProp) =
        match prop with
        | FieldValueCellElementProp.Base p -> ScrollableAreaCell.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldValueCellElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
