...
type DXRibbonWindowProp =
    | Base of DXWindowProp
    | IsCaptionVisible of bool
    | IsRibbonCaptionVisible of bool
    | RibbonAutoHideMode of bool
    | DisplayShowModeSelector of bool

module DXRibbonWindow =
    let isCaptionVisible v : obj = box (DXRibbonWindowProp.IsCaptionVisible v)
    let isRibbonCaptionVisible v : obj = box (DXRibbonWindowProp.IsRibbonCaptionVisible v)
    let ribbonAutoHideMode v : obj = box (DXRibbonWindowProp.RibbonAutoHideMode v)
    let displayShowModeSelector v : obj = box (DXRibbonWindowProp.DisplayShowModeSelector v)

    let apply (el: DevExpress.Xpf.Ribbon.DXRibbonWindow) (prop: DXRibbonWindowProp) =
        match prop with
        | DXRibbonWindowProp.Base p -> DXWindow.apply el p
        | DXRibbonWindowProp.IsCaptionVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindow.IsCaptionVisibleProperty, box v)
        | DXRibbonWindowProp.IsRibbonCaptionVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindow.IsRibbonCaptionVisibleProperty, box v)
        | DXRibbonWindowProp.RibbonAutoHideMode v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindow.RibbonAutoHideModeProperty, box v)
        | DXRibbonWindowProp.DisplayShowModeSelector v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindow.DisplayShowModeSelectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.DXRibbonWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
