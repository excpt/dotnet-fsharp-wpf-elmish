...
type TemplatedRibbonControllerProp =
    | Base of RibbonControllerProp
    | Template of System.Windows.DataTemplate

module TemplatedRibbonController =
    let template v : obj = box (TemplatedRibbonControllerProp.Template v)

    let apply (el: DevExpress.Xpf.Ribbon.TemplatedRibbonController) (prop: TemplatedRibbonControllerProp) =
        match prop with
        | TemplatedRibbonControllerProp.Base p -> RibbonController.apply el p
        | TemplatedRibbonControllerProp.Template v -> el.SetValue(DevExpress.Xpf.Ribbon.TemplatedRibbonController.TemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.TemplatedRibbonController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
