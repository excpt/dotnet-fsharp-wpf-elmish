...
type FilterPanelControlBaseProp =
    | ClearFilterCommand of System.Windows.Input.ICommand
    | ShowFilterEditorCommand of System.Windows.Input.ICommand
    | IsFilterEnabled of bool
    | IsCanEnableFilter of bool
    | AllowFilterEditor of bool
    | MRUFilters of obj
    | ActiveFilterInfo of DevExpress.Xpf.Core.CriteriaOperatorInfo
    | AllowMRUFilterList of bool
    | FilterPanelContent of obj

module FilterPanelControlBase =
    let clearFilterCommand v : obj = box (FilterPanelControlBaseProp.ClearFilterCommand v)
    let showFilterEditorCommand v : obj = box (FilterPanelControlBaseProp.ShowFilterEditorCommand v)
    let isFilterEnabled v : obj = box (FilterPanelControlBaseProp.IsFilterEnabled v)
    let isCanEnableFilter v : obj = box (FilterPanelControlBaseProp.IsCanEnableFilter v)
    let allowFilterEditor v : obj = box (FilterPanelControlBaseProp.AllowFilterEditor v)
    let mRUFilters v : obj = box (FilterPanelControlBaseProp.MRUFilters v)
    let activeFilterInfo v : obj = box (FilterPanelControlBaseProp.ActiveFilterInfo v)
    let allowMRUFilterList v : obj = box (FilterPanelControlBaseProp.AllowMRUFilterList v)
    let filterPanelContent v : obj = box (FilterPanelControlBaseProp.FilterPanelContent v)

    let apply (el: DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase) (prop: FilterPanelControlBaseProp) =
        match prop with
        | FilterPanelControlBaseProp.ClearFilterCommand v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.ClearFilterCommandProperty, box v)
        | FilterPanelControlBaseProp.ShowFilterEditorCommand v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.ShowFilterEditorCommandProperty, box v)
        | FilterPanelControlBaseProp.IsFilterEnabled v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.IsFilterEnabledProperty, box v)
        | FilterPanelControlBaseProp.IsCanEnableFilter v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.IsCanEnableFilterProperty, box v)
        | FilterPanelControlBaseProp.AllowFilterEditor v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.AllowFilterEditorProperty, box v)
        | FilterPanelControlBaseProp.MRUFilters v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.MRUFiltersProperty, box v)
        | FilterPanelControlBaseProp.ActiveFilterInfo v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.ActiveFilterInfoProperty, box v)
        | FilterPanelControlBaseProp.AllowMRUFilterList v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.AllowMRUFilterListProperty, box v)
        | FilterPanelControlBaseProp.FilterPanelContent v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FilterPanelControlBase.FilterPanelContentProperty, box v)
