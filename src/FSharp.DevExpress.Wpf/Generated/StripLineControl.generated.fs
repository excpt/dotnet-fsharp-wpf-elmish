...
type StripLineControlProp =
    | Offset of float
    | StripLine of DevExpress.Xpf.Gantt.StripLineBase
    | StripLineRange of DevExpress.Mvvm.DateTimeRange

module StripLineControl =
    let offset v : obj = box (StripLineControlProp.Offset v)
    let stripLine v : obj = box (StripLineControlProp.StripLine v)
    let stripLineRange v : obj = box (StripLineControlProp.StripLineRange v)

    let apply (el: DevExpress.Xpf.Gantt.StripLineControl) (prop: StripLineControlProp) =
        match prop with
        | StripLineControlProp.Offset v -> el.SetValue(DevExpress.Xpf.Gantt.StripLineControl.OffsetProperty, box v)
        | StripLineControlProp.StripLine v -> el.SetValue(DevExpress.Xpf.Gantt.StripLineControl.StripLineProperty, box v)
        | StripLineControlProp.StripLineRange v -> el.SetValue(DevExpress.Xpf.Gantt.StripLineControl.StripLineRangeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.StripLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
