...
type RangeBarOverlappedSeries2DProp =
    | Base of RangeBarSeries2DProp

module RangeBarOverlappedSeries2D =

    let apply (el: DevExpress.Xpf.Charts.RangeBarOverlappedSeries2D) (prop: RangeBarOverlappedSeries2DProp) =
        match prop with
        | RangeBarOverlappedSeries2DProp.Base p -> RangeBarSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RangeBarOverlappedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
