...
type FlatLightLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FlatLightLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightLinearScaleMarkerControl) (prop: FlatLightLinearScaleMarkerControlProp) =
        match prop with
        | FlatLightLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
