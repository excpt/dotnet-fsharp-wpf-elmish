...
type DigitalDefaultModelProp =
    | Base of DigitalGaugeModelProp

module DigitalDefaultModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalDefaultModel) (prop: DigitalDefaultModelProp) =
        match prop with
        | DigitalDefaultModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalDefaultModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
