...
type ShadowResizePointerProp =
    | Base of psvControlProp

module ShadowResizePointer =

    let apply (el: DevExpress.Xpf.Docking.Platform.ShadowResizePointer) (prop: ShadowResizePointerProp) =
        match prop with
        | ShadowResizePointerProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.ShadowResizePointer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
