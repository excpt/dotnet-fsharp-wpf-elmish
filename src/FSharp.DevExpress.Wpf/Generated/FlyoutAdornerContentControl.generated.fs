...
type FlyoutAdornerContentControlProp =
    | Content of obj
    | IsOpen of bool

module FlyoutAdornerContentControl =
    let content v : obj = box (FlyoutAdornerContentControlProp.Content v)
    let isOpen v : obj = box (FlyoutAdornerContentControlProp.IsOpen v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.FlyoutAdornerContentControl) (prop: FlyoutAdornerContentControlProp) =
        match prop with
        | FlyoutAdornerContentControlProp.Content v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlyoutAdornerContentControl.ContentProperty, box v)
        | FlyoutAdornerContentControlProp.IsOpen v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.FlyoutAdornerContentControl.IsOpenProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.FlyoutAdornerContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
