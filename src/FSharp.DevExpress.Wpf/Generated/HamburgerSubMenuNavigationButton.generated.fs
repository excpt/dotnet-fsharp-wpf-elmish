...
type HamburgerSubMenuNavigationButtonProp =
    | ShowPreviewMark of bool
    | ShowInPreview of bool
    | PreviewContent of obj
    | PreviewContentTemplate of System.Windows.DataTemplate
    | PreviewMarkTemplate of System.Windows.DataTemplate
    | PreviewRightContent of obj
    | PreviewRightContentTemplate of System.Windows.DataTemplate
    | CollapseFlyoutOnClick of bool
    | PreviewItemStyle of System.Windows.Style

module HamburgerSubMenuNavigationButton =
    let showPreviewMark v : obj = box (HamburgerSubMenuNavigationButtonProp.ShowPreviewMark v)
    let showInPreview v : obj = box (HamburgerSubMenuNavigationButtonProp.ShowInPreview v)
    let previewContent v : obj = box (HamburgerSubMenuNavigationButtonProp.PreviewContent v)
    let previewContentTemplate v : obj = box (HamburgerSubMenuNavigationButtonProp.PreviewContentTemplate v)
    let previewMarkTemplate v : obj = box (HamburgerSubMenuNavigationButtonProp.PreviewMarkTemplate v)
    let previewRightContent v : obj = box (HamburgerSubMenuNavigationButtonProp.PreviewRightContent v)
    let previewRightContentTemplate v : obj = box (HamburgerSubMenuNavigationButtonProp.PreviewRightContentTemplate v)
    let collapseFlyoutOnClick v : obj = box (HamburgerSubMenuNavigationButtonProp.CollapseFlyoutOnClick v)
    let previewItemStyle v : obj = box (HamburgerSubMenuNavigationButtonProp.PreviewItemStyle v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton) (prop: HamburgerSubMenuNavigationButtonProp) =
        match prop with
        | HamburgerSubMenuNavigationButtonProp.ShowPreviewMark v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.ShowPreviewMarkProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.ShowInPreview v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.ShowInPreviewProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.PreviewContent v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.PreviewContentProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.PreviewContentTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.PreviewContentTemplateProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.PreviewMarkTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.PreviewMarkTemplateProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.PreviewRightContent v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.PreviewRightContentProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.PreviewRightContentTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.PreviewRightContentTemplateProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.CollapseFlyoutOnClick v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.CollapseFlyoutOnClickProperty, box v)
        | HamburgerSubMenuNavigationButtonProp.PreviewItemStyle v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton.PreviewItemStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerSubMenuNavigationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
