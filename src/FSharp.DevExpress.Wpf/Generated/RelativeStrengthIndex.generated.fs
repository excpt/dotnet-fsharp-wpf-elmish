...
type RelativeStrengthIndexProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel
    | PointsCount of int

module RelativeStrengthIndex =
    let valueLevel v : obj = box (RelativeStrengthIndexProp.ValueLevel v)
    let pointsCount v : obj = box (RelativeStrengthIndexProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.RelativeStrengthIndex) (prop: RelativeStrengthIndexProp) =
        match prop with
        | RelativeStrengthIndexProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | RelativeStrengthIndexProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.RelativeStrengthIndex.ValueLevelProperty, box v)
        | RelativeStrengthIndexProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.RelativeStrengthIndex.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RelativeStrengthIndex>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
