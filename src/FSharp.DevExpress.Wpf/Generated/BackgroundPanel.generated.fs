...
type BackgroundPanelProp =
    | WasModifiedByBackgroundPanel of obj

module BackgroundPanel =
    let wasModifiedByBackgroundPanel v : obj = box (BackgroundPanelProp.WasModifiedByBackgroundPanel v)

    let apply (el: DevExpress.Xpf.Core.BackgroundPanel) (prop: BackgroundPanelProp) =
        match prop with
        | BackgroundPanelProp.WasModifiedByBackgroundPanel v -> el.SetValue(DevExpress.Xpf.Core.BackgroundPanel.PropertyWasModifiedByBackgroundPanelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.BackgroundPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
