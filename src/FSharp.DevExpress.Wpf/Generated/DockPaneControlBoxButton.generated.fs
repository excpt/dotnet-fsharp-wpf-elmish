...
type DockPaneControlBoxButtonProp =
    | Base of ControlBoxButtonProp
    | IsAutoHidden of bool

module DockPaneControlBoxButton =
    let isAutoHidden v : obj = box (DockPaneControlBoxButtonProp.IsAutoHidden v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockPaneControlBoxButton) (prop: DockPaneControlBoxButtonProp) =
        match prop with
        | DockPaneControlBoxButtonProp.Base p -> ControlBoxButton.apply el p
        | DockPaneControlBoxButtonProp.IsAutoHidden v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockPaneControlBoxButton.IsAutoHiddenProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockPaneControlBoxButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
