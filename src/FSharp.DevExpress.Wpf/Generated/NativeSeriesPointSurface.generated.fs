...
type NativeSeriesPointSurfaceProp =
    | Base of AdditionalSeriesPointGeometryProp

module NativeSeriesPointSurface =

    let apply (el: DevExpress.Xpf.Charts.Surface.NativeSeriesPointSurface) (prop: NativeSeriesPointSurfaceProp) =
        match prop with
        | NativeSeriesPointSurfaceProp.Base p -> AdditionalSeriesPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Surface.NativeSeriesPointSurface>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
