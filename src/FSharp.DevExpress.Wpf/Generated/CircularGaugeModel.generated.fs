...
type CircularGaugeModelProp =
    | Base of GaugeModelBaseProp
    | ModelFull of DevExpress.Xpf.Gauges.PartialCircularGaugeModel
    | ModelHalfTop of DevExpress.Xpf.Gauges.PartialCircularGaugeModel
    | ModelQuarterTopLeft of DevExpress.Xpf.Gauges.PartialCircularGaugeModel
    | ModelQuarterTopRight of DevExpress.Xpf.Gauges.PartialCircularGaugeModel
    | ModelThreeQuarters of DevExpress.Xpf.Gauges.PartialCircularGaugeModel

module CircularGaugeModel =
    let modelFull v : obj = box (CircularGaugeModelProp.ModelFull v)
    let modelHalfTop v : obj = box (CircularGaugeModelProp.ModelHalfTop v)
    let modelQuarterTopLeft v : obj = box (CircularGaugeModelProp.ModelQuarterTopLeft v)
    let modelQuarterTopRight v : obj = box (CircularGaugeModelProp.ModelQuarterTopRight v)
    let modelThreeQuarters v : obj = box (CircularGaugeModelProp.ModelThreeQuarters v)

    let apply (el: DevExpress.Xpf.Gauges.CircularGaugeModel) (prop: CircularGaugeModelProp) =
        match prop with
        | CircularGaugeModelProp.Base p -> GaugeModelBase.apply el p
        | CircularGaugeModelProp.ModelFull v -> el.SetValue(DevExpress.Xpf.Gauges.CircularGaugeModel.ModelFullProperty, box v)
        | CircularGaugeModelProp.ModelHalfTop v -> el.SetValue(DevExpress.Xpf.Gauges.CircularGaugeModel.ModelHalfTopProperty, box v)
        | CircularGaugeModelProp.ModelQuarterTopLeft v -> el.SetValue(DevExpress.Xpf.Gauges.CircularGaugeModel.ModelQuarterTopLeftProperty, box v)
        | CircularGaugeModelProp.ModelQuarterTopRight v -> el.SetValue(DevExpress.Xpf.Gauges.CircularGaugeModel.ModelQuarterTopRightProperty, box v)
        | CircularGaugeModelProp.ModelThreeQuarters v -> el.SetValue(DevExpress.Xpf.Gauges.CircularGaugeModel.ModelThreeQuartersProperty, box v)
