...
type VisualDayViewResourcesBasedViewInfoProp =
    | Base of VisualResourcesBasedViewInfoProp
    | ShowTimeRulerHeader of bool
    | AllDayAreaContainerGroups of DevExpress.Xpf.Scheduler.Drawing.VisualResourceAllDayAreaContainerGroupCollection
    | DateTimeScrollOffset of float
    | ShowDayHeaders of bool
    | TimeIndicatorVisibility of DevExpress.XtraScheduler.TimeIndicatorVisibility

module VisualDayViewResourcesBasedViewInfo =
    let showTimeRulerHeader v : obj = box (VisualDayViewResourcesBasedViewInfoProp.ShowTimeRulerHeader v)
    let allDayAreaContainerGroups v : obj = box (VisualDayViewResourcesBasedViewInfoProp.AllDayAreaContainerGroups v)
    let dateTimeScrollOffset v : obj = box (VisualDayViewResourcesBasedViewInfoProp.DateTimeScrollOffset v)
    let showDayHeaders v : obj = box (VisualDayViewResourcesBasedViewInfoProp.ShowDayHeaders v)
    let timeIndicatorVisibility v : obj = box (VisualDayViewResourcesBasedViewInfoProp.TimeIndicatorVisibility v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDayViewResourcesBasedViewInfo) (prop: VisualDayViewResourcesBasedViewInfoProp) =
        match prop with
        | VisualDayViewResourcesBasedViewInfoProp.Base p -> VisualResourcesBasedViewInfo.apply el p
        | VisualDayViewResourcesBasedViewInfoProp.ShowTimeRulerHeader v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewResourcesBasedViewInfo.ShowTimeRulerHeaderProperty, box v)
        | VisualDayViewResourcesBasedViewInfoProp.AllDayAreaContainerGroups v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewResourcesBasedViewInfo.AllDayAreaContainerGroupsProperty, box v)
        | VisualDayViewResourcesBasedViewInfoProp.DateTimeScrollOffset v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewResourcesBasedViewInfo.DateTimeScrollOffsetProperty, box v)
        | VisualDayViewResourcesBasedViewInfoProp.ShowDayHeaders v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewResourcesBasedViewInfo.ShowDayHeadersProperty, box v)
        | VisualDayViewResourcesBasedViewInfoProp.TimeIndicatorVisibility v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDayViewResourcesBasedViewInfo.TimeIndicatorVisibilityProperty, box v)
