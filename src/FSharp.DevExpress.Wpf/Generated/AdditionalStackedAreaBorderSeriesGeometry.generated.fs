...
type AdditionalStackedAreaBorderSeriesGeometryProp =
    | Base of AdditionalAreaBorderSeriesGeometryProp

module AdditionalStackedAreaBorderSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStackedAreaBorderSeriesGeometry) (prop: AdditionalStackedAreaBorderSeriesGeometryProp) =
        match prop with
        | AdditionalStackedAreaBorderSeriesGeometryProp.Base p -> AdditionalAreaBorderSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStackedAreaBorderSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
