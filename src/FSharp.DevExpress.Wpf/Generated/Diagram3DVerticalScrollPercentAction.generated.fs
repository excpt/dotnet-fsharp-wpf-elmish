...
type Diagram3DVerticalScrollPercentActionProp =
    | Base of Diagram3DAnimationActionProp
    | FinalVerticalScrollPercent of float

module Diagram3DVerticalScrollPercentAction =
    let finalVerticalScrollPercent v : obj = box (Diagram3DVerticalScrollPercentActionProp.FinalVerticalScrollPercent v)

    let apply (el: DevExpress.Xpf.Charts.Diagram3DVerticalScrollPercentAction) (prop: Diagram3DVerticalScrollPercentActionProp) =
        match prop with
        | Diagram3DVerticalScrollPercentActionProp.Base p -> Diagram3DAnimationAction.apply el p
        | Diagram3DVerticalScrollPercentActionProp.FinalVerticalScrollPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DVerticalScrollPercentAction.FinalVerticalScrollPercentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Diagram3DVerticalScrollPercentAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
