...
type TimelineCellsPanelProp =
    | ItemHorizontalBorderThickness of float
    | ItemVerticalBorderThickness of float

module TimelineCellsPanel =
    let itemHorizontalBorderThickness v : obj = box (TimelineCellsPanelProp.ItemHorizontalBorderThickness v)
    let itemVerticalBorderThickness v : obj = box (TimelineCellsPanelProp.ItemVerticalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineCellsPanel) (prop: TimelineCellsPanelProp) =
        match prop with
        | TimelineCellsPanelProp.ItemHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsPanel.ItemHorizontalBorderThicknessProperty, box v)
        | TimelineCellsPanelProp.ItemVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsPanel.ItemVerticalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineCellsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
