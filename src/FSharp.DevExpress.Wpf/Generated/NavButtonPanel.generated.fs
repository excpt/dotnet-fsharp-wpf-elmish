...
type NavButtonPanelProp =
    | Base of SplitLayoutPanelProp
    | GlyphSpace of float

module NavButtonPanel =
    let glyphSpace v : obj = box (NavButtonPanelProp.GlyphSpace v)

    let apply (el: DevExpress.Xpf.Navigation.Internal.NavButtonPanel) (prop: NavButtonPanelProp) =
        match prop with
        | NavButtonPanelProp.Base p -> SplitLayoutPanel.apply el p
        | NavButtonPanelProp.GlyphSpace v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavButtonPanel.GlyphSpaceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.NavButtonPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
