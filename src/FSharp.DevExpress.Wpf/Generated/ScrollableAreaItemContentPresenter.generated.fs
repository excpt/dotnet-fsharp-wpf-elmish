...
type ScrollableAreaItemContentPresenterProp =
    | Base of PivotContentPresenterProp

module ScrollableAreaItemContentPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaItemContentPresenter) (prop: ScrollableAreaItemContentPresenterProp) =
        match prop with
        | ScrollableAreaItemContentPresenterProp.Base p -> PivotContentPresenter.apply el p
