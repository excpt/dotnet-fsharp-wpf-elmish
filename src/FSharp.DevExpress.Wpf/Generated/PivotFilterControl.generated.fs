...
type PivotFilterControlProp =
    | Base of FilterControlProp

module PivotFilterControl =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.PivotFilterControl) (prop: PivotFilterControlProp) =
        match prop with
        | PivotFilterControlProp.Base p -> FilterControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.PivotFilterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
