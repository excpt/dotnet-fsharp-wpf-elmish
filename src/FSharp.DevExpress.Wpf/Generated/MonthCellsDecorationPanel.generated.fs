...
type MonthCellsDecorationPanelProp =
    | Base of CellsDecorationPanelProp
    | TodayCellIndex of int
    | TodayBorderThickness of float

module MonthCellsDecorationPanel =
    let todayCellIndex v : obj = box (MonthCellsDecorationPanelProp.TodayCellIndex v)
    let todayBorderThickness v : obj = box (MonthCellsDecorationPanelProp.TodayBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.MonthCellsDecorationPanel) (prop: MonthCellsDecorationPanelProp) =
        match prop with
        | MonthCellsDecorationPanelProp.Base p -> CellsDecorationPanel.apply el p
        | MonthCellsDecorationPanelProp.TodayCellIndex v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthCellsDecorationPanel.TodayCellIndexProperty, box v)
        | MonthCellsDecorationPanelProp.TodayBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.MonthCellsDecorationPanel.TodayBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.MonthCellsDecorationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
