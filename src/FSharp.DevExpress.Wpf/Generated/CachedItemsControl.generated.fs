...
type CachedItemsControlProp =
    | Base of ItemsControlBaseProp

module CachedItemsControl =

    let apply (el: DevExpress.Xpf.Core.CachedItemsControl) (prop: CachedItemsControlProp) =
        match prop with
        | CachedItemsControlProp.Base p -> ItemsControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.CachedItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
