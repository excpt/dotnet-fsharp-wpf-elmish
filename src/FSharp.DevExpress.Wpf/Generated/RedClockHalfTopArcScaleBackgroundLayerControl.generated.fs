...
type RedClockHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedClockHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockHalfTopArcScaleBackgroundLayerControl) (prop: RedClockHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | RedClockHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
