...
type TrafficLightsOffStatePresentationControlProp =
    | Base of PresentationControlProp

module TrafficLightsOffStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.TrafficLightsOffStatePresentationControl) (prop: TrafficLightsOffStatePresentationControlProp) =
        match prop with
        | TrafficLightsOffStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.TrafficLightsOffStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
