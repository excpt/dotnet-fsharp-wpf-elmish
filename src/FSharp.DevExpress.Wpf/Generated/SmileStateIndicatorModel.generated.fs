...
type SmileStateIndicatorModelProp =
    | Base of StateIndicatorModelProp

module SmileStateIndicatorModel =

    let apply (el: DevExpress.Xpf.Gauges.SmileStateIndicatorModel) (prop: SmileStateIndicatorModelProp) =
        match prop with
        | SmileStateIndicatorModelProp.Base p -> StateIndicatorModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmileStateIndicatorModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
