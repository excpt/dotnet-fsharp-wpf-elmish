...
type DateEditCalendarContentProp =
    | State of DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarState
    | DateTime of System.DateTime

module DateEditCalendarContent =
    let state v : obj = box (DateEditCalendarContentProp.State v)
    let dateTime v : obj = box (DateEditCalendarContentProp.DateTime v)

    let apply (el: DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarContent) (prop: DateEditCalendarContentProp) =
        match prop with
        | DateEditCalendarContentProp.State v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarContent.StateProperty, box v)
        | DateEditCalendarContentProp.DateTime v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarContent.DateTimeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
