...
type FlipViewItemProp =
    | Base of veContentSelectorItemProp

module FlipViewItem =

    let apply (el: DevExpress.Xpf.WindowsUI.FlipViewItem) (prop: FlipViewItemProp) =
        match prop with
        | FlipViewItemProp.Base p -> veContentSelectorItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.FlipViewItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
