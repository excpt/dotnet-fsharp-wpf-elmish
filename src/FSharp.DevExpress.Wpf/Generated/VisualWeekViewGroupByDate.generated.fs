...
type VisualWeekViewGroupByDateProp =
    | Base of VisualResourcesBasedViewInfoProp

module VisualWeekViewGroupByDate =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualWeekViewGroupByDate) (prop: VisualWeekViewGroupByDateProp) =
        match prop with
        | VisualWeekViewGroupByDateProp.Base p -> VisualResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualWeekViewGroupByDate>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
