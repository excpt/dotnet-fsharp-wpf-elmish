...
type PageSetupWindowProp =
    | Base of DXDialogProp

module PageSetupWindow =

    let apply (el: DevExpress.Xpf.Printing.Native.PageSetupWindow) (prop: PageSetupWindowProp) =
        match prop with
        | PageSetupWindowProp.Base p -> DXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.PageSetupWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
