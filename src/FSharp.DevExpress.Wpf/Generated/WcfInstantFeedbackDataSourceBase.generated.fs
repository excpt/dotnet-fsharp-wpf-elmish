...
type WcfInstantFeedbackDataSourceBaseProp =
    | Base of ListSourceDataSourceBaseProp
    | AreSourceRowsThreadSafe of bool
...
module WcfInstantFeedbackDataSourceBase =
    let areSourceRowsThreadSafe v : obj = box (WcfInstantFeedbackDataSourceBaseProp.AreSourceRowsThreadSafe v)
    let defaultSorting v : obj = box (WcfInstantFeedbackDataSourceBaseProp.DefaultSorting v)
    let fixedFilter v : obj = box (WcfInstantFeedbackDataSourceBaseProp.FixedFilter v)
    let keyExpression v : obj = box (WcfInstantFeedbackDataSourceBaseProp.KeyExpression v)
    let dataServiceContext v : obj = box (WcfInstantFeedbackDataSourceBaseProp.DataServiceContext v)
    let query v : obj = box (WcfInstantFeedbackDataSourceBaseProp.Query v)
    let serviceRoot v : obj = box (WcfInstantFeedbackDataSourceBaseProp.ServiceRoot v)

    let apply (el: DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase) (prop: WcfInstantFeedbackDataSourceBaseProp) =
        match prop with
        | WcfInstantFeedbackDataSourceBaseProp.Base p -> ListSourceDataSourceBase.apply el p
        | WcfInstantFeedbackDataSourceBaseProp.AreSourceRowsThreadSafe v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.AreSourceRowsThreadSafeProperty, box v)
        | WcfInstantFeedbackDataSourceBaseProp.DefaultSorting v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.DefaultSortingProperty, box v)
        | WcfInstantFeedbackDataSourceBaseProp.FixedFilter v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.FixedFilterProperty, box v)
        | WcfInstantFeedbackDataSourceBaseProp.KeyExpression v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.KeyExpressionProperty, box v)
        | WcfInstantFeedbackDataSourceBaseProp.DataServiceContext v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.DataServiceContextProperty, box v)
        | WcfInstantFeedbackDataSourceBaseProp.Query v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.QueryProperty, box v)
        | WcfInstantFeedbackDataSourceBaseProp.ServiceRoot v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfInstantFeedbackDataSourceBase.ServiceRootProperty, box v)
