...
type PaginationBarItemLinkControlProp =
    | Base of BarStaticItemLinkControlProp

module PaginationBarItemLinkControl =

    let apply (el: DevExpress.Xpf.DocumentViewer.PaginationBarItemLinkControl) (prop: PaginationBarItemLinkControlProp) =
        match prop with
        | PaginationBarItemLinkControlProp.Base p -> BarStaticItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.PaginationBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
