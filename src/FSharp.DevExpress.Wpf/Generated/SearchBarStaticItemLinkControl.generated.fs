...
type SearchBarStaticItemLinkControlProp =
    | Base of BarStaticItemLinkControlProp

module SearchBarStaticItemLinkControl =

    let apply (el: DevExpress.Xpf.DocumentViewer.SearchBarStaticItemLinkControl) (prop: SearchBarStaticItemLinkControlProp) =
        match prop with
        | SearchBarStaticItemLinkControlProp.Base p -> BarStaticItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.SearchBarStaticItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
