...
type SimpleFunnel2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp
    | Border of DevExpress.Xpf.Charts.SeriesBorder
    | PointGeometry of System.Windows.Media.Geometry
    | BorderGeometry of System.Windows.Media.Geometry

module SimpleFunnel2DModelControl =
    let border v : obj = box (SimpleFunnel2DModelControlProp.Border v)
    let pointGeometry v : obj = box (SimpleFunnel2DModelControlProp.PointGeometry v)
    let borderGeometry v : obj = box (SimpleFunnel2DModelControlProp.BorderGeometry v)

    let apply (el: DevExpress.Xpf.Charts.SimpleFunnel2DModelControl) (prop: SimpleFunnel2DModelControlProp) =
        match prop with
        | SimpleFunnel2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
        | SimpleFunnel2DModelControlProp.Border v -> el.SetValue(DevExpress.Xpf.Charts.SimpleFunnel2DModelControl.BorderProperty, box v)
        | SimpleFunnel2DModelControlProp.PointGeometry v -> el.SetValue(DevExpress.Xpf.Charts.SimpleFunnel2DModelControl.PointGeometryProperty, box v)
        | SimpleFunnel2DModelControlProp.BorderGeometry v -> el.SetValue(DevExpress.Xpf.Charts.SimpleFunnel2DModelControl.BorderGeometryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleFunnel2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
