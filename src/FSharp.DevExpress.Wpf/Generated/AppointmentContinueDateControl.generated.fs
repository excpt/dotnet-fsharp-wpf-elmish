...
type AppointmentContinueDateControlProp =
    | ViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentViewInfo
    | ArrowImage of System.Windows.Media.Imaging.BitmapImage
    | Text of string

module AppointmentContinueDateControl =
    let viewInfo v : obj = box (AppointmentContinueDateControlProp.ViewInfo v)
    let arrowImage v : obj = box (AppointmentContinueDateControlProp.ArrowImage v)
    let text v : obj = box (AppointmentContinueDateControlProp.Text v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueDateControl) (prop: AppointmentContinueDateControlProp) =
        match prop with
        | AppointmentContinueDateControlProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueDateControl.ViewInfoProperty, box v)
        | AppointmentContinueDateControlProp.ArrowImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueDateControl.ArrowImageProperty, box v)
        | AppointmentContinueDateControlProp.Text v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentContinueDateControl.TextProperty, box v)
