...
type WorksheetCommentPanelProp =
    | Base of WorksheetPaintPanelProp
    | CommentLineBrush of System.Windows.Media.Brush
    | CommentLineWidth of float

module WorksheetCommentPanel =
    let commentLineBrush v : obj = box (WorksheetCommentPanelProp.CommentLineBrush v)
    let commentLineWidth v : obj = box (WorksheetCommentPanelProp.CommentLineWidth v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetCommentPanel) (prop: WorksheetCommentPanelProp) =
        match prop with
        | WorksheetCommentPanelProp.Base p -> WorksheetPaintPanel.apply el p
        | WorksheetCommentPanelProp.CommentLineBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetCommentPanel.CommentLineBrushProperty, box v)
        | WorksheetCommentPanelProp.CommentLineWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetCommentPanel.CommentLineWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetCommentPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
