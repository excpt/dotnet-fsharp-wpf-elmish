...
type DefaultLinearScaleLineControlProp =
    | Base of PresentationControlProp

module DefaultLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleLineControl) (prop: DefaultLinearScaleLineControlProp) =
        match prop with
        | DefaultLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
