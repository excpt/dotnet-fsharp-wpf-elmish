...
type SchedulerCellsBasedPanelBaseProp =
    | Base of SchedulerPanelCoreBaseProp
    | SchedulerTimeCellControl of DevExpress.Xpf.Scheduler.Drawing.ISchedulerTimeCellControl
    | CellContainer of DevExpress.Xpf.Scheduler.Drawing.VisualCellContainer

module SchedulerCellsBasedPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerCellsBasedPanelBase) (prop: SchedulerCellsBasedPanelBaseProp) =
        match prop with
        | SchedulerCellsBasedPanelBaseProp.Base p -> SchedulerPanelCoreBase.apply el p
        | SchedulerCellsBasedPanelBaseProp.SchedulerTimeCellControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerCellsBasedPanelBase.SchedulerTimeCellControlProperty, box v)
        | SchedulerCellsBasedPanelBaseProp.CellContainer v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerCellsBasedPanelBase.CellContainerProperty, box v)
