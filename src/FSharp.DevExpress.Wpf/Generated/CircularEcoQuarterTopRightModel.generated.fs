...
type CircularEcoQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularEcoQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularEcoQuarterTopRightModel) (prop: CircularEcoQuarterTopRightModelProp) =
        match prop with
        | CircularEcoQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularEcoQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
