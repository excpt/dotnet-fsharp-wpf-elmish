...
type TableStyleViewProp =
    | Base of ThemedWindowProp

module TableStyleView =

    let apply (el: DevExpress.XtraRichEdit.View.TableStyleView) (prop: TableStyleViewProp) =
        match prop with
        | TableStyleViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.View.TableStyleView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
