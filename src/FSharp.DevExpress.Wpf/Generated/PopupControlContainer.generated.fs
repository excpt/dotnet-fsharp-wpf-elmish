...
type PopupControlContainerProp =
...
module PopupControlContainer =
    let closeOnClick v : obj = box (PopupControlContainerProp.CloseOnClick v)
    let content v : obj = box (PopupControlContainerProp.Content v)
    let foreground v : obj = box (PopupControlContainerProp.Foreground v)

    let apply (el: DevExpress.Xpf.Bars.PopupControlContainer) (prop: PopupControlContainerProp) =
        match prop with
        | PopupControlContainerProp.Base p -> BarPopupExpandable.apply el p
        | PopupControlContainerProp.CloseOnClick v -> el.SetValue(DevExpress.Xpf.Bars.PopupControlContainer.CloseOnClickProperty, box v)
        | PopupControlContainerProp.Content v -> el.SetValue(DevExpress.Xpf.Bars.PopupControlContainer.ContentProperty, box v)
        | PopupControlContainerProp.Foreground v -> el.SetValue(DevExpress.Xpf.Bars.PopupControlContainer.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupControlContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
