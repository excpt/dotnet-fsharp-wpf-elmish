...
type SimpleBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module SimpleBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.SimpleBar2DModelControl) (prop: SimpleBar2DModelControlProp) =
        match prop with
        | SimpleBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
