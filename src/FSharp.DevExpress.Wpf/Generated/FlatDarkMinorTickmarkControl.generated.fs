...
type FlatDarkMinorTickmarkControlProp =
    | Base of PresentationControlProp

module FlatDarkMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkMinorTickmarkControl) (prop: FlatDarkMinorTickmarkControlProp) =
        match prop with
        | FlatDarkMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
