...
type MultiScaleImageBaseProp =
    | UseSprings of bool
    | Source of DevExpress.Xpf.Map.MapImageSourceBase
    | Layer of DevExpress.Xpf.Map.ImageLayer

module MultiScaleImageBase =
    ...
    let apply (el: DevExpress.Xpf.Map.MultiScaleImageBase) (prop: MultiScaleImageBaseProp) =
        match prop with
        | MultiScaleImageBaseProp.UseSprings v -> el.SetValue(DevExpress.Xpf.Map.MultiScaleImageBase.UseSpringsProperty, box v)
        | MultiScaleImageBaseProp.Source v -> el.SetValue(DevExpress.Xpf.Map.MultiScaleImageBase.SourceProperty, box v)
        | MultiScaleImageBaseProp.Layer v -> el.SetValue(DevExpress.Xpf.Map.MultiScaleImageBase.LayerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MultiScaleImageBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
