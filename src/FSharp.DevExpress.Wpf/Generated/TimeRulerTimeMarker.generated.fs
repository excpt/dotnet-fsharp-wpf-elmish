...
type TimeRulerTimeMarkerProp =
    | TimeRuler of DevExpress.Xpf.Scheduler.Drawing.VisualTimeRuler

module TimeRulerTimeMarker =
    let timeRuler v : obj = box (TimeRulerTimeMarkerProp.TimeRuler v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.TimeRulerTimeMarker) (prop: TimeRulerTimeMarkerProp) =
        match prop with
        | TimeRulerTimeMarkerProp.TimeRuler v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.TimeRulerTimeMarker.TimeRulerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.TimeRulerTimeMarker>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
