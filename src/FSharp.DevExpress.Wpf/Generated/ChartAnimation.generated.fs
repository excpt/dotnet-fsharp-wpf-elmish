...
type ChartAnimationProp =
    | Base of ChartElementProp

module ChartAnimation =

    let apply (el: DevExpress.Xpf.Charts.ChartAnimation) (prop: ChartAnimationProp) =
        match prop with
        | ChartAnimationProp.Base p -> ChartElement.apply el p
