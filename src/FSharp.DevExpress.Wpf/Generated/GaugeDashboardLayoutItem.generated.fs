...
type GaugeDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module GaugeDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.GaugeDashboardLayoutItem) (prop: GaugeDashboardLayoutItemProp) =
        match prop with
        | GaugeDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.GaugeDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
