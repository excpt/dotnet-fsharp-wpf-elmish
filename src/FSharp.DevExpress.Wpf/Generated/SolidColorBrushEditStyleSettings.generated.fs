...
type SolidColorBrushEditStyleSettingsProp =
    | Base of BrushEditStyleSettingsBaseProp

module SolidColorBrushEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.SolidColorBrushEditStyleSettings) (prop: SolidColorBrushEditStyleSettingsProp) =
        match prop with
        | SolidColorBrushEditStyleSettingsProp.Base p -> BrushEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SolidColorBrushEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
