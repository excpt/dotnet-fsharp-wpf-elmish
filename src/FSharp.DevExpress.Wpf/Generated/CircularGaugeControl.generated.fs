...
type CircularGaugeControlProp =
    | Base of AnalogGaugeControlProp
    | Model of DevExpress.Xpf.Gauges.CircularGaugeModel

module CircularGaugeControl =
    let model v : obj = box (CircularGaugeControlProp.Model v)

    let apply (el: DevExpress.Xpf.Gauges.CircularGaugeControl) (prop: CircularGaugeControlProp) =
        match prop with
        | CircularGaugeControlProp.Base p -> AnalogGaugeControl.apply el p
        | CircularGaugeControlProp.Model v -> el.SetValue(DevExpress.Xpf.Gauges.CircularGaugeControl.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularGaugeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
