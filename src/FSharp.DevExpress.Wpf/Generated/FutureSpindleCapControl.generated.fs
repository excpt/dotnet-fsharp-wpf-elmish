...
type FutureSpindleCapControlProp =
    | Base of PresentationControlProp

module FutureSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureSpindleCapControl) (prop: FutureSpindleCapControlProp) =
        match prop with
        | FutureSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
