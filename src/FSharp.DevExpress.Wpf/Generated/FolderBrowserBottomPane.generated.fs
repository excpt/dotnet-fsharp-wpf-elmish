...
type FolderBrowserBottomPaneProp =
    | ShowNewFolderButton of bool
    | AcceptButtonName of string
    | CancelButtonName of string

module FolderBrowserBottomPane =
    let showNewFolderButton v : obj = box (FolderBrowserBottomPaneProp.ShowNewFolderButton v)
    let acceptButtonName v : obj = box (FolderBrowserBottomPaneProp.AcceptButtonName v)
    let cancelButtonName v : obj = box (FolderBrowserBottomPaneProp.CancelButtonName v)

    let apply (el: DevExpress.Xpf.Dialogs.Native.FolderBrowserBottomPane) (prop: FolderBrowserBottomPaneProp) =
        match prop with
        | FolderBrowserBottomPaneProp.ShowNewFolderButton v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FolderBrowserBottomPane.ShowNewFolderButtonProperty, box v)
        | FolderBrowserBottomPaneProp.AcceptButtonName v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FolderBrowserBottomPane.AcceptButtonNameProperty, box v)
        | FolderBrowserBottomPaneProp.CancelButtonName v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FolderBrowserBottomPane.CancelButtonNameProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.FolderBrowserBottomPane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
