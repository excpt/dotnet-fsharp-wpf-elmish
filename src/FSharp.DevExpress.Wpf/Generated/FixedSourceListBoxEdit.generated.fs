...
type FixedSourceListBoxEditProp =
    | Base of ListBoxEditProp

module FixedSourceListBoxEdit =

    let apply (el: DevExpress.Xpf.Scheduler.UI.FixedSourceListBoxEdit) (prop: FixedSourceListBoxEditProp) =
        match prop with
        | FixedSourceListBoxEditProp.Base p -> ListBoxEdit.apply el p
