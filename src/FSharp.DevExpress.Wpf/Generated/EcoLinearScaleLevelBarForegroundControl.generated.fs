...
type EcoLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module EcoLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoLinearScaleLevelBarForegroundControl) (prop: EcoLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | EcoLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
