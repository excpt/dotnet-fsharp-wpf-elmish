...
type CircularDiagram2DProp =
    | Base of Diagram2DProp
    | ShapeStyle of DevExpress.Xpf.Charts.CircularDiagramShapeStyle
    | RotationDirection of DevExpress.Xpf.Charts.CircularDiagramRotationDirection
    ...
    | DomainBorderGeometry of System.Windows.Media.Geometry
    | DomainClipGeometry of System.Windows.Media.Geometry
    | AxisItems of obj
    | SeriesLabelItems of obj
    | Elements of obj
    | AllowSeriesBitmapCaching of bool

module CircularDiagram2D =
    let shapeStyle v : obj = box (CircularDiagram2DProp.ShapeStyle v)
    let rotationDirection v : obj = box (CircularDiagram2DProp.RotationDirection v)
    let labelsResolveOverlappingMinIndent v : obj = box (CircularDiagram2DProp.LabelsResolveOverlappingMinIndent v)
    let startAngle v : obj = box (CircularDiagram2DProp.StartAngle v)
    let domainBrush v : obj = box (CircularDiagram2DProp.DomainBrush v)
    let domainBorderBrush v : obj = box (CircularDiagram2DProp.DomainBorderBrush v)
    let domainBorderGeometry v : obj = box (CircularDiagram2DProp.DomainBorderGeometry v)
    let domainClipGeometry v : obj = box (CircularDiagram2DProp.DomainClipGeometry v)
    let axisItems v : obj = box (CircularDiagram2DProp.AxisItems v)
    let seriesLabelItems v : obj = box (CircularDiagram2DProp.SeriesLabelItems v)
    let elements v : obj = box (CircularDiagram2DProp.Elements v)
    let allowSeriesBitmapCaching v : obj = box (CircularDiagram2DProp.AllowSeriesBitmapCaching v)

    let apply (el: DevExpress.Xpf.Charts.CircularDiagram2D) (prop: CircularDiagram2DProp) =
        match prop with
        | CircularDiagram2DProp.Base p -> Diagram2D.apply el p
        | CircularDiagram2DProp.ShapeStyle v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.ShapeStyleProperty, box v)
        | CircularDiagram2DProp.RotationDirection v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.RotationDirectionProperty, box v)
        | CircularDiagram2DProp.LabelsResolveOverlappingMinIndent v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.LabelsResolveOverlappingMinIndentProperty, box v)
        | CircularDiagram2DProp.StartAngle v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.StartAngleProperty, box v)
        | CircularDiagram2DProp.DomainBrush v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.DomainBrushProperty, box v)
        | CircularDiagram2DProp.DomainBorderBrush v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.DomainBorderBrushProperty, box v)
        | CircularDiagram2DProp.DomainBorderGeometry v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.DomainBorderGeometryProperty, box v)
        | CircularDiagram2DProp.DomainClipGeometry v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.DomainClipGeometryProperty, box v)
        | CircularDiagram2DProp.AxisItems v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.AxisItemsProperty, box v)
        | CircularDiagram2DProp.SeriesLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.SeriesLabelItemsProperty, box v)
        | CircularDiagram2DProp.Elements v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.ElementsProperty, box v)
        | CircularDiagram2DProp.AllowSeriesBitmapCaching v -> el.SetValue(DevExpress.Xpf.Charts.CircularDiagram2D.AllowSeriesBitmapCachingProperty, box v)
