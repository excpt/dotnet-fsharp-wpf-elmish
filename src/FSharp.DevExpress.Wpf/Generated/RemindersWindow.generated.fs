...
type RemindersWindowProp =
    | Base of ThemedWindowProp

module RemindersWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.RemindersWindow) (prop: RemindersWindowProp) =
        match prop with
        | RemindersWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.RemindersWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
