...
type ChartItemsPresenterProp =
    | Base of ItemsPresenterProp

module ChartItemsPresenter =

    let apply (el: DevExpress.Xpf.Charts.ChartItemsPresenter) (prop: ChartItemsPresenterProp) =
        match prop with
        | ChartItemsPresenterProp.Base p -> ItemsPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartItemsPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
