...
type NavPaneGroupButtonPanelProp =
    | Base of NavigationPanePanelBaseProp

module NavPaneGroupButtonPanel =

    let apply (el: DevExpress.Xpf.NavBar.NavPaneGroupButtonPanel) (prop: NavPaneGroupButtonPanelProp) =
        match prop with
        | NavPaneGroupButtonPanelProp.Base p -> NavigationPanePanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneGroupButtonPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
