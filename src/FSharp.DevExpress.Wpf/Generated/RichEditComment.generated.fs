...
type RichEditCommentProp =
    | Base of RichEditElementProp
    | RootRenderTransform of System.Windows.Media.Transform
    | MoreButtonVisibility of System.Windows.Visibility
    | MoreButtonCommand of System.Windows.Input.ICommand

module RichEditComment =
    let rootRenderTransform v : obj = box (RichEditCommentProp.RootRenderTransform v)
    let moreButtonVisibility v : obj = box (RichEditCommentProp.MoreButtonVisibility v)
    let moreButtonCommand v : obj = box (RichEditCommentProp.MoreButtonCommand v)

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RichEditComment) (prop: RichEditCommentProp) =
        match prop with
        | RichEditCommentProp.Base p -> RichEditElement.apply el p
        | RichEditCommentProp.RootRenderTransform v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditComment.RootRenderTransformProperty, box v)
        | RichEditCommentProp.MoreButtonVisibility v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditComment.MoreButtonVisibilityProperty, box v)
        | RichEditCommentProp.MoreButtonCommand v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditComment.MoreButtonCommandProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RichEditComment>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
