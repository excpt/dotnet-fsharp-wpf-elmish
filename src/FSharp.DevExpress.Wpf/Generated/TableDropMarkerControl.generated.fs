...
type TableDropMarkerControlProp =
    | DragIndicatorPosition of DevExpress.Xpf.Grid.TableDragIndicatorPosition

module TableDropMarkerControl =
    let dragIndicatorPosition v : obj = box (TableDropMarkerControlProp.DragIndicatorPosition v)

    let apply (el: DevExpress.Xpf.Grid.TableDropMarkerControl) (prop: TableDropMarkerControlProp) =
        match prop with
        | TableDropMarkerControlProp.DragIndicatorPosition v -> el.SetValue(DevExpress.Xpf.Grid.TableDropMarkerControl.DragIndicatorPositionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.TableDropMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
