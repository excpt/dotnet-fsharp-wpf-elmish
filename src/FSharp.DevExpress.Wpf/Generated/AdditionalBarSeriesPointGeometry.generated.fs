...
type AdditionalBarSeriesPointGeometryProp =
    | Base of AdditionalSeriesPointGeometryProp

module AdditionalBarSeriesPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalBarSeriesPointGeometry) (prop: AdditionalBarSeriesPointGeometryProp) =
        match prop with
        | AdditionalBarSeriesPointGeometryProp.Base p -> AdditionalSeriesPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalBarSeriesPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
