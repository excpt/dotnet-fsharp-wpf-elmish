...
type BreadcrumbButtonProp =
    | Base of ClickableButtonProp
...
module BreadcrumbButton =
    ...
    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbButton) (prop: BreadcrumbButtonProp) =
        match prop with
        | BreadcrumbButtonProp.Base p -> ClickableButton.apply el p
        | BreadcrumbButtonProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbButton.ContentTemplateProperty, box v)
        | BreadcrumbButtonProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbButton.ContentTemplateSelectorProperty, box v)
        | BreadcrumbButtonProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbButton.CornerRadiusProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
