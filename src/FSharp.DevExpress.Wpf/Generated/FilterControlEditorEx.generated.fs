...
type FilterControlEditorExProp =
    | Base of FilterControlEditorProp
    | ParameterService of DevExpress.DataAccess.Wizard.Services.IParameterService
    | OperandTypeButtonState of obj
    | SelectedParameter of DevExpress.XtraReports.Parameters.Parameter
    | UseCascadeParameters of bool
    | ParametersColumnTemplate of System.Windows.DataTemplate

module FilterControlEditorEx =
    let parameterService v : obj = box (FilterControlEditorExProp.ParameterService v)
    let operandTypeButtonState v : obj = box (FilterControlEditorExProp.OperandTypeButtonState v)
    ...
    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx) (prop: FilterControlEditorExProp) =
        match prop with
        | FilterControlEditorExProp.Base p -> FilterControlEditor.apply el p
        | FilterControlEditorExProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx.ParameterServiceProperty, box v)
        | FilterControlEditorExProp.OperandTypeButtonState v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx.OperandTypeButtonStateProperty, box v)
        | FilterControlEditorExProp.SelectedParameter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx.SelectedParameterProperty, box v)
        | FilterControlEditorExProp.UseCascadeParameters v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx.UseCascadeParametersProperty, box v)
        | FilterControlEditorExProp.ParametersColumnTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx.ParametersColumnTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.FilterControlEditorEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
