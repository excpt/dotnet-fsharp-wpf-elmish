...
type CircularThemeableQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularThemeableQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularThemeableQuarterTopRightModel) (prop: CircularThemeableQuarterTopRightModelProp) =
        match prop with
        | CircularThemeableQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularThemeableQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
