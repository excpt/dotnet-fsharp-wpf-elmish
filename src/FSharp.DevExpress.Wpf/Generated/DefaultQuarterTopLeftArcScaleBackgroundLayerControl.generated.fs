...
type DefaultQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultQuarterTopLeftArcScaleBackgroundLayerControl) (prop: DefaultQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | DefaultQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
