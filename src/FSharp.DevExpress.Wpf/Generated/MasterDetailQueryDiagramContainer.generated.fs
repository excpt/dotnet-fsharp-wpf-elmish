...
type MasterDetailQueryDiagramContainerProp =
    | Base of DiagramContainerProp

module MasterDetailQueryDiagramContainer =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailQueryDiagramContainer) (prop: MasterDetailQueryDiagramContainerProp) =
        match prop with
        | MasterDetailQueryDiagramContainerProp.Base p -> DiagramContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailQueryDiagramContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
