...
type AllDayGroupPanelProp =
    | Base of DayGroupPanelBaseProp
    | CellContainers of obj

module AllDayGroupPanel =
    let cellContainers v : obj = box (AllDayGroupPanelProp.CellContainers v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.AllDayGroupPanel) (prop: AllDayGroupPanelProp) =
        match prop with
        | AllDayGroupPanelProp.Base p -> DayGroupPanelBase.apply el p
        | AllDayGroupPanelProp.CellContainers v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.AllDayGroupPanel.CellContainersProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.AllDayGroupPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
