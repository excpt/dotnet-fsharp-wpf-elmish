...
type CircularFutureThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFutureThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFutureThreeQuartersModel) (prop: CircularFutureThreeQuartersModelProp) =
        match prop with
        | CircularFutureThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFutureThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
