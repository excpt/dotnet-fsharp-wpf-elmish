...
type HeatmapPresentationProp =
    | Geometry of DevExpress.Charts.Heatmap.Native.HeatmapGeometry

module HeatmapPresentation =
    let geometry v : obj = box (HeatmapPresentationProp.Geometry v)

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapPresentation) (prop: HeatmapPresentationProp) =
        match prop with
        | HeatmapPresentationProp.Geometry v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapPresentation.GeometryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
