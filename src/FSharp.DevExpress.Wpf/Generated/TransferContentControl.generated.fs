...
type TransferContentControlProp =
    | IsPreviousContent of bool

module TransferContentControl =
    let isPreviousContent v : obj = box (TransferContentControlProp.IsPreviousContent v)

    let apply (el: DevExpress.Xpf.Core.TransferContentControl) (prop: TransferContentControlProp) =
        match prop with
        | TransferContentControlProp.IsPreviousContent v -> el.SetValue(DevExpress.Xpf.Core.TransferContentControl.IsPreviousContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.TransferContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
