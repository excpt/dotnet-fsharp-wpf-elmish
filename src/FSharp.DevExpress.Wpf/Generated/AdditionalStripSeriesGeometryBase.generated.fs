...
type AdditionalStripSeriesGeometryBaseProp =
    | Base of AdditionalSeriesGeometryBaseProp

module AdditionalStripSeriesGeometryBase =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStripSeriesGeometryBase) (prop: AdditionalStripSeriesGeometryBaseProp) =
        match prop with
        | AdditionalStripSeriesGeometryBaseProp.Base p -> AdditionalSeriesGeometryBase.apply el p
