...
type HorizontalAnimationElementProp =
    | Base of AnimationElementBaseProp

module HorizontalAnimationElement =

    let apply (el: DevExpress.Xpf.Editors.HorizontalAnimationElement) (prop: HorizontalAnimationElementProp) =
        match prop with
        | HorizontalAnimationElementProp.Base p -> AnimationElementBase.apply el p

    let accelerateRatio v : obj = box (AnimationElementBaseProp.AccelerateRatio v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.HorizontalAnimationElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
