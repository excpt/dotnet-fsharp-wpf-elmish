...
type WaterfallSeries2DProp =
    | Base of BarStackedSeries2DProp
    | FallingBarBrush of System.Windows.Media.SolidColorBrush
    | RisingBarBrush of System.Windows.Media.SolidColorBrush
    | Model of obj

module WaterfallSeries2D =
    let fallingBarBrush v : obj = box (WaterfallSeries2DProp.FallingBarBrush v)
    let risingBarBrush v : obj = box (WaterfallSeries2DProp.RisingBarBrush v)
    let model v : obj = box (WaterfallSeries2DProp.Model v)

    let apply (el: DevExpress.Xpf.Charts.WaterfallSeries2D) (prop: WaterfallSeries2DProp) =
        match prop with
        | WaterfallSeries2DProp.Base p -> BarStackedSeries2D.apply el p
        | WaterfallSeries2DProp.FallingBarBrush v -> el.SetValue(DevExpress.Xpf.Charts.WaterfallSeries2D.FallingBarBrushProperty, box v)
        | WaterfallSeries2DProp.RisingBarBrush v -> el.SetValue(DevExpress.Xpf.Charts.WaterfallSeries2D.RisingBarBrushProperty, box v)
        | WaterfallSeries2DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.WaterfallSeries2D.ModelProperty, box v)
    ...
    let startBarBrush (v: System.Windows.Media.SolidColorBrush) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.StartBarBrushProperty, box v)) :: node.Props }
    let subtotalBarBrush (v: System.Windows.Media.SolidColorBrush) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.SubtotalBarBrushProperty, box v)) :: node.Props }
    let totalBarBrush (v: System.Windows.Media.SolidColorBrush) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.TotalBarBrushProperty, box v)) :: node.Props }
    let valueOptions (v: DevExpress.Xpf.Charts.WaterfallValueOptionsBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.ValueOptionsProperty, box v)) :: node.Props }
    let connectorStyle (v: DevExpress.Xpf.Charts.LineStyle) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.ConnectorStyleProperty, box v)) :: node.Props }
    let connectorBrush (v: System.Windows.Media.Brush) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.ConnectorBrushProperty, box v)) :: node.Props }
    let labelPosition (v: DevExpress.Xpf.Charts.WaterfallLabelPosition) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.WaterfallSeries2D.LabelPositionProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.WaterfallSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
