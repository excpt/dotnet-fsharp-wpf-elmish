...
type ContentContainerProp =
    | Base of DXContentPresenterProp
    | ForegroundSolidColor1 of System.Windows.Media.Color
    | ForegroundSolidColor2 of System.Windows.Media.Color
    | ForegroundSolidColor3 of System.Windows.Media.Color
    | ForegroundSolidColor4 of System.Windows.Media.Color
    | ForegroundSolidColor5 of System.Windows.Media.Color
    | ForegroundSolidColor6 of System.Windows.Media.Color

module ContentContainer =
    let foregroundSolidColor1 v : obj = box (ContentContainerProp.ForegroundSolidColor1 v)
    let foregroundSolidColor2 v : obj = box (ContentContainerProp.ForegroundSolidColor2 v)
    let foregroundSolidColor3 v : obj = box (ContentContainerProp.ForegroundSolidColor3 v)
    let foregroundSolidColor4 v : obj = box (ContentContainerProp.ForegroundSolidColor4 v)
    let foregroundSolidColor5 v : obj = box (ContentContainerProp.ForegroundSolidColor5 v)
    let foregroundSolidColor6 v : obj = box (ContentContainerProp.ForegroundSolidColor6 v)

    let apply (el: DevExpress.Xpf.Core.ContentContainer) (prop: ContentContainerProp) =
        match prop with
        | ContentContainerProp.Base p -> DXContentPresenter.apply el p
        | ContentContainerProp.ForegroundSolidColor1 v -> el.SetValue(DevExpress.Xpf.Core.ContentContainer.ForegroundSolidColor1Property, box v)
        | ContentContainerProp.ForegroundSolidColor2 v -> el.SetValue(DevExpress.Xpf.Core.ContentContainer.ForegroundSolidColor2Property, box v)
        | ContentContainerProp.ForegroundSolidColor3 v -> el.SetValue(DevExpress.Xpf.Core.ContentContainer.ForegroundSolidColor3Property, box v)
        | ContentContainerProp.ForegroundSolidColor4 v -> el.SetValue(DevExpress.Xpf.Core.ContentContainer.ForegroundSolidColor4Property, box v)
        | ContentContainerProp.ForegroundSolidColor5 v -> el.SetValue(DevExpress.Xpf.Core.ContentContainer.ForegroundSolidColor5Property, box v)
        | ContentContainerProp.ForegroundSolidColor6 v -> el.SetValue(DevExpress.Xpf.Core.ContentContainer.ForegroundSolidColor6Property, box v)

    let content v : obj = box (DXContentPresenterProp.Content v)
    let contentTemplate v : obj = box (DXContentPresenterProp.ContentTemplate v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ContentContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
