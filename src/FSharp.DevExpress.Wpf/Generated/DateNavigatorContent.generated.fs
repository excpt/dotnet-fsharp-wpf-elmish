...
type DateNavigatorContentProp =
    | ColumnCount of int
    | FocusedDate of System.DateTime
    | State of DevExpress.Xpf.Editors.DateNavigator.DateNavigatorCalendarView
    | RowCount of int

module DateNavigatorContent =
    let columnCount v : obj = box (DateNavigatorContentProp.ColumnCount v)
    let focusedDate v : obj = box (DateNavigatorContentProp.FocusedDate v)
    let state v : obj = box (DateNavigatorContentProp.State v)
    let rowCount v : obj = box (DateNavigatorContentProp.RowCount v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent) (prop: DateNavigatorContentProp) =
        match prop with
        | DateNavigatorContentProp.ColumnCount v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent.ColumnCountProperty, box v)
        | DateNavigatorContentProp.FocusedDate v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent.FocusedDateProperty, box v)
        | DateNavigatorContentProp.State v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent.StateProperty, box v)
        | DateNavigatorContentProp.RowCount v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent.RowCountProperty, box v)
    ...
    let panelOwner (v: DevExpress.Xpf.Editors.DateNavigator.Controls.IDateNavigatorContentPanelOwner) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent.PanelOwnerProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
