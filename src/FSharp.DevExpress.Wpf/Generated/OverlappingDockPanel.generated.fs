...
type OverlappingDockPanelProp =
    | DisplayMode of DevExpress.Xpf.Docking.Base.AutoHideMode

module OverlappingDockPanel =
    let displayMode v : obj = box (OverlappingDockPanelProp.DisplayMode v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.OverlappingDockPanel) (prop: OverlappingDockPanelProp) =
        match prop with
        | OverlappingDockPanelProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.OverlappingDockPanel.DisplayModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.OverlappingDockPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
