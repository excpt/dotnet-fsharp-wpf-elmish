...
type FieldPopupPlaceholderProp =
    | Field of DevExpress.Xpf.PivotGrid.PivotGridField

module FieldPopupPlaceholder =
    let field v : obj = box (FieldPopupPlaceholderProp.Field v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldPopupPlaceholder) (prop: FieldPopupPlaceholderProp) =
        match prop with
        | FieldPopupPlaceholderProp.Field v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldPopupPlaceholder.FieldProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldPopupPlaceholder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
