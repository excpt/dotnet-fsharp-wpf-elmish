...
type FormatAsTableItemLinkControlProp =
    | Base of BarSplitButtonItemLinkControlProp

module FormatAsTableItemLinkControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.FormatAsTableItemLinkControl) (prop: FormatAsTableItemLinkControlProp) =
        match prop with
        | FormatAsTableItemLinkControlProp.Base p -> BarSplitButtonItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.FormatAsTableItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
