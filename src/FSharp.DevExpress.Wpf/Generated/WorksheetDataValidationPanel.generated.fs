...
type WorksheetDataValidationPanelProp =
    | Base of WorksheetPaintPanelProp
    | DataValidationCircleBrush of System.Windows.Media.Brush
    | DataValidationCircleWidth of float
    | DataValidationBackgroundBrush of System.Windows.Media.Brush
    | DataValidationBorderColor of System.Windows.Media.Color
    | DataValidationMessageForeBrush of System.Windows.Media.Brush
    | DataValidationMessageBorderWidth of float
    | DataValidationMessageBorderBrush of System.Windows.Media.Brush
    | DataValidationMessageBackgroudBrush of System.Windows.Media.Brush

module WorksheetDataValidationPanel =
    let dataValidationCircleBrush v : obj = box (WorksheetDataValidationPanelProp.DataValidationCircleBrush v)
    let dataValidationCircleWidth v : obj = box (WorksheetDataValidationPanelProp.DataValidationCircleWidth v)
    let dataValidationBackgroundBrush v : obj = box (WorksheetDataValidationPanelProp.DataValidationBackgroundBrush v)
    let dataValidationBorderColor v : obj = box (WorksheetDataValidationPanelProp.DataValidationBorderColor v)
    let dataValidationMessageForeBrush v : obj = box (WorksheetDataValidationPanelProp.DataValidationMessageForeBrush v)
    let dataValidationMessageBorderWidth v : obj = box (WorksheetDataValidationPanelProp.DataValidationMessageBorderWidth v)
    let dataValidationMessageBorderBrush v : obj = box (WorksheetDataValidationPanelProp.DataValidationMessageBorderBrush v)
    let dataValidationMessageBackgroudBrush v : obj = box (WorksheetDataValidationPanelProp.DataValidationMessageBackgroudBrush v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel) (prop: WorksheetDataValidationPanelProp) =
        match prop with
        | WorksheetDataValidationPanelProp.Base p -> WorksheetPaintPanel.apply el p
        | WorksheetDataValidationPanelProp.DataValidationCircleBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationCircleBrushProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationCircleWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationCircleWidthProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationBackgroundBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationBackgroundBrushProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationBorderColor v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationBorderColorProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationMessageForeBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationMessageForeBrushProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationMessageBorderWidth v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationMessageBorderWidthProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationMessageBorderBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationMessageBorderBrushProperty, box v)
        | WorksheetDataValidationPanelProp.DataValidationMessageBackgroudBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel.DataValidationMessageBackgroudBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetDataValidationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
