...
type BorderCandleStick2DModelControlProp =
    | Base of PredefinedModelControlProp

module BorderCandleStick2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderCandleStick2DModelControl) (prop: BorderCandleStick2DModelControlProp) =
        match prop with
        | BorderCandleStick2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderCandleStick2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
