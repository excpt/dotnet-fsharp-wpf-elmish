...
type ClassicArcScaleLineControlProp =
    | Base of PresentationControlProp

module ClassicArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicArcScaleLineControl) (prop: ClassicArcScaleLineControlProp) =
        match prop with
        | ClassicArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
