...
type CircularClassicQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularClassicQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularClassicQuarterTopRightModel) (prop: CircularClassicQuarterTopRightModelProp) =
        match prop with
        | CircularClassicQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularClassicQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
