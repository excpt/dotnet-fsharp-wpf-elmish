...
type TreemapDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module TreemapDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.TreemapDashboardLayoutItem) (prop: TreemapDashboardLayoutItemProp) =
        match prop with
        | TreemapDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.TreemapDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
