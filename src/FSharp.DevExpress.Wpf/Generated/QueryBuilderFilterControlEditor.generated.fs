...
type QueryBuilderFilterControlEditorProp =
...
module QueryBuilderFilterControlEditor =
    let filtersView v : obj = box (QueryBuilderFilterControlEditorProp.FiltersView v)
    let reportParameterEditorTemplate v : obj = box (QueryBuilderFilterControlEditorProp.ReportParameterEditorTemplate v)
    let queryParameterEditorTemplate v : obj = box (QueryBuilderFilterControlEditorProp.QueryParameterEditorTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControlEditor) (prop: QueryBuilderFilterControlEditorProp) =
        match prop with
        | QueryBuilderFilterControlEditorProp.Base p -> FilterControlEditorEx.apply el p
        | QueryBuilderFilterControlEditorProp.FiltersView v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControlEditor.FiltersViewProperty, box v)
        | QueryBuilderFilterControlEditorProp.ReportParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControlEditor.ReportParameterEditorTemplateProperty, box v)
        | QueryBuilderFilterControlEditorProp.QueryParameterEditorTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControlEditor.QueryParameterEditorTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControlEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
