...
type FloatingLayoutItemsControlProp =
    | Base of LayoutItemsControlProp

module FloatingLayoutItemsControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatingLayoutItemsControl) (prop: FloatingLayoutItemsControlProp) =
        match prop with
        | FloatingLayoutItemsControlProp.Base p -> LayoutItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FloatingLayoutItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
