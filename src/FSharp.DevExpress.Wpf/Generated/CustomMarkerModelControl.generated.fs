...
type CustomMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module CustomMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.CustomMarkerModelControl) (prop: CustomMarkerModelControlProp) =
        match prop with
        | CustomMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.CustomMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
