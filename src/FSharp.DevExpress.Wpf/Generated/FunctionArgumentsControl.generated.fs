...
type FunctionArgumentsControlProp =
    | Base of ReferenceEditBaseControlProp

module FunctionArgumentsControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.FunctionArgumentsControl) (prop: FunctionArgumentsControlProp) =
        match prop with
        | FunctionArgumentsControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.FunctionArgumentsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
