...
type ShapeContentPresenterProp =
    | ShapeStyle of System.Windows.Style
...
module ShapeContentPresenter =
    let shapeStyle v : obj = box (ShapeContentPresenterProp.ShapeStyle v)
    let foreground v : obj = box (ShapeContentPresenterProp.Foreground v)
    let textWrapping v : obj = box (ShapeContentPresenterProp.TextWrapping v)
    let textAlignment v : obj = box (ShapeContentPresenterProp.TextAlignment v)
    let fontFamily v : obj = box (ShapeContentPresenterProp.FontFamily v)
    let fontSize v : obj = box (ShapeContentPresenterProp.FontSize v)
    let accentColor v : obj = box (ShapeContentPresenterProp.AccentColor v)
    let allowAccent v : obj = box (ShapeContentPresenterProp.AllowAccent v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter) (prop: ShapeContentPresenterProp) =
        match prop with
        | ShapeContentPresenterProp.ShapeStyle v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.ShapeStyleProperty, box v)
        | ShapeContentPresenterProp.Foreground v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.ForegroundProperty, box v)
        | ShapeContentPresenterProp.TextWrapping v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.TextWrappingProperty, box v)
        | ShapeContentPresenterProp.TextAlignment v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.TextAlignmentProperty, box v)
        | ShapeContentPresenterProp.FontFamily v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.FontFamilyProperty, box v)
        | ShapeContentPresenterProp.FontSize v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.FontSizeProperty, box v)
        | ShapeContentPresenterProp.AccentColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.AccentColorProperty, box v)
        | ShapeContentPresenterProp.AllowAccent v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter.AllowAccentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.ShapeContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
