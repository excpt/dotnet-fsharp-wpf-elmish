...
type SplineSeries2DProp =
    | Base of LineSeries2DProp
    | SplineAlgorithm of DevExpress.Xpf.Charts.SplineAlgorithm
    | LineTension of float

module SplineSeries2D =
    let splineAlgorithm v : obj = box (SplineSeries2DProp.SplineAlgorithm v)
    let lineTension v : obj = box (SplineSeries2DProp.LineTension v)

    let apply (el: DevExpress.Xpf.Charts.SplineSeries2D) (prop: SplineSeries2DProp) =
        match prop with
        | SplineSeries2DProp.Base p -> LineSeries2D.apply el p
        | SplineSeries2DProp.SplineAlgorithm v -> el.SetValue(DevExpress.Xpf.Charts.SplineSeries2D.SplineAlgorithmProperty, box v)
        | SplineSeries2DProp.LineTension v -> el.SetValue(DevExpress.Xpf.Charts.SplineSeries2D.LineTensionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SplineSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
