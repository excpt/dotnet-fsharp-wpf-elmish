...
type PopupControlContainerInfoProp =
    | Content of System.Windows.UIElement
    | CloseOnClick of bool

module PopupControlContainerInfo =
    let content v : obj = box (PopupControlContainerInfoProp.Content v)
    let closeOnClick v : obj = box (PopupControlContainerInfoProp.CloseOnClick v)

    let apply (el: DevExpress.Xpf.Bars.PopupControlContainerInfo) (prop: PopupControlContainerInfoProp) =
        match prop with
        | PopupControlContainerInfoProp.Content v -> el.SetValue(DevExpress.Xpf.Bars.PopupControlContainerInfo.ContentProperty, box v)
        | PopupControlContainerInfoProp.CloseOnClick v -> el.SetValue(DevExpress.Xpf.Bars.PopupControlContainerInfo.CloseOnClickProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupControlContainerInfo>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
