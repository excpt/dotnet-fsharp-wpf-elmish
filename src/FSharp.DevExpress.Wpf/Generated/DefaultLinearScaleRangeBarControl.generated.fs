...
type DefaultLinearScaleRangeBarControlProp =
    | Base of ValueIndicatorPresentationControlProp

module DefaultLinearScaleRangeBarControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleRangeBarControl) (prop: DefaultLinearScaleRangeBarControlProp) =
        match prop with
        | DefaultLinearScaleRangeBarControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleRangeBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
