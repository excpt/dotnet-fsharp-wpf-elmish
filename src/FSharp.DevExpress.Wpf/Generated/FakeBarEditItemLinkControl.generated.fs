...
type FakeBarEditItemLinkControlProp =
    | Base of BarEditItemLinkControlProp

module FakeBarEditItemLinkControl =

    let apply (el: DevExpress.Xpf.Ribbon.Internal.FakeBarEditItemLinkControl) (prop: FakeBarEditItemLinkControlProp) =
        match prop with
        | FakeBarEditItemLinkControlProp.Base p -> BarEditItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.FakeBarEditItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
