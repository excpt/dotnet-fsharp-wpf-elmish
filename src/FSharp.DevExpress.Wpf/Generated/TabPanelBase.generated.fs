...
type TabPanelBaseProp =
    | Base of DXPanelBaseProp
    | SelectedIndex of int
    | HeaderLocation of DevExpress.Xpf.Core.HeaderLocation
...
module TabPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Core.Native.TabPanelBase) (prop: TabPanelBaseProp) =
        match prop with
        | TabPanelBaseProp.Base p -> DXPanelBase.apply el p
        | TabPanelBaseProp.SelectedIndex v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelBase.SelectedIndexProperty, box v)
        | TabPanelBaseProp.HeaderLocation v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelBase.HeaderLocationProperty, box v)
    ...
    let childMinHeight (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.Native.TabPanelBase.ChildMinHeightProperty, box v)) :: node.Props }
