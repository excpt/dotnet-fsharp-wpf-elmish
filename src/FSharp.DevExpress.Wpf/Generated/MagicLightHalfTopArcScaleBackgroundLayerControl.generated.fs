...
type MagicLightHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightHalfTopArcScaleBackgroundLayerControl) (prop: MagicLightHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | MagicLightHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
