...
type PropertyGridViewProp =
    | Grid of obj
    | SelectedItem of DevExpress.Xpf.PropertyGrid.RowData
    | ShowCategories of DevExpress.Xpf.PropertyGrid.CategoriesShowMode

module PropertyGridView =
    let grid v : obj = box (PropertyGridViewProp.Grid v)
    let selectedItem v : obj = box (PropertyGridViewProp.SelectedItem v)
    let showCategories v : obj = box (PropertyGridViewProp.ShowCategories v)

    let apply (el: DevExpress.Xpf.PropertyGrid.PropertyGridView) (prop: PropertyGridViewProp) =
        match prop with
        | PropertyGridViewProp.Grid v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyGridView.PropertyGridProperty, box v)
        | PropertyGridViewProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyGridView.SelectedItemProperty, box v)
        | PropertyGridViewProp.ShowCategories v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PropertyGridView.ShowCategoriesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PropertyGridView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
