...
type GanttTaskBaselineControlProp =
    | Base of GanttTaskBaselineControlBaseProp

module GanttTaskBaselineControl =

    let apply (el: DevExpress.Xpf.Gantt.GanttTaskBaselineControl) (prop: GanttTaskBaselineControlProp) =
        match prop with
        | GanttTaskBaselineControlProp.Base p -> GanttTaskBaselineControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttTaskBaselineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
