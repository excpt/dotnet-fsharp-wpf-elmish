...
type PdfThumbnailsViewerControlProp =
    | Settings of DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings
    | SelectedPageNumber of int
    | HighlightedPageNumbers of obj
    | ZoomFactor of float
    | PageRotation of System.Windows.Media.Imaging.Rotation

module PdfThumbnailsViewerControl =
    let settings v : obj = box (PdfThumbnailsViewerControlProp.Settings v)
    let selectedPageNumber v : obj = box (PdfThumbnailsViewerControlProp.SelectedPageNumber v)
    let highlightedPageNumbers v : obj = box (PdfThumbnailsViewerControlProp.HighlightedPageNumbers v)
    let zoomFactor v : obj = box (PdfThumbnailsViewerControlProp.ZoomFactor v)
    let pageRotation v : obj = box (PdfThumbnailsViewerControlProp.PageRotation v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl) (prop: PdfThumbnailsViewerControlProp) =
        match prop with
        | PdfThumbnailsViewerControlProp.Settings v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl.SettingsProperty, box v)
        | PdfThumbnailsViewerControlProp.SelectedPageNumber v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl.SelectedPageNumberProperty, box v)
        | PdfThumbnailsViewerControlProp.HighlightedPageNumbers v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl.HighlightedPageNumbersProperty, box v)
        | PdfThumbnailsViewerControlProp.ZoomFactor v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl.ZoomFactorProperty, box v)
        | PdfThumbnailsViewerControlProp.PageRotation v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl.PageRotationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
