...
type PivotComboBoxStyleSettingsProp =
    | Base of CheckedComboBoxStyleSettingsProp

module PivotComboBoxStyleSettings =

    let apply (el: DevExpress.Xpf.PivotGrid.PivotComboBoxStyleSettings) (prop: PivotComboBoxStyleSettingsProp) =
        match prop with
        | PivotComboBoxStyleSettingsProp.Base p -> CheckedComboBoxStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.PivotComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
