...
open System
open System.Windows
open DevExpress.Xpf.Core.ConditionalFormattingManager
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FormatPreviewContainerProp =
    | Base of ManagerContainerBaseProp
    | Format of System.Windows.Freezable

module FormatPreviewContainer =
    let format v : obj = box (FormatPreviewContainerProp.Format v)

    let apply (el: DevExpress.Xpf.Core.ConditionalFormattingManager.FormatPreviewContainer) (prop: FormatPreviewContainerProp) =
        match prop with
        | FormatPreviewContainerProp.Base p -> ManagerContainerBase.apply el p
        | FormatPreviewContainerProp.Format v -> el.SetValue(DevExpress.Xpf.Core.ConditionalFormattingManager.FormatPreviewContainer.FormatProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ConditionalFormattingManager.FormatPreviewContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
