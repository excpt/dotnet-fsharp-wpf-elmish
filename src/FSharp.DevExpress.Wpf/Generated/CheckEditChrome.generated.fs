...
type CheckEditChromeProp =
    | Base of ButtonChrome2Prop
    | CheckSize of System.Windows.Size

module CheckEditChrome =
    let checkSize v : obj = box (CheckEditChromeProp.CheckSize v)

    let apply (el: DevExpress.Xpf.Core.Native.CheckEditChrome) (prop: CheckEditChromeProp) =
        match prop with
        | CheckEditChromeProp.Base p -> ButtonChrome2.apply el p
        | CheckEditChromeProp.CheckSize v -> el.SetValue(DevExpress.Xpf.Core.Native.CheckEditChrome.CheckSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.CheckEditChrome>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
