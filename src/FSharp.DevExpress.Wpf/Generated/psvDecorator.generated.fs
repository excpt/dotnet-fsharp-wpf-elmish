...
module psvDecorator =
    ...
    let apply (el: DevExpress.Xpf.Docking.VisualElements.psvDecorator) (prop: psvDecoratorProp) =
        match prop with
        | psvDecoratorProp.Base p -> psvPanel.apply el p
        | psvDecoratorProp.Child v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.psvDecorator.ChildProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.psvDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
