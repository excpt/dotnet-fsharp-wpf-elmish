...
type CircularIStyleQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularIStyleQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularIStyleQuarterTopLeftModel) (prop: CircularIStyleQuarterTopLeftModelProp) =
        match prop with
        | CircularIStyleQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularIStyleQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
