...
type FloatingPaneWindowProp =
    | Base of WindowContentHolderProp
    | InheritOwnerCommandBindings of bool
    | InheritOwnerInputBindings of bool
    | OverlapTaskbar of bool

module FloatingPaneWindow =
    let inheritOwnerCommandBindings v : obj = box (FloatingPaneWindowProp.InheritOwnerCommandBindings v)
    let inheritOwnerInputBindings v : obj = box (FloatingPaneWindowProp.InheritOwnerInputBindings v)
    let overlapTaskbar v : obj = box (FloatingPaneWindowProp.OverlapTaskbar v)

    let apply (el: DevExpress.Xpf.Docking.Platform.FloatingPaneWindow) (prop: FloatingPaneWindowProp) =
        match prop with
        | FloatingPaneWindowProp.Base p -> WindowContentHolder.apply el p
        | FloatingPaneWindowProp.InheritOwnerCommandBindings v -> el.SetValue(DevExpress.Xpf.Docking.Platform.FloatingPaneWindow.InheritOwnerCommandBindingsProperty, box v)
        | FloatingPaneWindowProp.InheritOwnerInputBindings v -> el.SetValue(DevExpress.Xpf.Docking.Platform.FloatingPaneWindow.InheritOwnerInputBindingsProperty, box v)
        | FloatingPaneWindowProp.OverlapTaskbar v -> el.SetValue(DevExpress.Xpf.Docking.Platform.FloatingPaneWindow.OverlapTaskbarProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.FloatingPaneWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
