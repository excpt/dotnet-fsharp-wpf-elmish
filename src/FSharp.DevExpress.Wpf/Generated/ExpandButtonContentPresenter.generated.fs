...
type ExpandButtonContentPresenterProp =
    | ItemType of DevExpress.Xpf.Accordion.AccordionItemType
    | ItemContent of obj
    | RootItemContent of obj

module ExpandButtonContentPresenter =
    let itemType v : obj = box (ExpandButtonContentPresenterProp.ItemType v)
    let itemContent v : obj = box (ExpandButtonContentPresenterProp.ItemContent v)
    let rootItemContent v : obj = box (ExpandButtonContentPresenterProp.RootItemContent v)

    let apply (el: DevExpress.Xpf.Accordion.ExpandButtonContentPresenter) (prop: ExpandButtonContentPresenterProp) =
        match prop with
        | ExpandButtonContentPresenterProp.ItemType v -> el.SetValue(DevExpress.Xpf.Accordion.ExpandButtonContentPresenter.ItemTypeProperty, box v)
        | ExpandButtonContentPresenterProp.ItemContent v -> el.SetValue(DevExpress.Xpf.Accordion.ExpandButtonContentPresenter.ItemContentProperty, box v)
        | ExpandButtonContentPresenterProp.RootItemContent v -> el.SetValue(DevExpress.Xpf.Accordion.ExpandButtonContentPresenter.RootItemContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.ExpandButtonContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
