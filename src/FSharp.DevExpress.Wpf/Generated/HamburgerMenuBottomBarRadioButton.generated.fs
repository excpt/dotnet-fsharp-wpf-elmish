...
type HamburgerMenuBottomBarRadioButtonProp =
    | Placement of DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarItemPlacement
...
module HamburgerMenuBottomBarRadioButton =
    let placement v : obj = box (HamburgerMenuBottomBarRadioButtonProp.Placement v)
    let compactModeVisibility v : obj = box (HamburgerMenuBottomBarRadioButtonProp.CompactModeVisibility v)
    let glyph v : obj = box (HamburgerMenuBottomBarRadioButtonProp.Glyph v)
    let glyphTemplate v : obj = box (HamburgerMenuBottomBarRadioButtonProp.GlyphTemplate v)
    let glyphWidth v : obj = box (HamburgerMenuBottomBarRadioButtonProp.GlyphWidth v)
    let glyphHeight v : obj = box (HamburgerMenuBottomBarRadioButtonProp.GlyphHeight v)
    let glyphStretch v : obj = box (HamburgerMenuBottomBarRadioButtonProp.GlyphStretch v)
    let allowGlyphTheming v : obj = box (HamburgerMenuBottomBarRadioButtonProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (HamburgerMenuBottomBarRadioButtonProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton) (prop: HamburgerMenuBottomBarRadioButtonProp) =
        match prop with
        | HamburgerMenuBottomBarRadioButtonProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.PlacementProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.CompactModeVisibility v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.CompactModeVisibilityProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.GlyphProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.GlyphTemplateProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.GlyphWidthProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.GlyphHeightProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.GlyphStretchProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.AllowGlyphThemingProperty, box v)
        | HamburgerMenuBottomBarRadioButtonProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarRadioButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
