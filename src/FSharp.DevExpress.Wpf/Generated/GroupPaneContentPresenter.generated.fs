...
type GroupPaneContentPresenterProp =
    | GroupBorderStyle of DevExpress.Xpf.Docking.GroupBorderStyle

module GroupPaneContentPresenter =
    let groupBorderStyle v : obj = box (GroupPaneContentPresenterProp.GroupBorderStyle v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.GroupPaneContentPresenter) (prop: GroupPaneContentPresenterProp) =
        match prop with
        | GroupPaneContentPresenterProp.GroupBorderStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.GroupPaneContentPresenter.GroupBorderStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.GroupPaneContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
