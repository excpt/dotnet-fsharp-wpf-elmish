...
type SmartHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartHalfTopArcScaleBackgroundLayerControl) (prop: SmartHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | SmartHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
