...
type DayCellsDecorationPanelProp =
    | Base of CellsDecorationPanelProp

module DayCellsDecorationPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.DayCellsDecorationPanel) (prop: DayCellsDecorationPanelProp) =
        match prop with
        | DayCellsDecorationPanelProp.Base p -> CellsDecorationPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.DayCellsDecorationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
