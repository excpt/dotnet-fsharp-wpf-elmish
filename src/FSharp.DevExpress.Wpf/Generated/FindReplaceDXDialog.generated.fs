...
type FindReplaceDXDialogProp =
    | Base of ModelessDXDialogProp

module FindReplaceDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.FindReplaceDXDialog) (prop: FindReplaceDXDialogProp) =
        match prop with
        | FindReplaceDXDialogProp.Base p -> ModelessDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.FindReplaceDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
