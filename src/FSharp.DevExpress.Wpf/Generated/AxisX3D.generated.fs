...
module AxisX3D =
    let dateTimeScaleOptions v : obj = box (AxisX3DProp.DateTimeScaleOptions v)
    let timeSpanScaleOptions v : obj = box (AxisX3DProp.TimeSpanScaleOptions v)
    let numericScaleOptions v : obj = box (AxisX3DProp.NumericScaleOptions v)
    let qualitativeScaleOptions v : obj = box (AxisX3DProp.QualitativeScaleOptions v)

    let apply (el: DevExpress.Xpf.Charts.AxisX3D) (prop: AxisX3DProp) =
        match prop with
        | AxisX3DProp.Base p -> Axis3D.apply el p
        | AxisX3DProp.DateTimeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.AxisX3D.DateTimeScaleOptionsProperty, box v)
        | AxisX3DProp.TimeSpanScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.AxisX3D.TimeSpanScaleOptionsProperty, box v)
        | AxisX3DProp.NumericScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.AxisX3D.NumericScaleOptionsProperty, box v)
        | AxisX3DProp.QualitativeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.AxisX3D.QualitativeScaleOptionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisX3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
