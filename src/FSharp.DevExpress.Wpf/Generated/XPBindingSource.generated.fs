...
type XPBindingSourceProp =
    | Base of XPDataSourceBaseProp

module XPBindingSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.XPBindingSource) (prop: XPBindingSourceProp) =
        match prop with
        | XPBindingSourceProp.Base p -> XPDataSourceBase.apply el p
