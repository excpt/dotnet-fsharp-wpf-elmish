...
type AppBarPanelProp =
    | Alignment of DevExpress.Xpf.WindowsUI.AppBarAlignment

module AppBarPanel =
    let alignment v : obj = box (AppBarPanelProp.Alignment v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.AppBarPanel) (prop: AppBarPanelProp) =
        match prop with
        | AppBarPanelProp.Alignment v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.AppBarPanel.AlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.AppBarPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
