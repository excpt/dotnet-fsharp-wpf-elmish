...
type AreaStackedSeries2DProp =
    | Base of SegmentSeries2DBaseProp
    | Transparency of float
    | PointAnimation of DevExpress.Xpf.Charts.AreaStacked2DFadeInAnimation
    | SeriesAnimation of DevExpress.Xpf.Charts.Area2DAnimationBase
    | Border of DevExpress.Xpf.Charts.SeriesBorder

module AreaStackedSeries2D =
    let transparency v : obj = box (AreaStackedSeries2DProp.Transparency v)
    let pointAnimation v : obj = box (AreaStackedSeries2DProp.PointAnimation v)
    let seriesAnimation v : obj = box (AreaStackedSeries2DProp.SeriesAnimation v)
    let border v : obj = box (AreaStackedSeries2DProp.Border v)

    let apply (el: DevExpress.Xpf.Charts.AreaStackedSeries2D) (prop: AreaStackedSeries2DProp) =
        match prop with
        | AreaStackedSeries2DProp.Base p -> SegmentSeries2DBase.apply el p
        | AreaStackedSeries2DProp.Transparency v -> el.SetValue(DevExpress.Xpf.Charts.AreaStackedSeries2D.TransparencyProperty, box v)
        | AreaStackedSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.AreaStackedSeries2D.PointAnimationProperty, box v)
        | AreaStackedSeries2DProp.SeriesAnimation v -> el.SetValue(DevExpress.Xpf.Charts.AreaStackedSeries2D.SeriesAnimationProperty, box v)
        | AreaStackedSeries2DProp.Border v -> el.SetValue(DevExpress.Xpf.Charts.AreaStackedSeries2D.BorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
