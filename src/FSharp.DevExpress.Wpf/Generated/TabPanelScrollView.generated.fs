...
type TabPanelScrollViewProp =
    | Base of TabPanelScrollViewBaseProp
    | AllowAnimation of bool
    | TransparencySize of int

module TabPanelScrollView =
    let allowAnimation v : obj = box (TabPanelScrollViewProp.AllowAnimation v)
    let transparencySize v : obj = box (TabPanelScrollViewProp.TransparencySize v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelScrollView) (prop: TabPanelScrollViewProp) =
        match prop with
        | TabPanelScrollViewProp.Base p -> TabPanelScrollViewBase.apply el p
        | TabPanelScrollViewProp.AllowAnimation v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelScrollView.AllowAnimationProperty, box v)
        | TabPanelScrollViewProp.TransparencySize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelScrollView.TransparencySizeProperty, box v)

    let isStretchedHorizontally v : obj = box (TabPanelScrollViewBaseProp.IsStretchedHorizontally v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabPanelScrollView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
