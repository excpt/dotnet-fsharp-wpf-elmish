...
type FlatDarkLinearScaleLevelBarBackgroundControlProp =
    | Base of PresentationControlProp

module FlatDarkLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkLinearScaleLevelBarBackgroundControl) (prop: FlatDarkLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | FlatDarkLinearScaleLevelBarBackgroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
