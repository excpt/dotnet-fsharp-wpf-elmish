...
type ScaleElementInfoContainerProp =
    | ElementInfo of DevExpress.Xpf.Gauges.ScaleElementInfoBase

module ScaleElementInfoContainer =
    let elementInfo v : obj = box (ScaleElementInfoContainerProp.ElementInfo v)

    let apply (el: DevExpress.Xpf.Gauges.ScaleElementInfoContainer) (prop: ScaleElementInfoContainerProp) =
        match prop with
        | ScaleElementInfoContainerProp.ElementInfo v -> el.SetValue(DevExpress.Xpf.Gauges.ScaleElementInfoContainer.ElementInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ScaleElementInfoContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
