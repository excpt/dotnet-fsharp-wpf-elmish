...
type TreeViewDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module TreeViewDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.TreeViewDashboardLayoutItem) (prop: TreeViewDashboardLayoutItemProp) =
        match prop with
        | TreeViewDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let treeListViewStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.TreeViewDashboardLayoutItem.TreeListViewStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.DashboardWpf.TreeViewDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
