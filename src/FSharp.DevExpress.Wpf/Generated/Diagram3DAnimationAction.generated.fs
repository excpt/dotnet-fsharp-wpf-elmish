...
type Diagram3DAnimationActionProp =
    | Base of ChartElementProp

module Diagram3DAnimationAction =

    let apply (el: DevExpress.Xpf.Charts.Diagram3DAnimationAction) (prop: Diagram3DAnimationActionProp) =
        match prop with
        | Diagram3DAnimationActionProp.Base p -> ChartElement.apply el p
