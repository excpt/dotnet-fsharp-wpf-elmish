...
type AnnotationProp =
    | Base of ChartNotificationElementProp
    | Content of obj
    | ContentTemplate of System.Windows.DataTemplate
    | Visible of bool
    | AnchorPoint of DevExpress.Xpf.Charts.AnnotationAnchorPoint
    | ShapePosition of DevExpress.Xpf.Charts.AnnotationShapePosition
    | LabelMode of bool
    | Angle of float
    | RuntimeAnchoring of bool
    | RuntimeMoving of bool
    | RuntimeResizing of bool
    | RuntimeRotation of bool
    | BorderStyle of DevExpress.Xpf.Charts.LineStyle
    | Margin of System.Windows.Thickness
    | RuntimeDeletion of bool

module Annotation =
    let content v : obj = box (AnnotationProp.Content v)
    let contentTemplate v : obj = box (AnnotationProp.ContentTemplate v)
    let visible v : obj = box (AnnotationProp.Visible v)
    let anchorPoint v : obj = box (AnnotationProp.AnchorPoint v)
    let shapePosition v : obj = box (AnnotationProp.ShapePosition v)
    let labelMode v : obj = box (AnnotationProp.LabelMode v)
    let angle v : obj = box (AnnotationProp.Angle v)
    let runtimeAnchoring v : obj = box (AnnotationProp.RuntimeAnchoring v)
    let runtimeMoving v : obj = box (AnnotationProp.RuntimeMoving v)
    let runtimeResizing v : obj = box (AnnotationProp.RuntimeResizing v)
    let runtimeRotation v : obj = box (AnnotationProp.RuntimeRotation v)
    let borderStyle v : obj = box (AnnotationProp.BorderStyle v)
    let margin v : obj = box (AnnotationProp.Margin v)
    let runtimeDeletion v : obj = box (AnnotationProp.RuntimeDeletion v)

    let apply (el: DevExpress.Xpf.Charts.Annotation) (prop: AnnotationProp) =
        match prop with
        | AnnotationProp.Base p -> ChartNotificationElement.apply el p
        | AnnotationProp.Content v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.ContentProperty, box v)
        | AnnotationProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.ContentTemplateProperty, box v)
        | AnnotationProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.VisibleProperty, box v)
        | AnnotationProp.AnchorPoint v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.AnchorPointProperty, box v)
        | AnnotationProp.ShapePosition v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.ShapePositionProperty, box v)
        | AnnotationProp.LabelMode v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.LabelModeProperty, box v)
        | AnnotationProp.Angle v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.AngleProperty, box v)
        | AnnotationProp.RuntimeAnchoring v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.RuntimeAnchoringProperty, box v)
        | AnnotationProp.RuntimeMoving v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.RuntimeMovingProperty, box v)
        | AnnotationProp.RuntimeResizing v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.RuntimeResizingProperty, box v)
        | AnnotationProp.RuntimeRotation v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.RuntimeRotationProperty, box v)
        | AnnotationProp.BorderStyle v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.BorderStyleProperty, box v)
        | AnnotationProp.Margin v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.MarginProperty, box v)
        | AnnotationProp.RuntimeDeletion v -> el.SetValue(DevExpress.Xpf.Charts.Annotation.RuntimeDeletionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Annotation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
