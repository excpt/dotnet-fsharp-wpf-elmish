...
type ConnectorSegmentAdornerProp =
    | Segment of DevExpress.Diagram.Core.BrokenLineSegment
    | Connector of DevExpress.Diagram.Core.IDiagramConnector

module ConnectorSegmentAdorner =
    let segment v : obj = box (ConnectorSegmentAdornerProp.Segment v)
    let connector v : obj = box (ConnectorSegmentAdornerProp.Connector v)

    let apply (el: DevExpress.Xpf.Diagram.ConnectorSegmentAdorner) (prop: ConnectorSegmentAdornerProp) =
        match prop with
        | ConnectorSegmentAdornerProp.Segment v -> el.SetValue(DevExpress.Xpf.Diagram.ConnectorSegmentAdorner.SegmentProperty, box v)
        | ConnectorSegmentAdornerProp.Connector v -> el.SetValue(DevExpress.Xpf.Diagram.ConnectorSegmentAdorner.ConnectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ConnectorSegmentAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
