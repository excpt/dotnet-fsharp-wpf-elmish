...
type PredefinedPie2DModelControlProp =
    | Base of PredefinedModelControlProp

module PredefinedPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.PredefinedPie2DModelControl) (prop: PredefinedPie2DModelControlProp) =
        match prop with
        | PredefinedPie2DModelControlProp.Base p -> PredefinedModelControl.apply el p
