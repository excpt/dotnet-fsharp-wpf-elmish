...
type AppointmentBorderBaseProp =
    | Base of CalculatedBorderBaseProp
    | ViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentViewInfo

module AppointmentBorderBase =
    let viewInfo v : obj = box (AppointmentBorderBaseProp.ViewInfo v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentBorderBase) (prop: AppointmentBorderBaseProp) =
        match prop with
        | AppointmentBorderBaseProp.Base p -> CalculatedBorderBase.apply el p
        | AppointmentBorderBaseProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentBorderBase.ViewInfoProperty, box v)
