...
type DesignTimeTabbedImagePickerMainViewProp =
    | Base of ThemedWindowProp

module DesignTimeTabbedImagePickerMainView =

    let apply (el: DevExpress.Xpf.Core.Native.DesignTimeTabbedImagePickerMainView) (prop: DesignTimeTabbedImagePickerMainViewProp) =
        match prop with
        | DesignTimeTabbedImagePickerMainViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DesignTimeTabbedImagePickerMainView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
