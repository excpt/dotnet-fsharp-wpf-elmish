...
type DXTabbedWindowHeaderDecoratorProp =
    | TabbedWindowMode of DevExpress.Xpf.Core.TabbedWindowMode

module DXTabbedWindowHeaderDecorator =
    let tabbedWindowMode v : obj = box (DXTabbedWindowHeaderDecoratorProp.TabbedWindowMode v)

    let apply (el: DevExpress.Xpf.Core.Native.DXTabbedWindowHeaderDecorator) (prop: DXTabbedWindowHeaderDecoratorProp) =
        match prop with
        | DXTabbedWindowHeaderDecoratorProp.TabbedWindowMode v -> el.SetValue(DevExpress.Xpf.Core.Native.DXTabbedWindowHeaderDecorator.TabbedWindowModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DXTabbedWindowHeaderDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
