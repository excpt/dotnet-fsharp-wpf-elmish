...
type DefaultArcScaleRangeControlProp =
    | Base of PresentationControlProp

module DefaultArcScaleRangeControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultArcScaleRangeControl) (prop: DefaultArcScaleRangeControlProp) =
        match prop with
        | DefaultArcScaleRangeControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultArcScaleRangeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
