...
type NameManagerControlProp =
    | Base of ReferenceEditBaseControlProp

module NameManagerControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.NameManagerControl) (prop: NameManagerControlProp) =
        match prop with
        | NameManagerControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.NameManagerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
