...
type BaseFloatingContainerProp =
    | FloatLocation of System.Windows.Point
    | FloatSize of System.Windows.Size
    | IsOpen of bool
    | Content of obj
    | ContainerTemplate of System.Windows.DataTemplate
    | ShowContentOnly of bool
    | Owner of System.Windows.FrameworkElement

module BaseFloatingContainer =
    ...
    let apply (el: DevExpress.Xpf.Core.BaseFloatingContainer) (prop: BaseFloatingContainerProp) =
        match prop with
        | BaseFloatingContainerProp.FloatLocation v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.FloatLocationProperty, box v)
        | BaseFloatingContainerProp.FloatSize v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.FloatSizeProperty, box v)
        | BaseFloatingContainerProp.IsOpen v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.IsOpenProperty, box v)
        | BaseFloatingContainerProp.Content v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.ContentProperty, box v)
        | BaseFloatingContainerProp.ContainerTemplate v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.ContainerTemplateProperty, box v)
        | BaseFloatingContainerProp.ShowContentOnly v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.ShowContentOnlyProperty, box v)
        | BaseFloatingContainerProp.Owner v -> el.SetValue(DevExpress.Xpf.Core.BaseFloatingContainer.OwnerProperty, box v)
