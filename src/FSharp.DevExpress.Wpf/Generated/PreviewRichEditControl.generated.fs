...
type PreviewRichEditControlProp =
    | Base of RichEditControlProp
    | Controller of DevExpress.XtraRichEdit.Forms.TableStyleFormControllerBase

module PreviewRichEditControl =
    let controller v : obj = box (PreviewRichEditControlProp.Controller v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.PreviewRichEditControl) (prop: PreviewRichEditControlProp) =
        match prop with
        | PreviewRichEditControlProp.Base p -> RichEditControl.apply el p
        | PreviewRichEditControlProp.Controller v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.PreviewRichEditControl.ControllerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.PreviewRichEditControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
