...
type PentagonMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module PentagonMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.PentagonMarkerModelControl) (prop: PentagonMarkerModelControlProp) =
        match prop with
        | PentagonMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.PentagonMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
