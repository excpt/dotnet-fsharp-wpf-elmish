...
type OverlayPresentationControlProp =
    | Content of obj

module OverlayPresentationControl =
    let content v : obj = box (OverlayPresentationControlProp.Content v)

    let apply (el: DevExpress.Xpf.Map.OverlayPresentationControl) (prop: OverlayPresentationControlProp) =
        match prop with
        | OverlayPresentationControlProp.Content v -> el.SetValue(DevExpress.Xpf.Map.OverlayPresentationControl.ContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.OverlayPresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
