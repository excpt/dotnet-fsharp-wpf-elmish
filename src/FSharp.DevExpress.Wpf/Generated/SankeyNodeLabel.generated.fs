...
type SankeyNodeLabelProp =
    | ContentTemplate of System.Windows.DataTemplate
    | TextOrientation of DevExpress.Xpf.Charts.TextOrientation

module SankeyNodeLabel =
    let contentTemplate v : obj = box (SankeyNodeLabelProp.ContentTemplate v)
    let textOrientation v : obj = box (SankeyNodeLabelProp.TextOrientation v)

    let apply (el: DevExpress.Xpf.Charts.Sankey.SankeyNodeLabel) (prop: SankeyNodeLabelProp) =
        match prop with
        | SankeyNodeLabelProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyNodeLabel.ContentTemplateProperty, box v)
        | SankeyNodeLabelProp.TextOrientation v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyNodeLabel.TextOrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.SankeyNodeLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
