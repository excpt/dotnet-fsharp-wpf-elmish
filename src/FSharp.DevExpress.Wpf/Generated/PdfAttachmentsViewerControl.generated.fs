...
type PdfAttachmentsViewerControlProp =
    | Settings of DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerSettings
    | HideAfterUse of bool

module PdfAttachmentsViewerControl =
    let settings v : obj = box (PdfAttachmentsViewerControlProp.Settings v)
    let hideAfterUse v : obj = box (PdfAttachmentsViewerControlProp.HideAfterUse v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerControl) (prop: PdfAttachmentsViewerControlProp) =
        match prop with
        | PdfAttachmentsViewerControlProp.Settings v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerControl.SettingsProperty, box v)
        | PdfAttachmentsViewerControlProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerControl.HideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfAttachmentsViewerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
