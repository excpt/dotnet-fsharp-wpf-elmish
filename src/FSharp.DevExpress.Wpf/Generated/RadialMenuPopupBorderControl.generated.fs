...
type RadialMenuPopupBorderControlProp =
    | Base of BarPopupBorderControlProp

module RadialMenuPopupBorderControl =

    let apply (el: DevExpress.Xpf.Bars.RadialMenuPopupBorderControl) (prop: RadialMenuPopupBorderControlProp) =
        match prop with
        | RadialMenuPopupBorderControlProp.Base p -> BarPopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.RadialMenuPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
