...
type ThemeableMajorTickmarkControlProp =
    | Base of ThemeableTickmarkControlProp

module ThemeableMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableMajorTickmarkControl) (prop: ThemeableMajorTickmarkControlProp) =
        match prop with
        | ThemeableMajorTickmarkControlProp.Base p -> ThemeableTickmarkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
