...
type NestedDonut2DGroupPresentationProp =
    | Base of ChartElementBaseProp

module NestedDonut2DGroupPresentation =

    let apply (el: DevExpress.Xpf.Charts.NestedDonut2DGroupPresentation) (prop: NestedDonut2DGroupPresentationProp) =
        match prop with
        | NestedDonut2DGroupPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.NestedDonut2DGroupPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
