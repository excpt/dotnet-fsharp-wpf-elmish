...
type PixelSnapperProp =
    | Base of PixelSnapperBaseProp

module PixelSnapper =

    let apply (el: DevExpress.Xpf.Core.PixelSnapper) (prop: PixelSnapperProp) =
        match prop with
        | PixelSnapperProp.Base p -> PixelSnapperBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PixelSnapper>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
