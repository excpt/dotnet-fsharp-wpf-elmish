...
type NavPaneExpandButtonProp =
    | Base of ExpandButtonBaseProp

module NavPaneExpandButton =

    let apply (el: DevExpress.Xpf.NavBar.NavPaneExpandButton) (prop: NavPaneExpandButtonProp) =
        match prop with
        | NavPaneExpandButtonProp.Base p -> ExpandButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneExpandButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
