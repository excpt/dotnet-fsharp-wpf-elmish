...
type HeatmapCellMarkerRenderControlProp =
    | Base of RectangleMarkerRenderControlProp

module HeatmapCellMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapCellMarkerRenderControl) (prop: HeatmapCellMarkerRenderControlProp) =
        match prop with
        | HeatmapCellMarkerRenderControlProp.Base p -> RectangleMarkerRenderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapCellMarkerRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
