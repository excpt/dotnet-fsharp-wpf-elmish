...
type AppointmentImagesControlProp =
    | Orientation of System.Windows.Controls.Orientation
    | ReminderImage of System.Windows.Media.Imaging.BitmapImage
    | ShouldShowReminderImage of bool
    | RecurrenceImage of System.Windows.Media.Imaging.BitmapImage
    | ShouldShowRecurrenceImage of bool
    | ChangedRecurrenceImage of System.Windows.Media.Imaging.BitmapImage
    | ShouldShowChangedRecurrenceImage of bool
    | ViewInfo of DevExpress.Xpf.Scheduler.Drawing.VisualAppointmentViewInfo

module AppointmentImagesControl =
    let orientation v : obj = box (AppointmentImagesControlProp.Orientation v)
    let reminderImage v : obj = box (AppointmentImagesControlProp.ReminderImage v)
    let shouldShowReminderImage v : obj = box (AppointmentImagesControlProp.ShouldShowReminderImage v)
    let recurrenceImage v : obj = box (AppointmentImagesControlProp.RecurrenceImage v)
    let shouldShowRecurrenceImage v : obj = box (AppointmentImagesControlProp.ShouldShowRecurrenceImage v)
    let changedRecurrenceImage v : obj = box (AppointmentImagesControlProp.ChangedRecurrenceImage v)
    let shouldShowChangedRecurrenceImage v : obj = box (AppointmentImagesControlProp.ShouldShowChangedRecurrenceImage v)
    let viewInfo v : obj = box (AppointmentImagesControlProp.ViewInfo v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl) (prop: AppointmentImagesControlProp) =
        match prop with
        | AppointmentImagesControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.OrientationProperty, box v)
        | AppointmentImagesControlProp.ReminderImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.ReminderImageProperty, box v)
        | AppointmentImagesControlProp.ShouldShowReminderImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.ShouldShowReminderImageProperty, box v)
        | AppointmentImagesControlProp.RecurrenceImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.RecurrenceImageProperty, box v)
        | AppointmentImagesControlProp.ShouldShowRecurrenceImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.ShouldShowRecurrenceImageProperty, box v)
        | AppointmentImagesControlProp.ChangedRecurrenceImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.ChangedRecurrenceImageProperty, box v)
        | AppointmentImagesControlProp.ShouldShowChangedRecurrenceImage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.ShouldShowChangedRecurrenceImageProperty, box v)
        | AppointmentImagesControlProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl.ViewInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentImagesControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
