...
type CircularDefaultFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularDefaultFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularDefaultFullModel) (prop: CircularDefaultFullModelProp) =
        match prop with
        | CircularDefaultFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularDefaultFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
