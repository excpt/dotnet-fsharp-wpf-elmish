...
type PageControlPanelProp =
    | PageWrapper of DevExpress.Xpf.DocumentViewer.PageWrapper

module PageControlPanel =
    let pageWrapper v : obj = box (PageControlPanelProp.PageWrapper v)

    let apply (el: DevExpress.Xpf.DocumentViewer.PageControlPanel) (prop: PageControlPanelProp) =
        match prop with
        | PageControlPanelProp.PageWrapper v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControlPanel.PageWrapperProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.PageControlPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
