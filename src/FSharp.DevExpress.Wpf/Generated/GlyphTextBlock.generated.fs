...
open System
open System.Windows
open DevExpress.XtraRichEdit.Drawing
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type GlyphTextBlockProp =
    | Base of UIElementProp

module GlyphTextBlock =

    let apply (el: DevExpress.XtraRichEdit.Drawing.GlyphTextBlock) (prop: GlyphTextBlockProp) =
        match prop with
        | GlyphTextBlockProp.Base p -> UIElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.Drawing.GlyphTextBlock>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
