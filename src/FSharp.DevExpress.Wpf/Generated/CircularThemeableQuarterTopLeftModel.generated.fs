...
type CircularThemeableQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularThemeableQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularThemeableQuarterTopLeftModel) (prop: CircularThemeableQuarterTopLeftModelProp) =
        match prop with
        | CircularThemeableQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularThemeableQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
