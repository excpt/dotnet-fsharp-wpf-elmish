...
type DayViewControlBaseProp =
    | Base of SchedulerViewControlBaseProp
    | View of DevExpress.Xpf.Scheduling.DayViewBase
    | VisualData of DevExpress.Xpf.Scheduling.VisualData.DayViewVisualDataBase
    | BorderTemplate of System.Windows.DataTemplate
    | TimeMarkerStyle of System.Windows.Style
    | AllDayAreaSeparatorTemplate of System.Windows.DataTemplate
    | GroupSeparatorTemplate of System.Windows.DataTemplate
    | DateHeaderSeparatorTemplate of System.Windows.DataTemplate
    | ResourceHeaderSeparatorTemplate of System.Windows.DataTemplate
    | TimeRulerHeaderSeparatorTemplate of System.Windows.DataTemplate
    | AppointmentsContainerStyle of System.Windows.Style
    | AllDayAppointmentsContainerStyle of System.Windows.Style
    | DragAppointmentsContainerStyle of System.Windows.Style
    | AllDayDragAppointmentsContainerStyle of System.Windows.Style
    | AllDayAreaCornerTemplate of System.Windows.DataTemplate
    | DateHeadersCornerTemplate of System.Windows.DataTemplate
    | ResourceHeadersCornerTemplate of System.Windows.DataTemplate
    | HeaderAreaSeparatorTemplate of System.Windows.DataTemplate

module DayViewControlBase =
    let view v : obj = box (DayViewControlBaseProp.View v)
    let visualData v : obj = box (DayViewControlBaseProp.VisualData v)
    let borderTemplate v : obj = box (DayViewControlBaseProp.BorderTemplate v)
    let timeMarkerStyle v : obj = box (DayViewControlBaseProp.TimeMarkerStyle v)
    let allDayAreaSeparatorTemplate v : obj = box (DayViewControlBaseProp.AllDayAreaSeparatorTemplate v)
    let groupSeparatorTemplate v : obj = box (DayViewControlBaseProp.GroupSeparatorTemplate v)
    let dateHeaderSeparatorTemplate v : obj = box (DayViewControlBaseProp.DateHeaderSeparatorTemplate v)
    let resourceHeaderSeparatorTemplate v : obj = box (DayViewControlBaseProp.ResourceHeaderSeparatorTemplate v)
    let timeRulerHeaderSeparatorTemplate v : obj = box (DayViewControlBaseProp.TimeRulerHeaderSeparatorTemplate v)
    let appointmentsContainerStyle v : obj = box (DayViewControlBaseProp.AppointmentsContainerStyle v)
    let allDayAppointmentsContainerStyle v : obj = box (DayViewControlBaseProp.AllDayAppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (DayViewControlBaseProp.DragAppointmentsContainerStyle v)
    let allDayDragAppointmentsContainerStyle v : obj = box (DayViewControlBaseProp.AllDayDragAppointmentsContainerStyle v)
    let allDayAreaCornerTemplate v : obj = box (DayViewControlBaseProp.AllDayAreaCornerTemplate v)
    let dateHeadersCornerTemplate v : obj = box (DayViewControlBaseProp.DateHeadersCornerTemplate v)
    let resourceHeadersCornerTemplate v : obj = box (DayViewControlBaseProp.ResourceHeadersCornerTemplate v)
    let headerAreaSeparatorTemplate v : obj = box (DayViewControlBaseProp.HeaderAreaSeparatorTemplate v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DayViewControlBase) (prop: DayViewControlBaseProp) =
        match prop with
        | DayViewControlBaseProp.Base p -> SchedulerViewControlBase.apply el p
        | DayViewControlBaseProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.ViewProperty, box v)
        | DayViewControlBaseProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.VisualDataProperty, box v)
        | DayViewControlBaseProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.BorderTemplateProperty, box v)
        | DayViewControlBaseProp.TimeMarkerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.TimeMarkerStyleProperty, box v)
        | DayViewControlBaseProp.AllDayAreaSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.AllDayAreaSeparatorTemplateProperty, box v)
        | DayViewControlBaseProp.GroupSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.GroupSeparatorTemplateProperty, box v)
        | DayViewControlBaseProp.DateHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.DateHeaderSeparatorTemplateProperty, box v)
        | DayViewControlBaseProp.ResourceHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.ResourceHeaderSeparatorTemplateProperty, box v)
        | DayViewControlBaseProp.TimeRulerHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.TimeRulerHeaderSeparatorTemplateProperty, box v)
        | DayViewControlBaseProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.AppointmentsContainerStyleProperty, box v)
        | DayViewControlBaseProp.AllDayAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.AllDayAppointmentsContainerStyleProperty, box v)
        | DayViewControlBaseProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.DragAppointmentsContainerStyleProperty, box v)
        | DayViewControlBaseProp.AllDayDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.AllDayDragAppointmentsContainerStyleProperty, box v)
        | DayViewControlBaseProp.AllDayAreaCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.AllDayAreaCornerTemplateProperty, box v)
        | DayViewControlBaseProp.DateHeadersCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.DateHeadersCornerTemplateProperty, box v)
        | DayViewControlBaseProp.ResourceHeadersCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.ResourceHeadersCornerTemplateProperty, box v)
        | DayViewControlBaseProp.HeaderAreaSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DayViewControlBase.HeaderAreaSeparatorTemplateProperty, box v)
