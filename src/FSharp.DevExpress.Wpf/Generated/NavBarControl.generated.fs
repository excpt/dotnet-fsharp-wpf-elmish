...
type NavBarControlProp =
    | View of DevExpress.Xpf.NavBar.NavBarViewBase
    | ActiveGroup of DevExpress.Xpf.NavBar.NavBarGroup
    | AllowSelectItem of bool
    | AllowSelectDisabledItem of bool
    | EachGroupHasSelectedItem of bool
    | SelectedItems of System.Collections.IEnumerable
    | SelectedItem of obj
    | ItemsSource of System.Collections.IEnumerable
    | GroupDescription of string
    | SelectedGroup of obj
...
module NavBarControl =
    let view v : obj = box (NavBarControlProp.View v)
    let activeGroup v : obj = box (NavBarControlProp.ActiveGroup v)
    let allowSelectItem v : obj = box (NavBarControlProp.AllowSelectItem v)
    let allowSelectDisabledItem v : obj = box (NavBarControlProp.AllowSelectDisabledItem v)
    let eachGroupHasSelectedItem v : obj = box (NavBarControlProp.EachGroupHasSelectedItem v)
    let selectedItems v : obj = box (NavBarControlProp.SelectedItems v)
    let selectedItem v : obj = box (NavBarControlProp.SelectedItem v)
    let itemsSource v : obj = box (NavBarControlProp.ItemsSource v)
    let groupDescription v : obj = box (NavBarControlProp.GroupDescription v)
    let selectedGroup v : obj = box (NavBarControlProp.SelectedGroup v)
    let itemTemplateSelector v : obj = box (NavBarControlProp.ItemTemplateSelector v)
    let itemStyle v : obj = box (NavBarControlProp.ItemStyle v)
    let itemTemplate v : obj = box (NavBarControlProp.ItemTemplate v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarControl) (prop: NavBarControlProp) =
        match prop with
        | NavBarControlProp.View v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.ViewProperty, box v)
        | NavBarControlProp.ActiveGroup v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.ActiveGroupProperty, box v)
        | NavBarControlProp.AllowSelectItem v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.AllowSelectItemProperty, box v)
        | NavBarControlProp.AllowSelectDisabledItem v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.AllowSelectDisabledItemProperty, box v)
        | NavBarControlProp.EachGroupHasSelectedItem v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.EachGroupHasSelectedItemProperty, box v)
        | NavBarControlProp.SelectedItems v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.SelectedItemsProperty, box v)
        | NavBarControlProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.SelectedItemProperty, box v)
        | NavBarControlProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.ItemsSourceProperty, box v)
        | NavBarControlProp.GroupDescription v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.GroupDescriptionProperty, box v)
        | NavBarControlProp.SelectedGroup v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.SelectedGroupProperty, box v)
        | NavBarControlProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.ItemTemplateSelectorProperty, box v)
        | NavBarControlProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.ItemStyleProperty, box v)
        | NavBarControlProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarControl.ItemTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
