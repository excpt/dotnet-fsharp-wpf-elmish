...
type SeriesLabelConnectorPresentationProp =
    | Base of ChartElementBaseProp

module SeriesLabelConnectorPresentation =

    let apply (el: DevExpress.Xpf.Charts.SeriesLabelConnectorPresentation) (prop: SeriesLabelConnectorPresentationProp) =
        match prop with
        | SeriesLabelConnectorPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesLabelConnectorPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
