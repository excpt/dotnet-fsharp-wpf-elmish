...
type SmartQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartQuarterTopRightArcScaleBackgroundLayerControl) (prop: SmartQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | SmartQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
