...
type OneMonthByDateResourceHeadersContainersPanelProp =
    | MainPanel of DevExpress.Xpf.Scheduling.Panels.IMainPanel
    | WeekCount of int

module OneMonthByDateResourceHeadersContainersPanel =
    let mainPanel v : obj = box (OneMonthByDateResourceHeadersContainersPanelProp.MainPanel v)
    let weekCount v : obj = box (OneMonthByDateResourceHeadersContainersPanelProp.WeekCount v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthByDateResourceHeadersContainersPanel) (prop: OneMonthByDateResourceHeadersContainersPanelProp) =
        match prop with
        | OneMonthByDateResourceHeadersContainersPanelProp.MainPanel v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthByDateResourceHeadersContainersPanel.MainPanelProperty, box v)
        | OneMonthByDateResourceHeadersContainersPanelProp.WeekCount v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.OneMonthByDateResourceHeadersContainersPanel.WeekCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthByDateResourceHeadersContainersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
