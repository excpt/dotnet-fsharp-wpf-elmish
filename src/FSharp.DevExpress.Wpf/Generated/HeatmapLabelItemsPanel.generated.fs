...
type HeatmapLabelItemsPanelProp =
    | Geometry of DevExpress.Charts.Heatmap.Native.HeatmapGeometry

module HeatmapLabelItemsPanel =
    let geometry v : obj = box (HeatmapLabelItemsPanelProp.Geometry v)

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapLabelItemsPanel) (prop: HeatmapLabelItemsPanelProp) =
        match prop with
        | HeatmapLabelItemsPanelProp.Geometry v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapLabelItemsPanel.GeometryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapLabelItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
