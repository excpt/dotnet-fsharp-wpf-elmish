...
type VisualTimelineSelectionBarCellProp =
    | Base of VisualSingleTimelineCellProp

module VisualTimelineSelectionBarCell =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimelineSelectionBarCell) (prop: VisualTimelineSelectionBarCellProp) =
        match prop with
        | VisualTimelineSelectionBarCellProp.Base p -> VisualSingleTimelineCell.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualTimelineSelectionBarCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
