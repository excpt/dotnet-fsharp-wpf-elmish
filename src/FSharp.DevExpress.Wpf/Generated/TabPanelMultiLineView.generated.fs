...
type TabPanelMultiLineViewProp =
    | Base of TabPanelMultiLineViewBaseProp
    | IsHoldMode of bool
    | AutoEnableHoldModeWhenManyRows of bool

module TabPanelMultiLineView =
    let isHoldMode v : obj = box (TabPanelMultiLineViewProp.IsHoldMode v)
    let autoEnableHoldModeWhenManyRows v : obj = box (TabPanelMultiLineViewProp.AutoEnableHoldModeWhenManyRows v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelMultiLineView) (prop: TabPanelMultiLineViewProp) =
        match prop with
        | TabPanelMultiLineViewProp.Base p -> TabPanelMultiLineViewBase.apply el p
        | TabPanelMultiLineViewProp.IsHoldMode v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelMultiLineView.IsHoldModeProperty, box v)
        | TabPanelMultiLineViewProp.AutoEnableHoldModeWhenManyRows v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelMultiLineView.AutoEnableHoldModeWhenManyRowsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabPanelMultiLineView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
