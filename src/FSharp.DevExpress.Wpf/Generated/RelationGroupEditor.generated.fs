...
type RelationGroupEditorProp =
    | RelationGroup of DevExpress.Xpf.DataAccess.Native.Editors.RelationGroup

module RelationGroupEditor =
    let relationGroup v : obj = box (RelationGroupEditorProp.RelationGroup v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.RelationGroupEditor) (prop: RelationGroupEditorProp) =
        match prop with
        | RelationGroupEditorProp.RelationGroup v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.RelationGroupEditor.RelationGroupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.RelationGroupEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
