...
type HamburgerMenuItemsPanelProp =
    | Base of HamburgerMenuItemsPanelBaseProp
    | MediateBorderCommand of System.Windows.Input.ICommand

module HamburgerMenuItemsPanel =
    let mediateBorderCommand v : obj = box (HamburgerMenuItemsPanelProp.MediateBorderCommand v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuItemsPanel) (prop: HamburgerMenuItemsPanelProp) =
        match prop with
        | HamburgerMenuItemsPanelProp.Base p -> HamburgerMenuItemsPanelBase.apply el p
        | HamburgerMenuItemsPanelProp.MediateBorderCommand v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuItemsPanel.MediateBorderCommandProperty, box v)

    let showSpecialElements v : obj = box (HamburgerMenuItemsPanelBaseProp.ShowSpecialElements v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
