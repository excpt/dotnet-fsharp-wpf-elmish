...
type AreaSparklineStyleSettingsProp =
    | Base of LineSparklineStyleSettingsProp
    | AreaOpacity of float

module AreaSparklineStyleSettings =
    let areaOpacity v : obj = box (AreaSparklineStyleSettingsProp.AreaOpacity v)

    let apply (el: DevExpress.Xpf.Editors.AreaSparklineStyleSettings) (prop: AreaSparklineStyleSettingsProp) =
        match prop with
        | AreaSparklineStyleSettingsProp.Base p -> LineSparklineStyleSettings.apply el p
        | AreaSparklineStyleSettingsProp.AreaOpacity v -> el.SetValue(DevExpress.Xpf.Editors.AreaSparklineStyleSettings.AreaOpacityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.AreaSparklineStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
