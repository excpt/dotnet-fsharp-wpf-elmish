...
type EmptyDetailRowControlProp =
    | Base of DetailRowControlBaseProp

module EmptyDetailRowControl =

    let apply (el: DevExpress.Xpf.Grid.EmptyDetailRowControl) (prop: EmptyDetailRowControlProp) =
        match prop with
        | EmptyDetailRowControlProp.Base p -> DetailRowControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.EmptyDetailRowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
