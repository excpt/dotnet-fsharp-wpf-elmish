...
type GridCachedItemsControlProp =
    | Base of CachedItemsControlProp

module GridCachedItemsControl =

    let apply (el: DevExpress.Xpf.Grid.GridCachedItemsControl) (prop: GridCachedItemsControlProp) =
        match prop with
        | GridCachedItemsControlProp.Base p -> CachedItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.GridCachedItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
