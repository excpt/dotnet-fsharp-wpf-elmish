...
type RibbonStatusBarRightPartControlProp =
    | Base of RibbonStatusBarPartControlBaseProp

module RibbonStatusBarRightPartControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonStatusBarRightPartControl) (prop: RibbonStatusBarRightPartControlProp) =
        match prop with
        | RibbonStatusBarRightPartControlProp.Base p -> RibbonStatusBarPartControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonStatusBarRightPartControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
