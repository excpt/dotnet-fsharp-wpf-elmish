...
type OutlineDXDialogProp =
    | Base of CustomDXDialogProp

module OutlineDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.OutlineDXDialog) (prop: OutlineDXDialogProp) =
        match prop with
        | OutlineDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.OutlineDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
