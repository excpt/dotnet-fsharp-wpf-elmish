...
type ThemeableLinearScaleLevelBarBackgroundControlProp =
    | Base of ThemeableLinearScaleLevelBarControlProp

module ThemeableLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableLinearScaleLevelBarBackgroundControl) (prop: ThemeableLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | ThemeableLinearScaleLevelBarBackgroundControlProp.Base p -> ThemeableLinearScaleLevelBarControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
