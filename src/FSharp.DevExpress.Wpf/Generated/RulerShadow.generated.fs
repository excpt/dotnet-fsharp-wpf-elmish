...
type RulerShadowProp =
    | Stroke of System.Windows.Media.Brush
    | StrokeDashArray of System.Windows.Media.DoubleCollection

module RulerShadow =
    let stroke v : obj = box (RulerShadowProp.Stroke v)
    let strokeDashArray v : obj = box (RulerShadowProp.StrokeDashArray v)

    let apply (el: DevExpress.Xpf.Diagram.RulerShadow) (prop: RulerShadowProp) =
        match prop with
        | RulerShadowProp.Stroke v -> el.SetValue(DevExpress.Xpf.Diagram.RulerShadow.StrokeProperty, box v)
        | RulerShadowProp.StrokeDashArray v -> el.SetValue(DevExpress.Xpf.Diagram.RulerShadow.StrokeDashArrayProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.RulerShadow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
