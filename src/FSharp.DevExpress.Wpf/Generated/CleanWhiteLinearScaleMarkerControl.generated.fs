...
type CleanWhiteLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CleanWhiteLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteLinearScaleMarkerControl) (prop: CleanWhiteLinearScaleMarkerControlProp) =
        match prop with
        | CleanWhiteLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
