...
type FileDialogBottomPaneProp =
    | Caption of string
    | Text of string
    | FiltersSource of obj
    | SelectedFilterIndex of int
    | FilterDisplayMember of string
    | AcceptButtonName of string
    | CancelButtonName of string

module FileDialogBottomPane =
    let caption v : obj = box (FileDialogBottomPaneProp.Caption v)
    let text v : obj = box (FileDialogBottomPaneProp.Text v)
    let filtersSource v : obj = box (FileDialogBottomPaneProp.FiltersSource v)
    let selectedFilterIndex v : obj = box (FileDialogBottomPaneProp.SelectedFilterIndex v)
    let filterDisplayMember v : obj = box (FileDialogBottomPaneProp.FilterDisplayMember v)
    let acceptButtonName v : obj = box (FileDialogBottomPaneProp.AcceptButtonName v)
    let cancelButtonName v : obj = box (FileDialogBottomPaneProp.CancelButtonName v)

    let apply (el: DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane) (prop: FileDialogBottomPaneProp) =
        match prop with
        | FileDialogBottomPaneProp.Caption v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.CaptionProperty, box v)
        | FileDialogBottomPaneProp.Text v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.TextProperty, box v)
        | FileDialogBottomPaneProp.FiltersSource v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.FiltersSourceProperty, box v)
        | FileDialogBottomPaneProp.SelectedFilterIndex v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.SelectedFilterIndexProperty, box v)
        | FileDialogBottomPaneProp.FilterDisplayMember v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.FilterDisplayMemberProperty, box v)
        | FileDialogBottomPaneProp.AcceptButtonName v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.AcceptButtonNameProperty, box v)
        | FileDialogBottomPaneProp.CancelButtonName v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane.CancelButtonNameProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.FileDialogBottomPane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
