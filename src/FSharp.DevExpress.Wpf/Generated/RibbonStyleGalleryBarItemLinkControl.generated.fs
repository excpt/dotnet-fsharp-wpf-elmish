...
type RibbonStyleGalleryBarItemLinkControlProp =
    | Base of RibbonGalleryBarItemLinkControlProp

module RibbonStyleGalleryBarItemLinkControl =

    let apply (el: DevExpress.Xpf.RichEdit.UI.RibbonStyleGalleryBarItemLinkControl) (prop: RibbonStyleGalleryBarItemLinkControlProp) =
        match prop with
        | RibbonStyleGalleryBarItemLinkControlProp.Base p -> RibbonGalleryBarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.RibbonStyleGalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
