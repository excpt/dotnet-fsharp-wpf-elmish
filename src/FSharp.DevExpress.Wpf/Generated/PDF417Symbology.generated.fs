...
module PDF417Symbology =
    let columns v : obj = box (PDF417SymbologyProp.Columns v)
    let compactionMode v : obj = box (PDF417SymbologyProp.CompactionMode v)
    let errorCorrectionLevel v : obj = box (PDF417SymbologyProp.ErrorCorrectionLevel v)
    let rows v : obj = box (PDF417SymbologyProp.Rows v)
    let truncateSymbol v : obj = box (PDF417SymbologyProp.TruncateSymbol v)
    let yToXRatio v : obj = box (PDF417SymbologyProp.YToXRatio v)

    let apply (el: DevExpress.Xpf.Controls.PDF417Symbology) (prop: PDF417SymbologyProp) =
        match prop with
        | PDF417SymbologyProp.Columns v -> el.SetValue(DevExpress.Xpf.Controls.PDF417Symbology.ColumnsProperty, box v)
        | PDF417SymbologyProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Controls.PDF417Symbology.CompactionModeProperty, box v)
        | PDF417SymbologyProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Controls.PDF417Symbology.ErrorCorrectionLevelProperty, box v)
        | PDF417SymbologyProp.Rows v -> el.SetValue(DevExpress.Xpf.Controls.PDF417Symbology.RowsProperty, box v)
        | PDF417SymbologyProp.TruncateSymbol v -> el.SetValue(DevExpress.Xpf.Controls.PDF417Symbology.TruncateSymbolProperty, box v)
        | PDF417SymbologyProp.YToXRatio v -> el.SetValue(DevExpress.Xpf.Controls.PDF417Symbology.YToXRatioProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.PDF417Symbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
