...
type SelectionPartAdornerProp =
    | Base of SelectionPartAdornerBaseProp

module SelectionPartAdorner =

    let apply (el: DevExpress.Xpf.Diagram.SelectionPartAdorner) (prop: SelectionPartAdornerProp) =
        match prop with
        | SelectionPartAdornerProp.Base p -> SelectionPartAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.SelectionPartAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
