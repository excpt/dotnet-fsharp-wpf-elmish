...
type EnhancedPrintPreviewRibbonWindowProp =
    | Base of ThemedWindowProp

module EnhancedPrintPreviewRibbonWindow =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.EnhancedPrintPreviewRibbonWindow) (prop: EnhancedPrintPreviewRibbonWindowProp) =
        match prop with
        | EnhancedPrintPreviewRibbonWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.EnhancedPrintPreviewRibbonWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
