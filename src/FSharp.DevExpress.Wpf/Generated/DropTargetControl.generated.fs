...
type DropTargetControlProp =
    | Command of System.Windows.Input.ICommand

module DropTargetControl =
    let command v : obj = box (DropTargetControlProp.Command v)

    let apply (el: DevExpress.Xpf.Charts.DropTargetControl) (prop: DropTargetControlProp) =
        match prop with
        | DropTargetControlProp.Command v -> el.SetValue(DevExpress.Xpf.Charts.DropTargetControl.CommandProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.DropTargetControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
