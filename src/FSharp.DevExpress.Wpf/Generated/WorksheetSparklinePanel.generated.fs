...
type WorksheetSparklinePanelProp =
    | Base of WorksheetPaintPanelProp

module WorksheetSparklinePanel =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetSparklinePanel) (prop: WorksheetSparklinePanelProp) =
        match prop with
        | WorksheetSparklinePanelProp.Base p -> WorksheetPaintPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetSparklinePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
