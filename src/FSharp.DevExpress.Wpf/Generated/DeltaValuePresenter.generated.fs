...
open System
open System.Windows
open DevExpress.DashboardWpf.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DeltaValuePresenterProp =
    | BadForeground of System.Windows.Media.Brush
    | GoodForeground of System.Windows.Media.Brush
    | IndicatorType of DevExpress.DashboardWpf.Internal.IndicatorType
    | IsGood of bool
    | ShowValue of bool
    | Value of obj
    | WarningForeground of System.Windows.Media.Brush
    | NeutralForeground of System.Windows.Media.Brush

module DeltaValuePresenter =
    let badForeground v : obj = box (DeltaValuePresenterProp.BadForeground v)
    let goodForeground v : obj = box (DeltaValuePresenterProp.GoodForeground v)
    let indicatorType v : obj = box (DeltaValuePresenterProp.IndicatorType v)
    let isGood v : obj = box (DeltaValuePresenterProp.IsGood v)
    let showValue v : obj = box (DeltaValuePresenterProp.ShowValue v)
    let value v : obj = box (DeltaValuePresenterProp.Value v)
    let warningForeground v : obj = box (DeltaValuePresenterProp.WarningForeground v)
    let neutralForeground v : obj = box (DeltaValuePresenterProp.NeutralForeground v)

    let apply (el: DevExpress.DashboardWpf.Internal.DeltaValuePresenter) (prop: DeltaValuePresenterProp) =
        match prop with
        | DeltaValuePresenterProp.BadForeground v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.BadForegroundProperty, box v)
        | DeltaValuePresenterProp.GoodForeground v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.GoodForegroundProperty, box v)
        | DeltaValuePresenterProp.IndicatorType v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.IndicatorTypeProperty, box v)
        | DeltaValuePresenterProp.IsGood v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.IsGoodProperty, box v)
        | DeltaValuePresenterProp.ShowValue v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.ShowValueProperty, box v)
        | DeltaValuePresenterProp.Value v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.ValueProperty, box v)
        | DeltaValuePresenterProp.WarningForeground v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.WarningForegroundProperty, box v)
        | DeltaValuePresenterProp.NeutralForeground v -> el.SetValue(DevExpress.DashboardWpf.Internal.DeltaValuePresenter.NeutralForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.DeltaValuePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
