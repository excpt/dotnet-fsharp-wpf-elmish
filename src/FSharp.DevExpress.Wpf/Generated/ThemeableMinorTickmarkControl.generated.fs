...
type ThemeableMinorTickmarkControlProp =
    | Base of ThemeableTickmarkControlProp

module ThemeableMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableMinorTickmarkControl) (prop: ThemeableMinorTickmarkControlProp) =
        match prop with
        | ThemeableMinorTickmarkControlProp.Base p -> ThemeableTickmarkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
