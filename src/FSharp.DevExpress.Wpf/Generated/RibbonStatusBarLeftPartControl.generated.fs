...
type RibbonStatusBarLeftPartControlProp =
    | Base of RibbonStatusBarPartControlBaseProp

module RibbonStatusBarLeftPartControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonStatusBarLeftPartControl) (prop: RibbonStatusBarLeftPartControlProp) =
        match prop with
        | RibbonStatusBarLeftPartControlProp.Base p -> RibbonStatusBarPartControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonStatusBarLeftPartControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
