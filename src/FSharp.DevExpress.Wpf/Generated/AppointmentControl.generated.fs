...
type AppointmentControlProp =
    | Base of AppointmentControlBaseProp
    | EditTemplate of System.Windows.DataTemplate
    ...
    | SelectionBorderBrush of System.Windows.Media.Brush
    | SelectionBorderThickness of System.Windows.Thickness
    | LeftArrowTextStringFormat of string
    | RightArrowTextStringFormat of string
    | ImageBoxTemplate of System.Windows.DataTemplate

module AppointmentControl =
    let editTemplate v : obj = box (AppointmentControlProp.EditTemplate v)
    let background v : obj = box (AppointmentControlProp.Background v)
    let borderBrush v : obj = box (AppointmentControlProp.BorderBrush v)
    let borderThickness v : obj = box (AppointmentControlProp.BorderThickness v)
    let selectionBorderBrush v : obj = box (AppointmentControlProp.SelectionBorderBrush v)
    let selectionBorderThickness v : obj = box (AppointmentControlProp.SelectionBorderThickness v)
    let leftArrowTextStringFormat v : obj = box (AppointmentControlProp.LeftArrowTextStringFormat v)
    let rightArrowTextStringFormat v : obj = box (AppointmentControlProp.RightArrowTextStringFormat v)
    let imageBoxTemplate v : obj = box (AppointmentControlProp.ImageBoxTemplate v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentControl) (prop: AppointmentControlProp) =
        match prop with
        | AppointmentControlProp.Base p -> AppointmentControlBase.apply el p
        | AppointmentControlProp.EditTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.EditTemplateProperty, box v)
        | AppointmentControlProp.Background v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.BackgroundProperty, box v)
        | AppointmentControlProp.BorderBrush v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.BorderBrushProperty, box v)
        | AppointmentControlProp.BorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.BorderThicknessProperty, box v)
        | AppointmentControlProp.SelectionBorderBrush v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.SelectionBorderBrushProperty, box v)
        | AppointmentControlProp.SelectionBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.SelectionBorderThicknessProperty, box v)
        | AppointmentControlProp.LeftArrowTextStringFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.LeftArrowTextStringFormatProperty, box v)
        | AppointmentControlProp.RightArrowTextStringFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.RightArrowTextStringFormatProperty, box v)
        | AppointmentControlProp.ImageBoxTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentControl.ImageBoxTemplateProperty, box v)
