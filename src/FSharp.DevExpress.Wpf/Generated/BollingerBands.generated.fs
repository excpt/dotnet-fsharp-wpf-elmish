...
type BollingerBandsProp =
    | Base of IndicatorProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel
    | PointsCount of int
    | StandardDeviationMultiplier of float

module BollingerBands =
    let valueLevel v : obj = box (BollingerBandsProp.ValueLevel v)
    let pointsCount v : obj = box (BollingerBandsProp.PointsCount v)
    let standardDeviationMultiplier v : obj = box (BollingerBandsProp.StandardDeviationMultiplier v)

    let apply (el: DevExpress.Xpf.Charts.BollingerBands) (prop: BollingerBandsProp) =
        match prop with
        | BollingerBandsProp.Base p -> Indicator.apply el p
        | BollingerBandsProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.BollingerBands.ValueLevelProperty, box v)
        | BollingerBandsProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.BollingerBands.PointsCountProperty, box v)
        | BollingerBandsProp.StandardDeviationMultiplier v -> el.SetValue(DevExpress.Xpf.Charts.BollingerBands.StandardDeviationMultiplierProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BollingerBands>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
