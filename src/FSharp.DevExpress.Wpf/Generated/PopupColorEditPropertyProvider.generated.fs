...
type PopupColorEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp

module PopupColorEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.PopupColorEditPropertyProvider) (prop: PopupColorEditPropertyProviderProp) =
        match prop with
        | PopupColorEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupColorEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
