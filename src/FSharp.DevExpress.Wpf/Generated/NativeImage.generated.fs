...
type NativeImageProp =
    | Renderer of DevExpress.Xpf.Editors.INativeImageRenderer

module NativeImage =
    let renderer v : obj = box (NativeImageProp.Renderer v)

    let apply (el: DevExpress.Xpf.Editors.NativeImage) (prop: NativeImageProp) =
        match prop with
        | NativeImageProp.Renderer v -> el.SetValue(DevExpress.Xpf.Editors.NativeImage.RendererProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.NativeImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
