...
type TileNavPaneItemsControlProp =
    | Base of veItemsControlProp

module TileNavPaneItemsControl =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileNavPaneItemsControl) (prop: TileNavPaneItemsControlProp) =
        match prop with
        | TileNavPaneItemsControlProp.Base p -> veItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileNavPaneItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
