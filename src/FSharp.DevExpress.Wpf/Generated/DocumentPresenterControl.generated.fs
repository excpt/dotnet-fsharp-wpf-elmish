...
type DocumentPresenterControlProp =
    | Base of DocumentPresenterControlProp
    | HighlightSelectionColor of System.Windows.Media.Color
    | Pages of obj
    | IsSearchControlVisible of bool

module DocumentPresenterControl =
    let highlightSelectionColor v : obj = box (DocumentPresenterControlProp.HighlightSelectionColor v)
    let pages v : obj = box (DocumentPresenterControlProp.Pages v)
    let isSearchControlVisible v : obj = box (DocumentPresenterControlProp.IsSearchControlVisible v)

    let apply (el: DevExpress.Xpf.Printing.DocumentPresenterControl) (prop: DocumentPresenterControlProp) =
        match prop with
        | DocumentPresenterControlProp.Base p -> DocumentPresenterControl.apply el p
        | DocumentPresenterControlProp.HighlightSelectionColor v -> el.SetValue(DevExpress.Xpf.Printing.DocumentPresenterControl.HighlightSelectionColorProperty, box v)
        | DocumentPresenterControlProp.Pages v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentPresenterControl.PagesProperty, box v)
        | DocumentPresenterControlProp.IsSearchControlVisible v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentPresenterControl.IsSearchControlVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.DocumentPresenterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
