...
type FutureLinearScaleLineControlProp =
    | Base of PresentationControlProp

module FutureLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureLinearScaleLineControl) (prop: FutureLinearScaleLineControlProp) =
        match prop with
        | FutureLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
