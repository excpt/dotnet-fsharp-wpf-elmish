...
type HorizontalTimeIndicatorContainerProp =
    | Intervals of DevExpress.Xpf.Scheduler.Drawing.VisualSimpleResourceIntervalCollection
...
module HorizontalTimeIndicatorContainer =
    let intervals v : obj = box (HorizontalTimeIndicatorContainerProp.Intervals v)
    let timeIndicatorVisibility v : obj = box (HorizontalTimeIndicatorContainerProp.TimeIndicatorVisibility v)
    let view v : obj = box (HorizontalTimeIndicatorContainerProp.View v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalTimeIndicatorContainer) (prop: HorizontalTimeIndicatorContainerProp) =
        match prop with
        | HorizontalTimeIndicatorContainerProp.Intervals v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalTimeIndicatorContainer.IntervalsProperty, box v)
        | HorizontalTimeIndicatorContainerProp.TimeIndicatorVisibility v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalTimeIndicatorContainer.TimeIndicatorVisibilityProperty, box v)
        | HorizontalTimeIndicatorContainerProp.View v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalTimeIndicatorContainer.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HorizontalTimeIndicatorContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
