...
type LinearCleanWhiteModelProp =
    | Base of LinearGaugeModelProp

module LinearCleanWhiteModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearCleanWhiteModel) (prop: LinearCleanWhiteModelProp) =
        match prop with
        | LinearCleanWhiteModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearCleanWhiteModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
