...
type AreaStepSeries2DProp =
    | Base of AreaSeries2DProp
    | SnapCrosshairToActualStep of bool
    | InvertedStep of bool

module AreaStepSeries2D =
    let snapCrosshairToActualStep v : obj = box (AreaStepSeries2DProp.SnapCrosshairToActualStep v)
    let invertedStep v : obj = box (AreaStepSeries2DProp.InvertedStep v)

    let apply (el: DevExpress.Xpf.Charts.AreaStepSeries2D) (prop: AreaStepSeries2DProp) =
        match prop with
        | AreaStepSeries2DProp.Base p -> AreaSeries2D.apply el p
        | AreaStepSeries2DProp.SnapCrosshairToActualStep v -> el.SetValue(DevExpress.Xpf.Charts.AreaStepSeries2D.SnapCrosshairToActualStepProperty, box v)
        | AreaStepSeries2DProp.InvertedStep v -> el.SetValue(DevExpress.Xpf.Charts.AreaStepSeries2D.InvertedStepProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaStepSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
