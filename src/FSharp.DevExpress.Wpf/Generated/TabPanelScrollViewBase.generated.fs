...
type TabPanelScrollViewBaseProp =
    | Base of TabPanelBaseProp
    | IsStretchedHorizontally of bool

module TabPanelScrollViewBase =
    let isStretchedHorizontally v : obj = box (TabPanelScrollViewBaseProp.IsStretchedHorizontally v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelScrollViewBase) (prop: TabPanelScrollViewBaseProp) =
        match prop with
        | TabPanelScrollViewBaseProp.Base p -> TabPanelBase.apply el p
        | TabPanelScrollViewBaseProp.IsStretchedHorizontally v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelScrollViewBase.IsStretchedHorizontallyProperty, box v)
