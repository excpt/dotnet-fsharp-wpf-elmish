...
type BarSubItemLinkControlProp =
    | Base of BarButtonItemLinkControlProp
    | ShowContentInArrow of bool
    | ActualArrowAlignment of System.Windows.Controls.Dock

module BarSubItemLinkControl =
    let showContentInArrow v : obj = box (BarSubItemLinkControlProp.ShowContentInArrow v)
    let actualArrowAlignment v : obj = box (BarSubItemLinkControlProp.ActualArrowAlignment v)

    let apply (el: DevExpress.Xpf.Bars.BarSubItemLinkControl) (prop: BarSubItemLinkControlProp) =
        match prop with
        | BarSubItemLinkControlProp.Base p -> BarButtonItemLinkControl.apply el p
        | BarSubItemLinkControlProp.ShowContentInArrow v -> el.SetValue(DevExpress.Xpf.Bars.BarSubItemLinkControl.ShowContentInArrowProperty, box v)
        | BarSubItemLinkControlProp.ActualArrowAlignment v -> el.SetValue(DevExpress.Xpf.Bars.BarSubItemLinkControl.ActualArrowAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarSubItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
