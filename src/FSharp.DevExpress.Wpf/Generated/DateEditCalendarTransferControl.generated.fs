...
type DateEditCalendarTransferControlProp =
    | Base of TransferControlProp
    | TransferType of DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarTransferType
    | AnimationTime of float

module DateEditCalendarTransferControl =
    let transferType v : obj = box (DateEditCalendarTransferControlProp.TransferType v)
    let animationTime v : obj = box (DateEditCalendarTransferControlProp.AnimationTime v)

    let apply (el: DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarTransferControl) (prop: DateEditCalendarTransferControlProp) =
        match prop with
        | DateEditCalendarTransferControlProp.Base p -> TransferControl.apply el p
        | DateEditCalendarTransferControlProp.TransferType v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarTransferControl.TransferTypeProperty, box v)
        | DateEditCalendarTransferControlProp.AnimationTime v -> el.SetValue(DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarTransferControl.AnimationTimeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.Calendar.DateEditCalendarTransferControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
