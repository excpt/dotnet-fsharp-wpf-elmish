...
type AxisElementTitleBaseProp =
    | Base of TitleBaseProp

module AxisElementTitleBase =

    let apply (el: DevExpress.Xpf.Charts.AxisElementTitleBase) (prop: AxisElementTitleBaseProp) =
        match prop with
        | AxisElementTitleBaseProp.Base p -> TitleBase.apply el p
