...
type DateNavigatorCalendarCellButtonProp =
    | CalendarView of DevExpress.Xpf.Editors.DateNavigator.DateNavigatorCalendarView
    | Appearance of DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCellButtonAppearance

module DateNavigatorCalendarCellButton =
    let calendarView v : obj = box (DateNavigatorCalendarCellButtonProp.CalendarView v)
    let appearance v : obj = box (DateNavigatorCalendarCellButtonProp.Appearance v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButton) (prop: DateNavigatorCalendarCellButtonProp) =
        match prop with
        | DateNavigatorCalendarCellButtonProp.CalendarView v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButton.CalendarViewProperty, box v)
        | DateNavigatorCalendarCellButtonProp.Appearance v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButton.AppearanceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarCellButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
