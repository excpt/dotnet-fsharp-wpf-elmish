...
type PieTotalLabelProp =
    | Base of ChartElementProp
    | TextPattern of string
    | Content of obj
    | ContentTemplate of System.Windows.DataTemplate

module PieTotalLabel =
    let textPattern v : obj = box (PieTotalLabelProp.TextPattern v)
    let content v : obj = box (PieTotalLabelProp.Content v)
    let contentTemplate v : obj = box (PieTotalLabelProp.ContentTemplate v)

    let apply (el: DevExpress.Xpf.Charts.PieTotalLabel) (prop: PieTotalLabelProp) =
        match prop with
        | PieTotalLabelProp.Base p -> ChartElement.apply el p
        | PieTotalLabelProp.TextPattern v -> el.SetValue(DevExpress.Xpf.Charts.PieTotalLabel.TextPatternProperty, box v)
        | PieTotalLabelProp.Content v -> el.SetValue(DevExpress.Xpf.Charts.PieTotalLabel.ContentProperty, box v)
        | PieTotalLabelProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Charts.PieTotalLabel.ContentTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PieTotalLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
