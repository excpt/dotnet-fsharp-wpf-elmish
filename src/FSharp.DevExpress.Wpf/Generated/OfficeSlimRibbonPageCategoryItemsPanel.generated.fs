...
type OfficeSlimRibbonPageCategoryItemsPanelProp =
    | Base of RibbonPageCategoryItemsPanelProp

module OfficeSlimRibbonPageCategoryItemsPanel =

    let apply (el: DevExpress.Xpf.Ribbon.OfficeSlimRibbonPageCategoryItemsPanel) (prop: OfficeSlimRibbonPageCategoryItemsPanelProp) =
        match prop with
        | OfficeSlimRibbonPageCategoryItemsPanelProp.Base p -> RibbonPageCategoryItemsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.OfficeSlimRibbonPageCategoryItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
