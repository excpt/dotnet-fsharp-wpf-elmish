...
type PreviewScrollViewerProp =
    | Base of DXScrollViewerProp

module PreviewScrollViewer =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.PreviewScrollViewer) (prop: PreviewScrollViewerProp) =
        match prop with
        | PreviewScrollViewerProp.Base p -> DXScrollViewer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.PreviewScrollViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
