...
type LayoutControlAvailableItemsControlProp =
    | Base of ControlBaseProp
    | AvailableItems of DevExpress.Xpf.Core.FrameworkElements
    | IsListOpen of bool
    | LayoutGroupItemTemplate of System.Windows.DataTemplate
    | NewItemsInfo of DevExpress.Xpf.LayoutControl.LayoutControlNewItemsInfo
    | NewItemsUIVisibility of System.Windows.Visibility

module LayoutControlAvailableItemsControl =
    let availableItems v : obj = box (LayoutControlAvailableItemsControlProp.AvailableItems v)
    let isListOpen v : obj = box (LayoutControlAvailableItemsControlProp.IsListOpen v)
    let layoutGroupItemTemplate v : obj = box (LayoutControlAvailableItemsControlProp.LayoutGroupItemTemplate v)
    let newItemsInfo v : obj = box (LayoutControlAvailableItemsControlProp.NewItemsInfo v)
    let newItemsUIVisibility v : obj = box (LayoutControlAvailableItemsControlProp.NewItemsUIVisibility v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl) (prop: LayoutControlAvailableItemsControlProp) =
        match prop with
        | LayoutControlAvailableItemsControlProp.Base p -> ControlBase.apply el p
        | LayoutControlAvailableItemsControlProp.AvailableItems v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl.AvailableItemsProperty, box v)
        | LayoutControlAvailableItemsControlProp.IsListOpen v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl.IsListOpenProperty, box v)
        | LayoutControlAvailableItemsControlProp.LayoutGroupItemTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl.LayoutGroupItemTemplateProperty, box v)
        | LayoutControlAvailableItemsControlProp.NewItemsInfo v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl.NewItemsInfoProperty, box v)
        | LayoutControlAvailableItemsControlProp.NewItemsUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl.NewItemsUIVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutControlAvailableItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
