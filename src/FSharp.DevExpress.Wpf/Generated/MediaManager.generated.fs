...
type MediaManagerProp =
    | BottomPanel of System.Windows.UIElement
    ...
    | SelectedItem of DevExpress.Xpf.Controls.MediaItem
    | TopPanel of obj
    | IsRandom of bool
    | PositionInfoType of DevExpress.Xpf.Controls.PositionInfoType
    | PositionInfoText of string

module MediaManager =
    let bottomPanel v : obj = box (MediaManagerProp.BottomPanel v)
    let information v : obj = box (MediaManagerProp.Information v)
    let isFullscreen v : obj = box (MediaManagerProp.IsFullscreen v)
    let leftPanel v : obj = box (MediaManagerProp.LeftPanel v)
    let mediaElement v : obj = box (MediaManagerProp.MediaElement v)
    let mediaList v : obj = box (MediaManagerProp.MediaList v)
    let rightPanel v : obj = box (MediaManagerProp.RightPanel v)
    let selectedIndex v : obj = box (MediaManagerProp.SelectedIndex v)
    let selectedItem v : obj = box (MediaManagerProp.SelectedItem v)
    let topPanel v : obj = box (MediaManagerProp.TopPanel v)
    let isRandom v : obj = box (MediaManagerProp.IsRandom v)
    let positionInfoType v : obj = box (MediaManagerProp.PositionInfoType v)
    let positionInfoText v : obj = box (MediaManagerProp.PositionInfoText v)

    let apply (el: DevExpress.Xpf.Controls.MediaManager) (prop: MediaManagerProp) =
        match prop with
        | MediaManagerProp.BottomPanel v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.BottomPanelProperty, box v)
        | MediaManagerProp.Information v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.InformationProperty, box v)
        | MediaManagerProp.IsFullscreen v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.IsFullscreenProperty, box v)
        | MediaManagerProp.LeftPanel v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.LeftPanelProperty, box v)
        | MediaManagerProp.MediaElement v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.MediaElementProperty, box v)
        | MediaManagerProp.MediaList v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.MediaListProperty, box v)
        | MediaManagerProp.RightPanel v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.RightPanelProperty, box v)
        | MediaManagerProp.SelectedIndex v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.SelectedIndexProperty, box v)
        | MediaManagerProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.SelectedItemProperty, box v)
        | MediaManagerProp.TopPanel v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.TopPanelProperty, box v)
        | MediaManagerProp.IsRandom v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.IsRandomProperty, box v)
        | MediaManagerProp.PositionInfoType v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.PositionInfoTypeProperty, box v)
        | MediaManagerProp.PositionInfoText v -> el.SetValue(DevExpress.Xpf.Controls.MediaManager.PositionInfoTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.MediaManager>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
