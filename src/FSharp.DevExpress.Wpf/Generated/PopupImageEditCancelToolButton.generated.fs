...
type PopupImageEditCancelToolButtonProp =
    | Base of PopupImageEditButtonProp

module PopupImageEditCancelToolButton =

    let apply (el: DevExpress.Xpf.Editors.PopupImageEditCancelToolButton) (prop: PopupImageEditCancelToolButtonProp) =
        match prop with
        | PopupImageEditCancelToolButtonProp.Base p -> PopupImageEditButton.apply el p

    let imageSource v : obj = box (ImageEditToolButtonProp.ImageSource v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupImageEditCancelToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
