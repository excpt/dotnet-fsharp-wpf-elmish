...
type LeftTabHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module LeftTabHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.LeftTabHotZoneControl) (prop: LeftTabHotZoneControlProp) =
        match prop with
        | LeftTabHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.LeftTabHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
