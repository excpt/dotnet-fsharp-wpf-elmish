...
type DockLayoutManagerThemeDependentValuesProviderProp =
    | Win32ResourcePath of System.Uri
    | IsDarkTheme of bool

module DockLayoutManagerThemeDependentValuesProvider =
    let win32ResourcePath v : obj = box (DockLayoutManagerThemeDependentValuesProviderProp.Win32ResourcePath v)
    let isDarkTheme v : obj = box (DockLayoutManagerThemeDependentValuesProviderProp.IsDarkTheme v)

    let apply (el: DevExpress.Xpf.Docking.DockLayoutManagerThemeDependentValuesProvider) (prop: DockLayoutManagerThemeDependentValuesProviderProp) =
        match prop with
        | DockLayoutManagerThemeDependentValuesProviderProp.Win32ResourcePath v -> el.SetValue(DevExpress.Xpf.Docking.DockLayoutManagerThemeDependentValuesProvider.Win32ResourcePathProperty, box v)
        | DockLayoutManagerThemeDependentValuesProviderProp.IsDarkTheme v -> el.SetValue(DevExpress.Xpf.Docking.DockLayoutManagerThemeDependentValuesProvider.IsDarkThemeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.DockLayoutManagerThemeDependentValuesProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
