...
type QueryBuilderDiagramConnectorProp =
    | Base of QueryBuilderDiagramConnectorBaseProp

module QueryBuilderDiagramConnector =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderDiagramConnector) (prop: QueryBuilderDiagramConnectorProp) =
        match prop with
        | QueryBuilderDiagramConnectorProp.Base p -> QueryBuilderDiagramConnectorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderDiagramConnector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
