...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.QueryBuilder
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type QueryBuilderViewBaseProp =
    | QueryBuilderViewModel of DevExpress.DataAccess.Native.Sql.QueryBuilder.QueryBuilderViewModel

module QueryBuilderViewBase =
    let queryBuilderViewModel v : obj = box (QueryBuilderViewBaseProp.QueryBuilderViewModel v)

    let apply (el: DevExpress.Xpf.DataAccess.QueryBuilder.QueryBuilderViewBase) (prop: QueryBuilderViewBaseProp) =
        match prop with
        | QueryBuilderViewBaseProp.QueryBuilderViewModel v -> el.SetValue(DevExpress.Xpf.DataAccess.QueryBuilder.QueryBuilderViewBase.QueryBuilderViewModelProperty, box v)
