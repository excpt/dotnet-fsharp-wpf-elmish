...
type BarItemLinkMenuHeaderItemsPanelProp =
    | HorizontalItems of bool

module BarItemLinkMenuHeaderItemsPanel =
    let horizontalItems v : obj = box (BarItemLinkMenuHeaderItemsPanelProp.HorizontalItems v)

    let apply (el: DevExpress.Xpf.Bars.BarItemLinkMenuHeaderItemsPanel) (prop: BarItemLinkMenuHeaderItemsPanelProp) =
        match prop with
        | BarItemLinkMenuHeaderItemsPanelProp.HorizontalItems v -> el.SetValue(DevExpress.Xpf.Bars.BarItemLinkMenuHeaderItemsPanel.HorizontalItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemLinkMenuHeaderItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
