...
type HeightLimitControlProp =
    | OuterSizeSourceElement of System.Windows.FrameworkElement

module HeightLimitControl =
    let outerSizeSourceElement v : obj = box (HeightLimitControlProp.OuterSizeSourceElement v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HeightLimitControl) (prop: HeightLimitControlProp) =
        match prop with
        | HeightLimitControlProp.OuterSizeSourceElement v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeightLimitControl.OuterSizeSourceElementProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HeightLimitControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
