...
type WindowControlBoxControlProp =
...
module WindowControlBoxControl =
    let minimizeButtonTemplate v : obj = box (WindowControlBoxControlProp.MinimizeButtonTemplate v)
    let maximizeButtonTemplate v : obj = box (WindowControlBoxControlProp.MaximizeButtonTemplate v)
    let restoreButtonTemplate v : obj = box (WindowControlBoxControlProp.RestoreButtonTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.WindowControlBoxControl) (prop: WindowControlBoxControlProp) =
        match prop with
        | WindowControlBoxControlProp.Base p -> BaseControlBoxControl.apply el p
        | WindowControlBoxControlProp.MinimizeButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.WindowControlBoxControl.MinimizeButtonTemplateProperty, box v)
        | WindowControlBoxControlProp.MaximizeButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.WindowControlBoxControl.MaximizeButtonTemplateProperty, box v)
        | WindowControlBoxControlProp.RestoreButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.WindowControlBoxControl.RestoreButtonTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.WindowControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
