...
type SunburstHoleContentControlProp =
    | HoleRadiusPercent of float

module SunburstHoleContentControl =
    let holeRadiusPercent v : obj = box (SunburstHoleContentControlProp.HoleRadiusPercent v)

    let apply (el: DevExpress.Xpf.TreeMap.SunburstHoleContentControl) (prop: SunburstHoleContentControlProp) =
        match prop with
        | SunburstHoleContentControlProp.HoleRadiusPercent v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstHoleContentControl.HoleRadiusPercentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.SunburstHoleContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
