...
type PageViewContentPanelProp =
    | ItemCacheMode of DevExpress.Xpf.WindowsUI.ItemCacheMode
    | AnimationType of DevExpress.Xpf.WindowsUI.AnimationType
    | AnimationDirection of DevExpress.Xpf.WindowsUI.SelectorAnimationDirection
    | AnimationSpeedRatio of float

module PageViewContentPanel =
    let itemCacheMode v : obj = box (PageViewContentPanelProp.ItemCacheMode v)
    let animationType v : obj = box (PageViewContentPanelProp.AnimationType v)
    let animationDirection v : obj = box (PageViewContentPanelProp.AnimationDirection v)
    let animationSpeedRatio v : obj = box (PageViewContentPanelProp.AnimationSpeedRatio v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.PageViewContentPanel) (prop: PageViewContentPanelProp) =
        match prop with
        | PageViewContentPanelProp.ItemCacheMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.PageViewContentPanel.ItemCacheModeProperty, box v)
        | PageViewContentPanelProp.AnimationType v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.PageViewContentPanel.AnimationTypeProperty, box v)
        | PageViewContentPanelProp.AnimationDirection v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.PageViewContentPanel.AnimationDirectionProperty, box v)
        | PageViewContentPanelProp.AnimationSpeedRatio v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.PageViewContentPanel.AnimationSpeedRatioProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.PageViewContentPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
