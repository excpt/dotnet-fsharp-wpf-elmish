...
type XYSeriesProp =
    ...
    | ColorEach of bool
    | AggregateFunction of DevExpress.Xpf.Charts.SeriesAggregateFunction
    | CustomAggregateFunction of DevExpress.Xpf.Charts.CustomAggregateFunction
...
module XYSeries =
    ...
    let apply (el: DevExpress.Xpf.Charts.XYSeries) (prop: XYSeriesProp) =
        match prop with
        | XYSeriesProp.Base p -> Series.apply el p
        | XYSeriesProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries.BrushProperty, box v)
        | XYSeriesProp.ColorEach v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries.ColorEachProperty, box v)
        | XYSeriesProp.AggregateFunction v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries.AggregateFunctionProperty, box v)
        | XYSeriesProp.CustomAggregateFunction v -> el.SetValue(DevExpress.Xpf.Charts.XYSeries.CustomAggregateFunctionProperty, box v)
