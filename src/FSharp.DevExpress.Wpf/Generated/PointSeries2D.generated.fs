...
module PointSeries2D =
    let markerModel v : obj = box (PointSeries2DProp.MarkerModel v)
    let markerSize v : obj = box (PointSeries2DProp.MarkerSize v)
    let pointAnimation v : obj = box (PointSeries2DProp.PointAnimation v)

    let apply (el: DevExpress.Xpf.Charts.PointSeries2D) (prop: PointSeries2DProp) =
        match prop with
        | PointSeries2DProp.Base p -> MarkerSeries2D.apply el p
        | PointSeries2DProp.MarkerModel v -> el.SetValue(DevExpress.Xpf.Charts.PointSeries2D.MarkerModelProperty, box v)
        | PointSeries2DProp.MarkerSize v -> el.SetValue(DevExpress.Xpf.Charts.PointSeries2D.MarkerSizeProperty, box v)
        | PointSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.PointSeries2D.PointAnimationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PointSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
