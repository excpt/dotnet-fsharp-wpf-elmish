...
type ToolTipControlProp =
    | Base of ChartElementBaseProp
    | ToolTipItem of DevExpress.Xpf.Charts.Native.ToolTipItem

module ToolTipControl =
    let toolTipItem v : obj = box (ToolTipControlProp.ToolTipItem v)

    let apply (el: DevExpress.Xpf.Charts.ToolTipControl) (prop: ToolTipControlProp) =
        match prop with
        | ToolTipControlProp.Base p -> ChartElementBase.apply el p
        | ToolTipControlProp.ToolTipItem v -> el.SetValue(DevExpress.Xpf.Charts.ToolTipControl.ToolTipItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ToolTipControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
