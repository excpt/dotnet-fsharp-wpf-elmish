...
type ComboBoxEditPropertyProviderProp =
    | Base of LookUpEditBasePropertyProviderProp

module ComboBoxEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.ComboBoxEditPropertyProvider) (prop: ComboBoxEditPropertyProviderProp) =
        match prop with
        | ComboBoxEditPropertyProviderProp.Base p -> LookUpEditBasePropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ComboBoxEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
