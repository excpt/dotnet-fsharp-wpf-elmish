...
type AxisElementTitlePresentationProp =
    | Base of ChartElementBaseProp

module AxisElementTitlePresentation =

    let apply (el: DevExpress.Xpf.Charts.AxisElementTitlePresentation) (prop: AxisElementTitlePresentationProp) =
        match prop with
        | AxisElementTitlePresentationProp.Base p -> ChartElementBase.apply el p
