...
type PreviewPageControlProp =
    | Base of PageControlProp
    | Pages of obj

module PreviewPageControl =
    let pages v : obj = box (PreviewPageControlProp.Pages v)

    let apply (el: DevExpress.Xpf.Printing.PreviewPageControl) (prop: PreviewPageControlProp) =
        match prop with
        | PreviewPageControlProp.Base p -> PageControl.apply el p
        | PreviewPageControlProp.Pages v -> el.SetValue(DevExpress.Xpf.Printing.PreviewPageControl.PagesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewPageControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
