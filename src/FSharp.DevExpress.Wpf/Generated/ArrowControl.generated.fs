...
type ArrowControlProp =
    | LinkControl of DevExpress.Xpf.Bars.BarItemLinkControl
    | ArrowAlignment of System.Windows.Controls.Dock
    | LinkContainerType of DevExpress.Xpf.Bars.LinkContainerType

module ArrowControl =
    let linkControl v : obj = box (ArrowControlProp.LinkControl v)
    let arrowAlignment v : obj = box (ArrowControlProp.ArrowAlignment v)
    let linkContainerType v : obj = box (ArrowControlProp.LinkContainerType v)

    let apply (el: DevExpress.Xpf.Bars.ArrowControl) (prop: ArrowControlProp) =
        match prop with
        | ArrowControlProp.LinkControl v -> el.SetValue(DevExpress.Xpf.Bars.ArrowControl.LinkControlProperty, box v)
        | ArrowControlProp.ArrowAlignment v -> el.SetValue(DevExpress.Xpf.Bars.ArrowControl.ArrowAlignmentProperty, box v)
        | ArrowControlProp.LinkContainerType v -> el.SetValue(DevExpress.Xpf.Bars.ArrowControl.LinkContainerTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.ArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
