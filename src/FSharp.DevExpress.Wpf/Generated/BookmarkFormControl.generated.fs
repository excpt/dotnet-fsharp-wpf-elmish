...
open System
open System.Windows
open DevExpress.XtraRichEdit.Forms
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type BookmarkFormControlProp =
    | CanAddBookmark of bool
    | CanDeleteBookmark of bool
    | CanSelectBookmark of bool
    | SelectedBookmarkIndex of int
    | BookmarkName of string

module BookmarkFormControl =
    let canAddBookmark v : obj = box (BookmarkFormControlProp.CanAddBookmark v)
    let canDeleteBookmark v : obj = box (BookmarkFormControlProp.CanDeleteBookmark v)
    let canSelectBookmark v : obj = box (BookmarkFormControlProp.CanSelectBookmark v)
    let selectedBookmarkIndex v : obj = box (BookmarkFormControlProp.SelectedBookmarkIndex v)
    let bookmarkName v : obj = box (BookmarkFormControlProp.BookmarkName v)

    let apply (el: DevExpress.XtraRichEdit.Forms.BookmarkFormControl) (prop: BookmarkFormControlProp) =
        match prop with
        | BookmarkFormControlProp.CanAddBookmark v -> el.SetValue(DevExpress.XtraRichEdit.Forms.BookmarkFormControl.CanAddBookmarkProperty, box v)
        | BookmarkFormControlProp.CanDeleteBookmark v -> el.SetValue(DevExpress.XtraRichEdit.Forms.BookmarkFormControl.CanDeleteBookmarkProperty, box v)
        | BookmarkFormControlProp.CanSelectBookmark v -> el.SetValue(DevExpress.XtraRichEdit.Forms.BookmarkFormControl.CanSelectBookmarkProperty, box v)
        | BookmarkFormControlProp.SelectedBookmarkIndex v -> el.SetValue(DevExpress.XtraRichEdit.Forms.BookmarkFormControl.SelectedBookmarkIndexProperty, box v)
        | BookmarkFormControlProp.BookmarkName v -> el.SetValue(DevExpress.XtraRichEdit.Forms.BookmarkFormControl.BookmarkNameProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.Forms.BookmarkFormControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
