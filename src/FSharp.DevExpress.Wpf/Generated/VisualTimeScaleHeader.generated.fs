...
type VisualTimeScaleHeaderProp =
    | Base of SchedulerContentControlProp
    | StartOffset of DevExpress.Xpf.Scheduler.Native.SingleTimelineHeaderCellOffset
    | EndOffset of DevExpress.Xpf.Scheduler.Native.SingleTimelineHeaderCellOffset

module VisualTimeScaleHeader =
    let startOffset v : obj = box (VisualTimeScaleHeaderProp.StartOffset v)
    let endOffset v : obj = box (VisualTimeScaleHeaderProp.EndOffset v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimeScaleHeader) (prop: VisualTimeScaleHeaderProp) =
        match prop with
        | VisualTimeScaleHeaderProp.Base p -> SchedulerContentControl.apply el p
        | VisualTimeScaleHeaderProp.StartOffset v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualTimeScaleHeader.StartOffsetProperty, box v)
        | VisualTimeScaleHeaderProp.EndOffset v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualTimeScaleHeader.EndOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualTimeScaleHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
