...
type ApplicationMenuProp =
    | Base of PopupMenuProp
    | RightPane of System.Windows.FrameworkElement
    | BottomPane of System.Windows.FrameworkElement
    | ShowRightPane of bool
    | RightPaneWidth of float

module ApplicationMenu =
    let rightPane v : obj = box (ApplicationMenuProp.RightPane v)
    let bottomPane v : obj = box (ApplicationMenuProp.BottomPane v)
    let showRightPane v : obj = box (ApplicationMenuProp.ShowRightPane v)
    let rightPaneWidth v : obj = box (ApplicationMenuProp.RightPaneWidth v)

    let apply (el: DevExpress.Xpf.Ribbon.ApplicationMenu) (prop: ApplicationMenuProp) =
        match prop with
        | ApplicationMenuProp.Base p -> PopupMenu.apply el p
        | ApplicationMenuProp.RightPane v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenu.RightPaneProperty, box v)
        | ApplicationMenuProp.BottomPane v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenu.BottomPaneProperty, box v)
        | ApplicationMenuProp.ShowRightPane v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenu.ShowRightPaneProperty, box v)
        | ApplicationMenuProp.RightPaneWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenu.RightPaneWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.ApplicationMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
