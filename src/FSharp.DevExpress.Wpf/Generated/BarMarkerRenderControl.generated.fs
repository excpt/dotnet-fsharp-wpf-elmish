...
type BarMarkerRenderControlProp =
    | Base of RectangleMarkerRenderControlProp

module BarMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.BarMarkerRenderControl) (prop: BarMarkerRenderControlProp) =
        match prop with
        | BarMarkerRenderControlProp.Base p -> RectangleMarkerRenderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BarMarkerRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
