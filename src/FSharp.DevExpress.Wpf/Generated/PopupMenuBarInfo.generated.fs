...
type PopupMenuBarInfoProp =
    | Base of PopupMenuInfoProp

module PopupMenuBarInfo =

    let apply (el: DevExpress.Xpf.Bars.PopupMenuBarInfo) (prop: PopupMenuBarInfoProp) =
        match prop with
        | PopupMenuBarInfoProp.Base p -> PopupMenuInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupMenuBarInfo>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
