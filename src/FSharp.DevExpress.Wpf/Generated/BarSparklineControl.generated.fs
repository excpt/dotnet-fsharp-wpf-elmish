...
type BarSparklineControlProp =
    | Base of BarSparklineControlBaseProp
    | HighlightNegativePoints of bool

module BarSparklineControl =
    let highlightNegativePoints v : obj = box (BarSparklineControlProp.HighlightNegativePoints v)

    let apply (el: DevExpress.Xpf.Editors.BarSparklineControl) (prop: BarSparklineControlProp) =
        match prop with
        | BarSparklineControlProp.Base p -> BarSparklineControlBase.apply el p
        | BarSparklineControlProp.HighlightNegativePoints v -> el.SetValue(DevExpress.Xpf.Editors.BarSparklineControl.HighlightNegativePointsProperty, box v)

    let barDistance v : obj = box (BarSparklineControlBaseProp.BarDistance v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BarSparklineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
