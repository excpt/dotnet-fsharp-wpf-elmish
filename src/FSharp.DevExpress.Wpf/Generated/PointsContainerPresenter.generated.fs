...
type PointsContainerPresenterProp =
    | ItemsSource of System.Collections.IEnumerable

module PointsContainerPresenter =
    let itemsSource v : obj = box (PointsContainerPresenterProp.ItemsSource v)

    let apply (el: DevExpress.Xpf.Charts.PointsContainerPresenter) (prop: PointsContainerPresenterProp) =
        match prop with
        | PointsContainerPresenterProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.PointsContainerPresenter.ItemsSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PointsContainerPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
