...
type ShapeGeometryPresenterProp =
    | Stroke of System.Windows.Media.Brush
    | StrokeThickness of float

module ShapeGeometryPresenter =
    ...
    let apply (el: DevExpress.Xpf.Diagram.Native.ShapeGeometryPresenter) (prop: ShapeGeometryPresenterProp) =
        match prop with
        | ShapeGeometryPresenterProp.Stroke v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ShapeGeometryPresenter.StrokeProperty, box v)
        | ShapeGeometryPresenterProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.Diagram.Native.ShapeGeometryPresenter.StrokeThicknessProperty, box v)
