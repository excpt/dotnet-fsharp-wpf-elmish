...
type CheckedListBoxEditStyleSettingsProp =
    | Base of BaseListBoxEditStyleSettingsProp
    | ShowSelectAllItem of bool
    | SelectAllItemText of string

module CheckedListBoxEditStyleSettings =
    let showSelectAllItem v : obj = box (CheckedListBoxEditStyleSettingsProp.ShowSelectAllItem v)
    let selectAllItemText v : obj = box (CheckedListBoxEditStyleSettingsProp.SelectAllItemText v)

    let apply (el: DevExpress.Xpf.Editors.CheckedListBoxEditStyleSettings) (prop: CheckedListBoxEditStyleSettingsProp) =
        match prop with
        | CheckedListBoxEditStyleSettingsProp.Base p -> BaseListBoxEditStyleSettings.apply el p
        | CheckedListBoxEditStyleSettingsProp.ShowSelectAllItem v -> el.SetValue(DevExpress.Xpf.Editors.CheckedListBoxEditStyleSettings.ShowSelectAllItemProperty, box v)
        | CheckedListBoxEditStyleSettingsProp.SelectAllItemText v -> el.SetValue(DevExpress.Xpf.Editors.CheckedListBoxEditStyleSettings.SelectAllItemTextProperty, box v)

    let selectionEventMode v : obj = box (BaseListBoxEditStyleSettingsProp.SelectionEventMode v)
    let itemContainerStyle v : obj = box (BaseListBoxEditStyleSettingsProp.ItemContainerStyle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CheckedListBoxEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
