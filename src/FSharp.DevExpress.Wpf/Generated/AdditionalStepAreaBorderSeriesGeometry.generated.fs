...
type AdditionalStepAreaBorderSeriesGeometryProp =
    | Base of AdditionalAreaBorderSeriesGeometryProp

module AdditionalStepAreaBorderSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStepAreaBorderSeriesGeometry) (prop: AdditionalStepAreaBorderSeriesGeometryProp) =
        match prop with
        | AdditionalStepAreaBorderSeriesGeometryProp.Base p -> AdditionalAreaBorderSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStepAreaBorderSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
