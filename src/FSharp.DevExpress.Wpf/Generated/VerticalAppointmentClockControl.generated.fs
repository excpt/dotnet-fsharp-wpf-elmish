...
type VerticalAppointmentClockControlProp =
    | Base of AppointmentClockControlBaseProp

module VerticalAppointmentClockControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VerticalAppointmentClockControl) (prop: VerticalAppointmentClockControlProp) =
        match prop with
        | VerticalAppointmentClockControlProp.Base p -> AppointmentClockControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VerticalAppointmentClockControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
