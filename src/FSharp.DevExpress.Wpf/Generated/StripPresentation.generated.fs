...
type StripPresentationProp =
    | Base of ChartElementBaseProp

module StripPresentation =

    let apply (el: DevExpress.Xpf.Charts.StripPresentation) (prop: StripPresentationProp) =
        match prop with
        | StripPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StripPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
