...
type AppointmentColorConvertControlProp =
    | Base of SchedulerColorConvertControlProp

module AppointmentColorConvertControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentColorConvertControl) (prop: AppointmentColorConvertControlProp) =
        match prop with
        | AppointmentColorConvertControlProp.Base p -> SchedulerColorConvertControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentColorConvertControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
