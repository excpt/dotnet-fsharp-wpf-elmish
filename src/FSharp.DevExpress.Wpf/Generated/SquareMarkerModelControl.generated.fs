...
type SquareMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module SquareMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.SquareMarkerModelControl) (prop: SquareMarkerModelControlProp) =
        match prop with
        | SquareMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.SquareMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
