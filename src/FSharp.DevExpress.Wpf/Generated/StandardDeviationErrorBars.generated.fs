...
type StandardDeviationErrorBarsProp =
    | Base of ErrorBarsProp
    | Multiplier of float

module StandardDeviationErrorBars =
    let multiplier v : obj = box (StandardDeviationErrorBarsProp.Multiplier v)

    let apply (el: DevExpress.Xpf.Charts.StandardDeviationErrorBars) (prop: StandardDeviationErrorBarsProp) =
        match prop with
        | StandardDeviationErrorBarsProp.Base p -> ErrorBars.apply el p
        | StandardDeviationErrorBarsProp.Multiplier v -> el.SetValue(DevExpress.Xpf.Charts.StandardDeviationErrorBars.MultiplierProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StandardDeviationErrorBars>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
