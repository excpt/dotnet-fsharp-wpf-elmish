...
type UICommandContainerProp =
    | Base of DXFrameworkElementProp
    | Id of obj
    | Caption of obj
...
module UICommandContainer =
    let id v : obj = box (UICommandContainerProp.Id v)
    let caption v : obj = box (UICommandContainerProp.Caption v)
    let command v : obj = box (UICommandContainerProp.Command v)
    let isDefault v : obj = box (UICommandContainerProp.IsDefault v)
    let isCancel v : obj = box (UICommandContainerProp.IsCancel v)

    let apply (el: DevExpress.Xpf.Editors.UICommandContainer) (prop: UICommandContainerProp) =
        match prop with
        | UICommandContainerProp.Base p -> DXFrameworkElement.apply el p
        | UICommandContainerProp.Id v -> el.SetValue(DevExpress.Xpf.Editors.UICommandContainer.IdProperty, box v)
        | UICommandContainerProp.Caption v -> el.SetValue(DevExpress.Xpf.Editors.UICommandContainer.CaptionProperty, box v)
        | UICommandContainerProp.Command v -> el.SetValue(DevExpress.Xpf.Editors.UICommandContainer.CommandProperty, box v)
        | UICommandContainerProp.IsDefault v -> el.SetValue(DevExpress.Xpf.Editors.UICommandContainer.IsDefaultProperty, box v)
        | UICommandContainerProp.IsCancel v -> el.SetValue(DevExpress.Xpf.Editors.UICommandContainer.IsCancelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.UICommandContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
