...
type AppointmentResourcePresenterProp =
    | Base of FastTextBlockProp

module AppointmentResourcePresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentResourcePresenter) (prop: AppointmentResourcePresenterProp) =
        match prop with
        | AppointmentResourcePresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentResourcePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
