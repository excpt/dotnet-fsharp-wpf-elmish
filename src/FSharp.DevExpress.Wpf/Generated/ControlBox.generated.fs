...
type ControlBoxProp =
    | MDIButtonMinimizeTemplate of System.Windows.DataTemplate
    | MDIButtonRestoreTemplate of System.Windows.DataTemplate
    | MDIButtonCloseTemplate of System.Windows.DataTemplate
    | MDIButtonBorderStyle of System.Windows.Style

module ControlBox =
    let mDIButtonMinimizeTemplate v : obj = box (ControlBoxProp.MDIButtonMinimizeTemplate v)
    let mDIButtonRestoreTemplate v : obj = box (ControlBoxProp.MDIButtonRestoreTemplate v)
    let mDIButtonCloseTemplate v : obj = box (ControlBoxProp.MDIButtonCloseTemplate v)
    let mDIButtonBorderStyle v : obj = box (ControlBoxProp.MDIButtonBorderStyle v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.ControlBox) (prop: ControlBoxProp) =
        match prop with
        | ControlBoxProp.MDIButtonMinimizeTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBox.MDIButtonMinimizeTemplateProperty, box v)
        | ControlBoxProp.MDIButtonRestoreTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBox.MDIButtonRestoreTemplateProperty, box v)
        | ControlBoxProp.MDIButtonCloseTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBox.MDIButtonCloseTemplateProperty, box v)
        | ControlBoxProp.MDIButtonBorderStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.ControlBox.MDIButtonBorderStyleProperty, box v)
    ...
    let hotButton (v: DevExpress.Xpf.Docking.Base.HitTestType) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Docking.VisualElements.ControlBox.HotButtonProperty, box v)) :: node.Props }
    let pressedButton (v: DevExpress.Xpf.Docking.Base.HitTestType) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Docking.VisualElements.ControlBox.PressedButtonProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.ControlBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
