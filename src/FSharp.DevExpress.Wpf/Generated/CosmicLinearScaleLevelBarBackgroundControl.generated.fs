...
type CosmicLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CosmicLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicLinearScaleLevelBarBackgroundControl) (prop: CosmicLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | CosmicLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
