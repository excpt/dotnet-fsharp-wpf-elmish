...
type BackstagePrintPreviewProp =
    | DocumentSource of obj
    | PrintOptionsTemplate of System.Windows.DataTemplate
    | ShowPreview of bool
    | ShowPrintSettings of bool
    | CustomSettings of obj
    | CustomSettingsTemplate of System.Windows.DataTemplate
    | StatusBarTemplate of System.Windows.DataTemplate
    | EnableContinuousScrolling of bool
    | ZoomFactor of float
    | ZoomMode of DevExpress.Xpf.DocumentViewer.ZoomMode

module BackstagePrintPreview =
    let documentSource v : obj = box (BackstagePrintPreviewProp.DocumentSource v)
    let printOptionsTemplate v : obj = box (BackstagePrintPreviewProp.PrintOptionsTemplate v)
    let showPreview v : obj = box (BackstagePrintPreviewProp.ShowPreview v)
    let showPrintSettings v : obj = box (BackstagePrintPreviewProp.ShowPrintSettings v)
    let customSettings v : obj = box (BackstagePrintPreviewProp.CustomSettings v)
    let customSettingsTemplate v : obj = box (BackstagePrintPreviewProp.CustomSettingsTemplate v)
    let statusBarTemplate v : obj = box (BackstagePrintPreviewProp.StatusBarTemplate v)
    let enableContinuousScrolling v : obj = box (BackstagePrintPreviewProp.EnableContinuousScrolling v)
    let zoomFactor v : obj = box (BackstagePrintPreviewProp.ZoomFactor v)
    let zoomMode v : obj = box (BackstagePrintPreviewProp.ZoomMode v)

    let apply (el: DevExpress.Xpf.Printing.BackstagePrintPreview) (prop: BackstagePrintPreviewProp) =
        match prop with
        | BackstagePrintPreviewProp.DocumentSource v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.DocumentSourceProperty, box v)
        | BackstagePrintPreviewProp.PrintOptionsTemplate v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.PrintOptionsTemplateProperty, box v)
        | BackstagePrintPreviewProp.ShowPreview v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.ShowPreviewProperty, box v)
        | BackstagePrintPreviewProp.ShowPrintSettings v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.ShowPrintSettingsProperty, box v)
        | BackstagePrintPreviewProp.CustomSettings v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.CustomSettingsProperty, box v)
        | BackstagePrintPreviewProp.CustomSettingsTemplate v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.CustomSettingsTemplateProperty, box v)
        | BackstagePrintPreviewProp.StatusBarTemplate v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.StatusBarTemplateProperty, box v)
        | BackstagePrintPreviewProp.EnableContinuousScrolling v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.EnableContinuousScrollingProperty, box v)
        | BackstagePrintPreviewProp.ZoomFactor v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.ZoomFactorProperty, box v)
        | BackstagePrintPreviewProp.ZoomMode v -> el.SetValue(DevExpress.Xpf.Printing.BackstagePrintPreview.ZoomModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.BackstagePrintPreview>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
