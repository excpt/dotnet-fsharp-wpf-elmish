...
type CollectionDefinitionProp =
    | Base of PropertyDefinitionProp
    | NewItemInitializer of DevExpress.Mvvm.Native.IInstanceInitializer
    | UseCollectionEditor of obj
    | AllowNewItemInitializer of obj
    | AllowRemoveItems of bool
    | AllowAddItems of bool
    | AllowRemoveItemsWithoutNewItemInitializer of bool

module CollectionDefinition =
    let newItemInitializer v : obj = box (CollectionDefinitionProp.NewItemInitializer v)
    let useCollectionEditor v : obj = box (CollectionDefinitionProp.UseCollectionEditor v)
    let allowNewItemInitializer v : obj = box (CollectionDefinitionProp.AllowNewItemInitializer v)
    let allowRemoveItems v : obj = box (CollectionDefinitionProp.AllowRemoveItems v)
    let allowAddItems v : obj = box (CollectionDefinitionProp.AllowAddItems v)
    let allowRemoveItemsWithoutNewItemInitializer v : obj = box (CollectionDefinitionProp.AllowRemoveItemsWithoutNewItemInitializer v)

    let apply (el: DevExpress.Xpf.PropertyGrid.CollectionDefinition) (prop: CollectionDefinitionProp) =
        match prop with
        | CollectionDefinitionProp.Base p -> PropertyDefinition.apply el p
        | CollectionDefinitionProp.NewItemInitializer v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CollectionDefinition.NewItemInitializerProperty, box v)
        | CollectionDefinitionProp.UseCollectionEditor v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CollectionDefinition.UseCollectionEditorProperty, box v)
        | CollectionDefinitionProp.AllowNewItemInitializer v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CollectionDefinition.AllowNewItemInitializerProperty, box v)
        | CollectionDefinitionProp.AllowRemoveItems v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CollectionDefinition.AllowRemoveItemsProperty, box v)
        | CollectionDefinitionProp.AllowAddItems v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CollectionDefinition.AllowAddItemsProperty, box v)
        | CollectionDefinitionProp.AllowRemoveItemsWithoutNewItemInitializer v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CollectionDefinition.AllowRemoveItemsWithoutNewItemInitializerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.CollectionDefinition>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
