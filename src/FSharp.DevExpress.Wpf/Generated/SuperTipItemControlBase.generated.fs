...
type SuperTipItemControlBaseProp =
    | Item of DevExpress.Xpf.Core.SuperTipItemBase
    | ActualLayoutStyle of System.Windows.Style
    | LayoutStyle of System.Windows.Style
    | UserLayoutStyle of System.Windows.Style
    | ContentStyle of System.Windows.Style
    | ContentTemplate of System.Windows.DataTemplate
    | UserContentTemplate of System.Windows.DataTemplate
    | ActualContentTemplate of System.Windows.DataTemplate

module SuperTipItemControlBase =
    let item v : obj = box (SuperTipItemControlBaseProp.Item v)
    let actualLayoutStyle v : obj = box (SuperTipItemControlBaseProp.ActualLayoutStyle v)
    let layoutStyle v : obj = box (SuperTipItemControlBaseProp.LayoutStyle v)
    let userLayoutStyle v : obj = box (SuperTipItemControlBaseProp.UserLayoutStyle v)
    let contentStyle v : obj = box (SuperTipItemControlBaseProp.ContentStyle v)
    let contentTemplate v : obj = box (SuperTipItemControlBaseProp.ContentTemplate v)
    let userContentTemplate v : obj = box (SuperTipItemControlBaseProp.UserContentTemplate v)
    let actualContentTemplate v : obj = box (SuperTipItemControlBaseProp.ActualContentTemplate v)

    let apply (el: DevExpress.Xpf.Core.SuperTipItemControlBase) (prop: SuperTipItemControlBaseProp) =
        match prop with
        | SuperTipItemControlBaseProp.Item v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.ItemProperty, box v)
        | SuperTipItemControlBaseProp.ActualLayoutStyle v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.ActualLayoutStyleProperty, box v)
        | SuperTipItemControlBaseProp.LayoutStyle v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.LayoutStyleProperty, box v)
        | SuperTipItemControlBaseProp.UserLayoutStyle v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.UserLayoutStyleProperty, box v)
        | SuperTipItemControlBaseProp.ContentStyle v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.ContentStyleProperty, box v)
        | SuperTipItemControlBaseProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.ContentTemplateProperty, box v)
        | SuperTipItemControlBaseProp.UserContentTemplate v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.UserContentTemplateProperty, box v)
        | SuperTipItemControlBaseProp.ActualContentTemplate v -> el.SetValue(DevExpress.Xpf.Core.SuperTipItemControlBase.ActualContentTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SuperTipItemControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
