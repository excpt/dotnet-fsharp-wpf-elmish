...
type TileBarItemsPanelProp =
    | Base of HeaderedStackLayoutPanelProp

module TileBarItemsPanel =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileBarItemsPanel) (prop: TileBarItemsPanelProp) =
        match prop with
        | TileBarItemsPanelProp.Base p -> HeaderedStackLayoutPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileBarItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
