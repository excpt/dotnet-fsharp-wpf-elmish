...
type ProgressiveQuarterTopLeftArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveQuarterTopLeftArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveQuarterTopLeftArcScaleForegroundLayerControl) (prop: ProgressiveQuarterTopLeftArcScaleForegroundLayerControlProp) =
        match prop with
        | ProgressiveQuarterTopLeftArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveQuarterTopLeftArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
