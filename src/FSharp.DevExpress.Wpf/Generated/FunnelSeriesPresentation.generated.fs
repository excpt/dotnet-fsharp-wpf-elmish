...
type FunnelSeriesPresentationProp =
    | Base of SeriesPresentationBaseProp

module FunnelSeriesPresentation =

    let apply (el: DevExpress.Xpf.Charts.FunnelSeriesPresentation) (prop: FunnelSeriesPresentationProp) =
        match prop with
        | FunnelSeriesPresentationProp.Base p -> SeriesPresentationBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FunnelSeriesPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
