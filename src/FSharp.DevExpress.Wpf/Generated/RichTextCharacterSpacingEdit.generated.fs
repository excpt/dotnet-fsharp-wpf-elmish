...
type RichTextCharacterSpacingEditProp =
    | Base of RichTextIndentEditProp

module RichTextCharacterSpacingEdit =

    let apply (el: DevExpress.Xpf.RichEdit.UI.RichTextCharacterSpacingEdit) (prop: RichTextCharacterSpacingEditProp) =
        match prop with
        | RichTextCharacterSpacingEditProp.Base p -> RichTextIndentEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.RichTextCharacterSpacingEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
