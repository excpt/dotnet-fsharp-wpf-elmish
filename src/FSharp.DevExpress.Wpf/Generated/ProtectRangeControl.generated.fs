...
type ProtectRangeControlProp =
    | Base of ReferenceEditBaseControlProp

module ProtectRangeControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ProtectRangeControl) (prop: ProtectRangeControlProp) =
        match prop with
        | ProtectRangeControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ProtectRangeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
