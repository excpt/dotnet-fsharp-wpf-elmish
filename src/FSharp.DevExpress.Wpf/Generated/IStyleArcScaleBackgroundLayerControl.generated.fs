...
type IStyleArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleArcScaleBackgroundLayerControl) (prop: IStyleArcScaleBackgroundLayerControlProp) =
        match prop with
        | IStyleArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
