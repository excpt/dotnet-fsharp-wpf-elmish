...
type ProgressiveArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ProgressiveArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveArcScaleMarkerControl) (prop: ProgressiveArcScaleMarkerControlProp) =
        match prop with
        | ProgressiveArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
