...
type CleanWhiteSpindleCapControlProp =
    | Base of PresentationControlProp

module CleanWhiteSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteSpindleCapControl) (prop: CleanWhiteSpindleCapControlProp) =
        match prop with
        | CleanWhiteSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
