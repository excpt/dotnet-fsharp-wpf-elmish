...
type DayGroupsByResourcePanelProp =
    | Base of DayGroupsPanelProp

module DayGroupsByResourcePanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.DayGroupsByResourcePanel) (prop: DayGroupsByResourcePanelProp) =
        match prop with
        | DayGroupsByResourcePanelProp.Base p -> DayGroupsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.DayGroupsByResourcePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
