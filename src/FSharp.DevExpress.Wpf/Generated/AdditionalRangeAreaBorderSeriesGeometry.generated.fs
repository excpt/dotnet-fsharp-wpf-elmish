...
type AdditionalRangeAreaBorderSeriesGeometryProp =
    | Base of AdditionalLineSeriesGeometryProp

module AdditionalRangeAreaBorderSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalRangeAreaBorderSeriesGeometry) (prop: AdditionalRangeAreaBorderSeriesGeometryProp) =
        match prop with
        | AdditionalRangeAreaBorderSeriesGeometryProp.Base p -> AdditionalLineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalRangeAreaBorderSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
