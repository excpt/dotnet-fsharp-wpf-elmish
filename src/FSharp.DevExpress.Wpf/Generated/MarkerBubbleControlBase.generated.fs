...
type MarkerBubbleControlBaseProp =
    | ShapeStyle of System.Windows.Style

module MarkerBubbleControlBase =
    let shapeStyle v : obj = box (MarkerBubbleControlBaseProp.ShapeStyle v)

    let apply (el: DevExpress.Xpf.Map.MarkerBubbleControlBase) (prop: MarkerBubbleControlBaseProp) =
        match prop with
        | MarkerBubbleControlBaseProp.ShapeStyle v -> el.SetValue(DevExpress.Xpf.Map.MarkerBubbleControlBase.ShapeStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MarkerBubbleControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
