...
type CircularCosmicFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCosmicFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCosmicFullModel) (prop: CircularCosmicFullModelProp) =
        match prop with
        | CircularCosmicFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCosmicFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
