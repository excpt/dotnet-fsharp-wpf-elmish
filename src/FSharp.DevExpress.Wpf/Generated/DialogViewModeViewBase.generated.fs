...
type DialogViewModeViewBaseProp =
    | IconSize of System.Windows.Size

module DialogViewModeViewBase =
    let iconSize v : obj = box (DialogViewModeViewBaseProp.IconSize v)

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogViewModeViewBase) (prop: DialogViewModeViewBaseProp) =
        match prop with
        | DialogViewModeViewBaseProp.IconSize v -> el.SetValue(DevExpress.Xpf.Dialogs.Native.DialogViewModeViewBase.IconSizeProperty, box v)
