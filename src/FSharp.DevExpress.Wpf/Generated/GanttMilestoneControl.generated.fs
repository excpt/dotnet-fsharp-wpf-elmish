...
type GanttMilestoneControlProp =
    | Base of GanttItemControlBaseProp

module GanttMilestoneControl =

    let apply (el: DevExpress.Xpf.Gantt.GanttMilestoneControl) (prop: GanttMilestoneControlProp) =
        match prop with
        | GanttMilestoneControlProp.Base p -> GanttItemControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttMilestoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
