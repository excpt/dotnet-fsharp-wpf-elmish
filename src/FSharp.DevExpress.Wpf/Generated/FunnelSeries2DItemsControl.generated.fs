...
type FunnelSeries2DItemsControlProp =
    | Base of Diagram2DItemsControlProp
    | Series of DevExpress.Xpf.Charts.Series
    | PointsContainer of System.Windows.Controls.ItemsControl
    | SeriesLabel of DevExpress.Xpf.Charts.SeriesLabel
    | SeriesLabelItems of obj

module FunnelSeries2DItemsControl =
    let series v : obj = box (FunnelSeries2DItemsControlProp.Series v)
    let pointsContainer v : obj = box (FunnelSeries2DItemsControlProp.PointsContainer v)
    let seriesLabel v : obj = box (FunnelSeries2DItemsControlProp.SeriesLabel v)
    let seriesLabelItems v : obj = box (FunnelSeries2DItemsControlProp.SeriesLabelItems v)

    let apply (el: DevExpress.Xpf.Charts.FunnelSeries2DItemsControl) (prop: FunnelSeries2DItemsControlProp) =
        match prop with
        | FunnelSeries2DItemsControlProp.Base p -> Diagram2DItemsControl.apply el p
        | FunnelSeries2DItemsControlProp.Series v -> el.SetValue(DevExpress.Xpf.Charts.FunnelSeries2DItemsControl.SeriesProperty, box v)
        | FunnelSeries2DItemsControlProp.PointsContainer v -> el.SetValue(DevExpress.Xpf.Charts.FunnelSeries2DItemsControl.PointsContainerProperty, box v)
        | FunnelSeries2DItemsControlProp.SeriesLabel v -> el.SetValue(DevExpress.Xpf.Charts.FunnelSeries2DItemsControl.SeriesLabelProperty, box v)
        | FunnelSeries2DItemsControlProp.SeriesLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.FunnelSeries2DItemsControl.SeriesLabelItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FunnelSeries2DItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
