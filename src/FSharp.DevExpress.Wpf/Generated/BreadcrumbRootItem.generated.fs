...
type BreadcrumbRootItemProp =
    | Base of BreadcrumbItemProp
    | ShowPredefinedSubItems of bool
    | PredefinedSubItems of obj

module BreadcrumbRootItem =
    let showPredefinedSubItems v : obj = box (BreadcrumbRootItemProp.ShowPredefinedSubItems v)
    let predefinedSubItems v : obj = box (BreadcrumbRootItemProp.PredefinedSubItems v)

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbRootItem) (prop: BreadcrumbRootItemProp) =
        match prop with
        | BreadcrumbRootItemProp.Base p -> BreadcrumbItem.apply el p
        | BreadcrumbRootItemProp.ShowPredefinedSubItems v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbRootItem.ShowPredefinedSubItemsProperty, box v)
        | BreadcrumbRootItemProp.PredefinedSubItems v -> el.SetValue(DevExpress.Xpf.Controls.Internal.BreadcrumbRootItem.PredefinedSubItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbRootItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
