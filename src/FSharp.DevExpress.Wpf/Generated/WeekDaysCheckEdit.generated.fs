...
type WeekDaysCheckEditProp =
    | FirstDayOfWeek of System.DayOfWeek
    | WeekDays of DevExpress.XtraScheduler.WeekDays

module WeekDaysCheckEdit =
    let firstDayOfWeek v : obj = box (WeekDaysCheckEditProp.FirstDayOfWeek v)
    let weekDays v : obj = box (WeekDaysCheckEditProp.WeekDays v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.WeekDaysCheckEdit) (prop: WeekDaysCheckEditProp) =
        match prop with
        | WeekDaysCheckEditProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.WeekDaysCheckEdit.FirstDayOfWeekProperty, box v)
        | WeekDaysCheckEditProp.WeekDays v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.WeekDaysCheckEdit.WeekDaysProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.WeekDaysCheckEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
