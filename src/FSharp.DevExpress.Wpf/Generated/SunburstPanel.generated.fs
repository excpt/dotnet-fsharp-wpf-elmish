...
type SunburstPanelProp =
    ...
    | LevelCount of int
    | SectorViewInfos of obj

module SunburstPanel =
    let holeRadiusPercent v : obj = box (SunburstPanelProp.HoleRadiusPercent v)
    let labelDisplayMode v : obj = box (SunburstPanelProp.LabelDisplayMode v)
    let minLabelSize v : obj = box (SunburstPanelProp.MinLabelSize v)
    let levelCount v : obj = box (SunburstPanelProp.LevelCount v)
    let sectorViewInfos v : obj = box (SunburstPanelProp.SectorViewInfos v)

    let apply (el: DevExpress.Xpf.TreeMap.SunburstPanel) (prop: SunburstPanelProp) =
        match prop with
        | SunburstPanelProp.HoleRadiusPercent v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstPanel.HoleRadiusPercentProperty, box v)
        | SunburstPanelProp.LabelDisplayMode v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstPanel.LabelDisplayModeProperty, box v)
        | SunburstPanelProp.MinLabelSize v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstPanel.MinLabelSizeProperty, box v)
        | SunburstPanelProp.LevelCount v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstPanel.LevelCountProperty, box v)
        | SunburstPanelProp.SectorViewInfos v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstPanel.SectorViewInfosProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.SunburstPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
