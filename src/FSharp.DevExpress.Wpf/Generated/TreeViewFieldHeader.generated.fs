...
type TreeViewFieldHeaderProp =
    | Base of FieldHeaderBaseProp
    | Node of DevExpress.Xpf.PivotGrid.Internal.IVisualCustomizationTreeItem
    | ShowCheckBox of bool
    | Checked of bool
    | ImageSource of System.Windows.Media.ImageSource

module TreeViewFieldHeader =
    let node v : obj = box (TreeViewFieldHeaderProp.Node v)
    let showCheckBox v : obj = box (TreeViewFieldHeaderProp.ShowCheckBox v)
    let checked v : obj = box (TreeViewFieldHeaderProp.Checked v)
    let imageSource v : obj = box (TreeViewFieldHeaderProp.ImageSource v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldHeader) (prop: TreeViewFieldHeaderProp) =
        match prop with
        | TreeViewFieldHeaderProp.Base p -> FieldHeaderBase.apply el p
        | TreeViewFieldHeaderProp.Node v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldHeader.NodeProperty, box v)
        | TreeViewFieldHeaderProp.ShowCheckBox v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldHeader.ShowCheckBoxProperty, box v)
        | TreeViewFieldHeaderProp.Checked v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldHeader.CheckedProperty, box v)
        | TreeViewFieldHeaderProp.ImageSource v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldHeader.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
