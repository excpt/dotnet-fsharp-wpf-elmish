...
type KpiImagePresenterProp =
    | KpiGraphic of DevExpress.Xpf.PivotGrid.PivotKpiGraphic
    | KpiType of DevExpress.Xpf.PivotGrid.PivotKpiType
    | Value of obj

module KpiImagePresenter =
    let kpiGraphic v : obj = box (KpiImagePresenterProp.KpiGraphic v)
    let kpiType v : obj = box (KpiImagePresenterProp.KpiType v)
    let value v : obj = box (KpiImagePresenterProp.Value v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.KpiImagePresenter) (prop: KpiImagePresenterProp) =
        match prop with
        | KpiImagePresenterProp.KpiGraphic v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.KpiImagePresenter.KpiGraphicProperty, box v)
        | KpiImagePresenterProp.KpiType v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.KpiImagePresenter.KpiTypeProperty, box v)
        | KpiImagePresenterProp.Value v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.KpiImagePresenter.ValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.KpiImagePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
