...
type RedClockDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedClockDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockDigitalGaugeBackgroundLayerControl) (prop: RedClockDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | RedClockDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
