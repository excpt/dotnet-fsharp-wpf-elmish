...
type SlideViewItemHeaderProp =
    | Base of veContentControlProp
    | IsHeaderInteractive of bool
    | InteractiveHeaderTemplate of System.Windows.DataTemplate
    | IsSticky of bool

module SlideViewItemHeader =
    let isHeaderInteractive v : obj = box (SlideViewItemHeaderProp.IsHeaderInteractive v)
    let interactiveHeaderTemplate v : obj = box (SlideViewItemHeaderProp.InteractiveHeaderTemplate v)
    let isSticky v : obj = box (SlideViewItemHeaderProp.IsSticky v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.SlideViewItemHeader) (prop: SlideViewItemHeaderProp) =
        match prop with
        | SlideViewItemHeaderProp.Base p -> veContentControl.apply el p
        | SlideViewItemHeaderProp.IsHeaderInteractive v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SlideViewItemHeader.IsHeaderInteractiveProperty, box v)
        | SlideViewItemHeaderProp.InteractiveHeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SlideViewItemHeader.InteractiveHeaderTemplateProperty, box v)
        | SlideViewItemHeaderProp.IsSticky v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SlideViewItemHeader.IsStickyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.SlideViewItemHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
