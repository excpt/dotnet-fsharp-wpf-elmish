...
type DiagramQueryBuilderViewProp =
    | Base of QueryBuilderViewBaseProp

module DiagramQueryBuilderView =

    let apply (el: DevExpress.Xpf.DataAccess.QueryBuilder.DiagramQueryBuilderView) (prop: DiagramQueryBuilderViewProp) =
        match prop with
        | DiagramQueryBuilderViewProp.Base p -> QueryBuilderViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.QueryBuilder.DiagramQueryBuilderView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
