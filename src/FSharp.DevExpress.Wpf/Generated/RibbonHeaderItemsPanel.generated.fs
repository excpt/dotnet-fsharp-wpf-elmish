...
type RibbonHeaderItemsPanelProp =
    | Base of RibbonItemsPanelProp

module RibbonHeaderItemsPanel =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonHeaderItemsPanel) (prop: RibbonHeaderItemsPanelProp) =
        match prop with
        | RibbonHeaderItemsPanelProp.Base p -> RibbonItemsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonHeaderItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
