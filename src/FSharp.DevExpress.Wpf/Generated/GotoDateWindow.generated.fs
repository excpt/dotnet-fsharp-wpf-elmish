...
type GotoDateWindowProp =
    | Base of ThemedWindowProp

module GotoDateWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.GotoDateWindow) (prop: GotoDateWindowProp) =
        match prop with
        | GotoDateWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.GotoDateWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
