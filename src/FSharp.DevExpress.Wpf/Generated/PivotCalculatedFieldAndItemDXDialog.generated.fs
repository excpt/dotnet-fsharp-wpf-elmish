...
type PivotCalculatedFieldAndItemDXDialogProp =
    | Base of CustomDXDialogProp

module PivotCalculatedFieldAndItemDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotCalculatedFieldAndItemDXDialog) (prop: PivotCalculatedFieldAndItemDXDialogProp) =
        match prop with
        | PivotCalculatedFieldAndItemDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotCalculatedFieldAndItemDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
