...
type BarCodePainterProp =
    | Symbology of DevExpress.Xpf.Editors.BarCodeStyleSettings
    | BarCodeEdit of DevExpress.Xpf.Editors.BarCodeEdit

module BarCodePainter =
    let symbology v : obj = box (BarCodePainterProp.Symbology v)
    let barCodeEdit v : obj = box (BarCodePainterProp.BarCodeEdit v)

    let apply (el: DevExpress.Xpf.Editors.Internal.BarCodePainter) (prop: BarCodePainterProp) =
        match prop with
        | BarCodePainterProp.Symbology v -> el.SetValue(DevExpress.Xpf.Editors.Internal.BarCodePainter.SymbologyProperty, box v)
        | BarCodePainterProp.BarCodeEdit v -> el.SetValue(DevExpress.Xpf.Editors.Internal.BarCodePainter.BarCodeEditProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.BarCodePainter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
