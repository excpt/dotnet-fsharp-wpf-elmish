...
type FieldHeaderBaseProp =
    | DragElementTemplate of System.Windows.DataTemplate
    | ChangeFieldSortOrder of System.Windows.Input.ICommand
    | DisplayText of string

module FieldHeaderBase =
    ...
    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldHeaderBase) (prop: FieldHeaderBaseProp) =
        match prop with
        | FieldHeaderBaseProp.DragElementTemplate v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderBase.DragElementTemplateProperty, box v)
        | FieldHeaderBaseProp.ChangeFieldSortOrder v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderBase.ChangeFieldSortOrderProperty, box v)
        | FieldHeaderBaseProp.DisplayText v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderBase.DisplayTextProperty, box v)
    ...
    let field (v: DevExpress.Xpf.PivotGrid.PivotGridField) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderBase.FieldProperty, box v)) :: node.Props }
