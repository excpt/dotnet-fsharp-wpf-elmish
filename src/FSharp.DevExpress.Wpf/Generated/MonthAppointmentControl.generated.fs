...
type MonthAppointmentControlProp =
    | Base of AppointmentHorizontalControlProp

module MonthAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthAppointmentControl) (prop: MonthAppointmentControlProp) =
        match prop with
        | MonthAppointmentControlProp.Base p -> AppointmentHorizontalControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MonthAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
