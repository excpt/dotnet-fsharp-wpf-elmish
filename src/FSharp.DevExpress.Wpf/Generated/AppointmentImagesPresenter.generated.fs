...
type AppointmentImagesPresenterProp =
    | Base of RotatablePanelBaseProp

module AppointmentImagesPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPresenter) (prop: AppointmentImagesPresenterProp) =
        match prop with
        | AppointmentImagesPresenterProp.Base p -> RotatablePanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
