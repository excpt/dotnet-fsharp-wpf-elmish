...
type IStyleLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module IStyleLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleLinearScaleLevelBarForegroundControl) (prop: IStyleLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | IStyleLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
