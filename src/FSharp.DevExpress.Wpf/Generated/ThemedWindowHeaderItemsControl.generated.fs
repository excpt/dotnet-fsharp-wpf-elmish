...
type ThemedWindowHeaderItemsControlProp =
    | Base of ThemedWindowHeaderItemsControlBaseProp

module ThemedWindowHeaderItemsControl =

    let apply (el: DevExpress.Xpf.Core.ThemedWindowHeaderItemsControl) (prop: ThemedWindowHeaderItemsControlProp) =
        match prop with
        | ThemedWindowHeaderItemsControlProp.Base p -> ThemedWindowHeaderItemsControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ThemedWindowHeaderItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
