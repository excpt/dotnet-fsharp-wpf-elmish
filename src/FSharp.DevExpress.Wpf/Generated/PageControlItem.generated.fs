...
type PageControlItemProp =
    | Base of PageControlItemProp
    | Pen of System.Windows.Media.Pen
    | Page of DevExpress.Xpf.Diagram.Native.IDiagramDocumentViewerPage
    | Position of DevExpress.Xpf.DocumentViewer.PageControlItemPosition
    | IsCoverPage of bool
    | IsSelected of bool
    | PageNumber of int
    | PageWrapper of DevExpress.Xpf.DocumentViewer.PageWrapper

module PageControlItem =
    let pen v : obj = box (PageControlItemProp.Pen v)
    let page v : obj = box (PageControlItemProp.Page v)
    let position v : obj = box (PageControlItemProp.Position v)
    let isCoverPage v : obj = box (PageControlItemProp.IsCoverPage v)
    let isSelected v : obj = box (PageControlItemProp.IsSelected v)
    let pageNumber v : obj = box (PageControlItemProp.PageNumber v)
    let pageWrapper v : obj = box (PageControlItemProp.PageWrapper v)

    let apply (el: DevExpress.Xpf.Diagram.Native.PageControlItem) (prop: PageControlItemProp) =
        match prop with
        | PageControlItemProp.Base p -> PageControlItem.apply el p
        | PageControlItemProp.Pen v -> el.SetValue(DevExpress.Xpf.Diagram.Native.PageControlItem.PenProperty, box v)
        | PageControlItemProp.Page v -> el.SetValue(DevExpress.Xpf.Diagram.Native.PageControlItem.PageProperty, box v)
        | PageControlItemProp.Position v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControlItem.PositionProperty, box v)
        | PageControlItemProp.IsCoverPage v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControlItem.IsCoverPageProperty, box v)
        | PageControlItemProp.IsSelected v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControlItem.IsSelectedProperty, box v)
        | PageControlItemProp.PageNumber v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControlItem.PageNumberProperty, box v)
        | PageControlItemProp.PageWrapper v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControlItem.PageWrapperProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.PageControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
