...
type DataProviderLegendProp =
    | Base of MapLegendBaseProp

module DataProviderLegend =

    let apply (el: DevExpress.Xpf.Map.DataProviderLegend) (prop: DataProviderLegendProp) =
        match prop with
        | DataProviderLegendProp.Base p -> MapLegendBase.apply el p
