...
type FibonacciRetracementProp =
    | Base of FibonacciIndicatorProp
    | ShowAdditionalLevels of bool

module FibonacciRetracement =
    let showAdditionalLevels v : obj = box (FibonacciRetracementProp.ShowAdditionalLevels v)

    let apply (el: DevExpress.Xpf.Charts.FibonacciRetracement) (prop: FibonacciRetracementProp) =
        match prop with
        | FibonacciRetracementProp.Base p -> FibonacciIndicator.apply el p
        | FibonacciRetracementProp.ShowAdditionalLevels v -> el.SetValue(DevExpress.Xpf.Charts.FibonacciRetracement.ShowAdditionalLevelsProperty, box v)

    let showLevel23_6 v : obj = box (FibonacciIndicatorProp.ShowLevel23_6 v)
    let showLevel76_4 v : obj = box (FibonacciIndicatorProp.ShowLevel76_4 v)
    let label v : obj = box (FibonacciIndicatorProp.Label v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FibonacciRetracement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
