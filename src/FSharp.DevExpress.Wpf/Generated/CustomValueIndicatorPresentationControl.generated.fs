...
type CustomValueIndicatorPresentationControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CustomValueIndicatorPresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.CustomValueIndicatorPresentationControl) (prop: CustomValueIndicatorPresentationControlProp) =
        match prop with
        | CustomValueIndicatorPresentationControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CustomValueIndicatorPresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
