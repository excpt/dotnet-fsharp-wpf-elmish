...
type RotatablePanelBaseProp =
    | Orientation of System.Windows.Controls.Orientation

module RotatablePanelBase =
    let orientation v : obj = box (RotatablePanelBaseProp.Orientation v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.RotatablePanelBase) (prop: RotatablePanelBaseProp) =
        match prop with
        | RotatablePanelBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.RotatablePanelBase.OrientationProperty, box v)
