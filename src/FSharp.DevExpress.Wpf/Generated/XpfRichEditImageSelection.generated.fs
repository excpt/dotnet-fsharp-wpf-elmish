...
type XpfRichEditImageSelectionProp =
    | HotSize of float

module XpfRichEditImageSelection =
    let hotSize v : obj = box (XpfRichEditImageSelectionProp.HotSize v)

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditImageSelection) (prop: XpfRichEditImageSelectionProp) =
        match prop with
        | XpfRichEditImageSelectionProp.HotSize v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditImageSelection.HotSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.XpfRichEditImageSelection>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
