...
type WatermarkEditorProp =
    | Base of DXWindowProp
    | Model of DevExpress.Xpf.Printing.Native.LegacyWatermarkEditorViewModel

module WatermarkEditor =
    let model v : obj = box (WatermarkEditorProp.Model v)

    let apply (el: DevExpress.Xpf.Printing.Native.WatermarkEditor) (prop: WatermarkEditorProp) =
        match prop with
        | WatermarkEditorProp.Base p -> DXWindow.apply el p
        | WatermarkEditorProp.Model v -> el.SetValue(DevExpress.Xpf.Printing.Native.WatermarkEditor.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.WatermarkEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
