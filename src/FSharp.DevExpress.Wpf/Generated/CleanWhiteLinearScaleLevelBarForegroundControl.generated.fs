...
type CleanWhiteLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module CleanWhiteLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteLinearScaleLevelBarForegroundControl) (prop: CleanWhiteLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | CleanWhiteLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
