...
type SplitLayoutPanelProp =
    | Content1 of System.Windows.UIElement
    | Content1Location of System.Windows.Controls.Dock
    | Content2 of System.Windows.UIElement
    | SingleContent1Margin of System.Windows.Thickness
    | TopContent1Margin of System.Windows.Thickness
    | LeftContent1Margin of System.Windows.Thickness
    | RightContent1Margin of System.Windows.Thickness
    | BottomContent1Margin of System.Windows.Thickness
    | SingleContent2Margin of System.Windows.Thickness
    | TopContent2Margin of System.Windows.Thickness
    | LeftContent2Margin of System.Windows.Thickness
    | RightContent2Margin of System.Windows.Thickness
    | BottomContent2Margin of System.Windows.Thickness
    | MaximizeContent1 of bool

module SplitLayoutPanel =
    let content1 v : obj = box (SplitLayoutPanelProp.Content1 v)
    let content1Location v : obj = box (SplitLayoutPanelProp.Content1Location v)
    let content2 v : obj = box (SplitLayoutPanelProp.Content2 v)
    let singleContent1Margin v : obj = box (SplitLayoutPanelProp.SingleContent1Margin v)
    let topContent1Margin v : obj = box (SplitLayoutPanelProp.TopContent1Margin v)
    let leftContent1Margin v : obj = box (SplitLayoutPanelProp.LeftContent1Margin v)
    let rightContent1Margin v : obj = box (SplitLayoutPanelProp.RightContent1Margin v)
    let bottomContent1Margin v : obj = box (SplitLayoutPanelProp.BottomContent1Margin v)
    let singleContent2Margin v : obj = box (SplitLayoutPanelProp.SingleContent2Margin v)
    let topContent2Margin v : obj = box (SplitLayoutPanelProp.TopContent2Margin v)
    let leftContent2Margin v : obj = box (SplitLayoutPanelProp.LeftContent2Margin v)
    let rightContent2Margin v : obj = box (SplitLayoutPanelProp.RightContent2Margin v)
    let bottomContent2Margin v : obj = box (SplitLayoutPanelProp.BottomContent2Margin v)
    let maximizeContent1 v : obj = box (SplitLayoutPanelProp.MaximizeContent1 v)

    let apply (el: DevExpress.Xpf.Bars.SplitLayoutPanel) (prop: SplitLayoutPanelProp) =
        match prop with
        | SplitLayoutPanelProp.Content1 v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.Content1Property, box v)
        | SplitLayoutPanelProp.Content1Location v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.Content1LocationProperty, box v)
        | SplitLayoutPanelProp.Content2 v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.Content2Property, box v)
        | SplitLayoutPanelProp.SingleContent1Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.SingleContent1MarginProperty, box v)
        | SplitLayoutPanelProp.TopContent1Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.TopContent1MarginProperty, box v)
        | SplitLayoutPanelProp.LeftContent1Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.LeftContent1MarginProperty, box v)
        | SplitLayoutPanelProp.RightContent1Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.RightContent1MarginProperty, box v)
        | SplitLayoutPanelProp.BottomContent1Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.BottomContent1MarginProperty, box v)
        | SplitLayoutPanelProp.SingleContent2Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.SingleContent2MarginProperty, box v)
        | SplitLayoutPanelProp.TopContent2Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.TopContent2MarginProperty, box v)
        | SplitLayoutPanelProp.LeftContent2Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.LeftContent2MarginProperty, box v)
        | SplitLayoutPanelProp.RightContent2Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.RightContent2MarginProperty, box v)
        | SplitLayoutPanelProp.BottomContent2Margin v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.BottomContent2MarginProperty, box v)
        | SplitLayoutPanelProp.MaximizeContent1 v -> el.SetValue(DevExpress.Xpf.Bars.SplitLayoutPanel.MaximizeContent1Property, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.SplitLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
