...
type DocumentInplaceEditorBaseProp =
    | Base of InplaceEditorBaseProp

module DocumentInplaceEditorBase =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.DocumentInplaceEditorBase) (prop: DocumentInplaceEditorBaseProp) =
        match prop with
        | DocumentInplaceEditorBaseProp.Base p -> InplaceEditorBase.apply el p
