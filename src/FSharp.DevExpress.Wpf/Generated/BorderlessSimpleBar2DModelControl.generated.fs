...
type BorderlessSimpleBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module BorderlessSimpleBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderlessSimpleBar2DModelControl) (prop: BorderlessSimpleBar2DModelControlProp) =
        match prop with
        | BorderlessSimpleBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderlessSimpleBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
