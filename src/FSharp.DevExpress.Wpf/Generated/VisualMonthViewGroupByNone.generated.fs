...
type VisualMonthViewGroupByNoneProp =
    | Base of VisualResourcesBasedViewInfoProp

module VisualMonthViewGroupByNone =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualMonthViewGroupByNone) (prop: VisualMonthViewGroupByNoneProp) =
        match prop with
        | VisualMonthViewGroupByNoneProp.Base p -> VisualResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualMonthViewGroupByNone>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
