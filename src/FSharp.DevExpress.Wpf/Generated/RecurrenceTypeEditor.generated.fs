...
type RecurrenceTypeEditorProp =
    | RecurrenceType of DevExpress.XtraScheduler.RecurrenceType
    | RecurrenceTypes of obj
    | IsReadOnly of bool

module RecurrenceTypeEditor =
    let recurrenceType v : obj = box (RecurrenceTypeEditorProp.RecurrenceType v)
    let recurrenceTypes v : obj = box (RecurrenceTypeEditorProp.RecurrenceTypes v)
    let isReadOnly v : obj = box (RecurrenceTypeEditorProp.IsReadOnly v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RecurrenceTypeEditor) (prop: RecurrenceTypeEditorProp) =
        match prop with
        | RecurrenceTypeEditorProp.RecurrenceType v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceTypeEditor.RecurrenceTypeProperty, box v)
        | RecurrenceTypeEditorProp.RecurrenceTypes v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceTypeEditor.RecurrenceTypesProperty, box v)
        | RecurrenceTypeEditorProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceTypeEditor.IsReadOnlyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RecurrenceTypeEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
