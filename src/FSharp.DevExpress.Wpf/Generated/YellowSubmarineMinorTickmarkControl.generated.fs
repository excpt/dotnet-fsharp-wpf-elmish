...
type YellowSubmarineMinorTickmarkControlProp =
    | Base of PresentationControlProp

module YellowSubmarineMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineMinorTickmarkControl) (prop: YellowSubmarineMinorTickmarkControlProp) =
        match prop with
        | YellowSubmarineMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
