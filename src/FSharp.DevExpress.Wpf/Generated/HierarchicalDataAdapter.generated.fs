...
type HierarchicalDataAdapterProp =
    | Base of HierarchicalDataAdapterBaseProp
    | ChildrenSelector of DevExpress.Xpf.Charts.IChildrenSelector

module HierarchicalDataAdapter =
    let childrenSelector v : obj = box (HierarchicalDataAdapterProp.ChildrenSelector v)

    let apply (el: DevExpress.Xpf.Charts.HierarchicalDataAdapter) (prop: HierarchicalDataAdapterProp) =
        match prop with
        | HierarchicalDataAdapterProp.Base p -> HierarchicalDataAdapterBase.apply el p
        | HierarchicalDataAdapterProp.ChildrenSelector v -> el.SetValue(DevExpress.Xpf.Charts.HierarchicalDataAdapter.ChildrenSelectorProperty, box v)

    let dataSource v : obj = box (HierarchicalDataAdapterBaseProp.DataSource v)
    let breadcrumbTextProvider v : obj = box (HierarchicalDataAdapterBaseProp.BreadcrumbTextProvider v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.HierarchicalDataAdapter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
