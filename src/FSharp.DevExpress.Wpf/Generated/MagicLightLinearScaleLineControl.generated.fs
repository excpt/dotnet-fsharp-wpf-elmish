...
type MagicLightLinearScaleLineControlProp =
    | Base of PresentationControlProp

module MagicLightLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightLinearScaleLineControl) (prop: MagicLightLinearScaleLineControlProp) =
        match prop with
        | MagicLightLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
