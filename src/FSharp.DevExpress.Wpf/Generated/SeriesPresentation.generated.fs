...
type SeriesPresentationProp =
    | Base of SeriesPresentationBaseProp

module SeriesPresentation =

    let apply (el: DevExpress.Xpf.Charts.SeriesPresentation) (prop: SeriesPresentationProp) =
        match prop with
        | SeriesPresentationProp.Base p -> SeriesPresentationBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
