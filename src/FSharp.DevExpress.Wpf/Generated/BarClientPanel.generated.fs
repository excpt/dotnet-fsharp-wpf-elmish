...
type BarClientPanelProp =
    | QuickCustomizationButton of DevExpress.Xpf.Bars.BarQuickCustomizationButton
    | QuickCustomizationButtonShowMode of obj
    | HorizontalIndent of float

module BarClientPanel =
    let quickCustomizationButton v : obj = box (BarClientPanelProp.QuickCustomizationButton v)
    let quickCustomizationButtonShowMode v : obj = box (BarClientPanelProp.QuickCustomizationButtonShowMode v)
    let horizontalIndent v : obj = box (BarClientPanelProp.HorizontalIndent v)

    let apply (el: DevExpress.Xpf.Bars.BarClientPanel) (prop: BarClientPanelProp) =
        match prop with
        | BarClientPanelProp.QuickCustomizationButton v -> el.SetValue(DevExpress.Xpf.Bars.BarClientPanel.QuickCustomizationButtonProperty, box v)
        | BarClientPanelProp.QuickCustomizationButtonShowMode v -> el.SetValue(DevExpress.Xpf.Bars.BarClientPanel.QuickCustomizationButtonShowModeProperty, box v)
        | BarClientPanelProp.HorizontalIndent v -> el.SetValue(DevExpress.Xpf.Bars.BarClientPanel.HorizontalIndentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarClientPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
