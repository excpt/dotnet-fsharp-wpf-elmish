...
type DefaultSizeDecoratorProp =
    | DefaultChildWidth of float
    | DefaultChildHeight of float

module DefaultSizeDecorator =
    let defaultChildWidth v : obj = box (DefaultSizeDecoratorProp.DefaultChildWidth v)
    let defaultChildHeight v : obj = box (DefaultSizeDecoratorProp.DefaultChildHeight v)

    let apply (el: DevExpress.Xpf.Core.Native.DefaultSizeDecorator) (prop: DefaultSizeDecoratorProp) =
        match prop with
        | DefaultSizeDecoratorProp.DefaultChildWidth v -> el.SetValue(DevExpress.Xpf.Core.Native.DefaultSizeDecorator.DefaultChildWidthProperty, box v)
        | DefaultSizeDecoratorProp.DefaultChildHeight v -> el.SetValue(DevExpress.Xpf.Core.Native.DefaultSizeDecorator.DefaultChildHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.DefaultSizeDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
