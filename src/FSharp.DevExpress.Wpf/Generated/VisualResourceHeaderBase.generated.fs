...
type VisualResourceHeaderBaseProp =
    | Base of VisualResourceCellBaseProp

module VisualResourceHeaderBase =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualResourceHeaderBase) (prop: VisualResourceHeaderBaseProp) =
        match prop with
        | VisualResourceHeaderBaseProp.Base p -> VisualResourceCellBase.apply el p
