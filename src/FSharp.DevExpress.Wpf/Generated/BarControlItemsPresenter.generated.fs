...
type BarControlItemsPresenterProp =
    | Base of ItemsPresenterProp
    | QuickCustomizationButtonStyle of System.Windows.Style
    | ShowBackground of bool

module BarControlItemsPresenter =
    let quickCustomizationButtonStyle v : obj = box (BarControlItemsPresenterProp.QuickCustomizationButtonStyle v)
    let showBackground v : obj = box (BarControlItemsPresenterProp.ShowBackground v)

    let apply (el: DevExpress.Xpf.Bars.BarControlItemsPresenter) (prop: BarControlItemsPresenterProp) =
        match prop with
        | BarControlItemsPresenterProp.Base p -> ItemsPresenter.apply el p
        | BarControlItemsPresenterProp.QuickCustomizationButtonStyle v -> el.SetValue(DevExpress.Xpf.Bars.BarControlItemsPresenter.QuickCustomizationButtonStyleProperty, box v)
        | BarControlItemsPresenterProp.ShowBackground v -> el.SetValue(DevExpress.Xpf.Bars.BarControlItemsPresenter.ShowBackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarControlItemsPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
