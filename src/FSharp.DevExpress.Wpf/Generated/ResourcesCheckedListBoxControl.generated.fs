...
type ResourcesCheckedListBoxControlProp =
    | Base of ListBoxEditProp
    | SchedulerControl of DevExpress.Xpf.Scheduler.SchedulerControl

module ResourcesCheckedListBoxControl =
    let schedulerControl v : obj = box (ResourcesCheckedListBoxControlProp.SchedulerControl v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.ResourcesCheckedListBoxControl) (prop: ResourcesCheckedListBoxControlProp) =
        match prop with
        | ResourcesCheckedListBoxControlProp.Base p -> ListBoxEdit.apply el p
        | ResourcesCheckedListBoxControlProp.SchedulerControl v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.ResourcesCheckedListBoxControl.SchedulerControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.ResourcesCheckedListBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
