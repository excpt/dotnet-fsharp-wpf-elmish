...
type CosmicArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CosmicArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicArcScaleNeedleControl) (prop: CosmicArcScaleNeedleControlProp) =
        match prop with
        | CosmicArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
