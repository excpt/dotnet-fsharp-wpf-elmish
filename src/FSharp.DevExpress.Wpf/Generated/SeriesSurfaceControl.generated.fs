...
type SeriesSurfaceControlProp =
    | Base of SeriesSurfaceControlBaseProp

module SeriesSurfaceControl =

    let apply (el: DevExpress.Xpf.Charts.SeriesSurfaceControl) (prop: SeriesSurfaceControlProp) =
        match prop with
        | SeriesSurfaceControlProp.Base p -> SeriesSurfaceControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesSurfaceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
