...
open System
open System.Windows
open DevExpress.Xpf.Core.ConditionalFormatting
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ConditionalFormattingManagerViewProp =
    | Base of ManagerViewProp

module ConditionalFormattingManagerView =

    let apply (el: DevExpress.Xpf.Core.ConditionalFormatting.ConditionalFormattingManagerView) (prop: ConditionalFormattingManagerViewProp) =
        match prop with
        | ConditionalFormattingManagerViewProp.Base p -> ManagerView.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ConditionalFormatting.ConditionalFormattingManagerView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
