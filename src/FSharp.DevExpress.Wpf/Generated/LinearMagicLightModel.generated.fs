...
type LinearMagicLightModelProp =
    | Base of LinearGaugeModelProp

module LinearMagicLightModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearMagicLightModel) (prop: LinearMagicLightModelProp) =
        match prop with
        | LinearMagicLightModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearMagicLightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
