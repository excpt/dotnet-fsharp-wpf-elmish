...
type ShapeTitleTextControlProp =
    | Stroke of System.Windows.Media.SolidColorBrush

module ShapeTitleTextControl =
    let stroke v : obj = box (ShapeTitleTextControlProp.Stroke v)

    let apply (el: DevExpress.Xpf.Map.ShapeTitleTextControl) (prop: ShapeTitleTextControlProp) =
        match prop with
        | ShapeTitleTextControlProp.Stroke v -> el.SetValue(DevExpress.Xpf.Map.ShapeTitleTextControl.StrokeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.ShapeTitleTextControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
