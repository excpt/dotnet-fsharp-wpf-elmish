...
type AdditionalAreaSeriesGeometryProp =
    | Base of AdditionalStripSeriesGeometryBaseProp

module AdditionalAreaSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalAreaSeriesGeometry) (prop: AdditionalAreaSeriesGeometryProp) =
        match prop with
        | AdditionalAreaSeriesGeometryProp.Base p -> AdditionalStripSeriesGeometryBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalAreaSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
