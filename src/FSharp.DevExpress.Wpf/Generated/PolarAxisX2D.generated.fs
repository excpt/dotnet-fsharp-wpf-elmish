...
type PolarAxisX2DProp =
    | Base of CircularAxisX2DProp

module PolarAxisX2D =

    let apply (el: DevExpress.Xpf.Charts.PolarAxisX2D) (prop: PolarAxisX2DProp) =
        match prop with
        | PolarAxisX2DProp.Base p -> CircularAxisX2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarAxisX2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
