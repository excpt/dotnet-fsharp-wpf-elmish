...
type ListBoxEditProp =
    ...
    | AllowItemHighlighting of bool
    | AllowRejectUnknownValues of bool
    | ItemTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | AllowLiveDataShaping of bool
    | ShowWaitIndicator of bool
    | IncrementalSearch of bool
    | ScrollUnit of DevExpress.Xpf.Editors.ScrollUnit
    | SelectItemWithNullValue of bool
    | OnSelectedIndexChanged of System.Windows.RoutedEventHandler
    | OnItemsSourceChanged of DevExpress.Xpf.Editors.ItemsSourceChangedEventHandler

module ListBoxEdit =
    let filterCriteria v : obj = box (ListBoxEditProp.FilterCriteria v)
    let showCustomItems v : obj = box (ListBoxEditProp.ShowCustomItems v)
    let allowCollectionView v : obj = box (ListBoxEditProp.AllowCollectionView v)
    let isSynchronizedWithCurrentItem v : obj = box (ListBoxEditProp.IsSynchronizedWithCurrentItem v)
    let itemsSource v : obj = box (ListBoxEditProp.ItemsSource v)
    let selectionMode v : obj = box (ListBoxEditProp.SelectionMode v)
    let selectedItem v : obj = box (ListBoxEditProp.SelectedItem v)
    let selectedIndex v : obj = box (ListBoxEditProp.SelectedIndex v)
    let displayMember v : obj = box (ListBoxEditProp.DisplayMember v)
    let valueMember v : obj = box (ListBoxEditProp.ValueMember v)
    let itemTemplate v : obj = box (ListBoxEditProp.ItemTemplate v)
    let itemsPanel v : obj = box (ListBoxEditProp.ItemsPanel v)
    let itemContainerStyle v : obj = box (ListBoxEditProp.ItemContainerStyle v)
    let allowItemHighlighting v : obj = box (ListBoxEditProp.AllowItemHighlighting v)
    let allowRejectUnknownValues v : obj = box (ListBoxEditProp.AllowRejectUnknownValues v)
    let itemTemplateSelector v : obj = box (ListBoxEditProp.ItemTemplateSelector v)
    let allowLiveDataShaping v : obj = box (ListBoxEditProp.AllowLiveDataShaping v)
    let showWaitIndicator v : obj = box (ListBoxEditProp.ShowWaitIndicator v)
    let incrementalSearch v : obj = box (ListBoxEditProp.IncrementalSearch v)
    let scrollUnit v : obj = box (ListBoxEditProp.ScrollUnit v)
    let selectItemWithNullValue v : obj = box (ListBoxEditProp.SelectItemWithNullValue v)
    let onSelectedIndexChanged v : obj = box (EventProp(box (ListBoxEditProp.OnSelectedIndexChanged v)))
    let onItemsSourceChanged v : obj = box (EventProp(box (ListBoxEditProp.OnItemsSourceChanged v)))

    let apply (el: DevExpress.Xpf.Editors.ListBoxEdit) (prop: ListBoxEditProp) =
        match prop with
        | ListBoxEditProp.Base p -> BaseEdit.apply el p
        | ListBoxEditProp.FilterCriteria v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.FilterCriteriaProperty, box v)
        | ListBoxEditProp.ShowCustomItems v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ShowCustomItemsProperty, box v)
        | ListBoxEditProp.AllowCollectionView v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.AllowCollectionViewProperty, box v)
        | ListBoxEditProp.IsSynchronizedWithCurrentItem v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.IsSynchronizedWithCurrentItemProperty, box v)
        | ListBoxEditProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ItemsSourceProperty, box v)
        | ListBoxEditProp.SelectionMode v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.SelectionModeProperty, box v)
        | ListBoxEditProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.SelectedItemProperty, box v)
        | ListBoxEditProp.SelectedIndex v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.SelectedIndexProperty, box v)
        | ListBoxEditProp.DisplayMember v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.DisplayMemberProperty, box v)
        | ListBoxEditProp.ValueMember v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ValueMemberProperty, box v)
        | ListBoxEditProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ItemTemplateProperty, box v)
        | ListBoxEditProp.ItemsPanel v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ItemsPanelProperty, box v)
        | ListBoxEditProp.ItemContainerStyle v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ItemContainerStyleProperty, box v)
        | ListBoxEditProp.AllowItemHighlighting v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.AllowItemHighlightingProperty, box v)
        | ListBoxEditProp.AllowRejectUnknownValues v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.AllowRejectUnknownValuesProperty, box v)
        | ListBoxEditProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ItemTemplateSelectorProperty, box v)
        | ListBoxEditProp.AllowLiveDataShaping v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.AllowLiveDataShapingProperty, box v)
        | ListBoxEditProp.ShowWaitIndicator v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ShowWaitIndicatorProperty, box v)
        | ListBoxEditProp.IncrementalSearch v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.IncrementalSearchProperty, box v)
        | ListBoxEditProp.ScrollUnit v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.ScrollUnitProperty, box v)
        | ListBoxEditProp.SelectItemWithNullValue v -> el.SetValue(DevExpress.Xpf.Editors.ListBoxEdit.SelectItemWithNullValueProperty, box v)
        | ListBoxEditProp.OnSelectedIndexChanged h -> el.SelectedIndexChanged.AddHandler(h)
        | ListBoxEditProp.OnItemsSourceChanged h -> el.ItemsSourceChanged.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ListBoxEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
