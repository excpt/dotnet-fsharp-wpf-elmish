...
type MaximizableHeaderedContentControlBaseProp =
    | Base of HeaderedContentControlBaseProp
    | CurrentContentTemplate of System.Windows.DataTemplate
    | MaximizedContentTemplate of System.Windows.DataTemplate

module MaximizableHeaderedContentControlBase =
    ...
    let apply (el: DevExpress.Xpf.LayoutControl.MaximizableHeaderedContentControlBase) (prop: MaximizableHeaderedContentControlBaseProp) =
        match prop with
        | MaximizableHeaderedContentControlBaseProp.Base p -> HeaderedContentControlBase.apply el p
        | MaximizableHeaderedContentControlBaseProp.CurrentContentTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.MaximizableHeaderedContentControlBase.CurrentContentTemplateProperty, box v)
        | MaximizableHeaderedContentControlBaseProp.MaximizedContentTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.MaximizableHeaderedContentControlBase.MaximizedContentTemplateProperty, box v)
