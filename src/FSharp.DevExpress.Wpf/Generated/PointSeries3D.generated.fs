...
type PointSeries3DProp =
    | Base of MarkerSeries3DProp
    | MarkerSize of float

module PointSeries3D =
    let markerSize v : obj = box (PointSeries3DProp.MarkerSize v)

    let apply (el: DevExpress.Xpf.Charts.PointSeries3D) (prop: PointSeries3DProp) =
        match prop with
        | PointSeries3DProp.Base p -> MarkerSeries3D.apply el p
        | PointSeries3DProp.MarkerSize v -> el.SetValue(DevExpress.Xpf.Charts.PointSeries3D.MarkerSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PointSeries3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
