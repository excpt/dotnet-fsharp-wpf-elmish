...
type CircularYellowSubmarineQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularYellowSubmarineQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularYellowSubmarineQuarterTopLeftModel) (prop: CircularYellowSubmarineQuarterTopLeftModelProp) =
        match prop with
        | CircularYellowSubmarineQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularYellowSubmarineQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
