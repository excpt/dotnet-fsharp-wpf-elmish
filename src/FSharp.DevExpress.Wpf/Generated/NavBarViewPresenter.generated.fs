...
type NavBarViewPresenterProp =
    | View of DevExpress.Xpf.NavBar.NavBarViewBase

module NavBarViewPresenter =
    let view v : obj = box (NavBarViewPresenterProp.View v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarViewPresenter) (prop: NavBarViewPresenterProp) =
        match prop with
        | NavBarViewPresenterProp.View v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewPresenter.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarViewPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
