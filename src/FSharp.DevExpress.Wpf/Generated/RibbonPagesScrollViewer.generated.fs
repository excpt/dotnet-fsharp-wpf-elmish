...
type RibbonPagesScrollViewerProp =
    | IWindowService of obj

module RibbonPagesScrollViewer =
    let iWindowService v : obj = box (RibbonPagesScrollViewerProp.IWindowService v)

    let apply (el: DevExpress.Xpf.Ribbon.Internal.RibbonPagesScrollViewer) (prop: RibbonPagesScrollViewerProp) =
        match prop with
        | RibbonPagesScrollViewerProp.IWindowService v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonPagesScrollViewer.IWindowServiceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.RibbonPagesScrollViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
