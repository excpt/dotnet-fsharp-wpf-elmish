...
type DocumentPreviewRibbonControllerProp =
    | Base of TemplatedRibbonControllerProp
    | DocumentViewer of DevExpress.Xpf.Printing.DocumentViewer

module DocumentPreviewRibbonController =
    let documentViewer v : obj = box (DocumentPreviewRibbonControllerProp.DocumentViewer v)

    let apply (el: DevExpress.Xpf.Printing.DocumentPreviewRibbonController) (prop: DocumentPreviewRibbonControllerProp) =
        match prop with
        | DocumentPreviewRibbonControllerProp.Base p -> TemplatedRibbonController.apply el p
        | DocumentPreviewRibbonControllerProp.DocumentViewer v -> el.SetValue(DevExpress.Xpf.Printing.DocumentPreviewRibbonController.DocumentViewerProperty, box v)

    let template v : obj = box (TemplatedRibbonControllerProp.Template v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.DocumentPreviewRibbonController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
