...
type ArrowUpStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowUpStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowUpStatePresentationControl) (prop: ArrowUpStatePresentationControlProp) =
        match prop with
        | ArrowUpStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowUpStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
