...
type AdditionalSeriesHighlightedPointGeometryProp =
    | Base of AdditionalSeriesPointGeometryProp

module AdditionalSeriesHighlightedPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSeriesHighlightedPointGeometry) (prop: AdditionalSeriesHighlightedPointGeometryProp) =
        match prop with
        | AdditionalSeriesHighlightedPointGeometryProp.Base p -> AdditionalSeriesPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSeriesHighlightedPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
