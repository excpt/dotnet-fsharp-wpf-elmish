...
type NavPaneGroupButtonPanelContentPresenterProp =
    | WithoutSplitterThickness of System.Windows.Thickness
    | WithSplitterThickness of System.Windows.Thickness

module NavPaneGroupButtonPanelContentPresenter =
    let withoutSplitterThickness v : obj = box (NavPaneGroupButtonPanelContentPresenterProp.WithoutSplitterThickness v)
    let withSplitterThickness v : obj = box (NavPaneGroupButtonPanelContentPresenterProp.WithSplitterThickness v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneGroupButtonPanelContentPresenter) (prop: NavPaneGroupButtonPanelContentPresenterProp) =
        match prop with
        | NavPaneGroupButtonPanelContentPresenterProp.WithoutSplitterThickness v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButtonPanelContentPresenter.WithoutSplitterThicknessProperty, box v)
        | NavPaneGroupButtonPanelContentPresenterProp.WithSplitterThickness v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneGroupButtonPanelContentPresenter.WithSplitterThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneGroupButtonPanelContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
