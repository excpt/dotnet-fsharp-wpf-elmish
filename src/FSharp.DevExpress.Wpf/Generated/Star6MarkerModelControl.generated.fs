...
type Star6MarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module Star6MarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.Star6MarkerModelControl) (prop: Star6MarkerModelControlProp) =
        match prop with
        | Star6MarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.Star6MarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
