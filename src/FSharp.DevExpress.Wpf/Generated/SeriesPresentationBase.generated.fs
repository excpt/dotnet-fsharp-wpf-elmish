...
type SeriesPresentationBaseProp =
    | Base of ChartElementBaseProp

module SeriesPresentationBase =

    let apply (el: DevExpress.Xpf.Charts.SeriesPresentationBase) (prop: SeriesPresentationBaseProp) =
        match prop with
        | SeriesPresentationBaseProp.Base p -> ChartElementBase.apply el p
