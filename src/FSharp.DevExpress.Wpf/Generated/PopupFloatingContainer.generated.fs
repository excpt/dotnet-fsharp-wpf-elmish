...
type PopupFloatingContainerProp =
    | Base of FloatingContainerProp

module PopupFloatingContainer =

    let apply (el: DevExpress.Xpf.Core.PopupFloatingContainer) (prop: PopupFloatingContainerProp) =
        match prop with
        | PopupFloatingContainerProp.Base p -> FloatingContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PopupFloatingContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
