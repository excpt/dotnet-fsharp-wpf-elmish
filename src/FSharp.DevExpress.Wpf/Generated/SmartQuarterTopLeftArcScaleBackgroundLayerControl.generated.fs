...
type SmartQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartQuarterTopLeftArcScaleBackgroundLayerControl) (prop: SmartQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | SmartQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
