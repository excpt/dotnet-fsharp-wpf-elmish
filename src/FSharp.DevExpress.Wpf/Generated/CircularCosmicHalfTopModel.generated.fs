...
type CircularCosmicHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCosmicHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCosmicHalfTopModel) (prop: CircularCosmicHalfTopModelProp) =
        match prop with
        | CircularCosmicHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCosmicHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
