...
type CompletionWizardPageProp =
    | Base of WizardPageProp

module CompletionWizardPage =

    let apply (el: DevExpress.Xpf.Controls.CompletionWizardPage) (prop: CompletionWizardPageProp) =
        match prop with
        | CompletionWizardPageProp.Base p -> WizardPage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.CompletionWizardPage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
