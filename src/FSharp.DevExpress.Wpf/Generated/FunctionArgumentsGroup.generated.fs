...
type FunctionArgumentsGroupProp =
    | Base of LayoutGroupProp
    | CurrentItemIndex of int
    | UnlimitedArguments of bool

module FunctionArgumentsGroup =
    let currentItemIndex v : obj = box (FunctionArgumentsGroupProp.CurrentItemIndex v)
    let unlimitedArguments v : obj = box (FunctionArgumentsGroupProp.UnlimitedArguments v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.FunctionArgumentsGroup) (prop: FunctionArgumentsGroupProp) =
        match prop with
        | FunctionArgumentsGroupProp.Base p -> LayoutGroup.apply el p
        | FunctionArgumentsGroupProp.CurrentItemIndex v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Forms.FunctionArgumentsGroup.CurrentItemIndexProperty, box v)
        | FunctionArgumentsGroupProp.UnlimitedArguments v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Forms.FunctionArgumentsGroup.UnlimitedArgumentsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.FunctionArgumentsGroup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
