...
type AppointmentDescriptionPresenterProp =
    | Base of FastTextBlockProp
    | SeparatorThickness of float
    | SeparatorBrush of System.Windows.Media.Brush

module AppointmentDescriptionPresenter =
    let separatorThickness v : obj = box (AppointmentDescriptionPresenterProp.SeparatorThickness v)
    let separatorBrush v : obj = box (AppointmentDescriptionPresenterProp.SeparatorBrush v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentDescriptionPresenter) (prop: AppointmentDescriptionPresenterProp) =
        match prop with
        | AppointmentDescriptionPresenterProp.Base p -> FastTextBlock.apply el p
        | AppointmentDescriptionPresenterProp.SeparatorThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentDescriptionPresenter.SeparatorThicknessProperty, box v)
        | AppointmentDescriptionPresenterProp.SeparatorBrush v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentDescriptionPresenter.SeparatorBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentDescriptionPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
