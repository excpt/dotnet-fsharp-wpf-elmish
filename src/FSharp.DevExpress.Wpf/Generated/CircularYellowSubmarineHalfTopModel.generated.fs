...
type CircularYellowSubmarineHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularYellowSubmarineHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularYellowSubmarineHalfTopModel) (prop: CircularYellowSubmarineHalfTopModelProp) =
        match prop with
        | CircularYellowSubmarineHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularYellowSubmarineHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
