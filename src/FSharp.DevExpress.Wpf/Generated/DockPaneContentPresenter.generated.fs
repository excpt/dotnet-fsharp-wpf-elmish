...
type DockPaneContentPresenterProp =
    | BarContainerMargin of System.Windows.Thickness
    | ContentMargin of System.Windows.Thickness

module DockPaneContentPresenter =
    let barContainerMargin v : obj = box (DockPaneContentPresenterProp.BarContainerMargin v)
    let contentMargin v : obj = box (DockPaneContentPresenterProp.ContentMargin v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockPaneContentPresenter) (prop: DockPaneContentPresenterProp) =
        match prop with
        | DockPaneContentPresenterProp.BarContainerMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockPaneContentPresenter.BarContainerMarginProperty, box v)
        | DockPaneContentPresenterProp.ContentMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockPaneContentPresenter.ContentMarginProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockPaneContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
