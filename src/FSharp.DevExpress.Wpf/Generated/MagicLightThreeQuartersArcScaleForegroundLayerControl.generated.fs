...
type MagicLightThreeQuartersArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightThreeQuartersArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightThreeQuartersArcScaleForegroundLayerControl) (prop: MagicLightThreeQuartersArcScaleForegroundLayerControlProp) =
        match prop with
        | MagicLightThreeQuartersArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightThreeQuartersArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
