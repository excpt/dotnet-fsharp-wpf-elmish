...
type MapScrollButtonsProp =
    | Base of MapButtonBaseProp

module MapScrollButtons =

    let apply (el: DevExpress.Xpf.Map.MapScrollButtons) (prop: MapScrollButtonsProp) =
        match prop with
        | MapScrollButtonsProp.Base p -> MapButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapScrollButtons>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
