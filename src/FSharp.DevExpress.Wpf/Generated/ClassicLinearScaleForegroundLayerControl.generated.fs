...
type ClassicLinearScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicLinearScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicLinearScaleForegroundLayerControl) (prop: ClassicLinearScaleForegroundLayerControlProp) =
        match prop with
        | ClassicLinearScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicLinearScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
