...
module PopupBase =
    ...
    let apply (el: DevExpress.Xpf.Core.PopupBase) (prop: PopupBaseProp) =
        match prop with
        | PopupBaseProp.PopupContent v -> el.SetValue(DevExpress.Xpf.Core.PopupBase.PopupContentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PopupBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
