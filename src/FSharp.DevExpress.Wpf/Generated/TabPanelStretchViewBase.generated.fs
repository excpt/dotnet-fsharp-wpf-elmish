...
type TabPanelStretchViewBaseProp =
    | Base of TabPanelBaseProp
    | NormalChildSize of int
    | NormalChildMinSize of int
    | ActiveChildMinSize of int
    | PinChildLeftSize of int
    | PinChildRightSize of int
    | PinPanelLeftIndent of int
    | PinPanelRightIndent of int
    | TransparencySize of int
    | AlwaysShowActiveChild of bool

module TabPanelStretchViewBase =
    let normalChildSize v : obj = box (TabPanelStretchViewBaseProp.NormalChildSize v)
    let normalChildMinSize v : obj = box (TabPanelStretchViewBaseProp.NormalChildMinSize v)
    let activeChildMinSize v : obj = box (TabPanelStretchViewBaseProp.ActiveChildMinSize v)
    let pinChildLeftSize v : obj = box (TabPanelStretchViewBaseProp.PinChildLeftSize v)
    let pinChildRightSize v : obj = box (TabPanelStretchViewBaseProp.PinChildRightSize v)
    let pinPanelLeftIndent v : obj = box (TabPanelStretchViewBaseProp.PinPanelLeftIndent v)
    let pinPanelRightIndent v : obj = box (TabPanelStretchViewBaseProp.PinPanelRightIndent v)
    let transparencySize v : obj = box (TabPanelStretchViewBaseProp.TransparencySize v)
    let alwaysShowActiveChild v : obj = box (TabPanelStretchViewBaseProp.AlwaysShowActiveChild v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelStretchViewBase) (prop: TabPanelStretchViewBaseProp) =
        match prop with
        | TabPanelStretchViewBaseProp.Base p -> TabPanelBase.apply el p
        | TabPanelStretchViewBaseProp.NormalChildSize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.NormalChildSizeProperty, box v)
        | TabPanelStretchViewBaseProp.NormalChildMinSize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.NormalChildMinSizeProperty, box v)
        | TabPanelStretchViewBaseProp.ActiveChildMinSize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.ActiveChildMinSizeProperty, box v)
        | TabPanelStretchViewBaseProp.PinChildLeftSize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.PinChildLeftSizeProperty, box v)
        | TabPanelStretchViewBaseProp.PinChildRightSize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.PinChildRightSizeProperty, box v)
        | TabPanelStretchViewBaseProp.PinPanelLeftIndent v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.PinPanelLeftIndentProperty, box v)
        | TabPanelStretchViewBaseProp.PinPanelRightIndent v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.PinPanelRightIndentProperty, box v)
        | TabPanelStretchViewBaseProp.TransparencySize v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.TransparencySizeProperty, box v)
        | TabPanelStretchViewBaseProp.AlwaysShowActiveChild v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchViewBase.AlwaysShowActiveChildProperty, box v)

    let selectedIndex v : obj = box (TabPanelBaseProp.SelectedIndex v)
    let headerLocation v : obj = box (TabPanelBaseProp.HeaderLocation v)
    let orientation v : obj = box (DXPanelBaseProp.Orientation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabPanelStretchViewBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
