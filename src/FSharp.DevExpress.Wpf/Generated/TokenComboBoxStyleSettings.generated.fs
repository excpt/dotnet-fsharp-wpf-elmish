...
type TokenComboBoxStyleSettingsProp =
    | Base of ComboBoxStyleSettingsProp
...
module TokenComboBoxStyleSettings =
    let showTokenButtons v : obj = box (TokenComboBoxStyleSettingsProp.ShowTokenButtons v)
    let tokenBorderTemplate v : obj = box (TokenComboBoxStyleSettingsProp.TokenBorderTemplate v)
    let enableTokenWrapping v : obj = box (TokenComboBoxStyleSettingsProp.EnableTokenWrapping v)
    let newTokenPosition v : obj = box (TokenComboBoxStyleSettingsProp.NewTokenPosition v)
    let tokenTextTrimming v : obj = box (TokenComboBoxStyleSettingsProp.TokenTextTrimming v)
    let tokenMaxWidth v : obj = box (TokenComboBoxStyleSettingsProp.TokenMaxWidth v)
    let allowEditTokens v : obj = box (TokenComboBoxStyleSettingsProp.AllowEditTokens v)
    let tokenStyle v : obj = box (TokenComboBoxStyleSettingsProp.TokenStyle v)
    let newTokenText v : obj = box (TokenComboBoxStyleSettingsProp.NewTokenText v)

    let apply (el: DevExpress.Xpf.Editors.TokenComboBoxStyleSettings) (prop: TokenComboBoxStyleSettingsProp) =
        match prop with
        | TokenComboBoxStyleSettingsProp.Base p -> ComboBoxStyleSettings.apply el p
        | TokenComboBoxStyleSettingsProp.ShowTokenButtons v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.ShowTokenButtonsProperty, box v)
        | TokenComboBoxStyleSettingsProp.TokenBorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.TokenBorderTemplateProperty, box v)
        | TokenComboBoxStyleSettingsProp.EnableTokenWrapping v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.EnableTokenWrappingProperty, box v)
        | TokenComboBoxStyleSettingsProp.NewTokenPosition v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.NewTokenPositionProperty, box v)
        | TokenComboBoxStyleSettingsProp.TokenTextTrimming v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.TokenTextTrimmingProperty, box v)
        | TokenComboBoxStyleSettingsProp.TokenMaxWidth v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.TokenMaxWidthProperty, box v)
        | TokenComboBoxStyleSettingsProp.AllowEditTokens v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.AllowEditTokensProperty, box v)
        | TokenComboBoxStyleSettingsProp.TokenStyle v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.TokenStyleProperty, box v)
        | TokenComboBoxStyleSettingsProp.NewTokenText v -> el.SetValue(DevExpress.Xpf.Editors.TokenComboBoxStyleSettings.NewTokenTextProperty, box v)

    let showEmptyItem v : obj = box (ComboBoxStyleSettingsProp.ShowEmptyItem v)
    let emptyItemText v : obj = box (ComboBoxStyleSettingsProp.EmptyItemText v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.TokenComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
