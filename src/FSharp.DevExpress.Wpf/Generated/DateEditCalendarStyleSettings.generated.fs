...
type DateEditCalendarStyleSettingsProp =
    | Base of DateEditStyleSettingsBaseProp

module DateEditCalendarStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.DateEditCalendarStyleSettings) (prop: DateEditCalendarStyleSettingsProp) =
        match prop with
        | DateEditCalendarStyleSettingsProp.Base p -> DateEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateEditCalendarStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
