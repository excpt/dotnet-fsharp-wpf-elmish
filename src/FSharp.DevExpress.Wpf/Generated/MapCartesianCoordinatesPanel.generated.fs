...
type MapCartesianCoordinatesPanelProp =
    | Base of MapCoordinatesPanelProp
    | CoordX of string
    | CoordY of string
    | MeasureUnit of string

module MapCartesianCoordinatesPanel =
    let coordX v : obj = box (MapCartesianCoordinatesPanelProp.CoordX v)
    let coordY v : obj = box (MapCartesianCoordinatesPanelProp.CoordY v)
    let measureUnit v : obj = box (MapCartesianCoordinatesPanelProp.MeasureUnit v)

    let apply (el: DevExpress.Xpf.Map.MapCartesianCoordinatesPanel) (prop: MapCartesianCoordinatesPanelProp) =
        match prop with
        | MapCartesianCoordinatesPanelProp.Base p -> MapCoordinatesPanel.apply el p
        | MapCartesianCoordinatesPanelProp.CoordX v -> el.SetValue(DevExpress.Xpf.Map.MapCartesianCoordinatesPanel.CoordXProperty, box v)
        | MapCartesianCoordinatesPanelProp.CoordY v -> el.SetValue(DevExpress.Xpf.Map.MapCartesianCoordinatesPanel.CoordYProperty, box v)
        | MapCartesianCoordinatesPanelProp.MeasureUnit v -> el.SetValue(DevExpress.Xpf.Map.MapCartesianCoordinatesPanel.MeasureUnitProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapCartesianCoordinatesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
