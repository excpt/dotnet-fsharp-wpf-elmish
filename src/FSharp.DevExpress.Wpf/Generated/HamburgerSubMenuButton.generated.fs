...
type HamburgerSubMenuButtonProp =
...
module HamburgerSubMenuButton =
    let glyph v : obj = box (HamburgerSubMenuButtonProp.Glyph v)
    let glyphTemplate v : obj = box (HamburgerSubMenuButtonProp.GlyphTemplate v)
    let glyphWidth v : obj = box (HamburgerSubMenuButtonProp.GlyphWidth v)
    let glyphHeight v : obj = box (HamburgerSubMenuButtonProp.GlyphHeight v)
    let glyphStretch v : obj = box (HamburgerSubMenuButtonProp.GlyphStretch v)
    let isSelected v : obj = box (HamburgerSubMenuButtonProp.IsSelected v)
    let allowGlyphTheming v : obj = box (HamburgerSubMenuButtonProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (HamburgerSubMenuButtonProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton) (prop: HamburgerSubMenuButtonProp) =
        match prop with
        | HamburgerSubMenuButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.GlyphProperty, box v)
        | HamburgerSubMenuButtonProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.GlyphTemplateProperty, box v)
        | HamburgerSubMenuButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.GlyphWidthProperty, box v)
        | HamburgerSubMenuButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.GlyphHeightProperty, box v)
        | HamburgerSubMenuButtonProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.GlyphStretchProperty, box v)
        | HamburgerSubMenuButtonProp.IsSelected v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.IsSelectedProperty, box v)
        | HamburgerSubMenuButtonProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.AllowGlyphThemingProperty, box v)
        | HamburgerSubMenuButtonProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
