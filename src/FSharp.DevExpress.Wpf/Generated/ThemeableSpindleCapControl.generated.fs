...
type ThemeableSpindleCapControlProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableSpindleCapControl =
    let themeFill v : obj = box (ThemeableSpindleCapControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableSpindleCapControl) (prop: ThemeableSpindleCapControlProp) =
        match prop with
        | ThemeableSpindleCapControlProp.Base p -> PresentationControl.apply el p
        | ThemeableSpindleCapControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableSpindleCapControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
