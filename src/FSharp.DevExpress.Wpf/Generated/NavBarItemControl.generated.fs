...
type NavBarItemControlProp =
    ...
    | FontSettings of DevExpress.Xpf.NavBar.FontSettings
    | NavBar of DevExpress.Xpf.NavBar.NavBarControl

module NavBarItemControl =
    let displayMode v : obj = box (NavBarItemControlProp.DisplayMode v)
    let layoutSettings v : obj = box (NavBarItemControlProp.LayoutSettings v)
    let imageSettings v : obj = box (NavBarItemControlProp.ImageSettings v)
    let fontSettings v : obj = box (NavBarItemControlProp.FontSettings v)
    let navBar v : obj = box (NavBarItemControlProp.NavBar v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarItemControl) (prop: NavBarItemControlProp) =
        match prop with
        | NavBarItemControlProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarItemControl.DisplayModeProperty, box v)
        | NavBarItemControlProp.LayoutSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarItemControl.LayoutSettingsProperty, box v)
        | NavBarItemControlProp.ImageSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarItemControl.ImageSettingsProperty, box v)
        | NavBarItemControlProp.FontSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarItemControl.FontSettingsProperty, box v)
        | NavBarItemControlProp.NavBar v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarItemControl.NavBarProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
