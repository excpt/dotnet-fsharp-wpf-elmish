...
type DefaultArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module DefaultArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultArcScaleNeedleControl) (prop: DefaultArcScaleNeedleControlProp) =
        match prop with
        | DefaultArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
