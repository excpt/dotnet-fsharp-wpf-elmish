...
type OneMonthViewGroupByDateControlProp =
    | Base of OneMonthViewControlProp
    | StandardBorderTemplate of System.Windows.DataTemplate
    | StandardResourcePanelBorderTemplate of System.Windows.DataTemplate

module OneMonthViewGroupByDateControl =
    let standardBorderTemplate v : obj = box (OneMonthViewGroupByDateControlProp.StandardBorderTemplate v)
    let standardResourcePanelBorderTemplate v : obj = box (OneMonthViewGroupByDateControlProp.StandardResourcePanelBorderTemplate v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.OneMonthViewGroupByDateControl) (prop: OneMonthViewGroupByDateControlProp) =
        match prop with
        | OneMonthViewGroupByDateControlProp.Base p -> OneMonthViewControl.apply el p
        | OneMonthViewGroupByDateControlProp.StandardBorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewGroupByDateControl.StandardBorderTemplateProperty, box v)
        | OneMonthViewGroupByDateControlProp.StandardResourcePanelBorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewGroupByDateControl.StandardResourcePanelBorderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.OneMonthViewGroupByDateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
