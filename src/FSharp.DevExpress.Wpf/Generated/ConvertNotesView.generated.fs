...
type ConvertNotesViewProp =
    | Base of ThemedWindowProp

module ConvertNotesView =

    let apply (el: DevExpress.Xpf.RichEdit.View.ConvertNotesView) (prop: ConvertNotesViewProp) =
        match prop with
        | ConvertNotesViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.ConvertNotesView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
