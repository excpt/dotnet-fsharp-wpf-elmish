...
type ScrollableAreaPresenterProp =
    | Left of int
    | Top of int
    | LeftOffset of float
    | TopOffset of float
...
module ScrollableAreaPresenter =
    let left v : obj = box (ScrollableAreaPresenterProp.Left v)
    let top v : obj = box (ScrollableAreaPresenterProp.Top v)
    let leftOffset v : obj = box (ScrollableAreaPresenterProp.LeftOffset v)
    let topOffset v : obj = box (ScrollableAreaPresenterProp.TopOffset v)
    let isChild v : obj = box (ScrollableAreaPresenterProp.IsChild v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter) (prop: ScrollableAreaPresenterProp) =
        match prop with
        | ScrollableAreaPresenterProp.Left v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter.LeftProperty, box v)
        | ScrollableAreaPresenterProp.Top v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter.TopProperty, box v)
        | ScrollableAreaPresenterProp.LeftOffset v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter.LeftOffsetProperty, box v)
        | ScrollableAreaPresenterProp.TopOffset v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter.TopOffsetProperty, box v)
        | ScrollableAreaPresenterProp.IsChild v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter.IsChildProperty, box v)
    ...
    let itemTemplate (v: System.Windows.Controls.ControlTemplate) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.PivotGrid.Internal.ScrollableAreaPresenter.ItemTemplateProperty, box v)) :: node.Props }
