...
type MonthGroupsByDatePanelProp =
    | Base of MonthGroupsPanelProp

module MonthGroupsByDatePanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.MonthGroupsByDatePanel) (prop: MonthGroupsByDatePanelProp) =
        match prop with
        | MonthGroupsByDatePanelProp.Base p -> MonthGroupsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.MonthGroupsByDatePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
