...
open System
open System.Windows
open DevExpress.Xpf.Ribbon.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type RibbonControlBoxContainerProp =
    | ShowCustomItems of bool
    | IsMinimizeButtonVisible of bool
    | IsMaximizeButtonVisible of bool
    | IsCloseButtonVisible of bool
    | IsRestoreButtonVisible of bool

module RibbonControlBoxContainer =
    let showCustomItems v : obj = box (RibbonControlBoxContainerProp.ShowCustomItems v)
    let isMinimizeButtonVisible v : obj = box (RibbonControlBoxContainerProp.IsMinimizeButtonVisible v)
    let isMaximizeButtonVisible v : obj = box (RibbonControlBoxContainerProp.IsMaximizeButtonVisible v)
    let isCloseButtonVisible v : obj = box (RibbonControlBoxContainerProp.IsCloseButtonVisible v)
    let isRestoreButtonVisible v : obj = box (RibbonControlBoxContainerProp.IsRestoreButtonVisible v)

    let apply (el: DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer) (prop: RibbonControlBoxContainerProp) =
        match prop with
        | RibbonControlBoxContainerProp.ShowCustomItems v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer.ShowCustomItemsProperty, box v)
        | RibbonControlBoxContainerProp.IsMinimizeButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer.IsMinimizeButtonVisibleProperty, box v)
        | RibbonControlBoxContainerProp.IsMaximizeButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer.IsMaximizeButtonVisibleProperty, box v)
        | RibbonControlBoxContainerProp.IsCloseButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer.IsCloseButtonVisibleProperty, box v)
        | RibbonControlBoxContainerProp.IsRestoreButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer.IsRestoreButtonVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.RibbonControlBoxContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
