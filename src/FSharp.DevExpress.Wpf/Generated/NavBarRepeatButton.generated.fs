...
type NavBarRepeatButtonProp =
    | Orientation of System.Windows.Controls.Orientation
    | ItemsPanelOrientation of System.Windows.Controls.Orientation

module NavBarRepeatButton =
    let orientation v : obj = box (NavBarRepeatButtonProp.Orientation v)
    let itemsPanelOrientation v : obj = box (NavBarRepeatButtonProp.ItemsPanelOrientation v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarRepeatButton) (prop: NavBarRepeatButtonProp) =
        match prop with
        | NavBarRepeatButtonProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarRepeatButton.OrientationProperty, box v)
        | NavBarRepeatButtonProp.ItemsPanelOrientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarRepeatButton.ItemsPanelOrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarRepeatButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
