...
open System
open System.Windows
open DevExpress.Xpf.TreeMap
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SunburstControlProp =
    | Base of HierarchicalChartControlBaseProp
    | DataAdapter of DevExpress.Xpf.TreeMap.SunburstDataAdapterBase
    | Colorizer of DevExpress.Xpf.TreeMap.SunburstColorizerBase
    | HighlightMode of DevExpress.Xpf.TreeMap.SunburstHighlightMode
    | StartAngle of float
    | SweepDirection of DevExpress.Xpf.TreeMap.SunburstSweepDirection
    | HoleRadiusPercent of float
    | LabelDisplayMode of DevExpress.Xpf.TreeMap.SunburstLabelDisplayMode
    | HoleContent of obj
    | MinLabelSize of System.Windows.Size
    | SectorStyle of System.Windows.Style
    | LabelStyle of System.Windows.Style

module SunburstControl =
    let dataAdapter v : obj = box (SunburstControlProp.DataAdapter v)
    let colorizer v : obj = box (SunburstControlProp.Colorizer v)
    let highlightMode v : obj = box (SunburstControlProp.HighlightMode v)
    let startAngle v : obj = box (SunburstControlProp.StartAngle v)
    let sweepDirection v : obj = box (SunburstControlProp.SweepDirection v)
    let holeRadiusPercent v : obj = box (SunburstControlProp.HoleRadiusPercent v)
    let labelDisplayMode v : obj = box (SunburstControlProp.LabelDisplayMode v)
    let holeContent v : obj = box (SunburstControlProp.HoleContent v)
    let minLabelSize v : obj = box (SunburstControlProp.MinLabelSize v)
    let sectorStyle v : obj = box (SunburstControlProp.SectorStyle v)
    let labelStyle v : obj = box (SunburstControlProp.LabelStyle v)

    let apply (el: DevExpress.Xpf.TreeMap.SunburstControl) (prop: SunburstControlProp) =
        match prop with
        | SunburstControlProp.Base p -> HierarchicalChartControlBase.apply el p
        | SunburstControlProp.DataAdapter v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.DataAdapterProperty, box v)
        | SunburstControlProp.Colorizer v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.ColorizerProperty, box v)
        | SunburstControlProp.HighlightMode v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.HighlightModeProperty, box v)
        | SunburstControlProp.StartAngle v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.StartAngleProperty, box v)
        | SunburstControlProp.SweepDirection v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.SweepDirectionProperty, box v)
        | SunburstControlProp.HoleRadiusPercent v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.HoleRadiusPercentProperty, box v)
        | SunburstControlProp.LabelDisplayMode v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.LabelDisplayModeProperty, box v)
        | SunburstControlProp.HoleContent v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.HoleContentProperty, box v)
        | SunburstControlProp.MinLabelSize v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.MinLabelSizeProperty, box v)
        | SunburstControlProp.SectorStyle v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.SectorStyleProperty, box v)
        | SunburstControlProp.LabelStyle v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstControl.LabelStyleProperty, box v)

    let toolTipTemplate v : obj = box (HierarchicalChartControlBaseProp.ToolTipTemplate v)
    let toolTipContentTemplate v : obj = box (HierarchicalChartControlBaseProp.ToolTipContentTemplate v)
    let toolTipPattern v : obj = box (HierarchicalChartControlBaseProp.ToolTipPattern v)
    let toolTipGroupContentTemplate v : obj = box (HierarchicalChartControlBaseProp.ToolTipGroupContentTemplate v)
    let toolTipGroupPattern v : obj = box (HierarchicalChartControlBaseProp.ToolTipGroupPattern v)
    let toolTipEnabled v : obj = box (HierarchicalChartControlBaseProp.ToolTipEnabled v)
    let toolTipOptions v : obj = box (HierarchicalChartControlBaseProp.ToolTipOptions v)
    let selectedItem v : obj = box (HierarchicalChartControlBaseProp.SelectedItem v)
    let selectedItems v : obj = box (HierarchicalChartControlBaseProp.SelectedItems v)
    let selectionMode v : obj = box (HierarchicalChartControlBaseProp.SelectionMode v)
    let titles v : obj = box (HierarchicalChartControlBaseProp.Titles v)
    let legend v : obj = box (HierarchicalChartControlBaseProp.Legend v)
    ...
    let sunburst (v: DevExpress.Xpf.TreeMap.SunburstControl) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.TreeMap.SunburstControl.SunburstProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.TreeMap.SunburstControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
