...
type HeaderFooterPreviewControlProp =
    | HeaderFooterValue of string
    | Provider of DevExpress.XtraSpreadsheet.Layout.HeaderFooterFormatTagProvider
    | HeaderFooterLeftValue of string
    | HeaderFooterCenterValue of string
    | HeaderFooterRightValue of string

module HeaderFooterPreviewControl =
    let headerFooterValue v : obj = box (HeaderFooterPreviewControlProp.HeaderFooterValue v)
    let provider v : obj = box (HeaderFooterPreviewControlProp.Provider v)
    let headerFooterLeftValue v : obj = box (HeaderFooterPreviewControlProp.HeaderFooterLeftValue v)
    let headerFooterCenterValue v : obj = box (HeaderFooterPreviewControlProp.HeaderFooterCenterValue v)
    let headerFooterRightValue v : obj = box (HeaderFooterPreviewControlProp.HeaderFooterRightValue v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl) (prop: HeaderFooterPreviewControlProp) =
        match prop with
        | HeaderFooterPreviewControlProp.HeaderFooterValue v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl.HeaderFooterValueProperty, box v)
        | HeaderFooterPreviewControlProp.Provider v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl.ProviderProperty, box v)
        | HeaderFooterPreviewControlProp.HeaderFooterLeftValue v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl.HeaderFooterLeftValueProperty, box v)
        | HeaderFooterPreviewControlProp.HeaderFooterCenterValue v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl.HeaderFooterCenterValueProperty, box v)
        | HeaderFooterPreviewControlProp.HeaderFooterRightValue v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl.HeaderFooterRightValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.HeaderFooterPreviewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
