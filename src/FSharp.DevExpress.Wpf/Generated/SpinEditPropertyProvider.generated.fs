...
type SpinEditPropertyProviderProp =
    | Base of ButtonEditPropertyProviderProp

module SpinEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.SpinEditPropertyProvider) (prop: SpinEditPropertyProviderProp) =
        match prop with
        | SpinEditPropertyProviderProp.Base p -> ButtonEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SpinEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
