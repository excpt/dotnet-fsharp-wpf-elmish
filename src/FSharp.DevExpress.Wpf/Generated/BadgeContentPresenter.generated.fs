...
type BadgeContentPresenterProp =
    | ContentFormatProvider of System.IFormatProvider

module BadgeContentPresenter =
    let contentFormatProvider v : obj = box (BadgeContentPresenterProp.ContentFormatProvider v)

    let apply (el: DevExpress.Xpf.Core.Native.BadgeContentPresenter) (prop: BadgeContentPresenterProp) =
        match prop with
        | BadgeContentPresenterProp.ContentFormatProvider v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeContentPresenter.ContentFormatProviderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.BadgeContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
