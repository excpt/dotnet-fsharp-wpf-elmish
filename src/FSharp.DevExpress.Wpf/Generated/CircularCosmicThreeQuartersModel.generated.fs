...
type CircularCosmicThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCosmicThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCosmicThreeQuartersModel) (prop: CircularCosmicThreeQuartersModelProp) =
        match prop with
        | CircularCosmicThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCosmicThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
