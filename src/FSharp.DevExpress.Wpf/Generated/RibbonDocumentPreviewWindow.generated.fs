...
type RibbonDocumentPreviewWindowProp =
    | Base of DXWindowProp
    | Model of DevExpress.Xpf.Printing.IDocumentPreviewModel

module RibbonDocumentPreviewWindow =
    let model v : obj = box (RibbonDocumentPreviewWindowProp.Model v)

    let apply (el: DevExpress.Xpf.Printing.RibbonDocumentPreviewWindow) (prop: RibbonDocumentPreviewWindowProp) =
        match prop with
        | RibbonDocumentPreviewWindowProp.Base p -> DXWindow.apply el p
        | RibbonDocumentPreviewWindowProp.Model v -> el.SetValue(DevExpress.Xpf.Printing.RibbonDocumentPreviewWindow.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.RibbonDocumentPreviewWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
