...
module NotesView =
    ...
    let apply (el: DevExpress.Xpf.RichEdit.View.NotesView) (prop: NotesViewProp) =
        match prop with
        | NotesViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.NotesView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
