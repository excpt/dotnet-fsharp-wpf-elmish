...
type StopMediaButtonProp =
    | Base of MediaButtonProp

module StopMediaButton =

    let apply (el: DevExpress.Xpf.Controls.StopMediaButton) (prop: StopMediaButtonProp) =
        match prop with
        | StopMediaButtonProp.Base p -> MediaButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.StopMediaButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
