...
type GroupFrameProp =
    | Base of GroupBoxProp

module GroupFrame =

    let apply (el: DevExpress.Xpf.Core.GroupFrame) (prop: GroupFrameProp) =
        match prop with
        | GroupFrameProp.Base p -> GroupBox.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.GroupFrame>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
