...
type FloatingResizePointerProp =
    | Base of psvControlProp

module FloatingResizePointer =

    let apply (el: DevExpress.Xpf.Docking.Platform.FloatingResizePointer) (prop: FloatingResizePointerProp) =
        match prop with
        | FloatingResizePointerProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.FloatingResizePointer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
