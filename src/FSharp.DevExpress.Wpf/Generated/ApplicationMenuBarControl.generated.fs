...
type ApplicationMenuBarControlProp =
    | Base of PopupMenuBarControlProp
    | RibbonStyle of DevExpress.Xpf.Ribbon.RibbonStyle
    | BorderTemplateForOffice2007Style of System.Windows.Controls.ControlTemplate
    | BorderTemplateForOffice2010Style of System.Windows.Controls.ControlTemplate
    | RightPaneWidth of float

module ApplicationMenuBarControl =
    let ribbonStyle v : obj = box (ApplicationMenuBarControlProp.RibbonStyle v)
    let borderTemplateForOffice2007Style v : obj = box (ApplicationMenuBarControlProp.BorderTemplateForOffice2007Style v)
    let borderTemplateForOffice2010Style v : obj = box (ApplicationMenuBarControlProp.BorderTemplateForOffice2010Style v)
    let rightPaneWidth v : obj = box (ApplicationMenuBarControlProp.RightPaneWidth v)

    let apply (el: DevExpress.Xpf.Ribbon.ApplicationMenuBarControl) (prop: ApplicationMenuBarControlProp) =
        match prop with
        | ApplicationMenuBarControlProp.Base p -> PopupMenuBarControl.apply el p
        | ApplicationMenuBarControlProp.RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuBarControl.RibbonStyleProperty, box v)
        | ApplicationMenuBarControlProp.BorderTemplateForOffice2007Style v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuBarControl.BorderTemplateForOffice2007StyleProperty, box v)
        | ApplicationMenuBarControlProp.BorderTemplateForOffice2010Style v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuBarControl.BorderTemplateForOffice2010StyleProperty, box v)
        | ApplicationMenuBarControlProp.RightPaneWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.ApplicationMenuBarControl.RightPaneWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.ApplicationMenuBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
