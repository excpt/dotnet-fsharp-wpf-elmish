...
type PageViewItemHeaderPresenterProp =
    | Base of veContentControlProp

module PageViewItemHeaderPresenter =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.PageViewItemHeaderPresenter) (prop: PageViewItemHeaderPresenterProp) =
        match prop with
        | PageViewItemHeaderPresenterProp.Base p -> veContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.PageViewItemHeaderPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
