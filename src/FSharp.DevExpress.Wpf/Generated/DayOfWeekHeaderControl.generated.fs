...
type DayOfWeekHeaderControlProp =
    | Base of AutoTextFormatControlBaseProp
    | IsCompressed of bool
    | DayOfWeek of System.DayOfWeek

module DayOfWeekHeaderControl =
    let isCompressed v : obj = box (DayOfWeekHeaderControlProp.IsCompressed v)
    let dayOfWeek v : obj = box (DayOfWeekHeaderControlProp.DayOfWeek v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DayOfWeekHeaderControl) (prop: DayOfWeekHeaderControlProp) =
        match prop with
        | DayOfWeekHeaderControlProp.Base p -> AutoTextFormatControlBase.apply el p
        | DayOfWeekHeaderControlProp.IsCompressed v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DayOfWeekHeaderControl.IsCompressedProperty, box v)
        | DayOfWeekHeaderControlProp.DayOfWeek v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DayOfWeekHeaderControl.DayOfWeekProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DayOfWeekHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
