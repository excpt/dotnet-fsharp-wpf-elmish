...
type CleanWhiteGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteGaugeBackgroundLayerControl) (prop: CleanWhiteGaugeBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
