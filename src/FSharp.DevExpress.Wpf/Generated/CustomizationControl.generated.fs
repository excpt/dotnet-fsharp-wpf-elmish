...
type CustomizationControlProp =
    | Ribbon of DevExpress.Xpf.Ribbon.RibbonControl

module CustomizationControl =
    let ribbon v : obj = box (CustomizationControlProp.Ribbon v)

    let apply (el: DevExpress.Xpf.Ribbon.Customization.CustomizationControl) (prop: CustomizationControlProp) =
        match prop with
        | CustomizationControlProp.Ribbon v -> el.SetValue(DevExpress.Xpf.Ribbon.Customization.CustomizationControl.RibbonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Customization.CustomizationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
