...
type LampGreenStatePresentationControlProp =
    | Base of PresentationControlProp

module LampGreenStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.LampGreenStatePresentationControl) (prop: LampGreenStatePresentationControlProp) =
        match prop with
        | LampGreenStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LampGreenStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
