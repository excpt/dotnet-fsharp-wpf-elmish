...
type LeftIndentBottomHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module LeftIndentBottomHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.LeftIndentBottomHotZoneControl) (prop: LeftIndentBottomHotZoneControlProp) =
        match prop with
        | LeftIndentBottomHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.LeftIndentBottomHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
