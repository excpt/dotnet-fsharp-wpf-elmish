...
type XPCollectionDataSourceProp =
    | Base of XPDataSourceBaseProp
    | DisplayableProperties of string
    | BindingBehavior of DevExpress.Xpo.CollectionBindingBehavior
    | DeleteObjectOnRemove of bool
    | LoadingEnabled of bool
    | TopReturnedObjects of int
    | SkipReturnedObjects of int

module XPCollectionDataSource =
    let displayableProperties v : obj = box (XPCollectionDataSourceProp.DisplayableProperties v)
    let bindingBehavior v : obj = box (XPCollectionDataSourceProp.BindingBehavior v)
    let deleteObjectOnRemove v : obj = box (XPCollectionDataSourceProp.DeleteObjectOnRemove v)
    let loadingEnabled v : obj = box (XPCollectionDataSourceProp.LoadingEnabled v)
    let topReturnedObjects v : obj = box (XPCollectionDataSourceProp.TopReturnedObjects v)
    let skipReturnedObjects v : obj = box (XPCollectionDataSourceProp.SkipReturnedObjects v)

    let apply (el: DevExpress.Xpf.Core.DataSources.XPCollectionDataSource) (prop: XPCollectionDataSourceProp) =
        match prop with
        | XPCollectionDataSourceProp.Base p -> XPDataSourceBase.apply el p
        | XPCollectionDataSourceProp.DisplayableProperties v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPCollectionDataSource.DisplayablePropertiesProperty, box v)
        | XPCollectionDataSourceProp.BindingBehavior v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPCollectionDataSource.BindingBehaviorProperty, box v)
        | XPCollectionDataSourceProp.DeleteObjectOnRemove v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPCollectionDataSource.DeleteObjectOnRemoveProperty, box v)
        | XPCollectionDataSourceProp.LoadingEnabled v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPCollectionDataSource.LoadingEnabledProperty, box v)
        | XPCollectionDataSourceProp.TopReturnedObjects v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPCollectionDataSource.TopReturnedObjectsProperty, box v)
        | XPCollectionDataSourceProp.SkipReturnedObjects v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPCollectionDataSource.SkipReturnedObjectsProperty, box v)

    let caseSensitive v : obj = box (XPDataSourceBaseProp.CaseSensitive v)
    let criteria v : obj = box (XPDataSourceBaseProp.Criteria v)
    let selectDeleted v : obj = box (XPDataSourceBaseProp.SelectDeleted v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.XPCollectionDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
