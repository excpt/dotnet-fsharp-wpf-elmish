...
type DocumentMapSettingsProp =
    | Base of DocumentMapSettingsProp
    | SelectedNode of obj
    | WrapLongLines of obj
    | HideAfterUse of obj
    | ActualHideAfterUse of bool

module DocumentMapSettings =
    let selectedNode v : obj = box (DocumentMapSettingsProp.SelectedNode v)
    let wrapLongLines v : obj = box (DocumentMapSettingsProp.WrapLongLines v)
    let hideAfterUse v : obj = box (DocumentMapSettingsProp.HideAfterUse v)
    let actualHideAfterUse v : obj = box (DocumentMapSettingsProp.ActualHideAfterUse v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.DocumentMapSettings) (prop: DocumentMapSettingsProp) =
        match prop with
        | DocumentMapSettingsProp.Base p -> DocumentMapSettings.apply el p
        | DocumentMapSettingsProp.SelectedNode v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.DocumentMapSettings.SelectedNodeProperty, box v)
        | DocumentMapSettingsProp.WrapLongLines v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapSettings.WrapLongLinesProperty, box v)
        | DocumentMapSettingsProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapSettings.HideAfterUseProperty, box v)
        | DocumentMapSettingsProp.ActualHideAfterUse v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapSettings.ActualHideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.DocumentMapSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
