...
open System
open System.Windows
open DevExpress.Xpf.Charts.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type AdditionalBoxPlotSeriesHighlightedPointGeometryProp =
    | Base of AdditionalSeriesHighlightedPointGeometryProp

module AdditionalBoxPlotSeriesHighlightedPointGeometry =

    let apply (el: DevExpress.Xpf.Charts.Native.AdditionalBoxPlotSeriesHighlightedPointGeometry) (prop: AdditionalBoxPlotSeriesHighlightedPointGeometryProp) =
        match prop with
        | AdditionalBoxPlotSeriesHighlightedPointGeometryProp.Base p -> AdditionalSeriesHighlightedPointGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Native.AdditionalBoxPlotSeriesHighlightedPointGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
