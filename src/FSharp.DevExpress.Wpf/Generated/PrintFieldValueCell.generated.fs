...
type PrintFieldValueCellProp =
    | Base of PivotPrintCellBaseProp

module PrintFieldValueCell =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintFieldValueCell) (prop: PrintFieldValueCellProp) =
        match prop with
        | PrintFieldValueCellProp.Base p -> PivotPrintCellBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintFieldValueCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
