...
type GalleryBarItemLinkControlProp =
    | Base of BarItemLinkControlProp

module GalleryBarItemLinkControl =

    let apply (el: DevExpress.Xpf.Editors.Internal.GalleryBarItemLinkControl) (prop: GalleryBarItemLinkControlProp) =
        match prop with
        | GalleryBarItemLinkControlProp.Base p -> BarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.GalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
