...
type QuickAccessToolbarCustomizationMenuProp =
    | Base of PopupMenuProp

module QuickAccessToolbarCustomizationMenu =

    let apply (el: DevExpress.Xpf.Ribbon.QuickAccessToolbarCustomizationMenu) (prop: QuickAccessToolbarCustomizationMenuProp) =
        match prop with
        | QuickAccessToolbarCustomizationMenuProp.Base p -> PopupMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.QuickAccessToolbarCustomizationMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
