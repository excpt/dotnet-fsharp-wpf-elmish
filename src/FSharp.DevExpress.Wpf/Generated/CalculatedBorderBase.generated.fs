...
type CalculatedBorderBaseProp =
    ...
    | DefaultPadding of System.Windows.Thickness
    | NoBorderMargin of System.Windows.Thickness

module CalculatedBorderBase =
    let defaultBorderThickness v : obj = box (CalculatedBorderBaseProp.DefaultBorderThickness v)
    let defaultCornerRadius v : obj = box (CalculatedBorderBaseProp.DefaultCornerRadius v)
    let defaultMargin v : obj = box (CalculatedBorderBaseProp.DefaultMargin v)
    let defaultPadding v : obj = box (CalculatedBorderBaseProp.DefaultPadding v)
    let noBorderMargin v : obj = box (CalculatedBorderBaseProp.NoBorderMargin v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.CalculatedBorderBase) (prop: CalculatedBorderBaseProp) =
        match prop with
        | CalculatedBorderBaseProp.DefaultBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.CalculatedBorderBase.DefaultBorderThicknessProperty, box v)
        | CalculatedBorderBaseProp.DefaultCornerRadius v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.CalculatedBorderBase.DefaultCornerRadiusProperty, box v)
        | CalculatedBorderBaseProp.DefaultMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.CalculatedBorderBase.DefaultMarginProperty, box v)
        | CalculatedBorderBaseProp.DefaultPadding v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.CalculatedBorderBase.DefaultPaddingProperty, box v)
        | CalculatedBorderBaseProp.NoBorderMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.CalculatedBorderBase.NoBorderMarginProperty, box v)
