...
type RibbonOverflowButtonProp =
    | Base of RibbonCheckedBorderControlProp

module RibbonOverflowButton =

    let apply (el: DevExpress.Xpf.Ribbon.Internal.RibbonOverflowButton) (prop: RibbonOverflowButtonProp) =
        match prop with
        | RibbonOverflowButtonProp.Base p -> RibbonCheckedBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.RibbonOverflowButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
