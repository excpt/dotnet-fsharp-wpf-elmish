...
type SeriesLabelProp =
    | Base of ChartTextElementProp
    | Visible of bool
    | Items of obj
    | Indent of int
    | RenderMode of DevExpress.Xpf.Charts.LabelRenderMode
    | ConnectorVisible of bool
    | ConnectorThickness of int
    | ResolveOverlappingMode of DevExpress.Xpf.Charts.ResolveOverlappingMode
    | TextOrientation of DevExpress.Xpf.Charts.TextOrientation
    | TextPattern of string

module SeriesLabel =
    let visible v : obj = box (SeriesLabelProp.Visible v)
    let items v : obj = box (SeriesLabelProp.Items v)
    let indent v : obj = box (SeriesLabelProp.Indent v)
    let renderMode v : obj = box (SeriesLabelProp.RenderMode v)
    let connectorVisible v : obj = box (SeriesLabelProp.ConnectorVisible v)
    let connectorThickness v : obj = box (SeriesLabelProp.ConnectorThickness v)
    let resolveOverlappingMode v : obj = box (SeriesLabelProp.ResolveOverlappingMode v)
    let textOrientation v : obj = box (SeriesLabelProp.TextOrientation v)
    let textPattern v : obj = box (SeriesLabelProp.TextPattern v)

    let apply (el: DevExpress.Xpf.Charts.SeriesLabel) (prop: SeriesLabelProp) =
        match prop with
        | SeriesLabelProp.Base p -> ChartTextElement.apply el p
        | SeriesLabelProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.VisibleProperty, box v)
        | SeriesLabelProp.Items v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.ItemsProperty, box v)
        | SeriesLabelProp.Indent v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.IndentProperty, box v)
        | SeriesLabelProp.RenderMode v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.RenderModeProperty, box v)
        | SeriesLabelProp.ConnectorVisible v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.ConnectorVisibleProperty, box v)
        | SeriesLabelProp.ConnectorThickness v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.ConnectorThicknessProperty, box v)
        | SeriesLabelProp.ResolveOverlappingMode v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.ResolveOverlappingModeProperty, box v)
        | SeriesLabelProp.TextOrientation v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.TextOrientationProperty, box v)
        | SeriesLabelProp.TextPattern v -> el.SetValue(DevExpress.Xpf.Charts.SeriesLabel.TextPatternProperty, box v)

    let elementTemplate v : obj = box (ChartTextElementProp.ElementTemplate v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
