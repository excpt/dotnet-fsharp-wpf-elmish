...
open System
open System.Windows
open DevExpress.Xpf.Scheduler.Reporting
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DXSchedulerPrintAdapterProp =
    | Base of DXDesignTimeControlProp
    | WorkTime of DevExpress.XtraScheduler.TimeOfDayInterval
    | ClientTimeZoneId of string
    | FirstDayOfWeek of DevExpress.XtraScheduler.FirstDayOfWeek
    | TimeInterval of DevExpress.XtraScheduler.TimeInterval
    | EnableSmartSync of bool
    | SmartSyncOptions of DevExpress.XtraScheduler.Reporting.ISmartSyncOptions
    | ResourceColorSchemas of DevExpress.Xpf.Scheduler.SchedulerColorSchemaCollection

module DXSchedulerPrintAdapter =
    let workTime v : obj = box (DXSchedulerPrintAdapterProp.WorkTime v)
    let clientTimeZoneId v : obj = box (DXSchedulerPrintAdapterProp.ClientTimeZoneId v)
    let firstDayOfWeek v : obj = box (DXSchedulerPrintAdapterProp.FirstDayOfWeek v)
    let timeInterval v : obj = box (DXSchedulerPrintAdapterProp.TimeInterval v)
    let enableSmartSync v : obj = box (DXSchedulerPrintAdapterProp.EnableSmartSync v)
    let smartSyncOptions v : obj = box (DXSchedulerPrintAdapterProp.SmartSyncOptions v)
    let resourceColorSchemas v : obj = box (DXSchedulerPrintAdapterProp.ResourceColorSchemas v)

    let apply (el: DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter) (prop: DXSchedulerPrintAdapterProp) =
        match prop with
        | DXSchedulerPrintAdapterProp.Base p -> DXDesignTimeControl.apply el p
        | DXSchedulerPrintAdapterProp.WorkTime v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.WorkTimeProperty, box v)
        | DXSchedulerPrintAdapterProp.ClientTimeZoneId v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.ClientTimeZoneIdProperty, box v)
        | DXSchedulerPrintAdapterProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.FirstDayOfWeekProperty, box v)
        | DXSchedulerPrintAdapterProp.TimeInterval v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.TimeIntervalProperty, box v)
        | DXSchedulerPrintAdapterProp.EnableSmartSync v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.EnableSmartSyncProperty, box v)
        | DXSchedulerPrintAdapterProp.SmartSyncOptions v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.SmartSyncOptionsProperty, box v)
        | DXSchedulerPrintAdapterProp.ResourceColorSchemas v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerPrintAdapter.ResourceColorSchemasProperty, box v)
