...
type CosmicScaleLabelControlProp =
    | Base of PresentationControlProp

module CosmicScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicScaleLabelControl) (prop: CosmicScaleLabelControlProp) =
        match prop with
        | CosmicScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
