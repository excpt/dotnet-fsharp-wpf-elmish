...
type DataPagerNumericButtonContainerProp =
    | AutoEllipsis of bool
    | ButtonCount of int
    | CurrentIndex of int
    | FirstButtonPageNumber of int
    | PageCount of int
    | SecondButtonPageNumber of int

module DataPagerNumericButtonContainer =
    let autoEllipsis v : obj = box (DataPagerNumericButtonContainerProp.AutoEllipsis v)
    let buttonCount v : obj = box (DataPagerNumericButtonContainerProp.ButtonCount v)
    let currentIndex v : obj = box (DataPagerNumericButtonContainerProp.CurrentIndex v)
    let firstButtonPageNumber v : obj = box (DataPagerNumericButtonContainerProp.FirstButtonPageNumber v)
    let pageCount v : obj = box (DataPagerNumericButtonContainerProp.PageCount v)
    let secondButtonPageNumber v : obj = box (DataPagerNumericButtonContainerProp.SecondButtonPageNumber v)

    let apply (el: DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer) (prop: DataPagerNumericButtonContainerProp) =
        match prop with
        | DataPagerNumericButtonContainerProp.AutoEllipsis v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.AutoEllipsisProperty, box v)
        | DataPagerNumericButtonContainerProp.ButtonCount v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.ButtonCountProperty, box v)
        | DataPagerNumericButtonContainerProp.CurrentIndex v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.CurrentIndexProperty, box v)
        | DataPagerNumericButtonContainerProp.FirstButtonPageNumber v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.FirstButtonPageNumberProperty, box v)
        | DataPagerNumericButtonContainerProp.PageCount v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.PageCountProperty, box v)
        | DataPagerNumericButtonContainerProp.SecondButtonPageNumber v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.SecondButtonPageNumberProperty, box v)
    ...
    let numericButtonContainer (v: DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer.NumericButtonContainerProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Editors.DataPager.DataPagerNumericButtonContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
