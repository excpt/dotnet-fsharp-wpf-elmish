...
type IndicatorElementsPanelProp =
    | Base of ChartItemsPanelBaseProp

module IndicatorElementsPanel =

    let apply (el: DevExpress.Xpf.Charts.IndicatorElementsPanel) (prop: IndicatorElementsPanelProp) =
        match prop with
        | IndicatorElementsPanelProp.Base p -> ChartItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.IndicatorElementsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
