...
type IEnumerableDataSourceProp =
    | Base of ItemsSourceDataSourceBaseProp

module IEnumerableDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.IEnumerableDataSource) (prop: IEnumerableDataSourceProp) =
        match prop with
        | IEnumerableDataSourceProp.Base p -> ItemsSourceDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.IEnumerableDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
