...
type PasswordBoxEditPropertyProviderProp =
    | Base of TextEditPropertyProviderProp

module PasswordBoxEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.PasswordBoxEditPropertyProvider) (prop: PasswordBoxEditPropertyProviderProp) =
        match prop with
        | PasswordBoxEditPropertyProviderProp.Base p -> TextEditPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PasswordBoxEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
