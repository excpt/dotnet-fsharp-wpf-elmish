...
type FlatLightScaleLabelControlProp =
    | Base of PresentationControlProp

module FlatLightScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightScaleLabelControl) (prop: FlatLightScaleLabelControlProp) =
        match prop with
        | FlatLightScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
