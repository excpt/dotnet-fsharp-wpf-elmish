...
type TimelineCellsDecorationProp =
    | Base of TimelineDecorationPresenterBaseProp
    | View of DevExpress.Xpf.Scheduling.ViewBase
    | SecondaryScale of DevExpress.Xpf.Scheduling.ITimeScale
    | VerticalLineThickness of float
    | HorizontalLineThickness of float
    | HighlightNonworkingHours of bool

module TimelineCellsDecoration =
    let view v : obj = box (TimelineCellsDecorationProp.View v)
    let secondaryScale v : obj = box (TimelineCellsDecorationProp.SecondaryScale v)
    let verticalLineThickness v : obj = box (TimelineCellsDecorationProp.VerticalLineThickness v)
    let horizontalLineThickness v : obj = box (TimelineCellsDecorationProp.HorizontalLineThickness v)
    let highlightNonworkingHours v : obj = box (TimelineCellsDecorationProp.HighlightNonworkingHours v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration) (prop: TimelineCellsDecorationProp) =
        match prop with
        | TimelineCellsDecorationProp.Base p -> TimelineDecorationPresenterBase.apply el p
        | TimelineCellsDecorationProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration.ViewProperty, box v)
        | TimelineCellsDecorationProp.SecondaryScale v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration.SecondaryScaleProperty, box v)
        | TimelineCellsDecorationProp.VerticalLineThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration.VerticalLineThicknessProperty, box v)
        | TimelineCellsDecorationProp.HorizontalLineThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration.HorizontalLineThicknessProperty, box v)
        | TimelineCellsDecorationProp.HighlightNonworkingHours v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration.HighlightNonworkingHoursProperty, box v)

    let viewportInterval v : obj = box (TimelineDecorationPresenterBaseProp.ViewportInterval v)
    let zoom v : obj = box (TimelineDecorationPresenterBaseProp.Zoom v)
    let containerViewModel v : obj = box (TimelineDecorationPresenterBaseProp.ContainerViewModel v)
    let scale v : obj = box (TimelineDecorationPresenterBaseProp.Scale v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecoration>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
