...
type SimpleButtonProp =
    | AsyncDisplayMode of DevExpress.Mvvm.AsyncDisplayMode
    | Glyph of System.Windows.Media.ImageSource
    | GlyphToContentOffset of float
    | GlyphHeight of obj
    | GlyphWidth of obj
    | ButtonKind of DevExpress.Xpf.Editors.ButtonKind
    | IsChecked of obj
    | Delay of int
    | Interval of int
...
module SimpleButton =
    ...
    let glyphHeight v : obj = box (SimpleButtonProp.GlyphHeight v)
    let glyphWidth v : obj = box (SimpleButtonProp.GlyphWidth v)
    let buttonKind v : obj = box (SimpleButtonProp.ButtonKind v)
    let isChecked v : obj = box (SimpleButtonProp.IsChecked v)
    ...
    let apply (el: DevExpress.Xpf.Core.SimpleButton) (prop: SimpleButtonProp) =
        match prop with
        | SimpleButtonProp.AsyncDisplayMode v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.AsyncDisplayModeProperty, box v)
        | SimpleButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.GlyphProperty, box v)
        | SimpleButtonProp.GlyphToContentOffset v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.GlyphToContentOffsetProperty, box v)
        | SimpleButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.GlyphHeightProperty, box v)
        | SimpleButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.GlyphWidthProperty, box v)
        | SimpleButtonProp.ButtonKind v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.ButtonKindProperty, box v)
        | SimpleButtonProp.IsChecked v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.IsCheckedProperty, box v)
        | SimpleButtonProp.Delay v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.DelayProperty, box v)
        | SimpleButtonProp.Interval v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.IntervalProperty, box v)
        | SimpleButtonProp.IsThreeState v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.IsThreeStateProperty, box v)
        | SimpleButtonProp.GlyphAlignment v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.GlyphAlignmentProperty, box v)
        | SimpleButtonProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Core.SimpleButton.CornerRadiusProperty, box v)
        | SimpleButtonProp.OnChecked h -> el.Checked.AddHandler(h)
        | SimpleButtonProp.OnUnchecked h -> el.Unchecked.AddHandler(h)
        | SimpleButtonProp.OnIndeterminate h -> el.Indeterminate.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SimpleButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
