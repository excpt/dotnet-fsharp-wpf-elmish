...
type FloatingItemsPanelProp =
    | Base of GroupPanelProp

module FloatingItemsPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatingItemsPanel) (prop: FloatingItemsPanelProp) =
        match prop with
        | FloatingItemsPanelProp.Base p -> GroupPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FloatingItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
