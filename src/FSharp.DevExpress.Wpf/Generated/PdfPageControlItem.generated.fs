...
type PdfPageControlItemProp =
    | Base of PageControlItemProp

module PdfPageControlItem =

    let apply (el: DevExpress.Xpf.PdfViewer.PdfPageControlItem) (prop: PdfPageControlItemProp) =
        match prop with
        | PdfPageControlItemProp.Base p -> PageControlItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfPageControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
