...
type ListViewControlProp =
    | Base of ViewControlBaseProp
    | View of DevExpress.Xpf.Scheduling.ListView
    | VisualData of DevExpress.Xpf.Scheduling.VisualData.ListViewVisualData

module ListViewControl =
    let view v : obj = box (ListViewControlProp.View v)
    let visualData v : obj = box (ListViewControlProp.VisualData v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.ListViewControl) (prop: ListViewControlProp) =
        match prop with
        | ListViewControlProp.Base p -> ViewControlBase.apply el p
        | ListViewControlProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ListViewControl.ViewProperty, box v)
        | ListViewControlProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ListViewControl.VisualDataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.ListViewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
