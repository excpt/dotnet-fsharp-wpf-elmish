...
type DialogExtraLargeIconsViewProp =
    | Base of DialogIconsViewProp

module DialogExtraLargeIconsView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogExtraLargeIconsView) (prop: DialogExtraLargeIconsViewProp) =
        match prop with
        | DialogExtraLargeIconsViewProp.Base p -> DialogIconsView.apply el p

    let iconSize v : obj = box (DialogViewModeViewBaseProp.IconSize v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogExtraLargeIconsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
