...
type SeriesTemplateHolderControlProp =
    | Base of ChartContentControlProp

module SeriesTemplateHolderControl =

    let apply (el: DevExpress.Xpf.Charts.SeriesTemplateHolderControl) (prop: SeriesTemplateHolderControlProp) =
        match prop with
        | SeriesTemplateHolderControlProp.Base p -> ChartContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesTemplateHolderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
