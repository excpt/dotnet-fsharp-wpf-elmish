...
type PopupMenuBarControlProp =
    | Base of SubMenuBarControlProp

module PopupMenuBarControl =

    let apply (el: DevExpress.Xpf.Bars.PopupMenuBarControl) (prop: PopupMenuBarControlProp) =
        match prop with
        | PopupMenuBarControlProp.Base p -> SubMenuBarControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupMenuBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
