...
type MonthViewGroupByDateControlProp =
    | Base of MonthViewControlBaseProp

module MonthViewGroupByDateControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthViewGroupByDateControl) (prop: MonthViewGroupByDateControlProp) =
        match prop with
        | MonthViewGroupByDateControlProp.Base p -> MonthViewControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MonthViewGroupByDateControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
