...
type HeatmapLabelProp =
    | Base of ChartTextElementProp
    | TextPattern of string
    | TextOrientation of DevExpress.Xpf.Charts.TextOrientation

module HeatmapLabel =
    let textPattern v : obj = box (HeatmapLabelProp.TextPattern v)
    let textOrientation v : obj = box (HeatmapLabelProp.TextOrientation v)

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapLabel) (prop: HeatmapLabelProp) =
        match prop with
        | HeatmapLabelProp.Base p -> ChartTextElement.apply el p
        | HeatmapLabelProp.TextPattern v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapLabel.TextPatternProperty, box v)
        | HeatmapLabelProp.TextOrientation v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapLabel.TextOrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
