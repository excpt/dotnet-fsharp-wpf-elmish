...
type LegendTitleProp =
    | Base of TitleBaseProp

module LegendTitle =

    let apply (el: DevExpress.Xpf.Charts.LegendTitle) (prop: LegendTitleProp) =
        match prop with
        | LegendTitleProp.Base p -> TitleBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LegendTitle>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
