...
type OneMonthViewControlProp =
    | Base of SchedulerViewControlBaseProp
    | View of DevExpress.Xpf.Scheduling.MonthView
    | VisualData of DevExpress.Xpf.Scheduling.VisualData.OneMonthViewVisualDataBase
...
module OneMonthViewControl =
    let view v : obj = box (OneMonthViewControlProp.View v)
    let visualData v : obj = box (OneMonthViewControlProp.VisualData v)
    let borderTemplate v : obj = box (OneMonthViewControlProp.BorderTemplate v)
    let groupSeparatorTemplate v : obj = box (OneMonthViewControlProp.GroupSeparatorTemplate v)
    let dateHeaderSeparatorTemplate v : obj = box (OneMonthViewControlProp.DateHeaderSeparatorTemplate v)
    let resourceHeaderSeparatorTemplate v : obj = box (OneMonthViewControlProp.ResourceHeaderSeparatorTemplate v)
    let appointmentsContainerStyle v : obj = box (OneMonthViewControlProp.AppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (OneMonthViewControlProp.DragAppointmentsContainerStyle v)
    let dateHeadersCornerTemplate v : obj = box (OneMonthViewControlProp.DateHeadersCornerTemplate v)
    let resourceHeadersCornerTemplate v : obj = box (OneMonthViewControlProp.ResourceHeadersCornerTemplate v)
    let resourceHeadersBottomCornerTemplate v : obj = box (OneMonthViewControlProp.ResourceHeadersBottomCornerTemplate v)
    let headerAreaSeparatorTemplate v : obj = box (OneMonthViewControlProp.HeaderAreaSeparatorTemplate v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl) (prop: OneMonthViewControlProp) =
        match prop with
        | OneMonthViewControlProp.Base p -> SchedulerViewControlBase.apply el p
        | OneMonthViewControlProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.ViewProperty, box v)
        | OneMonthViewControlProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.VisualDataProperty, box v)
        | OneMonthViewControlProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.BorderTemplateProperty, box v)
        | OneMonthViewControlProp.GroupSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.GroupSeparatorTemplateProperty, box v)
        | OneMonthViewControlProp.DateHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.DateHeaderSeparatorTemplateProperty, box v)
        | OneMonthViewControlProp.ResourceHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.ResourceHeaderSeparatorTemplateProperty, box v)
        | OneMonthViewControlProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.AppointmentsContainerStyleProperty, box v)
        | OneMonthViewControlProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.DragAppointmentsContainerStyleProperty, box v)
        | OneMonthViewControlProp.DateHeadersCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.DateHeadersCornerTemplateProperty, box v)
        | OneMonthViewControlProp.ResourceHeadersCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.ResourceHeadersCornerTemplateProperty, box v)
        | OneMonthViewControlProp.ResourceHeadersBottomCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.ResourceHeadersBottomCornerTemplateProperty, box v)
        | OneMonthViewControlProp.HeaderAreaSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl.HeaderAreaSeparatorTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.OneMonthViewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
