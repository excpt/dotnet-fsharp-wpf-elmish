...
type BorderlessSimpleRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module BorderlessSimpleRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderlessSimpleRangeBar2DModelControl) (prop: BorderlessSimpleRangeBar2DModelControlProp) =
        match prop with
        | BorderlessSimpleRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderlessSimpleRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
