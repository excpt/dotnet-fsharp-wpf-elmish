...
type HorizontalWeekMoreButtonPanelProp =
    | AppointmentsInfoContainer of DevExpress.Xpf.Scheduler.Drawing.IAppoinmentsInfoContainer

module HorizontalWeekMoreButtonPanel =
    let appointmentsInfoContainer v : obj = box (HorizontalWeekMoreButtonPanelProp.AppointmentsInfoContainer v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalWeekMoreButtonPanel) (prop: HorizontalWeekMoreButtonPanelProp) =
        match prop with
        | HorizontalWeekMoreButtonPanelProp.AppointmentsInfoContainer v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalWeekMoreButtonPanel.AppointmentsInfoContainerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HorizontalWeekMoreButtonPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
