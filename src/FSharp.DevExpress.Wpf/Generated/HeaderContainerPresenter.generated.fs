...
type HeaderContainerPresenterProp =
    | ViewInfo of DevExpress.Xpf.Core.Native.TabViewInfo
    | ChildMinHeight of float

module HeaderContainerPresenter =
    let viewInfo v : obj = box (HeaderContainerPresenterProp.ViewInfo v)
    let childMinHeight v : obj = box (HeaderContainerPresenterProp.ChildMinHeight v)

    let apply (el: DevExpress.Xpf.Core.Native.HeaderContainerPresenter) (prop: HeaderContainerPresenterProp) =
        match prop with
        | HeaderContainerPresenterProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Core.Native.HeaderContainerPresenter.ViewInfoProperty, box v)
        | HeaderContainerPresenterProp.ChildMinHeight v -> el.SetValue(DevExpress.Xpf.Core.Native.HeaderContainerPresenter.ChildMinHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.HeaderContainerPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
