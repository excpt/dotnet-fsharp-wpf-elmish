...
type EcoQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoQuarterTopRightArcScaleBackgroundLayerControl) (prop: EcoQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | EcoQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
