...
type ConnectorSelectionPartAdornerProp =
    | Base of SelectionPartAdornerBaseProp

module ConnectorSelectionPartAdorner =

    let apply (el: DevExpress.Xpf.Diagram.ConnectorSelectionPartAdorner) (prop: ConnectorSelectionPartAdornerProp) =
        match prop with
        | ConnectorSelectionPartAdornerProp.Base p -> SelectionPartAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ConnectorSelectionPartAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
