...
type ProgressBarStyleSettingsProp =
    | Base of BaseProgressBarStyleSettingsProp

module ProgressBarStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.ProgressBarStyleSettings) (prop: ProgressBarStyleSettingsProp) =
        match prop with
        | ProgressBarStyleSettingsProp.Base p -> BaseProgressBarStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ProgressBarStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
