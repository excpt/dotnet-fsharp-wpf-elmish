...
type DocumentFormBorderContentControlProp =
    | Base of FormBorderContentControlProp

module DocumentFormBorderContentControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentFormBorderContentControl) (prop: DocumentFormBorderContentControlProp) =
        match prop with
        | DocumentFormBorderContentControlProp.Base p -> FormBorderContentControl.apply el p

    let isActive v : obj = box (FormBorderContentControlProp.IsActive v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentFormBorderContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
