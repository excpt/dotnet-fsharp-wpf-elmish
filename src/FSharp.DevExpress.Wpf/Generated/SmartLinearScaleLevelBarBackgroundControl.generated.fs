...
type SmartLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module SmartLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartLinearScaleLevelBarBackgroundControl) (prop: SmartLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | SmartLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
