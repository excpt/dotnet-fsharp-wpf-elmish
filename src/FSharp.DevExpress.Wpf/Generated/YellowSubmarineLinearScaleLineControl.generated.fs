...
type YellowSubmarineLinearScaleLineControlProp =
    | Base of PresentationControlProp

module YellowSubmarineLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleLineControl) (prop: YellowSubmarineLinearScaleLineControlProp) =
        match prop with
        | YellowSubmarineLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
