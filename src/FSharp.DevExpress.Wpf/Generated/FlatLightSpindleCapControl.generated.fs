...
type FlatLightSpindleCapControlProp =
    | Base of PresentationControlProp

module FlatLightSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightSpindleCapControl) (prop: FlatLightSpindleCapControlProp) =
        match prop with
        | FlatLightSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
