...
type VisualDayViewGroupByResourceProp =
    | Base of VisualDayViewResourcesBasedViewInfoProp

module VisualDayViewGroupByResource =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByResource) (prop: VisualDayViewGroupByResourceProp) =
        match prop with
        | VisualDayViewGroupByResourceProp.Base p -> VisualDayViewResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByResource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
