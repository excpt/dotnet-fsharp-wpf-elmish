...
type YellowSubmarineArcScaleLineControlProp =
    | Base of PresentationControlProp

module YellowSubmarineArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineArcScaleLineControl) (prop: YellowSubmarineArcScaleLineControlProp) =
        match prop with
        | YellowSubmarineArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
