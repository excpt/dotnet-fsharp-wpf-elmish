...
type BarHistoryListSummaryItemLinkControlProp =
    | Base of BarStaticItemLinkControlProp

module BarHistoryListSummaryItemLinkControl =

    let apply (el: DevExpress.Xpf.Bars.Native.BarHistoryListSummaryItemLinkControl) (prop: BarHistoryListSummaryItemLinkControlProp) =
        match prop with
        | BarHistoryListSummaryItemLinkControlProp.Base p -> BarStaticItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.Native.BarHistoryListSummaryItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
