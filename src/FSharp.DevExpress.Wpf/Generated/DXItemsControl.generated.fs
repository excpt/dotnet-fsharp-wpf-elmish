...
type DXItemsControlProp =
    | IsLooped of bool

module DXItemsControl =
    let isLooped v : obj = box (DXItemsControlProp.IsLooped v)

    let apply (el: DevExpress.Xpf.Editors.DXItemsControl) (prop: DXItemsControlProp) =
        match prop with
        | DXItemsControlProp.IsLooped v -> el.SetValue(DevExpress.Xpf.Editors.DXItemsControl.IsLoopedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DXItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
