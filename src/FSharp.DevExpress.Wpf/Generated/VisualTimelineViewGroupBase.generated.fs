...
type VisualTimelineViewGroupBaseProp =
    | Base of VisualResourcesBasedViewInfoProp
    | Header of DevExpress.Xpf.Scheduler.Drawing.VisualTimelineHeader
    | SelectionBarContainer of DevExpress.Xpf.Scheduler.Drawing.VisualTimelineSelectionBar

module VisualTimelineViewGroupBase =
    let header v : obj = box (VisualTimelineViewGroupBaseProp.Header v)
    let selectionBarContainer v : obj = box (VisualTimelineViewGroupBaseProp.SelectionBarContainer v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupBase) (prop: VisualTimelineViewGroupBaseProp) =
        match prop with
        | VisualTimelineViewGroupBaseProp.Base p -> VisualResourcesBasedViewInfo.apply el p
        | VisualTimelineViewGroupBaseProp.Header v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupBase.HeaderProperty, box v)
        | VisualTimelineViewGroupBaseProp.SelectionBarContainer v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupBase.SelectionBarContainerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualTimelineViewGroupBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
