...
type AnnotationAnchorThumbProp =
    | Base of AnnotationThumbProp

module AnnotationAnchorThumb =

    let apply (el: DevExpress.Xpf.Charts.AnnotationAnchorThumb) (prop: AnnotationAnchorThumbProp) =
        match prop with
        | AnnotationAnchorThumbProp.Base p -> AnnotationThumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AnnotationAnchorThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
