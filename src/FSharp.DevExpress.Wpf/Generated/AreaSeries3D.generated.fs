...
module AreaSeries3D =
    ...
    let apply (el: DevExpress.Xpf.Charts.AreaSeries3D) (prop: AreaSeries3DProp) =
        match prop with
        | AreaSeries3DProp.Base p -> XYSeries3D.apply el p
        | AreaSeries3DProp.AreaWidth v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries3D.AreaWidthProperty, box v)
        | AreaSeries3DProp.Material v -> el.SetValue(DevExpress.Xpf.Charts.AreaSeries3D.MaterialProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AreaSeries3D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
