...
type MinorGridLinesRenderControlProp =
    | Base of GridLinesRenderControlBaseProp

module MinorGridLinesRenderControl =

    let apply (el: DevExpress.Xpf.Charts.MinorGridLinesRenderControl) (prop: MinorGridLinesRenderControlProp) =
        match prop with
        | MinorGridLinesRenderControlProp.Base p -> GridLinesRenderControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.MinorGridLinesRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
