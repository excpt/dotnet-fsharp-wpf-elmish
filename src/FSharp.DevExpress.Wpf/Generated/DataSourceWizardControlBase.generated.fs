...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.DataSourceWizard
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DataSourceWizardControlBaseProp =
    | DataSourceWizardSettings of DevExpress.DataAccess.UI.Wizard.DataSourceWizardSettings
    | StartPage of System.Type
    | PageTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | ServicesRegistry of obj
    | MessageBoxServiceTemplate of System.Windows.DataTemplate
    | SplashScreenServiceTemplate of System.Windows.DataTemplate
    | OpenFileDialogServiceTemplate of System.Windows.DataTemplate
    | QueryBuilderDialogServiceTemplate of System.Windows.DataTemplate
    | PreviewDialogServiceTemplate of System.Windows.DataTemplate
    | PasswordDialogServiceTemplate of System.Windows.DataTemplate
    | ChooseEFStoredProceduresDialogServiceTemplate of System.Windows.DataTemplate
    | MasterDetailDialogServiceTemplate of System.Windows.DataTemplate
    | FilterEditorDialogServiceTemplate of System.Windows.DataTemplate

module DataSourceWizardControlBase =
    let dataSourceWizardSettings v : obj = box (DataSourceWizardControlBaseProp.DataSourceWizardSettings v)
    let startPage v : obj = box (DataSourceWizardControlBaseProp.StartPage v)
    let pageTemplateSelector v : obj = box (DataSourceWizardControlBaseProp.PageTemplateSelector v)
    let servicesRegistry v : obj = box (DataSourceWizardControlBaseProp.ServicesRegistry v)
    let messageBoxServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.MessageBoxServiceTemplate v)
    let splashScreenServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.SplashScreenServiceTemplate v)
    let openFileDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.OpenFileDialogServiceTemplate v)
    let queryBuilderDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.QueryBuilderDialogServiceTemplate v)
    let previewDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.PreviewDialogServiceTemplate v)
    let passwordDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.PasswordDialogServiceTemplate v)
    let chooseEFStoredProceduresDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.ChooseEFStoredProceduresDialogServiceTemplate v)
    let masterDetailDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.MasterDetailDialogServiceTemplate v)
    let filterEditorDialogServiceTemplate v : obj = box (DataSourceWizardControlBaseProp.FilterEditorDialogServiceTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase) (prop: DataSourceWizardControlBaseProp) =
        match prop with
        | DataSourceWizardControlBaseProp.DataSourceWizardSettings v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.DataSourceWizardSettingsProperty, box v)
        | DataSourceWizardControlBaseProp.StartPage v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.StartPageProperty, box v)
        | DataSourceWizardControlBaseProp.PageTemplateSelector v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.PageTemplateSelectorProperty, box v)
        | DataSourceWizardControlBaseProp.ServicesRegistry v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.ServicesRegistryProperty, box v)
        | DataSourceWizardControlBaseProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.MessageBoxServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.SplashScreenServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.SplashScreenServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.OpenFileDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.OpenFileDialogServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.QueryBuilderDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.QueryBuilderDialogServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.PreviewDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.PreviewDialogServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.PasswordDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.PasswordDialogServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.ChooseEFStoredProceduresDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.ChooseEFStoredProceduresDialogServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.MasterDetailDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.MasterDetailDialogServiceTemplateProperty, box v)
        | DataSourceWizardControlBaseProp.FilterEditorDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.DataSourceWizardControlBase.FilterEditorDialogServiceTemplateProperty, box v)
