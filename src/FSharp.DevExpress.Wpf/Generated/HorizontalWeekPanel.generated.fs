...
type HorizontalWeekPanelProp =
    | Base of WeekPanelProp

module HorizontalWeekPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalWeekPanel) (prop: HorizontalWeekPanelProp) =
        match prop with
        | HorizontalWeekPanelProp.Base p -> WeekPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HorizontalWeekPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
