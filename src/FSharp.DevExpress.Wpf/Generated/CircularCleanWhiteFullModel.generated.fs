...
type CircularCleanWhiteFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCleanWhiteFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCleanWhiteFullModel) (prop: CircularCleanWhiteFullModelProp) =
        match prop with
        | CircularCleanWhiteFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCleanWhiteFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
