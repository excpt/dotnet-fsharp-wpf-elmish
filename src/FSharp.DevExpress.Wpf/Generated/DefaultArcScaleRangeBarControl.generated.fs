...
type DefaultArcScaleRangeBarControlProp =
    | Base of ValueIndicatorPresentationControlProp

module DefaultArcScaleRangeBarControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultArcScaleRangeBarControl) (prop: DefaultArcScaleRangeBarControlProp) =
        match prop with
        | DefaultArcScaleRangeBarControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultArcScaleRangeBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
