...
type CircularDefaultQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularDefaultQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularDefaultQuarterTopRightModel) (prop: CircularDefaultQuarterTopRightModelProp) =
        match prop with
        | CircularDefaultQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularDefaultQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
