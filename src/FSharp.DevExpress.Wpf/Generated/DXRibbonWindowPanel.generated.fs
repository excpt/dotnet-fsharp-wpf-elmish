...
type DXRibbonWindowPanelProp =
    | ControlBox of System.Windows.UIElement
    | BackgroundBorder of System.Windows.UIElement
    | HeaderBackgroundBorder of System.Windows.UIElement
    | TitleContainer of System.Windows.UIElement
    | IconContainer of System.Windows.UIElement
    | Content of System.Windows.UIElement
    | ContentBackgroundBorder of System.Windows.UIElement
    | ContentBackgroundBorderMargin of System.Windows.Thickness
    | StatusBarContainer of System.Windows.UIElement
    | BackgroundBorderPadding of System.Windows.Thickness
    | IsAeroMode of bool
    | ContentBackgroundBorderInAeroMode of System.Windows.UIElement
    | ContentBackgroundBorderMarginInAeroMode of System.Windows.Thickness
    | IsRibbonMode of bool
    | ContentBackgroundBorderPadding of System.Windows.Thickness

module DXRibbonWindowPanel =
    let controlBox v : obj = box (DXRibbonWindowPanelProp.ControlBox v)
    let backgroundBorder v : obj = box (DXRibbonWindowPanelProp.BackgroundBorder v)
    let headerBackgroundBorder v : obj = box (DXRibbonWindowPanelProp.HeaderBackgroundBorder v)
    let titleContainer v : obj = box (DXRibbonWindowPanelProp.TitleContainer v)
    let iconContainer v : obj = box (DXRibbonWindowPanelProp.IconContainer v)
    let content v : obj = box (DXRibbonWindowPanelProp.Content v)
    let contentBackgroundBorder v : obj = box (DXRibbonWindowPanelProp.ContentBackgroundBorder v)
    let contentBackgroundBorderMargin v : obj = box (DXRibbonWindowPanelProp.ContentBackgroundBorderMargin v)
    let statusBarContainer v : obj = box (DXRibbonWindowPanelProp.StatusBarContainer v)
    let backgroundBorderPadding v : obj = box (DXRibbonWindowPanelProp.BackgroundBorderPadding v)
    let isAeroMode v : obj = box (DXRibbonWindowPanelProp.IsAeroMode v)
    let contentBackgroundBorderInAeroMode v : obj = box (DXRibbonWindowPanelProp.ContentBackgroundBorderInAeroMode v)
    let contentBackgroundBorderMarginInAeroMode v : obj = box (DXRibbonWindowPanelProp.ContentBackgroundBorderMarginInAeroMode v)
    let isRibbonMode v : obj = box (DXRibbonWindowPanelProp.IsRibbonMode v)
    let contentBackgroundBorderPadding v : obj = box (DXRibbonWindowPanelProp.ContentBackgroundBorderPadding v)

    let apply (el: DevExpress.Xpf.Ribbon.DXRibbonWindowPanel) (prop: DXRibbonWindowPanelProp) =
        match prop with
        | DXRibbonWindowPanelProp.ControlBox v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ControlBoxProperty, box v)
        | DXRibbonWindowPanelProp.BackgroundBorder v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.BackgroundBorderProperty, box v)
        | DXRibbonWindowPanelProp.HeaderBackgroundBorder v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.HeaderBackgroundBorderProperty, box v)
        | DXRibbonWindowPanelProp.TitleContainer v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.TitleContainerProperty, box v)
        | DXRibbonWindowPanelProp.IconContainer v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.IconContainerProperty, box v)
        | DXRibbonWindowPanelProp.Content v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ContentProperty, box v)
        | DXRibbonWindowPanelProp.ContentBackgroundBorder v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ContentBackgroundBorderProperty, box v)
        | DXRibbonWindowPanelProp.ContentBackgroundBorderMargin v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ContentBackgroundBorderMarginProperty, box v)
        | DXRibbonWindowPanelProp.StatusBarContainer v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.StatusBarContainerProperty, box v)
        | DXRibbonWindowPanelProp.BackgroundBorderPadding v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.BackgroundBorderPaddingProperty, box v)
        | DXRibbonWindowPanelProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.IsAeroModeProperty, box v)
        | DXRibbonWindowPanelProp.ContentBackgroundBorderInAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ContentBackgroundBorderInAeroModeProperty, box v)
        | DXRibbonWindowPanelProp.ContentBackgroundBorderMarginInAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ContentBackgroundBorderMarginInAeroModeProperty, box v)
        | DXRibbonWindowPanelProp.IsRibbonMode v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.IsRibbonModeProperty, box v)
        | DXRibbonWindowPanelProp.ContentBackgroundBorderPadding v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowPanel.ContentBackgroundBorderPaddingProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.DXRibbonWindowPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
