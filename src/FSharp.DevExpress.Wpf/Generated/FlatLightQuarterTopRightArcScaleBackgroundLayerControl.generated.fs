...
type FlatLightQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatLightQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightQuarterTopRightArcScaleBackgroundLayerControl) (prop: FlatLightQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatLightQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
