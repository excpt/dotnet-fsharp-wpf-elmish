...
type AccordionFlyoutControlProp =
    | Base of FlyoutControlProp

module AccordionFlyoutControl =

    let apply (el: DevExpress.Xpf.Accordion.AccordionFlyoutControl) (prop: AccordionFlyoutControlProp) =
        match prop with
        | AccordionFlyoutControlProp.Base p -> FlyoutControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionFlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
