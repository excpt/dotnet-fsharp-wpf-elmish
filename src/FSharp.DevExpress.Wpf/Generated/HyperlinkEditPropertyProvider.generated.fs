...
type HyperlinkEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp

module HyperlinkEditPropertyProvider =

    let apply (el: DevExpress.Xpf.Editors.HyperlinkEditPropertyProvider) (prop: HyperlinkEditPropertyProviderProp) =
        match prop with
        | HyperlinkEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.HyperlinkEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
