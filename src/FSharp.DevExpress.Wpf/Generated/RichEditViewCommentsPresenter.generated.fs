...
type RichEditViewCommentsPresenterProp =
    | Base of RichEditElementProp

module RichEditViewCommentsPresenter =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewCommentsPresenter) (prop: RichEditViewCommentsPresenterProp) =
        match prop with
        | RichEditViewCommentsPresenterProp.Base p -> RichEditElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewCommentsPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
