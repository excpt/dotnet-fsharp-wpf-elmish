...
open System
open System.Windows
open DevExpress.Xpf.Editors.ExpressionEditor
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ExpressionEditorContainerProp =
    | CurrentColumnInfo of DevExpress.Data.IDataColumnInfo
    | BindableExpression of string

module ExpressionEditorContainer =
    ...
    let apply (el: DevExpress.Xpf.Editors.ExpressionEditor.ExpressionEditorContainer) (prop: ExpressionEditorContainerProp) =
        match prop with
        | ExpressionEditorContainerProp.CurrentColumnInfo v -> el.SetValue(DevExpress.Xpf.Editors.ExpressionEditor.ExpressionEditorContainer.CurrentColumnInfoProperty, box v)
        | ExpressionEditorContainerProp.BindableExpression v -> el.SetValue(DevExpress.Xpf.Editors.ExpressionEditor.ExpressionEditorContainer.BindableExpressionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ExpressionEditor.ExpressionEditorContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
