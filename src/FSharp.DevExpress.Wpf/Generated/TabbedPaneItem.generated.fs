...
type TabbedPaneItemProp =
    | Base of psvSelectorItemProp
    | CaptionOrientation of System.Windows.Controls.Orientation
    | CaptionLocation of DevExpress.Xpf.Docking.CaptionLocation
    | Pinned of bool
    | PinLocation of DevExpress.Xpf.Layout.Core.TabHeaderPinLocation
    | DragOffset of System.Windows.Thickness

module TabbedPaneItem =
    let captionOrientation v : obj = box (TabbedPaneItemProp.CaptionOrientation v)
    let captionLocation v : obj = box (TabbedPaneItemProp.CaptionLocation v)
    let pinned v : obj = box (TabbedPaneItemProp.Pinned v)
    let pinLocation v : obj = box (TabbedPaneItemProp.PinLocation v)
    let dragOffset v : obj = box (TabbedPaneItemProp.DragOffset v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem) (prop: TabbedPaneItemProp) =
        match prop with
        | TabbedPaneItemProp.Base p -> psvSelectorItem.apply el p
        | TabbedPaneItemProp.CaptionOrientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem.CaptionOrientationProperty, box v)
        | TabbedPaneItemProp.CaptionLocation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem.CaptionLocationProperty, box v)
        | TabbedPaneItemProp.Pinned v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem.PinnedProperty, box v)
        | TabbedPaneItemProp.PinLocation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem.PinLocationProperty, box v)
        | TabbedPaneItemProp.DragOffset v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem.DragOffsetProperty, box v)

    let viewStyle v : obj = box (psvSelectorItemProp.ViewStyle v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabbedPaneItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
