...
type SparklineStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp
...
module SparklineStyleSettings =
    ...
    let apply (el: DevExpress.Xpf.Editors.SparklineStyleSettings) (prop: SparklineStyleSettingsProp) =
        match prop with
        | SparklineStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
        | SparklineStyleSettingsProp.HighlightMinPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.HighlightMinPointProperty, box v)
        | SparklineStyleSettingsProp.HighlightMaxPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.HighlightMaxPointProperty, box v)
        | SparklineStyleSettingsProp.HighlightStartPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.HighlightStartPointProperty, box v)
        | SparklineStyleSettingsProp.HighlightEndPoint v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.HighlightEndPointProperty, box v)
        | SparklineStyleSettingsProp.Brush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.BrushProperty, box v)
        | SparklineStyleSettingsProp.MaxPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.MaxPointBrushProperty, box v)
        | SparklineStyleSettingsProp.MinPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.MinPointBrushProperty, box v)
        | SparklineStyleSettingsProp.StartPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.StartPointBrushProperty, box v)
        | SparklineStyleSettingsProp.EndPointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.EndPointBrushProperty, box v)
        | SparklineStyleSettingsProp.NegativePointBrush v -> el.SetValue(DevExpress.Xpf.Editors.SparklineStyleSettings.NegativePointBrushProperty, box v)
