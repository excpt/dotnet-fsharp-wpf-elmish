...
type LegendItemsControlProp =
    | Base of ChartItemsControlProp
    | LegendItems of DevExpress.Xpf.Charts.LegendItemList
    | ReverseItems of bool

module LegendItemsControl =
    let legendItems v : obj = box (LegendItemsControlProp.LegendItems v)
    let reverseItems v : obj = box (LegendItemsControlProp.ReverseItems v)

    let apply (el: DevExpress.Xpf.Charts.LegendItemsControl) (prop: LegendItemsControlProp) =
        match prop with
        | LegendItemsControlProp.Base p -> ChartItemsControl.apply el p
        | LegendItemsControlProp.LegendItems v -> el.SetValue(DevExpress.Xpf.Charts.LegendItemsControl.LegendItemsProperty, box v)
        | LegendItemsControlProp.ReverseItems v -> el.SetValue(DevExpress.Xpf.Charts.LegendItemsControl.ReverseItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LegendItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
