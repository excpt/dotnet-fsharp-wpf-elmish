...
type DocumentPaneItemProp =
    | Base of TabbedPaneItemProp
    | TabColor of System.Windows.Media.Color

module DocumentPaneItem =
    let tabColor v : obj = box (DocumentPaneItemProp.TabColor v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentPaneItem) (prop: DocumentPaneItemProp) =
        match prop with
        | DocumentPaneItemProp.Base p -> TabbedPaneItem.apply el p
        | DocumentPaneItemProp.TabColor v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentPaneItem.TabColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentPaneItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
