...
type CodabarStyleSettingsProp =
    | StartStopPair of DevExpress.XtraPrinting.BarCode.CodabarStartStopPair
    | WideNarrowRatio of float32

module CodabarStyleSettings =
    let startStopPair v : obj = box (CodabarStyleSettingsProp.StartStopPair v)
    let wideNarrowRatio v : obj = box (CodabarStyleSettingsProp.WideNarrowRatio v)

    let apply (el: DevExpress.Xpf.Editors.CodabarStyleSettings) (prop: CodabarStyleSettingsProp) =
        match prop with
        | CodabarStyleSettingsProp.StartStopPair v -> el.SetValue(DevExpress.Xpf.Editors.CodabarStyleSettings.StartStopPairProperty, box v)
        | CodabarStyleSettingsProp.WideNarrowRatio v -> el.SetValue(DevExpress.Xpf.Editors.CodabarStyleSettings.WideNarrowRatioProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CodabarStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
