...
type CircularYellowSubmarineQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularYellowSubmarineQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularYellowSubmarineQuarterTopRightModel) (prop: CircularYellowSubmarineQuarterTopRightModelProp) =
        match prop with
        | CircularYellowSubmarineQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularYellowSubmarineQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
