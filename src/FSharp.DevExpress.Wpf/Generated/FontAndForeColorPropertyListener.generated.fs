...
open System
open System.Windows
open DevExpress.XtraRichEdit.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FontAndForeColorPropertyListenerProp =
    | FontFamily of obj
    | FontSize of obj
    | FontWeight of obj
    | FontStyle of obj
...
module FontAndForeColorPropertyListener =
    let fontFamily v : obj = box (FontAndForeColorPropertyListenerProp.FontFamily v)
    let fontSize v : obj = box (FontAndForeColorPropertyListenerProp.FontSize v)
    let fontWeight v : obj = box (FontAndForeColorPropertyListenerProp.FontWeight v)
    let fontStyle v : obj = box (FontAndForeColorPropertyListenerProp.FontStyle v)
    let foreground v : obj = box (FontAndForeColorPropertyListenerProp.Foreground v)

    let apply (el: DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener) (prop: FontAndForeColorPropertyListenerProp) =
        match prop with
        | FontAndForeColorPropertyListenerProp.FontFamily v -> el.SetValue(DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener.FontFamilyProperty, box v)
        | FontAndForeColorPropertyListenerProp.FontSize v -> el.SetValue(DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener.FontSizeProperty, box v)
        | FontAndForeColorPropertyListenerProp.FontWeight v -> el.SetValue(DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener.FontWeightProperty, box v)
        | FontAndForeColorPropertyListenerProp.FontStyle v -> el.SetValue(DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener.FontStyleProperty, box v)
        | FontAndForeColorPropertyListenerProp.Foreground v -> el.SetValue(DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.Internal.FontAndForeColorPropertyListener>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
