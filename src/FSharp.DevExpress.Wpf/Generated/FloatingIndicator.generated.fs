...
type FloatingIndicatorProp =
    | Base of SelectionIndicatorProp

module FloatingIndicator =

    let apply (el: DevExpress.Xpf.Core.Native.FloatingIndicator) (prop: FloatingIndicatorProp) =
        match prop with
        | FloatingIndicatorProp.Base p -> SelectionIndicator.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.FloatingIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
