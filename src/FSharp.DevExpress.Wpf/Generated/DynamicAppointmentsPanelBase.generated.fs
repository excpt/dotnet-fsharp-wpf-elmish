...
type DynamicAppointmentsPanelBaseProp =
    | Base of SchedulerCellsBasedPanelBaseProp
    | CellPadding of System.Windows.Thickness
    | SnapToCells of DevExpress.XtraScheduler.AppointmentSnapToCellsMode
    | AppointmentControls of DevExpress.Xpf.Scheduler.Drawing.AppointmentControlObservableCollection
    | IsDraggedMode of bool
    | AppointmentStyle of System.Windows.Style

module DynamicAppointmentsPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DynamicAppointmentsPanelBase) (prop: DynamicAppointmentsPanelBaseProp) =
        match prop with
        | DynamicAppointmentsPanelBaseProp.Base p -> SchedulerCellsBasedPanelBase.apply el p
        | DynamicAppointmentsPanelBaseProp.CellPadding v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicAppointmentsPanelBase.CellPaddingProperty, box v)
        | DynamicAppointmentsPanelBaseProp.SnapToCells v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicAppointmentsPanelBase.SnapToCellsProperty, box v)
        | DynamicAppointmentsPanelBaseProp.AppointmentControls v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicAppointmentsPanelBase.AppointmentControlsProperty, box v)
        | DynamicAppointmentsPanelBaseProp.IsDraggedMode v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicAppointmentsPanelBase.IsDraggedModeProperty, box v)
        | DynamicAppointmentsPanelBaseProp.AppointmentStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicAppointmentsPanelBase.AppointmentStyleProperty, box v)
