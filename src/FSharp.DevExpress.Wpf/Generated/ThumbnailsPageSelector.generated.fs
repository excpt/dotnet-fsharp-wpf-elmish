...
type ThumbnailsPageSelectorProp =
    | Base of DocumentViewerItemsControlProp

module ThumbnailsPageSelector =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsPageSelector) (prop: ThumbnailsPageSelectorProp) =
        match prop with
        | ThumbnailsPageSelectorProp.Base p -> DocumentViewerItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.ThumbnailsPageSelector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
