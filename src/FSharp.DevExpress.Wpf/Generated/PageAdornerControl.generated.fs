...
module PageAdornerControl =
    let backCommand v : obj = box (PageAdornerControlProp.BackCommand v)
    let showBackButton v : obj = box (PageAdornerControlProp.ShowBackButton v)
    let backCommandParameter v : obj = box (PageAdornerControlProp.BackCommandParameter v)

    let apply (el: DevExpress.Xpf.WindowsUI.PageAdornerControl) (prop: PageAdornerControlProp) =
        match prop with
        | PageAdornerControlProp.Base p -> veHeaderedContentControl.apply el p
        | PageAdornerControlProp.BackCommand v -> el.SetValue(DevExpress.Xpf.WindowsUI.PageAdornerControl.BackCommandProperty, box v)
        | PageAdornerControlProp.ShowBackButton v -> el.SetValue(DevExpress.Xpf.WindowsUI.PageAdornerControl.ShowBackButtonProperty, box v)
        | PageAdornerControlProp.BackCommandParameter v -> el.SetValue(DevExpress.Xpf.WindowsUI.PageAdornerControl.BackCommandParameterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.PageAdornerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
