...
type SlideViewScrollPanelProp =
    | Base of ScrollControlProp
    | Child of System.Windows.UIElement
    | Orientation of System.Windows.Controls.Orientation

module SlideViewScrollPanel =
    let child v : obj = box (SlideViewScrollPanelProp.Child v)
    let orientation v : obj = box (SlideViewScrollPanelProp.Orientation v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.SlideViewScrollPanel) (prop: SlideViewScrollPanelProp) =
        match prop with
        | SlideViewScrollPanelProp.Base p -> ScrollControl.apply el p
        | SlideViewScrollPanelProp.Child v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SlideViewScrollPanel.ChildProperty, box v)
        | SlideViewScrollPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SlideViewScrollPanel.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.SlideViewScrollPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
