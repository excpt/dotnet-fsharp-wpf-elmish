...
type CircularIStyleThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularIStyleThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularIStyleThreeQuartersModel) (prop: CircularIStyleThreeQuartersModelProp) =
        match prop with
        | CircularIStyleThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularIStyleThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
