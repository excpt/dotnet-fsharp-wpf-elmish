...
type AxisScrollBarThumbResizerProp =
    | Base of AxisScrollBarThumbProp

module AxisScrollBarThumbResizer =

    let apply (el: DevExpress.Xpf.Charts.AxisScrollBarThumbResizer) (prop: AxisScrollBarThumbResizerProp) =
        match prop with
        | AxisScrollBarThumbResizerProp.Base p -> AxisScrollBarThumb.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisScrollBarThumbResizer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
