...
type ImageEditClearToolButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditClearToolButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditClearToolButton) (prop: ImageEditClearToolButtonProp) =
        match prop with
        | ImageEditClearToolButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditClearToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
