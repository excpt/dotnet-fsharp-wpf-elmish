...
type DefaultMajorTickmarkControlProp =
    | Base of PresentationControlProp

module DefaultMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultMajorTickmarkControl) (prop: DefaultMajorTickmarkControlProp) =
        match prop with
        | DefaultMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
