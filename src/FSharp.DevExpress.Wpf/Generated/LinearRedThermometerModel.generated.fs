...
type LinearRedThermometerModelProp =
    | Base of LinearGaugeModelProp

module LinearRedThermometerModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearRedThermometerModel) (prop: LinearRedThermometerModelProp) =
        match prop with
        | LinearRedThermometerModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearRedThermometerModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
