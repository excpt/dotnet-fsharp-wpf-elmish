...
type CircularRedClockFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularRedClockFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularRedClockFullModel) (prop: CircularRedClockFullModelProp) =
        match prop with
        | CircularRedClockFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularRedClockFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
