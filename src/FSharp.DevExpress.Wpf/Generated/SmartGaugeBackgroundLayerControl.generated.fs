...
type SmartGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartGaugeBackgroundLayerControl) (prop: SmartGaugeBackgroundLayerControlProp) =
        match prop with
        | SmartGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
