...
type PrintGroupCollapseButtonProp =
    | Base of GroupCollapseButtonProp

module PrintGroupCollapseButton =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintGroupCollapseButton) (prop: PrintGroupCollapseButtonProp) =
        match prop with
        | PrintGroupCollapseButtonProp.Base p -> GroupCollapseButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintGroupCollapseButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
