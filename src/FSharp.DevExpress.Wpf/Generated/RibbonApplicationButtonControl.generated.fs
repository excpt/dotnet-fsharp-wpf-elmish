...
type RibbonApplicationButtonControlProp =
    | IsPopup of bool
    | IsChecked of bool
    | RibbonStyle of DevExpress.Xpf.Ribbon.RibbonStyle
    | BorderTemplateForOffice2007RibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateInPopupForOffice2007RibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateForOffice2010RibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateInPopupForOffice2010RibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateInPopupForTabletOfficeRibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateForTabletOfficeRibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateForOfficeSlimRibbonStyle of System.Windows.Controls.ControlTemplate
    | BorderTemplateInPopupForOfficeSlimRibbonStyle of System.Windows.Controls.ControlTemplate

module RibbonApplicationButtonControl =
    let isPopup v : obj = box (RibbonApplicationButtonControlProp.IsPopup v)
    let isChecked v : obj = box (RibbonApplicationButtonControlProp.IsChecked v)
    let ribbonStyle v : obj = box (RibbonApplicationButtonControlProp.RibbonStyle v)
    let borderTemplateForOffice2007RibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateForOffice2007RibbonStyle v)
    let borderTemplateInPopupForOffice2007RibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateInPopupForOffice2007RibbonStyle v)
    let borderTemplateForOffice2010RibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateForOffice2010RibbonStyle v)
    let borderTemplateInPopupForOffice2010RibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateInPopupForOffice2010RibbonStyle v)
    let borderTemplateInPopupForTabletOfficeRibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateInPopupForTabletOfficeRibbonStyle v)
    let borderTemplateForTabletOfficeRibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateForTabletOfficeRibbonStyle v)
    let borderTemplateForOfficeSlimRibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateForOfficeSlimRibbonStyle v)
    let borderTemplateInPopupForOfficeSlimRibbonStyle v : obj = box (RibbonApplicationButtonControlProp.BorderTemplateInPopupForOfficeSlimRibbonStyle v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl) (prop: RibbonApplicationButtonControlProp) =
        match prop with
        | RibbonApplicationButtonControlProp.IsPopup v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.IsPopupProperty, box v)
        | RibbonApplicationButtonControlProp.IsChecked v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.IsCheckedProperty, box v)
        | RibbonApplicationButtonControlProp.RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.RibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateForOffice2007RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateForOffice2007RibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateInPopupForOffice2007RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateInPopupForOffice2007RibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateForOffice2010RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateForOffice2010RibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateInPopupForOffice2010RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateInPopupForOffice2010RibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateInPopupForTabletOfficeRibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateInPopupForTabletOfficeRibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateForTabletOfficeRibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateForTabletOfficeRibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateForOfficeSlimRibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateForOfficeSlimRibbonStyleProperty, box v)
        | RibbonApplicationButtonControlProp.BorderTemplateInPopupForOfficeSlimRibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl.BorderTemplateInPopupForOfficeSlimRibbonStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
