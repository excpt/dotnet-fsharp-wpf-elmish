...
type GanttStripLineFlyoutControlProp =
    | Base of GanttEditFlyoutControlBaseProp

module GanttStripLineFlyoutControl =

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttStripLineFlyoutControl) (prop: GanttStripLineFlyoutControlProp) =
        match prop with
        | GanttStripLineFlyoutControlProp.Base p -> GanttEditFlyoutControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttStripLineFlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
