...
type AppointmentVerticalControlProp =
    | Base of AppointmentControlProp

module AppointmentVerticalControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentVerticalControl) (prop: AppointmentVerticalControlProp) =
        match prop with
        | AppointmentVerticalControlProp.Base p -> AppointmentControl.apply el p
