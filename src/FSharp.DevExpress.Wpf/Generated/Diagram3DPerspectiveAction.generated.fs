...
type Diagram3DPerspectiveActionProp =
    | Base of Diagram3DAnimationActionProp
    | FinalPerspectiveAngle of float

module Diagram3DPerspectiveAction =
    let finalPerspectiveAngle v : obj = box (Diagram3DPerspectiveActionProp.FinalPerspectiveAngle v)

    let apply (el: DevExpress.Xpf.Charts.Diagram3DPerspectiveAction) (prop: Diagram3DPerspectiveActionProp) =
        match prop with
        | Diagram3DPerspectiveActionProp.Base p -> Diagram3DAnimationAction.apply el p
        | Diagram3DPerspectiveActionProp.FinalPerspectiveAngle v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DPerspectiveAction.FinalPerspectiveAngleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Diagram3DPerspectiveAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
