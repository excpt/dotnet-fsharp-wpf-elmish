...
type MoreButtonsControlProp =
    | GoUpCommand of System.Windows.Input.ICommand
    | GoDownCommand of System.Windows.Input.ICommand
    | UpButtonVisibility of System.Windows.Visibility
    | DownButtonVisibility of System.Windows.Visibility

module MoreButtonsControl =
    let goUpCommand v : obj = box (MoreButtonsControlProp.GoUpCommand v)
    let goDownCommand v : obj = box (MoreButtonsControlProp.GoDownCommand v)
    let upButtonVisibility v : obj = box (MoreButtonsControlProp.UpButtonVisibility v)
    let downButtonVisibility v : obj = box (MoreButtonsControlProp.DownButtonVisibility v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MoreButtonsControl) (prop: MoreButtonsControlProp) =
        match prop with
        | MoreButtonsControlProp.GoUpCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MoreButtonsControl.GoUpCommandProperty, box v)
        | MoreButtonsControlProp.GoDownCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MoreButtonsControl.GoDownCommandProperty, box v)
        | MoreButtonsControlProp.UpButtonVisibility v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MoreButtonsControl.UpButtonVisibilityProperty, box v)
        | MoreButtonsControlProp.DownButtonVisibility v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MoreButtonsControl.DownButtonVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MoreButtonsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
