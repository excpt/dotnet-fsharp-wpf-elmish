...
type ImageAndTextDecoratorProp =
    | DisplayMode of DevExpress.Xpf.NavBar.DisplayMode
    | ImageDocking of System.Windows.Controls.Dock
    | ContentSource of obj
    | ContentStyle of System.Windows.Style
    | ImageSource of System.Windows.Media.ImageSource
    | ImageStyle of System.Windows.Style
    | ImageFallbackSize of float
    | DisplayModeTextMargin of System.Windows.Thickness
    | DisplayModeImageMargin of System.Windows.Thickness
    | DockingTopContentMargin of System.Windows.Thickness
    | DockingTopImageMargin of System.Windows.Thickness
    | DockingBottomContentMargin of System.Windows.Thickness
    | DockingBottomImageMargin of System.Windows.Thickness
    | DockingRightContentMargin of System.Windows.Thickness
    | DockingRightImageMargin of System.Windows.Thickness
    | DockingLeftContentMargin of System.Windows.Thickness
    | DockingLeftImageMargin of System.Windows.Thickness

module ImageAndTextDecorator =
    let displayMode v : obj = box (ImageAndTextDecoratorProp.DisplayMode v)
    let imageDocking v : obj = box (ImageAndTextDecoratorProp.ImageDocking v)
    let contentSource v : obj = box (ImageAndTextDecoratorProp.ContentSource v)
    let contentStyle v : obj = box (ImageAndTextDecoratorProp.ContentStyle v)
    let imageSource v : obj = box (ImageAndTextDecoratorProp.ImageSource v)
    let imageStyle v : obj = box (ImageAndTextDecoratorProp.ImageStyle v)
    let imageFallbackSize v : obj = box (ImageAndTextDecoratorProp.ImageFallbackSize v)
    let displayModeTextMargin v : obj = box (ImageAndTextDecoratorProp.DisplayModeTextMargin v)
    let displayModeImageMargin v : obj = box (ImageAndTextDecoratorProp.DisplayModeImageMargin v)
    let dockingTopContentMargin v : obj = box (ImageAndTextDecoratorProp.DockingTopContentMargin v)
    let dockingTopImageMargin v : obj = box (ImageAndTextDecoratorProp.DockingTopImageMargin v)
    let dockingBottomContentMargin v : obj = box (ImageAndTextDecoratorProp.DockingBottomContentMargin v)
    let dockingBottomImageMargin v : obj = box (ImageAndTextDecoratorProp.DockingBottomImageMargin v)
    let dockingRightContentMargin v : obj = box (ImageAndTextDecoratorProp.DockingRightContentMargin v)
    let dockingRightImageMargin v : obj = box (ImageAndTextDecoratorProp.DockingRightImageMargin v)
    let dockingLeftContentMargin v : obj = box (ImageAndTextDecoratorProp.DockingLeftContentMargin v)
    let dockingLeftImageMargin v : obj = box (ImageAndTextDecoratorProp.DockingLeftImageMargin v)

    let apply (el: DevExpress.Xpf.NavBar.ImageAndTextDecorator) (prop: ImageAndTextDecoratorProp) =
        match prop with
        | ImageAndTextDecoratorProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DisplayModeProperty, box v)
        | ImageAndTextDecoratorProp.ImageDocking v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.ImageDockingProperty, box v)
        | ImageAndTextDecoratorProp.ContentSource v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.ContentSourceProperty, box v)
        | ImageAndTextDecoratorProp.ContentStyle v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.ContentStyleProperty, box v)
        | ImageAndTextDecoratorProp.ImageSource v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.ImageSourceProperty, box v)
        | ImageAndTextDecoratorProp.ImageStyle v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.ImageStyleProperty, box v)
        | ImageAndTextDecoratorProp.ImageFallbackSize v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.ImageFallbackSizeProperty, box v)
        | ImageAndTextDecoratorProp.DisplayModeTextMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DisplayModeTextMarginProperty, box v)
        | ImageAndTextDecoratorProp.DisplayModeImageMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DisplayModeImageMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingTopContentMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingTopContentMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingTopImageMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingTopImageMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingBottomContentMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingBottomContentMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingBottomImageMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingBottomImageMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingRightContentMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingRightContentMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingRightImageMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingRightImageMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingLeftContentMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingLeftContentMarginProperty, box v)
        | ImageAndTextDecoratorProp.DockingLeftImageMargin v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextDecorator.DockingLeftImageMarginProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ImageAndTextDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
