...
module DateHeaderPresenter =
    let fontFamily v : obj = box (DateHeaderPresenterProp.FontFamily v)
    let fontStyle v : obj = box (DateHeaderPresenterProp.FontStyle v)
    let fontWeight v : obj = box (DateHeaderPresenterProp.FontWeight v)
    let fontStretch v : obj = box (DateHeaderPresenterProp.FontStretch v)
    let fontSize v : obj = box (DateHeaderPresenterProp.FontSize v)
    let foreground v : obj = box (DateHeaderPresenterProp.Foreground v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter) (prop: DateHeaderPresenterProp) =
        match prop with
        | DateHeaderPresenterProp.FontFamily v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter.FontFamilyProperty, box v)
        | DateHeaderPresenterProp.FontStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter.FontStyleProperty, box v)
        | DateHeaderPresenterProp.FontWeight v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter.FontWeightProperty, box v)
        | DateHeaderPresenterProp.FontStretch v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter.FontStretchProperty, box v)
        | DateHeaderPresenterProp.FontSize v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter.FontSizeProperty, box v)
        | DateHeaderPresenterProp.Foreground v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DateHeaderPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
