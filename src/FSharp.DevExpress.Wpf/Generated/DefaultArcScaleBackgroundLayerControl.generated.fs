...
type DefaultArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultArcScaleBackgroundLayerControl) (prop: DefaultArcScaleBackgroundLayerControlProp) =
        match prop with
        | DefaultArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
