...
type LineScatterSeries2DProp =
    | Base of LineSeries2DProp

module LineScatterSeries2D =

    let apply (el: DevExpress.Xpf.Charts.LineScatterSeries2D) (prop: LineScatterSeries2DProp) =
        match prop with
        | LineScatterSeries2DProp.Base p -> LineSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LineScatterSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
