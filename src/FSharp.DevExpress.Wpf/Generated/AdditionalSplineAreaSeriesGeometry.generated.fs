...
type AdditionalSplineAreaSeriesGeometryProp =
    | Base of AdditionalAreaSeriesGeometryProp

module AdditionalSplineAreaSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalSplineAreaSeriesGeometry) (prop: AdditionalSplineAreaSeriesGeometryProp) =
        match prop with
        | AdditionalSplineAreaSeriesGeometryProp.Base p -> AdditionalAreaSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalSplineAreaSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
