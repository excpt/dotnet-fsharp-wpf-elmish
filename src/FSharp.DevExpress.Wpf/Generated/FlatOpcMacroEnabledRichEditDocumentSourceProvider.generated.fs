...
type FlatOpcMacroEnabledRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module FlatOpcMacroEnabledRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.FlatOpcMacroEnabledRichEditDocumentSourceProvider) (prop: FlatOpcMacroEnabledRichEditDocumentSourceProviderProp) =
        match prop with
        | FlatOpcMacroEnabledRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.FlatOpcMacroEnabledRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
