...
type ShapePresenterProp =
    | SelectionStrokeWidth of float
    | Shape of DevExpress.Diagram.Core.ShapeGeometry
    | ShowContent of bool
    | ContentPadding of System.Windows.Thickness
    | EditorBounds of System.Windows.Rect
    | PenLineCap of System.Windows.Media.PenLineCap
    | Content of string
    | Zoom of float
...
module ShapePresenter =
    let selectionStrokeWidth v : obj = box (ShapePresenterProp.SelectionStrokeWidth v)
    let shape v : obj = box (ShapePresenterProp.Shape v)
    let showContent v : obj = box (ShapePresenterProp.ShowContent v)
    let contentPadding v : obj = box (ShapePresenterProp.ContentPadding v)
    let editorBounds v : obj = box (ShapePresenterProp.EditorBounds v)
    let penLineCap v : obj = box (ShapePresenterProp.PenLineCap v)
    let content v : obj = box (ShapePresenterProp.Content v)
    let zoom v : obj = box (ShapePresenterProp.Zoom v)
    let contentBackground v : obj = box (ShapePresenterProp.ContentBackground v)
    let stroke v : obj = box (ShapePresenterProp.Stroke v)
    let strokeThickness v : obj = box (ShapePresenterProp.StrokeThickness v)
    let strokeDashArray v : obj = box (ShapePresenterProp.StrokeDashArray v)

    let apply (el: DevExpress.Xpf.Diagram.ShapePresenter) (prop: ShapePresenterProp) =
        match prop with
        | ShapePresenterProp.SelectionStrokeWidth v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.SelectionStrokeWidthProperty, box v)
        | ShapePresenterProp.Shape v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.ShapeProperty, box v)
        | ShapePresenterProp.ShowContent v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.ShowContentProperty, box v)
        | ShapePresenterProp.ContentPadding v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.ContentPaddingProperty, box v)
        | ShapePresenterProp.EditorBounds v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.EditorBoundsProperty, box v)
        | ShapePresenterProp.PenLineCap v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.PenLineCapProperty, box v)
        | ShapePresenterProp.Content v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.ContentProperty, box v)
        | ShapePresenterProp.Zoom v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.ZoomProperty, box v)
        | ShapePresenterProp.ContentBackground v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.ContentBackgroundProperty, box v)
        | ShapePresenterProp.Stroke v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.StrokeProperty, box v)
        | ShapePresenterProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.StrokeThicknessProperty, box v)
        | ShapePresenterProp.StrokeDashArray v -> el.SetValue(DevExpress.Xpf.Diagram.ShapePresenter.StrokeDashArrayProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ShapePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
