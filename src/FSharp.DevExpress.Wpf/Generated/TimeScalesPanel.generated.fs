...
type TimeScalesPanelProp =
    | ItemContainerOrientation of System.Windows.Controls.Orientation
    | ItemContainerInterval of DevExpress.Mvvm.DateTimeRange
    | ItemContainerZoom of System.TimeSpan
    | ItemContainerSetOffset of System.DateTime
    | ItemContainerSplitByRows of bool
    | ItemContainerRowHeight of float
    | ItemContainerScaleUnit of DevExpress.Xpf.Scheduling.TimeScaleUnit
    | ItemContainerUnitCount of int
    | ItemContainerSnapToCellsMode of DevExpress.Xpf.Scheduling.SnapToCellsMode
    | ItemContainerFirstDayOfWeek of System.DayOfWeek
    | ItemContainerItemMinWidth of float
    | ItemContainerStretchMode of DevExpress.Xpf.Scheduling.Panels.TimelineScrollPanelStretchMode
    | ItemContainerChildClippingMode of DevExpress.Xpf.Scheduling.Panels.TimelineScrollPanelClippingMode

module TimeScalesPanel =
    let itemContainerOrientation v : obj = box (TimeScalesPanelProp.ItemContainerOrientation v)
    let itemContainerInterval v : obj = box (TimeScalesPanelProp.ItemContainerInterval v)
    let itemContainerZoom v : obj = box (TimeScalesPanelProp.ItemContainerZoom v)
    let itemContainerSetOffset v : obj = box (TimeScalesPanelProp.ItemContainerSetOffset v)
    let itemContainerSplitByRows v : obj = box (TimeScalesPanelProp.ItemContainerSplitByRows v)
    let itemContainerRowHeight v : obj = box (TimeScalesPanelProp.ItemContainerRowHeight v)
    let itemContainerScaleUnit v : obj = box (TimeScalesPanelProp.ItemContainerScaleUnit v)
    let itemContainerUnitCount v : obj = box (TimeScalesPanelProp.ItemContainerUnitCount v)
    let itemContainerSnapToCellsMode v : obj = box (TimeScalesPanelProp.ItemContainerSnapToCellsMode v)
    let itemContainerFirstDayOfWeek v : obj = box (TimeScalesPanelProp.ItemContainerFirstDayOfWeek v)
    let itemContainerItemMinWidth v : obj = box (TimeScalesPanelProp.ItemContainerItemMinWidth v)
    let itemContainerStretchMode v : obj = box (TimeScalesPanelProp.ItemContainerStretchMode v)
    let itemContainerChildClippingMode v : obj = box (TimeScalesPanelProp.ItemContainerChildClippingMode v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel) (prop: TimeScalesPanelProp) =
        match prop with
        | TimeScalesPanelProp.ItemContainerOrientation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerOrientationProperty, box v)
        | TimeScalesPanelProp.ItemContainerInterval v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerIntervalProperty, box v)
        | TimeScalesPanelProp.ItemContainerZoom v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerZoomProperty, box v)
        | TimeScalesPanelProp.ItemContainerSetOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerSetOffsetProperty, box v)
        | TimeScalesPanelProp.ItemContainerSplitByRows v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerSplitByRowsProperty, box v)
        | TimeScalesPanelProp.ItemContainerRowHeight v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerRowHeightProperty, box v)
        | TimeScalesPanelProp.ItemContainerScaleUnit v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerScaleUnitProperty, box v)
        | TimeScalesPanelProp.ItemContainerUnitCount v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerUnitCountProperty, box v)
        | TimeScalesPanelProp.ItemContainerSnapToCellsMode v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerSnapToCellsModeProperty, box v)
        | TimeScalesPanelProp.ItemContainerFirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerFirstDayOfWeekProperty, box v)
        | TimeScalesPanelProp.ItemContainerItemMinWidth v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerItemMinWidthProperty, box v)
        | TimeScalesPanelProp.ItemContainerStretchMode v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerStretchModeProperty, box v)
        | TimeScalesPanelProp.ItemContainerChildClippingMode v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel.ItemContainerChildClippingModeProperty, box v)

    let orientation v : obj = box (RotatablePanelBaseProp.Orientation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimeScalesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
