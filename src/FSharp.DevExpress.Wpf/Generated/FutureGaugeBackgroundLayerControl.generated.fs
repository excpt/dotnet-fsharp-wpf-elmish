...
type FutureGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureGaugeBackgroundLayerControl) (prop: FutureGaugeBackgroundLayerControlProp) =
        match prop with
        | FutureGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
