...
type ThemeableArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableArcScaleMarkerControl =
    let themeFill v : obj = box (ThemeableArcScaleMarkerControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableArcScaleMarkerControl) (prop: ThemeableArcScaleMarkerControlProp) =
        match prop with
        | ThemeableArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
        | ThemeableArcScaleMarkerControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableArcScaleMarkerControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
