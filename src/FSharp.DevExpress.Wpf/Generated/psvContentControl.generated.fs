...
type psvContentControlProp =
    | Base of psvContentControlBaseProp

module psvContentControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.psvContentControl) (prop: psvContentControlProp) =
        match prop with
        | psvContentControlProp.Base p -> psvContentControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.psvContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
