...
type FlatGlassBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module FlatGlassBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatGlassBar2DModelControl) (prop: FlatGlassBar2DModelControlProp) =
        match prop with
        | FlatGlassBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatGlassBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
