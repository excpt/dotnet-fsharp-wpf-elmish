...
type StockLegendItemPresentationProp =
    | Base of LegendItemPresentationProp
    | ShowOpenClose of DevExpress.Xpf.Charts.StockType

module StockLegendItemPresentation =
    let showOpenClose v : obj = box (StockLegendItemPresentationProp.ShowOpenClose v)

    let apply (el: DevExpress.Xpf.Charts.StockLegendItemPresentation) (prop: StockLegendItemPresentationProp) =
        match prop with
        | StockLegendItemPresentationProp.Base p -> LegendItemPresentation.apply el p
        | StockLegendItemPresentationProp.ShowOpenClose v -> el.SetValue(DevExpress.Xpf.Charts.StockLegendItemPresentation.ShowOpenCloseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StockLegendItemPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
