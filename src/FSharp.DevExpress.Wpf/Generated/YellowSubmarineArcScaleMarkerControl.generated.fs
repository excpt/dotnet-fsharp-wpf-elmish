...
type YellowSubmarineArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module YellowSubmarineArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineArcScaleMarkerControl) (prop: YellowSubmarineArcScaleMarkerControlProp) =
        match prop with
        | YellowSubmarineArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
