...
type SmartArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module SmartArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartArcScaleMarkerControl) (prop: SmartArcScaleMarkerControlProp) =
        match prop with
        | SmartArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
