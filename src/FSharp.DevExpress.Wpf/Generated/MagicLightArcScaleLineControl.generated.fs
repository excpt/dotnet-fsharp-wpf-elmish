...
type MagicLightArcScaleLineControlProp =
    | Base of PresentationControlProp

module MagicLightArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightArcScaleLineControl) (prop: MagicLightArcScaleLineControlProp) =
        match prop with
        | MagicLightArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
