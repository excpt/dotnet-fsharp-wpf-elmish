...
type LightweightCellElementProp =
    | Base of CellElementProp

module LightweightCellElement =

    let apply (el: DevExpress.Xpf.PivotGrid.LightweightCellElement) (prop: LightweightCellElementProp) =
        match prop with
        | LightweightCellElementProp.Base p -> CellElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.LightweightCellElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
