...
type RichEditPopupMenuOldProp =
    | Base of PopupMenuProp

module RichEditPopupMenuOld =

    let apply (el: DevExpress.Xpf.RichEdit.Menu.RichEditPopupMenuOld) (prop: RichEditPopupMenuOldProp) =
        match prop with
        | RichEditPopupMenuOldProp.Base p -> PopupMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Menu.RichEditPopupMenuOld>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
