...
type ExplorerBarViewProp =
    | Base of NavBarViewBaseProp
    | OnGroupExpandedChanging of DevExpress.Xpf.NavBar.NavBarGroupExpandedChangingEventHandler
    | OnGroupExpandedChanged of DevExpress.Xpf.NavBar.NavBarGroupExpandedChangedEventHandler

module ExplorerBarView =
    let onGroupExpandedChanging v : obj = box (EventProp(box (ExplorerBarViewProp.OnGroupExpandedChanging v)))
    let onGroupExpandedChanged v : obj = box (EventProp(box (ExplorerBarViewProp.OnGroupExpandedChanged v)))

    let apply (el: DevExpress.Xpf.NavBar.ExplorerBarView) (prop: ExplorerBarViewProp) =
        match prop with
        | ExplorerBarViewProp.Base p -> NavBarViewBase.apply el p
        | ExplorerBarViewProp.OnGroupExpandedChanging h -> el.GroupExpandedChanging.AddHandler(h)
        | ExplorerBarViewProp.OnGroupExpandedChanged h -> el.GroupExpandedChanged.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ExplorerBarView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
