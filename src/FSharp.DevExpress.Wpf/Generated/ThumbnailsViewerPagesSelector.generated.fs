...
type ThumbnailsViewerPagesSelectorProp =
    | Base of DocumentViewerItemsControlProp

module ThumbnailsViewerPagesSelector =

    let apply (el: DevExpress.Xpf.PdfViewer.ThumbnailsViewerPagesSelector) (prop: ThumbnailsViewerPagesSelectorProp) =
        match prop with
        | ThumbnailsViewerPagesSelectorProp.Base p -> DocumentViewerItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.ThumbnailsViewerPagesSelector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
