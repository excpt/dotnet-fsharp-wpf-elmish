...
type QueryBuilderExpressionEditorProp =
    | Base of ExpressionEditorControlProp
    | Presenter of DevExpress.Data.Controls.ExpressionEditor.IExpressionEditorPresenter
    | IsValidExpression of bool
    | ExpressionString of string
    | MessageBoxServiceTemplate of System.Windows.DataTemplate

module QueryBuilderExpressionEditor =
    let presenter v : obj = box (QueryBuilderExpressionEditorProp.Presenter v)
    let isValidExpression v : obj = box (QueryBuilderExpressionEditorProp.IsValidExpression v)
    let expressionString v : obj = box (QueryBuilderExpressionEditorProp.ExpressionString v)
    let messageBoxServiceTemplate v : obj = box (QueryBuilderExpressionEditorProp.MessageBoxServiceTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditor) (prop: QueryBuilderExpressionEditorProp) =
        match prop with
        | QueryBuilderExpressionEditorProp.Base p -> ExpressionEditorControl.apply el p
        | QueryBuilderExpressionEditorProp.Presenter v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditor.PresenterProperty, box v)
        | QueryBuilderExpressionEditorProp.IsValidExpression v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditor.IsValidExpressionProperty, box v)
        | QueryBuilderExpressionEditorProp.ExpressionString v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditor.ExpressionStringProperty, box v)
        | QueryBuilderExpressionEditorProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditor.MessageBoxServiceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderExpressionEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
