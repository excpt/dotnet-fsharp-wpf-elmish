...
type AgendaViewControlProp =
    | Base of ViewControlBaseProp
    | View of DevExpress.Xpf.Scheduling.AgendaView
    | VisualData of DevExpress.Xpf.Scheduling.VisualData.AgendaViewVisualData
    | GroupRowStyle of System.Windows.Style

module AgendaViewControl =
    let view v : obj = box (AgendaViewControlProp.View v)
    let visualData v : obj = box (AgendaViewControlProp.VisualData v)
    let groupRowStyle v : obj = box (AgendaViewControlProp.GroupRowStyle v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AgendaViewControl) (prop: AgendaViewControlProp) =
        match prop with
        | AgendaViewControlProp.Base p -> ViewControlBase.apply el p
        | AgendaViewControlProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AgendaViewControl.ViewProperty, box v)
        | AgendaViewControlProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AgendaViewControl.VisualDataProperty, box v)
        | AgendaViewControlProp.GroupRowStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AgendaViewControl.GroupRowStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AgendaViewControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
