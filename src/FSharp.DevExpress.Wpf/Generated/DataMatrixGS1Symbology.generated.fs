...
type DataMatrixGS1SymbologyProp =
    | FNC1Substitute of string
    | HumanReadableText of bool
    | MatrixSize of DevExpress.XtraPrinting.BarCode.DataMatrixSize

module DataMatrixGS1Symbology =
    let fNC1Substitute v : obj = box (DataMatrixGS1SymbologyProp.FNC1Substitute v)
    let humanReadableText v : obj = box (DataMatrixGS1SymbologyProp.HumanReadableText v)
    let matrixSize v : obj = box (DataMatrixGS1SymbologyProp.MatrixSize v)

    let apply (el: DevExpress.Xpf.Controls.DataMatrixGS1Symbology) (prop: DataMatrixGS1SymbologyProp) =
        match prop with
        | DataMatrixGS1SymbologyProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Controls.DataMatrixGS1Symbology.FNC1SubstituteProperty, box v)
        | DataMatrixGS1SymbologyProp.HumanReadableText v -> el.SetValue(DevExpress.Xpf.Controls.DataMatrixGS1Symbology.HumanReadableTextProperty, box v)
        | DataMatrixGS1SymbologyProp.MatrixSize v -> el.SetValue(DevExpress.Xpf.Controls.DataMatrixGS1Symbology.MatrixSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.DataMatrixGS1Symbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
