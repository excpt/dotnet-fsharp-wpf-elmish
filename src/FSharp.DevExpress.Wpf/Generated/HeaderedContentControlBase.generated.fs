...
type HeaderedContentControlBaseProp =
    | Base of ContentControlBaseProp
    | Header of obj
    | HeaderTemplate of System.Windows.DataTemplate

module HeaderedContentControlBase =
    ...
    let apply (el: DevExpress.Xpf.Core.HeaderedContentControlBase) (prop: HeaderedContentControlBaseProp) =
        match prop with
        | HeaderedContentControlBaseProp.Base p -> ContentControlBase.apply el p
        | HeaderedContentControlBaseProp.Header v -> el.SetValue(DevExpress.Xpf.Core.HeaderedContentControlBase.HeaderProperty, box v)
        | HeaderedContentControlBaseProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.Core.HeaderedContentControlBase.HeaderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.HeaderedContentControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
