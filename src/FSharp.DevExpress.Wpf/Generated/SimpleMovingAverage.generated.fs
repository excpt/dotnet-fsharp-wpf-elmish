...
type SimpleMovingAverageProp =
    | Base of MovingAverageProp

module SimpleMovingAverage =

    let apply (el: DevExpress.Xpf.Charts.SimpleMovingAverage) (prop: SimpleMovingAverageProp) =
        match prop with
        | SimpleMovingAverageProp.Base p -> MovingAverage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleMovingAverage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
