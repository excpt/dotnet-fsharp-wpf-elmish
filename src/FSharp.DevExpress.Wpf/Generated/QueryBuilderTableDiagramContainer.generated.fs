...
type QueryBuilderTableDiagramContainerProp =
    | Base of QueryBuilderTableDiagramContainerBaseProp

module QueryBuilderTableDiagramContainer =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderTableDiagramContainer) (prop: QueryBuilderTableDiagramContainerProp) =
        match prop with
        | QueryBuilderTableDiagramContainerProp.Base p -> QueryBuilderTableDiagramContainerBase.apply el p

    let orientation v : obj = box (DiagramListProp.Orientation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderTableDiagramContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
