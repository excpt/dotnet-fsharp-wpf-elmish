...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.Native.DataFederation
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type QueryBuilderControlProp =
    | Model of DevExpress.DataAccess.Native.DataFederation.QueryBuilder.IQueryBuilderUIViewModel
    | SelectedAvailableItem of DevExpress.DataAccess.Native.DataFederation.QueryBuilder.AvailableItemData
    | JoinEditorDialogServiceTemplate of System.Windows.DataTemplate
    | ExpressionEditorDialogServiceTemplate of System.Windows.DataTemplate
    | MessageBoxServiceTemplate of System.Windows.DataTemplate
    | QueryNodeType of DevExpress.DataAccess.Native.DataFederation.QueryBuilder.QueryNodeType

module QueryBuilderControl =
    let model v : obj = box (QueryBuilderControlProp.Model v)
    let selectedAvailableItem v : obj = box (QueryBuilderControlProp.SelectedAvailableItem v)
    let joinEditorDialogServiceTemplate v : obj = box (QueryBuilderControlProp.JoinEditorDialogServiceTemplate v)
    let expressionEditorDialogServiceTemplate v : obj = box (QueryBuilderControlProp.ExpressionEditorDialogServiceTemplate v)
    let messageBoxServiceTemplate v : obj = box (QueryBuilderControlProp.MessageBoxServiceTemplate v)
    let queryNodeType v : obj = box (QueryBuilderControlProp.QueryNodeType v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl) (prop: QueryBuilderControlProp) =
        match prop with
        | QueryBuilderControlProp.Model v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl.ModelProperty, box v)
        | QueryBuilderControlProp.SelectedAvailableItem v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl.SelectedAvailableItemProperty, box v)
        | QueryBuilderControlProp.JoinEditorDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl.JoinEditorDialogServiceTemplateProperty, box v)
        | QueryBuilderControlProp.ExpressionEditorDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl.ExpressionEditorDialogServiceTemplateProperty, box v)
        | QueryBuilderControlProp.MessageBoxServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl.MessageBoxServiceTemplateProperty, box v)
        | QueryBuilderControlProp.QueryNodeType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl.QueryNodeTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.DataFederation.QueryBuilderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
