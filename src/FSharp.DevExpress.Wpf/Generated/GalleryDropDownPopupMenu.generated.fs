...
type GalleryDropDownPopupMenuProp =
    | Base of PopupMenuProp
    | InitialVisibleRowCount of int
    | InitialVisibleColCount of int
    | Gallery of DevExpress.Xpf.Bars.Gallery

module GalleryDropDownPopupMenu =
    let initialVisibleRowCount v : obj = box (GalleryDropDownPopupMenuProp.InitialVisibleRowCount v)
    let initialVisibleColCount v : obj = box (GalleryDropDownPopupMenuProp.InitialVisibleColCount v)
    let gallery v : obj = box (GalleryDropDownPopupMenuProp.Gallery v)

    let apply (el: DevExpress.Xpf.Ribbon.GalleryDropDownPopupMenu) (prop: GalleryDropDownPopupMenuProp) =
        match prop with
        | GalleryDropDownPopupMenuProp.Base p -> PopupMenu.apply el p
        | GalleryDropDownPopupMenuProp.InitialVisibleRowCount v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownPopupMenu.InitialVisibleRowCountProperty, box v)
        | GalleryDropDownPopupMenuProp.InitialVisibleColCount v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownPopupMenu.InitialVisibleColCountProperty, box v)
        | GalleryDropDownPopupMenuProp.Gallery v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownPopupMenu.GalleryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.GalleryDropDownPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
