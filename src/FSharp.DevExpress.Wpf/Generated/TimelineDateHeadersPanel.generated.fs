...
type TimelineDateHeadersPanelProp =
    | FirstColumnItemShowLeftBorder of obj
    | FirstRowItemShowTopBorder of obj

module TimelineDateHeadersPanel =
    let firstColumnItemShowLeftBorder v : obj = box (TimelineDateHeadersPanelProp.FirstColumnItemShowLeftBorder v)
    let firstRowItemShowTopBorder v : obj = box (TimelineDateHeadersPanelProp.FirstRowItemShowTopBorder v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineDateHeadersPanel) (prop: TimelineDateHeadersPanelProp) =
        match prop with
        | TimelineDateHeadersPanelProp.FirstColumnItemShowLeftBorder v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineDateHeadersPanel.FirstColumnItemShowLeftBorderProperty, box v)
        | TimelineDateHeadersPanelProp.FirstRowItemShowTopBorder v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineDateHeadersPanel.FirstRowItemShowTopBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineDateHeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
