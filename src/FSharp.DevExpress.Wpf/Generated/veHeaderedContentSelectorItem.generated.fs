...
open System
open System.Windows
open DevExpress.Xpf.WindowsUI.Base
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type veHeaderedContentSelectorItemProp =
    | Base of veContentSelectorItemProp
    | Header of obj
    ...
    | ActualHeader of obj
    | HasHeader of bool
    | HasHeaderTemplate of bool

module veHeaderedContentSelectorItem =
    let header v : obj = box (veHeaderedContentSelectorItemProp.Header v)
    let headerTemplate v : obj = box (veHeaderedContentSelectorItemProp.HeaderTemplate v)
    let headerTemplateSelector v : obj = box (veHeaderedContentSelectorItemProp.HeaderTemplateSelector v)
    let headerStringFormat v : obj = box (veHeaderedContentSelectorItemProp.HeaderStringFormat v)
    let actualHeader v : obj = box (veHeaderedContentSelectorItemProp.ActualHeader v)
    let hasHeader v : obj = box (veHeaderedContentSelectorItemProp.HasHeader v)
    let hasHeaderTemplate v : obj = box (veHeaderedContentSelectorItemProp.HasHeaderTemplate v)

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem) (prop: veHeaderedContentSelectorItemProp) =
        match prop with
        | veHeaderedContentSelectorItemProp.Base p -> veContentSelectorItem.apply el p
        | veHeaderedContentSelectorItemProp.Header v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.HeaderProperty, box v)
        | veHeaderedContentSelectorItemProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.HeaderTemplateProperty, box v)
        | veHeaderedContentSelectorItemProp.HeaderTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.HeaderTemplateSelectorProperty, box v)
        | veHeaderedContentSelectorItemProp.HeaderStringFormat v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.HeaderStringFormatProperty, box v)
        | veHeaderedContentSelectorItemProp.ActualHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.ActualHeaderProperty, box v)
        | veHeaderedContentSelectorItemProp.HasHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.HasHeaderProperty, box v)
        | veHeaderedContentSelectorItemProp.HasHeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem.HasHeaderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Base.veHeaderedContentSelectorItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
