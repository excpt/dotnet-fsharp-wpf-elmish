...
type CircularClassicFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularClassicFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularClassicFullModel) (prop: CircularClassicFullModelProp) =
        match prop with
        | CircularClassicFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularClassicFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
