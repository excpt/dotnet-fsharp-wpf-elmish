...
type PLinqDataSourceBaseProp =
    | Base of ItemsSourceDataSourceBaseProp

module PLinqDataSourceBase =

    let apply (el: DevExpress.Xpf.Core.DataSources.PLinqDataSourceBase) (prop: PLinqDataSourceBaseProp) =
        match prop with
        | PLinqDataSourceBaseProp.Base p -> ItemsSourceDataSourceBase.apply el p
