...
type PivotLoadingComboBoxStyleSettingsProp =
    | Base of CheckedComboBoxStyleSettingsProp

module PivotLoadingComboBoxStyleSettings =

    let apply (el: DevExpress.Xpf.PivotGrid.PivotLoadingComboBoxStyleSettings) (prop: PivotLoadingComboBoxStyleSettingsProp) =
        match prop with
        | PivotLoadingComboBoxStyleSettingsProp.Base p -> CheckedComboBoxStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.PivotLoadingComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
