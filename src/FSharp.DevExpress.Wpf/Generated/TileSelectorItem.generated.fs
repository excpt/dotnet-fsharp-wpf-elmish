...
type TileSelectorItemProp =
    | Base of TileBaseProp
    | AllowGlyphTheming of bool
    | ColorMode of DevExpress.Xpf.Navigation.TileColorMode
    | CommandParameter of obj
    | Command of System.Windows.Input.ICommand
    | CommandTarget of System.Windows.IInputElement
    | IsSelected of bool
    | SelectionPadding of System.Windows.Thickness
    | ShowFlyoutButton of bool

module TileSelectorItem =
    let allowGlyphTheming v : obj = box (TileSelectorItemProp.AllowGlyphTheming v)
    let colorMode v : obj = box (TileSelectorItemProp.ColorMode v)
    let commandParameter v : obj = box (TileSelectorItemProp.CommandParameter v)
    let command v : obj = box (TileSelectorItemProp.Command v)
    let commandTarget v : obj = box (TileSelectorItemProp.CommandTarget v)
    let isSelected v : obj = box (TileSelectorItemProp.IsSelected v)
    let selectionPadding v : obj = box (TileSelectorItemProp.SelectionPadding v)
    let showFlyoutButton v : obj = box (TileSelectorItemProp.ShowFlyoutButton v)

    let apply (el: DevExpress.Xpf.Navigation.TileSelectorItem) (prop: TileSelectorItemProp) =
        match prop with
        | TileSelectorItemProp.Base p -> TileBase.apply el p
        | TileSelectorItemProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.AllowGlyphThemingProperty, box v)
        | TileSelectorItemProp.ColorMode v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.ColorModeProperty, box v)
        | TileSelectorItemProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.CommandParameterProperty, box v)
        | TileSelectorItemProp.Command v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.CommandProperty, box v)
        | TileSelectorItemProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.CommandTargetProperty, box v)
        | TileSelectorItemProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.IsSelectedProperty, box v)
        | TileSelectorItemProp.SelectionPadding v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.SelectionPaddingProperty, box v)
        | TileSelectorItemProp.ShowFlyoutButton v -> el.SetValue(DevExpress.Xpf.Navigation.TileSelectorItem.ShowFlyoutButtonProperty, box v)

    let size v : obj = box (TileBaseProp.Size v)
    let tileGlyph v : obj = box (TileBaseProp.TileGlyph v)
    let horizontalTileGlyphAlignment v : obj = box (TileBaseProp.HorizontalTileGlyphAlignment v)
    let verticalTileGlyphAlignment v : obj = box (TileBaseProp.VerticalTileGlyphAlignment v)
