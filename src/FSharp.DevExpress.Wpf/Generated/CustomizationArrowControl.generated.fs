...
type CustomizationArrowControlProp =
    | Direction of DevExpress.Xpf.Ribbon.CustomizationArrowControlDirection

module CustomizationArrowControl =
    let direction v : obj = box (CustomizationArrowControlProp.Direction v)

    let apply (el: DevExpress.Xpf.Ribbon.CustomizationArrowControl) (prop: CustomizationArrowControlProp) =
        match prop with
        | CustomizationArrowControlProp.Direction v -> el.SetValue(DevExpress.Xpf.Ribbon.CustomizationArrowControl.DirectionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.CustomizationArrowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
