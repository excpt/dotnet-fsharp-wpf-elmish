...
type PolarAreaSeries2DProp =
    | Base of CircularAreaSeries2DProp

module PolarAreaSeries2D =

    let apply (el: DevExpress.Xpf.Charts.PolarAreaSeries2D) (prop: PolarAreaSeries2DProp) =
        match prop with
        | PolarAreaSeries2DProp.Base p -> CircularAreaSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarAreaSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
