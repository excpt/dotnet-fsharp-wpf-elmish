...
type DateTimePickerPanelProp =
    | Base of LoopedPanelProp

module DateTimePickerPanel =

    let apply (el: DevExpress.Xpf.Editors.DateTimePickerPanel) (prop: DateTimePickerPanelProp) =
        match prop with
        | DateTimePickerPanelProp.Base p -> LoopedPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateTimePickerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
