...
type BarPopupBorderControlProp =
    | Base of PopupBorderControlProp

module BarPopupBorderControl =

    let apply (el: DevExpress.Xpf.Bars.BarPopupBorderControl) (prop: BarPopupBorderControlProp) =
        match prop with
        | BarPopupBorderControlProp.Base p -> PopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
