...
type ColorListLegendProp =
    | Base of ColorLegendProp

module ColorListLegend =

    let apply (el: DevExpress.Xpf.Map.ColorListLegend) (prop: ColorListLegendProp) =
        match prop with
        | ColorListLegendProp.Base p -> ColorLegend.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.ColorListLegend>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
