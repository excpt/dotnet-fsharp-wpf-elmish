...
type DocumentViewerControlProp =
    | DocumentSource of obj
    | ZoomFactor of float
    | ZoomMode of DevExpress.Xpf.DocumentViewer.ZoomMode
    | PageRotation of System.Windows.Media.Imaging.Rotation
    | CurrentPageNumber of int
    | BehaviorProvider of DevExpress.Xpf.DocumentViewer.BehaviorProvider
    | CommandProvider of DevExpress.Xpf.DocumentViewer.CommandProvider
    | CommandBarStyle of DevExpress.Xpf.DocumentViewer.CommandBarStyle
    | BarsTemplate of System.Windows.DataTemplate
    | RibbonTemplate of System.Windows.DataTemplate
    | PresenterTemplate of System.Windows.DataTemplate
    | ResetSettingsOnDocumentClose of bool
    | OpenFileDialogTemplate of System.Windows.DataTemplate
    | HorizontalPageSpacing of float
    | DisposeDocumentOnUnload of bool
    | Provider of obj
    | OnDocumentChanged of System.Windows.RoutedEventHandler
    | OnZoomChanged of System.Windows.RoutedEventHandler
    | OnPageRotationChanged of System.Windows.RoutedEventHandler
    | OnCurrentPageNumberChanged of System.Windows.RoutedEventHandler

module DocumentViewerControl =
    ...
    let apply (el: DevExpress.Xpf.DocumentViewer.DocumentViewerControl) (prop: DocumentViewerControlProp) =
        match prop with
        | DocumentViewerControlProp.DocumentSource v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.DocumentSourceProperty, box v)
        | DocumentViewerControlProp.ZoomFactor v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.ZoomFactorProperty, box v)
        | DocumentViewerControlProp.ZoomMode v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.ZoomModeProperty, box v)
        | DocumentViewerControlProp.PageRotation v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.PageRotationProperty, box v)
        | DocumentViewerControlProp.CurrentPageNumber v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.CurrentPageNumberProperty, box v)
        | DocumentViewerControlProp.BehaviorProvider v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.BehaviorProviderProperty, box v)
        | DocumentViewerControlProp.CommandProvider v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.CommandProviderProperty, box v)
        | DocumentViewerControlProp.CommandBarStyle v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.CommandBarStyleProperty, box v)
        | DocumentViewerControlProp.BarsTemplate v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.BarsTemplateProperty, box v)
        | DocumentViewerControlProp.RibbonTemplate v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.RibbonTemplateProperty, box v)
        | DocumentViewerControlProp.PresenterTemplate v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.PresenterTemplateProperty, box v)
        | DocumentViewerControlProp.ResetSettingsOnDocumentClose v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.ResetSettingsOnDocumentCloseProperty, box v)
        | DocumentViewerControlProp.OpenFileDialogTemplate v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.OpenFileDialogTemplateProperty, box v)
        | DocumentViewerControlProp.HorizontalPageSpacing v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.HorizontalPageSpacingProperty, box v)
        | DocumentViewerControlProp.DisposeDocumentOnUnload v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.DisposeDocumentOnUnloadProperty, box v)
        | DocumentViewerControlProp.Provider v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.PropertyProviderProperty, box v)
        | DocumentViewerControlProp.OnDocumentChanged h -> el.DocumentChanged.AddHandler(h)
        | DocumentViewerControlProp.OnZoomChanged h -> el.ZoomChanged.AddHandler(h)
        | DocumentViewerControlProp.OnPageRotationChanged h -> el.PageRotationChanged.AddHandler(h)
        | DocumentViewerControlProp.OnCurrentPageNumberChanged h -> el.CurrentPageNumberChanged.AddHandler(h)
    ...
    let barItemName (v: string) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.BarItemNameProperty, box v)) :: node.Props }
    let actualViewer (v: DevExpress.Xpf.DocumentViewer.IDocumentViewerControl) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.DocumentViewer.DocumentViewerControl.ActualViewerProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.DocumentViewer.DocumentViewerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
