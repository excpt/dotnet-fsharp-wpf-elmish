...
type CircularFlatLightHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatLightHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatLightHalfTopModel) (prop: CircularFlatLightHalfTopModelProp) =
        match prop with
        | CircularFlatLightHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatLightHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
