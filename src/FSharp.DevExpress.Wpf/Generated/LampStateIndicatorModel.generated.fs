...
type LampStateIndicatorModelProp =
    | Base of StateIndicatorModelProp

module LampStateIndicatorModel =

    let apply (el: DevExpress.Xpf.Gauges.LampStateIndicatorModel) (prop: LampStateIndicatorModelProp) =
        match prop with
        | LampStateIndicatorModelProp.Base p -> StateIndicatorModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LampStateIndicatorModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
