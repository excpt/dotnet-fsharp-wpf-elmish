...
type NavigationBarItemProp =
    | Base of veViewSelectorItemProp
    | DisplayMode of DevExpress.Xpf.Controls.Primitives.ItemDisplayMode
    | GlyphAlignment of System.Windows.Controls.Dock
    | Glyph of System.Windows.Media.ImageSource
    | CustomizationCaption of obj
    | CustomizationCaptionTemplate of System.Windows.DataTemplate
    | CustomizationCaptionTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | Orientation of System.Windows.Controls.Orientation
    | PeekFormTemplate of System.Windows.DataTemplate
    | PeekFormTemplateSelector of System.Windows.Controls.DataTemplateSelector

module NavigationBarItem =
    let displayMode v : obj = box (NavigationBarItemProp.DisplayMode v)
    let glyphAlignment v : obj = box (NavigationBarItemProp.GlyphAlignment v)
    let glyph v : obj = box (NavigationBarItemProp.Glyph v)
    let customizationCaption v : obj = box (NavigationBarItemProp.CustomizationCaption v)
    let customizationCaptionTemplate v : obj = box (NavigationBarItemProp.CustomizationCaptionTemplate v)
    let customizationCaptionTemplateSelector v : obj = box (NavigationBarItemProp.CustomizationCaptionTemplateSelector v)
    let orientation v : obj = box (NavigationBarItemProp.Orientation v)
    let peekFormTemplate v : obj = box (NavigationBarItemProp.PeekFormTemplate v)
    let peekFormTemplateSelector v : obj = box (NavigationBarItemProp.PeekFormTemplateSelector v)

    let apply (el: DevExpress.Xpf.Navigation.NavigationBarItem) (prop: NavigationBarItemProp) =
        match prop with
        | NavigationBarItemProp.Base p -> veViewSelectorItem.apply el p
        | NavigationBarItemProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.DisplayModeProperty, box v)
        | NavigationBarItemProp.GlyphAlignment v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.GlyphAlignmentProperty, box v)
        | NavigationBarItemProp.Glyph v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.GlyphProperty, box v)
        | NavigationBarItemProp.CustomizationCaption v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.CustomizationCaptionProperty, box v)
        | NavigationBarItemProp.CustomizationCaptionTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.CustomizationCaptionTemplateProperty, box v)
        | NavigationBarItemProp.CustomizationCaptionTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.CustomizationCaptionTemplateSelectorProperty, box v)
        | NavigationBarItemProp.Orientation v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.OrientationProperty, box v)
        | NavigationBarItemProp.PeekFormTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.PeekFormTemplateProperty, box v)
        | NavigationBarItemProp.PeekFormTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.NavigationBarItem.PeekFormTemplateSelectorProperty, box v)

    let isSelected v : obj = box (veSelectorItemProp.IsSelected v)
    let contentTemplateInternal v : obj = box (veContentControlProp.ContentTemplateInternal v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.NavigationBarItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
