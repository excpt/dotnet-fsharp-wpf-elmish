...
type FilterRowCellEditorProp =
    | Base of CellEditorBaseProp

module FilterRowCellEditor =

    let apply (el: DevExpress.Xpf.Grid.FilterRowCellEditor) (prop: FilterRowCellEditorProp) =
        match prop with
        | FilterRowCellEditorProp.Base p -> CellEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.FilterRowCellEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
