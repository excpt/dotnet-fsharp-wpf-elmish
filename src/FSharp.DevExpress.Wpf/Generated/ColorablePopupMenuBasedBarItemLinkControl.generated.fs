...
type ColorablePopupMenuBasedBarItemLinkControlProp =
    | Base of BarSubItemLinkControlProp

module ColorablePopupMenuBasedBarItemLinkControl =

    let apply (el: DevExpress.Xpf.Scheduler.UI.ColorablePopupMenuBasedBarItemLinkControl) (prop: ColorablePopupMenuBasedBarItemLinkControlProp) =
        match prop with
        | ColorablePopupMenuBasedBarItemLinkControlProp.Base p -> BarSubItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.ColorablePopupMenuBasedBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
