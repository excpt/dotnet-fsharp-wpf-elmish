...
type TabSelectorPanelProp =
    | AddButtonTemplate of System.Windows.DataTemplate
    | TabSelectorItemDefaultTemplate of System.Windows.Controls.ControlTemplate
    | TabSelectorItemColoredTemplate of System.Windows.Controls.ControlTemplate

module TabSelectorPanel =
    let addButtonTemplate v : obj = box (TabSelectorPanelProp.AddButtonTemplate v)
    let tabSelectorItemDefaultTemplate v : obj = box (TabSelectorPanelProp.TabSelectorItemDefaultTemplate v)
    let tabSelectorItemColoredTemplate v : obj = box (TabSelectorPanelProp.TabSelectorItemColoredTemplate v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.TabSelectorPanel) (prop: TabSelectorPanelProp) =
        match prop with
        | TabSelectorPanelProp.AddButtonTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.TabSelectorPanel.AddButtonTemplateProperty, box v)
        | TabSelectorPanelProp.TabSelectorItemDefaultTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.TabSelectorPanel.TabSelectorItemDefaultTemplateProperty, box v)
        | TabSelectorPanelProp.TabSelectorItemColoredTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.TabSelectorPanel.TabSelectorItemColoredTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.TabSelectorPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
