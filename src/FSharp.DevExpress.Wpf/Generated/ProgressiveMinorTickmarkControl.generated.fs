...
type ProgressiveMinorTickmarkControlProp =
    | Base of PresentationControlProp

module ProgressiveMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveMinorTickmarkControl) (prop: ProgressiveMinorTickmarkControlProp) =
        match prop with
        | ProgressiveMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
