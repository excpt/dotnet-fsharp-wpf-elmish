...
open System
open System.Windows
open DevExpress.Xpf.Navigation.NavigationBar.Customization
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type NavigationBarMenuBaseProp =
    | Base of CustomizablePopupMenuBaseProp

module NavigationBarMenuBase =

    let apply (el: DevExpress.Xpf.Navigation.NavigationBar.Customization.NavigationBarMenuBase) (prop: NavigationBarMenuBaseProp) =
        match prop with
        | NavigationBarMenuBaseProp.Base p -> CustomizablePopupMenuBase.apply el p
    ...
    let gridMenuInfo (v: DevExpress.Xpf.Navigation.NavigationBar.Customization.NavigationBarMenuInfoBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Navigation.NavigationBar.Customization.NavigationBarMenuBase.GridMenuInfoProperty, box v)) :: node.Props }
