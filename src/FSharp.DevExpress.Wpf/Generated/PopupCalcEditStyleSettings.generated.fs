...
type PopupCalcEditStyleSettingsProp =
    | Base of PopupBaseEditStyleSettingsProp

module PopupCalcEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupCalcEditStyleSettings) (prop: PopupCalcEditStyleSettingsProp) =
        match prop with
        | PopupCalcEditStyleSettingsProp.Base p -> PopupBaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupCalcEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
