...
type MeasurementToolbarButtonProp =
    | Base of MapToggleButtonProp

module MeasurementToolbarButton =

    let apply (el: DevExpress.Xpf.Map.MeasurementToolbarButton) (prop: MeasurementToolbarButtonProp) =
        match prop with
        | MeasurementToolbarButtonProp.Base p -> MapToggleButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MeasurementToolbarButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
