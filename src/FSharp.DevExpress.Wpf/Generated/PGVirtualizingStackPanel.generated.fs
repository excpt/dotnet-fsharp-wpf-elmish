...
type PGVirtualizingStackPanelProp =
    | IsStandardPanel of bool

module PGVirtualizingStackPanel =
    let isStandardPanel v : obj = box (PGVirtualizingStackPanelProp.IsStandardPanel v)

    let apply (el: DevExpress.Xpf.PropertyGrid.PGVirtualizingStackPanel) (prop: PGVirtualizingStackPanelProp) =
        match prop with
        | PGVirtualizingStackPanelProp.IsStandardPanel v -> el.SetValue(DevExpress.Xpf.PropertyGrid.PGVirtualizingStackPanel.IsStandardPanelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.PGVirtualizingStackPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
