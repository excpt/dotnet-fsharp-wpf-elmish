...
type AdditionalAreaBorderSeriesGeometryProp =
    | Base of AdditionalLineSeriesGeometryProp

module AdditionalAreaBorderSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalAreaBorderSeriesGeometry) (prop: AdditionalAreaBorderSeriesGeometryProp) =
        match prop with
        | AdditionalAreaBorderSeriesGeometryProp.Base p -> AdditionalLineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalAreaBorderSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
