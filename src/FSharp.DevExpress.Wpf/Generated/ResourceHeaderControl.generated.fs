...
type ResourceHeaderControlProp =
    | Base of HeaderControlProp

module ResourceHeaderControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.ResourceHeaderControl) (prop: ResourceHeaderControlProp) =
        match prop with
        | ResourceHeaderControlProp.Base p -> HeaderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.ResourceHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
