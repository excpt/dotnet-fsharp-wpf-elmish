...
type LoadingDecoratorExProp =
    | Base of LoadingDecoratorProp
    | ArrangeOnStartupOnly of bool

module LoadingDecoratorEx =
    let arrangeOnStartupOnly v : obj = box (LoadingDecoratorExProp.ArrangeOnStartupOnly v)

    let apply (el: DevExpress.Xpf.Core.Native.LoadingDecoratorEx) (prop: LoadingDecoratorExProp) =
        match prop with
        | LoadingDecoratorExProp.Base p -> LoadingDecorator.apply el p
        | LoadingDecoratorExProp.ArrangeOnStartupOnly v -> el.SetValue(DevExpress.Xpf.Core.Native.LoadingDecoratorEx.ArrangeOnStartupOnlyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.LoadingDecoratorEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
