...
type ScaleLayoutControlProp =
    | Scale of DevExpress.Xpf.Gauges.Scale

module ScaleLayoutControl =
    let scale v : obj = box (ScaleLayoutControlProp.Scale v)

    let apply (el: DevExpress.Xpf.Gauges.ScaleLayoutControl) (prop: ScaleLayoutControlProp) =
        match prop with
        | ScaleLayoutControlProp.Scale v -> el.SetValue(DevExpress.Xpf.Gauges.ScaleLayoutControl.ScaleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ScaleLayoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
