...
type FlatLightLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module FlatLightLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightLinearScaleLevelBarForegroundControl) (prop: FlatLightLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | FlatLightLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
