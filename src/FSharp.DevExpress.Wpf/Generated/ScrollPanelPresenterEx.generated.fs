...
type ScrollPanelPresenterExProp =
    | Base of ScrollPanelPresenterProp

module ScrollPanelPresenterEx =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenterEx) (prop: ScrollPanelPresenterExProp) =
        match prop with
        | ScrollPanelPresenterExProp.Base p -> ScrollPanelPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenterEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
