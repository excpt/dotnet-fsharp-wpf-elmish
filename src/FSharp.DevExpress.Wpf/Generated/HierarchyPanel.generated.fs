...
type HierarchyPanelProp =
    | ItemsContainer of DevExpress.Xpf.Grid.Hierarchy.IRootItemsContainer
    | Orientation of System.Windows.Controls.Orientation
    | DataPresenter of DevExpress.Xpf.Grid.DataPresenterBase

module HierarchyPanel =
    ...
    let apply (el: DevExpress.Xpf.Grid.Hierarchy.HierarchyPanel) (prop: HierarchyPanelProp) =
        match prop with
        | HierarchyPanelProp.ItemsContainer v -> el.SetValue(DevExpress.Xpf.Grid.Hierarchy.HierarchyPanel.ItemsContainerProperty, box v)
        | HierarchyPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Grid.Hierarchy.HierarchyPanel.OrientationProperty, box v)
        | HierarchyPanelProp.DataPresenter v -> el.SetValue(DevExpress.Xpf.Grid.Hierarchy.HierarchyPanel.DataPresenterProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.Hierarchy.HierarchyPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
