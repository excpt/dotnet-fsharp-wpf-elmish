...
type SpellingOutlookStyleControlProp =
    | Base of SpellingControlBaseProp

module SpellingOutlookStyleControl =

    let apply (el: DevExpress.Xpf.SpellChecker.Forms.SpellingOutlookStyleControl) (prop: SpellingOutlookStyleControlProp) =
        match prop with
        | SpellingOutlookStyleControlProp.Base p -> SpellingControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.SpellChecker.Forms.SpellingOutlookStyleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
