...
type AccordionExpanderProp =
    | Base of DXExpanderProp

module AccordionExpander =

    let apply (el: DevExpress.Xpf.Accordion.Native.AccordionExpander) (prop: AccordionExpanderProp) =
        match prop with
        | AccordionExpanderProp.Base p -> DXExpander.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.Native.AccordionExpander>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
