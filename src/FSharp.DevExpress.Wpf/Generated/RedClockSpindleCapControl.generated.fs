...
type RedClockSpindleCapControlProp =
    | Base of PresentationControlProp

module RedClockSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockSpindleCapControl) (prop: RedClockSpindleCapControlProp) =
        match prop with
        | RedClockSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
