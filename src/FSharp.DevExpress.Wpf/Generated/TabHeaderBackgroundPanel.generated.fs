...
type TabHeaderBackgroundPanelProp =
    | Base of RenderTransformPanelProp
    | CaptionLocation of DevExpress.Xpf.Docking.CaptionLocation
    | CaptionOrientation of System.Windows.Controls.Orientation

module TabHeaderBackgroundPanel =
    let captionLocation v : obj = box (TabHeaderBackgroundPanelProp.CaptionLocation v)
    let captionOrientation v : obj = box (TabHeaderBackgroundPanelProp.CaptionOrientation v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabHeaderBackgroundPanel) (prop: TabHeaderBackgroundPanelProp) =
        match prop with
        | TabHeaderBackgroundPanelProp.Base p -> RenderTransformPanel.apply el p
        | TabHeaderBackgroundPanelProp.CaptionLocation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderBackgroundPanel.CaptionLocationProperty, box v)
        | TabHeaderBackgroundPanelProp.CaptionOrientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderBackgroundPanel.CaptionOrientationProperty, box v)

    let orientation v : obj = box (RenderTransformPanelProp.Orientation v)
    let dock v : obj = box (RenderTransformPanelProp.Dock v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabHeaderBackgroundPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
