...
type RibbonPageGroupPopupBorderControlProp =
    | Base of PopupBorderControlProp
    | ToolTipVerticalOffset of float

module RibbonPageGroupPopupBorderControl =
    let toolTipVerticalOffset v : obj = box (RibbonPageGroupPopupBorderControlProp.ToolTipVerticalOffset v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPageGroupPopupBorderControl) (prop: RibbonPageGroupPopupBorderControlProp) =
        match prop with
        | RibbonPageGroupPopupBorderControlProp.Base p -> PopupBorderControl.apply el p
        | RibbonPageGroupPopupBorderControlProp.ToolTipVerticalOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonPageGroupPopupBorderControl.ToolTipVerticalOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPageGroupPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
