...
type ProgressiveLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module ProgressiveLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveLinearScaleLevelBarForegroundControl) (prop: ProgressiveLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | ProgressiveLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
