...
type ParametersPanelProp =
    | ParametersModel of DevExpress.XtraReports.Parameters.ViewModels.ParameterPanelViewModel
    | ParameterTemplateSelector of System.Windows.Controls.DataTemplateSelector

module ParametersPanel =
    let parametersModel v : obj = box (ParametersPanelProp.ParametersModel v)
    let parameterTemplateSelector v : obj = box (ParametersPanelProp.ParameterTemplateSelector v)

    let apply (el: DevExpress.Xpf.Printing.Parameters.ParametersPanel) (prop: ParametersPanelProp) =
        match prop with
        | ParametersPanelProp.ParametersModel v -> el.SetValue(DevExpress.Xpf.Printing.Parameters.ParametersPanel.ParametersModelProperty, box v)
        | ParametersPanelProp.ParameterTemplateSelector v -> el.SetValue(DevExpress.Xpf.Printing.Parameters.ParametersPanel.ParameterTemplateSelectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Parameters.ParametersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
