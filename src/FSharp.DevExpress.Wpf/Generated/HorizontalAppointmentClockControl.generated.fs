...
type HorizontalAppointmentClockControlProp =
    | Base of AppointmentClockControlBaseProp
    | IntervalDisplayType of DevExpress.Xpf.Scheduler.Drawing.IntervalDisplayType

module HorizontalAppointmentClockControl =
    let intervalDisplayType v : obj = box (HorizontalAppointmentClockControlProp.IntervalDisplayType v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentClockControl) (prop: HorizontalAppointmentClockControlProp) =
        match prop with
        | HorizontalAppointmentClockControlProp.Base p -> AppointmentClockControlBase.apply el p
        | HorizontalAppointmentClockControlProp.IntervalDisplayType v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentClockControl.IntervalDisplayTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentClockControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
