...
type WinUIMessageBoxProp =
    | Base of DXMessageBoxProp

module WinUIMessageBox =

    let apply (el: DevExpress.Xpf.WindowsUI.WinUIMessageBox) (prop: WinUIMessageBoxProp) =
        match prop with
        | WinUIMessageBoxProp.Base p -> DXMessageBox.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.WinUIMessageBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
