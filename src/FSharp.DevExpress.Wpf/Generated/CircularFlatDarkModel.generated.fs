...
type CircularFlatDarkModelProp =
    | Base of CircularGaugeModelProp

module CircularFlatDarkModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatDarkModel) (prop: CircularFlatDarkModelProp) =
        match prop with
        | CircularFlatDarkModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatDarkModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
