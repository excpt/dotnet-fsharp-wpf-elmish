...
type TriangleMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module TriangleMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.TriangleMarkerModelControl) (prop: TriangleMarkerModelControlProp) =
        match prop with
        | TriangleMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.TriangleMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
