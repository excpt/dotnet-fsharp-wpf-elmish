...
type RecurrenceWindowProp =
    | Base of ThemedWindowProp

module RecurrenceWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.RecurrenceWindow) (prop: RecurrenceWindowProp) =
        match prop with
        | RecurrenceWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.RecurrenceWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
