...
type DragCursorControlProp =
    | Base of psvControlProp
    | CursorType of DevExpress.Xpf.Docking.VisualElements.DragCursorType

module DragCursorControl =
    let cursorType v : obj = box (DragCursorControlProp.CursorType v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DragCursorControl) (prop: DragCursorControlProp) =
        match prop with
        | DragCursorControlProp.Base p -> psvControl.apply el p
        | DragCursorControlProp.CursorType v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DragCursorControl.CursorTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DragCursorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
