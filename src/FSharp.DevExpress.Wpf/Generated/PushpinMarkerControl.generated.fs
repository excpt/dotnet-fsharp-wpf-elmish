...
type PushpinMarkerControlProp =
    | State of DevExpress.Xpf.Map.MapPushpinState
    | Item of DevExpress.Xpf.Map.MapItem
    | IsHighlighted of bool
    | IsSelected of bool
    | StrokeBrush of System.Windows.Media.Brush

module PushpinMarkerControl =
    let state v : obj = box (PushpinMarkerControlProp.State v)
    let item v : obj = box (PushpinMarkerControlProp.Item v)
    let isHighlighted v : obj = box (PushpinMarkerControlProp.IsHighlighted v)
    let isSelected v : obj = box (PushpinMarkerControlProp.IsSelected v)
    let strokeBrush v : obj = box (PushpinMarkerControlProp.StrokeBrush v)

    let apply (el: DevExpress.Xpf.Map.PushpinMarkerControl) (prop: PushpinMarkerControlProp) =
        match prop with
        | PushpinMarkerControlProp.State v -> el.SetValue(DevExpress.Xpf.Map.PushpinMarkerControl.StateProperty, box v)
        | PushpinMarkerControlProp.Item v -> el.SetValue(DevExpress.Xpf.Map.PushpinMarkerControl.ItemProperty, box v)
        | PushpinMarkerControlProp.IsHighlighted v -> el.SetValue(DevExpress.Xpf.Map.PushpinMarkerControl.IsHighlightedProperty, box v)
        | PushpinMarkerControlProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Map.PushpinMarkerControl.IsSelectedProperty, box v)
        | PushpinMarkerControlProp.StrokeBrush v -> el.SetValue(DevExpress.Xpf.Map.PushpinMarkerControl.StrokeBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.PushpinMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
