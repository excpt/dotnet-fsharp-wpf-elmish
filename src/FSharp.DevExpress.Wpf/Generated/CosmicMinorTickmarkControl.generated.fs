...
type CosmicMinorTickmarkControlProp =
    | Base of PresentationControlProp

module CosmicMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicMinorTickmarkControl) (prop: CosmicMinorTickmarkControlProp) =
        match prop with
        | CosmicMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
