...
type HorizontalAppointmentClockControlBaseProp =
    | Base of AppointmentClockControlBaseProp
    | AngleMinutes of float
    | AngleHours of float

module HorizontalAppointmentClockControlBase =
    let angleMinutes v : obj = box (HorizontalAppointmentClockControlBaseProp.AngleMinutes v)
    let angleHours v : obj = box (HorizontalAppointmentClockControlBaseProp.AngleHours v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentClockControlBase) (prop: HorizontalAppointmentClockControlBaseProp) =
        match prop with
        | HorizontalAppointmentClockControlBaseProp.Base p -> AppointmentClockControlBase.apply el p
        | HorizontalAppointmentClockControlBaseProp.AngleMinutes v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentClockControlBase.AngleMinutesProperty, box v)
        | HorizontalAppointmentClockControlBaseProp.AngleHours v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentClockControlBase.AngleHoursProperty, box v)

    let viewInfo v : obj = box (AppointmentClockControlBaseProp.ViewInfo v)
    let timeText v : obj = box (AppointmentClockControlBaseProp.TimeText v)
    let timeTextVisibility v : obj = box (AppointmentClockControlBaseProp.TimeTextVisibility v)
