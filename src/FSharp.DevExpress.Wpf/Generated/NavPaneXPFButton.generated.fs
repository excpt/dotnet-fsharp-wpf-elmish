...
type NavPaneXPFButtonProp =
    | Base of XPFButtonProp

module NavPaneXPFButton =

    let apply (el: DevExpress.Xpf.NavBar.NavPaneXPFButton) (prop: NavPaneXPFButtonProp) =
        match prop with
        | NavPaneXPFButtonProp.Base p -> XPFButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneXPFButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
