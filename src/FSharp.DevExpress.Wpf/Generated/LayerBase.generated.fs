...
type LayerBaseProp =
    ...
    | Bounds of DevExpress.Xpf.Map.CoordPointCollection
...
module LayerBase =
    ...
    let apply (el: DevExpress.Xpf.Map.LayerBase) (prop: LayerBaseProp) =
        match prop with
        | LayerBaseProp.Base p -> MapElement.apply el p
        | LayerBaseProp.Bounds v -> el.SetValue(DevExpress.Xpf.Map.LayerBase.BoundsProperty, box v)
        | LayerBaseProp.MinZoomLevel v -> el.SetValue(DevExpress.Xpf.Map.LayerBase.MinZoomLevelProperty, box v)
        | LayerBaseProp.MaxZoomLevel v -> el.SetValue(DevExpress.Xpf.Map.LayerBase.MaxZoomLevelProperty, box v)
