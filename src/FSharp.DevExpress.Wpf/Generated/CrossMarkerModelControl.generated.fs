...
type CrossMarkerModelControlProp =
    | Base of MarkerBubbleControlBaseProp

module CrossMarkerModelControl =

    let apply (el: DevExpress.Xpf.Map.CrossMarkerModelControl) (prop: CrossMarkerModelControlProp) =
        match prop with
        | CrossMarkerModelControlProp.Base p -> MarkerBubbleControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.CrossMarkerModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
