...
type AnimationPixelSnappedUniformGridProp =
    | Base of AnimationPanel2Prop
    | Orientation of System.Windows.Controls.Orientation

module AnimationPixelSnappedUniformGrid =
    let orientation v : obj = box (AnimationPixelSnappedUniformGridProp.Orientation v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AnimationPixelSnappedUniformGrid) (prop: AnimationPixelSnappedUniformGridProp) =
        match prop with
        | AnimationPixelSnappedUniformGridProp.Base p -> AnimationPanel2.apply el p
        | AnimationPixelSnappedUniformGridProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AnimationPixelSnappedUniformGrid.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AnimationPixelSnappedUniformGrid>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
