...
type RichEditCommentControlProp =
    | LayoutPanel of DevExpress.Xpf.Docking.LayoutPanel
    | DockLayoutManager of DevExpress.Xpf.Docking.DockLayoutManager
    | RichEditControl of DevExpress.Xpf.RichEdit.RichEditControl
    | ShowBorder of bool

module RichEditCommentControl =
    let layoutPanel v : obj = box (RichEditCommentControlProp.LayoutPanel v)
    let dockLayoutManager v : obj = box (RichEditCommentControlProp.DockLayoutManager v)
    let richEditControl v : obj = box (RichEditCommentControlProp.RichEditControl v)
    let showBorder v : obj = box (RichEditCommentControlProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.RichEdit.RichEditCommentControl) (prop: RichEditCommentControlProp) =
        match prop with
        | RichEditCommentControlProp.LayoutPanel v -> el.SetValue(DevExpress.Xpf.RichEdit.RichEditCommentControl.LayoutPanelProperty, box v)
        | RichEditCommentControlProp.DockLayoutManager v -> el.SetValue(DevExpress.Xpf.RichEdit.RichEditCommentControl.DockLayoutManagerProperty, box v)
        | RichEditCommentControlProp.RichEditControl v -> el.SetValue(DevExpress.Xpf.RichEdit.RichEditCommentControl.RichEditControlProperty, box v)
        | RichEditCommentControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.RichEdit.RichEditCommentControl.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.RichEditCommentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
