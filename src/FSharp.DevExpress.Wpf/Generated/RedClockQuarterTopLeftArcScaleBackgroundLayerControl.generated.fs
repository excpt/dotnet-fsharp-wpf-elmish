...
type RedClockQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedClockQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockQuarterTopLeftArcScaleBackgroundLayerControl) (prop: RedClockQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | RedClockQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
