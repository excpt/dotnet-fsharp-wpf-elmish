...
type DiagramPanAndZoomControlProp =
    | Diagram of DevExpress.Xpf.Diagram.DiagramControl

module DiagramPanAndZoomControl =
    let diagram v : obj = box (DiagramPanAndZoomControlProp.Diagram v)

    let apply (el: DevExpress.Xpf.Diagram.DiagramPanAndZoomControl) (prop: DiagramPanAndZoomControlProp) =
        match prop with
        | DiagramPanAndZoomControlProp.Diagram v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramPanAndZoomControl.DiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramPanAndZoomControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
