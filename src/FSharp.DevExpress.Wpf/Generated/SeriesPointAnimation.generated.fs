...
type SeriesPointAnimationProp =
    | Base of ChartAnimationProp
    | TargetSeriesPoint of DevExpress.Xpf.Charts.SeriesPoint
    | InitialNumericalArgument of obj
    | InitialNumericalValue of obj
    | InitialRotation of DevExpress.Xpf.Charts.AnimationRotation

module SeriesPointAnimation =
    let targetSeriesPoint v : obj = box (SeriesPointAnimationProp.TargetSeriesPoint v)
    let initialNumericalArgument v : obj = box (SeriesPointAnimationProp.InitialNumericalArgument v)
    let initialNumericalValue v : obj = box (SeriesPointAnimationProp.InitialNumericalValue v)
    let initialRotation v : obj = box (SeriesPointAnimationProp.InitialRotation v)

    let apply (el: DevExpress.Xpf.Charts.SeriesPointAnimation) (prop: SeriesPointAnimationProp) =
        match prop with
        | SeriesPointAnimationProp.Base p -> ChartAnimation.apply el p
        | SeriesPointAnimationProp.TargetSeriesPoint v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointAnimation.TargetSeriesPointProperty, box v)
        | SeriesPointAnimationProp.InitialNumericalArgument v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointAnimation.InitialNumericalArgumentProperty, box v)
        | SeriesPointAnimationProp.InitialNumericalValue v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointAnimation.InitialNumericalValueProperty, box v)
        | SeriesPointAnimationProp.InitialRotation v -> el.SetValue(DevExpress.Xpf.Charts.SeriesPointAnimation.InitialRotationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SeriesPointAnimation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
