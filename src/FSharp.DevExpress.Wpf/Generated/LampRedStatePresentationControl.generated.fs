...
type LampRedStatePresentationControlProp =
    | Base of PresentationControlProp

module LampRedStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.LampRedStatePresentationControl) (prop: LampRedStatePresentationControlProp) =
        match prop with
        | LampRedStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LampRedStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
