...
type FlatDarkArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FlatDarkArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkArcScaleNeedleControl) (prop: FlatDarkArcScaleNeedleControlProp) =
        match prop with
        | FlatDarkArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
