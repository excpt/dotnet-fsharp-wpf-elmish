...
type CircularYellowSubmarineThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularYellowSubmarineThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularYellowSubmarineThreeQuartersModel) (prop: CircularYellowSubmarineThreeQuartersModelProp) =
        match prop with
        | CircularYellowSubmarineThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularYellowSubmarineThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
