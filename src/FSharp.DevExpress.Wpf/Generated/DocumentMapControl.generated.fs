...
type DocumentMapControlProp =
    | TreeViewStyle of System.Windows.Style
    | Settings of DevExpress.Xpf.DocumentViewer.DocumentMapSettings
    | WrapLongLines of bool
    | HideAfterUse of bool

module DocumentMapControl =
    let treeViewStyle v : obj = box (DocumentMapControlProp.TreeViewStyle v)
    let settings v : obj = box (DocumentMapControlProp.Settings v)
    let wrapLongLines v : obj = box (DocumentMapControlProp.WrapLongLines v)
    let hideAfterUse v : obj = box (DocumentMapControlProp.HideAfterUse v)

    let apply (el: DevExpress.Xpf.DocumentViewer.DocumentMapControl) (prop: DocumentMapControlProp) =
        match prop with
        | DocumentMapControlProp.TreeViewStyle v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapControl.TreeViewStyleProperty, box v)
        | DocumentMapControlProp.Settings v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapControl.SettingsProperty, box v)
        | DocumentMapControlProp.WrapLongLines v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapControl.WrapLongLinesProperty, box v)
        | DocumentMapControlProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentMapControl.HideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.DocumentMapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
