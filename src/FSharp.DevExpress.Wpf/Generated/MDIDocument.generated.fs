...
type MDIDocumentProp =
    | Base of BaseDocumentProp
    | IsMaximized of bool

module MDIDocument =
    let isMaximized v : obj = box (MDIDocumentProp.IsMaximized v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.MDIDocument) (prop: MDIDocumentProp) =
        match prop with
        | MDIDocumentProp.Base p -> BaseDocument.apply el p
        | MDIDocumentProp.IsMaximized v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MDIDocument.IsMaximizedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.MDIDocument>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
