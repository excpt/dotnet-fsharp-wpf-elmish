...
type CustomPie2DModelControlProp =
    | Base of CustomModelControlProp

module CustomPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.CustomPie2DModelControl) (prop: CustomPie2DModelControlProp) =
        match prop with
        | CustomPie2DModelControlProp.Base p -> CustomModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.CustomPie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
