...
type AppBarToggleButtonProp =
    | Base of AppBarButtonProp
    | GroupName of string
    | IsChecked of bool

module AppBarToggleButton =
    let groupName v : obj = box (AppBarToggleButtonProp.GroupName v)
    let isChecked v : obj = box (AppBarToggleButtonProp.IsChecked v)

    let apply (el: DevExpress.Xpf.WindowsUI.AppBarToggleButton) (prop: AppBarToggleButtonProp) =
        match prop with
        | AppBarToggleButtonProp.Base p -> AppBarButton.apply el p
        | AppBarToggleButtonProp.GroupName v -> el.SetValue(DevExpress.Xpf.WindowsUI.AppBarToggleButton.GroupNameProperty, box v)
        | AppBarToggleButtonProp.IsChecked v -> el.SetValue(DevExpress.Xpf.WindowsUI.AppBarToggleButton.IsCheckedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.AppBarToggleButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
