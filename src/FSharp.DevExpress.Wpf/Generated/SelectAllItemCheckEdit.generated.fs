...
type SelectAllItemCheckEditProp =
    | Base of CheckEditProp

module SelectAllItemCheckEdit =

    let apply (el: DevExpress.Xpf.Editors.SelectAllItemCheckEdit) (prop: SelectAllItemCheckEditProp) =
        match prop with
        | SelectAllItemCheckEditProp.Base p -> CheckEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SelectAllItemCheckEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
