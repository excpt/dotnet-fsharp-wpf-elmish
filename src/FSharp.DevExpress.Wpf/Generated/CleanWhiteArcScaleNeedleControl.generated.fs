...
type CleanWhiteArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CleanWhiteArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteArcScaleNeedleControl) (prop: CleanWhiteArcScaleNeedleControlProp) =
        match prop with
        | CleanWhiteArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
