...
type NumberingListViewProp =
    | Base of ThemedWindowProp

module NumberingListView =

    let apply (el: DevExpress.Xpf.RichEdit.View.NumberingListView) (prop: NumberingListViewProp) =
        match prop with
        | NumberingListViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.NumberingListView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
