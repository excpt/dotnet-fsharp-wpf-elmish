...
type HamburgerMenuHyperlinkButtonProp =
...
module HamburgerMenuHyperlinkButton =
    let navigateUri v : obj = box (HamburgerMenuHyperlinkButtonProp.NavigateUri v)
    let placement v : obj = box (HamburgerMenuHyperlinkButtonProp.Placement v)
    let compactModeVisibility v : obj = box (HamburgerMenuHyperlinkButtonProp.CompactModeVisibility v)
    let collapseMenuOnClick v : obj = box (HamburgerMenuHyperlinkButtonProp.CollapseMenuOnClick v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuHyperlinkButton) (prop: HamburgerMenuHyperlinkButtonProp) =
        match prop with
        | HamburgerMenuHyperlinkButtonProp.NavigateUri v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuHyperlinkButton.NavigateUriProperty, box v)
        | HamburgerMenuHyperlinkButtonProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuHyperlinkButton.PlacementProperty, box v)
        | HamburgerMenuHyperlinkButtonProp.CompactModeVisibility v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuHyperlinkButton.CompactModeVisibilityProperty, box v)
        | HamburgerMenuHyperlinkButtonProp.CollapseMenuOnClick v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuHyperlinkButton.CollapseMenuOnClickProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuHyperlinkButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
