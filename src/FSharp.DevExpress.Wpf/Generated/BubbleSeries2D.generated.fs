...
type BubbleSeries2DProp =
    | Base of MarkerSeries2DProp
    | WeightDataMember of string
    | MarkerModel of DevExpress.Xpf.Charts.Marker2DModel
    | MaxSize of float
    | MinSize of float
    | Transparency of float
    | PointAnimation of DevExpress.Xpf.Charts.Marker2DAnimationBase
    | AutoSize of bool
    | SizeUnit of DevExpress.Xpf.Charts.BubbleSizeUnit

module BubbleSeries2D =
    let weightDataMember v : obj = box (BubbleSeries2DProp.WeightDataMember v)
    let markerModel v : obj = box (BubbleSeries2DProp.MarkerModel v)
    let maxSize v : obj = box (BubbleSeries2DProp.MaxSize v)
    let minSize v : obj = box (BubbleSeries2DProp.MinSize v)
    let transparency v : obj = box (BubbleSeries2DProp.Transparency v)
    let pointAnimation v : obj = box (BubbleSeries2DProp.PointAnimation v)
    let autoSize v : obj = box (BubbleSeries2DProp.AutoSize v)
    let sizeUnit v : obj = box (BubbleSeries2DProp.SizeUnit v)

    let apply (el: DevExpress.Xpf.Charts.BubbleSeries2D) (prop: BubbleSeries2DProp) =
        match prop with
        | BubbleSeries2DProp.Base p -> MarkerSeries2D.apply el p
        | BubbleSeries2DProp.WeightDataMember v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.WeightDataMemberProperty, box v)
        | BubbleSeries2DProp.MarkerModel v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.MarkerModelProperty, box v)
        | BubbleSeries2DProp.MaxSize v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.MaxSizeProperty, box v)
        | BubbleSeries2DProp.MinSize v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.MinSizeProperty, box v)
        | BubbleSeries2DProp.Transparency v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.TransparencyProperty, box v)
        | BubbleSeries2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.PointAnimationProperty, box v)
        | BubbleSeries2DProp.AutoSize v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.AutoSizeProperty, box v)
        | BubbleSeries2DProp.SizeUnit v -> el.SetValue(DevExpress.Xpf.Charts.BubbleSeries2D.SizeUnitProperty, box v)
    ...
    let weight (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BubbleSeries2D.WeightProperty, box v)) :: node.Props }
    let valueToDisplay (v: DevExpress.Xpf.Charts.BubbleLabelValueToDisplay) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BubbleSeries2D.ValueToDisplayProperty, box v)) :: node.Props }
    let labelPosition (v: DevExpress.Xpf.Charts.Bubble2DLabelPosition) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BubbleSeries2D.LabelPositionProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.BubbleSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
