...
type NavBarPositionPanelProp =
    | Base of NavBarStackPanelProp

module NavBarPositionPanel =

    let apply (el: DevExpress.Xpf.NavBar.NavBarPositionPanel) (prop: NavBarPositionPanelProp) =
        match prop with
        | NavBarPositionPanelProp.Base p -> NavBarStackPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarPositionPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
