...
type DynamicHorizontalAppointmentsPanelProp =
    | Base of DynamicAppointmentsPanelBaseProp
    | AppointmentsInfoContainer of DevExpress.Xpf.Scheduler.Drawing.IAppoinmentsInfoContainer
    | IsResizable of bool
    | AutoHeight of bool
    | IsStatusVisible of bool
    | DefaultAppointmentHeight of int

module DynamicHorizontalAppointmentsPanel =
    let appointmentsInfoContainer v : obj = box (DynamicHorizontalAppointmentsPanelProp.AppointmentsInfoContainer v)
    let isResizable v : obj = box (DynamicHorizontalAppointmentsPanelProp.IsResizable v)
    let autoHeight v : obj = box (DynamicHorizontalAppointmentsPanelProp.AutoHeight v)
    let isStatusVisible v : obj = box (DynamicHorizontalAppointmentsPanelProp.IsStatusVisible v)
    let defaultAppointmentHeight v : obj = box (DynamicHorizontalAppointmentsPanelProp.DefaultAppointmentHeight v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel) (prop: DynamicHorizontalAppointmentsPanelProp) =
        match prop with
        | DynamicHorizontalAppointmentsPanelProp.Base p -> DynamicAppointmentsPanelBase.apply el p
        | DynamicHorizontalAppointmentsPanelProp.AppointmentsInfoContainer v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel.AppointmentsInfoContainerProperty, box v)
        | DynamicHorizontalAppointmentsPanelProp.IsResizable v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel.IsResizableProperty, box v)
        | DynamicHorizontalAppointmentsPanelProp.AutoHeight v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel.AutoHeightProperty, box v)
        | DynamicHorizontalAppointmentsPanelProp.IsStatusVisible v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel.IsStatusVisibleProperty, box v)
        | DynamicHorizontalAppointmentsPanelProp.DefaultAppointmentHeight v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel.DefaultAppointmentHeightProperty, box v)

    let cellPadding v : obj = box (DynamicAppointmentsPanelBaseProp.CellPadding v)
    let snapToCells v : obj = box (DynamicAppointmentsPanelBaseProp.SnapToCells v)
    let appointmentControls v : obj = box (DynamicAppointmentsPanelBaseProp.AppointmentControls v)
    let isDraggedMode v : obj = box (DynamicAppointmentsPanelBaseProp.IsDraggedMode v)
    let appointmentStyle v : obj = box (DynamicAppointmentsPanelBaseProp.AppointmentStyle v)
    let schedulerTimeCellControl v : obj = box (SchedulerCellsBasedPanelBaseProp.SchedulerTimeCellControl v)
    let cellContainer v : obj = box (SchedulerCellsBasedPanelBaseProp.CellContainer v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DynamicHorizontalAppointmentsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
