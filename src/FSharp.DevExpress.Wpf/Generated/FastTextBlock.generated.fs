...
type FastTextBlockProp =
    | Text of string
    | ObjectToString of obj
    | StringFormat of string
    | WordWrap of bool
    | TrimmingMode of DevExpress.Xpf.Scheduling.Visual.TrimmingMode
...
module FastTextBlock =
    let text v : obj = box (FastTextBlockProp.Text v)
    let objectToString v : obj = box (FastTextBlockProp.ObjectToString v)
    let stringFormat v : obj = box (FastTextBlockProp.StringFormat v)
    let wordWrap v : obj = box (FastTextBlockProp.WordWrap v)
    let trimmingMode v : obj = box (FastTextBlockProp.TrimmingMode v)
    let fontFamily v : obj = box (FastTextBlockProp.FontFamily v)
    let fontStyle v : obj = box (FastTextBlockProp.FontStyle v)
    let fontWeight v : obj = box (FastTextBlockProp.FontWeight v)
    let fontStretch v : obj = box (FastTextBlockProp.FontStretch v)
    let fontSize v : obj = box (FastTextBlockProp.FontSize v)
    let foreground v : obj = box (FastTextBlockProp.Foreground v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.FastTextBlock) (prop: FastTextBlockProp) =
        match prop with
        | FastTextBlockProp.Text v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.TextProperty, box v)
        | FastTextBlockProp.ObjectToString v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.ObjectToStringProperty, box v)
        | FastTextBlockProp.StringFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.StringFormatProperty, box v)
        | FastTextBlockProp.WordWrap v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.WordWrapProperty, box v)
        | FastTextBlockProp.TrimmingMode v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.TrimmingModeProperty, box v)
        | FastTextBlockProp.FontFamily v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.FontFamilyProperty, box v)
        | FastTextBlockProp.FontStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.FontStyleProperty, box v)
        | FastTextBlockProp.FontWeight v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.FontWeightProperty, box v)
        | FastTextBlockProp.FontStretch v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.FontStretchProperty, box v)
        | FastTextBlockProp.FontSize v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.FontSizeProperty, box v)
        | FastTextBlockProp.Foreground v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.FastTextBlock.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.FastTextBlock>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
