...
type DiagramToolboxControlProp =
    | DiagramControl of DevExpress.Xpf.Diagram.DiagramControl
    | IsCompact of bool
    | LayoutError of float
    | MenuViewMode of DevExpress.Xpf.Diagram.ToolboxMenuViewMode
    | CompactWidth of float

module DiagramToolboxControl =
    let diagramControl v : obj = box (DiagramToolboxControlProp.DiagramControl v)
    let isCompact v : obj = box (DiagramToolboxControlProp.IsCompact v)
    let layoutError v : obj = box (DiagramToolboxControlProp.LayoutError v)
    let menuViewMode v : obj = box (DiagramToolboxControlProp.MenuViewMode v)
    let compactWidth v : obj = box (DiagramToolboxControlProp.CompactWidth v)

    let apply (el: DevExpress.Xpf.Diagram.DiagramToolboxControl) (prop: DiagramToolboxControlProp) =
        match prop with
        | DiagramToolboxControlProp.DiagramControl v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramToolboxControl.DiagramControlProperty, box v)
        | DiagramToolboxControlProp.IsCompact v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramToolboxControl.IsCompactProperty, box v)
        | DiagramToolboxControlProp.LayoutError v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramToolboxControl.LayoutErrorProperty, box v)
        | DiagramToolboxControlProp.MenuViewMode v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramToolboxControl.MenuViewModeProperty, box v)
        | DiagramToolboxControlProp.CompactWidth v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramToolboxControl.CompactWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramToolboxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
