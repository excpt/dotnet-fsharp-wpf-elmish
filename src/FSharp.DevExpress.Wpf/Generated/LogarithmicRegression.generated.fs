...
type LogarithmicRegressionProp =
    | Base of ParametricRegressionProp

module LogarithmicRegression =

    let apply (el: DevExpress.Xpf.Charts.LogarithmicRegression) (prop: LogarithmicRegressionProp) =
        match prop with
        | LogarithmicRegressionProp.Base p -> ParametricRegression.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LogarithmicRegression>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
