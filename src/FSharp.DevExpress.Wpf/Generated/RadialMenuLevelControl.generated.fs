...
type RadialMenuLevelControlProp =
    | Base of LinksControlProp
    | FirstSectorIndex of int

module RadialMenuLevelControl =
    let firstSectorIndex v : obj = box (RadialMenuLevelControlProp.FirstSectorIndex v)

    let apply (el: DevExpress.Xpf.Bars.RadialMenuLevelControl) (prop: RadialMenuLevelControlProp) =
        match prop with
        | RadialMenuLevelControlProp.Base p -> LinksControl.apply el p
        | RadialMenuLevelControlProp.FirstSectorIndex v -> el.SetValue(DevExpress.Xpf.Bars.RadialMenuLevelControl.FirstSectorIndexProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.RadialMenuLevelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
