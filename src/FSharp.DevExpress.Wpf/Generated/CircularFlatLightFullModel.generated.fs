...
type CircularFlatLightFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatLightFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatLightFullModel) (prop: CircularFlatLightFullModelProp) =
        match prop with
        | CircularFlatLightFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatLightFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
