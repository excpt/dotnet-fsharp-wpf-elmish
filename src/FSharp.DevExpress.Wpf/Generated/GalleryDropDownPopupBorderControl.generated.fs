...
type GalleryDropDownPopupBorderControlProp =
    | Base of BarPopupBorderControlProp

module GalleryDropDownPopupBorderControl =

    let apply (el: DevExpress.Xpf.Ribbon.GalleryDropDownPopupBorderControl) (prop: GalleryDropDownPopupBorderControlProp) =
        match prop with
        | GalleryDropDownPopupBorderControlProp.Base p -> BarPopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.GalleryDropDownPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
