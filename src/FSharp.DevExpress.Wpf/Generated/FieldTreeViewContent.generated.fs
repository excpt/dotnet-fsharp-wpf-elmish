...
type FieldTreeViewContentProp =
    | Foreground of System.Windows.Media.Brush
    | ImageSource of System.Windows.Media.ImageSource
    | DisplayText of string
    | Field of DevExpress.Xpf.PivotGrid.PivotGridField
    | IsChecked of bool
    | CheckBoxVisibility of System.Windows.Visibility
    | ContentTemplate of System.Windows.DataTemplate
    | ContentTemplateSelector of System.Windows.Controls.DataTemplateSelector
    | ActualHeaderContentStyle of System.Windows.Style

module FieldTreeViewContent =
    let foreground v : obj = box (FieldTreeViewContentProp.Foreground v)
    let imageSource v : obj = box (FieldTreeViewContentProp.ImageSource v)
    let displayText v : obj = box (FieldTreeViewContentProp.DisplayText v)
    let field v : obj = box (FieldTreeViewContentProp.Field v)
    let isChecked v : obj = box (FieldTreeViewContentProp.IsChecked v)
    let checkBoxVisibility v : obj = box (FieldTreeViewContentProp.CheckBoxVisibility v)
    let contentTemplate v : obj = box (FieldTreeViewContentProp.ContentTemplate v)
    let contentTemplateSelector v : obj = box (FieldTreeViewContentProp.ContentTemplateSelector v)
    let actualHeaderContentStyle v : obj = box (FieldTreeViewContentProp.ActualHeaderContentStyle v)

    let apply (el: DevExpress.Xpf.PivotGrid.FieldTreeViewContent) (prop: FieldTreeViewContentProp) =
        match prop with
        | FieldTreeViewContentProp.Foreground v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.ForegroundProperty, box v)
        | FieldTreeViewContentProp.ImageSource v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.ImageSourceProperty, box v)
        | FieldTreeViewContentProp.DisplayText v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.DisplayTextProperty, box v)
        | FieldTreeViewContentProp.Field v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.FieldProperty, box v)
        | FieldTreeViewContentProp.IsChecked v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.IsCheckedProperty, box v)
        | FieldTreeViewContentProp.CheckBoxVisibility v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.CheckBoxVisibilityProperty, box v)
        | FieldTreeViewContentProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.ContentTemplateProperty, box v)
        | FieldTreeViewContentProp.ContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.ContentTemplateSelectorProperty, box v)
        | FieldTreeViewContentProp.ActualHeaderContentStyle v -> el.SetValue(DevExpress.Xpf.PivotGrid.FieldTreeViewContent.ActualHeaderContentStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.FieldTreeViewContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
