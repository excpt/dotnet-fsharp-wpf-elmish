...
type ChartBoundRangeControlClientProp =
    | Base of ChartRangeControlClientBaseProp
    | Chart of DevExpress.Xpf.Charts.ChartControl
    | ScaleOptions of DevExpress.Xpf.Charts.RangeControlClient.ScaleOptions

module ChartBoundRangeControlClient =
    let chart v : obj = box (ChartBoundRangeControlClientProp.Chart v)
    let scaleOptions v : obj = box (ChartBoundRangeControlClientProp.ScaleOptions v)

    let apply (el: DevExpress.Xpf.Charts.RangeControlClient.ChartBoundRangeControlClient) (prop: ChartBoundRangeControlClientProp) =
        match prop with
        | ChartBoundRangeControlClientProp.Base p -> ChartRangeControlClientBase.apply el p
        | ChartBoundRangeControlClientProp.Chart v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartBoundRangeControlClient.ChartProperty, box v)
        | ChartBoundRangeControlClientProp.ScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.ChartBoundRangeControlClient.ScaleOptionsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RangeControlClient.ChartBoundRangeControlClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
