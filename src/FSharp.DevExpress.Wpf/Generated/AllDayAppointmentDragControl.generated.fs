...
type AllDayAppointmentDragControlProp =
    | Base of AllDayAppointmentControlProp

module AllDayAppointmentDragControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AllDayAppointmentDragControl) (prop: AllDayAppointmentDragControlProp) =
        match prop with
        | AllDayAppointmentDragControlProp.Base p -> AllDayAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AllDayAppointmentDragControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
