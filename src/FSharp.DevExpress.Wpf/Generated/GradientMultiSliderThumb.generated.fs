...
type GradientMultiSliderThumbProp =
    | Offset of float
    | Color of System.Windows.Media.Color
    | IsSelected of bool
    | OnThumbPositionChanged of System.Windows.RoutedEventHandler
    | OnThumbColorChanged of System.Windows.RoutedEventHandler

module GradientMultiSliderThumb =
    let offset v : obj = box (GradientMultiSliderThumbProp.Offset v)
    let color v : obj = box (GradientMultiSliderThumbProp.Color v)
    let isSelected v : obj = box (GradientMultiSliderThumbProp.IsSelected v)
    let onThumbPositionChanged v : obj = box (EventProp(box (GradientMultiSliderThumbProp.OnThumbPositionChanged v)))
    let onThumbColorChanged v : obj = box (EventProp(box (GradientMultiSliderThumbProp.OnThumbColorChanged v)))

    let apply (el: DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb) (prop: GradientMultiSliderThumbProp) =
        match prop with
        | GradientMultiSliderThumbProp.Offset v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb.OffsetProperty, box v)
        | GradientMultiSliderThumbProp.Color v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb.ColorProperty, box v)
        | GradientMultiSliderThumbProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb.IsSelectedProperty, box v)
        | GradientMultiSliderThumbProp.OnThumbPositionChanged h -> el.ThumbPositionChanged.AddHandler(h)
        | GradientMultiSliderThumbProp.OnThumbColorChanged h -> el.ThumbColorChanged.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.GradientMultiSliderThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
