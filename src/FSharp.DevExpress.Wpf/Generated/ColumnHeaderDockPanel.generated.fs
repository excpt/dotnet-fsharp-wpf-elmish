...
type ColumnHeaderDockPanelProp =
    | ContentMargin of System.Windows.Thickness
    | ContainerAlignment of System.Windows.HorizontalAlignment

module ColumnHeaderDockPanel =
    let contentMargin v : obj = box (ColumnHeaderDockPanelProp.ContentMargin v)
    let containerAlignment v : obj = box (ColumnHeaderDockPanelProp.ContainerAlignment v)

    let apply (el: DevExpress.Xpf.Grid.ColumnHeaderDockPanel) (prop: ColumnHeaderDockPanelProp) =
        match prop with
        | ColumnHeaderDockPanelProp.ContentMargin v -> el.SetValue(DevExpress.Xpf.Grid.ColumnHeaderDockPanel.ContentMarginProperty, box v)
        | ColumnHeaderDockPanelProp.ContainerAlignment v -> el.SetValue(DevExpress.Xpf.Grid.ColumnHeaderDockPanel.ContainerAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.ColumnHeaderDockPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
