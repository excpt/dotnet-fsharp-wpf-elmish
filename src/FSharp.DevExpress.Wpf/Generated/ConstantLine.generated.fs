...
type ConstantLineProp =
    ...
    | Title of DevExpress.Xpf.Charts.ConstantLineTitle
    | LegendMarkerTemplate of System.Windows.DataTemplate
    | ElementTemplate of System.Windows.DataTemplate
    | Legend of obj
    | RuntimeMoving of bool
    | RuntimeDeletion of bool

module ConstantLine =
    let visible v : obj = box (ConstantLineProp.Visible v)
    let checkedInLegend v : obj = box (ConstantLineProp.CheckedInLegend v)
    let checkableInLegend v : obj = box (ConstantLineProp.CheckableInLegend v)
    let value v : obj = box (ConstantLineProp.Value v)
    let brush v : obj = box (ConstantLineProp.Brush v)
    let lineStyle v : obj = box (ConstantLineProp.LineStyle v)
    let legendText v : obj = box (ConstantLineProp.LegendText v)
    let title v : obj = box (ConstantLineProp.Title v)
    let legendMarkerTemplate v : obj = box (ConstantLineProp.LegendMarkerTemplate v)
    let elementTemplate v : obj = box (ConstantLineProp.ElementTemplate v)
    let legend v : obj = box (ConstantLineProp.Legend v)
    let runtimeMoving v : obj = box (ConstantLineProp.RuntimeMoving v)
    let runtimeDeletion v : obj = box (ConstantLineProp.RuntimeDeletion v)

    let apply (el: DevExpress.Xpf.Charts.ConstantLine) (prop: ConstantLineProp) =
        match prop with
        | ConstantLineProp.Base p -> ChartElement.apply el p
        | ConstantLineProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.VisibleProperty, box v)
        | ConstantLineProp.CheckedInLegend v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.CheckedInLegendProperty, box v)
        | ConstantLineProp.CheckableInLegend v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.CheckableInLegendProperty, box v)
        | ConstantLineProp.Value v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.ValueProperty, box v)
        | ConstantLineProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.BrushProperty, box v)
        | ConstantLineProp.LineStyle v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.LineStyleProperty, box v)
        | ConstantLineProp.LegendText v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.LegendTextProperty, box v)
        | ConstantLineProp.Title v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.TitleProperty, box v)
        | ConstantLineProp.LegendMarkerTemplate v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.LegendMarkerTemplateProperty, box v)
        | ConstantLineProp.ElementTemplate v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.ElementTemplateProperty, box v)
        | ConstantLineProp.Legend v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.LegendProperty, box v)
        | ConstantLineProp.RuntimeMoving v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.RuntimeMovingProperty, box v)
        | ConstantLineProp.RuntimeDeletion v -> el.SetValue(DevExpress.Xpf.Charts.ConstantLine.RuntimeDeletionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ConstantLine>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
