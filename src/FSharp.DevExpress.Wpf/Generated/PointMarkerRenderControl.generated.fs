...
type PointMarkerRenderControlProp =
    | Base of MarkerRenderControlBaseProp

module PointMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.PointMarkerRenderControl) (prop: PointMarkerRenderControlProp) =
        match prop with
        | PointMarkerRenderControlProp.Base p -> MarkerRenderControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PointMarkerRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
