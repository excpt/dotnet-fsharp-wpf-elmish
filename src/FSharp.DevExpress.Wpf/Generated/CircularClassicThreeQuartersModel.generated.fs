...
type CircularClassicThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularClassicThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularClassicThreeQuartersModel) (prop: CircularClassicThreeQuartersModelProp) =
        match prop with
        | CircularClassicThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularClassicThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
