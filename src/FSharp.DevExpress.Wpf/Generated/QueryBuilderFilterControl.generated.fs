...
type QueryBuilderFilterControlProp =
    | EditValue of DevExpress.Xpf.DataAccess.Native.Editors.FiltersView

module QueryBuilderFilterControl =
    let editValue v : obj = box (QueryBuilderFilterControlProp.EditValue v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControl) (prop: QueryBuilderFilterControlProp) =
        match prop with
        | QueryBuilderFilterControlProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControl.EditValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryBuilderFilterControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
