...
open System
open System.Windows
open DevExpress.Xpf.Core.MvvmSample
...
type MvvmRootProp =
    ...
    | SplashScreenProvider of DevExpress.Xpf.Core.MvvmSample.ISplashScreenProvider

module MvvmRoot =
    let storyboard v : obj = box (MvvmRootProp.Storyboard v)
    let storyboards v : obj = box (MvvmRootProp.Storyboards v)
    let splashScreenProvider v : obj = box (MvvmRootProp.SplashScreenProvider v)

    let apply (el: DevExpress.Xpf.Core.MvvmSample.MvvmRoot) (prop: MvvmRootProp) =
        match prop with
        | MvvmRootProp.Storyboard v -> el.SetValue(DevExpress.Xpf.Core.MvvmSample.MvvmRoot.StoryboardProperty, box v)
        | MvvmRootProp.Storyboards v -> el.SetValue(DevExpress.Xpf.Core.MvvmSample.MvvmRoot.StoryboardsProperty, box v)
        | MvvmRootProp.SplashScreenProvider v -> el.SetValue(DevExpress.Xpf.Core.MvvmSample.MvvmRoot.SplashScreenProviderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.MvvmSample.MvvmRoot>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
