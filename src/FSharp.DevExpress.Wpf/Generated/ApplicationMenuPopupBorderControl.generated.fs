...
type ApplicationMenuPopupBorderControlProp =
    | Base of PopupBorderControlProp

module ApplicationMenuPopupBorderControl =

    let apply (el: DevExpress.Xpf.Ribbon.ApplicationMenuPopupBorderControl) (prop: ApplicationMenuPopupBorderControlProp) =
        match prop with
        | ApplicationMenuPopupBorderControlProp.Base p -> PopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.ApplicationMenuPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
