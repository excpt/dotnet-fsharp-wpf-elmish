...
type InsertTableControlProp =
    | Base of ReferenceEditBaseControlProp

module InsertTableControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.InsertTableControl) (prop: InsertTableControlProp) =
        match prop with
        | InsertTableControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.InsertTableControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
