...
type YellowSubmarineThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineThreeQuartersArcScaleBackgroundLayerControl) (prop: YellowSubmarineThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
