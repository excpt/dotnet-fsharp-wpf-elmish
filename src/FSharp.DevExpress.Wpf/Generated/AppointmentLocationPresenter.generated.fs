...
type AppointmentLocationPresenterProp =
    | Base of FastTextBlockProp

module AppointmentLocationPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentLocationPresenter) (prop: AppointmentLocationPresenterProp) =
        match prop with
        | AppointmentLocationPresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentLocationPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
