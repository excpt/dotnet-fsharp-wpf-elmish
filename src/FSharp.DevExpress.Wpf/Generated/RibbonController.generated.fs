...
type RibbonControllerProp =
    | Base of RibbonControllerBaseProp

module RibbonController =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonController) (prop: RibbonControllerProp) =
        match prop with
        | RibbonControllerProp.Base p -> RibbonControllerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
