...
type GroupBoxContentControlProp =
    | Base of GroupContentControlProp
    | CaptionBackground of System.Windows.Media.Brush

module GroupBoxContentControl =
    let captionBackground v : obj = box (GroupBoxContentControlProp.CaptionBackground v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.GroupBoxContentControl) (prop: GroupBoxContentControlProp) =
        match prop with
        | GroupBoxContentControlProp.Base p -> GroupContentControl.apply el p
        | GroupBoxContentControlProp.CaptionBackground v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.GroupBoxContentControl.CaptionBackgroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.GroupBoxContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
