...
type PrintCellContentPresenterProp =
    | Base of FieldDataCellContentPresenterProp

module PrintCellContentPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintCellContentPresenter) (prop: PrintCellContentPresenterProp) =
        match prop with
        | PrintCellContentPresenterProp.Base p -> FieldDataCellContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintCellContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
