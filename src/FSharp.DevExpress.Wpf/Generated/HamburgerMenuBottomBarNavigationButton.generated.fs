...
type HamburgerMenuBottomBarNavigationButtonProp =
...
module HamburgerMenuBottomBarNavigationButton =
    let placement v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.Placement v)
    let glyph v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.Glyph v)
    let glyphTemplate v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.GlyphTemplate v)
    let glyphWidth v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.GlyphWidth v)
    let glyphHeight v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.GlyphHeight v)
    let glyphStretch v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.GlyphStretch v)
    let allowGlyphTheming v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (HamburgerMenuBottomBarNavigationButtonProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton) (prop: HamburgerMenuBottomBarNavigationButtonProp) =
        match prop with
        | HamburgerMenuBottomBarNavigationButtonProp.Placement v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.PlacementProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.Glyph v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.GlyphProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.GlyphTemplateProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.GlyphWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.GlyphWidthProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.GlyphHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.GlyphHeightProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.GlyphStretchProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.AllowGlyphThemingProperty, box v)
        | HamburgerMenuBottomBarNavigationButtonProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.HamburgerMenuBottomBarNavigationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
