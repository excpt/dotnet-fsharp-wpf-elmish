...
open System
open System.Windows
open DevExpress.Xpf.Editors.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TokenEditorProp =
    | EditValue of obj
    | IsTextEditable of bool
    | IsReadOnly of bool
    | FocusPopupOnOpen of bool
    | EnableTokenWrapping of bool
    | TokenBorderTemplate of System.Windows.Controls.ControlTemplate
    | ShowTokenButtons of bool
    | TokenButtons of DevExpress.Xpf.Editors.ButtonInfoCollection
    | NewTokenPosition of DevExpress.Xpf.Editors.NewTokenPosition
    | TokenTextTrimming of System.Windows.TextTrimming
    | TokenMaxWidth of float
    | EditMode of DevExpress.Xpf.Editors.EditMode
    | AllowEditTokens of bool
    | CharacterCasing of System.Windows.Controls.CharacterCasing
    | NullTextForeground of System.Windows.Media.Brush
    | MaxTextLength of int
    | EditBehavior of DevExpress.Xpf.Editors.ITokenEditorBehavior
    | DeleteTokenButtonTemplate of System.Windows.DataTemplate
    | TokenStyle of System.Windows.Style
    | NewTokenText of string

module TokenEditor =
    let editValue v : obj = box (TokenEditorProp.EditValue v)
    let isTextEditable v : obj = box (TokenEditorProp.IsTextEditable v)
    let isReadOnly v : obj = box (TokenEditorProp.IsReadOnly v)
    let focusPopupOnOpen v : obj = box (TokenEditorProp.FocusPopupOnOpen v)
    let enableTokenWrapping v : obj = box (TokenEditorProp.EnableTokenWrapping v)
    let tokenBorderTemplate v : obj = box (TokenEditorProp.TokenBorderTemplate v)
    let showTokenButtons v : obj = box (TokenEditorProp.ShowTokenButtons v)
    let tokenButtons v : obj = box (TokenEditorProp.TokenButtons v)
    let newTokenPosition v : obj = box (TokenEditorProp.NewTokenPosition v)
    let tokenTextTrimming v : obj = box (TokenEditorProp.TokenTextTrimming v)
    let tokenMaxWidth v : obj = box (TokenEditorProp.TokenMaxWidth v)
    let editMode v : obj = box (TokenEditorProp.EditMode v)
    let allowEditTokens v : obj = box (TokenEditorProp.AllowEditTokens v)
    let characterCasing v : obj = box (TokenEditorProp.CharacterCasing v)
    let nullTextForeground v : obj = box (TokenEditorProp.NullTextForeground v)
    let maxTextLength v : obj = box (TokenEditorProp.MaxTextLength v)
    let editBehavior v : obj = box (TokenEditorProp.EditBehavior v)
    let deleteTokenButtonTemplate v : obj = box (TokenEditorProp.DeleteTokenButtonTemplate v)
    let tokenStyle v : obj = box (TokenEditorProp.TokenStyle v)
    let newTokenText v : obj = box (TokenEditorProp.NewTokenText v)

    let apply (el: DevExpress.Xpf.Editors.Internal.TokenEditor) (prop: TokenEditorProp) =
        match prop with
        | TokenEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.EditValueProperty, box v)
        | TokenEditorProp.IsTextEditable v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.IsTextEditableProperty, box v)
        | TokenEditorProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.IsReadOnlyProperty, box v)
        | TokenEditorProp.FocusPopupOnOpen v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.FocusPopupOnOpenProperty, box v)
        | TokenEditorProp.EnableTokenWrapping v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.EnableTokenWrappingProperty, box v)
        | TokenEditorProp.TokenBorderTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.TokenBorderTemplateProperty, box v)
        | TokenEditorProp.ShowTokenButtons v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.ShowTokenButtonsProperty, box v)
        | TokenEditorProp.TokenButtons v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.TokenButtonsProperty, box v)
        | TokenEditorProp.NewTokenPosition v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.NewTokenPositionProperty, box v)
        | TokenEditorProp.TokenTextTrimming v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.TokenTextTrimmingProperty, box v)
        | TokenEditorProp.TokenMaxWidth v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.TokenMaxWidthProperty, box v)
        | TokenEditorProp.EditMode v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.EditModeProperty, box v)
        | TokenEditorProp.AllowEditTokens v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.AllowEditTokensProperty, box v)
        | TokenEditorProp.CharacterCasing v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.CharacterCasingProperty, box v)
        | TokenEditorProp.NullTextForeground v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.NullTextForegroundProperty, box v)
        | TokenEditorProp.MaxTextLength v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.MaxTextLengthProperty, box v)
        | TokenEditorProp.EditBehavior v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.EditBehaviorProperty, box v)
        | TokenEditorProp.DeleteTokenButtonTemplate v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.DeleteTokenButtonTemplateProperty, box v)
        | TokenEditorProp.TokenStyle v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.TokenStyleProperty, box v)
        | TokenEditorProp.NewTokenText v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TokenEditor.NewTokenTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.TokenEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
