...
type BookProp =
    | DataSource of System.Collections.IList
    | PageIndex of int
    | PageTemplate of System.Windows.DataTemplate
    | ActiveAreaSize of System.Windows.Size
    | AnimationRate of float
    | AnimationSpeed of float
    | ShortAnimationSpeed of float
    | FirstPage of DevExpress.Xpf.Controls.PageType

module Book =
    let dataSource v : obj = box (BookProp.DataSource v)
    let pageIndex v : obj = box (BookProp.PageIndex v)
    let pageTemplate v : obj = box (BookProp.PageTemplate v)
    let activeAreaSize v : obj = box (BookProp.ActiveAreaSize v)
    let animationRate v : obj = box (BookProp.AnimationRate v)
    let animationSpeed v : obj = box (BookProp.AnimationSpeed v)
    let shortAnimationSpeed v : obj = box (BookProp.ShortAnimationSpeed v)
    let firstPage v : obj = box (BookProp.FirstPage v)

    let apply (el: DevExpress.Xpf.Controls.Book) (prop: BookProp) =
        match prop with
        | BookProp.DataSource v -> el.SetValue(DevExpress.Xpf.Controls.Book.DataSourceProperty, box v)
        | BookProp.PageIndex v -> el.SetValue(DevExpress.Xpf.Controls.Book.PageIndexProperty, box v)
        | BookProp.PageTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Book.PageTemplateProperty, box v)
        | BookProp.ActiveAreaSize v -> el.SetValue(DevExpress.Xpf.Controls.Book.ActiveAreaSizeProperty, box v)
        | BookProp.AnimationRate v -> el.SetValue(DevExpress.Xpf.Controls.Book.AnimationRateProperty, box v)
        | BookProp.AnimationSpeed v -> el.SetValue(DevExpress.Xpf.Controls.Book.AnimationSpeedProperty, box v)
        | BookProp.ShortAnimationSpeed v -> el.SetValue(DevExpress.Xpf.Controls.Book.ShortAnimationSpeedProperty, box v)
        | BookProp.FirstPage v -> el.SetValue(DevExpress.Xpf.Controls.Book.FirstPageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Book>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
