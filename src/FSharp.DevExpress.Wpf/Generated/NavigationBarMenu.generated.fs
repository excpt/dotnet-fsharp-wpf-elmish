...
type NavigationBarMenuProp =
    | Base of NavigationBarMenuBaseProp

module NavigationBarMenu =

    let apply (el: DevExpress.Xpf.Navigation.NavigationBar.Customization.NavigationBarMenu) (prop: NavigationBarMenuProp) =
        match prop with
        | NavigationBarMenuProp.Base p -> NavigationBarMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.NavigationBar.Customization.NavigationBarMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
