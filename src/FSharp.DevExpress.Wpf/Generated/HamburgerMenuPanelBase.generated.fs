...
type HamburgerMenuPanelBaseProp =
    | Base of ItemsSourcePanelProp
    | IsCompact of bool
    | CompactItemWidth of float
    | MinItemHeight of float
    | LayoutCalculator of DevExpress.Xpf.WindowsUI.Internal.IHamburgerMenuLayoutCalculator

module HamburgerMenuPanelBase =
    let isCompact v : obj = box (HamburgerMenuPanelBaseProp.IsCompact v)
    let compactItemWidth v : obj = box (HamburgerMenuPanelBaseProp.CompactItemWidth v)
    let minItemHeight v : obj = box (HamburgerMenuPanelBaseProp.MinItemHeight v)
    let layoutCalculator v : obj = box (HamburgerMenuPanelBaseProp.LayoutCalculator v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuPanelBase) (prop: HamburgerMenuPanelBaseProp) =
        match prop with
        | HamburgerMenuPanelBaseProp.Base p -> ItemsSourcePanel.apply el p
        | HamburgerMenuPanelBaseProp.IsCompact v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuPanelBase.IsCompactProperty, box v)
        | HamburgerMenuPanelBaseProp.CompactItemWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuPanelBase.CompactItemWidthProperty, box v)
        | HamburgerMenuPanelBaseProp.MinItemHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuPanelBase.MinItemHeightProperty, box v)
        | HamburgerMenuPanelBaseProp.LayoutCalculator v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuPanelBase.LayoutCalculatorProperty, box v)

    let itemsSource v : obj = box (ItemsSourcePanelProp.ItemsSource v)
