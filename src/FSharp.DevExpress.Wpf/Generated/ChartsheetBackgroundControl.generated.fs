...
type ChartsheetBackgroundControlProp =
    | Base of WorksheetPaintControlProp

module ChartsheetBackgroundControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.ChartsheetBackgroundControl) (prop: ChartsheetBackgroundControlProp) =
        match prop with
        | ChartsheetBackgroundControlProp.Base p -> WorksheetPaintControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.ChartsheetBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
