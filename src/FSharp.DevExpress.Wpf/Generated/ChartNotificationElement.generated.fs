...
type ChartNotificationElementProp =
    | Base of ChartElementProp

module ChartNotificationElement =

    let apply (el: DevExpress.Xpf.Charts.ChartNotificationElement) (prop: ChartNotificationElementProp) =
        match prop with
        | ChartNotificationElementProp.Base p -> ChartElement.apply el p
