...
open System
open System.Windows
open DevExpress.Xpf.Editors.RangeControl.Internal
...
module RangeBar =
    let selectionBrush v : obj = box (RangeBarProp.SelectionBrush v)

    let apply (el: DevExpress.Xpf.Editors.RangeControl.Internal.RangeBar) (prop: RangeBarProp) =
        match prop with
        | RangeBarProp.SelectionBrush v -> el.SetValue(DevExpress.Xpf.Editors.RangeControl.Internal.RangeBar.SelectionBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RangeControl.Internal.RangeBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
