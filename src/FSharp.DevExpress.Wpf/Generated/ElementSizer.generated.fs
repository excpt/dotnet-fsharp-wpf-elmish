...
type ElementSizerProp =
    | Base of ControlBaseProp
    | CollapseOnDoubleClick of bool
    | Element of System.Windows.FrameworkElement
    | UseSizingStep of bool
    | ShowResizingHandle of bool

module ElementSizer =
    let collapseOnDoubleClick v : obj = box (ElementSizerProp.CollapseOnDoubleClick v)
    let element v : obj = box (ElementSizerProp.Element v)
    let useSizingStep v : obj = box (ElementSizerProp.UseSizingStep v)
    let showResizingHandle v : obj = box (ElementSizerProp.ShowResizingHandle v)

    let apply (el: DevExpress.Xpf.LayoutControl.ElementSizer) (prop: ElementSizerProp) =
        match prop with
        | ElementSizerProp.Base p -> ControlBase.apply el p
        | ElementSizerProp.CollapseOnDoubleClick v -> el.SetValue(DevExpress.Xpf.LayoutControl.ElementSizer.CollapseOnDoubleClickProperty, box v)
        | ElementSizerProp.Element v -> el.SetValue(DevExpress.Xpf.LayoutControl.ElementSizer.ElementProperty, box v)
        | ElementSizerProp.UseSizingStep v -> el.SetValue(DevExpress.Xpf.LayoutControl.ElementSizer.UseSizingStepProperty, box v)
        | ElementSizerProp.ShowResizingHandle v -> el.SetValue(DevExpress.Xpf.LayoutControl.ElementSizer.ShowResizingHandleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.ElementSizer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
