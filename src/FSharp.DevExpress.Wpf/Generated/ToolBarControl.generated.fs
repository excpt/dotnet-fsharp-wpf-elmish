...
type ToolBarControlProp =
    | Base of ToolBarControlBaseProp
    | UseWholeRow of bool
    | ShowDragWidget of bool
...
module ToolBarControl =
    let useWholeRow v : obj = box (ToolBarControlProp.UseWholeRow v)
    let showDragWidget v : obj = box (ToolBarControlProp.ShowDragWidget v)
    let rotateWhenVertical v : obj = box (ToolBarControlProp.RotateWhenVertical v)
    let orientation v : obj = box (ToolBarControlProp.Orientation v)
    let allowCollapse v : obj = box (ToolBarControlProp.AllowCollapse v)
    let isCollapsed v : obj = box (ToolBarControlProp.IsCollapsed v)
    let allowQuickCustomization v : obj = box (ToolBarControlProp.AllowQuickCustomization v)

    let apply (el: DevExpress.Xpf.Bars.ToolBarControl) (prop: ToolBarControlProp) =
        match prop with
        | ToolBarControlProp.Base p -> ToolBarControlBase.apply el p
        | ToolBarControlProp.UseWholeRow v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.UseWholeRowProperty, box v)
        | ToolBarControlProp.ShowDragWidget v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.ShowDragWidgetProperty, box v)
        | ToolBarControlProp.RotateWhenVertical v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.RotateWhenVerticalProperty, box v)
        | ToolBarControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.OrientationProperty, box v)
        | ToolBarControlProp.AllowCollapse v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.AllowCollapseProperty, box v)
        | ToolBarControlProp.IsCollapsed v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.IsCollapsedProperty, box v)
        | ToolBarControlProp.AllowQuickCustomization v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControl.AllowQuickCustomizationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.ToolBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
