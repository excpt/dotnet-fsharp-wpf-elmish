...
type EntityServerModeDataSourceProp =
...
module EntityServerModeDataSource =
    let defaultSorting v : obj = box (EntityServerModeDataSourceProp.DefaultSorting v)
    let elementType v : obj = box (EntityServerModeDataSourceProp.ElementType v)
    let keyExpression v : obj = box (EntityServerModeDataSourceProp.KeyExpression v)
    let queryableSource v : obj = box (EntityServerModeDataSourceProp.QueryableSource v)
    let onExceptionThrown v : obj = box (EventProp(box (EntityServerModeDataSourceProp.OnExceptionThrown v)))
    let onInconsistencyDetected v : obj = box (EventProp(box (EntityServerModeDataSourceProp.OnInconsistencyDetected v)))

    let apply (el: DevExpress.Xpf.Core.ServerMode.EntityServerModeDataSource) (prop: EntityServerModeDataSourceProp) =
        match prop with
        | EntityServerModeDataSourceProp.Base p -> ListSourceDataSourceBase.apply el p
        | EntityServerModeDataSourceProp.DefaultSorting v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.EntityServerModeDataSource.DefaultSortingProperty, box v)
        | EntityServerModeDataSourceProp.ElementType v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.EntityServerModeDataSource.ElementTypeProperty, box v)
        | EntityServerModeDataSourceProp.KeyExpression v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.EntityServerModeDataSource.KeyExpressionProperty, box v)
        | EntityServerModeDataSourceProp.QueryableSource v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.EntityServerModeDataSource.QueryableSourceProperty, box v)
        | EntityServerModeDataSourceProp.OnExceptionThrown h -> el.ExceptionThrown.AddHandler(h)
        | EntityServerModeDataSourceProp.OnInconsistencyDetected h -> el.InconsistencyDetected.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ServerMode.EntityServerModeDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
