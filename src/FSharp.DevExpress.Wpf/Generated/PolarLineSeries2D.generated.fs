...
type PolarLineSeries2DProp =
    | Base of CircularLineSeries2DProp

module PolarLineSeries2D =

    let apply (el: DevExpress.Xpf.Charts.PolarLineSeries2D) (prop: PolarLineSeries2DProp) =
        match prop with
        | PolarLineSeries2DProp.Base p -> CircularLineSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarLineSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
