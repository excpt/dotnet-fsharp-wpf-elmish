...
type GanttConnectorEditPreviewProp =
    | Base of GanttConnectorBaseProp

module GanttConnectorEditPreview =

    let apply (el: DevExpress.Xpf.Gantt.GanttConnectorEditPreview) (prop: GanttConnectorEditPreviewProp) =
        match prop with
        | GanttConnectorEditPreviewProp.Base p -> GanttConnectorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.GanttConnectorEditPreview>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
