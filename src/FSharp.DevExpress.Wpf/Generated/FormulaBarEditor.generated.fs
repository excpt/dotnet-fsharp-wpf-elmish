...
type FormulaBarEditorProp =
    | Base of XpfCellInplaceEditorBaseProp

module FormulaBarEditor =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.FormulaBarEditor) (prop: FormulaBarEditorProp) =
        match prop with
        | FormulaBarEditorProp.Base p -> XpfCellInplaceEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.FormulaBarEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
