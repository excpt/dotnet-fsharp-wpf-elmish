...
type MeasurePixelSnapperContentControlProp =
    | SnapperType of DevExpress.Xpf.Core.SnapperType
    | TranslateContentOnRender of bool

module MeasurePixelSnapperContentControl =
    let snapperType v : obj = box (MeasurePixelSnapperContentControlProp.SnapperType v)
    let translateContentOnRender v : obj = box (MeasurePixelSnapperContentControlProp.TranslateContentOnRender v)

    let apply (el: DevExpress.Xpf.Core.MeasurePixelSnapperContentControl) (prop: MeasurePixelSnapperContentControlProp) =
        match prop with
        | MeasurePixelSnapperContentControlProp.SnapperType v -> el.SetValue(DevExpress.Xpf.Core.MeasurePixelSnapperContentControl.SnapperTypeProperty, box v)
        | MeasurePixelSnapperContentControlProp.TranslateContentOnRender v -> el.SetValue(DevExpress.Xpf.Core.MeasurePixelSnapperContentControl.TranslateContentOnRenderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.MeasurePixelSnapperContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
