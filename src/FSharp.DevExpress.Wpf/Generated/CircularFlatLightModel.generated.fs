...
type CircularFlatLightModelProp =
    | Base of CircularGaugeModelProp

module CircularFlatLightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatLightModel) (prop: CircularFlatLightModelProp) =
        match prop with
        | CircularFlatLightModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatLightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
