...
type EcoGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoGaugeBackgroundLayerControl) (prop: EcoGaugeBackgroundLayerControlProp) =
        match prop with
        | EcoGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
