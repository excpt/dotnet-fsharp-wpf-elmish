...
type TileBarItemProp =
    | Base of TileSelectorItemProp
    | FlyoutContent of obj
    | FlyoutContentTemplate of System.Windows.DataTemplate
    | FlyoutContentTemplateSelector of System.Windows.Controls.DataTemplateSelector

module TileBarItem =
    let flyoutContent v : obj = box (TileBarItemProp.FlyoutContent v)
    let flyoutContentTemplate v : obj = box (TileBarItemProp.FlyoutContentTemplate v)
    let flyoutContentTemplateSelector v : obj = box (TileBarItemProp.FlyoutContentTemplateSelector v)

    let apply (el: DevExpress.Xpf.Navigation.TileBarItem) (prop: TileBarItemProp) =
        match prop with
        | TileBarItemProp.Base p -> TileSelectorItem.apply el p
        | TileBarItemProp.FlyoutContent v -> el.SetValue(DevExpress.Xpf.Navigation.TileBarItem.FlyoutContentProperty, box v)
        | TileBarItemProp.FlyoutContentTemplate v -> el.SetValue(DevExpress.Xpf.Navigation.TileBarItem.FlyoutContentTemplateProperty, box v)
        | TileBarItemProp.FlyoutContentTemplateSelector v -> el.SetValue(DevExpress.Xpf.Navigation.TileBarItem.FlyoutContentTemplateSelectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.TileBarItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
