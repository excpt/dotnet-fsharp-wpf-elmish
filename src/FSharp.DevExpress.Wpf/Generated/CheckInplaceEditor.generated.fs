...
type CheckInplaceEditorProp =
    | Base of DocumentInplaceEditorBaseProp

module CheckInplaceEditor =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.CheckInplaceEditor) (prop: CheckInplaceEditorProp) =
        match prop with
        | CheckInplaceEditorProp.Base p -> DocumentInplaceEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.Editing.CheckInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
