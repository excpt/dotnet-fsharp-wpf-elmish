...
type TreeViewFieldsPresenterProp =
    | ShowCheckBoxes of bool
    | GroupFields of bool
    | CoreFields of obj
    | FilterCriteria of DevExpress.Data.Filtering.CriteriaOperator

module TreeViewFieldsPresenter =
    let showCheckBoxes v : obj = box (TreeViewFieldsPresenterProp.ShowCheckBoxes v)
    let groupFields v : obj = box (TreeViewFieldsPresenterProp.GroupFields v)
    let coreFields v : obj = box (TreeViewFieldsPresenterProp.CoreFields v)
    let filterCriteria v : obj = box (TreeViewFieldsPresenterProp.FilterCriteria v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldsPresenter) (prop: TreeViewFieldsPresenterProp) =
        match prop with
        | TreeViewFieldsPresenterProp.ShowCheckBoxes v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldsPresenter.ShowCheckBoxesProperty, box v)
        | TreeViewFieldsPresenterProp.GroupFields v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldsPresenter.GroupFieldsProperty, box v)
        | TreeViewFieldsPresenterProp.CoreFields v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldsPresenter.CoreFieldsProperty, box v)
        | TreeViewFieldsPresenterProp.FilterCriteria v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldsPresenter.FilterCriteriaProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.TreeViewFieldsPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
