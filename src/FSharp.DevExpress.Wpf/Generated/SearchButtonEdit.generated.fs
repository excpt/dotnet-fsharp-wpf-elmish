...
type SearchButtonEditProp =
    | Base of ButtonEditProp

module SearchButtonEdit =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.SearchButtonEdit) (prop: SearchButtonEditProp) =
        match prop with
        | SearchButtonEditProp.Base p -> ButtonEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.SearchButtonEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
