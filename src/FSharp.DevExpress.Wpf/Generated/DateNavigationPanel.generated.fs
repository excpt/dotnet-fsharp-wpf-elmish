...
type DateNavigationPanelProp =
    | Scheduler of DevExpress.Xpf.Scheduling.SchedulerControl
    | Interval of obj
    | DisplayMode of obj
    | ShowText of bool
    | ShowButtons of bool
    | ShowCalendarButton of bool
    | ShowViewSelector of bool
    | BackCommand of System.Windows.Input.ICommand
    | NextCommand of System.Windows.Input.ICommand
    | GoToDateCommand of System.Windows.Input.ICommand
    | BackButtonStyle of System.Windows.Style
    | NextButtonStyle of System.Windows.Style
    | TextBlockStyle of System.Windows.Style
    | ViewSelectorStyle of System.Windows.Style
    | DayModeSameDayFormat of string
    | DayModeSameMonthFormat of string
    | DayModeSameYearFormat of string
    | DayModeFullFormat of string
    | MonthModeSameMonthFormat of string
    | MonthModeSameYearFormat of string
    | MonthModeFullFormat of string

module DateNavigationPanel =
    let scheduler v : obj = box (DateNavigationPanelProp.Scheduler v)
    let interval v : obj = box (DateNavigationPanelProp.Interval v)
    let displayMode v : obj = box (DateNavigationPanelProp.DisplayMode v)
    let showText v : obj = box (DateNavigationPanelProp.ShowText v)
    let showButtons v : obj = box (DateNavigationPanelProp.ShowButtons v)
    let showCalendarButton v : obj = box (DateNavigationPanelProp.ShowCalendarButton v)
    let showViewSelector v : obj = box (DateNavigationPanelProp.ShowViewSelector v)
    let backCommand v : obj = box (DateNavigationPanelProp.BackCommand v)
    let nextCommand v : obj = box (DateNavigationPanelProp.NextCommand v)
    let goToDateCommand v : obj = box (DateNavigationPanelProp.GoToDateCommand v)
    let backButtonStyle v : obj = box (DateNavigationPanelProp.BackButtonStyle v)
    let nextButtonStyle v : obj = box (DateNavigationPanelProp.NextButtonStyle v)
    let textBlockStyle v : obj = box (DateNavigationPanelProp.TextBlockStyle v)
    let viewSelectorStyle v : obj = box (DateNavigationPanelProp.ViewSelectorStyle v)
    let dayModeSameDayFormat v : obj = box (DateNavigationPanelProp.DayModeSameDayFormat v)
    let dayModeSameMonthFormat v : obj = box (DateNavigationPanelProp.DayModeSameMonthFormat v)
    let dayModeSameYearFormat v : obj = box (DateNavigationPanelProp.DayModeSameYearFormat v)
    let dayModeFullFormat v : obj = box (DateNavigationPanelProp.DayModeFullFormat v)
    let monthModeSameMonthFormat v : obj = box (DateNavigationPanelProp.MonthModeSameMonthFormat v)
    let monthModeSameYearFormat v : obj = box (DateNavigationPanelProp.MonthModeSameYearFormat v)
    let monthModeFullFormat v : obj = box (DateNavigationPanelProp.MonthModeFullFormat v)

    let apply (el: DevExpress.Xpf.Scheduling.DateNavigationPanel) (prop: DateNavigationPanelProp) =
        match prop with
        | DateNavigationPanelProp.Scheduler v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.SchedulerProperty, box v)
        | DateNavigationPanelProp.Interval v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.IntervalProperty, box v)
        | DateNavigationPanelProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.DisplayModeProperty, box v)
        | DateNavigationPanelProp.ShowText v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.ShowTextProperty, box v)
        | DateNavigationPanelProp.ShowButtons v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.ShowButtonsProperty, box v)
        | DateNavigationPanelProp.ShowCalendarButton v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.ShowCalendarButtonProperty, box v)
        | DateNavigationPanelProp.ShowViewSelector v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.ShowViewSelectorProperty, box v)
        | DateNavigationPanelProp.BackCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.BackCommandProperty, box v)
        | DateNavigationPanelProp.NextCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.NextCommandProperty, box v)
        | DateNavigationPanelProp.GoToDateCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.GoToDateCommandProperty, box v)
        | DateNavigationPanelProp.BackButtonStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.BackButtonStyleProperty, box v)
        | DateNavigationPanelProp.NextButtonStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.NextButtonStyleProperty, box v)
        | DateNavigationPanelProp.TextBlockStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.TextBlockStyleProperty, box v)
        | DateNavigationPanelProp.ViewSelectorStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.ViewSelectorStyleProperty, box v)
        | DateNavigationPanelProp.DayModeSameDayFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.DayModeSameDayFormatProperty, box v)
        | DateNavigationPanelProp.DayModeSameMonthFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.DayModeSameMonthFormatProperty, box v)
        | DateNavigationPanelProp.DayModeSameYearFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.DayModeSameYearFormatProperty, box v)
        | DateNavigationPanelProp.DayModeFullFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.DayModeFullFormatProperty, box v)
        | DateNavigationPanelProp.MonthModeSameMonthFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.MonthModeSameMonthFormatProperty, box v)
        | DateNavigationPanelProp.MonthModeSameYearFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.MonthModeSameYearFormatProperty, box v)
        | DateNavigationPanelProp.MonthModeFullFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.DateNavigationPanel.MonthModeFullFormatProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.DateNavigationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
