...
type CircularProgressiveThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularProgressiveThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularProgressiveThreeQuartersModel) (prop: CircularProgressiveThreeQuartersModelProp) =
        match prop with
        | CircularProgressiveThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularProgressiveThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
