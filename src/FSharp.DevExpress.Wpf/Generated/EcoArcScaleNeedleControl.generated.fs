...
type EcoArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module EcoArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoArcScaleNeedleControl) (prop: EcoArcScaleNeedleControlProp) =
        match prop with
        | EcoArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
