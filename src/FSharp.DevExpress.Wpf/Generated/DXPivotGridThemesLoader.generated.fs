...
type DXPivotGridThemesLoaderProp =
    | Base of DXThemesLoaderBaseProp
    | ShowBorder of bool
    | ShowIndicator of bool
    | ShowErrorPanel of bool
    | ErrorPanelText of string
    | ErrorPanelStyle of System.Windows.Style

module DXPivotGridThemesLoader =
    let showBorder v : obj = box (DXPivotGridThemesLoaderProp.ShowBorder v)
    let showIndicator v : obj = box (DXPivotGridThemesLoaderProp.ShowIndicator v)
    let showErrorPanel v : obj = box (DXPivotGridThemesLoaderProp.ShowErrorPanel v)
    let errorPanelText v : obj = box (DXPivotGridThemesLoaderProp.ErrorPanelText v)
    let errorPanelStyle v : obj = box (DXPivotGridThemesLoaderProp.ErrorPanelStyle v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader) (prop: DXPivotGridThemesLoaderProp) =
        match prop with
        | DXPivotGridThemesLoaderProp.Base p -> DXThemesLoaderBase.apply el p
        | DXPivotGridThemesLoaderProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader.ShowBorderProperty, box v)
        | DXPivotGridThemesLoaderProp.ShowIndicator v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader.ShowIndicatorProperty, box v)
        | DXPivotGridThemesLoaderProp.ShowErrorPanel v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader.ShowErrorPanelProperty, box v)
        | DXPivotGridThemesLoaderProp.ErrorPanelText v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader.ErrorPanelTextProperty, box v)
        | DXPivotGridThemesLoaderProp.ErrorPanelStyle v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader.ErrorPanelStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.DXPivotGridThemesLoader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
