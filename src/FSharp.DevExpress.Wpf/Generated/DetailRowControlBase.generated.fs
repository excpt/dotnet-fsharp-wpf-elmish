...
type DetailRowControlBaseProp =
    | MasterRowData of DevExpress.Xpf.Grid.RowData

module DetailRowControlBase =
    let masterRowData v : obj = box (DetailRowControlBaseProp.MasterRowData v)

    let apply (el: DevExpress.Xpf.Grid.DetailRowControlBase) (prop: DetailRowControlBaseProp) =
        match prop with
        | DetailRowControlBaseProp.MasterRowData v -> el.SetValue(DevExpress.Xpf.Grid.DetailRowControlBase.MasterRowDataProperty, box v)
