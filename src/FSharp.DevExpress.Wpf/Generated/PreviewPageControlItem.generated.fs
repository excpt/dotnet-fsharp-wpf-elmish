...
type PreviewPageControlItemProp =
    | Base of PageControlItemProp

module PreviewPageControlItem =

    let apply (el: DevExpress.Xpf.Printing.PreviewPageControlItem) (prop: PreviewPageControlItemProp) =
        match prop with
        | PreviewPageControlItemProp.Base p -> PageControlItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewPageControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
