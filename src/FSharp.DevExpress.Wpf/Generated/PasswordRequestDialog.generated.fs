...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.DataSourceWizard.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type PasswordRequestDialogProp =
    | EditValue of DevExpress.Xpf.DataAccess.DataSourceWizard.PasswordRequestViewModel
    | OpenFileDialogServiceTemplate of System.Windows.DataTemplate

module PasswordRequestDialog =
    let editValue v : obj = box (PasswordRequestDialogProp.EditValue v)
    let openFileDialogServiceTemplate v : obj = box (PasswordRequestDialogProp.OpenFileDialogServiceTemplate v)

    let apply (el: DevExpress.Xpf.DataAccess.DataSourceWizard.Native.PasswordRequestDialog) (prop: PasswordRequestDialogProp) =
        match prop with
        | PasswordRequestDialogProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.Native.PasswordRequestDialog.EditValueProperty, box v)
        | PasswordRequestDialogProp.OpenFileDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.DataSourceWizard.Native.PasswordRequestDialog.OpenFileDialogServiceTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.DataSourceWizard.Native.PasswordRequestDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
