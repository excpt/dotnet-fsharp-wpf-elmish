...
type CosmicGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicGaugeBackgroundLayerControl) (prop: CosmicGaugeBackgroundLayerControlProp) =
        match prop with
        | CosmicGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
