...
type ClassicThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicThreeQuartersArcScaleBackgroundLayerControl) (prop: ClassicThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | ClassicThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
