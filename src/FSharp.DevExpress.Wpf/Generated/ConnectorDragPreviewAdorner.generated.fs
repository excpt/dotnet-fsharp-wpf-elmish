...
type ConnectorDragPreviewAdornerProp =
    | Base of ConnectorPreviewAdornerBaseProp

module ConnectorDragPreviewAdorner =

    let apply (el: DevExpress.Xpf.Diagram.ConnectorDragPreviewAdorner) (prop: ConnectorDragPreviewAdornerProp) =
        match prop with
        | ConnectorDragPreviewAdornerProp.Base p -> ConnectorPreviewAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ConnectorDragPreviewAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
