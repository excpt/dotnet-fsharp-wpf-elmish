...
type EditableImageContentProp =
    | ImageSource of System.Windows.Media.ImageSource

module EditableImageContent =
    let imageSource v : obj = box (EditableImageContentProp.ImageSource v)

    let apply (el: DevExpress.Xpf.Charts.EditableImageContent) (prop: EditableImageContentProp) =
        match prop with
        | EditableImageContentProp.ImageSource v -> el.SetValue(DevExpress.Xpf.Charts.EditableImageContent.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.EditableImageContent>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
