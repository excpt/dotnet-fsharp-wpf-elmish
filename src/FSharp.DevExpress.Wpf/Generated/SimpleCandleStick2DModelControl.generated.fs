...
type SimpleCandleStick2DModelControlProp =
    | Base of PredefinedModelControlProp

module SimpleCandleStick2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.SimpleCandleStick2DModelControl) (prop: SimpleCandleStick2DModelControlProp) =
        match prop with
        | SimpleCandleStick2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleCandleStick2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
