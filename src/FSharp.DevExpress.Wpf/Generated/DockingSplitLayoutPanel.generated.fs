...
type DockingSplitLayoutPanelProp =
    | Base of SplitLayoutPanelProp
    | ClipMargin of System.Windows.Thickness
    | UseClipMargin of bool

module DockingSplitLayoutPanel =
    let clipMargin v : obj = box (DockingSplitLayoutPanelProp.ClipMargin v)
    let useClipMargin v : obj = box (DockingSplitLayoutPanelProp.UseClipMargin v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockingSplitLayoutPanel) (prop: DockingSplitLayoutPanelProp) =
        match prop with
        | DockingSplitLayoutPanelProp.Base p -> SplitLayoutPanel.apply el p
        | DockingSplitLayoutPanelProp.ClipMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockingSplitLayoutPanel.ClipMarginProperty, box v)
        | DockingSplitLayoutPanelProp.UseClipMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockingSplitLayoutPanel.UseClipMarginProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockingSplitLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
