...
type ThemeableScaleLabelControlProp =
    | Base of PresentationControlProp

module ThemeableScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableScaleLabelControl) (prop: ThemeableScaleLabelControlProp) =
        match prop with
        | ThemeableScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
