...
type MeasurementsControlProp =
    | Fill of System.Windows.Media.Brush
    | Stroke of System.Windows.Media.Brush
    | StrokeThickness of float
    | AreaOpacity of float

module MeasurementsControl =
    let fill v : obj = box (MeasurementsControlProp.Fill v)
    let stroke v : obj = box (MeasurementsControlProp.Stroke v)
    let strokeThickness v : obj = box (MeasurementsControlProp.StrokeThickness v)
    let areaOpacity v : obj = box (MeasurementsControlProp.AreaOpacity v)

    let apply (el: DevExpress.Xpf.Map.MeasurementsControl) (prop: MeasurementsControlProp) =
        match prop with
        | MeasurementsControlProp.Fill v -> el.SetValue(DevExpress.Xpf.Map.MeasurementsControl.FillProperty, box v)
        | MeasurementsControlProp.Stroke v -> el.SetValue(DevExpress.Xpf.Map.MeasurementsControl.StrokeProperty, box v)
        | MeasurementsControlProp.StrokeThickness v -> el.SetValue(DevExpress.Xpf.Map.MeasurementsControl.StrokeThicknessProperty, box v)
        | MeasurementsControlProp.AreaOpacity v -> el.SetValue(DevExpress.Xpf.Map.MeasurementsControl.AreaOpacityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MeasurementsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
