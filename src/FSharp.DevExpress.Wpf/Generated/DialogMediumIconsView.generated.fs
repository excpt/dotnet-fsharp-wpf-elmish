...
type DialogMediumIconsViewProp =
    | Base of DialogIconsViewProp

module DialogMediumIconsView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogMediumIconsView) (prop: DialogMediumIconsViewProp) =
        match prop with
        | DialogMediumIconsViewProp.Base p -> DialogIconsView.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogMediumIconsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
