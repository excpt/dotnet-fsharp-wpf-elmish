...
type RecurrenceRangeControlProp =
    | RecurrenceInfo of DevExpress.XtraScheduler.IRecurrenceInfo
    | TimeZoneHelper of DevExpress.XtraScheduler.TimeZoneHelper
    | Pattern of DevExpress.XtraScheduler.Appointment
    | IsReadOnly of bool

module RecurrenceRangeControl =
    let recurrenceInfo v : obj = box (RecurrenceRangeControlProp.RecurrenceInfo v)
    let timeZoneHelper v : obj = box (RecurrenceRangeControlProp.TimeZoneHelper v)
    let pattern v : obj = box (RecurrenceRangeControlProp.Pattern v)
    let isReadOnly v : obj = box (RecurrenceRangeControlProp.IsReadOnly v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RecurrenceRangeControl) (prop: RecurrenceRangeControlProp) =
        match prop with
        | RecurrenceRangeControlProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceRangeControl.RecurrenceInfoProperty, box v)
        | RecurrenceRangeControlProp.TimeZoneHelper v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceRangeControl.TimeZoneHelperProperty, box v)
        | RecurrenceRangeControlProp.Pattern v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceRangeControl.PatternProperty, box v)
        | RecurrenceRangeControlProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceRangeControl.IsReadOnlyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RecurrenceRangeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
