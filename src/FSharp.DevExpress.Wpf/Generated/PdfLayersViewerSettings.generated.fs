...
type PdfLayersViewerSettingsProp =
    | HideLayersViewer of bool
    | LayersViewerState of DevExpress.Xpf.PdfViewer.PdfLayersViewerState
    | LayersViewerInitialState of obj
    | LayersViewerStyle of System.Windows.Style
    | HideAfterUse of obj

module PdfLayersViewerSettings =
    let hideLayersViewer v : obj = box (PdfLayersViewerSettingsProp.HideLayersViewer v)
    let layersViewerState v : obj = box (PdfLayersViewerSettingsProp.LayersViewerState v)
    let layersViewerInitialState v : obj = box (PdfLayersViewerSettingsProp.LayersViewerInitialState v)
    let layersViewerStyle v : obj = box (PdfLayersViewerSettingsProp.LayersViewerStyle v)
    let hideAfterUse v : obj = box (PdfLayersViewerSettingsProp.HideAfterUse v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings) (prop: PdfLayersViewerSettingsProp) =
        match prop with
        | PdfLayersViewerSettingsProp.HideLayersViewer v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings.HideLayersViewerProperty, box v)
        | PdfLayersViewerSettingsProp.LayersViewerState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings.LayersViewerStateProperty, box v)
        | PdfLayersViewerSettingsProp.LayersViewerInitialState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings.LayersViewerInitialStateProperty, box v)
        | PdfLayersViewerSettingsProp.LayersViewerStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings.LayersViewerStyleProperty, box v)
        | PdfLayersViewerSettingsProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings.HideAfterUseProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfLayersViewerSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
