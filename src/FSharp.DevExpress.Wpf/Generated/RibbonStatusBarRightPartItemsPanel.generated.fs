...
type RibbonStatusBarRightPartItemsPanelProp =
    | Base of RibbonItemsPanelBaseProp

module RibbonStatusBarRightPartItemsPanel =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonStatusBarRightPartItemsPanel) (prop: RibbonStatusBarRightPartItemsPanelProp) =
        match prop with
        | RibbonStatusBarRightPartItemsPanelProp.Base p -> RibbonItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonStatusBarRightPartItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
