...
type LineMarkerRenderControlProp =
    | Base of MarkerRenderControlBaseProp

module LineMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.LineMarkerRenderControl) (prop: LineMarkerRenderControlProp) =
        match prop with
        | LineMarkerRenderControlProp.Base p -> MarkerRenderControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LineMarkerRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
