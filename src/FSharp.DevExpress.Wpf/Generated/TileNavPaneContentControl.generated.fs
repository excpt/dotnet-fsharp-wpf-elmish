...
type TileNavPaneContentControlProp =
    | Base of veContentControlProp

module TileNavPaneContentControl =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileNavPaneContentControl) (prop: TileNavPaneContentControlProp) =
        match prop with
        | TileNavPaneContentControlProp.Base p -> veContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileNavPaneContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
