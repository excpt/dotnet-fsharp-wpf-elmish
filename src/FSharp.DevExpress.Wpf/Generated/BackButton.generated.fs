...
module BackButton =
    ...
    let apply (el: DevExpress.Xpf.WindowsUI.Internal.BackButton) (prop: BackButtonProp) =
        match prop with
        | BackButtonProp.Base p -> CommandButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.BackButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
