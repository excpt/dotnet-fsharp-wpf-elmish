...
type EntityPLinqInstantFeedbackDataSourceProp =
    | Base of PLinqInstantFeedbackDataSourceBaseProp

module EntityPLinqInstantFeedbackDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.EntityPLinqInstantFeedbackDataSource) (prop: EntityPLinqInstantFeedbackDataSourceProp) =
        match prop with
        | EntityPLinqInstantFeedbackDataSourceProp.Base p -> PLinqInstantFeedbackDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.EntityPLinqInstantFeedbackDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
