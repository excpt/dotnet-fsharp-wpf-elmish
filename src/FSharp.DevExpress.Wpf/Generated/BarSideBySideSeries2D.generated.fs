...
type BarSideBySideSeries2DProp =
    | Base of BarSeries2DProp

module BarSideBySideSeries2D =

    let apply (el: DevExpress.Xpf.Charts.BarSideBySideSeries2D) (prop: BarSideBySideSeries2DProp) =
        match prop with
        | BarSideBySideSeries2DProp.Base p -> BarSeries2D.apply el p
    ...
    let labelPosition (v: DevExpress.Xpf.Charts.Bar2DLabelPosition) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BarSideBySideSeries2D.LabelPositionProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.BarSideBySideSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
