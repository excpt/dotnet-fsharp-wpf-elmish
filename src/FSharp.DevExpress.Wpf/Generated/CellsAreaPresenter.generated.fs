...
type CellsAreaPresenterProp =
    | Base of ScrollableAreaPresenterProp
    | RowsLeft of int
    | RowsLeftOffset of float
    | OnLeftTopChanged of System.Windows.RoutedEventHandler

module CellsAreaPresenter =
    ...
    let apply (el: DevExpress.Xpf.PivotGrid.Internal.CellsAreaPresenter) (prop: CellsAreaPresenterProp) =
        match prop with
        | CellsAreaPresenterProp.Base p -> ScrollableAreaPresenter.apply el p
        | CellsAreaPresenterProp.RowsLeft v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.CellsAreaPresenter.RowsLeftProperty, box v)
        | CellsAreaPresenterProp.RowsLeftOffset v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.CellsAreaPresenter.RowsLeftOffsetProperty, box v)
        | CellsAreaPresenterProp.OnLeftTopChanged h -> el.LeftTopChanged.AddHandler(h)
