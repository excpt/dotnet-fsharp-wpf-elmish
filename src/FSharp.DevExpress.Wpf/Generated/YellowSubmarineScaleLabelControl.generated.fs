...
type YellowSubmarineScaleLabelControlProp =
    | Base of PresentationControlProp

module YellowSubmarineScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineScaleLabelControl) (prop: YellowSubmarineScaleLabelControlProp) =
        match prop with
        | YellowSubmarineScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
