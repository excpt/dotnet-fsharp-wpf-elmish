...
type MarkerSeries3DProp =
    | Base of XYSeries3DProp
    | Model of DevExpress.Xpf.Charts.Marker3DModel

module MarkerSeries3D =
    let model v : obj = box (MarkerSeries3DProp.Model v)

    let apply (el: DevExpress.Xpf.Charts.MarkerSeries3D) (prop: MarkerSeries3DProp) =
        match prop with
        | MarkerSeries3DProp.Base p -> XYSeries3D.apply el p
        | MarkerSeries3DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.MarkerSeries3D.ModelProperty, box v)
    ...
    let labelPosition (v: DevExpress.Xpf.Charts.Marker3DLabelPosition) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.MarkerSeries3D.LabelPositionProperty, box v)) :: node.Props }
    let transform (v: System.Windows.Media.Media3D.Transform3D) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.MarkerSeries3D.TransformProperty, box v)) :: node.Props }
