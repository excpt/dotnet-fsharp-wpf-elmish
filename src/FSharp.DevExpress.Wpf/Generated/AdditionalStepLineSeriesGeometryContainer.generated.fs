...
type AdditionalStepLineSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalStepLineSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStepLineSeriesGeometryContainer) (prop: AdditionalStepLineSeriesGeometryContainerProp) =
        match prop with
        | AdditionalStepLineSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStepLineSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
