...
type YellowSubmarineGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineGaugeBackgroundLayerControl) (prop: YellowSubmarineGaugeBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
