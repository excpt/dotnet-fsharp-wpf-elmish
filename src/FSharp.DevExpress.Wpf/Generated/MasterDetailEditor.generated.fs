...
type MasterDetailEditorProp =
    | MasterDetailEditorViewModel of DevExpress.Xpf.DataAccess.Native.Editors.IMasterDetailEditorViewModel
    | View of DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditorViewBase
    | UseLegacyMasterDetailEditor of bool

module MasterDetailEditor =
    let masterDetailEditorViewModel v : obj = box (MasterDetailEditorProp.MasterDetailEditorViewModel v)
    let view v : obj = box (MasterDetailEditorProp.View v)
    let useLegacyMasterDetailEditor v : obj = box (MasterDetailEditorProp.UseLegacyMasterDetailEditor v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditor) (prop: MasterDetailEditorProp) =
        match prop with
        | MasterDetailEditorProp.MasterDetailEditorViewModel v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditor.MasterDetailEditorViewModelProperty, box v)
        | MasterDetailEditorProp.View v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditor.ViewProperty, box v)
        | MasterDetailEditorProp.UseLegacyMasterDetailEditor v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditor.UseLegacyMasterDetailEditorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
