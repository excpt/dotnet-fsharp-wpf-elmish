...
type CircularThemeableHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularThemeableHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularThemeableHalfTopModel) (prop: CircularThemeableHalfTopModelProp) =
        match prop with
        | CircularThemeableHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularThemeableHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
