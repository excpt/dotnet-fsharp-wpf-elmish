...
type DXWindowBackgroundPanelProp =
    | Base of BackgroundPanelProp

module DXWindowBackgroundPanel =

    let apply (el: DevExpress.Xpf.Core.DXWindowBackgroundPanel) (prop: DXWindowBackgroundPanelProp) =
        match prop with
        | DXWindowBackgroundPanelProp.Base p -> BackgroundPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DXWindowBackgroundPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
