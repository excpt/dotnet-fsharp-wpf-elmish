...
type VerticalAnimationElementProp =
    | Base of AnimationElementBaseProp

module VerticalAnimationElement =

    let apply (el: DevExpress.Xpf.Editors.VerticalAnimationElement) (prop: VerticalAnimationElementProp) =
        match prop with
        | VerticalAnimationElementProp.Base p -> AnimationElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.VerticalAnimationElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
