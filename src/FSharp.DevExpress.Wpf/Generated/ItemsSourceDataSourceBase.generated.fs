...
type ItemsSourceDataSourceBaseProp =
    | Base of SimpleDataSourceBaseProp
    | ItemsSource of System.Collections.IEnumerable

module ItemsSourceDataSourceBase =
    let itemsSource v : obj = box (ItemsSourceDataSourceBaseProp.ItemsSource v)

    let apply (el: DevExpress.Xpf.Core.DataSources.ItemsSourceDataSourceBase) (prop: ItemsSourceDataSourceBaseProp) =
        match prop with
        | ItemsSourceDataSourceBaseProp.Base p -> SimpleDataSourceBase.apply el p
        | ItemsSourceDataSourceBaseProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ItemsSourceDataSourceBase.ItemsSourceProperty, box v)
