...
type FlatLightMajorTickmarkControlProp =
    | Base of PresentationControlProp

module FlatLightMajorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightMajorTickmarkControl) (prop: FlatLightMajorTickmarkControlProp) =
        match prop with
        | FlatLightMajorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightMajorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
