...
type EntityCollectionViewSourceProp =
    | Base of CollectionViewDataSourceBaseProp

module EntityCollectionViewSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.EntityCollectionViewSource) (prop: EntityCollectionViewSourceProp) =
        match prop with
        | EntityCollectionViewSourceProp.Base p -> CollectionViewDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.EntityCollectionViewSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
