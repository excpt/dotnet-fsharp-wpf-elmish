...
type VisualDraggedAppointmentControlProp =
    | Base of VisualAppointmentControlProp

module VisualDraggedAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDraggedAppointmentControl) (prop: VisualDraggedAppointmentControlProp) =
        match prop with
        | VisualDraggedAppointmentControlProp.Base p -> VisualAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDraggedAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
