...
type PivotTableStyleGalleryItemProp =
    | Base of TableStyleGalleryItemProp

module PivotTableStyleGalleryItem =

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.PivotTableStyleGalleryItem) (prop: PivotTableStyleGalleryItemProp) =
        match prop with
        | PivotTableStyleGalleryItemProp.Base p -> TableStyleGalleryItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.PivotTableStyleGalleryItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
