...
type ClassicDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicDigitalGaugeBackgroundLayerControl) (prop: ClassicDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | ClassicDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
