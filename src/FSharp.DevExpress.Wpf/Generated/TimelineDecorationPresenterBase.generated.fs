...
type TimelineDecorationPresenterBaseProp =
    | ViewportInterval of DevExpress.Mvvm.DateTimeRange
    | Zoom of System.TimeSpan
    | ContainerViewModel of DevExpress.Xpf.Scheduling.VisualData.TimelineCellContainerViewModelBase
    | Scale of DevExpress.Xpf.Scheduling.ITimeScale

module TimelineDecorationPresenterBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineDecorationPresenterBase) (prop: TimelineDecorationPresenterBaseProp) =
        match prop with
        | TimelineDecorationPresenterBaseProp.ViewportInterval v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineDecorationPresenterBase.ViewportIntervalProperty, box v)
        | TimelineDecorationPresenterBaseProp.Zoom v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineDecorationPresenterBase.ZoomProperty, box v)
        | TimelineDecorationPresenterBaseProp.ContainerViewModel v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineDecorationPresenterBase.ContainerViewModelProperty, box v)
        | TimelineDecorationPresenterBaseProp.Scale v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineDecorationPresenterBase.ScaleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineDecorationPresenterBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
