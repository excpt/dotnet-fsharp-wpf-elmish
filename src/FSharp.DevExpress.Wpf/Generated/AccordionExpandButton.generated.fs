...
type AccordionExpandButtonProp =
    | ItemState of DevExpress.Xpf.Accordion.AccordionItemState
    | ItemType of DevExpress.Xpf.Accordion.AccordionItemType
    | IsRightExpandButton of bool

module AccordionExpandButton =
    let itemState v : obj = box (AccordionExpandButtonProp.ItemState v)
    let itemType v : obj = box (AccordionExpandButtonProp.ItemType v)
    let isRightExpandButton v : obj = box (AccordionExpandButtonProp.IsRightExpandButton v)

    let apply (el: DevExpress.Xpf.Accordion.AccordionExpandButton) (prop: AccordionExpandButtonProp) =
        match prop with
        | AccordionExpandButtonProp.ItemState v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionExpandButton.ItemStateProperty, box v)
        | AccordionExpandButtonProp.ItemType v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionExpandButton.ItemTypeProperty, box v)
        | AccordionExpandButtonProp.IsRightExpandButton v -> el.SetValue(DevExpress.Xpf.Accordion.AccordionExpandButton.IsRightExpandButtonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.AccordionExpandButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
