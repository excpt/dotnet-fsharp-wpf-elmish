...
type DefaultQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultQuarterTopRightArcScaleBackgroundLayerControl) (prop: DefaultQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | DefaultQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
