...
type CircularFlatDarkQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatDarkQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatDarkQuarterTopLeftModel) (prop: CircularFlatDarkQuarterTopLeftModelProp) =
        match prop with
        | CircularFlatDarkQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatDarkQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
