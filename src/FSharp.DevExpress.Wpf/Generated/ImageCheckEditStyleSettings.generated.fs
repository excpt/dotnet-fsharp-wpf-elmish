...
type ImageCheckEditStyleSettingsProp =
    | Base of CheckEditStyleSettingsBaseProp

module ImageCheckEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.ImageCheckEditStyleSettings) (prop: ImageCheckEditStyleSettingsProp) =
        match prop with
        | ImageCheckEditStyleSettingsProp.Base p -> CheckEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageCheckEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
