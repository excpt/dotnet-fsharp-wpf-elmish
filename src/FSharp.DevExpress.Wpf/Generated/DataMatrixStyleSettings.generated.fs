...
type DataMatrixStyleSettingsProp =
    | CompactionMode of DevExpress.XtraPrinting.BarCode.DataMatrixCompactionMode
    | MatrixSize of DevExpress.XtraPrinting.BarCode.DataMatrixSize

module DataMatrixStyleSettings =
    let compactionMode v : obj = box (DataMatrixStyleSettingsProp.CompactionMode v)
    let matrixSize v : obj = box (DataMatrixStyleSettingsProp.MatrixSize v)

    let apply (el: DevExpress.Xpf.Editors.DataMatrixStyleSettings) (prop: DataMatrixStyleSettingsProp) =
        match prop with
        | DataMatrixStyleSettingsProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.DataMatrixStyleSettings.CompactionModeProperty, box v)
        | DataMatrixStyleSettingsProp.MatrixSize v -> el.SetValue(DevExpress.Xpf.Editors.DataMatrixStyleSettings.MatrixSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DataMatrixStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
