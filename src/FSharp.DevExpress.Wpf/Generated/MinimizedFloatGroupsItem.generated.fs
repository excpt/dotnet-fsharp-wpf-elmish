...
type MinimizedFloatGroupsItemProp =
    | Base of psvContentControlProp
    | ActualLayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem

module MinimizedFloatGroupsItem =
    let actualLayoutItem v : obj = box (MinimizedFloatGroupsItemProp.ActualLayoutItem v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.MinimizedFloatGroupsItem) (prop: MinimizedFloatGroupsItemProp) =
        match prop with
        | MinimizedFloatGroupsItemProp.Base p -> psvContentControl.apply el p
        | MinimizedFloatGroupsItemProp.ActualLayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.MinimizedFloatGroupsItem.ActualLayoutItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.MinimizedFloatGroupsItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
