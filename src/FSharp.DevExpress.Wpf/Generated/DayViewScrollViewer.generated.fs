...
type DayViewScrollViewerProp =
    | Base of SchedulerScrollViewerProp
    | BottomOffset of float

module DayViewScrollViewer =
    let bottomOffset v : obj = box (DayViewScrollViewerProp.BottomOffset v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.DayViewScrollViewer) (prop: DayViewScrollViewerProp) =
        match prop with
        | DayViewScrollViewerProp.Base p -> SchedulerScrollViewer.apply el p
        | DayViewScrollViewerProp.BottomOffset v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.DayViewScrollViewer.BottomOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.DayViewScrollViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
