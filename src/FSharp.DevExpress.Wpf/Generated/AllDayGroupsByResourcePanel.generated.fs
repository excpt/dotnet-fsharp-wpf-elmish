...
type AllDayGroupsByResourcePanelProp =
    | Base of AllDayGroupsPanelProp

module AllDayGroupsByResourcePanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.AllDayGroupsByResourcePanel) (prop: AllDayGroupsByResourcePanelProp) =
        match prop with
        | AllDayGroupsByResourcePanelProp.Base p -> AllDayGroupsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.AllDayGroupsByResourcePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
