...
type SearchBarSubItemLinkControlProp =
    | Base of BarSubItemLinkControlProp

module SearchBarSubItemLinkControl =

    let apply (el: DevExpress.Xpf.DocumentViewer.SearchBarSubItemLinkControl) (prop: SearchBarSubItemLinkControlProp) =
        match prop with
        | SearchBarSubItemLinkControlProp.Base p -> BarSubItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DocumentViewer.SearchBarSubItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
