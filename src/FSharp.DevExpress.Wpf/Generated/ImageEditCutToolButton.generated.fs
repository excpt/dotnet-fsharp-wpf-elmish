...
type ImageEditCutToolButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditCutToolButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditCutToolButton) (prop: ImageEditCutToolButtonProp) =
        match prop with
        | ImageEditCutToolButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditCutToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
