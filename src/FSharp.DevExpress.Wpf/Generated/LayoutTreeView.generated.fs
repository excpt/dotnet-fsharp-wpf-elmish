...
type LayoutTreeViewProp =
    | Base of psvControlProp

module LayoutTreeView =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.LayoutTreeView) (prop: LayoutTreeViewProp) =
        match prop with
        | LayoutTreeViewProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.LayoutTreeView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
