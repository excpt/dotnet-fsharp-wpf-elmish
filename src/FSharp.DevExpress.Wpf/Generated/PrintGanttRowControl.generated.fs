...
type PrintGanttRowControlProp =
    | UserStyle of System.Windows.Style

module PrintGanttRowControl =
    let userStyle v : obj = box (PrintGanttRowControlProp.UserStyle v)

    let apply (el: DevExpress.Xpf.Gantt.PrintGanttRowControl) (prop: PrintGanttRowControlProp) =
        match prop with
        | PrintGanttRowControlProp.UserStyle v -> el.SetValue(DevExpress.Xpf.Gantt.PrintGanttRowControl.UserStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.PrintGanttRowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
