...
type BackstageViewHeaderPresenterProp =
    | LeftOffset of float
    | RightOffset of float
    | BackstageViewControl of DevExpress.Xpf.Ribbon.BackstageViewControl

module BackstageViewHeaderPresenter =
    let leftOffset v : obj = box (BackstageViewHeaderPresenterProp.LeftOffset v)
    let rightOffset v : obj = box (BackstageViewHeaderPresenterProp.RightOffset v)
    let backstageViewControl v : obj = box (BackstageViewHeaderPresenterProp.BackstageViewControl v)

    let apply (el: DevExpress.Xpf.Ribbon.Internal.BackstageViewHeaderPresenter) (prop: BackstageViewHeaderPresenterProp) =
        match prop with
        | BackstageViewHeaderPresenterProp.LeftOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.BackstageViewHeaderPresenter.LeftOffsetProperty, box v)
        | BackstageViewHeaderPresenterProp.RightOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.BackstageViewHeaderPresenter.RightOffsetProperty, box v)
        | BackstageViewHeaderPresenterProp.BackstageViewControl v -> el.SetValue(DevExpress.Xpf.Ribbon.Internal.BackstageViewHeaderPresenter.BackstageViewControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.Internal.BackstageViewHeaderPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
