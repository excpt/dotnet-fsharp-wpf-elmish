...
type DateTimeChartRangeControlClientProp =
    | Base of ChartRangeControlClientProp
    | SnapAlignment of DevExpress.Xpf.Charts.DateTimeMeasurementUnit
    | GridAlignment of DevExpress.Xpf.Charts.RangeControlClient.DateTimeGridAlignment

module DateTimeChartRangeControlClient =
    let snapAlignment v : obj = box (DateTimeChartRangeControlClientProp.SnapAlignment v)
    let gridAlignment v : obj = box (DateTimeChartRangeControlClientProp.GridAlignment v)

    let apply (el: DevExpress.Xpf.Charts.RangeControlClient.DateTimeChartRangeControlClient) (prop: DateTimeChartRangeControlClientProp) =
        match prop with
        | DateTimeChartRangeControlClientProp.Base p -> ChartRangeControlClient.apply el p
        | DateTimeChartRangeControlClientProp.SnapAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.DateTimeChartRangeControlClient.SnapAlignmentProperty, box v)
        | DateTimeChartRangeControlClientProp.GridAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.DateTimeChartRangeControlClient.GridAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RangeControlClient.DateTimeChartRangeControlClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
