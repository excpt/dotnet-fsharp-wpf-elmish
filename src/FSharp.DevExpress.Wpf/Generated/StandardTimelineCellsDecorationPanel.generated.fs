...
type StandardTimelineCellsDecorationPanelProp =
    | Base of CellsDecorationPanelProp
    | HorizontalViewport of float
    | HorizontalOffset of float
    | HorizontalExtent of float
    | View of DevExpress.Xpf.Scheduling.ViewBase

module StandardTimelineCellsDecorationPanel =
    let horizontalViewport v : obj = box (StandardTimelineCellsDecorationPanelProp.HorizontalViewport v)
    let horizontalOffset v : obj = box (StandardTimelineCellsDecorationPanelProp.HorizontalOffset v)
    let horizontalExtent v : obj = box (StandardTimelineCellsDecorationPanelProp.HorizontalExtent v)
    let view v : obj = box (StandardTimelineCellsDecorationPanelProp.View v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsDecorationPanel) (prop: StandardTimelineCellsDecorationPanelProp) =
        match prop with
        | StandardTimelineCellsDecorationPanelProp.Base p -> CellsDecorationPanel.apply el p
        | StandardTimelineCellsDecorationPanelProp.HorizontalViewport v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsDecorationPanel.HorizontalViewportProperty, box v)
        | StandardTimelineCellsDecorationPanelProp.HorizontalOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsDecorationPanel.HorizontalOffsetProperty, box v)
        | StandardTimelineCellsDecorationPanelProp.HorizontalExtent v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsDecorationPanel.HorizontalExtentProperty, box v)
        | StandardTimelineCellsDecorationPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsDecorationPanel.ViewProperty, box v)

    let allowAlternateDecoration v : obj = box (CellsDecorationPanelProp.AllowAlternateDecoration v)
    let horizontalBorderThickness v : obj = box (CellsDecorationPanelProp.HorizontalBorderThickness v)
    let borders v : obj = box (CellsDecorationPanelProp.Borders v)
    let verticalBorderThickness v : obj = box (CellsDecorationPanelProp.VerticalBorderThickness v)
    let selection v : obj = box (CellsDecorationPanelProp.Selection v)
    let stretchDirection v : obj = box (TimeRegionDecorationPanelBaseProp.StretchDirection v)
    let drawDefaultDecoration v : obj = box (TimeRegionDecorationPanelBaseProp.DrawDefaultDecoration v)
    let rowIndexOffset v : obj = box (TimeRegionPanelBaseProp.RowIndexOffset v)
    let columns v : obj = box (DecorationScrollPanelBaseProp.Columns v)
    let rows v : obj = box (DecorationScrollPanelBaseProp.Rows v)
    let itemMinSize v : obj = box (DecorationScrollPanelBaseProp.ItemMinSize v)
    let autoSize v : obj = box (DecorationScrollPanelBaseProp.AutoSize v)
    let autoSizeMaxViewPort v : obj = box (DecorationScrollPanelBaseProp.AutoSizeMaxViewPort v)
    let scrollOffset v : obj = box (DecorationScrollPanelBaseProp.ScrollOffset v)
    let allowScroll v : obj = box (DecorationScrollPanelBaseProp.AllowScroll v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.StandardTimelineCellsDecorationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
