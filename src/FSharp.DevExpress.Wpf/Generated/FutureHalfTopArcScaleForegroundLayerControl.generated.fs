...
type FutureHalfTopArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module FutureHalfTopArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureHalfTopArcScaleForegroundLayerControl) (prop: FutureHalfTopArcScaleForegroundLayerControlProp) =
        match prop with
        | FutureHalfTopArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureHalfTopArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
