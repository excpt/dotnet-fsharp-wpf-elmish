...
type MasterDetailEditorViewBaseProp =
    | ViewModel of DevExpress.Xpf.DataAccess.Native.Editors.IMasterDetailEditorViewModel

module MasterDetailEditorViewBase =
    let viewModel v : obj = box (MasterDetailEditorViewBaseProp.ViewModel v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditorViewBase) (prop: MasterDetailEditorViewBaseProp) =
        match prop with
        | MasterDetailEditorViewBaseProp.ViewModel v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditorViewBase.ViewModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailEditorViewBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
