...
type SimpleViewPageProp =
    | Base of RichEditViewPageProp

module SimpleViewPage =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.SimpleViewPage) (prop: SimpleViewPageProp) =
        match prop with
        | SimpleViewPageProp.Base p -> RichEditViewPage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.SimpleViewPage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
