...
type HamburgerSubMenuFlyoutControlProp =
    | Base of FlyoutAdornerControlProp

module HamburgerSubMenuFlyoutControl =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuFlyoutControl) (prop: HamburgerSubMenuFlyoutControlProp) =
        match prop with
        | HamburgerSubMenuFlyoutControlProp.Base p -> FlyoutAdornerControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuFlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
