...
type InplaceEditorBaseProp =
    | Base of DataContentPresenterProp

module InplaceEditorBase =

    let apply (el: DevExpress.Xpf.Editors.InplaceEditorBase) (prop: InplaceEditorBaseProp) =
        match prop with
        | InplaceEditorBaseProp.Base p -> DataContentPresenter.apply el p
