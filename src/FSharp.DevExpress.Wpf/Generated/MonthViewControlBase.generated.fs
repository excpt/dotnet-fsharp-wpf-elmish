...
type MonthViewControlBaseProp =
    | Base of SchedulerViewControlBaseProp
    | View of DevExpress.Xpf.Scheduling.MonthView
    | VisualData of DevExpress.Xpf.Scheduling.VisualData.MonthViewVisualDataBase
...
module MonthViewControlBase =
    let view v : obj = box (MonthViewControlBaseProp.View v)
    let visualData v : obj = box (MonthViewControlBaseProp.VisualData v)
    let borderTemplate v : obj = box (MonthViewControlBaseProp.BorderTemplate v)
    let groupSeparatorTemplate v : obj = box (MonthViewControlBaseProp.GroupSeparatorTemplate v)
    let dateHeaderSeparatorTemplate v : obj = box (MonthViewControlBaseProp.DateHeaderSeparatorTemplate v)
    let resourceHeaderSeparatorTemplate v : obj = box (MonthViewControlBaseProp.ResourceHeaderSeparatorTemplate v)
    let appointmentsContainerStyle v : obj = box (MonthViewControlBaseProp.AppointmentsContainerStyle v)
    let dragAppointmentsContainerStyle v : obj = box (MonthViewControlBaseProp.DragAppointmentsContainerStyle v)
    let dateHeadersCornerTemplate v : obj = box (MonthViewControlBaseProp.DateHeadersCornerTemplate v)
    let resourceHeadersCornerTemplate v : obj = box (MonthViewControlBaseProp.ResourceHeadersCornerTemplate v)
    let resourceHeadersBottomCornerTemplate v : obj = box (MonthViewControlBaseProp.ResourceHeadersBottomCornerTemplate v)
    let headerAreaSeparatorTemplate v : obj = box (MonthViewControlBaseProp.HeaderAreaSeparatorTemplate v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase) (prop: MonthViewControlBaseProp) =
        match prop with
        | MonthViewControlBaseProp.Base p -> SchedulerViewControlBase.apply el p
        | MonthViewControlBaseProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.ViewProperty, box v)
        | MonthViewControlBaseProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.VisualDataProperty, box v)
        | MonthViewControlBaseProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.BorderTemplateProperty, box v)
        | MonthViewControlBaseProp.GroupSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.GroupSeparatorTemplateProperty, box v)
        | MonthViewControlBaseProp.DateHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.DateHeaderSeparatorTemplateProperty, box v)
        | MonthViewControlBaseProp.ResourceHeaderSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.ResourceHeaderSeparatorTemplateProperty, box v)
        | MonthViewControlBaseProp.AppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.AppointmentsContainerStyleProperty, box v)
        | MonthViewControlBaseProp.DragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.DragAppointmentsContainerStyleProperty, box v)
        | MonthViewControlBaseProp.DateHeadersCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.DateHeadersCornerTemplateProperty, box v)
        | MonthViewControlBaseProp.ResourceHeadersCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.ResourceHeadersCornerTemplateProperty, box v)
        | MonthViewControlBaseProp.ResourceHeadersBottomCornerTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.ResourceHeadersBottomCornerTemplateProperty, box v)
        | MonthViewControlBaseProp.HeaderAreaSeparatorTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthViewControlBase.HeaderAreaSeparatorTemplateProperty, box v)
