...
type BarButtonItemLinkControlProp =
    | Base of BarItemLinkControlProp

module BarButtonItemLinkControl =

    let apply (el: DevExpress.Xpf.Bars.BarButtonItemLinkControl) (prop: BarButtonItemLinkControlProp) =
        match prop with
        | BarButtonItemLinkControlProp.Base p -> BarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarButtonItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
