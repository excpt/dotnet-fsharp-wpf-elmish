...
type AutoSuggestEditPropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp
    | HasItemTemplate of bool

module AutoSuggestEditPropertyProvider =
    let hasItemTemplate v : obj = box (AutoSuggestEditPropertyProviderProp.HasItemTemplate v)

    let apply (el: DevExpress.Xpf.Editors.AutoSuggestEditPropertyProvider) (prop: AutoSuggestEditPropertyProviderProp) =
        match prop with
        | AutoSuggestEditPropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
        | AutoSuggestEditPropertyProviderProp.HasItemTemplate v -> el.SetValue(DevExpress.Xpf.Editors.AutoSuggestEditPropertyProvider.HasItemTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.AutoSuggestEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
