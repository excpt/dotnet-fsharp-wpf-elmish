...
type PharmacodeStyleSettingsProp =
    | PharmacodeType of DevExpress.XtraPrinting.BarCode.PharmacodeType

module PharmacodeStyleSettings =
    let pharmacodeType v : obj = box (PharmacodeStyleSettingsProp.PharmacodeType v)

    let apply (el: DevExpress.Xpf.Editors.PharmacodeStyleSettings) (prop: PharmacodeStyleSettingsProp) =
        match prop with
        | PharmacodeStyleSettingsProp.PharmacodeType v -> el.SetValue(DevExpress.Xpf.Editors.PharmacodeStyleSettings.PharmacodeTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PharmacodeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
