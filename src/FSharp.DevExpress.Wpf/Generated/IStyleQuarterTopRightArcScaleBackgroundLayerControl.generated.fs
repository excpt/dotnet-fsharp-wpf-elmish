...
type IStyleQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleQuarterTopRightArcScaleBackgroundLayerControl) (prop: IStyleQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | IStyleQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
