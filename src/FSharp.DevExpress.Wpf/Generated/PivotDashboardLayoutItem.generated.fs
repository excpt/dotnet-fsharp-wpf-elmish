...
type PivotDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module PivotDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.PivotDashboardLayoutItem) (prop: PivotDashboardLayoutItemProp) =
        match prop with
        | PivotDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.PivotDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
