...
type TimeRegionPanelBaseProp =
    | Base of DecorationScrollPanelBaseProp
    | RowIndexOffset of int

module TimeRegionPanelBase =
    let rowIndexOffset v : obj = box (TimeRegionPanelBaseProp.RowIndexOffset v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimeRegionPanelBase) (prop: TimeRegionPanelBaseProp) =
        match prop with
        | TimeRegionPanelBaseProp.Base p -> DecorationScrollPanelBase.apply el p
        | TimeRegionPanelBaseProp.RowIndexOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeRegionPanelBase.RowIndexOffsetProperty, box v)
