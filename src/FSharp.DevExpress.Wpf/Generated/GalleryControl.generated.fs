...
type GalleryControlProp =
    | Gallery of DevExpress.Xpf.Bars.Gallery
    | PlacementTarget of DevExpress.Xpf.Bars.GalleryPlacementTarget
    | DefaultItemMargin of obj
    | DefaultItemDescriptionMargin of obj
    | DefaultItemGlyphMargin of obj
    | DefaultItemCaptionMargin of obj
    | DefaultGroupCaptionMargin of obj
    ...
    | HintTextStyle of System.Windows.Style
    | HintCaptionTextStyle of System.Windows.Style
    | DefaultIsGroupCaptionVisible of bool
    | DesiredRowCount of int
    | DesiredColCount of int
    | DefaultItemBorderTemplate of System.Windows.Controls.ControlTemplate
    | DefaultItemGlyphBorderTemplate of System.Windows.Controls.ControlTemplate
    | DefaultGroupItemsMargin of obj
    | DefaultItemControlTemplate of System.Windows.Controls.ControlTemplate
    | DefaultItemGlyphBorderPadding of obj
    | DefaultGroupCaptionControlTemplate of System.Windows.Controls.ControlTemplate
    | DefaultFilterControlTemplate of System.Windows.Controls.ControlTemplate
    | ActualVerticalOffset of float

module GalleryControl =
    let gallery v : obj = box (GalleryControlProp.Gallery v)
    let placementTarget v : obj = box (GalleryControlProp.PlacementTarget v)
    let defaultItemMargin v : obj = box (GalleryControlProp.DefaultItemMargin v)
    let defaultItemDescriptionMargin v : obj = box (GalleryControlProp.DefaultItemDescriptionMargin v)
    let defaultItemGlyphMargin v : obj = box (GalleryControlProp.DefaultItemGlyphMargin v)
    let defaultItemCaptionMargin v : obj = box (GalleryControlProp.DefaultItemCaptionMargin v)
    let defaultGroupCaptionMargin v : obj = box (GalleryControlProp.DefaultGroupCaptionMargin v)
    let itemCaptionTextStyle v : obj = box (GalleryControlProp.ItemCaptionTextStyle v)
    let itemCaptionTextStyleSelector v : obj = box (GalleryControlProp.ItemCaptionTextStyleSelector v)
    let itemDescriptionTextStyle v : obj = box (GalleryControlProp.ItemDescriptionTextStyle v)
    let itemDescriptionTextStyleSelector v : obj = box (GalleryControlProp.ItemDescriptionTextStyleSelector v)
    let groupCaptionTextStyle v : obj = box (GalleryControlProp.GroupCaptionTextStyle v)
    let normalFilterCaptionTextStyle v : obj = box (GalleryControlProp.NormalFilterCaptionTextStyle v)
    let selectedFilterCaptionTextStyle v : obj = box (GalleryControlProp.SelectedFilterCaptionTextStyle v)
    let hintTextStyle v : obj = box (GalleryControlProp.HintTextStyle v)
    let hintCaptionTextStyle v : obj = box (GalleryControlProp.HintCaptionTextStyle v)
    let defaultIsGroupCaptionVisible v : obj = box (GalleryControlProp.DefaultIsGroupCaptionVisible v)
    let desiredRowCount v : obj = box (GalleryControlProp.DesiredRowCount v)
    let desiredColCount v : obj = box (GalleryControlProp.DesiredColCount v)
    let defaultItemBorderTemplate v : obj = box (GalleryControlProp.DefaultItemBorderTemplate v)
    let defaultItemGlyphBorderTemplate v : obj = box (GalleryControlProp.DefaultItemGlyphBorderTemplate v)
    let defaultGroupItemsMargin v : obj = box (GalleryControlProp.DefaultGroupItemsMargin v)
    let defaultItemControlTemplate v : obj = box (GalleryControlProp.DefaultItemControlTemplate v)
    let defaultItemGlyphBorderPadding v : obj = box (GalleryControlProp.DefaultItemGlyphBorderPadding v)
    let defaultGroupCaptionControlTemplate v : obj = box (GalleryControlProp.DefaultGroupCaptionControlTemplate v)
    let defaultFilterControlTemplate v : obj = box (GalleryControlProp.DefaultFilterControlTemplate v)
    let actualVerticalOffset v : obj = box (GalleryControlProp.ActualVerticalOffset v)

    let apply (el: DevExpress.Xpf.Bars.GalleryControl) (prop: GalleryControlProp) =
        match prop with
        | GalleryControlProp.Gallery v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.GalleryProperty, box v)
        | GalleryControlProp.PlacementTarget v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.PlacementTargetProperty, box v)
        | GalleryControlProp.DefaultItemMargin v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemMarginProperty, box v)
        | GalleryControlProp.DefaultItemDescriptionMargin v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemDescriptionMarginProperty, box v)
        | GalleryControlProp.DefaultItemGlyphMargin v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemGlyphMarginProperty, box v)
        | GalleryControlProp.DefaultItemCaptionMargin v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemCaptionMarginProperty, box v)
        | GalleryControlProp.DefaultGroupCaptionMargin v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultGroupCaptionMarginProperty, box v)
        | GalleryControlProp.ItemCaptionTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.ItemCaptionTextStyleProperty, box v)
        | GalleryControlProp.ItemCaptionTextStyleSelector v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.ItemCaptionTextStyleSelectorProperty, box v)
        | GalleryControlProp.ItemDescriptionTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.ItemDescriptionTextStyleProperty, box v)
        | GalleryControlProp.ItemDescriptionTextStyleSelector v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.ItemDescriptionTextStyleSelectorProperty, box v)
        | GalleryControlProp.GroupCaptionTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.GroupCaptionTextStyleProperty, box v)
        | GalleryControlProp.NormalFilterCaptionTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.NormalFilterCaptionTextStyleProperty, box v)
        | GalleryControlProp.SelectedFilterCaptionTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.SelectedFilterCaptionTextStyleProperty, box v)
        | GalleryControlProp.HintTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.HintTextStyleProperty, box v)
        | GalleryControlProp.HintCaptionTextStyle v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.HintCaptionTextStyleProperty, box v)
        | GalleryControlProp.DefaultIsGroupCaptionVisible v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultIsGroupCaptionVisibleProperty, box v)
        | GalleryControlProp.DesiredRowCount v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DesiredRowCountProperty, box v)
        | GalleryControlProp.DesiredColCount v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DesiredColCountProperty, box v)
        | GalleryControlProp.DefaultItemBorderTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemBorderTemplateProperty, box v)
        | GalleryControlProp.DefaultItemGlyphBorderTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemGlyphBorderTemplateProperty, box v)
        | GalleryControlProp.DefaultGroupItemsMargin v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultGroupItemsMarginProperty, box v)
        | GalleryControlProp.DefaultItemControlTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemControlTemplateProperty, box v)
        | GalleryControlProp.DefaultItemGlyphBorderPadding v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultItemGlyphBorderPaddingProperty, box v)
        | GalleryControlProp.DefaultGroupCaptionControlTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultGroupCaptionControlTemplateProperty, box v)
        | GalleryControlProp.DefaultFilterControlTemplate v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.DefaultFilterControlTemplateProperty, box v)
        | GalleryControlProp.ActualVerticalOffset v -> el.SetValue(DevExpress.Xpf.Bars.GalleryControl.ActualVerticalOffsetProperty, box v)
    ...
    let galleryControl (v: DevExpress.Xpf.Bars.GalleryControl) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Bars.GalleryControl.GalleryControlProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Bars.GalleryControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
