...
type IStyleArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module IStyleArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleArcScaleMarkerControl) (prop: IStyleArcScaleMarkerControlProp) =
        match prop with
        | IStyleArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
