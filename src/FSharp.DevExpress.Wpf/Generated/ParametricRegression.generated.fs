...
type ParametricRegressionProp =
    | Base of IndicatorProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel

module ParametricRegression =
    let valueLevel v : obj = box (ParametricRegressionProp.ValueLevel v)

    let apply (el: DevExpress.Xpf.Charts.ParametricRegression) (prop: ParametricRegressionProp) =
        match prop with
        | ParametricRegressionProp.Base p -> Indicator.apply el p
        | ParametricRegressionProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.ParametricRegression.ValueLevelProperty, box v)
