...
type FlatPie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module FlatPie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatPie2DModelControl) (prop: FlatPie2DModelControlProp) =
        match prop with
        | FlatPie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatPie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
