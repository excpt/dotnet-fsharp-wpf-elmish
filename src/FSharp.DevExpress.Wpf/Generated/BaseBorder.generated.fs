...
type BaseBorderProp =
    | DefaultCornerRadius of System.Windows.CornerRadius
    | DefaultMargin of System.Windows.Thickness
    | NoBorderMargin of System.Windows.Thickness
    | DefaultBorderThickness of System.Windows.Thickness
    | HasTopBorder of bool
    | HasBottomBorder of bool
    | HasLeftBorder of bool
    | HasRightBorder of bool
    | IsSelected of bool

module BaseBorder =
    let defaultCornerRadius v : obj = box (BaseBorderProp.DefaultCornerRadius v)
    let defaultMargin v : obj = box (BaseBorderProp.DefaultMargin v)
    let noBorderMargin v : obj = box (BaseBorderProp.NoBorderMargin v)
    let defaultBorderThickness v : obj = box (BaseBorderProp.DefaultBorderThickness v)
    let hasTopBorder v : obj = box (BaseBorderProp.HasTopBorder v)
    let hasBottomBorder v : obj = box (BaseBorderProp.HasBottomBorder v)
    let hasLeftBorder v : obj = box (BaseBorderProp.HasLeftBorder v)
    let hasRightBorder v : obj = box (BaseBorderProp.HasRightBorder v)
    let isSelected v : obj = box (BaseBorderProp.IsSelected v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.BaseBorder) (prop: BaseBorderProp) =
        match prop with
        | BaseBorderProp.DefaultCornerRadius v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.DefaultCornerRadiusProperty, box v)
        | BaseBorderProp.DefaultMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.DefaultMarginProperty, box v)
        | BaseBorderProp.NoBorderMargin v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.NoBorderMarginProperty, box v)
        | BaseBorderProp.DefaultBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.DefaultBorderThicknessProperty, box v)
        | BaseBorderProp.HasTopBorder v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.HasTopBorderProperty, box v)
        | BaseBorderProp.HasBottomBorder v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.HasBottomBorderProperty, box v)
        | BaseBorderProp.HasLeftBorder v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.HasLeftBorderProperty, box v)
        | BaseBorderProp.HasRightBorder v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.HasRightBorderProperty, box v)
        | BaseBorderProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.BaseBorder.IsSelectedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.BaseBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
