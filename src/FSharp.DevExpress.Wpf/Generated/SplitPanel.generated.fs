...
module SplitPanel =
    let childSpacing v : obj = box (SplitPanelProp.ChildSpacing v)
    let orientation v : obj = box (SplitPanelProp.Orientation v)

    let apply (el: DevExpress.DashboardWpf.Internal.SplitPanel) (prop: SplitPanelProp) =
        match prop with
        | SplitPanelProp.Base p -> PanelBase.apply el p
        | SplitPanelProp.ChildSpacing v -> el.SetValue(DevExpress.DashboardWpf.Internal.SplitPanel.ChildSpacingProperty, box v)
        | SplitPanelProp.Orientation v -> el.SetValue(DevExpress.DashboardWpf.Internal.SplitPanel.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.SplitPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
