...
type SearchControlColumnProviderProp =
    | HiddenProperties of DevExpress.Xpf.Editors.Filtering.PropertyNameCollection
    | UpperCaseNames of obj
    | AdditionalProperties of DevExpress.Xpf.Editors.Filtering.PropertyInfoCollection
    | ItemsSourceType of System.Type
    | SourceControl of DevExpress.Xpf.Editors.Filtering.IFilteredComponent

module SearchControlColumnProvider =
    let hiddenProperties v : obj = box (SearchControlColumnProviderProp.HiddenProperties v)
    let upperCaseNames v : obj = box (SearchControlColumnProviderProp.UpperCaseNames v)
    let additionalProperties v : obj = box (SearchControlColumnProviderProp.AdditionalProperties v)
    let itemsSourceType v : obj = box (SearchControlColumnProviderProp.ItemsSourceType v)
    let sourceControl v : obj = box (SearchControlColumnProviderProp.SourceControl v)

    let apply (el: DevExpress.Xpf.Editors.SearchControlColumnProvider) (prop: SearchControlColumnProviderProp) =
        match prop with
        | SearchControlColumnProviderProp.HiddenProperties v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlColumnProvider.HiddenPropertiesProperty, box v)
        | SearchControlColumnProviderProp.UpperCaseNames v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlColumnProvider.UpperCasePropertyNamesProperty, box v)
        | SearchControlColumnProviderProp.AdditionalProperties v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlColumnProvider.AdditionalPropertiesProperty, box v)
        | SearchControlColumnProviderProp.ItemsSourceType v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlColumnProvider.ItemsSourceTypeProperty, box v)
        | SearchControlColumnProviderProp.SourceControl v -> el.SetValue(DevExpress.Xpf.Editors.SearchControlColumnProvider.SourceControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SearchControlColumnProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
