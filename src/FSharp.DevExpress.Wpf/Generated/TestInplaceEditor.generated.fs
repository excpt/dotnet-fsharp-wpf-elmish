...
open System
open System.Windows
open DevExpress.Xpf.Editors.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TestInplaceEditorProp =
    | Base of InplaceEditorBaseProp
    | IsEditorFocused of bool

module TestInplaceEditor =
    let isEditorFocused v : obj = box (TestInplaceEditorProp.IsEditorFocused v)

    let apply (el: DevExpress.Xpf.Editors.Native.TestInplaceEditor) (prop: TestInplaceEditorProp) =
        match prop with
        | TestInplaceEditorProp.Base p -> InplaceEditorBase.apply el p
        | TestInplaceEditorProp.IsEditorFocused v -> el.SetValue(DevExpress.Xpf.Editors.Native.TestInplaceEditor.IsEditorFocusedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Native.TestInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
