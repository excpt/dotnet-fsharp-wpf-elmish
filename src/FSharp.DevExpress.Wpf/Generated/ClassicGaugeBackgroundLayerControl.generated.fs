...
type ClassicGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicGaugeBackgroundLayerControl) (prop: ClassicGaugeBackgroundLayerControlProp) =
        match prop with
        | ClassicGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
