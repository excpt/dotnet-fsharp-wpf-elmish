...
type PopupMenuProp =
    | Base of PopupMenuBaseProp
    | GlyphSize of DevExpress.Xpf.Bars.GlyphSize
    | CustomGlyphSize of System.Windows.Size
    | ItemLinksSource of System.Collections.IEnumerable
...
module PopupMenu =
    ...
    let apply (el: DevExpress.Xpf.Bars.PopupMenu) (prop: PopupMenuProp) =
        match prop with
        | PopupMenuProp.Base p -> PopupMenuBase.apply el p
        | PopupMenuProp.GlyphSize v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.GlyphSizeProperty, box v)
        | PopupMenuProp.CustomGlyphSize v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.CustomGlyphSizeProperty, box v)
        | PopupMenuProp.ItemLinksSource v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ItemLinksSourceProperty, box v)
        | PopupMenuProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ItemTemplateProperty, box v)
        | PopupMenuProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ItemStyleProperty, box v)
        | PopupMenuProp.ItemStyleSelector v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ItemStyleSelectorProperty, box v)
        | PopupMenuProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ItemTemplateSelectorProperty, box v)
        | PopupMenuProp.ShowKeyGestures v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ShowKeyGesturesProperty, box v)
        | PopupMenuProp.ItemLinksSourceElementGeneratesUniqueBarItem v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenu.ItemLinksSourceElementGeneratesUniqueBarItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
