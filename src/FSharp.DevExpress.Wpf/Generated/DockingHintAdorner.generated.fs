...
type DockingHintAdornerProp =
    | Base of DockingHintAdornerBaseProp

module DockingHintAdorner =

    let apply (el: DevExpress.Xpf.Docking.Platform.DockingHintAdorner) (prop: DockingHintAdornerProp) =
        match prop with
        | DockingHintAdornerProp.Base p -> DockingHintAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.DockingHintAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
