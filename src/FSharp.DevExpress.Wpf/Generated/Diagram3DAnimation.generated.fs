...
type Diagram3DAnimationProp =
    | Base of ChartAnimationProp
    | InitialPerspectiveAngle of float
    | InitialZoomPercent of float
    | InitialVerticalScrollPercent of float
    | InitialHorizontalScrollPercent of float
    | InitialRotation of DevExpress.Xpf.Charts.AnimationRotation

module Diagram3DAnimation =
    let initialPerspectiveAngle v : obj = box (Diagram3DAnimationProp.InitialPerspectiveAngle v)
    let initialZoomPercent v : obj = box (Diagram3DAnimationProp.InitialZoomPercent v)
    let initialVerticalScrollPercent v : obj = box (Diagram3DAnimationProp.InitialVerticalScrollPercent v)
    let initialHorizontalScrollPercent v : obj = box (Diagram3DAnimationProp.InitialHorizontalScrollPercent v)
    let initialRotation v : obj = box (Diagram3DAnimationProp.InitialRotation v)

    let apply (el: DevExpress.Xpf.Charts.Diagram3DAnimation) (prop: Diagram3DAnimationProp) =
        match prop with
        | Diagram3DAnimationProp.Base p -> ChartAnimation.apply el p
        | Diagram3DAnimationProp.InitialPerspectiveAngle v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DAnimation.InitialPerspectiveAngleProperty, box v)
        | Diagram3DAnimationProp.InitialZoomPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DAnimation.InitialZoomPercentProperty, box v)
        | Diagram3DAnimationProp.InitialVerticalScrollPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DAnimation.InitialVerticalScrollPercentProperty, box v)
        | Diagram3DAnimationProp.InitialHorizontalScrollPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DAnimation.InitialHorizontalScrollPercentProperty, box v)
        | Diagram3DAnimationProp.InitialRotation v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DAnimation.InitialRotationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Diagram3DAnimation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
