...
type CircularFlatDarkThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatDarkThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatDarkThreeQuartersModel) (prop: CircularFlatDarkThreeQuartersModelProp) =
        match prop with
        | CircularFlatDarkThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatDarkThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
