...
type ProgressiveThreeQuartersArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveThreeQuartersArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveThreeQuartersArcScaleForegroundLayerControl) (prop: ProgressiveThreeQuartersArcScaleForegroundLayerControlProp) =
        match prop with
        | ProgressiveThreeQuartersArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveThreeQuartersArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
