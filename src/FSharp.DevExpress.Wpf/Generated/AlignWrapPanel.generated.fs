...
open System
open System.Windows
open DevExpress.Xpf.DataAccess.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type AlignWrapPanelProp =
    | HorizontalContentAlignment of System.Windows.HorizontalAlignment

module AlignWrapPanel =
    let horizontalContentAlignment v : obj = box (AlignWrapPanelProp.HorizontalContentAlignment v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.AlignWrapPanel) (prop: AlignWrapPanelProp) =
        match prop with
        | AlignWrapPanelProp.HorizontalContentAlignment v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.AlignWrapPanel.HorizontalContentAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.AlignWrapPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
