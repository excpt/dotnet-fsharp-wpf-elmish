...
type SpreadsheetDefaultBarItemDataTemplatesProp =
    | MarginBarItemContentTemplate of System.Windows.DataTemplate
    | PaperKindBarItemContentTemplate of System.Windows.DataTemplate
    | ChartLayoutGalleryGroupTemplate of System.Windows.DataTemplate
    | ChartStylesGalleryGroupTemplate of System.Windows.DataTemplate
    | CheckEditTemplate of System.Windows.DataTemplate
    | StyleGalleryGroupTemplate of System.Windows.DataTemplate
    | CellStyleGalleryItemCaptionTemplate of System.Windows.DataTemplate
    | TableStyleGalleryItemCaptionTemplate of System.Windows.DataTemplate
    | PivotTableStyleGalleryItemCaptionTemplate of System.Windows.DataTemplate
    | StyleGalleryHintCaptionTemplate of System.Windows.DataTemplate

module SpreadsheetDefaultBarItemDataTemplates =
    let marginBarItemContentTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.MarginBarItemContentTemplate v)
    let paperKindBarItemContentTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.PaperKindBarItemContentTemplate v)
    let chartLayoutGalleryGroupTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.ChartLayoutGalleryGroupTemplate v)
    let chartStylesGalleryGroupTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.ChartStylesGalleryGroupTemplate v)
    let checkEditTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.CheckEditTemplate v)
    let styleGalleryGroupTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.StyleGalleryGroupTemplate v)
    let cellStyleGalleryItemCaptionTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.CellStyleGalleryItemCaptionTemplate v)
    let tableStyleGalleryItemCaptionTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.TableStyleGalleryItemCaptionTemplate v)
    let pivotTableStyleGalleryItemCaptionTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.PivotTableStyleGalleryItemCaptionTemplate v)
    let styleGalleryHintCaptionTemplate v : obj = box (SpreadsheetDefaultBarItemDataTemplatesProp.StyleGalleryHintCaptionTemplate v)

    let apply (el: DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates) (prop: SpreadsheetDefaultBarItemDataTemplatesProp) =
        match prop with
        | SpreadsheetDefaultBarItemDataTemplatesProp.MarginBarItemContentTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.MarginBarItemContentTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.PaperKindBarItemContentTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.PaperKindBarItemContentTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.ChartLayoutGalleryGroupTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.ChartLayoutGalleryGroupTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.ChartStylesGalleryGroupTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.ChartStylesGalleryGroupTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.CheckEditTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.CheckEditTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.StyleGalleryGroupTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.StyleGalleryGroupTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.CellStyleGalleryItemCaptionTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.CellStyleGalleryItemCaptionTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.TableStyleGalleryItemCaptionTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.TableStyleGalleryItemCaptionTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.PivotTableStyleGalleryItemCaptionTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.PivotTableStyleGalleryItemCaptionTemplateProperty, box v)
        | SpreadsheetDefaultBarItemDataTemplatesProp.StyleGalleryHintCaptionTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates.StyleGalleryHintCaptionTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.SpreadsheetDefaultBarItemDataTemplates>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
