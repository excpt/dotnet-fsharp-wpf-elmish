...
type DocRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module DocRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.DocRichEditDocumentSourceProvider) (prop: DocRichEditDocumentSourceProviderProp) =
        match prop with
        | DocRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.DocRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
