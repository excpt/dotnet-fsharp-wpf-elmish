...
type BarButtonGroupItemsPanelProp =
    | Base of RibbonItemsPanelBaseProp

module BarButtonGroupItemsPanel =

    let apply (el: DevExpress.Xpf.Ribbon.BarButtonGroupItemsPanel) (prop: BarButtonGroupItemsPanelProp) =
        match prop with
        | BarButtonGroupItemsPanelProp.Base p -> RibbonItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BarButtonGroupItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
