...
type CategoryDefinitionProp =
    | Base of PropertyDefinitionBaseProp
    | Glyph of System.Windows.Media.ImageSource
    | ColorizeGlyph of bool

module CategoryDefinition =
    let glyph v : obj = box (CategoryDefinitionProp.Glyph v)
    let colorizeGlyph v : obj = box (CategoryDefinitionProp.ColorizeGlyph v)

    let apply (el: DevExpress.Xpf.PropertyGrid.CategoryDefinition) (prop: CategoryDefinitionProp) =
        match prop with
        | CategoryDefinitionProp.Base p -> PropertyDefinitionBase.apply el p
        | CategoryDefinitionProp.Glyph v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CategoryDefinition.GlyphProperty, box v)
        | CategoryDefinitionProp.ColorizeGlyph v -> el.SetValue(DevExpress.Xpf.PropertyGrid.CategoryDefinition.ColorizeGlyphProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PropertyGrid.CategoryDefinition>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
