...
type LinearDefaultModelProp =
    | Base of LinearGaugeModelProp

module LinearDefaultModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearDefaultModel) (prop: LinearDefaultModelProp) =
        match prop with
        | LinearDefaultModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearDefaultModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
