...
type LayoutTransformPanelProp =
    | Clockwise of bool
    | Orientation of System.Windows.Controls.Orientation

module LayoutTransformPanel =
    ...
    let apply (el: DevExpress.Xpf.Core.LayoutTransformPanel) (prop: LayoutTransformPanelProp) =
        match prop with
        | LayoutTransformPanelProp.Clockwise v -> el.SetValue(DevExpress.Xpf.Core.LayoutTransformPanel.ClockwiseProperty, box v)
        | LayoutTransformPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Core.LayoutTransformPanel.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.LayoutTransformPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
