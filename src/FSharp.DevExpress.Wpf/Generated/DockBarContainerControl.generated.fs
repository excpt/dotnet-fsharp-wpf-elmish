...
type DockBarContainerControlProp =
    | Base of DockBarContainerControlBaseProp
    | BindableName of string
    | BindableAllowDrop of obj
    | LayoutItem of DevExpress.Xpf.Docking.BaseLayoutItem

module DockBarContainerControl =
    let bindableName v : obj = box (DockBarContainerControlProp.BindableName v)
    let bindableAllowDrop v : obj = box (DockBarContainerControlProp.BindableAllowDrop v)
    let layoutItem v : obj = box (DockBarContainerControlProp.LayoutItem v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockBarContainerControl) (prop: DockBarContainerControlProp) =
        match prop with
        | DockBarContainerControlProp.Base p -> DockBarContainerControlBase.apply el p
        | DockBarContainerControlProp.BindableName v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockBarContainerControl.BindableNameProperty, box v)
        | DockBarContainerControlProp.BindableAllowDrop v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockBarContainerControl.BindableAllowDropProperty, box v)
        | DockBarContainerControlProp.LayoutItem v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockBarContainerControl.LayoutItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockBarContainerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
