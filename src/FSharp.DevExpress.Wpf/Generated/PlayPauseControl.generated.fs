...
type PlayPauseControlProp =
    | Base of MediaToggleButtonProp

module PlayPauseControl =

    let apply (el: DevExpress.Xpf.Controls.PlayPauseControl) (prop: PlayPauseControlProp) =
        match prop with
        | PlayPauseControlProp.Base p -> MediaToggleButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.PlayPauseControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
