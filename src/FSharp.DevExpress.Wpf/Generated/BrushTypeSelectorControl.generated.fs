...
type BrushTypeSelectorControlProp =
    | BrushType of DevExpress.Xpf.Editors.BrushType

module BrushTypeSelectorControl =
    let brushType v : obj = box (BrushTypeSelectorControlProp.BrushType v)

    let apply (el: DevExpress.Xpf.Editors.BrushTypeSelectorControl) (prop: BrushTypeSelectorControlProp) =
        match prop with
        | BrushTypeSelectorControlProp.BrushType v -> el.SetValue(DevExpress.Xpf.Editors.BrushTypeSelectorControl.BrushTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BrushTypeSelectorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
