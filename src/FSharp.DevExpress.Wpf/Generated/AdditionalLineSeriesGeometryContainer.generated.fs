...
type AdditionalLineSeriesGeometryContainerProp =
    | Base of AdditionalSeriesPointGeometryContainerProp

module AdditionalLineSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalLineSeriesGeometryContainer) (prop: AdditionalLineSeriesGeometryContainerProp) =
        match prop with
        | AdditionalLineSeriesGeometryContainerProp.Base p -> AdditionalSeriesPointGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalLineSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
