...
type SteelColumnBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp
    | InnerTopBrush of System.Windows.Media.Brush
    | InnerBottomBrush of System.Windows.Media.Brush

module SteelColumnBar2DModelControl =
    let innerTopBrush v : obj = box (SteelColumnBar2DModelControlProp.InnerTopBrush v)
    let innerBottomBrush v : obj = box (SteelColumnBar2DModelControlProp.InnerBottomBrush v)

    let apply (el: DevExpress.Xpf.Charts.SteelColumnBar2DModelControl) (prop: SteelColumnBar2DModelControlProp) =
        match prop with
        | SteelColumnBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
        | SteelColumnBar2DModelControlProp.InnerTopBrush v -> el.SetValue(DevExpress.Xpf.Charts.SteelColumnBar2DModelControl.InnerTopBrushProperty, box v)
        | SteelColumnBar2DModelControlProp.InnerBottomBrush v -> el.SetValue(DevExpress.Xpf.Charts.SteelColumnBar2DModelControl.InnerBottomBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SteelColumnBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
