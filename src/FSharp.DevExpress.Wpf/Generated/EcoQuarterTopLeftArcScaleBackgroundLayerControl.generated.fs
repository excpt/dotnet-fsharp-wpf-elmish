...
type EcoQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoQuarterTopLeftArcScaleBackgroundLayerControl) (prop: EcoQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | EcoQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
