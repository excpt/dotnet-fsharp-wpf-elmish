...
module DataMatrixSymbology =
    let compactionMode v : obj = box (DataMatrixSymbologyProp.CompactionMode v)
    let matrixSize v : obj = box (DataMatrixSymbologyProp.MatrixSize v)

    let apply (el: DevExpress.Xpf.Controls.DataMatrixSymbology) (prop: DataMatrixSymbologyProp) =
        match prop with
        | DataMatrixSymbologyProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Controls.DataMatrixSymbology.CompactionModeProperty, box v)
        | DataMatrixSymbologyProp.MatrixSize v -> el.SetValue(DevExpress.Xpf.Controls.DataMatrixSymbology.MatrixSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.DataMatrixSymbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
