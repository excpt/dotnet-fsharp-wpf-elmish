...
type AutoHideTransformPanelProp =
    | Base of LayoutTransformPanelProp

module AutoHideTransformPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AutoHideTransformPanel) (prop: AutoHideTransformPanelProp) =
        match prop with
        | AutoHideTransformPanelProp.Base p -> LayoutTransformPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AutoHideTransformPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
