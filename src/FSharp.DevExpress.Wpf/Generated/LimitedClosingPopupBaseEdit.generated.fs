...
type LimitedClosingPopupBaseEditProp =
    | Base of PopupBaseEditProp

module LimitedClosingPopupBaseEdit =

    let apply (el: DevExpress.Xpf.Grid.LimitedClosingPopupBaseEdit) (prop: LimitedClosingPopupBaseEditProp) =
        match prop with
        | LimitedClosingPopupBaseEditProp.Base p -> PopupBaseEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.LimitedClosingPopupBaseEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
