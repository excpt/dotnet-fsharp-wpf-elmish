...
type SecondaryAxisY2DProp =
    | Base of AxisY2DProp

module SecondaryAxisY2D =

    let apply (el: DevExpress.Xpf.Charts.SecondaryAxisY2D) (prop: SecondaryAxisY2DProp) =
        match prop with
        | SecondaryAxisY2DProp.Base p -> AxisY2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SecondaryAxisY2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
