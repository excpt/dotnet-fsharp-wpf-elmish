...
type HamburgerMenuBottomBarItemsPanelProp =
    | Base of HamburgerMenuItemsPanelBaseProp

module HamburgerMenuBottomBarItemsPanel =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuBottomBarItemsPanel) (prop: HamburgerMenuBottomBarItemsPanelProp) =
        match prop with
        | HamburgerMenuBottomBarItemsPanelProp.Base p -> HamburgerMenuItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerMenuBottomBarItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
