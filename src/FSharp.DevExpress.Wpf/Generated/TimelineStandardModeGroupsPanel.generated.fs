...
type TimelineStandardModeGroupsPanelProp =
...
module TimelineStandardModeGroupsPanel =
    let view v : obj = box (TimelineStandardModeGroupsPanelProp.View v)
    let visualData v : obj = box (TimelineStandardModeGroupsPanelProp.VisualData v)
    let itemContainerAppointmentsContainerStyle v : obj = box (TimelineStandardModeGroupsPanelProp.ItemContainerAppointmentsContainerStyle v)
    let itemContainerDragAppointmentsContainerStyle v : obj = box (TimelineStandardModeGroupsPanelProp.ItemContainerDragAppointmentsContainerStyle v)
    let itemContainerVerticalBorderThickness v : obj = box (TimelineStandardModeGroupsPanelProp.ItemContainerVerticalBorderThickness v)
    let itemContainerHorizontalBorderThickness v : obj = box (TimelineStandardModeGroupsPanelProp.ItemContainerHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel) (prop: TimelineStandardModeGroupsPanelProp) =
        match prop with
        | TimelineStandardModeGroupsPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel.ViewProperty, box v)
        | TimelineStandardModeGroupsPanelProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel.VisualDataProperty, box v)
        | TimelineStandardModeGroupsPanelProp.ItemContainerAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel.ItemContainerAppointmentsContainerStyleProperty, box v)
        | TimelineStandardModeGroupsPanelProp.ItemContainerDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel.ItemContainerDragAppointmentsContainerStyleProperty, box v)
        | TimelineStandardModeGroupsPanelProp.ItemContainerVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel.ItemContainerVerticalBorderThicknessProperty, box v)
        | TimelineStandardModeGroupsPanelProp.ItemContainerHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel.ItemContainerHorizontalBorderThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
