...
type AppointmentWindowProp =
    | Base of ThemedWindowProp

module AppointmentWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentWindow) (prop: AppointmentWindowProp) =
        match prop with
        | AppointmentWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
