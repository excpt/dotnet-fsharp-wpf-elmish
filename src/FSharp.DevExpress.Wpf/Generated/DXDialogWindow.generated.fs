...
type DXDialogWindowProp =
    | Base of DXWindowProp
    | CommandButtonStyle of System.Windows.Style
    | CommandButtonsPanel of System.Windows.Controls.ItemsPanelTemplate
    | ActualDialogWindow of obj
    | CommandsSource of obj

module DXDialogWindow =
    let commandButtonStyle v : obj = box (DXDialogWindowProp.CommandButtonStyle v)
    let commandButtonsPanel v : obj = box (DXDialogWindowProp.CommandButtonsPanel v)
    let actualDialogWindow v : obj = box (DXDialogWindowProp.ActualDialogWindow v)
    let commandsSource v : obj = box (DXDialogWindowProp.CommandsSource v)

    let apply (el: DevExpress.Xpf.Core.DXDialogWindow) (prop: DXDialogWindowProp) =
        match prop with
        | DXDialogWindowProp.Base p -> DXWindow.apply el p
        | DXDialogWindowProp.CommandButtonStyle v -> el.SetValue(DevExpress.Xpf.Core.DXDialogWindow.CommandButtonStyleProperty, box v)
        | DXDialogWindowProp.CommandButtonsPanel v -> el.SetValue(DevExpress.Xpf.Core.DXDialogWindow.CommandButtonsPanelProperty, box v)
        | DXDialogWindowProp.ActualDialogWindow v -> el.SetValue(DevExpress.Xpf.Core.DXDialogWindow.ActualDialogWindowProperty, box v)
        | DXDialogWindowProp.CommandsSource v -> el.SetValue(DevExpress.Xpf.Core.DXDialogWindow.CommandsSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DXDialogWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
