...
type XPServerCollectionDataSourceProp =
    | Base of XPOSourceBaseWithSessionProp
    | DefaultSorting of string
    | DisplayableProperties of string
    | AllowEdit of bool
    | AllowNew of bool
    | AllowRemove of bool
    | DeleteObjectOnRemove of bool
    | FixedFilterCriteria of DevExpress.Data.Filtering.CriteriaOperator
    | FixedFilterString of string
    | TrackChanges of bool

module XPServerCollectionDataSource =
    let defaultSorting v : obj = box (XPServerCollectionDataSourceProp.DefaultSorting v)
    let displayableProperties v : obj = box (XPServerCollectionDataSourceProp.DisplayableProperties v)
    let allowEdit v : obj = box (XPServerCollectionDataSourceProp.AllowEdit v)
    let allowNew v : obj = box (XPServerCollectionDataSourceProp.AllowNew v)
    let allowRemove v : obj = box (XPServerCollectionDataSourceProp.AllowRemove v)
    let deleteObjectOnRemove v : obj = box (XPServerCollectionDataSourceProp.DeleteObjectOnRemove v)
    let fixedFilterCriteria v : obj = box (XPServerCollectionDataSourceProp.FixedFilterCriteria v)
    let fixedFilterString v : obj = box (XPServerCollectionDataSourceProp.FixedFilterString v)
    let trackChanges v : obj = box (XPServerCollectionDataSourceProp.TrackChanges v)

    let apply (el: DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource) (prop: XPServerCollectionDataSourceProp) =
        match prop with
        | XPServerCollectionDataSourceProp.Base p -> XPOSourceBaseWithSession.apply el p
        | XPServerCollectionDataSourceProp.DefaultSorting v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.DefaultSortingProperty, box v)
        | XPServerCollectionDataSourceProp.DisplayableProperties v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.DisplayablePropertiesProperty, box v)
        | XPServerCollectionDataSourceProp.AllowEdit v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.AllowEditProperty, box v)
        | XPServerCollectionDataSourceProp.AllowNew v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.AllowNewProperty, box v)
        | XPServerCollectionDataSourceProp.AllowRemove v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.AllowRemoveProperty, box v)
        | XPServerCollectionDataSourceProp.DeleteObjectOnRemove v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.DeleteObjectOnRemoveProperty, box v)
        | XPServerCollectionDataSourceProp.FixedFilterCriteria v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.FixedFilterCriteriaProperty, box v)
        | XPServerCollectionDataSourceProp.FixedFilterString v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.FixedFilterStringProperty, box v)
        | XPServerCollectionDataSourceProp.TrackChanges v -> el.SetValue(DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource.TrackChangesProperty, box v)

    let session v : obj = box (XPOSourceBaseWithSessionProp.Session v)
    let objectType v : obj = box (XPOSourceBaseProp.ObjectType v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.XPServerCollectionDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
