...
type AppointmentIntervalPresenterProp =
    | Space of float
...
module AppointmentIntervalPresenter =
    let space v : obj = box (AppointmentIntervalPresenterProp.Space v)
    let fontFamily v : obj = box (AppointmentIntervalPresenterProp.FontFamily v)
    let fontStyle v : obj = box (AppointmentIntervalPresenterProp.FontStyle v)
    let fontWeight v : obj = box (AppointmentIntervalPresenterProp.FontWeight v)
    let fontStretch v : obj = box (AppointmentIntervalPresenterProp.FontStretch v)
    let fontSize v : obj = box (AppointmentIntervalPresenterProp.FontSize v)
    let foreground v : obj = box (AppointmentIntervalPresenterProp.Foreground v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter) (prop: AppointmentIntervalPresenterProp) =
        match prop with
        | AppointmentIntervalPresenterProp.Space v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.SpaceProperty, box v)
        | AppointmentIntervalPresenterProp.FontFamily v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.FontFamilyProperty, box v)
        | AppointmentIntervalPresenterProp.FontStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.FontStyleProperty, box v)
        | AppointmentIntervalPresenterProp.FontWeight v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.FontWeightProperty, box v)
        | AppointmentIntervalPresenterProp.FontStretch v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.FontStretchProperty, box v)
        | AppointmentIntervalPresenterProp.FontSize v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.FontSizeProperty, box v)
        | AppointmentIntervalPresenterProp.Foreground v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentIntervalPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
