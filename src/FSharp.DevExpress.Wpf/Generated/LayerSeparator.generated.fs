...
type LayerSeparatorProp =
    | Base of ControlBaseProp
    | Thickness of float

module LayerSeparator =
    let thickness v : obj = box (LayerSeparatorProp.Thickness v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayerSeparator) (prop: LayerSeparatorProp) =
        match prop with
        | LayerSeparatorProp.Base p -> ControlBase.apply el p
        | LayerSeparatorProp.Thickness v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayerSeparator.ThicknessProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayerSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
