...
type SparklineEditProp =
    | Base of BaseEditProp
    | Items of System.Collections.IEnumerable
    | PointArgumentMember of string
    | PointValueMember of string
    | PointArgumentSortOrder of DevExpress.Xpf.Editors.SparklineSortOrder
    | FilterCriteria of DevExpress.Data.Filtering.CriteriaOperator
    | PointArgumentRange of DevExpress.Xpf.Editors.Range
    | PointValueRange of DevExpress.Xpf.Editors.Range

module SparklineEdit =
    let items v : obj = box (SparklineEditProp.Items v)
    let pointArgumentMember v : obj = box (SparklineEditProp.PointArgumentMember v)
    let pointValueMember v : obj = box (SparklineEditProp.PointValueMember v)
    let pointArgumentSortOrder v : obj = box (SparklineEditProp.PointArgumentSortOrder v)
    let filterCriteria v : obj = box (SparklineEditProp.FilterCriteria v)
    let pointArgumentRange v : obj = box (SparklineEditProp.PointArgumentRange v)
    let pointValueRange v : obj = box (SparklineEditProp.PointValueRange v)

    let apply (el: DevExpress.Xpf.Editors.SparklineEdit) (prop: SparklineEditProp) =
        match prop with
        | SparklineEditProp.Base p -> BaseEdit.apply el p
        | SparklineEditProp.Items v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.ItemsProperty, box v)
        | SparklineEditProp.PointArgumentMember v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.PointArgumentMemberProperty, box v)
        | SparklineEditProp.PointValueMember v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.PointValueMemberProperty, box v)
        | SparklineEditProp.PointArgumentSortOrder v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.PointArgumentSortOrderProperty, box v)
        | SparklineEditProp.FilterCriteria v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.FilterCriteriaProperty, box v)
        | SparklineEditProp.PointArgumentRange v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.PointArgumentRangeProperty, box v)
        | SparklineEditProp.PointValueRange v -> el.SetValue(DevExpress.Xpf.Editors.SparklineEdit.PointValueRangeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SparklineEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
