...
type SearchPanelProp =
    | ReplaceButtonText of string
    | ReplaceAllButtonText of string
    | FindLabelText of string
    | ReplaceLabelText of string
    | CommandParameter of obj
    | FindNextButtonTooltip of string
    | FindPrevButtonTooltip of string
    | CloseButtonTooltip of string
    | SearchOptionsButtonTooltip of string
    | OnClosed of System.Windows.RoutedEventHandler

module SearchPanel =
    let replaceButtonText v : obj = box (SearchPanelProp.ReplaceButtonText v)
    let replaceAllButtonText v : obj = box (SearchPanelProp.ReplaceAllButtonText v)
    let findLabelText v : obj = box (SearchPanelProp.FindLabelText v)
    let replaceLabelText v : obj = box (SearchPanelProp.ReplaceLabelText v)
    let commandParameter v : obj = box (SearchPanelProp.CommandParameter v)
    let findNextButtonTooltip v : obj = box (SearchPanelProp.FindNextButtonTooltip v)
    let findPrevButtonTooltip v : obj = box (SearchPanelProp.FindPrevButtonTooltip v)
    let closeButtonTooltip v : obj = box (SearchPanelProp.CloseButtonTooltip v)
    let searchOptionsButtonTooltip v : obj = box (SearchPanelProp.SearchOptionsButtonTooltip v)
    let onClosed v : obj = box (EventProp(box (SearchPanelProp.OnClosed v)))

    let apply (el: DevExpress.Xpf.Core.Native.SearchPanel) (prop: SearchPanelProp) =
        match prop with
        | SearchPanelProp.ReplaceButtonText v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.ReplaceButtonTextProperty, box v)
        | SearchPanelProp.ReplaceAllButtonText v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.ReplaceAllButtonTextProperty, box v)
        | SearchPanelProp.FindLabelText v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.FindLabelTextProperty, box v)
        | SearchPanelProp.ReplaceLabelText v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.ReplaceLabelTextProperty, box v)
        | SearchPanelProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.CommandParameterProperty, box v)
        | SearchPanelProp.FindNextButtonTooltip v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.FindNextButtonTooltipProperty, box v)
        | SearchPanelProp.FindPrevButtonTooltip v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.FindPrevButtonTooltipProperty, box v)
        | SearchPanelProp.CloseButtonTooltip v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.CloseButtonTooltipProperty, box v)
        | SearchPanelProp.SearchOptionsButtonTooltip v -> el.SetValue(DevExpress.Xpf.Core.Native.SearchPanel.SearchOptionsButtonTooltipProperty, box v)
        | SearchPanelProp.OnClosed h -> el.Closed.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.SearchPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
