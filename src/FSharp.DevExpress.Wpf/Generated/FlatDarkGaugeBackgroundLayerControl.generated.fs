...
type FlatDarkGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkGaugeBackgroundLayerControl) (prop: FlatDarkGaugeBackgroundLayerControlProp) =
        match prop with
        | FlatDarkGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
