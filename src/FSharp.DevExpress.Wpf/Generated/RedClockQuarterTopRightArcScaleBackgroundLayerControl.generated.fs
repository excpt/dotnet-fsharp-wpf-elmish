...
type RedClockQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedClockQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockQuarterTopRightArcScaleBackgroundLayerControl) (prop: RedClockQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | RedClockQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
