...
type DigitalYellowSubmarineModelProp =
    | Base of DigitalGaugeModelProp

module DigitalYellowSubmarineModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalYellowSubmarineModel) (prop: DigitalYellowSubmarineModelProp) =
        match prop with
        | DigitalYellowSubmarineModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalYellowSubmarineModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
