...
type RangeEditBaseStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp

module RangeEditBaseStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.RangeEditBaseStyleSettings) (prop: RangeEditBaseStyleSettingsProp) =
        match prop with
        | RangeEditBaseStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RangeEditBaseStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
