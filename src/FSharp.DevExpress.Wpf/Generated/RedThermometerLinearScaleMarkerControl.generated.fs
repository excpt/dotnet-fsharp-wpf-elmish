...
type RedThermometerLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module RedThermometerLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedThermometerLinearScaleMarkerControl) (prop: RedThermometerLinearScaleMarkerControlProp) =
        match prop with
        | RedThermometerLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedThermometerLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
