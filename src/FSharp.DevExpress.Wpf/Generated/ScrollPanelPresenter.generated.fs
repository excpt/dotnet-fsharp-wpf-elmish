...
type ScrollPanelPresenterProp =
    | HPixelScrolling of bool
    | VPixelScrolling of bool
    | AllowHScrollAnimation of bool
    | AllowVScrollAnimation of bool
    | HWheelScrollLines of float
    | VWheelScrollLines of float
    | HSmallScrollStep of int
    | VSmallScrollStep of int
    | ManualHScrollInfo of DevExpress.Xpf.Scheduling.Panels.ManualScrollInfo
    | ManualVScrollInfo of DevExpress.Xpf.Scheduling.Panels.ManualScrollInfo

module ScrollPanelPresenter =
    let hPixelScrolling v : obj = box (ScrollPanelPresenterProp.HPixelScrolling v)
    let vPixelScrolling v : obj = box (ScrollPanelPresenterProp.VPixelScrolling v)
    let allowHScrollAnimation v : obj = box (ScrollPanelPresenterProp.AllowHScrollAnimation v)
    let allowVScrollAnimation v : obj = box (ScrollPanelPresenterProp.AllowVScrollAnimation v)
    let hWheelScrollLines v : obj = box (ScrollPanelPresenterProp.HWheelScrollLines v)
    let vWheelScrollLines v : obj = box (ScrollPanelPresenterProp.VWheelScrollLines v)
    let hSmallScrollStep v : obj = box (ScrollPanelPresenterProp.HSmallScrollStep v)
    let vSmallScrollStep v : obj = box (ScrollPanelPresenterProp.VSmallScrollStep v)
    let manualHScrollInfo v : obj = box (ScrollPanelPresenterProp.ManualHScrollInfo v)
    let manualVScrollInfo v : obj = box (ScrollPanelPresenterProp.ManualVScrollInfo v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter) (prop: ScrollPanelPresenterProp) =
        match prop with
        | ScrollPanelPresenterProp.HPixelScrolling v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.HPixelScrollingProperty, box v)
        | ScrollPanelPresenterProp.VPixelScrolling v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.VPixelScrollingProperty, box v)
        | ScrollPanelPresenterProp.AllowHScrollAnimation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.AllowHScrollAnimationProperty, box v)
        | ScrollPanelPresenterProp.AllowVScrollAnimation v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.AllowVScrollAnimationProperty, box v)
        | ScrollPanelPresenterProp.HWheelScrollLines v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.HWheelScrollLinesProperty, box v)
        | ScrollPanelPresenterProp.VWheelScrollLines v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.VWheelScrollLinesProperty, box v)
        | ScrollPanelPresenterProp.HSmallScrollStep v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.HSmallScrollStepProperty, box v)
        | ScrollPanelPresenterProp.VSmallScrollStep v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.VSmallScrollStepProperty, box v)
        | ScrollPanelPresenterProp.ManualHScrollInfo v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.ManualHScrollInfoProperty, box v)
        | ScrollPanelPresenterProp.ManualVScrollInfo v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter.ManualVScrollInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.ScrollPanelPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
