...
type TransparentBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module TransparentBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.TransparentBar2DModelControl) (prop: TransparentBar2DModelControlProp) =
        match prop with
        | TransparentBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.TransparentBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
