...
type FlyoutPopupControlProp =
    | Base of FlyoutControlProp

module FlyoutPopupControl =

    let apply (el: DevExpress.Xpf.Controls.Primitives.FlyoutPopupControl) (prop: FlyoutPopupControlProp) =
        match prop with
        | FlyoutPopupControlProp.Base p -> FlyoutControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.FlyoutPopupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
