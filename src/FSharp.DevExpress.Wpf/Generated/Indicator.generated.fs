...
module Indicator =
    let visible v : obj = box (IndicatorProp.Visible v)
    let checkedInLegend v : obj = box (IndicatorProp.CheckedInLegend v)
    let checkableInLegend v : obj = box (IndicatorProp.CheckableInLegend v)
    let brush v : obj = box (IndicatorProp.Brush v)
    let legendText v : obj = box (IndicatorProp.LegendText v)
    let legendMarkerTemplate v : obj = box (IndicatorProp.LegendMarkerTemplate v)
    let lineStyle v : obj = box (IndicatorProp.LineStyle v)
    let showInLegend v : obj = box (IndicatorProp.ShowInLegend v)
    let legend v : obj = box (IndicatorProp.Legend v)
    let animation v : obj = box (IndicatorProp.Animation v)
    let animationAutoStartMode v : obj = box (IndicatorProp.AnimationAutoStartMode v)
    let crosshairEnabled v : obj = box (IndicatorProp.CrosshairEnabled v)
    let crosshairLabelPattern v : obj = box (IndicatorProp.CrosshairLabelPattern v)
    let crosshairContentShowMode v : obj = box (IndicatorProp.CrosshairContentShowMode v)
    let crosshairEmptyValueLegendText v : obj = box (IndicatorProp.CrosshairEmptyValueLegendText v)
    let displayName v : obj = box (IndicatorProp.DisplayName v)

    let apply (el: DevExpress.Xpf.Charts.Indicator) (prop: IndicatorProp) =
        match prop with
        | IndicatorProp.Base p -> ChartElement.apply el p
        | IndicatorProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.VisibleProperty, box v)
        | IndicatorProp.CheckedInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.CheckedInLegendProperty, box v)
        | IndicatorProp.CheckableInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.CheckableInLegendProperty, box v)
        | IndicatorProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.BrushProperty, box v)
        | IndicatorProp.LegendText v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.LegendTextProperty, box v)
        | IndicatorProp.LegendMarkerTemplate v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.LegendMarkerTemplateProperty, box v)
        | IndicatorProp.LineStyle v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.LineStyleProperty, box v)
        | IndicatorProp.ShowInLegend v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.ShowInLegendProperty, box v)
        | IndicatorProp.Legend v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.LegendProperty, box v)
        | IndicatorProp.Animation v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.AnimationProperty, box v)
        | IndicatorProp.AnimationAutoStartMode v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.AnimationAutoStartModeProperty, box v)
        | IndicatorProp.CrosshairEnabled v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.CrosshairEnabledProperty, box v)
        | IndicatorProp.CrosshairLabelPattern v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.CrosshairLabelPatternProperty, box v)
        | IndicatorProp.CrosshairContentShowMode v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.CrosshairContentShowModeProperty, box v)
        | IndicatorProp.CrosshairEmptyValueLegendText v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.CrosshairEmptyValueLegendTextProperty, box v)
        | IndicatorProp.DisplayName v -> el.SetValue(DevExpress.Xpf.Charts.Indicator.DisplayNameProperty, box v)
