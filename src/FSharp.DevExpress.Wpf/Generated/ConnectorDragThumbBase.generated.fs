...
type ConnectorDragThumbBaseProp =
    | ThumbKind of DevExpress.Xpf.Gantt.Native.ConnectorPointType
    | IsActive of bool

module ConnectorDragThumbBase =
    let thumbKind v : obj = box (ConnectorDragThumbBaseProp.ThumbKind v)
    let isActive v : obj = box (ConnectorDragThumbBaseProp.IsActive v)

    let apply (el: DevExpress.Xpf.Gantt.Native.ConnectorDragThumbBase) (prop: ConnectorDragThumbBaseProp) =
        match prop with
        | ConnectorDragThumbBaseProp.ThumbKind v -> el.SetValue(DevExpress.Xpf.Gantt.Native.ConnectorDragThumbBase.ThumbKindProperty, box v)
        | ConnectorDragThumbBaseProp.IsActive v -> el.SetValue(DevExpress.Xpf.Gantt.Native.ConnectorDragThumbBase.IsActiveProperty, box v)
