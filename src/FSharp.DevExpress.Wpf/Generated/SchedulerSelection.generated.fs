...
type SchedulerSelectionProp =
    | Resource of DevExpress.XtraScheduler.Resource
    | Interval of DevExpress.XtraScheduler.TimeInterval

module SchedulerSelection =
    let resource v : obj = box (SchedulerSelectionProp.Resource v)
    let interval v : obj = box (SchedulerSelectionProp.Interval v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.SchedulerSelection) (prop: SchedulerSelectionProp) =
        match prop with
        | SchedulerSelectionProp.Resource v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerSelection.ResourceProperty, box v)
        | SchedulerSelectionProp.Interval v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.SchedulerSelection.IntervalProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.SchedulerSelection>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
