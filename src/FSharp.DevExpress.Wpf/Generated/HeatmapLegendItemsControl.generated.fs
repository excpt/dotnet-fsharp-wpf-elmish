...
type HeatmapLegendItemsControlProp =
    | Base of ChartItemsControlProp

module HeatmapLegendItemsControl =

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapLegendItemsControl) (prop: HeatmapLegendItemsControlProp) =
        match prop with
        | HeatmapLegendItemsControlProp.Base p -> ChartItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapLegendItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
