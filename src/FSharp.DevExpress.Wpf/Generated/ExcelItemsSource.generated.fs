...
open System
open System.Windows
open DevExpress.Xpf.Core.DataSources
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type ExcelItemsSourceProp =
    | Base of DataSourceWithDataBaseProp
    | FileName of string
    | Columns of DevExpress.Xpf.Core.DataSources.ExcelSourceColumnsCollection
    | UseFirstRowAsHeader of bool
    | SkipEmptyRows of bool
    | SkipHiddenRows of bool
    | SkipHiddenColumns of bool
    | Password of string
    | WorksheetName of string
    | CellRange of string
    | Stream of System.IO.Stream
    | StreamDocumentFormat of DevExpress.DataAccess.Excel.ExcelDocumentFormat
    | FileUri of System.Uri
    | CSVDelimiter of obj

module ExcelItemsSource =
    let fileName v : obj = box (ExcelItemsSourceProp.FileName v)
    let columns v : obj = box (ExcelItemsSourceProp.Columns v)
    let useFirstRowAsHeader v : obj = box (ExcelItemsSourceProp.UseFirstRowAsHeader v)
    let skipEmptyRows v : obj = box (ExcelItemsSourceProp.SkipEmptyRows v)
    let skipHiddenRows v : obj = box (ExcelItemsSourceProp.SkipHiddenRows v)
    let skipHiddenColumns v : obj = box (ExcelItemsSourceProp.SkipHiddenColumns v)
    let password v : obj = box (ExcelItemsSourceProp.Password v)
    let worksheetName v : obj = box (ExcelItemsSourceProp.WorksheetName v)
    let cellRange v : obj = box (ExcelItemsSourceProp.CellRange v)
    let stream v : obj = box (ExcelItemsSourceProp.Stream v)
    let streamDocumentFormat v : obj = box (ExcelItemsSourceProp.StreamDocumentFormat v)
    let fileUri v : obj = box (ExcelItemsSourceProp.FileUri v)
    let cSVDelimiter v : obj = box (ExcelItemsSourceProp.CSVDelimiter v)

    let apply (el: DevExpress.Xpf.Core.DataSources.ExcelItemsSource) (prop: ExcelItemsSourceProp) =
        match prop with
        | ExcelItemsSourceProp.Base p -> DataSourceWithDataBase.apply el p
        | ExcelItemsSourceProp.FileName v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.FileNameProperty, box v)
        | ExcelItemsSourceProp.Columns v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.ColumnsProperty, box v)
        | ExcelItemsSourceProp.UseFirstRowAsHeader v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.UseFirstRowAsHeaderProperty, box v)
        | ExcelItemsSourceProp.SkipEmptyRows v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.SkipEmptyRowsProperty, box v)
        | ExcelItemsSourceProp.SkipHiddenRows v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.SkipHiddenRowsProperty, box v)
        | ExcelItemsSourceProp.SkipHiddenColumns v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.SkipHiddenColumnsProperty, box v)
        | ExcelItemsSourceProp.Password v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.PasswordProperty, box v)
        | ExcelItemsSourceProp.WorksheetName v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.WorksheetNameProperty, box v)
        | ExcelItemsSourceProp.CellRange v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.CellRangeProperty, box v)
        | ExcelItemsSourceProp.Stream v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.StreamProperty, box v)
        | ExcelItemsSourceProp.StreamDocumentFormat v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.StreamDocumentFormatProperty, box v)
        | ExcelItemsSourceProp.FileUri v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.FileUriProperty, box v)
        | ExcelItemsSourceProp.CSVDelimiter v -> el.SetValue(DevExpress.Xpf.Core.DataSources.ExcelItemsSource.CSVDelimiterProperty, box v)

    let data v : obj = box (DataSourceWithDataBaseProp.Data v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.ExcelItemsSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
