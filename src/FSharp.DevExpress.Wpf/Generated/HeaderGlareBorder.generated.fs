...
type HeaderGlareBorderProp =
    | Base of HeaderBorderProp

module HeaderGlareBorder =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HeaderGlareBorder) (prop: HeaderGlareBorderProp) =
        match prop with
        | HeaderGlareBorderProp.Base p -> HeaderBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HeaderGlareBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
