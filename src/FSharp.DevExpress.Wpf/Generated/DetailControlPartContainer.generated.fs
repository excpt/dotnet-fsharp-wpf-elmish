...
type DetailControlPartContainerProp =
    | DetailDescriptor of DevExpress.Xpf.Grid.DetailDescriptorBase
    | View of DevExpress.Xpf.Grid.DataViewBase
    | DetailPartTemplate of System.Windows.Controls.ControlTemplate

module DetailControlPartContainer =
    let detailDescriptor v : obj = box (DetailControlPartContainerProp.DetailDescriptor v)
    let view v : obj = box (DetailControlPartContainerProp.View v)
    let detailPartTemplate v : obj = box (DetailControlPartContainerProp.DetailPartTemplate v)

    let apply (el: DevExpress.Xpf.Grid.DetailControlPartContainer) (prop: DetailControlPartContainerProp) =
        match prop with
        | DetailControlPartContainerProp.DetailDescriptor v -> el.SetValue(DevExpress.Xpf.Grid.DetailControlPartContainer.DetailDescriptorProperty, box v)
        | DetailControlPartContainerProp.View v -> el.SetValue(DevExpress.Xpf.Grid.DetailControlPartContainer.ViewProperty, box v)
        | DetailControlPartContainerProp.DetailPartTemplate v -> el.SetValue(DevExpress.Xpf.Grid.DetailControlPartContainer.DetailPartTemplateProperty, box v)
