...
type AppBarExitButtonProp =
    | Base of AppBarButtonProp

module AppBarExitButton =

    let apply (el: DevExpress.Xpf.WindowsUI.AppBarExitButton) (prop: AppBarExitButtonProp) =
        match prop with
        | AppBarExitButtonProp.Base p -> AppBarButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.AppBarExitButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
