...
type CircularClassicModelProp =
    | Base of CircularGaugeModelProp

module CircularClassicModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularClassicModel) (prop: CircularClassicModelProp) =
        match prop with
        | CircularClassicModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularClassicModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
