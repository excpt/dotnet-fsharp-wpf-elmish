...
open System
open System.Windows
open DevExpress.Xpf.RichEdit.View
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type CustomizeOutlineNumberedListProp =
    | Base of ThemedWindowProp

module CustomizeOutlineNumberedList =

    let apply (el: DevExpress.Xpf.RichEdit.View.CustomizeOutlineNumberedList) (prop: CustomizeOutlineNumberedListProp) =
        match prop with
        | CustomizeOutlineNumberedListProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.View.CustomizeOutlineNumberedList>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
