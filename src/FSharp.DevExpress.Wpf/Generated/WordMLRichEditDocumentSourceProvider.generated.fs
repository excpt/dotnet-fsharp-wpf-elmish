...
type WordMLRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module WordMLRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.WordMLRichEditDocumentSourceProvider) (prop: WordMLRichEditDocumentSourceProviderProp) =
        match prop with
        | WordMLRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.WordMLRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
