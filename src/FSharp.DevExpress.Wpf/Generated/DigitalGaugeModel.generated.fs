...
type DigitalGaugeModelProp =
    | Base of GaugeModelBaseProp
    | SevenSegmentsModel of DevExpress.Xpf.Gauges.SevenSegmentsModel
    | FourteenSegmentsModel of DevExpress.Xpf.Gauges.FourteenSegmentsModel
    | Matrix5x8Model of DevExpress.Xpf.Gauges.Matrix5x8Model
    | Matrix8x14Model of DevExpress.Xpf.Gauges.Matrix8x14Model
    | LayerModels of DevExpress.Xpf.Gauges.LayerModelCollection

module DigitalGaugeModel =
    let sevenSegmentsModel v : obj = box (DigitalGaugeModelProp.SevenSegmentsModel v)
    let fourteenSegmentsModel v : obj = box (DigitalGaugeModelProp.FourteenSegmentsModel v)
    let matrix5x8Model v : obj = box (DigitalGaugeModelProp.Matrix5x8Model v)
    let matrix8x14Model v : obj = box (DigitalGaugeModelProp.Matrix8x14Model v)
    let layerModels v : obj = box (DigitalGaugeModelProp.LayerModels v)

    let apply (el: DevExpress.Xpf.Gauges.DigitalGaugeModel) (prop: DigitalGaugeModelProp) =
        match prop with
        | DigitalGaugeModelProp.Base p -> GaugeModelBase.apply el p
        | DigitalGaugeModelProp.SevenSegmentsModel v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeModel.SevenSegmentsModelProperty, box v)
        | DigitalGaugeModelProp.FourteenSegmentsModel v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeModel.FourteenSegmentsModelProperty, box v)
        | DigitalGaugeModelProp.Matrix5x8Model v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeModel.Matrix5x8ModelProperty, box v)
        | DigitalGaugeModelProp.Matrix8x14Model v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeModel.Matrix8x14ModelProperty, box v)
        | DigitalGaugeModelProp.LayerModels v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeModel.LayerModelsProperty, box v)
