...
type MicroQRCodeStyleSettingsProp =
    | CompactionMode of DevExpress.XtraPrinting.BarCode.MicroQRCodeCompactionMode
    | ErrorCorrectionLevel of DevExpress.XtraPrinting.BarCode.MicroQRCodeErrorCorrectionLevel
    | Version of DevExpress.XtraPrinting.BarCode.MicroQRCodeVersion

module MicroQRCodeStyleSettings =
    let compactionMode v : obj = box (MicroQRCodeStyleSettingsProp.CompactionMode v)
    let errorCorrectionLevel v : obj = box (MicroQRCodeStyleSettingsProp.ErrorCorrectionLevel v)
    let version v : obj = box (MicroQRCodeStyleSettingsProp.Version v)

    let apply (el: DevExpress.Xpf.Editors.MicroQRCodeStyleSettings) (prop: MicroQRCodeStyleSettingsProp) =
        match prop with
        | MicroQRCodeStyleSettingsProp.CompactionMode v -> el.SetValue(DevExpress.Xpf.Editors.MicroQRCodeStyleSettings.CompactionModeProperty, box v)
        | MicroQRCodeStyleSettingsProp.ErrorCorrectionLevel v -> el.SetValue(DevExpress.Xpf.Editors.MicroQRCodeStyleSettings.ErrorCorrectionLevelProperty, box v)
        | MicroQRCodeStyleSettingsProp.Version v -> el.SetValue(DevExpress.Xpf.Editors.MicroQRCodeStyleSettings.VersionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.MicroQRCodeStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
