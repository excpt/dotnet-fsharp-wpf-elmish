...
type MonthViewSelectionPresenterProp =
    | Base of SelectionPresenterProp

module MonthViewSelectionPresenter =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.MonthViewSelectionPresenter) (prop: MonthViewSelectionPresenterProp) =
        match prop with
        | MonthViewSelectionPresenterProp.Base p -> SelectionPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.MonthViewSelectionPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
