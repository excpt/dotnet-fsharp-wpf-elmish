...
type LanguageViewProp =
    | Base of ThemedWindowProp

module LanguageView =

    let apply (el: DevExpress.XtraRichEdit.View.LanguageView) (prop: LanguageViewProp) =
        match prop with
        | LanguageViewProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.XtraRichEdit.View.LanguageView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
