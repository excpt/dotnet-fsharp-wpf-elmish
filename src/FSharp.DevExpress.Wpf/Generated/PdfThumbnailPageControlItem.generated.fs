...
type PdfThumbnailPageControlItemProp =
    | Base of PageControlItemProp
    | IsHighlighted of bool

module PdfThumbnailPageControlItem =
    let isHighlighted v : obj = box (PdfThumbnailPageControlItemProp.IsHighlighted v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfThumbnailPageControlItem) (prop: PdfThumbnailPageControlItemProp) =
        match prop with
        | PdfThumbnailPageControlItemProp.Base p -> PageControlItem.apply el p
        | PdfThumbnailPageControlItemProp.IsHighlighted v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailPageControlItem.IsHighlightedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfThumbnailPageControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
