...
type CircularFlatDarkQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularFlatDarkQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularFlatDarkQuarterTopRightModel) (prop: CircularFlatDarkQuarterTopRightModelProp) =
        match prop with
        | CircularFlatDarkQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularFlatDarkQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
