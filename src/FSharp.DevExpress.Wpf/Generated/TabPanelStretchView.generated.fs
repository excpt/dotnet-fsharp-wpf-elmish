...
type TabPanelStretchViewProp =
    | Base of TabPanelStretchViewBaseProp
    | Owner of DevExpress.Xpf.Core.TabControlStretchView
    | DragDropMode of DevExpress.Xpf.Core.TabControlDragDropMode

module TabPanelStretchView =
    let owner v : obj = box (TabPanelStretchViewProp.Owner v)
    let dragDropMode v : obj = box (TabPanelStretchViewProp.DragDropMode v)

    let apply (el: DevExpress.Xpf.Core.Native.TabPanelStretchView) (prop: TabPanelStretchViewProp) =
        match prop with
        | TabPanelStretchViewProp.Base p -> TabPanelStretchViewBase.apply el p
        | TabPanelStretchViewProp.Owner v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchView.OwnerProperty, box v)
        | TabPanelStretchViewProp.DragDropMode v -> el.SetValue(DevExpress.Xpf.Core.Native.TabPanelStretchView.DragDropModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabPanelStretchView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
