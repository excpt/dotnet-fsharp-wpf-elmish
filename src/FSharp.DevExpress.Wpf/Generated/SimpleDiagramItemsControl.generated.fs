...
type SimpleDiagramItemsControlProp =
    | Base of ChartItemsControlProp

module SimpleDiagramItemsControl =

    let apply (el: DevExpress.Xpf.Charts.SimpleDiagramItemsControl) (prop: SimpleDiagramItemsControlProp) =
        match prop with
        | SimpleDiagramItemsControlProp.Base p -> ChartItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleDiagramItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
