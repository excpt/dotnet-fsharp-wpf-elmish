...
type ElementInfoPanelProp =
    | StretchToAvailableSize of bool

module ElementInfoPanel =
    let stretchToAvailableSize v : obj = box (ElementInfoPanelProp.StretchToAvailableSize v)

    let apply (el: DevExpress.Xpf.Gauges.ElementInfoPanel) (prop: ElementInfoPanelProp) =
        match prop with
        | ElementInfoPanelProp.StretchToAvailableSize v -> el.SetValue(DevExpress.Xpf.Gauges.ElementInfoPanel.StretchToAvailableSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ElementInfoPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
