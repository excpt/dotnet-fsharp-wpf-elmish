...
type FieldHeaderContentControlProp =
    | IsMouseOverOverride of bool
    | IsPressed of bool

module FieldHeaderContentControl =
    let isMouseOverOverride v : obj = box (FieldHeaderContentControlProp.IsMouseOverOverride v)
    let isPressed v : obj = box (FieldHeaderContentControlProp.IsPressed v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentControl) (prop: FieldHeaderContentControlProp) =
        match prop with
        | FieldHeaderContentControlProp.IsMouseOverOverride v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentControl.IsMouseOverOverrideProperty, box v)
        | FieldHeaderContentControlProp.IsPressed v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentControl.IsPressedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldHeaderContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
