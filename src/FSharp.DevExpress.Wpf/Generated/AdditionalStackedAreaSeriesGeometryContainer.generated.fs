...
type AdditionalStackedAreaSeriesGeometryContainerProp =
    | Base of AdditionalSeriesGeometryContainerProp

module AdditionalStackedAreaSeriesGeometryContainer =

    let apply (el: DevExpress.Xpf.Charts.AdditionalStackedAreaSeriesGeometryContainer) (prop: AdditionalStackedAreaSeriesGeometryContainerProp) =
        match prop with
        | AdditionalStackedAreaSeriesGeometryContainerProp.Base p -> AdditionalSeriesGeometryContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalStackedAreaSeriesGeometryContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
