...
type TimePickerClockProp =
    | DateTime of System.DateTime
    | Hours of int
    | Minutes of int
    | Seconds of int
    | LongTickOffset of float
    | ShortTickOffset of float
    | LongTickSize of float
    | ShortTickSize of float
    | LongTickFrequency of int
    | ShortTickFrequency of int
    | VisibleMaskParts of DevExpress.Xpf.Editors.TimePickerMaskPart

module TimePickerClock =
    let dateTime v : obj = box (TimePickerClockProp.DateTime v)
    let hours v : obj = box (TimePickerClockProp.Hours v)
    let minutes v : obj = box (TimePickerClockProp.Minutes v)
    let seconds v : obj = box (TimePickerClockProp.Seconds v)
    let longTickOffset v : obj = box (TimePickerClockProp.LongTickOffset v)
    let shortTickOffset v : obj = box (TimePickerClockProp.ShortTickOffset v)
    let longTickSize v : obj = box (TimePickerClockProp.LongTickSize v)
    let shortTickSize v : obj = box (TimePickerClockProp.ShortTickSize v)
    let longTickFrequency v : obj = box (TimePickerClockProp.LongTickFrequency v)
    let shortTickFrequency v : obj = box (TimePickerClockProp.ShortTickFrequency v)
    let visibleMaskParts v : obj = box (TimePickerClockProp.VisibleMaskParts v)

    let apply (el: DevExpress.Xpf.Editors.Internal.TimePickerClock) (prop: TimePickerClockProp) =
        match prop with
        | TimePickerClockProp.DateTime v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.DateTimeProperty, box v)
        | TimePickerClockProp.Hours v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.HoursProperty, box v)
        | TimePickerClockProp.Minutes v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.MinutesProperty, box v)
        | TimePickerClockProp.Seconds v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.SecondsProperty, box v)
        | TimePickerClockProp.LongTickOffset v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.LongTickOffsetProperty, box v)
        | TimePickerClockProp.ShortTickOffset v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.ShortTickOffsetProperty, box v)
        | TimePickerClockProp.LongTickSize v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.LongTickSizeProperty, box v)
        | TimePickerClockProp.ShortTickSize v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.ShortTickSizeProperty, box v)
        | TimePickerClockProp.LongTickFrequency v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.LongTickFrequencyProperty, box v)
        | TimePickerClockProp.ShortTickFrequency v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.ShortTickFrequencyProperty, box v)
        | TimePickerClockProp.VisibleMaskParts v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TimePickerClock.VisibleMaskPartsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.TimePickerClock>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
