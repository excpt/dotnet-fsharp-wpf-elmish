...
type RadarLineScatterSeries2DProp =
    | Base of CircularLineScatterSeries2DProp

module RadarLineScatterSeries2D =

    let apply (el: DevExpress.Xpf.Charts.RadarLineScatterSeries2D) (prop: RadarLineScatterSeries2DProp) =
        match prop with
        | RadarLineScatterSeries2DProp.Base p -> CircularLineScatterSeries2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RadarLineScatterSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
