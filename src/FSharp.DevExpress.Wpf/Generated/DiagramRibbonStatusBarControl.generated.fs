...
type DiagramRibbonStatusBarControlProp =
    | Base of RibbonStatusBarControlProp

module DiagramRibbonStatusBarControl =

    let apply (el: DevExpress.Xpf.Diagram.DiagramRibbonStatusBarControl) (prop: DiagramRibbonStatusBarControlProp) =
        match prop with
        | DiagramRibbonStatusBarControlProp.Base p -> RibbonStatusBarControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramRibbonStatusBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
