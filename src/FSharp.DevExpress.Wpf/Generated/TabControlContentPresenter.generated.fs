...
type TabControlContentPresenterProp =
    | Base of ContentHostContentPresenterProp
    | ActualHorizontalAlignment of System.Windows.HorizontalAlignment
    | ActualVerticalAlignment of System.Windows.VerticalAlignment

module TabControlContentPresenter =
    let actualHorizontalAlignment v : obj = box (TabControlContentPresenterProp.ActualHorizontalAlignment v)
    let actualVerticalAlignment v : obj = box (TabControlContentPresenterProp.ActualVerticalAlignment v)

    let apply (el: DevExpress.Xpf.Core.Native.TabControlContentPresenter) (prop: TabControlContentPresenterProp) =
        match prop with
        | TabControlContentPresenterProp.Base p -> ContentHostContentPresenter.apply el p
        | TabControlContentPresenterProp.ActualHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Core.Native.TabControlContentPresenter.ActualHorizontalAlignmentProperty, box v)
        | TabControlContentPresenterProp.ActualVerticalAlignment v -> el.SetValue(DevExpress.Xpf.Core.Native.TabControlContentPresenter.ActualVerticalAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabControlContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
