...
type AppointmentLabelPresenterProp =
    | Data of System.Windows.Media.Geometry

module AppointmentLabelPresenter =
    let data v : obj = box (AppointmentLabelPresenterProp.Data v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentLabelPresenter) (prop: AppointmentLabelPresenterProp) =
        match prop with
        | AppointmentLabelPresenterProp.Data v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentLabelPresenter.DataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentLabelPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
