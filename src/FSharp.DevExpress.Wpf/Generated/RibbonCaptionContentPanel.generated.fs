...
type RibbonCaptionContentPanelProp =
    | HorizontalContentMargin of float
    | ContentWidth of float

module RibbonCaptionContentPanel =
    let horizontalContentMargin v : obj = box (RibbonCaptionContentPanelProp.HorizontalContentMargin v)
    let contentWidth v : obj = box (RibbonCaptionContentPanelProp.ContentWidth v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonCaptionContentPanel) (prop: RibbonCaptionContentPanelProp) =
        match prop with
        | RibbonCaptionContentPanelProp.HorizontalContentMargin v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCaptionContentPanel.HorizontalContentMarginProperty, box v)
        | RibbonCaptionContentPanelProp.ContentWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonCaptionContentPanel.ContentWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonCaptionContentPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
