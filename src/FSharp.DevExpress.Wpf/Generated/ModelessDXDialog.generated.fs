...
type ModelessDXDialogProp =
    | Base of CustomDXDialogProp

module ModelessDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.ModelessDXDialog) (prop: ModelessDXDialogProp) =
        match prop with
        | ModelessDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.ModelessDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
