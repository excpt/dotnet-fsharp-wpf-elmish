...
type YellowSubmarineLinearScaleLevelBarBackgroundControlProp =
    | Base of ValueIndicatorPresentationControlProp

module YellowSubmarineLinearScaleLevelBarBackgroundControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleLevelBarBackgroundControl) (prop: YellowSubmarineLinearScaleLevelBarBackgroundControlProp) =
        match prop with
        | YellowSubmarineLinearScaleLevelBarBackgroundControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineLinearScaleLevelBarBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
