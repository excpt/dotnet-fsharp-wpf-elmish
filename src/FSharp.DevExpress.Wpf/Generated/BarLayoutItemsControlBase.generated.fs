...
type BarLayoutItemsControlBaseProp =
    | Base of BarItemsControlProp
    | ContainerKey of obj
    | Orientation of System.Windows.Controls.Orientation

module BarLayoutItemsControlBase =
    let containerKey v : obj = box (BarLayoutItemsControlBaseProp.ContainerKey v)
    let orientation v : obj = box (BarLayoutItemsControlBaseProp.Orientation v)

    let apply (el: DevExpress.Xpf.Bars.BarLayoutItemsControlBase) (prop: BarLayoutItemsControlBaseProp) =
        match prop with
        | BarLayoutItemsControlBaseProp.Base p -> BarItemsControl.apply el p
        | BarLayoutItemsControlBaseProp.ContainerKey v -> el.SetValue(DevExpress.Xpf.Bars.BarLayoutItemsControlBase.ContainerKeyProperty, box v)
        | BarLayoutItemsControlBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.Bars.BarLayoutItemsControlBase.OrientationProperty, box v)
