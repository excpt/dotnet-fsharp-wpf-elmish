...
type YellowSubmarineHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module YellowSubmarineHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineHalfTopArcScaleBackgroundLayerControl) (prop: YellowSubmarineHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | YellowSubmarineHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
