...
type QRCodeEPCStyleSettingsProp =
    | Base of QRCodeStyleSettingsProp

module QRCodeEPCStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.QRCodeEPCStyleSettings) (prop: QRCodeEPCStyleSettingsProp) =
        match prop with
        | QRCodeEPCStyleSettingsProp.Base p -> QRCodeStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.QRCodeEPCStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
