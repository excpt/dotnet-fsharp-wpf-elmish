...
module GridContainer =
    ...
    let apply (el: DevExpress.Xpf.Core.ConditionalFormattingManager.GridContainer) (prop: GridContainerProp) =
        match prop with
        | GridContainerProp.Base p -> ManagerContainerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ConditionalFormattingManager.GridContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
