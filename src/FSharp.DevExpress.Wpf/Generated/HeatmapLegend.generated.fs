...
type HeatmapLegendProp =
    | Base of LegendBaseProp
    | Items of DevExpress.Xpf.Charts.Heatmap.HeatmapLegendItemList

module HeatmapLegend =
    let items v : obj = box (HeatmapLegendProp.Items v)

    let apply (el: DevExpress.Xpf.Charts.Heatmap.HeatmapLegend) (prop: HeatmapLegendProp) =
        match prop with
        | HeatmapLegendProp.Base p -> LegendBase.apply el p
        | HeatmapLegendProp.Items v -> el.SetValue(DevExpress.Xpf.Charts.Heatmap.HeatmapLegend.ItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Heatmap.HeatmapLegend>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
