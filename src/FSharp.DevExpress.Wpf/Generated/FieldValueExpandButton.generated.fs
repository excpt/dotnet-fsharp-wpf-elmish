...
type FieldValueExpandButtonProp =
    | IsChecked of obj
...
module FieldValueExpandButton =
    let isChecked v : obj = box (FieldValueExpandButtonProp.IsChecked v)
    let command v : obj = box (FieldValueExpandButtonProp.Command v)
    let commandParameter v : obj = box (FieldValueExpandButtonProp.CommandParameter v)
    let valueItem v : obj = box (FieldValueExpandButtonProp.ValueItem v)

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldValueExpandButton) (prop: FieldValueExpandButtonProp) =
        match prop with
        | FieldValueExpandButtonProp.IsChecked v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldValueExpandButton.IsCheckedProperty, box v)
        | FieldValueExpandButtonProp.Command v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldValueExpandButton.CommandProperty, box v)
        | FieldValueExpandButtonProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldValueExpandButton.CommandParameterProperty, box v)
        | FieldValueExpandButtonProp.ValueItem v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldValueExpandButton.ValueItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldValueExpandButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
