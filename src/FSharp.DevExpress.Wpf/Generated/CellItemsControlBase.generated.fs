...
type CellItemsControlBaseProp =
    | Base of GridCachedItemsControlProp

module CellItemsControlBase =

    let apply (el: DevExpress.Xpf.Grid.CellItemsControlBase) (prop: CellItemsControlBaseProp) =
        match prop with
        | CellItemsControlBaseProp.Base p -> GridCachedItemsControl.apply el p
