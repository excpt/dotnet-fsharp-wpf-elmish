...
type AnimationPanel2Prop =
    | AnimationState of float

module AnimationPanel2 =
    let animationState v : obj = box (AnimationPanel2Prop.AnimationState v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AnimationPanel2) (prop: AnimationPanel2Prop) =
        match prop with
        | AnimationPanel2Prop.AnimationState v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AnimationPanel2.AnimationStateProperty, box v)
