...
type MediaSliderProp =
    | MediaManager of DevExpress.Xpf.Controls.MediaManager

module MediaSlider =
    let mediaManager v : obj = box (MediaSliderProp.MediaManager v)

    let apply (el: DevExpress.Xpf.Controls.MediaSlider) (prop: MediaSliderProp) =
        match prop with
        | MediaSliderProp.MediaManager v -> el.SetValue(DevExpress.Xpf.Controls.MediaSlider.MediaManagerProperty, box v)
