...
type ClassicQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ClassicQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ClassicQuarterTopLeftArcScaleBackgroundLayerControl) (prop: ClassicQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | ClassicQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ClassicQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
