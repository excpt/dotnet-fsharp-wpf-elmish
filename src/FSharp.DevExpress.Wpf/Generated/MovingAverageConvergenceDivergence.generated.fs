...
type MovingAverageConvergenceDivergenceProp =
    | Base of SeparatePaneIndicatorProp
    | LongPeriod of int
    | ShortPeriod of int
    | SignalSmoothingPeriod of int
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel

module MovingAverageConvergenceDivergence =
    let longPeriod v : obj = box (MovingAverageConvergenceDivergenceProp.LongPeriod v)
    let shortPeriod v : obj = box (MovingAverageConvergenceDivergenceProp.ShortPeriod v)
    let signalSmoothingPeriod v : obj = box (MovingAverageConvergenceDivergenceProp.SignalSmoothingPeriod v)
    let valueLevel v : obj = box (MovingAverageConvergenceDivergenceProp.ValueLevel v)

    let apply (el: DevExpress.Xpf.Charts.MovingAverageConvergenceDivergence) (prop: MovingAverageConvergenceDivergenceProp) =
        match prop with
        | MovingAverageConvergenceDivergenceProp.Base p -> SeparatePaneIndicator.apply el p
        | MovingAverageConvergenceDivergenceProp.LongPeriod v -> el.SetValue(DevExpress.Xpf.Charts.MovingAverageConvergenceDivergence.LongPeriodProperty, box v)
        | MovingAverageConvergenceDivergenceProp.ShortPeriod v -> el.SetValue(DevExpress.Xpf.Charts.MovingAverageConvergenceDivergence.ShortPeriodProperty, box v)
        | MovingAverageConvergenceDivergenceProp.SignalSmoothingPeriod v -> el.SetValue(DevExpress.Xpf.Charts.MovingAverageConvergenceDivergence.SignalSmoothingPeriodProperty, box v)
        | MovingAverageConvergenceDivergenceProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.MovingAverageConvergenceDivergence.ValueLevelProperty, box v)

    let pane v : obj = box (SeparatePaneIndicatorProp.Pane v)
    let axisY v : obj = box (SeparatePaneIndicatorProp.AxisY v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.MovingAverageConvergenceDivergence>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
