...
type ImageEditPasteToolButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditPasteToolButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditPasteToolButton) (prop: ImageEditPasteToolButtonProp) =
        match prop with
        | ImageEditPasteToolButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditPasteToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
