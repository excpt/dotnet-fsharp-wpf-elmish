...
type ScrollablePanelProp =
    | Base of psvPanelProp

module ScrollablePanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.ScrollablePanel) (prop: ScrollablePanelProp) =
        match prop with
        | ScrollablePanelProp.Base p -> psvPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.ScrollablePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
