...
module ArgumentAxis3D =
    ...
    let apply (el: DevExpress.Xpf.Charts.ArgumentAxis3D) (prop: ArgumentAxis3DProp) =
        match prop with
        | ArgumentAxis3DProp.Base p -> Axis3DBase.apply el p
        | ArgumentAxis3DProp.DateTimeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.ArgumentAxis3D.DateTimeScaleOptionsProperty, box v)
        | ArgumentAxis3DProp.TimeSpanScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.ArgumentAxis3D.TimeSpanScaleOptionsProperty, box v)
        | ArgumentAxis3DProp.NumericScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.ArgumentAxis3D.NumericScaleOptionsProperty, box v)
        | ArgumentAxis3DProp.QualitativeScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.ArgumentAxis3D.QualitativeScaleOptionsProperty, box v)
