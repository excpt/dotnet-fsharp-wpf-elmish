...
type FilterControlBarManagerProp =
    | Base of BarManagerProp

module FilterControlBarManager =

    let apply (el: DevExpress.Xpf.Editors.Filtering.FilterControlBarManager) (prop: FilterControlBarManagerProp) =
        match prop with
        | FilterControlBarManagerProp.Base p -> BarManager.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Filtering.FilterControlBarManager>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
