...
type VisualDayViewGroupByNoneProp =
    | Base of VisualDayViewResourcesBasedViewInfoProp

module VisualDayViewGroupByNone =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByNone) (prop: VisualDayViewGroupByNoneProp) =
        match prop with
        | VisualDayViewGroupByNoneProp.Base p -> VisualDayViewResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDayViewGroupByNone>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
