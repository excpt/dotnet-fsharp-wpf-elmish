...
type GlyphPresenterProp =
    | GlyphSize of obj
    | GlyphStretch of System.Windows.Media.Stretch

module GlyphPresenter =
    let glyphSize v : obj = box (GlyphPresenterProp.GlyphSize v)
    let glyphStretch v : obj = box (GlyphPresenterProp.GlyphStretch v)

    let apply (el: DevExpress.Xpf.Accordion.GlyphPresenter) (prop: GlyphPresenterProp) =
        match prop with
        | GlyphPresenterProp.GlyphSize v -> el.SetValue(DevExpress.Xpf.Accordion.GlyphPresenter.GlyphSizeProperty, box v)
        | GlyphPresenterProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.Accordion.GlyphPresenter.GlyphStretchProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.GlyphPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
