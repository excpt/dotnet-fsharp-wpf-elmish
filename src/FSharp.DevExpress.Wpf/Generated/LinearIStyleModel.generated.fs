...
type LinearIStyleModelProp =
    | Base of LinearGaugeModelProp

module LinearIStyleModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearIStyleModel) (prop: LinearIStyleModelProp) =
        match prop with
        | LinearIStyleModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearIStyleModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
