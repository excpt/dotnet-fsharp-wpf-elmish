...
type YellowSubmarineSpindleCapControlProp =
    | Base of PresentationControlProp

module YellowSubmarineSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.YellowSubmarineSpindleCapControl) (prop: YellowSubmarineSpindleCapControlProp) =
        match prop with
        | YellowSubmarineSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.YellowSubmarineSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
