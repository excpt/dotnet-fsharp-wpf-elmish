...
type DocumentTabHeaderControlBoxControlProp =
    | Base of BaseControlBoxControlProp
    | PinButtonTemplate of System.Windows.DataTemplate

module DocumentTabHeaderControlBoxControl =
    let pinButtonTemplate v : obj = box (DocumentTabHeaderControlBoxControlProp.PinButtonTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.DocumentTabHeaderControlBoxControl) (prop: DocumentTabHeaderControlBoxControlProp) =
        match prop with
        | DocumentTabHeaderControlBoxControlProp.Base p -> BaseControlBoxControl.apply el p
        | DocumentTabHeaderControlBoxControlProp.PinButtonTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DocumentTabHeaderControlBoxControl.PinButtonTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DocumentTabHeaderControlBoxControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
