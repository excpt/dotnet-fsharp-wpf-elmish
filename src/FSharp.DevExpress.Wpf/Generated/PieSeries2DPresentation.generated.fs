...
type PieSeries2DPresentationProp =
    | Base of SeriesPresentationBaseProp

module PieSeries2DPresentation =

    let apply (el: DevExpress.Xpf.Charts.PieSeries2DPresentation) (prop: PieSeries2DPresentationProp) =
        match prop with
        | PieSeries2DPresentationProp.Base p -> SeriesPresentationBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PieSeries2DPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
