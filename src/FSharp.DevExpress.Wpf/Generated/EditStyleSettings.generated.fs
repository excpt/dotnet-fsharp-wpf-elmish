...
type EditStyleSettingsProp =
    | Base of BaseEditStyleSettingsProp

module EditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.EditStyleSettings) (prop: EditStyleSettingsProp) =
        match prop with
        | EditStyleSettingsProp.Base p -> BaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.EditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
