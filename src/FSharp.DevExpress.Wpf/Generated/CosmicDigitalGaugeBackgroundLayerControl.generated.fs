...
type CosmicDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicDigitalGaugeBackgroundLayerControl) (prop: CosmicDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | CosmicDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
