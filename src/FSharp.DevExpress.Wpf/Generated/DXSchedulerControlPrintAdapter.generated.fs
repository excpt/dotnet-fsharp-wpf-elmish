...
type DXSchedulerControlPrintAdapterProp =
    | Base of DXSchedulerPrintAdapterProp
    | SchedulerControl of DevExpress.Xpf.Scheduler.SchedulerControl

module DXSchedulerControlPrintAdapter =
    let schedulerControl v : obj = box (DXSchedulerControlPrintAdapterProp.SchedulerControl v)

    let apply (el: DevExpress.Xpf.Scheduler.Reporting.DXSchedulerControlPrintAdapter) (prop: DXSchedulerControlPrintAdapterProp) =
        match prop with
        | DXSchedulerControlPrintAdapterProp.Base p -> DXSchedulerPrintAdapter.apply el p
        | DXSchedulerControlPrintAdapterProp.SchedulerControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerControlPrintAdapter.SchedulerControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Reporting.DXSchedulerControlPrintAdapter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
