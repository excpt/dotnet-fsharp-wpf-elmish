...
type PdfThumbnailsViewerSettingsProp =
    | HideThumbnailsViewer of bool
    | ThumbnailsViewerState of DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerState
    | ThumbnailsViewerInitialState of obj
    | ThumbnailsViewerStyle of System.Windows.Style

module PdfThumbnailsViewerSettings =
    let hideThumbnailsViewer v : obj = box (PdfThumbnailsViewerSettingsProp.HideThumbnailsViewer v)
    let thumbnailsViewerState v : obj = box (PdfThumbnailsViewerSettingsProp.ThumbnailsViewerState v)
    let thumbnailsViewerInitialState v : obj = box (PdfThumbnailsViewerSettingsProp.ThumbnailsViewerInitialState v)
    let thumbnailsViewerStyle v : obj = box (PdfThumbnailsViewerSettingsProp.ThumbnailsViewerStyle v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings) (prop: PdfThumbnailsViewerSettingsProp) =
        match prop with
        | PdfThumbnailsViewerSettingsProp.HideThumbnailsViewer v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings.HideThumbnailsViewerProperty, box v)
        | PdfThumbnailsViewerSettingsProp.ThumbnailsViewerState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings.ThumbnailsViewerStateProperty, box v)
        | PdfThumbnailsViewerSettingsProp.ThumbnailsViewerInitialState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings.ThumbnailsViewerInitialStateProperty, box v)
        | PdfThumbnailsViewerSettingsProp.ThumbnailsViewerStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings.ThumbnailsViewerStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfThumbnailsViewerSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
