...
type DataValidationControlProp =
    | Base of ReferenceEditBaseControlProp

module DataValidationControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.DataValidationControl) (prop: DataValidationControlProp) =
        match prop with
        | DataValidationControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.DataValidationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
