...
type QueryParameterEditorProp =
    | EditValue of DevExpress.DataAccess.Sql.QueryParameter

module QueryParameterEditor =
    let editValue v : obj = box (QueryParameterEditorProp.EditValue v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.QueryParameterEditor) (prop: QueryParameterEditorProp) =
        match prop with
        | QueryParameterEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.QueryParameterEditor.EditValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.QueryParameterEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
