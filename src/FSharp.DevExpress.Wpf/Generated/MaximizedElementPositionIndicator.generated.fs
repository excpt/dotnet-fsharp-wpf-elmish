...
type MaximizedElementPositionIndicatorProp =
    | Base of ControlBaseProp

module MaximizedElementPositionIndicator =

    let apply (el: DevExpress.Xpf.LayoutControl.MaximizedElementPositionIndicator) (prop: MaximizedElementPositionIndicatorProp) =
        match prop with
        | MaximizedElementPositionIndicatorProp.Base p -> ControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.MaximizedElementPositionIndicator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
