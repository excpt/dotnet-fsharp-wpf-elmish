...
type EmptySpaceItemProp =
    | Base of FixedItemProp

module EmptySpaceItem =

    let apply (el: DevExpress.Xpf.Docking.EmptySpaceItem) (prop: EmptySpaceItemProp) =
        match prop with
        | EmptySpaceItemProp.Base p -> FixedItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.EmptySpaceItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
