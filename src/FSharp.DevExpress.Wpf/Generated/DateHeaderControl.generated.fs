...
type DateHeaderControlProp =
    | Base of HeaderControlProp

module DateHeaderControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DateHeaderControl) (prop: DateHeaderControlProp) =
        match prop with
        | DateHeaderControlProp.Base p -> HeaderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DateHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
