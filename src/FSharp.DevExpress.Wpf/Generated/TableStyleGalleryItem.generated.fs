...
open System
open System.Windows
open DevExpress.Xpf.Spreadsheet.UI
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TableStyleGalleryItemProp =
    | Spreadsheet of DevExpress.Xpf.Spreadsheet.SpreadsheetControl
    | StyleName of string

module TableStyleGalleryItem =
    let spreadsheet v : obj = box (TableStyleGalleryItemProp.Spreadsheet v)
    let styleName v : obj = box (TableStyleGalleryItemProp.StyleName v)

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.TableStyleGalleryItem) (prop: TableStyleGalleryItemProp) =
        match prop with
        | TableStyleGalleryItemProp.Spreadsheet v -> el.SetValue(DevExpress.Xpf.Spreadsheet.UI.TableStyleGalleryItem.SpreadsheetProperty, box v)
        | TableStyleGalleryItemProp.StyleName v -> el.SetValue(DevExpress.Xpf.Spreadsheet.UI.TableStyleGalleryItem.StyleNameProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.TableStyleGalleryItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
