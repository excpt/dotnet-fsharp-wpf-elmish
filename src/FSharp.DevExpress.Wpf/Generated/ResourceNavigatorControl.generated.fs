...
type ResourceNavigatorControlProp =
    | SchedulerControl of DevExpress.Xpf.Scheduler.SchedulerControl
    | FilteredResourcesCount of float
    | ResourcesPerPage of float
    | FirstVisibleResourceIndex of float
    | ButtonFirstStyle of System.Windows.Style
    | ButtonPrevPageStyle of System.Windows.Style
    | ButtonPrevStyle of System.Windows.Style
    | ButtonNextStyle of System.Windows.Style
    | ButtonNextPageStyle of System.Windows.Style
    | ButtonLastStyle of System.Windows.Style
    | ButtonIncCountStyle of System.Windows.Style
    | ButtonDecCountStyle of System.Windows.Style
    | CommandFirst of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandPrevPage of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandPrev of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandNext of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandNextPage of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandLast of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandIncCount of DevExpress.Xpf.Scheduler.SchedulerUICommand
    | CommandDecCount of DevExpress.Xpf.Scheduler.SchedulerUICommand

module ResourceNavigatorControl =
    let schedulerControl v : obj = box (ResourceNavigatorControlProp.SchedulerControl v)
    let filteredResourcesCount v : obj = box (ResourceNavigatorControlProp.FilteredResourcesCount v)
    let resourcesPerPage v : obj = box (ResourceNavigatorControlProp.ResourcesPerPage v)
    let firstVisibleResourceIndex v : obj = box (ResourceNavigatorControlProp.FirstVisibleResourceIndex v)
    let buttonFirstStyle v : obj = box (ResourceNavigatorControlProp.ButtonFirstStyle v)
    let buttonPrevPageStyle v : obj = box (ResourceNavigatorControlProp.ButtonPrevPageStyle v)
    let buttonPrevStyle v : obj = box (ResourceNavigatorControlProp.ButtonPrevStyle v)
    let buttonNextStyle v : obj = box (ResourceNavigatorControlProp.ButtonNextStyle v)
    let buttonNextPageStyle v : obj = box (ResourceNavigatorControlProp.ButtonNextPageStyle v)
    let buttonLastStyle v : obj = box (ResourceNavigatorControlProp.ButtonLastStyle v)
    let buttonIncCountStyle v : obj = box (ResourceNavigatorControlProp.ButtonIncCountStyle v)
    let buttonDecCountStyle v : obj = box (ResourceNavigatorControlProp.ButtonDecCountStyle v)
    let commandFirst v : obj = box (ResourceNavigatorControlProp.CommandFirst v)
    let commandPrevPage v : obj = box (ResourceNavigatorControlProp.CommandPrevPage v)
    let commandPrev v : obj = box (ResourceNavigatorControlProp.CommandPrev v)
    let commandNext v : obj = box (ResourceNavigatorControlProp.CommandNext v)
    let commandNextPage v : obj = box (ResourceNavigatorControlProp.CommandNextPage v)
    let commandLast v : obj = box (ResourceNavigatorControlProp.CommandLast v)
    let commandIncCount v : obj = box (ResourceNavigatorControlProp.CommandIncCount v)
    let commandDecCount v : obj = box (ResourceNavigatorControlProp.CommandDecCount v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl) (prop: ResourceNavigatorControlProp) =
        match prop with
        | ResourceNavigatorControlProp.SchedulerControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.SchedulerControlProperty, box v)
        | ResourceNavigatorControlProp.FilteredResourcesCount v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.FilteredResourcesCountProperty, box v)
        | ResourceNavigatorControlProp.ResourcesPerPage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ResourcesPerPageProperty, box v)
        | ResourceNavigatorControlProp.FirstVisibleResourceIndex v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.FirstVisibleResourceIndexProperty, box v)
        | ResourceNavigatorControlProp.ButtonFirstStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonFirstStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonPrevPageStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonPrevPageStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonPrevStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonPrevStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonNextStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonNextStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonNextPageStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonNextPageStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonLastStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonLastStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonIncCountStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonIncCountStyleProperty, box v)
        | ResourceNavigatorControlProp.ButtonDecCountStyle v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.ButtonDecCountStyleProperty, box v)
        | ResourceNavigatorControlProp.CommandFirst v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandFirstProperty, box v)
        | ResourceNavigatorControlProp.CommandPrevPage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandPrevPageProperty, box v)
        | ResourceNavigatorControlProp.CommandPrev v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandPrevProperty, box v)
        | ResourceNavigatorControlProp.CommandNext v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandNextProperty, box v)
        | ResourceNavigatorControlProp.CommandNextPage v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandNextPageProperty, box v)
        | ResourceNavigatorControlProp.CommandLast v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandLastProperty, box v)
        | ResourceNavigatorControlProp.CommandIncCount v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandIncCountProperty, box v)
        | ResourceNavigatorControlProp.CommandDecCount v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl.CommandDecCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.ResourceNavigatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
