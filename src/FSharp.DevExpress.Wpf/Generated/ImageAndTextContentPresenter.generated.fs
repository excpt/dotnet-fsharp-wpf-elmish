...
type ImageAndTextContentPresenterProp =
    | Base of XPFContentPresenterProp
    | Orientation of System.Windows.Controls.Orientation
    | ContextElement of obj

module ImageAndTextContentPresenter =
    let orientation v : obj = box (ImageAndTextContentPresenterProp.Orientation v)
    let contextElement v : obj = box (ImageAndTextContentPresenterProp.ContextElement v)

    let apply (el: DevExpress.Xpf.NavBar.ImageAndTextContentPresenter) (prop: ImageAndTextContentPresenterProp) =
        match prop with
        | ImageAndTextContentPresenterProp.Base p -> XPFContentPresenter.apply el p
        | ImageAndTextContentPresenterProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextContentPresenter.OrientationProperty, box v)
        | ImageAndTextContentPresenterProp.ContextElement v -> el.SetValue(DevExpress.Xpf.NavBar.ImageAndTextContentPresenter.ContextElementProperty, box v)

    let foreground v : obj = box (XPFContentPresenterProp.Foreground v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ImageAndTextContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
