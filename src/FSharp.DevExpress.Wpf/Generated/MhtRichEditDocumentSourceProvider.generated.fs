...
type MhtRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module MhtRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.MhtRichEditDocumentSourceProvider) (prop: MhtRichEditDocumentSourceProviderProp) =
        match prop with
        | MhtRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.MhtRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
