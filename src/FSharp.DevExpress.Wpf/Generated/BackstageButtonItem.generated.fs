...
type BackstageButtonItemProp =
    | Base of BackstageItemWithImageProp
    | Command of System.Windows.Input.ICommand
    | CommandTarget of System.Windows.IInputElement
    | CommandParameter of obj
    | KeyGesture of System.Windows.Input.KeyGesture

module BackstageButtonItem =
    let command v : obj = box (BackstageButtonItemProp.Command v)
    let commandTarget v : obj = box (BackstageButtonItemProp.CommandTarget v)
    let commandParameter v : obj = box (BackstageButtonItemProp.CommandParameter v)
    let keyGesture v : obj = box (BackstageButtonItemProp.KeyGesture v)

    let apply (el: DevExpress.Xpf.Ribbon.BackstageButtonItem) (prop: BackstageButtonItemProp) =
        match prop with
        | BackstageButtonItemProp.Base p -> BackstageItemWithImage.apply el p
        | BackstageButtonItemProp.Command v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageButtonItem.CommandProperty, box v)
        | BackstageButtonItemProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageButtonItem.CommandTargetProperty, box v)
        | BackstageButtonItemProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageButtonItem.CommandParameterProperty, box v)
        | BackstageButtonItemProp.KeyGesture v -> el.SetValue(DevExpress.Xpf.Ribbon.BackstageButtonItem.KeyGestureProperty, box v)

    let glyph v : obj = box (BackstageItemWithImageProp.Glyph v)
    let glyphContainerStyle v : obj = box (BackstageItemWithImageProp.GlyphContainerStyle v)
    let glyphStyle v : obj = box (BackstageItemWithImageProp.GlyphStyle v)
    let content v : obj = box (BackstageItemProp.Content v)
    let contentTemplate v : obj = box (BackstageItemProp.ContentTemplate v)
    let ribbonStyle v : obj = box (BackstageItemProp.RibbonStyle v)
    let keyTip v : obj = box (BackstageItemProp.KeyTip v)
    let backstage v : obj = box (BackstageItemBaseProp.Backstage v)
    let borderStyle v : obj = box (BackstageItemBaseProp.BorderStyle v)
    let normalTextStyle v : obj = box (BackstageItemBaseProp.NormalTextStyle v)
    let hoverTextStyle v : obj = box (BackstageItemBaseProp.HoverTextStyle v)
    let contentStyle v : obj = box (BackstageItemBaseProp.ContentStyle v)
    let mergeOrder v : obj = box (BackstageItemBaseProp.MergeOrder v)
    let mergeType v : obj = box (BackstageItemBaseProp.MergeType v)
    let placement v : obj = box (BackstageItemBaseProp.Placement v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.BackstageButtonItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
