...
type RichEditViewPageContentControlProp =
    | CommentsWidth of float
    | CommentsVisibility of System.Windows.Visibility

module RichEditViewPageContentControl =
    let commentsWidth v : obj = box (RichEditViewPageContentControlProp.CommentsWidth v)
    let commentsVisibility v : obj = box (RichEditViewPageContentControlProp.CommentsVisibility v)

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPageContentControl) (prop: RichEditViewPageContentControlProp) =
        match prop with
        | RichEditViewPageContentControlProp.CommentsWidth v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPageContentControl.CommentsWidthProperty, box v)
        | RichEditViewPageContentControlProp.CommentsVisibility v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPageContentControl.CommentsVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RichEditViewPageContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
