...
type DialogTilesViewProp =
    | Base of DialogIconsViewBaseProp

module DialogTilesView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogTilesView) (prop: DialogTilesViewProp) =
        match prop with
        | DialogTilesViewProp.Base p -> DialogIconsViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogTilesView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
