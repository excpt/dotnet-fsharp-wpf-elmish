...
type ListBoxDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module ListBoxDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.ListBoxDashboardLayoutItem) (prop: ListBoxDashboardLayoutItemProp) =
        match prop with
        | ListBoxDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.ListBoxDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
