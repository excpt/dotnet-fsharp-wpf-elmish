...
type TimelineStandardModeGroupPanelProp =
    | Base of TimelineAutoHeightGroupPanelBaseProp

module TimelineStandardModeGroupPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupPanel) (prop: TimelineStandardModeGroupPanelProp) =
        match prop with
        | TimelineStandardModeGroupPanelProp.Base p -> TimelineAutoHeightGroupPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineStandardModeGroupPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
