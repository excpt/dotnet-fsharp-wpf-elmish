...
type AxisBaseProp =
    ...
    | MinorCount of int
    | NumericOptions of DevExpress.Xpf.Charts.NumericOptions
    | GridLinesVisible of bool
    | GridLinesMinorVisible of bool
    | GridLinesLineStyle of DevExpress.Xpf.Charts.LineStyle
    | GridLinesMinorLineStyle of DevExpress.Xpf.Charts.LineStyle
    | GridLinesBrush of System.Windows.Media.Brush
    | GridLinesMinorBrush of System.Windows.Media.Brush
    | Interlaced of bool
    | InterlacedBrush of System.Windows.Media.Brush
    | Label of DevExpress.Xpf.Charts.AxisLabel
    | QualitativeScaleComparer of System.Collections.IComparer
...
module AxisBase =
    ...
    let apply (el: DevExpress.Xpf.Charts.AxisBase) (prop: AxisBaseProp) =
        match prop with
        | AxisBaseProp.Base p -> ChartElement.apply el p
        | AxisBaseProp.MinorCount v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.MinorCountProperty, box v)
        | AxisBaseProp.NumericOptions v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.NumericOptionsProperty, box v)
        | AxisBaseProp.GridLinesVisible v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.GridLinesVisibleProperty, box v)
        | AxisBaseProp.GridLinesMinorVisible v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.GridLinesMinorVisibleProperty, box v)
        | AxisBaseProp.GridLinesLineStyle v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.GridLinesLineStyleProperty, box v)
        | AxisBaseProp.GridLinesMinorLineStyle v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.GridLinesMinorLineStyleProperty, box v)
        | AxisBaseProp.GridLinesBrush v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.GridLinesBrushProperty, box v)
        | AxisBaseProp.GridLinesMinorBrush v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.GridLinesMinorBrushProperty, box v)
        | AxisBaseProp.Interlaced v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.InterlacedProperty, box v)
        | AxisBaseProp.InterlacedBrush v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.InterlacedBrushProperty, box v)
        | AxisBaseProp.Label v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.LabelProperty, box v)
        | AxisBaseProp.QualitativeScaleComparer v -> el.SetValue(DevExpress.Xpf.Charts.AxisBase.QualitativeScaleComparerProperty, box v)
