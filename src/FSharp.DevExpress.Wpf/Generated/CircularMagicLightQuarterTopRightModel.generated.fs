...
type CircularMagicLightQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularMagicLightQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularMagicLightQuarterTopRightModel) (prop: CircularMagicLightQuarterTopRightModelProp) =
        match prop with
        | CircularMagicLightQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularMagicLightQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
