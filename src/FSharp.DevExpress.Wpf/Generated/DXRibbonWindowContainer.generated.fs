...
type DXRibbonWindowContainerProp =
    | IsActive of bool
    | IsStatusBarVisible of bool
    | IsHeaderVisible of bool
    | Icon of System.Windows.Media.ImageSource
    | Caption of string
    | IsMaximizeButtonVisible of bool
    | IsMinimizeButtonVisible of bool
    | IsRestoreButtonVisible of bool
    | IsCloseButtonVisible of bool
    | IsAeroMode of bool
    | AeroTemplate of System.Windows.Controls.ControlTemplate

module DXRibbonWindowContainer =
    let isActive v : obj = box (DXRibbonWindowContainerProp.IsActive v)
    let isStatusBarVisible v : obj = box (DXRibbonWindowContainerProp.IsStatusBarVisible v)
    let isHeaderVisible v : obj = box (DXRibbonWindowContainerProp.IsHeaderVisible v)
    let icon v : obj = box (DXRibbonWindowContainerProp.Icon v)
    let caption v : obj = box (DXRibbonWindowContainerProp.Caption v)
    let isMaximizeButtonVisible v : obj = box (DXRibbonWindowContainerProp.IsMaximizeButtonVisible v)
    let isMinimizeButtonVisible v : obj = box (DXRibbonWindowContainerProp.IsMinimizeButtonVisible v)
    let isRestoreButtonVisible v : obj = box (DXRibbonWindowContainerProp.IsRestoreButtonVisible v)
    let isCloseButtonVisible v : obj = box (DXRibbonWindowContainerProp.IsCloseButtonVisible v)
    let isAeroMode v : obj = box (DXRibbonWindowContainerProp.IsAeroMode v)
    let aeroTemplate v : obj = box (DXRibbonWindowContainerProp.AeroTemplate v)

    let apply (el: DevExpress.Xpf.Ribbon.DXRibbonWindowContainer) (prop: DXRibbonWindowContainerProp) =
        match prop with
        | DXRibbonWindowContainerProp.IsActive v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsActiveProperty, box v)
        | DXRibbonWindowContainerProp.IsStatusBarVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsStatusBarVisibleProperty, box v)
        | DXRibbonWindowContainerProp.IsHeaderVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsHeaderVisibleProperty, box v)
        | DXRibbonWindowContainerProp.Icon v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IconProperty, box v)
        | DXRibbonWindowContainerProp.Caption v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.CaptionProperty, box v)
        | DXRibbonWindowContainerProp.IsMaximizeButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsMaximizeButtonVisibleProperty, box v)
        | DXRibbonWindowContainerProp.IsMinimizeButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsMinimizeButtonVisibleProperty, box v)
        | DXRibbonWindowContainerProp.IsRestoreButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsRestoreButtonVisibleProperty, box v)
        | DXRibbonWindowContainerProp.IsCloseButtonVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsCloseButtonVisibleProperty, box v)
        | DXRibbonWindowContainerProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.IsAeroModeProperty, box v)
        | DXRibbonWindowContainerProp.AeroTemplate v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowContainer.AeroTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.DXRibbonWindowContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
