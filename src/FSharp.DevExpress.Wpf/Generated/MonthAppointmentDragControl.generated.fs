...
type MonthAppointmentDragControlProp =
    | Base of MonthAppointmentControlProp

module MonthAppointmentDragControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthAppointmentDragControl) (prop: MonthAppointmentDragControlProp) =
        match prop with
        | MonthAppointmentDragControlProp.Base p -> MonthAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MonthAppointmentDragControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
