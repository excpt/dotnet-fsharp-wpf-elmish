...
type TreeMapItemsControlProp =
    | ParentItem of obj

module TreeMapItemsControl =
    let parentItem v : obj = box (TreeMapItemsControlProp.ParentItem v)

    let apply (el: DevExpress.Xpf.TreeMap.TreeMapItemsControl) (prop: TreeMapItemsControlProp) =
        match prop with
        | TreeMapItemsControlProp.ParentItem v -> el.SetValue(DevExpress.Xpf.TreeMap.TreeMapItemsControl.ParentItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.TreeMapItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
