...
module CellEditor =
    ...
    let apply (el: DevExpress.Xpf.Grid.CellEditor) (prop: CellEditorProp) =
        match prop with
        | CellEditorProp.Base p -> CellEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.CellEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
