...
type WcfCollectionViewSourceProp =
    | Base of CollectionViewDataSourceBaseProp
    | ServiceRoot of System.Uri

module WcfCollectionViewSource =
    let serviceRoot v : obj = box (WcfCollectionViewSourceProp.ServiceRoot v)

    let apply (el: DevExpress.Xpf.Core.DataSources.WcfCollectionViewSource) (prop: WcfCollectionViewSourceProp) =
        match prop with
        | WcfCollectionViewSourceProp.Base p -> CollectionViewDataSourceBase.apply el p
        | WcfCollectionViewSourceProp.ServiceRoot v -> el.SetValue(DevExpress.Xpf.Core.DataSources.WcfCollectionViewSource.ServiceRootProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.WcfCollectionViewSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
