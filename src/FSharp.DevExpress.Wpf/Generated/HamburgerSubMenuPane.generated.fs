...
type HamburgerSubMenuPaneProp =
    ...
    | IsBackButtonVisible of bool

module HamburgerSubMenuPane =
    let itemsSource v : obj = box (HamburgerSubMenuPaneProp.ItemsSource v)
    let header v : obj = box (HamburgerSubMenuPaneProp.Header v)
    let headerTemplate v : obj = box (HamburgerSubMenuPaneProp.HeaderTemplate v)
    let headerPadding v : obj = box (HamburgerSubMenuPaneProp.HeaderPadding v)
    let headerHeight v : obj = box (HamburgerSubMenuPaneProp.HeaderHeight v)
    let headerFontSize v : obj = box (HamburgerSubMenuPaneProp.HeaderFontSize v)
    let backCommand v : obj = box (HamburgerSubMenuPaneProp.BackCommand v)
    let isBackButtonVisible v : obj = box (HamburgerSubMenuPaneProp.IsBackButtonVisible v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane) (prop: HamburgerSubMenuPaneProp) =
        match prop with
        | HamburgerSubMenuPaneProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.ItemsSourceProperty, box v)
        | HamburgerSubMenuPaneProp.Header v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.HeaderProperty, box v)
        | HamburgerSubMenuPaneProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.HeaderTemplateProperty, box v)
        | HamburgerSubMenuPaneProp.HeaderPadding v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.HeaderPaddingProperty, box v)
        | HamburgerSubMenuPaneProp.HeaderHeight v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.HeaderHeightProperty, box v)
        | HamburgerSubMenuPaneProp.HeaderFontSize v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.HeaderFontSizeProperty, box v)
        | HamburgerSubMenuPaneProp.BackCommand v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.BackCommandProperty, box v)
        | HamburgerSubMenuPaneProp.IsBackButtonVisible v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane.IsBackButtonVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.HamburgerSubMenuPane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
