...
type FlatDarkArcScaleLineControlProp =
    | Base of PresentationControlProp

module FlatDarkArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkArcScaleLineControl) (prop: FlatDarkArcScaleLineControlProp) =
        match prop with
        | FlatDarkArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
