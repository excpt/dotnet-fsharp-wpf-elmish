...
type MagicLightLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module MagicLightLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightLinearScaleMarkerControl) (prop: MagicLightLinearScaleMarkerControlProp) =
        match prop with
        | MagicLightLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
