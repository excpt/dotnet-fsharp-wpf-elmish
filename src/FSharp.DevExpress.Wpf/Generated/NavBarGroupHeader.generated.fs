...
module NavBarGroupHeader =
    let navBarViewKind v : obj = box (NavBarGroupHeaderProp.NavBarViewKind v)
    let animationProgress v : obj = box (NavBarGroupHeaderProp.AnimationProgress v)
    let groupPosition v : obj = box (NavBarGroupHeaderProp.GroupPosition v)
    let showBorder v : obj = box (NavBarGroupHeaderProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarGroupHeader) (prop: NavBarGroupHeaderProp) =
        match prop with
        | NavBarGroupHeaderProp.NavBarViewKind v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupHeader.NavBarViewKindProperty, box v)
        | NavBarGroupHeaderProp.AnimationProgress v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupHeader.AnimationProgressProperty, box v)
        | NavBarGroupHeaderProp.GroupPosition v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupHeader.GroupPositionProperty, box v)
        | NavBarGroupHeaderProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupHeader.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
