...
type ImageEditPropertyProviderProp =
    | Base of ActualPropertyProviderProp
    | InplaceMenuVisibility of System.Windows.Visibility

module ImageEditPropertyProvider =
    let inplaceMenuVisibility v : obj = box (ImageEditPropertyProviderProp.InplaceMenuVisibility v)

    let apply (el: DevExpress.Xpf.Editors.ImageEditPropertyProvider) (prop: ImageEditPropertyProviderProp) =
        match prop with
        | ImageEditPropertyProviderProp.Base p -> ActualPropertyProvider.apply el p
        | ImageEditPropertyProviderProp.InplaceMenuVisibility v -> el.SetValue(DevExpress.Xpf.Editors.ImageEditPropertyProvider.InplaceMenuVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
