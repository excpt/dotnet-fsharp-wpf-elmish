...
type PdfCommentViewerSettingsProp =
    | HideCommentViewer of bool
    | CommentViewerState of DevExpress.Xpf.PdfViewer.PdfCommentViewerState
    | CommentViewerInitialState of obj
    | CommentViewerStyle of System.Windows.Style
    | HideAfterUse of obj
    | Sort of DevExpress.Pdf.PdfCommentSortMode
    | Filter of DevExpress.Pdf.PdfCommentFilter
    | AllowCommentReplies of bool

module PdfCommentViewerSettings =
    let hideCommentViewer v : obj = box (PdfCommentViewerSettingsProp.HideCommentViewer v)
    let commentViewerState v : obj = box (PdfCommentViewerSettingsProp.CommentViewerState v)
    let commentViewerInitialState v : obj = box (PdfCommentViewerSettingsProp.CommentViewerInitialState v)
    let commentViewerStyle v : obj = box (PdfCommentViewerSettingsProp.CommentViewerStyle v)
    let hideAfterUse v : obj = box (PdfCommentViewerSettingsProp.HideAfterUse v)
    let sort v : obj = box (PdfCommentViewerSettingsProp.Sort v)
    let filter v : obj = box (PdfCommentViewerSettingsProp.Filter v)
    let allowCommentReplies v : obj = box (PdfCommentViewerSettingsProp.AllowCommentReplies v)

    let apply (el: DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings) (prop: PdfCommentViewerSettingsProp) =
        match prop with
        | PdfCommentViewerSettingsProp.HideCommentViewer v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.HideCommentViewerProperty, box v)
        | PdfCommentViewerSettingsProp.CommentViewerState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.CommentViewerStateProperty, box v)
        | PdfCommentViewerSettingsProp.CommentViewerInitialState v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.CommentViewerInitialStateProperty, box v)
        | PdfCommentViewerSettingsProp.CommentViewerStyle v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.CommentViewerStyleProperty, box v)
        | PdfCommentViewerSettingsProp.HideAfterUse v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.HideAfterUseProperty, box v)
        | PdfCommentViewerSettingsProp.Sort v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.SortProperty, box v)
        | PdfCommentViewerSettingsProp.Filter v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.FilterProperty, box v)
        | PdfCommentViewerSettingsProp.AllowCommentReplies v -> el.SetValue(DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings.AllowCommentRepliesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfCommentViewerSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
