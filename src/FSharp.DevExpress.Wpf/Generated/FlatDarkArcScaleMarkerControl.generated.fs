...
type FlatDarkArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FlatDarkArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkArcScaleMarkerControl) (prop: FlatDarkArcScaleMarkerControlProp) =
        match prop with
        | FlatDarkArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
