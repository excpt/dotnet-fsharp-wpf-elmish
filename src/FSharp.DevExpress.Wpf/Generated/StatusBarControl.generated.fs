...
type StatusBarControlProp =
    | Base of ToolBarControlBaseProp
    | ShowSizeGrip of bool

module StatusBarControl =
    let showSizeGrip v : obj = box (StatusBarControlProp.ShowSizeGrip v)

    let apply (el: DevExpress.Xpf.Bars.StatusBarControl) (prop: StatusBarControlProp) =
        match prop with
        | StatusBarControlProp.Base p -> ToolBarControlBase.apply el p
        | StatusBarControlProp.ShowSizeGrip v -> el.SetValue(DevExpress.Xpf.Bars.StatusBarControl.ShowSizeGripProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.StatusBarControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
