...
type DateEditNavigatorStyleSettingsProp =
    | Base of DateEditStyleSettingsBaseProp

module DateEditNavigatorStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.DateEditNavigatorStyleSettings) (prop: DateEditNavigatorStyleSettingsProp) =
        match prop with
        | DateEditNavigatorStyleSettingsProp.Base p -> DateEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateEditNavigatorStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
