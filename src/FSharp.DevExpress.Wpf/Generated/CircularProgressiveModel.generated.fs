...
type CircularProgressiveModelProp =
    | Base of CircularGaugeModelProp

module CircularProgressiveModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularProgressiveModel) (prop: CircularProgressiveModelProp) =
        match prop with
        | CircularProgressiveModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularProgressiveModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
