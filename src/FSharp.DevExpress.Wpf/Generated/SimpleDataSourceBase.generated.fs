...
type SimpleDataSourceBaseProp =
    | Base of DXDesignTimeControlProp

module SimpleDataSourceBase =

    let apply (el: DevExpress.Xpf.Core.DataSources.SimpleDataSourceBase) (prop: SimpleDataSourceBaseProp) =
        match prop with
        | SimpleDataSourceBaseProp.Base p -> DXDesignTimeControl.apply el p
