...
module CellBorder =
    ...
    let apply (el: DevExpress.Xpf.Scheduler.Drawing.CellBorder) (prop: CellBorderProp) =
        match prop with
        | CellBorderProp.Base p -> HeaderBorder.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.CellBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
