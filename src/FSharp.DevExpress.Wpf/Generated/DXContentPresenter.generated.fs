...
type DXContentPresenterProp =
    | Content of obj
    | ContentTemplate of System.Windows.DataTemplate

module DXContentPresenter =
    ...
    let apply (el: DevExpress.Xpf.Core.DXContentPresenter) (prop: DXContentPresenterProp) =
        match prop with
        | DXContentPresenterProp.Content v -> el.SetValue(DevExpress.Xpf.Core.DXContentPresenter.ContentProperty, box v)
        | DXContentPresenterProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Core.DXContentPresenter.ContentTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DXContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
