...
type StateIndicatorModelProp =
    | Base of GaugeModelBaseProp

module StateIndicatorModel =

    let apply (el: DevExpress.Xpf.Gauges.StateIndicatorModel) (prop: StateIndicatorModelProp) =
        match prop with
        | StateIndicatorModelProp.Base p -> GaugeModelBase.apply el p
