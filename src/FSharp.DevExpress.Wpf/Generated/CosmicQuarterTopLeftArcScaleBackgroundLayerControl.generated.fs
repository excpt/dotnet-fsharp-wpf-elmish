...
type CosmicQuarterTopLeftArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicQuarterTopLeftArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicQuarterTopLeftArcScaleBackgroundLayerControl) (prop: CosmicQuarterTopLeftArcScaleBackgroundLayerControlProp) =
        match prop with
        | CosmicQuarterTopLeftArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicQuarterTopLeftArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
