...
type SmartMinorTickmarkControlProp =
    | Base of PresentationControlProp

module SmartMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartMinorTickmarkControl) (prop: SmartMinorTickmarkControlProp) =
        match prop with
        | SmartMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
