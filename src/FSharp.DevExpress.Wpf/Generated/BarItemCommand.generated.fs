...
module BarItemCommand =
    let command v : obj = box (BarItemCommandProp.Command v)
    let commandParameter v : obj = box (BarItemCommandProp.CommandParameter v)
    let commandTarget v : obj = box (BarItemCommandProp.CommandTarget v)
    let keyGesture v : obj = box (BarItemCommandProp.KeyGesture v)

    let apply (el: DevExpress.Xpf.Bars.BarItemCommand) (prop: BarItemCommandProp) =
        match prop with
        | BarItemCommandProp.Command v -> el.SetValue(DevExpress.Xpf.Bars.BarItemCommand.CommandProperty, box v)
        | BarItemCommandProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.Bars.BarItemCommand.CommandParameterProperty, box v)
        | BarItemCommandProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.Bars.BarItemCommand.CommandTargetProperty, box v)
        | BarItemCommandProp.KeyGesture v -> el.SetValue(DevExpress.Xpf.Bars.BarItemCommand.KeyGestureProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarItemCommand>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
