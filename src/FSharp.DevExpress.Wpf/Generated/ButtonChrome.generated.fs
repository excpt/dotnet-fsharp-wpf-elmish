...
module ButtonChrome =
    ...
    let apply (el: DevExpress.Xpf.Core.Native.ButtonChrome) (prop: ButtonChromeProp) =
        match prop with
        | ButtonChromeProp.Base p -> Chrome.apply el p
        | ButtonChromeProp.IsDefaulted v -> el.SetValue(DevExpress.Xpf.Core.Native.ButtonChrome.IsDefaultedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ButtonChrome>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
