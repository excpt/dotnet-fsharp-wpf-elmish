...
type ThemeableQuarterTopRightArcScaleBackgroundLayerControlProp =
    | Base of ThemeableArcScaleBackgroundLayerControlBaseProp

module ThemeableQuarterTopRightArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ThemeableQuarterTopRightArcScaleBackgroundLayerControl) (prop: ThemeableQuarterTopRightArcScaleBackgroundLayerControlProp) =
        match prop with
        | ThemeableQuarterTopRightArcScaleBackgroundLayerControlProp.Base p -> ThemeableArcScaleBackgroundLayerControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableQuarterTopRightArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
