...
type FloatingWindowPresenterProp =
    | Base of FloatPanePresenterProp

module FloatingWindowPresenter =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatingWindowPresenter) (prop: FloatingWindowPresenterProp) =
        match prop with
        | FloatingWindowPresenterProp.Base p -> FloatPanePresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FloatingWindowPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
