...
type SimpleDataSourceProp =
    | Base of EnumerableDataSourceBaseProp

module SimpleDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.SimpleDataSource) (prop: SimpleDataSourceProp) =
        match prop with
        | SimpleDataSourceProp.Base p -> EnumerableDataSourceBase.apply el p
