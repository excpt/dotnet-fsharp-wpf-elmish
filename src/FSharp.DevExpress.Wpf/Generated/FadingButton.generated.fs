...
type FadingButtonProp =
    | Base of DirectionButtonProp

module FadingButton =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.FadingButton) (prop: FadingButtonProp) =
        match prop with
        | FadingButtonProp.Base p -> DirectionButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.FadingButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
