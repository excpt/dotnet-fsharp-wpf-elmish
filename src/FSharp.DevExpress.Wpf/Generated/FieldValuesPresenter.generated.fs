...
type FieldValuesPresenterProp =
    | Base of ScrollableAreaPresenterProp
    | IsColumn of bool
    | CurrentWidth of float

module FieldValuesPresenter =
    ...
    let apply (el: DevExpress.Xpf.PivotGrid.Internal.FieldValuesPresenter) (prop: FieldValuesPresenterProp) =
        match prop with
        | FieldValuesPresenterProp.Base p -> ScrollableAreaPresenter.apply el p
        | FieldValuesPresenterProp.IsColumn v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldValuesPresenter.IsColumnProperty, box v)
        | FieldValuesPresenterProp.CurrentWidth v -> el.SetValue(DevExpress.Xpf.PivotGrid.Internal.FieldValuesPresenter.CurrentWidthProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.FieldValuesPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
