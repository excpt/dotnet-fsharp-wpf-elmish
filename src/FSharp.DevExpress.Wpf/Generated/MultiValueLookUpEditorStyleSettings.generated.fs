...
type MultiValueLookUpEditorStyleSettingsProp =
    | Base of CheckedTokenComboBoxStyleSettingsProp

module MultiValueLookUpEditorStyleSettings =

    let apply (el: DevExpress.Xpf.Printing.Native.MultiValueLookUpEditorStyleSettings) (prop: MultiValueLookUpEditorStyleSettingsProp) =
        match prop with
        | MultiValueLookUpEditorStyleSettingsProp.Base p -> CheckedTokenComboBoxStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.MultiValueLookUpEditorStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
