...
module TitleBase =
    ...
    let visible v : obj = box (TitleBaseProp.Visible v)

    let apply (el: DevExpress.Xpf.Charts.TitleBase) (prop: TitleBaseProp) =
        match prop with
        | TitleBaseProp.Base p -> ChartElement.apply el p
        | TitleBaseProp.Content v -> el.SetValue(DevExpress.Xpf.Charts.TitleBase.ContentProperty, box v)
        | TitleBaseProp.ContentTemplate v -> el.SetValue(DevExpress.Xpf.Charts.TitleBase.ContentTemplateProperty, box v)
        | TitleBaseProp.Visible v -> el.SetValue(DevExpress.Xpf.Charts.TitleBase.VisibleProperty, box v)
