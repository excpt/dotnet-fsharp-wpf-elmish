...
type TimelineViewPanelGroupByNoneProp =
    | Base of TimelineViewLayoutPanelProp

module TimelineViewPanelGroupByNone =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.TimelineViewPanelGroupByNone) (prop: TimelineViewPanelGroupByNoneProp) =
        match prop with
        | TimelineViewPanelGroupByNoneProp.Base p -> TimelineViewLayoutPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.TimelineViewPanelGroupByNone>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
