...
type TimeRegionDecorationPanelBaseProp =
    | Base of TimeRegionPanelBaseProp
    | StretchDirection of DevExpress.Xpf.Scheduling.Panels.TimeRegionBrushStretchDirection
    | DrawDefaultDecoration of bool

module TimeRegionDecorationPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimeRegionDecorationPanelBase) (prop: TimeRegionDecorationPanelBaseProp) =
        match prop with
        | TimeRegionDecorationPanelBaseProp.Base p -> TimeRegionPanelBase.apply el p
        | TimeRegionDecorationPanelBaseProp.StretchDirection v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeRegionDecorationPanelBase.StretchDirectionProperty, box v)
        | TimeRegionDecorationPanelBaseProp.DrawDefaultDecoration v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimeRegionDecorationPanelBase.DrawDefaultDecorationProperty, box v)
