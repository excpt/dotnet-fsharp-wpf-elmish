...
type DiagramMenuProp =
    | Base of PopupMenuProp

module DiagramMenu =

    let apply (el: DevExpress.Xpf.Diagram.DiagramMenu) (prop: DiagramMenuProp) =
        match prop with
        | DiagramMenuProp.Base p -> PopupMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
