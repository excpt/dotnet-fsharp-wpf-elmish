...
type GanttConnectorsPanelProp =
    | FirstVisibleDate of System.DateTime

module GanttConnectorsPanel =
    let firstVisibleDate v : obj = box (GanttConnectorsPanelProp.FirstVisibleDate v)

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttConnectorsPanel) (prop: GanttConnectorsPanelProp) =
        match prop with
        | GanttConnectorsPanelProp.FirstVisibleDate v -> el.SetValue(DevExpress.Xpf.Gantt.Native.GanttConnectorsPanel.FirstVisibleDateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttConnectorsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
