...
type RatingControlProp =
    ...
    | IsReadOnly of bool
    | AllowHover of bool
    | ToolTipStringFormat of string

module RatingControl =
    let orientation v : obj = box (RatingControlProp.Orientation v)
    let precision v : obj = box (RatingControlProp.Precision v)
    let itemsCount v : obj = box (RatingControlProp.ItemsCount v)
    let itemStyle v : obj = box (RatingControlProp.ItemStyle v)
    let value v : obj = box (RatingControlProp.Value v)
    let minimum v : obj = box (RatingControlProp.Minimum v)
    let maximum v : obj = box (RatingControlProp.Maximum v)
    let isReadOnly v : obj = box (RatingControlProp.IsReadOnly v)
    let allowHover v : obj = box (RatingControlProp.AllowHover v)
    let toolTipStringFormat v : obj = box (RatingControlProp.ToolTipStringFormat v)

    let apply (el: DevExpress.Xpf.Editors.RatingControl) (prop: RatingControlProp) =
        match prop with
        | RatingControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.OrientationProperty, box v)
        | RatingControlProp.Precision v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.PrecisionProperty, box v)
        | RatingControlProp.ItemsCount v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.ItemsCountProperty, box v)
        | RatingControlProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.ItemStyleProperty, box v)
        | RatingControlProp.Value v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.ValueProperty, box v)
        | RatingControlProp.Minimum v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.MinimumProperty, box v)
        | RatingControlProp.Maximum v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.MaximumProperty, box v)
        | RatingControlProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.IsReadOnlyProperty, box v)
        | RatingControlProp.AllowHover v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.AllowHoverProperty, box v)
        | RatingControlProp.ToolTipStringFormat v -> el.SetValue(DevExpress.Xpf.Editors.RatingControl.ToolTipStringFormatProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.RatingControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
