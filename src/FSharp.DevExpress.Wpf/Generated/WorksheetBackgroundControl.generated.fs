...
type WorksheetBackgroundControlProp =
    | Base of WorksheetPaintControlProp

module WorksheetBackgroundControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetBackgroundControl) (prop: WorksheetBackgroundControlProp) =
        match prop with
        | WorksheetBackgroundControlProp.Base p -> WorksheetPaintControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetBackgroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
