...
type TabBorderProp =
    | Base of RotatableBorderProp
    | ViewInfo of DevExpress.Xpf.Core.Native.TabViewInfo
    | HoldBorderPadding of obj
    | HoldBorderThickness of obj
    | HoldBorderCornerRadius of obj
    | HoldBorderMargin of obj
    | BorderMode of DevExpress.Xpf.Core.Native.TabBorderMode
    | BackgroundMode of DevExpress.Xpf.Core.Native.TabBackgroundMode
    | LeaveOriginBorderColor of bool
    | LeaveOriginBackgroundColor of bool
    | CustomBackgroundBrightness of float
    | CustomBorderBrightness of float

module TabBorder =
    let viewInfo v : obj = box (TabBorderProp.ViewInfo v)
    let holdBorderPadding v : obj = box (TabBorderProp.HoldBorderPadding v)
    let holdBorderThickness v : obj = box (TabBorderProp.HoldBorderThickness v)
    let holdBorderCornerRadius v : obj = box (TabBorderProp.HoldBorderCornerRadius v)
    let holdBorderMargin v : obj = box (TabBorderProp.HoldBorderMargin v)
    let borderMode v : obj = box (TabBorderProp.BorderMode v)
    let backgroundMode v : obj = box (TabBorderProp.BackgroundMode v)
    let leaveOriginBorderColor v : obj = box (TabBorderProp.LeaveOriginBorderColor v)
    let leaveOriginBackgroundColor v : obj = box (TabBorderProp.LeaveOriginBackgroundColor v)
    let customBackgroundBrightness v : obj = box (TabBorderProp.CustomBackgroundBrightness v)
    let customBorderBrightness v : obj = box (TabBorderProp.CustomBorderBrightness v)

    let apply (el: DevExpress.Xpf.Core.Native.TabBorder) (prop: TabBorderProp) =
        match prop with
        | TabBorderProp.Base p -> RotatableBorder.apply el p
        | TabBorderProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.ViewInfoProperty, box v)
        | TabBorderProp.HoldBorderPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.HoldBorderPaddingProperty, box v)
        | TabBorderProp.HoldBorderThickness v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.HoldBorderThicknessProperty, box v)
        | TabBorderProp.HoldBorderCornerRadius v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.HoldBorderCornerRadiusProperty, box v)
        | TabBorderProp.HoldBorderMargin v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.HoldBorderMarginProperty, box v)
        | TabBorderProp.BorderMode v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.BorderModeProperty, box v)
        | TabBorderProp.BackgroundMode v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.BackgroundModeProperty, box v)
        | TabBorderProp.LeaveOriginBorderColor v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.LeaveOriginBorderColorProperty, box v)
        | TabBorderProp.LeaveOriginBackgroundColor v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.LeaveOriginBackgroundColorProperty, box v)
        | TabBorderProp.CustomBackgroundBrightness v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.CustomBackgroundBrightnessProperty, box v)
        | TabBorderProp.CustomBorderBrightness v -> el.SetValue(DevExpress.Xpf.Core.Native.TabBorder.CustomBorderBrightnessProperty, box v)

    let location v : obj = box (RotatableBorderProp.Location v)
    let borderThickness v : obj = box (RotatableBorderProp.BorderThickness v)
    let borderCornerRadius v : obj = box (RotatableBorderProp.BorderCornerRadius v)
    let borderMargin v : obj = box (RotatableBorderProp.BorderMargin v)
    let borderPadding v : obj = box (RotatableBorderProp.BorderPadding v)
    let borderBrush v : obj = box (RotatableBorderProp.BorderBrush v)
    let borderBackground v : obj = box (RotatableBorderProp.BorderBackground v)
    let borderOpacityMask v : obj = box (RotatableBorderProp.BorderOpacityMask v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.TabBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
