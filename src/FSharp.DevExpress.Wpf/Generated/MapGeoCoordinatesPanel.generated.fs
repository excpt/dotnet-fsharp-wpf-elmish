...
type MapGeoCoordinatesPanelProp =
    | Base of MapCoordinatesPanelProp
    | LatitudeDegrees of string
    | LatitudeMinutes of string
    | LatitudeSeconds of string
    | LatitudeCardinalPoint of string
    | LongitudeDegrees of string
    | LongitudeMinutes of string
    | LongitudeSeconds of string
    | LongitudeCardinalPoint of string

module MapGeoCoordinatesPanel =
    let latitudeDegrees v : obj = box (MapGeoCoordinatesPanelProp.LatitudeDegrees v)
    let latitudeMinutes v : obj = box (MapGeoCoordinatesPanelProp.LatitudeMinutes v)
    let latitudeSeconds v : obj = box (MapGeoCoordinatesPanelProp.LatitudeSeconds v)
    let latitudeCardinalPoint v : obj = box (MapGeoCoordinatesPanelProp.LatitudeCardinalPoint v)
    let longitudeDegrees v : obj = box (MapGeoCoordinatesPanelProp.LongitudeDegrees v)
    let longitudeMinutes v : obj = box (MapGeoCoordinatesPanelProp.LongitudeMinutes v)
    let longitudeSeconds v : obj = box (MapGeoCoordinatesPanelProp.LongitudeSeconds v)
    let longitudeCardinalPoint v : obj = box (MapGeoCoordinatesPanelProp.LongitudeCardinalPoint v)

    let apply (el: DevExpress.Xpf.Map.MapGeoCoordinatesPanel) (prop: MapGeoCoordinatesPanelProp) =
        match prop with
        | MapGeoCoordinatesPanelProp.Base p -> MapCoordinatesPanel.apply el p
        | MapGeoCoordinatesPanelProp.LatitudeDegrees v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LatitudeDegreesProperty, box v)
        | MapGeoCoordinatesPanelProp.LatitudeMinutes v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LatitudeMinutesProperty, box v)
        | MapGeoCoordinatesPanelProp.LatitudeSeconds v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LatitudeSecondsProperty, box v)
        | MapGeoCoordinatesPanelProp.LatitudeCardinalPoint v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LatitudeCardinalPointProperty, box v)
        | MapGeoCoordinatesPanelProp.LongitudeDegrees v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LongitudeDegreesProperty, box v)
        | MapGeoCoordinatesPanelProp.LongitudeMinutes v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LongitudeMinutesProperty, box v)
        | MapGeoCoordinatesPanelProp.LongitudeSeconds v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LongitudeSecondsProperty, box v)
        | MapGeoCoordinatesPanelProp.LongitudeCardinalPoint v -> el.SetValue(DevExpress.Xpf.Map.MapGeoCoordinatesPanel.LongitudeCardinalPointProperty, box v)

    let coordPoint v : obj = box (MapCoordinatesPanelProp.CoordPoint v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MapGeoCoordinatesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
