...
type NextMediaButtonProp =
    | Base of MediaButtonProp

module NextMediaButton =

    let apply (el: DevExpress.Xpf.Controls.NextMediaButton) (prop: NextMediaButtonProp) =
        match prop with
        | NextMediaButtonProp.Base p -> MediaButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.NextMediaButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
