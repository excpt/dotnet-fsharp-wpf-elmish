...
type OutsetBar2DModelControlProp =
    | Base of PredefinedBar2DModelControlProp

module OutsetBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.OutsetBar2DModelControl) (prop: OutsetBar2DModelControlProp) =
        match prop with
        | OutsetBar2DModelControlProp.Base p -> PredefinedBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.OutsetBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
