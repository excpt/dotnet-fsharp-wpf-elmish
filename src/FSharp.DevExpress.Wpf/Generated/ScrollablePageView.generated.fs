...
type ScrollablePageViewProp =
    | Model of DevExpress.Xpf.Printing.IPreviewModel
    | PageMargin of System.Windows.Thickness

module ScrollablePageView =
    let model v : obj = box (ScrollablePageViewProp.Model v)
    let pageMargin v : obj = box (ScrollablePageViewProp.PageMargin v)

    let apply (el: DevExpress.Xpf.Printing.Native.ScrollablePageView) (prop: ScrollablePageViewProp) =
        match prop with
        | ScrollablePageViewProp.Model v -> el.SetValue(DevExpress.Xpf.Printing.Native.ScrollablePageView.ModelProperty, box v)
        | ScrollablePageViewProp.PageMargin v -> el.SetValue(DevExpress.Xpf.Printing.Native.ScrollablePageView.PageMarginProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.ScrollablePageView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
