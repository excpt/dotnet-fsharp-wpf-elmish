...
type IStyleDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleDigitalGaugeBackgroundLayerControl) (prop: IStyleDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | IStyleDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
