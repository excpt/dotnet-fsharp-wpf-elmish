...
type CleanWhiteLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CleanWhiteLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteLinearScaleBackgroundLayerControl) (prop: CleanWhiteLinearScaleBackgroundLayerControlProp) =
        match prop with
        | CleanWhiteLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
