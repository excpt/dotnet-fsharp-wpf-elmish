...
module PageControl =
    ...
    let apply (el: DevExpress.Xpf.Diagram.Native.PageControl) (prop: PageControlProp) =
        match prop with
        | PageControlProp.Base p -> PageControl.apply el p
        | PageControlProp.PageDisplayMode v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControl.PageDisplayModeProperty, box v)
        | PageControlProp.MaxPageCount v -> el.SetValue(DevExpress.Xpf.DocumentViewer.PageControl.MaxPageCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.PageControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
