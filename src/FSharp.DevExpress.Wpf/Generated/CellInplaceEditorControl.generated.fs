...
type CellInplaceEditorControlProp =
    | Base of InplaceEditorControlProp

module CellInplaceEditorControl =

    let apply (el: DevExpress.Xpf.Scheduling.Editors.CellInplaceEditorControl) (prop: CellInplaceEditorControlProp) =
        match prop with
        | CellInplaceEditorControlProp.Base p -> InplaceEditorControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Editors.CellInplaceEditorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
