...
type ProgressiveHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveHalfTopArcScaleBackgroundLayerControl) (prop: ProgressiveHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | ProgressiveHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
