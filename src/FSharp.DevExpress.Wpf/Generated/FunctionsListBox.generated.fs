...
type FunctionsListBoxProp =
    | Base of ListBoxEditProp

module FunctionsListBox =

    let apply (el: DevExpress.Xpf.ExpressionEditor.Native.FunctionsListBox) (prop: FunctionsListBoxProp) =
        match prop with
        | FunctionsListBoxProp.Base p -> ListBoxEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.ExpressionEditor.Native.FunctionsListBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
