...
type IStyleArcScaleLineControlProp =
    | Base of PresentationControlProp

module IStyleArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleArcScaleLineControl) (prop: IStyleArcScaleLineControlProp) =
        match prop with
        | IStyleArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
