...
type PasswordBoxEditProp =
    | Base of TextEditBaseProp
    | PasswordChar of char
    | Password of string
    | ShowCapsLockWarningToolTip of bool
    | CapsLockWarningToolTipTemplate of System.Windows.DataTemplate
    | ShowNullTextIfFocused of bool
    | ShowPasswordButtonVisibility of DevExpress.Xpf.Editors.ShowPasswordButtonVisibility
    | ShowPasswordButtonTemplate of System.Windows.DataTemplate
    | OnCustomPasswordStrength of DevExpress.Xpf.Editors.CustomPasswordStrengthEventHandler

module PasswordBoxEdit =
    let passwordChar v : obj = box (PasswordBoxEditProp.PasswordChar v)
    let password v : obj = box (PasswordBoxEditProp.Password v)
    let showCapsLockWarningToolTip v : obj = box (PasswordBoxEditProp.ShowCapsLockWarningToolTip v)
    let capsLockWarningToolTipTemplate v : obj = box (PasswordBoxEditProp.CapsLockWarningToolTipTemplate v)
    let showNullTextIfFocused v : obj = box (PasswordBoxEditProp.ShowNullTextIfFocused v)
    let showPasswordButtonVisibility v : obj = box (PasswordBoxEditProp.ShowPasswordButtonVisibility v)
    let showPasswordButtonTemplate v : obj = box (PasswordBoxEditProp.ShowPasswordButtonTemplate v)
    let onCustomPasswordStrength v : obj = box (EventProp(box (PasswordBoxEditProp.OnCustomPasswordStrength v)))

    let apply (el: DevExpress.Xpf.Editors.PasswordBoxEdit) (prop: PasswordBoxEditProp) =
        match prop with
        | PasswordBoxEditProp.Base p -> TextEditBase.apply el p
        | PasswordBoxEditProp.PasswordChar v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.PasswordCharProperty, box v)
        | PasswordBoxEditProp.Password v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.PasswordProperty, box v)
        | PasswordBoxEditProp.ShowCapsLockWarningToolTip v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.ShowCapsLockWarningToolTipProperty, box v)
        | PasswordBoxEditProp.CapsLockWarningToolTipTemplate v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.CapsLockWarningToolTipTemplateProperty, box v)
        | PasswordBoxEditProp.ShowNullTextIfFocused v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.ShowNullTextIfFocusedProperty, box v)
        | PasswordBoxEditProp.ShowPasswordButtonVisibility v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.ShowPasswordButtonVisibilityProperty, box v)
        | PasswordBoxEditProp.ShowPasswordButtonTemplate v -> el.SetValue(DevExpress.Xpf.Editors.PasswordBoxEdit.ShowPasswordButtonTemplateProperty, box v)
        | PasswordBoxEditProp.OnCustomPasswordStrength h -> el.CustomPasswordStrength.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PasswordBoxEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
