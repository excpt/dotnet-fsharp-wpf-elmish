...
type TabHeaderContainerProp =
    | Base of DockDependentDecoratorProp
    | IsSelected of bool
    | TopSelectedMargin of System.Windows.Thickness
    | BottomSelectedMargin of System.Windows.Thickness
    | LeftSelectedMargin of System.Windows.Thickness
    | RightSelectedMargin of System.Windows.Thickness

module TabHeaderContainer =
    let isSelected v : obj = box (TabHeaderContainerProp.IsSelected v)
    let topSelectedMargin v : obj = box (TabHeaderContainerProp.TopSelectedMargin v)
    let bottomSelectedMargin v : obj = box (TabHeaderContainerProp.BottomSelectedMargin v)
    let leftSelectedMargin v : obj = box (TabHeaderContainerProp.LeftSelectedMargin v)
    let rightSelectedMargin v : obj = box (TabHeaderContainerProp.RightSelectedMargin v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer) (prop: TabHeaderContainerProp) =
        match prop with
        | TabHeaderContainerProp.Base p -> DockDependentDecorator.apply el p
        | TabHeaderContainerProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer.IsSelectedProperty, box v)
        | TabHeaderContainerProp.TopSelectedMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer.TopSelectedMarginProperty, box v)
        | TabHeaderContainerProp.BottomSelectedMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer.BottomSelectedMarginProperty, box v)
        | TabHeaderContainerProp.LeftSelectedMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer.LeftSelectedMarginProperty, box v)
        | TabHeaderContainerProp.RightSelectedMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer.RightSelectedMarginProperty, box v)

    let topMargin v : obj = box (DockDependentDecoratorProp.TopMargin v)
    let bottomMargin v : obj = box (DockDependentDecoratorProp.BottomMargin v)
    let leftMargin v : obj = box (DockDependentDecoratorProp.LeftMargin v)
    let rightMargin v : obj = box (DockDependentDecoratorProp.RightMargin v)
    let captionLocation v : obj = box (DockDependentDecoratorProp.CaptionLocation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabHeaderContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
