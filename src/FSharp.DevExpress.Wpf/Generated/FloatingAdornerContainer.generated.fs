...
type FloatingAdornerContainerProp =
    | Base of FloatingContainerProp

module FloatingAdornerContainer =

    let apply (el: DevExpress.Xpf.Core.FloatingAdornerContainer) (prop: FloatingAdornerContainerProp) =
        match prop with
        | FloatingAdornerContainerProp.Base p -> FloatingContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.FloatingAdornerContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
