...
type DiagramSeriesItemsControlProp =
    | Owner of DevExpress.Xpf.Charts.ChartElement

module DiagramSeriesItemsControl =
    let owner v : obj = box (DiagramSeriesItemsControlProp.Owner v)

    let apply (el: DevExpress.Xpf.Charts.DiagramSeriesItemsControl) (prop: DiagramSeriesItemsControlProp) =
        match prop with
        | DiagramSeriesItemsControlProp.Owner v -> el.SetValue(DevExpress.Xpf.Charts.DiagramSeriesItemsControl.OwnerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.DiagramSeriesItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
