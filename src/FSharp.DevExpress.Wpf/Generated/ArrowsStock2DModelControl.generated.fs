...
type ArrowsStock2DModelControlProp =
    | Base of PredefinedModelControlProp

module ArrowsStock2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.ArrowsStock2DModelControl) (prop: ArrowsStock2DModelControlProp) =
        match prop with
        | ArrowsStock2DModelControlProp.Base p -> PredefinedModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ArrowsStock2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
