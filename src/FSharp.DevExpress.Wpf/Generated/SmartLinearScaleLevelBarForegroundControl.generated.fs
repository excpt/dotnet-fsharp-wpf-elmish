...
type SmartLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module SmartLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartLinearScaleLevelBarForegroundControl) (prop: SmartLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | SmartLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
