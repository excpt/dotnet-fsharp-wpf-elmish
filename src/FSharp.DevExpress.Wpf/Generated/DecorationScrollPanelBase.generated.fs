...
type DecorationScrollPanelBaseProp =
    | Columns of int
    | Rows of int
    | ItemMinSize of float
    | AutoSize of bool
    | AutoSizeMaxViewPort of float
    | ScrollOffset of float
    | AllowScroll of bool

module DecorationScrollPanelBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase) (prop: DecorationScrollPanelBaseProp) =
        match prop with
        | DecorationScrollPanelBaseProp.Columns v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.ColumnsProperty, box v)
        | DecorationScrollPanelBaseProp.Rows v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.RowsProperty, box v)
        | DecorationScrollPanelBaseProp.ItemMinSize v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.ItemMinSizeProperty, box v)
        | DecorationScrollPanelBaseProp.AutoSize v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.AutoSizeProperty, box v)
        | DecorationScrollPanelBaseProp.AutoSizeMaxViewPort v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.AutoSizeMaxViewPortProperty, box v)
        | DecorationScrollPanelBaseProp.ScrollOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.ScrollOffsetProperty, box v)
        | DecorationScrollPanelBaseProp.AllowScroll v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.DecorationScrollPanelBase.AllowScrollProperty, box v)
