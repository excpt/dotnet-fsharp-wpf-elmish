...
module RenameHint =
    ...
    let apply (el: DevExpress.Xpf.Docking.Platform.RenameHint) (prop: RenameHintProp) =
        match prop with
        | RenameHintProp.Base p -> DockHintElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.RenameHint>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
