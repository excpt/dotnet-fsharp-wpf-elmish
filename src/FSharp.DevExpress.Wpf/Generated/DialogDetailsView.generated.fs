...
type DialogDetailsViewProp =
    | Base of DialogViewModeViewBaseProp

module DialogDetailsView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogDetailsView) (prop: DialogDetailsViewProp) =
        match prop with
        | DialogDetailsViewProp.Base p -> DialogViewModeViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogDetailsView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
