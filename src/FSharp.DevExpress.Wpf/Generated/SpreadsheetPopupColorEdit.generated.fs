...
type SpreadsheetPopupColorEditProp =
    | Base of PopupColorEditProp

module SpreadsheetPopupColorEdit =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetPopupColorEdit) (prop: SpreadsheetPopupColorEditProp) =
        match prop with
        | SpreadsheetPopupColorEditProp.Base p -> PopupColorEdit.apply el p
    ...
    let onColorChanged v : obj = box (EventProp(box (PopupColorEditProp.OnColorChanged v)))
    let onGetColorName v : obj = box (EventProp(box (PopupColorEditProp.OnGetColorName v)))
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.SpreadsheetPopupColorEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
