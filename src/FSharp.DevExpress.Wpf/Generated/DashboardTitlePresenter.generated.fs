...
type DashboardTitlePresenterProp =
    | DashboardViewModel of DevExpress.DashboardWpf.Internal.IBaseDashboardViewModel
    | SubtitleFontSize of float
    | TitleFontSize of float
    | TitleViewModel of DevExpress.Mvvm.BindableBase

module DashboardTitlePresenter =
    let dashboardViewModel v : obj = box (DashboardTitlePresenterProp.DashboardViewModel v)
    let subtitleFontSize v : obj = box (DashboardTitlePresenterProp.SubtitleFontSize v)
    let titleFontSize v : obj = box (DashboardTitlePresenterProp.TitleFontSize v)
    let titleViewModel v : obj = box (DashboardTitlePresenterProp.TitleViewModel v)

    let apply (el: DevExpress.DashboardWpf.Internal.DashboardTitlePresenter) (prop: DashboardTitlePresenterProp) =
        match prop with
        | DashboardTitlePresenterProp.DashboardViewModel v -> el.SetValue(DevExpress.DashboardWpf.Internal.DashboardTitlePresenter.DashboardViewModelProperty, box v)
        | DashboardTitlePresenterProp.SubtitleFontSize v -> el.SetValue(DevExpress.DashboardWpf.Internal.DashboardTitlePresenter.SubtitleFontSizeProperty, box v)
        | DashboardTitlePresenterProp.TitleFontSize v -> el.SetValue(DevExpress.DashboardWpf.Internal.DashboardTitlePresenter.TitleFontSizeProperty, box v)
        | DashboardTitlePresenterProp.TitleViewModel v -> el.SetValue(DevExpress.DashboardWpf.Internal.DashboardTitlePresenter.TitleViewModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.DashboardTitlePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
