...
type DiagramConnectorProp =
    | Base of DiagramItemProp
    | BeginArrow of DevExpress.Diagram.Core.ArrowDescription
    | EndArrow of DevExpress.Diagram.Core.ArrowDescription
    | BeginArrowSize of System.Windows.Size
    | EndArrowSize of System.Windows.Size
    | Type of DevExpress.Diagram.Core.ConnectorType
    | Content of string
    | BeginLeftLabel of string
    | BeginRightLabel of string
    | EndLeftLabel of string
    | EndRightLabel of string
    | BeginLabelArrowOffset of float
    | BeginLabelConnectorOffset of float
    | EndLabelArrowOffset of float
    | EndLabelConnectorOffset of float
    | ContentBackground of System.Windows.Media.Brush
    | BeginPoint of System.Windows.Point
    | EndPoint of System.Windows.Point
    | BeginItem of DevExpress.Diagram.Core.IDiagramItem
    | EndItem of DevExpress.Diagram.Core.IDiagramItem
    | BeginItemPointIndex of int
    | EndItemPointIndex of int
    | CanDragBeginPoint of bool
    | CanDragEndPoint of bool
    | CanChangeRoute of bool
    | BeginPointRestrictions of DevExpress.Diagram.Core.ConnectorPointRestrictions
    | EndPointRestrictions of DevExpress.Diagram.Core.ConnectorPointRestrictions
    | Points of DevExpress.Diagram.Core.DiagramPointCollection

module DiagramConnector =
    let beginArrow v : obj = box (DiagramConnectorProp.BeginArrow v)
    let endArrow v : obj = box (DiagramConnectorProp.EndArrow v)
    let beginArrowSize v : obj = box (DiagramConnectorProp.BeginArrowSize v)
    let endArrowSize v : obj = box (DiagramConnectorProp.EndArrowSize v)
    let type v : obj = box (DiagramConnectorProp.Type v)
    let content v : obj = box (DiagramConnectorProp.Content v)
    let beginLeftLabel v : obj = box (DiagramConnectorProp.BeginLeftLabel v)
    let beginRightLabel v : obj = box (DiagramConnectorProp.BeginRightLabel v)
    let endLeftLabel v : obj = box (DiagramConnectorProp.EndLeftLabel v)
    let endRightLabel v : obj = box (DiagramConnectorProp.EndRightLabel v)
    let beginLabelArrowOffset v : obj = box (DiagramConnectorProp.BeginLabelArrowOffset v)
    let beginLabelConnectorOffset v : obj = box (DiagramConnectorProp.BeginLabelConnectorOffset v)
    let endLabelArrowOffset v : obj = box (DiagramConnectorProp.EndLabelArrowOffset v)
    let endLabelConnectorOffset v : obj = box (DiagramConnectorProp.EndLabelConnectorOffset v)
    let contentBackground v : obj = box (DiagramConnectorProp.ContentBackground v)
    let beginPoint v : obj = box (DiagramConnectorProp.BeginPoint v)
    let endPoint v : obj = box (DiagramConnectorProp.EndPoint v)
    let beginItem v : obj = box (DiagramConnectorProp.BeginItem v)
    let endItem v : obj = box (DiagramConnectorProp.EndItem v)
    let beginItemPointIndex v : obj = box (DiagramConnectorProp.BeginItemPointIndex v)
    let endItemPointIndex v : obj = box (DiagramConnectorProp.EndItemPointIndex v)
    let canDragBeginPoint v : obj = box (DiagramConnectorProp.CanDragBeginPoint v)
    let canDragEndPoint v : obj = box (DiagramConnectorProp.CanDragEndPoint v)
    let canChangeRoute v : obj = box (DiagramConnectorProp.CanChangeRoute v)
    let beginPointRestrictions v : obj = box (DiagramConnectorProp.BeginPointRestrictions v)
    let endPointRestrictions v : obj = box (DiagramConnectorProp.EndPointRestrictions v)
    let points v : obj = box (DiagramConnectorProp.Points v)

    let apply (el: DevExpress.Xpf.Diagram.DiagramConnector) (prop: DiagramConnectorProp) =
        match prop with
        | DiagramConnectorProp.Base p -> DiagramItem.apply el p
        | DiagramConnectorProp.BeginArrow v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginArrowProperty, box v)
        | DiagramConnectorProp.EndArrow v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndArrowProperty, box v)
        | DiagramConnectorProp.BeginArrowSize v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginArrowSizeProperty, box v)
        | DiagramConnectorProp.EndArrowSize v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndArrowSizeProperty, box v)
        | DiagramConnectorProp.Type v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.TypeProperty, box v)
        | DiagramConnectorProp.Content v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.ContentProperty, box v)
        | DiagramConnectorProp.BeginLeftLabel v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginLeftLabelProperty, box v)
        | DiagramConnectorProp.BeginRightLabel v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginRightLabelProperty, box v)
        | DiagramConnectorProp.EndLeftLabel v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndLeftLabelProperty, box v)
        | DiagramConnectorProp.EndRightLabel v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndRightLabelProperty, box v)
        | DiagramConnectorProp.BeginLabelArrowOffset v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginLabelArrowOffsetProperty, box v)
        | DiagramConnectorProp.BeginLabelConnectorOffset v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginLabelConnectorOffsetProperty, box v)
        | DiagramConnectorProp.EndLabelArrowOffset v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndLabelArrowOffsetProperty, box v)
        | DiagramConnectorProp.EndLabelConnectorOffset v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndLabelConnectorOffsetProperty, box v)
        | DiagramConnectorProp.ContentBackground v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.ContentBackgroundProperty, box v)
        | DiagramConnectorProp.BeginPoint v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginPointProperty, box v)
        | DiagramConnectorProp.EndPoint v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndPointProperty, box v)
        | DiagramConnectorProp.BeginItem v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginItemProperty, box v)
        | DiagramConnectorProp.EndItem v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndItemProperty, box v)
        | DiagramConnectorProp.BeginItemPointIndex v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginItemPointIndexProperty, box v)
        | DiagramConnectorProp.EndItemPointIndex v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndItemPointIndexProperty, box v)
        | DiagramConnectorProp.CanDragBeginPoint v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.CanDragBeginPointProperty, box v)
        | DiagramConnectorProp.CanDragEndPoint v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.CanDragEndPointProperty, box v)
        | DiagramConnectorProp.CanChangeRoute v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.CanChangeRouteProperty, box v)
        | DiagramConnectorProp.BeginPointRestrictions v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.BeginPointRestrictionsProperty, box v)
        | DiagramConnectorProp.EndPointRestrictions v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.EndPointRestrictionsProperty, box v)
        | DiagramConnectorProp.Points v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramConnector.PointsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.DiagramConnector>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
