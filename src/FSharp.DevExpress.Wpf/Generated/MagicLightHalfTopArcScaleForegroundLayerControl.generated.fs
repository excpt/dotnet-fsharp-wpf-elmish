...
type MagicLightHalfTopArcScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module MagicLightHalfTopArcScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightHalfTopArcScaleForegroundLayerControl) (prop: MagicLightHalfTopArcScaleForegroundLayerControlProp) =
        match prop with
        | MagicLightHalfTopArcScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightHalfTopArcScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
