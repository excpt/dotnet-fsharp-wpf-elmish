...
type NavBarGroupControlProp =
    | NavBar of DevExpress.Xpf.NavBar.NavBarControl
    | DisplayMode of DevExpress.Xpf.NavBar.DisplayMode
    | LayoutSettings of DevExpress.Xpf.NavBar.LayoutSettings
    | ImageSettings of DevExpress.Xpf.NavBar.ImageSettings
    | DisplaySource of DevExpress.Xpf.NavBar.DisplaySource
    | Group of DevExpress.Xpf.NavBar.NavBarGroup
    | GroupContentPresenterTemplate of System.Windows.DataTemplate
    | GroupItemsControlTemplate of System.Windows.DataTemplate
    | Orientation of System.Windows.Controls.Orientation
    | ShowBorder of bool

module NavBarGroupControl =
    let navBar v : obj = box (NavBarGroupControlProp.NavBar v)
    let displayMode v : obj = box (NavBarGroupControlProp.DisplayMode v)
    let layoutSettings v : obj = box (NavBarGroupControlProp.LayoutSettings v)
    let imageSettings v : obj = box (NavBarGroupControlProp.ImageSettings v)
    let displaySource v : obj = box (NavBarGroupControlProp.DisplaySource v)
    let group v : obj = box (NavBarGroupControlProp.Group v)
    let groupContentPresenterTemplate v : obj = box (NavBarGroupControlProp.GroupContentPresenterTemplate v)
    let groupItemsControlTemplate v : obj = box (NavBarGroupControlProp.GroupItemsControlTemplate v)
    let orientation v : obj = box (NavBarGroupControlProp.Orientation v)
    let showBorder v : obj = box (NavBarGroupControlProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarGroupControl) (prop: NavBarGroupControlProp) =
        match prop with
        | NavBarGroupControlProp.NavBar v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.NavBarProperty, box v)
        | NavBarGroupControlProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.DisplayModeProperty, box v)
        | NavBarGroupControlProp.LayoutSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.LayoutSettingsProperty, box v)
        | NavBarGroupControlProp.ImageSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.ImageSettingsProperty, box v)
        | NavBarGroupControlProp.DisplaySource v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.DisplaySourceProperty, box v)
        | NavBarGroupControlProp.Group v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.GroupProperty, box v)
        | NavBarGroupControlProp.GroupContentPresenterTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.GroupContentPresenterTemplateProperty, box v)
        | NavBarGroupControlProp.GroupItemsControlTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.GroupItemsControlTemplateProperty, box v)
        | NavBarGroupControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.OrientationProperty, box v)
        | NavBarGroupControlProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupControl.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
