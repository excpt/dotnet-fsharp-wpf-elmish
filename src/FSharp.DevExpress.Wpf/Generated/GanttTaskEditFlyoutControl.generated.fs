...
type GanttTaskEditFlyoutControlProp =
    | Base of GanttEditFlyoutControlBaseProp

module GanttTaskEditFlyoutControl =

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttTaskEditFlyoutControl) (prop: GanttTaskEditFlyoutControlProp) =
        match prop with
        | GanttTaskEditFlyoutControlProp.Base p -> GanttEditFlyoutControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttTaskEditFlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
