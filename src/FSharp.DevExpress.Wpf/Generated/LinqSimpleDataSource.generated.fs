...
type LinqSimpleDataSourceProp =
    | Base of EnumerableDataSourceBaseProp

module LinqSimpleDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.LinqSimpleDataSource) (prop: LinqSimpleDataSourceProp) =
        match prop with
        | LinqSimpleDataSourceProp.Base p -> EnumerableDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.LinqSimpleDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
