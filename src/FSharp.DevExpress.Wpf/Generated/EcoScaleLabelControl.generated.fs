...
type EcoScaleLabelControlProp =
    | Base of PresentationControlProp

module EcoScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoScaleLabelControl) (prop: EcoScaleLabelControlProp) =
        match prop with
        | EcoScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
