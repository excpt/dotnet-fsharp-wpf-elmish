...
type AutoSuggestEditStyleSettingsProp =
    | Base of PopupBaseEditStyleSettingsProp

module AutoSuggestEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.AutoSuggestEditStyleSettings) (prop: AutoSuggestEditStyleSettingsProp) =
        match prop with
        | AutoSuggestEditStyleSettingsProp.Base p -> PopupBaseEditStyleSettings.apply el p
