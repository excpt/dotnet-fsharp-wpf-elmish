...
type CleanWhiteArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module CleanWhiteArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteArcScaleMarkerControl) (prop: CleanWhiteArcScaleMarkerControlProp) =
        match prop with
        | CleanWhiteArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
