...
type RichTextIndentEditProp =
    | Base of ButtonEditProp
    | ValueUnitConverter of DevExpress.Office.DocumentModelUnitConverter
    | DefaultUnitType of DevExpress.Office.DocumentUnit
    | TwipsValue of int
    | MinValue of int
    | MaxValue of int

module RichTextIndentEdit =
    let valueUnitConverter v : obj = box (RichTextIndentEditProp.ValueUnitConverter v)
    let defaultUnitType v : obj = box (RichTextIndentEditProp.DefaultUnitType v)
    let twipsValue v : obj = box (RichTextIndentEditProp.TwipsValue v)
    let minValue v : obj = box (RichTextIndentEditProp.MinValue v)
    let maxValue v : obj = box (RichTextIndentEditProp.MaxValue v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit) (prop: RichTextIndentEditProp) =
        match prop with
        | RichTextIndentEditProp.Base p -> ButtonEdit.apply el p
        | RichTextIndentEditProp.ValueUnitConverter v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit.ValueUnitConverterProperty, box v)
        | RichTextIndentEditProp.DefaultUnitType v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit.DefaultUnitTypeProperty, box v)
        | RichTextIndentEditProp.TwipsValue v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit.TwipsValueProperty, box v)
        | RichTextIndentEditProp.MinValue v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit.MinValueProperty, box v)
        | RichTextIndentEditProp.MaxValue v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit.MaxValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.RichTextIndentEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
