...
type EAN128StyleSettingsProp =
    | FNC1Substitute of string
    | HumanReadableText of bool

module EAN128StyleSettings =
    let fNC1Substitute v : obj = box (EAN128StyleSettingsProp.FNC1Substitute v)
    let humanReadableText v : obj = box (EAN128StyleSettingsProp.HumanReadableText v)

    let apply (el: DevExpress.Xpf.Editors.EAN128StyleSettings) (prop: EAN128StyleSettingsProp) =
        match prop with
        | EAN128StyleSettingsProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Editors.EAN128StyleSettings.FNC1SubstituteProperty, box v)
        | EAN128StyleSettingsProp.HumanReadableText v -> el.SetValue(DevExpress.Xpf.Editors.EAN128StyleSettings.HumanReadableTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.EAN128StyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
