...
type ScaleElementsPresentationControlProp =
    | Base of PresentationControlProp

module ScaleElementsPresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ScaleElementsPresentationControl) (prop: ScaleElementsPresentationControlProp) =
        match prop with
        | ScaleElementsPresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ScaleElementsPresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
