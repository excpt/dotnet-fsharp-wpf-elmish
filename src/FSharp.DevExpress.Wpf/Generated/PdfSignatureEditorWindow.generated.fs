...
type PdfSignatureEditorWindowProp =
    | Base of ThemedWindowProp

module PdfSignatureEditorWindow =

    let apply (el: DevExpress.Xpf.Printing.Native.PdfSignatureEditorWindow) (prop: PdfSignatureEditorWindowProp) =
        match prop with
        | PdfSignatureEditorWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.PdfSignatureEditorWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
