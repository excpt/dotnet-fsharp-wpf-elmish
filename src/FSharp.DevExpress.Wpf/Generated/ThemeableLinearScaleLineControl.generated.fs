...
type ThemeableLinearScaleLineControlProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableLinearScaleLineControl =
    let themeFill v : obj = box (ThemeableLinearScaleLineControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableLinearScaleLineControl) (prop: ThemeableLinearScaleLineControlProp) =
        match prop with
        | ThemeableLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
        | ThemeableLinearScaleLineControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableLinearScaleLineControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
