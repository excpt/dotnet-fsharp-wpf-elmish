...
type LayoutItemPanelProp =
    | ElementSpace of float
    | LabelPosition of DevExpress.Xpf.LayoutControl.LayoutItemLabelPosition

module LayoutItemPanel =
    let elementSpace v : obj = box (LayoutItemPanelProp.ElementSpace v)
    let labelPosition v : obj = box (LayoutItemPanelProp.LabelPosition v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemPanel) (prop: LayoutItemPanelProp) =
        match prop with
        | LayoutItemPanelProp.ElementSpace v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemPanel.ElementSpaceProperty, box v)
        | LayoutItemPanelProp.LabelPosition v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemPanel.LabelPositionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
