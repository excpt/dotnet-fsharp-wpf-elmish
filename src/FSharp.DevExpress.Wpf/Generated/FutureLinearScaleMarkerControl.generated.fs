...
type FutureLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FutureLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureLinearScaleMarkerControl) (prop: FutureLinearScaleMarkerControlProp) =
        match prop with
        | FutureLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
