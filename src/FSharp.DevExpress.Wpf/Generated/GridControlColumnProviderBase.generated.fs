...
type GridControlColumnProviderBaseProp =
    | AllowGridExtraFilter of bool
    | DataControlBase of DevExpress.Xpf.Grid.DataControlBase
    | AllowColumnsHighlighting of bool
    | AllowTextHighlighting of bool
    | FilterByColumnsMode of DevExpress.Xpf.Editors.FilterByColumnsMode
    | CustomColumns of obj

module GridControlColumnProviderBase =
    let allowGridExtraFilter v : obj = box (GridControlColumnProviderBaseProp.AllowGridExtraFilter v)
    let dataControlBase v : obj = box (GridControlColumnProviderBaseProp.DataControlBase v)
    let allowColumnsHighlighting v : obj = box (GridControlColumnProviderBaseProp.AllowColumnsHighlighting v)
    let allowTextHighlighting v : obj = box (GridControlColumnProviderBaseProp.AllowTextHighlighting v)
    let filterByColumnsMode v : obj = box (GridControlColumnProviderBaseProp.FilterByColumnsMode v)
    let customColumns v : obj = box (GridControlColumnProviderBaseProp.CustomColumns v)

    let apply (el: DevExpress.Xpf.Grid.GridControlColumnProviderBase) (prop: GridControlColumnProviderBaseProp) =
        match prop with
        | GridControlColumnProviderBaseProp.AllowGridExtraFilter v -> el.SetValue(DevExpress.Xpf.Grid.GridControlColumnProviderBase.AllowGridExtraFilterProperty, box v)
        | GridControlColumnProviderBaseProp.DataControlBase v -> el.SetValue(DevExpress.Xpf.Grid.GridControlColumnProviderBase.DataControlBaseProperty, box v)
        | GridControlColumnProviderBaseProp.AllowColumnsHighlighting v -> el.SetValue(DevExpress.Xpf.Grid.GridControlColumnProviderBase.AllowColumnsHighlightingProperty, box v)
        | GridControlColumnProviderBaseProp.AllowTextHighlighting v -> el.SetValue(DevExpress.Xpf.Grid.GridControlColumnProviderBase.AllowTextHighlightingProperty, box v)
        | GridControlColumnProviderBaseProp.FilterByColumnsMode v -> el.SetValue(DevExpress.Xpf.Grid.GridControlColumnProviderBase.FilterByColumnsModeProperty, box v)
        | GridControlColumnProviderBaseProp.CustomColumns v -> el.SetValue(DevExpress.Xpf.Grid.GridControlColumnProviderBase.CustomColumnsProperty, box v)
    ...
    let highlightColumn (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Grid.GridControlColumnProviderBase.HighlightColumnProperty, box v)) :: node.Props }
    let columnProvider (v: DevExpress.Xpf.Grid.GridControlColumnProviderBase) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Grid.GridControlColumnProviderBase.ColumnProviderProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Grid.GridControlColumnProviderBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
