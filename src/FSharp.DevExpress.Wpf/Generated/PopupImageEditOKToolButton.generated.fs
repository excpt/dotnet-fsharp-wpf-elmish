...
type PopupImageEditOKToolButtonProp =
    | Base of PopupImageEditButtonProp

module PopupImageEditOKToolButton =

    let apply (el: DevExpress.Xpf.Editors.PopupImageEditOKToolButton) (prop: PopupImageEditOKToolButtonProp) =
        match prop with
        | PopupImageEditOKToolButtonProp.Base p -> PopupImageEditButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupImageEditOKToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
