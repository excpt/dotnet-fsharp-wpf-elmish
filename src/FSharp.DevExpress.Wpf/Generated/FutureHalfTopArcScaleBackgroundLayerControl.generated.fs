...
type FutureHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FutureHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureHalfTopArcScaleBackgroundLayerControl) (prop: FutureHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | FutureHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
