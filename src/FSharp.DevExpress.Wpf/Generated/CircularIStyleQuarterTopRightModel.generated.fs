...
type CircularIStyleQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularIStyleQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularIStyleQuarterTopRightModel) (prop: CircularIStyleQuarterTopRightModelProp) =
        match prop with
        | CircularIStyleQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularIStyleQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
