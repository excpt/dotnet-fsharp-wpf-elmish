...
type SchedulerRangeControlClientProp =
    | SchedulerControl of DevExpress.Xpf.Scheduler.SchedulerControl

module SchedulerRangeControlClient =
    let schedulerControl v : obj = box (SchedulerRangeControlClientProp.SchedulerControl v)

    let apply (el: DevExpress.Xpf.Scheduler.SchedulerRangeControlClient) (prop: SchedulerRangeControlClientProp) =
        match prop with
        | SchedulerRangeControlClientProp.SchedulerControl v -> el.SetValue(DevExpress.Xpf.Scheduler.SchedulerRangeControlClient.SchedulerControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.SchedulerRangeControlClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
