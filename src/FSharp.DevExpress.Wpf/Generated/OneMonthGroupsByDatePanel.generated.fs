...
type OneMonthGroupsByDatePanelProp =
    | Base of OneMonthGroupsPanelProp

module OneMonthGroupsByDatePanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsByDatePanel) (prop: OneMonthGroupsByDatePanelProp) =
        match prop with
        | OneMonthGroupsByDatePanelProp.Base p -> OneMonthGroupsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.OneMonthGroupsByDatePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
