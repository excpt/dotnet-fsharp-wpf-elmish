...
type ComboBoxDashboardLayoutItemProp =
    | Base of DashboardLayoutItemProp

module ComboBoxDashboardLayoutItem =

    let apply (el: DevExpress.DashboardWpf.ComboBoxDashboardLayoutItem) (prop: ComboBoxDashboardLayoutItemProp) =
        match prop with
        | ComboBoxDashboardLayoutItemProp.Base p -> DashboardLayoutItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.ComboBoxDashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
