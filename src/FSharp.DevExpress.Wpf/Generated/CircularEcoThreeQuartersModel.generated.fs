...
type CircularEcoThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularEcoThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularEcoThreeQuartersModel) (prop: CircularEcoThreeQuartersModelProp) =
        match prop with
        | CircularEcoThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularEcoThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
