...
type HeaderedStackLayoutPanelProp =
    | Base of StackLayoutPanelProp
...
module HeaderedStackLayoutPanel =
    let showGroupHeaders v : obj = box (HeaderedStackLayoutPanelProp.ShowGroupHeaders v)
    let groupHeaderSpace v : obj = box (HeaderedStackLayoutPanelProp.GroupHeaderSpace v)
    let groupHeaderStyle v : obj = box (HeaderedStackLayoutPanelProp.GroupHeaderStyle v)
    let groupHeaderTemplate v : obj = box (HeaderedStackLayoutPanelProp.GroupHeaderTemplate v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel) (prop: HeaderedStackLayoutPanelProp) =
        match prop with
        | HeaderedStackLayoutPanelProp.Base p -> StackLayoutPanel.apply el p
        | HeaderedStackLayoutPanelProp.ShowGroupHeaders v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel.ShowGroupHeadersProperty, box v)
        | HeaderedStackLayoutPanelProp.GroupHeaderSpace v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel.GroupHeaderSpaceProperty, box v)
        | HeaderedStackLayoutPanelProp.GroupHeaderStyle v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel.GroupHeaderStyleProperty, box v)
        | HeaderedStackLayoutPanelProp.GroupHeaderTemplate v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel.GroupHeaderTemplateProperty, box v)
    ...
    let groupHeader (v: obj) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel.GroupHeaderProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.HeaderedStackLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
