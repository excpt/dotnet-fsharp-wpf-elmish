...
type ImageGalleryItemProp =
    | Header of obj
    | HeaderStyle of System.Windows.Style
    | HeaderHeight of float
    | ItemsSource of System.Collections.IList
    | ItemStyle of System.Windows.Style
    | ItemSize of System.Windows.Size

module ImageGalleryItem =
    let header v : obj = box (ImageGalleryItemProp.Header v)
    let headerStyle v : obj = box (ImageGalleryItemProp.HeaderStyle v)
    let headerHeight v : obj = box (ImageGalleryItemProp.HeaderHeight v)
    let itemsSource v : obj = box (ImageGalleryItemProp.ItemsSource v)
    let itemStyle v : obj = box (ImageGalleryItemProp.ItemStyle v)
    let itemSize v : obj = box (ImageGalleryItemProp.ItemSize v)

    let apply (el: DevExpress.Xpf.Core.Native.ImageGalleryItem) (prop: ImageGalleryItemProp) =
        match prop with
        | ImageGalleryItemProp.Header v -> el.SetValue(DevExpress.Xpf.Core.Native.ImageGalleryItem.HeaderProperty, box v)
        | ImageGalleryItemProp.HeaderStyle v -> el.SetValue(DevExpress.Xpf.Core.Native.ImageGalleryItem.HeaderStyleProperty, box v)
        | ImageGalleryItemProp.HeaderHeight v -> el.SetValue(DevExpress.Xpf.Core.Native.ImageGalleryItem.HeaderHeightProperty, box v)
        | ImageGalleryItemProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Core.Native.ImageGalleryItem.ItemsSourceProperty, box v)
        | ImageGalleryItemProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Core.Native.ImageGalleryItem.ItemStyleProperty, box v)
        | ImageGalleryItemProp.ItemSize v -> el.SetValue(DevExpress.Xpf.Core.Native.ImageGalleryItem.ItemSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.ImageGalleryItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
