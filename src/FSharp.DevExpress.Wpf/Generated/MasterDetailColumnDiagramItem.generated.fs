...
type MasterDetailColumnDiagramItemProp =
    | Base of DiagramContentItemProp

module MasterDetailColumnDiagramItem =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailColumnDiagramItem) (prop: MasterDetailColumnDiagramItemProp) =
        match prop with
        | MasterDetailColumnDiagramItemProp.Base p -> DiagramContentItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.MasterDetailColumnDiagramItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
