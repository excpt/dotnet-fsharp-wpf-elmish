...
module SpinEditEx =
    ...
    let apply (el: DevExpress.Xpf.Printing.Native.SpinEditEx) (prop: SpinEditExProp) =
        match prop with
        | SpinEditExProp.Base p -> SpinEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.SpinEditEx>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
