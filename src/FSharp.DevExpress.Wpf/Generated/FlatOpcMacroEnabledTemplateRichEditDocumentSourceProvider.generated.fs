...
type FlatOpcMacroEnabledTemplateRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module FlatOpcMacroEnabledTemplateRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.FlatOpcMacroEnabledTemplateRichEditDocumentSourceProvider) (prop: FlatOpcMacroEnabledTemplateRichEditDocumentSourceProviderProp) =
        match prop with
        | FlatOpcMacroEnabledTemplateRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p

    let source v : obj = box (RichEditDocumentSourceProviderProp.Source v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.FlatOpcMacroEnabledTemplateRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
