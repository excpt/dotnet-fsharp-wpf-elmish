...
type FlatLightLinearScaleLineControlProp =
    | Base of PresentationControlProp

module FlatLightLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightLinearScaleLineControl) (prop: FlatLightLinearScaleLineControlProp) =
        match prop with
        | FlatLightLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
