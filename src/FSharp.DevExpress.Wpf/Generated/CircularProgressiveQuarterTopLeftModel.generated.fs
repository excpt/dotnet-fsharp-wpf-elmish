...
type CircularProgressiveQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularProgressiveQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularProgressiveQuarterTopLeftModel) (prop: CircularProgressiveQuarterTopLeftModelProp) =
        match prop with
        | CircularProgressiveQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularProgressiveQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
