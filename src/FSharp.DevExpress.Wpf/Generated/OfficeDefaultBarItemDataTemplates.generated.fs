...
open System
open System.Windows
open DevExpress.Xpf.Office.UI
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type OfficeDefaultBarItemDataTemplatesProp =
...
module OfficeDefaultBarItemDataTemplates =
    let marginBarItemContentTemplate v : obj = box (OfficeDefaultBarItemDataTemplatesProp.MarginBarItemContentTemplate v)
    let paperKindBarItemContentTemplate v : obj = box (OfficeDefaultBarItemDataTemplatesProp.PaperKindBarItemContentTemplate v)
    let checkEditTemplate v : obj = box (OfficeDefaultBarItemDataTemplatesProp.CheckEditTemplate v)

    let apply (el: DevExpress.Xpf.Office.UI.OfficeDefaultBarItemDataTemplates) (prop: OfficeDefaultBarItemDataTemplatesProp) =
        match prop with
        | OfficeDefaultBarItemDataTemplatesProp.MarginBarItemContentTemplate v -> el.SetValue(DevExpress.Xpf.Office.UI.OfficeDefaultBarItemDataTemplates.MarginBarItemContentTemplateProperty, box v)
        | OfficeDefaultBarItemDataTemplatesProp.PaperKindBarItemContentTemplate v -> el.SetValue(DevExpress.Xpf.Office.UI.OfficeDefaultBarItemDataTemplates.PaperKindBarItemContentTemplateProperty, box v)
        | OfficeDefaultBarItemDataTemplatesProp.CheckEditTemplate v -> el.SetValue(DevExpress.Xpf.Office.UI.OfficeDefaultBarItemDataTemplates.CheckEditTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Office.UI.OfficeDefaultBarItemDataTemplates>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
