...
module Chrome =
    ...
    let apply (el: DevExpress.Xpf.Core.Native.Chrome) (prop: ChromeProp) =
        match prop with
        | ChromeProp.Foreground v -> el.SetValue(DevExpress.Xpf.Core.Native.Chrome.ForegroundProperty, box v)
        | ChromeProp.FontSize v -> el.SetValue(DevExpress.Xpf.Core.Native.Chrome.FontSizeProperty, box v)
        | ChromeProp.FontFamily v -> el.SetValue(DevExpress.Xpf.Core.Native.Chrome.FontFamilyProperty, box v)
        | ChromeProp.FontStretch v -> el.SetValue(DevExpress.Xpf.Core.Native.Chrome.FontStretchProperty, box v)
        | ChromeProp.FontStyle v -> el.SetValue(DevExpress.Xpf.Core.Native.Chrome.FontStyleProperty, box v)
        | ChromeProp.FontWeight v -> el.SetValue(DevExpress.Xpf.Core.Native.Chrome.FontWeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.Chrome>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
