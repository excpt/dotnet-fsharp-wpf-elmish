...
type DataBarSymbologyProp =
    | FNC1Substitute of string
    | SegmentsInRow of int
    | Type of DevExpress.XtraPrinting.BarCode.DataBarType

module DataBarSymbology =
    let fNC1Substitute v : obj = box (DataBarSymbologyProp.FNC1Substitute v)
    let segmentsInRow v : obj = box (DataBarSymbologyProp.SegmentsInRow v)
    let type v : obj = box (DataBarSymbologyProp.Type v)

    let apply (el: DevExpress.Xpf.Controls.DataBarSymbology) (prop: DataBarSymbologyProp) =
        match prop with
        | DataBarSymbologyProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Controls.DataBarSymbology.FNC1SubstituteProperty, box v)
        | DataBarSymbologyProp.SegmentsInRow v -> el.SetValue(DevExpress.Xpf.Controls.DataBarSymbology.SegmentsInRowProperty, box v)
        | DataBarSymbologyProp.Type v -> el.SetValue(DevExpress.Xpf.Controls.DataBarSymbology.TypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.DataBarSymbology>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
