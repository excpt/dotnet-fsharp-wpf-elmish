...
type GlueToPointAdornerProp =
    | Base of GlueToPointAdornerBaseProp

module GlueToPointAdorner =

    let apply (el: DevExpress.Xpf.Diagram.GlueToPointAdorner) (prop: GlueToPointAdornerProp) =
        match prop with
        | GlueToPointAdornerProp.Base p -> GlueToPointAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.GlueToPointAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
