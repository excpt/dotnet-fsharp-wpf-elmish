...
type LayoutItemCustomizationToolbarButtonArrowProp =
    | DefaultDirection of DevExpress.Xpf.Core.Side
    | Direction of DevExpress.Xpf.Core.Side
    | RotateTransform of System.Windows.Media.RotateTransform

module LayoutItemCustomizationToolbarButtonArrow =
    let defaultDirection v : obj = box (LayoutItemCustomizationToolbarButtonArrowProp.DefaultDirection v)
    let direction v : obj = box (LayoutItemCustomizationToolbarButtonArrowProp.Direction v)
    let rotateTransform v : obj = box (LayoutItemCustomizationToolbarButtonArrowProp.RotateTransform v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButtonArrow) (prop: LayoutItemCustomizationToolbarButtonArrowProp) =
        match prop with
        | LayoutItemCustomizationToolbarButtonArrowProp.DefaultDirection v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButtonArrow.DefaultDirectionProperty, box v)
        | LayoutItemCustomizationToolbarButtonArrowProp.Direction v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButtonArrow.DirectionProperty, box v)
        | LayoutItemCustomizationToolbarButtonArrowProp.RotateTransform v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButtonArrow.RotateTransformProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbarButtonArrow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
