...
type AppointmentRightArrowPresenterProp =
    | Base of AppointmentArrowPresenterBaseProp

module AppointmentRightArrowPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentRightArrowPresenter) (prop: AppointmentRightArrowPresenterProp) =
        match prop with
        | AppointmentRightArrowPresenterProp.Base p -> AppointmentArrowPresenterBase.apply el p

    let space v : obj = box (AppointmentArrowPresenterBaseProp.Space v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentRightArrowPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
