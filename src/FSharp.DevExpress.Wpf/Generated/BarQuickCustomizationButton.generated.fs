...
type BarQuickCustomizationButtonProp =
    | Orientation of System.Windows.Controls.Orientation

module BarQuickCustomizationButton =
    let orientation v : obj = box (BarQuickCustomizationButtonProp.Orientation v)

    let apply (el: DevExpress.Xpf.Bars.BarQuickCustomizationButton) (prop: BarQuickCustomizationButtonProp) =
        match prop with
        | BarQuickCustomizationButtonProp.Orientation v -> el.SetValue(DevExpress.Xpf.Bars.BarQuickCustomizationButton.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarQuickCustomizationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
