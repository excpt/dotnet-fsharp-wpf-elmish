...
type FlyoutCommandButtonProp =
    | Base of veButtonBaseProp

module FlyoutCommandButton =

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.FlyoutCommandButton) (prop: FlyoutCommandButtonProp) =
        match prop with
        | FlyoutCommandButtonProp.Base p -> veButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.FlyoutCommandButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
