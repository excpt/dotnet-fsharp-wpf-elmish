...
type WorksheetHeadersControlProp =
    | Orientation of System.Windows.Controls.Orientation
    | ItemTemplate of System.Windows.Controls.ControlTemplate
    | Items of obj

module WorksheetHeadersControl =
    let orientation v : obj = box (WorksheetHeadersControlProp.Orientation v)
    let itemTemplate v : obj = box (WorksheetHeadersControlProp.ItemTemplate v)
    let items v : obj = box (WorksheetHeadersControlProp.Items v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetHeadersControl) (prop: WorksheetHeadersControlProp) =
        match prop with
        | WorksheetHeadersControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetHeadersControl.OrientationProperty, box v)
        | WorksheetHeadersControlProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetHeadersControl.ItemTemplateProperty, box v)
        | WorksheetHeadersControlProp.Items v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetHeadersControl.ItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetHeadersControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
