...
type BrowsePathEditProp =
    | Base of ButtonEditProp
    | DialogType of DevExpress.Xpf.Editors.DialogType
    | ShowIcon of bool
    | DialogFilter of string
    | PathIconSelector of DevExpress.Xpf.Editors.IPathIconSelector

module BrowsePathEdit =
    let dialogType v : obj = box (BrowsePathEditProp.DialogType v)
    let showIcon v : obj = box (BrowsePathEditProp.ShowIcon v)
    let dialogFilter v : obj = box (BrowsePathEditProp.DialogFilter v)
    let pathIconSelector v : obj = box (BrowsePathEditProp.PathIconSelector v)

    let apply (el: DevExpress.Xpf.Editors.BrowsePathEdit) (prop: BrowsePathEditProp) =
        match prop with
        | BrowsePathEditProp.Base p -> ButtonEdit.apply el p
        | BrowsePathEditProp.DialogType v -> el.SetValue(DevExpress.Xpf.Editors.BrowsePathEdit.DialogTypeProperty, box v)
        | BrowsePathEditProp.ShowIcon v -> el.SetValue(DevExpress.Xpf.Editors.BrowsePathEdit.ShowIconProperty, box v)
        | BrowsePathEditProp.DialogFilter v -> el.SetValue(DevExpress.Xpf.Editors.BrowsePathEdit.DialogFilterProperty, box v)
        | BrowsePathEditProp.PathIconSelector v -> el.SetValue(DevExpress.Xpf.Editors.BrowsePathEdit.PathIconSelectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BrowsePathEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
