...
type ConnectorSelectionAdornerProp =
    | ZoomFactor of float

module ConnectorSelectionAdorner =
    let zoomFactor v : obj = box (ConnectorSelectionAdornerProp.ZoomFactor v)

    let apply (el: DevExpress.Xpf.Diagram.ConnectorSelectionAdorner) (prop: ConnectorSelectionAdornerProp) =
        match prop with
        | ConnectorSelectionAdornerProp.ZoomFactor v -> el.SetValue(DevExpress.Xpf.Diagram.ConnectorSelectionAdorner.ZoomFactorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ConnectorSelectionAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
