...
type ButtonsPanelProp =
    | Base of psvControlProp

module ButtonsPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.ButtonsPanel) (prop: ButtonsPanelProp) =
        match prop with
        | ButtonsPanelProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.ButtonsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
