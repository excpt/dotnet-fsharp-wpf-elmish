...
module GridColumnHeaderBase =
    ...
    let apply (el: DevExpress.Xpf.Grid.GridColumnHeaderBase) (prop: GridColumnHeaderBaseProp) =
        match prop with
        | GridColumnHeaderBaseProp.ColumnPosition v -> el.SetValue(DevExpress.Xpf.Grid.GridColumnHeaderBase.ColumnPositionProperty, box v)
        | GridColumnHeaderBaseProp.HasTopElement v -> el.SetValue(DevExpress.Xpf.Grid.GridColumnHeaderBase.HasTopElementProperty, box v)
        | GridColumnHeaderBaseProp.HasBottomElement v -> el.SetValue(DevExpress.Xpf.Grid.GridColumnHeaderBase.HasBottomElementProperty, box v)
        | GridColumnHeaderBaseProp.HasRightSibling v -> el.SetValue(DevExpress.Xpf.Grid.GridColumnHeaderBase.HasRightSiblingProperty, box v)
        | GridColumnHeaderBaseProp.HasLeftSibling v -> el.SetValue(DevExpress.Xpf.Grid.GridColumnHeaderBase.HasLeftSiblingProperty, box v)
    ...
    let isSelectedInDesignTime (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Grid.GridColumnHeaderBase.IsSelectedInDesignTimeProperty, box v)) :: node.Props }
