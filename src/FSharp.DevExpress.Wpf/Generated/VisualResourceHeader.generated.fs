...
type VisualResourceHeaderProp =
    | Base of VisualResourceHeaderBaseProp

module VisualResourceHeader =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualResourceHeader) (prop: VisualResourceHeaderProp) =
        match prop with
        | VisualResourceHeaderProp.Base p -> VisualResourceHeaderBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualResourceHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
