...
open System
open System.Windows
open DevExpress.Xpf.Core.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type GlyphControlProp =
    | Size of int
    | Mode of DevExpress.Xpf.Core.Native.GlyphControlMode
    | GlyphLeftTemplate of System.Windows.Controls.ControlTemplate
    | GlyphRightTemplate of System.Windows.Controls.ControlTemplate
    | GlyphUpTemplate of System.Windows.Controls.ControlTemplate
    | GlyphDownTemplate of System.Windows.Controls.ControlTemplate
    | GlyphPlusTemplate of System.Windows.Controls.ControlTemplate
    | GlyphCloseTemplate of System.Windows.Controls.ControlTemplate
    | GlyphLeftPadding of System.Windows.Thickness
    | GlyphRightPadding of System.Windows.Thickness
    | GlyphUpPadding of System.Windows.Thickness
    | GlyphDownPadding of System.Windows.Thickness
    | GlyphPlusPadding of System.Windows.Thickness
    | GlyphClosePadding of System.Windows.Thickness
    | GlyphViewInfo of DevExpress.Xpf.Core.Native.GlyphControlViewInfo

module GlyphControl =
    let size v : obj = box (GlyphControlProp.Size v)
    let mode v : obj = box (GlyphControlProp.Mode v)
    let glyphLeftTemplate v : obj = box (GlyphControlProp.GlyphLeftTemplate v)
    let glyphRightTemplate v : obj = box (GlyphControlProp.GlyphRightTemplate v)
    let glyphUpTemplate v : obj = box (GlyphControlProp.GlyphUpTemplate v)
    let glyphDownTemplate v : obj = box (GlyphControlProp.GlyphDownTemplate v)
    let glyphPlusTemplate v : obj = box (GlyphControlProp.GlyphPlusTemplate v)
    let glyphCloseTemplate v : obj = box (GlyphControlProp.GlyphCloseTemplate v)
    let glyphLeftPadding v : obj = box (GlyphControlProp.GlyphLeftPadding v)
    let glyphRightPadding v : obj = box (GlyphControlProp.GlyphRightPadding v)
    let glyphUpPadding v : obj = box (GlyphControlProp.GlyphUpPadding v)
    let glyphDownPadding v : obj = box (GlyphControlProp.GlyphDownPadding v)
    let glyphPlusPadding v : obj = box (GlyphControlProp.GlyphPlusPadding v)
    let glyphClosePadding v : obj = box (GlyphControlProp.GlyphClosePadding v)
    let glyphViewInfo v : obj = box (GlyphControlProp.GlyphViewInfo v)

    let apply (el: DevExpress.Xpf.Core.Native.GlyphControl) (prop: GlyphControlProp) =
        match prop with
        | GlyphControlProp.Size v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.SizeProperty, box v)
        | GlyphControlProp.Mode v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.ModeProperty, box v)
        | GlyphControlProp.GlyphLeftTemplate v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphLeftTemplateProperty, box v)
        | GlyphControlProp.GlyphRightTemplate v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphRightTemplateProperty, box v)
        | GlyphControlProp.GlyphUpTemplate v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphUpTemplateProperty, box v)
        | GlyphControlProp.GlyphDownTemplate v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphDownTemplateProperty, box v)
        | GlyphControlProp.GlyphPlusTemplate v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphPlusTemplateProperty, box v)
        | GlyphControlProp.GlyphCloseTemplate v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphCloseTemplateProperty, box v)
        | GlyphControlProp.GlyphLeftPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphLeftPaddingProperty, box v)
        | GlyphControlProp.GlyphRightPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphRightPaddingProperty, box v)
        | GlyphControlProp.GlyphUpPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphUpPaddingProperty, box v)
        | GlyphControlProp.GlyphDownPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphDownPaddingProperty, box v)
        | GlyphControlProp.GlyphPlusPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphPlusPaddingProperty, box v)
        | GlyphControlProp.GlyphClosePadding v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphClosePaddingProperty, box v)
        | GlyphControlProp.GlyphViewInfo v -> el.SetValue(DevExpress.Xpf.Core.Native.GlyphControl.GlyphViewInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.GlyphControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
