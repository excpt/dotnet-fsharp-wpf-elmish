...
type WcfSimpleDataSourceProp =
    | Base of SimpleDataSourceProp
    | ServiceRoot of System.Uri

module WcfSimpleDataSource =
    let serviceRoot v : obj = box (WcfSimpleDataSourceProp.ServiceRoot v)

    let apply (el: DevExpress.Xpf.Core.DataSources.WcfSimpleDataSource) (prop: WcfSimpleDataSourceProp) =
        match prop with
        | WcfSimpleDataSourceProp.Base p -> SimpleDataSource.apply el p
        | WcfSimpleDataSourceProp.ServiceRoot v -> el.SetValue(DevExpress.Xpf.Core.DataSources.WcfSimpleDataSource.ServiceRootProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.WcfSimpleDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
