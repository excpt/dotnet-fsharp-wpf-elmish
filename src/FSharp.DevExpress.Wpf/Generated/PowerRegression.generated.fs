...
type PowerRegressionProp =
    | Base of ParametricRegressionProp

module PowerRegression =

    let apply (el: DevExpress.Xpf.Charts.PowerRegression) (prop: PowerRegressionProp) =
        match prop with
        | PowerRegressionProp.Base p -> ParametricRegression.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PowerRegression>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
