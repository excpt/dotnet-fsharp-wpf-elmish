...
type SimpleMarker2DModelControlProp =
    | Base of PredefinedMarker2DModelControlProp

module SimpleMarker2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.SimpleMarker2DModelControl) (prop: SimpleMarker2DModelControlProp) =
        match prop with
        | SimpleMarker2DModelControlProp.Base p -> PredefinedMarker2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleMarker2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
