...
type CircularProgressiveQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularProgressiveQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularProgressiveQuarterTopRightModel) (prop: CircularProgressiveQuarterTopRightModelProp) =
        match prop with
        | CircularProgressiveQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularProgressiveQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
