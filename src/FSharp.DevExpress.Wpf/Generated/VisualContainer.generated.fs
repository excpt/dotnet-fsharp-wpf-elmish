...
type VisualContainerProp =
    | Base of ChartElementBaseProp
    | Diagram of DevExpress.Xpf.Charts.Diagram

module VisualContainer =
    let diagram v : obj = box (VisualContainerProp.Diagram v)

    let apply (el: DevExpress.Xpf.Charts.VisualContainer) (prop: VisualContainerProp) =
        match prop with
        | VisualContainerProp.Base p -> ChartElementBase.apply el p
        | VisualContainerProp.Diagram v -> el.SetValue(DevExpress.Xpf.Charts.VisualContainer.DiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.VisualContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
