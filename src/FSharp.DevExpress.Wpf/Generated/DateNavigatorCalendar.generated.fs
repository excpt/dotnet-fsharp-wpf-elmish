...
open System
open System.Windows
open DevExpress.Xpf.Editors.DateNavigator.Controls
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type DateNavigatorCalendarProp =
    | Base of DateNavigatorCalendarBaseProp
    | WeekdayAbbreviationStyle of System.Windows.Style
    | WeekNumberStyle of System.Windows.Style
    | CellButtonStyle of System.Windows.Style
    | MonthInfoTemplate of System.Windows.Controls.ControlTemplate
    | YearInfoTemplate of System.Windows.Controls.ControlTemplate
    | YearsInfoTemplate of System.Windows.Controls.ControlTemplate
    | YearsRangeInfoTemplate of System.Windows.Controls.ControlTemplate
    | CalendarTransferStyle of System.Windows.Style
    | MinValue of obj
    | MaxValue of obj
    | Calendar of DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar
    | ShowWeekNumbers of bool
    | ResizeToMaxContent of bool
    | WeekNumberRule of obj
    | HighlightSpecialDates of bool
    | HighlightHolidays of bool
    | FirstDayOfWeek of obj

module DateNavigatorCalendar =
    let weekdayAbbreviationStyle v : obj = box (DateNavigatorCalendarProp.WeekdayAbbreviationStyle v)
    let weekNumberStyle v : obj = box (DateNavigatorCalendarProp.WeekNumberStyle v)
    let cellButtonStyle v : obj = box (DateNavigatorCalendarProp.CellButtonStyle v)
    let monthInfoTemplate v : obj = box (DateNavigatorCalendarProp.MonthInfoTemplate v)
    let yearInfoTemplate v : obj = box (DateNavigatorCalendarProp.YearInfoTemplate v)
    let yearsInfoTemplate v : obj = box (DateNavigatorCalendarProp.YearsInfoTemplate v)
    let yearsRangeInfoTemplate v : obj = box (DateNavigatorCalendarProp.YearsRangeInfoTemplate v)
    let calendarTransferStyle v : obj = box (DateNavigatorCalendarProp.CalendarTransferStyle v)
    let minValue v : obj = box (DateNavigatorCalendarProp.MinValue v)
    let maxValue v : obj = box (DateNavigatorCalendarProp.MaxValue v)
    let calendar v : obj = box (DateNavigatorCalendarProp.Calendar v)
    let showWeekNumbers v : obj = box (DateNavigatorCalendarProp.ShowWeekNumbers v)
    let resizeToMaxContent v : obj = box (DateNavigatorCalendarProp.ResizeToMaxContent v)
    let weekNumberRule v : obj = box (DateNavigatorCalendarProp.WeekNumberRule v)
    let highlightSpecialDates v : obj = box (DateNavigatorCalendarProp.HighlightSpecialDates v)
    let highlightHolidays v : obj = box (DateNavigatorCalendarProp.HighlightHolidays v)
    let firstDayOfWeek v : obj = box (DateNavigatorCalendarProp.FirstDayOfWeek v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar) (prop: DateNavigatorCalendarProp) =
        match prop with
        | DateNavigatorCalendarProp.Base p -> DateNavigatorCalendarBase.apply el p
        | DateNavigatorCalendarProp.WeekdayAbbreviationStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.WeekdayAbbreviationStyleProperty, box v)
        | DateNavigatorCalendarProp.WeekNumberStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.WeekNumberStyleProperty, box v)
        | DateNavigatorCalendarProp.CellButtonStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.CellButtonStyleProperty, box v)
        | DateNavigatorCalendarProp.MonthInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.MonthInfoTemplateProperty, box v)
        | DateNavigatorCalendarProp.YearInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.YearInfoTemplateProperty, box v)
        | DateNavigatorCalendarProp.YearsInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.YearsInfoTemplateProperty, box v)
        | DateNavigatorCalendarProp.YearsRangeInfoTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.YearsRangeInfoTemplateProperty, box v)
        | DateNavigatorCalendarProp.CalendarTransferStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.CalendarTransferStyleProperty, box v)
        | DateNavigatorCalendarProp.MinValue v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.MinValueProperty, box v)
        | DateNavigatorCalendarProp.MaxValue v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.MaxValueProperty, box v)
        | DateNavigatorCalendarProp.Calendar v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.CalendarProperty, box v)
        | DateNavigatorCalendarProp.ShowWeekNumbers v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.ShowWeekNumbersProperty, box v)
        | DateNavigatorCalendarProp.ResizeToMaxContent v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.ResizeToMaxContentProperty, box v)
        | DateNavigatorCalendarProp.WeekNumberRule v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.WeekNumberRuleProperty, box v)
        | DateNavigatorCalendarProp.HighlightSpecialDates v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.HighlightSpecialDatesProperty, box v)
        | DateNavigatorCalendarProp.HighlightHolidays v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.HighlightHolidaysProperty, box v)
        | DateNavigatorCalendarProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.FirstDayOfWeekProperty, box v)
    ...
    let dateTime (v: System.DateTime) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.DateTimeProperty, box v)) :: node.Props }
    let cellState (v: DevExpress.Xpf.Editors.DateNavigator.DateNavigatorCalendarCellState) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.CellStateProperty, box v)) :: node.Props }
    let weekFirstDate (v: obj) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar.WeekFirstDateProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
