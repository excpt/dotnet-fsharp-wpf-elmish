...
type TimelineCellsDecorationPanelProp =
    | Base of CellsDecorationPanelProp

module TimelineCellsDecorationPanel =

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecorationPanel) (prop: TimelineCellsDecorationPanelProp) =
        match prop with
        | TimelineCellsDecorationPanelProp.Base p -> CellsDecorationPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.TimelineCellsDecorationPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
