...
type DocmRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module DocmRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.DocmRichEditDocumentSourceProvider) (prop: DocmRichEditDocumentSourceProviderProp) =
        match prop with
        | DocmRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.DocmRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
