...
type Diagram3DRotationActionProp =
    | Base of Diagram3DAnimationActionProp
    | Rotation of DevExpress.Xpf.Charts.AnimationRotation

module Diagram3DRotationAction =
    let rotation v : obj = box (Diagram3DRotationActionProp.Rotation v)

    let apply (el: DevExpress.Xpf.Charts.Diagram3DRotationAction) (prop: Diagram3DRotationActionProp) =
        match prop with
        | Diagram3DRotationActionProp.Base p -> Diagram3DAnimationAction.apply el p
        | Diagram3DRotationActionProp.Rotation v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DRotationAction.RotationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Diagram3DRotationAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
