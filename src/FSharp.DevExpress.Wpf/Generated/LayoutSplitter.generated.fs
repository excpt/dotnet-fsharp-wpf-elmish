...
type LayoutSplitterProp =
    | Base of FixedItemProp

module LayoutSplitter =

    let apply (el: DevExpress.Xpf.Docking.LayoutSplitter) (prop: LayoutSplitterProp) =
        match prop with
        | LayoutSplitterProp.Base p -> FixedItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.LayoutSplitter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
