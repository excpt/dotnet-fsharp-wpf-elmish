...
type GalleryItemGroupControlProp =
    | Group of DevExpress.Xpf.Bars.GalleryItemGroup
    | GroupsControl of DevExpress.Xpf.Bars.GalleryItemGroupsControl

module GalleryItemGroupControl =
    let group v : obj = box (GalleryItemGroupControlProp.Group v)
    let groupsControl v : obj = box (GalleryItemGroupControlProp.GroupsControl v)

    let apply (el: DevExpress.Xpf.Bars.GalleryItemGroupControl) (prop: GalleryItemGroupControlProp) =
        match prop with
        | GalleryItemGroupControlProp.Group v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupControl.GroupProperty, box v)
        | GalleryItemGroupControlProp.GroupsControl v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemGroupControl.GroupsControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryItemGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
