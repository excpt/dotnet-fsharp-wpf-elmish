...
type FlatOpcTemplateRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module FlatOpcTemplateRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.FlatOpcTemplateRichEditDocumentSourceProvider) (prop: FlatOpcTemplateRichEditDocumentSourceProviderProp) =
        match prop with
        | FlatOpcTemplateRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.FlatOpcTemplateRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
