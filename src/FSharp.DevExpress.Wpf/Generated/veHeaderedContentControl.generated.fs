...
type veHeaderedContentControlProp =
    | Base of veContentControlProp
    | Header of obj
...
module veHeaderedContentControl =
    let header v : obj = box (veHeaderedContentControlProp.Header v)
    let headerTemplate v : obj = box (veHeaderedContentControlProp.HeaderTemplate v)
    let headerTemplateSelector v : obj = box (veHeaderedContentControlProp.HeaderTemplateSelector v)
    let headerStringFormat v : obj = box (veHeaderedContentControlProp.HeaderStringFormat v)
    let actualHeader v : obj = box (veHeaderedContentControlProp.ActualHeader v)
    let hasHeader v : obj = box (veHeaderedContentControlProp.HasHeader v)
    let hasHeaderTemplate v : obj = box (veHeaderedContentControlProp.HasHeaderTemplate v)

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl) (prop: veHeaderedContentControlProp) =
        match prop with
        | veHeaderedContentControlProp.Base p -> veContentControl.apply el p
        | veHeaderedContentControlProp.Header v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.HeaderProperty, box v)
        | veHeaderedContentControlProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.HeaderTemplateProperty, box v)
        | veHeaderedContentControlProp.HeaderTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.HeaderTemplateSelectorProperty, box v)
        | veHeaderedContentControlProp.HeaderStringFormat v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.HeaderStringFormatProperty, box v)
        | veHeaderedContentControlProp.ActualHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.ActualHeaderProperty, box v)
        | veHeaderedContentControlProp.HasHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.HasHeaderProperty, box v)
        | veHeaderedContentControlProp.HasHeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl.HasHeaderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Base.veHeaderedContentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
