...
type OutsetRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module OutsetRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.OutsetRangeBar2DModelControl) (prop: OutsetRangeBar2DModelControlProp) =
        match prop with
        | OutsetRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.OutsetRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
