...
type NestedDonut2DGroupItemsControlProp =
    | Base of Diagram2DItemsControlProp
    | NestedDonutGroup of DevExpress.Xpf.Charts.Native.NestedDonut2DGroup

module NestedDonut2DGroupItemsControl =
    let nestedDonutGroup v : obj = box (NestedDonut2DGroupItemsControlProp.NestedDonutGroup v)

    let apply (el: DevExpress.Xpf.Charts.NestedDonut2DGroupItemsControl) (prop: NestedDonut2DGroupItemsControlProp) =
        match prop with
        | NestedDonut2DGroupItemsControlProp.Base p -> Diagram2DItemsControl.apply el p
        | NestedDonut2DGroupItemsControlProp.NestedDonutGroup v -> el.SetValue(DevExpress.Xpf.Charts.NestedDonut2DGroupItemsControl.NestedDonutGroupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.NestedDonut2DGroupItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
