...
type FlatDarkLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module FlatDarkLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkLinearScaleMarkerControl) (prop: FlatDarkLinearScaleMarkerControlProp) =
        match prop with
        | FlatDarkLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
