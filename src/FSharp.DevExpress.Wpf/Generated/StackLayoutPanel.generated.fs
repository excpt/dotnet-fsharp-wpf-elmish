...
module StackLayoutPanel =
    let allowItemMoving v : obj = box (StackLayoutPanelProp.AllowItemMoving v)
    let animateItemMoving v : obj = box (StackLayoutPanelProp.AnimateItemMoving v)
    let itemMovingAnimationDuration v : obj = box (StackLayoutPanelProp.ItemMovingAnimationDuration v)
    let movingItemPlaceHolderBrush v : obj = box (StackLayoutPanelProp.MovingItemPlaceHolderBrush v)
    let orientation v : obj = box (StackLayoutPanelProp.Orientation v)
    let allowItemClipping v : obj = box (StackLayoutPanelProp.AllowItemClipping v)
    let allowItemAlignment v : obj = box (StackLayoutPanelProp.AllowItemAlignment v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.StackLayoutPanel) (prop: StackLayoutPanelProp) =
        match prop with
        | StackLayoutPanelProp.Base p -> LayoutPanelBase.apply el p
        | StackLayoutPanelProp.AllowItemMoving v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.AllowItemMovingProperty, box v)
        | StackLayoutPanelProp.AnimateItemMoving v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.AnimateItemMovingProperty, box v)
        | StackLayoutPanelProp.ItemMovingAnimationDuration v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.ItemMovingAnimationDurationProperty, box v)
        | StackLayoutPanelProp.MovingItemPlaceHolderBrush v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.MovingItemPlaceHolderBrushProperty, box v)
        | StackLayoutPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.OrientationProperty, box v)
        | StackLayoutPanelProp.AllowItemClipping v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.AllowItemClippingProperty, box v)
        | StackLayoutPanelProp.AllowItemAlignment v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.StackLayoutPanel.AllowItemAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.StackLayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
