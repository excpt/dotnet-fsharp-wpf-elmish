...
type XPFContentPresenterProp =
    | Foreground of System.Windows.Media.Brush

module XPFContentPresenter =
    let foreground v : obj = box (XPFContentPresenterProp.Foreground v)

    let apply (el: DevExpress.Xpf.Core.XPFContentPresenter) (prop: XPFContentPresenterProp) =
        match prop with
        | XPFContentPresenterProp.Foreground v -> el.SetValue(DevExpress.Xpf.Core.XPFContentPresenter.ForegroundProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.XPFContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
