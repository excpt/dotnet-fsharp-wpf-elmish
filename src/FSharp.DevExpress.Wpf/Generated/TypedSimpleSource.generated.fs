...
type TypedSimpleSourceProp =
    | Base of SimpleDataSourceProp
    | AdapterType of System.Type

module TypedSimpleSource =
    let adapterType v : obj = box (TypedSimpleSourceProp.AdapterType v)

    let apply (el: DevExpress.Xpf.Core.DataSources.TypedSimpleSource) (prop: TypedSimpleSourceProp) =
        match prop with
        | TypedSimpleSourceProp.Base p -> SimpleDataSource.apply el p
        | TypedSimpleSourceProp.AdapterType v -> el.SetValue(DevExpress.Xpf.Core.DataSources.TypedSimpleSource.AdapterTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.TypedSimpleSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
