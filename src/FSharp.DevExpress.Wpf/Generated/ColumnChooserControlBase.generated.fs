...
type ColumnChooserControlBaseProp =
    | Owner of DevExpress.Xpf.Core.ILogicalOwner

module ColumnChooserControlBase =
    let owner v : obj = box (ColumnChooserControlBaseProp.Owner v)

    let apply (el: DevExpress.Xpf.Core.ColumnChooserControlBase) (prop: ColumnChooserControlBaseProp) =
        match prop with
        | ColumnChooserControlBaseProp.Owner v -> el.SetValue(DevExpress.Xpf.Core.ColumnChooserControlBase.OwnerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ColumnChooserControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
