...
type CircularCleanWhiteHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCleanWhiteHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCleanWhiteHalfTopModel) (prop: CircularCleanWhiteHalfTopModelProp) =
        match prop with
        | CircularCleanWhiteHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCleanWhiteHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
