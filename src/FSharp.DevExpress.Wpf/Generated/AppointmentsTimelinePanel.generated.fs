...
type AppointmentsTimelinePanelProp =
    | ExpandCommand of System.Windows.Input.ICommand
    | ExpandCommandParameter of obj
    | VisualData of DevExpress.Xpf.Scheduling.VisualData.IViewVisualData
    | Resource of DevExpress.Xpf.Scheduling.ResourceItem

module AppointmentsTimelinePanel =
    let expandCommand v : obj = box (AppointmentsTimelinePanelProp.ExpandCommand v)
    let expandCommandParameter v : obj = box (AppointmentsTimelinePanelProp.ExpandCommandParameter v)
    let visualData v : obj = box (AppointmentsTimelinePanelProp.VisualData v)
    let resource v : obj = box (AppointmentsTimelinePanelProp.Resource v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.AppointmentsTimelinePanel) (prop: AppointmentsTimelinePanelProp) =
        match prop with
        | AppointmentsTimelinePanelProp.ExpandCommand v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.AppointmentsTimelinePanel.ExpandCommandProperty, box v)
        | AppointmentsTimelinePanelProp.ExpandCommandParameter v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.AppointmentsTimelinePanel.ExpandCommandParameterProperty, box v)
        | AppointmentsTimelinePanelProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.AppointmentsTimelinePanel.VisualDataProperty, box v)
        | AppointmentsTimelinePanelProp.Resource v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.AppointmentsTimelinePanel.ResourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.AppointmentsTimelinePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
