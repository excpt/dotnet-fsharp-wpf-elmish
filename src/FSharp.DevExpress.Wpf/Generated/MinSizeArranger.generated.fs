...
type MinSizeArrangerProp =
    | MinChildWidth of float
    | MinChildHeight of float

module MinSizeArranger =
    let minChildWidth v : obj = box (MinSizeArrangerProp.MinChildWidth v)
    let minChildHeight v : obj = box (MinSizeArrangerProp.MinChildHeight v)

    let apply (el: DevExpress.Xpf.Core.MinSizeArranger) (prop: MinSizeArrangerProp) =
        match prop with
        | MinSizeArrangerProp.MinChildWidth v -> el.SetValue(DevExpress.Xpf.Core.MinSizeArranger.MinChildWidthProperty, box v)
        | MinSizeArrangerProp.MinChildHeight v -> el.SetValue(DevExpress.Xpf.Core.MinSizeArranger.MinChildHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.MinSizeArranger>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
