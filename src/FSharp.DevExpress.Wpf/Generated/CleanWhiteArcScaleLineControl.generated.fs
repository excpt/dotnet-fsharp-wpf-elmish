...
type CleanWhiteArcScaleLineControlProp =
    | Base of PresentationControlProp

module CleanWhiteArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteArcScaleLineControl) (prop: CleanWhiteArcScaleLineControlProp) =
        match prop with
        | CleanWhiteArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
