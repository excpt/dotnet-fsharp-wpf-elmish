...
type CheckedComboBoxStyleSettingsProp =
    | Base of BaseComboBoxStyleSettingsProp
    | ShowSelectAllItem of bool
    | SelectAllItemText of string

module CheckedComboBoxStyleSettings =
    ...
    let apply (el: DevExpress.Xpf.Editors.CheckedComboBoxStyleSettings) (prop: CheckedComboBoxStyleSettingsProp) =
        match prop with
        | CheckedComboBoxStyleSettingsProp.Base p -> BaseComboBoxStyleSettings.apply el p
        | CheckedComboBoxStyleSettingsProp.ShowSelectAllItem v -> el.SetValue(DevExpress.Xpf.Editors.CheckedComboBoxStyleSettings.ShowSelectAllItemProperty, box v)
        | CheckedComboBoxStyleSettingsProp.SelectAllItemText v -> el.SetValue(DevExpress.Xpf.Editors.CheckedComboBoxStyleSettings.SelectAllItemTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CheckedComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
