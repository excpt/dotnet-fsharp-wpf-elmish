...
type GalleryDropDownControlProp =
...
module GalleryDropDownControl =
    let gallery v : obj = box (GalleryDropDownControlProp.Gallery v)
    let isMenuVisible v : obj = box (GalleryDropDownControlProp.IsMenuVisible v)
    let initialVisibleColCount v : obj = box (GalleryDropDownControlProp.InitialVisibleColCount v)
    let initialVisibleRowCount v : obj = box (GalleryDropDownControlProp.InitialVisibleRowCount v)

    let apply (el: DevExpress.Xpf.Ribbon.GalleryDropDownControl) (prop: GalleryDropDownControlProp) =
        match prop with
        | GalleryDropDownControlProp.Base p -> PopupMenuBarControl.apply el p
        | GalleryDropDownControlProp.Gallery v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownControl.GalleryProperty, box v)
        | GalleryDropDownControlProp.IsMenuVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownControl.IsMenuVisibleProperty, box v)
        | GalleryDropDownControlProp.InitialVisibleColCount v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownControl.InitialVisibleColCountProperty, box v)
        | GalleryDropDownControlProp.InitialVisibleRowCount v -> el.SetValue(DevExpress.Xpf.Ribbon.GalleryDropDownControl.InitialVisibleRowCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.GalleryDropDownControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
