...
type MultiScaleWmsImageProp =
    | Base of FullRequestedMultiScaleImageProp

module MultiScaleWmsImage =

    let apply (el: DevExpress.Xpf.Map.MultiScaleWmsImage) (prop: MultiScaleWmsImageProp) =
        match prop with
        | MultiScaleWmsImageProp.Base p -> FullRequestedMultiScaleImage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.MultiScaleWmsImage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
