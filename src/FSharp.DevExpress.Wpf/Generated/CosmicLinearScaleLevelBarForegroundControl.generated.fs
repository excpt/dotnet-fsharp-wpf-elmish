...
type CosmicLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module CosmicLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicLinearScaleLevelBarForegroundControl) (prop: CosmicLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | CosmicLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
