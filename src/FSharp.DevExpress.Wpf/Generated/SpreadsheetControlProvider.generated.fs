...
type SpreadsheetControlProviderProp =
    | SpreadsheetControl of DevExpress.Xpf.Spreadsheet.SpreadsheetControl

module SpreadsheetControlProvider =
    let spreadsheetControl v : obj = box (SpreadsheetControlProviderProp.SpreadsheetControl v)

    let apply (el: DevExpress.Xpf.Spreadsheet.SpreadsheetControlProvider) (prop: SpreadsheetControlProviderProp) =
        match prop with
        | SpreadsheetControlProviderProp.SpreadsheetControl v -> el.SetValue(DevExpress.Xpf.Spreadsheet.SpreadsheetControlProvider.SpreadsheetControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.SpreadsheetControlProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
