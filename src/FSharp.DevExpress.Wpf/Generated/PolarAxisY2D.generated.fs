...
type PolarAxisY2DProp =
    | Base of CircularAxisY2DProp

module PolarAxisY2D =

    let apply (el: DevExpress.Xpf.Charts.PolarAxisY2D) (prop: PolarAxisY2DProp) =
        match prop with
        | PolarAxisY2DProp.Base p -> CircularAxisY2D.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PolarAxisY2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
