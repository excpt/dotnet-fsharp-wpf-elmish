...
type SimpleDiagramPanelProp =
    | Base of SimpleDiagramPanelBaseProp
    | SimpleDiagram of DevExpress.Charts.Native.ISimpleDiagram

module SimpleDiagramPanel =
    let simpleDiagram v : obj = box (SimpleDiagramPanelProp.SimpleDiagram v)

    let apply (el: DevExpress.Xpf.Charts.SimpleDiagramPanel) (prop: SimpleDiagramPanelProp) =
        match prop with
        | SimpleDiagramPanelProp.Base p -> SimpleDiagramPanelBase.apply el p
        | SimpleDiagramPanelProp.SimpleDiagram v -> el.SetValue(DevExpress.Xpf.Charts.SimpleDiagramPanel.SimpleDiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleDiagramPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
