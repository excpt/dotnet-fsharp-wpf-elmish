...
type RibbonLinksControlProp =
    | Base of LinksControlProp

module RibbonLinksControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonLinksControl) (prop: RibbonLinksControlProp) =
        match prop with
        | RibbonLinksControlProp.Base p -> LinksControl.apply el p
