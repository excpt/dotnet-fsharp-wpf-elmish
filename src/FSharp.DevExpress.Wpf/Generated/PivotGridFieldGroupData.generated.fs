...
type PivotGridFieldGroupDataProp =
...
module PivotGridFieldGroupData =
    let displayText v : obj = box (PivotGridFieldGroupDataProp.DisplayText v)
    let actualHeaderContentStyle v : obj = box (PivotGridFieldGroupDataProp.ActualHeaderContentStyle v)
    let padding v : obj = box (PivotGridFieldGroupDataProp.Padding v)
    let borderThickness v : obj = box (PivotGridFieldGroupDataProp.BorderThickness v)
    let imageSource v : obj = box (PivotGridFieldGroupDataProp.ImageSource v)

    let apply (el: DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData) (prop: PivotGridFieldGroupDataProp) =
        match prop with
        | PivotGridFieldGroupDataProp.DisplayText v -> el.SetValue(DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData.DisplayTextProperty, box v)
        | PivotGridFieldGroupDataProp.ActualHeaderContentStyle v -> el.SetValue(DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData.ActualHeaderContentStyleProperty, box v)
        | PivotGridFieldGroupDataProp.Padding v -> el.SetValue(DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData.PaddingProperty, box v)
        | PivotGridFieldGroupDataProp.BorderThickness v -> el.SetValue(DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData.BorderThicknessProperty, box v)
        | PivotGridFieldGroupDataProp.ImageSource v -> el.SetValue(DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData.ImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.PivotGridFieldGroupData>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
