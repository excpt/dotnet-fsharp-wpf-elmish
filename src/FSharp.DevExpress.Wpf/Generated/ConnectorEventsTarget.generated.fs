...
type ConnectorEventsTargetProp =
    | Base of EventsTargetProp

module ConnectorEventsTarget =

    let apply (el: DevExpress.Xpf.Gantt.Native.ConnectorEventsTarget) (prop: ConnectorEventsTargetProp) =
        match prop with
        | ConnectorEventsTargetProp.Base p -> EventsTarget.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.ConnectorEventsTarget>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
