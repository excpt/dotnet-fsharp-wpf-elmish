...
type NavigationBarThemeDependentValuesProviderProp =
    | CustomizationFormMinWidth of float
    | CustomizationFormMinHeight of float
    | CustomizationFormFloatSize of DevExpress.Xpf.Navigation.Internal.SizeEx

module NavigationBarThemeDependentValuesProvider =
    let customizationFormMinWidth v : obj = box (NavigationBarThemeDependentValuesProviderProp.CustomizationFormMinWidth v)
    let customizationFormMinHeight v : obj = box (NavigationBarThemeDependentValuesProviderProp.CustomizationFormMinHeight v)
    let customizationFormFloatSize v : obj = box (NavigationBarThemeDependentValuesProviderProp.CustomizationFormFloatSize v)

    let apply (el: DevExpress.Xpf.Navigation.Internal.NavigationBarThemeDependentValuesProvider) (prop: NavigationBarThemeDependentValuesProviderProp) =
        match prop with
        | NavigationBarThemeDependentValuesProviderProp.CustomizationFormMinWidth v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarThemeDependentValuesProvider.CustomizationFormMinWidthProperty, box v)
        | NavigationBarThemeDependentValuesProviderProp.CustomizationFormMinHeight v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarThemeDependentValuesProvider.CustomizationFormMinHeightProperty, box v)
        | NavigationBarThemeDependentValuesProviderProp.CustomizationFormFloatSize v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarThemeDependentValuesProvider.CustomizationFormFloatSizeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.NavigationBarThemeDependentValuesProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
