...
type ScrollBarBorderProp =
    | Annotations of obj
    | Brush of System.Windows.Media.Brush

module ScrollBarBorder =
    let annotations v : obj = box (ScrollBarBorderProp.Annotations v)
    let brush v : obj = box (ScrollBarBorderProp.Brush v)

    let apply (el: DevExpress.Xpf.Charts.ScrollBarBorder) (prop: ScrollBarBorderProp) =
        match prop with
        | ScrollBarBorderProp.Annotations v -> el.SetValue(DevExpress.Xpf.Charts.ScrollBarBorder.AnnotationsProperty, box v)
        | ScrollBarBorderProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.ScrollBarBorder.BrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ScrollBarBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
