...
type PivotPrintCellProp =
    | Base of PivotPrintCellBaseProp

module PivotPrintCell =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PivotPrintCell) (prop: PivotPrintCellProp) =
        match prop with
        | PivotPrintCellProp.Base p -> PivotPrintCellBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PivotPrintCell>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
