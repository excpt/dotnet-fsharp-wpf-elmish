...
type LayoutControlItemContextMenuProp =
    | Base of ItemContextMenuBaseProp

module LayoutControlItemContextMenu =

    let apply (el: DevExpress.Xpf.Docking.LayoutControlItemContextMenu) (prop: LayoutControlItemContextMenuProp) =
        match prop with
        | LayoutControlItemContextMenuProp.Base p -> ItemContextMenuBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.LayoutControlItemContextMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
