...
type DefaultScaleLabelControlProp =
    | Base of PresentationControlProp

module DefaultScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultScaleLabelControl) (prop: DefaultScaleLabelControlProp) =
        match prop with
        | DefaultScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
