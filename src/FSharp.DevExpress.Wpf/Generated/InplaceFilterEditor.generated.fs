...
type InplaceFilterEditorProp =
    | Base of InplaceEditorBaseProp
    | IsEditorFocused of bool

module InplaceFilterEditor =
    let isEditorFocused v : obj = box (InplaceFilterEditorProp.IsEditorFocused v)

    let apply (el: DevExpress.Xpf.Editors.Filtering.InplaceFilterEditor) (prop: InplaceFilterEditorProp) =
        match prop with
        | InplaceFilterEditorProp.Base p -> InplaceEditorBase.apply el p
        | InplaceFilterEditorProp.IsEditorFocused v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.InplaceFilterEditor.IsEditorFocusedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Filtering.InplaceFilterEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
