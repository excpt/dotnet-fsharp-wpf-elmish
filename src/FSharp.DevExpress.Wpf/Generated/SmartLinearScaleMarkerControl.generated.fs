...
type SmartLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module SmartLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartLinearScaleMarkerControl) (prop: SmartLinearScaleMarkerControlProp) =
        match prop with
        | SmartLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
