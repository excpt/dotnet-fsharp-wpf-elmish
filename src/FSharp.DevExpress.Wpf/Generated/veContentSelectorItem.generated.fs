...
type veContentSelectorItemProp =
    | Base of veSelectorItemProp

module veContentSelectorItem =

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veContentSelectorItem) (prop: veContentSelectorItemProp) =
        match prop with
        | veContentSelectorItemProp.Base p -> veSelectorItem.apply el p
