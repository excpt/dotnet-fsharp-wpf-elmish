...
type TextInplaceEditorProp =
    | Base of DocumentInplaceEditorBaseProp

module TextInplaceEditor =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.TextInplaceEditor) (prop: TextInplaceEditorProp) =
        match prop with
        | TextInplaceEditorProp.Base p -> DocumentInplaceEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.Editing.TextInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
