...
type CleanWhiteLinearScaleLineControlProp =
    | Base of PresentationControlProp

module CleanWhiteLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteLinearScaleLineControl) (prop: CleanWhiteLinearScaleLineControlProp) =
        match prop with
        | CleanWhiteLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
