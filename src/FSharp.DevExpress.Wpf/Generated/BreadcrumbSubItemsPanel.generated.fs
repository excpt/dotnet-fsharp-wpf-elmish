...
type BreadcrumbSubItemsPanelProp =
    | Base of DXVirtualizingStackPanelProp

module BreadcrumbSubItemsPanel =

    let apply (el: DevExpress.Xpf.Controls.Internal.BreadcrumbSubItemsPanel) (prop: BreadcrumbSubItemsPanelProp) =
        match prop with
        | BreadcrumbSubItemsPanelProp.Base p -> DXVirtualizingStackPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Internal.BreadcrumbSubItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
