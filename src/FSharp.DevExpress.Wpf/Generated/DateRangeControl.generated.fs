...
type DateRangeControlProp =
    | Start of obj
    | End of obj
    | MinValue of System.DateTime
    | MaxValue of System.DateTime
    | MinRangeLength of int
    | MaxRangeLength of int
    | Mask of string
    | StartNullText of string
    | EndNullText of string
    | IsTextReadOnly of bool
    | ShowClearButtons of bool
    | StartValidationErrorTemplate of System.Windows.DataTemplate
    | EndValidationErrorTemplate of System.Windows.DataTemplate
    | PopupFooterButtons of DevExpress.Xpf.Editors.PopupFooterButtons
    | ShowPredefinedRanges of bool
    | DateNavigatorStyle of System.Windows.Style
    | StartEditStyle of System.Windows.Style
    | EndEditStyle of System.Windows.Style
    | PredefinedRangeTemplate of System.Windows.DataTemplate
...
module DateRangeControl =
    let start v : obj = box (DateRangeControlProp.Start v)
    let end v : obj = box (DateRangeControlProp.End v)
    let minValue v : obj = box (DateRangeControlProp.MinValue v)
    let maxValue v : obj = box (DateRangeControlProp.MaxValue v)
    let minRangeLength v : obj = box (DateRangeControlProp.MinRangeLength v)
    let maxRangeLength v : obj = box (DateRangeControlProp.MaxRangeLength v)
    let mask v : obj = box (DateRangeControlProp.Mask v)
    let startNullText v : obj = box (DateRangeControlProp.StartNullText v)
    let endNullText v : obj = box (DateRangeControlProp.EndNullText v)
    let isTextReadOnly v : obj = box (DateRangeControlProp.IsTextReadOnly v)
    let showClearButtons v : obj = box (DateRangeControlProp.ShowClearButtons v)
    let startValidationErrorTemplate v : obj = box (DateRangeControlProp.StartValidationErrorTemplate v)
    let endValidationErrorTemplate v : obj = box (DateRangeControlProp.EndValidationErrorTemplate v)
    let popupFooterButtons v : obj = box (DateRangeControlProp.PopupFooterButtons v)
    let showPredefinedRanges v : obj = box (DateRangeControlProp.ShowPredefinedRanges v)
    let dateNavigatorStyle v : obj = box (DateRangeControlProp.DateNavigatorStyle v)
    let startEditStyle v : obj = box (DateRangeControlProp.StartEditStyle v)
    let endEditStyle v : obj = box (DateRangeControlProp.EndEditStyle v)
    let predefinedRangeTemplate v : obj = box (DateRangeControlProp.PredefinedRangeTemplate v)
    let popupTopAreaTemplate v : obj = box (DateRangeControlProp.PopupTopAreaTemplate v)
    let popupBottomAreaTemplate v : obj = box (DateRangeControlProp.PopupBottomAreaTemplate v)

    let apply (el: DevExpress.Xpf.Editors.DateRangeControl) (prop: DateRangeControlProp) =
        match prop with
        | DateRangeControlProp.Start v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.StartProperty, box v)
        | DateRangeControlProp.End v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.EndProperty, box v)
        | DateRangeControlProp.MinValue v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.MinValueProperty, box v)
        | DateRangeControlProp.MaxValue v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.MaxValueProperty, box v)
        | DateRangeControlProp.MinRangeLength v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.MinRangeLengthProperty, box v)
        | DateRangeControlProp.MaxRangeLength v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.MaxRangeLengthProperty, box v)
        | DateRangeControlProp.Mask v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.MaskProperty, box v)
        | DateRangeControlProp.StartNullText v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.StartNullTextProperty, box v)
        | DateRangeControlProp.EndNullText v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.EndNullTextProperty, box v)
        | DateRangeControlProp.IsTextReadOnly v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.IsTextReadOnlyProperty, box v)
        | DateRangeControlProp.ShowClearButtons v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.ShowClearButtonsProperty, box v)
        | DateRangeControlProp.StartValidationErrorTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.StartValidationErrorTemplateProperty, box v)
        | DateRangeControlProp.EndValidationErrorTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.EndValidationErrorTemplateProperty, box v)
        | DateRangeControlProp.PopupFooterButtons v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.PopupFooterButtonsProperty, box v)
        | DateRangeControlProp.ShowPredefinedRanges v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.ShowPredefinedRangesProperty, box v)
        | DateRangeControlProp.DateNavigatorStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.DateNavigatorStyleProperty, box v)
        | DateRangeControlProp.StartEditStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.StartEditStyleProperty, box v)
        | DateRangeControlProp.EndEditStyle v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.EndEditStyleProperty, box v)
        | DateRangeControlProp.PredefinedRangeTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.PredefinedRangeTemplateProperty, box v)
        | DateRangeControlProp.PopupTopAreaTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.PopupTopAreaTemplateProperty, box v)
        | DateRangeControlProp.PopupBottomAreaTemplate v -> el.SetValue(DevExpress.Xpf.Editors.DateRangeControl.PopupBottomAreaTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateRangeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
