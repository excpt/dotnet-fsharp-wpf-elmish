...
type AdditionalBoxPlotSeriesGeometryProp =
    | Base of AdditionalLineSeriesGeometryProp

module AdditionalBoxPlotSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalBoxPlotSeriesGeometry) (prop: AdditionalBoxPlotSeriesGeometryProp) =
        match prop with
        | AdditionalBoxPlotSeriesGeometryProp.Base p -> AdditionalLineSeriesGeometry.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalBoxPlotSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
