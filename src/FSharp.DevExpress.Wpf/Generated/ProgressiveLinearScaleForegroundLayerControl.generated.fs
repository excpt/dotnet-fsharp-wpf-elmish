...
type ProgressiveLinearScaleForegroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveLinearScaleForegroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveLinearScaleForegroundLayerControl) (prop: ProgressiveLinearScaleForegroundLayerControlProp) =
        match prop with
        | ProgressiveLinearScaleForegroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveLinearScaleForegroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
