...
type PrintFieldValueContentPresenterProp =
    | Base of FieldDataValueContentPresenterProp

module PrintFieldValueContentPresenter =

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.PrintFieldValueContentPresenter) (prop: PrintFieldValueContentPresenterProp) =
        match prop with
        | PrintFieldValueContentPresenterProp.Base p -> FieldDataValueContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.PrintFieldValueContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
