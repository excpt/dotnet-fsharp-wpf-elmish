...
type SankeyNodeLabelPresentationProp =
    | Base of SankeyNodePresentationProp

module SankeyNodeLabelPresentation =

    let apply (el: DevExpress.Xpf.Charts.Sankey.SankeyNodeLabelPresentation) (prop: SankeyNodeLabelPresentationProp) =
        match prop with
        | SankeyNodeLabelPresentationProp.Base p -> SankeyNodePresentation.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.SankeyNodeLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
