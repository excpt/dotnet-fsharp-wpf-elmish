...
type WorksheetShapeSelectionControlProp =
    | Base of WorksheetPaintControlProp

module WorksheetShapeSelectionControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetShapeSelectionControl) (prop: WorksheetShapeSelectionControlProp) =
        match prop with
        | WorksheetShapeSelectionControlProp.Base p -> WorksheetPaintControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetShapeSelectionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
