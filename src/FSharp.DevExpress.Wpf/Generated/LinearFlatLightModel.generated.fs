...
type LinearFlatLightModelProp =
    | Base of LinearGaugeModelProp

module LinearFlatLightModel =

    let apply (el: DevExpress.Xpf.Gauges.LinearFlatLightModel) (prop: LinearFlatLightModelProp) =
        match prop with
        | LinearFlatLightModelProp.Base p -> LinearGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.LinearFlatLightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
