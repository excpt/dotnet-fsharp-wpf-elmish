...
type DragAdornerProp =
    | Base of PlacementAdornerProp

module DragAdorner =

    let apply (el: DevExpress.Xpf.Docking.Platform.DragAdorner) (prop: DragAdornerProp) =
        match prop with
        | DragAdornerProp.Base p -> PlacementAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.DragAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
