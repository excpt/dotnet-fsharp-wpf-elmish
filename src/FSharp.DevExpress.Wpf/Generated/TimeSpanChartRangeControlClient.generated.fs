...
type TimeSpanChartRangeControlClientProp =
    | Base of ChartRangeControlClientProp
    | SnapAlignment of DevExpress.Xpf.Charts.TimeSpanMeasureUnit
    | GridAlignment of DevExpress.Xpf.Charts.RangeControlClient.TimeSpanGridAlignment

module TimeSpanChartRangeControlClient =
    let snapAlignment v : obj = box (TimeSpanChartRangeControlClientProp.SnapAlignment v)
    let gridAlignment v : obj = box (TimeSpanChartRangeControlClientProp.GridAlignment v)

    let apply (el: DevExpress.Xpf.Charts.RangeControlClient.TimeSpanChartRangeControlClient) (prop: TimeSpanChartRangeControlClientProp) =
        match prop with
        | TimeSpanChartRangeControlClientProp.Base p -> ChartRangeControlClient.apply el p
        | TimeSpanChartRangeControlClientProp.SnapAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.TimeSpanChartRangeControlClient.SnapAlignmentProperty, box v)
        | TimeSpanChartRangeControlClientProp.GridAlignment v -> el.SetValue(DevExpress.Xpf.Charts.RangeControlClient.TimeSpanChartRangeControlClient.GridAlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RangeControlClient.TimeSpanChartRangeControlClient>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
