...
type HorizontalHotZoneControlProp =
    | EnabledVisibility of System.Windows.Visibility
    | DisabledVisibility of System.Windows.Visibility

module HorizontalHotZoneControl =
    let enabledVisibility v : obj = box (HorizontalHotZoneControlProp.EnabledVisibility v)
    let disabledVisibility v : obj = box (HorizontalHotZoneControlProp.DisabledVisibility v)

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalHotZoneControl) (prop: HorizontalHotZoneControlProp) =
        match prop with
        | HorizontalHotZoneControlProp.EnabledVisibility v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalHotZoneControl.EnabledVisibilityProperty, box v)
        | HorizontalHotZoneControlProp.DisabledVisibility v -> el.SetValue(DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalHotZoneControl.DisabledVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.HorizontalHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
