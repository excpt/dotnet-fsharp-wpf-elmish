...
type TileGroupHeaderProp =
    | Base of ContentControlBaseProp
    | State of DevExpress.Xpf.LayoutControl.TileGroupHeaderState

module TileGroupHeader =
    let state v : obj = box (TileGroupHeaderProp.State v)

    let apply (el: DevExpress.Xpf.LayoutControl.TileGroupHeader) (prop: TileGroupHeaderProp) =
        match prop with
        | TileGroupHeaderProp.Base p -> ContentControlBase.apply el p
        | TileGroupHeaderProp.State v -> el.SetValue(DevExpress.Xpf.LayoutControl.TileGroupHeader.StateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.TileGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
