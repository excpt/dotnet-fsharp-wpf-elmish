...
type VisualResourcesBasedViewInfoProp =
    | Base of VisualViewInfoBaseProp

module VisualResourcesBasedViewInfo =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualResourcesBasedViewInfo) (prop: VisualResourcesBasedViewInfoProp) =
        match prop with
        | VisualResourcesBasedViewInfoProp.Base p -> VisualViewInfoBase.apply el p
