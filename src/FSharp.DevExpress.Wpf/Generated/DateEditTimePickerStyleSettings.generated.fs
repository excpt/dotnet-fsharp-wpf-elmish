...
type DateEditTimePickerStyleSettingsProp =
    | Base of DateEditStyleSettingsBaseProp

module DateEditTimePickerStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.DateEditTimePickerStyleSettings) (prop: DateEditTimePickerStyleSettingsProp) =
        match prop with
        | DateEditTimePickerStyleSettingsProp.Base p -> DateEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateEditTimePickerStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
