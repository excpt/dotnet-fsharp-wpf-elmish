...
type ConnectorMovePointPreviewAdornerProp =
    | Base of ConnectorPreviewAdornerBaseProp

module ConnectorMovePointPreviewAdorner =

    let apply (el: DevExpress.Xpf.Diagram.ConnectorMovePointPreviewAdorner) (prop: ConnectorMovePointPreviewAdornerProp) =
        match prop with
        | ConnectorMovePointPreviewAdornerProp.Base p -> ConnectorPreviewAdornerBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ConnectorMovePointPreviewAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
