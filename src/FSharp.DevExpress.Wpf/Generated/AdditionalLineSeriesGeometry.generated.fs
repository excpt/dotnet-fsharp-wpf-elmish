...
type AdditionalLineSeriesGeometryProp =
    | Base of AdditionalStripSeriesGeometryBaseProp

module AdditionalLineSeriesGeometry =

    let apply (el: DevExpress.Xpf.Charts.AdditionalLineSeriesGeometry) (prop: AdditionalLineSeriesGeometryProp) =
        match prop with
        | AdditionalLineSeriesGeometryProp.Base p -> AdditionalStripSeriesGeometryBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AdditionalLineSeriesGeometry>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
