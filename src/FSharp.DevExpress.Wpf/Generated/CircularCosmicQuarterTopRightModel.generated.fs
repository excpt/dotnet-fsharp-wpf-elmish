...
type CircularCosmicQuarterTopRightModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularCosmicQuarterTopRightModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularCosmicQuarterTopRightModel) (prop: CircularCosmicQuarterTopRightModelProp) =
        match prop with
        | CircularCosmicQuarterTopRightModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularCosmicQuarterTopRightModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
