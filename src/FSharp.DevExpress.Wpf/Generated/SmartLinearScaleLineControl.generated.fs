...
type SmartLinearScaleLineControlProp =
    | Base of PresentationControlProp

module SmartLinearScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartLinearScaleLineControl) (prop: SmartLinearScaleLineControlProp) =
        match prop with
        | SmartLinearScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartLinearScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
