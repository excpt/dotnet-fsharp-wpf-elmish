...
type WcfServerModeDataSourceProp =
...
module WcfServerModeDataSource =
    let defaultSorting v : obj = box (WcfServerModeDataSourceProp.DefaultSorting v)
    let fixedFilter v : obj = box (WcfServerModeDataSourceProp.FixedFilter v)
    let elementType v : obj = box (WcfServerModeDataSourceProp.ElementType v)
    let keyExpression v : obj = box (WcfServerModeDataSourceProp.KeyExpression v)
    let dataServiceContext v : obj = box (WcfServerModeDataSourceProp.DataServiceContext v)
    let query v : obj = box (WcfServerModeDataSourceProp.Query v)
    let serviceRoot v : obj = box (WcfServerModeDataSourceProp.ServiceRoot v)
    let useExtendedDataQuery v : obj = box (WcfServerModeDataSourceProp.UseExtendedDataQuery v)
    let onExceptionThrown v : obj = box (EventProp(box (WcfServerModeDataSourceProp.OnExceptionThrown v)))
    let onInconsistencyDetected v : obj = box (EventProp(box (WcfServerModeDataSourceProp.OnInconsistencyDetected v)))

    let apply (el: DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource) (prop: WcfServerModeDataSourceProp) =
        match prop with
        | WcfServerModeDataSourceProp.Base p -> ListSourceDataSourceBase.apply el p
        | WcfServerModeDataSourceProp.DefaultSorting v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.DefaultSortingProperty, box v)
        | WcfServerModeDataSourceProp.FixedFilter v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.FixedFilterProperty, box v)
        | WcfServerModeDataSourceProp.ElementType v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.ElementTypeProperty, box v)
        | WcfServerModeDataSourceProp.KeyExpression v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.KeyExpressionProperty, box v)
        | WcfServerModeDataSourceProp.DataServiceContext v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.DataServiceContextProperty, box v)
        | WcfServerModeDataSourceProp.Query v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.QueryProperty, box v)
        | WcfServerModeDataSourceProp.ServiceRoot v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.ServiceRootProperty, box v)
        | WcfServerModeDataSourceProp.UseExtendedDataQuery v -> el.SetValue(DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource.UseExtendedDataQueryProperty, box v)
        | WcfServerModeDataSourceProp.OnExceptionThrown h -> el.ExceptionThrown.AddHandler(h)
        | WcfServerModeDataSourceProp.OnInconsistencyDetected h -> el.InconsistencyDetected.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.ServerMode.WcfServerModeDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
