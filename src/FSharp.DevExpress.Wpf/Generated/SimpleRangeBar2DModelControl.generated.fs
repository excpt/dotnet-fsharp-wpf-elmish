...
type SimpleRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module SimpleRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.SimpleRangeBar2DModelControl) (prop: SimpleRangeBar2DModelControlProp) =
        match prop with
        | SimpleRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SimpleRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
