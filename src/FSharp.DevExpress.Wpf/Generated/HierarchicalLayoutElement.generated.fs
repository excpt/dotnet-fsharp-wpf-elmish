...
type HierarchicalLayoutElementProp =
    | VerticalPosition of DevExpress.Xpf.TreeMap.VerticalPosition
    | HorizontalPosition of DevExpress.Xpf.TreeMap.HorizontalPosition

module HierarchicalLayoutElement =
    let verticalPosition v : obj = box (HierarchicalLayoutElementProp.VerticalPosition v)
    let horizontalPosition v : obj = box (HierarchicalLayoutElementProp.HorizontalPosition v)

    let apply (el: DevExpress.Xpf.TreeMap.HierarchicalLayoutElement) (prop: HierarchicalLayoutElementProp) =
        match prop with
        | HierarchicalLayoutElementProp.VerticalPosition v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalLayoutElement.VerticalPositionProperty, box v)
        | HierarchicalLayoutElementProp.HorizontalPosition v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalLayoutElement.HorizontalPositionProperty, box v)
