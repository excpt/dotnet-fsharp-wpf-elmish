...
type PivotTableMoreSortOptionsControlProp =
    | Base of ReferenceEditBaseControlProp

module PivotTableMoreSortOptionsControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.PivotTableMoreSortOptionsControl) (prop: PivotTableMoreSortOptionsControlProp) =
        match prop with
        | PivotTableMoreSortOptionsControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.PivotTableMoreSortOptionsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
