...
type MagicLightSpindleCapControlProp =
    | Base of PresentationControlProp

module MagicLightSpindleCapControl =

    let apply (el: DevExpress.Xpf.Gauges.MagicLightSpindleCapControl) (prop: MagicLightSpindleCapControlProp) =
        match prop with
        | MagicLightSpindleCapControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.MagicLightSpindleCapControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
