...
type ChartElementItemsControlProp =
    | Base of ChartItemsControlProp
    | Diagram of System.Windows.Controls.Control

module ChartElementItemsControl =
    let diagram v : obj = box (ChartElementItemsControlProp.Diagram v)

    let apply (el: DevExpress.Xpf.Charts.ChartElementItemsControl) (prop: ChartElementItemsControlProp) =
        match prop with
        | ChartElementItemsControlProp.Base p -> ChartItemsControl.apply el p
        | ChartElementItemsControlProp.Diagram v -> el.SetValue(DevExpress.Xpf.Charts.ChartElementItemsControl.DiagramProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartElementItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
