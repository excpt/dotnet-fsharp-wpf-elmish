...
type VisualGanttViewGroupByNoneProp =
    | Base of VisualTimelineViewGroupBaseProp

module VisualGanttViewGroupByNone =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualGanttViewGroupByNone) (prop: VisualGanttViewGroupByNoneProp) =
        match prop with
        | VisualGanttViewGroupByNoneProp.Base p -> VisualTimelineViewGroupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualGanttViewGroupByNone>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
