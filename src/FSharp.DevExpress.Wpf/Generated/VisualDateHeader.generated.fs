...
type VisualDateHeaderProp =
    | Base of VisualDateCellProp
    | DisableResourceColor of bool

module VisualDateHeader =
    let disableResourceColor v : obj = box (VisualDateHeaderProp.DisableResourceColor v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualDateHeader) (prop: VisualDateHeaderProp) =
        match prop with
        | VisualDateHeaderProp.Base p -> VisualDateCell.apply el p
        | VisualDateHeaderProp.DisableResourceColor v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualDateHeader.DisableResourceColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualDateHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
