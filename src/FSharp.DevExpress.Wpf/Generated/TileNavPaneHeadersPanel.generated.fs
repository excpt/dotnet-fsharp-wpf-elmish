...
type TileNavPaneHeadersPanelProp =
    | Base of StackLayoutPanelProp

module TileNavPaneHeadersPanel =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileNavPaneHeadersPanel) (prop: TileNavPaneHeadersPanelProp) =
        match prop with
        | TileNavPaneHeadersPanelProp.Base p -> StackLayoutPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileNavPaneHeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
