...
type TimelineAppointmentDragControlProp =
    | Base of TimelineAppointmentControlProp

module TimelineAppointmentDragControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimelineAppointmentDragControl) (prop: TimelineAppointmentDragControlProp) =
        match prop with
        | TimelineAppointmentDragControlProp.Base p -> TimelineAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimelineAppointmentDragControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
