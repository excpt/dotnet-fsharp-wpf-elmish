...
type BadgeControlProp =
    | Shape of DevExpress.Xpf.Core.BadgeShape
    | Kind of DevExpress.Xpf.Core.BadgeKind
    | CornerRadius of obj
    | ContentFormatProvider of System.IFormatProvider

module BadgeControl =
    let shape v : obj = box (BadgeControlProp.Shape v)
    let kind v : obj = box (BadgeControlProp.Kind v)
    let cornerRadius v : obj = box (BadgeControlProp.CornerRadius v)
    let contentFormatProvider v : obj = box (BadgeControlProp.ContentFormatProvider v)

    let apply (el: DevExpress.Xpf.Core.Native.BadgeControl) (prop: BadgeControlProp) =
        match prop with
        | BadgeControlProp.Shape v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeControl.ShapeProperty, box v)
        | BadgeControlProp.Kind v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeControl.KindProperty, box v)
        | BadgeControlProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeControl.CornerRadiusProperty, box v)
        | BadgeControlProp.ContentFormatProvider v -> el.SetValue(DevExpress.Xpf.Core.Native.BadgeControl.ContentFormatProviderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.BadgeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
