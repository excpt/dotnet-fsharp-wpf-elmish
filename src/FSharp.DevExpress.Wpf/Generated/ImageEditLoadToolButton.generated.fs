...
type ImageEditLoadToolButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditLoadToolButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditLoadToolButton) (prop: ImageEditLoadToolButtonProp) =
        match prop with
        | ImageEditLoadToolButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditLoadToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
