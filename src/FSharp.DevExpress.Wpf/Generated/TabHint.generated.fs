...
module TabHint =
    ...
    let apply (el: DevExpress.Xpf.Docking.Platform.TabHint) (prop: TabHintProp) =
        match prop with
        | TabHintProp.Base p -> BaseTabHint.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.TabHint>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
