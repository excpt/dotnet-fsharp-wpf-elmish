...
type RibbonHeaderControlProp =
    | ControlBoxWidth of float
    | Offset of float
    | IsAeroMode of bool

module RibbonHeaderControl =
    let controlBoxWidth v : obj = box (RibbonHeaderControlProp.ControlBoxWidth v)
    let offset v : obj = box (RibbonHeaderControlProp.Offset v)
    let isAeroMode v : obj = box (RibbonHeaderControlProp.IsAeroMode v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonHeaderControl) (prop: RibbonHeaderControlProp) =
        match prop with
        | RibbonHeaderControlProp.ControlBoxWidth v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonHeaderControl.ControlBoxWidthProperty, box v)
        | RibbonHeaderControlProp.Offset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonHeaderControl.OffsetProperty, box v)
        | RibbonHeaderControlProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonHeaderControl.IsAeroModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
