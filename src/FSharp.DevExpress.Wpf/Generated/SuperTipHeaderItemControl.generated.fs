...
type SuperTipHeaderItemControlProp =
    | Base of SuperTipItemControlProp

module SuperTipHeaderItemControl =

    let apply (el: DevExpress.Xpf.Core.SuperTipHeaderItemControl) (prop: SuperTipHeaderItemControlProp) =
        match prop with
        | SuperTipHeaderItemControlProp.Base p -> SuperTipItemControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SuperTipHeaderItemControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
