...
type DialogContentViewProp =
    | Base of DialogIconsViewBaseProp

module DialogContentView =

    let apply (el: DevExpress.Xpf.Dialogs.Native.DialogContentView) (prop: DialogContentViewProp) =
        match prop with
        | DialogContentViewProp.Base p -> DialogIconsViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.DialogContentView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
