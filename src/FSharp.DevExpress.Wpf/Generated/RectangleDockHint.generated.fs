...
type RectangleDockHintProp =
    | Base of DockHintElementProp

module RectangleDockHint =

    let apply (el: DevExpress.Xpf.Docking.Platform.RectangleDockHint) (prop: RectangleDockHintProp) =
        match prop with
        | RectangleDockHintProp.Base p -> DockHintElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.RectangleDockHint>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
