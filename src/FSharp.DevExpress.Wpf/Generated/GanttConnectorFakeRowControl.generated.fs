...
type GanttConnectorFakeRowControlProp =
    | FakeRowDataConnector of DevExpress.Xpf.Gantt.GanttConnector

module GanttConnectorFakeRowControl =
    let fakeRowDataConnector v : obj = box (GanttConnectorFakeRowControlProp.FakeRowDataConnector v)

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttConnectorFakeRowControl) (prop: GanttConnectorFakeRowControlProp) =
        match prop with
        | GanttConnectorFakeRowControlProp.FakeRowDataConnector v -> el.SetValue(DevExpress.Xpf.Gantt.Native.GanttConnectorFakeRowControl.FakeRowDataConnectorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttConnectorFakeRowControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
