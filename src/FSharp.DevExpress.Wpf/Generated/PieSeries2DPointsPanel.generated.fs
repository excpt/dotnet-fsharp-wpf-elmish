...
type PieSeries2DPointsPanelProp =
    | Base of SimplePanelProp

module PieSeries2DPointsPanel =

    let apply (el: DevExpress.Xpf.Charts.PieSeries2DPointsPanel) (prop: PieSeries2DPointsPanelProp) =
        match prop with
        | PieSeries2DPointsPanelProp.Base p -> SimplePanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PieSeries2DPointsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
