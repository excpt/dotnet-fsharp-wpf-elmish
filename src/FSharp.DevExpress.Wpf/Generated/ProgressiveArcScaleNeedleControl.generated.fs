...
type ProgressiveArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ProgressiveArcScaleNeedleControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveArcScaleNeedleControl) (prop: ProgressiveArcScaleNeedleControlProp) =
        match prop with
        | ProgressiveArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
