...
module FastPath =
    let data v : obj = box (FastPathProp.Data v)

    let apply (el: DevExpress.Xpf.Charts.FastPath) (prop: FastPathProp) =
        match prop with
        | FastPathProp.Data v -> el.SetValue(DevExpress.Xpf.Charts.FastPath.DataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FastPath>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
