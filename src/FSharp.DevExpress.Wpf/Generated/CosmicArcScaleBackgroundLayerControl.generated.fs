...
type CosmicArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicArcScaleBackgroundLayerControl) (prop: CosmicArcScaleBackgroundLayerControlProp) =
        match prop with
        | CosmicArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
