...
type DayCellControlProp =
    | Base of CellControlProp

module DayCellControl =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.DayCellControl) (prop: DayCellControlProp) =
        match prop with
        | DayCellControlProp.Base p -> CellControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.DayCellControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
