...
type IndicatorLabelPresentationProp =
    | Base of ChartElementBaseProp

module IndicatorLabelPresentation =

    let apply (el: DevExpress.Xpf.Charts.IndicatorLabelPresentation) (prop: IndicatorLabelPresentationProp) =
        match prop with
        | IndicatorLabelPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.IndicatorLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
