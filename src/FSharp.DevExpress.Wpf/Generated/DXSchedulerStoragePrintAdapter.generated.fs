...
type DXSchedulerStoragePrintAdapterProp =
    | Base of DXSchedulerPrintAdapterProp
    | SchedulerStorage of DevExpress.Xpf.Scheduler.SchedulerStorage

module DXSchedulerStoragePrintAdapter =
    let schedulerStorage v : obj = box (DXSchedulerStoragePrintAdapterProp.SchedulerStorage v)

    let apply (el: DevExpress.Xpf.Scheduler.Reporting.DXSchedulerStoragePrintAdapter) (prop: DXSchedulerStoragePrintAdapterProp) =
        match prop with
        | DXSchedulerStoragePrintAdapterProp.Base p -> DXSchedulerPrintAdapter.apply el p
        | DXSchedulerStoragePrintAdapterProp.SchedulerStorage v -> el.SetValue(DevExpress.Xpf.Scheduler.Reporting.DXSchedulerStoragePrintAdapter.SchedulerStorageProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Reporting.DXSchedulerStoragePrintAdapter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
