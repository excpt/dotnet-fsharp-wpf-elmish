...
type VisualHorizontalAppointmentControlProp =
    | Base of VisualAppointmentControlProp

module VisualHorizontalAppointmentControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualHorizontalAppointmentControl) (prop: VisualHorizontalAppointmentControlProp) =
        match prop with
        | VisualHorizontalAppointmentControlProp.Base p -> VisualAppointmentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualHorizontalAppointmentControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
