...
type ImageEditCopyToolButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditCopyToolButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditCopyToolButton) (prop: ImageEditCopyToolButtonProp) =
        match prop with
        | ImageEditCopyToolButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditCopyToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
