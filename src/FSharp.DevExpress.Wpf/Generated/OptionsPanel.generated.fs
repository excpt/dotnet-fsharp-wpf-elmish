...
type OptionsPanelProp =
    | Base of psvControlProp

module OptionsPanel =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.OptionsPanel) (prop: OptionsPanelProp) =
        match prop with
        | OptionsPanelProp.Base p -> psvControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.OptionsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
