...
type RightIndentHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module RightIndentHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RightIndentHotZoneControl) (prop: RightIndentHotZoneControlProp) =
        match prop with
        | RightIndentHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RightIndentHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
