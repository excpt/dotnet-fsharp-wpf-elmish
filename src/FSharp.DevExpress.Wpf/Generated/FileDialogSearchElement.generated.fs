...
type FileDialogSearchElementProp =
    | Base of SearchControlProp

module FileDialogSearchElement =

    let apply (el: DevExpress.Xpf.Dialogs.Native.FileDialogSearchElement) (prop: FileDialogSearchElementProp) =
        match prop with
        | FileDialogSearchElementProp.Base p -> SearchControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.FileDialogSearchElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
