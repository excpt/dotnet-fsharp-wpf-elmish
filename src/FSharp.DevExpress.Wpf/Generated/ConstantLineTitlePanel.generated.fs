...
type ConstantLineTitlePanelProp =
    | Base of ChartItemsPanelBaseProp

module ConstantLineTitlePanel =

    let apply (el: DevExpress.Xpf.Charts.ConstantLineTitlePanel) (prop: ConstantLineTitlePanelProp) =
        match prop with
        | ConstantLineTitlePanelProp.Base p -> ChartItemsPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ConstantLineTitlePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
