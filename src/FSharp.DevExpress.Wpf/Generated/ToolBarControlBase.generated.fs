...
type ToolBarControlBaseProp =
    ...
    | ItemsSource of obj
    | BarItemDisplayMode of DevExpress.Xpf.Bars.BarItemDisplayMode
    | AllowCustomizationMenu of bool
    | AllowHide of bool
    | AllowRemove of bool
    | AllowRename of bool
    | BarItemHorizontalIndent of float
    | BarItemsAlignment of DevExpress.Xpf.Bars.BarItemAlignment
    | BarItemVerticalIndent of float
    | Caption of string
    | GlyphSize of DevExpress.Xpf.Bars.GlyphSize
    | IsMultiLine of bool
    | BackgroundTemplate of System.Windows.Controls.ControlTemplate
    | ShowBackground of bool
    | HideWhenEmpty of bool
    | BorderTemplate of System.Windows.Controls.ControlTemplate
    | CornerRadius of System.Windows.CornerRadius

module ToolBarControlBase =
    let itemTemplateSelector v : obj = box (ToolBarControlBaseProp.ItemTemplateSelector v)
    let itemTemplate v : obj = box (ToolBarControlBaseProp.ItemTemplate v)
    let itemStyle v : obj = box (ToolBarControlBaseProp.ItemStyle v)
    let itemsSource v : obj = box (ToolBarControlBaseProp.ItemsSource v)
    let barItemDisplayMode v : obj = box (ToolBarControlBaseProp.BarItemDisplayMode v)
    let allowCustomizationMenu v : obj = box (ToolBarControlBaseProp.AllowCustomizationMenu v)
    let allowHide v : obj = box (ToolBarControlBaseProp.AllowHide v)
    let allowRemove v : obj = box (ToolBarControlBaseProp.AllowRemove v)
    let allowRename v : obj = box (ToolBarControlBaseProp.AllowRename v)
    let barItemHorizontalIndent v : obj = box (ToolBarControlBaseProp.BarItemHorizontalIndent v)
    let barItemsAlignment v : obj = box (ToolBarControlBaseProp.BarItemsAlignment v)
    let barItemVerticalIndent v : obj = box (ToolBarControlBaseProp.BarItemVerticalIndent v)
    let caption v : obj = box (ToolBarControlBaseProp.Caption v)
    let glyphSize v : obj = box (ToolBarControlBaseProp.GlyphSize v)
    let isMultiLine v : obj = box (ToolBarControlBaseProp.IsMultiLine v)
    let backgroundTemplate v : obj = box (ToolBarControlBaseProp.BackgroundTemplate v)
    let showBackground v : obj = box (ToolBarControlBaseProp.ShowBackground v)
    let hideWhenEmpty v : obj = box (ToolBarControlBaseProp.HideWhenEmpty v)
    let borderTemplate v : obj = box (ToolBarControlBaseProp.BorderTemplate v)
    let cornerRadius v : obj = box (ToolBarControlBaseProp.CornerRadius v)

    let apply (el: DevExpress.Xpf.Bars.ToolBarControlBase) (prop: ToolBarControlBaseProp) =
        match prop with
        | ToolBarControlBaseProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.ItemTemplateSelectorProperty, box v)
        | ToolBarControlBaseProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.ItemTemplateProperty, box v)
        | ToolBarControlBaseProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.ItemStyleProperty, box v)
        | ToolBarControlBaseProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.ItemsSourceProperty, box v)
        | ToolBarControlBaseProp.BarItemDisplayMode v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.BarItemDisplayModeProperty, box v)
        | ToolBarControlBaseProp.AllowCustomizationMenu v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.AllowCustomizationMenuProperty, box v)
        | ToolBarControlBaseProp.AllowHide v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.AllowHideProperty, box v)
        | ToolBarControlBaseProp.AllowRemove v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.AllowRemoveProperty, box v)
        | ToolBarControlBaseProp.AllowRename v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.AllowRenameProperty, box v)
        | ToolBarControlBaseProp.BarItemHorizontalIndent v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.BarItemHorizontalIndentProperty, box v)
        | ToolBarControlBaseProp.BarItemsAlignment v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.BarItemsAlignmentProperty, box v)
        | ToolBarControlBaseProp.BarItemVerticalIndent v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.BarItemVerticalIndentProperty, box v)
        | ToolBarControlBaseProp.Caption v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.CaptionProperty, box v)
        | ToolBarControlBaseProp.GlyphSize v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.GlyphSizeProperty, box v)
        | ToolBarControlBaseProp.IsMultiLine v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.IsMultiLineProperty, box v)
        | ToolBarControlBaseProp.BackgroundTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.BackgroundTemplateProperty, box v)
        | ToolBarControlBaseProp.ShowBackground v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.ShowBackgroundProperty, box v)
        | ToolBarControlBaseProp.HideWhenEmpty v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.HideWhenEmptyProperty, box v)
        | ToolBarControlBaseProp.BorderTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.BorderTemplateProperty, box v)
        | ToolBarControlBaseProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.Bars.ToolBarControlBase.CornerRadiusProperty, box v)
