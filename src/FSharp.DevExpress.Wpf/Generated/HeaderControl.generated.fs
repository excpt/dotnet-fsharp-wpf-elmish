...
type HeaderControlProp =
    | Base of XPFContentControlProp
    | DisableResourceColor of bool
    | ResourceColor of System.Windows.Media.Brush
    | IsAlternate of bool
    | NormalTemplate of System.Windows.Controls.ControlTemplate
    | AlternateTemplate of System.Windows.Controls.ControlTemplate
    | Orientation of System.Windows.Controls.Orientation

module HeaderControl =
    let disableResourceColor v : obj = box (HeaderControlProp.DisableResourceColor v)
    let resourceColor v : obj = box (HeaderControlProp.ResourceColor v)
    let isAlternate v : obj = box (HeaderControlProp.IsAlternate v)
    let normalTemplate v : obj = box (HeaderControlProp.NormalTemplate v)
    let alternateTemplate v : obj = box (HeaderControlProp.AlternateTemplate v)
    let orientation v : obj = box (HeaderControlProp.Orientation v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HeaderControl) (prop: HeaderControlProp) =
        match prop with
        | HeaderControlProp.Base p -> XPFContentControl.apply el p
        | HeaderControlProp.DisableResourceColor v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.DisableResourceColorProperty, box v)
        | HeaderControlProp.ResourceColor v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.ResourceColorProperty, box v)
        | HeaderControlProp.IsAlternate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.IsAlternateProperty, box v)
        | HeaderControlProp.NormalTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.NormalTemplateProperty, box v)
        | HeaderControlProp.AlternateTemplate v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.AlternateTemplateProperty, box v)
        | HeaderControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.OrientationProperty, box v)
    ...
    let glareAlignment (v: System.Windows.HorizontalAlignment) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Scheduler.Drawing.HeaderControl.GlareAlignmentProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
