...
type ConditionEditorProp =
    | Condition of DevExpress.Xpf.DataAccess.Native.Editors.Condition
...
module ConditionEditor =
    let condition v : obj = box (ConditionEditorProp.Condition v)
    let allowChangeOperatorType v : obj = box (ConditionEditorProp.AllowChangeOperatorType v)
    let allowChangeMasterTable v : obj = box (ConditionEditorProp.AllowChangeMasterTable v)
    let allowCopyLeftTable v : obj = box (ConditionEditorProp.AllowCopyLeftTable v)
    let allowCopyRightTable v : obj = box (ConditionEditorProp.AllowCopyRightTable v)
    let allowRemoveItems v : obj = box (ConditionEditorProp.AllowRemoveItems v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor) (prop: ConditionEditorProp) =
        match prop with
        | ConditionEditorProp.Condition v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor.ConditionProperty, box v)
        | ConditionEditorProp.AllowChangeOperatorType v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor.AllowChangeOperatorTypeProperty, box v)
        | ConditionEditorProp.AllowChangeMasterTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor.AllowChangeMasterTableProperty, box v)
        | ConditionEditorProp.AllowCopyLeftTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor.AllowCopyLeftTableProperty, box v)
        | ConditionEditorProp.AllowCopyRightTable v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor.AllowCopyRightTableProperty, box v)
        | ConditionEditorProp.AllowRemoveItems v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor.AllowRemoveItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ConditionEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
