...
type NavPaneImageAndTextDecoratorProp =
    | Base of ImageAndTextDecoratorProp
    | ContentOpacity of float

module NavPaneImageAndTextDecorator =
    let contentOpacity v : obj = box (NavPaneImageAndTextDecoratorProp.ContentOpacity v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneImageAndTextDecorator) (prop: NavPaneImageAndTextDecoratorProp) =
        match prop with
        | NavPaneImageAndTextDecoratorProp.Base p -> ImageAndTextDecorator.apply el p
        | NavPaneImageAndTextDecoratorProp.ContentOpacity v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneImageAndTextDecorator.ContentOpacityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneImageAndTextDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
