...
type FormBorderControlProp =
    | Base of psvControlProp
    | SingleBorderTemplate of System.Windows.Controls.ControlTemplate
    | FormBorderTemplate of System.Windows.Controls.ControlTemplate
    | ActualShadowMargin of obj
    | ActualContentMargin of obj
    | ActualBorderMargin of obj
    | BorderStyle of DevExpress.Xpf.Docking.FloatGroupBorderStyle
    | IsMaximized of bool
    | EmptyBorderTemplate of System.Windows.Controls.ControlTemplate
...
module FormBorderControl =
    let singleBorderTemplate v : obj = box (FormBorderControlProp.SingleBorderTemplate v)
    let formBorderTemplate v : obj = box (FormBorderControlProp.FormBorderTemplate v)
    let actualShadowMargin v : obj = box (FormBorderControlProp.ActualShadowMargin v)
    let actualContentMargin v : obj = box (FormBorderControlProp.ActualContentMargin v)
    let actualBorderMargin v : obj = box (FormBorderControlProp.ActualBorderMargin v)
    let borderStyle v : obj = box (FormBorderControlProp.BorderStyle v)
    let isMaximized v : obj = box (FormBorderControlProp.IsMaximized v)
    let emptyBorderTemplate v : obj = box (FormBorderControlProp.EmptyBorderTemplate v)
    let formBorderMargin v : obj = box (FormBorderControlProp.FormBorderMargin v)
    let singleBorderMargin v : obj = box (FormBorderControlProp.SingleBorderMargin v)
    let maximizedBorderMargin v : obj = box (FormBorderControlProp.MaximizedBorderMargin v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FormBorderControl) (prop: FormBorderControlProp) =
        match prop with
        | FormBorderControlProp.Base p -> psvControl.apply el p
        | FormBorderControlProp.SingleBorderTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.SingleBorderTemplateProperty, box v)
        | FormBorderControlProp.FormBorderTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.FormBorderTemplateProperty, box v)
        | FormBorderControlProp.ActualShadowMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.ActualShadowMarginProperty, box v)
        | FormBorderControlProp.ActualContentMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.ActualContentMarginProperty, box v)
        | FormBorderControlProp.ActualBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.ActualBorderMarginProperty, box v)
        | FormBorderControlProp.BorderStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.BorderStyleProperty, box v)
        | FormBorderControlProp.IsMaximized v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.IsMaximizedProperty, box v)
        | FormBorderControlProp.EmptyBorderTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.EmptyBorderTemplateProperty, box v)
        | FormBorderControlProp.FormBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.FormBorderMarginProperty, box v)
        | FormBorderControlProp.SingleBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.SingleBorderMarginProperty, box v)
        | FormBorderControlProp.MaximizedBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FormBorderControl.MaximizedBorderMarginProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.FormBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
