...
type LinqPlinqInstantFeedbackDataSourceProp =
    | Base of PLinqInstantFeedbackDataSourceBaseProp

module LinqPlinqInstantFeedbackDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.LinqPlinqInstantFeedbackDataSource) (prop: LinqPlinqInstantFeedbackDataSourceProp) =
        match prop with
        | LinqPlinqInstantFeedbackDataSourceProp.Base p -> PLinqInstantFeedbackDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.LinqPlinqInstantFeedbackDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
