...
type ThemeableArcScaleNeedleControlProp =
    | Base of ValueIndicatorPresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableArcScaleNeedleControl =
    let themeFill v : obj = box (ThemeableArcScaleNeedleControlProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableArcScaleNeedleControl) (prop: ThemeableArcScaleNeedleControlProp) =
        match prop with
        | ThemeableArcScaleNeedleControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
        | ThemeableArcScaleNeedleControlProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableArcScaleNeedleControl.ThemeFillProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ThemeableArcScaleNeedleControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
