...
type FlyoutAdornerControlProp =
    | Base of FlyoutControlProp

module FlyoutAdornerControl =

    let apply (el: DevExpress.Xpf.Controls.Primitives.FlyoutAdornerControl) (prop: FlyoutAdornerControlProp) =
        match prop with
        | FlyoutAdornerControlProp.Base p -> FlyoutControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.FlyoutAdornerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
