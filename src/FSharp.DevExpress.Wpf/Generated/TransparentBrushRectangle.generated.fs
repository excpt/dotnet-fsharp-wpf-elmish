...
type TransparentBrushRectangleProp =
    | LightColor of System.Windows.Media.Color
    | DarkColor of System.Windows.Media.Color
    | BlockWidth of float
    | BlockHeight of float

module TransparentBrushRectangle =
    let lightColor v : obj = box (TransparentBrushRectangleProp.LightColor v)
    let darkColor v : obj = box (TransparentBrushRectangleProp.DarkColor v)
    let blockWidth v : obj = box (TransparentBrushRectangleProp.BlockWidth v)
    let blockHeight v : obj = box (TransparentBrushRectangleProp.BlockHeight v)

    let apply (el: DevExpress.Xpf.Editors.Internal.TransparentBrushRectangle) (prop: TransparentBrushRectangleProp) =
        match prop with
        | TransparentBrushRectangleProp.LightColor v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TransparentBrushRectangle.LightColorProperty, box v)
        | TransparentBrushRectangleProp.DarkColor v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TransparentBrushRectangle.DarkColorProperty, box v)
        | TransparentBrushRectangleProp.BlockWidth v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TransparentBrushRectangle.BlockWidthProperty, box v)
        | TransparentBrushRectangleProp.BlockHeight v -> el.SetValue(DevExpress.Xpf.Editors.Internal.TransparentBrushRectangle.BlockHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.TransparentBrushRectangle>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
