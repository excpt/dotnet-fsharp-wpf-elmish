...
type ThemeableArcScaleBackgroundLayerControlBaseProp =
    | Base of PresentationControlProp
    | ThemeFill of System.Windows.Media.Brush

module ThemeableArcScaleBackgroundLayerControlBase =
    let themeFill v : obj = box (ThemeableArcScaleBackgroundLayerControlBaseProp.ThemeFill v)

    let apply (el: DevExpress.Xpf.Gauges.ThemeableArcScaleBackgroundLayerControlBase) (prop: ThemeableArcScaleBackgroundLayerControlBaseProp) =
        match prop with
        | ThemeableArcScaleBackgroundLayerControlBaseProp.Base p -> PresentationControl.apply el p
        | ThemeableArcScaleBackgroundLayerControlBaseProp.ThemeFill v -> el.SetValue(DevExpress.Xpf.Gauges.ThemeableArcScaleBackgroundLayerControlBase.ThemeFillProperty, box v)
