...
type DXRibbonWindowTitlePanelProp =
    | MinCaptionWidthBlock of System.Windows.Controls.TextBlock
    | CaptionContentControl of System.Windows.Controls.ContentControl
    | ApplicationButton of DevExpress.Xpf.Ribbon.RibbonApplicationButtonControl
    | ToolbarControl of System.Windows.Controls.ContentControl
    | RibbonWindow of DevExpress.Xpf.Ribbon.IRibbonWindow
    | RibbonStyle of DevExpress.Xpf.Ribbon.RibbonStyle

module DXRibbonWindowTitlePanel =
    let minCaptionWidthBlock v : obj = box (DXRibbonWindowTitlePanelProp.MinCaptionWidthBlock v)
    let captionContentControl v : obj = box (DXRibbonWindowTitlePanelProp.CaptionContentControl v)
    let applicationButton v : obj = box (DXRibbonWindowTitlePanelProp.ApplicationButton v)
    let toolbarControl v : obj = box (DXRibbonWindowTitlePanelProp.ToolbarControl v)
    let ribbonWindow v : obj = box (DXRibbonWindowTitlePanelProp.RibbonWindow v)
    let ribbonStyle v : obj = box (DXRibbonWindowTitlePanelProp.RibbonStyle v)

    let apply (el: DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel) (prop: DXRibbonWindowTitlePanelProp) =
        match prop with
        | DXRibbonWindowTitlePanelProp.MinCaptionWidthBlock v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel.MinCaptionWidthBlockProperty, box v)
        | DXRibbonWindowTitlePanelProp.CaptionContentControl v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel.CaptionContentControlProperty, box v)
        | DXRibbonWindowTitlePanelProp.ApplicationButton v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel.ApplicationButtonProperty, box v)
        | DXRibbonWindowTitlePanelProp.ToolbarControl v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel.ToolbarControlProperty, box v)
        | DXRibbonWindowTitlePanelProp.RibbonWindow v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel.RibbonWindowProperty, box v)
        | DXRibbonWindowTitlePanelProp.RibbonStyle v -> el.SetValue(DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel.RibbonStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.DXRibbonWindowTitlePanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
