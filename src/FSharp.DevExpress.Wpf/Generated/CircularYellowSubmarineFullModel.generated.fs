...
type CircularYellowSubmarineFullModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularYellowSubmarineFullModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularYellowSubmarineFullModel) (prop: CircularYellowSubmarineFullModelProp) =
        match prop with
        | CircularYellowSubmarineFullModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularYellowSubmarineFullModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
