...
type DashTypePresenterProp =
    | Base of ShapeGeometryPresenterProp
    | DashType of obj

module DashTypePresenter =
    let dashType v : obj = box (DashTypePresenterProp.DashType v)

    let apply (el: DevExpress.Xpf.Diagram.Native.DashTypePresenter) (prop: DashTypePresenterProp) =
        match prop with
        | DashTypePresenterProp.Base p -> ShapeGeometryPresenter.apply el p
        | DashTypePresenterProp.DashType v -> el.SetValue(DevExpress.Xpf.Diagram.Native.DashTypePresenter.DashTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.DashTypePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
