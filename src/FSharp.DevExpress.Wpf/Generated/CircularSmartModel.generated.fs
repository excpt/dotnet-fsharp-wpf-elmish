...
type CircularSmartModelProp =
    | Base of CircularGaugeModelProp

module CircularSmartModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularSmartModel) (prop: CircularSmartModelProp) =
        match prop with
        | CircularSmartModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularSmartModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
