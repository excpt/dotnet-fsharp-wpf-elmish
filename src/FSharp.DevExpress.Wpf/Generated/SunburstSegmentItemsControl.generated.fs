...
type SunburstSegmentItemsControlProp =
    | SectorStyle of System.Windows.Style

module SunburstSegmentItemsControl =
    let sectorStyle v : obj = box (SunburstSegmentItemsControlProp.SectorStyle v)

    let apply (el: DevExpress.Xpf.TreeMap.SunburstSegmentItemsControl) (prop: SunburstSegmentItemsControlProp) =
        match prop with
        | SunburstSegmentItemsControlProp.SectorStyle v -> el.SetValue(DevExpress.Xpf.TreeMap.SunburstSegmentItemsControl.SectorStyleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.SunburstSegmentItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
