...
type PopupMenuInfoProp =
    | ItemsDisplayMode of DevExpress.Xpf.Bars.PopupMenuItemsDisplayMode
    | StretchRows of bool
    | MaxRowCount of int
    | MultiColumn of bool
    | MaxColumnHeight of float
...
module PopupMenuInfo =
    let itemsDisplayMode v : obj = box (PopupMenuInfoProp.ItemsDisplayMode v)
    let stretchRows v : obj = box (PopupMenuInfoProp.StretchRows v)
    let maxRowCount v : obj = box (PopupMenuInfoProp.MaxRowCount v)
    let multiColumn v : obj = box (PopupMenuInfoProp.MultiColumn v)
    let maxColumnHeight v : obj = box (PopupMenuInfoProp.MaxColumnHeight v)
    let glyphSize v : obj = box (PopupMenuInfoProp.GlyphSize v)
    let itemLinksSource v : obj = box (PopupMenuInfoProp.ItemLinksSource v)
    let itemTemplate v : obj = box (PopupMenuInfoProp.ItemTemplate v)
    let itemStyle v : obj = box (PopupMenuInfoProp.ItemStyle v)
    let itemTemplateSelector v : obj = box (PopupMenuInfoProp.ItemTemplateSelector v)
    let showKeyGestures v : obj = box (PopupMenuInfoProp.ShowKeyGestures v)
    let itemLinksSourceElementGeneratesUniqueBarItem v : obj = box (PopupMenuInfoProp.ItemLinksSourceElementGeneratesUniqueBarItem v)

    let apply (el: DevExpress.Xpf.Bars.PopupMenuInfo) (prop: PopupMenuInfoProp) =
        match prop with
        | PopupMenuInfoProp.ItemsDisplayMode v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ItemsDisplayModeProperty, box v)
        | PopupMenuInfoProp.StretchRows v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.StretchRowsProperty, box v)
        | PopupMenuInfoProp.MaxRowCount v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.MaxRowCountProperty, box v)
        | PopupMenuInfoProp.MultiColumn v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.MultiColumnProperty, box v)
        | PopupMenuInfoProp.MaxColumnHeight v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.MaxColumnHeightProperty, box v)
        | PopupMenuInfoProp.GlyphSize v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.GlyphSizeProperty, box v)
        | PopupMenuInfoProp.ItemLinksSource v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ItemLinksSourceProperty, box v)
        | PopupMenuInfoProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ItemTemplateProperty, box v)
        | PopupMenuInfoProp.ItemStyle v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ItemStyleProperty, box v)
        | PopupMenuInfoProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ItemTemplateSelectorProperty, box v)
        | PopupMenuInfoProp.ShowKeyGestures v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ShowKeyGesturesProperty, box v)
        | PopupMenuInfoProp.ItemLinksSourceElementGeneratesUniqueBarItem v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuInfo.ItemLinksSourceElementGeneratesUniqueBarItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupMenuInfo>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
