...
type CircularThemeableModelProp =
    | Base of CircularGaugeModelProp

module CircularThemeableModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularThemeableModel) (prop: CircularThemeableModelProp) =
        match prop with
        | CircularThemeableModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularThemeableModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
