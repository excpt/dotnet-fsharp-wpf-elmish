...
module ChromeBase =
    ...
    let apply (el: DevExpress.Xpf.Scheduling.Visual.ChromeBase) (prop: ChromeBaseProp) =
        match prop with
        | ChromeBaseProp.Base p -> Chrome.apply el p
        | ChromeBaseProp.StaticRenderTemplate v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.ChromeBase.StaticRenderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.ChromeBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
