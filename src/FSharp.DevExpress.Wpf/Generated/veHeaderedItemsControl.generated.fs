...
type veHeaderedItemsControlProp =
...
module veHeaderedItemsControl =
    let header v : obj = box (veHeaderedItemsControlProp.Header v)
    let headerTemplate v : obj = box (veHeaderedItemsControlProp.HeaderTemplate v)
    let headerTemplateSelector v : obj = box (veHeaderedItemsControlProp.HeaderTemplateSelector v)
    let headerStringFormat v : obj = box (veHeaderedItemsControlProp.HeaderStringFormat v)
    let actualHeader v : obj = box (veHeaderedItemsControlProp.ActualHeader v)
    let hasHeader v : obj = box (veHeaderedItemsControlProp.HasHeader v)
    let hasHeaderTemplate v : obj = box (veHeaderedItemsControlProp.HasHeaderTemplate v)

    let apply (el: DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl) (prop: veHeaderedItemsControlProp) =
        match prop with
        | veHeaderedItemsControlProp.Base p -> veItemsControl.apply el p
        | veHeaderedItemsControlProp.Header v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.HeaderProperty, box v)
        | veHeaderedItemsControlProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.HeaderTemplateProperty, box v)
        | veHeaderedItemsControlProp.HeaderTemplateSelector v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.HeaderTemplateSelectorProperty, box v)
        | veHeaderedItemsControlProp.HeaderStringFormat v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.HeaderStringFormatProperty, box v)
        | veHeaderedItemsControlProp.ActualHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.ActualHeaderProperty, box v)
        | veHeaderedItemsControlProp.HasHeader v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.HasHeaderProperty, box v)
        | veHeaderedItemsControlProp.HasHeaderTemplate v -> el.SetValue(DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl.HasHeaderTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Base.veHeaderedItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
