...
type NavPaneGroupButtonPanelControlProp =
    | Base of NavPaneItemsControlProp

module NavPaneGroupButtonPanelControl =

    let apply (el: DevExpress.Xpf.NavBar.NavPaneGroupButtonPanelControl) (prop: NavPaneGroupButtonPanelControlProp) =
        match prop with
        | NavPaneGroupButtonPanelControlProp.Base p -> NavPaneItemsControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneGroupButtonPanelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
