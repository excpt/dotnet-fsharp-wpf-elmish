...
type ChartSelectDataControlProp =
    | Base of ReferenceEditBaseControlProp

module ChartSelectDataControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ChartSelectDataControl) (prop: ChartSelectDataControlProp) =
        match prop with
        | ChartSelectDataControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ChartSelectDataControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
