...
type FibonacciIndicatorProp =
    | Base of FinancialIndicatorProp
    | ShowLevel23_6 of bool
    | ShowLevel76_4 of bool
    | Label of DevExpress.Xpf.Charts.IndicatorLabel

module FibonacciIndicator =
    ...
    let apply (el: DevExpress.Xpf.Charts.FibonacciIndicator) (prop: FibonacciIndicatorProp) =
        match prop with
        | FibonacciIndicatorProp.Base p -> FinancialIndicator.apply el p
        | FibonacciIndicatorProp.ShowLevel23_6 v -> el.SetValue(DevExpress.Xpf.Charts.FibonacciIndicator.ShowLevel23_6Property, box v)
        | FibonacciIndicatorProp.ShowLevel76_4 v -> el.SetValue(DevExpress.Xpf.Charts.FibonacciIndicator.ShowLevel76_4Property, box v)
        | FibonacciIndicatorProp.Label v -> el.SetValue(DevExpress.Xpf.Charts.FibonacciIndicator.LabelProperty, box v)
