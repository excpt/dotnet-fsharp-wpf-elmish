...
type DraftViewPageProp =
    | Base of RichEditViewPageProp

module DraftViewPage =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.DraftViewPage) (prop: DraftViewPageProp) =
        match prop with
        | DraftViewPageProp.Base p -> RichEditViewPage.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.DraftViewPage>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
