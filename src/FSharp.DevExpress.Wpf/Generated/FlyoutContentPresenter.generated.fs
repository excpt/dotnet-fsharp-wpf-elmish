...
type FlyoutContentPresenterProp =
    | Command of System.Windows.Input.ICommand
    | CommandParameter of obj
    | CommandTarget of System.Windows.IInputElement

module FlyoutContentPresenter =
    let command v : obj = box (FlyoutContentPresenterProp.Command v)
    let commandParameter v : obj = box (FlyoutContentPresenterProp.CommandParameter v)
    let commandTarget v : obj = box (FlyoutContentPresenterProp.CommandTarget v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.FlyoutContentPresenter) (prop: FlyoutContentPresenterProp) =
        match prop with
        | FlyoutContentPresenterProp.Command v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.FlyoutContentPresenter.CommandProperty, box v)
        | FlyoutContentPresenterProp.CommandParameter v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.FlyoutContentPresenter.CommandParameterProperty, box v)
        | FlyoutContentPresenterProp.CommandTarget v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.FlyoutContentPresenter.CommandTargetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.FlyoutContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
