...
type NavPaneActiveGroupControlProp =
    | Base of NavBarGroupControlProp
    | IsExpanded of bool
    | ItemsContainerOpacity of obj
    | VisibilityCore of System.Windows.Visibility

module NavPaneActiveGroupControl =
    let isExpanded v : obj = box (NavPaneActiveGroupControlProp.IsExpanded v)
    let itemsContainerOpacity v : obj = box (NavPaneActiveGroupControlProp.ItemsContainerOpacity v)
    let visibilityCore v : obj = box (NavPaneActiveGroupControlProp.VisibilityCore v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneActiveGroupControl) (prop: NavPaneActiveGroupControlProp) =
        match prop with
        | NavPaneActiveGroupControlProp.Base p -> NavBarGroupControl.apply el p
        | NavPaneActiveGroupControlProp.IsExpanded v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneActiveGroupControl.IsExpandedProperty, box v)
        | NavPaneActiveGroupControlProp.ItemsContainerOpacity v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneActiveGroupControl.ItemsContainerOpacityProperty, box v)
        | NavPaneActiveGroupControlProp.VisibilityCore v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneActiveGroupControl.VisibilityCoreProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneActiveGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
