...
type HierarchicalDataAdapterBaseProp =
    | DataSource of System.Collections.IEnumerable
    | BreadcrumbTextProvider of DevExpress.Xpf.Charts.IBreadcrumbTextProvider

module HierarchicalDataAdapterBase =
    ...
    let apply (el: DevExpress.Xpf.Charts.HierarchicalDataAdapterBase) (prop: HierarchicalDataAdapterBaseProp) =
        match prop with
        | HierarchicalDataAdapterBaseProp.DataSource v -> el.SetValue(DevExpress.Xpf.Charts.HierarchicalDataAdapterBase.DataSourceProperty, box v)
        | HierarchicalDataAdapterBaseProp.BreadcrumbTextProvider v -> el.SetValue(DevExpress.Xpf.Charts.HierarchicalDataAdapterBase.BreadcrumbTextProviderProperty, box v)
