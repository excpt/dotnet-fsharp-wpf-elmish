...
type FlatGlassRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module FlatGlassRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.FlatGlassRangeBar2DModelControl) (prop: FlatGlassRangeBar2DModelControlProp) =
        match prop with
        | FlatGlassRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.FlatGlassRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
