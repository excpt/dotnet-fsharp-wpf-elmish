...
open System
open System.Windows
open DevExpress.Xpf.Dialogs.Native
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FileDialogBreadcrumbProp =
    | Base of BreadcrumbControlProp

module FileDialogBreadcrumb =

    let apply (el: DevExpress.Xpf.Dialogs.Native.FileDialogBreadcrumb) (prop: FileDialogBreadcrumbProp) =
        match prop with
        | FileDialogBreadcrumbProp.Base p -> BreadcrumbControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.Native.FileDialogBreadcrumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
