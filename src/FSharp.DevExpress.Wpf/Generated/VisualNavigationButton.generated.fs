...
type VisualNavigationButtonProp =
    | Base of SchedulerButtonProp
    | Direction of DevExpress.Xpf.Scheduler.Drawing.NavigationDirection
    | Resource of DevExpress.XtraScheduler.Resource
    | Interval of DevExpress.XtraScheduler.TimeInterval
    | ButtonInfo of DevExpress.Xpf.Scheduler.Drawing.NavigationButtonViewModel
    | ParentActualHeight of float

module VisualNavigationButton =
    let direction v : obj = box (VisualNavigationButtonProp.Direction v)
    let resource v : obj = box (VisualNavigationButtonProp.Resource v)
    let interval v : obj = box (VisualNavigationButtonProp.Interval v)
    let buttonInfo v : obj = box (VisualNavigationButtonProp.ButtonInfo v)
    let parentActualHeight v : obj = box (VisualNavigationButtonProp.ParentActualHeight v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton) (prop: VisualNavigationButtonProp) =
        match prop with
        | VisualNavigationButtonProp.Base p -> SchedulerButton.apply el p
        | VisualNavigationButtonProp.Direction v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.DirectionProperty, box v)
        | VisualNavigationButtonProp.Resource v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.ResourceProperty, box v)
        | VisualNavigationButtonProp.Interval v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.IntervalProperty, box v)
        | VisualNavigationButtonProp.ButtonInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.ButtonInfoProperty, box v)
        | VisualNavigationButtonProp.ParentActualHeight v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.ParentActualHeightProperty, box v)
    ...
    let nextNavigationButtonMargin (v: System.Windows.Thickness) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.NextNavigationButtonMarginProperty, box v)) :: node.Props }
    let prevNavigationButtonMargin (v: System.Windows.Thickness) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton.PrevNavigationButtonMarginProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualNavigationButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
