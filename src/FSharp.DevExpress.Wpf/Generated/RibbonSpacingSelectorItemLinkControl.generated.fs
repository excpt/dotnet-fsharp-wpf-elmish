...
type RibbonSpacingSelectorItemLinkControlProp =
    | Base of BarSubItemLinkControlProp
    | ActualRibbon of DevExpress.Xpf.Ribbon.RibbonControl
    | SelectedSpacingMode of DevExpress.Xpf.Bars.SpacingMode

module RibbonSpacingSelectorItemLinkControl =
    let actualRibbon v : obj = box (RibbonSpacingSelectorItemLinkControlProp.ActualRibbon v)
    let selectedSpacingMode v : obj = box (RibbonSpacingSelectorItemLinkControlProp.SelectedSpacingMode v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonSpacingSelectorItemLinkControl) (prop: RibbonSpacingSelectorItemLinkControlProp) =
        match prop with
        | RibbonSpacingSelectorItemLinkControlProp.Base p -> BarSubItemLinkControl.apply el p
        | RibbonSpacingSelectorItemLinkControlProp.ActualRibbon v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSpacingSelectorItemLinkControl.ActualRibbonProperty, box v)
        | RibbonSpacingSelectorItemLinkControlProp.SelectedSpacingMode v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSpacingSelectorItemLinkControl.SelectedSpacingModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonSpacingSelectorItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
