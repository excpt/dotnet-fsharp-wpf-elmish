...
type ImageExporterProp =
    | ExportSettings of DevExpress.Xpf.PivotGrid.Printing.IPivotTextExportSettings

module ImageExporter =
    let exportSettings v : obj = box (ImageExporterProp.ExportSettings v)

    let apply (el: DevExpress.Xpf.PivotGrid.Printing.ImageExporter) (prop: ImageExporterProp) =
        match prop with
        | ImageExporterProp.ExportSettings v -> el.SetValue(DevExpress.Xpf.PivotGrid.Printing.ImageExporter.ExportSettingsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Printing.ImageExporter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
