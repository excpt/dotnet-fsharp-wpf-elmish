...
type FilterPopupVirtualizingStackPanelProp =
    | Base of DXVirtualizingStackPanelProp

module FilterPopupVirtualizingStackPanel =

    let apply (el: DevExpress.Xpf.Core.FilterPopupVirtualizingStackPanel) (prop: FilterPopupVirtualizingStackPanelProp) =
        match prop with
        | FilterPopupVirtualizingStackPanelProp.Base p -> DXVirtualizingStackPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.FilterPopupVirtualizingStackPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
