...
type PopupBaseEditPropertyProviderProp =
    | Base of ButtonEditPropertyProviderProp
    ...
    | PopupViewModel of DevExpress.Xpf.Editors.PopupViewModel
    | AddNewCommand of System.Windows.Input.ICommand

module PopupBaseEditPropertyProvider =
    let popupTopAreaTemplate v : obj = box (PopupBaseEditPropertyProviderProp.PopupTopAreaTemplate v)
    let popupBottomAreaTemplate v : obj = box (PopupBaseEditPropertyProviderProp.PopupBottomAreaTemplate v)
    let popupViewModel v : obj = box (PopupBaseEditPropertyProviderProp.PopupViewModel v)
    let addNewCommand v : obj = box (PopupBaseEditPropertyProviderProp.AddNewCommand v)

    let apply (el: DevExpress.Xpf.Editors.PopupBaseEditPropertyProvider) (prop: PopupBaseEditPropertyProviderProp) =
        match prop with
        | PopupBaseEditPropertyProviderProp.Base p -> ButtonEditPropertyProvider.apply el p
        | PopupBaseEditPropertyProviderProp.PopupTopAreaTemplate v -> el.SetValue(DevExpress.Xpf.Editors.PopupBaseEditPropertyProvider.PopupTopAreaTemplateProperty, box v)
        | PopupBaseEditPropertyProviderProp.PopupBottomAreaTemplate v -> el.SetValue(DevExpress.Xpf.Editors.PopupBaseEditPropertyProvider.PopupBottomAreaTemplateProperty, box v)
        | PopupBaseEditPropertyProviderProp.PopupViewModel v -> el.SetValue(DevExpress.Xpf.Editors.PopupBaseEditPropertyProvider.PopupViewModelProperty, box v)
        | PopupBaseEditPropertyProviderProp.AddNewCommand v -> el.SetValue(DevExpress.Xpf.Editors.PopupBaseEditPropertyProvider.AddNewCommandProperty, box v)

    let nullValueButtonPlacement v : obj = box (ButtonEditPropertyProviderProp.NullValueButtonPlacement v)
    let isTextEditable v : obj = box (ButtonEditPropertyProviderProp.IsTextEditable v)
    let isNullValueButtonVisible v : obj = box (ButtonEditPropertyProviderProp.IsNullValueButtonVisible v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupBaseEditPropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
