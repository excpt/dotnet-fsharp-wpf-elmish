...
type ItemPresenterProp =
    ...
    | GlyphSize of obj
    | GlyphPosition of DevExpress.Xpf.Accordion.GlyphPosition
    | IsRotatedView of bool
    | RotateAngle of float
    | CoerceGlyphMarginOnTouchTheme of bool
    | ShowDefaultGlyph of bool

module ItemPresenter =
    let glyphStretch v : obj = box (ItemPresenterProp.GlyphStretch v)
    let header v : obj = box (ItemPresenterProp.Header v)
    let headerTemplate v : obj = box (ItemPresenterProp.HeaderTemplate v)
    let headerTemplateSelector v : obj = box (ItemPresenterProp.HeaderTemplateSelector v)
    let showHeader v : obj = box (ItemPresenterProp.ShowHeader v)
    let glyph v : obj = box (ItemPresenterProp.Glyph v)
    let glyphTemplate v : obj = box (ItemPresenterProp.GlyphTemplate v)
    let glyphTemplateSelector v : obj = box (ItemPresenterProp.GlyphTemplateSelector v)
    let glyphSize v : obj = box (ItemPresenterProp.GlyphSize v)
    let glyphPosition v : obj = box (ItemPresenterProp.GlyphPosition v)
    let isRotatedView v : obj = box (ItemPresenterProp.IsRotatedView v)
    let rotateAngle v : obj = box (ItemPresenterProp.RotateAngle v)
    let coerceGlyphMarginOnTouchTheme v : obj = box (ItemPresenterProp.CoerceGlyphMarginOnTouchTheme v)
    let showDefaultGlyph v : obj = box (ItemPresenterProp.ShowDefaultGlyph v)

    let apply (el: DevExpress.Xpf.Accordion.ItemPresenter) (prop: ItemPresenterProp) =
        match prop with
        | ItemPresenterProp.GlyphStretch v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.GlyphStretchProperty, box v)
        | ItemPresenterProp.Header v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.HeaderProperty, box v)
        | ItemPresenterProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.HeaderTemplateProperty, box v)
        | ItemPresenterProp.HeaderTemplateSelector v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.HeaderTemplateSelectorProperty, box v)
        | ItemPresenterProp.ShowHeader v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.ShowHeaderProperty, box v)
        | ItemPresenterProp.Glyph v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.GlyphProperty, box v)
        | ItemPresenterProp.GlyphTemplate v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.GlyphTemplateProperty, box v)
        | ItemPresenterProp.GlyphTemplateSelector v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.GlyphTemplateSelectorProperty, box v)
        | ItemPresenterProp.GlyphSize v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.GlyphSizeProperty, box v)
        | ItemPresenterProp.GlyphPosition v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.GlyphPositionProperty, box v)
        | ItemPresenterProp.IsRotatedView v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.IsRotatedViewProperty, box v)
        | ItemPresenterProp.RotateAngle v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.RotateAngleProperty, box v)
        | ItemPresenterProp.CoerceGlyphMarginOnTouchTheme v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.CoerceGlyphMarginOnTouchThemeProperty, box v)
        | ItemPresenterProp.ShowDefaultGlyph v -> el.SetValue(DevExpress.Xpf.Accordion.ItemPresenter.ShowDefaultGlyphProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Accordion.ItemPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
