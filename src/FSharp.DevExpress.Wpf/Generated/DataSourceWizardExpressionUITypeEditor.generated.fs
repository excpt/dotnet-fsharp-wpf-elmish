...
type DataSourceWizardExpressionUITypeEditorProp =
    | EditValue of string
    | ParameterService of DevExpress.DataAccess.Wizard.Services.IParameterService

module DataSourceWizardExpressionUITypeEditor =
    let editValue v : obj = box (DataSourceWizardExpressionUITypeEditorProp.EditValue v)
    let parameterService v : obj = box (DataSourceWizardExpressionUITypeEditorProp.ParameterService v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionUITypeEditor) (prop: DataSourceWizardExpressionUITypeEditorProp) =
        match prop with
        | DataSourceWizardExpressionUITypeEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionUITypeEditor.EditValueProperty, box v)
        | DataSourceWizardExpressionUITypeEditorProp.ParameterService v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionUITypeEditor.ParameterServiceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.DataSourceWizardExpressionUITypeEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
