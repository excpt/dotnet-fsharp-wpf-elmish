...
type LookUpEditBasePropertyProviderProp =
    | Base of PopupBaseEditPropertyProviderProp
    | SelectionViewModel of DevExpress.Xpf.Editors.Popups.SelectionViewModel
    | ShowWaitIndicator of bool
    | HasItemTemplate of bool

module LookUpEditBasePropertyProvider =
    let selectionViewModel v : obj = box (LookUpEditBasePropertyProviderProp.SelectionViewModel v)
    let showWaitIndicator v : obj = box (LookUpEditBasePropertyProviderProp.ShowWaitIndicator v)
    let hasItemTemplate v : obj = box (LookUpEditBasePropertyProviderProp.HasItemTemplate v)

    let apply (el: DevExpress.Xpf.Editors.LookUpEditBasePropertyProvider) (prop: LookUpEditBasePropertyProviderProp) =
        match prop with
        | LookUpEditBasePropertyProviderProp.Base p -> PopupBaseEditPropertyProvider.apply el p
        | LookUpEditBasePropertyProviderProp.SelectionViewModel v -> el.SetValue(DevExpress.Xpf.Editors.LookUpEditBasePropertyProvider.SelectionViewModelProperty, box v)
        | LookUpEditBasePropertyProviderProp.ShowWaitIndicator v -> el.SetValue(DevExpress.Xpf.Editors.LookUpEditBasePropertyProvider.ShowWaitIndicatorProperty, box v)
        | LookUpEditBasePropertyProviderProp.HasItemTemplate v -> el.SetValue(DevExpress.Xpf.Editors.LookUpEditBasePropertyProvider.HasItemTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.LookUpEditBasePropertyProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
