...
type OverlayWindowProp =
    | Base of DXWindowProp

module OverlayWindow =

    let apply (el: DevExpress.Xpf.Printing.Native.OverlayWindow) (prop: OverlayWindowProp) =
        match prop with
        | OverlayWindowProp.Base p -> DXWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.OverlayWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
