...
type ExponentialRegressionProp =
    | Base of ParametricRegressionProp

module ExponentialRegression =

    let apply (el: DevExpress.Xpf.Charts.ExponentialRegression) (prop: ExponentialRegressionProp) =
        match prop with
        | ExponentialRegressionProp.Base p -> ParametricRegression.apply el p

    let valueLevel v : obj = box (ParametricRegressionProp.ValueLevel v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ExponentialRegression>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
