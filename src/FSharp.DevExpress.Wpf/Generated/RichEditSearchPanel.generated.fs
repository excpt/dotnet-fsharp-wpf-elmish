...
type RichEditSearchPanelProp =
    | Base of SearchPanelProp
    | RichEditControl of DevExpress.Xpf.RichEdit.RichEditControl

module RichEditSearchPanel =
    let richEditControl v : obj = box (RichEditSearchPanelProp.RichEditControl v)

    let apply (el: DevExpress.Xpf.RichEdit.UI.RichEditSearchPanel) (prop: RichEditSearchPanelProp) =
        match prop with
        | RichEditSearchPanelProp.Base p -> SearchPanel.apply el p
        | RichEditSearchPanelProp.RichEditControl v -> el.SetValue(DevExpress.Xpf.RichEdit.UI.RichEditSearchPanel.RichEditControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.UI.RichEditSearchPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
