...
type FutureLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module FutureLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureLinearScaleLevelBarForegroundControl) (prop: FutureLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | FutureLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
