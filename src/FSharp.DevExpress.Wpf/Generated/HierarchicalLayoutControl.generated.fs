...
type HierarchicalLayoutControlProp =
    | MasterElement of System.Windows.FrameworkElement
    | Titles of DevExpress.Xpf.TreeMap.TitleCollection
    | Legend of DevExpress.Xpf.TreeMap.Legend

module HierarchicalLayoutControl =
    let masterElement v : obj = box (HierarchicalLayoutControlProp.MasterElement v)
    let titles v : obj = box (HierarchicalLayoutControlProp.Titles v)
    let legend v : obj = box (HierarchicalLayoutControlProp.Legend v)

    let apply (el: DevExpress.Xpf.TreeMap.HierarchicalLayoutControl) (prop: HierarchicalLayoutControlProp) =
        match prop with
        | HierarchicalLayoutControlProp.MasterElement v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalLayoutControl.MasterElementProperty, box v)
        | HierarchicalLayoutControlProp.Titles v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalLayoutControl.TitlesProperty, box v)
        | HierarchicalLayoutControlProp.Legend v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalLayoutControl.LegendProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.TreeMap.HierarchicalLayoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
