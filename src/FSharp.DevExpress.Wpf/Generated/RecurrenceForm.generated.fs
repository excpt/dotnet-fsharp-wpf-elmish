...
type RecurrenceFormProp =
    | Title of string
    | FirstDayOfWeek of System.DayOfWeek

module RecurrenceForm =
    let title v : obj = box (RecurrenceFormProp.Title v)
    let firstDayOfWeek v : obj = box (RecurrenceFormProp.FirstDayOfWeek v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RecurrenceForm) (prop: RecurrenceFormProp) =
        match prop with
        | RecurrenceFormProp.Title v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceForm.TitleProperty, box v)
        | RecurrenceFormProp.FirstDayOfWeek v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceForm.FirstDayOfWeekProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RecurrenceForm>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
