...
type AreaFullStackedSeries2DProp =
    | Base of AreaStackedSeries2DProp

module AreaFullStackedSeries2D =

    let apply (el: DevExpress.Xpf.Charts.AreaFullStackedSeries2D) (prop: AreaFullStackedSeries2DProp) =
        match prop with
        | AreaFullStackedSeries2DProp.Base p -> AreaStackedSeries2D.apply el p
    ...
    let percentOptions (v: DevExpress.Xpf.Charts.PercentOptions) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.AreaFullStackedSeries2D.PercentOptionsProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.AreaFullStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
