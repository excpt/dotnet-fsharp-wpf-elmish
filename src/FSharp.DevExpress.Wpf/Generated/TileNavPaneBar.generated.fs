...
type TileNavPaneBarProp =
    | Base of TileBarProp

module TileNavPaneBar =

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileNavPaneBar) (prop: TileNavPaneBarProp) =
        match prop with
        | TileNavPaneBarProp.Base p -> TileBar.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileNavPaneBar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
