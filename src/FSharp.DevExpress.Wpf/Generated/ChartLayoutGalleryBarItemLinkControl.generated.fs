...
type ChartLayoutGalleryBarItemLinkControlProp =
    | Base of RibbonGalleryBarItemLinkControlProp

module ChartLayoutGalleryBarItemLinkControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.UI.ChartLayoutGalleryBarItemLinkControl) (prop: ChartLayoutGalleryBarItemLinkControlProp) =
        match prop with
        | ChartLayoutGalleryBarItemLinkControlProp.Base p -> RibbonGalleryBarItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.UI.ChartLayoutGalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
