...
type MonthlyRecurrenceControlProp =
    | Base of RecurrenceControlBaseProp
    | RecurrenceInfo of DevExpress.XtraScheduler.RecurrenceInfo

module MonthlyRecurrenceControl =
    let recurrenceInfo v : obj = box (MonthlyRecurrenceControlProp.RecurrenceInfo v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.MonthlyRecurrenceControl) (prop: MonthlyRecurrenceControlProp) =
        match prop with
        | MonthlyRecurrenceControlProp.Base p -> RecurrenceControlBase.apply el p
        | MonthlyRecurrenceControlProp.RecurrenceInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.MonthlyRecurrenceControl.RecurrenceInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.MonthlyRecurrenceControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
