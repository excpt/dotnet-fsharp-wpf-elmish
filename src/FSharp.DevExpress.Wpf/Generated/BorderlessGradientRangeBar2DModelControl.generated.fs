...
type BorderlessGradientRangeBar2DModelControlProp =
    | Base of PredefinedRangeBar2DModelControlProp

module BorderlessGradientRangeBar2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.BorderlessGradientRangeBar2DModelControl) (prop: BorderlessGradientRangeBar2DModelControlProp) =
        match prop with
        | BorderlessGradientRangeBar2DModelControlProp.Base p -> PredefinedRangeBar2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.BorderlessGradientRangeBar2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
