...
type HeadersPanelProp =
    | Orientation of System.Windows.Controls.Orientation
    | LayoutInfo of DevExpress.XtraSpreadsheet.Layout.IDocumentLayout

module HeadersPanel =
    let orientation v : obj = box (HeadersPanelProp.Orientation v)
    let layoutInfo v : obj = box (HeadersPanelProp.LayoutInfo v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.HeadersPanel) (prop: HeadersPanelProp) =
        match prop with
        | HeadersPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeadersPanel.OrientationProperty, box v)
        | HeadersPanelProp.LayoutInfo v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeadersPanel.LayoutInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.HeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
