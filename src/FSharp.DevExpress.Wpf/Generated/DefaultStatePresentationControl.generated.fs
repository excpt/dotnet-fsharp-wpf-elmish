...
type DefaultStatePresentationControlProp =
    | Base of PresentationControlProp

module DefaultStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultStatePresentationControl) (prop: DefaultStatePresentationControlProp) =
        match prop with
        | DefaultStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
