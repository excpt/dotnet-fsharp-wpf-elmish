...
type BarManagerLinksHolderControllerProp =
    | Base of BarManagerControllerProp

module BarManagerLinksHolderController =

    let apply (el: DevExpress.Xpf.Bars.BarManagerLinksHolderController) (prop: BarManagerLinksHolderControllerProp) =
        match prop with
        | BarManagerLinksHolderControllerProp.Base p -> BarManagerController.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarManagerLinksHolderController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
