...
type RangeBarSeries2DProp =
    | Base of BarSeries2DBaseProp
    | Model of DevExpress.Xpf.Charts.RangeBar2DModel
    | Value2DataMember of string
    | MinMarkerModel of DevExpress.Xpf.Charts.Marker2DModel
    | MinMarkerSize of int
    | MinMarkerVisible of bool
    | MaxMarkerModel of DevExpress.Xpf.Charts.Marker2DModel
    | MaxMarkerSize of int
    | MaxMarkerVisible of bool
    | LabelValueSeparator of string
    | LegendValueSeparator of string

module RangeBarSeries2D =
    let model v : obj = box (RangeBarSeries2DProp.Model v)
    let value2DataMember v : obj = box (RangeBarSeries2DProp.Value2DataMember v)
    let minMarkerModel v : obj = box (RangeBarSeries2DProp.MinMarkerModel v)
    let minMarkerSize v : obj = box (RangeBarSeries2DProp.MinMarkerSize v)
    let minMarkerVisible v : obj = box (RangeBarSeries2DProp.MinMarkerVisible v)
    let maxMarkerModel v : obj = box (RangeBarSeries2DProp.MaxMarkerModel v)
    let maxMarkerSize v : obj = box (RangeBarSeries2DProp.MaxMarkerSize v)
    let maxMarkerVisible v : obj = box (RangeBarSeries2DProp.MaxMarkerVisible v)
    let labelValueSeparator v : obj = box (RangeBarSeries2DProp.LabelValueSeparator v)
    let legendValueSeparator v : obj = box (RangeBarSeries2DProp.LegendValueSeparator v)

    let apply (el: DevExpress.Xpf.Charts.RangeBarSeries2D) (prop: RangeBarSeries2DProp) =
        match prop with
        | RangeBarSeries2DProp.Base p -> BarSeries2DBase.apply el p
        | RangeBarSeries2DProp.Model v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.ModelProperty, box v)
        | RangeBarSeries2DProp.Value2DataMember v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.Value2DataMemberProperty, box v)
        | RangeBarSeries2DProp.MinMarkerModel v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.MinMarkerModelProperty, box v)
        | RangeBarSeries2DProp.MinMarkerSize v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.MinMarkerSizeProperty, box v)
        | RangeBarSeries2DProp.MinMarkerVisible v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.MinMarkerVisibleProperty, box v)
        | RangeBarSeries2DProp.MaxMarkerModel v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.MaxMarkerModelProperty, box v)
        | RangeBarSeries2DProp.MaxMarkerSize v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.MaxMarkerSizeProperty, box v)
        | RangeBarSeries2DProp.MaxMarkerVisible v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.MaxMarkerVisibleProperty, box v)
        | RangeBarSeries2DProp.LabelValueSeparator v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.LabelValueSeparatorProperty, box v)
        | RangeBarSeries2DProp.LegendValueSeparator v -> el.SetValue(DevExpress.Xpf.Charts.RangeBarSeries2D.LegendValueSeparatorProperty, box v)

    let barWidth v : obj = box (BarSeries2DBaseProp.BarWidth v)
    let pointAnimation v : obj = box (BarSeries2DBaseProp.PointAnimation v)
    ...
    let value2 (v: float) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.RangeBarSeries2D.Value2Property, box v)) :: node.Props }
    let dateTimeValue2 (v: System.DateTime) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.RangeBarSeries2D.DateTimeValue2Property, box v)) :: node.Props }
    let timeSpanValue2 (v: System.TimeSpan) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.RangeBarSeries2D.TimeSpanValue2Property, box v)) :: node.Props }
    let labelKind (v: DevExpress.Xpf.Charts.RangeBarLabelKind) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.RangeBarSeries2D.LabelKindProperty, box v)) :: node.Props }
