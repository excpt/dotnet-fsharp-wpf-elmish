...
type RibbonSelectedPagePopupBorderControlProp =
    | Base of RibbonPopupBorderControlProp
    | ToolTipVerticalOffset of float

module RibbonSelectedPagePopupBorderControl =
    let toolTipVerticalOffset v : obj = box (RibbonSelectedPagePopupBorderControlProp.ToolTipVerticalOffset v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonSelectedPagePopupBorderControl) (prop: RibbonSelectedPagePopupBorderControlProp) =
        match prop with
        | RibbonSelectedPagePopupBorderControlProp.Base p -> RibbonPopupBorderControl.apply el p
        | RibbonSelectedPagePopupBorderControlProp.ToolTipVerticalOffset v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonSelectedPagePopupBorderControl.ToolTipVerticalOffsetProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonSelectedPagePopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
