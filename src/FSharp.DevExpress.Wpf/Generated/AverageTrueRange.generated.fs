...
type AverageTrueRangeProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | PointsCount of int

module AverageTrueRange =
    let pointsCount v : obj = box (AverageTrueRangeProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.AverageTrueRange) (prop: AverageTrueRangeProp) =
        match prop with
        | AverageTrueRangeProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | AverageTrueRangeProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.AverageTrueRange.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AverageTrueRange>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
