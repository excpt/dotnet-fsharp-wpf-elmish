...
type AreaSparklineControlProp =
    | Base of LineSparklineControlProp
    | AreaOpacity of float

module AreaSparklineControl =
    let areaOpacity v : obj = box (AreaSparklineControlProp.AreaOpacity v)

    let apply (el: DevExpress.Xpf.Editors.AreaSparklineControl) (prop: AreaSparklineControlProp) =
        match prop with
        | AreaSparklineControlProp.Base p -> LineSparklineControl.apply el p
        | AreaSparklineControlProp.AreaOpacity v -> el.SetValue(DevExpress.Xpf.Editors.AreaSparklineControl.AreaOpacityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.AreaSparklineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
