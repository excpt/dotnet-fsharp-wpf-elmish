...
type AppointmentsInfoPanelProp =
    | Base of XPFContentControlProp
    | SchedulerTimeCellControl of DevExpress.Xpf.Scheduler.Drawing.ISchedulerTimeCellControl
    | SchedulerWeekMoreButtonControl of DevExpress.Xpf.Scheduler.Drawing.ISchedulerWeekMoreButtonControl
    | View of DevExpress.Xpf.Scheduler.SchedulerViewBase
    | SchedulerControl of DevExpress.Xpf.Scheduler.SchedulerControl

module AppointmentsInfoPanel =
    let schedulerTimeCellControl v : obj = box (AppointmentsInfoPanelProp.SchedulerTimeCellControl v)
    let schedulerWeekMoreButtonControl v : obj = box (AppointmentsInfoPanelProp.SchedulerWeekMoreButtonControl v)
    let view v : obj = box (AppointmentsInfoPanelProp.View v)
    let schedulerControl v : obj = box (AppointmentsInfoPanelProp.SchedulerControl v)

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.AppointmentsInfoPanel) (prop: AppointmentsInfoPanelProp) =
        match prop with
        | AppointmentsInfoPanelProp.Base p -> XPFContentControl.apply el p
        | AppointmentsInfoPanelProp.SchedulerTimeCellControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentsInfoPanel.SchedulerTimeCellControlProperty, box v)
        | AppointmentsInfoPanelProp.SchedulerWeekMoreButtonControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentsInfoPanel.SchedulerWeekMoreButtonControlProperty, box v)
        | AppointmentsInfoPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentsInfoPanel.ViewProperty, box v)
        | AppointmentsInfoPanelProp.SchedulerControl v -> el.SetValue(DevExpress.Xpf.Scheduler.Drawing.AppointmentsInfoPanel.SchedulerControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.AppointmentsInfoPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
