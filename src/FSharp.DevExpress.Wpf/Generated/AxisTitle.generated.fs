...
type AxisTitleProp =
    ...
    | Alignment of DevExpress.Xpf.Charts.TitleAlignment

module AxisTitle =
    let alignment v : obj = box (AxisTitleProp.Alignment v)

    let apply (el: DevExpress.Xpf.Charts.AxisTitle) (prop: AxisTitleProp) =
        match prop with
        | AxisTitleProp.Base p -> AxisElementTitleBase.apply el p
        | AxisTitleProp.Alignment v -> el.SetValue(DevExpress.Xpf.Charts.AxisTitle.AlignmentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisTitle>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
