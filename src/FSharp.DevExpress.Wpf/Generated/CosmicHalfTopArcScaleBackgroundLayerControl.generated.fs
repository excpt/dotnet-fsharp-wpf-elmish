...
type CosmicHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module CosmicHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.CosmicHalfTopArcScaleBackgroundLayerControl) (prop: CosmicHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | CosmicHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CosmicHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
