...
type PositionedCompatibilityAdornerProp =
    | Base of CompatibilityAdornerProp

module PositionedCompatibilityAdorner =

    let apply (el: DevExpress.Xpf.Core.PositionedCompatibilityAdorner) (prop: PositionedCompatibilityAdornerProp) =
        match prop with
        | PositionedCompatibilityAdornerProp.Base p -> CompatibilityAdorner.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PositionedCompatibilityAdorner>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
