...
type ListBoxEditItemProp =
    | Base of ListBoxEditItemBaseProp

module ListBoxEditItem =

    let apply (el: DevExpress.Xpf.Editors.ListBoxEditItem) (prop: ListBoxEditItemProp) =
        match prop with
        | ListBoxEditItemProp.Base p -> ListBoxEditItemBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ListBoxEditItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
