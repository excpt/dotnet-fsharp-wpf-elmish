...
type RecurrenceControlBaseProp =
    | IsReadOnly of bool

module RecurrenceControlBase =
    let isReadOnly v : obj = box (RecurrenceControlBaseProp.IsReadOnly v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.RecurrenceControlBase) (prop: RecurrenceControlBaseProp) =
        match prop with
        | RecurrenceControlBaseProp.IsReadOnly v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.RecurrenceControlBase.IsReadOnlyProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.RecurrenceControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
