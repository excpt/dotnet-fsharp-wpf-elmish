...
type FutureScaleLabelControlProp =
    | Base of PresentationControlProp

module FutureScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureScaleLabelControl) (prop: FutureScaleLabelControlProp) =
        match prop with
        | FutureScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
