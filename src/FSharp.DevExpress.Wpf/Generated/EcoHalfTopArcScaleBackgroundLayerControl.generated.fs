...
type EcoHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module EcoHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoHalfTopArcScaleBackgroundLayerControl) (prop: EcoHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | EcoHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
