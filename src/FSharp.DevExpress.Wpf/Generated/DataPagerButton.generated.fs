...
type DataPagerButtonProp =
    | ButtonType of DevExpress.Xpf.Editors.DataPager.DataPagerButtonType
    | DisplayMode of DevExpress.Xpf.Editors.DataPager.DataPagerDisplayMode
    | IsCurrentPage of bool
    | ShowEllipsis of bool
    | PageNumber of int

module DataPagerButton =
    let buttonType v : obj = box (DataPagerButtonProp.ButtonType v)
    let displayMode v : obj = box (DataPagerButtonProp.DisplayMode v)
    let isCurrentPage v : obj = box (DataPagerButtonProp.IsCurrentPage v)
    let showEllipsis v : obj = box (DataPagerButtonProp.ShowEllipsis v)
    let pageNumber v : obj = box (DataPagerButtonProp.PageNumber v)

    let apply (el: DevExpress.Xpf.Editors.DataPager.DataPagerButton) (prop: DataPagerButtonProp) =
        match prop with
        | DataPagerButtonProp.ButtonType v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerButton.ButtonTypeProperty, box v)
        | DataPagerButtonProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerButton.DisplayModeProperty, box v)
        | DataPagerButtonProp.IsCurrentPage v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerButton.IsCurrentPageProperty, box v)
        | DataPagerButtonProp.ShowEllipsis v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerButton.ShowEllipsisProperty, box v)
        | DataPagerButtonProp.PageNumber v -> el.SetValue(DevExpress.Xpf.Editors.DataPager.DataPagerButton.PageNumberProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DataPager.DataPagerButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
