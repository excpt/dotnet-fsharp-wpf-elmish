...
type FutureMinorTickmarkControlProp =
    | Base of PresentationControlProp

module FutureMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.FutureMinorTickmarkControl) (prop: FutureMinorTickmarkControlProp) =
        match prop with
        | FutureMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FutureMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
