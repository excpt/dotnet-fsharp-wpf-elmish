...
type ChangeDataSourcePivotTableControlProp =
    | Base of ReferenceEditBaseControlProp

module ChangeDataSourcePivotTableControl =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.ChangeDataSourcePivotTableControl) (prop: ChangeDataSourcePivotTableControlProp) =
        match prop with
        | ChangeDataSourcePivotTableControlProp.Base p -> ReferenceEditBaseControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.ChangeDataSourcePivotTableControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
