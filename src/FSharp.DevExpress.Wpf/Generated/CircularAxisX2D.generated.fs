...
type CircularAxisX2DProp =
    | Base of AxisBaseProp
    | NumericScaleOptions of DevExpress.Xpf.Charts.NumericScaleOptionsBase

module CircularAxisX2D =
    let numericScaleOptions v : obj = box (CircularAxisX2DProp.NumericScaleOptions v)

    let apply (el: DevExpress.Xpf.Charts.CircularAxisX2D) (prop: CircularAxisX2DProp) =
        match prop with
        | CircularAxisX2DProp.Base p -> AxisBase.apply el p
        | CircularAxisX2DProp.NumericScaleOptions v -> el.SetValue(DevExpress.Xpf.Charts.CircularAxisX2D.NumericScaleOptionsProperty, box v)
