...
type FinancialIndicatorProp =
    | Base of IndicatorProp
    | Argument1 of obj
    | Argument2 of obj
    | ValueLevel1 of DevExpress.Xpf.Charts.ValueLevel
    | ValueLevel2 of DevExpress.Xpf.Charts.ValueLevel

module FinancialIndicator =
    let argument1 v : obj = box (FinancialIndicatorProp.Argument1 v)
    let argument2 v : obj = box (FinancialIndicatorProp.Argument2 v)
    let valueLevel1 v : obj = box (FinancialIndicatorProp.ValueLevel1 v)
    let valueLevel2 v : obj = box (FinancialIndicatorProp.ValueLevel2 v)

    let apply (el: DevExpress.Xpf.Charts.FinancialIndicator) (prop: FinancialIndicatorProp) =
        match prop with
        | FinancialIndicatorProp.Base p -> Indicator.apply el p
        | FinancialIndicatorProp.Argument1 v -> el.SetValue(DevExpress.Xpf.Charts.FinancialIndicator.Argument1Property, box v)
        | FinancialIndicatorProp.Argument2 v -> el.SetValue(DevExpress.Xpf.Charts.FinancialIndicator.Argument2Property, box v)
        | FinancialIndicatorProp.ValueLevel1 v -> el.SetValue(DevExpress.Xpf.Charts.FinancialIndicator.ValueLevel1Property, box v)
        | FinancialIndicatorProp.ValueLevel2 v -> el.SetValue(DevExpress.Xpf.Charts.FinancialIndicator.ValueLevel2Property, box v)
