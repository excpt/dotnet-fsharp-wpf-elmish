...
type HorizontalAppointmentStartClockControlProp =
    | Base of HorizontalAppointmentClockControlBaseProp

module HorizontalAppointmentStartClockControl =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentStartClockControl) (prop: HorizontalAppointmentStartClockControlProp) =
        match prop with
        | HorizontalAppointmentStartClockControlProp.Base p -> HorizontalAppointmentClockControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.HorizontalAppointmentStartClockControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
