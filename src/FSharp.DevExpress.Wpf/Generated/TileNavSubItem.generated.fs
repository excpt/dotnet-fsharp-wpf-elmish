...
type TileNavSubItemProp =
    | Base of NavElementBaseProp

module TileNavSubItem =

    let apply (el: DevExpress.Xpf.Navigation.TileNavSubItem) (prop: TileNavSubItemProp) =
        match prop with
        | TileNavSubItemProp.Base p -> NavElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.TileNavSubItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
