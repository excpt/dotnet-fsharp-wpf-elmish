...
type PieSeries2DItemsControlProp =
...
module PieSeries2DItemsControl =
    let series v : obj = box (PieSeries2DItemsControlProp.Series v)
    let pointsContainer v : obj = box (PieSeries2DItemsControlProp.PointsContainer v)
    let seriesLabel v : obj = box (PieSeries2DItemsControlProp.SeriesLabel v)
    let seriesLabelItems v : obj = box (PieSeries2DItemsControlProp.SeriesLabelItems v)

    let apply (el: DevExpress.Xpf.Charts.PieSeries2DItemsControl) (prop: PieSeries2DItemsControlProp) =
        match prop with
        | PieSeries2DItemsControlProp.Base p -> Diagram2DItemsControl.apply el p
        | PieSeries2DItemsControlProp.Series v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2DItemsControl.SeriesProperty, box v)
        | PieSeries2DItemsControlProp.PointsContainer v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2DItemsControl.PointsContainerProperty, box v)
        | PieSeries2DItemsControlProp.SeriesLabel v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2DItemsControl.SeriesLabelProperty, box v)
        | PieSeries2DItemsControlProp.SeriesLabelItems v -> el.SetValue(DevExpress.Xpf.Charts.PieSeries2DItemsControl.SeriesLabelItemsProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.PieSeries2DItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
