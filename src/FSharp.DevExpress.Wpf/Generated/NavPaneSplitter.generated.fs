...
type NavPaneSplitterProp =
    | Base of ThumbProp
    | Orientation of System.Windows.Controls.Orientation
    | ShowBorder of bool

module NavPaneSplitter =
    let orientation v : obj = box (NavPaneSplitterProp.Orientation v)
    let showBorder v : obj = box (NavPaneSplitterProp.ShowBorder v)

    let apply (el: DevExpress.Xpf.NavBar.NavPaneSplitter) (prop: NavPaneSplitterProp) =
        match prop with
        | NavPaneSplitterProp.Base p -> Thumb.apply el p
        | NavPaneSplitterProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneSplitter.OrientationProperty, box v)
        | NavPaneSplitterProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavPaneSplitter.ShowBorderProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavPaneSplitter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
