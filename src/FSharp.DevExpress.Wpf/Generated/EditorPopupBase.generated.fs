...
type EditorPopupBaseProp =
    | Base of PopupBaseProp

module EditorPopupBase =

    let apply (el: DevExpress.Xpf.Editors.Popups.EditorPopupBase) (prop: EditorPopupBaseProp) =
        match prop with
        | EditorPopupBaseProp.Base p -> PopupBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Popups.EditorPopupBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
