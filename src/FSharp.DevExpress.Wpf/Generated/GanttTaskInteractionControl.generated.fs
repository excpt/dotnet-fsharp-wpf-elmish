...
type GanttTaskInteractionControlProp =
    | ShowInteractionAdorner of bool

module GanttTaskInteractionControl =
    let showInteractionAdorner v : obj = box (GanttTaskInteractionControlProp.ShowInteractionAdorner v)

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttTaskInteractionControl) (prop: GanttTaskInteractionControlProp) =
        match prop with
        | GanttTaskInteractionControlProp.ShowInteractionAdorner v -> el.SetValue(DevExpress.Xpf.Gantt.Native.GanttTaskInteractionControl.ShowInteractionAdornerProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttTaskInteractionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
