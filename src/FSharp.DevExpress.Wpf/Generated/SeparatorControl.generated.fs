...
type SeparatorControlProp =
    | Base of psvContentControlProp
    | Orientation of System.Windows.Controls.Orientation

module SeparatorControl =
    let orientation v : obj = box (SeparatorControlProp.Orientation v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.SeparatorControl) (prop: SeparatorControlProp) =
        match prop with
        | SeparatorControlProp.Base p -> psvContentControl.apply el p
        | SeparatorControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.SeparatorControl.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.SeparatorControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
