...
type AxisRenderControlProp =
    | Base of ChartElementBaseProp
    | Brush of System.Windows.Media.Brush
    | AxisGeometry of System.Windows.Rect
    | MajorTickmarksGeometry of obj
    | MinorTickmarksGeometry of obj

module AxisRenderControl =
    let brush v : obj = box (AxisRenderControlProp.Brush v)
    let axisGeometry v : obj = box (AxisRenderControlProp.AxisGeometry v)
    let majorTickmarksGeometry v : obj = box (AxisRenderControlProp.MajorTickmarksGeometry v)
    let minorTickmarksGeometry v : obj = box (AxisRenderControlProp.MinorTickmarksGeometry v)

    let apply (el: DevExpress.Xpf.Charts.AxisRenderControl) (prop: AxisRenderControlProp) =
        match prop with
        | AxisRenderControlProp.Base p -> ChartElementBase.apply el p
        | AxisRenderControlProp.Brush v -> el.SetValue(DevExpress.Xpf.Charts.AxisRenderControl.BrushProperty, box v)
        | AxisRenderControlProp.AxisGeometry v -> el.SetValue(DevExpress.Xpf.Charts.AxisRenderControl.AxisGeometryProperty, box v)
        | AxisRenderControlProp.MajorTickmarksGeometry v -> el.SetValue(DevExpress.Xpf.Charts.AxisRenderControl.MajorTickmarksGeometryProperty, box v)
        | AxisRenderControlProp.MinorTickmarksGeometry v -> el.SetValue(DevExpress.Xpf.Charts.AxisRenderControl.MinorTickmarksGeometryProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
