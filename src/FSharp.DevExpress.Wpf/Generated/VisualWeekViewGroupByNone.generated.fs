...
type VisualWeekViewGroupByNoneProp =
    | Base of VisualResourcesBasedViewInfoProp

module VisualWeekViewGroupByNone =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.VisualWeekViewGroupByNone) (prop: VisualWeekViewGroupByNoneProp) =
        match prop with
        | VisualWeekViewGroupByNoneProp.Base p -> VisualResourcesBasedViewInfo.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.VisualWeekViewGroupByNone>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
