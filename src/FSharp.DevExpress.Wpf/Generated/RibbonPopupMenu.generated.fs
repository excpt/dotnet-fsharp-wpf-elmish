...
type RibbonPopupMenuProp =
    | Base of PopupMenuProp

module RibbonPopupMenu =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPopupMenu) (prop: RibbonPopupMenuProp) =
        match prop with
        | RibbonPopupMenuProp.Base p -> PopupMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
