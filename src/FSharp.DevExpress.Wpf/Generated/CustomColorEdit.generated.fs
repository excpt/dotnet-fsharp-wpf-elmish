...
type CustomColorEditProp =
    | Base of ColorEditProp

module CustomColorEdit =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.CustomColorEdit) (prop: CustomColorEditProp) =
        match prop with
        | CustomColorEditProp.Base p -> ColorEdit.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.Editing.CustomColorEdit>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
