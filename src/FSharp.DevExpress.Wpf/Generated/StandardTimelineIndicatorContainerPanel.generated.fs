...
type StandardTimelineIndicatorContainerPanelProp =
    | HorizontalViewport of float
    | HorizontalOffset of float
    | HorizontalExtent of float
    | View of DevExpress.Xpf.Scheduling.ViewBase

module StandardTimelineIndicatorContainerPanel =
    let horizontalViewport v : obj = box (StandardTimelineIndicatorContainerPanelProp.HorizontalViewport v)
    let horizontalOffset v : obj = box (StandardTimelineIndicatorContainerPanelProp.HorizontalOffset v)
    let horizontalExtent v : obj = box (StandardTimelineIndicatorContainerPanelProp.HorizontalExtent v)
    let view v : obj = box (StandardTimelineIndicatorContainerPanelProp.View v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.StandardTimelineIndicatorContainerPanel) (prop: StandardTimelineIndicatorContainerPanelProp) =
        match prop with
        | StandardTimelineIndicatorContainerPanelProp.HorizontalViewport v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineIndicatorContainerPanel.HorizontalViewportProperty, box v)
        | StandardTimelineIndicatorContainerPanelProp.HorizontalOffset v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineIndicatorContainerPanel.HorizontalOffsetProperty, box v)
        | StandardTimelineIndicatorContainerPanelProp.HorizontalExtent v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineIndicatorContainerPanel.HorizontalExtentProperty, box v)
        | StandardTimelineIndicatorContainerPanelProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.StandardTimelineIndicatorContainerPanel.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Panels.StandardTimelineIndicatorContainerPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
