...
type BarSparklineStyleSettingsProp =
    | Base of SparklineStyleSettingsProp
    | HighlightNegativePoints of bool
    | BarDistance of int

module BarSparklineStyleSettings =
    let highlightNegativePoints v : obj = box (BarSparklineStyleSettingsProp.HighlightNegativePoints v)
    let barDistance v : obj = box (BarSparklineStyleSettingsProp.BarDistance v)

    let apply (el: DevExpress.Xpf.Editors.BarSparklineStyleSettings) (prop: BarSparklineStyleSettingsProp) =
        match prop with
        | BarSparklineStyleSettingsProp.Base p -> SparklineStyleSettings.apply el p
        | BarSparklineStyleSettingsProp.HighlightNegativePoints v -> el.SetValue(DevExpress.Xpf.Editors.BarSparklineStyleSettings.HighlightNegativePointsProperty, box v)
        | BarSparklineStyleSettingsProp.BarDistance v -> el.SetValue(DevExpress.Xpf.Editors.BarSparklineStyleSettings.BarDistanceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.BarSparklineStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
