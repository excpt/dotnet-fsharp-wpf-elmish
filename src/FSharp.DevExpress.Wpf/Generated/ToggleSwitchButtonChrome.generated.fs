...
type ToggleSwitchButtonChromeProp =
    | Base of ButtonChromeProp

module ToggleSwitchButtonChrome =

    let apply (el: DevExpress.Xpf.Editors.Internal.ToggleSwitchButtonChrome) (prop: ToggleSwitchButtonChromeProp) =
        match prop with
        | ToggleSwitchButtonChromeProp.Base p -> ButtonChrome.apply el p

    let isDefaulted v : obj = box (ButtonChromeProp.IsDefaulted v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.ToggleSwitchButtonChrome>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
