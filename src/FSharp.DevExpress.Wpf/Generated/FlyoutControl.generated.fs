...
open System
open System.Windows
open DevExpress.Xpf.Editors.Flyout
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type FlyoutControlProp =
    | Base of FlyoutBaseProp

module FlyoutControl =

    let apply (el: DevExpress.Xpf.Editors.Flyout.FlyoutControl) (prop: FlyoutControlProp) =
        match prop with
        | FlyoutControlProp.Base p -> FlyoutBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Flyout.FlyoutControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
