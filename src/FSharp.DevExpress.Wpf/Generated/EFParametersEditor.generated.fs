...
type EFParametersEditorProp =
    | ViewModel of DevExpress.DataAccess.UI.IParametersGridViewModel
    | UseLegacyExpressionEditor of bool
    | ExternalParameterEditorDialogServiceTemplate of System.Windows.DataTemplate
    | ExpressionEditorDialogServiceTemplate of System.Windows.DataTemplate
    | OnRenameParameter of DevExpress.Xpf.DataAccess.Native.Editors.RenameParameterEventHandler

module EFParametersEditor =
    let viewModel v : obj = box (EFParametersEditorProp.ViewModel v)
    let useLegacyExpressionEditor v : obj = box (EFParametersEditorProp.UseLegacyExpressionEditor v)
    let externalParameterEditorDialogServiceTemplate v : obj = box (EFParametersEditorProp.ExternalParameterEditorDialogServiceTemplate v)
    let expressionEditorDialogServiceTemplate v : obj = box (EFParametersEditorProp.ExpressionEditorDialogServiceTemplate v)
    let onRenameParameter v : obj = box (EventProp(box (EFParametersEditorProp.OnRenameParameter v)))

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.EFParametersEditor) (prop: EFParametersEditorProp) =
        match prop with
        | EFParametersEditorProp.ViewModel v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.EFParametersEditor.ViewModelProperty, box v)
        | EFParametersEditorProp.UseLegacyExpressionEditor v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.EFParametersEditor.UseLegacyExpressionEditorProperty, box v)
        | EFParametersEditorProp.ExternalParameterEditorDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.EFParametersEditor.ExternalParameterEditorDialogServiceTemplateProperty, box v)
        | EFParametersEditorProp.ExpressionEditorDialogServiceTemplate v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.EFParametersEditor.ExpressionEditorDialogServiceTemplateProperty, box v)
        | EFParametersEditorProp.OnRenameParameter h -> el.RenameParameter.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.EFParametersEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
