...
type CircularSmartQuarterTopLeftModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularSmartQuarterTopLeftModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularSmartQuarterTopLeftModel) (prop: CircularSmartQuarterTopLeftModelProp) =
        match prop with
        | CircularSmartQuarterTopLeftModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularSmartQuarterTopLeftModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
