...
type TabbedLayoutGroupPaneProp =
    | Base of LayoutTabControlProp

module TabbedLayoutGroupPane =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabbedLayoutGroupPane) (prop: TabbedLayoutGroupPaneProp) =
        match prop with
        | TabbedLayoutGroupPaneProp.Base p -> LayoutTabControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabbedLayoutGroupPane>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
