...
type ImageEditSaveToolButtonProp =
    | Base of ImageEditToolButtonProp

module ImageEditSaveToolButton =

    let apply (el: DevExpress.Xpf.Editors.ImageEditSaveToolButton) (prop: ImageEditSaveToolButtonProp) =
        match prop with
        | ImageEditSaveToolButtonProp.Base p -> ImageEditToolButton.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ImageEditSaveToolButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
