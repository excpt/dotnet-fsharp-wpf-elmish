...
type TabCaptionControlProp =
    | Base of CaptionControlProp

module TabCaptionControl =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabCaptionControl) (prop: TabCaptionControlProp) =
        match prop with
        | TabCaptionControlProp.Base p -> CaptionControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabCaptionControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
