...
type ReportParameterEditorProp =
    | EditValue of DevExpress.Data.IParameter

module ReportParameterEditor =
    let editValue v : obj = box (ReportParameterEditorProp.EditValue v)

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterEditor) (prop: ReportParameterEditorProp) =
        match prop with
        | ReportParameterEditorProp.EditValue v -> el.SetValue(DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterEditor.EditValueProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.ReportParameterEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
