...
type SimpleFilterDXDialogProp =
    | Base of CustomDXDialogProp

module SimpleFilterDXDialog =

    let apply (el: DevExpress.Xpf.Spreadsheet.Forms.SimpleFilterDXDialog) (prop: SimpleFilterDXDialogProp) =
        match prop with
        | SimpleFilterDXDialogProp.Base p -> CustomDXDialog.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Forms.SimpleFilterDXDialog>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
