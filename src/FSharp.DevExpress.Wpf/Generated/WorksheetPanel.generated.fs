...
type WorksheetPanelProp =
    | Base of WorksheetPaintPanelProp

module WorksheetPanel =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetPanel) (prop: WorksheetPanelProp) =
        match prop with
        | WorksheetPanelProp.Base p -> WorksheetPaintPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
