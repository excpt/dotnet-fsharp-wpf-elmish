...
type GanttTaskDragThumbProp =
    | Base of EventsTargetProp
    | ThumbKind of DevExpress.Xpf.Gantt.Native.TaskEditKind
    | OnTaskValueChanging of DevExpress.Xpf.Gantt.Native.TaskValueChangingEventHandler
    | OnTaskValueBeginEdit of DevExpress.Xpf.Gantt.Native.TaskValueChangingEventHandler
    | OnTaskValueFinishEdit of DevExpress.Xpf.Gantt.Native.TaskValueChangingEventHandler

module GanttTaskDragThumb =
    let thumbKind v : obj = box (GanttTaskDragThumbProp.ThumbKind v)
    let onTaskValueChanging v : obj = box (EventProp(box (GanttTaskDragThumbProp.OnTaskValueChanging v)))
    let onTaskValueBeginEdit v : obj = box (EventProp(box (GanttTaskDragThumbProp.OnTaskValueBeginEdit v)))
    let onTaskValueFinishEdit v : obj = box (EventProp(box (GanttTaskDragThumbProp.OnTaskValueFinishEdit v)))

    let apply (el: DevExpress.Xpf.Gantt.Native.GanttTaskDragThumb) (prop: GanttTaskDragThumbProp) =
        match prop with
        | GanttTaskDragThumbProp.Base p -> EventsTarget.apply el p
        | GanttTaskDragThumbProp.ThumbKind v -> el.SetValue(DevExpress.Xpf.Gantt.Native.GanttTaskDragThumb.ThumbKindProperty, box v)
        | GanttTaskDragThumbProp.OnTaskValueChanging h -> el.TaskValueChanging.AddHandler(h)
        | GanttTaskDragThumbProp.OnTaskValueBeginEdit h -> el.TaskValueBeginEdit.AddHandler(h)
        | GanttTaskDragThumbProp.OnTaskValueFinishEdit h -> el.TaskValueFinishEdit.AddHandler(h)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.GanttTaskDragThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
