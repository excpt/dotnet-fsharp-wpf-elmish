...
type FlatLightThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatLightThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatLightThreeQuartersArcScaleBackgroundLayerControl) (prop: FlatLightThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatLightThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatLightThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
