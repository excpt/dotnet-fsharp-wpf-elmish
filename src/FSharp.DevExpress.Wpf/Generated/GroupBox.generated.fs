...
type GroupBoxProp =
    | Base of MaximizableHeaderedContentControlBaseProp
    | CornerRadius of System.Windows.CornerRadius
    | MaximizeElementVisibility of System.Windows.Visibility
    | MinimizeElementVisibility of System.Windows.Visibility
    | MinimizationDirection of System.Windows.Controls.Orientation
    | SeparatorBrush of System.Windows.Media.Brush
    | ShadowOffset of float
    | ShadowVisibility of obj
    | ShowShadow of DevExpress.Xpf.LayoutControl.GroupBoxShadowVisibility
    | State of DevExpress.Xpf.LayoutControl.GroupBoxState
    | TitleBackground of System.Windows.Media.Brush
    | TitleForeground of System.Windows.Media.Brush
    | TitleVisibility of System.Windows.Visibility
    | NormalTemplate of System.Windows.Controls.ControlTemplate
    | LightTemplate of System.Windows.Controls.ControlTemplate
    | DisplayMode of DevExpress.Xpf.LayoutControl.GroupBoxDisplayMode

module GroupBox =
    let cornerRadius v : obj = box (GroupBoxProp.CornerRadius v)
    let maximizeElementVisibility v : obj = box (GroupBoxProp.MaximizeElementVisibility v)
    let minimizeElementVisibility v : obj = box (GroupBoxProp.MinimizeElementVisibility v)
    let minimizationDirection v : obj = box (GroupBoxProp.MinimizationDirection v)
    let separatorBrush v : obj = box (GroupBoxProp.SeparatorBrush v)
    let shadowOffset v : obj = box (GroupBoxProp.ShadowOffset v)
    let shadowVisibility v : obj = box (GroupBoxProp.ShadowVisibility v)
    let showShadow v : obj = box (GroupBoxProp.ShowShadow v)
    let state v : obj = box (GroupBoxProp.State v)
    let titleBackground v : obj = box (GroupBoxProp.TitleBackground v)
    let titleForeground v : obj = box (GroupBoxProp.TitleForeground v)
    let titleVisibility v : obj = box (GroupBoxProp.TitleVisibility v)
    let normalTemplate v : obj = box (GroupBoxProp.NormalTemplate v)
    let lightTemplate v : obj = box (GroupBoxProp.LightTemplate v)
    let displayMode v : obj = box (GroupBoxProp.DisplayMode v)

    let apply (el: DevExpress.Xpf.LayoutControl.GroupBox) (prop: GroupBoxProp) =
        match prop with
        | GroupBoxProp.Base p -> MaximizableHeaderedContentControlBase.apply el p
        | GroupBoxProp.CornerRadius v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.CornerRadiusProperty, box v)
        | GroupBoxProp.MaximizeElementVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.MaximizeElementVisibilityProperty, box v)
        | GroupBoxProp.MinimizeElementVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.MinimizeElementVisibilityProperty, box v)
        | GroupBoxProp.MinimizationDirection v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.MinimizationDirectionProperty, box v)
        | GroupBoxProp.SeparatorBrush v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.SeparatorBrushProperty, box v)
        | GroupBoxProp.ShadowOffset v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.ShadowOffsetProperty, box v)
        | GroupBoxProp.ShadowVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.ShadowVisibilityProperty, box v)
        | GroupBoxProp.ShowShadow v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.ShowShadowProperty, box v)
        | GroupBoxProp.State v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.StateProperty, box v)
        | GroupBoxProp.TitleBackground v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.TitleBackgroundProperty, box v)
        | GroupBoxProp.TitleForeground v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.TitleForegroundProperty, box v)
        | GroupBoxProp.TitleVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.TitleVisibilityProperty, box v)
        | GroupBoxProp.NormalTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.NormalTemplateProperty, box v)
        | GroupBoxProp.LightTemplate v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.LightTemplateProperty, box v)
        | GroupBoxProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.LayoutControl.GroupBox.DisplayModeProperty, box v)

    let currentContentTemplate v : obj = box (MaximizableHeaderedContentControlBaseProp.CurrentContentTemplate v)
    let maximizedContentTemplate v : obj = box (MaximizableHeaderedContentControlBaseProp.MaximizedContentTemplate v)
    let header v : obj = box (HeaderedContentControlBaseProp.Header v)
    let headerTemplate v : obj = box (HeaderedContentControlBaseProp.HeaderTemplate v)
    let content v : obj = box (ContentControlBaseProp.Content v)
    let contentTemplate v : obj = box (ContentControlBaseProp.ContentTemplate v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.GroupBox>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
