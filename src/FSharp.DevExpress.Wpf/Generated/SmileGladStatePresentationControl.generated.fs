...
type SmileGladStatePresentationControlProp =
    | Base of PresentationControlProp

module SmileGladStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.SmileGladStatePresentationControl) (prop: SmileGladStatePresentationControlProp) =
        match prop with
        | SmileGladStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmileGladStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
