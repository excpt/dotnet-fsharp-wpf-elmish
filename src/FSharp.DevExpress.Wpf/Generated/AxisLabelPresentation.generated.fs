...
type AxisLabelPresentationProp =
    | Base of ChartElementBaseProp

module AxisLabelPresentation =

    let apply (el: DevExpress.Xpf.Charts.AxisLabelPresentation) (prop: AxisLabelPresentationProp) =
        match prop with
        | AxisLabelPresentationProp.Base p -> ChartElementBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.AxisLabelPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
