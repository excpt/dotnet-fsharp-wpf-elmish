...
type DropMarkerProp =
    | Position of DevExpress.Xpf.Core.DropPosition
    | Orientation of System.Windows.Controls.Orientation

module DropMarker =
    let position v : obj = box (DropMarkerProp.Position v)
    let orientation v : obj = box (DropMarkerProp.Orientation v)

    let apply (el: DevExpress.Xpf.Core.DropMarker) (prop: DropMarkerProp) =
        match prop with
        | DropMarkerProp.Position v -> el.SetValue(DevExpress.Xpf.Core.DropMarker.PositionProperty, box v)
        | DropMarkerProp.Orientation v -> el.SetValue(DevExpress.Xpf.Core.DropMarker.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DropMarker>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
