...
type BarManagerThemeDependentValuesProviderProp =
    | ToolbarCaptionEditorWindowFloatSize of DevExpress.Xpf.Bars.SizeEx
    | CustomizationFormMinWidth of float
    | CustomizationFormMinHeight of float
    | CustomizationFormFloatSize of DevExpress.Xpf.Bars.SizeEx
    | ColorizeGlyph of bool

module BarManagerThemeDependentValuesProvider =
    let toolbarCaptionEditorWindowFloatSize v : obj = box (BarManagerThemeDependentValuesProviderProp.ToolbarCaptionEditorWindowFloatSize v)
    let customizationFormMinWidth v : obj = box (BarManagerThemeDependentValuesProviderProp.CustomizationFormMinWidth v)
    let customizationFormMinHeight v : obj = box (BarManagerThemeDependentValuesProviderProp.CustomizationFormMinHeight v)
    let customizationFormFloatSize v : obj = box (BarManagerThemeDependentValuesProviderProp.CustomizationFormFloatSize v)
    let colorizeGlyph v : obj = box (BarManagerThemeDependentValuesProviderProp.ColorizeGlyph v)

    let apply (el: DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider) (prop: BarManagerThemeDependentValuesProviderProp) =
        match prop with
        | BarManagerThemeDependentValuesProviderProp.ToolbarCaptionEditorWindowFloatSize v -> el.SetValue(DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider.ToolbarCaptionEditorWindowFloatSizeProperty, box v)
        | BarManagerThemeDependentValuesProviderProp.CustomizationFormMinWidth v -> el.SetValue(DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider.CustomizationFormMinWidthProperty, box v)
        | BarManagerThemeDependentValuesProviderProp.CustomizationFormMinHeight v -> el.SetValue(DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider.CustomizationFormMinHeightProperty, box v)
        | BarManagerThemeDependentValuesProviderProp.CustomizationFormFloatSize v -> el.SetValue(DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider.CustomizationFormFloatSizeProperty, box v)
        | BarManagerThemeDependentValuesProviderProp.ColorizeGlyph v -> el.SetValue(DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider.ColorizeGlyphProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarManagerThemeDependentValuesProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
