...
type LayoutItemCustomizationToolbarProp =
    | Base of ControlBaseProp
    | AvailableItemsUIVisibility of System.Windows.Visibility
    | CanMoveItemBackward of bool
    | CanMoveItemForward of bool
    | ItemHeader of obj
    | ItemMovingDirection of System.Windows.Controls.Orientation
    | ItemMovingBackwardDirection of DevExpress.Xpf.Core.Side
    | ItemMovingForwardDirection of DevExpress.Xpf.Core.Side
    | ItemMovingUIVisibility of System.Windows.Visibility
    | ItemRenamingUIVisibility of System.Windows.Visibility
    | NewItemsUIVisibility of System.Windows.Visibility

module LayoutItemCustomizationToolbar =
    let availableItemsUIVisibility v : obj = box (LayoutItemCustomizationToolbarProp.AvailableItemsUIVisibility v)
    let canMoveItemBackward v : obj = box (LayoutItemCustomizationToolbarProp.CanMoveItemBackward v)
    let canMoveItemForward v : obj = box (LayoutItemCustomizationToolbarProp.CanMoveItemForward v)
    let itemHeader v : obj = box (LayoutItemCustomizationToolbarProp.ItemHeader v)
    let itemMovingDirection v : obj = box (LayoutItemCustomizationToolbarProp.ItemMovingDirection v)
    let itemMovingBackwardDirection v : obj = box (LayoutItemCustomizationToolbarProp.ItemMovingBackwardDirection v)
    let itemMovingForwardDirection v : obj = box (LayoutItemCustomizationToolbarProp.ItemMovingForwardDirection v)
    let itemMovingUIVisibility v : obj = box (LayoutItemCustomizationToolbarProp.ItemMovingUIVisibility v)
    let itemRenamingUIVisibility v : obj = box (LayoutItemCustomizationToolbarProp.ItemRenamingUIVisibility v)
    let newItemsUIVisibility v : obj = box (LayoutItemCustomizationToolbarProp.NewItemsUIVisibility v)

    let apply (el: DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar) (prop: LayoutItemCustomizationToolbarProp) =
        match prop with
        | LayoutItemCustomizationToolbarProp.Base p -> ControlBase.apply el p
        | LayoutItemCustomizationToolbarProp.AvailableItemsUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.AvailableItemsUIVisibilityProperty, box v)
        | LayoutItemCustomizationToolbarProp.CanMoveItemBackward v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.CanMoveItemBackwardProperty, box v)
        | LayoutItemCustomizationToolbarProp.CanMoveItemForward v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.CanMoveItemForwardProperty, box v)
        | LayoutItemCustomizationToolbarProp.ItemHeader v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.ItemHeaderProperty, box v)
        | LayoutItemCustomizationToolbarProp.ItemMovingDirection v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.ItemMovingDirectionProperty, box v)
        | LayoutItemCustomizationToolbarProp.ItemMovingBackwardDirection v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.ItemMovingBackwardDirectionProperty, box v)
        | LayoutItemCustomizationToolbarProp.ItemMovingForwardDirection v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.ItemMovingForwardDirectionProperty, box v)
        | LayoutItemCustomizationToolbarProp.ItemMovingUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.ItemMovingUIVisibilityProperty, box v)
        | LayoutItemCustomizationToolbarProp.ItemRenamingUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.ItemRenamingUIVisibilityProperty, box v)
        | LayoutItemCustomizationToolbarProp.NewItemsUIVisibility v -> el.SetValue(DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar.NewItemsUIVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.LayoutControl.LayoutItemCustomizationToolbar>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
