...
type AppointmentImagesPanelProp =
    | Base of AppointmentImagesPresenterProp
...
module AppointmentImagesPanel =
    let reminderImageSource v : obj = box (AppointmentImagesPanelProp.ReminderImageSource v)
    let recurrenceImageSource v : obj = box (AppointmentImagesPanelProp.RecurrenceImageSource v)
    let changedRecurrenceImageSource v : obj = box (AppointmentImagesPanelProp.ChangedRecurrenceImageSource v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPanel) (prop: AppointmentImagesPanelProp) =
        match prop with
        | AppointmentImagesPanelProp.Base p -> AppointmentImagesPresenter.apply el p
        | AppointmentImagesPanelProp.ReminderImageSource v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPanel.ReminderImageSourceProperty, box v)
        | AppointmentImagesPanelProp.RecurrenceImageSource v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPanel.RecurrenceImageSourceProperty, box v)
        | AppointmentImagesPanelProp.ChangedRecurrenceImageSource v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPanel.ChangedRecurrenceImageSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.AppointmentImagesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
