...
type PopupBorderControlProp =
    | IsLeft of bool
    | DropOpposite of bool
    | ContentWidth of float
    | ContentMinWidth of float
    | ContentMaxWidth of float
    | ContentHeight of float
    | ContentMinHeight of float
    | ContentMaxHeight of float
    | Popup of System.Windows.Controls.Primitives.Popup

module PopupBorderControl =
    let isLeft v : obj = box (PopupBorderControlProp.IsLeft v)
    let dropOpposite v : obj = box (PopupBorderControlProp.DropOpposite v)
    let contentWidth v : obj = box (PopupBorderControlProp.ContentWidth v)
    let contentMinWidth v : obj = box (PopupBorderControlProp.ContentMinWidth v)
    let contentMaxWidth v : obj = box (PopupBorderControlProp.ContentMaxWidth v)
    let contentHeight v : obj = box (PopupBorderControlProp.ContentHeight v)
    let contentMinHeight v : obj = box (PopupBorderControlProp.ContentMinHeight v)
    let contentMaxHeight v : obj = box (PopupBorderControlProp.ContentMaxHeight v)
    let popup v : obj = box (PopupBorderControlProp.Popup v)

    let apply (el: DevExpress.Xpf.Core.PopupBorderControl) (prop: PopupBorderControlProp) =
        match prop with
        | PopupBorderControlProp.IsLeft v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.IsLeftProperty, box v)
        | PopupBorderControlProp.DropOpposite v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.DropOppositeProperty, box v)
        | PopupBorderControlProp.ContentWidth v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.ContentWidthProperty, box v)
        | PopupBorderControlProp.ContentMinWidth v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.ContentMinWidthProperty, box v)
        | PopupBorderControlProp.ContentMaxWidth v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.ContentMaxWidthProperty, box v)
        | PopupBorderControlProp.ContentHeight v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.ContentHeightProperty, box v)
        | PopupBorderControlProp.ContentMinHeight v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.ContentMinHeightProperty, box v)
        | PopupBorderControlProp.ContentMaxHeight v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.ContentMaxHeightProperty, box v)
        | PopupBorderControlProp.Popup v -> el.SetValue(DevExpress.Xpf.Core.PopupBorderControl.PopupProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.PopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
