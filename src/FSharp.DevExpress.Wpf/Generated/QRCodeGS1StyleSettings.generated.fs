...
type QRCodeGS1StyleSettingsProp =
    | Base of QRCodeStyleSettingsProp
    | FNC1Substitute of string

module QRCodeGS1StyleSettings =
    let fNC1Substitute v : obj = box (QRCodeGS1StyleSettingsProp.FNC1Substitute v)

    let apply (el: DevExpress.Xpf.Editors.QRCodeGS1StyleSettings) (prop: QRCodeGS1StyleSettingsProp) =
        match prop with
        | QRCodeGS1StyleSettingsProp.Base p -> QRCodeStyleSettings.apply el p
        | QRCodeGS1StyleSettingsProp.FNC1Substitute v -> el.SetValue(DevExpress.Xpf.Editors.QRCodeGS1StyleSettings.FNC1SubstituteProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.QRCodeGS1StyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
