...
type SankeyTitleItemsControlProp =
    | LastChild of System.Windows.FrameworkElement
    | Titles of DevExpress.Xpf.Charts.Sankey.SankeyTitleCollection

module SankeyTitleItemsControl =
    let lastChild v : obj = box (SankeyTitleItemsControlProp.LastChild v)
    let titles v : obj = box (SankeyTitleItemsControlProp.Titles v)

    let apply (el: DevExpress.Xpf.Charts.Sankey.SankeyTitleItemsControl) (prop: SankeyTitleItemsControlProp) =
        match prop with
        | SankeyTitleItemsControlProp.LastChild v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyTitleItemsControl.LastChildProperty, box v)
        | SankeyTitleItemsControlProp.Titles v -> el.SetValue(DevExpress.Xpf.Charts.Sankey.SankeyTitleItemsControl.TitlesProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Sankey.SankeyTitleItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
