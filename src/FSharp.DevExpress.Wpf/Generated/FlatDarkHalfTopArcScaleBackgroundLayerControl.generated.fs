...
type FlatDarkHalfTopArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkHalfTopArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkHalfTopArcScaleBackgroundLayerControl) (prop: FlatDarkHalfTopArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatDarkHalfTopArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkHalfTopArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
