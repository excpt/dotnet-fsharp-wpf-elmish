...
type InputConnectorDragThumbProp =
    | Base of ConnectorDragThumbBaseProp

module InputConnectorDragThumb =

    let apply (el: DevExpress.Xpf.Gantt.Native.InputConnectorDragThumb) (prop: InputConnectorDragThumbProp) =
        match prop with
        | InputConnectorDragThumbProp.Base p -> ConnectorDragThumbBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gantt.Native.InputConnectorDragThumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
