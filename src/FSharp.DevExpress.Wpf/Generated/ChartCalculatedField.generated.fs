...
type ChartCalculatedFieldProp =
    | Base of ChartElementProp
    | FieldName of string
    | FieldType of DevExpress.Xpf.Charts.ChartCalculatedFieldType
    | DisplayName of string
    | Expression of string
    | DataSource of obj
    | DataMember of string

module ChartCalculatedField =
    let fieldName v : obj = box (ChartCalculatedFieldProp.FieldName v)
    let fieldType v : obj = box (ChartCalculatedFieldProp.FieldType v)
    let displayName v : obj = box (ChartCalculatedFieldProp.DisplayName v)
    let expression v : obj = box (ChartCalculatedFieldProp.Expression v)
    let dataSource v : obj = box (ChartCalculatedFieldProp.DataSource v)
    let dataMember v : obj = box (ChartCalculatedFieldProp.DataMember v)

    let apply (el: DevExpress.Xpf.Charts.ChartCalculatedField) (prop: ChartCalculatedFieldProp) =
        match prop with
        | ChartCalculatedFieldProp.Base p -> ChartElement.apply el p
        | ChartCalculatedFieldProp.FieldName v -> el.SetValue(DevExpress.Xpf.Charts.ChartCalculatedField.FieldNameProperty, box v)
        | ChartCalculatedFieldProp.FieldType v -> el.SetValue(DevExpress.Xpf.Charts.ChartCalculatedField.FieldTypeProperty, box v)
        | ChartCalculatedFieldProp.DisplayName v -> el.SetValue(DevExpress.Xpf.Charts.ChartCalculatedField.DisplayNameProperty, box v)
        | ChartCalculatedFieldProp.Expression v -> el.SetValue(DevExpress.Xpf.Charts.ChartCalculatedField.ExpressionProperty, box v)
        | ChartCalculatedFieldProp.DataSource v -> el.SetValue(DevExpress.Xpf.Charts.ChartCalculatedField.DataSourceProperty, box v)
        | ChartCalculatedFieldProp.DataMember v -> el.SetValue(DevExpress.Xpf.Charts.ChartCalculatedField.DataMemberProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartCalculatedField>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
