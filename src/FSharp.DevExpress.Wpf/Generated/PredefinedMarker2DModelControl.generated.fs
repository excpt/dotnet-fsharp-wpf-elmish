...
type PredefinedMarker2DModelControlProp =
    | Base of PredefinedModelControlProp

module PredefinedMarker2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.PredefinedMarker2DModelControl) (prop: PredefinedMarker2DModelControlProp) =
        match prop with
        | PredefinedMarker2DModelControlProp.Base p -> PredefinedModelControl.apply el p
