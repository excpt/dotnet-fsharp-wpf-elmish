...
type IndicatorLabelProp =
    | Base of ChartTextElementProp

module IndicatorLabel =

    let apply (el: DevExpress.Xpf.Charts.IndicatorLabel) (prop: IndicatorLabelProp) =
        match prop with
        | IndicatorLabelProp.Base p -> ChartTextElement.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.IndicatorLabel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
