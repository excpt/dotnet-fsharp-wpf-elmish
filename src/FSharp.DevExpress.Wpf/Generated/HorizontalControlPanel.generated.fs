...
type HorizontalControlPanelProp =
    | ChaptersVisibility of System.Windows.Visibility
    | ChaptersDisplayType of DevExpress.Xpf.Controls.ChaptersDisplayType

module HorizontalControlPanel =
    let chaptersVisibility v : obj = box (HorizontalControlPanelProp.ChaptersVisibility v)
    let chaptersDisplayType v : obj = box (HorizontalControlPanelProp.ChaptersDisplayType v)

    let apply (el: DevExpress.Xpf.Controls.HorizontalControlPanel) (prop: HorizontalControlPanelProp) =
        match prop with
        | HorizontalControlPanelProp.ChaptersVisibility v -> el.SetValue(DevExpress.Xpf.Controls.HorizontalControlPanel.ChaptersVisibilityProperty, box v)
        | HorizontalControlPanelProp.ChaptersDisplayType v -> el.SetValue(DevExpress.Xpf.Controls.HorizontalControlPanel.ChaptersDisplayTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.HorizontalControlPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
