...
type ControlItemCaptionPresenterProp =
    | Base of ControlItemElementPresenterProp

module ControlItemCaptionPresenter =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.ControlItemCaptionPresenter) (prop: ControlItemCaptionPresenterProp) =
        match prop with
        | ControlItemCaptionPresenterProp.Base p -> ControlItemElementPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.ControlItemCaptionPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
