...
type ProgressiveArcScaleLineControlProp =
    | Base of PresentationControlProp

module ProgressiveArcScaleLineControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveArcScaleLineControl) (prop: ProgressiveArcScaleLineControlProp) =
        match prop with
        | ProgressiveArcScaleLineControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveArcScaleLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
