...
module RatingPanel =
    ...
    let apply (el: DevExpress.Xpf.Editors.Internal.RatingPanel) (prop: RatingPanelProp) =
        match prop with
        | RatingPanelProp.Base p -> DXPanelBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Internal.RatingPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
