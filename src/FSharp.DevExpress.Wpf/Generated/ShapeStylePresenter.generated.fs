...
type ShapeStylePresenterProp =
    | Base of ShapePresenterProp
    | Text of string
    | StyleId of DevExpress.Diagram.Core.DiagramItemStyleId
    | Theme of DevExpress.Diagram.Core.DiagramTheme

module ShapeStylePresenter =
    let text v : obj = box (ShapeStylePresenterProp.Text v)
    let styleId v : obj = box (ShapeStylePresenterProp.StyleId v)
    let theme v : obj = box (ShapeStylePresenterProp.Theme v)

    let apply (el: DevExpress.Xpf.Diagram.ShapeStylePresenter) (prop: ShapeStylePresenterProp) =
        match prop with
        | ShapeStylePresenterProp.Base p -> ShapePresenter.apply el p
        | ShapeStylePresenterProp.Text v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeStylePresenter.TextProperty, box v)
        | ShapeStylePresenterProp.StyleId v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeStylePresenter.StyleIdProperty, box v)
        | ShapeStylePresenterProp.Theme v -> el.SetValue(DevExpress.Xpf.Diagram.ShapeStylePresenter.ThemeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.ShapeStylePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
