...
type CircularRedClockModelProp =
    | Base of CircularGaugeModelProp

module CircularRedClockModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularRedClockModel) (prop: CircularRedClockModelProp) =
        match prop with
        | CircularRedClockModelProp.Base p -> CircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularRedClockModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
