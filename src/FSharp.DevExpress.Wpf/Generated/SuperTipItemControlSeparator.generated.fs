...
type SuperTipItemControlSeparatorProp =
    | Base of SuperTipItemControlBaseProp

module SuperTipItemControlSeparator =

    let apply (el: DevExpress.Xpf.Core.SuperTipItemControlSeparator) (prop: SuperTipItemControlSeparatorProp) =
        match prop with
        | SuperTipItemControlSeparatorProp.Base p -> SuperTipItemControlBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SuperTipItemControlSeparator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
