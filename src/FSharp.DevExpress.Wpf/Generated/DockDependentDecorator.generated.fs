...
type DockDependentDecoratorProp =
...
module DockDependentDecorator =
    ...
    let apply (el: DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator) (prop: DockDependentDecoratorProp) =
        match prop with
        | DockDependentDecoratorProp.TopMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator.TopMarginProperty, box v)
        | DockDependentDecoratorProp.BottomMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator.BottomMarginProperty, box v)
        | DockDependentDecoratorProp.LeftMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator.LeftMarginProperty, box v)
        | DockDependentDecoratorProp.RightMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator.RightMarginProperty, box v)
        | DockDependentDecoratorProp.CaptionLocation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator.CaptionLocationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.DockDependentDecorator>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
