...
type ProgressiveLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module ProgressiveLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveLinearScaleBackgroundLayerControl) (prop: ProgressiveLinearScaleBackgroundLayerControlProp) =
        match prop with
        | ProgressiveLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
