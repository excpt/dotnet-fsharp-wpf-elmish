...
type DateNavigatorCalendarMonthLabelsPanelProp =
    | Orientation of System.Windows.Controls.Orientation

module DateNavigatorCalendarMonthLabelsPanel =
    let orientation v : obj = box (DateNavigatorCalendarMonthLabelsPanelProp.Orientation v)

    let apply (el: DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarMonthLabelsPanel) (prop: DateNavigatorCalendarMonthLabelsPanelProp) =
        match prop with
        | DateNavigatorCalendarMonthLabelsPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarMonthLabelsPanel.OrientationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.DateNavigator.Controls.DateNavigatorCalendarMonthLabelsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
