...
type HtmlRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module HtmlRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.HtmlRichEditDocumentSourceProvider) (prop: HtmlRichEditDocumentSourceProviderProp) =
        match prop with
        | HtmlRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.HtmlRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
