...
module DashboardLayoutGroup =
    let contextMenuTemplate v : obj = box (DashboardLayoutGroupProp.ContextMenuTemplate v)
    let captionCustomizationsTemplate v : obj = box (DashboardLayoutGroupProp.CaptionCustomizationsTemplate v)

    let apply (el: DevExpress.DashboardWpf.DashboardLayoutGroup) (prop: DashboardLayoutGroupProp) =
        match prop with
        | DashboardLayoutGroupProp.Base p -> LayoutGroup.apply el p
        | DashboardLayoutGroupProp.ContextMenuTemplate v -> el.SetValue(DevExpress.DashboardWpf.DashboardLayoutGroup.ContextMenuTemplateProperty, box v)
        | DashboardLayoutGroupProp.CaptionCustomizationsTemplate v -> el.SetValue(DevExpress.DashboardWpf.DashboardLayoutGroup.CaptionCustomizationsTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.DashboardLayoutGroup>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
