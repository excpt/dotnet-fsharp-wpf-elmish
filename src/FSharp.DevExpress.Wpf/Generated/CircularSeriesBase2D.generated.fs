...
type CircularSeriesBase2DProp =
    | Base of XYSeriesProp
    | PointAnimation of DevExpress.Xpf.Charts.CircularMarkerAnimationBase

module CircularSeriesBase2D =
    let pointAnimation v : obj = box (CircularSeriesBase2DProp.PointAnimation v)

    let apply (el: DevExpress.Xpf.Charts.CircularSeriesBase2D) (prop: CircularSeriesBase2DProp) =
        match prop with
        | CircularSeriesBase2DProp.Base p -> XYSeries.apply el p
        | CircularSeriesBase2DProp.PointAnimation v -> el.SetValue(DevExpress.Xpf.Charts.CircularSeriesBase2D.PointAnimationProperty, box v)
