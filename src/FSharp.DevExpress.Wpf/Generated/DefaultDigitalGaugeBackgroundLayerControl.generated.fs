...
type DefaultDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module DefaultDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultDigitalGaugeBackgroundLayerControl) (prop: DefaultDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | DefaultDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
