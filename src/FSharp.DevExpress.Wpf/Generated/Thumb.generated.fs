...
open System
open System.Windows
open DevExpress.Xpf.Core.DragAndDrop
...
module Thumb =
    ...
    let allowDrag v : obj = box (ThumbProp.AllowDrag v)
    ...
    let apply (el: DevExpress.Xpf.Core.DragAndDrop.Thumb) (prop: ThumbProp) =
        match prop with
        | ThumbProp.Base p -> SLThumb.apply el p
        | ThumbProp.IsDragging v -> el.SetValue(DevExpress.Xpf.Core.DragAndDrop.Thumb.IsDraggingProperty, box v)
        | ThumbProp.AllowDrag v -> el.SetValue(DevExpress.Xpf.Core.DragAndDrop.Thumb.AllowDragProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DragAndDrop.Thumb>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
