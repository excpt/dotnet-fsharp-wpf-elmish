...
type DefaultLinearScaleRangeControlProp =
    | Base of PresentationControlProp

module DefaultLinearScaleRangeControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultLinearScaleRangeControl) (prop: DefaultLinearScaleRangeControlProp) =
        match prop with
        | DefaultLinearScaleRangeControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultLinearScaleRangeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
