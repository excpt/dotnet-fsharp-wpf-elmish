...
type FloatPanePresenterProp =
    | Base of BaseFloatingContainerProp
    | BorderStyle of DevExpress.Xpf.Docking.FloatGroupBorderStyle
    | IsMaximized of bool
    | FormBorderMargin of System.Windows.Thickness
    | SingleBorderMargin of System.Windows.Thickness
    | MaximizedBorderMargin of System.Windows.Thickness
    | ActualContentMargin of System.Windows.Thickness
    | ShadowMargin of System.Windows.Thickness
    | BorderMargin of System.Windows.Thickness
    | ActualShadowMargin of System.Windows.Thickness
    | ActualBorderMargin of System.Windows.Thickness

module FloatPanePresenter =
    let borderStyle v : obj = box (FloatPanePresenterProp.BorderStyle v)
    let isMaximized v : obj = box (FloatPanePresenterProp.IsMaximized v)
    let formBorderMargin v : obj = box (FloatPanePresenterProp.FormBorderMargin v)
    let singleBorderMargin v : obj = box (FloatPanePresenterProp.SingleBorderMargin v)
    let maximizedBorderMargin v : obj = box (FloatPanePresenterProp.MaximizedBorderMargin v)
    let actualContentMargin v : obj = box (FloatPanePresenterProp.ActualContentMargin v)
    let shadowMargin v : obj = box (FloatPanePresenterProp.ShadowMargin v)
    let borderMargin v : obj = box (FloatPanePresenterProp.BorderMargin v)
    let actualShadowMargin v : obj = box (FloatPanePresenterProp.ActualShadowMargin v)
    let actualBorderMargin v : obj = box (FloatPanePresenterProp.ActualBorderMargin v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter) (prop: FloatPanePresenterProp) =
        match prop with
        | FloatPanePresenterProp.Base p -> BaseFloatingContainer.apply el p
        | FloatPanePresenterProp.BorderStyle v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.BorderStyleProperty, box v)
        | FloatPanePresenterProp.IsMaximized v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.IsMaximizedProperty, box v)
        | FloatPanePresenterProp.FormBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.FormBorderMarginProperty, box v)
        | FloatPanePresenterProp.SingleBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.SingleBorderMarginProperty, box v)
        | FloatPanePresenterProp.MaximizedBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.MaximizedBorderMarginProperty, box v)
        | FloatPanePresenterProp.ActualContentMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.ActualContentMarginProperty, box v)
        | FloatPanePresenterProp.ShadowMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.ShadowMarginProperty, box v)
        | FloatPanePresenterProp.BorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.BorderMarginProperty, box v)
        | FloatPanePresenterProp.ActualShadowMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.ActualShadowMarginProperty, box v)
        | FloatPanePresenterProp.ActualBorderMargin v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.FloatPanePresenter.ActualBorderMarginProperty, box v)
