...
type CustomColumnFilterContentPresenterProp =
    | CustomColumnFilter of DevExpress.Data.Filtering.CriteriaOperator
    | ColumnFilterInfo of DevExpress.Xpf.Grid.CustomColumnFilterInfo

module CustomColumnFilterContentPresenter =
    let customColumnFilter v : obj = box (CustomColumnFilterContentPresenterProp.CustomColumnFilter v)
    let columnFilterInfo v : obj = box (CustomColumnFilterContentPresenterProp.ColumnFilterInfo v)

    let apply (el: DevExpress.Xpf.Grid.CustomColumnFilterContentPresenter) (prop: CustomColumnFilterContentPresenterProp) =
        match prop with
        | CustomColumnFilterContentPresenterProp.CustomColumnFilter v -> el.SetValue(DevExpress.Xpf.Grid.CustomColumnFilterContentPresenter.CustomColumnFilterProperty, box v)
        | CustomColumnFilterContentPresenterProp.ColumnFilterInfo v -> el.SetValue(DevExpress.Xpf.Grid.CustomColumnFilterContentPresenter.ColumnFilterInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.CustomColumnFilterContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
