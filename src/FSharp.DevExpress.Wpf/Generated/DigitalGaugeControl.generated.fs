...
type DigitalGaugeControlProp =
    | Base of GaugeControlBaseProp
    | Model of DevExpress.Xpf.Gauges.DigitalGaugeModel
    | Text of string
    | SymbolCount of int
    | SymbolView of DevExpress.Xpf.Gauges.SymbolViewBase
    | TextHorizontalAlignment of DevExpress.Xpf.Gauges.TextHorizontalAlignment
    | TextVerticalAlignment of DevExpress.Xpf.Gauges.TextVerticalAlignment
    | TextDirection of DevExpress.Xpf.Gauges.TextDirection

module DigitalGaugeControl =
    let model v : obj = box (DigitalGaugeControlProp.Model v)
    let text v : obj = box (DigitalGaugeControlProp.Text v)
    let symbolCount v : obj = box (DigitalGaugeControlProp.SymbolCount v)
    let symbolView v : obj = box (DigitalGaugeControlProp.SymbolView v)
    let textHorizontalAlignment v : obj = box (DigitalGaugeControlProp.TextHorizontalAlignment v)
    let textVerticalAlignment v : obj = box (DigitalGaugeControlProp.TextVerticalAlignment v)
    let textDirection v : obj = box (DigitalGaugeControlProp.TextDirection v)

    let apply (el: DevExpress.Xpf.Gauges.DigitalGaugeControl) (prop: DigitalGaugeControlProp) =
        match prop with
        | DigitalGaugeControlProp.Base p -> GaugeControlBase.apply el p
        | DigitalGaugeControlProp.Model v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.ModelProperty, box v)
        | DigitalGaugeControlProp.Text v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.TextProperty, box v)
        | DigitalGaugeControlProp.SymbolCount v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.SymbolCountProperty, box v)
        | DigitalGaugeControlProp.SymbolView v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.SymbolViewProperty, box v)
        | DigitalGaugeControlProp.TextHorizontalAlignment v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.TextHorizontalAlignmentProperty, box v)
        | DigitalGaugeControlProp.TextVerticalAlignment v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.TextVerticalAlignmentProperty, box v)
        | DigitalGaugeControlProp.TextDirection v -> el.SetValue(DevExpress.Xpf.Gauges.DigitalGaugeControl.TextDirectionProperty, box v)

    let enableAnimation v : obj = box (GaugeControlBaseProp.EnableAnimation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalGaugeControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
