...
type BarSplitButtonColorEditItemLinkControlProp =
    | Base of BarSplitButtonItemLinkControlProp

module BarSplitButtonColorEditItemLinkControl =

    let apply (el: DevExpress.Xpf.Office.UI.BarSplitButtonColorEditItemLinkControl) (prop: BarSplitButtonColorEditItemLinkControlProp) =
        match prop with
        | BarSplitButtonColorEditItemLinkControlProp.Base p -> BarSplitButtonItemLinkControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Office.UI.BarSplitButtonColorEditItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
