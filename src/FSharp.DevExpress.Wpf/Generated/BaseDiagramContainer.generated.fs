...
type BaseDiagramContainerProp =
    | Base of DiagramItemProp

module BaseDiagramContainer =

    let apply (el: DevExpress.Xpf.Diagram.BaseDiagramContainer) (prop: BaseDiagramContainerProp) =
        match prop with
        | BaseDiagramContainerProp.Base p -> DiagramItem.apply el p
