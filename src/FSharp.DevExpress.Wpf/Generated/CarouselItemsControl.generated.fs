...
type CarouselItemsControlProp =
    | Carousel of DevExpress.Xpf.Carousel.CarouselPanel

module CarouselItemsControl =
    let carousel v : obj = box (CarouselItemsControlProp.Carousel v)

    let apply (el: DevExpress.Xpf.Carousel.CarouselItemsControl) (prop: CarouselItemsControlProp) =
        match prop with
        | CarouselItemsControlProp.Carousel v -> el.SetValue(DevExpress.Xpf.Carousel.CarouselItemsControl.CarouselProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Carousel.CarouselItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
