...
type RotatableBorderProp =
    | Location of System.Windows.Controls.Dock
    | BorderThickness of System.Windows.Thickness
    | BorderCornerRadius of System.Windows.CornerRadius
    ...
    | BorderBackground of System.Windows.Media.Brush
    | BorderOpacityMask of System.Windows.Media.Brush

module RotatableBorder =
    ...
    let apply (el: DevExpress.Xpf.Core.Native.RotatableBorder) (prop: RotatableBorderProp) =
        match prop with
        | RotatableBorderProp.Location v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.LocationProperty, box v)
        | RotatableBorderProp.BorderThickness v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderThicknessProperty, box v)
        | RotatableBorderProp.BorderCornerRadius v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderCornerRadiusProperty, box v)
        | RotatableBorderProp.BorderMargin v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderMarginProperty, box v)
        | RotatableBorderProp.BorderPadding v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderPaddingProperty, box v)
        | RotatableBorderProp.BorderBrush v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderBrushProperty, box v)
        | RotatableBorderProp.BorderBackground v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderBackgroundProperty, box v)
        | RotatableBorderProp.BorderOpacityMask v -> el.SetValue(DevExpress.Xpf.Core.Native.RotatableBorder.BorderOpacityMaskProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.RotatableBorder>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
