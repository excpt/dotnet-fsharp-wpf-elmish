...
type DXWindowProp =
    | IsDraggingOrResizing of bool
    | WindowTemplate of System.Windows.DataTemplate
    | AeroWindowTemplate of System.Windows.DataTemplate
    | SmallIcon of System.Windows.Media.ImageSource
    | AeroBorderSize of float
    | IsAeroMode of bool
    | AllowApplicationIconScaling of bool
    ...
    | BorderEffectLeftMargins of System.Windows.Thickness
    | BorderEffectRightMargins of System.Windows.Thickness
    | BorderEffectTopMargins of System.Windows.Thickness
    | BorderEffectBottomMargins of System.Windows.Thickness
    | BorderEffectImagesUri of System.Windows.Controls.TextBlock
    | BorderEffectOffset of System.Windows.Thickness
    | BorderEffectActiveColor of System.Windows.Media.SolidColorBrush
    | BorderEffectInactiveColor of System.Windows.Media.SolidColorBrush
    | ResizeBorderThickness of System.Windows.Thickness
    | ResizeBorderThicknessInAeroMode of System.Windows.Thickness
    | AllowSystemMenu of bool

module DXWindow =
    let isDraggingOrResizing v : obj = box (DXWindowProp.IsDraggingOrResizing v)
    let windowTemplate v : obj = box (DXWindowProp.WindowTemplate v)
    let aeroWindowTemplate v : obj = box (DXWindowProp.AeroWindowTemplate v)
    let smallIcon v : obj = box (DXWindowProp.SmallIcon v)
    let aeroBorderSize v : obj = box (DXWindowProp.AeroBorderSize v)
    let isAeroMode v : obj = box (DXWindowProp.IsAeroMode v)
    let allowApplicationIconScaling v : obj = box (DXWindowProp.AllowApplicationIconScaling v)
    let headerItemsSource v : obj = box (DXWindowProp.HeaderItemsSource v)
    let headerItemContainerStyle v : obj = box (DXWindowProp.HeaderItemContainerStyle v)
    let headerItemContainerStyleSelector v : obj = box (DXWindowProp.HeaderItemContainerStyleSelector v)
    let headerItemTemplate v : obj = box (DXWindowProp.HeaderItemTemplate v)
    let headerItemTemplateSelector v : obj = box (DXWindowProp.HeaderItemTemplateSelector v)
    let borderEffectLeftMargins v : obj = box (DXWindowProp.BorderEffectLeftMargins v)
    let borderEffectRightMargins v : obj = box (DXWindowProp.BorderEffectRightMargins v)
    let borderEffectTopMargins v : obj = box (DXWindowProp.BorderEffectTopMargins v)
    let borderEffectBottomMargins v : obj = box (DXWindowProp.BorderEffectBottomMargins v)
    let borderEffectImagesUri v : obj = box (DXWindowProp.BorderEffectImagesUri v)
    let borderEffectOffset v : obj = box (DXWindowProp.BorderEffectOffset v)
    let borderEffectActiveColor v : obj = box (DXWindowProp.BorderEffectActiveColor v)
    let borderEffectInactiveColor v : obj = box (DXWindowProp.BorderEffectInactiveColor v)
    let resizeBorderThickness v : obj = box (DXWindowProp.ResizeBorderThickness v)
    let resizeBorderThicknessInAeroMode v : obj = box (DXWindowProp.ResizeBorderThicknessInAeroMode v)
    let allowSystemMenu v : obj = box (DXWindowProp.AllowSystemMenu v)

    let apply (el: DevExpress.Xpf.Core.DXWindow) (prop: DXWindowProp) =
        match prop with
        | DXWindowProp.IsDraggingOrResizing v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.IsDraggingOrResizingProperty, box v)
        | DXWindowProp.WindowTemplate v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.WindowTemplateProperty, box v)
        | DXWindowProp.AeroWindowTemplate v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.AeroWindowTemplateProperty, box v)
        | DXWindowProp.SmallIcon v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.SmallIconProperty, box v)
        | DXWindowProp.AeroBorderSize v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.AeroBorderSizeProperty, box v)
        | DXWindowProp.IsAeroMode v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.IsAeroModeProperty, box v)
        | DXWindowProp.AllowApplicationIconScaling v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.AllowApplicationIconScalingProperty, box v)
        | DXWindowProp.HeaderItemsSource v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.HeaderItemsSourceProperty, box v)
        | DXWindowProp.HeaderItemContainerStyle v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.HeaderItemContainerStyleProperty, box v)
        | DXWindowProp.HeaderItemContainerStyleSelector v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.HeaderItemContainerStyleSelectorProperty, box v)
        | DXWindowProp.HeaderItemTemplate v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.HeaderItemTemplateProperty, box v)
        | DXWindowProp.HeaderItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.HeaderItemTemplateSelectorProperty, box v)
        | DXWindowProp.BorderEffectLeftMargins v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectLeftMarginsProperty, box v)
        | DXWindowProp.BorderEffectRightMargins v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectRightMarginsProperty, box v)
        | DXWindowProp.BorderEffectTopMargins v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectTopMarginsProperty, box v)
        | DXWindowProp.BorderEffectBottomMargins v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectBottomMarginsProperty, box v)
        | DXWindowProp.BorderEffectImagesUri v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectImagesUriProperty, box v)
        | DXWindowProp.BorderEffectOffset v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectOffsetProperty, box v)
        | DXWindowProp.BorderEffectActiveColor v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectActiveColorProperty, box v)
        | DXWindowProp.BorderEffectInactiveColor v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.BorderEffectInactiveColorProperty, box v)
        | DXWindowProp.ResizeBorderThickness v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.ResizeBorderThicknessProperty, box v)
        | DXWindowProp.ResizeBorderThicknessInAeroMode v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.ResizeBorderThicknessInAeroModeProperty, box v)
        | DXWindowProp.AllowSystemMenu v -> el.SetValue(DevExpress.Xpf.Core.DXWindow.AllowSystemMenuProperty, box v)
    ...
    let showIcon (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.DXWindow.ShowIconProperty, box v)) :: node.Props }
    let showTitle (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.DXWindow.ShowTitleProperty, box v)) :: node.Props }
    let isMaximized (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.DXWindow.IsMaximizedProperty, box v)) :: node.Props }
    let isActiveEx (v: bool) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Core.DXWindow.IsActiveExProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Core.DXWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
