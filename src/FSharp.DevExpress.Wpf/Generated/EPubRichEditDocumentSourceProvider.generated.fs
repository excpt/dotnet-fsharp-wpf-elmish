...
type EPubRichEditDocumentSourceProviderProp =
    | Base of RichEditDocumentSourceProviderProp

module EPubRichEditDocumentSourceProvider =

    let apply (el: DevExpress.Xpf.RichEdit.EPubRichEditDocumentSourceProvider) (prop: EPubRichEditDocumentSourceProviderProp) =
        match prop with
        | EPubRichEditDocumentSourceProviderProp.Base p -> RichEditDocumentSourceProvider.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.EPubRichEditDocumentSourceProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
