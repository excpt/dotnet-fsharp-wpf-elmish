...
type BarManagerMenuControllerProp =
    | Base of BarManagerLinksHolderControllerProp

module BarManagerMenuController =

    let apply (el: DevExpress.Xpf.Bars.BarManagerMenuController) (prop: BarManagerMenuControllerProp) =
        match prop with
        | BarManagerMenuControllerProp.Base p -> BarManagerLinksHolderController.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.BarManagerMenuController>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
