...
type DragIconControlProp =
    | DragType of DevExpress.Xpf.Core.DragType

module DragIconControl =
    let dragType v : obj = box (DragIconControlProp.DragType v)

    let apply (el: DevExpress.Xpf.Core.DragIconControl) (prop: DragIconControlProp) =
        match prop with
        | DragIconControlProp.DragType v -> el.SetValue(DevExpress.Xpf.Core.DragIconControl.DragTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DragIconControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
