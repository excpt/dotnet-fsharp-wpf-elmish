...
type RibbonGalleryBarItemLinkControlProp =
    | Base of BarItemLinkControlProp
    | IsGalleryVisible of bool

module RibbonGalleryBarItemLinkControl =
    let isGalleryVisible v : obj = box (RibbonGalleryBarItemLinkControlProp.IsGalleryVisible v)

    let apply (el: DevExpress.Xpf.Ribbon.RibbonGalleryBarItemLinkControl) (prop: RibbonGalleryBarItemLinkControlProp) =
        match prop with
        | RibbonGalleryBarItemLinkControlProp.Base p -> BarItemLinkControl.apply el p
        | RibbonGalleryBarItemLinkControlProp.IsGalleryVisible v -> el.SetValue(DevExpress.Xpf.Ribbon.RibbonGalleryBarItemLinkControl.IsGalleryVisibleProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonGalleryBarItemLinkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
