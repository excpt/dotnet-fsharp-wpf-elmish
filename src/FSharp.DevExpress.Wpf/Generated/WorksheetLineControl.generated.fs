...
type WorksheetLineControlProp =
    | Base of WorksheetPaintControlProp
    | GridLinesColor of System.Windows.Media.Color
    | FrozenSeparatorBrush of System.Windows.Media.Brush

module WorksheetLineControl =
    let gridLinesColor v : obj = box (WorksheetLineControlProp.GridLinesColor v)
    let frozenSeparatorBrush v : obj = box (WorksheetLineControlProp.FrozenSeparatorBrush v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.WorksheetLineControl) (prop: WorksheetLineControlProp) =
        match prop with
        | WorksheetLineControlProp.Base p -> WorksheetPaintControl.apply el p
        | WorksheetLineControlProp.GridLinesColor v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetLineControl.GridLinesColorProperty, box v)
        | WorksheetLineControlProp.FrozenSeparatorBrush v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.WorksheetLineControl.FrozenSeparatorBrushProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.WorksheetLineControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
