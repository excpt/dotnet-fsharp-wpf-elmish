...
type RenderTransformPanelProp =
    | Orientation of System.Windows.Controls.Orientation
    | Dock of System.Windows.Controls.Dock

module RenderTransformPanel =
    let orientation v : obj = box (RenderTransformPanelProp.Orientation v)
    let dock v : obj = box (RenderTransformPanelProp.Dock v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.RenderTransformPanel) (prop: RenderTransformPanelProp) =
        match prop with
        | RenderTransformPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.RenderTransformPanel.OrientationProperty, box v)
        | RenderTransformPanelProp.Dock v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.RenderTransformPanel.DockProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.RenderTransformPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
