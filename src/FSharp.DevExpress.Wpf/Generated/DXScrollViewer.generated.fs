...
type DXScrollViewerProp =
    | Base of DXScrollViewerProp
    | CanMouseScroll of bool
    | ShowFlyoutOnScroll of bool

module DXScrollViewer =
    let canMouseScroll v : obj = box (DXScrollViewerProp.CanMouseScroll v)
    let showFlyoutOnScroll v : obj = box (DXScrollViewerProp.ShowFlyoutOnScroll v)

    let apply (el: DevExpress.Xpf.PdfViewer.DXScrollViewer) (prop: DXScrollViewerProp) =
        match prop with
        | DXScrollViewerProp.Base p -> DXScrollViewer.apply el p
        | DXScrollViewerProp.CanMouseScroll v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DXScrollViewer.CanMouseScrollProperty, box v)
        | DXScrollViewerProp.ShowFlyoutOnScroll v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DXScrollViewer.ShowFlyoutOnScrollProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.DXScrollViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
