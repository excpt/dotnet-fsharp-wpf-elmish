...
type RedClockThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module RedClockThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.RedClockThreeQuartersArcScaleBackgroundLayerControl) (prop: RedClockThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | RedClockThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.RedClockThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
