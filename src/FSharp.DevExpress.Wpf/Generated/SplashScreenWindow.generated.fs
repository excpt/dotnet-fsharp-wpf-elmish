...
type SplashScreenWindowProp =
    | AllowTheming of bool
    | AllowDrag of bool
    | AllowAcrylic of bool
    | FadeInDuration of System.TimeSpan
    | FadeOutDuration of System.TimeSpan
    | AcrylicColor of System.Windows.Media.Color

module SplashScreenWindow =
    let allowTheming v : obj = box (SplashScreenWindowProp.AllowTheming v)
    let allowDrag v : obj = box (SplashScreenWindowProp.AllowDrag v)
    let allowAcrylic v : obj = box (SplashScreenWindowProp.AllowAcrylic v)
    let fadeInDuration v : obj = box (SplashScreenWindowProp.FadeInDuration v)
    let fadeOutDuration v : obj = box (SplashScreenWindowProp.FadeOutDuration v)
    let acrylicColor v : obj = box (SplashScreenWindowProp.AcrylicColor v)

    let apply (el: DevExpress.Xpf.Core.SplashScreenWindow) (prop: SplashScreenWindowProp) =
        match prop with
        | SplashScreenWindowProp.AllowTheming v -> el.SetValue(DevExpress.Xpf.Core.SplashScreenWindow.AllowThemingProperty, box v)
        | SplashScreenWindowProp.AllowDrag v -> el.SetValue(DevExpress.Xpf.Core.SplashScreenWindow.AllowDragProperty, box v)
        | SplashScreenWindowProp.AllowAcrylic v -> el.SetValue(DevExpress.Xpf.Core.SplashScreenWindow.AllowAcrylicProperty, box v)
        | SplashScreenWindowProp.FadeInDuration v -> el.SetValue(DevExpress.Xpf.Core.SplashScreenWindow.FadeInDurationProperty, box v)
        | SplashScreenWindowProp.FadeOutDuration v -> el.SetValue(DevExpress.Xpf.Core.SplashScreenWindow.FadeOutDurationProperty, box v)
        | SplashScreenWindowProp.AcrylicColor v -> el.SetValue(DevExpress.Xpf.Core.SplashScreenWindow.AcrylicColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.SplashScreenWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
