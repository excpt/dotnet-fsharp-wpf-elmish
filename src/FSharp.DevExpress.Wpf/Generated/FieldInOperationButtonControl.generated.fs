...
type FieldInOperationButtonControlProp =
    | Base of XPFContentControlProp
    | Node of DevExpress.Xpf.Editors.Filtering.ClauseNode
    | OperatorName of obj
    | ColumnCaption of obj

module FieldInOperationButtonControl =
    let node v : obj = box (FieldInOperationButtonControlProp.Node v)
    let operatorName v : obj = box (FieldInOperationButtonControlProp.OperatorName v)
    let columnCaption v : obj = box (FieldInOperationButtonControlProp.ColumnCaption v)

    let apply (el: DevExpress.Xpf.Editors.Filtering.FieldInOperationButtonControl) (prop: FieldInOperationButtonControlProp) =
        match prop with
        | FieldInOperationButtonControlProp.Base p -> XPFContentControl.apply el p
        | FieldInOperationButtonControlProp.Node v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FieldInOperationButtonControl.NodeProperty, box v)
        | FieldInOperationButtonControlProp.OperatorName v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FieldInOperationButtonControl.OperatorPropertyNameProperty, box v)
        | FieldInOperationButtonControlProp.ColumnCaption v -> el.SetValue(DevExpress.Xpf.Editors.Filtering.FieldInOperationButtonControl.ColumnCaptionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.Filtering.FieldInOperationButtonControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
