...
type DiagramContainerBaseProp =
    | Base of BaseDiagramContainerProp
    | IsSnapScope of bool
    | AdjustBoundsBehavior of DevExpress.Diagram.Core.AdjustBoundaryBehavior

module DiagramContainerBase =
    ...
    let apply (el: DevExpress.Xpf.Diagram.DiagramContainerBase) (prop: DiagramContainerBaseProp) =
        match prop with
        | DiagramContainerBaseProp.Base p -> BaseDiagramContainer.apply el p
        | DiagramContainerBaseProp.IsSnapScope v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramContainerBase.IsSnapScopeProperty, box v)
        | DiagramContainerBaseProp.AdjustBoundsBehavior v -> el.SetValue(DevExpress.Xpf.Diagram.DiagramContainerBase.AdjustBoundsBehaviorProperty, box v)
