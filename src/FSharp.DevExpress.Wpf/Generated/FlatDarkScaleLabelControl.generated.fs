...
type FlatDarkScaleLabelControlProp =
    | Base of PresentationControlProp

module FlatDarkScaleLabelControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkScaleLabelControl) (prop: FlatDarkScaleLabelControlProp) =
        match prop with
        | FlatDarkScaleLabelControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkScaleLabelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
