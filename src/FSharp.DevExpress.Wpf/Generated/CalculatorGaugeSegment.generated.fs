...
type CalculatorGaugeSegmentProp =
    | Char of char
    | ShowDot of bool

module CalculatorGaugeSegment =
    let char v : obj = box (CalculatorGaugeSegmentProp.Char v)
    let showDot v : obj = box (CalculatorGaugeSegmentProp.ShowDot v)

    let apply (el: DevExpress.Xpf.Editors.CalculatorGaugeSegment) (prop: CalculatorGaugeSegmentProp) =
        match prop with
        | CalculatorGaugeSegmentProp.Char v -> el.SetValue(DevExpress.Xpf.Editors.CalculatorGaugeSegment.CharProperty, box v)
        | CalculatorGaugeSegmentProp.ShowDot v -> el.SetValue(DevExpress.Xpf.Editors.CalculatorGaugeSegment.ShowDotProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.CalculatorGaugeSegment>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
