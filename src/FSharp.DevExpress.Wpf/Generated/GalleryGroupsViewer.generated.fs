...
type GalleryGroupsViewerProp =
    | Child of DevExpress.Xpf.Bars.GalleryItemGroupsControl

module GalleryGroupsViewer =
    let child v : obj = box (GalleryGroupsViewerProp.Child v)

    let apply (el: DevExpress.Xpf.Bars.GalleryGroupsViewer) (prop: GalleryGroupsViewerProp) =
        match prop with
        | GalleryGroupsViewerProp.Child v -> el.SetValue(DevExpress.Xpf.Bars.GalleryGroupsViewer.ChildProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryGroupsViewer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
