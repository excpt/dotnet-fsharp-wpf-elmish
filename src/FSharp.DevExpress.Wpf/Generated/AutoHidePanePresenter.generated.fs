...
type AutoHidePanePresenterProp =
    | Base of psvContentControlProp
    | Win32CompatibleTemplate of System.Windows.Controls.ControlTemplate

module AutoHidePanePresenter =
    let win32CompatibleTemplate v : obj = box (AutoHidePanePresenterProp.Win32CompatibleTemplate v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.AutoHidePanePresenter) (prop: AutoHidePanePresenterProp) =
        match prop with
        | AutoHidePanePresenterProp.Base p -> psvContentControl.apply el p
        | AutoHidePanePresenterProp.Win32CompatibleTemplate v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.AutoHidePanePresenter.Win32CompatibleTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.AutoHidePanePresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
