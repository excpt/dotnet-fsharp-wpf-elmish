...
type DocumentMapProp =
    | Base of DocumentMapControlProp
    | SelectedItem of obj

module DocumentMap =
    let selectedItem v : obj = box (DocumentMapProp.SelectedItem v)

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.DocumentMap) (prop: DocumentMapProp) =
        match prop with
        | DocumentMapProp.Base p -> DocumentMapControl.apply el p
        | DocumentMapProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Printing.PreviewControl.Native.DocumentMap.SelectedItemProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.DocumentMap>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
