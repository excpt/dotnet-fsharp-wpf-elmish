...
type SmileDefaultStatePresentationControlProp =
    | Base of PresentationControlProp

module SmileDefaultStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.SmileDefaultStatePresentationControl) (prop: SmileDefaultStatePresentationControlProp) =
        match prop with
        | SmileDefaultStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmileDefaultStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
