...
type MonthCellControlProp =
    | Base of CellControlProp
    | TodayBorderThickness of float
    | TodayBorderBackground of System.Windows.Media.Brush
    | FirstDayOfYearStringFormat of string
    | FirstDayOfMonthStringFormat of string
    | DayStringFormat of string

module MonthCellControl =
    let todayBorderThickness v : obj = box (MonthCellControlProp.TodayBorderThickness v)
    let todayBorderBackground v : obj = box (MonthCellControlProp.TodayBorderBackground v)
    let firstDayOfYearStringFormat v : obj = box (MonthCellControlProp.FirstDayOfYearStringFormat v)
    let firstDayOfMonthStringFormat v : obj = box (MonthCellControlProp.FirstDayOfMonthStringFormat v)
    let dayStringFormat v : obj = box (MonthCellControlProp.DayStringFormat v)

    let apply (el: DevExpress.Xpf.Scheduling.Visual.MonthCellControl) (prop: MonthCellControlProp) =
        match prop with
        | MonthCellControlProp.Base p -> CellControl.apply el p
        | MonthCellControlProp.TodayBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthCellControl.TodayBorderThicknessProperty, box v)
        | MonthCellControlProp.TodayBorderBackground v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthCellControl.TodayBorderBackgroundProperty, box v)
        | MonthCellControlProp.FirstDayOfYearStringFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthCellControl.FirstDayOfYearStringFormatProperty, box v)
        | MonthCellControlProp.FirstDayOfMonthStringFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthCellControl.FirstDayOfMonthStringFormatProperty, box v)
        | MonthCellControlProp.DayStringFormat v -> el.SetValue(DevExpress.Xpf.Scheduling.Visual.MonthCellControl.DayStringFormatProperty, box v)

    let background v : obj = box (CellControlProp.Background v)
    let selectedBackground v : obj = box (CellControlProp.SelectedBackground v)
    let leftBorderThickness v : obj = box (CellControlProp.LeftBorderThickness v)
    let bottomBorderThickness v : obj = box (CellControlProp.BottomBorderThickness v)
    let drawDefaultBackground v : obj = box (CellControlProp.DrawDefaultBackground v)
    let drawDefaultDecoration v : obj = box (CellControlProp.DrawDefaultDecoration v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.MonthCellControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
