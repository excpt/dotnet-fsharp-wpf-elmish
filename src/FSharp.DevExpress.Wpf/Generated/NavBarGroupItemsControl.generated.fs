...
type NavBarGroupItemsControlProp =
    | ViewKind of DevExpress.Xpf.NavBar.NavBarViewKind
    | ShowViewBorder of bool
    | ItemsSourceCore of System.Collections.Specialized.INotifyCollectionChanged

module NavBarGroupItemsControl =
    let viewKind v : obj = box (NavBarGroupItemsControlProp.ViewKind v)
    let showViewBorder v : obj = box (NavBarGroupItemsControlProp.ShowViewBorder v)
    let itemsSourceCore v : obj = box (NavBarGroupItemsControlProp.ItemsSourceCore v)

    let apply (el: DevExpress.Xpf.NavBar.NavBarGroupItemsControl) (prop: NavBarGroupItemsControlProp) =
        match prop with
        | NavBarGroupItemsControlProp.ViewKind v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupItemsControl.ViewKindProperty, box v)
        | NavBarGroupItemsControlProp.ShowViewBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupItemsControl.ShowViewBorderProperty, box v)
        | NavBarGroupItemsControlProp.ItemsSourceCore v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarGroupItemsControl.ItemsSourceCoreProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarGroupItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
