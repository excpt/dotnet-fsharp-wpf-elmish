...
type TimelineAutoHeightGroupsPanelBaseProp =
...
module TimelineAutoHeightGroupsPanelBase =
    let view v : obj = box (TimelineAutoHeightGroupsPanelBaseProp.View v)
    let visualData v : obj = box (TimelineAutoHeightGroupsPanelBaseProp.VisualData v)
    let itemContainerAppointmentsContainerStyle v : obj = box (TimelineAutoHeightGroupsPanelBaseProp.ItemContainerAppointmentsContainerStyle v)
    let itemContainerDragAppointmentsContainerStyle v : obj = box (TimelineAutoHeightGroupsPanelBaseProp.ItemContainerDragAppointmentsContainerStyle v)
    let itemContainerVerticalBorderThickness v : obj = box (TimelineAutoHeightGroupsPanelBaseProp.ItemContainerVerticalBorderThickness v)
    let itemContainerHorizontalBorderThickness v : obj = box (TimelineAutoHeightGroupsPanelBaseProp.ItemContainerHorizontalBorderThickness v)

    let apply (el: DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase) (prop: TimelineAutoHeightGroupsPanelBaseProp) =
        match prop with
        | TimelineAutoHeightGroupsPanelBaseProp.View v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase.ViewProperty, box v)
        | TimelineAutoHeightGroupsPanelBaseProp.VisualData v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase.VisualDataProperty, box v)
        | TimelineAutoHeightGroupsPanelBaseProp.ItemContainerAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase.ItemContainerAppointmentsContainerStyleProperty, box v)
        | TimelineAutoHeightGroupsPanelBaseProp.ItemContainerDragAppointmentsContainerStyle v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase.ItemContainerDragAppointmentsContainerStyleProperty, box v)
        | TimelineAutoHeightGroupsPanelBaseProp.ItemContainerVerticalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase.ItemContainerVerticalBorderThicknessProperty, box v)
        | TimelineAutoHeightGroupsPanelBaseProp.ItemContainerHorizontalBorderThickness v -> el.SetValue(DevExpress.Xpf.Scheduling.Panels.TimelineAutoHeightGroupsPanelBase.ItemContainerHorizontalBorderThicknessProperty, box v)
