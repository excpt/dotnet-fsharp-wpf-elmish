...
type ImageInplaceEditorProp =
    | Base of DocumentInplaceEditorBaseProp

module ImageInplaceEditor =

    let apply (el: DevExpress.Xpf.Printing.PreviewControl.Native.Editing.ImageInplaceEditor) (prop: ImageInplaceEditorProp) =
        match prop with
        | ImageInplaceEditorProp.Base p -> DocumentInplaceEditorBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.PreviewControl.Native.Editing.ImageInplaceEditor>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
