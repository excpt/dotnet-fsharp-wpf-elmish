...
type LayoutControlItemCustomizationMenuProp =
    | Base of BaseLayoutElementMenuProp

module LayoutControlItemCustomizationMenu =

    let apply (el: DevExpress.Xpf.Docking.LayoutControlItemCustomizationMenu) (prop: LayoutControlItemCustomizationMenuProp) =
        match prop with
        | LayoutControlItemCustomizationMenuProp.Base p -> BaseLayoutElementMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.LayoutControlItemCustomizationMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
