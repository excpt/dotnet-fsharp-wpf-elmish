...
type NavBarViewBaseProp =
    ...
    | ItemsPanelTemplate of System.Windows.Controls.ItemsPanelTemplate
    | ItemsPanelOrientation of System.Windows.Controls.Orientation
    | NavBarViewKind of DevExpress.Xpf.NavBar.NavBarViewKind
    | GroupVisualStyle of System.Windows.Style
    | ItemVisualStyle of System.Windows.Style
    | GroupDisplayMode of DevExpress.Xpf.NavBar.DisplayMode
    | GroupLayoutSettings of DevExpress.Xpf.NavBar.LayoutSettings
    | GroupImageSettings of DevExpress.Xpf.NavBar.ImageSettings
    | ItemDisplayMode of DevExpress.Xpf.NavBar.DisplayMode
    | ItemLayoutSettings of DevExpress.Xpf.NavBar.LayoutSettings
    | ItemImageSettings of DevExpress.Xpf.NavBar.ImageSettings
    | GroupFontSettings of DevExpress.Xpf.NavBar.FontSettings
    | ItemFontSettings of DevExpress.Xpf.NavBar.FontSettings
    | GroupHeaderTemplate of System.Windows.Controls.ControlTemplate
    | AnimateGroupExpansion of bool
    | ItemForeground of System.Windows.Media.Brush
    | OnItemSelecting of DevExpress.Xpf.NavBar.NavBarItemSelectingEventHandler
    | OnItemSelected of DevExpress.Xpf.NavBar.NavBarItemSelectedEventHandler
    | OnActiveGroupChanging of DevExpress.Xpf.NavBar.NavBarActiveGroupChangingEventHandler
    | OnActiveGroupChanged of DevExpress.Xpf.NavBar.NavBarActiveGroupChangedEventHandler
    | OnClick of System.Windows.RoutedEventHandler

module NavBarViewBase =
    ...
    let apply (el: DevExpress.Xpf.NavBar.NavBarViewBase) (prop: NavBarViewBaseProp) =
        match prop with
        | NavBarViewBaseProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ShowBorderProperty, box v)
        | NavBarViewBaseProp.HeaderTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.HeaderTemplateProperty, box v)
        | NavBarViewBaseProp.ItemTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemTemplateProperty, box v)
        | NavBarViewBaseProp.ItemControlTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemControlTemplateProperty, box v)
        | NavBarViewBaseProp.HeaderTemplateSelector v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.HeaderTemplateSelectorProperty, box v)
        | NavBarViewBaseProp.ItemTemplateSelector v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemTemplateSelectorProperty, box v)
        | NavBarViewBaseProp.Orientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.OrientationProperty, box v)
        | NavBarViewBaseProp.ItemsPanelTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemsPanelTemplateProperty, box v)
        | NavBarViewBaseProp.ItemsPanelOrientation v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemsPanelOrientationProperty, box v)
        | NavBarViewBaseProp.NavBarViewKind v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.NavBarViewKindProperty, box v)
        | NavBarViewBaseProp.GroupVisualStyle v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.GroupVisualStyleProperty, box v)
        | NavBarViewBaseProp.ItemVisualStyle v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemVisualStyleProperty, box v)
        | NavBarViewBaseProp.GroupDisplayMode v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.GroupDisplayModeProperty, box v)
        | NavBarViewBaseProp.GroupLayoutSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.GroupLayoutSettingsProperty, box v)
        | NavBarViewBaseProp.GroupImageSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.GroupImageSettingsProperty, box v)
        | NavBarViewBaseProp.ItemDisplayMode v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemDisplayModeProperty, box v)
        | NavBarViewBaseProp.ItemLayoutSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemLayoutSettingsProperty, box v)
        | NavBarViewBaseProp.ItemImageSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemImageSettingsProperty, box v)
        | NavBarViewBaseProp.GroupFontSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.GroupFontSettingsProperty, box v)
        | NavBarViewBaseProp.ItemFontSettings v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemFontSettingsProperty, box v)
        | NavBarViewBaseProp.GroupHeaderTemplate v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.GroupHeaderTemplateProperty, box v)
        | NavBarViewBaseProp.AnimateGroupExpansion v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.AnimateGroupExpansionProperty, box v)
        | NavBarViewBaseProp.ItemForeground v -> el.SetValue(DevExpress.Xpf.NavBar.NavBarViewBase.ItemForegroundProperty, box v)
        | NavBarViewBaseProp.OnItemSelecting h -> el.ItemSelecting.AddHandler(h)
        | NavBarViewBaseProp.OnItemSelected h -> el.ItemSelected.AddHandler(h)
        | NavBarViewBaseProp.OnActiveGroupChanging h -> el.ActiveGroupChanging.AddHandler(h)
        | NavBarViewBaseProp.OnActiveGroupChanged h -> el.ActiveGroupChanged.AddHandler(h)
        | NavBarViewBaseProp.OnClick h -> el.Click.AddHandler(h)
    ...
    let imageSettings (v: DevExpress.Xpf.NavBar.ImageSettings) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.NavBar.NavBarViewBase.ImageSettingsProperty, box v)) :: node.Props }
    let layoutSettings (v: DevExpress.Xpf.NavBar.LayoutSettings) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.NavBar.NavBarViewBase.LayoutSettingsProperty, box v)) :: node.Props }
    let displayMode (v: DevExpress.Xpf.NavBar.DisplayMode) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.NavBar.NavBarViewBase.DisplayModeProperty, box v)) :: node.Props }
    let fontSettings (v: DevExpress.Xpf.NavBar.FontSettings) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.NavBar.NavBarViewBase.FontSettingsProperty, box v)) :: node.Props }
