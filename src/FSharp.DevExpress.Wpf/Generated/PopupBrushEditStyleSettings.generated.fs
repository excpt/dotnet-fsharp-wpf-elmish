...
type PopupBrushEditStyleSettingsProp =
    | Base of PopupBrushEditStyleSettingsBaseProp

module PopupBrushEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.PopupBrushEditStyleSettings) (prop: PopupBrushEditStyleSettingsProp) =
        match prop with
        | PopupBrushEditStyleSettingsProp.Base p -> PopupBrushEditStyleSettingsBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.PopupBrushEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
