...
type LayoutElementPresentationProp =
    | Base of ChartContentPresenterProp

module LayoutElementPresentation =

    let apply (el: DevExpress.Xpf.Charts.LayoutElementPresentation) (prop: LayoutElementPresentationProp) =
        match prop with
        | LayoutElementPresentationProp.Base p -> ChartContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.LayoutElementPresentation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
