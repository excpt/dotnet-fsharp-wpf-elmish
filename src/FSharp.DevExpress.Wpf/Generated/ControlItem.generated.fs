...
type ControlItemProp =
    | Base of psvHeaderedContentControlProp

module ControlItem =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.ControlItem) (prop: ControlItemProp) =
        match prop with
        | ControlItemProp.Base p -> psvHeaderedContentControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.ControlItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
