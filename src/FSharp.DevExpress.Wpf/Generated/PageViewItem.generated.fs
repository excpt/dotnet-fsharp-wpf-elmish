...
type PageViewItemProp =
    | Base of veHeaderedContentSelectorItemProp

module PageViewItem =

    let apply (el: DevExpress.Xpf.WindowsUI.PageViewItem) (prop: PageViewItemProp) =
        match prop with
        | PageViewItemProp.Base p -> veHeaderedContentSelectorItem.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.PageViewItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
