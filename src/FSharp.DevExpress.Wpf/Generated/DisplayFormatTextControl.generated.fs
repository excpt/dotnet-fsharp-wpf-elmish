...
type DisplayFormatTextControlProp =
    | Prefix of string
    | Suffix of string
    | DisplayFormatSourceCollection of System.ComponentModel.ICollectionView
    | ExampleText of string

module DisplayFormatTextControl =
    let prefix v : obj = box (DisplayFormatTextControlProp.Prefix v)
    let suffix v : obj = box (DisplayFormatTextControlProp.Suffix v)
    let displayFormatSourceCollection v : obj = box (DisplayFormatTextControlProp.DisplayFormatSourceCollection v)
    let exampleText v : obj = box (DisplayFormatTextControlProp.ExampleText v)

    let apply (el: DevExpress.Xpf.Core.DisplayFormatTextControl) (prop: DisplayFormatTextControlProp) =
        match prop with
        | DisplayFormatTextControlProp.Prefix v -> el.SetValue(DevExpress.Xpf.Core.DisplayFormatTextControl.PrefixProperty, box v)
        | DisplayFormatTextControlProp.Suffix v -> el.SetValue(DevExpress.Xpf.Core.DisplayFormatTextControl.SuffixProperty, box v)
        | DisplayFormatTextControlProp.DisplayFormatSourceCollection v -> el.SetValue(DevExpress.Xpf.Core.DisplayFormatTextControl.DisplayFormatSourceCollectionProperty, box v)
        | DisplayFormatTextControlProp.ExampleText v -> el.SetValue(DevExpress.Xpf.Core.DisplayFormatTextControl.ExampleTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DisplayFormatTextControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
