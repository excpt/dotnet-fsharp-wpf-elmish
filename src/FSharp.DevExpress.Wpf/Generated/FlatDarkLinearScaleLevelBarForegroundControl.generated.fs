...
type FlatDarkLinearScaleLevelBarForegroundControlProp =
    | Base of PresentationControlProp

module FlatDarkLinearScaleLevelBarForegroundControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkLinearScaleLevelBarForegroundControl) (prop: FlatDarkLinearScaleLevelBarForegroundControlProp) =
        match prop with
        | FlatDarkLinearScaleLevelBarForegroundControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkLinearScaleLevelBarForegroundControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
