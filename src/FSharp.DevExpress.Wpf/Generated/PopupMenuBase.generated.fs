...
type PopupMenuBaseProp =
    | Base of BarPopupExpandableProp
...
module PopupMenuBase =
    ...
    let apply (el: DevExpress.Xpf.Bars.PopupMenuBase) (prop: PopupMenuBaseProp) =
        match prop with
        | PopupMenuBaseProp.Base p -> BarPopupExpandable.apply el p
        | PopupMenuBaseProp.ItemsDisplayMode v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuBase.ItemsDisplayModeProperty, box v)
        | PopupMenuBaseProp.StretchRows v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuBase.StretchRowsProperty, box v)
        | PopupMenuBaseProp.MaxRowCount v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuBase.MaxRowCountProperty, box v)
        | PopupMenuBaseProp.MultiColumn v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuBase.MultiColumnProperty, box v)
        | PopupMenuBaseProp.MaxColumnHeight v -> el.SetValue(DevExpress.Xpf.Bars.PopupMenuBase.MaxColumnHeightProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.PopupMenuBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
