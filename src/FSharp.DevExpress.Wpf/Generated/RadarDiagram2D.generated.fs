...
type RadarDiagram2DProp =
    | Base of CircularDiagram2DProp
    | AxisX of DevExpress.Xpf.Charts.RadarAxisX2D
    | AxisY of DevExpress.Xpf.Charts.RadarAxisY2D

module RadarDiagram2D =
    let axisX v : obj = box (RadarDiagram2DProp.AxisX v)
    let axisY v : obj = box (RadarDiagram2DProp.AxisY v)

    let apply (el: DevExpress.Xpf.Charts.RadarDiagram2D) (prop: RadarDiagram2DProp) =
        match prop with
        | RadarDiagram2DProp.Base p -> CircularDiagram2D.apply el p
        | RadarDiagram2DProp.AxisX v -> el.SetValue(DevExpress.Xpf.Charts.RadarDiagram2D.AxisXProperty, box v)
        | RadarDiagram2DProp.AxisY v -> el.SetValue(DevExpress.Xpf.Charts.RadarDiagram2D.AxisYProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.RadarDiagram2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
