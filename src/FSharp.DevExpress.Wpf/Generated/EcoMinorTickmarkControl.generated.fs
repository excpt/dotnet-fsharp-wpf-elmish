...
type EcoMinorTickmarkControlProp =
    | Base of PresentationControlProp

module EcoMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoMinorTickmarkControl) (prop: EcoMinorTickmarkControlProp) =
        match prop with
        | EcoMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
