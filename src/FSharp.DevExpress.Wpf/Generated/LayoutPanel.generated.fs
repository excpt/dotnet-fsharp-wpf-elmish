...
type LayoutPanelProp =
    | Base of ContentItemProp
    ...
    | ShowBorder of bool
    | AllowDockToDocumentGroup of bool
    | TabBackgroundColor of System.Windows.Media.Color
    | AutoHidden of bool
    | AutoHideExpandState of DevExpress.Xpf.Docking.Base.AutoHideExpandState
    | ShowHideButton of bool
    | ShowExpandButton of bool
    | ShowCollapseButton of bool
    | ShowInDocumentSelector of bool

module LayoutPanel =
    let horizontalScrollBarVisibility v : obj = box (LayoutPanelProp.HorizontalScrollBarVisibility v)
    let verticalScrollBarVisibility v : obj = box (LayoutPanelProp.VerticalScrollBarVisibility v)
    let showBorder v : obj = box (LayoutPanelProp.ShowBorder v)
    let allowDockToDocumentGroup v : obj = box (LayoutPanelProp.AllowDockToDocumentGroup v)
    let tabBackgroundColor v : obj = box (LayoutPanelProp.TabBackgroundColor v)
    let autoHidden v : obj = box (LayoutPanelProp.AutoHidden v)
    let autoHideExpandState v : obj = box (LayoutPanelProp.AutoHideExpandState v)
    let showHideButton v : obj = box (LayoutPanelProp.ShowHideButton v)
    let showExpandButton v : obj = box (LayoutPanelProp.ShowExpandButton v)
    let showCollapseButton v : obj = box (LayoutPanelProp.ShowCollapseButton v)
    let showInDocumentSelector v : obj = box (LayoutPanelProp.ShowInDocumentSelector v)

    let apply (el: DevExpress.Xpf.Docking.LayoutPanel) (prop: LayoutPanelProp) =
        match prop with
        | LayoutPanelProp.Base p -> ContentItem.apply el p
        | LayoutPanelProp.HorizontalScrollBarVisibility v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.HorizontalScrollBarVisibilityProperty, box v)
        | LayoutPanelProp.VerticalScrollBarVisibility v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.VerticalScrollBarVisibilityProperty, box v)
        | LayoutPanelProp.ShowBorder v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.ShowBorderProperty, box v)
        | LayoutPanelProp.AllowDockToDocumentGroup v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.AllowDockToDocumentGroupProperty, box v)
        | LayoutPanelProp.TabBackgroundColor v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.TabBackgroundColorProperty, box v)
        | LayoutPanelProp.AutoHidden v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.AutoHiddenProperty, box v)
        | LayoutPanelProp.AutoHideExpandState v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.AutoHideExpandStateProperty, box v)
        | LayoutPanelProp.ShowHideButton v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.ShowHideButtonProperty, box v)
        | LayoutPanelProp.ShowExpandButton v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.ShowExpandButtonProperty, box v)
        | LayoutPanelProp.ShowCollapseButton v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.ShowCollapseButtonProperty, box v)
        | LayoutPanelProp.ShowInDocumentSelector v -> el.SetValue(DevExpress.Xpf.Docking.LayoutPanel.ShowInDocumentSelectorProperty, box v)
    ...
    let mDIMergeStyle (v: DevExpress.Xpf.Bars.MDIMergeStyle) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Docking.LayoutPanel.MDIMergeStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Docking.LayoutPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
