...
type IStyleThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module IStyleThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.IStyleThreeQuartersArcScaleBackgroundLayerControl) (prop: IStyleThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | IStyleThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.IStyleThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
