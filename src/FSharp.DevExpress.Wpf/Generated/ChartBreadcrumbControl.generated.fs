...
type ChartBreadcrumbControlProp =
    | ItemsSource of System.Collections.IEnumerable

module ChartBreadcrumbControl =
    let itemsSource v : obj = box (ChartBreadcrumbControlProp.ItemsSource v)

    let apply (el: DevExpress.Xpf.Charts.ChartBreadcrumbControl) (prop: ChartBreadcrumbControlProp) =
        match prop with
        | ChartBreadcrumbControlProp.ItemsSource v -> el.SetValue(DevExpress.Xpf.Charts.ChartBreadcrumbControl.ItemsSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.ChartBreadcrumbControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
