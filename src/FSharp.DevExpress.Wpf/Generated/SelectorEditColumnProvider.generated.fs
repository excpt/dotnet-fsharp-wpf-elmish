...
type SelectorEditColumnProviderProp =
    | OwnerEdit of DevExpress.Xpf.Editors.Internal.ISelectorEdit
    | AllowFilter of bool
    | CustomColumns of obj
    | ItemsSourceType of System.Type

module SelectorEditColumnProvider =
    let ownerEdit v : obj = box (SelectorEditColumnProviderProp.OwnerEdit v)
    let allowFilter v : obj = box (SelectorEditColumnProviderProp.AllowFilter v)
    let customColumns v : obj = box (SelectorEditColumnProviderProp.CustomColumns v)
    let itemsSourceType v : obj = box (SelectorEditColumnProviderProp.ItemsSourceType v)

    let apply (el: DevExpress.Xpf.Editors.SelectorEditColumnProvider) (prop: SelectorEditColumnProviderProp) =
        match prop with
        | SelectorEditColumnProviderProp.OwnerEdit v -> el.SetValue(DevExpress.Xpf.Editors.SelectorEditColumnProvider.OwnerEditProperty, box v)
        | SelectorEditColumnProviderProp.AllowFilter v -> el.SetValue(DevExpress.Xpf.Editors.SelectorEditColumnProvider.AllowFilterProperty, box v)
        | SelectorEditColumnProviderProp.CustomColumns v -> el.SetValue(DevExpress.Xpf.Editors.SelectorEditColumnProvider.CustomColumnsProperty, box v)
        | SelectorEditColumnProviderProp.ItemsSourceType v -> el.SetValue(DevExpress.Xpf.Editors.SelectorEditColumnProvider.ItemsSourceTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.SelectorEditColumnProvider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
