...
type SymbologyBaseProp =
    | Base of DXFrameworkElementProp

module SymbologyBase =

    let apply (el: DevExpress.Xpf.Controls.SymbologyBase) (prop: SymbologyBaseProp) =
        match prop with
        | SymbologyBaseProp.Base p -> DXFrameworkElement.apply el p
