...
type RibbonPopupBorderControlProp =
    | Base of PopupBorderControlProp

module RibbonPopupBorderControl =

    let apply (el: DevExpress.Xpf.Ribbon.RibbonPopupBorderControl) (prop: RibbonPopupBorderControlProp) =
        match prop with
        | RibbonPopupBorderControlProp.Base p -> PopupBorderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.RibbonPopupBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
