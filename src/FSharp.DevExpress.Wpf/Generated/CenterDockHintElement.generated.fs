...
type CenterDockHintElementProp =
    | Base of DockHintElementProp
    | DockHintsVisibility of System.Windows.Visibility
    | TabHintsVisibility of System.Windows.Visibility

module CenterDockHintElement =
    let dockHintsVisibility v : obj = box (CenterDockHintElementProp.DockHintsVisibility v)
    let tabHintsVisibility v : obj = box (CenterDockHintElementProp.TabHintsVisibility v)

    let apply (el: DevExpress.Xpf.Docking.Platform.CenterDockHintElement) (prop: CenterDockHintElementProp) =
        match prop with
        | CenterDockHintElementProp.Base p -> DockHintElement.apply el p
        | CenterDockHintElementProp.DockHintsVisibility v -> el.SetValue(DevExpress.Xpf.Docking.Platform.CenterDockHintElement.DockHintsVisibilityProperty, box v)
        | CenterDockHintElementProp.TabHintsVisibility v -> el.SetValue(DevExpress.Xpf.Docking.Platform.CenterDockHintElement.TabHintsVisibilityProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.Platform.CenterDockHintElement>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
