...
type FlatDarkArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkArcScaleBackgroundLayerControl) (prop: FlatDarkArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatDarkArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
