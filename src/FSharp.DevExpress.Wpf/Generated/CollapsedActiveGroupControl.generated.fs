...
type CollapsedActiveGroupControlProp =
    | ShowMode of DevExpress.Xpf.NavBar.ShowMode
    | Items of System.Windows.Controls.ItemsControl
    | DefaultItem of System.Windows.Controls.Control
    | DefaultIsChecked of bool
    | Group of DevExpress.Xpf.NavBar.NavBarGroup
    | CollapsedNavPaneItemsSource of obj

module CollapsedActiveGroupControl =
    let showMode v : obj = box (CollapsedActiveGroupControlProp.ShowMode v)
    let items v : obj = box (CollapsedActiveGroupControlProp.Items v)
    let defaultItem v : obj = box (CollapsedActiveGroupControlProp.DefaultItem v)
    let defaultIsChecked v : obj = box (CollapsedActiveGroupControlProp.DefaultIsChecked v)
    let group v : obj = box (CollapsedActiveGroupControlProp.Group v)
    let collapsedNavPaneItemsSource v : obj = box (CollapsedActiveGroupControlProp.CollapsedNavPaneItemsSource v)

    let apply (el: DevExpress.Xpf.NavBar.CollapsedActiveGroupControl) (prop: CollapsedActiveGroupControlProp) =
        match prop with
        | CollapsedActiveGroupControlProp.ShowMode v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupControl.ShowModeProperty, box v)
        | CollapsedActiveGroupControlProp.Items v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupControl.ItemsProperty, box v)
        | CollapsedActiveGroupControlProp.DefaultItem v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupControl.DefaultItemProperty, box v)
        | CollapsedActiveGroupControlProp.DefaultIsChecked v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupControl.DefaultIsCheckedProperty, box v)
        | CollapsedActiveGroupControlProp.Group v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupControl.GroupProperty, box v)
        | CollapsedActiveGroupControlProp.CollapsedNavPaneItemsSource v -> el.SetValue(DevExpress.Xpf.NavBar.CollapsedActiveGroupControl.CollapsedNavPaneItemsSourceProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.CollapsedActiveGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
