...
type TimeRulerCellHourPresenterProp =
    | Base of FastTextBlockProp

module TimeRulerCellHourPresenter =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimeRulerCellHourPresenter) (prop: TimeRulerCellHourPresenterProp) =
        match prop with
        | TimeRulerCellHourPresenterProp.Base p -> FastTextBlock.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimeRulerCellHourPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
