...
type DetailRowContentPresenterProp =
    | MasterRowData of DevExpress.Xpf.Grid.RowData

module DetailRowContentPresenter =
    let masterRowData v : obj = box (DetailRowContentPresenterProp.MasterRowData v)

    let apply (el: DevExpress.Xpf.Grid.DetailRowContentPresenter) (prop: DetailRowContentPresenterProp) =
        match prop with
        | DetailRowContentPresenterProp.MasterRowData v -> el.SetValue(DevExpress.Xpf.Grid.DetailRowContentPresenter.MasterRowDataProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.DetailRowContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
