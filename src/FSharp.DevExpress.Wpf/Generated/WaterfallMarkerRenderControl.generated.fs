...
type WaterfallMarkerRenderControlProp =
    | Base of BarMarkerRenderControlProp

module WaterfallMarkerRenderControl =

    let apply (el: DevExpress.Xpf.Charts.WaterfallMarkerRenderControl) (prop: WaterfallMarkerRenderControlProp) =
        match prop with
        | WaterfallMarkerRenderControlProp.Base p -> BarMarkerRenderControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.WaterfallMarkerRenderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
