...
type Diagram3DZoomActionProp =
    | Base of Diagram3DAnimationActionProp
    | FinalZoomPercent of float

module Diagram3DZoomAction =
    let finalZoomPercent v : obj = box (Diagram3DZoomActionProp.FinalZoomPercent v)

    let apply (el: DevExpress.Xpf.Charts.Diagram3DZoomAction) (prop: Diagram3DZoomActionProp) =
        match prop with
        | Diagram3DZoomActionProp.Base p -> Diagram3DAnimationAction.apply el p
        | Diagram3DZoomActionProp.FinalZoomPercent v -> el.SetValue(DevExpress.Xpf.Charts.Diagram3DZoomAction.FinalZoomPercentProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.Diagram3DZoomAction>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
