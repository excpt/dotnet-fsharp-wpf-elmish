...
open System
open System.Windows
open DevExpress.Xpf.Navigation.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type TileButtonControlProp =
    | Base of veContentContainerProp
    | Glyph of System.Windows.Media.ImageSource
    | HorizontalGlyphAlignment of System.Windows.HorizontalAlignment
    | VerticalGlyphAlignment of System.Windows.VerticalAlignment
    | AllowGlyphTheming of bool
    | GlyphColor of System.Windows.Media.Color

module TileButtonControl =
    let glyph v : obj = box (TileButtonControlProp.Glyph v)
    let horizontalGlyphAlignment v : obj = box (TileButtonControlProp.HorizontalGlyphAlignment v)
    let verticalGlyphAlignment v : obj = box (TileButtonControlProp.VerticalGlyphAlignment v)
    let allowGlyphTheming v : obj = box (TileButtonControlProp.AllowGlyphTheming v)
    let glyphColor v : obj = box (TileButtonControlProp.GlyphColor v)

    let apply (el: DevExpress.Xpf.Navigation.Internal.TileButtonControl) (prop: TileButtonControlProp) =
        match prop with
        | TileButtonControlProp.Base p -> veContentContainer.apply el p
        | TileButtonControlProp.Glyph v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.TileButtonControl.GlyphProperty, box v)
        | TileButtonControlProp.HorizontalGlyphAlignment v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.TileButtonControl.HorizontalGlyphAlignmentProperty, box v)
        | TileButtonControlProp.VerticalGlyphAlignment v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.TileButtonControl.VerticalGlyphAlignmentProperty, box v)
        | TileButtonControlProp.AllowGlyphTheming v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.TileButtonControl.AllowGlyphThemingProperty, box v)
        | TileButtonControlProp.GlyphColor v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.TileButtonControl.GlyphColorProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.TileButtonControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
