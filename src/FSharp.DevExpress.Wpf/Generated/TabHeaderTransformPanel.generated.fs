...
type TabHeaderTransformPanelProp =
    | Base of LayoutTransformPanelProp
    | CaptionLocation of DevExpress.Xpf.Docking.CaptionLocation
    | CaptionOrientation of System.Windows.Controls.Orientation

module TabHeaderTransformPanel =
    let captionLocation v : obj = box (TabHeaderTransformPanelProp.CaptionLocation v)
    let captionOrientation v : obj = box (TabHeaderTransformPanelProp.CaptionOrientation v)

    let apply (el: DevExpress.Xpf.Docking.VisualElements.TabHeaderTransformPanel) (prop: TabHeaderTransformPanelProp) =
        match prop with
        | TabHeaderTransformPanelProp.Base p -> LayoutTransformPanel.apply el p
        | TabHeaderTransformPanelProp.CaptionLocation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderTransformPanel.CaptionLocationProperty, box v)
        | TabHeaderTransformPanelProp.CaptionOrientation v -> el.SetValue(DevExpress.Xpf.Docking.VisualElements.TabHeaderTransformPanel.CaptionOrientationProperty, box v)

    let clockwise v : obj = box (LayoutTransformPanelProp.Clockwise v)
    let orientation v : obj = box (LayoutTransformPanelProp.Orientation v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.TabHeaderTransformPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
