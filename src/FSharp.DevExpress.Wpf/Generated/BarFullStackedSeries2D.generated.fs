...
type BarFullStackedSeries2DProp =
    | Base of BarStackedSeries2DProp

module BarFullStackedSeries2D =

    let apply (el: DevExpress.Xpf.Charts.BarFullStackedSeries2D) (prop: BarFullStackedSeries2DProp) =
        match prop with
        | BarFullStackedSeries2DProp.Base p -> BarStackedSeries2D.apply el p
    ...
    let percentOptions (v: DevExpress.Xpf.Charts.PercentOptions) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.Xpf.Charts.BarFullStackedSeries2D.PercentOptionsProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.Xpf.Charts.BarFullStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
