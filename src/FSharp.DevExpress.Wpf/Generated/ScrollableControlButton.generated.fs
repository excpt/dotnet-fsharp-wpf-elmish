...
type ScrollableControlButtonProp =
    | Base of DirectionButtonProp
    | ColorMode of DevExpress.Xpf.Controls.Primitives.ScrollButtonColorMode

module ScrollableControlButton =
    let colorMode v : obj = box (ScrollableControlButtonProp.ColorMode v)

    let apply (el: DevExpress.Xpf.Controls.Primitives.ScrollableControlButton) (prop: ScrollableControlButtonProp) =
        match prop with
        | ScrollableControlButtonProp.Base p -> DirectionButton.apply el p
        | ScrollableControlButtonProp.ColorMode v -> el.SetValue(DevExpress.Xpf.Controls.Primitives.ScrollableControlButton.ColorModeProperty, box v)

    let direction v : obj = box (DirectionButtonProp.Direction v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.Primitives.ScrollableControlButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
