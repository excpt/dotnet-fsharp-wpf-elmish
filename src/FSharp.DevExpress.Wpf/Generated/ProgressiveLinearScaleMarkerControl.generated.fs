...
type ProgressiveLinearScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module ProgressiveLinearScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.ProgressiveLinearScaleMarkerControl) (prop: ProgressiveLinearScaleMarkerControlProp) =
        match prop with
        | ProgressiveLinearScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ProgressiveLinearScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
