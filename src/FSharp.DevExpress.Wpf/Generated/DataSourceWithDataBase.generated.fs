...
type DataSourceWithDataBaseProp =
    | Base of SimpleDataSourceBaseProp
    | Data of obj

module DataSourceWithDataBase =
    let data v : obj = box (DataSourceWithDataBaseProp.Data v)

    let apply (el: DevExpress.Xpf.Core.DataSources.DataSourceWithDataBase) (prop: DataSourceWithDataBaseProp) =
        match prop with
        | DataSourceWithDataBaseProp.Base p -> SimpleDataSourceBase.apply el p
        | DataSourceWithDataBaseProp.Data v -> el.SetValue(DevExpress.Xpf.Core.DataSources.DataSourceWithDataBase.DataProperty, box v)
