...
type FloatingWindowContainerProp =
    | Base of FloatingContainerProp

module FloatingWindowContainer =

    let apply (el: DevExpress.Xpf.Core.FloatingWindowContainer) (prop: FloatingWindowContainerProp) =
        match prop with
        | FloatingWindowContainerProp.Base p -> FloatingContainer.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.FloatingWindowContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
