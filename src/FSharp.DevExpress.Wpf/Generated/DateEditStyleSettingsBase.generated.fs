...
type DateEditStyleSettingsBaseProp =
    | Base of PopupBaseEditStyleSettingsProp
    | GlyphKind of obj

module DateEditStyleSettingsBase =
    let glyphKind v : obj = box (DateEditStyleSettingsBaseProp.GlyphKind v)

    let apply (el: DevExpress.Xpf.Editors.DateEditStyleSettingsBase) (prop: DateEditStyleSettingsBaseProp) =
        match prop with
        | DateEditStyleSettingsBaseProp.Base p -> PopupBaseEditStyleSettings.apply el p
        | DateEditStyleSettingsBaseProp.GlyphKind v -> el.SetValue(DevExpress.Xpf.Editors.DateEditStyleSettingsBase.GlyphKindProperty, box v)
