...
type PdfOutlinesViewerControlProp =
    | Base of DocumentMapControlProp

module PdfOutlinesViewerControl =

    let apply (el: DevExpress.Xpf.PdfViewer.PdfOutlinesViewerControl) (prop: PdfOutlinesViewerControlProp) =
        match prop with
        | PdfOutlinesViewerControlProp.Base p -> DocumentMapControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PdfViewer.PdfOutlinesViewerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
