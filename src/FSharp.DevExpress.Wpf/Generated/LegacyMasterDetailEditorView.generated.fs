...
type LegacyMasterDetailEditorViewProp =
    | Base of MasterDetailEditorViewBaseProp

module LegacyMasterDetailEditorView =

    let apply (el: DevExpress.Xpf.DataAccess.Native.Editors.LegacyMasterDetailEditorView) (prop: LegacyMasterDetailEditorViewProp) =
        match prop with
        | LegacyMasterDetailEditorViewProp.Base p -> MasterDetailEditorViewBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.DataAccess.Native.Editors.LegacyMasterDetailEditorView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
