...
type LinqPlinqServerModeDataSourceProp =
    | Base of PLinqServerModeDataSourceBaseProp

module LinqPlinqServerModeDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.LinqPlinqServerModeDataSource) (prop: LinqPlinqServerModeDataSourceProp) =
        match prop with
        | LinqPlinqServerModeDataSourceProp.Base p -> PLinqServerModeDataSourceBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.LinqPlinqServerModeDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
