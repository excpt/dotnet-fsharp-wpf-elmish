...
type NavBarPopupMenuProp =
    | Base of PopupMenuProp

module NavBarPopupMenu =

    let apply (el: DevExpress.Xpf.NavBar.NavBarPopupMenu) (prop: NavBarPopupMenuProp) =
        match prop with
        | NavBarPopupMenuProp.Base p -> PopupMenu.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.NavBarPopupMenu>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
