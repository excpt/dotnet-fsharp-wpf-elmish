...
type ItemBorderControlProp =
    | HideBorderSide of DevExpress.Xpf.Bars.HideBorderSide
    | ArrowHideBorderSide of DevExpress.Xpf.Bars.HideBorderSide
    | IsActive of bool
    | State of DevExpress.Xpf.Bars.BorderState
    | LinkControl of DevExpress.Xpf.Bars.BarItemLinkControl
    | ItemPosition of DevExpress.Xpf.Bars.HorizontalItemPositionType
    | NormalTemplate of System.Windows.Controls.ControlTemplate
    | HoverTemplate of System.Windows.Controls.ControlTemplate
    | PressedTemplate of System.Windows.Controls.ControlTemplate
    | CustomizationTemplate of System.Windows.Controls.ControlTemplate

module ItemBorderControl =
    let hideBorderSide v : obj = box (ItemBorderControlProp.HideBorderSide v)
    let arrowHideBorderSide v : obj = box (ItemBorderControlProp.ArrowHideBorderSide v)
    let isActive v : obj = box (ItemBorderControlProp.IsActive v)
    let state v : obj = box (ItemBorderControlProp.State v)
    let linkControl v : obj = box (ItemBorderControlProp.LinkControl v)
    let itemPosition v : obj = box (ItemBorderControlProp.ItemPosition v)
    let normalTemplate v : obj = box (ItemBorderControlProp.NormalTemplate v)
    let hoverTemplate v : obj = box (ItemBorderControlProp.HoverTemplate v)
    let pressedTemplate v : obj = box (ItemBorderControlProp.PressedTemplate v)
    let customizationTemplate v : obj = box (ItemBorderControlProp.CustomizationTemplate v)

    let apply (el: DevExpress.Xpf.Bars.ItemBorderControl) (prop: ItemBorderControlProp) =
        match prop with
        | ItemBorderControlProp.HideBorderSide v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.HideBorderSideProperty, box v)
        | ItemBorderControlProp.ArrowHideBorderSide v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.ArrowHideBorderSideProperty, box v)
        | ItemBorderControlProp.IsActive v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.IsActiveProperty, box v)
        | ItemBorderControlProp.State v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.StateProperty, box v)
        | ItemBorderControlProp.LinkControl v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.LinkControlProperty, box v)
        | ItemBorderControlProp.ItemPosition v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.ItemPositionProperty, box v)
        | ItemBorderControlProp.NormalTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.NormalTemplateProperty, box v)
        | ItemBorderControlProp.HoverTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.HoverTemplateProperty, box v)
        | ItemBorderControlProp.PressedTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.PressedTemplateProperty, box v)
        | ItemBorderControlProp.CustomizationTemplate v -> el.SetValue(DevExpress.Xpf.Bars.ItemBorderControl.CustomizationTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.ItemBorderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
