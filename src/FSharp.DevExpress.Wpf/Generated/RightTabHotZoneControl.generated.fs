...
type RightTabHotZoneControlProp =
    | Base of HorizontalHotZoneControlProp

module RightTabHotZoneControl =

    let apply (el: DevExpress.Xpf.RichEdit.Controls.Internal.RightTabHotZoneControl) (prop: RightTabHotZoneControlProp) =
        match prop with
        | RightTabHotZoneControlProp.Base p -> HorizontalHotZoneControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.RichEdit.Controls.Internal.RightTabHotZoneControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
