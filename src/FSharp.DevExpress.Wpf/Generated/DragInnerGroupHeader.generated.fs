...
type DragInnerGroupHeaderProp =
    | Base of DragFieldHeaderProp

module DragInnerGroupHeader =

    let apply (el: DevExpress.Xpf.PivotGrid.Internal.DragInnerGroupHeader) (prop: DragInnerGroupHeaderProp) =
        match prop with
        | DragInnerGroupHeaderProp.Base p -> DragFieldHeader.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.PivotGrid.Internal.DragInnerGroupHeader>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
