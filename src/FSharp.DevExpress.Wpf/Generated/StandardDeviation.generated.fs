...
type StandardDeviationProp =
    | Base of SeparatePaneIndicatorWithPointsProp
    | ValueLevel of DevExpress.Xpf.Charts.ValueLevel
    | PointsCount of int

module StandardDeviation =
    let valueLevel v : obj = box (StandardDeviationProp.ValueLevel v)
    let pointsCount v : obj = box (StandardDeviationProp.PointsCount v)

    let apply (el: DevExpress.Xpf.Charts.StandardDeviation) (prop: StandardDeviationProp) =
        match prop with
        | StandardDeviationProp.Base p -> SeparatePaneIndicatorWithPoints.apply el p
        | StandardDeviationProp.ValueLevel v -> el.SetValue(DevExpress.Xpf.Charts.StandardDeviation.ValueLevelProperty, box v)
        | StandardDeviationProp.PointsCount v -> el.SetValue(DevExpress.Xpf.Charts.StandardDeviation.PointsCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.StandardDeviation>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
