...
module HeaderItem =
    let fontHeight v : obj = box (HeaderItemProp.FontHeight v)
    let text v : obj = box (HeaderItemProp.Text v)
    let isSelected v : obj = box (HeaderItemProp.IsSelected v)

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.HeaderItem) (prop: HeaderItemProp) =
        match prop with
        | HeaderItemProp.FontHeight v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderItem.FontHeightProperty, box v)
        | HeaderItemProp.Text v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderItem.TextProperty, box v)
        | HeaderItemProp.IsSelected v -> el.SetValue(DevExpress.Xpf.Spreadsheet.Internal.HeaderItem.IsSelectedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.HeaderItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
