...
type OriginPageGroupControlProp =
    | Base of RibbonPageGroupControlProp

module OriginPageGroupControl =

    let apply (el: DevExpress.Xpf.Ribbon.OriginPageGroupControl) (prop: OriginPageGroupControlProp) =
        match prop with
        | OriginPageGroupControlProp.Base p -> RibbonPageGroupControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Ribbon.OriginPageGroupControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
