...
type HeaderSmartPresenterProp =
    | HideControl of obj

module HeaderSmartPresenter =
    let hideControl v : obj = box (HeaderSmartPresenterProp.HideControl v)

    let apply (el: DevExpress.Xpf.Core.Native.HeaderSmartPresenter) (prop: HeaderSmartPresenterProp) =
        match prop with
        | HeaderSmartPresenterProp.HideControl v -> el.SetValue(DevExpress.Xpf.Core.Native.HeaderSmartPresenter.HideControlProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.Native.HeaderSmartPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
