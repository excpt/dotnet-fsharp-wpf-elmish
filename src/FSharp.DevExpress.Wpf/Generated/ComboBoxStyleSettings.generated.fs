...
module ComboBoxStyleSettings =
    ...
    let apply (el: DevExpress.Xpf.Editors.ComboBoxStyleSettings) (prop: ComboBoxStyleSettingsProp) =
        match prop with
        | ComboBoxStyleSettingsProp.Base p -> BaseComboBoxStyleSettings.apply el p
        | ComboBoxStyleSettingsProp.ShowEmptyItem v -> el.SetValue(DevExpress.Xpf.Editors.ComboBoxStyleSettings.ShowEmptyItemProperty, box v)
        | ComboBoxStyleSettingsProp.EmptyItemText v -> el.SetValue(DevExpress.Xpf.Editors.ComboBoxStyleSettings.EmptyItemTextProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.ComboBoxStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
