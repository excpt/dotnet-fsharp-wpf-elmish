...
type CleanWhiteMinorTickmarkControlProp =
    | Base of PresentationControlProp

module CleanWhiteMinorTickmarkControl =

    let apply (el: DevExpress.Xpf.Gauges.CleanWhiteMinorTickmarkControl) (prop: CleanWhiteMinorTickmarkControlProp) =
        match prop with
        | CleanWhiteMinorTickmarkControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CleanWhiteMinorTickmarkControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
