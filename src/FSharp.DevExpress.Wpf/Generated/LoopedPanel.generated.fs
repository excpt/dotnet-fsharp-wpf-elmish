...
type LoopedPanelProp =
    | Orientation of System.Windows.Controls.Orientation
    | IsLooped of bool

module LoopedPanel =
    let orientation v : obj = box (LoopedPanelProp.Orientation v)
    let isLooped v : obj = box (LoopedPanelProp.IsLooped v)

    let apply (el: DevExpress.Xpf.Editors.LoopedPanel) (prop: LoopedPanelProp) =
        match prop with
        | LoopedPanelProp.Orientation v -> el.SetValue(DevExpress.Xpf.Editors.LoopedPanel.OrientationProperty, box v)
        | LoopedPanelProp.IsLooped v -> el.SetValue(DevExpress.Xpf.Editors.LoopedPanel.IsLoopedProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.LoopedPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
