...
type AppointmentStatusControlProp =
...
module AppointmentStatusControl =
    let orientation v : obj = box (AppointmentStatusControlProp.Orientation v)
    let viewInfo v : obj = box (AppointmentStatusControlProp.ViewInfo v)

    let apply (el: DevExpress.Xpf.Scheduler.UI.AppointmentStatusControl) (prop: AppointmentStatusControlProp) =
        match prop with
        | AppointmentStatusControlProp.Base p -> XPFContentControl.apply el p
        | AppointmentStatusControlProp.Orientation v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.AppointmentStatusControl.OrientationProperty, box v)
        | AppointmentStatusControlProp.ViewInfo v -> el.SetValue(DevExpress.Xpf.Scheduler.UI.AppointmentStatusControl.ViewInfoProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.UI.AppointmentStatusControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
