...
type ExplorerBarExpandButtonProp =
    | Base of ExpandButtonBaseProp

module ExplorerBarExpandButton =

    let apply (el: DevExpress.Xpf.NavBar.ExplorerBarExpandButton) (prop: ExplorerBarExpandButtonProp) =
        match prop with
        | ExplorerBarExpandButtonProp.Base p -> ExpandButtonBase.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.NavBar.ExplorerBarExpandButton>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
