...
type GridDataControlBaseProp =
    | Base of DataControlBaseProp

module GridDataControlBase =

    let apply (el: DevExpress.Xpf.Grid.GridDataControlBase) (prop: GridDataControlBaseProp) =
        match prop with
        | GridDataControlBaseProp.Base p -> DataControlBase.apply el p
