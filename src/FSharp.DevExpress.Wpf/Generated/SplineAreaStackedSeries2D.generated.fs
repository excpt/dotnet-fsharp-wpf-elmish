...
type SplineAreaStackedSeries2DProp =
    | Base of AreaStackedSeries2DProp
    | SplineAlgorithm of DevExpress.Xpf.Charts.SplineAlgorithm
    | LineTension of float

module SplineAreaStackedSeries2D =
    let splineAlgorithm v : obj = box (SplineAreaStackedSeries2DProp.SplineAlgorithm v)
    let lineTension v : obj = box (SplineAreaStackedSeries2DProp.LineTension v)

    let apply (el: DevExpress.Xpf.Charts.SplineAreaStackedSeries2D) (prop: SplineAreaStackedSeries2DProp) =
        match prop with
        | SplineAreaStackedSeries2DProp.Base p -> AreaStackedSeries2D.apply el p
        | SplineAreaStackedSeries2DProp.SplineAlgorithm v -> el.SetValue(DevExpress.Xpf.Charts.SplineAreaStackedSeries2D.SplineAlgorithmProperty, box v)
        | SplineAreaStackedSeries2DProp.LineTension v -> el.SetValue(DevExpress.Xpf.Charts.SplineAreaStackedSeries2D.LineTensionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.SplineAreaStackedSeries2D>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
