...
type LabelControlCaptionPresenterProp =
    | Base of psvContentPresenterProp

module LabelControlCaptionPresenter =

    let apply (el: DevExpress.Xpf.Docking.VisualElements.LabelControlCaptionPresenter) (prop: LabelControlCaptionPresenterProp) =
        match prop with
        | LabelControlCaptionPresenterProp.Base p -> psvContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Docking.VisualElements.LabelControlCaptionPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
