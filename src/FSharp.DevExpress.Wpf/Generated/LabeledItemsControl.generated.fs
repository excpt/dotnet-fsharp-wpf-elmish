...
type LabeledItemsControlProp =
    | ItemLabelTemplate of System.Windows.DataTemplate

module LabeledItemsControl =
    let itemLabelTemplate v : obj = box (LabeledItemsControlProp.ItemLabelTemplate v)

    let apply (el: DevExpress.Xpf.Map.LabeledItemsControl) (prop: LabeledItemsControlProp) =
        match prop with
        | LabeledItemsControlProp.ItemLabelTemplate v -> el.SetValue(DevExpress.Xpf.Map.LabeledItemsControl.ItemLabelTemplateProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Map.LabeledItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
