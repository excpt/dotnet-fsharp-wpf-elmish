...
type VectorLayerBaseProp =
    | Base of LayerBaseProp
    | EnableHighlighting of bool
    | ToolTipPattern of string
    | ToolTipContentTemplate of System.Windows.DataTemplate
    | AllowResetSelection of bool
    | SelectedItem of obj
    | SelectedItems of System.Collections.IList
    | EnableSelection of bool
    | ToolTipEnabled of obj
    | IncreaseItemZIndexInInteraction of bool
    | InitialMapSize of System.Windows.Size
    | MapProjection of DevExpress.Xpf.Map.ProjectionBase
    | ShapeFill of System.Windows.Media.Brush
    | ShapeStroke of System.Windows.Media.Brush
    | ShapeStrokeStyle of DevExpress.Xpf.Map.StrokeStyle
    | HighlightShapeFill of System.Windows.Media.Brush
    | HighlightShapeStroke of System.Windows.Media.Brush
    | HighlightShapeStrokeStyle of DevExpress.Xpf.Map.StrokeStyle
    | SelectedShapeFill of System.Windows.Media.Brush
    | SelectedShapeStroke of System.Windows.Media.Brush
    | SelectedShapeStrokeStyle of DevExpress.Xpf.Map.StrokeStyle

module VectorLayerBase =
    let enableHighlighting v : obj = box (VectorLayerBaseProp.EnableHighlighting v)
    let toolTipPattern v : obj = box (VectorLayerBaseProp.ToolTipPattern v)
    let toolTipContentTemplate v : obj = box (VectorLayerBaseProp.ToolTipContentTemplate v)
    let allowResetSelection v : obj = box (VectorLayerBaseProp.AllowResetSelection v)
    let selectedItem v : obj = box (VectorLayerBaseProp.SelectedItem v)
    let selectedItems v : obj = box (VectorLayerBaseProp.SelectedItems v)
    let enableSelection v : obj = box (VectorLayerBaseProp.EnableSelection v)
    let toolTipEnabled v : obj = box (VectorLayerBaseProp.ToolTipEnabled v)
    let increaseItemZIndexInInteraction v : obj = box (VectorLayerBaseProp.IncreaseItemZIndexInInteraction v)
    let initialMapSize v : obj = box (VectorLayerBaseProp.InitialMapSize v)
    let mapProjection v : obj = box (VectorLayerBaseProp.MapProjection v)
    let shapeFill v : obj = box (VectorLayerBaseProp.ShapeFill v)
    let shapeStroke v : obj = box (VectorLayerBaseProp.ShapeStroke v)
    let shapeStrokeStyle v : obj = box (VectorLayerBaseProp.ShapeStrokeStyle v)
    let highlightShapeFill v : obj = box (VectorLayerBaseProp.HighlightShapeFill v)
    let highlightShapeStroke v : obj = box (VectorLayerBaseProp.HighlightShapeStroke v)
    let highlightShapeStrokeStyle v : obj = box (VectorLayerBaseProp.HighlightShapeStrokeStyle v)
    let selectedShapeFill v : obj = box (VectorLayerBaseProp.SelectedShapeFill v)
    let selectedShapeStroke v : obj = box (VectorLayerBaseProp.SelectedShapeStroke v)
    let selectedShapeStrokeStyle v : obj = box (VectorLayerBaseProp.SelectedShapeStrokeStyle v)

    let apply (el: DevExpress.Xpf.Map.VectorLayerBase) (prop: VectorLayerBaseProp) =
        match prop with
        | VectorLayerBaseProp.Base p -> LayerBase.apply el p
        | VectorLayerBaseProp.EnableHighlighting v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.EnableHighlightingProperty, box v)
        | VectorLayerBaseProp.ToolTipPattern v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.ToolTipPatternProperty, box v)
        | VectorLayerBaseProp.ToolTipContentTemplate v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.ToolTipContentTemplateProperty, box v)
        | VectorLayerBaseProp.AllowResetSelection v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.AllowResetSelectionProperty, box v)
        | VectorLayerBaseProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.SelectedItemProperty, box v)
        | VectorLayerBaseProp.SelectedItems v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.SelectedItemsProperty, box v)
        | VectorLayerBaseProp.EnableSelection v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.EnableSelectionProperty, box v)
        | VectorLayerBaseProp.ToolTipEnabled v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.ToolTipEnabledProperty, box v)
        | VectorLayerBaseProp.IncreaseItemZIndexInInteraction v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.IncreaseItemZIndexInInteractionProperty, box v)
        | VectorLayerBaseProp.InitialMapSize v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.InitialMapSizeProperty, box v)
        | VectorLayerBaseProp.MapProjection v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.MapProjectionProperty, box v)
        | VectorLayerBaseProp.ShapeFill v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.ShapeFillProperty, box v)
        | VectorLayerBaseProp.ShapeStroke v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.ShapeStrokeProperty, box v)
        | VectorLayerBaseProp.ShapeStrokeStyle v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.ShapeStrokeStyleProperty, box v)
        | VectorLayerBaseProp.HighlightShapeFill v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.HighlightShapeFillProperty, box v)
        | VectorLayerBaseProp.HighlightShapeStroke v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.HighlightShapeStrokeProperty, box v)
        | VectorLayerBaseProp.HighlightShapeStrokeStyle v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.HighlightShapeStrokeStyleProperty, box v)
        | VectorLayerBaseProp.SelectedShapeFill v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.SelectedShapeFillProperty, box v)
        | VectorLayerBaseProp.SelectedShapeStroke v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.SelectedShapeStrokeProperty, box v)
        | VectorLayerBaseProp.SelectedShapeStrokeStyle v -> el.SetValue(DevExpress.Xpf.Map.VectorLayerBase.SelectedShapeStrokeStyleProperty, box v)

    let bounds v : obj = box (LayerBaseProp.Bounds v)
    let minZoomLevel v : obj = box (LayerBaseProp.MinZoomLevel v)
    let maxZoomLevel v : obj = box (LayerBaseProp.MaxZoomLevel v)
