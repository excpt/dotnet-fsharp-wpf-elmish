...
type CircularThemeableThreeQuartersModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularThemeableThreeQuartersModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularThemeableThreeQuartersModel) (prop: CircularThemeableThreeQuartersModelProp) =
        match prop with
        | CircularThemeableThreeQuartersModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularThemeableThreeQuartersModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
