...
type SelectionViewProp =
    | SelectedItemsSource of System.Collections.IList
    | AllowSelectionSynchronize of bool
    | DisableStandardSelection of bool

module SelectionView =
    let selectedItemsSource v : obj = box (SelectionViewProp.SelectedItemsSource v)
    let allowSelectionSynchronize v : obj = box (SelectionViewProp.AllowSelectionSynchronize v)
    let disableStandardSelection v : obj = box (SelectionViewProp.DisableStandardSelection v)

    let apply (el: DevExpress.Xpf.Grid.SelectionView) (prop: SelectionViewProp) =
        match prop with
        | SelectionViewProp.SelectedItemsSource v -> el.SetValue(DevExpress.Xpf.Grid.SelectionView.SelectedItemsSourceProperty, box v)
        | SelectionViewProp.AllowSelectionSynchronize v -> el.SetValue(DevExpress.Xpf.Grid.SelectionView.AllowSelectionSynchronizeProperty, box v)
        | SelectionViewProp.DisableStandardSelection v -> el.SetValue(DevExpress.Xpf.Grid.SelectionView.DisableStandardSelectionProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.SelectionView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
