...
type CircularDefaultHalfTopModelProp =
    | Base of PartialCircularGaugeModelProp

module CircularDefaultHalfTopModel =

    let apply (el: DevExpress.Xpf.Gauges.CircularDefaultHalfTopModel) (prop: CircularDefaultHalfTopModelProp) =
        match prop with
        | CircularDefaultHalfTopModelProp.Base p -> PartialCircularGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.CircularDefaultHalfTopModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
