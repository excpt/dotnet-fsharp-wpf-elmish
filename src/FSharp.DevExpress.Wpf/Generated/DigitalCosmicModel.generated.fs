...
type DigitalCosmicModelProp =
    | Base of DigitalGaugeModelProp

module DigitalCosmicModel =

    let apply (el: DevExpress.Xpf.Gauges.DigitalCosmicModel) (prop: DigitalCosmicModelProp) =
        match prop with
        | DigitalCosmicModelProp.Base p -> DigitalGaugeModel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DigitalCosmicModel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
