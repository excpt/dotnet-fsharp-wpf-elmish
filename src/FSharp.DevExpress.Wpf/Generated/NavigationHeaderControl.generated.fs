...
type NavigationHeaderControlProp =
...
module NavigationHeaderControl =
    let backCommand v : obj = box (NavigationHeaderControlProp.BackCommand v)
    let backCommandParameter v : obj = box (NavigationHeaderControlProp.BackCommandParameter v)
    let showBackButton v : obj = box (NavigationHeaderControlProp.ShowBackButton v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.NavigationHeaderControl) (prop: NavigationHeaderControlProp) =
        match prop with
        | NavigationHeaderControlProp.Base p -> veContentControl.apply el p
        | NavigationHeaderControlProp.BackCommand v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.NavigationHeaderControl.BackCommandProperty, box v)
        | NavigationHeaderControlProp.BackCommandParameter v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.NavigationHeaderControl.BackCommandParameterProperty, box v)
        | NavigationHeaderControlProp.ShowBackButton v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.NavigationHeaderControl.ShowBackButtonProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.NavigationHeaderControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
