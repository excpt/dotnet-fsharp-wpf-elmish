...
type EntitySimpleDataSourceProp =
    | Base of SimpleDataSourceProp

module EntitySimpleDataSource =

    let apply (el: DevExpress.Xpf.Core.DataSources.EntitySimpleDataSource) (prop: EntitySimpleDataSourceProp) =
        match prop with
        | EntitySimpleDataSourceProp.Base p -> SimpleDataSource.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.EntitySimpleDataSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
