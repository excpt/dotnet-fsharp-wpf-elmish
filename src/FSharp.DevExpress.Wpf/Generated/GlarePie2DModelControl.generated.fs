...
type GlarePie2DModelControlProp =
    | Base of PredefinedPie2DModelControlProp

module GlarePie2DModelControl =

    let apply (el: DevExpress.Xpf.Charts.GlarePie2DModelControl) (prop: GlarePie2DModelControlProp) =
        match prop with
        | GlarePie2DModelControlProp.Base p -> PredefinedPie2DModelControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Charts.GlarePie2DModelControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
