...
type ValueIndicatorPresentationControlProp =
    | Base of PresentationControlProp

module ValueIndicatorPresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ValueIndicatorPresentationControl) (prop: ValueIndicatorPresentationControlProp) =
        match prop with
        | ValueIndicatorPresentationControlProp.Base p -> PresentationControl.apply el p
