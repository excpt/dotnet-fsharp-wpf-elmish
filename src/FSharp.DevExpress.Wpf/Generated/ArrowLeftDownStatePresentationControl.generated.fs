...
type ArrowLeftDownStatePresentationControlProp =
    | Base of PresentationControlProp

module ArrowLeftDownStatePresentationControl =

    let apply (el: DevExpress.Xpf.Gauges.ArrowLeftDownStatePresentationControl) (prop: ArrowLeftDownStatePresentationControlProp) =
        match prop with
        | ArrowLeftDownStatePresentationControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArrowLeftDownStatePresentationControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
