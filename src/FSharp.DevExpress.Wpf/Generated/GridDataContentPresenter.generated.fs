...
type GridDataContentPresenterProp =
    | Base of DataContentPresenterProp

module GridDataContentPresenter =

    let apply (el: DevExpress.Xpf.Grid.GridDataContentPresenter) (prop: GridDataContentPresenterProp) =
        match prop with
        | GridDataContentPresenterProp.Base p -> DataContentPresenter.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.GridDataContentPresenter>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
