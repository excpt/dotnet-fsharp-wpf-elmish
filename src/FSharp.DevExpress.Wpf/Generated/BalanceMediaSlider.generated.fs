...
type BalanceMediaSliderProp =
    | Base of MediaSliderProp

module BalanceMediaSlider =

    let apply (el: DevExpress.Xpf.Controls.BalanceMediaSlider) (prop: BalanceMediaSliderProp) =
        match prop with
        | BalanceMediaSliderProp.Base p -> MediaSlider.apply el p

    let mediaManager v : obj = box (MediaSliderProp.MediaManager v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Controls.BalanceMediaSlider>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
