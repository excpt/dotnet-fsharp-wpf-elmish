...
type DocumentViewerItemsControlProp =
    | Base of DocumentViewerItemsControlProp
    | PageDisplayMode of DevExpress.Xpf.DocumentViewer.PageDisplayMode

module DocumentViewerItemsControl =
    let pageDisplayMode v : obj = box (DocumentViewerItemsControlProp.PageDisplayMode v)

    let apply (el: DevExpress.Xpf.Diagram.Native.DocumentViewerItemsControl) (prop: DocumentViewerItemsControlProp) =
        match prop with
        | DocumentViewerItemsControlProp.Base p -> DocumentViewerItemsControl.apply el p
        | DocumentViewerItemsControlProp.PageDisplayMode v -> el.SetValue(DevExpress.Xpf.DocumentViewer.DocumentViewerItemsControl.PageDisplayModeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Diagram.Native.DocumentViewerItemsControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
