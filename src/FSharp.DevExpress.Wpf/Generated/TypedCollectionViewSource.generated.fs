...
type TypedCollectionViewSourceProp =
    | Base of CollectionViewDataSourceBaseProp
    | AdapterType of System.Type

module TypedCollectionViewSource =
    let adapterType v : obj = box (TypedCollectionViewSourceProp.AdapterType v)

    let apply (el: DevExpress.Xpf.Core.DataSources.TypedCollectionViewSource) (prop: TypedCollectionViewSourceProp) =
        match prop with
        | TypedCollectionViewSourceProp.Base p -> CollectionViewDataSourceBase.apply el p
        | TypedCollectionViewSourceProp.AdapterType v -> el.SetValue(DevExpress.Xpf.Core.DataSources.TypedCollectionViewSource.AdapterTypeProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Core.DataSources.TypedCollectionViewSource>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
