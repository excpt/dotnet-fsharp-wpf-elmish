...
type GridSearchControlBaseProp =
    | Base of SearchControlProp
    | View of DevExpress.Xpf.Grid.DataViewBase

module GridSearchControlBase =
    let view v : obj = box (GridSearchControlBaseProp.View v)

    let apply (el: DevExpress.Xpf.Grid.GridSearchControlBase) (prop: GridSearchControlBaseProp) =
        match prop with
        | GridSearchControlBaseProp.Base p -> SearchControl.apply el p
        | GridSearchControlBaseProp.View v -> el.SetValue(DevExpress.Xpf.Grid.GridSearchControlBase.ViewProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Grid.GridSearchControlBase>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
