...
module PiesPanel =
    ...
    let apply (el: DevExpress.DashboardWpf.Internal.PiesPanel) (prop: PiesPanelProp) =
        match prop with
        | PiesPanelProp.Base p -> CardsPanel.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.DashboardWpf.Internal.PiesPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
