...
type NavigationBarItemsPanelProp =
    | Base of FlowLayoutPanelProp
    | MaxItemCount of int

module NavigationBarItemsPanel =
    let maxItemCount v : obj = box (NavigationBarItemsPanelProp.MaxItemCount v)

    let apply (el: DevExpress.Xpf.Navigation.Internal.NavigationBarItemsPanel) (prop: NavigationBarItemsPanelProp) =
        match prop with
        | NavigationBarItemsPanelProp.Base p -> FlowLayoutPanel.apply el p
        | NavigationBarItemsPanelProp.MaxItemCount v -> el.SetValue(DevExpress.Xpf.Navigation.Internal.NavigationBarItemsPanel.MaxItemCountProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Navigation.Internal.NavigationBarItemsPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
