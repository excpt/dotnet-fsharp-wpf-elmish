...
type SmartLinearScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartLinearScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartLinearScaleBackgroundLayerControl) (prop: SmartLinearScaleBackgroundLayerControlProp) =
        match prop with
        | SmartLinearScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartLinearScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
