...
type HierarchicalChartControlBaseProp =
    ...
    | ToolTipGroupContentTemplate of System.Windows.DataTemplate
    | ToolTipGroupPattern of string
    | ToolTipEnabled of bool
    | ToolTipOptions of DevExpress.Xpf.TreeMap.ToolTipOptions
    | SelectedItem of obj
    | SelectedItems of System.Collections.IList
    | SelectionMode of DevExpress.Xpf.TreeMap.SelectionMode
    | Titles of DevExpress.Xpf.TreeMap.TitleCollection
    | Legend of DevExpress.Xpf.TreeMap.Legend

module HierarchicalChartControlBase =
    ...
    let apply (el: DevExpress.Xpf.TreeMap.HierarchicalChartControlBase) (prop: HierarchicalChartControlBaseProp) =
        match prop with
        | HierarchicalChartControlBaseProp.ToolTipTemplate v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipTemplateProperty, box v)
        | HierarchicalChartControlBaseProp.ToolTipContentTemplate v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipContentTemplateProperty, box v)
        | HierarchicalChartControlBaseProp.ToolTipPattern v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipPatternProperty, box v)
        | HierarchicalChartControlBaseProp.ToolTipGroupContentTemplate v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipGroupContentTemplateProperty, box v)
        | HierarchicalChartControlBaseProp.ToolTipGroupPattern v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipGroupPatternProperty, box v)
        | HierarchicalChartControlBaseProp.ToolTipEnabled v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipEnabledProperty, box v)
        | HierarchicalChartControlBaseProp.ToolTipOptions v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.ToolTipOptionsProperty, box v)
        | HierarchicalChartControlBaseProp.SelectedItem v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.SelectedItemProperty, box v)
        | HierarchicalChartControlBaseProp.SelectedItems v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.SelectedItemsProperty, box v)
        | HierarchicalChartControlBaseProp.SelectionMode v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.SelectionModeProperty, box v)
        | HierarchicalChartControlBaseProp.Titles v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.TitlesProperty, box v)
        | HierarchicalChartControlBaseProp.Legend v -> el.SetValue(DevExpress.Xpf.TreeMap.HierarchicalChartControlBase.LegendProperty, box v)
