...
open System
open System.Windows
open DevExpress.Xpf.WindowsUI.Internal
open FSharp.Windows.Dsl

[<RequireQualifiedAccess>]
type SplitViewProp =
    | AnimationSettings of DevExpress.Xpf.WindowsUI.HamburgerMenuAnimationSettings
    | CompactPaneWidth of float
    | OpenPaneWidth of float
    | IsPaneOpen of bool
    | DisplayMode of DevExpress.Xpf.WindowsUI.Internal.SplitViewDisplayMode
    | PanePlacement of DevExpress.Xpf.WindowsUI.Internal.SplitViewPanePlacement
    | Content of System.Windows.UIElement
    | Pane of System.Windows.UIElement
    | PaneBackground of System.Windows.Media.Brush
    | ActualOpenPaneWidth of float
    | PaneSvgPalette of DevExpress.Xpf.Core.WpfSvgPalette

module SplitView =
    let animationSettings v : obj = box (SplitViewProp.AnimationSettings v)
    let compactPaneWidth v : obj = box (SplitViewProp.CompactPaneWidth v)
    let openPaneWidth v : obj = box (SplitViewProp.OpenPaneWidth v)
    let isPaneOpen v : obj = box (SplitViewProp.IsPaneOpen v)
    let displayMode v : obj = box (SplitViewProp.DisplayMode v)
    let panePlacement v : obj = box (SplitViewProp.PanePlacement v)
    let content v : obj = box (SplitViewProp.Content v)
    let pane v : obj = box (SplitViewProp.Pane v)
    let paneBackground v : obj = box (SplitViewProp.PaneBackground v)
    let actualOpenPaneWidth v : obj = box (SplitViewProp.ActualOpenPaneWidth v)
    let paneSvgPalette v : obj = box (SplitViewProp.PaneSvgPalette v)

    let apply (el: DevExpress.Xpf.WindowsUI.Internal.SplitView) (prop: SplitViewProp) =
        match prop with
        | SplitViewProp.AnimationSettings v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.AnimationSettingsProperty, box v)
        | SplitViewProp.CompactPaneWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.CompactPaneWidthProperty, box v)
        | SplitViewProp.OpenPaneWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.OpenPaneWidthProperty, box v)
        | SplitViewProp.IsPaneOpen v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.IsPaneOpenProperty, box v)
        | SplitViewProp.DisplayMode v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.DisplayModeProperty, box v)
        | SplitViewProp.PanePlacement v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.PanePlacementProperty, box v)
        | SplitViewProp.Content v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.ContentProperty, box v)
        | SplitViewProp.Pane v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.PaneProperty, box v)
        | SplitViewProp.PaneBackground v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.PaneBackgroundProperty, box v)
        | SplitViewProp.ActualOpenPaneWidth v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.ActualOpenPaneWidthProperty, box v)
        | SplitViewProp.PaneSvgPalette v -> el.SetValue(DevExpress.Xpf.WindowsUI.Internal.SplitView.PaneSvgPaletteProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.WindowsUI.Internal.SplitView>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
