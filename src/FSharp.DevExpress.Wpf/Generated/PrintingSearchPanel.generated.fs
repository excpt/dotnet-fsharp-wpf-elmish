...
type PrintingSearchPanelProp =
    | Base of SearchPanelProp
    | Model of DevExpress.Xpf.Printing.IDocumentPreviewModel

module PrintingSearchPanel =
    let model v : obj = box (PrintingSearchPanelProp.Model v)

    let apply (el: DevExpress.Xpf.Printing.Native.PrintingSearchPanel) (prop: PrintingSearchPanelProp) =
        match prop with
        | PrintingSearchPanelProp.Base p -> SearchPanel.apply el p
        | PrintingSearchPanelProp.Model v -> el.SetValue(DevExpress.Xpf.Printing.Native.PrintingSearchPanel.ModelProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Printing.Native.PrintingSearchPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
