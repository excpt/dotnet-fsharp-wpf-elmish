...
type DefaultArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module DefaultArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.DefaultArcScaleMarkerControl) (prop: DefaultArcScaleMarkerControlProp) =
        match prop with
        | DefaultArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.DefaultArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
