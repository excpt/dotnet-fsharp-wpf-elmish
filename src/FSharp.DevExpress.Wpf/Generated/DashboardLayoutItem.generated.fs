...
type DashboardLayoutItemProp =
    | Base of LayoutControlItemProp
    | ContextMenuTemplate of System.Windows.DataTemplate
    | CaptionCustomizationsTemplate of System.Windows.DataTemplate

module DashboardLayoutItem =
    ...
    let apply (el: DevExpress.DashboardWpf.DashboardLayoutItem) (prop: DashboardLayoutItemProp) =
        match prop with
        | DashboardLayoutItemProp.Base p -> LayoutControlItem.apply el p
        | DashboardLayoutItemProp.ContextMenuTemplate v -> el.SetValue(DevExpress.DashboardWpf.DashboardLayoutItem.ContextMenuTemplateProperty, box v)
        | DashboardLayoutItemProp.CaptionCustomizationsTemplate v -> el.SetValue(DevExpress.DashboardWpf.DashboardLayoutItem.CaptionCustomizationsTemplateProperty, box v)
    ...
    let viewStyle (v: System.Windows.Style) (node: VirtualNode) : VirtualNode =
        { node with Props = box (AttachedProp(DevExpress.DashboardWpf.DashboardLayoutItem.ViewStyleProperty, box v)) :: node.Props }

    let create (props: obj list) : VirtualNode =
        let cs, uk, ps = VirtualTree.extractSpecialProps props
        { Type = typeof<DevExpress.DashboardWpf.DashboardLayoutItem>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
