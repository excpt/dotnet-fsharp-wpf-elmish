...
type ArcScaleProp =
    | Base of ScaleProp
    | SpindleCapPresentation of DevExpress.Xpf.Gauges.SpindleCapPresentation
    | LayoutMode of DevExpress.Xpf.Gauges.ArcScaleLayoutMode
    | StartAngle of float
    | EndAngle of float
    | LabelOptions of DevExpress.Xpf.Gauges.ArcScaleLabelOptions
    | ShowSpindleCap of DevExpress.Utils.DefaultBoolean
    | SpindleCapOptions of DevExpress.Xpf.Gauges.SpindleCapOptions
    | LinePresentation of DevExpress.Xpf.Gauges.ArcScaleLinePresentation

module ArcScale =
    let spindleCapPresentation v : obj = box (ArcScaleProp.SpindleCapPresentation v)
    let layoutMode v : obj = box (ArcScaleProp.LayoutMode v)
    let startAngle v : obj = box (ArcScaleProp.StartAngle v)
    let endAngle v : obj = box (ArcScaleProp.EndAngle v)
    let labelOptions v : obj = box (ArcScaleProp.LabelOptions v)
    let showSpindleCap v : obj = box (ArcScaleProp.ShowSpindleCap v)
    let spindleCapOptions v : obj = box (ArcScaleProp.SpindleCapOptions v)
    let linePresentation v : obj = box (ArcScaleProp.LinePresentation v)

    let apply (el: DevExpress.Xpf.Gauges.ArcScale) (prop: ArcScaleProp) =
        match prop with
        | ArcScaleProp.Base p -> Scale.apply el p
        | ArcScaleProp.SpindleCapPresentation v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.SpindleCapPresentationProperty, box v)
        | ArcScaleProp.LayoutMode v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.LayoutModeProperty, box v)
        | ArcScaleProp.StartAngle v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.StartAngleProperty, box v)
        | ArcScaleProp.EndAngle v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.EndAngleProperty, box v)
        | ArcScaleProp.LabelOptions v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.LabelOptionsProperty, box v)
        | ArcScaleProp.ShowSpindleCap v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.ShowSpindleCapProperty, box v)
        | ArcScaleProp.SpindleCapOptions v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.SpindleCapOptionsProperty, box v)
        | ArcScaleProp.LinePresentation v -> el.SetValue(DevExpress.Xpf.Gauges.ArcScale.LinePresentationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.ArcScale>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
