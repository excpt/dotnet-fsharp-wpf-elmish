...
type TimelineLevelHeadersPanelProp =
    | Base of PixelSnappedUniformGridProp

module TimelineLevelHeadersPanel =

    let apply (el: DevExpress.Xpf.Scheduler.Drawing.TimelineLevelHeadersPanel) (prop: TimelineLevelHeadersPanelProp) =
        match prop with
        | TimelineLevelHeadersPanelProp.Base p -> PixelSnappedUniformGrid.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduler.Drawing.TimelineLevelHeadersPanel>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
