...
type TimeRulerWindowProp =
    | Base of ThemedWindowProp

module TimeRulerWindow =

    let apply (el: DevExpress.Xpf.Scheduling.Visual.TimeRulerWindow) (prop: TimeRulerWindowProp) =
        match prop with
        | TimeRulerWindowProp.Base p -> ThemedWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Scheduling.Visual.TimeRulerWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
