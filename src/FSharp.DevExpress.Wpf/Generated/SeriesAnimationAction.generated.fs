...
type SeriesAnimationActionProp =
    | Base of ChartElementProp

module SeriesAnimationAction =

    let apply (el: DevExpress.Xpf.Charts.SeriesAnimationAction) (prop: SeriesAnimationActionProp) =
        match prop with
        | SeriesAnimationActionProp.Base p -> ChartElement.apply el p
