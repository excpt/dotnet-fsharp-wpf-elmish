...
type FormatBorderPreviewControlContainerProp =
    | Base of BackgroundPanelProp

module FormatBorderPreviewControlContainer =

    let apply (el: DevExpress.Xpf.Spreadsheet.Internal.FormatBorderPreviewControlContainer) (prop: FormatBorderPreviewControlContainerProp) =
        match prop with
        | FormatBorderPreviewControlContainerProp.Base p -> BackgroundPanel.apply el p

    let wasModifiedByBackgroundPanel v : obj = box (BackgroundPanelProp.WasModifiedByBackgroundPanel v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Spreadsheet.Internal.FormatBorderPreviewControlContainer>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
