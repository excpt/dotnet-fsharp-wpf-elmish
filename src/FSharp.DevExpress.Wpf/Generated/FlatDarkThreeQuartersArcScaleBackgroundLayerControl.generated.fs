...
type FlatDarkThreeQuartersArcScaleBackgroundLayerControlProp =
    | Base of PresentationControlProp

module FlatDarkThreeQuartersArcScaleBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.FlatDarkThreeQuartersArcScaleBackgroundLayerControl) (prop: FlatDarkThreeQuartersArcScaleBackgroundLayerControlProp) =
        match prop with
        | FlatDarkThreeQuartersArcScaleBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.FlatDarkThreeQuartersArcScaleBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
