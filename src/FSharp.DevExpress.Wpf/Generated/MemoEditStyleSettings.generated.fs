...
type MemoEditStyleSettingsProp =
    | Base of PopupBaseEditStyleSettingsProp

module MemoEditStyleSettings =

    let apply (el: DevExpress.Xpf.Editors.MemoEditStyleSettings) (prop: MemoEditStyleSettingsProp) =
        match prop with
        | MemoEditStyleSettingsProp.Base p -> PopupBaseEditStyleSettings.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Editors.MemoEditStyleSettings>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
