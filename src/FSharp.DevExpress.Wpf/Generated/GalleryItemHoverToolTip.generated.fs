...
type GalleryItemHoverToolTipProp =
    | Glyph of System.Windows.Media.ImageSource
    | LargeGlyphSize of System.Windows.Size
    | SmallGlyphSize of System.Windows.Size
    | AllowAnimation of bool
    | Duration of int

module GalleryItemHoverToolTip =
    let glyph v : obj = box (GalleryItemHoverToolTipProp.Glyph v)
    let largeGlyphSize v : obj = box (GalleryItemHoverToolTipProp.LargeGlyphSize v)
    let smallGlyphSize v : obj = box (GalleryItemHoverToolTipProp.SmallGlyphSize v)
    let allowAnimation v : obj = box (GalleryItemHoverToolTipProp.AllowAnimation v)
    let duration v : obj = box (GalleryItemHoverToolTipProp.Duration v)

    let apply (el: DevExpress.Xpf.Bars.GalleryItemHoverToolTip) (prop: GalleryItemHoverToolTipProp) =
        match prop with
        | GalleryItemHoverToolTipProp.Glyph v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemHoverToolTip.GlyphProperty, box v)
        | GalleryItemHoverToolTipProp.LargeGlyphSize v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemHoverToolTip.LargeGlyphSizeProperty, box v)
        | GalleryItemHoverToolTipProp.SmallGlyphSize v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemHoverToolTip.SmallGlyphSizeProperty, box v)
        | GalleryItemHoverToolTipProp.AllowAnimation v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemHoverToolTip.AllowAnimationProperty, box v)
        | GalleryItemHoverToolTipProp.Duration v -> el.SetValue(DevExpress.Xpf.Bars.GalleryItemHoverToolTip.DurationProperty, box v)
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Bars.GalleryItemHoverToolTip>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
