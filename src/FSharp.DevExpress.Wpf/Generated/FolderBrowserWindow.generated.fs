...
type FolderBrowserWindowProp =
    | Base of DialogWindowProp

module FolderBrowserWindow =

    let apply (el: DevExpress.Xpf.Dialogs.FolderBrowserWindow) (prop: FolderBrowserWindowProp) =
        match prop with
        | FolderBrowserWindowProp.Base p -> DialogWindow.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Dialogs.FolderBrowserWindow>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
