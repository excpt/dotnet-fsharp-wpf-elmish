...
type SmartDigitalGaugeBackgroundLayerControlProp =
    | Base of PresentationControlProp

module SmartDigitalGaugeBackgroundLayerControl =

    let apply (el: DevExpress.Xpf.Gauges.SmartDigitalGaugeBackgroundLayerControl) (prop: SmartDigitalGaugeBackgroundLayerControlProp) =
        match prop with
        | SmartDigitalGaugeBackgroundLayerControlProp.Base p -> PresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.SmartDigitalGaugeBackgroundLayerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
