...
type EcoArcScaleMarkerControlProp =
    | Base of ValueIndicatorPresentationControlProp

module EcoArcScaleMarkerControl =

    let apply (el: DevExpress.Xpf.Gauges.EcoArcScaleMarkerControl) (prop: EcoArcScaleMarkerControlProp) =
        match prop with
        | EcoArcScaleMarkerControlProp.Base p -> ValueIndicatorPresentationControl.apply el p
    ...
    let create (props: obj list) : VirtualNode =
        ...
        { Type = typeof<DevExpress.Xpf.Gauges.EcoArcScaleMarkerControl>
          Props = ps
          Children = cs
          UserKey = uk
          InternalId = "" }
